...
description: "Aspose.Svg.Filters.SVGFEMorphologyElement klasse. De SVGFEMorphologyElement interface komt overeen met het feMorphology element"
type: docs
weight: 3920
url: /nl/net/aspose.svg.filters/svgfemorphologyelement/
---
...
| [Height](../../aspose.svg.filters/svgfemorphologyelement/height/) { get; } | Komt overeen met attribuut ‘height’ op het opgegeven ‘filter’-element. |
...
| [In1](../../aspose.svg.filters/svgfemorphologyelement/in1/) { get; } | Komt overeen met attribuut ‘in’ op het opgegeven ‘feMorphology’ element. |
...
| [Operator](../../aspose.svg.filters/svgfemorphologyelement/operator/) { get; } | Komt overeen met attribuut ‘operator’ op het opgegeven ‘feMorphology’ element. Neemt een van de SVG_MORPHOLOGY_OPERATOR_* constanten die op deze interface zijn gedefinieerd. |
...
| [RadiusX](../../aspose.svg.filters/svgfemorphologyelement/radiusx/) { get; } | Komt overeen met attribuut ‘radius’ op het opgegeven ‘feMorphology’-element. |
| [RadiusY](../../aspose.svg.filters/svgfemorphologyelement/radiusy/) { get; } | Komt overeen met attribuut ‘radius’ op het opgegeven ‘feMorphology’-element. |
| [Result](../../aspose.svg.filters/svgfemorphologyelement/result/) { get; } | Komt overeen met attribuut ‘result’ op het opgegeven ‘filter’-element. |
...
| [Width](../../aspose.svg.filters/svgfemorphologyelement/width/) { get; } | Komt overeen met attribuut ‘width’ op het opgegeven ‘filter’-element. |
| [X](../../aspose.svg.filters/svgfemorphologyelement/x/) { get; } | Komt overeen met attribuut ‘x’ op het opgegeven ‘filter’-element. |
| [Y](../../aspose.svg.filters/svgfemorphologyelement/y/) { get; } | Komt overeen met attribuut ‘y’ op het opgegeven ‘filter’-element. |
...
| Naam | Beschrijving |
| --- | --- |
| const [SVG_MORPHOLOGY_OPERATOR_DILATE](../../aspose.svg.filters/svgfemorphologyelement/svg_morphology_operator_dilate/) | Komt overeen met waarde 'dilate'. |
| const [SVG_MORPHOLOGY_OPERATOR_ERODE](../../aspose.svg.filters/svgfemorphologyelement/svg_morphology_operator_erode/) | Komt overeen met waarde 'erode'. |
| const [SVG_MORPHOLOGY_OPERATOR_UNKNOWN](../../aspose.svg.filters/svgfemorphologyelement/svg_morphology_operator_unknown/) | Het type is niet een van de vooraf gedefinieerde types. Het is ongeldig om te proberen een nieuwe waarde van dit type te definiëren of om te proberen een bestaande waarde naar dit type te wijzigen. |
