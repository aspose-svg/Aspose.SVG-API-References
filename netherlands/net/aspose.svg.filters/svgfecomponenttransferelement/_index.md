...
description: Aspose.Svg.Filters.SVGFEComponentTransferElement klas. De interface SVGFEComponentTransferElement komt overeen met het element feComponentTransfer.
type: docs
weight: 1670
...
| [Height](../../aspose.svg.filters/svgfecomponenttransferelement/height/) { get; } | Komt overeen met attribuut 'height' op het gegeven 'filter'-element. |
...
| [In1](../../aspose.svg.filters/svgfecomponenttransferelement/in1/) { get; } | Komt overeen met attribuut 'in' op het gegeven 'feComponentTransfer' element. |
...
| [Result](../../aspose.svg.filters/svgfecomponenttransferelement/result/) { get; } | Komt overeen met attribuut 'result' op het gegeven 'filter'-element. |
...
| [Width](../../aspose.svg.filters/svgfecomponenttransferelement/width/) { get; } | Komt overeen met attribuut 'width' op het gegeven 'filter'-element. |
| [X](../../aspose.svg.filters/svgfecomponenttransferelement/x/) { get; } | Komt overeen met attribuut 'x' op het gegeven 'filter'-element. |
| [Y](../../aspose.svg.filters/svgfecomponenttransferelement/y/) { get; } | Komt overeen met attribuut 'y' op het gegeven 'filter'-element. |
