...
description: Aspose.Svg.Filters.SVGFEMergeElement klas. De interface SVGFEMergeElement komt overeen met het element feMerge.
type: docs
weight: 1810
...
| [Height](../../aspose.svg.filters/svgfemergeelement/height/) { get; } | Komt overeen met attribuut 'height' op het gegeven 'filter'-element. |
...
| [Result](../../aspose.svg.filters/svgfemergeelement/result/) { get; } | Komt overeen met attribuut 'result' op het gegeven 'filter'-element. |
...
| [Width](../../aspose.svg.filters/svgfemergeelement/width/) { get; } | Komt overeen met attribuut 'width' op het gegeven 'filter'-element. |
| [X](../../aspose.svg.filters/svgfemergeelement/x/) { get; } | Komt overeen met attribuut 'x' op het gegeven 'filter'-element. |
| [Y](../../aspose.svg.filters/svgfemergeelement/y/) { get; } | Komt overeen met attribuut 'y' op het gegeven 'filter'-element. |
