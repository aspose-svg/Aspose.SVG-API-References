...
description: Aspose.Svg.Filters.SVGFEColorMatrixElement klas. De interface SVGFEColorMatrixElement komt overeen met het element feColorMatrix.
type: docs
weight: 1660
...
| [Height](../../aspose.svg.filters/svgfecolormatrixelement/height/) { get; } | Komt overeen met attribuut 'height' op het gegeven 'filter'-element. |
...
| [Result](../../aspose.svg.filters/svgfecolormatrixelement/result/) { get; } | Komt overeen met attribuut 'result' op het gegeven 'filter'-element. |
...
| [Values](../../aspose.svg.filters/svgfecolormatrixelement/values/) { get; } | Komt overeen met attribuut 'waarden' op het gegeven 'feColorMatrix'-element. |
...
| [Width](../../aspose.svg.filters/svgfecolormatrixelement/width/) { get; } | Komt overeen met attribuut 'width' op het gegeven 'filter'-element. |
| [X](../../aspose.svg.filters/svgfecolormatrixelement/x/) { get; } | Komt overeen met attribuut 'x' op het gegeven 'filter'-element. |
| [Y](../../aspose.svg.filters/svgfecolormatrixelement/y/) { get; } | Komt overeen met attribuut 'y' op het gegeven 'filter'-element. |
...
| const [SVG_FECOLORMATRIX_TYPE_SATURATE](../../aspose.svg.filters/svgfecolormatrixelement/svg_fecolormatrix_type_saturate/) | Komt overeen met waarde 'verzadigen'. |
| const [SVG_FECOLORMATRIX_TYPE_UNKNOWN](../../aspose.svg.filters/svgfecolormatrixelement/svg_fecolormatrix_type_unknown/) | Het type is niet een van de vooraf gedefinieerde typen. Het is ongeldig om te proberen een nieuwe waarde van dit type te definiëren of om een bestaande waarde naar dit type om te schakelen. |
