...
description: "Aspose.Svg.Filters.SVGFEColorMatrixElement klasse. De SVGFEColorMatrixElement interface komt overeen met het feColorMatrix-element"
type: docs
weight: 3750
url: /nl/net/aspose.svg.filters/svgfecolormatrixelement/
---
...
| [Height](../../aspose.svg.filters/svgfecolormatrixelement/height/) { get; } | Komt overeen met attribuut ‘height’ op het opgegeven ‘filter’-element. |
...
| [In1](../../aspose.svg.filters/svgfecolormatrixelement/in1/) { get; } | Komt overeen met attribuut ‘in’ op het opgegeven ‘feColorMatrix’-element. |
...
| [Result](../../aspose.svg.filters/svgfecolormatrixelement/result/) { get; } | Komt overeen met attribuut ‘result’ op het opgegeven ‘filter’-element. |
...
| [Type](../../aspose.svg.filters/svgfecolormatrixelement/type/) { get; } | Komt overeen met attribuut ‘type’ op het opgegeven ‘feColorMatrix’-element. Neemt een van de SVG_FECOLORMATRIX_TYPE_* constanten die op deze interface zijn gedefinieerd. |
| [Values](../../aspose.svg.filters/svgfecolormatrixelement/values/) { get; } | Komt overeen met attribuut ‘values’ op het opgegeven ‘feColorMatrix’-element. |
...
| [Width](../../aspose.svg.filters/svgfecolormatrixelement/width/) { get; } | Komt overeen met attribuut ‘width’ op het opgegeven ‘filter’-element. |
| [X](../../aspose.svg.filters/svgfecolormatrixelement/x/) { get; } | Komt overeen met attribuut ‘x’ op het opgegeven ‘filter’-element. |
| [Y](../../aspose.svg.filters/svgfecolormatrixelement/y/) { get; } | Komt overeen met attribuut ‘y’ op het opgegeven ‘filter’-element. |
...
| Naam | Beschrijving |
| --- | --- |
| const [SVG_FECOLORMATRIX_TYPE_HUEROTATE](../../aspose.svg.filters/svgfecolormatrixelement/svg_fecolormatrix_type_huerotate/) | Komt overeen met waarde 'hueRotate'. |
| const [SVG_FECOLORMATRIX_TYPE_LUMINANCETOALPHA](../../aspose.svg.filters/svgfecolormatrixelement/svg_fecolormatrix_type_luminancetoalpha/) | Komt overeen met waarde 'luminanceToAlpha'. |
| const [SVG_FECOLORMATRIX_TYPE_MATRIX](../../aspose.svg.filters/svgfecolormatrixelement/svg_fecolormatrix_type_matrix/) | Komt overeen met waarde 'matrix'. |
| const [SVG_FECOLORMATRIX_TYPE_SATURATE](../../aspose.svg.filters/svgfecolormatrixelement/svg_fecolormatrix_type_saturate/) | Komt overeen met waarde 'saturate'. |
| const [SVG_FECOLORMATRIX_TYPE_UNKNOWN](../../aspose.svg.filters/svgfecolormatrixelement/svg_fecolormatrix_type_unknown/) | Het type is niet een van de vooraf gedefinieerde types. Het is ongeldig om te proberen een nieuwe waarde van dit type te definiëren of om te proberen een bestaande waarde naar dit type te wijzigen. |
