...
description: Aspose.Svg.Filters.SVGFEDropShadowElement klas. De interface SVGFEDropShadowElement komt overeen met het element feDropShadow.
type: docs
weight: 1730
...
| [Dx](../../aspose.svg.filters/svgfedropshadowelement/dx/) { get; } | Komt overeen met attribuut 'dx' op het gegeven 'feDropShadow'-element. |
| [Dy](../../aspose.svg.filters/svgfedropshadowelement/dy/) { get; } | Komt overeen met attribuut 'dy' op het gegeven 'feDropShadow'-element. |
...
| [Height](../../aspose.svg.filters/svgfedropshadowelement/height/) { get; } | Komt overeen met attribuut 'height' op het gegeven 'feDropShadow'-element. |
...
| [In1](../../aspose.svg.filters/svgfedropshadowelement/in1/) { get; } | Komt overeen met attribuut 'in' op het gegeven 'feDropShadow'-element. |
...
| [Result](../../aspose.svg.filters/svgfedropshadowelement/result/) { get; } | Komt overeen met attribuut 'result' op het gegeven 'feDropShadow'-element. |
...
| [StdDeviationX](../../aspose.svg.filters/svgfedropshadowelement/stddeviationx/) { get; } | Komt overeen met attribuut 'stdDeviation' op het gegeven 'feDropShadow' element. Bevat de X-component van attribuut 'stdDeviation'. |
| [StdDeviationY](../../aspose.svg.filters/svgfedropshadowelement/stddeviationy/) { get; } | Komt overeen met attribuut 'stdDeviation' op het gegeven 'feDropShadow' element. Bevat de Y-component (mogelijk automatisch berekend) van attribuut 'stdDeviation'. |
...
| [Width](../../aspose.svg.filters/svgfedropshadowelement/width/) { get; } | Komt overeen met attribuut 'width' op het gegeven 'feDropShadow'-element. |
| [X](../../aspose.svg.filters/svgfedropshadowelement/x/) { get; } | Komt overeen met attribuut 'x' op het gegeven 'feDropShadow'-element. |
| [Y](../../aspose.svg.filters/svgfedropshadowelement/y/) { get; } | Komt overeen met attribuut 'y' op het gegeven 'feDropShadow'-element. |
