...
description: Aspose.Svg.Filters.SVGFEImageElement klas. De interface SVGFEImageElement komt overeen met het element feImage.
type: docs
weight: 1800
...
| [Height](../../aspose.svg.filters/svgfeimageelement/height/) { get; } | Komt overeen met attribuut 'height' op het gegeven 'filter'-element. |
| [Href](../../aspose.svg.filters/svgfeimageelement/href/) { get; } | Komt overeen met attribuut 'xlink:href' op het gegeven element. |
...
| [Result](../../aspose.svg.filters/svgfeimageelement/result/) { get; } | Komt overeen met attribuut 'result' op het gegeven 'filter'-element. |
...
| [Width](../../aspose.svg.filters/svgfeimageelement/width/) { get; } | Komt overeen met attribuut 'width' op het gegeven 'filter'-element. |
| [X](../../aspose.svg.filters/svgfeimageelement/x/) { get; } | Komt overeen met attribuut 'x' op het gegeven 'filter'-element. |
| [Y](../../aspose.svg.filters/svgfeimageelement/y/) { get; } | Komt overeen met attribuut 'y' op het gegeven 'filter'-element. |
