...
description: Aspose.Svg.Filters.SVGFEFloodElement klas. De interface SVGFEFloodElement komt overeen met het element feFlood.
type: docs
weight: 1740
...
| [Height](../../aspose.svg.filters/svgfefloodelement/height/) { get; } | Komt overeen met attribuut 'height' op het gegeven 'filter'-element. |
...
| [Result](../../aspose.svg.filters/svgfefloodelement/result/) { get; } | Komt overeen met attribuut 'result' op het gegeven 'filter'-element. |
...
| [Width](../../aspose.svg.filters/svgfefloodelement/width/) { get; } | Komt overeen met attribuut 'width' op het gegeven 'filter'-element. |
| [X](../../aspose.svg.filters/svgfefloodelement/x/) { get; } | Komt overeen met attribuut 'x' op het gegeven 'filter'-element. |
| [Y](../../aspose.svg.filters/svgfefloodelement/y/) { get; } | Komt overeen met attribuut 'y' op het gegeven 'filter'-element. |
