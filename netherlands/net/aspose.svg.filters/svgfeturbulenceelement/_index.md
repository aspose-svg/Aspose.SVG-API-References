...
description: Aspose.Svg.Filters.SVGFETurbulenceElement klas. De interface SVGFETurbulenceElement komt overeen met het element feTurbulence.
type: docs
weight: 1890
...
| [BaseFrequencyX](../../aspose.svg.filters/svgfeturbulenceelement/basefrequencyx/) { get; } | Komt overeen met attribuut 'baseFrequency' op het gegeven 'feTurbulence' element. Bevat de X-component van het 'baseFrequency'-attribuut. |
| [BaseFrequencyY](../../aspose.svg.filters/svgfeturbulenceelement/basefrequencyy/) { get; } | Komt overeen met attribuut 'baseFrequency' op het gegeven 'feTurbulence' element. Bevat de Y-component van het (mogelijk automatisch berekende) 'baseFrequency'-attribuut. |
...
| [Height](../../aspose.svg.filters/svgfeturbulenceelement/height/) { get; } | Komt overeen met attribuut 'height' op het gegeven 'filter'-element. |
...
| [NumOctaves](../../aspose.svg.filters/svgfeturbulenceelement/numoctaves/) { get; } | Komt overeen met attribuut 'numOctaves' op het gegeven 'feTurbulence' element. |
...
| [Result](../../aspose.svg.filters/svgfeturbulenceelement/result/) { get; } | Komt overeen met attribuut 'result' op het gegeven 'filter'-element. |
| [SchemaTypeInfo](../../aspose.svg.dom/element/schematypeinfo/) { get; } | De type-informatie die aan dit element is gekoppeld. |
| [Seed](../../aspose.svg.filters/svgfeturbulenceelement/seed/) { get; } | Komt overeen met attribuut 'seed' op het gegeven 'feTurbulence'-element. |
...
| [StitchTiles](../../aspose.svg.filters/svgfeturbulenceelement/stitchtiles/) { get; } | Komt overeen met attribuut 'stitchTiles' op het gegeven 'feTurbulence' element. Neemt een van de SVG_STITCHTYPE_*-constanten die in deze interface zijn gedefinieerd. |
...
| [Type](../../aspose.svg.filters/svgfeturbulenceelement/type/) { get; } | Komt overeen met attribuut 'type' op het gegeven 'feTurbulence'-element. Neemt een van de SVG_TURBULENCE_TYPE_*-constanten die in deze interface zijn gedefinieerd. |
...
| [Width](../../aspose.svg.filters/svgfeturbulenceelement/width/) { get; } | Komt overeen met attribuut 'width' op het gegeven 'filter'-element. |
| [X](../../aspose.svg.filters/svgfeturbulenceelement/x/) { get; } | Komt overeen met attribuut 'x' op het gegeven 'filter'-element. |
| [Y](../../aspose.svg.filters/svgfeturbulenceelement/y/) { get; } | Komt overeen met attribuut 'y' op het gegeven 'filter'-element. |
...
| const [SVG_STITCHTYPE_UNKNOWN](../../aspose.svg.filters/svgfeturbulenceelement/svg_stitchtype_unknown/) | Het type is niet een van de vooraf gedefinieerde typen. Het is ongeldig om te proberen een nieuwe waarde van dit type te definiëren of om een bestaande waarde naar dit type om te schakelen. |
...
| const [SVG_TURBULENCE_TYPE_TURBULENCE](../../aspose.svg.filters/svgfeturbulenceelement/svg_turbulence_type_turbulence/) | Komt overeen met waarde 'turbulentie'. |
| const [SVG_TURBULENCE_TYPE_UNKNOWN](../../aspose.svg.filters/svgfeturbulenceelement/svg_turbulence_type_unknown/) | Het type is niet een van de vooraf gedefinieerde typen. Het is ongeldig om te proberen een nieuwe waarde van dit type te definiëren of om een bestaande waarde naar dit type om te schakelen. |
