...
description: "Aspose.Svg.Filters.SVGFETurbulenceElement klasse. De SVGFETurbulenceElement interface komt overeen met het feTurbulence-element."
type: docs
weight: 3980
url: /nl/net/aspose.svg.filters/svgfeturbulenceelement/
---
...
| [BaseFrequencyX](../../aspose.svg.filters/svgfeturbulenceelement/basefrequencyx/) { get; } | Komt overeen met attribuut ‘baseFrequency’ op het opgegeven ‘feTurbulence’-element. Bevat de X-component van het ‘baseFrequency’-attribuut. |
| [BaseFrequencyY](../../aspose.svg.filters/svgfeturbulenceelement/basefrequencyy/) { get; } | Komt overeen met attribuut ‘baseFrequency’ op het opgegeven ‘feTurbulence’-element. Bevat de Y-component van het (mogelijk automatisch berekende) ‘baseFrequency’-attribuut. |
...
| [Height](../../aspose.svg.filters/svgfeturbulenceelement/height/) { get; } | Komt overeen met attribuut ‘height’ op het opgegeven ‘filter’-element. |
...
| [NumOctaves](../../aspose.svg.filters/svgfeturbulenceelement/numoctaves/) { get; } | Komt overeen met attribuut ‘numOctaves’ op het opgegeven ‘feTurbulence’-element. |
...
| [Result](../../aspose.svg.filters/svgfeturbulenceelement/result/) { get; } | Komt overeen met attribuut ‘result’ op het opgegeven ‘filter’-element. |
| [Seed](../../aspose.svg.filters/svgfeturbulenceelement/seed/) { get; } | Komt overeen met attribuut ‘seed’ op het opgegeven ‘feTurbulence’-element. |
...
| [StitchTiles](../../aspose.svg.filters/svgfeturbulenceelement/stitchtiles/) { get; } | Komt overeen met attribuut ‘stitchTiles’ op het opgegeven ‘feTurbulence’-element. Neemt een van de SVG_STITCHTYPE_* constanten die op deze interface zijn gedefinieerd. |
...
| [Type](../../aspose.svg.filters/svgfeturbulenceelement/type/) { get; } | Komt overeen met attribuut ‘type’ op het opgegeven ‘feTurbulence’-element. Neemt een van de SVG_TURBULENCE_TYPE_* constanten die op deze interface zijn gedefinieerd. |
...
| [Width](../../aspose.svg.filters/svgfeturbulenceelement/width/) { get; } | Komt overeen met attribuut ‘width’ op het opgegeven ‘filter’-element. |
| [X](../../aspose.svg.filters/svgfeturbulenceelement/x/) { get; } | Komt overeen met attribuut ‘x’ op het opgegeven ‘filter’-element. |
| [Y](../../aspose.svg.filters/svgfeturbulenceelement/y/) { get; } | Komt overeen met attribuut ‘y’ op het opgegeven ‘filter’-element. |
...
| Naam | Beschrijving |
| --- | --- |
| const [SVG_STITCHTYPE_NOSTITCH](../../aspose.svg.filters/svgfeturbulenceelement/svg_stitchtype_nostitch/) | Komt overeen met waarde 'noStitch'. |
| const [SVG_STITCHTYPE_STITCH](../../aspose.svg.filters/svgfeturbulenceelement/svg_stitchtype_stitch/) | Komt overeen met waarde 'stitch'. |
| const [SVG_STITCHTYPE_UNKNOWN](../../aspose.svg.filters/svgfeturbulenceelement/svg_stitchtype_unknown/) | Het type is niet een van de vooraf gedefinieerde types. Het is ongeldig om te proberen een nieuwe waarde van dit type te definiëren of om te proberen een bestaande waarde naar dit type te wijzigen. |
| const [SVG_TURBULENCE_TYPE_FRACTALNOISE](../../aspose.svg.filters/svgfeturbulenceelement/svg_turbulence_type_fractalnoise/) | Komt overeen met waarde 'fractalNoise'. |
| const [SVG_TURBULENCE_TYPE_TURBULENCE](../../aspose.svg.filters/svgfeturbulenceelement/svg_turbulence_type_turbulence/) | Komt overeen met waarde 'turbulence'. |
| const [SVG_TURBULENCE_TYPE_UNKNOWN](../../aspose.svg.filters/svgfeturbulenceelement/svg_turbulence_type_unknown/) | Het type is niet een van de vooraf gedefinieerde types. Het is ongeldig om te proberen een nieuwe waarde van dit type te definiëren of om te proberen een bestaande waarde naar dit type te wijzigen. |
