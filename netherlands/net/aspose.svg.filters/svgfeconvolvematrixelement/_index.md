...
description: Aspose.Svg.Filters.SVGFEConvolveMatrixElement klas. De interface SVGFEConvolveMatrixElement komt overeen met het element feConvolveMatrix.
type: docs
weight: 1690
...
| [Bias](../../aspose.svg.filters/svgfeconvolvematrixelement/bias/) { get; } | Komt overeen met attribuut 'bias' op het gegeven 'feConvolveMatrix'-element. |
...
| [Divisor](../../aspose.svg.filters/svgfeconvolvematrixelement/divisor/) { get; } | Komt overeen met attribuut 'deler' op het gegeven 'feConvolveMatrix'-element. |
| [EdgeMode](../../aspose.svg.filters/svgfeconvolvematrixelement/edgemode/) { get; } | Komt overeen met attribuut 'edgeMode' op het gegeven 'feConvolveMatrix'-element. |
...
| [Height](../../aspose.svg.filters/svgfeconvolvematrixelement/height/) { get; } | Komt overeen met attribuut 'height' op het gegeven 'filter'-element. |
...
| [In1](../../aspose.svg.filters/svgfeconvolvematrixelement/in1/) { get; } | Komt overeen met attribuut 'in' op het gegeven 'feConvolveMatrix'-element. |
...
| [OrderX](../../aspose.svg.filters/svgfeconvolvematrixelement/orderx/) { get; } | Komt overeen met attribuut 'volgorde' op het gegeven 'feConvolveMatrix'-element. |
| [OrderY](../../aspose.svg.filters/svgfeconvolvematrixelement/ordery/) { get; } | Komt overeen met attribuut 'volgorde' op het gegeven 'feConvolveMatrix'-element. |
...
| [Result](../../aspose.svg.filters/svgfeconvolvematrixelement/result/) { get; } | Komt overeen met attribuut 'result' op het gegeven 'filter'-element. |
...
| [TargetX](../../aspose.svg.filters/svgfeconvolvematrixelement/targetx/) { get; } | Komt overeen met attribuut 'targetX' op het gegeven 'feConvolveMatrix'-element. |
| [TargetY](../../aspose.svg.filters/svgfeconvolvematrixelement/targety/) { get; } | Komt overeen met attribuut 'targetY' op het gegeven 'feConvolveMatrix'-element. |
...
| [Width](../../aspose.svg.filters/svgfeconvolvematrixelement/width/) { get; } | Komt overeen met attribuut 'width' op het gegeven 'filter'-element. |
| [X](../../aspose.svg.filters/svgfeconvolvematrixelement/x/) { get; } | Komt overeen met attribuut 'x' op het gegeven 'filter'-element. |
| [Y](../../aspose.svg.filters/svgfeconvolvematrixelement/y/) { get; } | Komt overeen met attribuut 'y' op het gegeven 'filter'-element. |
...
| Naam | Beschrijving |
| --- | --- |
| const [SVG_EDGEMODE_DUPLICATE](../../aspose.svg.filters/svgfeconvolvematrixelement/svg_edgemode_duplicate/) | Komt overeen met waarde 'dupliceren'. |
| const [SVG_EDGEMODE_NONE](../../aspose.svg.filters/svgfeconvolvematrixelement/svg_edgemode_none/) | Komt overeen met waarde 'geen'. |
| const [SVG_EDGEMODE_UNKNOWN](../../aspose.svg.filters/svgfeconvolvematrixelement/svg_edgemode_unknown/) | Het type is niet een van de vooraf gedefinieerde typen. Het is ongeldig om te proberen een nieuwe waarde van dit type te definiëren of om een bestaande waarde naar dit type om te schakelen. |
