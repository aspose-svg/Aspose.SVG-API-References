...
description: "Aspose.Svg.Filters.SVGFEConvolveMatrixElement class. De SVGFEConvolveMatrixElement interface komt overeen met het feConvolveMatrix-element"
type: docs
weight: 3780
url: /nl/net/aspose.svg.filters/svgfeconvolvematrixelement/
---
...
| [Bias](../../aspose.svg.filters/svgfeconvolvematrixelement/bias/) { get; } | Komt overeen met attribuut ‘bias’ op het opgegeven ‘feConvolveMatrix’-element. |
...
| [Divisor](../../aspose.svg.filters/svgfeconvolvematrixelement/divisor/) { get; } | Komt overeen met attribuut ‘divisor’ op het opgegeven ‘feConvolveMatrix’-element. |
| [EdgeMode](../../aspose.svg.filters/svgfeconvolvematrixelement/edgemode/) { get; } | Komt overeen met attribuut ‘edgeMode’ op het opgegeven ‘feConvolveMatrix’-element. |
...
| [Height](../../aspose.svg.filters/svgfeconvolvematrixelement/height/) { get; } | Komt overeen met attribuut ‘height’ op het opgegeven ‘filter’-element. |
...
| [In1](../../aspose.svg.filters/svgfeconvolvematrixelement/in1/) { get; } | Komt overeen met attribuut ‘in’ op het opgegeven ‘feConvolveMatrix’-element. |
...
| [KernelMatrix](../../aspose.svg.filters/svgfeconvolvematrixelement/kernelmatrix/) { get; } | Komt overeen met attribuut ‘kernelMatrix’ op het opgegeven ‘feConvolveMatrix’-element. |
| [KernelUnitLengthX](../../aspose.svg.filters/svgfeconvolvematrixelement/kernelunitlengthx/) { get; } | Komt overeen met attribuut ‘kernelUnitLength’ op het opgegeven ‘feConvolveMatrix’-element. |
| [KernelUnitLengthY](../../aspose.svg.filters/svgfeconvolvematrixelement/kernelunitlengthy/) { get; } | Komt overeen met attribuut ‘kernelUnitLength’ op het opgegeven ‘feConvolveMatrix’-element. |
...
| [OrderX](../../aspose.svg.filters/svgfeconvolvematrixelement/orderx/) { get; } | Komt overeen met attribuut ‘order’ op het opgegeven ‘feConvolveMatrix’-element. |
| [OrderY](../../aspose.svg.filters/svgfeconvolvematrixelement/ordery/) { get; } | Komt overeen met attribuut ‘order’ op het opgegeven ‘feConvolveMatrix’-element. |
...
| [PreserveAlpha](../../aspose.svg.filters/svgfeconvolvematrixelement/preservealpha/) { get; } | Komt overeen met attribuut ‘preserveAlpha’ op het opgegeven ‘feConvolveMatrix’-element. |
...
| [Result](../../aspose.svg.filters/svgfeconvolvematrixelement/result/) { get; } | Komt overeen met attribuut ‘result’ op het opgegeven ‘filter’-element. |
...
| [TargetX](../../aspose.svg.filters/svgfeconvolvematrixelement/targetx/) { get; } | Komt overeen met attribuut ‘targetX’ op het opgegeven ‘feConvolveMatrix’-element. |
| [TargetY](../../aspose.svg.filters/svgfeconvolvematrixelement/targety/) { get; } | Komt overeen met attribuut ‘targetY’ op het opgegeven ‘feConvolveMatrix’-element. |
...
| [Width](../../aspose.svg.filters/svgfeconvolvematrixelement/width/) { get; } | Komt overeen met attribuut ‘width’ op het opgegeven ‘filter’-element. |
| [X](../../aspose.svg.filters/svgfeconvolvematrixelement/x/) { get; } | Komt overeen met attribuut ‘x’ op het opgegeven ‘filter’-element. |
| [Y](../../aspose.svg.filters/svgfeconvolvematrixelement/y/) { get; } | Komt overeen met attribuut ‘y’ op het opgegeven ‘filter’-element. |
...
| Naam | Beschrijving |
| --- | --- |
| const [SVG_EDGEMODE_DUPLICATE](../../aspose.svg.filters/svgfeconvolvematrixelement/svg_edgemode_duplicate/) | Komt overeen met waarde 'duplicate'. |
| const [SVG_EDGEMODE_NONE](../../aspose.svg.filters/svgfeconvolvematrixelement/svg_edgemode_none/) | Komt overeen met waarde 'none'. |
| const [SVG_EDGEMODE_UNKNOWN](../../aspose.svg.filters/svgfeconvolvematrixelement/svg_edgemode_unknown/) | Het type is niet een van de vooraf gedefinieerde types. Het is ongeldig om te proberen een nieuwe waarde van dit type te definiëren of om te proberen een bestaande waarde naar dit type te wijzigen. |
| const [SVG_EDGEMODE_WRAP](../../aspose.svg.filters/svgfeconvolvematrixelement/svg_edgemode_wrap/) | Komt overeen met waarde 'wrap'. |
