...
description: Aspose.Svg.Filters.SVGFEGaussianBlurElement klas. De interface SVGFEGaussianBlurElement komt overeen met het element feGaussianBlur.
type: docs
weight: 1790
...
De interface SVGFEGaussianBlurElement komt overeen met het element �feGaussianBlur�.
...
| [Height](../../aspose.svg.filters/svgfegaussianblurelement/height/) { get; } | Komt overeen met attribuut �hoogte� op het gegeven �filter� element. |
...
| [In1](../../aspose.svg.filters/svgfegaussianblurelement/in1/) { get; } | Komt overeen met attribuut �in� op het gegeven �feGaussianBlur� element. |
...
| [Result](../../aspose.svg.filters/svgfegaussianblurelement/result/) { get; } | Komt overeen met attribuut �resultaat� op het gegeven �filter� element. |
...
| [StdDeviationX](../../aspose.svg.filters/svgfegaussianblurelement/stddeviationx/) { get; } | Komt overeen met attribuut �stdDeviation� op het gegeven �feGaussianBlur� element. Bevat de X-component van attribuut �stdDeviation�. |
| [StdDeviationY](../../aspose.svg.filters/svgfegaussianblurelement/stddeviationy/) { get; } | Komt overeen met attribuut �stdDeviation� op het gegeven �feGaussianBlur� element. Bevat de Y-component (mogelijk automatisch berekend) van attribuut �stdDeviation�. |
...
| [Width](../../aspose.svg.filters/svgfegaussianblurelement/width/) { get; } | Komt overeen met attribuut �width� op het gegeven �filter� element. |
| [X](../../aspose.svg.filters/svgfegaussianblurelement/x/) { get; } | Komt overeen met attribuut �x� op het gegeven �filter� element. |
| [Y](../../aspose.svg.filters/svgfegaussianblurelement/y/) { get; } | Komt overeen met attribuut �y� op het gegeven �filter� element. |
