...
description: Aspose.Svg.Filters.SVGFEDisplacementMapElement klas. De interface SVGFEDisplacementMapElement komt overeen met het element feDisplacementMap.
type: docs
weight: 1710
...
| [Height](../../aspose.svg.filters/svgfedisplacementmapelement/height/) { get; } | Komt overeen met attribuut 'height' op het gegeven 'filter'-element. |
...
| [In1](../../aspose.svg.filters/svgfedisplacementmapelement/in1/) { get; } | Komt overeen met attribuut 'in' op het gegeven 'feDisplacementMap'-element. |
| [In2](../../aspose.svg.filters/svgfedisplacementmapelement/in2/) { get; } | Komt overeen met attribuut 'in2' op het gegeven 'feDisplacementMap'-element. |
...
| [Result](../../aspose.svg.filters/svgfedisplacementmapelement/result/) { get; } | Komt overeen met attribuut 'result' op het gegeven 'filter'-element. |
| [Scale](../../aspose.svg.filters/svgfedisplacementmapelement/scale/) { get; } | Komt overeen met attribuut 'scale' op het gegeven 'feDisplacementMap'-element. |
...
| [Width](../../aspose.svg.filters/svgfedisplacementmapelement/width/) { get; } | Komt overeen met attribuut 'width' op het gegeven 'filter'-element. |
| [X](../../aspose.svg.filters/svgfedisplacementmapelement/x/) { get; } | Komt overeen met attribuut 'x' op het gegeven 'filter'-element. |
...
| [Y](../../aspose.svg.filters/svgfedisplacementmapelement/y/) { get; } | Komt overeen met attribuut 'y' op het gegeven 'filter'-element. |
...
| const [SVG_CHANNEL_UNKNOWN](../../aspose.svg.filters/svgfedisplacementmapelement/svg_channel_unknown/) | Het type is niet een van de vooraf gedefinieerde typen. Het is ongeldig om te proberen een nieuwe waarde van dit type te definiëren of om een bestaande waarde naar dit type om te schakelen. |
