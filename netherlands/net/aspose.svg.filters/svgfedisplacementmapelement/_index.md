...
description: "Aspose.Svg.Filters.SVGFEDisplacementMapElement klasse. De SVGFEDisplacementMapElement interface komt overeen met het feDisplacementMap-element."
type: docs
weight: 3800
url: /nl/net/aspose.svg.filters/svgfedisplacementmapelement/
---
...
| [Height](../../aspose.svg.filters/svgfedisplacementmapelement/height/) { get; } | Komt overeen met attribuut ‘height’ op het opgegeven ‘filter’-element. |
...
| [In1](../../aspose.svg.filters/svgfedisplacementmapelement/in1/) { get; } | Komt overeen met attribuut ‘in’ op het opgegeven ‘feDisplacementMap’-element. |
| [In2](../../aspose.svg.filters/svgfedisplacementmapelement/in2/) { get; } | Komt overeen met attribuut ‘in2’ op het opgegeven ‘feDisplacementMap’-element. |
...
| [Result](../../aspose.svg.filters/svgfedisplacementmapelement/result/) { get; } | Komt overeen met attribuut ‘result’ op het opgegeven ‘filter’-element. |
| [Scale](../../aspose.svg.filters/svgfedisplacementmapelement/scale/) { get; } | Komt overeen met attribuut ‘scale’ op het opgegeven ‘feDisplacementMap’-element. |
...
| [Width](../../aspose.svg.filters/svgfedisplacementmapelement/width/) { get; } | Komt overeen met attribuut ‘width’ op het opgegeven ‘filter’-element. |
| [X](../../aspose.svg.filters/svgfedisplacementmapelement/x/) { get; } | Komt overeen met attribuut ‘x’ op het opgegeven ‘filter’-element. |
| [XChannelSelector](../../aspose.svg.filters/svgfedisplacementmapelement/xchannelselector/) { get; } | Komt overeen met attribuut ‘xChannelSelector’ op het opgegeven ‘feDisplacementMap’-element. Neemt een van de SVG_CHANNEL_* constanten die op deze interface zijn gedefinieerd. |
| [Y](../../aspose.svg.filters/svgfedisplacementmapelement/y/) { get; } | Komt overeen met attribuut ‘y’ op het opgegeven ‘filter’-element. |
| [YChannelSelector](../../aspose.svg.filters/svgfedisplacementmapelement/ychannelselector/) { get; } | Komt overeen met attribuut ‘yChannelSelector’ op het opgegeven ‘feDisplacementMap’-element. Neemt een van de SVG_CHANNEL_* constanten die op deze interface zijn gedefinieerd. |
...
| Naam | Beschrijving |
| --- | --- |
| const [SVG_CHANNEL_A](../../aspose.svg.filters/svgfedisplacementmapelement/svg_channel_a/) | Komt overeen met waarde 'A'. |
| const [SVG_CHANNEL_B](../../aspose.svg.filters/svgfedisplacementmapelement/svg_channel_b/) | Komt overeen met waarde 'B'. |
| const [SVG_CHANNEL_G](../../aspose.svg.filters/svgfedisplacementmapelement/svg_channel_g/) | Komt overeen met waarde 'G'. |
| const [SVG_CHANNEL_R](../../aspose.svg.filters/svgfedisplacementmapelement/svg_channel_r/) | Komt overeen met waarde 'R'. |
| const [SVG_CHANNEL_UNKNOWN](../../aspose.svg.filters/svgfedisplacementmapelement/svg_channel_unknown/) | Het type is niet een van de vooraf gedefinieerde types. Het is ongeldig om te proberen een nieuwe waarde van dit type te definiëren of om te proberen een bestaande waarde naar dit type te wijzigen. |
