...
description: Aspose.Svg.Filters.SVGFEDiffuseLightingElement klas. De interface SVGFEDiffuseLightingElement komt overeen met het element feDiffuseLighting.
type: docs
weight: 1700
...
| [DiffuseConstant](../../aspose.svg.filters/svgfediffuselightingelement/diffuseconstant/) { get; } | Komt overeen met attribuut 'diffuseConstant' op het gegeven 'feDiffuseLighting' element. |
...
| [Height](../../aspose.svg.filters/svgfediffuselightingelement/height/) { get; } | Komt overeen met attribuut 'height' op het gegeven 'filter'-element. |
...
| [In1](../../aspose.svg.filters/svgfediffuselightingelement/in1/) { get; } | Komt overeen met attribuut 'in' op het gegeven 'feDiffuseLighting'-element. |
...
| [KernelUnitLengthX](../../aspose.svg.filters/svgfediffuselightingelement/kernelunitlengthx/) { get; } | Komt overeen met attribuut 'kernelUnitLength' op het gegeven 'feDiffuseLighting'-element. |
| [KernelUnitLengthY](../../aspose.svg.filters/svgfediffuselightingelement/kernelunitlengthy/) { get; } | Komt overeen met attribuut 'kernelUnitLength' op het gegeven 'feDiffuseLighting'-element. |
...
| [Result](../../aspose.svg.filters/svgfediffuselightingelement/result/) { get; } | Komt overeen met attribuut 'result' op het gegeven 'filter'-element. |
...
| [SurfaceScale](../../aspose.svg.filters/svgfediffuselightingelement/surfacescale/) { get; } | Komt overeen met attribuut 'surfaceScale' op het gegeven 'feDiffuseLighting'-element. |
...
| [Width](../../aspose.svg.filters/svgfediffuselightingelement/width/) { get; } | Komt overeen met attribuut 'width' op het gegeven 'filter'-element. |
| [X](../../aspose.svg.filters/svgfediffuselightingelement/x/) { get; } | Komt overeen met attribuut 'x' op het gegeven 'filter'-element. |
| [Y](../../aspose.svg.filters/svgfediffuselightingelement/y/) { get; } | Komt overeen met attribuut 'y' op het gegeven 'filter'-element. |
