...
description: Aspose.Svg.Filters.SVGFECompositeElement klas. De interface SVGFECompositeElement komt overeen met het element feComposite.
type: docs
weight: 1680
...
| [Height](../../aspose.svg.filters/svgfecompositeelement/height/) { get; } | Komt overeen met attribuut 'height' op het gegeven 'filter'-element. |
...
| [In1](../../aspose.svg.filters/svgfecompositeelement/in1/) { get; } | Komt overeen met attribuut 'in' op het gegeven 'feComposite' element. |
| [In2](../../aspose.svg.filters/svgfecompositeelement/in2/) { get; } | Komt overeen met attribuut 'in2' op het gegeven 'feComposite' element. |
...
| [K1](../../aspose.svg.filters/svgfecompositeelement/k1/) { get; } | Komt overeen met attribuut 'k1' op het gegeven 'feComposite' element. |
| [K2](../../aspose.svg.filters/svgfecompositeelement/k2/) { get; } | Komt overeen met attribuut 'k2' op het gegeven 'feComposite' element. |
...
| [Operator](../../aspose.svg.filters/svgfecompositeelement/operator/) { get; } | Komt overeen met attribuut 'operator' op het gegeven 'feComposite' element. Neemt een van de SVG_FECOMPOSITE_OPERATOR_*-constanten die op deze interface zijn gedefinieerd. |
...
| [Result](../../aspose.svg.filters/svgfecompositeelement/result/) { get; } | Komt overeen met attribuut 'result' op het gegeven 'filter'-element. |
...
| [Width](../../aspose.svg.filters/svgfecompositeelement/width/) { get; } | Komt overeen met attribuut 'width' op het gegeven 'filter'-element. |
| [X](../../aspose.svg.filters/svgfecompositeelement/x/) { get; } | Komt overeen met attribuut 'x' op het gegeven 'filter'-element. |
| [Y](../../aspose.svg.filters/svgfecompositeelement/y/) { get; } | Komt overeen met attribuut 'y' op het gegeven 'filter'-element. |
...
| Naam | Beschrijving |
| --- | --- |
| const [SVG_FECOMPOSITE_OPERATOR_ARITHMETIC](../../aspose.svg.filters/svgfecompositeelement/svg_fecomposite_operator_arithmetic/) | Komt overeen met waarde 'rekenkundig'. |
| const [SVG_FECOMPOSITE_OPERATOR_ATOP](../../aspose.svg.filters/svgfecompositeelement/svg_fecomposite_operator_atop/) | Komt overeen met waarde 'bovenop'. |
...
| const [SVG_FECOMPOSITE_OPERATOR_OUT](../../aspose.svg.filters/svgfecompositeelement/svg_fecomposite_operator_out/) | Komt overeen met waarde 'uit'. |
...
| const [SVG_FECOMPOSITE_OPERATOR_UNKNOWN](../../aspose.svg.filters/svgfecompositeelement/svg_fecomposite_operator_unknown/) | Het type is niet een van de vooraf gedefinieerde typen. Het is ongeldig om te proberen een nieuwe waarde van dit type te definiëren of om een bestaande waarde naar dit type om te schakelen. |
