...
description: "Aspose.Svg.Filters.SVGFECompositeElement klasse. De SVGFECompositeElement interface komt overeen met het feComposite-element."
type: docs
weight: 3770
url: /nl/net/aspose.svg.filters/svgfecompositeelement/
---
...
| [Height](../../aspose.svg.filters/svgfecompositeelement/height/) { get; } | Komt overeen met attribuut ‘height’ op het opgegeven ‘filter’-element. |
...
| [In1](../../aspose.svg.filters/svgfecompositeelement/in1/) { get; } | Komt overeen met attribuut ‘in’ op het opgegeven ‘feComposite’-element. |
| [In2](../../aspose.svg.filters/svgfecompositeelement/in2/) { get; } | Komt overeen met attribuut ‘in2’ op het opgegeven ‘feComposite’-element. |
...
| [K1](../../aspose.svg.filters/svgfecompositeelement/k1/) { get; } | Komt overeen met attribuut ‘k1’ op het opgegeven ‘feComposite’-element. |
| [K2](../../aspose.svg.filters/svgfecompositeelement/k2/) { get; } | Komt overeen met attribuut ‘k2’ op het opgegeven ‘feComposite’-element. |
| [K3](../../aspose.svg.filters/svgfecompositeelement/k3/) { get; } | Komt overeen met attribuut ‘k3’ op het opgegeven ‘feComposite’-element. |
| [K4](../../aspose.svg.filters/svgfecompositeelement/k4/) { get; } | Komt overeen met attribuut ‘k4’ op het opgegeven ‘feComposite’-element. |
...
| [Operator](../../aspose.svg.filters/svgfecompositeelement/operator/) { get; } | Komt overeen met attribuut ‘operator’ op het opgegeven ‘feComposite’-element. Neemt een van de SVG_FECOMPOSITE_OPERATOR_* constanten die op deze interface zijn gedefinieerd. |
...
| [Result](../../aspose.svg.filters/svgfecompositeelement/result/) { get; } | Komt overeen met attribuut ‘result’ op het opgegeven ‘filter’-element. |
...
| [Width](../../aspose.svg.filters/svgfecompositeelement/width/) { get; } | Komt overeen met attribuut ‘width’ op het opgegeven ‘filter’-element. |
| [X](../../aspose.svg.filters/svgfecompositeelement/x/) { get; } | Komt overeen met attribuut ‘x’ op het opgegeven ‘filter’-element. |
| [Y](../../aspose.svg.filters/svgfecompositeelement/y/) { get; } | Komt overeen met attribuut ‘y’ op het opgegeven ‘filter’-element. |
...
| Naam | Beschrijving |
| --- | --- |
| const [SVG_FECOMPOSITE_OPERATOR_ARITHMETIC](../../aspose.svg.filters/svgfecompositeelement/svg_fecomposite_operator_arithmetic/) | Komt overeen met waarde 'arithmetic'. |
| const [SVG_FECOMPOSITE_OPERATOR_ATOP](../../aspose.svg.filters/svgfecompositeelement/svg_fecomposite_operator_atop/) | Komt overeen met waarde 'atop'. |
| const [SVG_FECOMPOSITE_OPERATOR_IN](../../aspose.svg.filters/svgfecompositeelement/svg_fecomposite_operator_in/) | Komt overeen met waarde 'in'. |
| const [SVG_FECOMPOSITE_OPERATOR_OUT](../../aspose.svg.filters/svgfecompositeelement/svg_fecomposite_operator_out/) | Komt overeen met waarde 'out'. |
| const [SVG_FECOMPOSITE_OPERATOR_OVER](../../aspose.svg.filters/svgfecompositeelement/svg_fecomposite_operator_over/) | Komt overeen met waarde 'over'. |
| const [SVG_FECOMPOSITE_OPERATOR_UNKNOWN](../../aspose.svg.filters/svgfecompositeelement/svg_fecomposite_operator_unknown/) | Het type is niet een van de vooraf gedefinieerde types. Het is ongeldig om te proberen een nieuwe waarde van dit type te definiëren of om te proberen een bestaande waarde naar dit type te wijzigen. |
| const [SVG_FECOMPOSITE_OPERATOR_XOR](../../aspose.svg.filters/svgfecompositeelement/svg_fecomposite_operator_xor/) | Komt overeen met waarde 'xor'. |
