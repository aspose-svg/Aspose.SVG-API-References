...
description: Aspose.Svg.Filters.SVGFEBlendElement klas. De interface SVGFEBlendElement komt overeen met het element feBlend.
type: docs
weight: 1650
...
| [Height](../../aspose.svg.filters/svgfeblendelement/height/) { get; } | Komt overeen met attribuut 'height' op het gegeven 'filter'-element. |
...
| [In1](../../aspose.svg.filters/svgfeblendelement/in1/) { get; } | Komt overeen met attribuut 'in' op het gegeven 'feBlend' element. |
| [In2](../../aspose.svg.filters/svgfeblendelement/in2/) { get; } | Komt overeen met attribuut 'in2' op het gegeven 'feBlend' element. |
...
| [Mode](../../aspose.svg.filters/svgfeblendelement/mode/) { get; } | Komt overeen met attribuut 'mode' op het gegeven 'feBlend' element. Neemt een van de SVG_FEBLEND_MODE_*-constanten die in deze interface zijn gedefinieerd. |
...
| [Result](../../aspose.svg.filters/svgfeblendelement/result/) { get; } | Komt overeen met attribuut 'result' op het gegeven 'filter'-element. |
...
| [Width](../../aspose.svg.filters/svgfeblendelement/width/) { get; } | Komt overeen met attribuut 'width' op het gegeven 'filter'-element. |
| [X](../../aspose.svg.filters/svgfeblendelement/x/) { get; } | Komt overeen met attribuut 'x' op het gegeven 'filter'-element. |
| [Y](../../aspose.svg.filters/svgfeblendelement/y/) { get; } | Komt overeen met attribuut 'y' op het gegeven 'filter'-element. |
...
| Naam | Beschrijving |
| --- | --- |
| const [SVG_FEBLEND_MODE_COLOR](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_color/) | Komt overeen met waarde 'kleur'. |
...
| const [SVG_FEBLEND_MODE_DARKEN](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_darken/) | Komt overeen met de waarde 'donkerder maken'. |
| const [SVG_FEBLEND_MODE_DIFFERENCE](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_difference/) | Komt overeen met waarde 'verschil'. |
| const [SVG_FEBLEND_MODE_EXCLUSION](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_exclusion/) | Komt overeen met waarde 'uitsluiting'. |
...
| const [SVG_FEBLEND_MODE_HUE](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_hue/) | Komt overeen met waarde 'tint'. |
...
| const [SVG_FEBLEND_MODE_LUMINOSITY](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_luminosity/) | Komt overeen met de waarde 'helderheid'. |
| const [SVG_FEBLEND_MODE_MULTIPLY](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_multiply/) | Komt overeen met waarde 'vermenigvuldigen'. |
| const [SVG_FEBLEND_MODE_NORMAL](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_normal/) | Komt overeen met waarde 'normaal'. |
...
| const [SVG_FEBLEND_MODE_SATURATION](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_saturation/) | Komt overeen met waarde 'verzadiging'. |
| const [SVG_FEBLEND_MODE_SCREEN](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_screen/) | Komt overeen met waarde 'scherm'. |
...
| const [SVG_FEBLEND_MODE_UNKNOWN](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_unknown/) | Het type is niet een van de vooraf gedefinieerde typen. Het is ongeldig om te proberen een nieuwe waarde van dit type te definiëren of om een bestaande waarde naar dit type om te schakelen. |
...
* naamruimte [Aspose.Svg.Filters](../../aspose.svg.filters/)
* montage [Aspose.SVG](../../)
