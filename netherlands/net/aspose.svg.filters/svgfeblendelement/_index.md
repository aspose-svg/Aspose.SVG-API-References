...
description: "Aspose.Svg.Filters.SVGFEBlendElement class. De SVGFEBlendElement interface komt overeen met het feBlend-element"
type: docs
weight: 3740
url: /nl/net/aspose.svg.filters/svgfeblendelement/
---
...
| [Height](../../aspose.svg.filters/svgfeblendelement/height/) { get; } | Komt overeen met attribuut ‘height’ op het opgegeven ‘filter’-element. |
...
| [In1](../../aspose.svg.filters/svgfeblendelement/in1/) { get; } | Komt overeen met attribuut ‘in’ op het opgegeven ‘feBlend’-element. |
| [In2](../../aspose.svg.filters/svgfeblendelement/in2/) { get; } | Komt overeen met attribuut ‘in2’ op het opgegeven ‘feBlend’-element. |
...
| [Mode](../../aspose.svg.filters/svgfeblendelement/mode/) { get; } | Komt overeen met attribuut ‘mode’ op het opgegeven ‘feBlend’-element. Neemt een van de SVG_FEBLEND_MODE_* constanten die op deze interface zijn gedefinieerd. |
...
| [Result](../../aspose.svg.filters/svgfeblendelement/result/) { get; } | Komt overeen met attribuut ‘result’ op het opgegeven ‘filter’-element. |
...
| [Width](../../aspose.svg.filters/svgfeblendelement/width/) { get; } | Komt overeen met attribuut ‘width’ op het opgegeven ‘filter’-element. |
| [X](../../aspose.svg.filters/svgfeblendelement/x/) { get; } | Komt overeen met attribuut ‘x’ op het opgegeven ‘filter’-element. |
| [Y](../../aspose.svg.filters/svgfeblendelement/y/) { get; } | Komt overeen met attribuut ‘y’ op het opgegeven ‘filter’-element. |
...
| Naam | Beschrijving |
| --- | --- |
| const [SVG_FEBLEND_MODE_COLOR](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_color/) | Komt overeen met waarde 'color'. |
| const [SVG_FEBLEND_MODE_COLOR_BURN](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_color_burn/) | Komt overeen met waarde 'color_burn'. |
| const [SVG_FEBLEND_MODE_COLOR_DODGE](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_color_dodge/) | Komt overeen met waarde 'color_dodge'. |
| const [SVG_FEBLEND_MODE_DARKEN](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_darken/) | Komt overeen met waarde 'darken'. |
| const [SVG_FEBLEND_MODE_DIFFERENCE](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_difference/) | Komt overeen met waarde 'difference'. |
| const [SVG_FEBLEND_MODE_EXCLUSION](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_exclusion/) | Komt overeen met waarde 'exclusion'. |
| const [SVG_FEBLEND_MODE_HARD_LIGHT](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_hard_light/) | Komt overeen met waarde 'hard_light'. |
| const [SVG_FEBLEND_MODE_HUE](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_hue/) | Komt overeen met waarde 'hue'. |
| const [SVG_FEBLEND_MODE_LIGHTEN](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_lighten/) | Komt overeen met waarde 'lighten'. |
| const [SVG_FEBLEND_MODE_LUMINOSITY](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_luminosity/) | Komt overeen met waarde 'luminosity'. |
| const [SVG_FEBLEND_MODE_MULTIPLY](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_multiply/) | Komt overeen met waarde 'multiply'. |
| const [SVG_FEBLEND_MODE_NORMAL](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_normal/) | Komt overeen met waarde 'normal'. |
| const [SVG_FEBLEND_MODE_OVERLAY](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_overlay/) | Komt overeen met waarde 'overlay'. |
| const [SVG_FEBLEND_MODE_SATURATION](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_saturation/) | Komt overeen met waarde 'saturation'. |
| const [SVG_FEBLEND_MODE_SCREEN](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_screen/) | Komt overeen met waarde 'screen'. |
| const [SVG_FEBLEND_MODE_SOFT_LIGHT](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_soft_light/) | Komt overeen met waarde 'soft_light'. |
| const [SVG_FEBLEND_MODE_UNKNOWN](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_unknown/) | Het type is niet een van de vooraf gedefinieerde types. Het is ongeldig om te proberen een nieuwe waarde van dit type te definiëren of om te proberen een bestaande waarde naar dit type te wijzigen. |
