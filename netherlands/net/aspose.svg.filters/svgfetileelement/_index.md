...
description: Aspose.Svg.Filters.SVGFETileElement klas. De SVGFETileElementinterface komt overeen met het feTileelement.
type: docs
weight: 1880
...
| [Height](../../aspose.svg.filters/svgfetileelement/height/) { get; } | Komt overeen met attribuut 'height' op het gegeven 'filter'-element. |
...
| [In1](../../aspose.svg.filters/svgfetileelement/in1/) { get; } | Komt overeen met attribuut 'in' op het gegeven 'feTile' element. |
...
| [Result](../../aspose.svg.filters/svgfetileelement/result/) { get; } | Komt overeen met attribuut 'result' op het gegeven 'filter'-element. |
...
| [Width](../../aspose.svg.filters/svgfetileelement/width/) { get; } | Komt overeen met attribuut 'width' op het gegeven 'filter'-element. |
| [X](../../aspose.svg.filters/svgfetileelement/x/) { get; } | Komt overeen met attribuut 'x' op het gegeven 'filter'-element. |
| [Y](../../aspose.svg.filters/svgfetileelement/y/) { get; } | Komt overeen met attribuut 'y' op het gegeven 'filter'-element. |
