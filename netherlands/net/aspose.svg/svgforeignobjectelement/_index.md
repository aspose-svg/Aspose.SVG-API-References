...
description: Aspose.Svg.SVGForeignObjectElement klas. De interface SVGForeignObjectElement komt overeen met het element foreignObject.
type: docs
weight: 3250
...
| [Height](../../aspose.svg/svgforeignobjectelement/height/) { get; } | Komt overeen met attribuut 'height' op het opgegeven 'foreignObject'-element. |
...
| [Width](../../aspose.svg/svgforeignobjectelement/width/) { get; } | Komt overeen met attribuut 'width' op het opgegeven 'foreignObject'-element. |
| [X](../../aspose.svg/svgforeignobjectelement/x/) { get; } | Komt overeen met attribuut 'x' op het opgegeven 'foreignObject'-element. |
| [Y](../../aspose.svg/svgforeignobjectelement/y/) { get; } | Komt overeen met attribuut 'y' op het opgegeven 'foreignObject'-element. |
