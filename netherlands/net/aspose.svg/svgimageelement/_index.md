...
description: Aspose.Svg.SVGImageElement klas. De interface SVGImageElement komt overeen met het element image.
type: docs
weight: 3300
...
| [Height](../../aspose.svg/svgimageelement/height/) { get; } | Komt overeen met attribuut 'height' op het gegeven 'image' element. |
| [Href](../../aspose.svg/svgimageelement/href/) { get; } | Komt overeen met attribuut 'xlink:href' op het gegeven element. |
...
| [Width](../../aspose.svg/svgimageelement/width/) { get; } | Komt overeen met attribuut 'width' op het gegeven 'image'-element. |
| [X](../../aspose.svg/svgimageelement/x/) { get; } | Komt overeen met attribuut 'x' op het gegeven 'image'-element. |
| [Y](../../aspose.svg/svgimageelement/y/) { get; } | Komt overeen met attribuut 'y' op het gegeven 'image'-element. |
