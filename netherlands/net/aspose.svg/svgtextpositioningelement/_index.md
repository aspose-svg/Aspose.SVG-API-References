...
description: Aspose.Svg.SVGTextPositioningElement klas. De SVGTextPositioningElementinterface wordt overgenomen door tekstgerelateerde interfaces SVGTextElement SVGTSpanElement SVGTRefElement en SVGAltGlyphElement.
type: docs
weight: 3550
...
| [Dx](../../aspose.svg/svgtextpositioningelement/dx/) { get; } | Komt overeen met attribuut 'dx' op het gegeven element. |
| [Dy](../../aspose.svg/svgtextpositioningelement/dy/) { get; } | Komt overeen met attribuut 'dy' op het gegeven element. |
...
| [Rotate](../../aspose.svg/svgtextpositioningelement/rotate/) { get; } | Komt overeen met attribuut 'draaien' op het gegeven element. |
...
| [X](../../aspose.svg/svgtextpositioningelement/x/) { get; } | Komt overeen met attribuut 'x' op het gegeven element. |
| [Y](../../aspose.svg/svgtextpositioningelement/y/) { get; } | Komt overeen met attribuut 'y' op het gegeven element. |
