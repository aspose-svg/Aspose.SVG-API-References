...
description: "Aspose.Svg.SVGElementInstance klasse. Het rootobject van elke use-element schaduwbomen implementeert de SVGUseElementShadowRoot interface. Deze interface definieert momenteel geen uitbreidingen op de eigenschappen en methoden die zijn gedefinieerd voor de ShadowRoot interface en de DocumentOrShadowRoot mixin. Echter is de boom die op dit knooppunt is geworteld volledig alleen-lezen vanuit het perspectief van auteurscripts."
type: docs
weight: 5280
url: /nl/net/aspose.svg/svgelementinstance/
---
...
| [ChildElementCount](../../aspose.svg.dom/documentfragment/childelementcount/) { get; } | Geeft het huidige aantal elementknooppunten terug die kinderen zijn van dit element. 0 als dit element geen kindknooppunten heeft van nodeType 1. |
...
| [Children](../../aspose.svg.dom/documentfragment/children/) { get; } | Retourneert de kindelementen van het huidige element. |
...
| [FirstElementChild](../../aspose.svg.dom/documentfragment/firstelementchild/) { get; } | Geeft het eerste kind‑elementknooppunt van dit element terug. null als dit element geen kind‑elementen heeft. |
| [Host](../../aspose.svg.dom/shadowroot/host/) { get; } | Host is een element dat deze ShadowRoot bevat. |
| [InnerHTML](../../aspose.svg.dom/documentfragment/innerhtml/) { get; set; } | Retourneert een fragment van HTML of XML dat de inhoud van het element weergeeft. Kan worden ingesteld om de inhoud van het element te vervangen door knooppunten die uit de opgegeven tekenreeks zijn geparseerd. |
...
| [LastElementChild](../../aspose.svg.dom/documentfragment/lastelementchild/) { get; } | Retourneert het laatste kind-elementknooppunt van dit element. null als dit element geen kindelementen heeft. |
...
| [Mode](../../aspose.svg.dom/shadowroot/mode/) { get; } | Modus waarin deze ShadowRoot opereert. |
...
| [NextElementSibling](../../aspose.svg.dom/documentfragment/nextelementsibling/) { get; } | Retourneert het volgende sibling‑elementknooppunt van dit element. null als dit element geen element‑sibling‑knooppunten heeft die na dit knooppunt in de documentboom komen. |
...
| [OuterHTML](../../aspose.svg.dom/documentfragment/outerhtml/) { get; set; } | Retourneert een fragment van HTML of XML dat het element en de inhoud ervan weergeeft. Kan worden ingesteld om het element te vervangen door knooppunten die uit de opgegeven tekenreeks zijn geparseerd. |
...
| [PreviousElementSibling](../../aspose.svg.dom/documentfragment/previouselementsibling/) { get; } | Retourneert het vorige sibling‑elementknooppunt van dit element. null als dit element geen element‑sibling‑knooppunten heeft die vóór dit knooppunt in de documentboom komen. |
...
| [QuerySelector](../../aspose.svg.dom/documentfragment/queryselector/)(*string*) | Retourneert het eerste Element in het document dat aan de selector voldoet |
| [QuerySelectorAll](../../aspose.svg.dom/documentfragment/queryselectorall/)(*string*) | Retourneert een NodeList van alle Elements in het document die aan de selector voldoen |
