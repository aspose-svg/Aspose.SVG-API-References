...
description: "Aspose.Svg.SVGViewElement klasse. De SVGViewElement interface komt overeen met het view element."
type: docs
weight: 5660
url: /nl/net/aspose.svg/svgviewelement/
---
...
| [PreserveAspectRatio](../../aspose.svg/svgviewelement/preserveaspectratio/) { get; } | Komt overeen met het attribuut ‘preserveAspectRatio’ op het opgegeven element. |
...
| [ViewBox](../../aspose.svg/svgviewelement/viewbox/) { get; } | Komt overeen met het attribuut ‘viewBox’ op het opgegeven element. |
...
| [ViewTarget](../../aspose.svg/svgviewelement/viewtarget/) { get; } | Komt overeen met attribuut ‘viewTarget’ op het opgegeven ‘view’ element. Een lijst van DOMString-waarden die de namen bevatten die in het ‘viewTarget’ attribuut zijn opgesomd. Elke DOMString-waarde kan worden geassocieerd met het overeenkomstige element via de getElementById()-methodeaanroep. |
| [ZoomAndPan](../../aspose.svg/svgviewelement/zoomandpan/) { get; set; } | Komt overeen met het attribuut ‘zoomAndPan’ op het opgegeven element. De waarde moet een van de SVG_ZOOMANDPAN_*‑constanten zijn die op deze interface zijn gedefinieerd. |
