...
description: Aspose.Svg.SVGMaskElement klas. De SVGMaskElementinterface komt overeen met het maskerelement.
type: docs
weight: 3350
...
| [Height](../../aspose.svg/svgmaskelement/height/) { get; } | Komt overeen met attribuut 'height' op het gegeven 'mask' element. Neemt een van de constanten die zijn gedefinieerd in SVGUnitTypes. |
...
| [MaskUnits](../../aspose.svg/svgmaskelement/maskunits/) { get; } | Komt overeen met attribuut 'maskUnits' op het gegeven 'mask' element. Neemt een van de constanten die zijn gedefinieerd in SVGUnitTypes. |
...
| [RequiredExtensions](../../aspose.svg/svgmaskelement/requiredextensions/) { get; } | Komt overeen met attribuut 'requiredExtensions' op het gegeven element. |
| [RequiredFeatures](../../aspose.svg/svgmaskelement/requiredfeatures/) { get; } | Komt overeen met attribuut 'requiredFeatures' op het gegeven element. |
...
| [SystemLanguage](../../aspose.svg/svgmaskelement/systemlanguage/) { get; } | Komt overeen met attribuut 'systemLanguage' op het gegeven element. |
...
| [Width](../../aspose.svg/svgmaskelement/width/) { get; } | Komt overeen met attribuut 'width' op het gegeven 'mask' element. Neemt een van de constanten die zijn gedefinieerd in SVGUnitTypes. |
| [X](../../aspose.svg/svgmaskelement/x/) { get; } | Komt overeen met attribuut 'x' op het gegeven 'mask'-element. Neemt een van de constanten die zijn gedefinieerd in SVGUnitTypes. |
| [Y](../../aspose.svg/svgmaskelement/y/) { get; } | Komt overeen met attribuut 'y' op het gegeven 'mask'-element. Neemt een van de constanten die zijn gedefinieerd in SVGUnitTypes. |
