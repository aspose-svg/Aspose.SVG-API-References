...
description: Aspose.Svg.SVGGradientElement klas. De SVGGradientElementinterface is een basisinterface die wordt gebruikt door SVGLinearGradientElement en SVGRadialGradientElement.
type: docs
weight: 3280
...
| Naam | Beschrijving |
| --- | --- |
| const [SVG_SPREADMETHOD_PAD](../../aspose.svg/svggradientelement/svg_spreadmethod_pad/) | Komt overeen met waarde 'pad'. |
| const [SVG_SPREADMETHOD_REFLECT](../../aspose.svg/svggradientelement/svg_spreadmethod_reflect/) | Komt overeen met waarde 'reflect'. |
| const [SVG_SPREADMETHOD_REPEAT](../../aspose.svg/svggradientelement/svg_spreadmethod_repeat/) | Komt overeen met waarde 'herhalen'. |
| const [SVG_SPREADMETHOD_UNKNOWN](../../aspose.svg/svggradientelement/svg_spreadmethod_unknown/) | Het type is niet een van de vooraf gedefinieerde typen. Het is ongeldig om te proberen een nieuwe waarde van dit type te definiëren of om een bestaande waarde naar dit type om te schakelen. |
