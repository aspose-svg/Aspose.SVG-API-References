...
description: "Aspose.Svg.SVGGradientElement klasse. De SVGGradientElement interface is een basisinterface die wordt gebruikt door SVGLinearGradientElement en SVGRadialGradientElement."
type: docs
weight: 5350
url: /nl/net/aspose.svg/svggradientelement/
---
...
| Naam | Beschrijving |
| --- | --- |
| const [SVG_SPREADMETHOD_PAD](../../aspose.svg/svggradientelement/svg_spreadmethod_pad/) | Komt overeen met de waarde 'pad'. |
| const [SVG_SPREADMETHOD_REFLECT](../../aspose.svg/svggradientelement/svg_spreadmethod_reflect/) | Komt overeen met de waarde 'reflect'. |
| const [SVG_SPREADMETHOD_REPEAT](../../aspose.svg/svggradientelement/svg_spreadmethod_repeat/) | Komt overeen met de waarde 'repeat'. |
| const [SVG_SPREADMETHOD_UNKNOWN](../../aspose.svg/svggradientelement/svg_spreadmethod_unknown/) | Het type is niet een van de vooraf gedefinieerde types. Het is ongeldig om te proberen een nieuwe waarde van dit type te definiëren of om te proberen een bestaande waarde naar dit type te wijzigen. |
