...
description: "Aspose.Svg.SVGRectElement klasse. De SVGRectElement interface komt overeen met het rect-element."
type: docs
weight: 5490
url: /nl/net/aspose.svg/svgrectelement/
---
...
| [Height](../../aspose.svg/svgrectelement/height/) { get; } | Komt overeen met attribuut ‘height’ op het opgegeven ‘rect’-element. |
...
| [PathLength](../../aspose.svg/svggeometryelement/pathlength/) { get; } | Komt overeen met het attribuut pathLength op het opgegeven element. |
...
| [Rx](../../aspose.svg/svgrectelement/rx/) { get; } | Komt overeen met attribuut ‘rx’ op het opgegeven ‘rect’-element. |
| [Ry](../../aspose.svg/svgrectelement/ry/) { get; } | Komt overeen met attribuut ‘ry’ op het opgegeven ‘rect’-element. |
...
| [Width](../../aspose.svg/svgrectelement/width/) { get; } | Komt overeen met attribuut ‘width’ op het opgegeven ‘rect’-element. |
| [X](../../aspose.svg/svgrectelement/x/) { get; } | Komt overeen met attribuut ‘x’ op het opgegeven ‘rect’-element. |
| [Y](../../aspose.svg/svgrectelement/y/) { get; } | Komt overeen met attribuut ‘y’ op het opgegeven ‘rect’-element. |
...
| [Combine](../../aspose.svg/svggeometryelement/combine/)(*[SVGGeometryElement](../svggeometryelement/), [BooleanPathOp](../../aspose.svg.rendering/booleanpathop/)*) | Combineert deze geometrie met een andere SVG-geometrie met behulp van een booleaanse bewerking, en retourneert een nieuw `<path>`-element dat het resultaat bevat. |
...
| [GetEquivalentPath](../../aspose.svg/svggeometryelement/getequivalentpath/)() | Retourneert een nieuw exemplaar van de [`SVGPathSegList`](../../aspose.svg.paths/svgpathseglist/) die [`SVGGeometryElement`](../svggeometryelement/) als padsegmenten weergeeft. |
...
| [GetPointAtLength](../../aspose.svg/svggeometryelement/getpointatlength/)(*float*) | Retourneert de (x,y)-coördinaat in de gebruikersruimte die afstandseenheden langs het pad aangeeft, met gebruik van het distance-along-a-path-algoritme van de user agent. |
...
| [GetTotalLength](../../aspose.svg/svggeometryelement/gettotallength/)() | Retourneert de door de user agent berekende waarde voor de totale lengte van het pad met behulp van het distance-along-a-path-algoritme van de user agent, als een afstand in het huidige gebruikerscoördinatensysteem. |
