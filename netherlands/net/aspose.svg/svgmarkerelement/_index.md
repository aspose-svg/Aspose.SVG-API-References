...
description: "Aspose.Svg.SVGMarkerElement klasse. De SVGMarkerElement interface komt overeen met het marker-element."
type: docs
weight: 5410
url: /nl/net/aspose.svg/svgmarkerelement/
---
...
| [MarkerHeight](../../aspose.svg/svgmarkerelement/markerheight/) { get; } | Komt overeen met het attribuut ‘markerHeight’ op het opgegeven ‘marker’-element. |
| [MarkerUnits](../../aspose.svg/svgmarkerelement/markerunits/) { get; } | Komt overeen met het attribuut ‘markerUnits’ op het opgegeven ‘marker’-element. Een van de Marker Unit Types die op deze interface zijn gedefinieerd. |
| [MarkerWidth](../../aspose.svg/svgmarkerelement/markerwidth/) { get; } | Komt overeen met het attribuut ‘markerWidth’ op het opgegeven ‘marker’-element. |
...
| [OrientAngle](../../aspose.svg/svgmarkerelement/orientangle/) { get; } | Komt overeen met het attribuut ‘orient’ op het opgegeven ‘marker’-element. Als markerUnits gelijk is aan SVG_MARKER_ORIENT_ANGLE, dan is de hoekwaarde voor het attribuut ‘orient’; anders wordt deze op nul gezet. |
| [OrientType](../../aspose.svg/svgmarkerelement/orienttype/) { get; } | Komt overeen met het attribuut ‘orient’ op het opgegeven ‘marker’-element. Een van de Marker Orientation Types die op deze interface zijn gedefinieerd. |
...
| [PreserveAspectRatio](../../aspose.svg/svgmarkerelement/preserveaspectratio/) { get; } | Komt overeen met het attribuut ‘preserveAspectRatio’ op het opgegeven element. |
...
| [RefX](../../aspose.svg/svgmarkerelement/refx/) { get; } | Komt overeen met het attribuut ‘refX’ op het opgegeven ‘marker’-element. |
| [RefY](../../aspose.svg/svgmarkerelement/refy/) { get; } | Komt overeen met het attribuut ‘refY’ op het opgegeven ‘marker’-element. |
...
| [ViewBox](../../aspose.svg/svgmarkerelement/viewbox/) { get; } | Komt overeen met het attribuut ‘viewBox’ op het opgegeven element. |
...
| [SetOrientToAngle](../../aspose.svg/svgmarkerelement/setorienttoangle/)(*[SVGAngle](../../aspose.svg.datatypes/svgangle/)*) | Stelt de waarde van het attribuut ‘orient’ in op de opgegeven hoek. |
| [SetOrientToAuto](../../aspose.svg/svgmarkerelement/setorienttoauto/)() | Stelt de waarde van het attribuut ‘orient’ in op 'auto'. |
...
| Naam | Beschrijving |
| --- | --- |
| const [SVG_MARKERUNITS_STROKEWIDTH](../../aspose.svg/svgmarkerelement/svg_markerunits_strokewidth/) | De waarde van het attribuut ‘markerUnits’ is 'strokeWidth'. |
| const [SVG_MARKERUNITS_UNKNOWN](../../aspose.svg/svgmarkerelement/svg_markerunits_unknown/) | Het type marker-eenheid is geen van de vooraf gedefinieerde types. Het is ongeldig om te proberen een nieuwe waarde van dit type te definiëren of om te proberen een bestaande waarde naar dit type te wijzigen. |
| const [SVG_MARKERUNITS_USERSPACEONUSE](../../aspose.svg/svgmarkerelement/svg_markerunits_userspaceonuse/) | De waarde van attribuut ‘markerUnits’ is 'userSpaceOnUse'. |
| const [SVG_MARKER_ORIENT_ANGLE](../../aspose.svg/svgmarkerelement/svg_marker_orient_angle/) | Attribuut ‘orient’ heeft een hoekwaarde. |
| const [SVG_MARKER_ORIENT_AUTO](../../aspose.svg/svgmarkerelement/svg_marker_orient_auto/) | Attribuut ‘orient’ heeft de waarde 'auto'. |
| const [SVG_MARKER_ORIENT_UNKNOWN](../../aspose.svg/svgmarkerelement/svg_marker_orient_unknown/) | De markeroriëntatie is geen van de vooraf gedefinieerde types. Het is ongeldig om te proberen een nieuwe waarde van dit type te definiëren of om te proberen een bestaande waarde naar dit type te wijzigen. |
