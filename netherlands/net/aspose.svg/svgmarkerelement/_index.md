...
description: Aspose.Svg.SVGMarkerElement klas. De SVGMarkerElementinterface komt overeen met het markerelement.
type: docs
weight: 3340
...
| [MarkerHeight](../../aspose.svg/svgmarkerelement/markerheight/) { get; } | Komt overeen met attribuut 'markerHeight' op het gegeven 'marker'-element. |
| [MarkerUnits](../../aspose.svg/svgmarkerelement/markerunits/) { get; } | Komt overeen met attribuut 'markerUnits' op het gegeven 'marker' element. Een van de Marker Unit Types gedefinieerd op deze interface. |
| [MarkerWidth](../../aspose.svg/svgmarkerelement/markerwidth/) { get; } | Komt overeen met attribuut 'markerWidth' op het gegeven 'marker'-element. |
...
| [OrientAngle](../../aspose.svg/svgmarkerelement/orientangle/) { get; } | Komt overeen met attribuut 'orient' op het gegeven 'marker' element. Als markerUnits SVG_MARKER_ORIENT_ANGLE is, de hoekwaarde voor attribuut 'orient'; anders wordt het op nul gezet. |
| [OrientType](../../aspose.svg/svgmarkerelement/orienttype/) { get; } | Komt overeen met attribuut 'orient' op het gegeven 'marker' element. Een van de markeringsoriëntatietypen die op deze interface zijn gedefinieerd. |
...
| [PreserveAspectRatio](../../aspose.svg/svgmarkerelement/preserveaspectratio/) { get; } | Komt overeen met attribuut 'preserveAspectRatio' op het gegeven element. |
...
| [RefX](../../aspose.svg/svgmarkerelement/refx/) { get; } | Komt overeen met attribuut 'refX' op het gegeven 'marker'-element. |
| [RefY](../../aspose.svg/svgmarkerelement/refy/) { get; } | Komt overeen met attribuut 'refY' op het gegeven 'marker'-element. |
...
| [ViewBox](../../aspose.svg/svgmarkerelement/viewbox/) { get; } | Komt overeen met attribuut 'viewBox' op het gegeven element. |
...
| [SetOrientToAngle](../../aspose.svg/svgmarkerelement/setorienttoangle/)(SVGAngle) | Stelt de waarde van attribuut 'orient' in op de gegeven hoek. |
| [SetOrientToAuto](../../aspose.svg/svgmarkerelement/setorienttoauto/)() | Stelt de waarde van attribuut 'orient' in op 'auto'. |
...
| Naam | Beschrijving |
| --- | --- |
| const [SVG_MARKERUNITS_STROKEWIDTH](../../aspose.svg/svgmarkerelement/svg_markerunits_strokewidth/) | De waarde van attribuut 'markerUnits' is 'strokeWidth'. |
| const [SVG_MARKERUNITS_UNKNOWN](../../aspose.svg/svgmarkerelement/svg_markerunits_unknown/) | Het type markeringseenheid is niet een van de vooraf gedefinieerde typen. Het is ongeldig om te proberen een nieuwe waarde van dit type te definiëren of om een bestaande waarde naar dit type om te schakelen. |
...
| const [SVG_MARKER_ORIENT_AUTO](../../aspose.svg/svgmarkerelement/svg_marker_orient_auto/) | Attribuut 'orient' heeft waarde 'auto'. |
| const [SVG_MARKER_ORIENT_UNKNOWN](../../aspose.svg/svgmarkerelement/svg_marker_orient_unknown/) | De markeringsoriëntatie is niet een van de vooraf gedefinieerde typen. Het is ongeldig om te proberen een nieuwe waarde van dit type te definiëren of om een bestaande waarde naar dit type om te schakelen. |
