...
description: Aspose.Svg.SVGPathElement klas. De SVGPathElementinterface komt overeen met het pathelement.
type: docs
weight: 3370
url: /nl/net/aspose.svg/svgpathelement/
---
...
| [PathLength](../../aspose.svg/svggeometryelement/pathlength/) { get; } | Komt overeen met attribuut pathLength op het gegeven element. |
| [PathSegList](../../aspose.svg/svgpathelement/pathseglist/) { get; set; } | Biedt toegang tot de basis (dwz statische) inhoud van het 'd'-attribuut in een vorm die een-op-een overeenkomt met de SVG-syntaxis. Dus als het 'd'-attribuut een "absolute moveto (M)" en een "absolute arcto (A)"-opdracht heeft, dan heeft pathSegList twee ingangen: een SVG_PATHSEG_MOVETO_ABS en een SVG_PATHSEG_ARC_ABS. |
...
| [CreateSVGPathSegArcAbs](../../aspose.svg/svgpathelement/createsvgpathsegarcabs/)(float, float, float, float, float, bool, bool) | Retourneert een zelfstandig, ouderloos SVGPathSegArcAbs-object. |
| [CreateSVGPathSegArcRel](../../aspose.svg/svgpathelement/createsvgpathsegarcrel/)(float, float, float, float, float, bool, bool) | Retourneert een zelfstandig, ouderloos SVGPathSegArcRel-object. |
| [CreateSVGPathSegClosePath](../../aspose.svg/svgpathelement/createsvgpathsegclosepath/)() | Retourneert een zelfstandig, ouderloos SVGPathSegClosePath-object. |
| [CreateSVGPathSegCurvetoCubicAbs](../../aspose.svg/svgpathelement/createsvgpathsegcurvetocubicabs/)(float, float, float, float, float, float) | Retourneert een zelfstandig, ouderloos SVGPathSegCurvetoCubicAbs-object. |
| [CreateSVGPathSegCurvetoCubicRel](../../aspose.svg/svgpathelement/createsvgpathsegcurvetocubicrel/)(float, float, float, float, float, float) | Retourneert een zelfstandig, ouderloos SVGPathSegCurvetoCubicRel-object. |
| [CreateSVGPathSegCurvetoCubicSmoothAbs](../../aspose.svg/svgpathelement/createsvgpathsegcurvetocubicsmoothabs/)(float, float, float, float) | Retourneert een zelfstandig, ouderloos SVGPathSegCurvetoCubicSmoothAbs-object. |
| [CreateSVGPathSegCurvetoCubicSmoothRel](../../aspose.svg/svgpathelement/createsvgpathsegcurvetocubicsmoothrel/)(float, float, float, float) | Retourneert een zelfstandig, ouderloos SVGPathSegCurvetoCubicSmoothRel-object. |
| [CreateSVGPathSegCurvetoQuadraticAbs](../../aspose.svg/svgpathelement/createsvgpathsegcurvetoquadraticabs/)(float, float, float, float) | Retourneert een zelfstandig, ouderloos SVGPathSegCurvetoQuadraticAbs-object. |
| [CreateSVGPathSegCurvetoQuadraticRel](../../aspose.svg/svgpathelement/createsvgpathsegcurvetoquadraticrel/)(float, float, float, float) | Retourneert een zelfstandig, ouderloos SVGPathSegCurvetoQuadraticRel-object. |
| [CreateSVGPathSegCurvetoQuadraticSmoothAbs](../../aspose.svg/svgpathelement/createsvgpathsegcurvetoquadraticsmoothabs/)(float, float) | Retourneert een zelfstandig, ouderloos SVGPathSegCurvetoQuadraticSmoothAbs-object. |
| [CreateSVGPathSegCurvetoQuadraticSmoothRel](../../aspose.svg/svgpathelement/createsvgpathsegcurvetoquadraticsmoothrel/)(float, float) | Retourneert een zelfstandig, ouderloos SVGPathSegCurvetoQuadraticSmoothRel-object. |
| [CreateSVGPathSegLinetoAbs](../../aspose.svg/svgpathelement/createsvgpathseglinetoabs/)(float, float) | Retourneert een zelfstandig, ouderloos SVGPathSegLinetoAbs-object. |
| [CreateSVGPathSegLinetoHorizontalAbs](../../aspose.svg/svgpathelement/createsvgpathseglinetohorizontalabs/)(float) | Retourneert een zelfstandig, ouderloos SVGPathSegLinetoHorizontalAbs-object. |
| [CreateSVGPathSegLinetoHorizontalRel](../../aspose.svg/svgpathelement/createsvgpathseglinetohorizontalrel/)(float) | Retourneert een zelfstandig, ouderloos SVGPathSegLinetoHorizontalRel-object. |
| [CreateSVGPathSegLinetoRel](../../aspose.svg/svgpathelement/createsvgpathseglinetorel/)(float, float) | Retourneert een zelfstandig, ouderloos SVGPathSegLinetoRel-object. |
| [CreateSVGPathSegLinetoVerticalAbs](../../aspose.svg/svgpathelement/createsvgpathseglinetoverticalabs/)(float) | Retourneert een zelfstandig, ouderloos SVGPathSegLinetoVerticalAbs-object. |
| [CreateSVGPathSegLinetoVerticalRel](../../aspose.svg/svgpathelement/createsvgpathseglinetoverticalrel/)(float) | Retourneert een zelfstandig, ouderloos SVGPathSegLinetoVerticalRel-object. |
| [CreateSVGPathSegMovetoAbs](../../aspose.svg/svgpathelement/createsvgpathsegmovetoabs/)(float, float) | Retourneert een zelfstandig, ouderloos SVGPathSegMovetoAbs-object. |
| [CreateSVGPathSegMovetoRel](../../aspose.svg/svgpathelement/createsvgpathsegmovetorel/)(float, float) | Retourneert een zelfstandig, ouderloos SVGPathSegMovetoRel-object. |
...
| [GetEquivalentPath](../../aspose.svg/svggeometryelement/getequivalentpath/)() | Retourneert een nieuwe instantie van de[`SVGPathSegList`](../../aspose.svg.paths/svgpathseglist/) wat vertegenwoordigt[`SVGGeometryElement`](../svggeometryelement/) als padsegmenten. |
...
| [GetPointAtLength](../../aspose.svg/svggeometryelement/getpointatlength/)(float) | Retourneert de (x,y)-coördinaat in gebruikersruimte, d.w.z. afstandseenheden langs het pad, gebruikmakend van het algoritme voor afstand langs een pad van de user-agent. |
...
| [GetTotalLength](../../aspose.svg/svggeometryelement/gettotallength/)() | Retourneert de door de user-agent berekende waarde voor de totale lengte van het pad met behulp van het afstand-langs-een-pad-algoritme van de user-agent, als een afstand in het huidige gebruikerscoördinatensysteem. |
