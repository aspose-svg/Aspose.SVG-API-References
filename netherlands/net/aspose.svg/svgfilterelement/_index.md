...
description: Aspose.Svg.SVGFilterElement klas. De SVGFilterElementinterface komt overeen met het filterelement.
type: docs
weight: 3240
...
| [FilterUnits](../../aspose.svg/svgfilterelement/filterunits/) { get; } | Komt overeen met attribuut 'filterUnits' op het gegeven 'filter' element. Neemt een van de constanten die zijn gedefinieerd in SVGUnitTypes. |
...
| [Height](../../aspose.svg/svgfilterelement/height/) { get; } | Komt overeen met attribuut 'height' op het gegeven 'filter'-element. |
| [Href](../../aspose.svg/svgfilterelement/href/) { get; } | Komt overeen met attribuut 'xlink:href' op het gegeven element. |
...
| [PrimitiveUnits](../../aspose.svg/svgfilterelement/primitiveunits/) { get; } | Komt overeen met attribuut 'primitiveUnits' op het gegeven 'filter'-element. Neemt een van de constanten die zijn gedefinieerd in SVGUnitTypes. |
...
| [Width](../../aspose.svg/svgfilterelement/width/) { get; } | Komt overeen met attribuut 'width' op het gegeven 'filter'-element. |
| [X](../../aspose.svg/svgfilterelement/x/) { get; } | Komt overeen met attribuut 'x' op het gegeven 'filter'-element. |
| [Y](../../aspose.svg/svgfilterelement/y/) { get; } | Komt overeen met attribuut 'y' op het gegeven 'filter'-element. |
