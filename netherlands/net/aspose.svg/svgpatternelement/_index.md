...
description: Aspose.Svg.SVGPatternElement klas. De SVGPatternElementinterface komt overeen met het patroonelement.
type: docs
weight: 3380
...
| [Height](../../aspose.svg/svgpatternelement/height/) { get; } | Komt overeen met attribuut 'hoogte' op het gegeven 'patroon'-element. |
| [Href](../../aspose.svg/svgpatternelement/href/) { get; } | Komt overeen met attribuut 'xlink:href' op het gegeven element. |
...
| [PatternContentUnits](../../aspose.svg/svgpatternelement/patterncontentunits/) { get; } | Komt overeen met attribuut 'patternContentUnits' op het gegeven 'pattern' element. Neemt een van de constanten die zijn gedefinieerd in SVGUnitTypes. |
| [PatternTransform](../../aspose.svg/svgpatternelement/patterntransform/) { get; } | Komt overeen met attribuut 'patternTransform' op het gegeven 'pattern' element. |
| [PatternUnits](../../aspose.svg/svgpatternelement/patternunits/) { get; } | Komt overeen met attribuut 'patternUnits' op het gegeven 'pattern' element. Neemt een van de constanten die zijn gedefinieerd in SVGUnitTypes. |
...
| [PreserveAspectRatio](../../aspose.svg/svgpatternelement/preserveaspectratio/) { get; } | Komt overeen met attribuut 'preserveAspectRatio' op het gegeven element. |
...
| [RequiredExtensions](../../aspose.svg/svgpatternelement/requiredextensions/) { get; } | Komt overeen met attribuut 'requiredExtensions' op het gegeven element. |
| [RequiredFeatures](../../aspose.svg/svgpatternelement/requiredfeatures/) { get; } | Komt overeen met attribuut 'requiredFeatures' op het gegeven element. |
...
| [SystemLanguage](../../aspose.svg/svgpatternelement/systemlanguage/) { get; } | Komt overeen met attribuut 'systemLanguage' op het gegeven element. |
...
| [ViewBox](../../aspose.svg/svgpatternelement/viewbox/) { get; } | Komt overeen met attribuut 'viewBox' op het gegeven element. |
...
| [Width](../../aspose.svg/svgpatternelement/width/) { get; } | Komt overeen met attribuut 'width' op het gegeven 'pattern' element. |
| [X](../../aspose.svg/svgpatternelement/x/) { get; } | Komt overeen met attribuut 'x' op het gegeven 'patroon'-element. |
| [Y](../../aspose.svg/svgpatternelement/y/) { get; } | Komt overeen met attribuut 'y' op het gegeven 'patroon'-element. |
