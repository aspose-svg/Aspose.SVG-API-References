...
description: "Aspose.Svg.SVGPatternElement class. De SVGPatternElement‑interface correspondeert met het pattern‑element."
type: docs
weight: 5450
url: /nl/net/aspose.svg/svgpatternelement/
---
...
| [Height](../../aspose.svg/svgpatternelement/height/) { get; } | Komt overeen met het attribuut ‘height’ op het opgegeven ‘pattern’-element. |
| [Href](../../aspose.svg/svgpatternelement/href/) { get; } | Komt overeen met attribuut ‘xlink:href’ op het opgegeven element. |
...
| [PatternContentUnits](../../aspose.svg/svgpatternelement/patterncontentunits/) { get; } | Komt overeen met het attribuut ‘patternContentUnits’ op het opgegeven ‘pattern’-element. Neemt een van de constanten die zijn gedefinieerd in SVGUnitTypes. |
| [PatternTransform](../../aspose.svg/svgpatternelement/patterntransform/) { get; } | Komt overeen met het attribuut ‘patternTransform’ op het opgegeven ‘pattern’-element. |
| [PatternUnits](../../aspose.svg/svgpatternelement/patternunits/) { get; } | Komt overeen met attribuut ‘patternUnits’ op het opgegeven ‘pattern’-element. Neemt een van de constanten die gedefinieerd zijn in SVGUnitTypes. |
...
| [PreserveAspectRatio](../../aspose.svg/svgpatternelement/preserveaspectratio/) { get; } | Komt overeen met het attribuut ‘preserveAspectRatio’ op het opgegeven element. |
...
| [RequiredExtensions](../../aspose.svg/svgpatternelement/requiredextensions/) { get; } | Komt overeen met het attribuut ‘requiredExtensions’ van het opgegeven element. |
| [RequiredFeatures](../../aspose.svg/svgpatternelement/requiredfeatures/) { get; } | Komt overeen met het attribuut ‘requiredFeatures’ van het opgegeven element. |
...
| [SystemLanguage](../../aspose.svg/svgpatternelement/systemlanguage/) { get; } | Komt overeen met het attribuut ‘systemLanguage’ van het opgegeven element. |
...
| [ViewBox](../../aspose.svg/svgpatternelement/viewbox/) { get; } | Komt overeen met het attribuut ‘viewBox’ op het opgegeven element. |
...
| [Width](../../aspose.svg/svgpatternelement/width/) { get; } | Komt overeen met attribuut ‘width’ op het opgegeven ‘pattern’-element. |
| [X](../../aspose.svg/svgpatternelement/x/) { get; } | Komt overeen met attribuut ‘x’ op het opgegeven ‘pattern’-element. |
| [Y](../../aspose.svg/svgpatternelement/y/) { get; } | Komt overeen met attribuut ‘y’ op het opgegeven ‘pattern’-element. |
