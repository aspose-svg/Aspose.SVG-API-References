...
description: "Aspose.Svg.SVGTextPathElement klasse. De SVGTextPathElement interface komt overeen met het textPath element"
type: docs
weight: 5610
url: /nl/net/aspose.svg/svgtextpathelement/
---
...
| [ClassName](../../aspose.svg/svgelement/classname/) { get; } | Komt overeen met het attribuut ‘class’ van het opgegeven element. |
...
| [FarthestViewportElement](../../aspose.svg/svggraphicselement/farthestviewportelement/) { get; } | Het verste voorouder‑element ‘svg’. Null als het huidige element het buitenste svg‑element is. |
...
| [Href](../../aspose.svg/svgtextpathelement/href/) { get; } | Komt overeen met attribuut ‘xlink:href’ op het opgegeven element. |
| [Id](../../aspose.svg/svgelement/id/) { get; set; } | De waarde van het ‘id’-attribuut van het opgegeven element, of de lege tekenreeks als ‘id’ niet aanwezig is. |
...
| [LengthAdjust](../../aspose.svg/svgtextcontentelement/lengthadjust/) { get; } | Komt overeen met attribuut ‘lengthAdjust’ op het opgegeven element. De waarde moet een van de length‑adjust‑constanten zijn die op deze interface zijn gedefinieerd. |
...
| [Method](../../aspose.svg/svgtextpathelement/method/) { get; } | Komt overeen met attribuut ‘method’ op het opgegeven ‘textPath’-element. |
...
| [NearestViewportElement](../../aspose.svg/svggraphicselement/nearestviewportelement/) { get; } | Het element dat het huidige viewport heeft vastgesteld. Vaak het dichtstbijzijnde voorouder‑element ‘svg’. Null als het huidige element het buitenste svg‑element is. |
...
| [OwnerSVGElement](../../aspose.svg/svgelement/ownersvgelement/) { get; } | Het dichtstbijzijnde bovenliggende ‘svg’-element. Null als het opgegeven element het buitenste svg-element is. |
...
| [RequiredExtensions](../../aspose.svg/svggraphicselement/requiredextensions/) { get; } | Komt overeen met het attribuut ‘requiredExtensions’ van het opgegeven element. |
| [RequiredFeatures](../../aspose.svg/svggraphicselement/requiredfeatures/) { get; } | Komt overeen met het attribuut ‘requiredFeatures’ van het opgegeven element. |
...
| [Spacing](../../aspose.svg/svgtextpathelement/spacing/) { get; } | Komt overeen met attribuut ‘spacing’ op het opgegeven ‘textPath’-element. |
| [StartOffset](../../aspose.svg/svgtextpathelement/startoffset/) { get; } | Komt overeen met attribuut ‘startOffset’ op het opgegeven ‘textPath’-element. |
| [Style](../../aspose.svg/svgelement/style/) { get; } | Komt overeen met het attribuut ‘style’ van het opgegeven element. Als de user agent geen styling met CSS ondersteunt, moet dit attribuut altijd de waarde null hebben. |
| [SystemLanguage](../../aspose.svg/svggraphicselement/systemlanguage/) { get; } | Komt overeen met het attribuut ‘systemLanguage’ van het opgegeven element. |
...
| [TextLength](../../aspose.svg/svgtextcontentelement/textlength/) { get; } | Komt overeen met attribuut ‘textLength’ op het opgegeven element. |
| [Transform](../../aspose.svg/svggraphicselement/transform/) { get; } | Komt overeen met attribuut ‘transform’ op het opgegeven element. |
| [ViewportElement](../../aspose.svg/svgelement/viewportelement/) { get; } | Het element dat de huidige viewport heeft vastgesteld. Vaak het dichtstbijzijnde bovenliggende ‘svg’-element. Null als het opgegeven element het buitenste svg-element is. |
...
| [AttachShadow](../../aspose.svg.dom/element/attachshadow/)(*[ShadowRootMode](../../aspose.svg.dom/shadowrootmode/)*) | Maakt een shadow root aan en koppelt deze aan het huidige element. |
...
| [GetBBox](../../aspose.svg/svggraphicselement/getbbox/)() | Retourneert de nauwkeurige begrenzingsbox in de huidige gebruikersruimte (d.w.z. na toepassing van het ‘transform’-attribuut, indien aanwezig) op de geometrie van alle ingesloten grafische elementen, exclusief stroken, bijsnijden, maskeren en filtereffecten). Merk op dat getBBox de feitelijke begrenzingsbox moet retourneren op het moment dat de methode werd aangeroepen, zelfs als het element nog niet is gerenderd. |
| [GetComputedTextLength](../../aspose.svg/svgtextcontentelement/getcomputedtextlength/)() | De totale som van alle voortschrijdende waarden bij het renderen van alle tekens binnen dit element, inclusief de voortschrijdende waarde op de glyphs (horizontaal of verticaal), het effect van de eigenschappen ‘kerning’, ‘letter-spacing’ en ‘word-spacing’ en aanpassingen door de attributen ‘dx’ en ‘dy’ op ‘tspan’-elementen. Voor niet‑renderende omgevingen moet de user agent redelijke aannames doen over glyph‑metriek. |
| [GetCTM](../../aspose.svg/svggraphicselement/getctm/)() | Retourneert de transformatie‑matrix van de huidige gebruikerseenheden (d.w.z. na toepassing van het ‘transform’-attribuut, indien aanwezig) naar het viewport‑coördinatensysteem voor het nearestViewportElement. |
| [GetElementsByClassName](../../aspose.svg.dom/element/getelementsbyclassname/)(*string*) | Retourneert een [`HTMLCollection`](../../aspose.svg.collections/htmlcollection/) object dat alle elementen binnen [`element`](../../aspose.svg.dom/element/) bevat die alle opgegeven klassen hebben. |
| [GetElementsByTagName](../../aspose.svg.dom/element/getelementsbytagname/)(*string*) | Retourneert een [`HTMLCollection`](../../aspose.svg.collections/htmlcollection/) object dat alle [`elements`](../../aspose.svg.dom/element/) met een opgegeven tagnaam bevat, in documentvolgorde. |
| [GetElementsByTagNameNS](../../aspose.svg.dom/element/getelementsbytagnamens/)(*string, string*) | Retourneert een [`HTMLCollection`](../../aspose.svg.collections/htmlcollection/) object dat alle [`elements`](../../aspose.svg.dom/element/) met een opgegeven lokale naam en namespace‑URI‑tekenreeks bevat, in documentvolgorde. |
| [GetNumberOfChars](../../aspose.svg/svgtextcontentelement/getnumberofchars/)() | Retourneert het totale aantal tekens dat beschikbaar is voor weergave binnen het huidige element, inclusief verwijzende tekens uit de ‘tref’-referentie, ongeacht of ze worden gerenderd. In feite is dit gelijk aan de lengte van het Node::textContent‑attribuut uit DOM Level 3 Core ([DOM3], sectie 1.4), als dat attribuut ook ‘tref’-elementen uitbreidt. |
...
| [RemoveAttributeNode](../../aspose.svg.dom/element/removeattributenode/)(*[Attr](../../aspose.svg.dom/attr/)*) | Verwijdert het opgegeven attribuutknooppunt. |
...
| [SetAttributeNode](../../aspose.svg.dom/element/setattributenode/)(*[Attr](../../aspose.svg.dom/attr/)*) | Voegt een nieuw attribuutknooppunt toe. Als een attribuut met die naam (nodeName) al aanwezig is in het element, wordt het vervangen door het nieuwe. |
| [SetAttributeNodeNS](../../aspose.svg.dom/element/setattributenodens/)(*[Attr](../../aspose.svg.dom/attr/)*) | Voegt een nieuw attribuut toe. Als een attribuut met die lokale naam en die namespace-URI al aanwezig is in het element, wordt het vervangen door het nieuwe. |
...
| [ToggleAttribute](../../aspose.svg.dom/element/toggleattribute/)(*string*) | Als force niet is opgegeven, "schakelt" qualifiedName, verwijdert het als het aanwezig is en voegt het toe als het niet aanwezig is. Als force true is, wordt qualifiedName toegevoegd. Als force false is, wordt qualifiedName verwijderd. |
| [ToggleAttribute](../../aspose.svg.dom/element/toggleattribute/)(*string, bool*) | Als force niet is opgegeven, "schakelt" qualifiedName, verwijdert het als het aanwezig is en voegt het toe als het niet aanwezig is. Als force true is, wordt qualifiedName toegevoegd. Als force false is, wordt qualifiedName verwijderd. |
...
| Naam | Beschrijving |
| --- | --- |
| const [TEXTPATH_METHODTYPE_ALIGN](../../aspose.svg/svgtextpathelement/textpath_methodtype_align/) | Komt overeen met waarde 'align'. |
| const [TEXTPATH_METHODTYPE_STRETCH](../../aspose.svg/svgtextpathelement/textpath_methodtype_stretch/) | Komt overeen met waarde 'stretch'. |
| const [TEXTPATH_METHODTYPE_UNKNOWN](../../aspose.svg/svgtextpathelement/textpath_methodtype_unknown/) | De enumeratie is ingesteld op een waarde die geen van de vooraf gedefinieerde types is. Het is ongeldig om te proberen een nieuwe waarde van dit type te definiëren of om een bestaande waarde naar dit type te wijzigen. |
| const [TEXTPATH_SPACINGTYPE_AUTO](../../aspose.svg/svgtextpathelement/textpath_spacingtype_auto/) | Komt overeen met waarde 'auto'. |
| const [TEXTPATH_SPACINGTYPE_EXACT](../../aspose.svg/svgtextpathelement/textpath_spacingtype_exact/) | Komt overeen met waarde 'exact'. |
| const [TEXTPATH_SPACINGTYPE_UNKNOWN](../../aspose.svg/svgtextpathelement/textpath_spacingtype_unknown/) | De enumeratie is ingesteld op een waarde die geen van de vooraf gedefinieerde types is. Het is ongeldig om te proberen een nieuwe waarde van dit type te definiëren of om een bestaande waarde naar dit type te wijzigen. |
