...
description: Aspose.Svg.SVGTextPathElement klas. De SVGTextPathElementinterface komt overeen met het textPathelement.
type: docs
weight: 3540
...
| [Href](../../aspose.svg/svgtextpathelement/href/) { get; } | Komt overeen met attribuut 'xlink:href' op het gegeven element. |
...
| [Method](../../aspose.svg/svgtextpathelement/method/) { get; } | Komt overeen met attribuut 'method' op het gegeven 'textPath'-element. |
...
| [Spacing](../../aspose.svg/svgtextpathelement/spacing/) { get; } | Komt overeen met attribuut 'spacing' op het gegeven 'textPath'-element. |
...
| const [TEXTPATH_METHODTYPE_UNKNOWN](../../aspose.svg/svgtextpathelement/textpath_methodtype_unknown/) | De opsomming is ingesteld op een waarde die niet een van de vooraf gedefinieerde typen is. Het is ongeldig om te proberen een nieuwe waarde van dit type te definiëren of om een bestaande waarde naar dit type om te schakelen. |
...
| const [TEXTPATH_SPACINGTYPE_UNKNOWN](../../aspose.svg/svgtextpathelement/textpath_spacingtype_unknown/) | De opsomming is ingesteld op een waarde die niet een van de vooraf gedefinieerde typen is. Het is ongeldig om te proberen een nieuwe waarde van dit type te definiëren of om een bestaande waarde naar dit type om te schakelen. |
