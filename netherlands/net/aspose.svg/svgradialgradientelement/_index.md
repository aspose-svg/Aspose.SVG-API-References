...
description: Aspose.Svg.SVGRadialGradientElement klas. De interface SVGRadialGradientElement komt overeen met het element radialGradient.
type: docs
weight: 3410
...
| [Fx](../../aspose.svg/svgradialgradientelement/fx/) { get; } | Komt overeen met attribuut 'fx' op het gegeven 'radialGradient' element. |
| [Fy](../../aspose.svg/svgradialgradientelement/fy/) { get; } | Komt overeen met attribuut 'fy' op het gegeven 'radialGradient' element. |
| [GradientTransform](../../aspose.svg/svggradientelement/gradienttransform/) { get; } | Komt overeen met attribuut 'gradientTransform' op het gegeven element. |
| [GradientUnits](../../aspose.svg/svggradientelement/gradientunits/) { get; } | Komt overeen met attribuut 'gradientUnits' op het gegeven element. Neemt een van de constanten die zijn gedefinieerd in SVGUnitTypes. |
| [Href](../../aspose.svg/svggradientelement/href/) { get; } | Komt overeen met attribuut 'xlink:href' op het gegeven element. |
...
| [SpreadMethod](../../aspose.svg/svggradientelement/spreadmethod/) { get; } | Komt overeen met attribuut 'spreadMethod' op het gegeven element. Een van de Spread Method Types gedefinieerd op deze interface. |
