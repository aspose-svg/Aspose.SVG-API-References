...
description: "Aspose.Svg.SVGAnimationElement klasse. De SVGAnimationElement interface is de basisinterface voor alle animatie‑element‑interfaces SVGAnimateElement SVGSetElement SVGAnimateColorElement SVGAnimateMotionElement en SVGAnimateTransformElement"
type: docs
weight: 5190
url: /nl/net/aspose.svg/svganimationelement/
---
## SVGAnimationElement class

De SVGAnimationElement-interface is de basiskoppelvlak voor alle animatie‑element‑interfaces: SVGAnimateElement, SVGSetElement, SVGAnimateColorElement, SVGAnimateMotionElement en SVGAnimateTransformElement.
...
| [RequiredExtensions](../../aspose.svg/svganimationelement/requiredextensions/) { get; } | Komt overeen met het attribuut ‘requiredExtensions’ van het opgegeven element. |
| [RequiredFeatures](../../aspose.svg/svganimationelement/requiredfeatures/) { get; } | Komt overeen met het attribuut ‘requiredFeatures’ van het opgegeven element. |
...
| [SystemLanguage](../../aspose.svg/svganimationelement/systemlanguage/) { get; } | Komt overeen met het attribuut ‘systemLanguage’ van het opgegeven element. |
| [TagName](../../aspose.svg.dom/element/tagname/) { get; } | De naam van het element. |
| [TargetElement](../../aspose.svg/svganimationelement/targetelement/) { get; } | Het element dat geanimeerd wordt. |
