...
description: Aspose.Svg.SVGAnimationElement klas. De SVGAnimationElementinterface is de basisinterface voor alle animatieelementinterfaces SVGAnimateElement SVGSetElement SVGAnimateColorElement SVGAnimateMotionElement en SVGAnimateTransformElement.
type: docs
weight: 3120
...
| [RequiredExtensions](../../aspose.svg/svganimationelement/requiredextensions/) { get; } | Komt overeen met attribuut 'requiredExtensions' op het gegeven element. |
| [RequiredFeatures](../../aspose.svg/svganimationelement/requiredfeatures/) { get; } | Komt overeen met attribuut 'requiredFeatures' op het gegeven element. |
...
| [SystemLanguage](../../aspose.svg/svganimationelement/systemlanguage/) { get; } | Komt overeen met attribuut 'systemLanguage' op het gegeven element. |
| [TagName](../../aspose.svg.dom/element/tagname/) { get; } | De naam van het element. |
| [TargetElement](../../aspose.svg/svganimationelement/targetelement/) { get; } | Het element dat wordt geanimeerd. |
