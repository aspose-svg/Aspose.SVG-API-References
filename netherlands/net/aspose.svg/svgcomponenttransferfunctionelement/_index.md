...
description: "Aspose.Svg.SVGComponentTransferFunctionElement klasse. Deze interface definieert een basisinterface die wordt gebruikt door de component transfer-functie‑interfaces"
type: docs
weight: 5220
url: /nl/net/aspose.svg/svgcomponenttransferfunctionelement/
---
## SVGComponentTransferFunctionElement class

Deze interface definieert een basiskoppelvlak dat wordt gebruikt door de component‑overdrachtsfunctie‑interfaces.
...
| Naam | Beschrijving |
| --- | --- |
| [Amplitude](../../aspose.svg/svgcomponenttransferfunctionelement/amplitude/) { get; } | Komt overeen met attribuut ‘amplitude’ op het opgegeven element. |
...
| [Exponent](../../aspose.svg/svgcomponenttransferfunctionelement/exponent/) { get; } | Komt overeen met attribuut ‘exponent’ op het opgegeven element. |
...
| [Intercept](../../aspose.svg/svgcomponenttransferfunctionelement/intercept/) { get; } | Komt overeen met attribuut ‘intercept’ op het opgegeven element. |
...
| [Offset](../../aspose.svg/svgcomponenttransferfunctionelement/offset/) { get; } | Komt overeen met attribuut ‘offset’ op het opgegeven element. |
...
| [Slope](../../aspose.svg/svgcomponenttransferfunctionelement/slope/) { get; } | Komt overeen met attribuut ‘slope’ op het opgegeven element. |
...
| [TableValues](../../aspose.svg/svgcomponenttransferfunctionelement/tablevalues/) { get; } | Komt overeen met attribuut ‘tableValues’ op het opgegeven element. |
...
| [Type](../../aspose.svg/svgcomponenttransferfunctionelement/type/) { get; } | Komt overeen met attribuut ‘type’ op het opgegeven element. Neemt een van de SVG_FECOMPONENTTRANSFER_TYPE_* constanten die op deze interface zijn gedefinieerd. |
...
| Naam | Beschrijving |
| --- | --- |
| const [SVG_FECOMPONENTTRANSFER_TYPE_DISCRETE](../../aspose.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_discrete/) | Komt overeen met waarde 'discrete'. |
| const [SVG_FECOMPONENTTRANSFER_TYPE_GAMMA](../../aspose.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_gamma/) | Komt overeen met waarde 'gamma'. |
| const [SVG_FECOMPONENTTRANSFER_TYPE_IDENTITY](../../aspose.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_identity/) | Komt overeen met waarde 'identity'. |
| const [SVG_FECOMPONENTTRANSFER_TYPE_LINEAR](../../aspose.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_linear/) | Komt overeen met waarde 'linear'. |
| const [SVG_FECOMPONENTTRANSFER_TYPE_TABLE](../../aspose.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_table/) | Komt overeen met waarde 'table'. |
