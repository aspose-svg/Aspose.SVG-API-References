...
description: Aspose.Svg.SVGComponentTransferFunctionElement klas. Deze interface definieert een basisinterface die wordt gebruikt door de componentoverdrachtsfunctieinterfaces.
type: docs
weight: 3150
...
| Naam | Beschrijving |
| --- | --- |
| [Amplitude](../../aspose.svg/svgcomponenttransferfunctionelement/amplitude/) { get; } | Komt overeen met attribuut 'amplitude' op het gegeven element. |
...
| [Exponent](../../aspose.svg/svgcomponenttransferfunctionelement/exponent/) { get; } | Komt overeen met attribuut 'exponent' op het gegeven element. |
...
| [Intercept](../../aspose.svg/svgcomponenttransferfunctionelement/intercept/) { get; } | Komt overeen met attribuut 'intercept' op het gegeven element. |
...
| [Offset](../../aspose.svg/svgcomponenttransferfunctionelement/offset/) { get; } | Komt overeen met attribuut 'offset' op het gegeven element. |
...
| [Slope](../../aspose.svg/svgcomponenttransferfunctionelement/slope/) { get; } | Komt overeen met attribuut 'slope' op het gegeven element. |
...
| [TableValues](../../aspose.svg/svgcomponenttransferfunctionelement/tablevalues/) { get; } | Komt overeen met attribuut 'tableValues' op het gegeven element. |
...
| [Type](../../aspose.svg/svgcomponenttransferfunctionelement/type/) { get; } | Komt overeen met attribuut 'type' op het gegeven element. Neemt een van de SVG_FECOMPONENTTRANSFER_TYPE_*-constanten die op deze interface zijn gedefinieerd. |
...
| Naam | Beschrijving |
| --- | --- |
| const [SVG_FECOMPONENTTRANSFER_TYPE_DISCRETE](../../aspose.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_discrete/) | Komt overeen met waarde 'discreet'. |
...
| const [SVG_FECOMPONENTTRANSFER_TYPE_IDENTITY](../../aspose.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_identity/) | Komt overeen met waarde 'identiteit'. |
| const [SVG_FECOMPONENTTRANSFER_TYPE_LINEAR](../../aspose.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_linear/) | Komt overeen met waarde 'lineair'. |
| const [SVG_FECOMPONENTTRANSFER_TYPE_TABLE](../../aspose.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_table/) | Komt overeen met waarde 'tabel'. |
