...
description: "SVGBuilderExtensions AddFeComposite-methode. Voegt een feComposite-elementconfiguratie toe aan de builder. Dit element voert een bitwise-combinatie uit van twee invoergrafische elementen."
type: docs
weight: 160
url: /nl/net/aspose.svg.builder/svgbuilderextensions/addfecomposite/
---
## AddFeComposite<TBuilder>(*this TBuilder, Action&lt;SVGFECompositeElementBuilder&gt;*) {#addfecomposite}

Voegt een 'feComposite'‑elementconfiguratie toe aan de builder. Dit element voert een bitgewijze combinatie van twee invoergrafische elementen uit.
...
| configureren | De configuratie‑actie voor het 'feComposite'-element. |
...
Voegt een 'feComposite'-element toe aan de SVG builder, waarbij de compositie‑bewerking en verschillende andere eigenschappen voor het combineren van invoerafbeeldingen worden gespecificeerd.
...
| builder | De SVG-builderinstantie waaraan het 'feComposite'-element zal worden toegevoegd. |
| compositeOperator | De te gebruiken composite-operator. Optionele parameter. |
| k1 | De eerste numerieke waarde voor de composite-bewerking. Optionele parameter. |
| k2 | De tweede numerieke waarde voor de composite-bewerking. Optionele parameter. |
| k3 | De derde numerieke waarde voor de composite-bewerking. Optionele parameter. |
| k4 | De vierde numerieke waarde voor de composite-bewerking. Optionele parameter. |
| in | De eerste invoer voor het composite-effect. Kan een tekenreeks of een FilterInput zijn. Optionele parameter. |
| in2 | De tweede invoer voor het composite-effect. Kan een tekenreeks of een FilterInput zijn. Optionele parameter. |
...
| extend | Een optionele actie om de SVGFECompositeElementBuilder verder te configureren. |
