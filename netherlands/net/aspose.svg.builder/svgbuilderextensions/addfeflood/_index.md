...
description: "SVGBuilderExtensions AddFeFlood-methode. Voegt een feFlood-elementconfiguratie toe aan de builder. Dit element vult het filter-subgebied met een opgegeven kleur."
type: docs
weight: 210
url: /nl/net/aspose.svg.builder/svgbuilderextensions/addfeflood/
---
## AddFeFlood<TBuilder>(*this TBuilder, Action&lt;SVGFEFloodElementBuilder&gt;*) {#addfeflood}

Voegt een configuratie van het 'feFlood'-element toe aan de builder. Dit element vult de filtersubregio met een opgegeven kleur.
...
| configureren | De configuratie-actie voor het 'feFlood'-element. |
...
Voegt een 'feFlood'-element toe aan de SVG builder, waardoor een uniforme overstromingskleur over de gehele filtersubregio ontstaat.
...
| builder | De SVG-builder-instantie waaraan het 'feFlood'-element zal worden toegevoegd. |
| floodColor | De kleur die wordt gebruikt voor het flood-effect. Optionele parameter. |
| floodOpacity | Het opaciteitsniveau van de flood-kleur. Optionele parameter. |
...
| extend | Een optionele actie om de SVGFEFloodElementBuilder verder te configureren. |
