...
description: "SVGBuilderExtensions AddFeConvolveMatrix-methode. Voegt een feConvolveMatrix-elementconfiguratie toe aan de builder. Dit element past een matrixconvolutiefiltereffect toe."
type: docs
weight: 170
url: /nl/net/aspose.svg.builder/svgbuilderextensions/addfeconvolvematrix/
---
## AddFeConvolveMatrix<TBuilder>(*this TBuilder, Action&lt;SVGFEConvolveMatrixElementBuilder&gt;*) {#addfeconvolvematrix_1}

Voegt een configuratie van het 'feConvolveMatrix'-element toe aan de builder. Dit element past een matrixconvolutiefiltereffect toe.
...
| configureren | De configuratieactie voor het 'feConvolveMatrix'-element. |
...
Voegt een 'feConvolveMatrix'-element toe aan de SVG builder, waarbij een matrixconvolutiefiltereffect wordt toegepast.
...
| builder | De SVG-builderinstantie waaraan het 'feConvolveMatrix'-element zal worden toegevoegd. |
| kernelMatrix | De matrix met waarden voor de convolutie. Optionele parameter. |
| deler | De deler voor de convolutie. Optionele parameter. |
| bias | De bias die wordt toegevoegd aan het resultaat van de convolutie. Optionele parameter. |
| targetX | De x-coördinaat van de doelpixel in de kernelmatrix. Optionele parameter. |
| targetY | De y-coördinaat van de doelpixel in de kernelmatrix. Optionele parameter. |
| edgeMode | Definieert hoe randpixels in de convolutie worden behandeld. Optionele parameter. |
| preserveAlpha | Geeft aan of het alfacanaal behouden moet blijven. Optionele parameter. |
| volgorde | De volgorde van de kernelmatrix. Kan een int of een ValueTuple van twee ints zijn. Optionele parameter. |
| in | De invoer voor het convolutie-effect. Kan een string of een FilterInput zijn. Optionele parameter. |
...
| extend | Een optionele actie om de SVGFEConvolveMatrixElementBuilder verder te configureren. |
