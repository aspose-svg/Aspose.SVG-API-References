...
description: "SVGBuilderExtensions AddFeDiffuseLighting-methode. Voegt een feDiffuseLighting-elementconfiguratie toe aan de builder. Dit element levert een verlichtingseffect op een afbeelding."
type: docs
weight: 180
url: /nl/net/aspose.svg.builder/svgbuilderextensions/addfediffuselighting/
---
## AddFeDiffuseLighting<TBuilder>(*this TBuilder, Action&lt;SVGFEDiffuseLightingElementBuilder&gt;*) {#addfediffuselighting}

Voegt een configuratie van het 'feDiffuseLighting'-element toe aan de builder. Dit element levert een lichteffect op een afbeelding.
...
| configureren | De configuratieactie voor het 'feDiffuseLighting'-element. |
...
Voegt een 'feDiffuseLighting'-element toe aan de SVG builder, waarbij een diffuus lichteffect wordt toegepast met een opgegeven lichtbron.
...
| builder | De SVG-builderinstantie waaraan het 'feDiffuseLighting'-element zal worden toegevoegd. |
| lightSource | Een actie om de lichtbron voor het diffuse verlichtingseffect te configureren. |
...
| diffuseConstant | De constante die wordt gebruikt om het verlichtingseffect te bepalen. Optionele parameter. |
| in | De invoer voor het diffuse verlichtingseffect. Kan een string of een FilterInput zijn. Optionele parameter. |
...
| extend | Een optionele actie om de SVGFEDiffuseLightingElementBuilder verder te configureren. |
