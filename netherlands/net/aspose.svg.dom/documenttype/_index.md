...
description: Aspose.Svg.Dom.DocumentType klas. Het DocumentType biedt een interface naar de lijst met entiteiten die zijn gedefinieerd voor het document
type: docs
weight: 830
...
| [Name](../../aspose.svg.dom/documenttype/name/) { get; } | De naam van DTD; dwz de naam die onmiddellijk volgt op het trefwoord DOCTYPE. |
...
| [PublicId](../../aspose.svg.dom/documenttype/publicid/) { get; } | De publieke identifier van de externe subset. |
| [SystemId](../../aspose.svg.dom/documenttype/systemid/) { get; } | De systeem-ID van de externe subset. Dit kan een absolute URI zijn of niet. |
...
| override [ToString](../../aspose.svg.dom/documenttype/tostring/)() | Geeft als resultaat eenString die deze instantie vertegenwoordigt. |
