...
description: Aspose.Svg.Dom.Entity klas. Vertegenwoordigt een bekende entiteit al dan niet geparseerd in een XMLdocument.
type: docs
weight: 850
...
| [InputEncoding](../../aspose.svg.dom/entity/inputencoding/) { get; } | Een attribuut dat de codering specificeert die voor deze entiteit is gebruikt op het moment van parseren, wanneer het een externe geparseerde entiteit is. Dit is null als het een entiteit is uit de interne subset of als het niet bekend is. |
...
| [PublicId](../../aspose.svg.dom/entity/publicid/) { get; } | De publieke identifier die aan de entiteit is gekoppeld, indien gespecificeerd, en anders null. |
| [SystemId](../../aspose.svg.dom/entity/systemid/) { get; } | De systeem-ID die aan de entiteit is gekoppeld, indien gespecificeerd, en anders null. Dit kan een absolute URI zijn of niet. |
...
| [XmlEncoding](../../aspose.svg.dom/entity/xmlencoding/) { get; } | Een attribuut dat, als onderdeel van de tekstdeclaratie, de codering van deze entiteit specificeert, wanneer het een externe geparseerde entiteit is. Dit is anders nul. |
| [XmlVersion](../../aspose.svg.dom/entity/xmlversion/) { get; } | Een attribuut dat, als onderdeel van de tekstdeclaratie, het versienummer van deze entiteit specificeert, wanneer het een externe geparseerde entiteit is. Dit is anders nul. |
