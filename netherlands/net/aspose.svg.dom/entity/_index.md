...
description: "Aspose.Svg.Dom.Entity klasse. Vertegenwoordigt een bekende entiteit, geparseerd of niet‑geparseerd, in een XML‑document."
type: docs
weight: 2850
url: /nl/net/aspose.svg.dom/entity/
---
## Entity class

Vertegenwoordigt een bekende entiteit, geparseerd of niet-geparseerd, in een XML-document.
...
| [InputEncoding](../../aspose.svg.dom/entity/inputencoding/) { get; } | Een attribuut dat de codering specificeert die voor deze entiteit wordt gebruikt op het moment van ontleden, wanneer het een externe geparseerde entiteit is. Dit is null als het een entiteit uit de interne subset is of als het onbekend is. |
...
| override [NodeName](../../aspose.svg.dom/entity/nodename/) { get; } | De naam van dit knooppunt, afhankelijk van het type. |
| override [NodeType](../../aspose.svg.dom/entity/nodetype/) { get; } | Een code die het type van het onderliggende object vertegenwoordigt. |
| virtual [NodeValue](../../aspose.svg.dom/node/nodevalue/) { get; set; } | Retourneert of stelt de waarde van het huidige knooppunt in. |
| [NotationName](../../aspose.svg.dom/entity/notationname/) { get; } | Voor niet‑geparseerde entiteiten, de naam van de notatie voor de entiteit. Voor geparseerde entiteiten is dit null. |
...
| [PublicId](../../aspose.svg.dom/entity/publicid/) { get; } | De openbare identifier die aan de entiteit is gekoppeld indien gespecificeerd, anders null. |
| [SystemId](../../aspose.svg.dom/entity/systemid/) { get; } | De systeemidentifier die aan de entiteit is gekoppeld indien gespecificeerd, anders null. Dit kan een absolute URI zijn of niet. |
...
| [XmlEncoding](../../aspose.svg.dom/entity/xmlencoding/) { get; } | Een attribuut dat, als onderdeel van de tekstdeclaratie, de codering van deze entiteit specificeert wanneer het een externe geparseerde entiteit is. Dit is anders null. |
| [XmlVersion](../../aspose.svg.dom/entity/xmlversion/) { get; } | Een attribuut dat, als onderdeel van de tekstdeclaratie, het versienummer van deze entiteit specificeert wanneer het een externe geparseerde entiteit is. Dit is anders null. |
