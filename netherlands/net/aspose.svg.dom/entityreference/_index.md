...
description: "Aspose.Svg.Dom.EntityReference-klasse. EntityReference-knooppunten kunnen worden gebruikt om een entiteitsreferentie in de boom weer te geven."
type: docs
weight: 2860
url: /nl/net/aspose.svg.dom/entityreference/
---
## EntityReference class

EntityReference-knooppunten kunnen worden gebruikt om een entiteitsreferentie in de boom te vertegenwoordigen.
...
| override [NodeName](../../aspose.svg.dom/entityreference/nodename/) { get; } | De naam van dit knooppunt, afhankelijk van het type. |
| override [NodeType](../../aspose.svg.dom/entityreference/nodetype/) { get; } | Een code die het type van het onderliggende object vertegenwoordigt. |
