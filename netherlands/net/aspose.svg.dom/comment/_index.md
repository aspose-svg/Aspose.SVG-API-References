...
description: Aspose.Svg.Dom.Comment klas. Neemt over van CharacterData en vertegenwoordigt de inhoud van een opmerking dwz alle tekens tussen het begin  .
type: docs
weight: 460
url: /nl/net/aspose.svg.dom/comment/
---
## Comment class
...
| override [NodeName](../../aspose.svg.dom/comment/nodename/) { get; } | De naam van dit knooppunt, afhankelijk van het type. |
| override [NodeType](../../aspose.svg.dom/comment/nodetype/) { get; } | Een code die het type van het onderliggende object vertegenwoordigt. |
| override [NodeValue](../../aspose.svg.dom/comment/nodevalue/) { get; set; } | De waarde van dit knooppunt, afhankelijk van het type. |
