...
description: "Aspose.Svg.Dom.Notation class. Vertegenwoordigt een notatie die in de DTD is gedeclareerd."
type: docs
weight: 3150
url: /nl/net/aspose.svg.dom/notation/
---
## Notation class
...
| override [NodeName](../../aspose.svg.dom/notation/nodename/) { get; } | De naam van dit knooppunt, afhankelijk van het type. |
| override [NodeType](../../aspose.svg.dom/notation/nodetype/) { get; } | Een code die het type van het onderliggende object vertegenwoordigt. |
...
| [PublicId](../../aspose.svg.dom/notation/publicid/) { get; } | De openbare identifier van deze notatie. Als de openbare identifier niet is opgegeven, is dit null. |
| [SystemId](../../aspose.svg.dom/notation/systemid/) { get; } | De systeemidentifier van deze notatie. Als de systeemidentifier niet is opgegeven, is dit null. Dit kan een absolute URI zijn of niet. |
