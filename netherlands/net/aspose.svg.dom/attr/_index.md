...
description: Aspose.Svg.Dom.Attr klas. De Attrinterface vertegenwoordigt een attribuut in een Elementobject. Meestal worden de toegestane waarden voor het kenmerk gedefinieerd in een schema dat aan het document is gekoppeld.
type: docs
weight: 350
...
| [IsId](../../aspose.svg.dom/attr/isid/) { get; } | Retourneert of bekend is dat dit attribuut van het type ID is (dwz dat het een identifier bevat voor het eigenaarselement) of niet. |
...
| override [LocalName](../../aspose.svg.dom/attr/localname/) { get; } | Retourneert het lokale deel van de gekwalificeerde naam van dit knooppunt. Voor knooppunten van een ander type dan ELEMENT_NODE en ATTRIBUTE_NODE en knooppunten gemaakt met een DOM Level 1-methode, zoals Document.createElement(), is dit altijd null. |
| [Name](../../aspose.svg.dom/attr/name/) { get; } | Retourneert de naam van dit attribuut. |
| override [NamespaceURI](../../aspose.svg.dom/attr/namespaceuri/) { get; } | De naamruimte-URI van dit knooppunt, of null als deze niet is gespecificeerd. |
...
| [OwnerElement](../../aspose.svg.dom/attr/ownerelement/) { get; } | Het elementknooppunt waaraan dit attribuut is gekoppeld of null als dit attribuut niet in gebruik is. |
...
| override [Prefix](../../aspose.svg.dom/attr/prefix/) { get; } | Het naamruimtevoorvoegsel van dit knooppunt, of null als het niet is gespecificeerd. Als het is gedefinieerd als null, heeft het instellen ervan geen effect |
...
| [SchemaTypeInfo](../../aspose.svg.dom/attr/schematypeinfo/) { get; } | De type-informatie die aan dit attribuut is gekoppeld. |
| [Specified](../../aspose.svg.dom/attr/specified/) { get; } | Waar als dit attribuut expliciet een waarde heeft gekregen in het instantiedocument, anders onwaar. |
