...
description: Aspose.Svg.Dom.CharacterData klas. De CharacterData breidt Node uit met een set attributen en methoden voor toegang tot karaktergegevens in de DOM.
type: docs
weight: 450
