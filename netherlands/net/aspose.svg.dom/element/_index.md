...
description: Aspose.Svg.Dom.Element klas. De Elementinterface vertegenwoordigt een element in een HTML of XMLdocument.
type: docs
weight: 840
...
| [Id](../../aspose.svg.dom/element/id/) { get; set; } | De identificatie van het element. Zie de definitie van het id-kenmerk in HTML 4.01. |
...
| [ParentElement](../../aspose.svg.dom/node/parentelement/) { get; } | Haalt de ouder op`Element` van dit knooppunt. |
