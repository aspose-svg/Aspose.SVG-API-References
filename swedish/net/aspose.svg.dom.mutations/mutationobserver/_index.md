...
description: AMutationObserver./mutationobserver objekt kan användas för att observera mutationer i trädet avNode../aspose.svg.dom/node .
type: docs
weight: 1120
...
A[`MutationObserver`](../mutationobserver) objekt kan användas för att observera mutationer i trädet av[`Node`](../../aspose.svg.dom/node) .
