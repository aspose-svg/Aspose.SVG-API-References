...
description: En surrogatström omsluter den verkliga utströmmen och kontrollerar åtkomsten till den. OutputStream./outputstream innehåller URIdata som beskriver platsen för utgångsströmmen.
type: docs
weight: 1980
...
En surrogatström omsluter den verkliga utströmmen och kontrollerar åtkomsten till den. [`OutputStream`](../outputstream) innehåller URI-data som beskriver platsen för utgångsströmmen.
...
| namn | Beskrivning |
| --- | --- |
| [OutputStream](outputstream)(Stream, string) | Initierar en ny instans av[`OutputStream`](../outputstream) class. |
