...
| namn | Beskrivning |
| --- | --- |
| [PdfEncryptionInfo](pdfencryptioninfo)(string, string, PdfPermissions, PdfEncryptionAlgorithm) | Initierar en ny instans av[`PdfEncryptionInfo`](../pdfencryptioninfo) class. |
