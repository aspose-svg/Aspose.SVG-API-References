...
description: Rotobjektet för varje användningselements skuggaträd implementerar SVGUseElementShadowRootgränssnittet. Det här gränssnittet definierar för närvarande inga tillägg till egenskaperna och metoderna som definierats för ShadowRootgränssnittet och DocumentOrShadowRootmixin. Trädet som är rotat vid denna nod är dock helt skrivskyddat ur perspektivet för författarens skript.
type: docs
weight: 3160
