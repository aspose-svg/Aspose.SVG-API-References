...
description: Aspose.Svg.SVGGeometryElement klass. Gränssnitt SVGGeometryElement representerar SVGelement vars rendering definieras av geometri med en ekvivalent bana och som kan fyllas och strökas. Detta inkluderar banor och de grundläggande formerna.
type: docs
weight: 3270
...
| [GetEquivalentPath](../../aspose.svg/svggeometryelement/getequivalentpath/)() | Returnerar en ny instans av[`SVGPathSegList`](../../aspose.svg.paths/svgpathseglist/) som representerar`SVGGeometryElement` som vägsegment. |
