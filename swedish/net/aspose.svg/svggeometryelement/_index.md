...
description: "Aspose.Svg.SVGGeometryElement-klass. Gränssnittet SVGGeometryElement representerar SVG-element vars rendering definieras av geometri med en motsvarande bana och som kan fyllas och kontureras. Detta inkluderar banor och de grundläggande formerna."
type: docs
weight: 5340
url: /sv/net/aspose.svg/svggeometryelement/
---
...
| [Combine](../../aspose.svg/svggeometryelement/combine/)(*SVGGeometryElement, [BooleanPathOp](../../aspose.svg.rendering/booleanpathop/)*) | Kombinerar denna geometri med en annan SVG-geometri med en boolesk operation och returnerar ett nytt `<path>`-element som innehåller resultatet. |
...
| [GetEquivalentPath](../../aspose.svg/svggeometryelement/getequivalentpath/)() | Returnerar en ny instans av [`SVGPathSegList`](../../aspose.svg.paths/svgpathseglist/) som representerar `SVGGeometryElement` som bansegment. |
