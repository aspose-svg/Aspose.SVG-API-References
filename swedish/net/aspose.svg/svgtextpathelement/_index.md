...
description: "Aspose.Svg.SVGTextPathElement-klass. SVGTextPathElement-gränssnittet motsvarar textPath-elementet"
type: docs
weight: 5610
url: /sv/net/aspose.svg/svgtextpathelement/
---
...
| [Href](../../aspose.svg/svgtextpathelement/href/) { get; } | Motsvarar attributet ‘xlink:href’ på det angivna elementet. |
...
| [LengthAdjust](../../aspose.svg/svgtextcontentelement/lengthadjust/) { get; } | Motsvarar attributet ‘lengthAdjust’ på det angivna elementet. Värdet måste vara en av de längdadjusteringskonstanter som definieras i detta gränssnitt. |
...
| [Method](../../aspose.svg/svgtextpathelement/method/) { get; } | Motsvarar attributet ‘method’ på det angivna ‘textPath’-elementet. |
...
| [Spacing](../../aspose.svg/svgtextpathelement/spacing/) { get; } | Motsvarar attributet ‘spacing’ på det angivna ‘textPath’-elementet. |
| [StartOffset](../../aspose.svg/svgtextpathelement/startoffset/) { get; } | Motsvarar attributet ‘startOffset’ på det angivna ‘textPath’-elementet. |
...
| [TextLength](../../aspose.svg/svgtextcontentelement/textlength/) { get; } | Motsvarar attributet ‘textLength’ på det angivna elementet. |
...
| [GetComputedTextLength](../../aspose.svg/svgtextcontentelement/getcomputedtextlength/)() | Den totala summan av alla förskjutningsvärden från rendering av alla tecken inom detta element, inklusive förskjutningsvärdet på glyferna (horisontellt eller vertikalt), effekten av egenskaperna ‘kerning’, ‘letter-spacing’ och ‘word-spacing’ samt justeringar på grund av attributen ‘dx’ och ‘dy’ på ‘tspan’-element. För icke-renderande miljöer ska användaragenten göra rimliga antaganden om glyfmetrik. |
...
| Namn | Beskrivning |
| --- | --- |
| const [TEXTPATH_METHODTYPE_ALIGN](../../aspose.svg/svgtextpathelement/textpath_methodtype_align/) | Motsvarar värdet 'align'. |
| const [TEXTPATH_METHODTYPE_STRETCH](../../aspose.svg/svgtextpathelement/textpath_methodtype_stretch/) | Motsvarar värdet 'stretch'. |
| const [TEXTPATH_METHODTYPE_UNKNOWN](../../aspose.svg/svgtextpathelement/textpath_methodtype_unknown/) | Uppräkningen sattes till ett värde som inte är en av de fördefinierade typerna. Det är ogiltigt att försöka definiera ett nytt värde av denna typ eller att försöka byta ett befintligt värde till denna typ. |
| const [TEXTPATH_SPACINGTYPE_AUTO](../../aspose.svg/svgtextpathelement/textpath_spacingtype_auto/) | Motsvarar värdet 'auto'. |
| const [TEXTPATH_SPACINGTYPE_EXACT](../../aspose.svg/svgtextpathelement/textpath_spacingtype_exact/) | Motsvarar värdet 'exact'. |
| const [TEXTPATH_SPACINGTYPE_UNKNOWN](../../aspose.svg/svgtextpathelement/textpath_spacingtype_unknown/) | Uppräkningen sattes till ett värde som inte är en av de fördefinierade typerna. Det är ogiltigt att försöka definiera ett nytt värde av denna typ eller att försöka byta ett befintligt värde till denna typ. |
