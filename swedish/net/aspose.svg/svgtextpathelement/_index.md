...
description: Aspose.Svg.SVGTextPathElement klass. SVGTextPathElementgränssnittet motsvarar elementet textPath.
type: docs
weight: 3540
...
| [Href](../../aspose.svg/svgtextpathelement/href/) { get; } | Motsvarar attributet 'xlink:href' på det givna elementet. |
...
| [LengthAdjust](../../aspose.svg/svgtextcontentelement/lengthadjust/) { get; } | Motsvarar attributet 'lengthAdjust' på det givna elementet. Värdet måste vara en av längdjusteringskonstanterna som definieras i detta gränssnitt. |
...
| [Method](../../aspose.svg/svgtextpathelement/method/) { get; } | Motsvarar attributet 'metod' på det givna 'textPath'-elementet. |
...
| [Spacing](../../aspose.svg/svgtextpathelement/spacing/) { get; } | Motsvarar attributet 'mellanrum' på det givna 'textPath'-elementet. |
| [StartOffset](../../aspose.svg/svgtextpathelement/startoffset/) { get; } | Motsvarar attributet 'startOffset' på det givna 'textPath'-elementet. |
...
| [TextLength](../../aspose.svg/svgtextcontentelement/textlength/) { get; } | Motsvarar attributet 'textLength' på det givna elementet. |
...
| const [TEXTPATH_METHODTYPE_UNKNOWN](../../aspose.svg/svgtextpathelement/textpath_methodtype_unknown/) | Uppräkningen sattes till ett värde som inte är en av fördefinierade typer. Det är ogiltigt att försöka definiera ett nytt värde av denna typ eller att försöka ändra ett befintligt värde till denna typ. |
| const [TEXTPATH_SPACINGTYPE_AUTO](../../aspose.svg/svgtextpathelement/textpath_spacingtype_auto/) | Motsvarar värdet 'auto'. |
| const [TEXTPATH_SPACINGTYPE_EXACT](../../aspose.svg/svgtextpathelement/textpath_spacingtype_exact/) | Motsvarar värdet 'exakt'. |
| const [TEXTPATH_SPACINGTYPE_UNKNOWN](../../aspose.svg/svgtextpathelement/textpath_spacingtype_unknown/) | Uppräkningen sattes till ett värde som inte är en av fördefinierade typer. Det är ogiltigt att försöka definiera ett nytt värde av denna typ eller att försöka ändra ett befintligt värde till denna typ. |
