...
description: Aspose.Svg.SVGGradientElement klass. SVGGradientElementgränssnittet är ett basgränssnitt som används av SVGLinearGradientElement och SVGRadialGradientElement.
type: docs
weight: 3280
...
| const [SVG_SPREADMETHOD_REFLECT](../../aspose.svg/svggradientelement/svg_spreadmethod_reflect/) | Motsvarar värdet 'reflektera'. |
| const [SVG_SPREADMETHOD_REPEAT](../../aspose.svg/svggradientelement/svg_spreadmethod_repeat/) | Motsvarar värdet 'repetera'. |
| const [SVG_SPREADMETHOD_UNKNOWN](../../aspose.svg/svggradientelement/svg_spreadmethod_unknown/) | Typen är inte en av fördefinierade typer. Det är ogiltigt att försöka definiera ett nytt värde av denna typ eller att försöka ändra ett befintligt värde till denna typ. |
