...
description: "Aspose.Svg.SVGGradientElement-klass. SVGGradientElement-gränssnittet är ett basgränssnitt som används av SVGLinearGradientElement och SVGRadialGradientElement."
type: docs
weight: 5350
url: /sv/net/aspose.svg/svggradientelement/
---
## SVGGradientElement class

Gränssnittet SVGGradientElement är ett basgränssnitt som används av SVGLinearGradientElement och SVGRadialGradientElement.
...
| [GradientTransform](../../aspose.svg/svggradientelement/gradienttransform/) { get; } | Motsvarar attributet ‘gradientTransform’ på det givna elementet. |
| [GradientUnits](../../aspose.svg/svggradientelement/gradientunits/) { get; } | Motsvarar attributet ‘gradientUnits’ på det givna elementet. Tar en av de konstanter som definieras i SVGUnitTypes. |
| [Href](../../aspose.svg/svggradientelement/href/) { get; } | Motsvarar attributet ‘xlink:href’ på det angivna elementet. |
...
| [SpreadMethod](../../aspose.svg/svggradientelement/spreadmethod/) { get; } | Motsvarar attributet ‘spreadMethod’ på det givna elementet. En av de spridningsmetodtyper som definieras i detta gränssnitt. |
...
| Namn | Beskrivning |
| --- | --- |
| const [SVG_SPREADMETHOD_PAD](../../aspose.svg/svggradientelement/svg_spreadmethod_pad/) | Motsvarar värdet 'pad'. |
| const [SVG_SPREADMETHOD_REFLECT](../../aspose.svg/svggradientelement/svg_spreadmethod_reflect/) | Motsvarar värdet 'reflect'. |
| const [SVG_SPREADMETHOD_REPEAT](../../aspose.svg/svggradientelement/svg_spreadmethod_repeat/) | Motsvarar värdet 'repeat'. |
| const [SVG_SPREADMETHOD_UNKNOWN](../../aspose.svg/svggradientelement/svg_spreadmethod_unknown/) | Typen är inte en av de fördefinierade typerna. Det är ogiltigt att försöka definiera ett nytt värde av denna typ eller att försöka byta ett befintligt värde till denna typ. |
