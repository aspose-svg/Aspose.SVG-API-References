...
description: "Aspose.Svg.SVGComponentTransferFunctionElement-klass. Detta gränssnitt definierar ett basgränssnitt som används av komponentöverföringsfunktionens gränssnitt."
type: docs
weight: 5220
url: /sv/net/aspose.svg/svgcomponenttransferfunctionelement/
---
## SVGComponentTransferFunctionElement class

Detta gränssnitt definierar ett basgränssnitt som används av komponentens överföringsfunktionsgränssnitt.
...
| Namn | Beskrivning |
| --- | --- |
| [Amplitude](../../aspose.svg/svgcomponenttransferfunctionelement/amplitude/) { get; } | Motsvarar attributet ‘amplitude’ på det givna elementet. |
...
| [Exponent](../../aspose.svg/svgcomponenttransferfunctionelement/exponent/) { get; } | Motsvarar attributet ‘exponent’ på det givna elementet. |
...
| [Intercept](../../aspose.svg/svgcomponenttransferfunctionelement/intercept/) { get; } | Motsvarar attributet ‘intercept’ på det givna elementet. |
...
| [Offset](../../aspose.svg/svgcomponenttransferfunctionelement/offset/) { get; } | Motsvarar attributet ‘offset’ på det givna elementet. |
...
| [Slope](../../aspose.svg/svgcomponenttransferfunctionelement/slope/) { get; } | Motsvarar attributet ‘slope’ på det givna elementet. |
...
| [TableValues](../../aspose.svg/svgcomponenttransferfunctionelement/tablevalues/) { get; } | Motsvarar attributet ‘tableValues’ på det givna elementet. |
...
| [Type](../../aspose.svg/svgcomponenttransferfunctionelement/type/) { get; } | Motsvarar attributet ‘type’ på det givna elementet. Accepterar en av SVG_FECOMPONENTTRANSFER_TYPE_*-konstanterna som definieras i detta gränssnitt. |
...
| Namn | Beskrivning |
| --- | --- |
| const [SVG_FECOMPONENTTRANSFER_TYPE_DISCRETE](../../aspose.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_discrete/) | Motsvarar värdet 'discrete'. |
| const [SVG_FECOMPONENTTRANSFER_TYPE_GAMMA](../../aspose.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_gamma/) | Motsvarar värdet 'gamma'. |
| const [SVG_FECOMPONENTTRANSFER_TYPE_IDENTITY](../../aspose.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_identity/) | Motsvarar värdet 'identity'. |
| const [SVG_FECOMPONENTTRANSFER_TYPE_LINEAR](../../aspose.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_linear/) | Motsvarar värdet 'linear'. |
| const [SVG_FECOMPONENTTRANSFER_TYPE_TABLE](../../aspose.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_table/) | Motsvarar värdet 'table'. |
| const [SVG_FECOMPONENTTRANSFER_TYPE_UNKNOWN](../../aspose.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_unknown/) | Typen är inte en av de fördefinierade typerna. Det är ogiltigt att försöka definiera ett nytt värde av denna typ eller att försöka byta ett befintligt värde till denna typ. |
