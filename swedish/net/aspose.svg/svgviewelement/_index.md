...
description: Aspose.Svg.SVGViewElement klass. SVGViewElementgränssnittet motsvarar viewelementet.
type: docs
weight: 3590
...
| [ViewTarget](../../aspose.svg/svgviewelement/viewtarget/) { get; } | Motsvarar attributet 'viewTarget' på det givna 'view'-elementet. En lista med DOMString-värden som innehåller namnen som anges i attributet 'viewTarget'. Vart och ett av DOMString-värdena kan associeras med motsvarande element med metoden getElementById() call. |
| [ZoomAndPan](../../aspose.svg/svgviewelement/zoomandpan/) { get; set; } | Motsvarar attributet 'zoomAndPan' på det givna elementet. Värdet måste vara en av SVG_ZOOMANDPAN_*-konstanterna som definierats i detta gränssnitt. |
