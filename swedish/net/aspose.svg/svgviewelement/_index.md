...
description: "Aspose.Svg.SVGViewElement-klass. SVGViewElement-gränssnittet motsvarar view-elementet."
type: docs
weight: 5660
url: /sv/net/aspose.svg/svgviewelement/
---
...
| [PreserveAspectRatio](../../aspose.svg/svgviewelement/preserveaspectratio/) { get; } | Motsvarar attributet ‘preserveAspectRatio’ på det givna elementet. |
...
| [ViewBox](../../aspose.svg/svgviewelement/viewbox/) { get; } | Motsvarar attributet ‘viewBox’ på det givna elementet. |
...
| [ViewTarget](../../aspose.svg/svgviewelement/viewtarget/) { get; } | Motsvarar attributet ‘viewTarget’ på det angivna ‘view’-elementet. En lista med DOMString‑värden som innehåller namnen som anges i ‘viewTarget’-attributet. Varje DOMString‑värde kan associeras med motsvarande element genom att anropa getElementById()-metoden. |
| [ZoomAndPan](../../aspose.svg/svgviewelement/zoomandpan/) { get; set; } | Motsvarar attributet ‘zoomAndPan’ på det givna elementet. Värdet måste vara en av SVG_ZOOMANDPAN_*-konstanterna som definieras i detta gränssnitt. |
