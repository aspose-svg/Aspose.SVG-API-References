...
description: Aspose.Svg.SVGMaskElement klass. SVGMaskElementgränssnittet motsvarar maskelementet.
type: docs
weight: 3350
...
| [Height](../../aspose.svg/svgmaskelement/height/) { get; } | Motsvarar attributet 'höjd' på det givna 'mask'-elementet. Tar en av konstanterna definierade i SVGUnitTypes. |
...
| [MaskContentUnits](../../aspose.svg/svgmaskelement/maskcontentunits/) { get; } | Motsvarar attributet 'maskContentUnits' på det givna 'mask'-elementet. Tar en av konstanterna definierade i SVGUnitTypes. |
| [MaskUnits](../../aspose.svg/svgmaskelement/maskunits/) { get; } | Motsvarar attributet 'maskUnits' på det givna 'mask'-elementet. Tar en av konstanterna definierade i SVGUnitTypes. |
...
| [Width](../../aspose.svg/svgmaskelement/width/) { get; } | Motsvarar attributet 'width' på det givna 'mask'-elementet. Tar en av konstanterna definierade i SVGUnitTypes. |
| [X](../../aspose.svg/svgmaskelement/x/) { get; } | Motsvarar attributet 'x' på det givna 'mask'-elementet. Tar en av konstanterna definierade i SVGUnitTypes. |
| [Y](../../aspose.svg/svgmaskelement/y/) { get; } | Motsvarar attributet 'y' på det givna 'mask'-elementet. Tar en av konstanterna definierade i SVGUnitTypes. |
