...
description: "Aspose.Svg.SVGMaskElement-klass. SVGMaskElement-gränssnittet motsvarar mask-elementet"
type: docs
weight: 5420
url: /sv/net/aspose.svg/svgmaskelement/
---
## SVGMaskElement class

Gränssnittet SVGMaskElement motsvarar elementet ‘mask’.
...
| [Height](../../aspose.svg/svgmaskelement/height/) { get; } | Motsvarar attributet ‘height’ på det angivna ‘mask’-elementet. Tar en av de konstanter som definieras i SVGUnitTypes. |
...
| [MaskContentUnits](../../aspose.svg/svgmaskelement/maskcontentunits/) { get; } | Motsvarar attributet ‘maskContentUnits’ på det angivna ‘mask’-elementet. Tar en av de konstanter som definieras i SVGUnitTypes. |
| [MaskUnits](../../aspose.svg/svgmaskelement/maskunits/) { get; } | Motsvarar attributet ‘maskUnits’ på det angivna ‘mask’-elementet. Tar en av de konstanter som definieras i SVGUnitTypes. |
...
| [RequiredExtensions](../../aspose.svg/svgmaskelement/requiredextensions/) { get; } | Motsvarar attributet ‘requiredExtensions’ på det givna elementet. |
| [RequiredFeatures](../../aspose.svg/svgmaskelement/requiredfeatures/) { get; } | Motsvarar attributet ‘requiredFeatures’ på det givna elementet. |
...
| [SystemLanguage](../../aspose.svg/svgmaskelement/systemlanguage/) { get; } | Motsvarar attributet ‘systemLanguage’ på det givna elementet. |
...
| [Width](../../aspose.svg/svgmaskelement/width/) { get; } | Motsvarar attributet ‘width’ på det angivna ‘mask’-elementet. Tar en av de konstanter som definieras i SVGUnitTypes. |
| [X](../../aspose.svg/svgmaskelement/x/) { get; } | Motsvarar attributet ‘x’ på det angivna ‘mask’-elementet. Tar en av de konstanter som definieras i SVGUnitTypes. |
| [Y](../../aspose.svg/svgmaskelement/y/) { get; } | Motsvarar attributet ‘y’ på det angivna ‘mask’-elementet. Tar en av de konstanter som definieras i SVGUnitTypes. |
