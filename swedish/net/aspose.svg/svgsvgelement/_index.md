...
| [CurrentScale](../../aspose.svg/svgsvgelement/currentscale/) { get; set; } | På ett yttersta svg‑element anger detta attribut den aktuella skalningsfaktorn i förhållande till den ursprungliga vyn för att ta hänsyn till användarmagnifiering och panorering, enligt beskrivningen under Magnification and panning. DOM‑attributen currentScale och currentTranslate är ekvivalenta med 2x3‑matrisen [a b c d e f] = [currentScale 0 0 currentScale currentTranslate.x currentTranslate.y]. Om "magnification" är aktiverat (dvs. zoomAndPan="magnify"), blir effekten som om en extra transformation placerades på den yttersta nivån i SVG‑dokumentfragmentet (dvs. utanför det yttersta svg‑elementet). När det nås på ett ‘svg’-element som inte är ett ytterst svg‑element, är det odefinierat vilket beteende detta attribut har. |
| [CurrentTranslate](../../aspose.svg/svgsvgelement/currenttranslate/) { get; } | På ett yttersta svg‑element är detta motsvarande translationsfaktor som tar hänsyn till användar‑"magnification". När det nås på ett ‘svg’-element som inte är ett ytterst svg‑element, är det odefinierat vilket beteende detta attribut har. |
...
| [Height](../../aspose.svg/svgsvgelement/height/) { get; } | Motsvarar attributet ‘height’ på det givna ‘svg’-elementet. |
...
| [ZoomAndPan](../../aspose.svg/svgsvgelement/zoomandpan/) { get; set; } | Motsvarar attributet ‘zoomAndPan’ på det givna elementet. Värdet måste vara en av SVG_ZOOMANDPAN_*-konstanterna som definieras i detta gränssnitt. |
...
| [AnimationsPaused](../../aspose.svg/svgsvgelement/animationspaused/)() | Returnerar true om detta SVG-dokumentfragment är i ett pausat tillstånd. |
...
| [CreateEvent](../../aspose.svg/svgsvgelement/createevent/)(*string*) | Skapar ett [`Event`](../../aspose.svg.dom.events/event/) av en typ som stöds av implementationen. |
| [CreateSVGAngle](../../aspose.svg/svgsvgelement/createsvgangle/)() | Skapar ett SVGAngle-objekt utanför alla dokumentträd. Objektet initieras till värdet 0 grader (utan enhet). |
...
| [CreateSVGPoint](../../aspose.svg/svgsvgelement/createsvgpoint/)() | Skapar ett SVGPoint-objekt utanför alla dokumentträd. Objektet initieras till punkten (0,0) i användarkoordinatsystemet. |
...
| [CreateSVGTransformFromMatrix](../../aspose.svg/svgsvgelement/createsvgtransformfrommatrix/)(*[SVGMatrix](../../aspose.svg.datatypes/svgmatrix/)*) | Skapar ett SVGTransform-objekt utanför alla dokumentträd. Objektet initieras till den angivna matrisomvandlingen (dvs. SVG_TRANSFORM_MATRIX). Värdena från parameter‑matrisen kopieras, matris‑parametern antas inte som SVGTransform::matrix. |
...
| [PauseAnimations](../../aspose.svg/svgsvgelement/pauseanimations/)() | Suspenderar (dvs. pausar) alla för närvarande körande animationer som är definierade inom SVG-dokumentfragmentet som motsvarar detta ‘svg’-element, vilket får animationsklockan för detta dokumentfragment att stå stilla tills den återupptas. |
...
| [UnpauseAnimations](../../aspose.svg/svgsvgelement/unpauseanimations/)() | Återupptar (dvs. avpausar) för närvarande körande animationer som är definierade inom SVG-dokumentfragmentet, vilket får animationsklockan att fortsätta från den tidpunkt då den suspenderades. |
