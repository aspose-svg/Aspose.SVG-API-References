...
description: Skapar ett SVGTransformobjekt utanför alla dokumentträd. Objektet initieras till den givna matristransformen dvs SVG_TRANSFORM_MATRIX. Värdena från parametermatrisen kopieras matrisparametern används inte som SVGTransformmatrix.
type: docs
weight: 190
