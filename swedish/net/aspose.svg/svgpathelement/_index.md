...
description: "Aspose.Svg.SVGPathElement-klass. SVGPathElement-gränssnittet motsvarar path-elementet"
type: docs
weight: 5440
url: /sv/net/aspose.svg/svgpathelement/
---
## SVGPathElement class

Gränssnittet SVGPathElement motsvarar elementet ‘path’.
...
| [FarthestViewportElement](../../aspose.svg/svggraphicselement/farthestviewportelement/) { get; } | Det längst bakligaste förfäders‑‘svg’-elementet. Null om det aktuella elementet är det yttersta svg‑elementet. |
...
| [NearestViewportElement](../../aspose.svg/svggraphicselement/nearestviewportelement/) { get; } | Elementet som etablerade den aktuella viewporten. Ofta det närmaste förfäders‑‘svg’-elementet. Null om det aktuella elementet är det yttersta svg‑elementet. |
...
| [PathLength](../../aspose.svg/svggeometryelement/pathlength/) { get; } | Motsvarar attributet pathLength på det angivna elementet. |
| [PathSegList](../../aspose.svg/svgpathelement/pathseglist/) { get; set; } | Tillhandahåller åtkomst till de grundläggande (dvs. statiska) innehållen i ‘d’-attributet i ett format som matchar en‑till‑en med SVG:s syntax. Således, om ‘d’-attributet har ett \"absolut moveto (M)\" och ett \"absolut arcto (A)\"‑kommando, kommer pathSegList att ha två poster: ett SVG_PATHSEG_MOVETO_ABS och ett SVG_PATHSEG_ARC_ABS. |
...
| [Transform](../../aspose.svg/svggraphicselement/transform/) { get; } | Motsvarar attributet ‘transform’ på det angivna elementet. |
...
| [Combine](../../aspose.svg/svggeometryelement/combine/)(*[SVGGeometryElement](../svggeometryelement/), [BooleanPathOp](../../aspose.svg.rendering/booleanpathop/)*) | Kombinerar denna geometri med en annan SVG-geometri med en boolesk operation och returnerar ett nytt `<path>`-element som innehåller resultatet. |
| [CreateSVGPathSegArcAbs](../../aspose.svg/svgpathelement/createsvgpathsegarcabs/)(*float, float, float, float, float, bool, bool*) | Returnerar ett fristående, föräldralöst SVGPathSegArcAbs-objekt. |
| [CreateSVGPathSegArcRel](../../aspose.svg/svgpathelement/createsvgpathsegarcrel/)(*float, float, float, float, float, bool, bool*) | Returnerar ett fristående, föräldralöst SVGPathSegArcRel-objekt. |
| [CreateSVGPathSegClosePath](../../aspose.svg/svgpathelement/createsvgpathsegclosepath/)() | Returnerar ett fristående, föräldralöst SVGPathSegClosePath-objekt. |
| [CreateSVGPathSegCurvetoCubicAbs](../../aspose.svg/svgpathelement/createsvgpathsegcurvetocubicabs/)(*float, float, float, float, float, float*) | Returnerar ett fristående, föräldralöst SVGPathSegCurvetoCubicAbs-objekt. |
| [CreateSVGPathSegCurvetoCubicRel](../../aspose.svg/svgpathelement/createsvgpathsegcurvetocubicrel/)(*float, float, float, float, float, float*) | Returnerar ett fristående, föräldralöst SVGPathSegCurvetoCubicRel-objekt. |
| [CreateSVGPathSegCurvetoCubicSmoothAbs](../../aspose.svg/svgpathelement/createsvgpathsegcurvetocubicsmoothabs/)(*float, float, float, float*) | Returnerar ett fristående, föräldralöst SVGPathSegCurvetoCubicSmoothAbs-objekt. |
| [CreateSVGPathSegCurvetoCubicSmoothRel](../../aspose.svg/svgpathelement/createsvgpathsegcurvetocubicsmoothrel/)(*float, float, float, float*) | Returnerar ett fristående, föräldralöst SVGPathSegCurvetoCubicSmoothRel-objekt. |
| [CreateSVGPathSegCurvetoQuadraticAbs](../../aspose.svg/svgpathelement/createsvgpathsegcurvetoquadraticabs/)(*float, float, float, float*) | Returnerar ett fristående, föräldralöst SVGPathSegCurvetoQuadraticAbs-objekt. |
| [CreateSVGPathSegCurvetoQuadraticRel](../../aspose.svg/svgpathelement/createsvgpathsegcurvetoquadraticrel/)(*float, float, float, float*) | Returnerar ett fristående, föräldralöst SVGPathSegCurvetoQuadraticRel-objekt. |
| [CreateSVGPathSegCurvetoQuadraticSmoothAbs](../../aspose.svg/svgpathelement/createsvgpathsegcurvetoquadraticsmoothabs/)(*float, float*) | Returnerar ett fristående, föräldralöst SVGPathSegCurvetoQuadraticSmoothAbs-objekt. |
| [CreateSVGPathSegCurvetoQuadraticSmoothRel](../../aspose.svg/svgpathelement/createsvgpathsegcurvetoquadraticsmoothrel/)(*float, float*) | Returnerar ett fristående, föräldralöst SVGPathSegCurvetoQuadraticSmoothRel-objekt. |
| [CreateSVGPathSegLinetoAbs](../../aspose.svg/svgpathelement/createsvgpathseglinetoabs/)(*float, float*) | Returnerar ett fristående, föräldralöst SVGPathSegLinetoAbs-objekt. |
| [CreateSVGPathSegLinetoHorizontalAbs](../../aspose.svg/svgpathelement/createsvgpathseglinetohorizontalabs/)(*float*) | Returnerar ett fristående, föräldralöst SVGPathSegLinetoHorizontalAbs-objekt. |
| [CreateSVGPathSegLinetoHorizontalRel](../../aspose.svg/svgpathelement/createsvgpathseglinetohorizontalrel/)(*float*) | Returnerar ett fristående, föräldralöst SVGPathSegLinetoHorizontalRel-objekt. |
| [CreateSVGPathSegLinetoRel](../../aspose.svg/svgpathelement/createsvgpathseglinetorel/)(*float, float*) | Returnerar ett fristående, föräldralöst SVGPathSegLinetoRel-objekt. |
| [CreateSVGPathSegLinetoVerticalAbs](../../aspose.svg/svgpathelement/createsvgpathseglinetoverticalabs/)(*float*) | Returnerar ett fristående, föräldralöst SVGPathSegLinetoVerticalAbs-objekt. |
| [CreateSVGPathSegLinetoVerticalRel](../../aspose.svg/svgpathelement/createsvgpathseglinetoverticalrel/)(*float*) | Returnerar ett fristående, föräldralöst SVGPathSegLinetoVerticalRel-objekt. |
| [CreateSVGPathSegMovetoAbs](../../aspose.svg/svgpathelement/createsvgpathsegmovetoabs/)(*float, float*) | Returnerar ett fristående, föräldralöst SVGPathSegMovetoAbs-objekt. |
| [CreateSVGPathSegMovetoRel](../../aspose.svg/svgpathelement/createsvgpathsegmovetorel/)(*float, float*) | Returnerar ett fristående, föräldralöst SVGPathSegMovetoRel-objekt. |
...
| [GetBBox](../../aspose.svg/svggraphicselement/getbbox/)() | Returnerar den täta omgivande lådan i det aktuella användarrymmet (dvs. efter tillämpning av attributet ‘transform’, om någon) på geometrin för alla innehållna grafikelement, exklusive konturlinjer, beskärning, maskning och filtereffekter). Observera att getBBox måste returnera den faktiska omgivande lådan vid den tidpunkt metoden anropas, även om elementet ännu inte har renderats. |
| [GetCTM](../../aspose.svg/svggraphicselement/getctm/)() | Returnerar transformationsmatrisen från aktuella användarenheter (dvs. efter tillämpning av attributet ‘transform’, om någon) till viewport‑koordinatsystemet för nearestViewportElement. |
...
| [GetEquivalentPath](../../aspose.svg/svggeometryelement/getequivalentpath/)() | Returnerar en ny instans av [`SVGPathSegList`](../../aspose.svg.paths/svgpathseglist/) som representerar [`SVGGeometryElement`](../svggeometryelement/) som pathsegment. |
...
| [GetPointAtLength](../../aspose.svg/svggeometryelement/getpointatlength/)(*float*) | Returnerar (x,y)-koordinaten i användarutrymmet som är avståndsenheter längs vägen, med hjälp av användaragentens distance-along-a-path-algoritm. |
...
| [GetTotalLength](../../aspose.svg/svggeometryelement/gettotallength/)() | Returnerar användaragentens beräknade värde för den totala längden på banan med hjälp av användaragentens avstånd‑längs‑en‑bana-algoritm, som ett avstånd i det aktuella användarkoordinatsystemet. |
