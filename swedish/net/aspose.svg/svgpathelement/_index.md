...
description: Aspose.Svg.SVGPathElement klass. SVGPathElementgränssnittet motsvarar pathelementet.
type: docs
weight: 3370
...
| [GetEquivalentPath](../../aspose.svg/svggeometryelement/getequivalentpath/)() | Returnerar en ny instans av[`SVGPathSegList`](../../aspose.svg.paths/svgpathseglist/) som representerar[`SVGGeometryElement`](../svggeometryelement/) som vägsegment. |
| virtual [GetPlatformType](../../aspose.svg.dom/domobject/getplatformtype/)() | Denna metod används för att hämta ECMAScript-objektType . |
| [GetPointAtLength](../../aspose.svg/svggeometryelement/getpointatlength/)(float) | Returnerar (x,y)-koordinaten i användarutrymmet som är avståndsenheter längs vägen, med hjälp av användaragentens algoritm för avstånd längs en väg. |
...
| [GetTotalLength](../../aspose.svg/svggeometryelement/gettotallength/)() | Returnerar användaragentens beräknade värde för sökvägens totala längd med hjälp av användaragentens algoritm för avstånd längs en väg, som ett avstånd i det aktuella användarkoordinatsystemet. |
