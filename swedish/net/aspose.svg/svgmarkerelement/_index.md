...
description: "Aspose.Svg.SVGMarkerElement-klass. SVGMarkerElement-gränssnittet motsvarar marker-elementet."
type: docs
weight: 5410
url: /sv/net/aspose.svg/svgmarkerelement/
---
## SVGMarkerElement class

Gränssnittet SVGMarkerElement motsvarar elementet ‘marker’.
...
| [MarkerHeight](../../aspose.svg/svgmarkerelement/markerheight/) { get; } | Motsvarar attributet ‘markerHeight’ på det angivna ‘marker’-elementet. |
| [MarkerUnits](../../aspose.svg/svgmarkerelement/markerunits/) { get; } | Motsvarar attributet ‘markerUnits’ på det angivna ‘marker’-elementet. En av Marker Unit Types som definieras i detta gränssnitt. |
| [MarkerWidth](../../aspose.svg/svgmarkerelement/markerwidth/) { get; } | Motsvarar attributet ‘markerWidth’ på det angivna ‘marker’-elementet. |
...
| [OrientAngle](../../aspose.svg/svgmarkerelement/orientangle/) { get; } | Motsvarar attributet ‘orient’ på det angivna ‘marker’-elementet. Om markerUnits är SVG_MARKER_ORIENT_ANGLE, används vinkelvärdet för attributet ‘orient’; annars sätts det till noll. |
| [OrientType](../../aspose.svg/svgmarkerelement/orienttype/) { get; } | Motsvarar attributet ‘orient’ på det angivna ‘marker’-elementet. En av Marker Orientation Types som definieras i detta gränssnitt. |
...
| [PreserveAspectRatio](../../aspose.svg/svgmarkerelement/preserveaspectratio/) { get; } | Motsvarar attributet ‘preserveAspectRatio’ på det givna elementet. |
...
| [RefX](../../aspose.svg/svgmarkerelement/refx/) { get; } | Motsvarar attributet ‘refX’ på det angivna ‘marker’-elementet. |
| [RefY](../../aspose.svg/svgmarkerelement/refy/) { get; } | Motsvarar attributet ‘refY’ på det angivna ‘marker’-elementet. |
...
| [ViewBox](../../aspose.svg/svgmarkerelement/viewbox/) { get; } | Motsvarar attributet ‘viewBox’ på det givna elementet. |
...
| [SetOrientToAngle](../../aspose.svg/svgmarkerelement/setorienttoangle/)(*[SVGAngle](../../aspose.svg.datatypes/svgangle/)*) | Sätter värdet för attributet ‘orient’ till den angivna vinkeln. |
| [SetOrientToAuto](../../aspose.svg/svgmarkerelement/setorienttoauto/)() | Sätter värdet för attributet ‘orient’ till 'auto'. |
...
| Namn | Beskrivning |
| --- | --- |
| const [SVG_MARKERUNITS_STROKEWIDTH](../../aspose.svg/svgmarkerelement/svg_markerunits_strokewidth/) | Värdet för attributet ‘markerUnits’ är 'strokeWidth'. |
| const [SVG_MARKERUNITS_UNKNOWN](../../aspose.svg/svgmarkerelement/svg_markerunits_unknown/) | Markeringsenhetstypen är inte en av de fördefinierade typerna. Det är ogiltigt att försöka definiera ett nytt värde av denna typ eller att försöka byta ett befintligt värde till denna typ. |
| const [SVG_MARKERUNITS_USERSPACEONUSE](../../aspose.svg/svgmarkerelement/svg_markerunits_userspaceonuse/) | Värdet på attributet ‘markerUnits’ är 'userSpaceOnUse'. |
| const [SVG_MARKER_ORIENT_ANGLE](../../aspose.svg/svgmarkerelement/svg_marker_orient_angle/) | Attributet ‘orient’ har ett vinkelvärde. |
| const [SVG_MARKER_ORIENT_AUTO](../../aspose.svg/svgmarkerelement/svg_marker_orient_auto/) | Attributet ‘orient’ har värdet 'auto'. |
| const [SVG_MARKER_ORIENT_UNKNOWN](../../aspose.svg/svgmarkerelement/svg_marker_orient_unknown/) | Markeringsorienteringen är inte en av de fördefinierade typerna. Det är ogiltigt att försöka definiera ett nytt värde av denna typ eller att försöka byta ett befintligt värde till denna typ. |
