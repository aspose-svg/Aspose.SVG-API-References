...
description: Aspose.Svg.SVGMarkerElement klass. SVGMarkerElementgränssnittet motsvarar markerelementet.
type: docs
weight: 3340
...
| [MarkerHeight](../../aspose.svg/svgmarkerelement/markerheight/) { get; } | Motsvarar attributet 'markerHeight' på det givna 'marker'-elementet. |
| [MarkerUnits](../../aspose.svg/svgmarkerelement/markerunits/) { get; } | Motsvarar attributet 'markerUnits' på det givna 'marker'-elementet. En av de markörenhetstyper som definieras i detta gränssnitt. |
| [MarkerWidth](../../aspose.svg/svgmarkerelement/markerwidth/) { get; } | Motsvarar attributet 'markerWidth' på det givna 'marker'-elementet. |
...
| [OrientAngle](../../aspose.svg/svgmarkerelement/orientangle/) { get; } | Motsvarar attributet 'orient' på det givna 'markör'-elementet. Om markerUnits är SVG_MARKER_ORIENT_ANGLE, vinkelvärdet för attributet 'orient'; annars sätts den till noll. |
| [OrientType](../../aspose.svg/svgmarkerelement/orienttype/) { get; } | Motsvarar attributet 'orient' på det givna 'markör'-elementet. En av markörorienteringstyperna som definieras i detta gränssnitt. |
...
| [RefX](../../aspose.svg/svgmarkerelement/refx/) { get; } | Motsvarar attributet 'refX' på det givna 'markör'-elementet. |
| [RefY](../../aspose.svg/svgmarkerelement/refy/) { get; } | Motsvarar attributet 'refY' på det givna 'marker'-elementet. |
...
| [SetOrientToAngle](../../aspose.svg/svgmarkerelement/setorienttoangle/)(SVGAngle) | Anger värdet för attributet 'orient' till den givna vinkeln. |
| [SetOrientToAuto](../../aspose.svg/svgmarkerelement/setorienttoauto/)() | Anger värdet för attributet 'orient' till 'auto'. |
...
| const [SVG_MARKERUNITS_UNKNOWN](../../aspose.svg/svgmarkerelement/svg_markerunits_unknown/) | Markörenhetstypen är inte en av fördefinierade typer. Det är ogiltigt att försöka definiera ett nytt värde av denna typ eller att försöka ändra ett befintligt värde till denna typ. |
| const [SVG_MARKERUNITS_USERSPACEONUSE](../../aspose.svg/svgmarkerelement/svg_markerunits_userspaceonuse/) | Värdet för attributet 'markerUnits' är 'userSpaceOnUse'. |
...
| const [SVG_MARKER_ORIENT_UNKNOWN](../../aspose.svg/svgmarkerelement/svg_marker_orient_unknown/) | Markörens orientering är inte en av fördefinierade typer. Det är ogiltigt att försöka definiera ett nytt värde av denna typ eller att försöka ändra ett befintligt värde till denna typ. |
