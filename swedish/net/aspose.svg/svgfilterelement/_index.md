...
description: Aspose.Svg.SVGFilterElement klass. SVGFilterElementgränssnittet motsvarar filterelementet.
type: docs
weight: 3240
...
| [FilterUnits](../../aspose.svg/svgfilterelement/filterunits/) { get; } | Motsvarar attributet 'filterUnits' på det givna 'filter'-elementet. Tar en av konstanterna definierade i SVGUnitTypes. |
...
| [Height](../../aspose.svg/svgfilterelement/height/) { get; } | Motsvarar attributet 'höjd' på det givna 'filter'-elementet. |
| [Href](../../aspose.svg/svgfilterelement/href/) { get; } | Motsvarar attributet 'xlink:href' på det givna elementet. |
...
| [PrimitiveUnits](../../aspose.svg/svgfilterelement/primitiveunits/) { get; } | Motsvarar attributet 'primitiveUnits' på det givna 'filter'-elementet. Tar en av konstanterna definierade i SVGUnitTypes. |
