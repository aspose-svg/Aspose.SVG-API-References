...
description: Aspose.Svg.SVGAnimateMotionElement klass. SVGAnimateMotionElementgränssnittet motsvarar animateMotionelementet. Objektorienterad åtkomst till attributen för animateMotionelementet via SVG DOM är inte tillgänglig.
type: docs
weight: 3100
