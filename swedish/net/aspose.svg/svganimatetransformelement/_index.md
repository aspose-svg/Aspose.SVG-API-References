...
description: Aspose.Svg.SVGAnimateTransformElement klass. SVGAnimateTransformElementgränssnittet motsvarar elementet animateTransform. Objektorienterad åtkomst till attributen för elementet animateTransform via SVG DOM är inte tillgänglig.
type: docs
weight: 3110
