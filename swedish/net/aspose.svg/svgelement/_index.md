...
description: "Aspose.Svg.SVGElement-klass. Alla SVG DOM-gränssnitt som motsvarar direkt element i SVG-språket, såsom SVGPathElement-gränssnittet för path-elementet, ärver från SVGElement-gränssnittet."
type: docs
weight: 5270
url: /sv/net/aspose.svg/svgelement/
---
## SVGElement class

Alla SVG‑DOM‑gränssnitt som motsvarar element i SVG‑språket direkt (t.ex. SVGPathElement‑gränssnittet för ‘path’-elementet) ärver från SVGElement‑gränssnittet.
