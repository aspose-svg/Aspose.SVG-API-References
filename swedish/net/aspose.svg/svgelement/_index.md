...
description: Aspose.Svg.SVGElement klass. Alla SVG DOMgränssnitt som direkt motsvarar element i SVGspråket som SVGPathElementgränssnittet för pathelementet härrör från SVGElementgränssnittet.
type: docs
weight: 3200
