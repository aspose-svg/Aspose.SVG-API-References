...
description: SVGTransform är gränssnittet för en av komponenttransformationerna inom en SVGTransformList sålunda motsvarar ett SVGTransformobjekt en enskild komponent t.ex. scale... eller matrix... inom en transformattributspecifikation.
type: docs
weight: 320
