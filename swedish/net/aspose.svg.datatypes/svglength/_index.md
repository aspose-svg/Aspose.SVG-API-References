...
description: Aspose.Svg.DataTypes.SVGLength klass. SVGLengthgränssnittet motsvarar längden grundläggande datatyp. Ett SVGLengthobjekt kan betecknas som skrivskyddat vilket innebär att försök att modifiera objektet kommer att resultera i ett undantag som beskrivs nedan.
type: docs
weight: 220
