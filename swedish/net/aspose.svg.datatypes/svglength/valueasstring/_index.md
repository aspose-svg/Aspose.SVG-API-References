...
description: Värdet som ett strängvärde i enheterna uttryckta av unitType. Om du ställer in detta attribut kommer värde valueInSpecifiedUnits och unitType att uppdateras automatiskt för att återspegla denna inställning.
type: docs
weight: 30
