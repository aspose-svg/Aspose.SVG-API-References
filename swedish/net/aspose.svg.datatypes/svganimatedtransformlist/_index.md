...
description: Används för de olika attributen som anger en uppsättning transformationer såsom attributet transform som är tillgängligt för många av SVGs element och som kan animeras.
type: docs
weight: 200
url: /sv/net/aspose.svg.datatypes/svganimatedtransformlist/
---
## SVGAnimatedTransformList class

Används för de olika attributen som anger en uppsättning transformationer, såsom attributet 'transform' som är tillgängligt för många av SVG:s element, och som kan animeras.
...
| override [ToString](../../aspose.svg.datatypes/svganimatedtransformlist/tostring)() | Returnerar enString som representerar denna instans. |
