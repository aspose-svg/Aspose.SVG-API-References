...
description: SVGStringList har samma attribut och metoder som andra SVGxxxListgränssnitt. Implementerare kan överväga att använda en enda basklass för att implementera de olika SVGxxxListgränssnitten.
type: docs
weight: 310
url: /sv/net/aspose.svg.datatypes/svgstringlist/
---
## SVGStringList class
...
| namn | Beskrivning |
| --- | --- |
| [SVGStringList](svgstringlist#constructor)() | Initierar en ny instans av[`SVGStringList`](../svgstringlist) class. |
| [SVGStringList](svgstringlist#constructor_1)(IEnumerable&lt;string&gt;) | Initierar en ny instans av[`SVGStringList`](../svgstringlist) class. |
...
| override [ToString](../../aspose.svg.datatypes/svgstringlist/tostring)() | Returnerar enString som representerar denna instans. |
