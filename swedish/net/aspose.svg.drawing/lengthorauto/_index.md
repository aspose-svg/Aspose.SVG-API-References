...
description: Representerar en behållare för lagringslängd eller autoenheter..
type: docs
weight: 1530
...
| namn | Beskrivning |
| --- | --- |
| [LengthOrAuto](lengthorauto#constructor)() | Initierar en ny instans av[`LengthOrAuto`](../lengthorauto) klass och ställer in tillståndet till 'auto'. |
| [LengthOrAuto](lengthorauto#constructor_1)(Length) | Initierar en ny instans av[`LengthOrAuto`](../lengthorauto)klass och ställer in tillståndet till 'längd'. |
...
| [implicit operator](../../aspose.svg.drawing/lengthorauto/op_implicit) | Utför en implicit konvertering från[`Length`](./length) till[`LengthOrAuto`](../lengthorauto) . |
