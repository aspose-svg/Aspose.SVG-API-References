...
description: Initierar en ny instans avColoraspose.svg.drawing/color class. Som standard är färgen svart.
type: docs
weight: 10
...
Initierar en ny instans av[`Color`](../../color) class. Som standard är färgen svart.
...
Initierar en ny instans av[`Color`](../../color) class. Alla färgkomponenter måste vara i intervallet 0-1.
...
Initierar en ny instans av[`Color`](../../color)class. Alla färgkomponenter måste vara i intervallet 0-255.
