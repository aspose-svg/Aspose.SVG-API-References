...
description: Denna ImageVectorizerklass vektoriserar rasterbilder som PNG JPG GIF BMP och etc... och returnerar SVGDocument. Under vektorisering menar vi processen att reducera bitmappar till geometriska former som består av banelement och lagras som SVG.
type: docs
weight: 2130
...
| namn | Beskrivning |
| --- | --- |
| [ImageVectorizer](imagevectorizer#constructor)() | Initierar en ny instans av[`ImageVectorizer`](../imagevectorizer) class. |
| [ImageVectorizer](imagevectorizer#constructor_1)(ImageVectorizerConfiguration) | Initierar en ny instans av[`ImageVectorizer`](../imagevectorizer) class. |
