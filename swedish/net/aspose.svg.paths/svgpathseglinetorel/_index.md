...
description: Aspose.Svg.Paths.SVGPathSegLinetoRel klass. SVGPathSegLinetoRelgränssnittet motsvarar ett relativ lineto l sökvägsdatakommando.
type: docs
weight: 2640
url: /sv/net/aspose.svg.paths/svgpathseglinetorel/
---
## SVGPathSegLinetoRel class

SVGPathSegLinetoRel-gränssnittet motsvarar ett "relativ lineto" (l) sökvägsdatakommando.
...
| [X](../../aspose.svg.paths/svgpathseglinetorel/x/) { get; set; } | Den relativa X-koordinaten för slutpunkten för detta vägsegment. |
| [Y](../../aspose.svg.paths/svgpathseglinetorel/y/) { get; set; } | Den relativa Y-koordinaten för slutpunkten för detta vägsegment. |
