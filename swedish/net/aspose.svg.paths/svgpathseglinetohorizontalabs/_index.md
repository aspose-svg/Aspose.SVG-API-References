...
description: Aspose.Svg.Paths.SVGPathSegLinetoHorizontalAbs klass. SVGPathSegLinetoHorizontalAbsgränssnittet motsvarar ett absolut horizontal lineto H sökvägsdatakommando.
type: docs
weight: 2620
url: /sv/net/aspose.svg.paths/svgpathseglinetohorizontalabs/
---
...
| [X](../../aspose.svg.paths/svgpathseglinetohorizontalabs/x/) { get; set; } | Den absoluta X-koordinaten för slutpunkten för detta vägsegment. |
