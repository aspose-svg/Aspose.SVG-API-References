...
description: SVGPathSegCurvetoQuadraticSmoothAbsgränssnittet motsvarar ett absolut smooth cubic curveto T sökvägsdatakommando.
type: docs
weight: 2560
url: /sv/net/aspose.svg.paths/svgpathsegcurvetoquadraticsmoothabs/
---
## SVGPathSegCurvetoQuadraticSmoothAbs class

SVGPathSegCurvetoQuadraticSmoothAbs-gränssnittet motsvarar ett "absolut smooth cubic curveto" (T) sökvägsdatakommando.
...
| [X](../../aspose.svg.paths/svgpathsegcurvetoquadraticsmoothabs/x) { get; set; } | Den absoluta X-koordinaten för slutpunkten för detta vägsegment. |
| [Y](../../aspose.svg.paths/svgpathsegcurvetoquadraticsmoothabs/y) { get; set; } | Den absoluta Y-koordinaten för slutpunkten för detta vägsegment. |
