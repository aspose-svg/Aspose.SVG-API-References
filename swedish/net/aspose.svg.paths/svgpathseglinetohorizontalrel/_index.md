...
description: Aspose.Svg.Paths.SVGPathSegLinetoHorizontalRel klass. SVGPathSegLinetoHorizontalRelgränssnittet motsvarar ett relativ horisontell lineto h sökvägsdatakommando.
type: docs
weight: 2630
...
| [X](../../aspose.svg.paths/svgpathseglinetohorizontalrel/x/) { get; set; } | Den relativa X-koordinaten för slutpunkten för detta vägsegment. |
