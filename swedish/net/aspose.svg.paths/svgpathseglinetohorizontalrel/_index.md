...
description: "Aspose.Svg.Paths.SVGPathSegLinetoHorizontalRel klass. SVGPathSegLinetoHorizontalRel‑gränssnittet motsvarar ett relativt horisontellt lineto h‑sökvägsdatakommandot."
type: docs
weight: 4700
url: /sv/net/aspose.svg.paths/svgpathseglinetohorizontalrel/
---
## SVGPathSegLinetoHorizontalRel class

SVGPathSegLinetoHorizontalRel-gränssnittet motsvarar ett "relativt horisontellt lineto" (h) banadata-kommando.
...
| [X](../../aspose.svg.paths/svgpathseglinetohorizontalrel/x/) { get; set; } | Den relativa X-koordinaten för slutpunkten av detta segment. |
