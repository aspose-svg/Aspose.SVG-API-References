...
description: "Aspose.Svg.Rendering.GraphicContext klass. Innehåller aktuella grafikstyrningsparametrar. Dessa parametrar definierar det globala ramverket inom vilket grafikoperatorerna körs"
type: docs
weight: 4880
...
Innehåller aktuella grafikstyrningsparametrar. Dessa parametrar definierar det globala ramverket inom vilket grafikoperatorerna körs.
...
| Namn | Beskrivning |
| --- | --- |
| [GraphicContext](graphiccontext/)() | Initierar en ny instans av klassen `GraphicContext`. |
...
| virtual [TextInfo](../../aspose.svg.rendering/graphiccontext/textinfo/) { get; } | Hämtar ett [`TextInfo`](../textinfo/)‑objekt som innehåller information om renderad text. |
