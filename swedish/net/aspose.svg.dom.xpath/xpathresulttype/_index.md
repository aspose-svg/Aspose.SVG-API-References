...
description: En osignerad kortslutning som indikerar vilken typ av resultat detta är. Om en specifik typanges kommer resultatet att returneras som motsvarande typ med hjälp av XPathtypkonverteringar där så krävs och är möjligt.
type: docs
weight: 1360
