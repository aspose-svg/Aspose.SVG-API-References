...
| undantag | skick |
| --- | --- |
| [DOMException](../../../aspose.svg.dom/domexception/) | INVALID_EXPRESSION_ERR: Ökas om uttrycket inte är lagligt enligt enligt reglerna i[`IXPathEvaluator`](../). |
...
| [DOMException](../../../aspose.svg.dom/domexception/) | WRONG_DOCUMENT_ERR: Noden är från ett dokument som inte stöds av detta[`IXPathEvaluator`](../). |
| [DOMException](../../../aspose.svg.dom/domexception/) | NOT_SUPPORTED_ERR: Noden är inte en typ som är tillåten som en XPath-kontext nod eller så är begäranstypen inte tillåten av denna[`IXPathEvaluator`](../). |
