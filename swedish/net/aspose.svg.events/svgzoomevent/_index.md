...
description: Zoomhändelsen inträffar när användaren initierar en åtgärd som gör att den aktuella vyn av SVGdokumentfragmentet skalas om. Händelsehanterare känns bara igen på svgelement.
type: docs
weight: 1620
