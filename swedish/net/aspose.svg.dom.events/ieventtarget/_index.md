...
description: DenEventTarget../aspose.svg.dom/eventtarget gränssnitt implementeras av alla noder i en implementering som stöder DOMhändelsemodellen. Därför kan detta gränssnitt erhållas genom att använda bindningsspecifika castingmetoder på en instans av nodgränssnittet. Gränssnittet tillåter registrering och borttagning av händelseavlyssnare på enEventTarget../aspose.svg.dom/eventtarget och sändning av händelser till detIEventTarget./ieventtarget .
type: docs
weight: 960
