...
description: UIEventgränssnittet tillhandahåller specifik kontextuell information associerad med användargränssnittshändelser.
type: docs
weight: 1000
...
| namn | Beskrivning |
| --- | --- |
| [UIEvent](uievent#constructor)(string) | Initierar en ny instans av[`UIEvent`](../uievent) class. |
| [UIEvent](uievent#constructor_1)(string, IDictionary&lt;string, object&gt;) | Initierar en ny instans av[`UIEvent`](../uievent) class. |
