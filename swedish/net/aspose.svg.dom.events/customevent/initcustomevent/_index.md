...
description: /// DenInitEventaspose.svg.dom.events/event/initevent metod används för att initiera värdet av enEventaspose.svg.dom.events/event skapas genomIDocumentEventaspose.svg.dom.events/idocumentevent gränssnitt.
type: docs
weight: 30
