...
description: DenErrorEvent./errorevent ger kontextuell information om ett fel som uppstod under körning.
type: docs
weight: 910
...
Den[`ErrorEvent`](../errorevent) ger kontextuell information om ett fel som uppstod under körning.
...
| namn | Beskrivning |
| --- | --- |
| [ErrorEvent](errorevent#constructor_1)(Exception) | Initierar en ny instans av[`ErrorEvent`](../errorevent) class. |
| [ErrorEvent](errorevent#constructor)(IDictionary&lt;string, object&gt;) | Initierar en ny instans av[`ErrorEvent`](../errorevent) class. |
