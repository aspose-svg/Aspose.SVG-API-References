...
description: "Aspose.Svg.Dom.Events.ErrorEvent-klass. ErrorEvent tillhandahåller kontextuell information om ett fel som inträffade under körning."
type: docs
weight: 2910
url: /sv/net/aspose.svg.dom.events/errorevent/
---
## ErrorEvent class

`ErrorEvent` ger kontextuell information om ett fel som inträffade under körning.
...
| [ErrorEvent](errorevent/#constructor)(*IDictionary&lt;string, object&gt;*) | Initierar en ny instans av `ErrorEvent`-klassen. |
...
| [ColNo](../../aspose.svg.dom.events/errorevent/colno/) { get; } | colno-attributet måste returnera det värde det initierades med. När objektet skapas måste detta attribut initieras till noll. Det representerar kolumnnumret där felet inträffade i skriptet. |
...
| [Error](../../aspose.svg.dom.events/errorevent/error/) { get; } | error-attributet måste returnera det värde det initierades med. När objektet skapas måste detta attribut initieras till null. När det är lämpligt sätts det till objektet som representerar felet (t.ex. undantagsobjektet i fallet med ett oavlyssnat DOM‑undantag). |
...
| [FileName](../../aspose.svg.dom.events/errorevent/filename/) { get; } | filename-attributet måste returnera det värde det initierades med. När objektet skapas måste detta attribut initieras till en tom sträng. Det representerar den absoluta URL:en för skriptet där felet ursprungligen inträffade. |
...
| [LineNo](../../aspose.svg.dom.events/errorevent/lineno/) { get; } | lineno-attributet måste returnera det värde det initierades med. När objektet skapas måste detta attribut initieras till noll. Det representerar radnumret där felet inträffade i skriptet. |
| [Message](../../aspose.svg.dom.events/errorevent/message/) { get; } | message-attributet måste returnera det värde det initierades med. När objektet skapas måste detta attribut initieras till en tom sträng. Det representerar felmeddelandet. |
