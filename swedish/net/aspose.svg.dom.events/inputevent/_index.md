...
description: Indatahändelser skickas som aviseringar när DOM uppdateras.
type: docs
weight: 970
...
| namn | Beskrivning |
| --- | --- |
| [InputEvent](inputevent#constructor)(string) | Initierar en ny instans av[`InputEvent`](../inputevent) class. |
| [InputEvent](inputevent#constructor_1)(string, IDictionary&lt;string, object&gt;) | Initierar en ny instans av[`InputEvent`](../inputevent) class. |
...
| [IsComposing](../../aspose.svg.dom.events/inputevent/iscomposing) { get; } | true om ingångshändelsen inträffar som en del av en sammansättningssession, dvs efter en sammansättningsstarthändelse och före motsvarande sammansättningssluthändelse. Det oinitierade värdet för detta attribut MÅSTE vara false. |
