...
description: Aspose.Svg.Dom.Events.WheelEvent klass. WheelEventgränssnittet tillhandahåller specifik kontextuell information associerad med hjulhändelser. För att skapa en instans av WheelEventgränssnittet använder du WheelEventkonstruktorn och skickar en valfri WheelEventInitordbok.
type: docs
weight: 1010
