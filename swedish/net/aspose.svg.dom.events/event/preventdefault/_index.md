...
description: Om en händelse kan avbrytasPreventDefaultaspose.svg.dom.events/event/preventdefault metod används för att indikera att händelsen ska avbrytas vilket betyder att någon standardåtgärd som normalt vidtas av implementeringen som ett resultat av händelsen inte kommer att inträffa.
type: docs
weight: 120
