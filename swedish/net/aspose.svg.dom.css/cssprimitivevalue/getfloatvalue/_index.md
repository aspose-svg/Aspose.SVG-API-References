...
description: Denna metod används för att få ett flytvärde i en specificerad enhet. Om detta CSSvärde inte innehåller ett flytande värde eller inte kan konverteras till den angivna enheten höjs ett DOMException.
type: docs
weight: 30
