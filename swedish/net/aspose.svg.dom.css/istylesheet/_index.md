...
description: Aspose.Svg.Dom.Css.IStyleSheet gränssnitt. StyleSheetgränssnittet är det abstrakta basgränssnittet för alla typer av stilmall. Den representerar en enda formatmall som är associerad med ett strukturerat dokument.
type: docs
weight: 740
