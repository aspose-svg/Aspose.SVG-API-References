...
description: Rectgränssnittet används för att representera alla rectvärden. Detta gränssnitt återspeglar värdena i den underliggande stilegenskapen. Därför ändrar modifieringar gjorda av CSSPrimitiveValueobjekten stilegenskapen.
type: docs
weight: 780
