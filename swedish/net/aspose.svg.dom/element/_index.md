...
description: Elementgränssnittet representerar ett element i ett HTML eller XMLdokument.
type: docs
weight: 840
...
| namn | Beskrivning |
| --- | --- |
| [Element](element)(IElementInit) | Initierar en ny instans av[`Element`](../element)klass. Ring inte den här konstruktören direkt, använd[`CreateElement`](../document/createelement) eller[`CreateElementNS`](../document/createelementns) . |
