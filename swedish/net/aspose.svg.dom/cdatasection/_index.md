...
description: Aspose.Svg.Dom.CDATASection klass. CDATAsektioner används för att undvika textblock som innehåller tecken som annars skulle betraktas som uppmärkning.
type: docs
weight: 440
