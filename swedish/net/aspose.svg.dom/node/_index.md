...
description: Aspose.Svg.Dom.Node klass. Nodgränssnittet är den primära datatypen för hela dokumentobjektmodellen. Den representerar en enda nod i dokumentträdet.
type: docs
weight: 1150
...
| abstract [NodeName](../../aspose.svg.dom/node/nodename/) { get; } | Namnet på denna nod, beroende på dess typ. |
...
| [CloneNode](../../aspose.svg.dom/node/clonenode/#clonenode)() | Returnerar en dubblett av denna nod, dvs fungerar som en generisk kopiakonstruktor för noder. Dubblettnoden har ingen förälder (parentNode är null) och inga användardata. |
| [CloneNode](../../aspose.svg.dom/node/clonenode/#clonenode_1)(bool) | Returnerar en dubblett av denna nod, dvs fungerar som en generisk kopiakonstruktor för noder. Dubblettnoden har ingen förälder (parentNode är null) och inga användardata. |
...
| namn | Beskrivning |
| --- | --- |
| const [ATTRIBUTE_NODE](../../aspose.svg.dom/node/attribute_node/) | En attribut node |
| const [CDATA_SECTION_NODE](../../aspose.svg.dom/node/cdata_section_node/) | En cdatasektion node |
| const [COMMENT_NODE](../../aspose.svg.dom/node/comment_node/) | En kommentarsnod |
| const [DOCUMENT_FRAGMENT_NODE](../../aspose.svg.dom/node/document_fragment_node/) | Ett dokumentfragment node |
| const [DOCUMENT_NODE](../../aspose.svg.dom/node/document_node/) | En dokumentnod |
| const [DOCUMENT_TYPE_NODE](../../aspose.svg.dom/node/document_type_node/) | En dokumenttyp node |
