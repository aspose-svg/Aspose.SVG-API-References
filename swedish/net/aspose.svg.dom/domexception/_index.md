...
description: Aspose.Svg.Dom.DOMException klass. DOMExceptiongränssnittet representerar en onormal händelse kallad ett undantag som inträffar som ett resultat av anrop av en metod eller åtkomst till en egenskap hos ett webbAPI. Det är i princip hur feltillstånd beskrivs i webbAPIer.
type: docs
weight: 790
