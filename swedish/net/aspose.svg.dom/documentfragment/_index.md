...
description: DocumentFragment är ett lätt eller minimalt dokumentobjekt. Det är mycket vanligt att man vill kunna extrahera en del av ett dokuments träd eller skapa ett nytt fragment av ett dokument.
type: docs
weight: 820
