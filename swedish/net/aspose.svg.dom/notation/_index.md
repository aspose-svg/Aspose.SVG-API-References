...
description: "Aspose.Svg.Dom.Notation-klass. Representerar en notation som deklarerats i DTD"
type: docs
weight: 3150
url: /sv/net/aspose.svg.dom/notation/
---
## Notation class

Representerar en notation som deklarerats i DTD.
...
| override [NodeName](../../aspose.svg.dom/notation/nodename/) { get; } | Namnet på denna nod, beroende på dess typ. |
| override [NodeType](../../aspose.svg.dom/notation/nodetype/) { get; } | En kod som representerar typen av det underliggande objektet. |
...
| [PublicId](../../aspose.svg.dom/notation/publicid/) { get; } | Den offentliga identifieraren för denna notation. Om den offentliga identifieraren inte angavs är detta null. |
| [SystemId](../../aspose.svg.dom/notation/systemid/) { get; } | Systemidentifieraren för denna notation. Om systemidentifieraren inte angavs är detta null. Detta kan vara en absolut URI eller inte. |
