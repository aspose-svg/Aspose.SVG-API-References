...
description: Skapar ett EntityReferenceobjekt. Dessutom om den refererade enheten är känd görs den underordnade listan för EntityReferencenoden densamma som den för motsvarande Entitynod.
type: docs
weight: 870
