...
description: DocumentType tillhandahåller ett gränssnitt till listan över enheter som är definierade för document
type: docs
weight: 830
...
| namn | Beskrivning |
| --- | --- |
| [DocumentType](documenttype)(string, string, string, string, Document) | Initierar en ny instans av[`DocumentType`](../documenttype) class. |
...
| [InternalSubset](../../aspose.svg.dom/documenttype/internalsubset) { get; } | Den interna delmängden som en sträng, eller null om det inte finns någon. |
...
| [Name](../../aspose.svg.dom/documenttype/name) { get; } | Namnet på DTD; dvs namnet omedelbart efter DOCTYPE-nyckelordet. |
...
| override [ToString](../../aspose.svg.dom/documenttype/tostring)() | Returnerar enString som representerar denna instans. |
