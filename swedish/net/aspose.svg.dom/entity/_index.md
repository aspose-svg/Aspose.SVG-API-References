...
description: "Aspose.Svg.Dom.Entity-klass. Representerar en känd entitet, antingen parsad eller oparsad, i ett XML-dokument."
type: docs
weight: 2850
...
| [InputEncoding](../../aspose.svg.dom/entity/inputencoding/) { get; } | Ett attribut som specificerar den kodning som används för denna entitet vid parsning, när den är en extern parsad entitet. Detta är null om det är en entitet från den interna delmängden eller om den inte är känd. |
...
| [NotationName](../../aspose.svg.dom/entity/notationname/) { get; } | För oparsade entiteter, namnet på notation för entiteten. För parsade entiteter är detta null. |
...
| [PublicId](../../aspose.svg.dom/entity/publicid/) { get; } | Den offentliga identifieraren som är associerad med entiteten om den anges, annars null. |
| [SystemId](../../aspose.svg.dom/entity/systemid/) { get; } | Systemidentifieraren som är associerad med entiteten om den anges, annars null. Detta kan vara en absolut URI eller inte. |
| virtual [TextContent](../../aspose.svg.dom/node/textcontent/) { get; set; } | Representerar textinnehållet i noden och dess undernoder. |
| [XmlEncoding](../../aspose.svg.dom/entity/xmlencoding/) { get; } | Ett attribut som specificerar, som en del av textdeklarationen, kodningen för denna entitet när den är en extern parsad entitet. Detta är null annars. |
| [XmlVersion](../../aspose.svg.dom/entity/xmlversion/) { get; } | Ett attribut som specificerar, som en del av textdeklarationen, versionsnumret för denna entitet när den är en extern parsad entitet. Detta är null annars. |
