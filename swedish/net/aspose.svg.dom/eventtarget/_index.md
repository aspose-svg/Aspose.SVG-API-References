...
description: DenEventTarget./eventtarget gränssnitt implementeras av alla noder i en implementering som stöder DOMhändelsemodellen. Därför kan detta gränssnitt erhållas genom att använda bindningsspecifika castingmetoder på en instans av nodgränssnittet. Gränssnittet tillåter registrering och borttagning av händelseavlyssnare på enEventTarget./eventtarget och sändning av händelser till detIEventTarget../aspose.svg.dom.events/ieventtarget .
type: docs
weight: 870
