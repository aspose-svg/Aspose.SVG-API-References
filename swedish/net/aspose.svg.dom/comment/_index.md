...
description: "Aspose.Svg.Dom.Comment-klass. Ärver från CharacterData och representerar innehållet i en kommentar, dvs. alla tecken mellan start"
type: docs
weight: 2460
url: /sv/net/aspose.svg.dom/comment/
---
## Comment class

Arver från CharacterData och representerar innehållet i en kommentar, d.v.s. alla tecken mellan den inledande ''.
...
| override [NodeName](../../aspose.svg.dom/comment/nodename/) { get; } | Namnet på denna nod, beroende på dess typ. |
| override [NodeType](../../aspose.svg.dom/comment/nodetype/) { get; } | En kod som representerar typen av det underliggande objektet. |
| override [NodeValue](../../aspose.svg.dom/comment/nodevalue/) { get; set; } | Värdet på denna nod, beroende på dess typ. |
