...
description: ProcessingInstruction representerar en bearbetningsinstruktion som används i XML som ett sätt att behålla processorspecifik information i dokumentets text.
type: docs
weight: 1170
