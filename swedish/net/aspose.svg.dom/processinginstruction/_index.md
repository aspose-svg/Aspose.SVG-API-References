...
description: "Aspose.Svg.Dom.ProcessingInstruction-klass. ProcessingInstruction representerar en bearbetningsinstruktion som används i XML för att hålla processor-specifik information i dokumentets text."
type: docs
weight: 3160
...
| override [NodeValue](../../aspose.svg.dom/processinginstruction/nodevalue/) { get; set; } | Värdet på denna nod, beroende på dess typ. |
