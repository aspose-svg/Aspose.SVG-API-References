...
description: Aspose.Svg.Dom.ProcessingInstruction klass. ProcessingInstruction representerar en bearbetningsinstruktion som används i XML som ett sätt att behålla processorspecifik information i dokumentets text.
type: docs
weight: 1170
url: /sv/net/aspose.svg.dom/processinginstruction/
---
...
| override [NodeName](../../aspose.svg.dom/processinginstruction/nodename/) { get; } | Namnet på denna nod, beroende på dess typ. |
| override [NodeType](../../aspose.svg.dom/processinginstruction/nodetype/) { get; } | En kod som representerar typen av det underliggande objektet. |
| override [NodeValue](../../aspose.svg.dom/processinginstruction/nodevalue/) { get; set; } | Värdet för denna nod, beroende på dess typ. |
...
| [Target](../../aspose.svg.dom/processinginstruction/target/) { get; } | Målet för denna bearbetningsinstruktion. |
| override [TextContent](../../aspose.svg.dom/processinginstruction/textcontent/) { get; set; } | Detta attribut returnerar textinnehållet för denna nod och dess avkomlingar. När den är definierad som null har inställningen ingen effekt. Vid inställning tas alla möjliga barn bort som denna nod kan ha och, om den nya strängen inte är tom eller null, ersätts den av en enda textnod som innehåller strängen som detta attribut är inställt på. |
