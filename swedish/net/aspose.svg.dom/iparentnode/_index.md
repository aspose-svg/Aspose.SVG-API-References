...
description: DefinierarIParentNode./iparentnode gränssnitt som implementeras av eventuella föräldrar.
type: docs
weight: 1100
...
Definierar[`IParentNode`](../iparentnode) gränssnitt som implementeras av eventuella föräldrar.
