...
description: Aspose.Svg.Filters.SVGFEDropShadowElement klass. SVGFEDropShadowElementgränssnittet motsvarar feDropShadowelementet.
type: docs
weight: 1730
...
| [Height](../../aspose.svg.filters/svgfedropshadowelement/height/) { get; } | Motsvarar attributet 'höjd' på det givna 'feDropShadow'-elementet. |
...
| [StdDeviationY](../../aspose.svg.filters/svgfedropshadowelement/stddeviationy/) { get; } | Motsvarar attributet 'stdDeviation' på det givna 'feDropShadow'-elementet. Innehåller Y-komponenten (möjligen beräknad automatiskt) för attributet 'stdDeviation'. |
