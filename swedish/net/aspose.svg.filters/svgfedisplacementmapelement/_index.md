...
description: "Aspose.Svg.Filters.SVGFEDisplacementMapElement klass. SVGFEDisplacementMapElement-gränssnittet motsvarar elementet feDisplacementMap."
type: docs
weight: 3800
url: /sv/net/aspose.svg.filters/svgfedisplacementmapelement/
---
...
| [Height](../../aspose.svg.filters/svgfedisplacementmapelement/height/) { get; } | Motsvarar attributet ‘height’ på det givna ‘filter’-elementet. |
...
| [In1](../../aspose.svg.filters/svgfedisplacementmapelement/in1/) { get; } | Motsvarar attributet ‘in’ på det angivna ‘feDisplacementMap’-elementet. |
| [In2](../../aspose.svg.filters/svgfedisplacementmapelement/in2/) { get; } | Motsvarar attributet ‘in2’ på det angivna ‘feDisplacementMap’-elementet. |
...
| [Result](../../aspose.svg.filters/svgfedisplacementmapelement/result/) { get; } | Motsvarar attributet ‘result’ på det givna ‘filter’-elementet. |
| [Scale](../../aspose.svg.filters/svgfedisplacementmapelement/scale/) { get; } | Motsvarar attributet ‘scale’ på det angivna ‘feDisplacementMap’-elementet. |
...
| [Width](../../aspose.svg.filters/svgfedisplacementmapelement/width/) { get; } | Motsvarar attributet ‘width’ på det givna ‘filter’-elementet. |
| [X](../../aspose.svg.filters/svgfedisplacementmapelement/x/) { get; } | Motsvarar attributet ‘x’ på det givna ‘filter’-elementet. |
| [XChannelSelector](../../aspose.svg.filters/svgfedisplacementmapelement/xchannelselector/) { get; } | Motsvarar attributet ‘xChannelSelector’ på det angivna ‘feDisplacementMap’-elementet. Accepterar en av SVG_CHANNEL_*-konstanterna som definierats i detta gränssnitt. |
| [Y](../../aspose.svg.filters/svgfedisplacementmapelement/y/) { get; } | Motsvarar attributet ‘y’ på det givna ‘filter’-elementet. |
| [YChannelSelector](../../aspose.svg.filters/svgfedisplacementmapelement/ychannelselector/) { get; } | Motsvarar attributet ‘yChannelSelector’ på det angivna ‘feDisplacementMap’-elementet. Accepterar en av SVG_CHANNEL_*-konstanterna som definierats i detta gränssnitt. |
...
| Namn | Beskrivning |
| --- | --- |
| const [SVG_CHANNEL_A](../../aspose.svg.filters/svgfedisplacementmapelement/svg_channel_a/) | Motsvarar värdet 'A'. |
| const [SVG_CHANNEL_B](../../aspose.svg.filters/svgfedisplacementmapelement/svg_channel_b/) | Motsvarar värdet 'B'. |
| const [SVG_CHANNEL_G](../../aspose.svg.filters/svgfedisplacementmapelement/svg_channel_g/) | Motsvarar värdet 'G'. |
| const [SVG_CHANNEL_R](../../aspose.svg.filters/svgfedisplacementmapelement/svg_channel_r/) | Motsvarar värdet 'R'. |
| const [SVG_CHANNEL_UNKNOWN](../../aspose.svg.filters/svgfedisplacementmapelement/svg_channel_unknown/) | Typen är inte en av de fördefinierade typerna. Det är ogiltigt att försöka definiera ett nytt värde av denna typ eller att försöka byta ett befintligt värde till denna typ. |
