...
description: Aspose.Svg.Filters.SVGFEDisplacementMapElement klass. SVGFEDisplacementMapElementgränssnittet motsvarar elementet feDisplacementMap.
type: docs
weight: 1710
...
| [Height](../../aspose.svg.filters/svgfedisplacementmapelement/height/) { get; } | Motsvarar attributet 'höjd' på det givna 'filter'-elementet. |
...
| [In1](../../aspose.svg.filters/svgfedisplacementmapelement/in1/) { get; } | Motsvarar attributet 'in' på det givna 'feDisplacementMap'-elementet. |
| [In2](../../aspose.svg.filters/svgfedisplacementmapelement/in2/) { get; } | Motsvarar attributet 'in2' på det givna 'feDisplacementMap'-elementet. |
...
| [Scale](../../aspose.svg.filters/svgfedisplacementmapelement/scale/) { get; } | Motsvarar attributet 'scale' på det givna 'feDisplacementMap'-elementet. |
...
| [XChannelSelector](../../aspose.svg.filters/svgfedisplacementmapelement/xchannelselector/) { get; } | Motsvarar attributet 'xChannelSelector' på det givna 'feDisplacementMap'-elementet. Tar en av SVG_CHANNEL_* konstanterna som definierats i detta gränssnitt. |
| [Y](../../aspose.svg.filters/svgfedisplacementmapelement/y/) { get; } | Motsvarar attributet 'y' på det givna 'filter'-elementet. |
| [YChannelSelector](../../aspose.svg.filters/svgfedisplacementmapelement/ychannelselector/) { get; } | Motsvarar attributet 'yChannelSelector' på det givna 'feDisplacementMap'-elementet. Tar en av SVG_CHANNEL_* konstanterna som definierats i detta gränssnitt. |
...
| const [SVG_CHANNEL_UNKNOWN](../../aspose.svg.filters/svgfedisplacementmapelement/svg_channel_unknown/) | Typen är inte en av fördefinierade typer. Det är ogiltigt att försöka definiera ett nytt värde av denna typ eller att försöka ändra ett befintligt värde till denna typ. |
