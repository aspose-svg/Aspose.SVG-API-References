...
description: "Aspose.Svg.Filters.SVGFESpecularLightingElement klass. Den SVGFESpecularLightingElement-gränssnittet motsvarar feSpecularLighting-elementet."
type: docs
weight: 3950
url: /sv/net/aspose.svg.filters/svgfespecularlightingelement/
---
## SVGFESpecularLightingElement class

SVGFESpecularLightingElement-gränssnittet motsvarar ‘feSpecularLighting’-elementet.
...
| [Height](../../aspose.svg.filters/svgfespecularlightingelement/height/) { get; } | Motsvarar attributet ‘height’ på det givna ‘filter’-elementet. |
...
| [In1](../../aspose.svg.filters/svgfespecularlightingelement/in1/) { get; } | Motsvarar attributet ‘in’ på det givna ‘feSpecularLighting’-elementet. |
...
| [KernelUnitLengthX](../../aspose.svg.filters/svgfespecularlightingelement/kernelunitlengthx/) { get; } | Motsvarar attributet ‘kernelUnitLength’ på det givna ‘feSpecularLighting’-elementet. |
| [KernelUnitLengthY](../../aspose.svg.filters/svgfespecularlightingelement/kernelunitlengthy/) { get; } | Motsvarar attributet ‘kernelUnitLength’ på det givna ‘feSpecularLighting’-elementet. |
...
| [Result](../../aspose.svg.filters/svgfespecularlightingelement/result/) { get; } | Motsvarar attributet ‘result’ på det givna ‘filter’-elementet. |
...
| [SpecularConstant](../../aspose.svg.filters/svgfespecularlightingelement/specularconstant/) { get; } | Motsvarar attributet ‘specularConstant’ på det givna ‘feSpecularLighting’-elementet. |
| [SpecularExponent](../../aspose.svg.filters/svgfespecularlightingelement/specularexponent/) { get; } | Motsvarar attributet ‘specularExponent’ på det givna ‘feSpecularLighting’-elementet. |
...
| [SurfaceScale](../../aspose.svg.filters/svgfespecularlightingelement/surfacescale/) { get; } | Motsvarar attributet ‘surfaceScale’ på det givna ‘feSpecularLighting’-elementet. |
...
| [Width](../../aspose.svg.filters/svgfespecularlightingelement/width/) { get; } | Motsvarar attributet ‘width’ på det givna ‘filter’-elementet. |
| [X](../../aspose.svg.filters/svgfespecularlightingelement/x/) { get; } | Motsvarar attributet ‘x’ på det givna ‘filter’-elementet. |
| [Y](../../aspose.svg.filters/svgfespecularlightingelement/y/) { get; } | Motsvarar attributet ‘y’ på det givna ‘filter’-elementet. |
