...
description: Aspose.Svg.Filters.SVGFEMorphologyElement klass. SVGFEMorphologyElementgränssnittet motsvarar elementet feMorphology.
type: docs
weight: 1830
...
| [Height](../../aspose.svg.filters/svgfemorphologyelement/height/) { get; } | Motsvarar attributet 'höjd' på det givna 'filter'-elementet. |
...
| [In1](../../aspose.svg.filters/svgfemorphologyelement/in1/) { get; } | Motsvarar attributet 'in' på det givna 'feMorphology'-elementet. |
...
| [Operator](../../aspose.svg.filters/svgfemorphologyelement/operator/) { get; } | Motsvarar attributet 'operator' på det givna 'feMorphology'-elementet. Tar en av SVG_MORPHOLOGY_OPERATOR_* konstanterna som definierats i detta gränssnitt. |
...
| [RadiusX](../../aspose.svg.filters/svgfemorphologyelement/radiusx/) { get; } | Motsvarar attributet 'radius' på det givna 'feMorphology'-elementet. |
| [RadiusY](../../aspose.svg.filters/svgfemorphologyelement/radiusy/) { get; } | Motsvarar attributet 'radius' på det givna 'feMorphology'-elementet. |
...
| const [SVG_MORPHOLOGY_OPERATOR_UNKNOWN](../../aspose.svg.filters/svgfemorphologyelement/svg_morphology_operator_unknown/) | Typen är inte en av fördefinierade typer. Det är ogiltigt att försöka definiera ett nytt värde av denna typ eller att försöka ändra ett befintligt värde till denna typ. |
