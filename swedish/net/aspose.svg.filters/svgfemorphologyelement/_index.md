...
description: "Aspose.Svg.Filters.SVGFEMorphologyElement klass. SVGFEMorphologyElement-gränssnittet motsvarar feMorphology-elementet."
type: docs
weight: 3920
url: /sv/net/aspose.svg.filters/svgfemorphologyelement/
---
## SVGFEMorphologyElement class

SVGFEMorphologyElement-gränssnittet motsvarar ‘feMorphology’-elementet.
...
| [Height](../../aspose.svg.filters/svgfemorphologyelement/height/) { get; } | Motsvarar attributet ‘height’ på det givna ‘filter’-elementet. |
...
| [In1](../../aspose.svg.filters/svgfemorphologyelement/in1/) { get; } | Motsvarar attributet ‘in’ på det angivna ‘feMorphology’-elementet. |
...
| [Operator](../../aspose.svg.filters/svgfemorphologyelement/operator/) { get; } | Motsvarar attributet ‘operator’ på det angivna ‘feMorphology’-elementet. Accepterar en av SVG_MORPHOLOGY_OPERATOR_*-konstanterna som definieras i detta gränssnitt. |
...
| [RadiusX](../../aspose.svg.filters/svgfemorphologyelement/radiusx/) { get; } | Motsvarar attributet ‘radius’ på det angivna ‘feMorphology’-elementet. |
| [RadiusY](../../aspose.svg.filters/svgfemorphologyelement/radiusy/) { get; } | Motsvarar attributet ‘radius’ på det angivna ‘feMorphology’-elementet. |
| [Result](../../aspose.svg.filters/svgfemorphologyelement/result/) { get; } | Motsvarar attributet ‘result’ på det givna ‘filter’-elementet. |
...
| [Width](../../aspose.svg.filters/svgfemorphologyelement/width/) { get; } | Motsvarar attributet ‘width’ på det givna ‘filter’-elementet. |
| [X](../../aspose.svg.filters/svgfemorphologyelement/x/) { get; } | Motsvarar attributet ‘x’ på det givna ‘filter’-elementet. |
| [Y](../../aspose.svg.filters/svgfemorphologyelement/y/) { get; } | Motsvarar attributet ‘y’ på det givna ‘filter’-elementet. |
...
| Namn | Beskrivning |
| --- | --- |
| const [SVG_MORPHOLOGY_OPERATOR_DILATE](../../aspose.svg.filters/svgfemorphologyelement/svg_morphology_operator_dilate/) | Motsvarar värdet 'dilate'. |
| const [SVG_MORPHOLOGY_OPERATOR_ERODE](../../aspose.svg.filters/svgfemorphologyelement/svg_morphology_operator_erode/) | Motsvarar värdet 'erode'. |
| const [SVG_MORPHOLOGY_OPERATOR_UNKNOWN](../../aspose.svg.filters/svgfemorphologyelement/svg_morphology_operator_unknown/) | Typen är inte en av de fördefinierade typerna. Det är ogiltigt att försöka definiera ett nytt värde av denna typ eller att försöka byta ett befintligt värde till denna typ. |
