...
description: "Aspose.Svg.Filters.SVGFEGaussianBlurElement klass. Den SVGFEGaussianBlurElement-gränssnittet motsvarar feGaussianBlur-elementet."
type: docs
weight: 3880
url: /sv/net/aspose.svg.filters/svgfegaussianblurelement/
---
## SVGFEGaussianBlurElement class

SVGFEGaussianBlurElement-gränssnittet motsvarar ‘feGaussianBlur’-elementet.
...
| [Height](../../aspose.svg.filters/svgfegaussianblurelement/height/) { get; } | Motsvarar attributet �height� på det givna �filter� elementet. |
...
| [In1](../../aspose.svg.filters/svgfegaussianblurelement/in1/) { get; } | Motsvarar attributet �in� på det givna �feGaussianBlur� elementet. |
...
| [Result](../../aspose.svg.filters/svgfegaussianblurelement/result/) { get; } | Motsvarar attributet �result� på det givna �filter� elementet. |
...
| [StdDeviationX](../../aspose.svg.filters/svgfegaussianblurelement/stddeviationx/) { get; } | Motsvarar attributet �stdDeviation� på det givna �feGaussianBlur� elementet. Innehåller X-komponenten av attributet �stdDeviation�. |
| [StdDeviationY](../../aspose.svg.filters/svgfegaussianblurelement/stddeviationy/) { get; } | Motsvarar attributet �stdDeviation� på det givna �feGaussianBlur� elementet. Innehåller Y-komponenten (möjligen beräknad automatiskt) av attributet �stdDeviation�. |
...
| [Width](../../aspose.svg.filters/svgfegaussianblurelement/width/) { get; } | Motsvarar attributet �width� på det givna �filter� elementet. |
| [X](../../aspose.svg.filters/svgfegaussianblurelement/x/) { get; } | Motsvarar attributet �x� på det givna �filter� elementet. |
| [Y](../../aspose.svg.filters/svgfegaussianblurelement/y/) { get; } | Motsvarar attributet �y� på det givna �filter� elementet. |
...
| [SetStdDeviation](../../aspose.svg.filters/svgfegaussianblurelement/setstddeviation/)(*float, float*) | Ställer in värdena för attributet stdDeviation. |
