...
description: Aspose.Svg.Filters.SVGFEBlendElement klass. SVGFEBlendElementgränssnittet motsvarar elementet feBlend.
type: docs
weight: 1650
...
| [Height](../../aspose.svg.filters/svgfeblendelement/height/) { get; } | Motsvarar attributet 'höjd' på det givna 'filter'-elementet. |
...
| [In1](../../aspose.svg.filters/svgfeblendelement/in1/) { get; } | Motsvarar attributet 'in' på det givna 'feBlend'-elementet. |
| [In2](../../aspose.svg.filters/svgfeblendelement/in2/) { get; } | Motsvarar attributet 'in2' på det givna 'feBlend'-elementet. |
...
| [Mode](../../aspose.svg.filters/svgfeblendelement/mode/) { get; } | Motsvarar attributet 'mode' på det givna 'feBlend'-elementet. Tar en av SVG_FEBLEND_MODE_*-konstanterna som definierats i detta gränssnitt. |
...
| const [SVG_FEBLEND_MODE_DARKEN](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_darken/) | Motsvarar värdet 'mörkare'. |
...
| const [SVG_FEBLEND_MODE_MULTIPLY](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_multiply/) | Motsvarar värdet 'multiplicera'. |
| const [SVG_FEBLEND_MODE_NORMAL](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_normal/) | Motsvarar värdet "normalt". |
...
| const [SVG_FEBLEND_MODE_SCREEN](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_screen/) | Motsvarar värdet 'skärm'. |
...
| const [SVG_FEBLEND_MODE_UNKNOWN](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_unknown/) | Typen är inte en av fördefinierade typer. Det är ogiltigt att försöka definiera ett nytt värde av denna typ eller att försöka ändra ett befintligt värde till denna typ. |
