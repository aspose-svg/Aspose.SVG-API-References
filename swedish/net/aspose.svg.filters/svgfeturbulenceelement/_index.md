...
description: Aspose.Svg.Filters.SVGFETurbulenceElement klass. SVGFETurbulenceElementgränssnittet motsvarar elementet feTurbulence.
type: docs
weight: 1890
...
| [BaseFrequencyX](../../aspose.svg.filters/svgfeturbulenceelement/basefrequencyx/) { get; } | Motsvarar attributet 'baseFrequency' på det givna 'feTurbulence'-elementet. Innehåller X-komponenten av attributet 'baseFrequency'. |
| [BaseFrequencyY](../../aspose.svg.filters/svgfeturbulenceelement/basefrequencyy/) { get; } | Motsvarar attributet 'baseFrequency' på det givna 'feTurbulence'-elementet. Innehåller Y-komponenten av (möjligen beräknad automatiskt) 'baseFrequency'-attributet. |
...
| [Height](../../aspose.svg.filters/svgfeturbulenceelement/height/) { get; } | Motsvarar attributet 'höjd' på det givna 'filter'-elementet. |
...
| [NumOctaves](../../aspose.svg.filters/svgfeturbulenceelement/numoctaves/) { get; } | Motsvarar attributet 'numOctaves' på det givna 'feTurbulence'-elementet. |
...
| [Seed](../../aspose.svg.filters/svgfeturbulenceelement/seed/) { get; } | Motsvarar attributet 'seed' på det givna 'feTurbulence'-elementet. |
...
| [StitchTiles](../../aspose.svg.filters/svgfeturbulenceelement/stitchtiles/) { get; } | Motsvarar attributet 'stitchTiles' på det givna 'feTurbulence'-elementet. Tar en av SVG_STITCHTYPE_* konstanterna som definierats i detta gränssnitt. |
...
| [Type](../../aspose.svg.filters/svgfeturbulenceelement/type/) { get; } | Motsvarar attributet 'type' på det givna 'feTurbulence'-elementet. Tar en av SVG_TURBULENCE_TYPE_* konstanterna som definierats i detta gränssnitt. |
...
| const [SVG_STITCHTYPE_UNKNOWN](../../aspose.svg.filters/svgfeturbulenceelement/svg_stitchtype_unknown/) | Typen är inte en av fördefinierade typer. Det är ogiltigt att försöka definiera ett nytt värde av denna typ eller att försöka ändra ett befintligt värde till denna typ. |
...
| const [SVG_TURBULENCE_TYPE_TURBULENCE](../../aspose.svg.filters/svgfeturbulenceelement/svg_turbulence_type_turbulence/) | Motsvarar värdet 'turbulens'. |
| const [SVG_TURBULENCE_TYPE_UNKNOWN](../../aspose.svg.filters/svgfeturbulenceelement/svg_turbulence_type_unknown/) | Typen är inte en av fördefinierade typer. Det är ogiltigt att försöka definiera ett nytt värde av denna typ eller att försöka ändra ett befintligt värde till denna typ. |
