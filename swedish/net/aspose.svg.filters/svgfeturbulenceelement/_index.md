...
description: "Aspose.Svg.Filters.SVGFETurbulenceElement klass. SVGFETurbulenceElement-gränssnittet motsvarar elementet feTurbulence."
type: docs
weight: 3980
url: /sv/net/aspose.svg.filters/svgfeturbulenceelement/
---
## SVGFETurbulenceElement class

SVGFETurbulenceElement-gränssnittet motsvarar ‘feTurbulence’-elementet.
...
| [BaseFrequencyX](../../aspose.svg.filters/svgfeturbulenceelement/basefrequencyx/) { get; } | Motsvarar attributet ‘baseFrequency’ på det angivna ‘feTurbulence’-elementet. Innehåller X-komponenten av attributet ‘baseFrequency’. |
| [BaseFrequencyY](../../aspose.svg.filters/svgfeturbulenceelement/basefrequencyy/) { get; } | Motsvarar attributet ‘baseFrequency’ på det angivna ‘feTurbulence’-elementet. Innehåller Y-komponenten av (möjligen automatiskt beräknade) attributet ‘baseFrequency’. |
...
| [Height](../../aspose.svg.filters/svgfeturbulenceelement/height/) { get; } | Motsvarar attributet ‘height’ på det givna ‘filter’-elementet. |
...
| [NumOctaves](../../aspose.svg.filters/svgfeturbulenceelement/numoctaves/) { get; } | Motsvarar attributet ‘numOctaves’ på det angivna ‘feTurbulence’-elementet. |
...
| [Result](../../aspose.svg.filters/svgfeturbulenceelement/result/) { get; } | Motsvarar attributet ‘result’ på det givna ‘filter’-elementet. |
| [Seed](../../aspose.svg.filters/svgfeturbulenceelement/seed/) { get; } | Motsvarar attributet ‘seed’ på det angivna ‘feTurbulence’-elementet. |
...
| [StitchTiles](../../aspose.svg.filters/svgfeturbulenceelement/stitchtiles/) { get; } | Motsvarar attributet ‘stitchTiles’ på det angivna ‘feTurbulence’-elementet. Accepterar en av SVG_STITCHTYPE_*-konstanterna som definierats i detta gränssnitt. |
...
| [Type](../../aspose.svg.filters/svgfeturbulenceelement/type/) { get; } | Motsvarar attributet ‘type’ på det angivna ‘feTurbulence’-elementet. Accepterar en av SVG_TURBULENCE_TYPE_*-konstanterna som definierats i detta gränssnitt. |
...
| [Width](../../aspose.svg.filters/svgfeturbulenceelement/width/) { get; } | Motsvarar attributet ‘width’ på det givna ‘filter’-elementet. |
| [X](../../aspose.svg.filters/svgfeturbulenceelement/x/) { get; } | Motsvarar attributet ‘x’ på det givna ‘filter’-elementet. |
| [Y](../../aspose.svg.filters/svgfeturbulenceelement/y/) { get; } | Motsvarar attributet ‘y’ på det givna ‘filter’-elementet. |
...
| Namn | Beskrivning |
| --- | --- |
| const [SVG_STITCHTYPE_NOSTITCH](../../aspose.svg.filters/svgfeturbulenceelement/svg_stitchtype_nostitch/) | Motsvarar värdet 'noStitch'. |
| const [SVG_STITCHTYPE_STITCH](../../aspose.svg.filters/svgfeturbulenceelement/svg_stitchtype_stitch/) | Motsvarar värdet 'stitch'. |
| const [SVG_STITCHTYPE_UNKNOWN](../../aspose.svg.filters/svgfeturbulenceelement/svg_stitchtype_unknown/) | Typen är inte en av de fördefinierade typerna. Det är ogiltigt att försöka definiera ett nytt värde av denna typ eller att försöka byta ett befintligt värde till denna typ. |
| const [SVG_TURBULENCE_TYPE_FRACTALNOISE](../../aspose.svg.filters/svgfeturbulenceelement/svg_turbulence_type_fractalnoise/) | Motsvarar värdet 'fractalNoise'. |
| const [SVG_TURBULENCE_TYPE_TURBULENCE](../../aspose.svg.filters/svgfeturbulenceelement/svg_turbulence_type_turbulence/) | Motsvarar värdet 'turbulence'. |
| const [SVG_TURBULENCE_TYPE_UNKNOWN](../../aspose.svg.filters/svgfeturbulenceelement/svg_turbulence_type_unknown/) | Typen är inte en av de fördefinierade typerna. Det är ogiltigt att försöka definiera ett nytt värde av denna typ eller att försöka byta ett befintligt värde till denna typ. |
