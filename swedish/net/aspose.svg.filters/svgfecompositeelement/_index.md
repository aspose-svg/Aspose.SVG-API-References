...
description: "Aspose.Svg.Filters.SVGFECompositeElement klass. SVGFECompositeElement-gränssnittet motsvarar feComposite-elementet."
type: docs
weight: 3770
url: /sv/net/aspose.svg.filters/svgfecompositeelement/
---
...
| [Height](../../aspose.svg.filters/svgfecompositeelement/height/) { get; } | Motsvarar attributet ‘height’ på det givna ‘filter’-elementet. |
...
| [In1](../../aspose.svg.filters/svgfecompositeelement/in1/) { get; } | Motsvarar attributet ‘in’ på det angivna ‘feComposite’-elementet. |
| [In2](../../aspose.svg.filters/svgfecompositeelement/in2/) { get; } | Motsvarar attributet ‘in2’ på det angivna ‘feComposite’-elementet. |
...
| [K1](../../aspose.svg.filters/svgfecompositeelement/k1/) { get; } | Motsvarar attributet ‘k1’ på det angivna ‘feComposite’-elementet. |
| [K2](../../aspose.svg.filters/svgfecompositeelement/k2/) { get; } | Motsvarar attributet ‘k2’ på det angivna ‘feComposite’-elementet. |
| [K3](../../aspose.svg.filters/svgfecompositeelement/k3/) { get; } | Motsvarar attributet ‘k3’ på det angivna ‘feComposite’-elementet. |
| [K4](../../aspose.svg.filters/svgfecompositeelement/k4/) { get; } | Motsvarar attributet ‘k4’ på det angivna ‘feComposite’-elementet. |
...
| [Operator](../../aspose.svg.filters/svgfecompositeelement/operator/) { get; } | Motsvarar attributet ‘operator’ på det angivna ‘feComposite’-elementet. Accepterar en av SVG_FECOMPOSITE_OPERATOR_*-konstanterna som definieras på detta gränssnitt. |
...
| [Result](../../aspose.svg.filters/svgfecompositeelement/result/) { get; } | Motsvarar attributet ‘result’ på det givna ‘filter’-elementet. |
...
| [Width](../../aspose.svg.filters/svgfecompositeelement/width/) { get; } | Motsvarar attributet ‘width’ på det givna ‘filter’-elementet. |
| [X](../../aspose.svg.filters/svgfecompositeelement/x/) { get; } | Motsvarar attributet ‘x’ på det givna ‘filter’-elementet. |
| [Y](../../aspose.svg.filters/svgfecompositeelement/y/) { get; } | Motsvarar attributet ‘y’ på det givna ‘filter’-elementet. |
...
| Namn | Beskrivning |
| --- | --- |
| const [SVG_FECOMPOSITE_OPERATOR_ARITHMETIC](../../aspose.svg.filters/svgfecompositeelement/svg_fecomposite_operator_arithmetic/) | Motsvarar värdet 'arithmetic'. |
| const [SVG_FECOMPOSITE_OPERATOR_ATOP](../../aspose.svg.filters/svgfecompositeelement/svg_fecomposite_operator_atop/) | Motsvarar värdet 'atop'. |
| const [SVG_FECOMPOSITE_OPERATOR_IN](../../aspose.svg.filters/svgfecompositeelement/svg_fecomposite_operator_in/) | Motsvarar värdet 'in'. |
| const [SVG_FECOMPOSITE_OPERATOR_OUT](../../aspose.svg.filters/svgfecompositeelement/svg_fecomposite_operator_out/) | Motsvarar värdet 'out'. |
| const [SVG_FECOMPOSITE_OPERATOR_OVER](../../aspose.svg.filters/svgfecompositeelement/svg_fecomposite_operator_over/) | Motsvarar värdet 'over'. |
| const [SVG_FECOMPOSITE_OPERATOR_UNKNOWN](../../aspose.svg.filters/svgfecompositeelement/svg_fecomposite_operator_unknown/) | Typen är inte en av de fördefinierade typerna. Det är ogiltigt att försöka definiera ett nytt värde av denna typ eller att försöka byta ett befintligt värde till denna typ. |
| const [SVG_FECOMPOSITE_OPERATOR_XOR](../../aspose.svg.filters/svgfecompositeelement/svg_fecomposite_operator_xor/) | Motsvarar värdet 'xor'. |
