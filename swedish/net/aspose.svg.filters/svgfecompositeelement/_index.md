...
description: Aspose.Svg.Filters.SVGFECompositeElement klass. SVGFECompositeElementgränssnittet motsvarar elementet feComposite.
type: docs
weight: 1680
...
| [Height](../../aspose.svg.filters/svgfecompositeelement/height/) { get; } | Motsvarar attributet 'höjd' på det givna 'filter'-elementet. |
...
| [In1](../../aspose.svg.filters/svgfecompositeelement/in1/) { get; } | Motsvarar attributet 'in' på det givna 'feComposite'-elementet. |
| [In2](../../aspose.svg.filters/svgfecompositeelement/in2/) { get; } | Motsvarar attributet 'in2' på det givna 'feComposite'-elementet. |
...
| [K1](../../aspose.svg.filters/svgfecompositeelement/k1/) { get; } | Motsvarar attributet 'k1' på det givna 'feComposite'-elementet. |
| [K2](../../aspose.svg.filters/svgfecompositeelement/k2/) { get; } | Motsvarar attributet 'k2' på det givna 'feComposite'-elementet. |
| [K3](../../aspose.svg.filters/svgfecompositeelement/k3/) { get; } | Motsvarar attributet 'k3' på det givna 'feComposite'-elementet. |
| [K4](../../aspose.svg.filters/svgfecompositeelement/k4/) { get; } | Motsvarar attributet 'k4' på det givna 'feComposite'-elementet. |
...
| [Operator](../../aspose.svg.filters/svgfecompositeelement/operator/) { get; } | Motsvarar attributet 'operator' på det givna 'feComposite'-elementet. Tar en av SVG_FECOMPOSITE_OPERATOR_* konstanterna som definierats i detta gränssnitt. |
...
| const [SVG_FECOMPOSITE_OPERATOR_OVER](../../aspose.svg.filters/svgfecompositeelement/svg_fecomposite_operator_over/) | Motsvarar värdet 'över'. |
| const [SVG_FECOMPOSITE_OPERATOR_UNKNOWN](../../aspose.svg.filters/svgfecompositeelement/svg_fecomposite_operator_unknown/) | Typen är inte en av fördefinierade typer. Det är ogiltigt att försöka definiera ett nytt värde av denna typ eller att försöka ändra ett befintligt värde till denna typ. |
