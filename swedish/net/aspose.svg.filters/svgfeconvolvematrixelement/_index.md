...
description: Aspose.Svg.Filters.SVGFEConvolveMatrixElement klass. SVGFEConvolveMatrixElementgränssnittet motsvarar elementet feConvolveMatrix.
type: docs
weight: 1690
url: /sv/net/aspose.svg.filters/svgfeconvolvematrixelement/
---
...
| [Bias](../../aspose.svg.filters/svgfeconvolvematrixelement/bias/) { get; } | Motsvarar attributet 'bias' på det givna 'feConvolveMatrix'-elementet. |
...
| [Divisor](../../aspose.svg.filters/svgfeconvolvematrixelement/divisor/) { get; } | Motsvarar attributet 'divisor' på det givna 'feConvolveMatrix'-elementet. |
| [EdgeMode](../../aspose.svg.filters/svgfeconvolvematrixelement/edgemode/) { get; } | Motsvarar attributet 'edgeMode' på det givna 'feConvolveMatrix'-elementet. |
...
| [Height](../../aspose.svg.filters/svgfeconvolvematrixelement/height/) { get; } | Motsvarar attributet 'höjd' på det givna 'filter'-elementet. |
...
| [In1](../../aspose.svg.filters/svgfeconvolvematrixelement/in1/) { get; } | Motsvarar attributet 'in' på det givna 'feConvolveMatrix'-elementet. |
...
| [KernelMatrix](../../aspose.svg.filters/svgfeconvolvematrixelement/kernelmatrix/) { get; } | Motsvarar attributet 'kernelMatrix' på det givna 'feConvolveMatrix'-elementet. |
| [KernelUnitLengthX](../../aspose.svg.filters/svgfeconvolvematrixelement/kernelunitlengthx/) { get; } | Motsvarar attributet 'kernelUnitLength' på det givna 'feConvolveMatrix'-elementet. |
| [KernelUnitLengthY](../../aspose.svg.filters/svgfeconvolvematrixelement/kernelunitlengthy/) { get; } | Motsvarar attributet 'kernelUnitLength' på det givna 'feConvolveMatrix'-elementet. |
...
| [OrderX](../../aspose.svg.filters/svgfeconvolvematrixelement/orderx/) { get; } | Motsvarar attributet 'order' på det givna 'feConvolveMatrix'-elementet. |
| [OrderY](../../aspose.svg.filters/svgfeconvolvematrixelement/ordery/) { get; } | Motsvarar attributet 'order' på det givna 'feConvolveMatrix'-elementet. |
...
| [PreserveAlpha](../../aspose.svg.filters/svgfeconvolvematrixelement/preservealpha/) { get; } | Motsvarar attributet 'preserveAlpha' på det givna 'feConvolveMatrix'-elementet. |
...
| [Result](../../aspose.svg.filters/svgfeconvolvematrixelement/result/) { get; } | Motsvarar attributet 'result' på det givna 'filter'-elementet. |
...
| [TargetX](../../aspose.svg.filters/svgfeconvolvematrixelement/targetx/) { get; } | Motsvarar attributet 'targetX' på det givna 'feConvolveMatrix'-elementet. |
| [TargetY](../../aspose.svg.filters/svgfeconvolvematrixelement/targety/) { get; } | Motsvarar attributet 'targetY' på det givna 'feConvolveMatrix'-elementet. |
...
| [Width](../../aspose.svg.filters/svgfeconvolvematrixelement/width/) { get; } | Motsvarar attributet 'width' på det givna 'filter'-elementet. |
| [X](../../aspose.svg.filters/svgfeconvolvematrixelement/x/) { get; } | Motsvarar attributet 'x' på det givna 'filter'-elementet. |
| [Y](../../aspose.svg.filters/svgfeconvolvematrixelement/y/) { get; } | Motsvarar attributet 'y' på det givna 'filter'-elementet. |
...
| namn | Beskrivning |
| --- | --- |
| const [SVG_EDGEMODE_DUPLICATE](../../aspose.svg.filters/svgfeconvolvematrixelement/svg_edgemode_duplicate/) | Motsvarar värdet 'duplicera'. |
| const [SVG_EDGEMODE_NONE](../../aspose.svg.filters/svgfeconvolvematrixelement/svg_edgemode_none/) | Motsvarar värdet 'ingen'. |
| const [SVG_EDGEMODE_UNKNOWN](../../aspose.svg.filters/svgfeconvolvematrixelement/svg_edgemode_unknown/) | Typen är inte en av fördefinierade typer. Det är ogiltigt att försöka definiera ett nytt värde av denna typ eller att försöka ändra ett befintligt värde till denna typ. |
| const [SVG_EDGEMODE_WRAP](../../aspose.svg.filters/svgfeconvolvematrixelement/svg_edgemode_wrap/) | Motsvarar värdet 'wrap'. |
