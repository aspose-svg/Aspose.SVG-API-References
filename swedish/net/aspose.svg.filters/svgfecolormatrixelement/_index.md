...
description: "Aspose.Svg.Filters.SVGFEColorMatrixElement-klass. SVGFEColorMatrixElement-gränssnittet motsvarar feColorMatrix-elementet."
type: docs
weight: 3750
url: /sv/net/aspose.svg.filters/svgfecolormatrixelement/
---
...
| [Height](../../aspose.svg.filters/svgfecolormatrixelement/height/) { get; } | Motsvarar attributet ‘height’ på det givna ‘filter’-elementet. |
...
| [In1](../../aspose.svg.filters/svgfecolormatrixelement/in1/) { get; } | Motsvarar attributet ‘in’ på det givna ‘feColorMatrix’-elementet. |
...
| [Result](../../aspose.svg.filters/svgfecolormatrixelement/result/) { get; } | Motsvarar attributet ‘result’ på det givna ‘filter’-elementet. |
...
| [Type](../../aspose.svg.filters/svgfecolormatrixelement/type/) { get; } | Motsvarar attributet ‘type’ på det givna ‘feColorMatrix’-elementet. Tar en av SVG_FECOLORMATRIX_TYPE_*-konstanterna som definieras i detta gränssnitt. |
| [Values](../../aspose.svg.filters/svgfecolormatrixelement/values/) { get; } | Motsvarar attributet ‘values’ på det givna ‘feColorMatrix’-elementet. |
...
| [Width](../../aspose.svg.filters/svgfecolormatrixelement/width/) { get; } | Motsvarar attributet ‘width’ på det givna ‘filter’-elementet. |
| [X](../../aspose.svg.filters/svgfecolormatrixelement/x/) { get; } | Motsvarar attributet ‘x’ på det givna ‘filter’-elementet. |
| [Y](../../aspose.svg.filters/svgfecolormatrixelement/y/) { get; } | Motsvarar attributet ‘y’ på det givna ‘filter’-elementet. |
...
| Namn | Beskrivning |
| --- | --- |
| const [SVG_FECOLORMATRIX_TYPE_HUEROTATE](../../aspose.svg.filters/svgfecolormatrixelement/svg_fecolormatrix_type_huerotate/) | Motsvarar värdet 'hueRotate'. |
| const [SVG_FECOLORMATRIX_TYPE_LUMINANCETOALPHA](../../aspose.svg.filters/svgfecolormatrixelement/svg_fecolormatrix_type_luminancetoalpha/) | Motsvarar värdet 'luminanceToAlpha'. |
| const [SVG_FECOLORMATRIX_TYPE_MATRIX](../../aspose.svg.filters/svgfecolormatrixelement/svg_fecolormatrix_type_matrix/) | Motsvarar värdet 'matrix'. |
| const [SVG_FECOLORMATRIX_TYPE_SATURATE](../../aspose.svg.filters/svgfecolormatrixelement/svg_fecolormatrix_type_saturate/) | Motsvarar värdet 'saturate'. |
| const [SVG_FECOLORMATRIX_TYPE_UNKNOWN](../../aspose.svg.filters/svgfecolormatrixelement/svg_fecolormatrix_type_unknown/) | Typen är inte en av de fördefinierade typerna. Det är ogiltigt att försöka definiera ett nytt värde av denna typ eller att försöka byta ett befintligt värde till denna typ. |
