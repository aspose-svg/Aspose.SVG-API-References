...
description: Aspose.Svg.Filters.SVGFEColorMatrixElement klass. SVGFEColorMatrixElementgränssnittet motsvarar elementet feColorMatrix.
type: docs
weight: 1660
...
| [Height](../../aspose.svg.filters/svgfecolormatrixelement/height/) { get; } | Motsvarar attributet 'höjd' på det givna 'filter'-elementet. |
...
| [Type](../../aspose.svg.filters/svgfecolormatrixelement/type/) { get; } | Motsvarar attributet 'type' på det givna 'feColorMatrix'-elementet. Tar en av SVG_FECOLORMATRIX_TYPE_* konstanterna som definierats i detta gränssnitt. |
| [Values](../../aspose.svg.filters/svgfecolormatrixelement/values/) { get; } | Motsvarar attributet 'värden' på det givna 'feColorMatrix'-elementet. |
...
| const [SVG_FECOLORMATRIX_TYPE_MATRIX](../../aspose.svg.filters/svgfecolormatrixelement/svg_fecolormatrix_type_matrix/) | Motsvarar värdet 'matris'. |
...
| const [SVG_FECOLORMATRIX_TYPE_UNKNOWN](../../aspose.svg.filters/svgfecolormatrixelement/svg_fecolormatrix_type_unknown/) | Typen är inte en av fördefinierade typer. Det är ogiltigt att försöka definiera ett nytt värde av denna typ eller att försöka ändra ett befintligt värde till denna typ. |
