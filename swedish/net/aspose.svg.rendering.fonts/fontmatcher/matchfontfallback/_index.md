...
description: Den här metoden anropas om det inte finns något lämpligt teckensnitt i sökmapparna för teckensnitt. Den bör returnera true typeteckensnitt baserat påfontMatchingProperties som kan återgecharCode  ellernull om ett sådant teckensnitt inte är tillgängligt.
type: docs
weight: 10
