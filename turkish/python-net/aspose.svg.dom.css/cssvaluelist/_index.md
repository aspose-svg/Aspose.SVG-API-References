...
type: docs
weight: 30
url: /tr/python-net/aspose.svg.dom.css/cssvaluelist/
is_root: false
---
...
**Inheritance:** [`CSSValueList`](/svg/python-net/aspose.svg.dom.css/cssvaluelist) → 
...
| :- | :- |
| [__init__](/svg/python-net/aspose.svg.dom.css/cssvaluelist/__init__/#) | Initializes a new instance of the [`CSSValueList`](/svg/python-net/aspose.svg.dom.css/cssvaluelist) class. |
| [__init__](/svg/python-net/aspose.svg.dom.css/cssvaluelist/__init__/#list) | Constructs a new instance of CSSValueList |
| [__init__](/svg/python-net/aspose.svg.dom.css/cssvaluelist/__init__/#list) | Initializes a new instance of the [`CSSValueList`](/svg/python-net/aspose.svg.dom.css/cssvaluelist) class. |
...
| Method | Description |
| :- | :- |
| [get_platform_type](/svg/python-net/aspose.svg.dom.css/cssvaluelist/get_platform_type/#) | This method is used to retrieve ECMAScript object Type. |
