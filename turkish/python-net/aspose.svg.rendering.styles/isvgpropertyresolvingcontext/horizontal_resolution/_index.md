...
type: docs
weight: 90
url: /tr/python-net/aspose.svg.rendering.styles/isvgpropertyresolvingcontext/horizontal_resolution/
is_root: false
---
...
Gets the horizontal resolution of the context. See [`Resolution`](/svg/python-net/aspose.svg.drawing/resolution).
### Definition:
```python
@property
