...
description: "SVGBuilderExtensions AddFeOffset yöntemi. Builder'a bir feOffset öğesi yapılandırması ekler. Bu öğe, giriş görüntüsünü belirtilen bir vektörle kaydırır"
type: docs
weight: 260
url: /tr/net/aspose.svg.builder/svgbuilderextensions/addfeoffset/
---
## AddFeOffset<TBuilder>(*this TBuilder, Action&lt;SVGFEOffsetElementBuilder&gt;*) {#addfeoffset}

Yapıcıya bir 'feOffset' öğesi yapılandırması ekler. Bu öğe, giriş görüntüsünü belirtilen bir vektörle kaydırır.
...
| yapılandır | 'feOffset' öğesi için yapılandırma eylemi. |
...
| oluşturucu | 'feOffset' öğesinin ekleneceği SVG builder örneği. |
| dx | Yatay kaydırma mesafesi. İsteğe bağlı parametre. |
| dy | Dikey kaydırma mesafesi. İsteğe bağlı parametre. |
| in | Kaydırmanın uygulanacağı giriş görüntüsü. Bir dize veya FilterInput olabilir. İsteğe bağlı parametre. |
...
| genişlet | SVGFEOffsetElementBuilder'ı daha da yapılandırmak için isteğe bağlı bir eylem. |
