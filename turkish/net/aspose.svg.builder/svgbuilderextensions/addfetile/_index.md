...
description: "SVGBuilderExtensions AddFeTile yöntemi. Builder'a bir feTile öğesi yapılandırması ekler. Bu öğe, bir giriş görüntüsünün tekrarlanan döşeme desenini kullanarak bir dikdörtgeni doldurur."
type: docs
weight: 280
url: /tr/net/aspose.svg.builder/svgbuilderextensions/addfetile/
---
## AddFeTile<TBuilder>(*this TBuilder, Action&lt;SVGFETileElementBuilder&gt;*) {#addfetile_1}

Yapıcıya bir 'feTile' öğesi yapılandırması ekler. Bu öğe, bir dikdörtgeni giriş görüntüsünün tekrarlanan döşeme deseniyle doldurur.
...
| yapılandır | ‘feTile’ öğesi için yapılandırma eylemi. |
...
SVG yapıcıya bir 'feTile' öğesi ekler, giriş görüntüsünü çoğaltarak bir döşeme deseni oluşturur.
...
| oluşturucu | ‘feTile’ öğesinin ekleneceği SVG builder örneği. |
| in | Döşemeler halinde çoğaltılacak giriş görüntüsü. Bir dize veya FilterInput olabilir. İsteğe bağlı parametre. |
...
| genişlet | SVGFETileElementBuilder'ı daha da yapılandırmak için isteğe bağlı bir eylem. |
