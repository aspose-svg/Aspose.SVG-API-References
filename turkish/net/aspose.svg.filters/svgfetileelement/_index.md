...
description: Aspose.Svg.Filters.SVGFETileElement sınıf. SVGFETileElement arabirimi feTile öğesine karşılık gelir.
type: docs
weight: 1880
url: /tr/net/aspose.svg.filters/svgfetileelement/
---
...
| [Height](../../aspose.svg.filters/svgfetileelement/height/) { get; } | Belirtilen 'filtre' öğesindeki 'yükseklik' özelliğine karşılık gelir. |
| [Id](../../aspose.svg/svgelement/id/) { get; set; } | Belirtilen öğedeki 'id' özniteliğinin değeri veya 'id' yoksa boş dize. |
| [In1](../../aspose.svg.filters/svgfetileelement/in1/) { get; } | Verilen 'feTile' öğesindeki 'in' özniteliğine karşılık gelir. |
...
| [Result](../../aspose.svg.filters/svgfetileelement/result/) { get; } | Belirtilen 'filtre' öğesindeki 'sonuç' özniteliğine karşılık gelir. |
...
| [Width](../../aspose.svg.filters/svgfetileelement/width/) { get; } | Verilen 'filtre' öğesindeki 'genişlik' özelliğine karşılık gelir. |
| [X](../../aspose.svg.filters/svgfetileelement/x/) { get; } | Verilen 'filtre' öğesindeki 'x' özniteliğine karşılık gelir. |
| [Y](../../aspose.svg.filters/svgfetileelement/y/) { get; } | Verilen 'filtre' öğesindeki 'y' özniteliğine karşılık gelir. |
