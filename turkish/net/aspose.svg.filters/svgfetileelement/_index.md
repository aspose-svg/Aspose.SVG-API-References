...
description: SVGFETileElement arabirimi feTile öğesine karşılık gelir.
type: docs
weight: 1880
...
| [Height](../../aspose.svg.filters/svgfetileelement/height) { get; } | Verilen 'filtre' öğesindeki 'yükseklik' özelliğine karşılık gelir. |
| [Id](../../aspose.svg/svgelement/id) { get; set; } | Verilen öğedeki 'id' özniteliğinin değeri veya 'id' yoksa boş dize. |
| [In1](../../aspose.svg.filters/svgfetileelement/in1) { get; } | Verilen 'feTile' öğesindeki 'in' özelliğine karşılık gelir. |
...
| [Result](../../aspose.svg.filters/svgfetileelement/result) { get; } | Verilen 'filtre' öğesindeki 'sonuç' niteliğine karşılık gelir. |
...
| [Width](../../aspose.svg.filters/svgfetileelement/width) { get; } | Verilen 'filtre' öğesindeki 'width' özelliğine karşılık gelir. |
| [X](../../aspose.svg.filters/svgfetileelement/x) { get; } | Verilen 'filtre' öğesindeki 'x' özelliğine karşılık gelir. |
