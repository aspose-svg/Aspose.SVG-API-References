...
description: SVGFEDropShadowElement arabirimi feDropShadow öğesine karşılık gelir.
type: docs
weight: 1730
...
| [Dx](../../aspose.svg.filters/svgfedropshadowelement/dx) { get; } | Verilen 'feDropShadow' öğesinde 'dx' özniteliğine karşılık gelir. |
...
| [Height](../../aspose.svg.filters/svgfedropshadowelement/height) { get; } | Verilen 'feDropShadow' öğesindeki 'yükseklik' özelliğine karşılık gelir. |
| [Id](../../aspose.svg/svgelement/id) { get; set; } | Verilen öğedeki 'id' özniteliğinin değeri veya 'id' yoksa boş dize. |
| [In1](../../aspose.svg.filters/svgfedropshadowelement/in1) { get; } | Verilen 'feDropShadow' öğesindeki 'in' özelliğine karşılık gelir. |
...
| [Result](../../aspose.svg.filters/svgfedropshadowelement/result) { get; } | Verilen 'feDropShadow' öğesinde 'sonuç' niteliğine karşılık gelir. |
...
| [StdDeviationX](../../aspose.svg.filters/svgfedropshadowelement/stddeviationx) { get; } | Verilen 'feDropShadow' öğesinde 'stdDeviation' özniteliğine karşılık gelir. 'stdDeviation'. özniteliğinin X bileşenini içerir |
| [StdDeviationY](../../aspose.svg.filters/svgfedropshadowelement/stddeviationy) { get; } | Verilen 'feDropShadow' öğesinde 'stdDeviation' özniteliğine karşılık gelir. 'stdDeviation'. özniteliğinin Y bileşenini (muhtemelen otomatik olarak hesaplanır) içerir. |
...
| [Width](../../aspose.svg.filters/svgfedropshadowelement/width) { get; } | Verilen 'feDropShadow' öğesindeki 'width' özniteliğine karşılık gelir. |
| [X](../../aspose.svg.filters/svgfedropshadowelement/x) { get; } | Verilen 'feDropShadow' öğesindeki 'x' özelliğine karşılık gelir. |
