...
description: Aspose.Svg.Filters.SVGFEDropShadowElement sınıf. SVGFEDropShadowElement arabirimi feDropShadow öğesine karşılık gelir.
type: docs
weight: 1730
url: /tr/net/aspose.svg.filters/svgfedropshadowelement/
---
...
| [Dx](../../aspose.svg.filters/svgfedropshadowelement/dx/) { get; } | Verilen 'feDropShadow' öğesindeki 'dx' özniteliğine karşılık gelir. |
| [Dy](../../aspose.svg.filters/svgfedropshadowelement/dy/) { get; } | Verilen 'feDropShadow' öğesindeki 'dy' özniteliğine karşılık gelir. |
...
| [Height](../../aspose.svg.filters/svgfedropshadowelement/height/) { get; } | Belirtilen 'feDropShadow' öğesindeki 'yükseklik' özelliğine karşılık gelir. |
| [Id](../../aspose.svg/svgelement/id/) { get; set; } | Belirtilen öğedeki 'id' özniteliğinin değeri veya 'id' yoksa boş dize. |
| [In1](../../aspose.svg.filters/svgfedropshadowelement/in1/) { get; } | Verilen 'feDropShadow' öğesindeki 'in' özniteliğine karşılık gelir. |
...
| [Result](../../aspose.svg.filters/svgfedropshadowelement/result/) { get; } | Verilen 'feDropShadow' öğesindeki 'sonuç' özniteliğine karşılık gelir. |
...
| [StdDeviationX](../../aspose.svg.filters/svgfedropshadowelement/stddeviationx/) { get; } | Verilen 'feDropShadow' öğesindeki 'stdDeviation' özniteliğine karşılık gelir. 'stdDeviation'. özniteliğinin X bileşenini içerir |
| [StdDeviationY](../../aspose.svg.filters/svgfedropshadowelement/stddeviationy/) { get; } | Verilen 'feDropShadow' öğesindeki 'stdDeviation' özniteliğine karşılık gelir. 'stdDeviation' özniteliğinin Y bileşenini (muhtemelen otomatik olarak hesaplanmıştır) içerir. |
...
| [Width](../../aspose.svg.filters/svgfedropshadowelement/width/) { get; } | Verilen 'feDropShadow' öğesindeki 'genişlik' özelliğine karşılık gelir. |
| [X](../../aspose.svg.filters/svgfedropshadowelement/x/) { get; } | Verilen 'feDropShadow' öğesindeki 'x' özniteliğine karşılık gelir. |
| [Y](../../aspose.svg.filters/svgfedropshadowelement/y/) { get; } | Verilen 'feDropShadow' öğesindeki 'y' özniteliğine karşılık gelir. |
...
| [SetStdDeviation](../../aspose.svg.filters/svgfedropshadowelement/setstddeviation/)(float, float) | 'stdDeviation' özniteliği için değerleri ayarlar. |
