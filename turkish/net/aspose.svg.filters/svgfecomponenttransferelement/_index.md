...
description: Aspose.Svg.Filters.SVGFEComponentTransferElement sınıf. SVGFEComponentTransferElement arabirimi feComponentTransfer öğesine karşılık gelir.
type: docs
weight: 1670
url: /tr/net/aspose.svg.filters/svgfecomponenttransferelement/
---
...
| [Height](../../aspose.svg.filters/svgfecomponenttransferelement/height/) { get; } | Belirtilen 'filtre' öğesindeki 'yükseklik' özelliğine karşılık gelir. |
| [Id](../../aspose.svg/svgelement/id/) { get; set; } | Belirtilen öğedeki 'id' özniteliğinin değeri veya 'id' yoksa boş dize. |
| [In1](../../aspose.svg.filters/svgfecomponenttransferelement/in1/) { get; } | Verilen 'feComponentTransfer' öğesindeki 'in' özniteliğine karşılık gelir. |
...
| [Result](../../aspose.svg.filters/svgfecomponenttransferelement/result/) { get; } | Belirtilen 'filtre' öğesindeki 'sonuç' özniteliğine karşılık gelir. |
...
| [Width](../../aspose.svg.filters/svgfecomponenttransferelement/width/) { get; } | Verilen 'filtre' öğesindeki 'genişlik' özelliğine karşılık gelir. |
| [X](../../aspose.svg.filters/svgfecomponenttransferelement/x/) { get; } | Verilen 'filtre' öğesindeki 'x' özniteliğine karşılık gelir. |
| [Y](../../aspose.svg.filters/svgfecomponenttransferelement/y/) { get; } | Verilen 'filtre' öğesindeki 'y' özniteliğine karşılık gelir. |
