...
description: SVGFEComponentTransferElement arabirimi feComponentTransfer öğesine karşılık gelir.
type: docs
weight: 1670
...
| [Height](../../aspose.svg.filters/svgfecomponenttransferelement/height) { get; } | Verilen 'filtre' öğesindeki 'yükseklik' özelliğine karşılık gelir. |
| [Id](../../aspose.svg/svgelement/id) { get; set; } | Verilen öğedeki 'id' özniteliğinin değeri veya 'id' yoksa boş dize. |
| [In1](../../aspose.svg.filters/svgfecomponenttransferelement/in1) { get; } | Verilen 'feComponentTransfer' öğesindeki 'in' özelliğine karşılık gelir. |
...
| [Result](../../aspose.svg.filters/svgfecomponenttransferelement/result) { get; } | Verilen 'filtre' öğesindeki 'sonuç' niteliğine karşılık gelir. |
...
| [Width](../../aspose.svg.filters/svgfecomponenttransferelement/width) { get; } | Verilen 'filtre' öğesindeki 'width' özelliğine karşılık gelir. |
| [X](../../aspose.svg.filters/svgfecomponenttransferelement/x) { get; } | Verilen 'filtre' öğesindeki 'x' özelliğine karşılık gelir. |
