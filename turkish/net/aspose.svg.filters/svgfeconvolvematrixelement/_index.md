...
description: SVGFEConvolveMatrixElement arabirimi feConvolveMatrix öğesine karşılık gelir.
type: docs
weight: 1690
...
| [Bias](../../aspose.svg.filters/svgfeconvolvematrixelement/bias) { get; } | Verilen 'feConvolveMatrix' öğesindeki 'önyargı' özniteliğine karşılık gelir. |
...
| [Divisor](../../aspose.svg.filters/svgfeconvolvematrixelement/divisor) { get; } | Verilen 'feConvolveMatrix' öğesindeki 'bölen' özniteliğine karşılık gelir. |
| [EdgeMode](../../aspose.svg.filters/svgfeconvolvematrixelement/edgemode) { get; } | Verilen 'feConvolveMatrix' öğesinde 'edgeMode' özniteliğine karşılık gelir. |
...
| [Height](../../aspose.svg.filters/svgfeconvolvematrixelement/height) { get; } | Verilen 'filtre' öğesindeki 'yükseklik' özelliğine karşılık gelir. |
| [Id](../../aspose.svg/svgelement/id) { get; set; } | Verilen öğedeki 'id' özniteliğinin değeri veya 'id' yoksa boş dize. |
| [In1](../../aspose.svg.filters/svgfeconvolvematrixelement/in1) { get; } | Verilen 'feConvolveMatrix' öğesindeki 'in' özelliğine karşılık gelir. |
...
| [KernelMatrix](../../aspose.svg.filters/svgfeconvolvematrixelement/kernelmatrix) { get; } | Verilen 'feConvolveMatrix' öğesinde 'kernelMatrix' özniteliğine karşılık gelir. |
| [KernelUnitLengthX](../../aspose.svg.filters/svgfeconvolvematrixelement/kernelunitlengthx) { get; } | Verilen 'feConvolveMatrix' öğesinde 'kernelUnitLength' özniteliğine karşılık gelir. |
| [KernelUnitLengthY](../../aspose.svg.filters/svgfeconvolvematrixelement/kernelunitlengthy) { get; } | Verilen 'feConvolveMatrix' öğesinde 'kernelUnitLength' özniteliğine karşılık gelir. |
...
| [OrderX](../../aspose.svg.filters/svgfeconvolvematrixelement/orderx) { get; } | Verilen 'feConvolveMatrix' öğesindeki 'sipariş' özniteliğine karşılık gelir. |
| [OrderY](../../aspose.svg.filters/svgfeconvolvematrixelement/ordery) { get; } | Verilen 'feConvolveMatrix' öğesindeki 'sipariş' özniteliğine karşılık gelir. |
...
| [PreserveAlpha](../../aspose.svg.filters/svgfeconvolvematrixelement/preservealpha) { get; } | Verilen 'feConvolveMatrix' öğesinde 'preserveAlpha' özniteliğine karşılık gelir. |
...
| [Result](../../aspose.svg.filters/svgfeconvolvematrixelement/result) { get; } | Verilen 'filtre' öğesindeki 'sonuç' niteliğine karşılık gelir. |
...
| [Width](../../aspose.svg.filters/svgfeconvolvematrixelement/width) { get; } | Verilen 'filtre' öğesindeki 'width' özelliğine karşılık gelir. |
| [X](../../aspose.svg.filters/svgfeconvolvematrixelement/x) { get; } | Verilen 'filtre' öğesindeki 'x' özelliğine karşılık gelir. |
...
| const [SVG_EDGEMODE_NONE](../../aspose.svg.filters/svgfeconvolvematrixelement/svg_edgemode_none) | 'none' değerine karşılık gelir. |
...
| const [SVG_EDGEMODE_WRAP](../../aspose.svg.filters/svgfeconvolvematrixelement/svg_edgemode_wrap) | 'wrap' değerine karşılık gelir. |
