...
description: Aspose.Svg.Filters.SVGFEConvolveMatrixElement sınıf. SVGFEConvolveMatrixElement arabirimi feConvolveMatrix öğesine karşılık gelir.
type: docs
weight: 1690
url: /tr/net/aspose.svg.filters/svgfeconvolvematrixelement/
---
...
| [Bias](../../aspose.svg.filters/svgfeconvolvematrixelement/bias/) { get; } | Verilen 'feConvolveMatrix' öğesindeki 'bias' özniteliğine karşılık gelir. |
...
| [Divisor](../../aspose.svg.filters/svgfeconvolvematrixelement/divisor/) { get; } | Verilen 'feConvolveMatrix' öğesindeki 'divisor' özniteliğine karşılık gelir. |
| [EdgeMode](../../aspose.svg.filters/svgfeconvolvematrixelement/edgemode/) { get; } | Verilen 'feConvolveMatrix' öğesindeki 'edgeMode' özniteliğine karşılık gelir. |
...
| [Height](../../aspose.svg.filters/svgfeconvolvematrixelement/height/) { get; } | Belirtilen 'filtre' öğesindeki 'yükseklik' özelliğine karşılık gelir. |
| [Id](../../aspose.svg/svgelement/id/) { get; set; } | Belirtilen öğedeki 'id' özniteliğinin değeri veya 'id' yoksa boş dize. |
| [In1](../../aspose.svg.filters/svgfeconvolvematrixelement/in1/) { get; } | Verilen 'feConvolveMatrix' öğesindeki 'in' özniteliğine karşılık gelir. |
...
| [KernelMatrix](../../aspose.svg.filters/svgfeconvolvematrixelement/kernelmatrix/) { get; } | Verilen 'feConvolveMatrix' öğesindeki 'kernelMatrix' özniteliğine karşılık gelir. |
| [KernelUnitLengthX](../../aspose.svg.filters/svgfeconvolvematrixelement/kernelunitlengthx/) { get; } | Verilen 'feConvolveMatrix' öğesindeki 'kernelUnitLength' özniteliğine karşılık gelir. |
| [KernelUnitLengthY](../../aspose.svg.filters/svgfeconvolvematrixelement/kernelunitlengthy/) { get; } | Verilen 'feConvolveMatrix' öğesindeki 'kernelUnitLength' özniteliğine karşılık gelir. |
...
| [OrderX](../../aspose.svg.filters/svgfeconvolvematrixelement/orderx/) { get; } | Verilen 'feConvolveMatrix' öğesindeki 'order' özniteliğine karşılık gelir. |
| [OrderY](../../aspose.svg.filters/svgfeconvolvematrixelement/ordery/) { get; } | Verilen 'feConvolveMatrix' öğesindeki 'order' özniteliğine karşılık gelir. |
...
| [PreserveAlpha](../../aspose.svg.filters/svgfeconvolvematrixelement/preservealpha/) { get; } | Verilen 'feConvolveMatrix' öğesindeki 'preserveAlpha' özniteliğine karşılık gelir. |
...
| [Result](../../aspose.svg.filters/svgfeconvolvematrixelement/result/) { get; } | Belirtilen 'filtre' öğesindeki 'sonuç' özniteliğine karşılık gelir. |
...
| [TargetX](../../aspose.svg.filters/svgfeconvolvematrixelement/targetx/) { get; } | Verilen 'feConvolveMatrix' öğesindeki 'targetX' özniteliğine karşılık gelir. |
| [TargetY](../../aspose.svg.filters/svgfeconvolvematrixelement/targety/) { get; } | Verilen 'feConvolveMatrix' öğesindeki 'targetY' özniteliğine karşılık gelir. |
...
| [Width](../../aspose.svg.filters/svgfeconvolvematrixelement/width/) { get; } | Verilen 'filtre' öğesindeki 'genişlik' özelliğine karşılık gelir. |
| [X](../../aspose.svg.filters/svgfeconvolvematrixelement/x/) { get; } | Verilen 'filtre' öğesindeki 'x' özniteliğine karşılık gelir. |
| [Y](../../aspose.svg.filters/svgfeconvolvematrixelement/y/) { get; } | Verilen 'filtre' öğesindeki 'y' özniteliğine karşılık gelir. |
...
| İsim | Tanım |
| --- | --- |
| const [SVG_EDGEMODE_DUPLICATE](../../aspose.svg.filters/svgfeconvolvematrixelement/svg_edgemode_duplicate/) | 'yinelenen' değerine karşılık gelir. |
| const [SVG_EDGEMODE_NONE](../../aspose.svg.filters/svgfeconvolvematrixelement/svg_edgemode_none/) | "yok" değerine karşılık gelir. |
| const [SVG_EDGEMODE_UNKNOWN](../../aspose.svg.filters/svgfeconvolvematrixelement/svg_edgemode_unknown/) | Tür, önceden tanımlanmış türlerden biri değil. Bu türde yeni bir değer tanımlamaya veya mevcut bir değeri bu türe değiştirmeye çalışmak geçersizdir. |
| const [SVG_EDGEMODE_WRAP](../../aspose.svg.filters/svgfeconvolvematrixelement/svg_edgemode_wrap/) | 'sarma' değerine karşılık gelir. |
