...
description: SVGFEDisplacementMapElement arabirimi feDisplacementMap öğesine karşılık gelir.
type: docs
weight: 1710
...
| [Height](../../aspose.svg.filters/svgfedisplacementmapelement/height) { get; } | Verilen 'filtre' öğesindeki 'yükseklik' özelliğine karşılık gelir. |
| [Id](../../aspose.svg/svgelement/id) { get; set; } | Verilen öğedeki 'id' özniteliğinin değeri veya 'id' yoksa boş dize. |
| [In1](../../aspose.svg.filters/svgfedisplacementmapelement/in1) { get; } | Verilen 'feDisplacementMap' öğesindeki 'in' özelliğine karşılık gelir. |
| [In2](../../aspose.svg.filters/svgfedisplacementmapelement/in2) { get; } | Verilen 'feDisplacementMap' öğesindeki 'in2' özelliğine karşılık gelir. |
...
| [Result](../../aspose.svg.filters/svgfedisplacementmapelement/result) { get; } | Verilen 'filtre' öğesindeki 'sonuç' niteliğine karşılık gelir. |
| [Scale](../../aspose.svg.filters/svgfedisplacementmapelement/scale) { get; } | Verilen 'feDisplacementMap' öğesindeki 'ölçek' özelliğine karşılık gelir. |
...
| [Width](../../aspose.svg.filters/svgfedisplacementmapelement/width) { get; } | Verilen 'filtre' öğesindeki 'width' özelliğine karşılık gelir. |
| [X](../../aspose.svg.filters/svgfedisplacementmapelement/x) { get; } | Verilen 'filtre' öğesindeki 'x' özelliğine karşılık gelir. |
| [XChannelSelector](../../aspose.svg.filters/svgfedisplacementmapelement/xchannelselector) { get; } | Verilen 'feDisplacementMap' öğesinde 'xChannelSelector' özniteliğine karşılık gelir. Bu arabirimde tanımlanan SVG_CHANNEL_* sabitlerinden birini alır. |
| [Y](../../aspose.svg.filters/svgfedisplacementmapelement/y) { get; } | Verilen 'filtre' öğesindeki 'y' özniteliğine karşılık gelir. |
| [YChannelSelector](../../aspose.svg.filters/svgfedisplacementmapelement/ychannelselector) { get; } | Verilen 'feDisplacementMap' öğesinde 'yChannelSelector' özniteliğine karşılık gelir. Bu arabirimde tanımlanan SVG_CHANNEL_* sabitlerinden birini alır. |
