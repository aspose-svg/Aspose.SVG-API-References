...
description: Aspose.Svg.Filters.SVGFEDisplacementMapElement sınıf. SVGFEDisplacementMapElement arabirimi feDisplacementMap öğesine karşılık gelir.
type: docs
weight: 1710
url: /tr/net/aspose.svg.filters/svgfedisplacementmapelement/
---
...
| [Height](../../aspose.svg.filters/svgfedisplacementmapelement/height/) { get; } | Belirtilen 'filtre' öğesindeki 'yükseklik' özelliğine karşılık gelir. |
| [Id](../../aspose.svg/svgelement/id/) { get; set; } | Belirtilen öğedeki 'id' özniteliğinin değeri veya 'id' yoksa boş dize. |
| [In1](../../aspose.svg.filters/svgfedisplacementmapelement/in1/) { get; } | Verilen 'feDisplacementMap' öğesindeki 'in' özniteliğine karşılık gelir. |
| [In2](../../aspose.svg.filters/svgfedisplacementmapelement/in2/) { get; } | Verilen 'feDisplacementMap' öğesindeki 'in2' özniteliğine karşılık gelir. |
...
| [Result](../../aspose.svg.filters/svgfedisplacementmapelement/result/) { get; } | Belirtilen 'filtre' öğesindeki 'sonuç' özniteliğine karşılık gelir. |
| [Scale](../../aspose.svg.filters/svgfedisplacementmapelement/scale/) { get; } | Verilen 'feDisplacementMap' öğesindeki 'ölçek' özniteliğine karşılık gelir. |
...
| [Width](../../aspose.svg.filters/svgfedisplacementmapelement/width/) { get; } | Verilen 'filtre' öğesindeki 'genişlik' özelliğine karşılık gelir. |
| [X](../../aspose.svg.filters/svgfedisplacementmapelement/x/) { get; } | Verilen 'filtre' öğesindeki 'x' özniteliğine karşılık gelir. |
| [XChannelSelector](../../aspose.svg.filters/svgfedisplacementmapelement/xchannelselector/) { get; } | Verilen 'feDisplacementMap' öğesindeki 'xChannelSelector' özniteliğine karşılık gelir. Bu arabirimde tanımlanan SVG_CHANNEL_* sabitlerinden birini alır. |
| [Y](../../aspose.svg.filters/svgfedisplacementmapelement/y/) { get; } | Verilen 'filtre' öğesindeki 'y' özniteliğine karşılık gelir. |
| [YChannelSelector](../../aspose.svg.filters/svgfedisplacementmapelement/ychannelselector/) { get; } | Verilen 'feDisplacementMap' öğesindeki 'yChannelSelector' özniteliğine karşılık gelir. Bu arabirimde tanımlanan SVG_CHANNEL_* sabitlerinden birini alır. |
...
| İsim | Tanım |
| --- | --- |
| const [SVG_CHANNEL_A](../../aspose.svg.filters/svgfedisplacementmapelement/svg_channel_a/) | 'A' değerine karşılık gelir. |
| const [SVG_CHANNEL_B](../../aspose.svg.filters/svgfedisplacementmapelement/svg_channel_b/) | 'B' değerine karşılık gelir. |
| const [SVG_CHANNEL_G](../../aspose.svg.filters/svgfedisplacementmapelement/svg_channel_g/) | 'G' değerine karşılık gelir. |
| const [SVG_CHANNEL_R](../../aspose.svg.filters/svgfedisplacementmapelement/svg_channel_r/) | 'R' değerine karşılık gelir. |
| const [SVG_CHANNEL_UNKNOWN](../../aspose.svg.filters/svgfedisplacementmapelement/svg_channel_unknown/) | Tür, önceden tanımlanmış türlerden biri değil. Bu türde yeni bir değer tanımlamaya veya mevcut bir değeri bu türe değiştirmeye çalışmak geçersizdir. |
