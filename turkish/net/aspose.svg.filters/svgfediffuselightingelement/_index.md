...
description: Aspose.Svg.Filters.SVGFEDiffuseLightingElement sınıf. SVGFEDiffuseLightingElement arabirimi feDiffuseLighting öğesine karşılık gelir.
type: docs
weight: 1700
url: /tr/net/aspose.svg.filters/svgfediffuselightingelement/
---
...
| [DiffuseConstant](../../aspose.svg.filters/svgfediffuselightingelement/diffuseconstant/) { get; } | Verilen 'feDiffuseLighting' öğesindeki 'diffuseConstant' özniteliğine karşılık gelir. |
...
| [Height](../../aspose.svg.filters/svgfediffuselightingelement/height/) { get; } | Belirtilen 'filtre' öğesindeki 'yükseklik' özelliğine karşılık gelir. |
| [Id](../../aspose.svg/svgelement/id/) { get; set; } | Belirtilen öğedeki 'id' özniteliğinin değeri veya 'id' yoksa boş dize. |
| [In1](../../aspose.svg.filters/svgfediffuselightingelement/in1/) { get; } | Verilen 'feDiffuseLighting' öğesindeki 'in' özniteliğine karşılık gelir. |
...
| [KernelUnitLengthX](../../aspose.svg.filters/svgfediffuselightingelement/kernelunitlengthx/) { get; } | Verilen 'feDiffuseLighting' öğesinde 'kernelUnitLength' özniteliğine karşılık gelir. |
| [KernelUnitLengthY](../../aspose.svg.filters/svgfediffuselightingelement/kernelunitlengthy/) { get; } | Verilen 'feDiffuseLighting' öğesinde 'kernelUnitLength' özniteliğine karşılık gelir. |
...
| [Result](../../aspose.svg.filters/svgfediffuselightingelement/result/) { get; } | Belirtilen 'filtre' öğesindeki 'sonuç' özniteliğine karşılık gelir. |
...
| [SurfaceScale](../../aspose.svg.filters/svgfediffuselightingelement/surfacescale/) { get; } | Verilen 'feDiffuseLighting' öğesindeki 'surfaceScale' özniteliğine karşılık gelir. |
...
| [Width](../../aspose.svg.filters/svgfediffuselightingelement/width/) { get; } | Verilen 'filtre' öğesindeki 'genişlik' özelliğine karşılık gelir. |
| [X](../../aspose.svg.filters/svgfediffuselightingelement/x/) { get; } | Verilen 'filtre' öğesindeki 'x' özniteliğine karşılık gelir. |
| [Y](../../aspose.svg.filters/svgfediffuselightingelement/y/) { get; } | Verilen 'filtre' öğesindeki 'y' özniteliğine karşılık gelir. |
