...
description: SVGFEDiffuseLightingElement arabirimi feDiffuseLighting öğesine karşılık gelir.
type: docs
weight: 1700
...
| [DiffuseConstant](../../aspose.svg.filters/svgfediffuselightingelement/diffuseconstant) { get; } | Verilen 'feDiffuseLighting' öğesinde 'diffuseConstant' özniteliğine karşılık gelir. |
...
| [Height](../../aspose.svg.filters/svgfediffuselightingelement/height) { get; } | Verilen 'filtre' öğesindeki 'yükseklik' özelliğine karşılık gelir. |
| [Id](../../aspose.svg/svgelement/id) { get; set; } | Verilen öğedeki 'id' özniteliğinin değeri veya 'id' yoksa boş dize. |
| [In1](../../aspose.svg.filters/svgfediffuselightingelement/in1) { get; } | Verilen 'feDiffuseLighting' öğesindeki 'in' özelliğine karşılık gelir. |
...
| [KernelUnitLengthX](../../aspose.svg.filters/svgfediffuselightingelement/kernelunitlengthx) { get; } | Verilen 'feDiffuseLighting' öğesinde 'kernelUnitLength' özelliğine karşılık gelir. |
| [KernelUnitLengthY](../../aspose.svg.filters/svgfediffuselightingelement/kernelunitlengthy) { get; } | Verilen 'feDiffuseLighting' öğesinde 'kernelUnitLength' özelliğine karşılık gelir. |
...
| [Result](../../aspose.svg.filters/svgfediffuselightingelement/result) { get; } | Verilen 'filtre' öğesindeki 'sonuç' niteliğine karşılık gelir. |
...
| [SurfaceScale](../../aspose.svg.filters/svgfediffuselightingelement/surfacescale) { get; } | Verilen 'feDiffuseLighting' öğesinde 'surfaceScale' özelliğine karşılık gelir. |
...
| [Width](../../aspose.svg.filters/svgfediffuselightingelement/width) { get; } | Verilen 'filtre' öğesindeki 'width' özelliğine karşılık gelir. |
| [X](../../aspose.svg.filters/svgfediffuselightingelement/x) { get; } | Verilen 'filtre' öğesindeki 'x' özelliğine karşılık gelir. |
