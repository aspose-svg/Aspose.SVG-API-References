...
description: SVGFEGaussianBlurElement arabirimi feGaussianBlur öğesine karşılık gelir.
type: docs
weight: 1790
...
| [Height](../../aspose.svg.filters/svgfegaussianblurelement/height) { get; } | Verilen "filtre" öğesindeki "yükseklik" özniteliğine karşılık gelir. |
| [Id](../../aspose.svg/svgelement/id) { get; set; } | Verilen öğedeki 'id' özniteliğinin değeri veya 'id' yoksa boş dize. |
| [In1](../../aspose.svg.filters/svgfegaussianblurelement/in1) { get; } | Verilen "feGaussianBlur" öğesindeki "in" özniteliğine karşılık gelir. |
...
| [Result](../../aspose.svg.filters/svgfegaussianblurelement/result) { get; } | Verilen "filtre" öğesindeki "sonuç" özniteliğine karşılık gelir. |
...
| [StdDeviationX](../../aspose.svg.filters/svgfegaussianblurelement/stddeviationx) { get; } | Verilen "feGaussianBlur" öğesindeki "stdDeviation" özniteliğine karşılık gelir. �stdDeviation�. özniteliğinin X bileşenini içerir |
| [StdDeviationY](../../aspose.svg.filters/svgfegaussianblurelement/stddeviationy) { get; } | Verilen "feGaussianBlur" öğesindeki "stdDeviation" özniteliğine karşılık gelir. �stdDeviation�. özniteliğinin Y bileşenini (muhtemelen otomatik olarak hesaplanır) içerir |
...
| [Width](../../aspose.svg.filters/svgfegaussianblurelement/width) { get; } | Verilen "filtre" öğesindeki "width" özniteliğine karşılık gelir. |
| [X](../../aspose.svg.filters/svgfegaussianblurelement/x) { get; } | Verilen "filtre" öğesindeki "x" özniteliğine karşılık gelir. |
| [Y](../../aspose.svg.filters/svgfegaussianblurelement/y) { get; } | Verilen "filtre" öğesindeki "y" özniteliğine karşılık gelir. |
