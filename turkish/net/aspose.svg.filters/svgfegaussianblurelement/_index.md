...
description: Aspose.Svg.Filters.SVGFEGaussianBlurElement sınıf. SVGFEGaussianBlurElement arabirimi feGaussianBlur öğesine karşılık gelir.
type: docs
weight: 1790
url: /tr/net/aspose.svg.filters/svgfegaussianblurelement/
---
...
| [Height](../../aspose.svg.filters/svgfegaussianblurelement/height/) { get; } | Verilen "filtre" öğesindeki "yükseklik" özelliğine karşılık gelir. |
| [Id](../../aspose.svg/svgelement/id/) { get; set; } | Belirtilen öğedeki 'id' özniteliğinin değeri veya 'id' yoksa boş dize. |
| [In1](../../aspose.svg.filters/svgfegaussianblurelement/in1/) { get; } | Verilen "feGaussianBlur" öğesindeki "in" özelliğine karşılık gelir. |
...
| [Result](../../aspose.svg.filters/svgfegaussianblurelement/result/) { get; } | Verilen "filtre" öğesindeki "sonuç" özelliğine karşılık gelir. |
...
| [StdDeviationX](../../aspose.svg.filters/svgfegaussianblurelement/stddeviationx/) { get; } | Verilen "feGaussianBlur" öğesinde "stdDeviation" özelliğine karşılık gelir. �stdDeviation�. özniteliğinin X bileşenini içerir |
| [StdDeviationY](../../aspose.svg.filters/svgfegaussianblurelement/stddeviationy/) { get; } | Verilen "feGaussianBlur" öğesinde "stdDeviation" özelliğine karşılık gelir. "stdDeviation". özniteliğinin Y bileşenini (muhtemelen otomatik olarak hesaplanmıştır) içerir |
...
| [Width](../../aspose.svg.filters/svgfegaussianblurelement/width/) { get; } | Verilen "filtre" öğesindeki "genişlik" özelliğine karşılık gelir. |
| [X](../../aspose.svg.filters/svgfegaussianblurelement/x/) { get; } | Verilen "filtre" öğesinde "x" özelliğine karşılık gelir. |
| [Y](../../aspose.svg.filters/svgfegaussianblurelement/y/) { get; } | Verilen "filter" öğesindeki "y" özelliğine karşılık gelir. |
...
| [SetStdDeviation](../../aspose.svg.filters/svgfegaussianblurelement/setstddeviation/)(float, float) | "stdDeviation" özniteliği için değerleri ayarlar. |
