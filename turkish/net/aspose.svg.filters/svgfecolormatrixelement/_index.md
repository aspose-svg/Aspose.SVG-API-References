...
description: SVGFEColorMatrixElement arabirimi feColorMatrix öğesine karşılık gelir.
type: docs
weight: 1660
...
| [Height](../../aspose.svg.filters/svgfecolormatrixelement/height) { get; } | Verilen 'filtre' öğesindeki 'yükseklik' özelliğine karşılık gelir. |
| [Id](../../aspose.svg/svgelement/id) { get; set; } | Verilen öğedeki 'id' özniteliğinin değeri veya 'id' yoksa boş dize. |
| [In1](../../aspose.svg.filters/svgfecolormatrixelement/in1) { get; } | Verilen 'feColorMatrix' öğesindeki 'in' özelliğine karşılık gelir. |
...
| [Result](../../aspose.svg.filters/svgfecolormatrixelement/result) { get; } | Verilen 'filtre' öğesindeki 'sonuç' niteliğine karşılık gelir. |
...
| [Width](../../aspose.svg.filters/svgfecolormatrixelement/width) { get; } | Verilen 'filtre' öğesindeki 'width' özelliğine karşılık gelir. |
| [X](../../aspose.svg.filters/svgfecolormatrixelement/x) { get; } | Verilen 'filtre' öğesindeki 'x' özelliğine karşılık gelir. |
...
| const [SVG_FECOLORMATRIX_TYPE_MATRIX](../../aspose.svg.filters/svgfecolormatrixelement/svg_fecolormatrix_type_matrix) | 'matris' değerine karşılık gelir. |
| const [SVG_FECOLORMATRIX_TYPE_SATURATE](../../aspose.svg.filters/svgfecolormatrixelement/svg_fecolormatrix_type_saturate) | 'doygun' değerine karşılık gelir. |
