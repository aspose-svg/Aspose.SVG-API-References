...
description: Aspose.Svg.Filters.SVGFEColorMatrixElement sınıf. SVGFEColorMatrixElement arabirimi feColorMatrix öğesine karşılık gelir.
type: docs
weight: 1660
url: /tr/net/aspose.svg.filters/svgfecolormatrixelement/
---
...
| [Height](../../aspose.svg.filters/svgfecolormatrixelement/height/) { get; } | Belirtilen 'filtre' öğesindeki 'yükseklik' özelliğine karşılık gelir. |
| [Id](../../aspose.svg/svgelement/id/) { get; set; } | Belirtilen öğedeki 'id' özniteliğinin değeri veya 'id' yoksa boş dize. |
| [In1](../../aspose.svg.filters/svgfecolormatrixelement/in1/) { get; } | Verilen 'feColorMatrix' öğesinin 'in' özniteliğine karşılık gelir. |
...
| [Result](../../aspose.svg.filters/svgfecolormatrixelement/result/) { get; } | Belirtilen 'filtre' öğesindeki 'sonuç' özniteliğine karşılık gelir. |
...
| [Type](../../aspose.svg.filters/svgfecolormatrixelement/type/) { get; } | Verilen 'feColorMatrix' öğesindeki 'type' özniteliğine karşılık gelir. Bu arabirimde tanımlanan SVG_FECOLORMATRIX_TYPE_* sabitlerinden birini alır. |
| [Values](../../aspose.svg.filters/svgfecolormatrixelement/values/) { get; } | Verilen 'feColorMatrix' öğesindeki 'değerler' özniteliğine karşılık gelir. |
...
| [Width](../../aspose.svg.filters/svgfecolormatrixelement/width/) { get; } | Verilen 'filtre' öğesindeki 'genişlik' özelliğine karşılık gelir. |
| [X](../../aspose.svg.filters/svgfecolormatrixelement/x/) { get; } | Verilen 'filtre' öğesindeki 'x' özniteliğine karşılık gelir. |
| [Y](../../aspose.svg.filters/svgfecolormatrixelement/y/) { get; } | Verilen 'filtre' öğesindeki 'y' özniteliğine karşılık gelir. |
...
| İsim | Tanım |
| --- | --- |
| const [SVG_FECOLORMATRIX_TYPE_HUEROTATE](../../aspose.svg.filters/svgfecolormatrixelement/svg_fecolormatrix_type_huerotate/) | 'hueRotate' değerine karşılık gelir. |
| const [SVG_FECOLORMATRIX_TYPE_LUMINANCETOALPHA](../../aspose.svg.filters/svgfecolormatrixelement/svg_fecolormatrix_type_luminancetoalpha/) | 'luminanceToAlpha' değerine karşılık gelir. |
| const [SVG_FECOLORMATRIX_TYPE_MATRIX](../../aspose.svg.filters/svgfecolormatrixelement/svg_fecolormatrix_type_matrix/) | 'matrix' değerine karşılık gelir. |
| const [SVG_FECOLORMATRIX_TYPE_SATURATE](../../aspose.svg.filters/svgfecolormatrixelement/svg_fecolormatrix_type_saturate/) | 'doymuş' değerine karşılık gelir. |
| const [SVG_FECOLORMATRIX_TYPE_UNKNOWN](../../aspose.svg.filters/svgfecolormatrixelement/svg_fecolormatrix_type_unknown/) | Tür, önceden tanımlanmış türlerden biri değil. Bu türde yeni bir değer tanımlamaya veya mevcut bir değeri bu türe değiştirmeye çalışmak geçersizdir. |
