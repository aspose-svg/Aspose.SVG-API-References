...
description: Aspose.Svg.Filters.SVGFEMorphologyElement sınıf. SVGFEMorphologyElement arabirimi feMorphology öğesine karşılık gelir.
type: docs
weight: 1830
url: /tr/net/aspose.svg.filters/svgfemorphologyelement/
---
...
| [Height](../../aspose.svg.filters/svgfemorphologyelement/height/) { get; } | Belirtilen 'filtre' öğesindeki 'yükseklik' özelliğine karşılık gelir. |
| [Id](../../aspose.svg/svgelement/id/) { get; set; } | Belirtilen öğedeki 'id' özniteliğinin değeri veya 'id' yoksa boş dize. |
| [In1](../../aspose.svg.filters/svgfemorphologyelement/in1/) { get; } | Verilen 'feMorphology' öğesindeki 'in' özniteliğine karşılık gelir. |
...
| [Operator](../../aspose.svg.filters/svgfemorphologyelement/operator/) { get; } | Verilen 'feMorphology' öğesindeki 'operatör' özniteliğine karşılık gelir. Bu arabirimde tanımlanan SVG_MORPHOLOGY_OPERATOR_* sabitlerinden birini alır. |
...
| [RadiusX](../../aspose.svg.filters/svgfemorphologyelement/radiusx/) { get; } | Verilen 'feMorphology' öğesindeki 'yarıçap' özelliğine karşılık gelir. |
| [RadiusY](../../aspose.svg.filters/svgfemorphologyelement/radiusy/) { get; } | Verilen 'feMorphology' öğesindeki 'yarıçap' özelliğine karşılık gelir. |
| [Result](../../aspose.svg.filters/svgfemorphologyelement/result/) { get; } | Belirtilen 'filtre' öğesindeki 'sonuç' özniteliğine karşılık gelir. |
...
| [Width](../../aspose.svg.filters/svgfemorphologyelement/width/) { get; } | Verilen 'filtre' öğesindeki 'genişlik' özelliğine karşılık gelir. |
| [X](../../aspose.svg.filters/svgfemorphologyelement/x/) { get; } | Verilen 'filtre' öğesindeki 'x' özniteliğine karşılık gelir. |
| [Y](../../aspose.svg.filters/svgfemorphologyelement/y/) { get; } | Verilen 'filtre' öğesindeki 'y' özniteliğine karşılık gelir. |
...
| İsim | Tanım |
| --- | --- |
| const [SVG_MORPHOLOGY_OPERATOR_DILATE](../../aspose.svg.filters/svgfemorphologyelement/svg_morphology_operator_dilate/) | 'dilate' değerine karşılık gelir. |
| const [SVG_MORPHOLOGY_OPERATOR_ERODE](../../aspose.svg.filters/svgfemorphologyelement/svg_morphology_operator_erode/) | 'erode' değerine karşılık gelir. |
| const [SVG_MORPHOLOGY_OPERATOR_UNKNOWN](../../aspose.svg.filters/svgfemorphologyelement/svg_morphology_operator_unknown/) | Tür, önceden tanımlanmış türlerden biri değil. Bu türde yeni bir değer tanımlamaya veya mevcut bir değeri bu türe değiştirmeye çalışmak geçersizdir. |
