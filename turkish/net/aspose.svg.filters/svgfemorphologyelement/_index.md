...
description: SVGFEMorphologyElement arabirimi feMorphology öğesine karşılık gelir.
type: docs
weight: 1830
...
| [Height](../../aspose.svg.filters/svgfemorphologyelement/height) { get; } | Verilen 'filtre' öğesindeki 'yükseklik' özelliğine karşılık gelir. |
| [Id](../../aspose.svg/svgelement/id) { get; set; } | Verilen öğedeki 'id' özniteliğinin değeri veya 'id' yoksa boş dize. |
| [In1](../../aspose.svg.filters/svgfemorphologyelement/in1) { get; } | Verilen 'feMorphology' öğesindeki 'in' özelliğine karşılık gelir. |
...
| [Operator](../../aspose.svg.filters/svgfemorphologyelement/operator) { get; } | Verilen 'feMorphology' öğesinde 'operatör' özniteliğine karşılık gelir. Bu arabirimde tanımlanan SVG_MORPHOLOGY_OPERATOR_* sabitlerinden birini alır. |
...
| [RadiusX](../../aspose.svg.filters/svgfemorphologyelement/radiusx) { get; } | Verilen 'feMorphology' öğesindeki 'yarıçap' özniteliğine karşılık gelir. |
| [RadiusY](../../aspose.svg.filters/svgfemorphologyelement/radiusy) { get; } | Verilen 'feMorphology' öğesindeki 'yarıçap' özniteliğine karşılık gelir. |
| [Result](../../aspose.svg.filters/svgfemorphologyelement/result) { get; } | Verilen 'filtre' öğesindeki 'sonuç' niteliğine karşılık gelir. |
...
| [Width](../../aspose.svg.filters/svgfemorphologyelement/width) { get; } | Verilen 'filtre' öğesindeki 'width' özelliğine karşılık gelir. |
| [X](../../aspose.svg.filters/svgfemorphologyelement/x) { get; } | Verilen 'filtre' öğesindeki 'x' özelliğine karşılık gelir. |
...
| İsim | Tanım |
| --- | --- |
| const [SVG_MORPHOLOGY_OPERATOR_DILATE](../../aspose.svg.filters/svgfemorphologyelement/svg_morphology_operator_dilate) | 'genişletme' değerine karşılık gelir. |
| const [SVG_MORPHOLOGY_OPERATOR_ERODE](../../aspose.svg.filters/svgfemorphologyelement/svg_morphology_operator_erode) | 'aşınma' değerine karşılık gelir. |
