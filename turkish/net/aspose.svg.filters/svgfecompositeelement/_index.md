...
description: Aspose.Svg.Filters.SVGFECompositeElement sınıf. SVGFECompositeElement arabirimi feComposite öğesine karşılık gelir.
type: docs
weight: 1680
url: /tr/net/aspose.svg.filters/svgfecompositeelement/
---
...
| [Height](../../aspose.svg.filters/svgfecompositeelement/height/) { get; } | Belirtilen 'filtre' öğesindeki 'yükseklik' özelliğine karşılık gelir. |
| [Id](../../aspose.svg/svgelement/id/) { get; set; } | Belirtilen öğedeki 'id' özniteliğinin değeri veya 'id' yoksa boş dize. |
| [In1](../../aspose.svg.filters/svgfecompositeelement/in1/) { get; } | Verilen 'feComposite' öğesindeki 'in' özniteliğine karşılık gelir. |
| [In2](../../aspose.svg.filters/svgfecompositeelement/in2/) { get; } | Verilen 'feComposite' öğesindeki 'in2' özniteliğine karşılık gelir. |
...
| [K1](../../aspose.svg.filters/svgfecompositeelement/k1/) { get; } | Verilen 'feComposite' öğesindeki 'k1' özniteliğine karşılık gelir. |
| [K2](../../aspose.svg.filters/svgfecompositeelement/k2/) { get; } | Verilen 'feComposite' öğesindeki 'k2' özniteliğine karşılık gelir. |
| [K3](../../aspose.svg.filters/svgfecompositeelement/k3/) { get; } | Verilen 'feComposite' öğesindeki 'k3' özniteliğine karşılık gelir. |
| [K4](../../aspose.svg.filters/svgfecompositeelement/k4/) { get; } | Verilen 'feComposite' öğesindeki 'k4' özniteliğine karşılık gelir. |
...
| [Operator](../../aspose.svg.filters/svgfecompositeelement/operator/) { get; } | Verilen 'feComposite' öğesinde 'operator' özniteliğine karşılık gelir. Bu arabirimde tanımlanan SVG_FECOMPOSITE_OPERATOR_* sabitlerinden birini alır. |
...
| [Result](../../aspose.svg.filters/svgfecompositeelement/result/) { get; } | Belirtilen 'filtre' öğesindeki 'sonuç' özniteliğine karşılık gelir. |
...
| [Width](../../aspose.svg.filters/svgfecompositeelement/width/) { get; } | Verilen 'filtre' öğesindeki 'genişlik' özelliğine karşılık gelir. |
| [X](../../aspose.svg.filters/svgfecompositeelement/x/) { get; } | Verilen 'filtre' öğesindeki 'x' özniteliğine karşılık gelir. |
| [Y](../../aspose.svg.filters/svgfecompositeelement/y/) { get; } | Verilen 'filtre' öğesindeki 'y' özniteliğine karşılık gelir. |
...
| İsim | Tanım |
| --- | --- |
| const [SVG_FECOMPOSITE_OPERATOR_ARITHMETIC](../../aspose.svg.filters/svgfecompositeelement/svg_fecomposite_operator_arithmetic/) | 'aritmetik' değerine karşılık gelir. |
| const [SVG_FECOMPOSITE_OPERATOR_ATOP](../../aspose.svg.filters/svgfecompositeelement/svg_fecomposite_operator_atop/) | 'atop' değerine karşılık gelir. |
| const [SVG_FECOMPOSITE_OPERATOR_IN](../../aspose.svg.filters/svgfecompositeelement/svg_fecomposite_operator_in/) | 'in' değerine karşılık gelir. |
| const [SVG_FECOMPOSITE_OPERATOR_OUT](../../aspose.svg.filters/svgfecompositeelement/svg_fecomposite_operator_out/) | 'out' değerine karşılık gelir. |
| const [SVG_FECOMPOSITE_OPERATOR_OVER](../../aspose.svg.filters/svgfecompositeelement/svg_fecomposite_operator_over/) | 'over' değerine karşılık gelir. |
| const [SVG_FECOMPOSITE_OPERATOR_UNKNOWN](../../aspose.svg.filters/svgfecompositeelement/svg_fecomposite_operator_unknown/) | Tür, önceden tanımlanmış türlerden biri değil. Bu türde yeni bir değer tanımlamaya veya mevcut bir değeri bu türe değiştirmeye çalışmak geçersizdir. |
| const [SVG_FECOMPOSITE_OPERATOR_XOR](../../aspose.svg.filters/svgfecompositeelement/svg_fecomposite_operator_xor/) | 'xor' değerine karşılık gelir. |
