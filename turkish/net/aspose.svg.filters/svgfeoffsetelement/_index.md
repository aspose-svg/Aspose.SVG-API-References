...
description: SVGFEOffsetElement arabirimi feOffset öğesine karşılık gelir.
type: docs
weight: 1840
...
| [Dx](../../aspose.svg.filters/svgfeoffsetelement/dx) { get; } | Verilen 'feOffset' öğesinde 'dx' özniteliğine karşılık gelir. |
...
| [Height](../../aspose.svg.filters/svgfeoffsetelement/height) { get; } | Verilen 'filtre' öğesindeki 'yükseklik' özelliğine karşılık gelir. |
| [Id](../../aspose.svg/svgelement/id) { get; set; } | Verilen öğedeki 'id' özniteliğinin değeri veya 'id' yoksa boş dize. |
| [In1](../../aspose.svg.filters/svgfeoffsetelement/in1) { get; } | Verilen 'feOffset' öğesindeki 'in' özelliğine karşılık gelir. |
...
| [Result](../../aspose.svg.filters/svgfeoffsetelement/result) { get; } | Verilen 'filtre' öğesindeki 'sonuç' niteliğine karşılık gelir. |
...
| [Width](../../aspose.svg.filters/svgfeoffsetelement/width) { get; } | Verilen 'filtre' öğesindeki 'width' özelliğine karşılık gelir. |
| [X](../../aspose.svg.filters/svgfeoffsetelement/x) { get; } | Verilen 'filtre' öğesindeki 'x' özelliğine karşılık gelir. |
