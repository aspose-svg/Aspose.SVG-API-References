...
description: Aspose.Svg.Filters.SVGFEOffsetElement sınıf. SVGFEOffsetElement arabirimi feOffset öğesine karşılık gelir.
type: docs
weight: 1840
url: /tr/net/aspose.svg.filters/svgfeoffsetelement/
---
...
| [Dx](../../aspose.svg.filters/svgfeoffsetelement/dx/) { get; } | Verilen 'feOffset' öğesindeki 'dx' özniteliğine karşılık gelir. |
| [Dy](../../aspose.svg.filters/svgfeoffsetelement/dy/) { get; } | Verilen 'feOffset' öğesindeki 'dy' özniteliğine karşılık gelir. |
...
| [Height](../../aspose.svg.filters/svgfeoffsetelement/height/) { get; } | Belirtilen 'filtre' öğesindeki 'yükseklik' özelliğine karşılık gelir. |
| [Id](../../aspose.svg/svgelement/id/) { get; set; } | Belirtilen öğedeki 'id' özniteliğinin değeri veya 'id' yoksa boş dize. |
| [In1](../../aspose.svg.filters/svgfeoffsetelement/in1/) { get; } | Verilen 'feOffset' öğesindeki 'in' özniteliğine karşılık gelir. |
...
| [Result](../../aspose.svg.filters/svgfeoffsetelement/result/) { get; } | Belirtilen 'filtre' öğesindeki 'sonuç' özniteliğine karşılık gelir. |
...
| [Width](../../aspose.svg.filters/svgfeoffsetelement/width/) { get; } | Verilen 'filtre' öğesindeki 'genişlik' özelliğine karşılık gelir. |
| [X](../../aspose.svg.filters/svgfeoffsetelement/x/) { get; } | Verilen 'filtre' öğesindeki 'x' özniteliğine karşılık gelir. |
| [Y](../../aspose.svg.filters/svgfeoffsetelement/y/) { get; } | Verilen 'filtre' öğesindeki 'y' özniteliğine karşılık gelir. |
