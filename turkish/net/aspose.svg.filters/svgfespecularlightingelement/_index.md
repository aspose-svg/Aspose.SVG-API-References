...
description: Aspose.Svg.Filters.SVGFESpecularLightingElement sınıf. SVGFESpecularLightingElement arabirimi feSpecularLighting öğesine karşılık gelir.
type: docs
weight: 1860
url: /tr/net/aspose.svg.filters/svgfespecularlightingelement/
---
...
| [Height](../../aspose.svg.filters/svgfespecularlightingelement/height/) { get; } | Belirtilen 'filtre' öğesindeki 'yükseklik' özelliğine karşılık gelir. |
| [Id](../../aspose.svg/svgelement/id/) { get; set; } | Belirtilen öğedeki 'id' özniteliğinin değeri veya 'id' yoksa boş dize. |
| [In1](../../aspose.svg.filters/svgfespecularlightingelement/in1/) { get; } | Verilen 'feSpecularLighting' öğesindeki 'in' özniteliğine karşılık gelir. |
...
| [KernelUnitLengthX](../../aspose.svg.filters/svgfespecularlightingelement/kernelunitlengthx/) { get; } | Verilen 'feSpecularLighting' öğesindeki 'kernelUnitLength' özniteliğine karşılık gelir. |
| [KernelUnitLengthY](../../aspose.svg.filters/svgfespecularlightingelement/kernelunitlengthy/) { get; } | Verilen 'feSpecularLighting' öğesindeki 'kernelUnitLength' özniteliğine karşılık gelir. |
...
| [Result](../../aspose.svg.filters/svgfespecularlightingelement/result/) { get; } | Belirtilen 'filtre' öğesindeki 'sonuç' özniteliğine karşılık gelir. |
...
| [SpecularConstant](../../aspose.svg.filters/svgfespecularlightingelement/specularconstant/) { get; } | Verilen 'feSpecularLighting' öğesindeki 'specularConstant' özniteliğine karşılık gelir. |
| [SpecularExponent](../../aspose.svg.filters/svgfespecularlightingelement/specularexponent/) { get; } | Verilen 'feSpecularLighting' öğesindeki 'specularExponent' özniteliğine karşılık gelir. |
...
| [SurfaceScale](../../aspose.svg.filters/svgfespecularlightingelement/surfacescale/) { get; } | Verilen 'feSpecularLighting' öğesindeki 'surfaceScale' özniteliğine karşılık gelir. |
...
| [Width](../../aspose.svg.filters/svgfespecularlightingelement/width/) { get; } | Verilen 'filtre' öğesindeki 'genişlik' özelliğine karşılık gelir. |
| [X](../../aspose.svg.filters/svgfespecularlightingelement/x/) { get; } | Verilen 'filtre' öğesindeki 'x' özniteliğine karşılık gelir. |
| [Y](../../aspose.svg.filters/svgfespecularlightingelement/y/) { get; } | Verilen 'filtre' öğesindeki 'y' özniteliğine karşılık gelir. |
