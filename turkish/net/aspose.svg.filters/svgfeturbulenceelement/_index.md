...
description: SVGFETurbulenceElement arabirimi feTurbulence öğesine karşılık gelir.
type: docs
weight: 1890
...
| [Height](../../aspose.svg.filters/svgfeturbulenceelement/height) { get; } | Verilen 'filtre' öğesindeki 'yükseklik' özelliğine karşılık gelir. |
...
| [NumOctaves](../../aspose.svg.filters/svgfeturbulenceelement/numoctaves) { get; } | Verilen 'feTurbulence' öğesindeki 'numOctaves' özelliğine karşılık gelir. |
...
| [Result](../../aspose.svg.filters/svgfeturbulenceelement/result) { get; } | Verilen 'filtre' öğesindeki 'sonuç' niteliğine karşılık gelir. |
| [SchemaTypeInfo](../../aspose.svg.dom/element/schematypeinfo) { get; } | Bu öğeyle ilişkili tür bilgisi. |
| [Seed](../../aspose.svg.filters/svgfeturbulenceelement/seed) { get; } | Verilen 'feTurbulence' öğesindeki 'tohum' özniteliğine karşılık gelir. |
...
| [Type](../../aspose.svg.filters/svgfeturbulenceelement/type) { get; } | Verilen 'feTurbulence' öğesindeki 'type' özniteliğine karşılık gelir. Bu arayüzde tanımlanan SVG_TURBULENCE_TYPE_* sabitlerinden birini alır. |
...
| [Width](../../aspose.svg.filters/svgfeturbulenceelement/width) { get; } | Verilen 'filtre' öğesindeki 'width' özelliğine karşılık gelir. |
| [X](../../aspose.svg.filters/svgfeturbulenceelement/x) { get; } | Verilen 'filtre' öğesindeki 'x' özelliğine karşılık gelir. |
...
| const [SVG_TURBULENCE_TYPE_FRACTALNOISE](../../aspose.svg.filters/svgfeturbulenceelement/svg_turbulence_type_fractalnoise) | 'fraktalNoise' değerine karşılık gelir. |
