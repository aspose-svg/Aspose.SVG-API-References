...
description: Aspose.Svg.Filters.SVGFETurbulenceElement sınıf. SVGFETurbulenceElement arabirimi feTurbulence öğesine karşılık gelir.
type: docs
weight: 1890
url: /tr/net/aspose.svg.filters/svgfeturbulenceelement/
---
...
| [BaseFrequencyX](../../aspose.svg.filters/svgfeturbulenceelement/basefrequencyx/) { get; } | Verilen 'feTurbulence' öğesindeki 'baseFrequency' özniteliğine karşılık gelir. "baseFrequency" özniteliğinin X bileşenini içerir. |
| [BaseFrequencyY](../../aspose.svg.filters/svgfeturbulenceelement/basefrequencyy/) { get; } | Verilen 'feTurbulence' öğesindeki 'baseFrequency' özniteliğine karşılık gelir. (Muhtemelen otomatik olarak hesaplanır) 'baseFrequency' özniteliğinin Y bileşenini içerir. |
...
| [Height](../../aspose.svg.filters/svgfeturbulenceelement/height/) { get; } | Belirtilen 'filtre' öğesindeki 'yükseklik' özelliğine karşılık gelir. |
...
| [NumOctaves](../../aspose.svg.filters/svgfeturbulenceelement/numoctaves/) { get; } | Verilen 'feTurbulence' öğesindeki 'numOctaves' özniteliğine karşılık gelir. |
...
| [Result](../../aspose.svg.filters/svgfeturbulenceelement/result/) { get; } | Belirtilen 'filtre' öğesindeki 'sonuç' özniteliğine karşılık gelir. |
| [SchemaTypeInfo](../../aspose.svg.dom/element/schematypeinfo/) { get; } | Bu öğeyle ilişkili tür bilgisi. |
| [Seed](../../aspose.svg.filters/svgfeturbulenceelement/seed/) { get; } | Verilen 'feTurbulence' öğesindeki 'seed' özniteliğine karşılık gelir. |
| [ShadowRoot](../../aspose.svg.dom/element/shadowroot/) { get; } | Bu öğede depolanan shadowRoot'u veya kapalıysa boş değeri döndürür. |
| [StitchTiles](../../aspose.svg.filters/svgfeturbulenceelement/stitchtiles/) { get; } | Verilen 'feTurbulence' öğesindeki 'stitchTiles' özniteliğine karşılık gelir. Bu arabirimde tanımlanan SVG_STITCHTYPE_* sabitlerinden birini alır. |
...
| [Type](../../aspose.svg.filters/svgfeturbulenceelement/type/) { get; } | Verilen 'feTurbulence' öğesindeki 'type' özniteliğine karşılık gelir. Bu arabirimde tanımlanan SVG_TURBULENCE_TYPE_* sabitlerinden birini alır. |
...
| [Width](../../aspose.svg.filters/svgfeturbulenceelement/width/) { get; } | Verilen 'filtre' öğesindeki 'genişlik' özelliğine karşılık gelir. |
| [X](../../aspose.svg.filters/svgfeturbulenceelement/x/) { get; } | Verilen 'filtre' öğesindeki 'x' özniteliğine karşılık gelir. |
| [Y](../../aspose.svg.filters/svgfeturbulenceelement/y/) { get; } | Verilen 'filtre' öğesindeki 'y' özniteliğine karşılık gelir. |
...
| İsim | Tanım |
| --- | --- |
| const [SVG_STITCHTYPE_NOSTITCH](../../aspose.svg.filters/svgfeturbulenceelement/svg_stitchtype_nostitch/) | 'noStitch' değerine karşılık gelir. |
| const [SVG_STITCHTYPE_STITCH](../../aspose.svg.filters/svgfeturbulenceelement/svg_stitchtype_stitch/) | 'dikiş' değerine karşılık gelir. |
| const [SVG_STITCHTYPE_UNKNOWN](../../aspose.svg.filters/svgfeturbulenceelement/svg_stitchtype_unknown/) | Tür, önceden tanımlanmış türlerden biri değil. Bu türde yeni bir değer tanımlamaya veya mevcut bir değeri bu türe değiştirmeye çalışmak geçersizdir. |
| const [SVG_TURBULENCE_TYPE_FRACTALNOISE](../../aspose.svg.filters/svgfeturbulenceelement/svg_turbulence_type_fractalnoise/) | 'fraktal Gürültü' değerine karşılık gelir. |
| const [SVG_TURBULENCE_TYPE_TURBULENCE](../../aspose.svg.filters/svgfeturbulenceelement/svg_turbulence_type_turbulence/) | 'türbülans' değerine karşılık gelir. |
| const [SVG_TURBULENCE_TYPE_UNKNOWN](../../aspose.svg.filters/svgfeturbulenceelement/svg_turbulence_type_unknown/) | Tür, önceden tanımlanmış türlerden biri değil. Bu türde yeni bir değer tanımlamaya veya mevcut bir değeri bu türe değiştirmeye çalışmak geçersizdir. |
