...
description: SVGFEBlendElement arabirimi feBlend öğesine karşılık gelir.
type: docs
weight: 1650
...
| [Height](../../aspose.svg.filters/svgfeblendelement/height) { get; } | Verilen 'filtre' öğesindeki 'yükseklik' özelliğine karşılık gelir. |
| [Id](../../aspose.svg/svgelement/id) { get; set; } | Verilen öğedeki 'id' özniteliğinin değeri veya 'id' yoksa boş dize. |
| [In1](../../aspose.svg.filters/svgfeblendelement/in1) { get; } | Verilen 'feBlend' öğesindeki 'in' özelliğine karşılık gelir. |
| [In2](../../aspose.svg.filters/svgfeblendelement/in2) { get; } | Verilen 'feBlend' öğesindeki 'in2' özelliğine karşılık gelir. |
...
| [Mode](../../aspose.svg.filters/svgfeblendelement/mode) { get; } | Verilen 'feBlend' öğesindeki 'mode' özniteliğine karşılık gelir. Bu arayüzde tanımlanan SVG_FEBLEND_MODE_* sabitlerinden birini alır. |
...
| [Result](../../aspose.svg.filters/svgfeblendelement/result) { get; } | Verilen 'filtre' öğesindeki 'sonuç' niteliğine karşılık gelir. |
...
| [Width](../../aspose.svg.filters/svgfeblendelement/width) { get; } | Verilen 'filtre' öğesindeki 'width' özelliğine karşılık gelir. |
| [X](../../aspose.svg.filters/svgfeblendelement/x) { get; } | Verilen 'filtre' öğesindeki 'x' özelliğine karşılık gelir. |
...
| İsim | Tanım |
| --- | --- |
| const [SVG_FEBLEND_MODE_COLOR](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_color) | 'color' değerine karşılık gelir. |
...
| const [SVG_FEBLEND_MODE_DARKEN](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_darken) | 'karartma' değerine karşılık gelir. |
...
| const [SVG_FEBLEND_MODE_LIGHTEN](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_lighten) | 'lighten' değerine karşılık gelir. |
...
| const [SVG_FEBLEND_MODE_MULTIPLY](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_multiply) | 'Çarpma' değerine karşılık gelir. |
...
| const [SVG_FEBLEND_MODE_OVERLAY](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_overlay) | 'overlay' değerine karşılık gelir. |
...
| const [SVG_FEBLEND_MODE_SCREEN](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_screen) | 'ekran' değerine karşılık gelir. |
