...
description: SVGEllipseElement arabirimi ellipse öğesine karşılık gelir.
type: docs
weight: 3170
...
SVGEllipseElement arabirimi, 'ellipse' öğesine karşılık gelir.
...
| [Ry](../../aspose.svg/svgellipseelement/ry) { get; } | Verilen 'daire' öğesindeki 'ry' niteliğine karşılık gelir. |
