...
description: Aspose.Svg.SVGViewElement sınıf. SVGViewElement arabirimi görünüm öğesine karşılık gelir.
type: docs
weight: 3590
url: /tr/net/aspose.svg/svgviewelement/
---
...
| [PreserveAspectRatio](../../aspose.svg/svgviewelement/preserveaspectratio/) { get; } | Belirtilen öğede 'preserveAspectRatio' özniteliğine karşılık gelir. |
...
| [ViewBox](../../aspose.svg/svgviewelement/viewbox/) { get; } | Belirtilen öğede 'viewBox' özelliğine karşılık gelir. |
...
| [ViewTarget](../../aspose.svg/svgviewelement/viewtarget/) { get; } | Verilen 'view' öğesinde 'viewTarget' özniteliğine karşılık gelir. 'viewTarget' özelliğinde listelenen adları içeren DOMString değerlerinin listesi. DOMString değerlerinin her biri, getElementById() yöntemi call. kullanılarak karşılık gelen öğeyle ilişkilendirilebilir. |
| [ZoomAndPan](../../aspose.svg/svgviewelement/zoomandpan/) { get; set; } | Belirtilen öğede 'zoomAndPan' özniteliğine karşılık gelir. Değer, bu arabirimde tanımlanan SVG_ZOOMANDPAN_* sabitlerinden biri olmalıdır. |
