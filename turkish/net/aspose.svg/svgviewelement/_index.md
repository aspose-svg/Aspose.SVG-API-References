...
description: SVGViewElement arabirimi görünüm öğesine karşılık gelir.
type: docs
weight: 3540
...
| [PreserveAspectRatio](../../aspose.svg/svgviewelement/preserveaspectratio) { get; } | Verilen öğede 'preserveAspectRatio' özniteliğine karşılık gelir. |
...
| [ViewBox](../../aspose.svg/svgviewelement/viewbox) { get; } | Verilen öğedeki 'viewBox' özelliğine karşılık gelir. |
...
| [ViewTarget](../../aspose.svg/svgviewelement/viewtarget) { get; } | Verilen 'view' öğesinde 'viewTarget' özniteliğine karşılık gelir. 'viewTarget' özniteliğinde listelenen adları içeren DOMString değerlerinin listesi. DOMString değerlerinin her biri, getElementById() yöntemi call. kullanılarak karşılık gelen öğeyle ilişkilendirilebilir. |
| [ZoomAndPan](../../aspose.svg/svgviewelement/zoomandpan) { get; set; } | Verilen öğede 'zoomAndPan' özniteliğine karşılık gelir. Değer, bu arabirimde tanımlanan SVG_ZOOMANDPAN_* sabitlerinden biri olmalıdır. |
