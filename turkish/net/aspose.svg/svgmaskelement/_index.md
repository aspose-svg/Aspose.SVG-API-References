...
description: Aspose.Svg.SVGMaskElement sınıf. SVGMaskElement arabirimi maske öğesine karşılık gelir.
type: docs
weight: 3350
url: /tr/net/aspose.svg/svgmaskelement/
---
...
| [Height](../../aspose.svg/svgmaskelement/height/) { get; } | Verilen 'maske' öğesindeki 'yükseklik' özelliğine karşılık gelir. SVGUnitTypes. içinde tanımlanan sabitlerden birini alır |
...
| [MaskContentUnits](../../aspose.svg/svgmaskelement/maskcontentunits/) { get; } | Verilen 'mask' öğesinde 'maskContentUnits' özniteliğine karşılık gelir. SVGUnitTypes. içinde tanımlanan sabitlerden birini alır |
| [MaskUnits](../../aspose.svg/svgmaskelement/maskunits/) { get; } | Verilen 'mask' öğesindeki 'maskUnits' özniteliğine karşılık gelir. SVGUnitTypes. içinde tanımlanan sabitlerden birini alır |
...
| [RequiredExtensions](../../aspose.svg/svgmaskelement/requiredextensions/) { get; } | Belirtilen öğede 'requiredExtensions' özniteliğine karşılık gelir. |
| [RequiredFeatures](../../aspose.svg/svgmaskelement/requiredfeatures/) { get; } | Belirtilen öğede 'requiredFeatures' özniteliğine karşılık gelir. |
...
| [SystemLanguage](../../aspose.svg/svgmaskelement/systemlanguage/) { get; } | Verilen öğedeki 'systemLanguage' özniteliğine karşılık gelir. |
...
| [Width](../../aspose.svg/svgmaskelement/width/) { get; } | Verilen 'maske' öğesindeki 'genişlik' özelliğine karşılık gelir. SVGUnitTypes. içinde tanımlanan sabitlerden birini alır |
| [X](../../aspose.svg/svgmaskelement/x/) { get; } | Verilen 'maske' öğesindeki 'x' özniteliğine karşılık gelir. SVGUnitTypes. içinde tanımlanan sabitlerden birini alır |
| [Y](../../aspose.svg/svgmaskelement/y/) { get; } | Verilen 'maske' öğesindeki 'y' özniteliğine karşılık gelir. SVGUnitTypes. içinde tanımlanan sabitlerden birini alır |
