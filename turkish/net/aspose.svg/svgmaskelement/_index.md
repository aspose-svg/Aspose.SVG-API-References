...
description: SVGMaskElement arabirimi maske öğesine karşılık gelir.
type: docs
weight: 3300
...
| [Height](../../aspose.svg/svgmaskelement/height) { get; } | Verilen 'maske' öğesindeki 'yükseklik' özniteliğine karşılık gelir. SVGUnitTypes. içinde tanımlanan sabitlerden birini alır |
...
| [MaskContentUnits](../../aspose.svg/svgmaskelement/maskcontentunits) { get; } | Verilen 'maske' öğesinde 'maskContentUnits' özniteliğine karşılık gelir. SVGUnitTypes. içinde tanımlanan sabitlerden birini alır |
| [MaskUnits](../../aspose.svg/svgmaskelement/maskunits) { get; } | Verilen 'maske' öğesinde 'maskBirimleri' özniteliğine karşılık gelir. SVGUnitTypes. içinde tanımlanan sabitlerden birini alır |
...
| [RequiredExtensions](../../aspose.svg/svgmaskelement/requiredextensions) { get; } | Verilen öğede 'requiredExtensions' özniteliğine karşılık gelir. |
| [RequiredFeatures](../../aspose.svg/svgmaskelement/requiredfeatures) { get; } | Verilen öğede 'requiredFeatures' özniteliğine karşılık gelir. |
...
| [SystemLanguage](../../aspose.svg/svgmaskelement/systemlanguage) { get; } | Verilen öğede 'systemLanguage' özelliğine karşılık gelir. |
...
| [Width](../../aspose.svg/svgmaskelement/width) { get; } | Verilen 'maske' öğesindeki 'width' özniteliğine karşılık gelir. SVGUnitTypes. içinde tanımlanan sabitlerden birini alır |
