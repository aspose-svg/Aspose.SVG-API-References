...
description: Aspose.Svg.SVGStyleElement sınıf. SVGStyleElement arabirimi stil öğesine karşılık gelir.
type: docs
weight: 3480
...
| [Sheet](../../aspose.svg/svgstyleelement/sheet/) { get; } | İlgili stil sayfasını alır. |
...
| [Type](../../aspose.svg/svgstyleelement/type/) { get; set; } | Belirli bir öğede 'tür' özniteliğine karşılık gelir. |
