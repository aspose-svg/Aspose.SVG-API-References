...
description: Aspose.Svg.SVGAnimateMotionElement sınıf. SVGAnimateMotionElement arabirimi animateMotion öğesine karşılık gelir. animateMotion öğesinin özniteliklerine SVG DOM üzerinden nesne yönelimli erişim mevcut değildir.
type: docs
weight: 3100
