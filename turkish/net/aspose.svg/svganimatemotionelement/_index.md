...
description: SVGAnimateMotionElement arabirimi animateMotion öğesine karşılık gelir. SVG DOM aracılığıyla animateMotion öğesinin özelliklerine nesne yönelimli erişim kullanılamaz.
type: docs
weight: 3050
url: /tr/net/aspose.svg/svganimatemotionelement/
---
## SVGAnimateMotionElement class

SVGAnimateMotionElement arabirimi, 'animateMotion' öğesine karşılık gelir. SVG DOM aracılığıyla 'animateMotion' öğesinin özelliklerine nesne yönelimli erişim kullanılamaz.
