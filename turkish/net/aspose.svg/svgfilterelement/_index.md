...
description: Aspose.Svg.SVGFilterElement sınıf. SVGFilterElement arabirimi filter öğesine karşılık gelir.
type: docs
weight: 3240
...
| [FilterUnits](../../aspose.svg/svgfilterelement/filterunits/) { get; } | Verilen 'filter' öğesindeki 'filterUnits' özniteliğine karşılık gelir. SVGUnitTypes. içinde tanımlanan sabitlerden birini alır |
...
| [Height](../../aspose.svg/svgfilterelement/height/) { get; } | Belirtilen 'filtre' öğesindeki 'yükseklik' özelliğine karşılık gelir. |
| [Href](../../aspose.svg/svgfilterelement/href/) { get; } | Belirtilen öğede 'xlink:href' özelliğine karşılık gelir. |
...
| [PrimitiveUnits](../../aspose.svg/svgfilterelement/primitiveunits/) { get; } | Verilen 'filter' öğesindeki 'primitiveUnits' özniteliğine karşılık gelir. SVGUnitTypes. içinde tanımlanan sabitlerden birini alır |
...
| [Width](../../aspose.svg/svgfilterelement/width/) { get; } | Verilen 'filtre' öğesindeki 'genişlik' özelliğine karşılık gelir. |
| [X](../../aspose.svg/svgfilterelement/x/) { get; } | Verilen 'filtre' öğesindeki 'x' özniteliğine karşılık gelir. |
