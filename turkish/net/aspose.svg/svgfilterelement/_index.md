...
description: SVGFilterElement arabirimi filtre öğesine karşılık gelir.
type: docs
weight: 3190
url: /tr/net/aspose.svg/svgfilterelement/
---
## SVGFilterElement class

SVGFilterElement arabirimi, 'filtre' öğesine karşılık gelir.
...
| [FilterUnits](../../aspose.svg/svgfilterelement/filterunits) { get; } | Verilen 'filtre' öğesindeki 'filterUnits' özniteliğine karşılık gelir. SVGUnitTypes. içinde tanımlanan sabitlerden birini alır |
...
| [Height](../../aspose.svg/svgfilterelement/height) { get; } | Verilen 'filtre' öğesindeki 'yükseklik' özelliğine karşılık gelir. |
| [Href](../../aspose.svg/svgfilterelement/href) { get; } | Verilen öğedeki 'xlink:href' özelliğine karşılık gelir. |
...
| [PrimitiveUnits](../../aspose.svg/svgfilterelement/primitiveunits) { get; } | Verilen 'filtre' öğesinde 'ilkelBirimler' özniteliğine karşılık gelir. SVGUnitTypes. içinde tanımlanan sabitlerden birini alır |
...
| [Width](../../aspose.svg/svgfilterelement/width) { get; } | Verilen 'filtre' öğesindeki 'width' özelliğine karşılık gelir. |
| [X](../../aspose.svg/svgfilterelement/x) { get; } | Verilen 'filtre' öğesindeki 'x' özelliğine karşılık gelir. |
| [Y](../../aspose.svg/svgfilterelement/y) { get; } | Verilen 'filtre' öğesindeki 'y' özniteliğine karşılık gelir. |
