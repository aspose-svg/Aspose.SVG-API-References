...
description: Doğrudan SVG dilindeki öğelere karşılık gelen tüm SVG DOM arabirimleri yol öğesi için SVGPathElement arabirimi gibi SVGElement arabiriminden türetilir.
type: docs
weight: 3150
url: /tr/net/aspose.svg/svgelement/
---
## SVGElement class

Doğrudan SVG dilindeki öğelere karşılık gelen tüm SVG DOM arabirimleri ('yol' öğesi için SVGPathElement arabirimi gibi) SVGElement arabiriminden türetilir.
