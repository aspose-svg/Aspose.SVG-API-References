...
description: Aspose.Svg.SVGTextPathElement sınıf. SVGTextPathElement arabirimi textPath öğesine karşılık gelir.
type: docs
weight: 3540
url: /tr/net/aspose.svg/svgtextpathelement/
---
...
| [Href](../../aspose.svg/svgtextpathelement/href/) { get; } | Belirtilen öğede 'xlink:href' özelliğine karşılık gelir. |
...
| [LengthAdjust](../../aspose.svg/svgtextcontentelement/lengthadjust/) { get; } | Belirtilen öğede 'uzunlukAdjust' özniteliğine karşılık gelir. Değer, bu arabirimde tanımlanan uzunluk ayarlama sabitlerinden biri olmalıdır. |
...
| [Method](../../aspose.svg/svgtextpathelement/method/) { get; } | Verilen 'textPath' öğesindeki 'method' özniteliğine karşılık gelir. |
...
| [Spacing](../../aspose.svg/svgtextpathelement/spacing/) { get; } | Verilen 'textPath' öğesindeki 'boşluk' özniteliğine karşılık gelir. |
| [StartOffset](../../aspose.svg/svgtextpathelement/startoffset/) { get; } | Belirtilen 'textPath' öğesinde 'startOffset' özniteliğine karşılık gelir. |
...
| [TextLength](../../aspose.svg/svgtextcontentelement/textlength/) { get; } | Verilen öğedeki 'textLength' özniteliğine karşılık gelir. |
...
| İsim | Tanım |
| --- | --- |
| const [TEXTPATH_METHODTYPE_ALIGN](../../aspose.svg/svgtextpathelement/textpath_methodtype_align/) | 'hizalama' değerine karşılık gelir. |
| const [TEXTPATH_METHODTYPE_STRETCH](../../aspose.svg/svgtextpathelement/textpath_methodtype_stretch/) | 'germe' değerine karşılık gelir. |
| const [TEXTPATH_METHODTYPE_UNKNOWN](../../aspose.svg/svgtextpathelement/textpath_methodtype_unknown/) | Numaralandırma, önceden tanımlanmış türlerden biri olmayan bir değere ayarlandı. Bu türde yeni bir değer tanımlamaya veya mevcut bir değeri bu türe değiştirmeye çalışmak geçersizdir. |
| const [TEXTPATH_SPACINGTYPE_AUTO](../../aspose.svg/svgtextpathelement/textpath_spacingtype_auto/) | 'auto' değerine karşılık gelir. |
| const [TEXTPATH_SPACINGTYPE_EXACT](../../aspose.svg/svgtextpathelement/textpath_spacingtype_exact/) | 'exact' değerine karşılık gelir. |
| const [TEXTPATH_SPACINGTYPE_UNKNOWN](../../aspose.svg/svgtextpathelement/textpath_spacingtype_unknown/) | Numaralandırma, önceden tanımlanmış türlerden biri olmayan bir değere ayarlandı. Bu türde yeni bir değer tanımlamaya veya mevcut bir değeri bu türe değiştirmeye çalışmak geçersizdir. |
