...
description: SVGTextPathElement arabirimi textPath öğesine karşılık gelir.
type: docs
weight: 3490
...
| [Href](../../aspose.svg/svgtextpathelement/href) { get; } | Verilen öğedeki 'xlink:href' özelliğine karşılık gelir. |
...
| [Method](../../aspose.svg/svgtextpathelement/method) { get; } | Verilen 'textPath' öğesinde 'yöntem' özniteliğine karşılık gelir. |
...
| [Spacing](../../aspose.svg/svgtextpathelement/spacing) { get; } | Verilen 'textPath' öğesindeki 'aralık' özelliğine karşılık gelir. |
| [StartOffset](../../aspose.svg/svgtextpathelement/startoffset) { get; } | Verilen 'textPath' öğesinde 'startOffset' özniteliğine karşılık gelir. |
...
| İsim | Tanım |
| --- | --- |
| const [TEXTPATH_METHODTYPE_ALIGN](../../aspose.svg/svgtextpathelement/textpath_methodtype_align) | 'align' değerine karşılık gelir. |
| const [TEXTPATH_METHODTYPE_STRETCH](../../aspose.svg/svgtextpathelement/textpath_methodtype_stretch) | 'stretch' değerine karşılık gelir. |
...
| const [TEXTPATH_SPACINGTYPE_EXACT](../../aspose.svg/svgtextpathelement/textpath_spacingtype_exact) | 'tam' değerine karşılık gelir. |
