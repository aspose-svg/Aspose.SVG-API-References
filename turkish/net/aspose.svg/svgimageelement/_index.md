...
description: Aspose.Svg.SVGImageElement sınıf. SVGImageElement arabirimi resim öğesine karşılık gelir.
type: docs
weight: 3300
...
| [Href](../../aspose.svg/svgimageelement/href/) { get; } | Belirtilen öğede 'xlink:href' özelliğine karşılık gelir. |
...
| [PreserveAspectRatio](../../aspose.svg/svgimageelement/preserveaspectratio/) { get; } | Belirtilen 'görüntü' öğesinde 'preserveAspectRatio' özniteliğine karşılık gelir. |
...
| [Width](../../aspose.svg/svgimageelement/width/) { get; } | Belirtilen 'görüntü' öğesindeki 'genişlik' özelliğine karşılık gelir. |
| [X](../../aspose.svg/svgimageelement/x/) { get; } | Verilen 'görüntü' öğesindeki 'x' özniteliğine karşılık gelir. |
| [Y](../../aspose.svg/svgimageelement/y/) { get; } | Verilen 'görüntü' öğesindeki 'y' özniteliğine karşılık gelir. |
