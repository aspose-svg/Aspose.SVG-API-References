...
description: SVGImageElement arabirimi image öğesine karşılık gelir.
type: docs
weight: 3250
url: /tr/net/aspose.svg/svgimageelement/
---
## SVGImageElement class

SVGImageElement arabirimi, 'image' öğesine karşılık gelir.
...
| [Height](../../aspose.svg/svgimageelement/height) { get; } | Verilen 'görüntü' öğesindeki 'yükseklik' özelliğine karşılık gelir. |
| [Href](../../aspose.svg/svgimageelement/href) { get; } | Verilen öğedeki 'xlink:href' özelliğine karşılık gelir. |
...
| [PreserveAspectRatio](../../aspose.svg/svgimageelement/preserveaspectratio) { get; } | Verilen 'görüntü' öğesinde 'preserveAspectRatio' özniteliğine karşılık gelir. |
...
| [Width](../../aspose.svg/svgimageelement/width) { get; } | Verilen 'görüntü' öğesindeki 'genişlik' özelliğine karşılık gelir. |
| [X](../../aspose.svg/svgimageelement/x) { get; } | Verilen 'görüntü' öğesindeki 'x' özelliğine karşılık gelir. |
| [Y](../../aspose.svg/svgimageelement/y) { get; } | Verilen 'görüntü' öğesindeki 'y' özelliğine karşılık gelir. |
