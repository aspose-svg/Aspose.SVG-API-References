...
description: Aspose.Svg.SVGAnimateElement sınıf. SVGAnimateElement arabirimi animate öğesine karşılık gelir. animate öğesinin özniteliklerine SVG DOM aracılığıyla nesne yönelimli erişim mevcut değildir.
type: docs
weight: 3090
