...
description: SVGAnimateElement arabirimi animate öğesine karşılık gelir. SVG DOM aracılığıyla animate öğesinin özelliklerine nesne yönelimli erişim kullanılamaz.
type: docs
weight: 3040
url: /tr/net/aspose.svg/svganimateelement/
---
## SVGAnimateElement class

SVGAnimateElement arabirimi, 'animate' öğesine karşılık gelir. SVG DOM aracılığıyla 'animate' öğesinin özelliklerine nesne yönelimli erişim kullanılamaz.
