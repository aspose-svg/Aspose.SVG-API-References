...
description: Her bir useelement shadow ağacının kök nesnesi SVGUseElementShadowRoot arabirimini uygular. Bu arayüz şu anda ShadowRoot arayüzü ve DocumentOrShadowRoot karışımı için tanımlanan özelliklere ve yöntemlere herhangi bir uzantı tanımlamamaktadır. Ancak bu düğümde köklenen ağaç yazar komut dosyaları açısından tamamen salt okunurdur.
type: docs
weight: 3160
...
Her bir use-element shadow ağacının kök nesnesi, SVGUseElementShadowRoot arabirimini uygular. Bu arayüz şu anda ShadowRoot arayüzü ve DocumentOrShadowRoot karışımı için tanımlanan özelliklere ve yöntemlere herhangi bir uzantı tanımlamamaktadır. Ancak, bu düğümde köklenen ağaç, yazar komut dosyaları açısından tamamen salt okunurdur.
...
| [Host](../../aspose.svg.dom/shadowroot/host) { get; } | Ana bilgisayar, bu ShadowRoot. öğesini içeren bir öğedir. |
