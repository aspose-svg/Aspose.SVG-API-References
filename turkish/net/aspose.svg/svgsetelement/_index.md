...
description: Aspose.Svg.SVGSetElement sınıf. SVGSetElement arabirimi set öğesine karşılık gelir. set öğesinin özniteliklerine SVG DOM üzerinden nesne yönelimli erişim mevcut değildir.
type: docs
weight: 3460
