...
description: SVGSetElement arabirimi set öğesine karşılık gelir. SVG DOM aracılığıyla set öğesinin özelliklerine nesne yönelimli erişim kullanılamaz.
type: docs
weight: 3410
url: /tr/net/aspose.svg/svgsetelement/
---
## SVGSetElement class

SVGSetElement arabirimi, 'set' öğesine karşılık gelir. SVG DOM aracılığıyla 'set' öğesinin özelliklerine nesne yönelimli erişim kullanılamaz.
