...
description: Aspose.Svg.SVGGeometryElement sınıf. Arayüz SVGGeometryElement işlemesi eşdeğer bir yolla geometri tarafından tanımlanan ve doldurulabilen ve konturlanabilen SVG öğelerini temsil eder. Bu yolları ve temel şekilleri içerir.
type: docs
weight: 3270
url: /tr/net/aspose.svg/svggeometryelement/
---
...
| [GetEquivalentPath](../../aspose.svg/svggeometryelement/getequivalentpath/)() | Yeni bir örnek örneğini döndürür.[`SVGPathSegList`](../../aspose.svg.paths/svgpathseglist/) hangi temsil eder`SVGGeometryElement` yol segmentleri olarak. |
