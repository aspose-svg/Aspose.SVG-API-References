...
description: SVGClipPathElement arabirimi clipPath öğesine karşılık gelir.
type: docs
weight: 3090
...
| [ClipPathUnits](../../aspose.svg/svgclippathelement/clippathunits) { get; } | Verilen 'clipPath' öğesindeki 'clipPathUnits' özniteliğine karşılık gelir. SVGUnitTypes. içinde tanımlanan sabitlerden birini alır |
...
| [Transform](../../aspose.svg/svgclippathelement/transform) { get; } | Verilen öğede 'dönüştürme' özniteliğine karşılık gelir. |
