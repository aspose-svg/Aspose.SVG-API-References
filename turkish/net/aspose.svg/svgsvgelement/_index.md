...
description: Anahtar arabirim tanımı svg öğesine karşılık gelen arabirim olan SVGSVGElement arabirimidir. Bu arabirim matris işlemleri ve görsel işleme aygıtlarında yeniden çizme süresini kontrol etme yeteneği gibi çeşitli yaygın olarak kullanılan yardımcı program yöntemlerini içerir.
type: docs
weight: 3390
...
Anahtar arabirim tanımı, 'svg' öğesine karşılık gelen arabirim olan SVGSVGElement arabirimidir. Bu arabirim, matris işlemleri ve görsel işleme aygıtlarında yeniden çizme süresini kontrol etme yeteneği gibi çeşitli yaygın olarak kullanılan yardımcı program yöntemlerini içerir.
...
| [PreserveAspectRatio](../../aspose.svg/svgsvgelement/preserveaspectratio) { get; } | Verilen öğede 'preserveAspectRatio' özniteliğine karşılık gelir. |
...
| [ViewBox](../../aspose.svg/svgsvgelement/viewbox) { get; } | Verilen öğedeki 'viewBox' özelliğine karşılık gelir. |
...
| [Width](../../aspose.svg/svgsvgelement/width) { get; } | Verilen 'svg' öğesindeki 'width' özniteliğine karşılık gelir. |
| [X](../../aspose.svg/svgsvgelement/x) { get; } | Verilen 'svg' öğesindeki 'x' özelliğine karşılık gelir. |
| [Y](../../aspose.svg/svgsvgelement/y) { get; } | Verilen 'svg' öğesindeki 'y' özniteliğine karşılık gelir. |
| [ZoomAndPan](../../aspose.svg/svgsvgelement/zoomandpan) { get; set; } | Verilen öğede 'zoomAndPan' özniteliğine karşılık gelir. Değer, bu arabirimde tanımlanan SVG_ZOOMANDPAN_* sabitlerinden biri olmalıdır. |
...
| [CreateEvent](../../aspose.svg/svgsvgelement/createevent)(string) | Bir[`Event`](../../aspose.svg.dom.events/event) uygulama tarafından desteklenen türden. |
| [CreateSVGAngle](../../aspose.svg/svgsvgelement/createsvgangle)() | Herhangi bir belge ağacının dışında bir SVGAngle nesnesi oluşturur. Nesne 0 derece (birimsiz) değerine başlatılır. |
| [CreateSVGLength](../../aspose.svg/svgsvgelement/createsvglength)() | Herhangi bir belge ağacının dışında bir SVGLength nesnesi oluşturur. Nesne, 0 kullanıcı birimi değerine başlatıldı. |
| [CreateSVGMatrix](../../aspose.svg/svgsvgelement/createsvgmatrix)() | Herhangi bir belge ağacının dışında bir SVGMatrix nesnesi oluşturur. Nesne, kimlik matrisine başlatılır. |
| [CreateSVGNumber](../../aspose.svg/svgsvgelement/createsvgnumber)() | Herhangi bir belge ağacının dışında bir SVGNumber nesnesi oluşturur. Nesne sıfır değerine başlatıldı. |
| [CreateSVGPoint](../../aspose.svg/svgsvgelement/createsvgpoint)() | Herhangi bir belge ağacının dışında bir SVGPoint nesnesi oluşturur. Nesne, kullanıcı koordinat sisteminde (0,0) noktasına başlatılır. |
...
| [CreateSVGTransform](../../aspose.svg/svgsvgelement/createsvgtransform)() | Herhangi bir belge ağacının dışında bir SVGTransform nesnesi oluşturur. Nesne, bir kimlik matrisi dönüşümüne başlatılır (SVG_TRANSFORM_MATRIX). |
| [CreateSVGTransformFromMatrix](../../aspose.svg/svgsvgelement/createsvgtransformfrommatrix)(SVGMatrix) | Herhangi bir belge ağacının dışında bir SVGTransform nesnesi oluşturur. Nesne, verilen matris dönüşümüne başlatılır (yani, SVG_TRANSFORM_MATRIX). Parametre matrisindeki değerler kopyalanır, matris parametresi SVGTransform::matrix. olarak benimsenmez |
...
| [GetCurrentTime](../../aspose.svg/svgsvgelement/getcurrenttime)() | Geçerli SVG belge parçasının başlangıç zamanına göre geçerli saati saniye cinsinden döndürür. Belge zaman çizelgesi başlamadan önce getCurrentTime çağrılırsa (örneğin, belgenin SVGLoad olayı gönderilmeden önce bir 'komut dosyası' öğesinde komut dosyası çalıştırılarak), 0 döndürülür. |
| [GetElementById](../../aspose.svg/svgsvgelement/getelementbyid)(string) | Bu SVG belge parçasını arar (yani arama, belge ağacının bir alt kümesiyle sınırlıdır), kimliği elementId tarafından verilen bir Öğe için. Bir Element bulunursa, o Element döndürülür. Böyle bir öğe yoksa, null değerini döndürür. Bu kimliğe sahip birden fazla öğe varsa davranış tanımlanmaz. |
...
| [PauseAnimations](../../aspose.svg/svgsvgelement/pauseanimations)() | Bu 'svg' öğesine karşılık gelen SVG belge parçası içinde tanımlanan, o anda çalışan tüm animasyonları askıya alır (yani duraklatır), bu belge parçasına karşılık gelen animasyon saatinin, duraklatılana kadar hareketsiz kalmasına neden olur. |
...
| [UnpauseAnimations](../../aspose.svg/svgsvgelement/unpauseanimations)() | Şu anda SVG belge parçası içinde tanımlanan animasyonları askıya almayı kaldırır (yani duraklatmayı kaldırır), bu da animasyon saatinin askıya alındığı andan itibaren devam etmesine neden olur. |
