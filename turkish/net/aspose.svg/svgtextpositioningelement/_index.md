...
description: SVGTextPositioningElement arabirimi metinle ilgili arabirimler tarafından devralınır SVGTextElement SVGTSpanElement SVGTRefElement ve SVGAltGlyphElement.
type: docs
weight: 3500
...
| [Dx](../../aspose.svg/svgtextpositioningelement/dx) { get; } | Verilen öğedeki 'dx' özelliğine karşılık gelir. |
...
| [Rotate](../../aspose.svg/svgtextpositioningelement/rotate) { get; } | Verilen öğede "döndürme" özelliğine karşılık gelir. |
...
| [X](../../aspose.svg/svgtextpositioningelement/x) { get; } | Verilen öğedeki 'x' özelliğine karşılık gelir. |
