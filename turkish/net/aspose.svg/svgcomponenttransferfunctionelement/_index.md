...
description: Bu arabirim bileşen aktarım işlevi arabirimleri tarafından kullanılan bir temel arabirimi tanımlar.
type: docs
weight: 3100
...
| [Intercept](../../aspose.svg/svgcomponenttransferfunctionelement/intercept) { get; } | Verilen öğede "intercept" özelliğine karşılık gelir. |
...
| [Offset](../../aspose.svg/svgcomponenttransferfunctionelement/offset) { get; } | Verilen öğede 'ofset' özelliğine karşılık gelir. |
...
| [Slope](../../aspose.svg/svgcomponenttransferfunctionelement/slope) { get; } | Verilen öğedeki 'eğim' özelliğine karşılık gelir. |
...
| [TableValues](../../aspose.svg/svgcomponenttransferfunctionelement/tablevalues) { get; } | Verilen öğede 'tableValues' özniteliğine karşılık gelir. |
...
| [Type](../../aspose.svg/svgcomponenttransferfunctionelement/type) { get; } | Verilen öğedeki 'type' özniteliğine karşılık gelir. Bu arabirimde tanımlanan SVG_FECOMPONENTTRANSFER_TYPE_* sabitlerinden birini alır. |
...
| const [SVG_FECOMPONENTTRANSFER_TYPE_GAMMA](../../aspose.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_gamma) | 'gama' değerine karşılık gelir. |
