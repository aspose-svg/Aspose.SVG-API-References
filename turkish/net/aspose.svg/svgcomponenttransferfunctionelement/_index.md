...
description: Aspose.Svg.SVGComponentTransferFunctionElement sınıf. Bu arabirim bileşen aktarım işlevi arabirimleri tarafından kullanılan bir temel arabirimi tanımlar.
type: docs
weight: 3150
url: /tr/net/aspose.svg/svgcomponenttransferfunctionelement/
---
...
| İsim | Tanım |
| --- | --- |
| [Amplitude](../../aspose.svg/svgcomponenttransferfunctionelement/amplitude/) { get; } | Verilen öğedeki 'genlik' özelliğine karşılık gelir. |
...
| [Exponent](../../aspose.svg/svgcomponenttransferfunctionelement/exponent/) { get; } | Verilen öğedeki 'üs' özniteliğine karşılık gelir. |
...
| [Intercept](../../aspose.svg/svgcomponenttransferfunctionelement/intercept/) { get; } | Belirli bir öğede 'intercept' özelliğine karşılık gelir. |
...
| [Offset](../../aspose.svg/svgcomponenttransferfunctionelement/offset/) { get; } | Belirli bir öğede 'offset' özniteliğine karşılık gelir. |
...
| [Slope](../../aspose.svg/svgcomponenttransferfunctionelement/slope/) { get; } | Belirli bir öğede 'eğim' özelliğine karşılık gelir. |
...
| [TableValues](../../aspose.svg/svgcomponenttransferfunctionelement/tablevalues/) { get; } | Verilen öğedeki 'tableValues' özniteliğine karşılık gelir. |
...
| [Type](../../aspose.svg/svgcomponenttransferfunctionelement/type/) { get; } | Belirli bir öğede 'tür' özniteliğine karşılık gelir. Bu arabirimde tanımlanan SVG_FECOMPONENTTRANSFER_TYPE_* sabitlerinden birini alır. |
...
| İsim | Tanım |
| --- | --- |
| const [SVG_FECOMPONENTTRANSFER_TYPE_DISCRETE](../../aspose.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_discrete/) | 'ayrık' değerine karşılık gelir. |
| const [SVG_FECOMPONENTTRANSFER_TYPE_GAMMA](../../aspose.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_gamma/) | 'gamma' değerine karşılık gelir. |
| const [SVG_FECOMPONENTTRANSFER_TYPE_IDENTITY](../../aspose.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_identity/) | 'kimlik' değerine karşılık gelir. |
| const [SVG_FECOMPONENTTRANSFER_TYPE_LINEAR](../../aspose.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_linear/) | 'doğrusal' değerine karşılık gelir. |
| const [SVG_FECOMPONENTTRANSFER_TYPE_TABLE](../../aspose.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_table/) | 'tablo' değerine karşılık gelir. |
| const [SVG_FECOMPONENTTRANSFER_TYPE_UNKNOWN](../../aspose.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_unknown/) | Tür, önceden tanımlanmış türlerden biri değil. Bu türde yeni bir değer tanımlamaya veya mevcut bir değeri bu türe değiştirmeye çalışmak geçersizdir. |
