...
description: Aspose.Svg.SVGPathElement sınıf. SVGPathElement arabirimi yol öğesine karşılık gelir.
type: docs
weight: 3370
...
| [PathLength](../../aspose.svg/svggeometryelement/pathlength/) { get; } | Verilen öğedeki pathLength özniteliğine karşılık gelir. |
| [PathSegList](../../aspose.svg/svgpathelement/pathseglist/) { get; set; } | SVG'nin sözdizimiyle bire bir eşleşen bir biçimde 'd' özniteliğinin temel (yani statik) içeriğine erişim sağlar. Dolayısıyla, 'd' özniteliği bir "mutlak hareket (M)" ve bir "mutlak ark (A)" komutuna sahipse, pathSegList'in iki girişi olacaktır: bir SVG_PATHSEG_MOVETO_ABS ve bir SVG_PATHSEG_ARC_ABS. |
...
| [CreateSVGPathSegCurvetoCubicAbs](../../aspose.svg/svgpathelement/createsvgpathsegcurvetocubicabs/)(float, float, float, float, float, float) | Tek başına, ebeveynsiz bir SVGPathSegCurvetoCubicAbs nesnesi döndürür. |
...
| [CreateSVGPathSegCurvetoQuadraticSmoothRel](../../aspose.svg/svgpathelement/createsvgpathsegcurvetoquadraticsmoothrel/)(float, float) | Tek başına, ebeveynsiz bir SVGPathSegCurvetoQuadraticSmoothRel nesnesi döndürür. |
...
| [GetEquivalentPath](../../aspose.svg/svggeometryelement/getequivalentpath/)() | Yeni bir örnek örneğini döndürür.[`SVGPathSegList`](../../aspose.svg.paths/svgpathseglist/) hangi temsil eder[`SVGGeometryElement`](../svggeometryelement/) yol segmentleri olarak. |
...
| [GetPointAtLength](../../aspose.svg/svggeometryelement/getpointatlength/)(float) | Kullanıcı aracısının yol boyunca mesafe algoritmasını kullanarak, yol boyunca mesafe birimleri olan kullanıcı alanındaki (x,y) koordinatını döndürür. |
...
| [GetTotalLength](../../aspose.svg/svggeometryelement/gettotallength/)() | Geçerli kullanıcı koordinat sisteminde bir mesafe olarak, kullanıcı aracısının yol boyunca mesafe algoritmasını kullanarak yolun toplam uzunluğu için kullanıcı aracısının hesaplanan değerini döndürür. |
