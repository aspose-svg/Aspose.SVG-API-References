...
description: SVGPathElement arabirimi yol öğesine karşılık gelir.
type: docs
weight: 3320
url: /tr/net/aspose.svg/svgpathelement/
---
...
| İsim | Tanım |
| --- | --- |
| [AnimatedPathSegList](../../aspose.svg/svgpathelement/animatedpathseglist) { get; } | 'd' özniteliğinin mevcut animasyon içeriğine, SVG'nin sözdizimi ile birebir eşleşen bir biçimde erişim sağlar. Verilen öznitelik veya özellik canlandırılıyorsa, özniteliğin veya özelliğin geçerli animasyonlu değerini içerir ve hem nesnenin kendisi hem de içeriği salt okunurdur. Verilen öznitelik veya özellik şu anda canlandırılmıyorsa, pathSegList. ile aynı değeri içerir. |
...
| [PathLength](../../aspose.svg/svggeometryelement/pathlength) { get; } | Verilen öğede pathLength niteliğine karşılık gelir. |
| [PathSegList](../../aspose.svg/svgpathelement/pathseglist) { get; set; } | 'd' özniteliğinin temel (yani statik) içeriğine, SVG'nin sözdizimi ile birebir eşleşen bir biçimde erişim sağlar. Bu nedenle, 'd' özniteliği bir "mutlak hareket (M)" ve bir "mutlak yay (A)" komutuna sahipse, pathSegList'in iki girişi olacaktır: bir SVG_PATHSEG_MOVETO_ABS ve bir SVG_PATHSEG_ARC_ABS. |
...
| [CreateSVGPathSegArcAbs](../../aspose.svg/svgpathelement/createsvgpathsegarcabs)(float, float, float, float, float, bool, bool) | Tek başına, ebeveynsiz bir SVGPathSegArcAbs nesnesi döndürür. |
| [CreateSVGPathSegArcRel](../../aspose.svg/svgpathelement/createsvgpathsegarcrel)(float, float, float, float, float, bool, bool) | Tek başına, ebeveynsiz bir SVGPathSegArcRel nesnesi döndürür. |
| [CreateSVGPathSegClosePath](../../aspose.svg/svgpathelement/createsvgpathsegclosepath)() | Tek başına, ebeveynsiz bir SVGPathSegClosePath nesnesi döndürür. |
| [CreateSVGPathSegCurvetoCubicAbs](../../aspose.svg/svgpathelement/createsvgpathsegcurvetocubicabs)(float, float, float, float, float, float) | Bağımsız, ebeveynsiz bir SVGPathSegCurvetoCubicAbs nesnesi döndürür. |
| [CreateSVGPathSegCurvetoCubicRel](../../aspose.svg/svgpathelement/createsvgpathsegcurvetocubicrel)(float, float, float, float, float, float) | Tek başına, ebeveynsiz bir SVGPathSegCurvetoCubicRel nesnesi döndürür. |
| [CreateSVGPathSegCurvetoCubicSmoothAbs](../../aspose.svg/svgpathelement/createsvgpathsegcurvetocubicsmoothabs)(float, float, float, float) | Tek başına, ebeveynsiz bir SVGPathSegCurvetoCubicSmoothAbs nesnesi döndürür. |
| [CreateSVGPathSegCurvetoCubicSmoothRel](../../aspose.svg/svgpathelement/createsvgpathsegcurvetocubicsmoothrel)(float, float, float, float) | Tek başına, ebeveynsiz bir SVGPathSegCurvetoCubicSmoothRel nesnesi döndürür. |
| [CreateSVGPathSegCurvetoQuadraticAbs](../../aspose.svg/svgpathelement/createsvgpathsegcurvetoquadraticabs)(float, float, float, float) | Tek başına, ebeveynsiz bir SVGPathSegCurvetoQuadraticAbs nesnesi döndürür. |
| [CreateSVGPathSegCurvetoQuadraticRel](../../aspose.svg/svgpathelement/createsvgpathsegcurvetoquadraticrel)(float, float, float, float) | Tek başına, ebeveynsiz bir SVGPathSegCurvetoQuadraticRel nesnesi döndürür. |
| [CreateSVGPathSegCurvetoQuadraticSmoothAbs](../../aspose.svg/svgpathelement/createsvgpathsegcurvetoquadraticsmoothabs)(float, float) | Tek başına, ebeveynsiz bir SVGPathSegCurvetoQuadraticSmoothAbs nesnesi döndürür. |
| [CreateSVGPathSegCurvetoQuadraticSmoothRel](../../aspose.svg/svgpathelement/createsvgpathsegcurvetoquadraticsmoothrel)(float, float) | Bağımsız, ebeveynsiz bir SVGPathSegCurvetoQuadraticSmoothRel nesnesi döndürür. |
| [CreateSVGPathSegLinetoAbs](../../aspose.svg/svgpathelement/createsvgpathseglinetoabs)(float, float) | Tek başına, ebeveynsiz bir SVGPathSegLinetoAbs nesnesi döndürür. |
| [CreateSVGPathSegLinetoHorizontalAbs](../../aspose.svg/svgpathelement/createsvgpathseglinetohorizontalabs)(float) | Tek başına, ebeveynsiz bir SVGPathSegLinetoHorizontalAbs nesnesi döndürür. |
| [CreateSVGPathSegLinetoHorizontalRel](../../aspose.svg/svgpathelement/createsvgpathseglinetohorizontalrel)(float) | Tek başına, ebeveynsiz bir SVGPathSegLinetoHorizontalRel nesnesi döndürür. |
| [CreateSVGPathSegLinetoRel](../../aspose.svg/svgpathelement/createsvgpathseglinetorel)(float, float) | Tek başına, ebeveynsiz bir SVGPathSegLinetoRel nesnesi döndürür. |
| [CreateSVGPathSegLinetoVerticalAbs](../../aspose.svg/svgpathelement/createsvgpathseglinetoverticalabs)(float) | Tek başına, ebeveynsiz bir SVGPathSegLinetoVerticalAbs nesnesi döndürür. |
| [CreateSVGPathSegLinetoVerticalRel](../../aspose.svg/svgpathelement/createsvgpathseglinetoverticalrel)(float) | Tek başına, ebeveynsiz bir SVGPathSegLinetoVerticalRel nesnesi döndürür. |
| [CreateSVGPathSegMovetoAbs](../../aspose.svg/svgpathelement/createsvgpathsegmovetoabs)(float, float) | Tek başına, ebeveynsiz bir SVGPathSegMovetoAbs nesnesi döndürür. |
| [CreateSVGPathSegMovetoRel](../../aspose.svg/svgpathelement/createsvgpathsegmovetorel)(float, float) | Tek başına, ebeveynsiz bir SVGPathSegMovetoRel nesnesi döndürür. |
...
| [GetPointAtLength](../../aspose.svg/svggeometryelement/getpointatlength)(float) | Kullanıcı aracısının bir yol boyunca-uzaklık algoritmasını kullanarak, yol boyunca uzaklık birimleri olan kullanıcı alanındaki (x,y) koordinatını döndürür. |
...
| [GetTotalLength](../../aspose.svg/svggeometryelement/gettotallength)() | Geçerli kullanıcı koordinat sisteminde bir mesafe olarak, kullanıcı aracısının bir yol boyunca-uzaklık algoritmasını kullanarak yolun toplam uzunluğu için kullanıcı aracısının hesaplanan değerini döndürür. |
