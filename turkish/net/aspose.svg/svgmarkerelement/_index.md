...
description: SVGMarkerElement arabirimi işaretleyici öğesine karşılık gelir.
type: docs
weight: 3290
...
SVGMarkerElement arabirimi, 'işaretleyici' öğesine karşılık gelir.
...
| [MarkerHeight](../../aspose.svg/svgmarkerelement/markerheight) { get; } | Verilen 'marker' öğesindeki 'markerHeight' özelliğine karşılık gelir. |
| [MarkerUnits](../../aspose.svg/svgmarkerelement/markerunits) { get; } | Verilen 'marker' öğesinde 'markerUnits' özniteliğine karşılık gelir. Bu arabirimde tanımlanan İşaretleyici Birim Türlerinden biri. |
| [MarkerWidth](../../aspose.svg/svgmarkerelement/markerwidth) { get; } | Verilen 'marker' öğesindeki 'markerWidth' özelliğine karşılık gelir. |
...
| [OrientAngle](../../aspose.svg/svgmarkerelement/orientangle) { get; } | Verilen 'işaretleyici' öğesinde 'orient' niteliğine karşılık gelir. markerUnits SVG_MARKER_ORIENT_ANGLE ise, 'orient' özniteliği için açı değeri; aksi takdirde sıfıra ayarlanır. |
| [OrientType](../../aspose.svg/svgmarkerelement/orienttype) { get; } | Verilen 'işaretleyici' öğesinde 'orient' niteliğine karşılık gelir. Bu arabirimde tanımlanan İşaretçi Yönlendirme Türlerinden biri. |
...
| [PreserveAspectRatio](../../aspose.svg/svgmarkerelement/preserveaspectratio) { get; } | Verilen öğede 'preserveAspectRatio' özniteliğine karşılık gelir. |
...
| [RefX](../../aspose.svg/svgmarkerelement/refx) { get; } | Verilen 'işaretleyici' öğesindeki 'refX' özelliğine karşılık gelir. |
| [RefY](../../aspose.svg/svgmarkerelement/refy) { get; } | Verilen 'işaretleyici' öğesindeki 'refY' özniteliğine karşılık gelir. |
...
| [ViewBox](../../aspose.svg/svgmarkerelement/viewbox) { get; } | Verilen öğedeki 'viewBox' özelliğine karşılık gelir. |
...
| const [SVG_MARKERUNITS_UNKNOWN](../../aspose.svg/svgmarkerelement/svg_markerunits_unknown) | İşaretleyici birim türü, önceden tanımlanmış türlerden biri değil. Bu türde yeni bir değer tanımlamaya veya mevcut bir değeri bu türe değiştirmeye çalışmak geçersizdir. |
| const [SVG_MARKERUNITS_USERSPACEONUSE](../../aspose.svg/svgmarkerelement/svg_markerunits_userspaceonuse) | 'markerUnits' özelliğinin değeri 'userSpaceOnUse'dur. |
| const [SVG_MARKER_ORIENT_ANGLE](../../aspose.svg/svgmarkerelement/svg_marker_orient_angle) | 'orient' özelliğinin bir açı değeri var. |
| const [SVG_MARKER_ORIENT_AUTO](../../aspose.svg/svgmarkerelement/svg_marker_orient_auto) | 'orient' özelliğinin değeri 'auto'. |
