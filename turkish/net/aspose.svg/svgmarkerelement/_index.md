...
description: Aspose.Svg.SVGMarkerElement sınıf. SVGMarkerElement arabirimi işaretleyici öğeye karşılık gelir.
type: docs
weight: 3340
url: /tr/net/aspose.svg/svgmarkerelement/
---
...
| [MarkerHeight](../../aspose.svg/svgmarkerelement/markerheight/) { get; } | Belirtilen 'işaretçi' öğesindeki 'işaretçiYüksekliği' özniteliğine karşılık gelir. |
| [MarkerUnits](../../aspose.svg/svgmarkerelement/markerunits/) { get; } | Belirtilen 'işaretleyici' öğedeki 'işaretleyici Birimler' özniteliğine karşılık gelir. Bu arabirimde tanımlanan İşaretleyici Birim Türlerinden biri. |
| [MarkerWidth](../../aspose.svg/svgmarkerelement/markerwidth/) { get; } | Belirtilen 'marker' öğesinde 'markerWidth' özniteliğine karşılık gelir. |
...
| [OrientAngle](../../aspose.svg/svgmarkerelement/orientangle/) { get; } | Belirtilen 'işaretleyici' öğedeki 'orient' özelliğine karşılık gelir. markerUnits, SVG_MARKER_ORIENT_ANGLE ise, 'orient' niteliği için açı değeri; aksi takdirde, sıfıra ayarlanacaktır. |
| [OrientType](../../aspose.svg/svgmarkerelement/orienttype/) { get; } | Belirtilen 'işaretleyici' öğedeki 'orient' özelliğine karşılık gelir. Bu arabirimde tanımlanan İşaretçi Oryantasyon Türlerinden biri. |
...
| [PreserveAspectRatio](../../aspose.svg/svgmarkerelement/preserveaspectratio/) { get; } | Belirtilen öğede 'preserveAspectRatio' özniteliğine karşılık gelir. |
...
| [RefX](../../aspose.svg/svgmarkerelement/refx/) { get; } | Belirtilen 'işaretçi' öğesindeki 'refX' özniteliğine karşılık gelir. |
| [RefY](../../aspose.svg/svgmarkerelement/refy/) { get; } | Belirtilen 'işaretçi' öğesindeki 'refY' özniteliğine karşılık gelir. |
...
| [ViewBox](../../aspose.svg/svgmarkerelement/viewbox/) { get; } | Belirtilen öğede 'viewBox' özelliğine karşılık gelir. |
...
| [SetOrientToAngle](../../aspose.svg/svgmarkerelement/setorienttoangle/)(SVGAngle) | 'orient' özniteliğinin değerini verilen açıya ayarlar. |
| [SetOrientToAuto](../../aspose.svg/svgmarkerelement/setorienttoauto/)() | 'orient' özniteliğinin değerini 'auto' olarak ayarlar. |
...
| İsim | Tanım |
| --- | --- |
| const [SVG_MARKERUNITS_STROKEWIDTH](../../aspose.svg/svgmarkerelement/svg_markerunits_strokewidth/) | 'markerUnits' özelliğinin değeri 'strokeWidth'. |
| const [SVG_MARKERUNITS_UNKNOWN](../../aspose.svg/svgmarkerelement/svg_markerunits_unknown/) | İşaret birimi tipi önceden tanımlanmış tiplerden biri değil. Bu türde yeni bir değer tanımlamaya veya mevcut bir değeri bu türe değiştirmeye çalışmak geçersizdir. |
| const [SVG_MARKERUNITS_USERSPACEONUSE](../../aspose.svg/svgmarkerelement/svg_markerunits_userspaceonuse/) | 'markerUnits' özniteliğinin değeri 'userSpaceOnUse'dur. |
| const [SVG_MARKER_ORIENT_ANGLE](../../aspose.svg/svgmarkerelement/svg_marker_orient_angle/) | 'orient' özelliğinin bir açı değeri var. |
| const [SVG_MARKER_ORIENT_AUTO](../../aspose.svg/svgmarkerelement/svg_marker_orient_auto/) | 'orient' özelliğinin 'auto' değeri var. |
| const [SVG_MARKER_ORIENT_UNKNOWN](../../aspose.svg/svgmarkerelement/svg_marker_orient_unknown/) | İşaretçi yönü önceden tanımlanmış türlerden biri değil. Bu türde yeni bir değer tanımlamaya veya mevcut bir değeri bu türe değiştirmeye çalışmak geçersizdir. |
