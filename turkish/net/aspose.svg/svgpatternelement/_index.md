...
description: Aspose.Svg.SVGPatternElement sınıf. SVGPatternElement arabirimi pattern öğesine karşılık gelir.
type: docs
weight: 3380
url: /tr/net/aspose.svg/svgpatternelement/
---
...
| [Height](../../aspose.svg/svgpatternelement/height/) { get; } | Verilen 'desen' öğesindeki 'yükseklik' özelliğine karşılık gelir. |
| [Href](../../aspose.svg/svgpatternelement/href/) { get; } | Belirtilen öğede 'xlink:href' özelliğine karşılık gelir. |
...
| [PatternContentUnits](../../aspose.svg/svgpatternelement/patterncontentunits/) { get; } | Verilen 'pattern' öğesindeki 'patternContentUnits' özniteliğine karşılık gelir. SVGUnitTypes. içinde tanımlanan sabitlerden birini alır |
| [PatternTransform](../../aspose.svg/svgpatternelement/patterntransform/) { get; } | Verilen 'pattern' öğesinde 'patternTransform' özniteliğine karşılık gelir. |
| [PatternUnits](../../aspose.svg/svgpatternelement/patternunits/) { get; } | Verilen 'pattern' öğesindeki 'patternUnits' özniteliğine karşılık gelir. SVGUnitTypes. içinde tanımlanan sabitlerden birini alır |
...
| [PreserveAspectRatio](../../aspose.svg/svgpatternelement/preserveaspectratio/) { get; } | Belirtilen öğede 'preserveAspectRatio' özniteliğine karşılık gelir. |
...
| [RequiredExtensions](../../aspose.svg/svgpatternelement/requiredextensions/) { get; } | Belirtilen öğede 'requiredExtensions' özniteliğine karşılık gelir. |
| [RequiredFeatures](../../aspose.svg/svgpatternelement/requiredfeatures/) { get; } | Belirtilen öğede 'requiredFeatures' özniteliğine karşılık gelir. |
...
| [SystemLanguage](../../aspose.svg/svgpatternelement/systemlanguage/) { get; } | Verilen öğedeki 'systemLanguage' özniteliğine karşılık gelir. |
...
| [ViewBox](../../aspose.svg/svgpatternelement/viewbox/) { get; } | Belirtilen öğede 'viewBox' özelliğine karşılık gelir. |
...
| [Width](../../aspose.svg/svgpatternelement/width/) { get; } | Verilen 'desen' öğesindeki 'genişlik' özelliğine karşılık gelir. |
| [X](../../aspose.svg/svgpatternelement/x/) { get; } | Verilen 'kalıp' öğesindeki 'x' özniteliğine karşılık gelir. |
| [Y](../../aspose.svg/svgpatternelement/y/) { get; } | Verilen 'kalıp' öğesindeki 'y' özniteliğine karşılık gelir. |
