...
description: SVGPatternElement arabirimi pattern öğesine karşılık gelir.
type: docs
weight: 3330
...
| [Href](../../aspose.svg/svgpatternelement/href) { get; } | Verilen öğedeki 'xlink:href' özelliğine karşılık gelir. |
...
| [PatternContentUnits](../../aspose.svg/svgpatternelement/patterncontentunits) { get; } | Verilen 'pattern' öğesinde 'patternContentUnits' özniteliğine karşılık gelir. SVGUnitTypes. içinde tanımlanan sabitlerden birini alır |
| [PatternTransform](../../aspose.svg/svgpatternelement/patterntransform) { get; } | Verilen 'pattern' öğesindeki 'patternTransform' özniteliğine karşılık gelir. |
...
| [PreserveAspectRatio](../../aspose.svg/svgpatternelement/preserveaspectratio) { get; } | Verilen öğede 'preserveAspectRatio' özniteliğine karşılık gelir. |
...
| [RequiredExtensions](../../aspose.svg/svgpatternelement/requiredextensions) { get; } | Verilen öğede 'requiredExtensions' özniteliğine karşılık gelir. |
| [RequiredFeatures](../../aspose.svg/svgpatternelement/requiredfeatures) { get; } | Verilen öğede 'requiredFeatures' özniteliğine karşılık gelir. |
...
| [SystemLanguage](../../aspose.svg/svgpatternelement/systemlanguage) { get; } | Verilen öğede 'systemLanguage' özelliğine karşılık gelir. |
...
| [ViewBox](../../aspose.svg/svgpatternelement/viewbox) { get; } | Verilen öğedeki 'viewBox' özelliğine karşılık gelir. |
...
| [Width](../../aspose.svg/svgpatternelement/width) { get; } | Verilen 'desen' öğesindeki 'width' özniteliğine karşılık gelir. |
| [X](../../aspose.svg/svgpatternelement/x) { get; } | Verilen 'desen' öğesindeki 'x' özniteliğine karşılık gelir. |
| [Y](../../aspose.svg/svgpatternelement/y) { get; } | Verilen 'desen' öğesindeki 'y' özniteliğine karşılık gelir. |
