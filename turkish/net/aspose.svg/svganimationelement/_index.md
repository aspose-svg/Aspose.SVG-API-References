...
description: Aspose.Svg.SVGAnimationElement sınıf. SVGAnimationElement arabirimi tüm animasyon öğesi arabirimleri için temel arabirimdir SVGAnimateElement SVGSetElement SVGAnimateColorElement SVGAnimateMotionElement ve SVGAnimateTransformElement.
type: docs
weight: 3120
...
| [RequiredExtensions](../../aspose.svg/svganimationelement/requiredextensions/) { get; } | Belirtilen öğede 'requiredExtensions' özniteliğine karşılık gelir. |
| [RequiredFeatures](../../aspose.svg/svganimationelement/requiredfeatures/) { get; } | Belirtilen öğede 'requiredFeatures' özniteliğine karşılık gelir. |
...
| [SystemLanguage](../../aspose.svg/svganimationelement/systemlanguage/) { get; } | Verilen öğedeki 'systemLanguage' özniteliğine karşılık gelir. |
