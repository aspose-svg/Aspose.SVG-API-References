...
description: SVGAnimateElement arabirimi tüm animasyon öğesi arabirimleri için temel arabirimdir SVGAnimateElement SVGSetElement SVGAnimateColorElement SVGAnimateMotionElement ve SVGAnimateTransformElement.
type: docs
weight: 3070
url: /tr/net/aspose.svg/svganimationelement/
---
## SVGAnimationElement class

SVGAnimateElement arabirimi, tüm animasyon öğesi arabirimleri için temel arabirimdir: SVGAnimateElement, SVGSetElement, SVGAnimateColorElement, SVGAnimateMotionElement ve SVGAnimateTransformElement.
...
| [RequiredExtensions](../../aspose.svg/svganimationelement/requiredextensions) { get; } | Verilen öğede 'requiredExtensions' özniteliğine karşılık gelir. |
| [RequiredFeatures](../../aspose.svg/svganimationelement/requiredfeatures) { get; } | Verilen öğede 'requiredFeatures' özniteliğine karşılık gelir. |
...
| [SystemLanguage](../../aspose.svg/svganimationelement/systemlanguage) { get; } | Verilen öğede 'systemLanguage' özelliğine karşılık gelir. |
| [TagName](../../aspose.svg.dom/element/tagname) { get; } | Öğenin adı. |
| [TargetElement](../../aspose.svg/svganimationelement/targetelement) { get; } | Animasyon yapılan öğe. |
