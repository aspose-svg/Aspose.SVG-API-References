...
description: Aspose.Svg.SVGAnimateTransformElement sınıf. SVGAnimateTransformElement arabirimi animateTransform öğesine karşılık gelir. animateTransform öğesinin özniteliklerine SVG DOM aracılığıyla nesne yönelimli erişim mevcut değildir.
type: docs
weight: 3110
