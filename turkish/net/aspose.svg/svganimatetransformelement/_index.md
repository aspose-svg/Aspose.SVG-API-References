...
description: SVGAnimateTransformElement arabirimi animateTransform öğesine karşılık gelir. SVG DOM aracılığıyla animateTransform öğesinin özelliklerine nesne yönelimli erişim kullanılamaz.
type: docs
weight: 3060
url: /tr/net/aspose.svg/svganimatetransformelement/
---
## SVGAnimateTransformElement class

SVGAnimateTransformElement arabirimi, 'animateTransform' öğesine karşılık gelir. SVG DOM aracılığıyla 'animateTransform' öğesinin özelliklerine nesne yönelimli erişim kullanılamaz.
