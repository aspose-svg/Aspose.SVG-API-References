...
description: SVGRadialGradientElement arabirimi radialGradient öğesine karşılık gelir.
type: docs
weight: 3360
url: /tr/net/aspose.svg/svgradialgradientelement/
---
...
| [Cx](../../aspose.svg/svgradialgradientelement/cx) { get; } | Verilen 'radialGradient' öğesindeki 'cx' özniteliğine karşılık gelir. |
| [Cy](../../aspose.svg/svgradialgradientelement/cy) { get; } | Verilen 'radialGradient' öğesindeki 'cy' özniteliğine karşılık gelir. |
...
| [Fr](../../aspose.svg/svgradialgradientelement/fr) { get; } | Verilen 'radialGradient' öğesindeki 'fr' özniteliğine karşılık gelir. |
| [Fx](../../aspose.svg/svgradialgradientelement/fx) { get; } | Verilen 'radialGradient' öğesindeki 'fx' özniteliğine karşılık gelir. |
| [Fy](../../aspose.svg/svgradialgradientelement/fy) { get; } | Verilen 'radialGradient' öğesindeki 'fy' özniteliğine karşılık gelir. |
| [GradientTransform](../../aspose.svg/svggradientelement/gradienttransform) { get; } | Verilen öğede 'gradientTransform' özniteliğine karşılık gelir. |
| [GradientUnits](../../aspose.svg/svggradientelement/gradientunits) { get; } | Verilen öğedeki 'gradientUnits' özniteliğine karşılık gelir. SVGUnitTypes. içinde tanımlanan sabitlerden birini alır |
| [Href](../../aspose.svg/svggradientelement/href) { get; } | Verilen öğedeki 'xlink:href' özelliğine karşılık gelir. |
...
| [R](../../aspose.svg/svgradialgradientelement/r) { get; } | Verilen 'radialGradient' öğesindeki 'r' özniteliğine karşılık gelir. |
...
| [SpreadMethod](../../aspose.svg/svggradientelement/spreadmethod) { get; } | Verilen öğede 'spreadMethod' özniteliğine karşılık gelir. Bu arabirimde tanımlanan Yayılma Yöntemi Türlerinden biri. |
