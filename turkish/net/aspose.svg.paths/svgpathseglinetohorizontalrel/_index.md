...
description: Aspose.Svg.Paths.SVGPathSegLinetoHorizontalRel sınıf. SVGPathSegLinetoHorizontalRel arayüzü göreceli yatay çizgi h yol veri komutuna karşılık gelir.
type: docs
weight: 2630
url: /tr/net/aspose.svg.paths/svgpathseglinetohorizontalrel/
---
...
| [X](../../aspose.svg.paths/svgpathseglinetohorizontalrel/x/) { get; set; } | Bu yol bölümünün bitiş noktası için göreli X koordinatı. |
