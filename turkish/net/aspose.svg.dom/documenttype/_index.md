...
description: Aspose.Svg.Dom.DocumentType sınıf. DocumentType document için tanımlanan varlıkların listesine bir arabirim sağlar.
type: docs
weight: 830
...
| [InternalSubset](../../aspose.svg.dom/documenttype/internalsubset/) { get; } | Dizi olarak dahili altküme veya hiçbiri yoksa null. |
...
| override [NodeType](../../aspose.svg.dom/documenttype/nodetype/) { get; } | Altta yatan nesnenin türünü temsil eden bir kod. |
...
| override [ToString](../../aspose.svg.dom/documenttype/tostring/)() | a döndürürString bu örneği temsil eder. |
