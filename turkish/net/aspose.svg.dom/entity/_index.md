...
description: Bir XML belgesinde ayrıştırılmış veya ayrıştırılmamış bilinen bir varlığı temsil eder.
type: docs
weight: 850
...
Bir XML belgesinde ayrıştırılmış veya ayrıştırılmamış bilinen bir varlığı temsil eder.
...
| [InputEncoding](../../aspose.svg.dom/entity/inputencoding) { get; } | Harici bir ayrıştırılmış varlık olduğunda, ayrıştırma sırasında bu varlık için kullanılan kodlamayı belirten bir öznitelik. Bu, dahili alt kümeden bir varlıksa veya bilinmiyorsa boştur. |
...
| override [NodeType](../../aspose.svg.dom/entity/nodetype) { get; } | Temel alınan nesnenin türünü temsil eden bir kod. |
| virtual [NodeValue](../../aspose.svg.dom/node/nodevalue) { get; set; } | Türüne bağlı olarak bu düğümün değeri. |
| [NotationName](../../aspose.svg.dom/entity/notationname) { get; } | Ayrıştırılmamış varlıklar için, varlığın gösteriminin adı. Ayrıştırılan varlıklar için bu, null. |
...
| [PublicId](../../aspose.svg.dom/entity/publicid) { get; } | Belirtilmişse varlıkla ilişkili genel tanımlayıcı, aksi takdirde null. |
| [SystemId](../../aspose.svg.dom/entity/systemid) { get; } | Belirtilmişse varlıkla ilişkili sistem tanımlayıcısı, aksi takdirde null. Bu mutlak bir URI olabilir veya olmayabilir. |
...
| [XmlEncoding](../../aspose.svg.dom/entity/xmlencoding) { get; } | Metin bildiriminin bir parçası olarak, harici bir ayrıştırılmış varlık olduğunda bu varlığın kodlamasını belirten bir öznitelik. Aksi takdirde bu boştur. |
| [XmlVersion](../../aspose.svg.dom/entity/xmlversion) { get; } | Metin bildiriminin bir parçası olarak, harici bir ayrıştırılmış varlık olduğunda bu varlığın sürüm numarasını belirten bir öznitelik. Aksi takdirde bu boştur. |
