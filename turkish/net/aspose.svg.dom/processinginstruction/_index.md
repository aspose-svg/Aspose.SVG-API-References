...
description: Aspose.Svg.Dom.ProcessingInstruction sınıf. ProcessingInstruction XMLde işlemciye özgü bilgileri belge metninde tutmanın bir yolu olarak kullanılan bir işleme yönergesini temsil eder.
type: docs
weight: 1170
url: /tr/net/aspose.svg.dom/processinginstruction/
---
...
| override [NodeName](../../aspose.svg.dom/processinginstruction/nodename/) { get; } | Türüne bağlı olarak bu düğümün adı. |
| override [NodeType](../../aspose.svg.dom/processinginstruction/nodetype/) { get; } | Altta yatan nesnenin türünü temsil eden bir kod. |
| override [NodeValue](../../aspose.svg.dom/processinginstruction/nodevalue/) { get; set; } | Türüne bağlı olarak bu düğümün değeri. |
