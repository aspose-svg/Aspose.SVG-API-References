...
description: ProcessingInstruction XMLde işlemciye özgü bilgileri belge metninde tutmanın bir yolu olarak kullanılan bir işleme talimatını temsil eder.
type: docs
weight: 1170
...
ProcessingInstruction, XML'de işlemciye özgü bilgileri belge metninde tutmanın bir yolu olarak kullanılan bir "işleme talimatını" temsil eder.
...
| override [NodeType](../../aspose.svg.dom/processinginstruction/nodetype) { get; } | Temel alınan nesnenin türünü temsil eden bir kod. |
