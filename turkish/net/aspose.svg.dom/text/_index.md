...
description: Metin arabirimi CharacterData öğesinden miras alır ve bir Öğenin veya Attrnin metin içeriğini XMLde karakter verileri olarak adlandırılır temsil eder.
type: docs
weight: 1200
...
Metin arabirimi, CharacterData öğesinden miras alır ve bir Öğenin veya Attr'nin metin içeriğini (XML'de karakter verileri olarak adlandırılır) temsil eder.
...
| override [NodeType](../../aspose.svg.dom/text/nodetype) { get; } | Temel alınan nesnenin türünü temsil eden bir kod. |
