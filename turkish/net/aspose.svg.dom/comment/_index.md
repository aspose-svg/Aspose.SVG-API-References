...
description: Aspose.Svg.Dom.Comment sınıf. CharacterDatadan devralır ve bir yorumun içeriğini temsil eder yani  ile başlayan arasındaki tüm karakterler .
type: docs
weight: 460
url: /tr/net/aspose.svg.dom/comment/
---
## Comment class
...
| override [NodeName](../../aspose.svg.dom/comment/nodename/) { get; } | Türüne bağlı olarak bu düğümün adı. |
| override [NodeType](../../aspose.svg.dom/comment/nodetype/) { get; } | Altta yatan nesnenin türünü temsil eden bir kod. |
| override [NodeValue](../../aspose.svg.dom/comment/nodevalue/) { get; set; } | Türüne bağlı olarak bu düğümün değeri. |
