...
description: CharacterData öğesinden devralır ve bir yorumun içeriğini yani başlangıç  ile arasındaki tüm karakterleri temsil eder. .
type: docs
weight: 460
...
CharacterData öğesinden devralır ve bir yorumun içeriğini, yani başlangıç ' ile arasındaki tüm karakterleri temsil eder. .
...
| override [NodeType](../../aspose.svg.dom/comment/nodetype) { get; } | Temel alınan nesnenin türünü temsil eden bir kod. |
