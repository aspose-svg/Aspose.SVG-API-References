...
description: DTDde bildirilen bir gösterimi temsil eder.
type: docs
weight: 1160
url: /tr/net/aspose.svg.dom/notation/
---
## Notation class

DTD'de bildirilen bir gösterimi temsil eder.
...
| override [NodeName](../../aspose.svg.dom/notation/nodename) { get; } | Türüne bağlı olarak bu düğümün adı. |
| override [NodeType](../../aspose.svg.dom/notation/nodetype) { get; } | Temel alınan nesnenin türünü temsil eden bir kod. |
...
| [PublicId](../../aspose.svg.dom/notation/publicid) { get; } | Bu gösterimin genel tanımlayıcısı. Genel tanımlayıcı belirtilmemişse, bu null. |
| [SystemId](../../aspose.svg.dom/notation/systemid) { get; } | Bu gösterimin sistem tanımlayıcısı. Sistem tanımlayıcısı belirtilmemişse, bu boştur. Bu mutlak bir URI olabilir veya olmayabilir. |
