...
description: Aspose.Svg.Dom.Element sınıf. Öğe arabirimi bir HTML veya XML belgesindeki bir öğeyi temsil eder.
type: docs
weight: 840
...
| [Id](../../aspose.svg.dom/element/id/) { get; set; } | Öğenin tanımlayıcısı. HTML 4.01. 'deki id niteliği tanımına bakın |
...
| [ParentElement](../../aspose.svg.dom/node/parentelement/) { get; } | Ebeveyni alır`Element` bu düğümün. |
