...
description: Öğe arayüzü bir HTML veya XML belgesindeki bir öğeyi temsil eder.
type: docs
weight: 840
url: /tr/net/aspose.svg.dom/element/
---
## Element class
...
| İsim | Tanım |
| --- | --- |
| [Element](element)(IElementInit) | Yeni bir örneğini başlatır[`Element`](../element)sınıf. Bu kurucuyu doğrudan aramayın, kullanın[`CreateElement`](../document/createelement) veya[`CreateElementNS`](../document/createelementns) . |
...
| [Id](../../aspose.svg.dom/element/id) { get; set; } | Öğenin tanımlayıcısı. HTML 4.01. 'deki id özelliği tanımına bakın |
