...
description: EntityReference düğümleri ağaçta bir varlık referansını temsil etmek için kullanılabilir.
type: docs
weight: 860
...
| override [NodeType](../../aspose.svg.dom/entityreference/nodetype) { get; } | Temel alınan nesnenin türünü temsil eden bir kod. |
