...
description: Aspose.Svg.Dom.EntityReference sınıf. EntityReference düğümleri ağaçta bir varlık referansını temsil etmek için kullanılabilir.
type: docs
weight: 860
url: /tr/net/aspose.svg.dom/entityreference/
---
...
| override [NodeName](../../aspose.svg.dom/entityreference/nodename/) { get; } | Türüne bağlı olarak bu düğümün adı. |
| override [NodeType](../../aspose.svg.dom/entityreference/nodetype/) { get; } | Altta yatan nesnenin türünü temsil eden bir kod. |
