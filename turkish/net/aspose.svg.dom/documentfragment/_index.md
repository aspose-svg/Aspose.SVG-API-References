...
description: Aspose.Svg.Dom.DocumentFragment sınıf. DocumentFragment hafif veya minimum bir Belge nesnesidir. Bir belge ağacının bir bölümünü ayıklayabilmek veya bir belgenin yeni bir parçasını oluşturmak istemek çok yaygın bir durumdur.
type: docs
weight: 820
