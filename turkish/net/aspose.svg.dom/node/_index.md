...
description: Aspose.Svg.Dom.Node sınıf. Düğüm arabirimi tüm Belge nesnesi Modeli için birincil veri türüdür. Belge ağacında tek bir düğümü temsil eder.
type: docs
weight: 1150
url: /tr/net/aspose.svg.dom/node/
---
## Node class
...
| abstract [NodeType](../../aspose.svg.dom/node/nodetype/) { get; } | Altta yatan nesnenin türünü temsil eden bir kod. |
...
| [CloneNode](../../aspose.svg.dom/node/clonenode/#clonenode)() | Bu düğümün bir kopyasını döndürür, yani düğümler için genel bir kopya oluşturucu görevi görür. Yinelenen düğümün üst öğesi (parentNode boştur) ve kullanıcı verisi yoktur. |
| [CloneNode](../../aspose.svg.dom/node/clonenode/#clonenode_1)(bool) | Bu düğümün bir kopyasını döndürür, yani düğümler için genel bir kopya oluşturucu görevi görür. Yinelenen düğümün üst öğesi (parentNode boştur) ve kullanıcı verisi yoktur. |
...
| İsim | Tanım |
| --- | --- |
| const [ATTRIBUTE_NODE](../../aspose.svg.dom/node/attribute_node/) | Bir öznitelik node |
| const [CDATA_SECTION_NODE](../../aspose.svg.dom/node/cdata_section_node/) | Bir cdata bölümü node |
| const [COMMENT_NODE](../../aspose.svg.dom/node/comment_node/) | Bir yorum düğümü |
| const [DOCUMENT_FRAGMENT_NODE](../../aspose.svg.dom/node/document_fragment_node/) | Bir belge parçası node |
| const [DOCUMENT_NODE](../../aspose.svg.dom/node/document_node/) | Bir belge düğümü |
| const [DOCUMENT_TYPE_NODE](../../aspose.svg.dom/node/document_type_node/) | Bir belge türü node |
| const [ELEMENT_NODE](../../aspose.svg.dom/node/element_node/) | Bir öğe node |
| const [ENTITY_NODE](../../aspose.svg.dom/node/entity_node/) | Bir varlık node |
| const [ENTITY_REFERENCE_NODE](../../aspose.svg.dom/node/entity_reference_node/) | Bir varlık referans düğümü |
| const [NOTATION_NODE](../../aspose.svg.dom/node/notation_node/) | Bir gösterim düğümü |
| const [PROCESSING_INSTRUCTION_NODE](../../aspose.svg.dom/node/processing_instruction_node/) | Bir işleme talimatı node |
| const [TEXT_NODE](../../aspose.svg.dom/node/text_node/) | Bir metin düğümü |
