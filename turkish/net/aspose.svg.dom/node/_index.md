...
description: Düğüm arabirimi tüm Document nesne Modeli için birincil veri türüdür. Belge ağacındaki tek bir düğümü temsil eder.
type: docs
weight: 1150
...
Düğüm arabirimi, tüm Document nesne Modeli için birincil veri türüdür. Belge ağacındaki tek bir düğümü temsil eder.
...
| [CloneNode](../../aspose.svg.dom/node/clonenode#clonenode)() | Bu düğümün bir kopyasını döndürür, yani düğümler için genel bir kopya oluşturucu görevi görür. Yinelenen düğümün üst öğesi yok (parentNode null) ve kullanıcı verisi yok. |
| [CloneNode](../../aspose.svg.dom/node/clonenode#clonenode_1)(bool) | Bu düğümün bir kopyasını döndürür, yani düğümler için genel bir kopya oluşturucu görevi görür. Yinelenen düğümün üst öğesi yok (parentNode null) ve kullanıcı verisi yok. |
...
| İsim | Tanım |
| --- | --- |
| const [ATTRIBUTE_NODE](../../aspose.svg.dom/node/attribute_node) | Bir öznitelik düğümü |
| const [CDATA_SECTION_NODE](../../aspose.svg.dom/node/cdata_section_node) | Bir cdata bölümü düğümü |
| const [COMMENT_NODE](../../aspose.svg.dom/node/comment_node) | Bir yorum düğümü |
| const [DOCUMENT_FRAGMENT_NODE](../../aspose.svg.dom/node/document_fragment_node) | Bir belge parçası düğümü |
| const [DOCUMENT_NODE](../../aspose.svg.dom/node/document_node) | Bir belge düğümü |
| const [DOCUMENT_TYPE_NODE](../../aspose.svg.dom/node/document_type_node) | Belge türü düğümü |
| const [ELEMENT_NODE](../../aspose.svg.dom/node/element_node) | Bir öğe düğümü |
| const [ENTITY_NODE](../../aspose.svg.dom/node/entity_node) | Bir varlık düğümü |
| const [ENTITY_REFERENCE_NODE](../../aspose.svg.dom/node/entity_reference_node) | Bir varlık referansı düğümü |
| const [NOTATION_NODE](../../aspose.svg.dom/node/notation_node) | Bir gösterim düğümü |
| const [PROCESSING_INSTRUCTION_NODE](../../aspose.svg.dom/node/processing_instruction_node) | Bir işleme talimatı düğümü |
