...
| [IsId](../../aspose.svg.dom/attr/isid) { get; } | Bu özniteliğin tür kimliği olduğunun bilinip bilinmediğini (yani sahip öğesi için bir tanımlayıcı içerdiği) döndürür. |
| [LastChild](../../aspose.svg.dom/node/lastchild) { get; } | Bu düğümün son çocuğu. Böyle bir düğüm yoksa, bu null. değerini döndürür. |
| override [LocalName](../../aspose.svg.dom/attr/localname) { get; } | Bu düğümün nitelikli adının yerel bölümünü döndürür. ELEMENT_NODE ve ATTRIBUTE_NODE dışındaki herhangi bir türdeki düğümler ve Document.createElement() gibi bir DOM Düzey 1 yöntemiyle oluşturulan düğümler için bu her zaman null. |
| [Name](../../aspose.svg.dom/attr/name) { get; } | Bu özelliğin adını döndürür. |
| override [NamespaceURI](../../aspose.svg.dom/attr/namespaceuri) { get; } | Bu düğümün ad alanı URI'si veya belirtilmemişse null. |
...
| override [NodeType](../../aspose.svg.dom/attr/nodetype) { get; } | Temel alınan nesnenin türünü temsil eden bir kod. |
...
| override [Prefix](../../aspose.svg.dom/attr/prefix) { get; } | Bu düğümün ad alanı öneki veya belirtilmemişse null. Null olarak tanımlandığında, ayarın hiçbir etkisi yoktur |
...
| [Specified](../../aspose.svg.dom/attr/specified) { get; } | Bu özniteliğe örnek belgesinde açıkça bir değer verilmişse true, aksi takdirde false. |
...
| [Value](../../aspose.svg.dom/attr/value) { get; set; } | Geri alındığında, özniteliğin değeri bir dize olarak döndürülür. |
