...
description: Aspose.Svg.Dom.Attr sınıf. Attr arabirimi bir Element nesnesindeki bir özniteliği temsil eder. Tipik olarak öznitelik için izin verilen değerler belgeyle ilişkili bir şemada tanımlanır.
type: docs
weight: 350
url: /tr/net/aspose.svg.dom/attr/
---
## Attr class
...
| [IsId](../../aspose.svg.dom/attr/isid/) { get; } | Bu özniteliğin kimlik türünde olduğunun bilinip bilinmediğini (yani sahip öğesi için bir tanımlayıcı içermesi) olup olmadığını döndürür. |
| [LastChild](../../aspose.svg.dom/node/lastchild/) { get; } | Bu düğümün son çocuğu. Böyle bir düğüm yoksa bu, null. değerini döndürür. |
| override [LocalName](../../aspose.svg.dom/attr/localname/) { get; } | Bu düğümün nitelikli adının yerel kısmını döndürür. ELEMENT_NODE ve ATTRIBUTE_NODE dışındaki herhangi bir türdeki düğümler ve Document.createElement() gibi DOM Düzey 1 yöntemiyle oluşturulan düğümler için bu her zaman boştur. |
| [Name](../../aspose.svg.dom/attr/name/) { get; } | Bu özniteliğin adını döndürür. |
| override [NamespaceURI](../../aspose.svg.dom/attr/namespaceuri/) { get; } | Bu düğümün ad alanı URI'si veya belirtilmemişse boş. |
...
| override [NodeName](../../aspose.svg.dom/attr/nodename/) { get; } | Türüne bağlı olarak bu düğümün adı. |
| override [NodeType](../../aspose.svg.dom/attr/nodetype/) { get; } | Altta yatan nesnenin türünü temsil eden bir kod. |
| override [NodeValue](../../aspose.svg.dom/attr/nodevalue/) { get; set; } | Türüne bağlı olarak bu düğümün değeri. |
...
| [OwnerElement](../../aspose.svg.dom/attr/ownerelement/) { get; } | Bu özniteliğin eklendiği Öğe düğümü veya bu öznitelik kullanımda değilse boş. |
...
| override [Prefix](../../aspose.svg.dom/attr/prefix/) { get; } | Bu düğümün ad alanı öneki veya belirtilmemişse boş. Boş olarak tanımlandığında, ayarının etkisi yoktur |
...
| [SchemaTypeInfo](../../aspose.svg.dom/attr/schematypeinfo/) { get; } | Bu öznitelikle ilişkili tür bilgisi. |
| [Specified](../../aspose.svg.dom/attr/specified/) { get; } | Bu özniteliğe örnek belgede açıkça bir değer verildiyse doğrudur, aksi takdirde yanlıştır. |
| override [TextContent](../../aspose.svg.dom/attr/textcontent/) { get; set; } | Bu öznitelik, bu düğümün ve onun soyundan gelenlerin metin içeriğini döndürür. Null olarak tanımlandığında, ayarının hiçbir etkisi yoktur. Ayarlama sırasında, bu düğümün sahip olabileceği tüm olası alt öğeler kaldırılır ve yeni dize boş veya boş değilse, bu özniteliğin ayarlandığı dizeyi içeren tek bir Metin düğümü ile değiştirilir. |
| [Value](../../aspose.svg.dom/attr/value/) { get; set; } | Alma sırasında özniteliğin değeri bir dize olarak döndürülür. |
