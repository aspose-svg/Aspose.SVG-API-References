...
description: Aspose.Svg.Dom.CDATASection sınıf. CDATA bölümleri normalde biçimlendirme olarak kabul edilecek karakterleri içeren metin bloklarından kaçmak için kullanılır.
type: docs
weight: 440
...
| override [NodeType](../../aspose.svg.dom/cdatasection/nodetype/) { get; } | Altta yatan nesnenin türünü temsil eden bir kod. |
