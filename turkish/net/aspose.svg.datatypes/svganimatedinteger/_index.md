...
description: Hareket ettirilebilen temel tür tamsayı öznitelikleri için kullanılır.
type: docs
weight: 120
url: /tr/net/aspose.svg.datatypes/svganimatedinteger/
---
## SVGAnimatedInteger class

Hareket ettirilebilen temel tür tamsayı öznitelikleri için kullanılır.
...
| override [ToString](../../aspose.svg.datatypes/svganimatedinteger/tostring)() | Bir döndürürString bu, bu örneği temsil eder. |
