...
description: Aspose.Svg.DataTypes.SVGAnimatedRect sınıf. Animasyonlu olabilen SVGRect tipi öznitelikler için kullanılır.
type: docs
weight: 180
...
Animasyonlu olabilen SVGRect tipi öznitelikler için kullanılır.
...
| override [ToString](../../aspose.svg.datatypes/svganimatedrect/tostring/)() | a döndürürString bu örneği temsil eder. |
