...
description: Aspose.Svg.DataTypes.SVGAnimatedNumberList sınıf. Bir sayı listesi alan ve canlandırılabilen nitelikler için kullanılır.
type: docs
weight: 160
...
Bir sayı listesi alan ve canlandırılabilen nitelikler için kullanılır.
...
| override [ToString](../../aspose.svg.datatypes/svganimatednumberlist/tostring/)() | a döndürürString bu örneği temsil eder. |
