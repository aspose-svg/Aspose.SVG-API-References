...
description: Hareket ettirilebilen temel veri türü açısının nitelikleri için kullanılır.
type: docs
weight: 90
url: /tr/net/aspose.svg.datatypes/svganimatedangle/
---
## SVGAnimatedAngle class

Hareket ettirilebilen temel veri türü açısının nitelikleri için kullanılır.
...
| override [ToString](../../aspose.svg.datatypes/svganimatedangle/tostring)() | Bir döndürürString bu, bu örneği temsil eder. |
