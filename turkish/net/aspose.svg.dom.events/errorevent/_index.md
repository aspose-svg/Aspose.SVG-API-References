...
description: ErrorEvent./errorevent çalışma zamanı sırasında meydana gelen hatalar hakkında bağlamsal bilgi sağlar.
type: docs
weight: 910
...
| İsim | Tanım |
| --- | --- |
| [ErrorEvent](errorevent#constructor_1)(Exception) | Yeni bir örneğini başlatır[`ErrorEvent`](../errorevent) sınıf. |
| [ErrorEvent](errorevent#constructor)(IDictionary&lt;string, object&gt;) | Yeni bir örneğini başlatır[`ErrorEvent`](../errorevent) sınıf. |
