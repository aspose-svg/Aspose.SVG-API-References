...
description: UIEvent arabirimi Kullanıcı Arabirimi olaylarıyla ilişkili belirli bağlamsal bilgiler sağlar.
type: docs
weight: 1000
...
| İsim | Tanım |
| --- | --- |
| [UIEvent](uievent#constructor)(string) | Yeni bir örneğini başlatır[`UIEvent`](../uievent) sınıf. |
| [UIEvent](uievent#constructor_1)(string, IDictionary&lt;string, object&gt;) | Yeni bir örneğini başlatır[`UIEvent`](../uievent) sınıf. |
