...
description: Aspose.Svg.Dom.Events.InputEvent sınıf. Giriş olayları DOM her güncellendiğinde bildirim olarak gönderilir.
type: docs
weight: 970
...
| [IsComposing](../../aspose.svg.dom.events/inputevent/iscomposing/) { get; } | true girdi olayı bir kompozisyon oturumunun parçası olarak, yani bir kompozisyon başlangıcı olayından sonra ve ilgili kompozisyon bitiş olayından önce meydana geliyorsa. Bu özelliğin başlatılmamış değeri false. OLMALIDIR |
