...
description: Aspose.Svg.Paths.SVGPathSegLinetoHorizontalAbs 수업. SVGPathSegLinetoHorizontalAbs 인터페이스는 absolute horizontal linetoH 경로 데이터 명령에 해당합니다.
type: docs
weight: 2620
url: /ko/net/aspose.svg.paths/svgpathseglinetohorizontalabs/
---
...
| [X](../../aspose.svg.paths/svgpathseglinetohorizontalabs/x/) { get; set; } | 이 경로 세그먼트의 끝점에 대한 절대 X 좌표입니다. |
