...
description: Aspose.Svg.Paths.SVGPathSegCurvetoQuadraticSmoothRel 수업. SVGPathSegCurvetoQuadraticSmoothRel 인터페이스는 relative smooth cubic curvetot 경로 데이터 명령에 해당합니다.
type: docs
weight: 2600
url: /ko/net/aspose.svg.paths/svgpathsegcurvetoquadraticsmoothrel/
---
...
| [X](../../aspose.svg.paths/svgpathsegcurvetoquadraticsmoothrel/x/) { get; set; } | 이 경로 세그먼트의 끝점에 대한 상대 X 좌표입니다. |
| [Y](../../aspose.svg.paths/svgpathsegcurvetoquadraticsmoothrel/y/) { get; set; } | 이 경로 세그먼트의 끝점에 대한 상대 Y 좌표입니다. |
