...
description: Aspose.Svg.Paths.SVGPathSegLinetoAbs 수업. SVGPathSegLinetoAbs 인터페이스는 absolute linetoL 경로 데이터 명령에 해당합니다.
type: docs
weight: 2610
url: /ko/net/aspose.svg.paths/svgpathseglinetoabs/
---
...
| [X](../../aspose.svg.paths/svgpathseglinetoabs/x/) { get; set; } | 이 경로 세그먼트의 끝점에 대한 절대 X 좌표입니다. |
| [Y](../../aspose.svg.paths/svgpathseglinetoabs/y/) { get; set; } | 이 경로 세그먼트의 끝점에 대한 절대 Y 좌표입니다. |
