...
description: Aspose.Svg.Paths.SVGPathSegLinetoVerticalAbs 수업. SVGPathSegLinetoVerticalAbs 인터페이스는 absolute vertical linetoV 경로 데이터 명령에 해당합니다.
type: docs
weight: 2650
url: /ko/net/aspose.svg.paths/svgpathseglinetoverticalabs/
---
...
| [Y](../../aspose.svg.paths/svgpathseglinetoverticalabs/y/) { get; set; } | 이 경로 세그먼트의 끝점에 대한 절대 Y 좌표입니다. |
