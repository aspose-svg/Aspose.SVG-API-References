...
description: Aspose.Svg.Paths.SVGPathSegLinetoVerticalRel 수업. SVGPathSegLinetoVerticalRel 인터페이스는 상대 수직선v 경로 데이터 명령에 해당합니다.
type: docs
weight: 2660
url: /ko/net/aspose.svg.paths/svgpathseglinetoverticalrel/
---
...
| [Y](../../aspose.svg.paths/svgpathseglinetoverticalrel/y/) { get; set; } | 이 경로 세그먼트의 끝점에 대한 상대 Y 좌표입니다. |
