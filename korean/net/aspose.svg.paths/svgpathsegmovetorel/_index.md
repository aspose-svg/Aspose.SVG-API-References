...
description: Aspose.Svg.Paths.SVGPathSegMovetoRel 수업. SVGPathSegMovetoRel 인터페이스는 상대 이동m 경로 데이터 명령에 해당합니다.
type: docs
weight: 2690
url: /ko/net/aspose.svg.paths/svgpathsegmovetorel/
---
...
| [X](../../aspose.svg.paths/svgpathsegmovetorel/x/) { get; set; } | 이 경로 세그먼트의 끝점에 대한 상대 X 좌표입니다. |
| [Y](../../aspose.svg.paths/svgpathsegmovetorel/y/) { get; set; } | 이 경로 세그먼트의 끝점에 대한 상대 Y 좌표입니다. |
