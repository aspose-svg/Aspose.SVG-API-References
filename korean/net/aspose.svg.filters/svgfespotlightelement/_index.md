...
description: Aspose.Svg.Filters.SVGFESpotLightElement 수업. SVGFESpotLightElement 인터페이스는 feSpotLight 요소에 해당합니다.
type: docs
weight: 1870
url: /ko/net/aspose.svg.filters/svgfespotlightelement/
---
...
| [LimitingConeAngle](../../aspose.svg.filters/svgfespotlightelement/limitingconeangle/) { get; } | 지정된 'feSpotLight' 요소의 'limitingConeAngle' 속성에 해당합니다. |
...
| [PointsAtX](../../aspose.svg.filters/svgfespotlightelement/pointsatx/) { get; } | 지정된 'feSpotLight' 요소의 'pointsAtX' 속성에 해당합니다. |
| [PointsAtY](../../aspose.svg.filters/svgfespotlightelement/pointsaty/) { get; } | 지정된 'feSpotLight' 요소의 'pointsAtY' 속성에 해당합니다. |
| [PointsAtZ](../../aspose.svg.filters/svgfespotlightelement/pointsatz/) { get; } | 지정된 'feSpotLight' 요소의 'pointsAtZ' 속성에 해당합니다. |
...
| [SpecularExponent](../../aspose.svg.filters/svgfespotlightelement/specularexponent/) { get; } | 지정된 'feSpotLight' 요소의 'specularExponent' 속성에 해당합니다. |
...
| [X](../../aspose.svg.filters/svgfespotlightelement/x/) { get; } | 지정된 'feSpotLight' 요소의 속성 'x'에 해당합니다. |
| [Y](../../aspose.svg.filters/svgfespotlightelement/y/) { get; } | 지정된 'feSpotLight' 요소의 속성 'y'에 해당합니다. |
| [Z](../../aspose.svg.filters/svgfespotlightelement/z/) { get; } | 지정된 'feSpotLight' 요소의 속성 'z'에 해당합니다. |
