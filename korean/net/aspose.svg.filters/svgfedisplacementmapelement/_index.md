...
description: Aspose.Svg.Filters.SVGFEDisplacementMapElement 수업. SVGFEDisplacementMapElement 인터페이스는 feDisplacementMap 요소에 해당합니다.
type: docs
weight: 1710
url: /ko/net/aspose.svg.filters/svgfedisplacementmapelement/
---
...
| [Height](../../aspose.svg.filters/svgfedisplacementmapelement/height/) { get; } | 지정된 '필터' 요소의 '높이' 속성에 해당합니다. |
| [Id](../../aspose.svg/svgelement/id/) { get; set; } | 주어진 요소의 'id' 속성 값 또는 'id'가 없으면 빈 문자열. |
| [In1](../../aspose.svg.filters/svgfedisplacementmapelement/in1/) { get; } | 지정된 'feDisplacementMap' 요소의 속성 'in'에 해당합니다. |
| [In2](../../aspose.svg.filters/svgfedisplacementmapelement/in2/) { get; } | 지정된 'feDisplacementMap' 요소의 속성 'in2'에 해당합니다. |
...
| [Result](../../aspose.svg.filters/svgfedisplacementmapelement/result/) { get; } | 지정된 '필터' 요소의 '결과' 속성에 해당합니다. |
| [Scale](../../aspose.svg.filters/svgfedisplacementmapelement/scale/) { get; } | 지정된 'feDisplacementMap' 요소의 'scale' 속성에 해당합니다. |
...
| [Width](../../aspose.svg.filters/svgfedisplacementmapelement/width/) { get; } | 지정된 '필터' 요소의 '너비' 속성에 해당합니다. |
| [X](../../aspose.svg.filters/svgfedisplacementmapelement/x/) { get; } | 지정된 '필터' 요소의 속성 'x'에 해당합니다. |
| [XChannelSelector](../../aspose.svg.filters/svgfedisplacementmapelement/xchannelselector/) { get; } | 지정된 'feDisplacementMap' 요소의 'xChannelSelector' 속성에 해당합니다. 이 인터페이스에 정의된 SVG_CHANNEL_* 상수 중 하나를 사용합니다. |
| [Y](../../aspose.svg.filters/svgfedisplacementmapelement/y/) { get; } | 지정된 '필터' 요소의 속성 'y'에 해당합니다. |
| [YChannelSelector](../../aspose.svg.filters/svgfedisplacementmapelement/ychannelselector/) { get; } | 지정된 'feDisplacementMap' 요소의 'yChannelSelector' 속성에 해당합니다. 이 인터페이스에 정의된 SVG_CHANNEL_* 상수 중 하나를 사용합니다. |
...
| 이름 | 설명 |
| --- | --- |
| const [SVG_CHANNEL_A](../../aspose.svg.filters/svgfedisplacementmapelement/svg_channel_a/) | 값 'A'에 해당합니다. |
| const [SVG_CHANNEL_B](../../aspose.svg.filters/svgfedisplacementmapelement/svg_channel_b/) | 값 'B'에 해당합니다. |
| const [SVG_CHANNEL_G](../../aspose.svg.filters/svgfedisplacementmapelement/svg_channel_g/) | 값 'G'에 해당합니다. |
| const [SVG_CHANNEL_R](../../aspose.svg.filters/svgfedisplacementmapelement/svg_channel_r/) | 값 'R'에 해당합니다. |
| const [SVG_CHANNEL_UNKNOWN](../../aspose.svg.filters/svgfedisplacementmapelement/svg_channel_unknown/) | 유형이 미리 정의된 유형 중 하나가 아닙니다. 이 유형의 새 값을 정의하거나 기존 값을 이 유형으로 전환하려는 시도는 유효하지 않습니다. |
