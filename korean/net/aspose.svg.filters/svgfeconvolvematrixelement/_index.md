...
description: Aspose.Svg.Filters.SVGFEConvolveMatrixElement 수업. SVGFEConvolveMatrixElement 인터페이스는 feConvolveMatrix 요소에 해당합니다.
type: docs
weight: 1690
url: /ko/net/aspose.svg.filters/svgfeconvolvematrixelement/
---
...
| [Bias](../../aspose.svg.filters/svgfeconvolvematrixelement/bias/) { get; } | 지정된 'feConvolveMatrix' 요소의 'bias' 속성에 해당합니다. |
...
| [Divisor](../../aspose.svg.filters/svgfeconvolvematrixelement/divisor/) { get; } | 지정된 'feConvolveMatrix' 요소의 'divisor' 속성에 해당합니다. |
| [EdgeMode](../../aspose.svg.filters/svgfeconvolvematrixelement/edgemode/) { get; } | 지정된 'feConvolveMatrix' 요소의 'edgeMode' 속성에 해당합니다. |
...
| [Height](../../aspose.svg.filters/svgfeconvolvematrixelement/height/) { get; } | 지정된 '필터' 요소의 '높이' 속성에 해당합니다. |
| [Id](../../aspose.svg/svgelement/id/) { get; set; } | 주어진 요소의 'id' 속성 값 또는 'id'가 없으면 빈 문자열. |
| [In1](../../aspose.svg.filters/svgfeconvolvematrixelement/in1/) { get; } | 지정된 'feConvolveMatrix' 요소의 속성 'in'에 해당합니다. |
...
| [KernelMatrix](../../aspose.svg.filters/svgfeconvolvematrixelement/kernelmatrix/) { get; } | 지정된 'feConvolveMatrix' 요소의 'kernelMatrix' 속성에 해당합니다. |
| [KernelUnitLengthX](../../aspose.svg.filters/svgfeconvolvematrixelement/kernelunitlengthx/) { get; } | 지정된 'feConvolveMatrix' 요소의 'kernelUnitLength' 속성에 해당합니다. |
| [KernelUnitLengthY](../../aspose.svg.filters/svgfeconvolvematrixelement/kernelunitlengthy/) { get; } | 지정된 'feConvolveMatrix' 요소의 'kernelUnitLength' 속성에 해당합니다. |
...
| [OrderX](../../aspose.svg.filters/svgfeconvolvematrixelement/orderx/) { get; } | 지정된 'feConvolveMatrix' 요소의 'order' 속성에 해당합니다. |
| [OrderY](../../aspose.svg.filters/svgfeconvolvematrixelement/ordery/) { get; } | 지정된 'feConvolveMatrix' 요소의 'order' 속성에 해당합니다. |
...
| [PreserveAlpha](../../aspose.svg.filters/svgfeconvolvematrixelement/preservealpha/) { get; } | 지정된 'feConvolveMatrix' 요소의 'preserveAlpha' 속성에 해당합니다. |
...
| [Result](../../aspose.svg.filters/svgfeconvolvematrixelement/result/) { get; } | 지정된 '필터' 요소의 '결과' 속성에 해당합니다. |
...
| [TargetX](../../aspose.svg.filters/svgfeconvolvematrixelement/targetx/) { get; } | 지정된 'feConvolveMatrix' 요소의 'targetX' 속성에 해당합니다. |
| [TargetY](../../aspose.svg.filters/svgfeconvolvematrixelement/targety/) { get; } | 지정된 'feConvolveMatrix' 요소의 'targetY' 속성에 해당합니다. |
...
| [Width](../../aspose.svg.filters/svgfeconvolvematrixelement/width/) { get; } | 지정된 '필터' 요소의 '너비' 속성에 해당합니다. |
| [X](../../aspose.svg.filters/svgfeconvolvematrixelement/x/) { get; } | 지정된 '필터' 요소의 속성 'x'에 해당합니다. |
| [Y](../../aspose.svg.filters/svgfeconvolvematrixelement/y/) { get; } | 지정된 '필터' 요소의 속성 'y'에 해당합니다. |
...
| 이름 | 설명 |
| --- | --- |
| const [SVG_EDGEMODE_DUPLICATE](../../aspose.svg.filters/svgfeconvolvematrixelement/svg_edgemode_duplicate/) | 값 'duplicate'에 해당합니다. |
| const [SVG_EDGEMODE_NONE](../../aspose.svg.filters/svgfeconvolvematrixelement/svg_edgemode_none/) | 값 '없음'에 해당합니다. |
| const [SVG_EDGEMODE_UNKNOWN](../../aspose.svg.filters/svgfeconvolvematrixelement/svg_edgemode_unknown/) | 유형이 미리 정의된 유형 중 하나가 아닙니다. 이 유형의 새 값을 정의하거나 기존 값을 이 유형으로 전환하려는 시도는 유효하지 않습니다. |
| const [SVG_EDGEMODE_WRAP](../../aspose.svg.filters/svgfeconvolvematrixelement/svg_edgemode_wrap/) | 값 'wrap'에 해당합니다. |
