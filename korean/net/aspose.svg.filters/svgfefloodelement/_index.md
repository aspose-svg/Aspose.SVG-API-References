...
description: Aspose.Svg.Filters.SVGFEFloodElement 수업. SVGFEFloodElement 인터페이스는 feFlood 요소에 해당합니다.
type: docs
weight: 1740
url: /ko/net/aspose.svg.filters/svgfefloodelement/
---
...
| [Height](../../aspose.svg.filters/svgfefloodelement/height/) { get; } | 지정된 '필터' 요소의 '높이' 속성에 해당합니다. |
...
| [Result](../../aspose.svg.filters/svgfefloodelement/result/) { get; } | 지정된 '필터' 요소의 '결과' 속성에 해당합니다. |
...
| [Width](../../aspose.svg.filters/svgfefloodelement/width/) { get; } | 지정된 '필터' 요소의 '너비' 속성에 해당합니다. |
| [X](../../aspose.svg.filters/svgfefloodelement/x/) { get; } | 지정된 '필터' 요소의 속성 'x'에 해당합니다. |
| [Y](../../aspose.svg.filters/svgfefloodelement/y/) { get; } | 지정된 '필터' 요소의 속성 'y'에 해당합니다. |
