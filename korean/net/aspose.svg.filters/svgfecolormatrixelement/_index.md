...
description: Aspose.Svg.Filters.SVGFEColorMatrixElement 수업. SVGFEColorMatrixElement 인터페이스는 feColorMatrix 요소에 해당합니다.
type: docs
weight: 1660
url: /ko/net/aspose.svg.filters/svgfecolormatrixelement/
---
...
| [Height](../../aspose.svg.filters/svgfecolormatrixelement/height/) { get; } | 지정된 '필터' 요소의 '높이' 속성에 해당합니다. |
| [Id](../../aspose.svg/svgelement/id/) { get; set; } | 주어진 요소의 'id' 속성 값 또는 'id'가 없으면 빈 문자열. |
| [In1](../../aspose.svg.filters/svgfecolormatrixelement/in1/) { get; } | 지정된 'feColorMatrix' 요소의 속성 'in'에 해당합니다. |
...
| [Result](../../aspose.svg.filters/svgfecolormatrixelement/result/) { get; } | 지정된 '필터' 요소의 '결과' 속성에 해당합니다. |
...
| [Type](../../aspose.svg.filters/svgfecolormatrixelement/type/) { get; } | 지정된 'feColorMatrix' 요소의 'type' 속성에 해당합니다. 이 인터페이스에 정의된 SVG_FECOLORMATRIX_TYPE_* 상수 중 하나를 사용합니다. |
| [Values](../../aspose.svg.filters/svgfecolormatrixelement/values/) { get; } | 지정된 'feColorMatrix' 요소의 속성 'values'에 해당합니다. |
...
| [Width](../../aspose.svg.filters/svgfecolormatrixelement/width/) { get; } | 지정된 '필터' 요소의 '너비' 속성에 해당합니다. |
| [X](../../aspose.svg.filters/svgfecolormatrixelement/x/) { get; } | 지정된 '필터' 요소의 속성 'x'에 해당합니다. |
| [Y](../../aspose.svg.filters/svgfecolormatrixelement/y/) { get; } | 지정된 '필터' 요소의 속성 'y'에 해당합니다. |
...
| 이름 | 설명 |
| --- | --- |
| const [SVG_FECOLORMATRIX_TYPE_HUEROTATE](../../aspose.svg.filters/svgfecolormatrixelement/svg_fecolormatrix_type_huerotate/) | 값 'hueRotate'에 해당합니다. |
| const [SVG_FECOLORMATRIX_TYPE_LUMINANCETOALPHA](../../aspose.svg.filters/svgfecolormatrixelement/svg_fecolormatrix_type_luminancetoalpha/) | 'luminanceToAlpha' 값에 해당합니다. |
| const [SVG_FECOLORMATRIX_TYPE_MATRIX](../../aspose.svg.filters/svgfecolormatrixelement/svg_fecolormatrix_type_matrix/) | 값 '행렬'에 해당합니다. |
| const [SVG_FECOLORMATRIX_TYPE_SATURATE](../../aspose.svg.filters/svgfecolormatrixelement/svg_fecolormatrix_type_saturate/) | 값 '포화'에 해당합니다. |
| const [SVG_FECOLORMATRIX_TYPE_UNKNOWN](../../aspose.svg.filters/svgfecolormatrixelement/svg_fecolormatrix_type_unknown/) | 유형이 미리 정의된 유형 중 하나가 아닙니다. 이 유형의 새 값을 정의하거나 기존 값을 이 유형으로 전환하려는 시도는 유효하지 않습니다. |
