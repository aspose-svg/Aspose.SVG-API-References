...
description: Aspose.Svg.Filters.SVGFEOffsetElement 수업. SVGFEOffsetElement 인터페이스는 feOffset 요소에 해당합니다.
type: docs
weight: 1840
url: /ko/net/aspose.svg.filters/svgfeoffsetelement/
---
...
| [Dx](../../aspose.svg.filters/svgfeoffsetelement/dx/) { get; } | 지정된 'feOffset' 요소의 속성 'dx'에 해당합니다. |
| [Dy](../../aspose.svg.filters/svgfeoffsetelement/dy/) { get; } | 지정된 'feOffset' 요소의 속성 'dy'에 해당합니다. |
...
| [Height](../../aspose.svg.filters/svgfeoffsetelement/height/) { get; } | 지정된 '필터' 요소의 '높이' 속성에 해당합니다. |
| [Id](../../aspose.svg/svgelement/id/) { get; set; } | 주어진 요소의 'id' 속성 값 또는 'id'가 없으면 빈 문자열. |
| [In1](../../aspose.svg.filters/svgfeoffsetelement/in1/) { get; } | 지정된 'feOffset' 요소의 속성 'in'에 해당합니다. |
...
| [Result](../../aspose.svg.filters/svgfeoffsetelement/result/) { get; } | 지정된 '필터' 요소의 '결과' 속성에 해당합니다. |
...
| [Width](../../aspose.svg.filters/svgfeoffsetelement/width/) { get; } | 지정된 '필터' 요소의 '너비' 속성에 해당합니다. |
| [X](../../aspose.svg.filters/svgfeoffsetelement/x/) { get; } | 지정된 '필터' 요소의 속성 'x'에 해당합니다. |
| [Y](../../aspose.svg.filters/svgfeoffsetelement/y/) { get; } | 지정된 '필터' 요소의 속성 'y'에 해당합니다. |
