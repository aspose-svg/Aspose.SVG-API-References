...
description: Aspose.Svg.Filters.SVGFEComponentTransferElement 수업. SVGFEComponentTransferElement 인터페이스는 feComponentTransfer 요소에 해당합니다.
type: docs
weight: 1670
url: /ko/net/aspose.svg.filters/svgfecomponenttransferelement/
---
...
| [Height](../../aspose.svg.filters/svgfecomponenttransferelement/height/) { get; } | 지정된 '필터' 요소의 '높이' 속성에 해당합니다. |
| [Id](../../aspose.svg/svgelement/id/) { get; set; } | 주어진 요소의 'id' 속성 값 또는 'id'가 없으면 빈 문자열. |
| [In1](../../aspose.svg.filters/svgfecomponenttransferelement/in1/) { get; } | 지정된 'feComponentTransfer' 요소의 속성 'in'에 해당합니다. |
...
| [Result](../../aspose.svg.filters/svgfecomponenttransferelement/result/) { get; } | 지정된 '필터' 요소의 '결과' 속성에 해당합니다. |
...
| [Width](../../aspose.svg.filters/svgfecomponenttransferelement/width/) { get; } | 지정된 '필터' 요소의 '너비' 속성에 해당합니다. |
| [X](../../aspose.svg.filters/svgfecomponenttransferelement/x/) { get; } | 지정된 '필터' 요소의 속성 'x'에 해당합니다. |
| [Y](../../aspose.svg.filters/svgfecomponenttransferelement/y/) { get; } | 지정된 '필터' 요소의 속성 'y'에 해당합니다. |
