...
description: Aspose.Svg.Filters.SVGFEImageElement 수업. SVGFEImageElement 인터페이스는 feImage 요소에 해당합니다.
type: docs
weight: 1800
url: /ko/net/aspose.svg.filters/svgfeimageelement/
---
...
| [Height](../../aspose.svg.filters/svgfeimageelement/height/) { get; } | 지정된 '필터' 요소의 '높이' 속성에 해당합니다. |
| [Href](../../aspose.svg.filters/svgfeimageelement/href/) { get; } | 지정된 요소의 'xlink:href' 속성에 해당합니다. |
...
| [PreserveAspectRatio](../../aspose.svg.filters/svgfeimageelement/preserveaspectratio/) { get; } | 지정된 'feImage' 요소의 'preserveAspectRatio' 속성에 해당합니다. |
...
| [Result](../../aspose.svg.filters/svgfeimageelement/result/) { get; } | 지정된 '필터' 요소의 '결과' 속성에 해당합니다. |
...
| [Width](../../aspose.svg.filters/svgfeimageelement/width/) { get; } | 지정된 '필터' 요소의 '너비' 속성에 해당합니다. |
| [X](../../aspose.svg.filters/svgfeimageelement/x/) { get; } | 지정된 '필터' 요소의 속성 'x'에 해당합니다. |
| [Y](../../aspose.svg.filters/svgfeimageelement/y/) { get; } | 지정된 '필터' 요소의 속성 'y'에 해당합니다. |
