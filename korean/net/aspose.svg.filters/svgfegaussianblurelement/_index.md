...
description: Aspose.Svg.Filters.SVGFEGaussianBlurElement 수업. SVGFEGaussianBlurElement 인터페이스는 feGaussianBlur 요소에 해당합니다.
type: docs
weight: 1790
url: /ko/net/aspose.svg.filters/svgfegaussianblurelement/
---
...
| [Height](../../aspose.svg.filters/svgfegaussianblurelement/height/) { get; } | 지정된 "필터" 요소의 "높이" 속성에 해당합니다. |
| [Id](../../aspose.svg/svgelement/id/) { get; set; } | 주어진 요소의 'id' 속성 값 또는 'id'가 없으면 빈 문자열. |
| [In1](../../aspose.svg.filters/svgfegaussianblurelement/in1/) { get; } | 지정된 "feGaussianBlur" 요소의 속성 "in"에 해당합니다. |
...
| [Result](../../aspose.svg.filters/svgfegaussianblurelement/result/) { get; } | 지정된 "필터" 요소의 "결과" 속성에 해당합니다. |
...
| [StdDeviationX](../../aspose.svg.filters/svgfegaussianblurelement/stddeviationx/) { get; } | 지정된 "feGaussianBlur" 요소의 "stdDeviation" 속성에 해당합니다. 속성 �stdDeviation�. 의 X 구성 요소를 포함합니다. |
| [StdDeviationY](../../aspose.svg.filters/svgfegaussianblurelement/stddeviationy/) { get; } | 지정된 "feGaussianBlur" 요소의 "stdDeviation" 속성에 해당합니다. �stdDeviation�. 속성의 Y 구성 요소(자동으로 계산될 수 있음)를 포함합니다. |
...
| [Width](../../aspose.svg.filters/svgfegaussianblurelement/width/) { get; } | 지정된 "필터" 요소의 "너비" 속성에 해당합니다. |
| [X](../../aspose.svg.filters/svgfegaussianblurelement/x/) { get; } | 지정된 "필터" 요소의 속성 "x"에 해당합니다. |
| [Y](../../aspose.svg.filters/svgfegaussianblurelement/y/) { get; } | 지정된 "필터" 요소의 속성 "y"에 해당합니다. |
...
| [SetStdDeviation](../../aspose.svg.filters/svgfegaussianblurelement/setstddeviation/)(float, float) | �stdDeviation� 속성 값을 설정합니다. |
