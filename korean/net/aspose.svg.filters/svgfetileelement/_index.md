...
description: Aspose.Svg.Filters.SVGFETileElement 수업. SVGFETileElement 인터페이스는 feTile 요소에 해당합니다.
type: docs
weight: 1880
url: /ko/net/aspose.svg.filters/svgfetileelement/
---
...
| [Height](../../aspose.svg.filters/svgfetileelement/height/) { get; } | 지정된 '필터' 요소의 '높이' 속성에 해당합니다. |
| [Id](../../aspose.svg/svgelement/id/) { get; set; } | 주어진 요소의 'id' 속성 값 또는 'id'가 없으면 빈 문자열. |
| [In1](../../aspose.svg.filters/svgfetileelement/in1/) { get; } | 지정된 'feTile' 요소의 속성 'in'에 해당합니다. |
...
| [Result](../../aspose.svg.filters/svgfetileelement/result/) { get; } | 지정된 '필터' 요소의 '결과' 속성에 해당합니다. |
...
| [Width](../../aspose.svg.filters/svgfetileelement/width/) { get; } | 지정된 '필터' 요소의 '너비' 속성에 해당합니다. |
| [X](../../aspose.svg.filters/svgfetileelement/x/) { get; } | 지정된 '필터' 요소의 속성 'x'에 해당합니다. |
| [Y](../../aspose.svg.filters/svgfetileelement/y/) { get; } | 지정된 '필터' 요소의 속성 'y'에 해당합니다. |
