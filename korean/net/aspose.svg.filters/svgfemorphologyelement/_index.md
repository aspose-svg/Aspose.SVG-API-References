...
description: Aspose.Svg.Filters.SVGFEMorphologyElement 수업. SVGFEMorphologyElement 인터페이스는 feMorphology 요소에 해당합니다.
type: docs
weight: 1830
url: /ko/net/aspose.svg.filters/svgfemorphologyelement/
---
...
| [Height](../../aspose.svg.filters/svgfemorphologyelement/height/) { get; } | 지정된 '필터' 요소의 '높이' 속성에 해당합니다. |
| [Id](../../aspose.svg/svgelement/id/) { get; set; } | 주어진 요소의 'id' 속성 값 또는 'id'가 없으면 빈 문자열. |
| [In1](../../aspose.svg.filters/svgfemorphologyelement/in1/) { get; } | 지정된 'feMorphology' 요소의 속성 'in'에 해당합니다. |
...
| [Operator](../../aspose.svg.filters/svgfemorphologyelement/operator/) { get; } | 지정된 'feMorphology' 요소의 'operator' 속성에 해당합니다. 이 인터페이스에 정의된 SVG_MORPHOLOGY_OPERATOR_* 상수 중 하나를 사용합니다. |
...
| [RadiusX](../../aspose.svg.filters/svgfemorphologyelement/radiusx/) { get; } | 지정된 'feMorphology' 요소의 'radius' 속성에 해당합니다. |
| [RadiusY](../../aspose.svg.filters/svgfemorphologyelement/radiusy/) { get; } | 지정된 'feMorphology' 요소의 'radius' 속성에 해당합니다. |
| [Result](../../aspose.svg.filters/svgfemorphologyelement/result/) { get; } | 지정된 '필터' 요소의 '결과' 속성에 해당합니다. |
...
| [Width](../../aspose.svg.filters/svgfemorphologyelement/width/) { get; } | 지정된 '필터' 요소의 '너비' 속성에 해당합니다. |
| [X](../../aspose.svg.filters/svgfemorphologyelement/x/) { get; } | 지정된 '필터' 요소의 속성 'x'에 해당합니다. |
| [Y](../../aspose.svg.filters/svgfemorphologyelement/y/) { get; } | 지정된 '필터' 요소의 속성 'y'에 해당합니다. |
...
| 이름 | 설명 |
| --- | --- |
| const [SVG_MORPHOLOGY_OPERATOR_DILATE](../../aspose.svg.filters/svgfemorphologyelement/svg_morphology_operator_dilate/) | 값 '확장'에 해당합니다. |
| const [SVG_MORPHOLOGY_OPERATOR_ERODE](../../aspose.svg.filters/svgfemorphologyelement/svg_morphology_operator_erode/) | 값 '침식'에 해당합니다. |
| const [SVG_MORPHOLOGY_OPERATOR_UNKNOWN](../../aspose.svg.filters/svgfemorphologyelement/svg_morphology_operator_unknown/) | 유형이 미리 정의된 유형 중 하나가 아닙니다. 이 유형의 새 값을 정의하거나 기존 값을 이 유형으로 전환하려는 시도는 유효하지 않습니다. |
