...
description: Aspose.Svg.Filters.SVGFESpecularLightingElement 수업. SVGFESpecularLightingElement 인터페이스는 feSpecularLighting 요소에 해당합니다.
type: docs
weight: 1860
url: /ko/net/aspose.svg.filters/svgfespecularlightingelement/
---
...
| [Height](../../aspose.svg.filters/svgfespecularlightingelement/height/) { get; } | 지정된 '필터' 요소의 '높이' 속성에 해당합니다. |
| [Id](../../aspose.svg/svgelement/id/) { get; set; } | 주어진 요소의 'id' 속성 값 또는 'id'가 없으면 빈 문자열. |
| [In1](../../aspose.svg.filters/svgfespecularlightingelement/in1/) { get; } | 지정된 'feSpecularLighting' 요소의 속성 'in'에 해당합니다. |
...
| [KernelUnitLengthX](../../aspose.svg.filters/svgfespecularlightingelement/kernelunitlengthx/) { get; } | 지정된 'feSpecularLighting' 요소의 'kernelUnitLength' 속성에 해당합니다. |
| [KernelUnitLengthY](../../aspose.svg.filters/svgfespecularlightingelement/kernelunitlengthy/) { get; } | 지정된 'feSpecularLighting' 요소의 'kernelUnitLength' 속성에 해당합니다. |
...
| [Result](../../aspose.svg.filters/svgfespecularlightingelement/result/) { get; } | 지정된 '필터' 요소의 '결과' 속성에 해당합니다. |
...
| [SpecularConstant](../../aspose.svg.filters/svgfespecularlightingelement/specularconstant/) { get; } | 지정된 'feSpecularLighting' 요소의 'specularConstant' 속성에 해당합니다. |
| [SpecularExponent](../../aspose.svg.filters/svgfespecularlightingelement/specularexponent/) { get; } | 지정된 'feSpecularLighting' 요소의 'specularExponent' 속성에 해당합니다. |
...
| [SurfaceScale](../../aspose.svg.filters/svgfespecularlightingelement/surfacescale/) { get; } | 지정된 'feSpecularLighting' 요소의 'surfaceScale' 속성에 해당합니다. |
...
| [Width](../../aspose.svg.filters/svgfespecularlightingelement/width/) { get; } | 지정된 '필터' 요소의 '너비' 속성에 해당합니다. |
| [X](../../aspose.svg.filters/svgfespecularlightingelement/x/) { get; } | 지정된 '필터' 요소의 속성 'x'에 해당합니다. |
| [Y](../../aspose.svg.filters/svgfespecularlightingelement/y/) { get; } | 지정된 '필터' 요소의 속성 'y'에 해당합니다. |
