...
description: Aspose.Svg.Filters.SVGFETurbulenceElement 수업. SVGFETurbulenceElement 인터페이스는 feTurbulence 요소에 해당합니다.
type: docs
weight: 1890
url: /ko/net/aspose.svg.filters/svgfeturbulenceelement/
---
...
| [BaseFrequencyX](../../aspose.svg.filters/svgfeturbulenceelement/basefrequencyx/) { get; } | 지정된 'feTurbulence' 요소의 'baseFrequency' 속성에 해당합니다. 'baseFrequency' 속성의 X 구성 요소를 포함합니다. |
| [BaseFrequencyY](../../aspose.svg.filters/svgfeturbulenceelement/basefrequencyy/) { get; } | 지정된 'feTurbulence' 요소의 'baseFrequency' 속성에 해당합니다. (자동으로 계산될 수 있음) 'baseFrequency' 속성의 Y 구성 요소를 포함합니다. |
...
| [Height](../../aspose.svg.filters/svgfeturbulenceelement/height/) { get; } | 지정된 '필터' 요소의 '높이' 속성에 해당합니다. |
...
| [NumOctaves](../../aspose.svg.filters/svgfeturbulenceelement/numoctaves/) { get; } | 지정된 'feTurbulence' 요소의 속성 'numOctaves'에 해당합니다. |
...
| [Result](../../aspose.svg.filters/svgfeturbulenceelement/result/) { get; } | 지정된 '필터' 요소의 '결과' 속성에 해당합니다. |
| [SchemaTypeInfo](../../aspose.svg.dom/element/schematypeinfo/) { get; } | 이 요소와 관련된 유형 정보입니다. |
| [Seed](../../aspose.svg.filters/svgfeturbulenceelement/seed/) { get; } | 지정된 'feTurbulence' 요소의 속성 'seed'에 해당합니다. |
| [ShadowRoot](../../aspose.svg.dom/element/shadowroot/) { get; } | 이 요소에 저장된 shadowRoot를 반환하거나 닫혀 있으면 null을 반환합니다. |
| [StitchTiles](../../aspose.svg.filters/svgfeturbulenceelement/stitchtiles/) { get; } | 지정된 'feTurbulence' 요소의 'stitchTiles' 속성에 해당합니다. 이 인터페이스에 정의된 SVG_STITCHTYPE_* 상수 중 하나를 사용합니다. |
...
| [Type](../../aspose.svg.filters/svgfeturbulenceelement/type/) { get; } | 지정된 'feTurbulence' 요소의 속성 'type'에 해당합니다. 이 인터페이스에 정의된 SVG_TURBULENCE_TYPE_* 상수 중 하나를 사용합니다. |
...
| [Width](../../aspose.svg.filters/svgfeturbulenceelement/width/) { get; } | 지정된 '필터' 요소의 '너비' 속성에 해당합니다. |
| [X](../../aspose.svg.filters/svgfeturbulenceelement/x/) { get; } | 지정된 '필터' 요소의 속성 'x'에 해당합니다. |
| [Y](../../aspose.svg.filters/svgfeturbulenceelement/y/) { get; } | 지정된 '필터' 요소의 속성 'y'에 해당합니다. |
...
| 이름 | 설명 |
| --- | --- |
| const [SVG_STITCHTYPE_NOSTITCH](../../aspose.svg.filters/svgfeturbulenceelement/svg_stitchtype_nostitch/) | 값 'noStitch'에 해당합니다. |
| const [SVG_STITCHTYPE_STITCH](../../aspose.svg.filters/svgfeturbulenceelement/svg_stitchtype_stitch/) | 값 'stitch'에 해당합니다. |
| const [SVG_STITCHTYPE_UNKNOWN](../../aspose.svg.filters/svgfeturbulenceelement/svg_stitchtype_unknown/) | 유형이 미리 정의된 유형 중 하나가 아닙니다. 이 유형의 새 값을 정의하거나 기존 값을 이 유형으로 전환하려는 시도는 유효하지 않습니다. |
| const [SVG_TURBULENCE_TYPE_FRACTALNOISE](../../aspose.svg.filters/svgfeturbulenceelement/svg_turbulence_type_fractalnoise/) | 'fractalNoise' 값에 해당합니다. |
| const [SVG_TURBULENCE_TYPE_TURBULENCE](../../aspose.svg.filters/svgfeturbulenceelement/svg_turbulence_type_turbulence/) | 값 '난기류'에 해당합니다. |
| const [SVG_TURBULENCE_TYPE_UNKNOWN](../../aspose.svg.filters/svgfeturbulenceelement/svg_turbulence_type_unknown/) | 유형이 미리 정의된 유형 중 하나가 아닙니다. 이 유형의 새 값을 정의하거나 기존 값을 이 유형으로 전환하려는 시도는 유효하지 않습니다. |
