...
description: Aspose.Svg.Filters.SVGFEDiffuseLightingElement 수업. SVGFEDiffuseLightingElement 인터페이스는 feDiffuseLighting 요소에 해당합니다.
type: docs
weight: 1700
url: /ko/net/aspose.svg.filters/svgfediffuselightingelement/
---
...
| [DiffuseConstant](../../aspose.svg.filters/svgfediffuselightingelement/diffuseconstant/) { get; } | 지정된 'feDiffuseLighting' 요소의 'diffuseConstant' 속성에 해당합니다. |
...
| [Height](../../aspose.svg.filters/svgfediffuselightingelement/height/) { get; } | 지정된 '필터' 요소의 '높이' 속성에 해당합니다. |
| [Id](../../aspose.svg/svgelement/id/) { get; set; } | 주어진 요소의 'id' 속성 값 또는 'id'가 없으면 빈 문자열. |
| [In1](../../aspose.svg.filters/svgfediffuselightingelement/in1/) { get; } | 지정된 'feDiffuseLighting' 요소의 속성 'in'에 해당합니다. |
...
| [KernelUnitLengthX](../../aspose.svg.filters/svgfediffuselightingelement/kernelunitlengthx/) { get; } | 지정된 'feDiffuseLighting' 요소의 'kernelUnitLength' 속성에 해당합니다. |
| [KernelUnitLengthY](../../aspose.svg.filters/svgfediffuselightingelement/kernelunitlengthy/) { get; } | 지정된 'feDiffuseLighting' 요소의 'kernelUnitLength' 속성에 해당합니다. |
...
| [Result](../../aspose.svg.filters/svgfediffuselightingelement/result/) { get; } | 지정된 '필터' 요소의 '결과' 속성에 해당합니다. |
...
| [SurfaceScale](../../aspose.svg.filters/svgfediffuselightingelement/surfacescale/) { get; } | 지정된 'feDiffuseLighting' 요소의 'surfaceScale' 속성에 해당합니다. |
...
| [Width](../../aspose.svg.filters/svgfediffuselightingelement/width/) { get; } | 지정된 '필터' 요소의 '너비' 속성에 해당합니다. |
| [X](../../aspose.svg.filters/svgfediffuselightingelement/x/) { get; } | 지정된 '필터' 요소의 속성 'x'에 해당합니다. |
| [Y](../../aspose.svg.filters/svgfediffuselightingelement/y/) { get; } | 지정된 '필터' 요소의 속성 'y'에 해당합니다. |
