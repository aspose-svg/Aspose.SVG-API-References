...
description: Aspose.Svg.Filters.SVGFECompositeElement 수업. SVGFECompositeElement 인터페이스는 feComposite 요소에 해당합니다.
type: docs
weight: 1680
url: /ko/net/aspose.svg.filters/svgfecompositeelement/
---
...
| [Height](../../aspose.svg.filters/svgfecompositeelement/height/) { get; } | 지정된 '필터' 요소의 '높이' 속성에 해당합니다. |
| [Id](../../aspose.svg/svgelement/id/) { get; set; } | 주어진 요소의 'id' 속성 값 또는 'id'가 없으면 빈 문자열. |
| [In1](../../aspose.svg.filters/svgfecompositeelement/in1/) { get; } | 지정된 'feComposite' 요소의 속성 'in'에 해당합니다. |
| [In2](../../aspose.svg.filters/svgfecompositeelement/in2/) { get; } | 지정된 'feComposite' 요소의 속성 'in2'에 해당합니다. |
...
| [K1](../../aspose.svg.filters/svgfecompositeelement/k1/) { get; } | 지정된 'feComposite' 요소의 속성 'k1'에 해당합니다. |
| [K2](../../aspose.svg.filters/svgfecompositeelement/k2/) { get; } | 지정된 'feComposite' 요소의 속성 'k2'에 해당합니다. |
| [K3](../../aspose.svg.filters/svgfecompositeelement/k3/) { get; } | 지정된 'feComposite' 요소의 속성 'k3'에 해당합니다. |
| [K4](../../aspose.svg.filters/svgfecompositeelement/k4/) { get; } | 지정된 'feComposite' 요소의 속성 'k4'에 해당합니다. |
...
| [Operator](../../aspose.svg.filters/svgfecompositeelement/operator/) { get; } | 지정된 'feComposite' 요소의 'operator' 속성에 해당합니다. 이 인터페이스에 정의된 SVG_FECOMPOSITE_OPERATOR_* 상수 중 하나를 사용합니다. |
...
| [Result](../../aspose.svg.filters/svgfecompositeelement/result/) { get; } | 지정된 '필터' 요소의 '결과' 속성에 해당합니다. |
...
| [Width](../../aspose.svg.filters/svgfecompositeelement/width/) { get; } | 지정된 '필터' 요소의 '너비' 속성에 해당합니다. |
| [X](../../aspose.svg.filters/svgfecompositeelement/x/) { get; } | 지정된 '필터' 요소의 속성 'x'에 해당합니다. |
| [Y](../../aspose.svg.filters/svgfecompositeelement/y/) { get; } | 지정된 '필터' 요소의 속성 'y'에 해당합니다. |
...
| 이름 | 설명 |
| --- | --- |
| const [SVG_FECOMPOSITE_OPERATOR_ARITHMETIC](../../aspose.svg.filters/svgfecompositeelement/svg_fecomposite_operator_arithmetic/) | 값 '산술'에 해당합니다. |
| const [SVG_FECOMPOSITE_OPERATOR_ATOP](../../aspose.svg.filters/svgfecompositeelement/svg_fecomposite_operator_atop/) | 값 'atop'에 해당합니다. |
| const [SVG_FECOMPOSITE_OPERATOR_IN](../../aspose.svg.filters/svgfecompositeelement/svg_fecomposite_operator_in/) | 값 'in'에 해당합니다. |
| const [SVG_FECOMPOSITE_OPERATOR_OUT](../../aspose.svg.filters/svgfecompositeelement/svg_fecomposite_operator_out/) | 값 'out'에 해당합니다. |
| const [SVG_FECOMPOSITE_OPERATOR_OVER](../../aspose.svg.filters/svgfecompositeelement/svg_fecomposite_operator_over/) | 값 'over'에 해당합니다. |
| const [SVG_FECOMPOSITE_OPERATOR_UNKNOWN](../../aspose.svg.filters/svgfecompositeelement/svg_fecomposite_operator_unknown/) | 유형이 미리 정의된 유형 중 하나가 아닙니다. 이 유형의 새 값을 정의하거나 기존 값을 이 유형으로 전환하려는 시도는 유효하지 않습니다. |
| const [SVG_FECOMPOSITE_OPERATOR_XOR](../../aspose.svg.filters/svgfecompositeelement/svg_fecomposite_operator_xor/) | 값 'xor'에 해당합니다. |
