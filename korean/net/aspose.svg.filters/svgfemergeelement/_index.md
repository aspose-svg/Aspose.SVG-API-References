...
description: Aspose.Svg.Filters.SVGFEMergeElement 수업. SVGFEMergeElement 인터페이스는 feMerge 요소에 해당합니다.
type: docs
weight: 1810
url: /ko/net/aspose.svg.filters/svgfemergeelement/
---
...
| [Height](../../aspose.svg.filters/svgfemergeelement/height/) { get; } | 지정된 '필터' 요소의 '높이' 속성에 해당합니다. |
...
| [Result](../../aspose.svg.filters/svgfemergeelement/result/) { get; } | 지정된 '필터' 요소의 '결과' 속성에 해당합니다. |
...
| [Width](../../aspose.svg.filters/svgfemergeelement/width/) { get; } | 지정된 '필터' 요소의 '너비' 속성에 해당합니다. |
| [X](../../aspose.svg.filters/svgfemergeelement/x/) { get; } | 지정된 '필터' 요소의 속성 'x'에 해당합니다. |
| [Y](../../aspose.svg.filters/svgfemergeelement/y/) { get; } | 지정된 '필터' 요소의 속성 'y'에 해당합니다. |
