...
description: Aspose.Svg.Filters.SVGFEDropShadowElement 수업. SVGFEDropShadowElement 인터페이스는 feDropShadow 요소에 해당합니다.
type: docs
weight: 1730
url: /ko/net/aspose.svg.filters/svgfedropshadowelement/
---
...
| [Dx](../../aspose.svg.filters/svgfedropshadowelement/dx/) { get; } | 지정된 'feDropShadow' 요소의 속성 'dx'에 해당합니다. |
| [Dy](../../aspose.svg.filters/svgfedropshadowelement/dy/) { get; } | 지정된 'feDropShadow' 요소의 속성 'dy'에 해당합니다. |
...
| [Height](../../aspose.svg.filters/svgfedropshadowelement/height/) { get; } | 지정된 'feDropShadow' 요소의 '높이' 속성에 해당합니다. |
| [Id](../../aspose.svg/svgelement/id/) { get; set; } | 주어진 요소의 'id' 속성 값 또는 'id'가 없으면 빈 문자열. |
| [In1](../../aspose.svg.filters/svgfedropshadowelement/in1/) { get; } | 지정된 'feDropShadow' 요소의 속성 'in'에 해당합니다. |
...
| [Result](../../aspose.svg.filters/svgfedropshadowelement/result/) { get; } | 지정된 'feDropShadow' 요소의 'result' 속성에 해당합니다. |
...
| [StdDeviationX](../../aspose.svg.filters/svgfedropshadowelement/stddeviationx/) { get; } | 지정된 'feDropShadow' 요소의 'stdDeviation' 속성에 해당합니다. 속성 'stdDeviation'의 X 구성요소를 포함합니다. |
| [StdDeviationY](../../aspose.svg.filters/svgfedropshadowelement/stddeviationy/) { get; } | 지정된 'feDropShadow' 요소의 'stdDeviation' 속성에 해당합니다. 'stdDeviation' 속성의 Y 구성 요소(자동으로 계산될 수 있음)를 포함합니다. |
...
| [Width](../../aspose.svg.filters/svgfedropshadowelement/width/) { get; } | 지정된 'feDropShadow' 요소의 '너비' 속성에 해당합니다. |
| [X](../../aspose.svg.filters/svgfedropshadowelement/x/) { get; } | 지정된 'feDropShadow' 요소의 속성 'x'에 해당합니다. |
| [Y](../../aspose.svg.filters/svgfedropshadowelement/y/) { get; } | 지정된 'feDropShadow' 요소의 속성 'y'에 해당합니다. |
...
| [SetStdDeviation](../../aspose.svg.filters/svgfedropshadowelement/setstddeviation/)(float, float) | 속성 'stdDeviation'의 값을 설정합니다. |
