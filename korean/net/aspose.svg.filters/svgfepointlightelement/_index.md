...
description: Aspose.Svg.Filters.SVGFEPointLightElement 수업. SVGFEPointLightElement 인터페이스는 fePointLight 요소에 해당합니다.
type: docs
weight: 1850
url: /ko/net/aspose.svg.filters/svgfepointlightelement/
---
...
| [X](../../aspose.svg.filters/svgfepointlightelement/x/) { get; } | 지정된 'fePointLight' 요소의 속성 'x'에 해당합니다. |
| [Y](../../aspose.svg.filters/svgfepointlightelement/y/) { get; } | 지정된 'fePointLight' 요소의 속성 'y'에 해당합니다. |
| [Z](../../aspose.svg.filters/svgfepointlightelement/z/) { get; } | 지정된 'fePointLight' 요소의 속성 'z'에 해당합니다. |
