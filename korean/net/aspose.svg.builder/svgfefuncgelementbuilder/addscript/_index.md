...
description: "SVGFEFuncGElementBuilder AddScript 메서드. feFuncG 요소에 스크립트 구성을 추가합니다"
type: docs
weight: 20
url: /ko/net/aspose.svg.builder/svgfefuncgelementbuilder/addscript/
---
## SVGFEFuncGElementBuilder.AddScript method

feFuncG 요소에 스크립트 구성을 추가합니다.
