...
description: "SVGBuilderExtensions AddFeSpecularLighting 메서드. 빌더에 feSpecularLighting 요소 구성을 추가합니다. 이 요소는 이미지에 반사광을 시뮬레이션하는 조명 효과를 적용합니다."
type: docs
weight: 270
url: /ko/net/aspose.svg.builder/svgbuilderextensions/addfespecularlighting/
---
## AddFeSpecularLighting<TBuilder>(*this TBuilder, Action&lt;SVGFESpecularLightingElementBuilder&gt;*) {#addfespecularlighting_2}

빌더에 'feSpecularLighting' 요소 구성을 추가합니다. 이 요소는 이미지에 조명 효과를 적용하여 반사광을 시뮬레이션합니다.
...
| 빌더 | 빌더 인스턴스입니다. |
| 구성 | 'feSpecularLighting' 요소에 대한 구성 액션입니다. |
...
SVG 빌더에 'feSpecularLighting' 요소를 추가하여 지정된 광원을 사용해 반사 조명 효과를 적용합니다.
...
| 빌더 | 'feSpecularLighting' 요소가 추가될 SVG 빌더 인스턴스입니다. |
| lightSource | 반사 조명 효과를 위한 광원을 구성하는 액션입니다. |
| lightingColor | 광원의 색상입니다. 선택적 매개변수. |
| surfaceScale | 조명 효과를 위한 표면 스케일 팩터입니다. 선택적 매개변수. |
| specularConstant | 반사 항을 스케일링하는 데 사용되는 상수입니다. 선택적 매개변수. |
| specularExponent | specular term의 지수이며, specular highlight의 초점을 제어합니다. 선택 매개변수. |
| kernelUnitLength | convolution filter의 kernel unit length입니다. double 또는 두 개의 double을 갖는 ValueTuple일 수 있습니다. 선택 매개변수. |
| in | specular lighting 효과가 적용될 입력 이미지입니다. 문자열이나 FilterInput일 수 있습니다. 선택 매개변수. |
...
| extend | SVGFESpecularLightingElementBuilder를 추가로 구성하기 위한 선택적 액션입니다. |
