...
description: "SVGBuilderExtensions MarkerStart 메서드. 경로 시작 부분에 마커를 지정하는 SVG 요소의 marker-start 속성을 설정합니다."
type: docs
weight: 1140
url: /ko/net/aspose.svg.builder/svgbuilderextensions/markerstart/
---
## MarkerStart<TBuilder>(*this TBuilder, string*) {#markerstart_1}

SVG 요소에 'marker-start' 속성을 설정하고, 경로 시작에 마커를 지정합니다.
...
미리 정의된 마커 위치를 사용하여 SVG 요소에 'marker-start' 속성을 설정합니다.
