...
description: "SVGBuilderExtensions LetterSpacing 메서드. 숫자 값과 특정 길이 유형을 사용하여 SVG 요소의 letter-spacing 속성을 설정합니다."
type: docs
weight: 1100
url: /ko/net/aspose.svg.builder/svgbuilderextensions/letterspacing/
---
## LetterSpacing<TBuilder>(*this TBuilder, double, [LengthType](../../lengthtype/)*) {#letterspacing_1}

숫자 값과 특정 길이 유형을 사용하여 SVG 요소에 'letter-spacing' 속성을 설정합니다.
...
미리 정의된 간격 값을 사용하여 SVG 요소에 'letter-spacing' 속성을 설정합니다.
