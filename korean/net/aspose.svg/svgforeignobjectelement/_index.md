...
description: Aspose.Svg.SVGForeignObjectElement 수업. SVGForeignObjectElement 인터페이스는 foreignObject 요소에 해당합니다.
type: docs
weight: 3250
url: /ko/net/aspose.svg/svgforeignobjectelement/
---
...
| [Height](../../aspose.svg/svgforeignobjectelement/height/) { get; } | 지정된 'foreignObject' 요소의 '높이' 속성에 해당합니다. |
...
| [Width](../../aspose.svg/svgforeignobjectelement/width/) { get; } | 지정된 'foreignObject' 요소의 'width' 속성에 해당합니다. |
| [X](../../aspose.svg/svgforeignobjectelement/x/) { get; } | 지정된 'foreignObject' 요소의 속성 'x'에 해당합니다. |
| [Y](../../aspose.svg/svgforeignobjectelement/y/) { get; } | 지정된 'foreignObject' 요소의 속성 'y'에 해당합니다. |
