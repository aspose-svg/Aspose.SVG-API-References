...
description: Aspose.Svg.SVGEllipseElement 수업. SVGEllipseElement 인터페이스는 ellipse 요소에 해당합니다.
type: docs
weight: 3220
url: /ko/net/aspose.svg/svgellipseelement/
---
...
| [Cx](../../aspose.svg/svgellipseelement/cx/) { get; } | 지정된 '원' 요소의 속성 'cx'에 해당합니다. |
| [Cy](../../aspose.svg/svgellipseelement/cy/) { get; } | 지정된 '원' 요소의 속성 'cy'에 해당합니다. |
...
| [Rx](../../aspose.svg/svgellipseelement/rx/) { get; } | 지정된 '원' 요소의 속성 'cx'에 해당합니다. |
| [Ry](../../aspose.svg/svgellipseelement/ry/) { get; } | 지정된 '원' 요소의 속성 'ry'에 해당합니다. |
