...
description: Aspose.Svg.SVGFilterElement 수업. SVGFilterElement 인터페이스는 필터 요소에 해당합니다.
type: docs
weight: 3240
url: /ko/net/aspose.svg/svgfilterelement/
---
...
| [FilterUnits](../../aspose.svg/svgfilterelement/filterunits/) { get; } | 지정된 'filter' 요소의 'filterUnits' 속성에 해당합니다. SVGUnitTypes. 에 정의된 상수 중 하나를 사용합니다. |
...
| [Height](../../aspose.svg/svgfilterelement/height/) { get; } | 지정된 '필터' 요소의 '높이' 속성에 해당합니다. |
| [Href](../../aspose.svg/svgfilterelement/href/) { get; } | 지정된 요소의 'xlink:href' 속성에 해당합니다. |
...
| [PrimitiveUnits](../../aspose.svg/svgfilterelement/primitiveunits/) { get; } | 지정된 '필터' 요소의 'primitiveUnits' 속성에 해당합니다. SVGUnitTypes. 에 정의된 상수 중 하나를 사용합니다. |
...
| [Width](../../aspose.svg/svgfilterelement/width/) { get; } | 지정된 '필터' 요소의 '너비' 속성에 해당합니다. |
| [X](../../aspose.svg/svgfilterelement/x/) { get; } | 지정된 '필터' 요소의 속성 'x'에 해당합니다. |
| [Y](../../aspose.svg/svgfilterelement/y/) { get; } | 지정된 '필터' 요소의 속성 'y'에 해당합니다. |
