...
description: Aspose.Svg.SVGImageElement 수업. SVGImageElement 인터페이스는 이미지 요소에 해당합니다.
type: docs
weight: 3300
url: /ko/net/aspose.svg/svgimageelement/
---
...
| [Height](../../aspose.svg/svgimageelement/height/) { get; } | 지정된 '이미지' 요소의 '높이' 속성에 해당합니다. |
| [Href](../../aspose.svg/svgimageelement/href/) { get; } | 지정된 요소의 'xlink:href' 속성에 해당합니다. |
...
| [PreserveAspectRatio](../../aspose.svg/svgimageelement/preserveaspectratio/) { get; } | 지정된 '이미지' 요소의 'preserveAspectRatio' 속성에 해당합니다. |
...
| [Width](../../aspose.svg/svgimageelement/width/) { get; } | 지정된 '이미지' 요소의 '너비' 속성에 해당합니다. |
| [X](../../aspose.svg/svgimageelement/x/) { get; } | 지정된 '이미지' 요소의 속성 'x'에 해당합니다. |
| [Y](../../aspose.svg/svgimageelement/y/) { get; } | 지정된 '이미지' 요소의 속성 'y'에 해당합니다. |
