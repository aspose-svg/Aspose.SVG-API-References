...
description: Aspose.Svg.SVGCursorElement 수업. SVGCursorElement 인터페이스는 커서 요소에 해당합니다.
type: docs
weight: 3160
url: /ko/net/aspose.svg/svgcursorelement/
---
...
| [Href](../../aspose.svg/svgcursorelement/href/) { get; } | 지정된 요소의 'xlink:href' 속성에 해당합니다. |
...
| [RequiredExtensions](../../aspose.svg/svgcursorelement/requiredextensions/) { get; } | 지정된 요소의 'requiredExtensions' 속성에 해당합니다. |
| [RequiredFeatures](../../aspose.svg/svgcursorelement/requiredfeatures/) { get; } | 지정된 요소의 'requiredFeatures' 속성에 해당합니다. |
...
| [SystemLanguage](../../aspose.svg/svgcursorelement/systemlanguage/) { get; } | 지정된 요소의 'systemLanguage' 속성에 해당합니다. |
...
| [X](../../aspose.svg/svgcursorelement/x/) { get; } | 지정된 '커서' 요소의 속성 'x'에 해당합니다. |
| [Y](../../aspose.svg/svgcursorelement/y/) { get; } | 지정된 '커서' 요소의 속성 'y'에 해당합니다. |
