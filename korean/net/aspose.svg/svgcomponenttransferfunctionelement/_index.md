...
description: Aspose.Svg.SVGComponentTransferFunctionElement 수업. 이 인터페이스는 구성 요소 전송 기능 인터페이스에서 사용하는 기본 인터페이스를 정의합니다.
type: docs
weight: 3150
url: /ko/net/aspose.svg/svgcomponenttransferfunctionelement/
---
...
| 이름 | 설명 |
| --- | --- |
| [Amplitude](../../aspose.svg/svgcomponenttransferfunctionelement/amplitude/) { get; } | 지정된 요소의 '진폭' 속성에 해당합니다. |
...
| [Exponent](../../aspose.svg/svgcomponenttransferfunctionelement/exponent/) { get; } | 지정된 요소의 속성 '지수'에 해당합니다. |
...
| [Intercept](../../aspose.svg/svgcomponenttransferfunctionelement/intercept/) { get; } | 지정된 요소의 '절편' 속성에 해당합니다. |
...
| [Offset](../../aspose.svg/svgcomponenttransferfunctionelement/offset/) { get; } | 지정된 요소의 '오프셋' 속성에 해당합니다. |
...
| [Slope](../../aspose.svg/svgcomponenttransferfunctionelement/slope/) { get; } | 지정된 요소의 '기울기' 속성에 해당합니다. |
...
| [TableValues](../../aspose.svg/svgcomponenttransferfunctionelement/tablevalues/) { get; } | 지정된 요소의 'tableValues' 속성에 해당합니다. |
...
| [Type](../../aspose.svg/svgcomponenttransferfunctionelement/type/) { get; } | 지정된 요소의 속성 '유형'에 해당합니다. 이 인터페이스에 정의된 SVG_FECOMPONENTTRANSFER_TYPE_* 상수 중 하나를 사용합니다. |
...
| 이름 | 설명 |
| --- | --- |
| const [SVG_FECOMPONENTTRANSFER_TYPE_DISCRETE](../../aspose.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_discrete/) | 'discrete' 값에 해당합니다. |
| const [SVG_FECOMPONENTTRANSFER_TYPE_GAMMA](../../aspose.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_gamma/) | 값 '감마'에 해당합니다. |
| const [SVG_FECOMPONENTTRANSFER_TYPE_IDENTITY](../../aspose.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_identity/) | 값 'identity'에 해당합니다. |
| const [SVG_FECOMPONENTTRANSFER_TYPE_LINEAR](../../aspose.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_linear/) | 값 '선형'에 해당합니다. |
| const [SVG_FECOMPONENTTRANSFER_TYPE_TABLE](../../aspose.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_table/) | 값 'table'에 해당합니다. |
| const [SVG_FECOMPONENTTRANSFER_TYPE_UNKNOWN](../../aspose.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_unknown/) | 유형이 미리 정의된 유형 중 하나가 아닙니다. 이 유형의 새 값을 정의하거나 기존 값을 이 유형으로 전환하려는 시도는 유효하지 않습니다. |
