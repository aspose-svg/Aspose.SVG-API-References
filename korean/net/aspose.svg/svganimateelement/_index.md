...
description: Aspose.Svg.SVGAnimateElement 수업. SVGAnimateElement 인터페이스는 animate 요소에 해당합니다. SVG DOM을 통한 animate 요소의 속성에 대한 객체 지향 액세스는 사용할 수 없습니다.
type: docs
weight: 3090
url: /ko/net/aspose.svg/svganimateelement/
---
