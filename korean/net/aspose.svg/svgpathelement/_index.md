...
description: Aspose.Svg.SVGPathElement 수업. SVGPathElement 인터페이스는 경로 요소에 해당합니다.
type: docs
weight: 3370
url: /ko/net/aspose.svg/svgpathelement/
---
...
| 이름 | 설명 |
| --- | --- |
| [AnimatedPathSegList](../../aspose.svg/svgpathelement/animatedpathseglist/) { get; } | SVG 구문과 일대일로 일치하는 형식으로 'd' 속성의 현재 애니메이션 콘텐츠에 대한 액세스를 제공합니다. 주어진 속성 또는 속성이 애니메이션되는 경우 속성 또는 속성의 현재 애니메이션 값을 포함하고 개체 자체와 해당 내용이 모두 읽기 전용입니다. 지정된 속성 또는 속성이 현재 애니메이션되지 않는 경우 pathSegList. 와 동일한 값을 포함합니다. |
...
| [PathLength](../../aspose.svg/svggeometryelement/pathlength/) { get; } | 지정된 요소의 속성 pathLength에 해당합니다. |
| [PathSegList](../../aspose.svg/svgpathelement/pathseglist/) { get; set; } | SVG 구문과 일대일로 일치하는 형식으로 'd' 속성의 기본(예: 정적) 콘텐츠에 대한 액세스를 제공합니다. 따라서 'd' 속성에 "absolute moveto(M)" 및 "absolute arcto(A)" 명령이 있는 경우 pathSegList에는 SVG_PATHSEG_MOVETO_ABS 및 SVG_PATHSEG_ARC_ABS의 두 항목이 있습니다. |
...
| [CreateSVGPathSegArcAbs](../../aspose.svg/svgpathelement/createsvgpathsegarcabs/)(float, float, float, float, float, bool, bool) | 부모가 없는 독립 실행형 SVGPathSegArcAbs 개체를 반환합니다. |
| [CreateSVGPathSegArcRel](../../aspose.svg/svgpathelement/createsvgpathsegarcrel/)(float, float, float, float, float, bool, bool) | 부모가 없는 독립 실행형 SVGPathSegArcRel 개체를 반환합니다. |
| [CreateSVGPathSegClosePath](../../aspose.svg/svgpathelement/createsvgpathsegclosepath/)() | 부모가 없는 독립 실행형 SVGPathSegClosePath 개체를 반환합니다. |
| [CreateSVGPathSegCurvetoCubicAbs](../../aspose.svg/svgpathelement/createsvgpathsegcurvetocubicabs/)(float, float, float, float, float, float) | 부모가 없는 독립 실행형 SVGPathSegCurvetoCubicAbs 개체를 반환합니다. |
| [CreateSVGPathSegCurvetoCubicRel](../../aspose.svg/svgpathelement/createsvgpathsegcurvetocubicrel/)(float, float, float, float, float, float) | 부모가 없는 독립 실행형 SVGPathSegCurvetoCubicRel 개체를 반환합니다. |
| [CreateSVGPathSegCurvetoCubicSmoothAbs](../../aspose.svg/svgpathelement/createsvgpathsegcurvetocubicsmoothabs/)(float, float, float, float) | 부모가 없는 독립 실행형 SVGPathSegCurvetoCubicSmoothAbs 개체를 반환합니다. |
| [CreateSVGPathSegCurvetoCubicSmoothRel](../../aspose.svg/svgpathelement/createsvgpathsegcurvetocubicsmoothrel/)(float, float, float, float) | 부모가 없는 독립 실행형 SVGPathSegCurvetoCubicSmoothRel 개체를 반환합니다. |
| [CreateSVGPathSegCurvetoQuadraticAbs](../../aspose.svg/svgpathelement/createsvgpathsegcurvetoquadraticabs/)(float, float, float, float) | 부모가 없는 독립 실행형 SVGPathSegCurvetoQuadraticAbs 개체를 반환합니다. |
| [CreateSVGPathSegCurvetoQuadraticRel](../../aspose.svg/svgpathelement/createsvgpathsegcurvetoquadraticrel/)(float, float, float, float) | 부모가 없는 독립 실행형 SVGPathSegCurvetoQuadraticRel 개체를 반환합니다. |
| [CreateSVGPathSegCurvetoQuadraticSmoothAbs](../../aspose.svg/svgpathelement/createsvgpathsegcurvetoquadraticsmoothabs/)(float, float) | 부모가 없는 독립 실행형 SVGPathSegCurvetoQuadraticSmoothAbs 개체를 반환합니다. |
| [CreateSVGPathSegCurvetoQuadraticSmoothRel](../../aspose.svg/svgpathelement/createsvgpathsegcurvetoquadraticsmoothrel/)(float, float) | 부모가 없는 독립 실행형 SVGPathSegCurvetoQuadraticSmoothRel 개체를 반환합니다. |
| [CreateSVGPathSegLinetoAbs](../../aspose.svg/svgpathelement/createsvgpathseglinetoabs/)(float, float) | 부모가 없는 독립 실행형 SVGPathSegLinetoAbs 개체를 반환합니다. |
| [CreateSVGPathSegLinetoHorizontalAbs](../../aspose.svg/svgpathelement/createsvgpathseglinetohorizontalabs/)(float) | 부모가 없는 독립 실행형 SVGPathSegLinetoHorizontalAbs 개체를 반환합니다. |
| [CreateSVGPathSegLinetoHorizontalRel](../../aspose.svg/svgpathelement/createsvgpathseglinetohorizontalrel/)(float) | 부모가 없는 독립 실행형 SVGPathSegLinetoHorizontalRel 개체를 반환합니다. |
| [CreateSVGPathSegLinetoRel](../../aspose.svg/svgpathelement/createsvgpathseglinetorel/)(float, float) | 부모가 없는 독립 실행형 SVGPathSegLinetoRel 개체를 반환합니다. |
| [CreateSVGPathSegLinetoVerticalAbs](../../aspose.svg/svgpathelement/createsvgpathseglinetoverticalabs/)(float) | 부모가 없는 독립 실행형 SVGPathSegLinetoVerticalAbs 개체를 반환합니다. |
| [CreateSVGPathSegLinetoVerticalRel](../../aspose.svg/svgpathelement/createsvgpathseglinetoverticalrel/)(float) | 부모가 없는 독립 실행형 SVGPathSegLinetoVerticalRel 개체를 반환합니다. |
| [CreateSVGPathSegMovetoAbs](../../aspose.svg/svgpathelement/createsvgpathsegmovetoabs/)(float, float) | 부모가 없는 독립 실행형 SVGPathSegMovetoAbs 개체를 반환합니다. |
| [CreateSVGPathSegMovetoRel](../../aspose.svg/svgpathelement/createsvgpathsegmovetorel/)(float, float) | 부모가 없는 독립 실행형 SVGPathSegMovetoRel 개체를 반환합니다. |
...
| [GetEquivalentPath](../../aspose.svg/svggeometryelement/getequivalentpath/)() | 의 새 인스턴스 인스턴스를 반환합니다.[`SVGPathSegList`](../../aspose.svg.paths/svgpathseglist/) 나타내는[`SVGGeometryElement`](../svggeometryelement/) 경로 세그먼트로. |
| virtual [GetPlatformType](../../aspose.svg.dom/domobject/getplatformtype/)() | 이 메서드는 ECMAScript 개체를 검색하는 데 사용됩니다.Type . |
| [GetPointAtLength](../../aspose.svg/svggeometryelement/getpointatlength/)(float) | 사용자 에이전트의 경로를 따른 거리 알고리즘을 활용하여 경로를 따라 거리 단위인 사용자 공간의 (x,y) 좌표를 반환합니다. |
...
| [GetTotalLength](../../aspose.svg/svggeometryelement/gettotallength/)() | 사용자 에이전트의 경로별 거리 알고리즘을 사용하여 경로의 총 길이에 대한 사용자 에이전트의 계산된 값을 현재 사용자 좌표계의 거리로 반환합니다. |
