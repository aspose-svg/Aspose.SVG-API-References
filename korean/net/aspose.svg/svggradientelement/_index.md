...
description: Aspose.Svg.SVGGradientElement 수업. SVGGradientElement 인터페이스는 SVGLinearGradientElement 및 SVGRadialGradientElement에서 사용하는 기본 인터페이스입니다.
type: docs
weight: 3280
url: /ko/net/aspose.svg/svggradientelement/
---
...
| 이름 | 설명 |
| --- | --- |
| const [SVG_SPREADMETHOD_PAD](../../aspose.svg/svggradientelement/svg_spreadmethod_pad/) | 값 'pad'에 해당합니다. |
| const [SVG_SPREADMETHOD_REFLECT](../../aspose.svg/svggradientelement/svg_spreadmethod_reflect/) | 값 'reflect'에 해당합니다. |
| const [SVG_SPREADMETHOD_REPEAT](../../aspose.svg/svggradientelement/svg_spreadmethod_repeat/) | '반복' 값에 해당합니다. |
| const [SVG_SPREADMETHOD_UNKNOWN](../../aspose.svg/svggradientelement/svg_spreadmethod_unknown/) | 유형이 미리 정의된 유형 중 하나가 아닙니다. 이 유형의 새 값을 정의하거나 기존 값을 이 유형으로 전환하려는 시도는 유효하지 않습니다. |
