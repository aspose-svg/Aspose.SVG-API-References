...
description: Aspose.Svg.SVGTextPositioningElement 수업. SVGTextPositioningElement 인터페이스는 SVGTextElement SVGTSpanElement SVGTRefElement 및 SVGAltGlyphElement와 같은 텍스트 관련 인터페이스에 의해 상속됩니다.
type: docs
weight: 3550
url: /ko/net/aspose.svg/svgtextpositioningelement/
---
...
| [Dx](../../aspose.svg/svgtextpositioningelement/dx/) { get; } | 지정된 요소의 속성 'dx'에 해당합니다. |
| [Dy](../../aspose.svg/svgtextpositioningelement/dy/) { get; } | 지정된 요소의 속성 'dy'에 해당합니다. |
...
| [Rotate](../../aspose.svg/svgtextpositioningelement/rotate/) { get; } | 지정된 요소의 '회전' 속성에 해당합니다. |
...
| [X](../../aspose.svg/svgtextpositioningelement/x/) { get; } | 지정된 요소의 속성 'x'에 해당합니다. |
| [Y](../../aspose.svg/svgtextpositioningelement/y/) { get; } | 지정된 요소의 속성 'y'에 해당합니다. |
