...
description: Aspose.Svg.SVGGeometryElement 수업. 인터페이스 SVGGeometryElement는 렌더링이 동등한 경로가 있는 기하학에 의해 정의되고 채워지고 선을 칠 수 있는 SVG 요소를 나타냅니다. 여기에는 경로와 기본 모양이 포함됩니다.
type: docs
weight: 3270
url: /ko/net/aspose.svg/svggeometryelement/
---
...
| [GetEquivalentPath](../../aspose.svg/svggeometryelement/getequivalentpath/)() | 의 새 인스턴스 인스턴스를 반환합니다.[`SVGPathSegList`](../../aspose.svg.paths/svgpathseglist/) 나타내는`SVGGeometryElement` 경로 세그먼트로. |
