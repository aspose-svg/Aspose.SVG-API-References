...
description: Aspose.Svg.SVGRectElement 수업. SVGRectElement 인터페이스는 rect 요소에 해당합니다.
type: docs
weight: 3420
url: /ko/net/aspose.svg/svgrectelement/
---
...
| [Height](../../aspose.svg/svgrectelement/height/) { get; } | 지정된 'rect' 요소의 'height' 속성에 해당합니다. |
...
| [Rx](../../aspose.svg/svgrectelement/rx/) { get; } | 지정된 'rect' 요소의 속성 'rx'에 해당합니다. |
| [Ry](../../aspose.svg/svgrectelement/ry/) { get; } | 지정된 'rect' 요소의 속성 'ry'에 해당합니다. |
...
| [Width](../../aspose.svg/svgrectelement/width/) { get; } | 지정된 'rect' 요소의 'width' 속성에 해당합니다. |
| [X](../../aspose.svg/svgrectelement/x/) { get; } | 지정된 'rect' 요소의 속성 'x'에 해당합니다. |
| [Y](../../aspose.svg/svgrectelement/y/) { get; } | 지정된 'rect' 요소의 속성 'y'에 해당합니다. |
