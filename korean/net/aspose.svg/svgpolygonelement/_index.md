...
description: Aspose.Svg.SVGPolygonElement 수업. SVGPolygonElement 인터페이스는 다각형 요소에 해당합니다.
type: docs
weight: 3390
url: /ko/net/aspose.svg/svgpolygonelement/
---
...
| 이름 | 설명 |
| --- | --- |
| [AnimatedPoints](../../aspose.svg/svgpolygonelement/animatedpoints/) { get; } | '포인트' 속성의 현재 애니메이션 콘텐츠에 대한 액세스를 제공합니다. 지정된 속성 또는 속성이 애니메이션되는 경우 속성 또는 속성의 현재 애니메이션 값을 포함합니다. 지정된 속성 또는 속성이 현재 애니메이션되지 않는 경우 points. 와 동일한 값을 포함합니다. |
...
| [Points](../../aspose.svg/svgpolygonelement/points/) { get; } | '포인트' 속성의 기본(예: 정적) 콘텐츠에 대한 액세스를 제공합니다. |
