...
description: Aspose.Svg.SVGViewElement 수업. SVGViewElement 인터페이스는 view 요소에 해당합니다.
type: docs
weight: 3590
url: /ko/net/aspose.svg/svgviewelement/
---
...
| [PreserveAspectRatio](../../aspose.svg/svgviewelement/preserveaspectratio/) { get; } | 지정된 요소의 'preserveAspectRatio' 속성에 해당합니다. |
...
| [ViewBox](../../aspose.svg/svgviewelement/viewbox/) { get; } | 지정된 요소의 속성 'viewBox'에 해당합니다. |
...
| [ViewTarget](../../aspose.svg/svgviewelement/viewtarget/) { get; } | 지정된 'view' 요소의 'viewTarget' 속성에 해당합니다. 'viewTarget' 속성에 나열된 이름을 포함하는 DOMString 값 목록입니다. 각 DOMString 값은 getElementById() 메소드 호출을 사용하여 해당 요소와 연관될 수 있습니다. |
| [ZoomAndPan](../../aspose.svg/svgviewelement/zoomandpan/) { get; set; } | 지정된 요소의 'zoomAndPan' 속성에 해당합니다. 값은 이 인터페이스에 정의된 SVG_ZOOMANDPAN_* 상수 중 하나여야 합니다. |
