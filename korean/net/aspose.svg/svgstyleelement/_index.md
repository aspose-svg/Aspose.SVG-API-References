...
description: Aspose.Svg.SVGStyleElement 수업. SVGStyleElement 인터페이스는 style 요소에 해당합니다.
type: docs
weight: 3480
url: /ko/net/aspose.svg/svgstyleelement/
---
...
| [Media](../../aspose.svg/svgstyleelement/media/) { get; set; } | 지정된 요소의 속성 '미디어'에 해당합니다. |
...
| [Sheet](../../aspose.svg/svgstyleelement/sheet/) { get; } | 연결된 스타일 시트를 가져옵니다. |
...
| [Title](../../aspose.svg/svgstyleelement/title/) { get; set; } | 지정된 요소의 속성 '제목'에 해당합니다. |
| [Type](../../aspose.svg/svgstyleelement/type/) { get; set; } | 지정된 요소의 속성 '유형'에 해당합니다. |
