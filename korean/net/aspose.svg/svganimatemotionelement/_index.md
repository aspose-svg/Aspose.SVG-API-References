...
description: Aspose.Svg.SVGAnimateMotionElement 수업. SVGAnimateMotionElement 인터페이스는 animateMotion 요소에 해당합니다. SVG DOM을 통한 animateMotion 요소의 속성에 대한 객체 지향 액세스는 사용할 수 없습니다.
type: docs
weight: 3100
url: /ko/net/aspose.svg/svganimatemotionelement/
---
