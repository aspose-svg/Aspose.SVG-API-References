...
description: Aspose.Svg.SVGTextPathElement 수업. SVGTextPathElement 인터페이스는 textPath 요소에 해당합니다.
type: docs
weight: 3540
url: /ko/net/aspose.svg/svgtextpathelement/
---
...
| [Href](../../aspose.svg/svgtextpathelement/href/) { get; } | 지정된 요소의 'xlink:href' 속성에 해당합니다. |
...
| [LengthAdjust](../../aspose.svg/svgtextcontentelement/lengthadjust/) { get; } | 지정된 요소의 'lengthAdjust' 속성에 해당합니다. 값은 이 인터페이스에 정의된 길이 조정 상수 중 하나여야 합니다. |
...
| [Method](../../aspose.svg/svgtextpathelement/method/) { get; } | 지정된 'textPath' 요소의 'method' 속성에 해당합니다. |
...
| [Spacing](../../aspose.svg/svgtextpathelement/spacing/) { get; } | 지정된 'textPath' 요소의 '간격' 속성에 해당합니다. |
| [StartOffset](../../aspose.svg/svgtextpathelement/startoffset/) { get; } | 지정된 'textPath' 요소의 'startOffset' 속성에 해당합니다. |
...
| [TextLength](../../aspose.svg/svgtextcontentelement/textlength/) { get; } | 지정된 요소의 'textLength' 속성에 해당합니다. |
...
| [GetComputedTextLength](../../aspose.svg/svgtextcontentelement/getcomputedtextlength/)() | 글리프(수평 또는 수직)의 고급 값, 속성 'kerning', 'letter-spacing' 및 'word- 간격' 및 'tspan' 요소의 'dx' 및 'dy' 속성으로 인한 조정. 비 렌더링 환경의 경우 사용자 에이전트는 글리프 메트릭에 대해 합리적인 가정을 해야 합니다. |
...
| [GetNumberOfChars](../../aspose.svg/svgtextcontentelement/getnumberofchars/)() | 렌더링 여부에 관계없이 'tref' 참조에서 참조된 문자를 포함하여 현재 요소 내에서 렌더링에 사용할 수 있는 총 문자 수를 반환합니다. 사실상 이것은 DOM Level 3 Core([DOM3], 섹션 1.4)의 Node::textContent 속성 길이와 동일합니다. 해당 속성이 'tref' 요소도 확장된 경우. |
...
| 이름 | 설명 |
| --- | --- |
| const [TEXTPATH_METHODTYPE_ALIGN](../../aspose.svg/svgtextpathelement/textpath_methodtype_align/) | 값 '정렬'에 해당합니다. |
| const [TEXTPATH_METHODTYPE_STRETCH](../../aspose.svg/svgtextpathelement/textpath_methodtype_stretch/) | 값 'stretch'에 해당합니다. |
| const [TEXTPATH_METHODTYPE_UNKNOWN](../../aspose.svg/svgtextpathelement/textpath_methodtype_unknown/) | 열거형이 미리 정의된 유형 중 하나가 아닌 값으로 설정되었습니다. 이 유형의 새 값을 정의하거나 기존 값을 이 유형으로 전환하려는 시도는 유효하지 않습니다. |
| const [TEXTPATH_SPACINGTYPE_AUTO](../../aspose.svg/svgtextpathelement/textpath_spacingtype_auto/) | 값 'auto'에 해당합니다. |
| const [TEXTPATH_SPACINGTYPE_EXACT](../../aspose.svg/svgtextpathelement/textpath_spacingtype_exact/) | 값 'exact'에 해당합니다. |
| const [TEXTPATH_SPACINGTYPE_UNKNOWN](../../aspose.svg/svgtextpathelement/textpath_spacingtype_unknown/) | 열거형이 미리 정의된 유형 중 하나가 아닌 값으로 설정되었습니다. 이 유형의 새 값을 정의하거나 기존 값을 이 유형으로 전환하려는 시도는 유효하지 않습니다. |
