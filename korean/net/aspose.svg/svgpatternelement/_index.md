...
description: Aspose.Svg.SVGPatternElement 수업. SVGPatternElement 인터페이스는 패턴 요소에 해당합니다.
type: docs
weight: 3380
url: /ko/net/aspose.svg/svgpatternelement/
---
...
| [Height](../../aspose.svg/svgpatternelement/height/) { get; } | 지정된 '패턴' 요소의 '높이' 속성에 해당합니다. |
| [Href](../../aspose.svg/svgpatternelement/href/) { get; } | 지정된 요소의 'xlink:href' 속성에 해당합니다. |
...
| [PatternContentUnits](../../aspose.svg/svgpatternelement/patterncontentunits/) { get; } | 지정된 'pattern' 요소의 'patternContentUnits' 속성에 해당합니다. SVGUnitTypes. 에 정의된 상수 중 하나를 사용합니다. |
| [PatternTransform](../../aspose.svg/svgpatternelement/patterntransform/) { get; } | 지정된 'pattern' 요소의 'patternTransform' 속성에 해당합니다. |
| [PatternUnits](../../aspose.svg/svgpatternelement/patternunits/) { get; } | 지정된 'pattern' 요소의 'patternUnits' 속성에 해당합니다. SVGUnitTypes. 에 정의된 상수 중 하나를 사용합니다. |
| override [Prefix](../../aspose.svg.dom/element/prefix/) { get; } | 이 노드의 네임스페이스 접두사 또는 지정되지 않은 경우 null입니다. null로 정의했을 때 설정해도 아무런 효과가 없다 |
| [PreserveAspectRatio](../../aspose.svg/svgpatternelement/preserveaspectratio/) { get; } | 지정된 요소의 'preserveAspectRatio' 속성에 해당합니다. |
...
| [RequiredExtensions](../../aspose.svg/svgpatternelement/requiredextensions/) { get; } | 지정된 요소의 'requiredExtensions' 속성에 해당합니다. |
| [RequiredFeatures](../../aspose.svg/svgpatternelement/requiredfeatures/) { get; } | 지정된 요소의 'requiredFeatures' 속성에 해당합니다. |
...
| [SystemLanguage](../../aspose.svg/svgpatternelement/systemlanguage/) { get; } | 지정된 요소의 'systemLanguage' 속성에 해당합니다. |
...
| [ViewBox](../../aspose.svg/svgpatternelement/viewbox/) { get; } | 지정된 요소의 속성 'viewBox'에 해당합니다. |
...
| [Width](../../aspose.svg/svgpatternelement/width/) { get; } | 지정된 '패턴' 요소의 '너비' 속성에 해당합니다. |
| [X](../../aspose.svg/svgpatternelement/x/) { get; } | 지정된 '패턴' 요소의 속성 'x'에 해당합니다. |
| [Y](../../aspose.svg/svgpatternelement/y/) { get; } | 지정된 '패턴' 요소의 속성 'y'에 해당합니다. |
