...
description: Aspose.Svg.SVGLinearGradientElement 수업. SVGLinearGradientElement 인터페이스는 linearGradient 요소에 해당합니다.
type: docs
weight: 3320
url: /ko/net/aspose.svg/svglineargradientelement/
---
...
| [X1](../../aspose.svg/svglineargradientelement/x1/) { get; } | 지정된 'linearGradient' 요소의 속성 'x1'에 해당합니다. |
| [X2](../../aspose.svg/svglineargradientelement/x2/) { get; } | 지정된 'linearGradient' 요소의 속성 'x2'에 해당합니다. |
| [Y1](../../aspose.svg/svglineargradientelement/y1/) { get; } | 지정된 'linearGradient' 요소의 속성 'y1'에 해당합니다. |
| [Y2](../../aspose.svg/svglineargradientelement/y2/) { get; } | 지정된 'linearGradient' 요소의 속성 'y2'에 해당합니다. |
