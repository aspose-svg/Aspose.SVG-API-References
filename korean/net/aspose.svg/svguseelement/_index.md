...
description: Aspose.Svg.SVGUseElement 수업. SVGUseElement 인터페이스는 use 요소에 해당합니다.
type: docs
weight: 3580
url: /ko/net/aspose.svg/svguseelement/
---
## SVGUseElement class
...
| [Height](../../aspose.svg/svguseelement/height/) { get; } | 지정된 'use' 요소의 'height' 속성에 해당합니다. |
| [Href](../../aspose.svg/svguseelement/href/) { get; } | 지정된 요소의 'xlink:href' 속성에 해당합니다. |
...
| [Width](../../aspose.svg/svguseelement/width/) { get; } | 지정된 'use' 요소의 'width' 속성에 해당합니다. |
| [X](../../aspose.svg/svguseelement/x/) { get; } | 지정된 'use' 요소의 속성 'x'에 해당합니다. |
| [Y](../../aspose.svg/svguseelement/y/) { get; } | 지정된 'use' 요소의 속성 'y'에 해당합니다. |
