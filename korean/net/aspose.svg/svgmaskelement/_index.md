...
description: Aspose.Svg.SVGMaskElement 수업. SVGMaskElement 인터페이스는 마스크 요소에 해당합니다.
type: docs
weight: 3350
url: /ko/net/aspose.svg/svgmaskelement/
---
...
| [Height](../../aspose.svg/svgmaskelement/height/) { get; } | 지정된 '마스크' 요소의 '높이' 속성에 해당합니다. SVGUnitTypes. 에 정의된 상수 중 하나를 사용합니다. |
...
| [MaskContentUnits](../../aspose.svg/svgmaskelement/maskcontentunits/) { get; } | 지정된 '마스크' 요소의 'maskContentUnits' 속성에 해당합니다. SVGUnitTypes. 에 정의된 상수 중 하나를 사용합니다. |
| [MaskUnits](../../aspose.svg/svgmaskelement/maskunits/) { get; } | 지정된 'mask' 요소의 'maskUnits' 속성에 해당합니다. SVGUnitTypes. 에 정의된 상수 중 하나를 사용합니다. |
...
| [RequiredExtensions](../../aspose.svg/svgmaskelement/requiredextensions/) { get; } | 지정된 요소의 'requiredExtensions' 속성에 해당합니다. |
| [RequiredFeatures](../../aspose.svg/svgmaskelement/requiredfeatures/) { get; } | 지정된 요소의 'requiredFeatures' 속성에 해당합니다. |
...
| [SystemLanguage](../../aspose.svg/svgmaskelement/systemlanguage/) { get; } | 지정된 요소의 'systemLanguage' 속성에 해당합니다. |
...
| [Width](../../aspose.svg/svgmaskelement/width/) { get; } | 지정된 '마스크' 요소의 '너비' 속성에 해당합니다. SVGUnitTypes. 에 정의된 상수 중 하나를 사용합니다. |
| [X](../../aspose.svg/svgmaskelement/x/) { get; } | 지정된 '마스크' 요소의 속성 'x'에 해당합니다. SVGUnitTypes. 에 정의된 상수 중 하나를 사용합니다. |
| [Y](../../aspose.svg/svgmaskelement/y/) { get; } | 지정된 '마스크' 요소의 속성 'y'에 해당합니다. SVGUnitTypes. 에 정의된 상수 중 하나를 사용합니다. |
