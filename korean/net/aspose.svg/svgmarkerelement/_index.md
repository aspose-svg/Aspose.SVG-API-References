...
description: Aspose.Svg.SVGMarkerElement 수업. SVGMarkerElement 인터페이스는 marker 요소에 해당합니다.
type: docs
weight: 3340
url: /ko/net/aspose.svg/svgmarkerelement/
---
...
| [MarkerHeight](../../aspose.svg/svgmarkerelement/markerheight/) { get; } | 지정된 'marker' 요소의 'markerHeight' 속성에 해당합니다. |
| [MarkerUnits](../../aspose.svg/svgmarkerelement/markerunits/) { get; } | 지정된 'marker' 요소의 'markerUnits' 속성에 해당합니다. 이 인터페이스에 정의된 마커 단위 유형 중 하나입니다. |
| [MarkerWidth](../../aspose.svg/svgmarkerelement/markerwidth/) { get; } | 지정된 'marker' 요소의 'markerWidth' 속성에 해당합니다. |
...
| [OrientAngle](../../aspose.svg/svgmarkerelement/orientangle/) { get; } | 지정된 'marker' 요소의 'orient' 속성에 해당합니다. markerUnits가 SVG_MARKER_ORIENT_ANGLE인 경우 속성 'orient'의 각도 값입니다. 그렇지 않으면 0으로 설정됩니다. |
| [OrientType](../../aspose.svg/svgmarkerelement/orienttype/) { get; } | 지정된 'marker' 요소의 'orient' 속성에 해당합니다. 이 인터페이스에 정의된 마커 방향 유형 중 하나입니다. |
...
| [PreserveAspectRatio](../../aspose.svg/svgmarkerelement/preserveaspectratio/) { get; } | 지정된 요소의 'preserveAspectRatio' 속성에 해당합니다. |
...
| [RefX](../../aspose.svg/svgmarkerelement/refx/) { get; } | 지정된 'marker' 요소의 속성 'refX'에 해당합니다. |
| [RefY](../../aspose.svg/svgmarkerelement/refy/) { get; } | 지정된 'marker' 요소의 'refY' 속성에 해당합니다. |
...
| [ViewBox](../../aspose.svg/svgmarkerelement/viewbox/) { get; } | 지정된 요소의 속성 'viewBox'에 해당합니다. |
...
| [SetOrientToAngle](../../aspose.svg/svgmarkerelement/setorienttoangle/)(SVGAngle) | 속성 'orient'의 값을 주어진 각도로 설정합니다. |
| [SetOrientToAuto](../../aspose.svg/svgmarkerelement/setorienttoauto/)() | 'orient' 속성 값을 'auto'로 설정합니다. |
...
| 이름 | 설명 |
| --- | --- |
| const [SVG_MARKERUNITS_STROKEWIDTH](../../aspose.svg/svgmarkerelement/svg_markerunits_strokewidth/) | 속성 'markerUnits'의 값은 'strokeWidth'입니다. |
| const [SVG_MARKERUNITS_UNKNOWN](../../aspose.svg/svgmarkerelement/svg_markerunits_unknown/) | 마커 단위 유형이 미리 정의된 유형 중 하나가 아닙니다. 이 유형의 새 값을 정의하거나 기존 값을 이 유형으로 전환하려는 시도는 유효하지 않습니다. |
| const [SVG_MARKERUNITS_USERSPACEONUSE](../../aspose.svg/svgmarkerelement/svg_markerunits_userspaceonuse/) | 속성 'markerUnits'의 값은 'userSpaceOnUse'입니다. |
| const [SVG_MARKER_ORIENT_ANGLE](../../aspose.svg/svgmarkerelement/svg_marker_orient_angle/) | 속성 'orient'에 각도 값이 있습니다. |
| const [SVG_MARKER_ORIENT_AUTO](../../aspose.svg/svgmarkerelement/svg_marker_orient_auto/) | 속성 'orient'의 값은 'auto'입니다. |
| const [SVG_MARKER_ORIENT_UNKNOWN](../../aspose.svg/svgmarkerelement/svg_marker_orient_unknown/) | 마커 방향이 미리 정의된 유형 중 하나가 아닙니다. 이 유형의 새 값을 정의하거나 기존 값을 이 유형으로 전환하려는 시도는 유효하지 않습니다. |
