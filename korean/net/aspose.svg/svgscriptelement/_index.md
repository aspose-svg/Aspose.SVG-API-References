...
description: Aspose.Svg.SVGScriptElement 수업. SVGScriptElement 인터페이스는 script 요소에 해당합니다.
type: docs
weight: 3450
url: /ko/net/aspose.svg/svgscriptelement/
---
...
| [CrossOrigin](../../aspose.svg/svgscriptelement/crossorigin/) { get; set; } | 지정된 'script' 요소의 'crossorigin' 속성에 해당합니다. |
...
| [Href](../../aspose.svg/svgscriptelement/href/) { get; } | 지정된 요소의 'xlink:href' 속성에 해당합니다. |
...
| [Type](../../aspose.svg/svgscriptelement/type/) { get; set; } | 지정된 'script' 요소의 'type' 속성에 해당합니다. |
