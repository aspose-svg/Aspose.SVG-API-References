...
description: Aspose.Svg.SVGRadialGradientElement 수업. SVGRadialGradientElement 인터페이스는 radialGradient 요소에 해당합니다.
type: docs
weight: 3410
url: /ko/net/aspose.svg/svgradialgradientelement/
---
...
| [Cx](../../aspose.svg/svgradialgradientelement/cx/) { get; } | 지정된 'radialGradient' 요소의 속성 'cx'에 해당합니다. |
| [Cy](../../aspose.svg/svgradialgradientelement/cy/) { get; } | 지정된 'radialGradient' 요소의 'cy' 속성에 해당합니다. |
...
| [Fr](../../aspose.svg/svgradialgradientelement/fr/) { get; } | 지정된 'radialGradient' 요소의 속성 'fr'에 해당합니다. |
| [Fx](../../aspose.svg/svgradialgradientelement/fx/) { get; } | 지정된 'radialGradient' 요소의 속성 'fx'에 해당합니다. |
| [Fy](../../aspose.svg/svgradialgradientelement/fy/) { get; } | 지정된 'radialGradient' 요소의 속성 'fy'에 해당합니다. |
| [GradientTransform](../../aspose.svg/svggradientelement/gradienttransform/) { get; } | 지정된 요소의 'gradientTransform' 속성에 해당합니다. |
| [GradientUnits](../../aspose.svg/svggradientelement/gradientunits/) { get; } | 지정된 요소의 'gradientUnits' 속성에 해당합니다. SVGUnitTypes. 에 정의된 상수 중 하나를 사용합니다. |
| [Href](../../aspose.svg/svggradientelement/href/) { get; } | 지정된 요소의 'xlink:href' 속성에 해당합니다. |
...
| [R](../../aspose.svg/svgradialgradientelement/r/) { get; } | 지정된 'radialGradient' 요소의 속성 'r'에 해당합니다. |
...
| [SpreadMethod](../../aspose.svg/svggradientelement/spreadmethod/) { get; } | 지정된 요소의 'spreadMethod' 속성에 해당합니다. 이 인터페이스에 정의된 확산 방법 유형 중 하나입니다. |
