...
description: Aspose.Svg.SVGDocument 수업. 안SVG문서SVG 계층 구조의 루트이며 전체 콘텐츠를 보유합니다. 계층 구조에 대한 액세스를 제공하는 것 외에도 문서에서 특정 정보 세트에 액세스하기 위한 몇 가지 편리한 방법을 제공합니다. 요소가 XHTML 문서XHTML 내에 인라인으로 내장되어 있으면 SVGDocument 객체가 존재하지 않습니다. 대신 문서 객체 계층 구조의 루트 객체는 HTMLDocument 객체와 같은 다른 유형의 Document 객체가 됩니다. 그러나 XML 문서 계층 구조의 루트 요소가 svg 요소인 경우 SVGDocument 객체는 실제로 존재합니다. 예를 들어 독립형 SVG 파일예 MIME 유형이 image/svgxml인 파일을 볼 때. 이 경우 SVGDocument 객체는 문서 객체 모델 계층 구조의 루트 객체가 됩니다.
type: docs
weight: 3190
url: /ko/net/aspose.svg/svgdocument/
---
## SVGDocument class
...
| [SVGDocument](svgdocument/#constructor_2)(RequestMessage) | 의 새 인스턴스를 초기화합니다.`SVGDocument`수업. 생성자는 동기적으로 작동하며 모든 외부 리소스(이미지, 스크립트 등)의 로드를 기다립니다. 문서를 비동기적으로 로드하려면 메소드를 사용하십시오.[`Navigate`](../../aspose.svg.dom/document/navigate/) 또는 과부하. 또는 다음에서 적절한 플래그를 설정하여 일부 외부 리소스의 로드를 비활성화할 수 있습니다.[`Security`](../../aspose.svg.dom/ibrowsingcontext/security/) . |
| [SVGDocument](svgdocument/#constructor_10)(string) | 의 새 인스턴스를 초기화합니다.`SVGDocument`수업. 생성자는 동기적으로 작동하며 모든 외부 리소스(이미지, 스크립트 등)의 로드를 기다립니다. 문서를 비동기적으로 로드하려면 메소드를 사용하십시오.[`Navigate`](../../aspose.svg.dom/document/navigate/) 또는 과부하. 또는 다음에서 적절한 플래그를 설정하여 일부 외부 리소스의 로드를 비활성화할 수 있습니다.[`Security`](../../aspose.svg.dom/ibrowsingcontext/security/) . |
| [SVGDocument](svgdocument/#constructor_4)(Url) | 의 새 인스턴스를 초기화합니다.`SVGDocument`수업. 생성자는 동기적으로 작동하며 모든 외부 리소스(이미지, 스크립트 등)의 로드를 기다립니다. 문서를 비동기적으로 로드하려면 메소드를 사용하십시오.[`Navigate`](../../aspose.svg.dom/document/navigate/) 또는 과부하. 또는 다음에서 적절한 플래그를 설정하여 일부 외부 리소스의 로드를 비활성화할 수 있습니다.[`Security`](../../aspose.svg.dom/ibrowsingcontext/security/) . |
| [SVGDocument](svgdocument/#constructor_3)(RequestMessage, Configuration) | 의 새 인스턴스를 초기화합니다.`SVGDocument`수업. 생성자는 동기적으로 작동하며 모든 외부 리소스(이미지, 스크립트 등)의 로드를 기다립니다. 문서를 비동기적으로 로드하려면 메소드를 사용하십시오.[`Navigate`](../../aspose.svg.dom/document/navigate/) 또는 과부하. 또는 다음에서 적절한 플래그를 설정하여 일부 외부 리소스의 로드를 비활성화할 수 있습니다.[`Security`](../../aspose.svg.dom/ibrowsingcontext/security/) . |
| [SVGDocument](svgdocument/#constructor_8)(Stream, string) | 의 새 인스턴스를 초기화합니다.`SVGDocument`수업. 생성자는 동기적으로 작동하며 모든 외부 리소스(이미지, 스크립트 등)의 로드를 기다립니다. 문서를 비동기적으로 로드하려면 메소드를 사용하십시오.[`Navigate`](../../aspose.svg.dom/document/navigate/) 또는 과부하. 또는 다음에서 적절한 플래그를 설정하여 일부 외부 리소스의 로드를 비활성화할 수 있습니다.[`Security`](../../aspose.svg.dom/ibrowsingcontext/security/) . 스트림의 현재 위치에서 문서 로드가 시작됩니다. |
| [SVGDocument](svgdocument/#constructor_6)(Stream, Url) | 의 새 인스턴스를 초기화합니다.`SVGDocument`수업. 생성자는 동기적으로 작동하며 모든 외부 리소스(이미지, 스크립트 등)의 로드를 기다립니다. 문서를 비동기적으로 로드하려면 메소드를 사용하십시오.[`Navigate`](../../aspose.svg.dom/document/navigate/) 또는 과부하. 또는 다음에서 적절한 플래그를 설정하여 일부 외부 리소스의 로드를 비활성화할 수 있습니다.[`Security`](../../aspose.svg.dom/ibrowsingcontext/security/) . 스트림의 현재 위치에서 문서 로드가 시작됩니다. |
| [SVGDocument](svgdocument/#constructor_11)(string, Configuration) | 의 새 인스턴스를 초기화합니다.`SVGDocument`수업. 생성자는 동기적으로 작동하며 모든 외부 리소스(이미지, 스크립트 등)의 로드를 기다립니다. 문서를 비동기적으로 로드하려면 메소드를 사용하십시오.[`Navigate`](../../aspose.svg.dom/document/navigate/) 또는 과부하. 또는 다음에서 적절한 플래그를 설정하여 일부 외부 리소스의 로드를 비활성화할 수 있습니다.[`Security`](../../aspose.svg.dom/ibrowsingcontext/security/) . |
| [SVGDocument](svgdocument/#constructor_14)(string, string) | 의 새 인스턴스를 초기화합니다.`SVGDocument`수업. 생성자는 동기적으로 작동하며 모든 외부 리소스(이미지, 스크립트 등)의 로드를 기다립니다. 문서를 비동기적으로 로드하려면 메소드를 사용하십시오.[`Navigate`](../../aspose.svg.dom/document/navigate/) 또는 과부하. 또는 다음에서 적절한 플래그를 설정하여 일부 외부 리소스의 로드를 비활성화할 수 있습니다.[`Security`](../../aspose.svg.dom/ibrowsingcontext/security/) . |
| [SVGDocument](svgdocument/#constructor_12)(string, Url) | 의 새 인스턴스를 초기화합니다.`SVGDocument`수업. 생성자는 동기적으로 작동하며 모든 외부 리소스(이미지, 스크립트 등)의 로드를 기다립니다. 문서를 비동기적으로 로드하려면 메소드를 사용하십시오.[`Navigate`](../../aspose.svg.dom/document/navigate/) 또는 과부하. 또는 다음에서 적절한 플래그를 설정하여 일부 외부 리소스의 로드를 비활성화할 수 있습니다.[`Security`](../../aspose.svg.dom/ibrowsingcontext/security/) . |
| [SVGDocument](svgdocument/#constructor_5)(Url, Configuration) | 의 새 인스턴스를 초기화합니다.`SVGDocument`수업. 생성자는 동기적으로 작동하며 모든 외부 리소스(이미지, 스크립트 등)의 로드를 기다립니다. 문서를 비동기적으로 로드하려면 메소드를 사용하십시오.[`Navigate`](../../aspose.svg.dom/document/navigate/) 또는 과부하. 또는 다음에서 적절한 플래그를 설정하여 일부 외부 리소스의 로드를 비활성화할 수 있습니다.[`Security`](../../aspose.svg.dom/ibrowsingcontext/security/) . |
| [SVGDocument](svgdocument/#constructor_9)(Stream, string, Configuration) | 의 새 인스턴스를 초기화합니다.`SVGDocument`수업. 생성자는 동기적으로 작동하며 모든 외부 리소스(이미지, 스크립트 등)의 로드를 기다립니다. 문서를 비동기적으로 로드하려면 메소드를 사용하십시오.[`Navigate`](../../aspose.svg.dom/document/navigate/) 또는 과부하. 또는 다음에서 적절한 플래그를 설정하여 일부 외부 리소스의 로드를 비활성화할 수 있습니다.[`Security`](../../aspose.svg.dom/ibrowsingcontext/security/) . 스트림의 현재 위치에서 문서 로드가 시작됩니다. |
| [SVGDocument](svgdocument/#constructor_7)(Stream, Url, Configuration) | 의 새 인스턴스를 초기화합니다.`SVGDocument`수업. 생성자는 동기적으로 작동하며 모든 외부 리소스(이미지, 스크립트 등)의 로드를 기다립니다. 문서를 비동기적으로 로드하려면 메소드를 사용하십시오.[`Navigate`](../../aspose.svg.dom/document/navigate/) 또는 과부하. 또는 다음에서 적절한 플래그를 설정하여 일부 외부 리소스의 로드를 비활성화할 수 있습니다.[`Security`](../../aspose.svg.dom/ibrowsingcontext/security/) . 스트림의 현재 위치에서 문서 로드가 시작됩니다. |
| [SVGDocument](svgdocument/#constructor_15)(string, string, Configuration) | 의 새 인스턴스를 초기화합니다.`SVGDocument`수업. 생성자는 동기적으로 작동하며 모든 외부 리소스(이미지, 스크립트 등)의 로드를 기다립니다. 문서를 비동기적으로 로드하려면 메소드를 사용하십시오.[`Navigate`](../../aspose.svg.dom/document/navigate/) 또는 과부하. 또는 다음에서 적절한 플래그를 설정하여 일부 외부 리소스의 로드를 비활성화할 수 있습니다.[`Security`](../../aspose.svg.dom/ibrowsingcontext/security/) . |
| [SVGDocument](svgdocument/#constructor_13)(string, Url, Configuration) | 의 새 인스턴스를 초기화합니다.`SVGDocument`수업. 생성자는 동기적으로 작동하며 모든 외부 리소스(이미지, 스크립트 등)의 로드를 기다립니다. 문서를 비동기적으로 로드하려면 메소드를 사용하십시오.[`Navigate`](../../aspose.svg.dom/document/navigate/) 또는 과부하. 또는 다음에서 적절한 플래그를 설정하여 일부 외부 리소스의 로드를 비활성화할 수 있습니다.[`Security`](../../aspose.svg.dom/ibrowsingcontext/security/) . |
...
| [Domain](../../aspose.svg/svgdocument/domain/) { get; } | 문서를 제공한 서버의 도메인 이름 또는 도메인 이름으로 서버를 식별할 수 없는 경우 null 문자열입니다. |
...
| [Referrer](../../aspose.svg/svgdocument/referrer/) { get; } | 이 페이지에 연결된 페이지의 URI를 반환합니다. 사용자가 페이지로 직접 이동한 경우 값은 빈 문자열입니다(링크가 아니라 예를 들어 책갈피를 통해). |
| [RootElement](../../aspose.svg/svgdocument/rootelement/) { get; } | 문서 계층 구조의 루트 'svg'입니다. |
...
| [Title](../../aspose.svg/svgdocument/title/) { get; } | 'svg' 루트 요소의 'title' 하위 요소(즉,여기 제목이 있습니다... ) |
| [URL](../../aspose.svg/svgdocument/url/) { get; } | 문서의 전체 URI입니다. |
...
| [CreateNodeIterator](../../aspose.svg.dom/document/createnodeiterator/)(Node) | 지정한 노드 에 뿌리를 둔 하위 트리에 새 NodeIterator를 만듭니다. |
| [CreateNodeIterator](../../aspose.svg.dom/document/createnodeiterator/)(Node, long) | 지정한 노드 에 뿌리를 둔 하위 트리에 새 NodeIterator를 만듭니다. |
| [CreateNodeIterator](../../aspose.svg.dom/document/createnodeiterator/)(Node, long, INodeFilter) | 지정한 노드 에 뿌리를 둔 하위 트리에 새 NodeIterator를 만듭니다. |
...
| [CreateTreeWalker](../../aspose.svg.dom/document/createtreewalker/)(Node) | 지정한 노드 에 뿌리를 둔 하위 트리에 새 TreeWalker를 만듭니다. |
| [CreateTreeWalker](../../aspose.svg.dom/document/createtreewalker/)(Node, long) | 지정한 노드 에 뿌리를 둔 하위 트리에 새 TreeWalker를 만듭니다. |
| [CreateTreeWalker](../../aspose.svg.dom/document/createtreewalker/)(Node, long, INodeFilter) | 지정한 노드 에 뿌리를 둔 하위 트리에 새 TreeWalker를 만듭니다. |
...
| [GetOverrideStyle](../../aspose.svg/svgdocument/getoverridestyle/)(Element, string) | 이 메서드는 지정된 요소 및 지정된 의사 요소에 대한 재정의 스타일 선언을 검색하는 데 사용됩니다. |
...
| [Navigate](../../aspose.svg.dom/document/navigate/)(RequestMessage) | 지정된 요청 개체를 기반으로 문서를 로드하여 이전 내용을 바꿉니다. |
| [Navigate](../../aspose.svg.dom/document/navigate/)(string) | 지정된 URL(Uniform Resource Locator)의 문서를 현재 인스턴스로 로드하여 이전 콘텐츠를 바꿉니다. |
| [Navigate](../../aspose.svg.dom/document/navigate/)(Url) | 지정된 URL(Uniform Resource Locator)의 문서를 현재 인스턴스로 로드하여 이전 콘텐츠를 바꿉니다. |
| [Navigate](../../aspose.svg.dom/document/navigate/)(Stream, string) | 지정된 콘텐츠에서 문서를 로드하고 baseUri를 사용하여 상대 리소스를 확인하고 이전 콘텐츠를 바꿉니다. 문서 로드는 스트림의 현재 위치에서 시작됩니다. |
| [Navigate](../../aspose.svg.dom/document/navigate/)(Stream, Url) | 지정된 콘텐츠에서 문서를 로드하고 baseUri를 사용하여 상대 리소스를 확인하고 이전 콘텐츠를 바꿉니다. 문서 로드는 스트림의 현재 위치에서 시작됩니다. |
| [Navigate](../../aspose.svg.dom/document/navigate/)(string, string) | 지정된 콘텐츠에서 문서를 로드하고 baseUri를 사용하여 관련 리소스를 확인하여 이전 콘텐츠를 바꿉니다. |
| [Navigate](../../aspose.svg.dom/document/navigate/)(string, Url) | 지정된 콘텐츠에서 문서를 로드하고 baseUri를 사용하여 관련 리소스를 확인하여 이전 콘텐츠를 바꿉니다. |
...
| override [RenderTo](../../aspose.svg/svgdocument/renderto/)(IDevice) | 이 메서드는 현재 문서의 내용을 지정된 장치로 인쇄하는 데 사용됩니다. |
...
| [Save](../../aspose.svg/svgdocument/save/#save)(IOutputStorage) | 문서 콘텐츠 및 리소스를 출력 저장소에 저장합니다. |
| [Save](../../aspose.svg/svgdocument/save/#save_6)(string) | 지정된 로컬 파일에 문서를 저장합니다.`길` . 이 문서에 사용된 모든 리소스는 에 인접한 폴더에 저장되며 이름은 output_file_name + "_files". 로 구성됩니다. |
| [Save](../../aspose.svg/svgdocument/save/#save_3)(Url) | 지정된 로컬 파일에 문서를 저장합니다.`URL` . 이 문서에 사용된 모든 리소스는 에 인접한 폴더에 저장되며 이름은 output_file_name + "_files". 로 구성됩니다. |
| [Save](../../aspose.svg/svgdocument/save/#save_1)(IOutputStorage, SVGSaveFormat) | 문서 콘텐츠 및 리소스를 출력 저장소에 저장합니다. |
| [Save](../../aspose.svg/svgdocument/save/#save_2)(IOutputStorage, SVGSaveOptions) | 문서 콘텐츠 및 리소스를 출력 저장소에 저장합니다. |
| [Save](../../aspose.svg/svgdocument/save/#save_7)(string, SVGSaveFormat) | 지정된 로컬 파일에 문서를 저장합니다.`길` . 이 문서에 사용된 모든 리소스는 에 인접한 폴더에 저장되며 이름은 output_file_name + "_files". 로 구성됩니다. |
| [Save](../../aspose.svg/svgdocument/save/#save_8)(string, SVGSaveOptions) | 지정된 로컬 파일에 문서를 저장합니다.`길` . 이 문서에 사용된 모든 리소스는 에 인접한 폴더에 저장되며 이름은 output_file_name + "_files". 로 구성됩니다. |
| [Save](../../aspose.svg/svgdocument/save/#save_4)(Url, SVGSaveFormat) | 지정된 로컬 파일에 문서를 저장합니다.`URL` . 이 문서에 사용된 모든 리소스는 에 인접한 폴더에 저장되며 이름은 output_file_name + "_files". 로 구성됩니다. |
| [Save](../../aspose.svg/svgdocument/save/#save_5)(Url, SVGSaveOptions) | 지정된 로컬 파일에 문서를 저장합니다.`URL` . 이 문서에 사용된 모든 리소스는 에 인접한 폴더에 저장되며 이름은 output_file_name + "_files". 로 구성됩니다. |
