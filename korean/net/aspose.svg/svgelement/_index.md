...
description: Aspose.Svg.SVGElement 수업. SVG 언어의 요소에 직접 해당하는 모든 SVG DOM 인터페이스예 경로 요소에 대한 SVGPathElement 인터페이스는 SVGElement 인터페이스에서 파생됩니다.
type: docs
weight: 3200
url: /ko/net/aspose.svg/svgelement/
---
## SVGElement class
