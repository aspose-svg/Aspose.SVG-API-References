...
description: Aspose.Svg.SVGClipPathElement 수업. SVGClipPathElement 인터페이스는 clipPath 요소에 해당합니다.
type: docs
weight: 3140
url: /ko/net/aspose.svg/svgclippathelement/
---
...
| [ClipPathUnits](../../aspose.svg/svgclippathelement/clippathunits/) { get; } | 지정된 'clipPath' 요소의 'clipPathUnits' 속성에 해당합니다. SVGUnitTypes. 에 정의된 상수 중 하나를 사용합니다. |
...
| [Transform](../../aspose.svg/svgclippathelement/transform/) { get; } | 지정된 요소의 '변환' 속성에 해당합니다. |
