...
description: Aspose.Svg.DataTypes.SVGAnimatedInteger 수업. 애니메이션할 수 있는 기본 유형 정수의 속성에 사용됩니다.
type: docs
weight: 120
url: /ko/net/aspose.svg.datatypes/svganimatedinteger/
---
## SVGAnimatedInteger class

애니메이션할 수 있는 기본 유형 정수의 속성에 사용됩니다.
...
| override [ToString](../../aspose.svg.datatypes/svganimatedinteger/tostring/)() | 반환String 이 instance. 를 나타냅니다. |
