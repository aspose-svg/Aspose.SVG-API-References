...
description: Aspose.Svg.DataTypes.SVGAnimatedTransformList 수업. 많은 SVG 요소에 사용할 수 있고 애니메이션을 적용할 수 있는 변형 속성과 같은 변형 집합을 지정하는 다양한 속성에 사용됩니다.
type: docs
weight: 200
url: /ko/net/aspose.svg.datatypes/svganimatedtransformlist/
---
## SVGAnimatedTransformList class

많은 SVG 요소에 사용할 수 있고 애니메이션을 적용할 수 있는 '변형' 속성과 같은 변형 집합을 지정하는 다양한 속성에 사용됩니다.
...
| override [ToString](../../aspose.svg.datatypes/svganimatedtransformlist/tostring/)() | 반환String 이 instance. 를 나타냅니다. |
