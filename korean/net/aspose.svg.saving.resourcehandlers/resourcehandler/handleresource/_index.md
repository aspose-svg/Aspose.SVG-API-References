...
description: "ResourceHandler HandleResource 메서드. 이 메서드는 리소스를 처리하는 역할을 합니다. 여기서 리소스를 스트림에 저장하거나 상위 리소스에 포함시킬 수 있습니다."
type: docs
weight: 10
url: /ko/net/aspose.svg.saving.resourcehandlers/resourcehandler/handleresource/
---
## ResourceHandler.HandleResource method

이 메서드는 리소스를 처리하는 역할을 합니다. 여기서 [`Resource`](../../../aspose.svg.saving/resource/)를 스트림에 저장하거나 상위 리소스에 포함시킬 수 있습니다.
