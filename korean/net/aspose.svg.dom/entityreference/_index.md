...
description: Aspose.Svg.Dom.EntityReference 수업. EntityReference 노드는 트리에서 엔티티 참조를 나타내는 데 사용될 수 있습니다.
type: docs
weight: 860
url: /ko/net/aspose.svg.dom/entityreference/
---
...
| override [NodeName](../../aspose.svg.dom/entityreference/nodename/) { get; } | 유형에 따라 이 노드의 이름입니다. |
| override [NodeType](../../aspose.svg.dom/entityreference/nodetype/) { get; } | 기본 개체의 유형을 나타내는 코드입니다. |
