...
description: Aspose.Svg.Dom.Comment 수업. CharacterData에서 상속되고 주석의 내용 즉 시작  사이의 모든 문자를 나타냅니다. .
type: docs
weight: 460
url: /ko/net/aspose.svg.dom/comment/
---
## Comment class
...
| override [NodeName](../../aspose.svg.dom/comment/nodename/) { get; } | 유형에 따라 이 노드의 이름입니다. |
| override [NodeType](../../aspose.svg.dom/comment/nodetype/) { get; } | 기본 개체의 유형을 나타내는 코드입니다. |
| override [NodeValue](../../aspose.svg.dom/comment/nodevalue/) { get; set; } | 유형에 따라 이 노드의 값입니다. |
...
| override [TextContent](../../aspose.svg.dom/comment/textcontent/) { get; set; } | 이 속성은 이 노드와 그 자손의 텍스트 내용을 반환합니다. null로 정의된 경우 설정해도 아무런 효과가 없습니다. 설정 시 이 노드가 가질 수 있는 모든 가능한 자식이 제거되고 새 문자열이 비어 있거나 null이 아닌 경우 이 속성이 설정된 문자열을 포함하는 단일 텍스트 노드로 대체됩니다. |
