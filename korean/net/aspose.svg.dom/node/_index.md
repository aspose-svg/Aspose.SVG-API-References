...
description: Aspose.Svg.Dom.Node 수업. Node 인터페이스는 전체 문서 개체 모델의 기본 데이터 유형입니다. 문서 트리에서 단일 노드를 나타냅니다.
type: docs
weight: 1150
url: /ko/net/aspose.svg.dom/node/
---
## Node class
...
| abstract [NodeName](../../aspose.svg.dom/node/nodename/) { get; } | 유형에 따라 이 노드의 이름입니다. |
| abstract [NodeType](../../aspose.svg.dom/node/nodetype/) { get; } | 기본 개체의 유형을 나타내는 코드입니다. |
...
| [CloneNode](../../aspose.svg.dom/node/clonenode/#clonenode)() | 이 노드의 복제본을 반환합니다. 즉, 노드의 일반 복사 생성자 역할을 합니다. 중복 노드에는 부모가 없고(parentNode는 null임) 사용자 데이터가 없습니다. |
| [CloneNode](../../aspose.svg.dom/node/clonenode/#clonenode_1)(bool) | 이 노드의 복제본을 반환합니다. 즉, 노드의 일반 복사 생성자 역할을 합니다. 중복 노드에는 부모가 없고(parentNode는 null임) 사용자 데이터가 없습니다. |
...
| 이름 | 설명 |
| --- | --- |
| const [ATTRIBUTE_NODE](../../aspose.svg.dom/node/attribute_node/) | 속성 node |
| const [CDATA_SECTION_NODE](../../aspose.svg.dom/node/cdata_section_node/) | cdata 섹션 node |
| const [COMMENT_NODE](../../aspose.svg.dom/node/comment_node/) | 주석 node |
| const [DOCUMENT_FRAGMENT_NODE](../../aspose.svg.dom/node/document_fragment_node/) | 문서 조각 node |
| const [DOCUMENT_NODE](../../aspose.svg.dom/node/document_node/) | 문서 node |
| const [DOCUMENT_TYPE_NODE](../../aspose.svg.dom/node/document_type_node/) | 문서 유형 node |
| const [ELEMENT_NODE](../../aspose.svg.dom/node/element_node/) | 요소 node |
| const [ENTITY_NODE](../../aspose.svg.dom/node/entity_node/) | 엔티티 node |
| const [ENTITY_REFERENCE_NODE](../../aspose.svg.dom/node/entity_reference_node/) | 엔터티 참조 node |
| const [NOTATION_NODE](../../aspose.svg.dom/node/notation_node/) | 표기 node |
| const [PROCESSING_INSTRUCTION_NODE](../../aspose.svg.dom/node/processing_instruction_node/) | 처리 명령 node |
| const [TEXT_NODE](../../aspose.svg.dom/node/text_node/) | 텍스트 node |
