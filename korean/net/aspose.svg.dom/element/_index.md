...
description: Aspose.Svg.Dom.Element 수업. 요소 인터페이스는 HTML 또는 XML 문서의 요소를 나타냅니다.
type: docs
weight: 840
url: /ko/net/aspose.svg.dom/element/
---
## Element class
...
| [Id](../../aspose.svg.dom/element/id/) { get; set; } | 요소의 식별자입니다. HTML 4.01. 의 id 속성 정의를 참조하십시오. |
...
| [ParentElement](../../aspose.svg.dom/node/parentelement/) { get; } | 부모를 가져옵니다`Element` 이 노드의. |
