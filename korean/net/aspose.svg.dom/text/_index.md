...
description: Aspose.Svg.Dom.Text 수업. Text 인터페이스는 CharacterData에서 상속하고 요소 또는 Attr. 의 텍스트 콘텐츠XML에서 문자 데이터라고 함를 나타냅니다.
type: docs
weight: 1200
url: /ko/net/aspose.svg.dom/text/
---
## Text class
...
| override [NodeName](../../aspose.svg.dom/text/nodename/) { get; } | 유형에 따라 이 노드의 이름입니다. |
| override [NodeType](../../aspose.svg.dom/text/nodetype/) { get; } | 기본 개체의 유형을 나타내는 코드입니다. |
