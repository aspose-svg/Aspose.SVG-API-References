...
description: Aspose.Svg.Dom.ProcessingInstruction 수업. ProcessingInstruction은 문서의 텍스트에 프로세서별 정보를 유지하는 방법으로 XML에서 사용되는 처리 명령을 나타냅니다.
type: docs
weight: 1170
url: /ko/net/aspose.svg.dom/processinginstruction/
---
...
| override [NodeName](../../aspose.svg.dom/processinginstruction/nodename/) { get; } | 유형에 따라 이 노드의 이름입니다. |
| override [NodeType](../../aspose.svg.dom/processinginstruction/nodetype/) { get; } | 기본 개체의 유형을 나타내는 코드입니다. |
| override [NodeValue](../../aspose.svg.dom/processinginstruction/nodevalue/) { get; set; } | 유형에 따라 이 노드의 값입니다. |
...
| [Target](../../aspose.svg.dom/processinginstruction/target/) { get; } | 이 처리 명령의 대상입니다. |
| override [TextContent](../../aspose.svg.dom/processinginstruction/textcontent/) { get; set; } | 이 속성은 이 노드와 그 자손의 텍스트 내용을 반환합니다. null로 정의된 경우 설정해도 아무런 효과가 없습니다. 설정 시 이 노드가 가질 수 있는 모든 가능한 자식이 제거되고 새 문자열이 비어 있거나 null이 아닌 경우 이 속성이 설정된 문자열을 포함하는 단일 텍스트 노드로 대체됩니다. |
