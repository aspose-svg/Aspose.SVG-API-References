...
description: Aspose.Svg.Dom.Entity 수업. XML 문서에서 구문 분석되거나 구문 분석되지 않은 알려진 엔터티를 나타냅니다.
type: docs
weight: 850
url: /ko/net/aspose.svg.dom/entity/
---
## Entity class
...
| [InputEncoding](../../aspose.svg.dom/entity/inputencoding/) { get; } | 외부 구문 분석 엔터티인 경우 구문 분석 시 이 엔터티에 사용되는 인코딩을 지정하는 속성입니다. 내부 하위 집합의 엔터티이거나 알 수 없는 경우 null입니다. |
...
| override [NodeName](../../aspose.svg.dom/entity/nodename/) { get; } | 유형에 따라 이 노드의 이름입니다. |
| override [NodeType](../../aspose.svg.dom/entity/nodetype/) { get; } | 기본 개체의 유형을 나타내는 코드입니다. |
| virtual [NodeValue](../../aspose.svg.dom/node/nodevalue/) { get; set; } | 유형에 따라 이 노드의 값입니다. |
| [NotationName](../../aspose.svg.dom/entity/notationname/) { get; } | 구문 분석되지 않은 엔터티의 경우 엔터티 표기법의 이름입니다. 구문 분석된 엔터티의 경우 null입니다. |
...
| [PublicId](../../aspose.svg.dom/entity/publicid/) { get; } | 지정된 경우 엔터티와 연결된 공용 식별자이고 그렇지 않으면 null입니다. |
| [SystemId](../../aspose.svg.dom/entity/systemid/) { get; } | 지정된 경우 엔터티와 연결된 시스템 식별자이고 그렇지 않은 경우 null입니다. 절대 URI일 수도 있고 아닐 수도 있습니다. |
...
| [XmlEncoding](../../aspose.svg.dom/entity/xmlencoding/) { get; } | 이 엔터티가 구문 분석된 외부 엔터티인 경우 텍스트 선언의 일부로 이 엔터티의 인코딩을 지정하는 속성입니다. 그렇지 않으면 null입니다. |
| [XmlVersion](../../aspose.svg.dom/entity/xmlversion/) { get; } | 이 엔터티가 구문 분석된 외부 엔터티인 경우 텍스트 선언의 일부로 이 엔터티의 버전 번호를 지정하는 속성입니다. 그렇지 않으면 null입니다. |
