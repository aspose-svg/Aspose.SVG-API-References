...
description: Aspose.Svg.Dom.Events.CustomEvent 수업. CustomEvent 인터페이스를 사용하는 이벤트는 사용자 지정 데이터를 전달하는 데 사용할 수 있습니다.
type: docs
weight: 880
url: /ko/net/aspose.svg.dom.events/customevent/
---
## CustomEvent class
...
| [Detail](../../aspose.svg.dom.events/customevent/detail/) { get; } | 사용자 지정 데이터를 가져옵니다. |
...
| [InitCustomEvent](../../aspose.svg.dom.events/customevent/initcustomevent/)(string, bool, bool, object) | ///[`InitEvent`](../event/initevent/) 메서드는 값을 초기화하는 데 사용됩니다.[`Event`](../event/) 를 통해 생성된[`IDocumentEvent`](../idocumentevent/) 인터페이스. |
