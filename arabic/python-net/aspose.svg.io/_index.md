...
type: docs
weight: 10
url: /ar/python-net/aspose.svg.io/
is_root: false
---
...
| Class | Description |
| :- | :- |
| [`FileCreateStreamProvider`](/svg/python-net/aspose.svg.io/filecreatestreamprovider) | Represents FileStream implementation for providing streams to the rendering devices. |
| [`IBlob`](/svg/python-net/aspose.svg.io/iblob) | A Blob object refers to a byte sequence, and has a size attribute which is the total number of bytes in the byte sequence, and a type attribute, which is an ASCII-encoded string in lower case representing the media type of the byte sequence. |
