...
description: تاريخ آخر تعديل للملف. عند الحصول  إذا كان بإمكان وكلاء المستخدم إتاحة هذه المعلومات  يجب أن يعيد هذا مجموعة طويلة إلى الوقت الذي تم فيه تعديل الملف آخر مرة على أنه عدد المللي ثانية منذ عهد يونكس.
type: docs
weight: 10
