...
description: تخطي هذه العقدة المفردة. طرق التنقل المحددة لـ لن تقوم NodeIterator أو TreeWalker بإرجاع هذه العقدة. لكل من NodeIterator و TreeWalker  سيظل اعتبار العناصر الفرعية لهذه العقدة .
type: docs
weight: 50
