---
title: "فئة ImageDevice"
second_title: "مرجع API لـ Aspose.SVG لـ .NET"
description: "فئة Aspose.Svg.Rendering.Image.ImageDevice. تمثل عملية التصيير إلى صيغ نقطية jpeg png bmp gif tiff."
type: docs
weight: 4910
...
يمثل العرض إلى صيغ الرسوم النقطية: jpeg, png, bmp, gif, tiff.
...
| الاسم | الوصف |
| --- | --- |
| [ImageDevice](imagedevice/#constructor)(*[ICreateStreamProvider](../../aspose.svg.io/icreatestreamprovider/)*) | يُنشئ مثيلًا جديدًا لفئة `ImageDevice`. |
| [ImageDevice](imagedevice/#constructor_4)(*Stream*) | يُنشئ مثيلًا جديدًا لفئة `ImageDevice`. |
| [ImageDevice](imagedevice/#constructor_5)(*string*) | يُنشئ مثيلًا جديدًا لفئة `ImageDevice`. |
| [ImageDevice](imagedevice/#constructor_1)(*[ImageRenderingOptions](../imagerenderingoptions/), [ICreateStreamProvider](../../aspose.svg.io/icreatestreamprovider/)*) | يُنشئ مثيلًا جديدًا لفئة `ImageDevice` باستخدام خيارات التصيير ومزود الدفق. |
| [ImageDevice](imagedevice/#constructor_2)(*[ImageRenderingOptions](../imagerenderingoptions/), Stream*) | يُنشئ مثيلًا جديدًا لفئة `ImageDevice` باستخدام خيارات التصيير وتدفق الإخراج. |
| [ImageDevice](imagedevice/#constructor_3)(*[ImageRenderingOptions](../imagerenderingoptions/), string*) | يُنشئ مثيلًا جديدًا لفئة `ImageDevice` باستخدام خيارات التصيير واسم ملف الإخراج. |
...
| الاسم | الوصف |
| --- | --- |
| class [ImageGraphicContext](../../aspose.svg.rendering.image/imagedevice.imagegraphiccontext) | يحفظ معلمات التحكم الرسومية الحالية لـ `ImageDevice`. تُعرّف هذه المعلمات الإطار العالمي الذي تنفّذ ضمنه عمليات الرسوميات. |
