...
description: Aspose.Svg.Dom.Traversal.INodeFilter واجهه المستخدم. المرشحات هي كائنات تعرف كيفية تصفية العقد. إذا تم إعطاء NodeIterator أو TreeWalker NodeFilter  فإنه يطبق عامل التصفية قبل إرجاع العقدة التالية . إذا طلب عامل التصفية قبول العقدة  فسيعيد منطق الاجتياز it وبخلاف ذلك  يبحث الاجتياز عن العقدة التالية ويتظاهر بأن العقدة التي تم رفضها لم تكن موجودة.
type: docs
weight: 1240
