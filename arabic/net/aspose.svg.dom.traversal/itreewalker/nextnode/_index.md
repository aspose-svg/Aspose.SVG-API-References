...
description: ينقل TreeWalker إلى العقدة المرئية التالية بترتيب document المتعلق بالعقدة الحالية  ويعيد العقدة الجديدة. إذا لم يكن للعقدة الحالية عقدة تالية  أو إذا كان البحث عن nextNode try للانتقال لأعلى من عقدة root لـ TreeWalker  فتُرجع قيمة فارغة  وتحتفظ بالعقدة الحالية.
type: docs
weight: 40
