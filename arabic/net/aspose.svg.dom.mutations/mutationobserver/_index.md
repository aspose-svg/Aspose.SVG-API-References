...
description: أMutationObserver./mutationobserver يمكن استخدام الكائن لمراقبة الطفرات في شجرةNode../aspose.svg.dom/node .
type: docs
weight: 1120
...
أ[`MutationObserver`](../mutationobserver) يمكن استخدام الكائن لمراقبة الطفرات في شجرة[`Node`](../../aspose.svg.dom/node) .
