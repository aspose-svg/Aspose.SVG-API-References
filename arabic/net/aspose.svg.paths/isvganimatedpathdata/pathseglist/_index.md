...
description: يوفر الوصول إلى المحتويات الأساسية أي الثابتة للسمة d في نموذج يطابق واحدًا لواحد مع صيغة SVG. وبالتالي  إذا كانت السمة d تحتوي على أمر الحركة المطلقة M وأمر arcto A المطلق  فسيكون لدى pathSegList إدخالان SVG_PATHSEG_MOVETO_ABS و SVG_PATHSEG_ARC_ABS.
type: docs
weight: 20
