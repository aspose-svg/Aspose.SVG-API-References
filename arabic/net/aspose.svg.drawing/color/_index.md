...
description: Aspose.Svg.Drawing.Color فصل. تتيح لك فئة اللون تحديد الألوان مثل قيم الأحمرالأخضرالأزرق RGB  HueSaturationLuminosity HSL  HueSaturationValue HSV  HueWhiteenessBlackness HWB  القيم  قيم lightnessAB LAB  قيم LuminanceChromaHue LCH  قيم CyanMagentaYellowKey CMYK  قيم الألوان الطبيعية NCOL  أو باسم لون . تتوفر أيضًا قناة Alpha للإشارة إلى الشفافية.
type: docs
weight: 1390
...
| override [Equals](../../aspose.svg.drawing/color/equals/)(object) | تحديد ما إذا كان الملف المحدد`Color` يساوي هذا المثال. |
