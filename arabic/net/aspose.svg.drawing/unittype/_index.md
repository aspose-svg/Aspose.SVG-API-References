...
| [Equals](../../aspose.svg.drawing/unittype/equals#equals)(UnitType) | تحديد ما إذا كان الملف المحدد[`UnitType`](../unittype) ، يساوي هذا المثال. |
...
| [operator ==](../../aspose.svg.drawing/unittype/op_equality) | تحديد ما إذا تم تحديد الاثنين[`UnitType`](../unittype) القيم متساوية. |
| [explicit operator](../../aspose.svg.drawing/unittype/op_explicit) | يقوم بإجراء تحويل صريح من[`UnitType`](../unittype) إلىString . |
| [implicit operator](../../aspose.svg.drawing/unittype/op_implicit) | يقوم بإجراء تحويل ضمني منString إلى[`UnitType`](../unittype) . |
| [operator !=](../../aspose.svg.drawing/unittype/op_inequality) | تحديد ما إذا تم تحديد الاثنين[`UnitType`](../unittype) القيم ليست متساوية. |
