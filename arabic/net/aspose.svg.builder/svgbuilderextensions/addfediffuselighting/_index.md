...
description: "طريقة SVGBuilderExtensions AddFeDiffuseLighting. تضيف تكوين عنصر feDiffuseLighting إلى المُنشئ. هذا العنصر يوفر تأثير إضاءة على الصورة."
type: docs
weight: 180
url: /ar/net/aspose.svg.builder/svgbuilderextensions/addfediffuselighting/
---
## AddFeDiffuseLighting<TBuilder>(*this TBuilder, Action&lt;SVGFEDiffuseLightingElementBuilder&gt;*) {#addfediffuselighting}

يضيف تكوين عنصر 'feDiffuseLighting' إلى المنشئ. هذا العنصر يوفر تأثير إضاءة على صورة.
...
| تكوين | إجراء التكوين لعنصر 'feDiffuseLighting'. |
...
يضيف عنصر 'feDiffuseLighting' إلى منشئ SVG، مطبقًا تأثير إضاءة منتشر باستخدام مصدر ضوء محدد.
...
| builder | مثيل مُنشئ SVG الذي سيُضاف إليه عنصر 'feDiffuseLighting'. |
| lightSource | إجراء لتكوين مصدر الضوء لتأثير الإضاءة المنتشرة. |
| lightingColor | لون الضوء. معلمة اختيارية. |
| surfaceScale | عامل مقياس السطح لتأثير الإضاءة. معلمة اختيارية. |
| diffuseConstant | الثابت المستخدم لتحديد تأثير الإضاءة. معامل اختياري. |
| in | المدخل لتأثير الإضاءة المنتشرة. يمكن أن يكون سلسلة نصية أو FilterInput. معامل اختياري. |
...
| extend | إجراء اختياري لتكوين إضافي لـ SVGFEDiffuseLightingElementBuilder. |
