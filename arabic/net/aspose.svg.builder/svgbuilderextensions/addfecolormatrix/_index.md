...
description: "طريقة SVGBuilderExtensions AddFeColorMatrix. تُضيف تكوين عنصر feColorMatrix إلى المُنشئ. هذا العنصر يطبق تحويل مصفوفة على قيم اللون والألفا لكل بكسل."
type: docs
weight: 140
url: /ar/net/aspose.svg.builder/svgbuilderextensions/addfecolormatrix/
---
## AddFeColorMatrix<TBuilder>(*this TBuilder, Action&lt;SVGFEColorMatrixElementBuilder&gt;*) {#addfecolormatrix_1}

يضيف تكوين عنصر 'feColorMatrix' إلى الباني. يطبق هذا العنصر تحويلًا مصفوفيًا على قيم اللون والشفافية لكل بكسل.
...
| تكوين | إجراء التكوين لعنصر 'feColorMatrix'. |
...
يضيف عنصر 'feColorMatrix' إلى باني SVG، مع تحديد نوع عملية مصفوفة اللون ومجموعة من الخصائص الأخرى لتأثير الفلتر.
...
| builder | مثيل مُنشئ SVG الذي سيُضاف إليه عنصر 'feColorMatrix'. |
| type | نوع عملية مصفوفة اللون التي سيتم تطبيقها. |
| القيم | القيم لعملية مصفوفة اللون. معلمة اختيارية. |
| in | المدخل لتأثير مصفوفة اللون. يمكن أن يكون سلسلة نصية أو FilterInput. معلمة اختيارية. |
...
| extend | إجراء اختياري لمزيد من تكوين SVGFEColorMatrixElementBuilder. |
