...
description: "طريقة SVGBuilderExtensions AddFeGaussianBlur. تضيف تكوين عنصر feGaussianBlur إلى المُنشئ. هذا العنصر يطبق تمويه Gaussian على صورة الإدخال"
type: docs
weight: 220
url: /ar/net/aspose.svg.builder/svgbuilderextensions/addfegaussianblur/
---
## AddFeGaussianBlur<TBuilder>(*this TBuilder, Action&lt;SVGFEGaussianBlurElementBuilder&gt;*) {#addfegaussianblur_1}

يضيف تكوين عنصر 'feGaussianBlur' إلى المنشئ. هذا العنصر يطبق تمويه غاوسي على الصورة المدخلة.
...
| تكوين | إجراء التكوين لعنصر 'feGaussianBlur'. |
...
يضيف عنصر 'feGaussianBlur' إلى منشئ SVG، مطبقًا تأثير تمويه غاوسي على الصورة المدخلة.
...
| builder | مثيل مُنشئ SVG الذي سيُضاف إليه عنصر 'feGaussianBlur'. |
| stdDeviation | الانحراف المعياري لعملية التمويه. يمكن أن يكون عددًا مزدوجًا أو ValueTuple من عددين مزدوجين. معلمة اختيارية. |
| in | صورة الإدخال التي سيُطبق عليها تمويه Gaussian. يمكن أن تكون سلسلة نصية أو FilterInput. معلمة اختيارية. |
...
| extend | إجراء اختياري لتكوين إضافي لـ SVGFEGaussianBlurElementBuilder. |
