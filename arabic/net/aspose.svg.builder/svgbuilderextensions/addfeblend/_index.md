...
description: "طريقة SVGBuilderExtensions AddFeBlend. يضيف تكوين عنصر feBlend إلى المُنشئ. هذا العنصر يعرّف تأثير دمج بين رسومتين."
type: docs
weight: 130
url: /ar/net/aspose.svg.builder/svgbuilderextensions/addfeblend/
---
## AddFeBlend<TBuilder>(*this TBuilder, Action&lt;SVGFEBlendElementBuilder&gt;*) {#addfeblend}

يضيف تكوين عنصر 'feBlend' إلى الباني. يحدد هذا العنصر تأثير الدمج بين رسومتين.
...
| تكوين | إجراء التكوين لعنصر 'feBlend'. |
...
يضيف عنصر 'feBlend' إلى باني SVG، مع تحديد وضع الدمج ومجموعة من الخصائص الأخرى لتأثير الفلتر.
...
| builder | مثيل مُنشئ SVG الذي سيُضاف إليه عنصر 'feBlend'. |
| mode | وضع الدمج الذي سيُستخدم. معامل اختياري. |
| in | المدخل الأول لتأثير الدمج. يمكن أن يكون سلسلة نصية أو FilterInput. معامل اختياري. |
| in2 | المدخل الثاني لتأثير الدمج. يمكن أن يكون سلسلة نصية أو FilterInput. معامل اختياري. |
...
| extend | إجراء اختياري لتكوين إضافي لـ SVGFEBlendElementBuilder. |
