...
description: توفر واجهة MediaList تجريدًا لمجموعة مرتبة من الوسائط  بدون تعريف أو تقييد كيفية تنفيذ هذه المجموعة. القائمة الفارغة هي نفس القائمة التي تحتوي على الوسيط الكل.
type: docs
weight: 730
