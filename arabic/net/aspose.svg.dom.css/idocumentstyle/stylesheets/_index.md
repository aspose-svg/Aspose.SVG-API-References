...
description: قائمة تحتوي على كافة أوراق الأنماط المرتبطة أو المضمنة في مستند بشكل صريح. بالنسبة لمستندات HTML  يتضمن ذلك أوراق الأنماط الخارجية  المضمنة عبر عنصر HTML LINK  وعناصر النمط المضمنة.
type: docs
weight: 10
url: /ar/net/aspose.svg.dom.css/idocumentstyle/stylesheets/
---
...
* مساحة الاسم [Aspose.Svg.Dom.Css](../../idocumentstyle)
* المجسم [Aspose.SVG](../../../)
