...
description: إذا تم احتواء هذه القاعدة داخل قاعدة أخرى مثل قاعدة نمط داخل كتلةmedia  فهذه هي القاعدة الحاوية. إذا لم تكن هذه القاعدة متداخلة داخل أي قواعد أخرى  فسيتم إرجاع قيمة خالية.
type: docs
weight: 20
