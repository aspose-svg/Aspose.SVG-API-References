...
| resolver | IXPathNSResolver | ال`محلل` يسمح بترجمة جميع البادئات ، بما في ذلك `xml` بادئة مساحة الاسم ، ضمن تعبير XPath إلى مساحة الاسم المناسبة URIs. إذا تم تحديد ذلك على أنه`باطل` ، ستؤدي أي بادئة لمساحة الاسم داخل التعبير إلى في[`DOMException`](../../../aspose.svg.dom/domexception/) تم إلقاؤهم مع الرمز`NAMESPACE_ERR`. |
...
| [DOMException](../../../aspose.svg.dom/domexception/) | WRONG_DOCUMENT_ERR: العقدة من مستند لا يدعمه هذا [`IXPathEvaluator`](../). |
| [DOMException](../../../aspose.svg.dom/domexception/) | NOT_SUPPORTED_ERR: العقدة ليست نوعًا مسموحًا به كعقدة سياق XPath أو نوع الطلب غير مسموح به بواسطة هذا[`IXPathEvaluator`](../). |
