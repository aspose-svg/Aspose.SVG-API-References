...
description: Aspose.Svg.SVGTextPathElement فصل. تتوافق واجهة SVGTextPathElement مع عنصر مسار النص.
type: docs
weight: 3540
...
| [Href](../../aspose.svg/svgtextpathelement/href/) { get; } | يتوافق مع السمة "xlink: href" في العنصر المحدد. |
...
| [LengthAdjust](../../aspose.svg/svgtextcontentelement/lengthadjust/) { get; } | يتوافق مع السمة "lengthAdjust" على العنصر المحدد. يجب أن تكون القيمة أحد ثوابت ضبط الطول المحددة في هذه الواجهة. |
...
| [Method](../../aspose.svg/svgtextpathelement/method/) { get; } | يتوافق مع السمة "الطريقة" في عنصر "مسار النص" المحدد . |
...
| [Spacing](../../aspose.svg/svgtextpathelement/spacing/) { get; } | يتوافق مع السمة "التباعد" على عنصر "مسار النص" المحدد. |
| [StartOffset](../../aspose.svg/svgtextpathelement/startoffset/) { get; } | يتوافق مع السمة "startOffset" على عنصر "textPath" المحدد. |
...
| [TextLength](../../aspose.svg/svgtextcontentelement/textlength/) { get; } | يتوافق مع السمة "textLength" في العنصر المحدد. |
...
| اسم | وصف |
| --- | --- |
| const [TEXTPATH_METHODTYPE_ALIGN](../../aspose.svg/svgtextpathelement/textpath_methodtype_align/) | يتوافق مع القيمة "محاذاة" . |
| const [TEXTPATH_METHODTYPE_STRETCH](../../aspose.svg/svgtextpathelement/textpath_methodtype_stretch/) | يتوافق مع القيمة "امتداد" . |
| const [TEXTPATH_METHODTYPE_UNKNOWN](../../aspose.svg/svgtextpathelement/textpath_methodtype_unknown/) | تم تعيين التعداد على قيمة ليست من الأنواع المحددة مسبقًا. من غير الصحيح محاولة تحديد قيمة جديدة من هذا النوع أو محاولة تبديل قيمة موجودة إلى هذا النوع. |
| const [TEXTPATH_SPACINGTYPE_AUTO](../../aspose.svg/svgtextpathelement/textpath_spacingtype_auto/) | يتوافق مع القيمة "auto" . |
| const [TEXTPATH_SPACINGTYPE_EXACT](../../aspose.svg/svgtextpathelement/textpath_spacingtype_exact/) | يتوافق مع القيمة "بالضبط" . |
| const [TEXTPATH_SPACINGTYPE_UNKNOWN](../../aspose.svg/svgtextpathelement/textpath_spacingtype_unknown/) | تم تعيين التعداد على قيمة ليست من الأنواع المحددة مسبقًا. من غير الصحيح محاولة تحديد قيمة جديدة من هذا النوع أو محاولة تبديل قيمة موجودة إلى هذا النوع. |
