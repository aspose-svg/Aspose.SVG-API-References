...
description: Aspose.Svg.SVGImageElement فصل. تتوافق واجهة SVGImageElement مع عنصر الصورة.
type: docs
weight: 3300
...
| [Height](../../aspose.svg/svgimageelement/height/) { get; } | يتوافق مع السمة "الارتفاع" على عنصر "الصورة" المحدد . |
| [Href](../../aspose.svg/svgimageelement/href/) { get; } | يتوافق مع السمة "xlink: href" في العنصر المحدد. |
...
| [PreserveAspectRatio](../../aspose.svg/svgimageelement/preserveaspectratio/) { get; } | يتوافق مع السمة "saveAspectRatio" في عنصر "الصورة" المحدد . |
...
| [Width](../../aspose.svg/svgimageelement/width/) { get; } | يتوافق مع السمة "العرض" على عنصر "الصورة" المحدد . |
| [X](../../aspose.svg/svgimageelement/x/) { get; } | يتوافق مع السمة "x" في عنصر "الصورة" المحدد . |
| [Y](../../aspose.svg/svgimageelement/y/) { get; } | يتوافق مع السمة "y" في عنصر "الصورة" المحدد . |
