...
description: Aspose.Svg.SVGSVGElement فصل. تعريف الواجهة الرئيسية هو واجهة SVGSVGElement  وهي الواجهة التي تتوافق مع عنصر svg. تحتوي هذه الواجهة على طرق مساعدة متنوعة شائعة الاستخدام  مثل عمليات المصفوفة والقدرة على التحكم في وقت إعادة الرسم على أجهزة العرض المرئي.
type: docs
weight: 3440
...
| [CurrentTranslate](../../aspose.svg/svgsvgelement/currenttranslate/) { get; } | على عنصر svg الخارجي ، عامل الترجمة المقابل الذي يأخذ في الاعتبار "تكبير" المستخدم . عند الوصول إلى عنصر "svg" ليس عنصر svg خارجيًا ، فإنه غير محدد سلوك هذه السمة. |
...
| [Height](../../aspose.svg/svgsvgelement/height/) { get; } | يتوافق مع سمة "الارتفاع" على عنصر "svg" المحدد . |
...
| [PreserveAspectRatio](../../aspose.svg/svgsvgelement/preserveaspectratio/) { get; } | يتوافق مع السمة "saveAspectRatio" للعنصر المحدد. |
...
| [ViewBox](../../aspose.svg/svgsvgelement/viewbox/) { get; } | يتوافق مع السمة "viewBox" في العنصر المحدد. |
...
| [Width](../../aspose.svg/svgsvgelement/width/) { get; } | يتوافق مع السمة "العرض" على عنصر "svg" المحدد . |
| [X](../../aspose.svg/svgsvgelement/x/) { get; } | يتوافق مع السمة "x" في عنصر "svg" المحدد . |
| [Y](../../aspose.svg/svgsvgelement/y/) { get; } | يتوافق مع السمة "y" في عنصر "svg" المحدد . |
| [ZoomAndPan](../../aspose.svg/svgsvgelement/zoomandpan/) { get; set; } | يتوافق مع السمة "zoomAndPan" على العنصر المحدد. يجب أن تكون القيمة واحدة من ثوابت SVG_ZOOMANDPAN_ * المحددة في هذه الواجهة. |
...
| [AnimationsPaused](../../aspose.svg/svgsvgelement/animationspaused/)() | إرجاع صحيح إذا كان جزء مستند SVG في حالة إيقاف مؤقت. |
...
| [CreateEvent](../../aspose.svg/svgsvgelement/createevent/)(string) | ينشئ ملف[`Event`](../../aspose.svg.dom.events/event/) من النوع الذي يدعمه التنفيذ . |
| [CreateSVGAngle](../../aspose.svg/svgsvgelement/createsvgangle/)() | لتكوين كائن SVGAngle خارج أي شجرة مستندات. يتم تهيئة الكائن إلى القيمة 0 درجة (بدون وحدة) . |
| [CreateSVGLength](../../aspose.svg/svgsvgelement/createsvglength/)() | لتكوين كائن SVGLength خارج أية شجرات مستندات. تمت تهيئة الكائن إلى قيمة 0 وحدة مستخدم. |
| [CreateSVGMatrix](../../aspose.svg/svgsvgelement/createsvgmatrix/)() | لتكوين كائن SVGMatrix خارج أية شجرات مستندات. يتم تهيئة الكائن إلى مصفوفة الهوية. |
| [CreateSVGNumber](../../aspose.svg/svgsvgelement/createsvgnumber/)() | لتكوين كائن SVGNumber خارج أية شجرات مستندات. تمت تهيئة الكائن إلى قيمة صفر. |
| [CreateSVGPoint](../../aspose.svg/svgsvgelement/createsvgpoint/)() | لتكوين كائن SVGPoint خارج أي شجرة مستندات. يتم تهيئة الكائن إلى النقطة (0،0) في نظام إحداثيات المستخدم. |
| [CreateSVGRect](../../aspose.svg/svgsvgelement/createsvgrect/)() | لتكوين كائن SVGRect خارج أي شجرة مستندات. تتم تهيئة الكائن بحيث يتم تعيين جميع القيم على 0 وحدة مستخدم. |
| [CreateSVGTransform](../../aspose.svg/svgsvgelement/createsvgtransform/)() | لتكوين كائن SVGTransform خارج أية شجرات مستندات. تتم تهيئة الكائن لتحويل مصفوفة الهوية (SVG_TRANSFORM_MATRIX) . |
...
| [PauseAnimations](../../aspose.svg/svgsvgelement/pauseanimations/)() | يوقف (على سبيل المثال ، الإيقاف المؤقت) جميع الرسوم المتحركة قيد التشغيل حاليًا والمحددة داخل جزء مستند SVG المقابل لعنصر "svg" هذا ، مما يتسبب في بقاء ساعة الرسوم المتحركة المقابلة لجزء المستند ثابتة حتى يتم إلغاء الإيقاف المؤقت . |
...
| [UnpauseAnimations](../../aspose.svg/svgsvgelement/unpauseanimations/)() | Unsuspends (على سبيل المثال ، إلغاء الإيقاف المؤقت) قيد التشغيل حاليًا للرسوم المتحركة المحددة داخل جزء مستند SVG ، مما يتسبب في استمرار ساعة الرسوم المتحركة من وقت تعليقها. |
