...
description: Aspose.Svg.SVGViewElement فصل. تتوافق واجهة SVGViewElement مع عنصر العرض.
type: docs
weight: 3590
...
| [PreserveAspectRatio](../../aspose.svg/svgviewelement/preserveaspectratio/) { get; } | يتوافق مع السمة "saveAspectRatio" للعنصر المحدد. |
...
| [ViewBox](../../aspose.svg/svgviewelement/viewbox/) { get; } | يتوافق مع السمة "viewBox" في العنصر المحدد. |
...
| [ViewTarget](../../aspose.svg/svgviewelement/viewtarget/) { get; } | يتوافق مع السمة "viewTarget" في عنصر "العرض" المحدد. قائمة بقيم DOMString التي تحتوي على الأسماء المدرجة في السمة "viewTarget". يمكن ربط كل من قيم سلسلة DOM بالعنصر المقابل باستخدام استدعاء أسلوب getElementById (). |
| [ZoomAndPan](../../aspose.svg/svgviewelement/zoomandpan/) { get; set; } | يتوافق مع السمة "zoomAndPan" على العنصر المحدد. يجب أن تكون القيمة واحدة من ثوابت SVG_ZOOMANDPAN_ * المحددة في هذه الواجهة. |
