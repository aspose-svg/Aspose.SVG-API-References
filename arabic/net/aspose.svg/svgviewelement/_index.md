...
description: "Aspose.Svg.SVGViewElement فئة. واجهة SVGViewElement تتطابق مع العنصر view"
type: docs
weight: 5660
url: /ar/net/aspose.svg/svgviewelement/
---
...
| [PreserveAspectRatio](../../aspose.svg/svgviewelement/preserveaspectratio/) { get; } | يتطابق مع السمة ‘preserveAspectRatio’ في العنصر المعطى. |
...
| [ViewBox](../../aspose.svg/svgviewelement/viewbox/) { get; } | يتطابق مع السمة ‘viewBox’ في العنصر المعطى. |
...
| [ViewTarget](../../aspose.svg/svgviewelement/viewtarget/) { get; } | يتطابق مع السمة ‘viewTarget’ على العنصر ‘view’ المحدد. قائمة من قيم DOMString التي تحتوي على الأسماء المذكورة في سمة ‘viewTarget’. يمكن ربط كل قيمة من قيم DOMString بالعنصر المقابل باستخدام استدعاء الطريقة getElementById(). |
| [ZoomAndPan](../../aspose.svg/svgviewelement/zoomandpan/) { get; set; } | يتطابق مع السمة ‘zoomAndPan’ على العنصر المعطى. يجب أن تكون القيمة واحدة من الثوابت SVG_ZOOMANDPAN_* المعرفة في هذه الواجهة. |
