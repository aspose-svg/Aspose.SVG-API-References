...
description: يتوافق مع السمة viewTarget في عنصر العرض المحدد. قائمة بقيم DOMString التي تحتوي على الأسماء المدرجة في السمة viewTarget. يمكن ربط كل من قيم سلسلة DOM بالعنصر المقابل باستخدام استدعاء أسلوب getElementById .
type: docs
weight: 30
