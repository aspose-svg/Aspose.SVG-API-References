...
description: Aspose.Svg.SVGForeignObjectElement فصل. تتوافق واجهة SVGForeignObjectElement مع عنصر الكائن الأجنبي.
type: docs
weight: 3250
...
| [Height](../../aspose.svg/svgforeignobjectelement/height/) { get; } | يتوافق مع السمة "الارتفاع" على عنصر "الكائن الأجنبي" المحدد . |
...
| [Width](../../aspose.svg/svgforeignobjectelement/width/) { get; } | يتوافق مع السمة "العرض" على عنصر "الكائن الأجنبي" المحدد . |
| [X](../../aspose.svg/svgforeignobjectelement/x/) { get; } | يتوافق مع السمة "x" في عنصر "الكائن الأجنبي" المحدد . |
| [Y](../../aspose.svg/svgforeignobjectelement/y/) { get; } | يتوافق مع السمة "y" في عنصر "الكائن الأجنبي" المحدد . |
