...
description: Aspose.Svg.SVGScriptElement فصل. تتوافق واجهة SVGScriptElement مع عنصر البرنامج النصي.
type: docs
weight: 3450
...
| [CrossOrigin](../../aspose.svg/svgscriptelement/crossorigin/) { get; set; } | يتوافق مع السمة "crossorigin" في عنصر "البرنامج النصي" المحدد. |
...
| [Href](../../aspose.svg/svgscriptelement/href/) { get; } | يتوافق مع السمة "xlink: href" في العنصر المحدد. |
...
| [Type](../../aspose.svg/svgscriptelement/type/) { get; set; } | يتوافق مع السمة "النوع" في عنصر "البرنامج النصي" المحدد . |
