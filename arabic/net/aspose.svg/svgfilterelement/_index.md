...
description: Aspose.Svg.SVGFilterElement فصل. تتوافق واجهة SVGFilterElement مع عنصر عامل التصفية.
type: docs
weight: 3240
...
| [FilterUnits](../../aspose.svg/svgfilterelement/filterunits/) { get; } | يتوافق مع السمة "filterUnits" في عنصر "التصفية" المحدد. يأخذ أحد الثوابت المعرفة في SVGUnitTypes. |
...
| [Height](../../aspose.svg/svgfilterelement/height/) { get; } | يتوافق مع السمة "الارتفاع" على عنصر "الفلتر" المحدد . |
| [Href](../../aspose.svg/svgfilterelement/href/) { get; } | يتوافق مع السمة "xlink: href" في العنصر المحدد. |
...
| [PrimitiveUnits](../../aspose.svg/svgfilterelement/primitiveunits/) { get; } | يتوافق مع السمة "primitiveUnits" على عنصر "مرشح" المحدد. يأخذ أحد الثوابت المعرفة في SVGUnitTypes. |
...
| [Width](../../aspose.svg/svgfilterelement/width/) { get; } | يتوافق مع السمة "العرض" على عنصر "الفلتر" المحدد . |
| [X](../../aspose.svg/svgfilterelement/x/) { get; } | يتوافق مع السمة "x" في عنصر "عامل التصفية" المحدد . |
| [Y](../../aspose.svg/svgfilterelement/y/) { get; } | يتوافق مع السمة "y" في عنصر "عامل التصفية" المحدد . |
