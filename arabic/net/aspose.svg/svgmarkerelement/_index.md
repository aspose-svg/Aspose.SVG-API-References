...
description: Aspose.Svg.SVGMarkerElement فصل. تتوافق واجهة SVGMarkerElement مع عنصر العلامة.
type: docs
weight: 3340
...
| [MarkerHeight](../../aspose.svg/svgmarkerelement/markerheight/) { get; } | يتوافق مع السمة "markerHeight" على عنصر "العلامة" المحدد . |
| [MarkerUnits](../../aspose.svg/svgmarkerelement/markerunits/) { get; } | يتوافق مع السمة "markerUnits" على عنصر "العلامة" المحدد. أحد أنواع وحدات العلامات المحددة في هذه الواجهة. |
| [MarkerWidth](../../aspose.svg/svgmarkerelement/markerwidth/) { get; } | يتوافق مع السمة "markerWidth" على عنصر "العلامة" المحدد . |
...
| [OrientAngle](../../aspose.svg/svgmarkerelement/orientangle/) { get; } | يتوافق مع السمة "orient" على عنصر "العلامة" المحدد. إذا كانت markerUnits هي SVG_MARKER_ORIENT_ANGLE ، فإن قيمة الزاوية للسمة "orient" ؛ وإلا فسيتم ضبطه على صفر. |
| [OrientType](../../aspose.svg/svgmarkerelement/orienttype/) { get; } | يتوافق مع السمة "orient" على عنصر "العلامة" المحدد. أحد أنواع اتجاه العلامة المحددة في هذه الواجهة. |
...
| [PreserveAspectRatio](../../aspose.svg/svgmarkerelement/preserveaspectratio/) { get; } | يتوافق مع السمة "saveAspectRatio" للعنصر المحدد. |
...
| [RefX](../../aspose.svg/svgmarkerelement/refx/) { get; } | يتوافق مع السمة "refX" على عنصر "العلامة" المحدد . |
| [RefY](../../aspose.svg/svgmarkerelement/refy/) { get; } | يتوافق مع السمة "refY" على عنصر "العلامة" المحدد . |
...
| [ViewBox](../../aspose.svg/svgmarkerelement/viewbox/) { get; } | يتوافق مع السمة "viewBox" في العنصر المحدد. |
...
| [SetOrientToAngle](../../aspose.svg/svgmarkerelement/setorienttoangle/)(SVGAngle) | يضبط قيمة السمة "الاتجاه" على الزاوية المحددة. |
| [SetOrientToAuto](../../aspose.svg/svgmarkerelement/setorienttoauto/)() | يضبط قيمة السمة "الاتجاه" على "تلقائي" . |
...
| const [SVG_MARKERUNITS_UNKNOWN](../../aspose.svg/svgmarkerelement/svg_markerunits_unknown/) | نوع وحدة العلامة ليس من الأنواع المحددة مسبقًا. من غير الصحيح محاولة تحديد قيمة جديدة من هذا النوع أو محاولة تبديل قيمة موجودة إلى هذا النوع. |
...
| const [SVG_MARKER_ORIENT_ANGLE](../../aspose.svg/svgmarkerelement/svg_marker_orient_angle/) | السمة "الاتجاه" لها قيمة زاوية . |
| const [SVG_MARKER_ORIENT_AUTO](../../aspose.svg/svgmarkerelement/svg_marker_orient_auto/) | السمة "المشرق" لها قيمة "تلقائية" . |
| const [SVG_MARKER_ORIENT_UNKNOWN](../../aspose.svg/svgmarkerelement/svg_marker_orient_unknown/) | اتجاه العلامة ليس أحد الأنواع المحددة مسبقًا. من غير الصحيح محاولة تحديد قيمة جديدة من هذا النوع أو محاولة تبديل قيمة موجودة إلى هذا النوع. |
