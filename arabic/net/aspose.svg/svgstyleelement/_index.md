...
description: Aspose.Svg.SVGStyleElement فصل. تتوافق واجهة SVGStyleElement مع عنصر النمط.
type: docs
weight: 3480
...
| [Media](../../aspose.svg/svgstyleelement/media/) { get; set; } | يتوافق مع السمة "الوسائط" على العنصر المحدد. |
...
| [Sheet](../../aspose.svg/svgstyleelement/sheet/) { get; } | الحصول على ورقة الأنماط المرتبطة. |
...
| [Title](../../aspose.svg/svgstyleelement/title/) { get; set; } | يتوافق مع السمة "العنوان" في العنصر المحدد. |
| [Type](../../aspose.svg/svgstyleelement/type/) { get; set; } | يتوافق مع السمة "النوع" في العنصر المحدد. |
