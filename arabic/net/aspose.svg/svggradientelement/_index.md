...
description: Aspose.Svg.SVGGradientElement فصل. واجهة SVGGradientElement هي واجهة أساسية مستخدمة بواسطة SVGLinearGradientElement و SVGRadialGradientElement.
type: docs
weight: 3280
...
| [GradientTransform](../../aspose.svg/svggradientelement/gradienttransform/) { get; } | يتوافق مع السمة "gradientTransform" على العنصر المحدد. |
| [GradientUnits](../../aspose.svg/svggradientelement/gradientunits/) { get; } | يتوافق مع السمة "وحدات التدرج" على العنصر المحدد. يأخذ أحد الثوابت المعرفة في SVGUnitTypes. |
| [Href](../../aspose.svg/svggradientelement/href/) { get; } | يتوافق مع السمة "xlink: href" في العنصر المحدد. |
...
| [SpreadMethod](../../aspose.svg/svggradientelement/spreadmethod/) { get; } | يتوافق مع السمة "طريقة الانتشار" على العنصر المحدد. أحد أنواع طرق الانتشار المحددة في هذه الواجهة. |
...
| اسم | وصف |
| --- | --- |
| const [SVG_SPREADMETHOD_PAD](../../aspose.svg/svggradientelement/svg_spreadmethod_pad/) | يتوافق مع القيمة "وسادة" . |
| const [SVG_SPREADMETHOD_REFLECT](../../aspose.svg/svggradientelement/svg_spreadmethod_reflect/) | يتوافق مع القيمة "انعكاس" . |
| const [SVG_SPREADMETHOD_REPEAT](../../aspose.svg/svggradientelement/svg_spreadmethod_repeat/) | يتوافق مع قيمة "تكرار" . |
| const [SVG_SPREADMETHOD_UNKNOWN](../../aspose.svg/svggradientelement/svg_spreadmethod_unknown/) | النوع ليس من الأنواع المحددة مسبقًا. من غير الصحيح محاولة تحديد قيمة جديدة من هذا النوع أو محاولة تبديل قيمة موجودة إلى هذا النوع. |
