...
description: Aspose.Svg.SVGComponentTransferFunctionElement فصل. تحدد هذه الواجهة الواجهة الأساسية المستخدمة بواسطة واجهات وظيفة نقل المكون.
type: docs
weight: 3150
...
| اسم | وصف |
| --- | --- |
| [Amplitude](../../aspose.svg/svgcomponenttransferfunctionelement/amplitude/) { get; } | يتوافق مع السمة "السعة" على العنصر المحدد. |
...
| [Exponent](../../aspose.svg/svgcomponenttransferfunctionelement/exponent/) { get; } | يتوافق مع السمة "الأس" على العنصر المحدد. |
...
| [Intercept](../../aspose.svg/svgcomponenttransferfunctionelement/intercept/) { get; } | يتوافق مع السمة "التقاطع" على العنصر المحدد. |
...
| [Offset](../../aspose.svg/svgcomponenttransferfunctionelement/offset/) { get; } | يتوافق مع السمة "الإزاحة" في العنصر المحدد. |
...
| [Slope](../../aspose.svg/svgcomponenttransferfunctionelement/slope/) { get; } | يتوافق مع السمة "المنحدر" على العنصر المحدد. |
...
| [TableValues](../../aspose.svg/svgcomponenttransferfunctionelement/tablevalues/) { get; } | يتوافق مع السمة "tableValues" على العنصر المحدد. |
...
| [Type](../../aspose.svg/svgcomponenttransferfunctionelement/type/) { get; } | يتوافق مع السمة "النوع" في العنصر المحدد. يأخذ أحد ثوابت SVG_FECOMPONENTTRANSFER_TYPE_ * المحددة في هذه الواجهة. |
...
| اسم | وصف |
| --- | --- |
| const [SVG_FECOMPONENTTRANSFER_TYPE_DISCRETE](../../aspose.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_discrete/) | يتوافق مع القيمة "المنفصلة" . |
| const [SVG_FECOMPONENTTRANSFER_TYPE_GAMMA](../../aspose.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_gamma/) | يتوافق مع قيمة "جاما" . |
| const [SVG_FECOMPONENTTRANSFER_TYPE_IDENTITY](../../aspose.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_identity/) | يتوافق مع "هوية" القيمة . |
| const [SVG_FECOMPONENTTRANSFER_TYPE_LINEAR](../../aspose.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_linear/) | يتوافق مع القيمة "الخطية" . |
| const [SVG_FECOMPONENTTRANSFER_TYPE_TABLE](../../aspose.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_table/) | يتوافق مع "جدول" القيمة . |
| const [SVG_FECOMPONENTTRANSFER_TYPE_UNKNOWN](../../aspose.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_unknown/) | النوع ليس من الأنواع المحددة مسبقًا. من غير الصحيح محاولة تحديد قيمة جديدة من هذا النوع أو محاولة تبديل قيمة موجودة إلى هذا النوع. |
