...
description: Aspose.Svg.SVGLinearGradientElement فصل. تتوافق واجهة SVGLinearGradientElement مع عنصر linearGradient.
type: docs
weight: 3320
...
| [X1](../../aspose.svg/svglineargradientelement/x1/) { get; } | يتوافق مع السمة "x1" على عنصر "linearGradient" المحدد . |
| [X2](../../aspose.svg/svglineargradientelement/x2/) { get; } | يتوافق مع السمة "x2" على عنصر "linearGradient" المحدد . |
| [Y1](../../aspose.svg/svglineargradientelement/y1/) { get; } | يتوافق مع السمة "y1" على عنصر "linearGradient" المحدد . |
| [Y2](../../aspose.svg/svglineargradientelement/y2/) { get; } | يتوافق مع السمة "y2" على عنصر "linearGradient" المحدد . |
