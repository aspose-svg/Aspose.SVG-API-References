...
description: Aspose.Svg.SVGPathElement فصل. تتوافق واجهة SVGPathElement مع عنصر المسار.
type: docs
weight: 3370
...
| [PathLength](../../aspose.svg/svggeometryelement/pathlength/) { get; } | يتوافق مع مسار السمة الطول على العنصر المحدد. |
| [PathSegList](../../aspose.svg/svgpathelement/pathseglist/) { get; set; } | يوفر الوصول إلى المحتويات الأساسية (أي الثابتة) للسمة "d" في نموذج يطابق واحدًا لواحد مع صيغة SVG. وبالتالي ، إذا كانت السمة 'd' تحتوي على أمر "الحركة المطلقة (M)" وأمر "arcto (A) المطلق" ، فسيكون لدى pathSegList إدخالان: SVG_PATHSEG_MOVETO_ABS و SVG_PATHSEG_ARC_ABS. |
...
| [CreateSVGPathSegArcAbs](../../aspose.svg/svgpathelement/createsvgpathsegarcabs/)(float, float, float, float, float, bool, bool) | إرجاع كائن SVGPathSegArcAbs مستقل وغير أبوي. |
| [CreateSVGPathSegArcRel](../../aspose.svg/svgpathelement/createsvgpathsegarcrel/)(float, float, float, float, float, bool, bool) | إرجاع كائن SVGPathSegArcRel مستقل وغير أبوي. |
| [CreateSVGPathSegClosePath](../../aspose.svg/svgpathelement/createsvgpathsegclosepath/)() | إرجاع كائن SVGPathSegClosePath مستقل وغير أبوي. |
| [CreateSVGPathSegCurvetoCubicAbs](../../aspose.svg/svgpathelement/createsvgpathsegcurvetocubicabs/)(float, float, float, float, float, float) | إرجاع كائن SVGPathSegCurvetoCubicAbs مستقل وغير أبوي. |
| [CreateSVGPathSegCurvetoCubicRel](../../aspose.svg/svgpathelement/createsvgpathsegcurvetocubicrel/)(float, float, float, float, float, float) | إرجاع كائن SVGPathSegCurvetoCubicRel مستقل وغير أبوي. |
| [CreateSVGPathSegCurvetoCubicSmoothAbs](../../aspose.svg/svgpathelement/createsvgpathsegcurvetocubicsmoothabs/)(float, float, float, float) | إرجاع كائن SVGPathSegCurvetoCubicSmoothAbs مستقل وغير أبوي. |
| [CreateSVGPathSegCurvetoCubicSmoothRel](../../aspose.svg/svgpathelement/createsvgpathsegcurvetocubicsmoothrel/)(float, float, float, float) | إرجاع كائن SVGPathSegCurvetoCubicSmoothRel مستقل وغير أبوي. |
| [CreateSVGPathSegCurvetoQuadraticAbs](../../aspose.svg/svgpathelement/createsvgpathsegcurvetoquadraticabs/)(float, float, float, float) | إرجاع كائن SVGPathSegCurvetoQuadraticAbs مستقل وغير أبوي. |
| [CreateSVGPathSegCurvetoQuadraticRel](../../aspose.svg/svgpathelement/createsvgpathsegcurvetoquadraticrel/)(float, float, float, float) | إرجاع كائن SVGPathSegCurvetoQuadraticRel مستقل بدون أب. |
| [CreateSVGPathSegCurvetoQuadraticSmoothAbs](../../aspose.svg/svgpathelement/createsvgpathsegcurvetoquadraticsmoothabs/)(float, float) | إرجاع كائن SVGPathSegCurvetoQuadraticSmoothAbs مستقل وغير أبوي. |
| [CreateSVGPathSegCurvetoQuadraticSmoothRel](../../aspose.svg/svgpathelement/createsvgpathsegcurvetoquadraticsmoothrel/)(float, float) | إرجاع كائن SVGPathSegCurvetoQuadraticSmoothRel مستقل وغير أبوي. |
| [CreateSVGPathSegLinetoAbs](../../aspose.svg/svgpathelement/createsvgpathseglinetoabs/)(float, float) | إرجاع كائن SVGPathSegLinetoAbs مستقل وغير أبوي. |
| [CreateSVGPathSegLinetoHorizontalAbs](../../aspose.svg/svgpathelement/createsvgpathseglinetohorizontalabs/)(float) | إرجاع كائن SVGPathSegLinetoHorizontalAbs مستقل وغير أبوي. |
| [CreateSVGPathSegLinetoHorizontalRel](../../aspose.svg/svgpathelement/createsvgpathseglinetohorizontalrel/)(float) | إرجاع كائن SVGPathSegLinetoHorizontalRel مستقل وغير أبوي. |
| [CreateSVGPathSegLinetoRel](../../aspose.svg/svgpathelement/createsvgpathseglinetorel/)(float, float) | إرجاع كائن SVGPathSegLinetoRel مستقل وغير أبوي. |
| [CreateSVGPathSegLinetoVerticalAbs](../../aspose.svg/svgpathelement/createsvgpathseglinetoverticalabs/)(float) | إرجاع كائن SVGPathSegLinetoVerticalAbs مستقل وغير أبوي. |
| [CreateSVGPathSegLinetoVerticalRel](../../aspose.svg/svgpathelement/createsvgpathseglinetoverticalrel/)(float) | إرجاع كائن SVGPathSegLinetoVerticalRel قائم بذاته وبدون أب. |
| [CreateSVGPathSegMovetoAbs](../../aspose.svg/svgpathelement/createsvgpathsegmovetoabs/)(float, float) | إرجاع كائن SVGPathSegMovetoAbs مستقل وغير أبوي. |
| [CreateSVGPathSegMovetoRel](../../aspose.svg/svgpathelement/createsvgpathsegmovetorel/)(float, float) | إرجاع كائن SVGPathSegMovetoRel مستقل وغير أبوي. |
...
| [GetCTM](../../aspose.svg/svggraphicselement/getctm/)() | إرجاع مصفوفة التحويل من وحدات المستخدم الحالية (على سبيل المثال ، بعد تطبيق السمة "التحويل" ، إن وجدت) إلى نظام إحداثي منفذ العرض لأقرب منفذ عرض. |
...
| [GetEquivalentPath](../../aspose.svg/svggeometryelement/getequivalentpath/)() | إرجاع مثيل جديد لملف[`SVGPathSegList`](../../aspose.svg.paths/svgpathseglist/) التي تمثل[`SVGGeometryElement`](../svggeometryelement/) مقاطع المسار . |
| virtual [GetPlatformType](../../aspose.svg.dom/domobject/getplatformtype/)() | تُستخدم هذه الطريقة لاسترداد كائن ECMAScriptType . |
| [GetPointAtLength](../../aspose.svg/svggeometryelement/getpointatlength/)(float) | إرجاع إحداثيات (س ، ص) في مساحة المستخدم وهي وحدات مسافة على طول المسار ، باستخدام خوارزمية المسافة على طول المسار لوكيل المستخدم. |
...
| [GetTotalLength](../../aspose.svg/svggeometryelement/gettotallength/)() | تُرجع القيمة المحسوبة لوكيل المستخدم للطول الإجمالي للمسار باستخدام خوارزمية المسافة على طول المسار لوكيل المستخدم ، كمسافة في نظام إحداثيات المستخدم الحالي. |
