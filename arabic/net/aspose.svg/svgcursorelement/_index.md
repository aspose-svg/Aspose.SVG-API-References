...
description: Aspose.Svg.SVGCursorElement فصل. تتوافق واجهة SVGCursorElement مع عنصر المؤشر.
type: docs
weight: 3160
...
| [Href](../../aspose.svg/svgcursorelement/href/) { get; } | يتوافق مع السمة "xlink: href" في العنصر المحدد. |
...
| [RequiredExtensions](../../aspose.svg/svgcursorelement/requiredextensions/) { get; } | يتوافق مع السمة "requiredExtensions" في العنصر المحدد. |
| [RequiredFeatures](../../aspose.svg/svgcursorelement/requiredfeatures/) { get; } | يتوافق مع السمة "requiredFeatures" في العنصر المحدد . |
...
| [SystemLanguage](../../aspose.svg/svgcursorelement/systemlanguage/) { get; } | يتوافق مع السمة "systemLanguage" على العنصر المحدد. |
...
| [X](../../aspose.svg/svgcursorelement/x/) { get; } | يتوافق مع السمة "x" في عنصر "المؤشر" المحدد . |
| [Y](../../aspose.svg/svgcursorelement/y/) { get; } | يتوافق مع السمة "y" على عنصر "المؤشر" المحدد . |
