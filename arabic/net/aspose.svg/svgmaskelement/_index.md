...
description: Aspose.Svg.SVGMaskElement فصل. تتوافق واجهة SVGMaskElement مع عنصر القناع.
type: docs
weight: 3350
...
| [Height](../../aspose.svg/svgmaskelement/height/) { get; } | يتوافق مع سمة "الارتفاع" على عنصر "القناع" المحدد. يأخذ أحد الثوابت المعرفة في SVGUnitTypes. |
...
| [MaskContentUnits](../../aspose.svg/svgmaskelement/maskcontentunits/) { get; } | يتوافق مع السمة "maskContentUnits" في عنصر "القناع" المحدد. يأخذ أحد الثوابت المعرفة في SVGUnitTypes. |
| [MaskUnits](../../aspose.svg/svgmaskelement/maskunits/) { get; } | يتوافق مع السمة "maskUnits" في عنصر "القناع" المحدد. يأخذ أحد الثوابت المعرفة في SVGUnitTypes. |
...
| [RequiredExtensions](../../aspose.svg/svgmaskelement/requiredextensions/) { get; } | يتوافق مع السمة "requiredExtensions" في العنصر المحدد. |
| [RequiredFeatures](../../aspose.svg/svgmaskelement/requiredfeatures/) { get; } | يتوافق مع السمة "requiredFeatures" في العنصر المحدد . |
...
| [SystemLanguage](../../aspose.svg/svgmaskelement/systemlanguage/) { get; } | يتوافق مع السمة "systemLanguage" على العنصر المحدد. |
...
| [Width](../../aspose.svg/svgmaskelement/width/) { get; } | يتوافق مع السمة "العرض" على عنصر "القناع" المحدد. يأخذ أحد الثوابت المعرفة في SVGUnitTypes. |
| [X](../../aspose.svg/svgmaskelement/x/) { get; } | يتوافق مع السمة "x" في عنصر "القناع" المحدد. يأخذ أحد الثوابت المعرفة في SVGUnitTypes. |
| [Y](../../aspose.svg/svgmaskelement/y/) { get; } | يتوافق مع السمة "y" في عنصر "القناع" المحدد. يأخذ أحد الثوابت المعرفة في SVGUnitTypes. |
