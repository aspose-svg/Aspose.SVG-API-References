...
description: Interface SVGeometryElement يمثل عناصر SVG التي يتم تحديد عرضها بواسطة الهندسة بمسار مكافئ  والتي يمكن تعبئتها والحد منها. يتضمن ذلك المسارات والأشكال الأساسية.
type: docs
weight: 3220
