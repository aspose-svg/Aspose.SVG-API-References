...
description: Aspose.Svg.SVGGeometryElement فصل. Interface SVGeometryElement يمثل عناصر SVG التي يتم تحديد عرضها بواسطة الهندسة بمسار مكافئ  والتي يمكن تعبئتها والحد منها. يتضمن ذلك المسارات والأشكال الأساسية.
type: docs
weight: 3270
...
| [GetEquivalentPath](../../aspose.svg/svggeometryelement/getequivalentpath/)() | إرجاع مثيل جديد لملف[`SVGPathSegList`](../../aspose.svg.paths/svgpathseglist/) التي تمثل`SVGGeometryElement` مقاطع المسار . |
