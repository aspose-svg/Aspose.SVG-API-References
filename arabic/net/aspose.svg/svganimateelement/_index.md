...
description: Aspose.Svg.SVGAnimateElement فصل. تتوافق واجهة SVGAnimateElement مع عنصر animate . لا يتوفر الوصول الموجه للكائنات إلى سمات العنصر animate عبر SVG DOM .
type: docs
weight: 3090
