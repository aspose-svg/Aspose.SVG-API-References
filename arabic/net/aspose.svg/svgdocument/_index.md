...
| [Domain](../../aspose.svg/svgdocument/domain/) { get; } | اسم المجال للخادم الذي خدم المستند ، أو سلسلة فارغة إذا تعذر تحديد الخادم باسم المجال. |
...
| [Referrer](../../aspose.svg/svgdocument/referrer/) { get; } | إرجاع URI للصفحة المرتبطة بهذه الصفحة. القيمة عبارة عن سلسلة فارغة إذا انتقل المستخدم إلى الصفحة مباشرة (ليس من خلال رابط ، ولكن ، على سبيل المثال ، عبر إشارة مرجعية) . |
| [RootElement](../../aspose.svg/svgdocument/rootelement/) { get; } | الجذر "svg" في التسلسل الهرمي للمستند. |
...
| [Title](../../aspose.svg/svgdocument/title/) { get; } | عنوان المستند كما هو محدد بواسطة العنصر الفرعي "العنوان" للعنصر الجذر "svg" (على سبيل المثال ،هنا العنوان... ) |
| [URL](../../aspose.svg/svgdocument/url/) { get; } | عنوان URL الكامل للمستند. |
...
| [CreateNodeIterator](../../aspose.svg.dom/document/createnodeiterator/)(Node) | قم بإنشاء NodeIterator جديد فوق الشجرة الفرعية التي تم تحديد جذرها في العقدة المحددة. |
| [CreateNodeIterator](../../aspose.svg.dom/document/createnodeiterator/)(Node, long) | قم بإنشاء NodeIterator جديد فوق الشجرة الفرعية التي تم تحديد جذرها في العقدة المحددة. |
| [CreateNodeIterator](../../aspose.svg.dom/document/createnodeiterator/)(Node, long, INodeFilter) | قم بإنشاء NodeIterator جديد فوق الشجرة الفرعية التي تم تحديد جذرها في العقدة المحددة. |
...
| [CreateTreeWalker](../../aspose.svg.dom/document/createtreewalker/)(Node) | قم بإنشاء TreeWalker جديد فوق الشجرة الفرعية التي تم تحديد جذرها في العقدة المحددة. |
| [CreateTreeWalker](../../aspose.svg.dom/document/createtreewalker/)(Node, long) | قم بإنشاء TreeWalker جديد فوق الشجرة الفرعية التي تم تحديد جذرها في العقدة المحددة. |
| [CreateTreeWalker](../../aspose.svg.dom/document/createtreewalker/)(Node, long, INodeFilter) | قم بإنشاء TreeWalker جديد فوق الشجرة الفرعية التي تم تحديد جذرها في العقدة المحددة. |
...
| [GetOverrideStyle](../../aspose.svg/svgdocument/getoverridestyle/)(Element, string) | تُستخدم هذه الطريقة لاسترداد إعلان نمط التجاوز لعنصر محدد وعنصر زائف محدد. |
...
| [Navigate](../../aspose.svg.dom/document/navigate/)(RequestMessage) | يتم تحميل المستند بناءً على كائن الطلب المحدد ، مع استبدال المحتوى السابق. |
| [Navigate](../../aspose.svg.dom/document/navigate/)(string) | تحميل المستند في محدد موقع المعلومات (URL) المحدد في المثيل الحالي ، مع استبدال المحتوى السابق. |
| [Navigate](../../aspose.svg.dom/document/navigate/)(Url) | تحميل المستند في محدد موقع المعلومات (URL) المحدد في المثيل الحالي ، مع استبدال المحتوى السابق. |
| [Navigate](../../aspose.svg.dom/document/navigate/)(Stream, string) | تحميل المستند من محتوى محدد واستخدام baseUri لحل الموارد ذات الصلة ، واستبدال المحتوى السابق. يبدأ تحميل المستند من الموضع الحالي في الدفق . |
| [Navigate](../../aspose.svg.dom/document/navigate/)(Stream, Url) | تحميل المستند من محتوى محدد واستخدام baseUri لحل الموارد ذات الصلة ، واستبدال المحتوى السابق. يبدأ تحميل المستند من الموضع الحالي في الدفق . |
| [Navigate](../../aspose.svg.dom/document/navigate/)(string, string) | تحميل المستند من محتوى محدد واستخدام baseUri لحل الموارد ذات الصلة ، واستبدال المحتوى السابق. |
| [Navigate](../../aspose.svg.dom/document/navigate/)(string, Url) | تحميل المستند من محتوى محدد واستخدام baseUri لحل الموارد ذات الصلة ، واستبدال المحتوى السابق. |
...
| override [RenderTo](../../aspose.svg/svgdocument/renderto/)(IDevice) | تُستخدم هذه الطريقة لطباعة محتويات المستند الحالي على الجهاز المحدد. |
...
| [Save](../../aspose.svg/svgdocument/save/#save)(IOutputStorage) | يحفظ محتوى الوثيقة والموارد في تخزين المخرجات. |
| [Save](../../aspose.svg/svgdocument/save/#save_6)(string) | يحفظ المستند في الملف المحلي المحدد بواسطة`طريق` . سيتم حفظ جميع الموارد المستخدمة في هذا المستند في إلى المجلد المجاور ، والذي سيتم إنشاء اسمه على النحو التالي: output_file_name + "_files" . |
| [Save](../../aspose.svg/svgdocument/save/#save_3)(Url) | يحفظ المستند في الملف المحلي المحدد بواسطة`عنوان url` . سيتم حفظ جميع الموارد المستخدمة في هذا المستند في إلى المجلد المجاور ، والذي سيتم إنشاء اسمه على النحو التالي: output_file_name + "_files" . |
| [Save](../../aspose.svg/svgdocument/save/#save_1)(IOutputStorage, SVGSaveFormat) | يحفظ محتوى الوثيقة والموارد في تخزين المخرجات. |
| [Save](../../aspose.svg/svgdocument/save/#save_2)(IOutputStorage, SVGSaveOptions) | يحفظ محتوى الوثيقة والموارد في تخزين المخرجات. |
| [Save](../../aspose.svg/svgdocument/save/#save_7)(string, SVGSaveFormat) | يحفظ المستند في الملف المحلي المحدد بواسطة`طريق` . سيتم حفظ جميع الموارد المستخدمة في هذا المستند في إلى المجلد المجاور ، والذي سيتم إنشاء اسمه على النحو التالي: output_file_name + "_files" . |
| [Save](../../aspose.svg/svgdocument/save/#save_8)(string, SVGSaveOptions) | يحفظ المستند في الملف المحلي المحدد بواسطة`طريق` . سيتم حفظ جميع الموارد المستخدمة في هذا المستند في إلى المجلد المجاور ، والذي سيتم إنشاء اسمه على النحو التالي: output_file_name + "_files" . |
| [Save](../../aspose.svg/svgdocument/save/#save_4)(Url, SVGSaveFormat) | يحفظ المستند في الملف المحلي المحدد بواسطة`عنوان url` . سيتم حفظ جميع الموارد المستخدمة في هذا المستند في إلى المجلد المجاور ، والذي سيتم إنشاء اسمه على النحو التالي: output_file_name + "_files" . |
| [Save](../../aspose.svg/svgdocument/save/#save_5)(Url, SVGSaveOptions) | يحفظ المستند في الملف المحلي المحدد بواسطة`عنوان url` . سيتم حفظ جميع الموارد المستخدمة في هذا المستند في إلى المجلد المجاور ، والذي سيتم إنشاء اسمه على النحو التالي: output_file_name + "_files" . |
...
| اسم | وصف |
| --- | --- |
| event [OnAbort](../../aspose.svg.dom/document/onabort/) | الحصول على معالج الحدث أو تعيينه لحدث OnAbort. |
| event [OnBlur](../../aspose.svg.dom/document/onblur/) | الحصول على معالج الحدث أو تعيينه لحدث OnBlur. |
| event [OnCancel](../../aspose.svg.dom/document/oncancel/) | الحصول على أو تعيين معالج الأحداث لحدث OnCancel. |
| event [OnCanplay](../../aspose.svg.dom/document/oncanplay/) | الحصول على معالج الحدث أو تعيينه لحدث OnCanplay. |
| event [OnCanPlayThrough](../../aspose.svg.dom/document/oncanplaythrough/) | الحصول على معالج الحدث أو تعيينه لحدث OnCanPlayThrough. |
| event [OnChange](../../aspose.svg.dom/document/onchange/) | الحصول على معالج الحدث لحدث OnChange أو تعيينه. |
| event [OnClick](../../aspose.svg.dom/document/onclick/) | الحصول على معالج الحدث لحدث OnClick أو تعيينه. |
| event [OnCueChange](../../aspose.svg.dom/document/oncuechange/) | الحصول على معالج الحدث أو تعيينه لحدث OnCueChange. |
| event [OnDblClick](../../aspose.svg.dom/document/ondblclick/) | الحصول على أو تعيين معالج الأحداث لحدث OnDblClick. |
| event [OnDurationChange](../../aspose.svg.dom/document/ondurationchange/) | الحصول على معالج الحدث لحدث OnDurationChange أو تعيينه. |
| event [OnEmptied](../../aspose.svg.dom/document/onemptied/) | الحصول على أو تعيين معالج الأحداث لحدث OnEmptied. |
| event [OnEnded](../../aspose.svg.dom/document/onended/) | الحصول على معالج الأحداث أو تعيينه لحدث OnEnded. |
| event [OnError](../../aspose.svg.dom/document/onerror/) | الحصول على معالج الحدث لحدث OnError أو تعيينه. |
| event [OnFocus](../../aspose.svg.dom/document/onfocus/) | الحصول على أو تعيين معالج الأحداث لحدث OnFocus. |
| event [OnInput](../../aspose.svg.dom/document/oninput/) | الحصول على أو تعيين معالج الأحداث لحدث OnInput. |
| event [OnInvalid](../../aspose.svg.dom/document/oninvalid/) | الحصول على معالج الحدث أو تعيينه لحدث OnInvalid . |
| event [OnKeyDown](../../aspose.svg.dom/document/onkeydown/) | الحصول على معالج الحدث أو تعيينه لحدث OnKeyDown. |
| event [OnKeyPress](../../aspose.svg.dom/document/onkeypress/) | الحصول على معالج الحدث أو تعيينه لحدث OnKeyPress. |
| event [OnKeyUp](../../aspose.svg.dom/document/onkeyup/) | الحصول على معالج الحدث أو تعيينه لحدث OnKeyUp. |
| event [OnLoad](../../aspose.svg.dom/document/onload/) | الحصول على معالج الحدث أو تعيينه لحدث OnLoad. |
| event [OnLoadedData](../../aspose.svg.dom/document/onloadeddata/) | الحصول على معالج الحدث أو تعيينه لحدث OnLoadedData. |
| event [OnLoadedMetadata](../../aspose.svg.dom/document/onloadedmetadata/) | الحصول على معالج الحدث لحدث OnLoadedMetadata أو تعيينه. |
| event [OnLoadStart](../../aspose.svg.dom/document/onloadstart/) | الحصول على أو تعيين معالج الأحداث لحدث OnLoadStart. |
| event [OnMouseDown](../../aspose.svg.dom/document/onmousedown/) | الحصول على معالج الحدث أو تعيينه لحدث OnMouseDown. |
| event [OnMouseEnter](../../aspose.svg.dom/document/onmouseenter/) | الحصول على معالج الحدث أو تعيينه لحدث OnMouseEnter. |
| event [OnMouseLeave](../../aspose.svg.dom/document/onmouseleave/) | الحصول على معالج الأحداث أو تعيينه لحدث OnMouseLeave. |
| event [OnMouseMove](../../aspose.svg.dom/document/onmousemove/) | الحصول على معالج الحدث أو تعيينه لحدث OnMouseMove. |
| event [OnMouseOut](../../aspose.svg.dom/document/onmouseout/) | الحصول على معالج الحدث أو تعيينه لحدث OnMouseOut. |
| event [OnMouseOver](../../aspose.svg.dom/document/onmouseover/) | الحصول على معالج الحدث أو تعيينه لحدث OnMouseOver. |
| event [OnMouseUp](../../aspose.svg.dom/document/onmouseup/) | الحصول على معالج الحدث أو تعيينه لحدث OnMouseUp. |
| event [OnMouseWheel](../../aspose.svg.dom/document/onmousewheel/) | الحصول على معالج الحدث أو تعيينه لحدث OnMouseWheel. |
| event [OnPause](../../aspose.svg.dom/document/onpause/) | الحصول على معالج الحدث أو تعيينه لحدث OnPause. |
| event [OnPlay](../../aspose.svg.dom/document/onplay/) | الحصول على معالج الحدث أو تعيينه لحدث OnPlay. |
| event [OnPlaying](../../aspose.svg.dom/document/onplaying/) | الحصول على معالج الحدث أو تعيينه لحدث OnPlaying. |
| event [OnProgress](../../aspose.svg.dom/document/onprogress/) | الحصول على معالج الحدث أو تعيينه لحدث OnProgress . |
| event [OnRateChange](../../aspose.svg.dom/document/onratechange/) | الحصول على معالج الحدث لحدث OnRateChange أو تعيينه. |
| event [OnReadyStateChange](../../aspose.svg.dom/document/onreadystatechange/) | الحصول على أو تعيين معالج الأحداث لحدث OnReadyStateChange. |
| event [OnReset](../../aspose.svg.dom/document/onreset/) | الحصول على معالج الحدث لحدث OnReset أو تعيينه. |
| event [OnResize](../../aspose.svg.dom/document/onresize/) | الحصول على معالج الحدث لحدث OnResize أو تعيينه. |
| event [OnScroll](../../aspose.svg.dom/document/onscroll/) | الحصول على أو تعيين معالج الأحداث لحدث OnScroll. |
| event [OnSeeked](../../aspose.svg.dom/document/onseeked/) | الحصول على معالج الحدث لحدث OnSeeked أو تعيينه. |
| event [OnSeeking](../../aspose.svg.dom/document/onseeking/) | الحصول على معالج الحدث لحدث OnSeeking أو تعيينه. |
| event [OnSelect](../../aspose.svg.dom/document/onselect/) | الحصول على معالج الحدث لحدث OnSelect أو تعيينه. |
| event [OnShow](../../aspose.svg.dom/document/onshow/) | الحصول على معالج الحدث لحدث OnShow أو تعيينه. |
| event [OnStalled](../../aspose.svg.dom/document/onstalled/) | الحصول على معالج الحدث للحدث OnStalled أو تعيينه. |
| event [OnSubmit](../../aspose.svg.dom/document/onsubmit/) | الحصول على معالج الحدث أو تعيينه لحدث OnSubmit. |
| event [OnSuspend](../../aspose.svg.dom/document/onsuspend/) | الحصول على معالج الحدث أو تعيينه لحدث OnSuspend. |
| event [OnTimeUpdate](../../aspose.svg.dom/document/ontimeupdate/) | الحصول على أو تعيين معالج الأحداث لحدث OnTimeUpdate. |
| event [OnToggle](../../aspose.svg.dom/document/ontoggle/) | الحصول على أو تعيين معالج الأحداث لحدث OnToggle. |
| event [OnVolumeChange](../../aspose.svg.dom/document/onvolumechange/) | الحصول على معالج الحدث لحدث OnVolumeChange أو تعيينه. |
| event [OnWaiting](../../aspose.svg.dom/document/onwaiting/) | الحصول على معالج الحدث للحدث OnWaiting أو تعيينه. |
