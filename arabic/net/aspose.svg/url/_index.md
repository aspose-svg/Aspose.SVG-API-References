...
| اسم | وصف |
| --- | --- |
| [Url](url#constructor)(string) | يقوم بتهيئة مثيل جديد لملف[`Url`](../url) مع عنوان URL المحدد. |
...
| [SearchParams](../../aspose.svg/url/searchparams) { get; } | يحصل على ملف[`IUrlSearchParams`](../iurlsearchparams) الكائن . |
