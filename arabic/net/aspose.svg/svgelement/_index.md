...
description: Aspose.Svg.SVGElement فصل. جميع واجهات SVG DOM التي تتوافق مباشرةً مع العناصر في لغة SVG مثل واجهة SVGPathElement لعنصر المسار مشتقة من واجهة SVGElement.
type: docs
weight: 3200
