...
description: Aspose.Svg.SVGClipPathElement فصل. تتوافق واجهة SVGClipPathElement مع عنصر clipPath.
type: docs
weight: 3140
...
| [ClipPathUnits](../../aspose.svg/svgclippathelement/clippathunits/) { get; } | يتوافق مع السمة "clipPathUnits" على عنصر "clipPath" المحدد. يأخذ أحد الثوابت المعرفة في SVGUnitTypes. |
...
| [Transform](../../aspose.svg/svgclippathelement/transform/) { get; } | يتوافق مع السمة "التحويل" على العنصر المحدد. |
