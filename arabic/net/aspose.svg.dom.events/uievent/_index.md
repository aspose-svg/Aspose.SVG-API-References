...
description: "Aspose.Svg.Dom.Events.UIEvent فئة. توفر واجهة UIEvent معلومات سياقية محددة مرتبطة بأحداث واجهة المستخدم."
type: docs
weight: 3000
url: /ar/net/aspose.svg.dom.events/uievent/
---
## UIEvent class

واجهة UIEvent تُوفر معلومات سياقية محددة مرتبطة بأحداث واجهة المستخدم.
...
| الاسم | الوصف |
| --- | --- |
| [UIEvent](uievent/#constructor)(*string*) | ينشئ مثيلًا جديدًا من فئة `UIEvent`. |
| [UIEvent](uievent/#constructor_1)(*string, IDictionary&lt;string, object&gt;*) | ينشئ مثيلًا جديدًا من فئة `UIEvent`. |
