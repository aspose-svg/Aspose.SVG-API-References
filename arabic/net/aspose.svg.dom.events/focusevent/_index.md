...
description: "Aspose.Svg.Dom.Events.FocusEvent فئة. توفر واجهة FocusEvent معلومات سياقية محددة مرتبطة بأحداث التركيز."
type: docs
weight: 2930
url: /ar/net/aspose.svg.dom.events/focusevent/
---
## FocusEvent class

واجهة FocusEvent تُوفر معلومات سياقية محددة مرتبطة بأحداث التركيز.
...
| الاسم | الوصف |
| --- | --- |
| [FocusEvent](focusevent/#constructor)(*string*) | يُنشئ مثيلاً جديدًا من الفئة `FocusEvent`. |
| [FocusEvent](focusevent/#constructor_1)(*string, IDictionary&lt;string, object&gt;*) | يُنشئ مثيلاً جديدًا من الفئة `FocusEvent`. |
...
| [RelatedTarget](../../aspose.svg.dom.events/focusevent/relatedtarget/) { get; } | يُستخدم لتحديد هدف حدث ثانوي مرتبط بحدث تركيز، حسب نوع الحدث. |
