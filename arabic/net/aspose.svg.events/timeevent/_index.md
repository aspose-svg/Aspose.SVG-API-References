...
description: Aspose.Svg.Events.TimeEvent فصل. توفر واجهة TimeEvent معلومات سياقية محددة مرتبطة بأحداث الوقت. الأنواع المختلفة من الأحداث التي يمكن أن تحدث هي startEvent و endEvent و RepEvent.
type: docs
weight: 1630
