...
description: Aspose.Svg.Filters.SVGFESpotLightElement فصل. تتوافق واجهة SVGFESpotLightElement مع عنصر feSpotLight.
type: docs
weight: 1870
...
| [LimitingConeAngle](../../aspose.svg.filters/svgfespotlightelement/limitingconeangle/) { get; } | يتوافق مع السمة "LimitingConeAngle" في عنصر "feSpotLight" المحدد. |
...
| [PointsAtX](../../aspose.svg.filters/svgfespotlightelement/pointsatx/) { get; } | يتوافق مع السمة "PointsAtX" على عنصر "feSpotLight" المحدد . |
| [PointsAtY](../../aspose.svg.filters/svgfespotlightelement/pointsaty/) { get; } | يتوافق مع السمة "PointsAtY" في عنصر "feSpotLight" المحدد. |
| [PointsAtZ](../../aspose.svg.filters/svgfespotlightelement/pointsatz/) { get; } | يتوافق مع السمة "PointsAtZ" على عنصر "feSpotLight" المحدد . |
...
| [SpecularExponent](../../aspose.svg.filters/svgfespotlightelement/specularexponent/) { get; } | يتوافق مع السمة "specularExponent" على عنصر "feSpotLight" المحدد. |
...
| [X](../../aspose.svg.filters/svgfespotlightelement/x/) { get; } | يتوافق مع السمة "x" في عنصر "feSpotLight" المحدد . |
| [Y](../../aspose.svg.filters/svgfespotlightelement/y/) { get; } | يتوافق مع السمة "y" في عنصر "feSpotLight" المحدد . |
| [Z](../../aspose.svg.filters/svgfespotlightelement/z/) { get; } | يتوافق مع السمة "z" في عنصر "feSpotLight" المحدد . |
