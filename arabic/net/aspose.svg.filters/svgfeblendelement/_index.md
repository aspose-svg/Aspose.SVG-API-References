...
description: Aspose.Svg.Filters.SVGFEBlendElement فصل. واجهة SVGFEBlendElement تتوافق مع عنصر feBlend.
type: docs
weight: 1650
...
| [Height](../../aspose.svg.filters/svgfeblendelement/height/) { get; } | يتوافق مع السمة "الارتفاع" على عنصر "الفلتر" المحدد . |
| [Id](../../aspose.svg/svgelement/id/) { get; set; } | قيمة سمة "id" في العنصر المحدد ، أو السلسلة الفارغة إذا لم يكن "id" موجودًا . |
| [In1](../../aspose.svg.filters/svgfeblendelement/in1/) { get; } | يتوافق مع السمة "in" في عنصر "feBlend" المحدد . |
| [In2](../../aspose.svg.filters/svgfeblendelement/in2/) { get; } | يتوافق مع السمة "in2" في عنصر "feBlend" المحدد . |
...
| [Mode](../../aspose.svg.filters/svgfeblendelement/mode/) { get; } | يتوافق مع السمة "الوضع" على عنصر "feBlend" المحدد. يأخذ أحد ثوابت SVG_FEBLEND_MODE_ * المحددة في هذه الواجهة . |
...
| [Result](../../aspose.svg.filters/svgfeblendelement/result/) { get; } | يتوافق مع السمة "نتيجة" على عنصر "عامل التصفية" المحدد . |
...
| [Width](../../aspose.svg.filters/svgfeblendelement/width/) { get; } | يتوافق مع السمة "العرض" على عنصر "الفلتر" المحدد . |
| [X](../../aspose.svg.filters/svgfeblendelement/x/) { get; } | يتوافق مع السمة "x" في عنصر "عامل التصفية" المحدد . |
| [Y](../../aspose.svg.filters/svgfeblendelement/y/) { get; } | يتوافق مع السمة "y" في عنصر "عامل التصفية" المحدد . |
...
| اسم | وصف |
| --- | --- |
| const [SVG_FEBLEND_MODE_COLOR](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_color/) | يتوافق مع قيمة "اللون" . |
| const [SVG_FEBLEND_MODE_COLOR_BURN](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_color_burn/) | يتوافق مع القيمة "color_burn" . |
| const [SVG_FEBLEND_MODE_COLOR_DODGE](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_color_dodge/) | يتوافق مع القيمة "color_dodge" . |
| const [SVG_FEBLEND_MODE_DARKEN](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_darken/) | يتوافق مع القيمة "تعتيم" . |
| const [SVG_FEBLEND_MODE_DIFFERENCE](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_difference/) | يتوافق مع "فرق" القيمة . |
| const [SVG_FEBLEND_MODE_EXCLUSION](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_exclusion/) | يتوافق مع "استبعاد" القيمة . |
| const [SVG_FEBLEND_MODE_HARD_LIGHT](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_hard_light/) | يتوافق مع القيمة "hard_light" . |
| const [SVG_FEBLEND_MODE_HUE](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_hue/) | يتوافق مع قيمة "hue" . |
| const [SVG_FEBLEND_MODE_LIGHTEN](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_lighten/) | يتوافق مع القيمة "lighten" . |
| const [SVG_FEBLEND_MODE_LUMINOSITY](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_luminosity/) | يتوافق مع قيمة "اللمعان" . |
| const [SVG_FEBLEND_MODE_MULTIPLY](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_multiply/) | يتوافق مع القيمة "مضاعفة" . |
| const [SVG_FEBLEND_MODE_NORMAL](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_normal/) | يتوافق مع القيمة "عادي" . |
| const [SVG_FEBLEND_MODE_OVERLAY](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_overlay/) | يتوافق مع القيمة "تراكب" . |
| const [SVG_FEBLEND_MODE_SATURATION](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_saturation/) | يتوافق مع قيمة "التشبع" . |
| const [SVG_FEBLEND_MODE_SCREEN](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_screen/) | يتوافق مع "شاشة" القيمة . |
| const [SVG_FEBLEND_MODE_SOFT_LIGHT](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_soft_light/) | يتوافق مع القيمة "soft_light" . |
| const [SVG_FEBLEND_MODE_UNKNOWN](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_unknown/) | النوع ليس من الأنواع المحددة مسبقًا. من غير الصحيح محاولة تحديد قيمة جديدة من هذا النوع أو محاولة تبديل قيمة موجودة إلى هذا النوع. |
