...
description: Aspose.Svg.Filters.SVGFEComponentTransferElement فصل. تتوافق واجهة SVGFEComponentTransferElement مع عنصر feComponentTransfer.
type: docs
weight: 1670
...
| [Height](../../aspose.svg.filters/svgfecomponenttransferelement/height/) { get; } | يتوافق مع السمة "الارتفاع" على عنصر "الفلتر" المحدد . |
| [Id](../../aspose.svg/svgelement/id/) { get; set; } | قيمة سمة "id" في العنصر المحدد ، أو السلسلة الفارغة إذا لم يكن "id" موجودًا . |
| [In1](../../aspose.svg.filters/svgfecomponenttransferelement/in1/) { get; } | يتوافق مع السمة "in" في عنصر "feComponentTransfer" المحدد . |
...
| [Result](../../aspose.svg.filters/svgfecomponenttransferelement/result/) { get; } | يتوافق مع السمة "نتيجة" على عنصر "عامل التصفية" المحدد . |
...
| [Width](../../aspose.svg.filters/svgfecomponenttransferelement/width/) { get; } | يتوافق مع السمة "العرض" على عنصر "الفلتر" المحدد . |
| [X](../../aspose.svg.filters/svgfecomponenttransferelement/x/) { get; } | يتوافق مع السمة "x" في عنصر "عامل التصفية" المحدد . |
| [Y](../../aspose.svg.filters/svgfecomponenttransferelement/y/) { get; } | يتوافق مع السمة "y" في عنصر "عامل التصفية" المحدد . |
