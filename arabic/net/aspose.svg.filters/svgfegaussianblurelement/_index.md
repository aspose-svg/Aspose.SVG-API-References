...
description: Aspose.Svg.Filters.SVGFEGaussianBlurElement فصل. تتوافق واجهة SVGFEGaussianBlurElement مع العنصر feGaussianBlur .
type: docs
weight: 1790
...
| [Height](../../aspose.svg.filters/svgfegaussianblurelement/height/) { get; } | يتوافق مع السمة "الارتفاع" على عنصر "عامل التصفية" المحدد . |
| [Id](../../aspose.svg/svgelement/id/) { get; set; } | قيمة سمة "id" في العنصر المحدد ، أو السلسلة الفارغة إذا لم يكن "id" موجودًا . |
| [In1](../../aspose.svg.filters/svgfegaussianblurelement/in1/) { get; } | يتوافق مع السمة �in� على عنصر �FeGaussianBlur المعطى . |
...
| [Result](../../aspose.svg.filters/svgfegaussianblurelement/result/) { get; } | يتوافق مع السمة �النتيجة على عنصر التصفية� المحدد . |
...
| [StdDeviationX](../../aspose.svg.filters/svgfegaussianblurelement/stddeviationx/) { get; } | يتوافق مع السمة �stdDeviation� على عنصر �feGaussianBlur� المحدد. يحتوي على المكون X للسمة �stdDeviation�. |
| [StdDeviationY](../../aspose.svg.filters/svgfegaussianblurelement/stddeviationy/) { get; } | يتوافق مع السمة �stdDeviation� على عنصر �feGaussianBlur� المحدد. يحتوي على المكون Y (ربما يتم حسابه تلقائيًا) للسمة �stdDeviation�. |
...
| [Width](../../aspose.svg.filters/svgfegaussianblurelement/width/) { get; } | يتوافق مع السمة "العرض" على عنصر التصفية "المحدد . |
| [X](../../aspose.svg.filters/svgfegaussianblurelement/x/) { get; } | يتوافق مع السمة × على عنصر التصفية المحدد . |
| [Y](../../aspose.svg.filters/svgfegaussianblurelement/y/) { get; } | يتوافق مع السمة � ص� على عنصر التصفية� المحدد . |
...
| [SetStdDeviation](../../aspose.svg.filters/svgfegaussianblurelement/setstddeviation/)(float, float) | يعيّن قيم السمة �الانحراف القياسي� . |
