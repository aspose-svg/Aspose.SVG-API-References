...
description: Aspose.Svg.Filters.SVGFEFloodElement فصل. تتوافق واجهة SVGFEFloodElement مع عنصر feFlood.
type: docs
weight: 1740
...
| [Height](../../aspose.svg.filters/svgfefloodelement/height/) { get; } | يتوافق مع السمة "الارتفاع" على عنصر "الفلتر" المحدد . |
...
| [Result](../../aspose.svg.filters/svgfefloodelement/result/) { get; } | يتوافق مع السمة "نتيجة" على عنصر "عامل التصفية" المحدد . |
...
| [Width](../../aspose.svg.filters/svgfefloodelement/width/) { get; } | يتوافق مع السمة "العرض" على عنصر "الفلتر" المحدد . |
| [X](../../aspose.svg.filters/svgfefloodelement/x/) { get; } | يتوافق مع السمة "x" في عنصر "عامل التصفية" المحدد . |
| [Y](../../aspose.svg.filters/svgfefloodelement/y/) { get; } | يتوافق مع السمة "y" في عنصر "عامل التصفية" المحدد . |
