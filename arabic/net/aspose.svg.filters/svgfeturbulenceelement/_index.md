...
description: Aspose.Svg.Filters.SVGFETurbulenceElement فصل. تتوافق واجهة SVGFETurbulenceElement مع عنصر feTurbulence.
type: docs
weight: 1890
url: /ar/net/aspose.svg.filters/svgfeturbulenceelement/
---
...
| [BaseFrequencyX](../../aspose.svg.filters/svgfeturbulenceelement/basefrequencyx/) { get; } | يتوافق مع السمة "baseFrequency" على عنصر "feTurbulence" المحدد. يحتوي على المكون X لسمة "baseFrequency". |
| [BaseFrequencyY](../../aspose.svg.filters/svgfeturbulenceelement/basefrequencyy/) { get; } | يتوافق مع السمة "baseFrequency" على عنصر "feTurbulence" المحدد. يحتوي على المكوِّن Y لسمة "baseFrequency" (ربما يتم حسابها تلقائيًا). |
...
| [Height](../../aspose.svg.filters/svgfeturbulenceelement/height/) { get; } | يتوافق مع السمة "الارتفاع" على عنصر "الفلتر" المحدد . |
...
| [NumOctaves](../../aspose.svg.filters/svgfeturbulenceelement/numoctaves/) { get; } | يتوافق مع السمة "عدد الأكتاف" على عنصر "feTurbulence" المحدد . |
...
| [Result](../../aspose.svg.filters/svgfeturbulenceelement/result/) { get; } | يتوافق مع السمة "نتيجة" على عنصر "عامل التصفية" المحدد . |
| [SchemaTypeInfo](../../aspose.svg.dom/element/schematypeinfo/) { get; } | نوع المعلومات المرتبطة بهذا العنصر . |
| [Seed](../../aspose.svg.filters/svgfeturbulenceelement/seed/) { get; } | يتوافق مع السمة "البذور" على عنصر "feTurbulence" المحدد . |
| [ShadowRoot](../../aspose.svg.dom/element/shadowroot/) { get; } | تُرجع shadowRoot المخزنة في هذا العنصر أو تُرجع فارغة إذا كان مغلقًا. |
| [StitchTiles](../../aspose.svg.filters/svgfeturbulenceelement/stitchtiles/) { get; } | يتوافق مع السمة "stitchTiles" على عنصر "feTurbulence" المحدد. يأخذ أحد ثوابت SVG_STITCHTYPE_ * المحددة في هذه الواجهة. |
...
| [Type](../../aspose.svg.filters/svgfeturbulenceelement/type/) { get; } | يتوافق مع السمة "type" على عنصر "feTurbulence" المحدد. يأخذ أحد ثوابت SVG_TURBULENCE_TYPE_ * المحددة في هذه الواجهة . |
...
| [Width](../../aspose.svg.filters/svgfeturbulenceelement/width/) { get; } | يتوافق مع السمة "العرض" على عنصر "الفلتر" المحدد . |
| [X](../../aspose.svg.filters/svgfeturbulenceelement/x/) { get; } | يتوافق مع السمة "x" في عنصر "عامل التصفية" المحدد . |
| [Y](../../aspose.svg.filters/svgfeturbulenceelement/y/) { get; } | يتوافق مع السمة "y" في عنصر "عامل التصفية" المحدد . |
...
| اسم | وصف |
| --- | --- |
| const [SVG_STITCHTYPE_NOSTITCH](../../aspose.svg.filters/svgfeturbulenceelement/svg_stitchtype_nostitch/) | يتوافق مع القيمة "noStitch" . |
| const [SVG_STITCHTYPE_STITCH](../../aspose.svg.filters/svgfeturbulenceelement/svg_stitchtype_stitch/) | يتوافق مع القيمة "غرزة" . |
| const [SVG_STITCHTYPE_UNKNOWN](../../aspose.svg.filters/svgfeturbulenceelement/svg_stitchtype_unknown/) | النوع ليس من الأنواع المحددة مسبقًا. من غير الصحيح محاولة تحديد قيمة جديدة من هذا النوع أو محاولة تبديل قيمة موجودة إلى هذا النوع. |
| const [SVG_TURBULENCE_TYPE_FRACTALNOISE](../../aspose.svg.filters/svgfeturbulenceelement/svg_turbulence_type_fractalnoise/) | يتوافق مع القيمة "fractalNoise". |
| const [SVG_TURBULENCE_TYPE_TURBULENCE](../../aspose.svg.filters/svgfeturbulenceelement/svg_turbulence_type_turbulence/) | يتوافق مع قيمة "الاضطرابات" . |
| const [SVG_TURBULENCE_TYPE_UNKNOWN](../../aspose.svg.filters/svgfeturbulenceelement/svg_turbulence_type_unknown/) | النوع ليس من الأنواع المحددة مسبقًا. من غير الصحيح محاولة تحديد قيمة جديدة من هذا النوع أو محاولة تبديل قيمة موجودة إلى هذا النوع. |
