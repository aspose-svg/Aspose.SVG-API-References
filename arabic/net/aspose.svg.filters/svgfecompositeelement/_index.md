...
description: Aspose.Svg.Filters.SVGFECompositeElement فصل. تتوافق واجهة SVGFECompositeElement مع عنصر feComposite.
type: docs
weight: 1680
...
| [Height](../../aspose.svg.filters/svgfecompositeelement/height/) { get; } | يتوافق مع السمة "الارتفاع" على عنصر "الفلتر" المحدد . |
| [Id](../../aspose.svg/svgelement/id/) { get; set; } | قيمة سمة "id" في العنصر المحدد ، أو السلسلة الفارغة إذا لم يكن "id" موجودًا . |
| [In1](../../aspose.svg.filters/svgfecompositeelement/in1/) { get; } | يتوافق مع السمة "in" في عنصر "feComposite" المحدد . |
| [In2](../../aspose.svg.filters/svgfecompositeelement/in2/) { get; } | يتوافق مع السمة "in2" في عنصر "feComposite" المحدد . |
...
| [K1](../../aspose.svg.filters/svgfecompositeelement/k1/) { get; } | يتوافق مع السمة "k1" على عنصر "feComposite" المحدد . |
| [K2](../../aspose.svg.filters/svgfecompositeelement/k2/) { get; } | يتوافق مع السمة "k2" على عنصر "feComposite" المحدد. |
| [K3](../../aspose.svg.filters/svgfecompositeelement/k3/) { get; } | يتوافق مع السمة "k3" على عنصر "feComposite" المحدد. |
| [K4](../../aspose.svg.filters/svgfecompositeelement/k4/) { get; } | يتوافق مع السمة "k4" على عنصر "feComposite" المحدد. |
...
| [Operator](../../aspose.svg.filters/svgfecompositeelement/operator/) { get; } | يتوافق مع السمة "عامل التشغيل" على عنصر "feComposite" المحدد. يأخذ أحد ثوابت SVG_FECOMPOSITE_OPERATOR_ * المحددة في هذه الواجهة. |
...
| [Result](../../aspose.svg.filters/svgfecompositeelement/result/) { get; } | يتوافق مع السمة "نتيجة" على عنصر "عامل التصفية" المحدد . |
...
| [Width](../../aspose.svg.filters/svgfecompositeelement/width/) { get; } | يتوافق مع السمة "العرض" على عنصر "الفلتر" المحدد . |
| [X](../../aspose.svg.filters/svgfecompositeelement/x/) { get; } | يتوافق مع السمة "x" في عنصر "عامل التصفية" المحدد . |
| [Y](../../aspose.svg.filters/svgfecompositeelement/y/) { get; } | يتوافق مع السمة "y" في عنصر "عامل التصفية" المحدد . |
...
| اسم | وصف |
| --- | --- |
| const [SVG_FECOMPOSITE_OPERATOR_ARITHMETIC](../../aspose.svg.filters/svgfecompositeelement/svg_fecomposite_operator_arithmetic/) | يتوافق مع القيمة "الحسابية" . |
| const [SVG_FECOMPOSITE_OPERATOR_ATOP](../../aspose.svg.filters/svgfecompositeelement/svg_fecomposite_operator_atop/) | يتوافق مع القيمة "أعلى" . |
| const [SVG_FECOMPOSITE_OPERATOR_IN](../../aspose.svg.filters/svgfecompositeelement/svg_fecomposite_operator_in/) | يتوافق مع القيمة "في" . |
| const [SVG_FECOMPOSITE_OPERATOR_OUT](../../aspose.svg.filters/svgfecompositeelement/svg_fecomposite_operator_out/) | يتوافق مع القيمة "out" . |
| const [SVG_FECOMPOSITE_OPERATOR_OVER](../../aspose.svg.filters/svgfecompositeelement/svg_fecomposite_operator_over/) | يتوافق مع القيمة "أكثر" . |
| const [SVG_FECOMPOSITE_OPERATOR_UNKNOWN](../../aspose.svg.filters/svgfecompositeelement/svg_fecomposite_operator_unknown/) | النوع ليس من الأنواع المحددة مسبقًا. من غير الصحيح محاولة تحديد قيمة جديدة من هذا النوع أو محاولة تبديل قيمة موجودة إلى هذا النوع. |
| const [SVG_FECOMPOSITE_OPERATOR_XOR](../../aspose.svg.filters/svgfecompositeelement/svg_fecomposite_operator_xor/) | يتوافق مع القيمة "xor" . |
