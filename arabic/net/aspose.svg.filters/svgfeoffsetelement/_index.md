...
description: Aspose.Svg.Filters.SVGFEOffsetElement فصل. تتوافق واجهة SVGFEOffsetElement مع عنصر feOffset.
type: docs
weight: 1840
...
| [Dx](../../aspose.svg.filters/svgfeoffsetelement/dx/) { get; } | يتوافق مع السمة "dx" على عنصر "feOffset" المحدد . |
| [Dy](../../aspose.svg.filters/svgfeoffsetelement/dy/) { get; } | يتوافق مع السمة "dy" في عنصر "feOffset" المحدد . |
...
| [Height](../../aspose.svg.filters/svgfeoffsetelement/height/) { get; } | يتوافق مع السمة "الارتفاع" على عنصر "الفلتر" المحدد . |
| [Id](../../aspose.svg/svgelement/id/) { get; set; } | قيمة سمة "id" في العنصر المحدد ، أو السلسلة الفارغة إذا لم يكن "id" موجودًا . |
| [In1](../../aspose.svg.filters/svgfeoffsetelement/in1/) { get; } | يتوافق مع السمة "in" في عنصر "feOffset" المحدد . |
...
| [Result](../../aspose.svg.filters/svgfeoffsetelement/result/) { get; } | يتوافق مع السمة "نتيجة" على عنصر "عامل التصفية" المحدد . |
...
| [Width](../../aspose.svg.filters/svgfeoffsetelement/width/) { get; } | يتوافق مع السمة "العرض" على عنصر "الفلتر" المحدد . |
| [X](../../aspose.svg.filters/svgfeoffsetelement/x/) { get; } | يتوافق مع السمة "x" في عنصر "عامل التصفية" المحدد . |
| [Y](../../aspose.svg.filters/svgfeoffsetelement/y/) { get; } | يتوافق مع السمة "y" في عنصر "عامل التصفية" المحدد . |
