...
description: Aspose.Svg.Filters.SVGFEPointLightElement فصل. تتوافق واجهة SVGFEPointLightElement مع عنصر fePointLight.
type: docs
weight: 1850
...
| [X](../../aspose.svg.filters/svgfepointlightelement/x/) { get; } | يتوافق مع السمة "x" في عنصر "fePointLight" المحدد . |
| [Y](../../aspose.svg.filters/svgfepointlightelement/y/) { get; } | يتوافق مع السمة "y" في عنصر "fePointLight" المحدد. |
| [Z](../../aspose.svg.filters/svgfepointlightelement/z/) { get; } | يتوافق مع السمة "z" في عنصر "fePointLight" المحدد. |
