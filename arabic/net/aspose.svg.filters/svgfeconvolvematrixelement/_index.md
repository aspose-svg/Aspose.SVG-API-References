...
description: Aspose.Svg.Filters.SVGFEConvolveMatrixElement فصل. تتوافق واجهة SVGFEConvolveMatrixElement مع عنصر feConvolveMatrix.
type: docs
weight: 1690
...
| [Bias](../../aspose.svg.filters/svgfeconvolvematrixelement/bias/) { get; } | يتوافق مع السمة "التحيز" على عنصر "feConvolveMatrix" المحدد. |
...
| [Divisor](../../aspose.svg.filters/svgfeconvolvematrixelement/divisor/) { get; } | يتوافق مع السمة "القاسم" على عنصر "feConvolveMatrix" المحدد. |
| [EdgeMode](../../aspose.svg.filters/svgfeconvolvematrixelement/edgemode/) { get; } | يتوافق مع السمة "edgeMode" في عنصر "feConvolveMatrix" المحدد. |
...
| [Height](../../aspose.svg.filters/svgfeconvolvematrixelement/height/) { get; } | يتوافق مع السمة "الارتفاع" على عنصر "الفلتر" المحدد . |
| [Id](../../aspose.svg/svgelement/id/) { get; set; } | قيمة سمة "id" في العنصر المحدد ، أو السلسلة الفارغة إذا لم يكن "id" موجودًا . |
| [In1](../../aspose.svg.filters/svgfeconvolvematrixelement/in1/) { get; } | يتوافق مع السمة "in" في عنصر "feConvolveMatrix" المحدد . |
...
| [KernelMatrix](../../aspose.svg.filters/svgfeconvolvematrixelement/kernelmatrix/) { get; } | يتوافق مع السمة "kernelMatrix" في عنصر "feConvolveMatrix" المحدد. |
| [KernelUnitLengthX](../../aspose.svg.filters/svgfeconvolvematrixelement/kernelunitlengthx/) { get; } | يتوافق مع السمة "kernelUnitLength" في عنصر "feConvolveMatrix" المحدد. |
| [KernelUnitLengthY](../../aspose.svg.filters/svgfeconvolvematrixelement/kernelunitlengthy/) { get; } | يتوافق مع السمة "kernelUnitLength" في عنصر "feConvolveMatrix" المحدد. |
...
| [OrderX](../../aspose.svg.filters/svgfeconvolvematrixelement/orderx/) { get; } | يتوافق مع السمة "الترتيب" على عنصر "feConvolveMatrix" المحدد . |
| [OrderY](../../aspose.svg.filters/svgfeconvolvematrixelement/ordery/) { get; } | يتوافق مع السمة "الترتيب" على عنصر "feConvolveMatrix" المحدد . |
...
| [PreserveAlpha](../../aspose.svg.filters/svgfeconvolvematrixelement/preservealpha/) { get; } | يتوافق مع السمة "keepAlpha" على عنصر "feConvolveMatrix" المحدد . |
...
| [Result](../../aspose.svg.filters/svgfeconvolvematrixelement/result/) { get; } | يتوافق مع السمة "نتيجة" على عنصر "عامل التصفية" المحدد . |
...
| [TargetX](../../aspose.svg.filters/svgfeconvolvematrixelement/targetx/) { get; } | يتوافق مع السمة "targetX" في عنصر "feConvolveMatrix" المحدد . |
| [TargetY](../../aspose.svg.filters/svgfeconvolvematrixelement/targety/) { get; } | يتوافق مع السمة "targetY" في عنصر "feConvolveMatrix" المحدد. |
...
| [Width](../../aspose.svg.filters/svgfeconvolvematrixelement/width/) { get; } | يتوافق مع السمة "العرض" على عنصر "الفلتر" المحدد . |
| [X](../../aspose.svg.filters/svgfeconvolvematrixelement/x/) { get; } | يتوافق مع السمة "x" في عنصر "عامل التصفية" المحدد . |
| [Y](../../aspose.svg.filters/svgfeconvolvematrixelement/y/) { get; } | يتوافق مع السمة "y" في عنصر "عامل التصفية" المحدد . |
...
| اسم | وصف |
| --- | --- |
| const [SVG_EDGEMODE_DUPLICATE](../../aspose.svg.filters/svgfeconvolvematrixelement/svg_edgemode_duplicate/) | يتوافق مع القيمة "مكررة" . |
| const [SVG_EDGEMODE_NONE](../../aspose.svg.filters/svgfeconvolvematrixelement/svg_edgemode_none/) | يتوافق مع القيمة "لا شيء" . |
| const [SVG_EDGEMODE_UNKNOWN](../../aspose.svg.filters/svgfeconvolvematrixelement/svg_edgemode_unknown/) | النوع ليس من الأنواع المحددة مسبقًا. من غير الصحيح محاولة تحديد قيمة جديدة من هذا النوع أو محاولة تبديل قيمة موجودة إلى هذا النوع. |
| const [SVG_EDGEMODE_WRAP](../../aspose.svg.filters/svgfeconvolvematrixelement/svg_edgemode_wrap/) | يتوافق مع القيمة "التفاف" . |
