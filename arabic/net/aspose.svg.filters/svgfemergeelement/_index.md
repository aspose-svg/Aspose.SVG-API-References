...
description: Aspose.Svg.Filters.SVGFEMergeElement فصل. تتوافق واجهة SVGFEMergeElement مع عنصر feMerge.
type: docs
weight: 1810
...
| [Height](../../aspose.svg.filters/svgfemergeelement/height/) { get; } | يتوافق مع السمة "الارتفاع" على عنصر "الفلتر" المحدد . |
...
| [Result](../../aspose.svg.filters/svgfemergeelement/result/) { get; } | يتوافق مع السمة "نتيجة" على عنصر "عامل التصفية" المحدد . |
...
| [Width](../../aspose.svg.filters/svgfemergeelement/width/) { get; } | يتوافق مع السمة "العرض" على عنصر "الفلتر" المحدد . |
| [X](../../aspose.svg.filters/svgfemergeelement/x/) { get; } | يتوافق مع السمة "x" في عنصر "عامل التصفية" المحدد . |
| [Y](../../aspose.svg.filters/svgfemergeelement/y/) { get; } | يتوافق مع السمة "y" في عنصر "عامل التصفية" المحدد . |
