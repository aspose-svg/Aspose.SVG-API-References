...
description: Aspose.Svg.Filters.SVGFEDisplacementMapElement فصل. تتوافق واجهة SVGFEDisplacementMapElement مع عنصر feDisplacementMap.
type: docs
weight: 1710
...
| [Height](../../aspose.svg.filters/svgfedisplacementmapelement/height/) { get; } | يتوافق مع السمة "الارتفاع" على عنصر "الفلتر" المحدد . |
| [Id](../../aspose.svg/svgelement/id/) { get; set; } | قيمة سمة "id" في العنصر المحدد ، أو السلسلة الفارغة إذا لم يكن "id" موجودًا . |
| [In1](../../aspose.svg.filters/svgfedisplacementmapelement/in1/) { get; } | يتوافق مع السمة "in" في عنصر "feDisplacementMap" المحدد . |
| [In2](../../aspose.svg.filters/svgfedisplacementmapelement/in2/) { get; } | يتوافق مع السمة "in2" في عنصر "feDisplacementMap" المحدد. |
...
| [Result](../../aspose.svg.filters/svgfedisplacementmapelement/result/) { get; } | يتوافق مع السمة "نتيجة" على عنصر "عامل التصفية" المحدد . |
| [Scale](../../aspose.svg.filters/svgfedisplacementmapelement/scale/) { get; } | يتوافق مع السمة "مقياس" على عنصر "feDisplacementMap" المحدد . |
...
| [Width](../../aspose.svg.filters/svgfedisplacementmapelement/width/) { get; } | يتوافق مع السمة "العرض" على عنصر "الفلتر" المحدد . |
| [X](../../aspose.svg.filters/svgfedisplacementmapelement/x/) { get; } | يتوافق مع السمة "x" في عنصر "عامل التصفية" المحدد . |
| [XChannelSelector](../../aspose.svg.filters/svgfedisplacementmapelement/xchannelselector/) { get; } | يتوافق مع السمة "xChannelSelector" في عنصر "feDisplacementMap" المحدد. يأخذ أحد ثوابت SVG_CHANNEL_ * المحددة في هذه الواجهة. |
| [Y](../../aspose.svg.filters/svgfedisplacementmapelement/y/) { get; } | يتوافق مع السمة "y" في عنصر "عامل التصفية" المحدد . |
| [YChannelSelector](../../aspose.svg.filters/svgfedisplacementmapelement/ychannelselector/) { get; } | يتوافق مع السمة "yChannelSelector" في عنصر "feDisplacementMap" المحدد. يأخذ أحد ثوابت SVG_CHANNEL_ * المحددة في هذه الواجهة. |
...
| اسم | وصف |
| --- | --- |
| const [SVG_CHANNEL_A](../../aspose.svg.filters/svgfedisplacementmapelement/svg_channel_a/) | يتوافق مع القيمة "أ" . |
| const [SVG_CHANNEL_B](../../aspose.svg.filters/svgfedisplacementmapelement/svg_channel_b/) | يتوافق مع القيمة "ب" . |
| const [SVG_CHANNEL_G](../../aspose.svg.filters/svgfedisplacementmapelement/svg_channel_g/) | يتوافق مع القيمة "G" . |
| const [SVG_CHANNEL_R](../../aspose.svg.filters/svgfedisplacementmapelement/svg_channel_r/) | يتوافق مع القيمة "R" . |
| const [SVG_CHANNEL_UNKNOWN](../../aspose.svg.filters/svgfedisplacementmapelement/svg_channel_unknown/) | النوع ليس من الأنواع المحددة مسبقًا. من غير الصحيح محاولة تحديد قيمة جديدة من هذا النوع أو محاولة تبديل قيمة موجودة إلى هذا النوع. |
