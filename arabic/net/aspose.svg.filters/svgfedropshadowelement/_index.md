...
description: Aspose.Svg.Filters.SVGFEDropShadowElement فصل. واجهة SVGFEDropShadowElement تتوافق مع عنصر feDropShadow.
type: docs
weight: 1730
...
| [Dx](../../aspose.svg.filters/svgfedropshadowelement/dx/) { get; } | يتوافق مع السمة "dx" على عنصر "feDropShadow" المحدد . |
| [Dy](../../aspose.svg.filters/svgfedropshadowelement/dy/) { get; } | يتوافق مع السمة "dy" على عنصر "feDropShadow" المحدد. |
...
| [Height](../../aspose.svg.filters/svgfedropshadowelement/height/) { get; } | يتوافق مع سمة "الارتفاع" على عنصر "feDropShadow" المحدد . |
| [Id](../../aspose.svg/svgelement/id/) { get; set; } | قيمة سمة "id" في العنصر المحدد ، أو السلسلة الفارغة إذا لم يكن "id" موجودًا . |
| [In1](../../aspose.svg.filters/svgfedropshadowelement/in1/) { get; } | يتوافق مع السمة "in" في عنصر "feDropShadow" المحدد . |
...
| [Result](../../aspose.svg.filters/svgfedropshadowelement/result/) { get; } | يتوافق مع السمة "نتيجة" على عنصر "feDropShadow" المحدد . |
...
| [StdDeviationX](../../aspose.svg.filters/svgfedropshadowelement/stddeviationx/) { get; } | يتوافق مع السمة "الانحراف القياسي" على عنصر "feDropShadow" المحدد. يحتوي على المكون X للسمة "الانحراف القياسي" . |
| [StdDeviationY](../../aspose.svg.filters/svgfedropshadowelement/stddeviationy/) { get; } | يتوافق مع السمة "الانحراف القياسي" على عنصر "feDropShadow" المحدد. يحتوي على المكوِّن Y (الذي يُحسب تلقائيًا) للسمة "الانحراف المعياري" . |
...
| [Width](../../aspose.svg.filters/svgfedropshadowelement/width/) { get; } | يتوافق مع السمة "العرض" على عنصر "feDropShadow" المحدد . |
| [X](../../aspose.svg.filters/svgfedropshadowelement/x/) { get; } | يتوافق مع السمة "x" في عنصر "feDropShadow" المحدد . |
| [Y](../../aspose.svg.filters/svgfedropshadowelement/y/) { get; } | يتوافق مع السمة "y" في عنصر "feDropShadow" المحدد . |
...
| [SetStdDeviation](../../aspose.svg.filters/svgfedropshadowelement/setstddeviation/)(float, float) | يضبط قيم السمة "الانحراف القياسي" . |
