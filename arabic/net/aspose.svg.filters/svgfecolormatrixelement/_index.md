...
description: Aspose.Svg.Filters.SVGFEColorMatrixElement فصل. تتوافق واجهة SVGFEColorMatrixElement مع عنصر feColorMatrix.
type: docs
weight: 1660
...
| [Height](../../aspose.svg.filters/svgfecolormatrixelement/height/) { get; } | يتوافق مع السمة "الارتفاع" على عنصر "الفلتر" المحدد . |
| [Id](../../aspose.svg/svgelement/id/) { get; set; } | قيمة سمة "id" في العنصر المحدد ، أو السلسلة الفارغة إذا لم يكن "id" موجودًا . |
| [In1](../../aspose.svg.filters/svgfecolormatrixelement/in1/) { get; } | يتوافق مع السمة "in" في عنصر "feColorMatrix" المحدد . |
...
| [Result](../../aspose.svg.filters/svgfecolormatrixelement/result/) { get; } | يتوافق مع السمة "نتيجة" على عنصر "عامل التصفية" المحدد . |
...
| [Type](../../aspose.svg.filters/svgfecolormatrixelement/type/) { get; } | يتوافق مع السمة "النوع" على عنصر "feColorMatrix" المحدد. يأخذ أحد ثوابت SVG_FECOLORMATRIX_TYPE_ * المحددة في هذه الواجهة. |
| [Values](../../aspose.svg.filters/svgfecolormatrixelement/values/) { get; } | يتوافق مع السمة "قيم" على عنصر "feColorMatrix" المحدد. |
...
| [Width](../../aspose.svg.filters/svgfecolormatrixelement/width/) { get; } | يتوافق مع السمة "العرض" على عنصر "الفلتر" المحدد . |
| [X](../../aspose.svg.filters/svgfecolormatrixelement/x/) { get; } | يتوافق مع السمة "x" في عنصر "عامل التصفية" المحدد . |
| [Y](../../aspose.svg.filters/svgfecolormatrixelement/y/) { get; } | يتوافق مع السمة "y" في عنصر "عامل التصفية" المحدد . |
...
| اسم | وصف |
| --- | --- |
| const [SVG_FECOLORMATRIX_TYPE_HUEROTATE](../../aspose.svg.filters/svgfecolormatrixelement/svg_fecolormatrix_type_huerotate/) | يتوافق مع القيمة "hueRotate" . |
| const [SVG_FECOLORMATRIX_TYPE_LUMINANCETOALPHA](../../aspose.svg.filters/svgfecolormatrixelement/svg_fecolormatrix_type_luminancetoalpha/) | يتوافق مع قيمة "luminanceToAlpha" . |
| const [SVG_FECOLORMATRIX_TYPE_MATRIX](../../aspose.svg.filters/svgfecolormatrixelement/svg_fecolormatrix_type_matrix/) | يتوافق مع قيمة "المصفوفة" . |
| const [SVG_FECOLORMATRIX_TYPE_SATURATE](../../aspose.svg.filters/svgfecolormatrixelement/svg_fecolormatrix_type_saturate/) | يتوافق مع القيمة "التشبع" . |
| const [SVG_FECOLORMATRIX_TYPE_UNKNOWN](../../aspose.svg.filters/svgfecolormatrixelement/svg_fecolormatrix_type_unknown/) | النوع ليس من الأنواع المحددة مسبقًا. من غير الصحيح محاولة تحديد قيمة جديدة من هذا النوع أو محاولة تبديل قيمة موجودة إلى هذا النوع. |
