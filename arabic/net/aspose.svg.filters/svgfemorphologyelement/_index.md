...
description: Aspose.Svg.Filters.SVGFEMorphologyElement فصل. تتوافق واجهة SVGFEMorphologyElement مع عنصر feMorphology.
type: docs
weight: 1830
...
| [Height](../../aspose.svg.filters/svgfemorphologyelement/height/) { get; } | يتوافق مع السمة "الارتفاع" على عنصر "الفلتر" المحدد . |
| [Id](../../aspose.svg/svgelement/id/) { get; set; } | قيمة سمة "id" في العنصر المحدد ، أو السلسلة الفارغة إذا لم يكن "id" موجودًا . |
| [In1](../../aspose.svg.filters/svgfemorphologyelement/in1/) { get; } | يتوافق مع السمة "in" في عنصر "feMorphology" المحدد . |
...
| [Operator](../../aspose.svg.filters/svgfemorphologyelement/operator/) { get; } | يتوافق مع السمة "عامل التشغيل" على عنصر "feMorphology" المحدد. يأخذ أحد ثوابت SVG_MORPHOLOGY_OPERATOR_ * المحددة في هذه الواجهة. |
...
| [RadiusX](../../aspose.svg.filters/svgfemorphologyelement/radiusx/) { get; } | يتوافق مع السمة "radius" على عنصر "feMorphology" المحدد. |
| [RadiusY](../../aspose.svg.filters/svgfemorphologyelement/radiusy/) { get; } | يتوافق مع السمة "radius" على عنصر "feMorphology" المحدد. |
| [Result](../../aspose.svg.filters/svgfemorphologyelement/result/) { get; } | يتوافق مع السمة "نتيجة" على عنصر "عامل التصفية" المحدد . |
...
| [Width](../../aspose.svg.filters/svgfemorphologyelement/width/) { get; } | يتوافق مع السمة "العرض" على عنصر "الفلتر" المحدد . |
| [X](../../aspose.svg.filters/svgfemorphologyelement/x/) { get; } | يتوافق مع السمة "x" في عنصر "عامل التصفية" المحدد . |
| [Y](../../aspose.svg.filters/svgfemorphologyelement/y/) { get; } | يتوافق مع السمة "y" في عنصر "عامل التصفية" المحدد . |
...
| اسم | وصف |
| --- | --- |
| const [SVG_MORPHOLOGY_OPERATOR_DILATE](../../aspose.svg.filters/svgfemorphologyelement/svg_morphology_operator_dilate/) | يتوافق مع القيمة "تمدد" . |
| const [SVG_MORPHOLOGY_OPERATOR_ERODE](../../aspose.svg.filters/svgfemorphologyelement/svg_morphology_operator_erode/) | يتوافق مع القيمة "تآكل" . |
| const [SVG_MORPHOLOGY_OPERATOR_UNKNOWN](../../aspose.svg.filters/svgfemorphologyelement/svg_morphology_operator_unknown/) | النوع ليس من الأنواع المحددة مسبقًا. من غير الصحيح محاولة تحديد قيمة جديدة من هذا النوع أو محاولة تبديل قيمة موجودة إلى هذا النوع. |
