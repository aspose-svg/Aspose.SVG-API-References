...
description: Aspose.Svg.Filters.SVGFEDiffuseLightingElement فصل. واجهة SVGFEDiffuseLightingElement تتوافق مع عنصر feDiffuseLighting.
type: docs
weight: 1700
...
| [DiffuseConstant](../../aspose.svg.filters/svgfediffuselightingelement/diffuseconstant/) { get; } | يتوافق مع السمة "diffuseConstant" على عنصر "feDiffuseLighting" المحدد. |
...
| [Height](../../aspose.svg.filters/svgfediffuselightingelement/height/) { get; } | يتوافق مع السمة "الارتفاع" على عنصر "الفلتر" المحدد . |
| [Id](../../aspose.svg/svgelement/id/) { get; set; } | قيمة سمة "id" في العنصر المحدد ، أو السلسلة الفارغة إذا لم يكن "id" موجودًا . |
| [In1](../../aspose.svg.filters/svgfediffuselightingelement/in1/) { get; } | يتوافق مع السمة "in" في عنصر "feDiffuseLighting" المحدد . |
...
| [KernelUnitLengthX](../../aspose.svg.filters/svgfediffuselightingelement/kernelunitlengthx/) { get; } | يتوافق مع السمة "kernelUnitLength" في عنصر "feDiffuseLighting" المحدد. |
| [KernelUnitLengthY](../../aspose.svg.filters/svgfediffuselightingelement/kernelunitlengthy/) { get; } | يتوافق مع السمة "kernelUnitLength" في عنصر "feDiffuseLighting" المحدد. |
...
| [Result](../../aspose.svg.filters/svgfediffuselightingelement/result/) { get; } | يتوافق مع السمة "نتيجة" على عنصر "عامل التصفية" المحدد . |
...
| [SurfaceScale](../../aspose.svg.filters/svgfediffuselightingelement/surfacescale/) { get; } | يتوافق مع السمة "SurfaceScale" على عنصر "feDiffuseLighting" المحدد. |
...
| [Width](../../aspose.svg.filters/svgfediffuselightingelement/width/) { get; } | يتوافق مع السمة "العرض" على عنصر "الفلتر" المحدد . |
| [X](../../aspose.svg.filters/svgfediffuselightingelement/x/) { get; } | يتوافق مع السمة "x" في عنصر "عامل التصفية" المحدد . |
| [Y](../../aspose.svg.filters/svgfediffuselightingelement/y/) { get; } | يتوافق مع السمة "y" في عنصر "عامل التصفية" المحدد . |
