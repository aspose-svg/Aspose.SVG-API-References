...
description: Aspose.Svg.Filters.SVGFESpecularLightingElement فصل. واجهة SVGFESpecularLightingElement تتوافق مع عنصر feSpecularLighting.
type: docs
weight: 1860
...
| [Height](../../aspose.svg.filters/svgfespecularlightingelement/height/) { get; } | يتوافق مع السمة "الارتفاع" على عنصر "الفلتر" المحدد . |
| [Id](../../aspose.svg/svgelement/id/) { get; set; } | قيمة سمة "id" في العنصر المحدد ، أو السلسلة الفارغة إذا لم يكن "id" موجودًا . |
| [In1](../../aspose.svg.filters/svgfespecularlightingelement/in1/) { get; } | يتوافق مع السمة "in" في عنصر "feSpecularLighting" المحدد. |
...
| [KernelUnitLengthX](../../aspose.svg.filters/svgfespecularlightingelement/kernelunitlengthx/) { get; } | يتوافق مع السمة "kernelUnitLength" في عنصر "feSpecularLighting" المحدد. |
| [KernelUnitLengthY](../../aspose.svg.filters/svgfespecularlightingelement/kernelunitlengthy/) { get; } | يتوافق مع السمة "kernelUnitLength" في عنصر "feSpecularLighting" المحدد. |
...
| [Result](../../aspose.svg.filters/svgfespecularlightingelement/result/) { get; } | يتوافق مع السمة "نتيجة" على عنصر "عامل التصفية" المحدد . |
...
| [SpecularConstant](../../aspose.svg.filters/svgfespecularlightingelement/specularconstant/) { get; } | يتوافق مع السمة "specularConstant" في عنصر "feSpecularLighting" المحدد. |
| [SpecularExponent](../../aspose.svg.filters/svgfespecularlightingelement/specularexponent/) { get; } | يتوافق مع السمة "specularExponent" على عنصر "feSpecularLighting" المحدد. |
...
| [SurfaceScale](../../aspose.svg.filters/svgfespecularlightingelement/surfacescale/) { get; } | يتوافق مع السمة "SurfaceScale" على عنصر "feSpecularLighting" المحدد. |
...
| [Width](../../aspose.svg.filters/svgfespecularlightingelement/width/) { get; } | يتوافق مع السمة "العرض" على عنصر "الفلتر" المحدد . |
| [X](../../aspose.svg.filters/svgfespecularlightingelement/x/) { get; } | يتوافق مع السمة "x" في عنصر "عامل التصفية" المحدد . |
| [Y](../../aspose.svg.filters/svgfespecularlightingelement/y/) { get; } | يتوافق مع السمة "y" في عنصر "عامل التصفية" المحدد . |
