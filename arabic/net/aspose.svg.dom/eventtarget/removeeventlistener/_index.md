...
description: تسمح هذه الطريقة بإزالة مستمعي الحدث من هدف الحدث. إذا كانIEventListeneraspose.svg.dom.events/ieventlistener تمت إزالته من ملفEventTargetaspose.svg.dom/eventtarget أثناء معالجة حدث  لن يتم تشغيله من خلال الإجراءات الحالية. لا يمكن استدعاء مستمعي الأحداث بعد إزالتها.
type: docs
weight: 40
...
تسمح هذه الطريقة بإزالة مستمعي الحدث من هدف الحدث. إذا كان[`IEventListener`](../../../aspose.svg.dom.events/ieventlistener) تمت إزالته من ملف[`EventTarget`](../../eventtarget) أثناء معالجة حدث ، لن يتم تشغيله من خلال الإجراءات الحالية. لا يمكن استدعاء مستمعي الأحداث بعد إزالتها.
