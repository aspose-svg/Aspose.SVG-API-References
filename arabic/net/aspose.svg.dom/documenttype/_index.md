...
description: Aspose.Svg.Dom.DocumentType فصل. يوفر DocumentType واجهة لقائمة الكيانات المحددة للمستند document
type: docs
weight: 830
url: /ar/net/aspose.svg.dom/documenttype/
---
## DocumentType class
...
| [InternalSubset](../../aspose.svg.dom/documenttype/internalsubset/) { get; } | المجموعة الفرعية الداخلية كسلسلة ، أو فارغة إذا لم يكن هناك أي منها. |
...
| [Name](../../aspose.svg.dom/documenttype/name/) { get; } | اسم DTD ؛ على سبيل المثال ، الاسم الذي يلي الكلمة الأساسية DOCTYPE مباشرة. |
...
| override [NodeName](../../aspose.svg.dom/documenttype/nodename/) { get; } | اسم هذه العقدة حسب نوعها. |
| override [NodeType](../../aspose.svg.dom/documenttype/nodetype/) { get; } | رمز يمثل نوع الكائن الأساسي. |
...
| [PublicId](../../aspose.svg.dom/documenttype/publicid/) { get; } | المعرف العام للمجموعة الفرعية الخارجية . |
| [SystemId](../../aspose.svg.dom/documenttype/systemid/) { get; } | معرّف النظام الخاص بالمجموعة الفرعية الخارجية. قد يكون هذا URI مطلقًا أم لا. |
...
| override [ToString](../../aspose.svg.dom/documenttype/tostring/)() | إرجاع أString الذي يمثل هذا المثال. |
