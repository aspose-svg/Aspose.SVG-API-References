...
description: "فئة Aspose.Svg.Dom.Notation. تمثِّل تدوينًا مُعلنًا في DTD."
type: docs
weight: 3150
...
| [PublicId](../../aspose.svg.dom/notation/publicid/) { get; } | المعرّف العام لهذا التدوين. إذا لم يُحدَّد المعرف العام، فستكون القيمة null. |
| [SystemId](../../aspose.svg.dom/notation/systemid/) { get; } | المعرّف النظامي لهذا التدوين. إذا لم يُحدَّد المعرف النظامي، فستكون القيمة null. قد يكون هذا URI مطلقًا أو لا. |
