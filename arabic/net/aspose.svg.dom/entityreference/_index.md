...
description: Aspose.Svg.Dom.EntityReference فصل. يمكن استخدام عقد EntityReference لتمثيل مرجع كيان في الشجرة.
type: docs
weight: 860
url: /ar/net/aspose.svg.dom/entityreference/
---
...
| override [NodeName](../../aspose.svg.dom/entityreference/nodename/) { get; } | اسم هذه العقدة حسب نوعها. |
| override [NodeType](../../aspose.svg.dom/entityreference/nodetype/) { get; } | رمز يمثل نوع الكائن الأساسي. |
