...
description: "الفئة Aspose.Svg.Dom.Comment. ترث من CharacterData وتمثل محتوى التعليق أي جميع الأحرف بين بداية التعليق."
type: docs
weight: 2460
url: /ar/net/aspose.svg.dom/comment/
---
## Comment class

ورثت من CharacterData وتمثل محتوى تعليق، أي جميع الأحرف بين البداية ''.
...
| override [NodeName](../../aspose.svg.dom/comment/nodename/) { get; } | اسم هذه العقدة، حسب نوعها. |
| override [NodeType](../../aspose.svg.dom/comment/nodetype/) { get; } | رمز يمثل نوع الكائن الأساسي. |
| override [NodeValue](../../aspose.svg.dom/comment/nodevalue/) { get; set; } | قيمة هذه العقدة، حسب نوعها. |
