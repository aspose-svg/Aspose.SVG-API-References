...
description: Aspose.Svg.Dom.Entity فصل. يمثل كيانًا معروفًا  سواء تم تحليله أو عدم تحليله  في مستند XML.
type: docs
weight: 850
...
| [InputEncoding](../../aspose.svg.dom/entity/inputencoding/) { get; } | سمة تحدد الترميز المستخدم لهذا الكيان في وقت التحليل ، عندما يكون كيانًا خارجيًا محللًا. يعد هذا فارغًا إذا كان كيانًا من مجموعة فرعية داخلية أو إذا كان غير معروف. |
...
| [NotationName](../../aspose.svg.dom/entity/notationname/) { get; } | بالنسبة للكيانات التي لم يتم تحليلها ، اسم الترميز الخاص بالكيان. بالنسبة للكيانات التي تم تحليلها ، يعد هذا فارغًا . |
...
| [PublicId](../../aspose.svg.dom/entity/publicid/) { get; } | المعرف العام المرتبط بالكيان إذا تم تحديده ، وخالٍ بخلاف ذلك. |
| [SystemId](../../aspose.svg.dom/entity/systemid/) { get; } | معرّف النظام المرتبط بالكيان إذا تم تحديده ، وخالٍ بخلاف ذلك. قد يكون هذا URI مطلقًا أم لا. |
...
| [XmlEncoding](../../aspose.svg.dom/entity/xmlencoding/) { get; } | سمة تحدد ، كجزء من الإعلان النصي ، ترميز هذا الكيان ، عندما يكون كيانًا خارجيًا محللًا. هذا لاغى خلاف ذلك. |
| [XmlVersion](../../aspose.svg.dom/entity/xmlversion/) { get; } | سمة تحدد ، كجزء من الإعلان النصي ، رقم إصدار هذا الكيان ، عندما يكون كيانًا خارجيًا محللًا. هذا لاغى خلاف ذلك. |
