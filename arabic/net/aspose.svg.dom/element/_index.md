...
description: "فئة Aspose.Svg.Dom.Element. تمثل واجهة العنصر عنصرًا في مستند HTML أو XML."
type: docs
weight: 2840
url: /ar/net/aspose.svg.dom/element/
---
## Element class
...
| الاسم | الوصف |
| --- | --- |
| [Element](element/)(*[QualifiedName](../qualifiedname/), [Document](../document/)*) | ينشئ مثيلًا جديدًا من فئة `Element`. لا تستدعِ هذا المُنشئ مباشرةً، استخدم [`CreateElement`](../document/createelement/) أو [`CreateElementNS`](../document/createelementns/). |
...
| [Id](../../aspose.svg.dom/element/id/) { get; set; } | معرّف العنصر. راجع تعريف سمة id في HTML 4.01. |
...
| [ParentElement](../../aspose.svg.dom/node/parentelement/) { get; } | يعيد العنصر الأب `Element` لعقدة DOM، أو null إذا لم يكن للعقدة أب، أو إذا لم يكن أبها عنصر DOM. |
...
| [AttachShadow](../../aspose.svg.dom/element/attachshadow/)(*[ShadowRootMode](../shadowrootmode/)*) | ينشئ shadow root ويُرفقه بالعنصر الحالي. |
...
| [GetElementsByClassName](../../aspose.svg.dom/element/getelementsbyclassname/)(*string*) | يعيد كائن [`HTMLCollection`](../../aspose.svg.collections/htmlcollection/) يحتوي على جميع العناصر داخل `element` التي تمتلك جميع الفئات المحددة في الوسيط. |
| [GetElementsByTagName](../../aspose.svg.dom/element/getelementsbytagname/)(*string*) | يعيد كائن [`HTMLCollection`](../../aspose.svg.collections/htmlcollection/) يحتوي على جميع `elements` ذات اسم علامة معين، بترتيب المستند. |
| [GetElementsByTagNameNS](../../aspose.svg.dom/element/getelementsbytagnamens/)(*string, string*) | يعيد كائن [`HTMLCollection`](../../aspose.svg.collections/htmlcollection/) يحتوي على جميع `elements` ذات اسم محلي ومسار مساحة اسم URI معين، بترتيب المستند. |
...
| [RemoveAttributeNode](../../aspose.svg.dom/element/removeattributenode/)(*[Attr](../attr/)*) | يزيل عقدة السمة المحددة. |
...
| [SetAttributeNode](../../aspose.svg.dom/element/setattributenode/)(*[Attr](../attr/)*) | يضيف عقدة سمة جديدة. إذا كانت سمة بهذا الاسم (nodeName) موجودة بالفعل في العنصر، يتم استبدالها بالجديدة. |
| [SetAttributeNodeNS](../../aspose.svg.dom/element/setattributenodens/)(*[Attr](../attr/)*) | يضيف سمة جديدة. إذا كانت سمة بهذا الاسم المحلي وURI مساحة الاسم موجودة بالفعل في العنصر، يتم استبدالها بالجديدة. |
...
| [ToggleAttribute](../../aspose.svg.dom/element/toggleattribute/#toggleattribute)(*string*) | إذا لم يتم تقديم force، "يقلب" qualifiedName، يزيله إذا كان موجودًا ويضيفه إذا لم يكن موجودًا. إذا كان force true، يضيف qualifiedName. إذا كان force false، يزيل qualifiedName. |
| [ToggleAttribute](../../aspose.svg.dom/element/toggleattribute/#toggleattribute_1)(*string, bool*) | إذا لم يتم تقديم force، "يقلب" qualifiedName، يزيله إذا كان موجودًا ويضيفه إذا لم يكن موجودًا. إذا كان force true، يضيف qualifiedName. إذا كان force false، يزيل qualifiedName. |
