...
description: Aspose.Svg.Dom.Element فصل. تمثل واجهة العنصر عنصرًا في مستند HTML أو XML.
type: docs
weight: 840
...
| [Id](../../aspose.svg.dom/element/id/) { get; set; } | معرف العنصر. راجع تعريف سمة المعرف في HTML 4.01. |
...
| [ParentElement](../../aspose.svg.dom/node/parentelement/) { get; } | يحصل على الوالد`Element` من هذه العقدة. |
