...
description: Aspose.Svg.Dom.ProcessingInstruction فصل. تمثل تعليمات المعالجة تعليمات معالجة تُستخدم في XML كطريقة للاحتفاظ بالمعلومات الخاصة بالمعالج في نص المستند.
type: docs
weight: 1170
