---
title: "الفئة ProcessingInstruction"
second_title: "مرجع API لـ Aspose.SVG لـ .NET"
description: "الفئة Aspose.Svg.Dom.ProcessingInstruction. تمثل ProcessingInstruction تعليمًا للمعالجة يُستخدم في XML كطريقة للحفاظ على معلومات خاصة بالمُعالج داخل نص المستند."
type: docs
weight: 3160
url: /ar/net/aspose.svg.dom/processinginstruction/
---
## ProcessingInstruction class

تمثل ProcessingInstruction "تعليمة معالجة"، وتُستخدم في XML كطريقة للحفاظ على معلومات خاصة بالمعالج في نص المستند.
...
| override [NodeName](../../aspose.svg.dom/processinginstruction/nodename/) { get; } | اسم هذه العقدة، حسب نوعها. |
| override [NodeType](../../aspose.svg.dom/processinginstruction/nodetype/) { get; } | رمز يمثل نوع الكائن الأساسي. |
| override [NodeValue](../../aspose.svg.dom/processinginstruction/nodevalue/) { get; set; } | قيمة هذه العقدة، حسب نوعها. |
