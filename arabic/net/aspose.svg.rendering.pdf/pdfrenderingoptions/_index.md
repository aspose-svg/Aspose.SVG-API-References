...
description: Aspose.Svg.Rendering.Pdf.PdfRenderingOptions فصل. يمثل خيارات التقديم لـPdfDevice .
type: docs
weight: 2980
...
| اسم | وصف |
| --- | --- |
| [PdfRenderingOptions](pdfrenderingoptions/)() | يقوم بتهيئة مثيل جديد لملف`PdfRenderingOptions` فئة . |
...
| [FormFieldBehaviour](../../aspose.svg.rendering.pdf/pdfrenderingoptions/formfieldbehaviour/) { get; set; } | يحدد سلوك حقول النموذج في مستند PDF الناتج. |
