...
description: Aspose.Svg.Dom.Attr kelas. Antarmuka Attr mewakili atribut dalam objek Elemen. Biasanya nilai yang diizinkan untuk atribut ditentukan dalam skema yang terkait dengan dokumen.
type: docs
weight: 350
url: /id/net/aspose.svg.dom/attr/
---
## Attr class
...
| [IsId](../../aspose.svg.dom/attr/isid/) { get; } | Mengembalikan apakah atribut ini diketahui bertipe ID (yakni mengandung pengenal untuk elemen pemiliknya) atau tidak. |
...
| override [LocalName](../../aspose.svg.dom/attr/localname/) { get; } | Mengembalikan bagian lokal dari nama yang memenuhi syarat dari node ini. Untuk node jenis apa pun selain ELEMENT_NODE dan ATTRIBUTE_NODE dan node yang dibuat dengan metode DOM Level 1, seperti Document.createElement(), ini selalu null. |
| [Name](../../aspose.svg.dom/attr/name/) { get; } | Mengembalikan nama atribut ini. |
| override [NamespaceURI](../../aspose.svg.dom/attr/namespaceuri/) { get; } | Namespace URI node ini, atau null jika tidak ditentukan. |
...
| override [NodeName](../../aspose.svg.dom/attr/nodename/) { get; } | Nama node ini, tergantung jenisnya. |
| override [NodeType](../../aspose.svg.dom/attr/nodetype/) { get; } | Kode yang mewakili jenis objek yang mendasarinya. |
| override [NodeValue](../../aspose.svg.dom/attr/nodevalue/) { get; set; } | Nilai simpul ini, tergantung pada jenisnya. |
...
| [OwnerElement](../../aspose.svg.dom/attr/ownerelement/) { get; } | Simpul elemen yang dilampirkan atribut ini atau null jika atribut ini tidak digunakan. |
...
| override [Prefix](../../aspose.svg.dom/attr/prefix/) { get; } | Awalan namespace node ini, atau null jika tidak ditentukan. Ketika didefinisikan sebagai null, menyetelnya tidak berpengaruh |
...
| [SchemaTypeInfo](../../aspose.svg.dom/attr/schematypeinfo/) { get; } | Jenis informasi yang terkait dengan atribut ini. |
| [Specified](../../aspose.svg.dom/attr/specified/) { get; } | Benar jika atribut ini secara eksplisit diberi nilai dalam dokumen contoh, salah jika sebaliknya. |
| override [TextContent](../../aspose.svg.dom/attr/textcontent/) { get; set; } | Atribut ini mengembalikan konten teks dari node ini dan turunannya. Ketika didefinisikan sebagai nol, pengaturan itu tidak berpengaruh. Pada pengaturan, setiap anak yang mungkin dimiliki simpul ini dihapus dan, jika string baru tidak kosong atau nol, diganti dengan simpul Teks tunggal yang berisi string yang disetel ke atribut ini. |
| [Value](../../aspose.svg.dom/attr/value/) { get; set; } | Saat pengambilan, nilai atribut dikembalikan sebagai string. |
