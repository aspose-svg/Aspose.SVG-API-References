...
description: Aspose.Svg.Dom.CDATASection kelas. Bagian CDATA digunakan untuk keluar dari blok teks yang berisi karakter yang seharusnya dianggap sebagai markup.
type: docs
weight: 440
url: /id/net/aspose.svg.dom/cdatasection/
---
## CDATASection class
...
| [IsElementContentWhitespace](../../aspose.svg.dom/text/iselementcontentwhitespace/) { get; } | Mengembalikan apakah simpul teks ini berisi spasi kosong konten elemen, sering kali secara kasar disebut "spasi kosong yang tidak dapat diabaikan". |
...
| override [NodeName](../../aspose.svg.dom/cdatasection/nodename/) { get; } | Nama node ini, tergantung jenisnya. |
| override [NodeType](../../aspose.svg.dom/cdatasection/nodetype/) { get; } | Kode yang mewakili jenis objek yang mendasarinya. |
| override [NodeValue](../../aspose.svg.dom/text/nodevalue/) { get; set; } | Nilai simpul ini, tergantung pada jenisnya. |
...
| [WholeText](../../aspose.svg.dom/text/wholetext/) { get; } | Mengembalikan semua teks node Teks yang berdekatan secara logis dengan node teks ke node ini, digabungkan dalam urutan dokumen. |
...
| [ReplaceWholeText](../../aspose.svg.dom/text/replacewholetext/)(string) | Mengganti teks dari node saat ini dan semua node teks yang berdekatan secara logis dengan teks yang ditentukan. Semua node teks yang berdekatan secara logis dihapus termasuk node saat ini kecuali node tersebut adalah penerima teks pengganti. |
| [SplitText](../../aspose.svg.dom/text/splittext/)(int) | Memecah simpul ini menjadi dua simpul pada offset yang ditentukan, mempertahankan keduanya di pohon sebagai saudara kandung. |
