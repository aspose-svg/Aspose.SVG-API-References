...
description: Aspose.Svg.Dom.Node kelas. Antarmuka Node adalah tipe data utama untuk seluruh Model objek Dokumen. Ini mewakili satu simpul di pohon dokumen.
type: docs
weight: 1150
url: /id/net/aspose.svg.dom/node/
---
## Node class
...
| abstract [NodeName](../../aspose.svg.dom/node/nodename/) { get; } | Nama node ini, tergantung jenisnya. |
| abstract [NodeType](../../aspose.svg.dom/node/nodetype/) { get; } | Kode yang mewakili jenis objek yang mendasarinya. |
...
| [CloneNode](../../aspose.svg.dom/node/clonenode/#clonenode)() | Mengembalikan duplikat dari node ini, misalnya berfungsi sebagai pembuat salinan umum untuk node. Node duplikat tidak memiliki induk (parentNode adalah null) dan tidak ada data pengguna. |
| [CloneNode](../../aspose.svg.dom/node/clonenode/#clonenode_1)(bool) | Mengembalikan duplikat dari node ini, misalnya berfungsi sebagai pembuat salinan umum untuk node. Node duplikat tidak memiliki induk (parentNode adalah null) dan tidak ada data pengguna. |
...
| Nama | Keterangan |
| --- | --- |
| const [ATTRIBUTE_NODE](../../aspose.svg.dom/node/attribute_node/) | Node atribut |
| const [CDATA_SECTION_NODE](../../aspose.svg.dom/node/cdata_section_node/) | Node bagian cdata |
| const [COMMENT_NODE](../../aspose.svg.dom/node/comment_node/) | Node komentar |
| const [DOCUMENT_FRAGMENT_NODE](../../aspose.svg.dom/node/document_fragment_node/) | Node fragmen dokumen |
| const [DOCUMENT_NODE](../../aspose.svg.dom/node/document_node/) | Simpul dokumen |
| const [DOCUMENT_TYPE_NODE](../../aspose.svg.dom/node/document_type_node/) | Node tipe dokumen |
| const [ELEMENT_NODE](../../aspose.svg.dom/node/element_node/) | Simpul elemen |
| const [ENTITY_NODE](../../aspose.svg.dom/node/entity_node/) | Sebuah node entitas |
| const [ENTITY_REFERENCE_NODE](../../aspose.svg.dom/node/entity_reference_node/) | Node referensi entitas |
| const [NOTATION_NODE](../../aspose.svg.dom/node/notation_node/) | Node notasi |
| const [PROCESSING_INSTRUCTION_NODE](../../aspose.svg.dom/node/processing_instruction_node/) | Node instruksi pemrosesan |
| const [TEXT_NODE](../../aspose.svg.dom/node/text_node/) | Simpul teks |
