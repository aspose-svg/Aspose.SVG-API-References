...
description: Aspose.Svg.Dom.Document kelas. Dokumen mewakili seluruh dokumen HTML XML atau SVG. Secara konseptual ini adalah akar pohon dokumen dan menyediakan akses utama ke data dokumen.
type: docs
weight: 810
url: /id/net/aspose.svg.dom/document/
---
## Document class
...
| [CreateNodeIterator](../../aspose.svg.dom/document/createnodeiterator/#createnodeiterator)(Node) | Buat NodeIterator baru di atas subtree yang di-root pada node yang ditentukan. |
| [CreateNodeIterator](../../aspose.svg.dom/document/createnodeiterator/#createnodeiterator_1)(Node, long) | Buat NodeIterator baru di atas subtree yang di-root pada node yang ditentukan. |
| [CreateNodeIterator](../../aspose.svg.dom/document/createnodeiterator/#createnodeiterator_2)(Node, long, INodeFilter) | Buat NodeIterator baru di atas subtree yang di-root pada node yang ditentukan. |
...
| [CreateTreeWalker](../../aspose.svg.dom/document/createtreewalker/#createtreewalker)(Node) | Buat TreeWalker baru di atas subtree yang di-root di node yang ditentukan. |
| [CreateTreeWalker](../../aspose.svg.dom/document/createtreewalker/#createtreewalker_1)(Node, long) | Buat TreeWalker baru di atas subtree yang di-root di node yang ditentukan. |
| [CreateTreeWalker](../../aspose.svg.dom/document/createtreewalker/#createtreewalker_2)(Node, long, INodeFilter) | Buat TreeWalker baru di atas subtree yang di-root di node yang ditentukan. |
...
| [Navigate](../../aspose.svg.dom/document/navigate/#navigate)(RequestMessage) | Memuat dokumen berdasarkan objek permintaan yang ditentukan, menggantikan konten sebelumnya. |
| [Navigate](../../aspose.svg.dom/document/navigate/#navigate_4)(string) | Memuat dokumen di Uniform Resource Locator (URL) yang ditentukan ke dalam instance saat ini, menggantikan konten sebelumnya. |
| [Navigate](../../aspose.svg.dom/document/navigate/#navigate_1)(Url) | Memuat dokumen di Uniform Resource Locator (URL) yang ditentukan ke dalam instance saat ini, menggantikan konten sebelumnya. |
| [Navigate](../../aspose.svg.dom/document/navigate/#navigate_3)(Stream, string) | Memuat dokumen dari konten tertentu dan menggunakan baseUri untuk menyelesaikan sumber daya relatif, menggantikan konten sebelumnya. Pemuatan dokumen dimulai dari posisi saat ini di aliran. |
| [Navigate](../../aspose.svg.dom/document/navigate/#navigate_2)(Stream, Url) | Memuat dokumen dari konten tertentu dan menggunakan baseUri untuk menyelesaikan sumber daya relatif, menggantikan konten sebelumnya. Pemuatan dokumen dimulai dari posisi saat ini di aliran. |
| [Navigate](../../aspose.svg.dom/document/navigate/#navigate_6)(string, string) | Memuat dokumen dari konten tertentu dan menggunakan baseUri untuk menyelesaikan sumber daya relatif, menggantikan konten sebelumnya. |
| [Navigate](../../aspose.svg.dom/document/navigate/#navigate_5)(string, Url) | Memuat dokumen dari konten tertentu dan menggunakan baseUri untuk menyelesaikan sumber daya relatif, menggantikan konten sebelumnya. |
...
| virtual [RenderTo](../../aspose.svg.dom/document/renderto/)(IDevice) | Metode ini digunakan untuk merender isi dokumen saat ini ke perangkat grafis tertentu. |
