...
description: Aspose.Svg.Dom.ProcessingInstruction kelas. ProcessingInstruction merepresentasikan instruksi pemrosesan yang digunakan dalam XML sebagai cara untuk menyimpan informasi khusus prosesor dalam teks dokumen.
type: docs
weight: 1170
url: /id/net/aspose.svg.dom/processinginstruction/
---
...
| override [NodeName](../../aspose.svg.dom/processinginstruction/nodename/) { get; } | Nama node ini, tergantung jenisnya. |
| override [NodeType](../../aspose.svg.dom/processinginstruction/nodetype/) { get; } | Kode yang mewakili jenis objek yang mendasarinya. |
| override [NodeValue](../../aspose.svg.dom/processinginstruction/nodevalue/) { get; set; } | Nilai simpul ini, tergantung pada jenisnya. |
...
| [Target](../../aspose.svg.dom/processinginstruction/target/) { get; } | Target instruksi pemrosesan ini. |
| override [TextContent](../../aspose.svg.dom/processinginstruction/textcontent/) { get; set; } | Atribut ini mengembalikan konten teks dari node ini dan turunannya. Ketika didefinisikan sebagai nol, pengaturan itu tidak berpengaruh. Pada pengaturan, setiap anak yang mungkin dimiliki simpul ini dihapus dan, jika string baru tidak kosong atau nol, diganti dengan simpul Teks tunggal yang berisi string yang disetel ke atribut ini. |
