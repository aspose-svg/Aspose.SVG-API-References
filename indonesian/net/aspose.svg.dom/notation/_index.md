...
description: Aspose.Svg.Dom.Notation kelas. Merupakan notasi yang dideklarasikan dalam DTD.
type: docs
weight: 1160
url: /id/net/aspose.svg.dom/notation/
---
## Notation class
...
| override [NodeName](../../aspose.svg.dom/notation/nodename/) { get; } | Nama node ini, tergantung jenisnya. |
| override [NodeType](../../aspose.svg.dom/notation/nodetype/) { get; } | Kode yang mewakili jenis objek yang mendasarinya. |
...
| [PublicId](../../aspose.svg.dom/notation/publicid/) { get; } | Pengidentifikasi publik dari notasi ini. Jika pengidentifikasi publik tidak ditentukan, ini adalah null. |
| [SystemId](../../aspose.svg.dom/notation/systemid/) { get; } | Pengidentifikasi sistem notasi ini. Jika pengidentifikasi sistem tidak ditentukan, ini adalah nol. Ini mungkin URI mutlak atau tidak. |
