...
description: "Metode SVGBuilderExtensions AddFeComposite. Menambahkan konfigurasi elemen feComposite ke builder. Elemen ini melakukan kombinasi bitwise dari dua grafik input."
type: docs
weight: 160
url: /id/net/aspose.svg.builder/svgbuilderextensions/addfecomposite/
---
## AddFeComposite<TBuilder>(*this TBuilder, Action&lt;SVGFECompositeElementBuilder&gt;*) {#addfecomposite}

Menambahkan konfigurasi elemen 'feComposite' ke builder. Elemen ini melakukan kombinasi bitwise dari dua grafik input.
...
| konfigurasi | Aksi konfigurasi untuk elemen 'feComposite'. |
...
Menambahkan elemen 'feComposite' ke pembuat SVG, menentukan operasi komposit dan berbagai properti lainnya untuk menggabungkan gambar input.
...
| builder | Instansi builder SVG yang akan ditambahkan elemen 'feComposite'. |
| compositeOperator | Operator komposit yang akan digunakan. Parameter opsional. |
| k1 | Nilai numerik pertama untuk operasi komposit. Parameter opsional. |
| k2 | Nilai numerik kedua untuk operasi komposit. Parameter opsional. |
| k3 | Nilai numerik ketiga untuk operasi komposit. Parameter opsional. |
| k4 | Nilai numerik keempat untuk operasi komposit. Parameter opsional. |
| in | Input pertama untuk efek komposit. Dapat berupa string atau FilterInput. Parameter opsional. |
| in2 | Input kedua untuk efek komposit. Dapat berupa string atau FilterInput. Parameter opsional. |
...
| extend | Aksi opsional untuk lebih lanjut mengkonfigurasi SVGFECompositeElementBuilder. |
