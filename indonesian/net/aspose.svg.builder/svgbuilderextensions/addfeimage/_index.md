...
description: "Metode SVGBuilderExtensions AddFeImage. Menambahkan konfigurasi elemen feImage ke builder. Elemen ini mengambil gambar eksternal dan menyertakannya dalam pipeline filter."
type: docs
weight: 230
url: /id/net/aspose.svg.builder/svgbuilderextensions/addfeimage/
---
## AddFeImage<TBuilder>(*this TBuilder, Action&lt;SVGFEImageElementBuilder&gt;*) {#addfeimage}

Menambahkan konfigurasi elemen 'feImage' ke pembuat. Elemen ini mengambil gambar eksternal dan memasukkannya ke dalam alur filter.
...
| konfigurasi | Aksi konfigurasi untuk elemen 'feImage'. |
...
Menambahkan elemen 'feImage' ke pembuat SVG, menggabungkan gambar eksternal ke dalam efek filter.
...
| builder | Instansi SVG builder ke mana elemen 'feImage' akan ditambahkan. |
...
| extend | Aksi opsional untuk lebih lanjut mengkonfigurasi SVGFEImageElementBuilder. |
