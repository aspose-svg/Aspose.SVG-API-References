...
description: "Metode SVGBuilderExtensions AddFeColorMatrix. Menambahkan konfigurasi elemen feColorMatrix ke builder. Elemen ini menerapkan transformasi matriks pada nilai warna dan alfa setiap piksel."
type: docs
weight: 140
url: /id/net/aspose.svg.builder/svgbuilderextensions/addfecolormatrix/
---
## AddFeColorMatrix<TBuilder>(*this TBuilder, Action&lt;SVGFEColorMatrixElementBuilder&gt;*) {#addfecolormatrix_1}

Menambahkan konfigurasi elemen 'feColorMatrix' ke builder. Elemen ini menerapkan transformasi matriks pada nilai warna dan alfa setiap piksel.
...
| konfigurasi | Aksi konfigurasi untuk elemen 'feColorMatrix'. |
...
Menambahkan elemen 'feColorMatrix' ke builder SVG, menentukan jenis operasi matriks warna dan berbagai properti lainnya untuk efek filter.
...
| builder | Instansi builder SVG yang akan ditambahkan elemen 'feColorMatrix'. |
| type | Jenis operasi matriks warna yang akan diterapkan. |
| nilai | Nilai untuk operasi matriks warna. Parameter opsional. |
| in | Input untuk efek matriks warna. Dapat berupa string atau FilterInput. Parameter opsional. |
...
| extend | Aksi opsional untuk lebih mengkonfigurasi SVGFEColorMatrixElementBuilder. |
