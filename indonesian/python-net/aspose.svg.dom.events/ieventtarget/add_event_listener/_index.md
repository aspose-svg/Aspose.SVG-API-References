...
type: docs
weight: 20
url: /id/python-net/aspose.svg.dom.events/ieventtarget/add_event_listener/
is_root: false
---
...
| listener | [`IEventListener`](/svg/python-net/aspose.svg.dom.events/ieventlistener) | Takes an interface implemented by the user which contains the methods to be called when the event occurs. |
### Remarks
...
[`IEventTarget.remove_event_listener`](/svg/python-net/aspose.svg.dom.events/ieventtarget/remove_event_listener)
method.
