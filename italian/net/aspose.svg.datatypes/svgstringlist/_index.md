...
description: Aspose.Svg.DataTypes.SVGStringList classe. SVGStringList ha gli stessi attributi e metodi delle altre interfacce SVGxxxList. Gli implementatori possono prendere in considerazione lutilizzo di una singola classe base per implementare le varie interfacce SVGxxxList.
type: docs
weight: 310
...
| Nome | Descrizione |
| --- | --- |
| [SVGStringList](svgstringlist/#constructor)() | Inizializza una nuova istanza di`SVGStringList` classe. |
| [SVGStringList](svgstringlist/#constructor_1)(IEnumerable&lt;string&gt;) | Inizializza una nuova istanza di`SVGStringList` classe. |
