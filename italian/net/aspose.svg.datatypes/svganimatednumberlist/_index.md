...
description: Usato per attributi che accettano un elenco di numeri e che possono essere animati.
type: docs
weight: 160
url: /it/net/aspose.svg.datatypes/svganimatednumberlist/
---
## SVGAnimatedNumberList class

Usato per attributi che accettano un elenco di numeri e che possono essere animati.
...
| override [ToString](../../aspose.svg.datatypes/svganimatednumberlist/tostring)() | Restituisce aString che rappresenta questa istanza. |
