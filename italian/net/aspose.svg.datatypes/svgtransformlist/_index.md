...
description: Questa interfaccia definisce un elenco di oggetti SVGTransform.
type: docs
weight: 330
url: /it/net/aspose.svg.datatypes/svgtransformlist/
---
...
| Nome | Descrizione |
| --- | --- |
| [SVGTransformList](svgtransformlist#constructor)() | Inizializza una nuova istanza di[`SVGTransformList`](../svgtransformlist) classe. |
| [SVGTransformList](svgtransformlist#constructor_1)(IEnumerable&lt;SVGTransform&gt;) | Inizializza una nuova istanza di[`SVGTransformList`](../svgtransformlist) classe. |
...
| override [ToString](../../aspose.svg.datatypes/svgtransformlist/tostring)() | Restituisce aString che rappresenta questa istanza. |
