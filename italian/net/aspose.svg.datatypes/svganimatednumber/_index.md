...
description: Utilizzato per attributi di numero di tipo base che possono essere animati.
type: docs
weight: 150
url: /it/net/aspose.svg.datatypes/svganimatednumber/
---
## SVGAnimatedNumber class

Utilizzato per attributi di numero di tipo base che possono essere animati.
...
| override [ToString](../../aspose.svg.datatypes/svganimatednumber/tostring)() | Restituisce aString che rappresenta questa istanza. |
