...
description: Aspose.Svg.Rendering.GraphicContext classe. Contiene i parametri di controllo della grafica correnti. Questi parametri definiscono la struttura globale allinterno della quale vengono eseguiti gli operatori grafici.
type: docs
weight: 2800
...
Contiene i parametri di controllo della grafica correnti. Questi parametri definiscono la struttura globale all'interno della quale vengono eseguiti gli operatori grafici.
...
| Nome | Descrizione |
| --- | --- |
| [GraphicContext](graphiccontext/)() | Inizializza una nuova istanza di`GraphicContext` classe. |
