...
description: Linterfaccia SVGPathSegLinetoRel corrisponde a un comando di dati di percorso relativo lineto l.
type: docs
weight: 2610
url: /it/net/aspose.svg.paths/svgpathseglinetorel/
---
## SVGPathSegLinetoRel class

L'interfaccia SVGPathSegLinetoRel corrisponde a un comando di dati di percorso "relativo lineto" (l).
...
| [X](../../aspose.svg.paths/svgpathseglinetorel/x) { get; set; } | La coordinata X relativa per il punto finale di questo segmento di percorso. |
| [Y](../../aspose.svg.paths/svgpathseglinetorel/y) { get; set; } | La coordinata Y relativa per il punto finale di questo segmento di percorso. |
