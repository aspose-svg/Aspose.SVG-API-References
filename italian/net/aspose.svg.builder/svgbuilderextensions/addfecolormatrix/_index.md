...
description: "Metodo SVGBuilderExtensions AddFeColorMatrix. Aggiunge una configurazione dell'elemento feColorMatrix al builder. Questo elemento applica una trasformazione matriciale ai valori di colore e alfa di ogni pixel."
type: docs
weight: 140
url: /it/net/aspose.svg.builder/svgbuilderextensions/addfecolormatrix/
---
## AddFeColorMatrix<TBuilder>(*this TBuilder, Action&lt;SVGFEColorMatrixElementBuilder&gt;*) {#addfecolormatrix_1}

Aggiunge una configurazione dell'elemento 'feColorMatrix' al costruttore. Questo elemento applica una trasformazione matriciale ai valori di colore e alfa di ogni pixel.
...
| configurare | L'azione di configurazione per l'elemento 'feColorMatrix'. |
...
Aggiunge un elemento 'feColorMatrix' al costruttore SVG, specificando il tipo di operazione della matrice di colore e varie altre proprietà per l'effetto del filtro.
...
| costruttore | L'istanza del builder SVG a cui verrà aggiunto l'elemento 'feColorMatrix'. |
| tipo | Il tipo di operazione della matrice di colore da applicare. |
| valori | I valori per l'operazione della matrice di colore. Parametro opzionale. |
| in | L'input per l'effetto della matrice di colore. Può essere una stringa o un FilterInput. Parametro opzionale. |
...
| estendi | Un'azione opzionale per configurare ulteriormente lo SVGFEColorMatrixElementBuilder. |
