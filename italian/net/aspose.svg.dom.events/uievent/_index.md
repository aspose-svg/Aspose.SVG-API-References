...
description: Linterfaccia UIEvent fornisce informazioni contestuali specifiche associate agli eventi dellinterfaccia utente.
type: docs
weight: 1000
...
| Nome | Descrizione |
| --- | --- |
| [UIEvent](uievent#constructor)(string) | Inizializza una nuova istanza di[`UIEvent`](../uievent) classe. |
| [UIEvent](uievent#constructor_1)(string, IDictionary&lt;string, object&gt;) | Inizializza una nuova istanza di[`UIEvent`](../uievent) classe. |
