...
description: Linterfaccia FocusEvent fornisce informazioni contestuali specifiche associate agli eventi Focus.
type: docs
weight: 930
url: /it/net/aspose.svg.dom.events/focusevent/
---
## FocusEvent class
...
| Nome | Descrizione |
| --- | --- |
| [FocusEvent](focusevent#constructor)(string) | Inizializza una nuova istanza di[`FocusEvent`](../focusevent) classe. |
| [FocusEvent](focusevent#constructor_1)(string, IDictionary&lt;string, object&gt;) | Inizializza una nuova istanza di[`FocusEvent`](../focusevent) classe. |
...
| [RelatedTarget](../../aspose.svg.dom.events/focusevent/relatedtarget) { get; } | Utilizzato per identificare un EventTarget secondario correlato a un evento Focus, a seconda del tipo di evento. |
