...
description: IlErrorEvent./errorevent fornisce informazioni contestuali su un errore che si è verificato durante il runtime.
type: docs
weight: 910
url: /it/net/aspose.svg.dom.events/errorevent/
---
## ErrorEvent class

Il[`ErrorEvent`](../errorevent) fornisce informazioni contestuali su un errore che si è verificato durante il runtime.
...
| Nome | Descrizione |
| --- | --- |
| [ErrorEvent](errorevent#constructor_1)(Exception) | Inizializza una nuova istanza di[`ErrorEvent`](../errorevent) classe. |
| [ErrorEvent](errorevent#constructor)(IDictionary&lt;string, object&gt;) | Inizializza una nuova istanza di[`ErrorEvent`](../errorevent) classe. |
