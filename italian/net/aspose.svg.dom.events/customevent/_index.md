...
description: Gli eventi che utilizzano linterfaccia CustomEvent possono essere utilizzati per trasportare dati personalizzati.
type: docs
weight: 880
...
| Nome | Descrizione |
| --- | --- |
| [CustomEvent](customevent#constructor)(string) | Inizializza una nuova istanza di[`CustomEvent`](../customevent) classe. |
| [CustomEvent](customevent#constructor_1)(string, IDictionary&lt;string, object&gt;) | Inizializza una nuova istanza di[`CustomEvent`](../customevent) classe. |
...
| [InitCustomEvent](../../aspose.svg.dom.events/customevent/initcustomevent)(string, bool, bool, object) | /// Il[`InitEvent`](../event/initevent) viene utilizzato per inizializzare il valore di an[`Event`](../event) creato attraverso il[`IDocumentEvent`](../idocumentevent) interfaccia. |
