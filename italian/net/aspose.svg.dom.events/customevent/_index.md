...
description: Aspose.Svg.Dom.Events.CustomEvent classe. Gli eventi che utilizzano linterfaccia CustomEvent possono essere utilizzati per trasportare dati personalizzati.
type: docs
weight: 880
url: /it/net/aspose.svg.dom.events/customevent/
---
## CustomEvent class
...
| [Detail](../../aspose.svg.dom.events/customevent/detail/) { get; } | Ottiene i dati personalizzati. |
...
| [InitCustomEvent](../../aspose.svg.dom.events/customevent/initcustomevent/)(string, bool, bool, object) | /// Il[`InitEvent`](../event/initevent/) Il metodo viene utilizzato per inizializzare il valore di an[`Event`](../event/) creato attraverso il[`IDocumentEvent`](../idocumentevent/) interfaccia. |
