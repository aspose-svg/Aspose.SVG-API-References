...
description: Aspose.Svg.Filters.SVGFEConvolveMatrixElement classe. Linterfaccia SVGFEConvolveMatrixElement corrisponde allelemento feConvolveMatrix.
type: docs
weight: 1690
...
| [Bias](../../aspose.svg.filters/svgfeconvolvematrixelement/bias/) { get; } | Corrisponde all'attributo 'bias' sull'elemento 'feConvolveMatrix' dato. |
...
| [Divisor](../../aspose.svg.filters/svgfeconvolvematrixelement/divisor/) { get; } | Corrisponde all'attributo 'divisor' sull'elemento 'feConvolveMatrix' dato. |
| [EdgeMode](../../aspose.svg.filters/svgfeconvolvematrixelement/edgemode/) { get; } | Corrisponde all'attributo 'edgeMode' sull'elemento 'feConvolveMatrix' dato. |
...
| [Height](../../aspose.svg.filters/svgfeconvolvematrixelement/height/) { get; } | Corrisponde all'attributo 'altezza' sull'elemento 'filtro' dato. |
...
| [In1](../../aspose.svg.filters/svgfeconvolvematrixelement/in1/) { get; } | Corrisponde all'attributo 'in' sull'elemento 'feConvolveMatrix' dato. |
...
| [KernelMatrix](../../aspose.svg.filters/svgfeconvolvematrixelement/kernelmatrix/) { get; } | Corrisponde all'attributo 'kernelMatrix' sull'elemento 'feConvolveMatrix' dato. |
| [KernelUnitLengthX](../../aspose.svg.filters/svgfeconvolvematrixelement/kernelunitlengthx/) { get; } | Corrisponde all'attributo 'kernelUnitLength' sull'elemento 'feConvolveMatrix' dato. |
| [KernelUnitLengthY](../../aspose.svg.filters/svgfeconvolvematrixelement/kernelunitlengthy/) { get; } | Corrisponde all'attributo 'kernelUnitLength' sull'elemento 'feConvolveMatrix' dato. |
...
| [OrderX](../../aspose.svg.filters/svgfeconvolvematrixelement/orderx/) { get; } | Corrisponde all'attributo 'ordine' sull'elemento 'feConvolveMatrix' dato. |
| [OrderY](../../aspose.svg.filters/svgfeconvolvematrixelement/ordery/) { get; } | Corrisponde all'attributo 'ordine' sull'elemento 'feConvolveMatrix' dato. |
...
| [PreserveAlpha](../../aspose.svg.filters/svgfeconvolvematrixelement/preservealpha/) { get; } | Corrisponde all'attributo 'preserveAlpha' sull'elemento 'feConvolveMatrix' dato. |
...
| [Result](../../aspose.svg.filters/svgfeconvolvematrixelement/result/) { get; } | Corrisponde all'attributo 'risultato' sull'elemento 'filtro' dato. |
...
| [TargetX](../../aspose.svg.filters/svgfeconvolvematrixelement/targetx/) { get; } | Corrisponde all'attributo 'targetX' sull'elemento 'feConvolveMatrix' dato. |
| [TargetY](../../aspose.svg.filters/svgfeconvolvematrixelement/targety/) { get; } | Corrisponde all'attributo 'targetY' sull'elemento 'feConvolveMatrix' dato. |
...
| [Width](../../aspose.svg.filters/svgfeconvolvematrixelement/width/) { get; } | Corrisponde all'attributo 'width' sull'elemento 'filter' dato. |
| [X](../../aspose.svg.filters/svgfeconvolvematrixelement/x/) { get; } | Corrisponde all'attributo 'x' sull'elemento 'filtro' dato. |
| [Y](../../aspose.svg.filters/svgfeconvolvematrixelement/y/) { get; } | Corrisponde all'attributo 'y' sull'elemento 'filtro' dato. |
...
| const [SVG_EDGEMODE_UNKNOWN](../../aspose.svg.filters/svgfeconvolvematrixelement/svg_edgemode_unknown/) | Il tipo non è uno dei tipi predefiniti. Non è valido tentare di definire un nuovo valore di questo tipo o tentare di convertire un valore esistente in questo tipo. |
