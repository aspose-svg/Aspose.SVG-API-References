...
description: Linterfaccia SVGFEConvolveMatrixElement corrisponde allelemento feConvolveMatrix.
type: docs
weight: 1690
url: /it/net/aspose.svg.filters/svgfeconvolvematrixelement/
---
...
| [Bias](../../aspose.svg.filters/svgfeconvolvematrixelement/bias) { get; } | Corrisponde all'attributo 'bias' sull'elemento 'feConvolveMatrix' specificato. |
...
| [Divisor](../../aspose.svg.filters/svgfeconvolvematrixelement/divisor) { get; } | Corrisponde all'attributo 'divisor' sull'elemento 'feConvolveMatrix' specificato. |
| [EdgeMode](../../aspose.svg.filters/svgfeconvolvematrixelement/edgemode) { get; } | Corrisponde all'attributo 'edgeMode' sull'elemento 'feConvolveMatrix' specificato. |
...
| [Height](../../aspose.svg.filters/svgfeconvolvematrixelement/height) { get; } | Corrisponde all'attributo 'height' sull'elemento 'filter' specificato. |
...
| [In1](../../aspose.svg.filters/svgfeconvolvematrixelement/in1) { get; } | Corrisponde all'attributo 'in' sull'elemento 'feConvolveMatrix' specificato. |
...
| [KernelMatrix](../../aspose.svg.filters/svgfeconvolvematrixelement/kernelmatrix) { get; } | Corrisponde all'attributo 'kernelMatrix' sull'elemento 'feConvolveMatrix' specificato. |
| [KernelUnitLengthX](../../aspose.svg.filters/svgfeconvolvematrixelement/kernelunitlengthx) { get; } | Corrisponde all'attributo 'kernelUnitLength' sull'elemento 'feConvolveMatrix' specificato. |
| [KernelUnitLengthY](../../aspose.svg.filters/svgfeconvolvematrixelement/kernelunitlengthy) { get; } | Corrisponde all'attributo 'kernelUnitLength' sull'elemento 'feConvolveMatrix' specificato. |
...
| [OrderX](../../aspose.svg.filters/svgfeconvolvematrixelement/orderx) { get; } | Corrisponde all'attributo 'order' sull'elemento 'feConvolveMatrix' specificato. |
| [OrderY](../../aspose.svg.filters/svgfeconvolvematrixelement/ordery) { get; } | Corrisponde all'attributo 'order' sull'elemento 'feConvolveMatrix' specificato. |
...
| [PreserveAlpha](../../aspose.svg.filters/svgfeconvolvematrixelement/preservealpha) { get; } | Corrisponde all'attributo 'preserveAlpha' sull'elemento 'feConvolveMatrix' specificato. |
...
| [Result](../../aspose.svg.filters/svgfeconvolvematrixelement/result) { get; } | Corrisponde all'attributo 'risultato' sull'elemento 'filtro' specificato. |
...
| [TargetX](../../aspose.svg.filters/svgfeconvolvematrixelement/targetx) { get; } | Corrisponde all'attributo 'targetX' sull'elemento 'feConvolveMatrix' specificato. |
| [TargetY](../../aspose.svg.filters/svgfeconvolvematrixelement/targety) { get; } | Corrisponde all'attributo 'targetY' sull'elemento 'feConvolveMatrix' specificato. |
...
| [Width](../../aspose.svg.filters/svgfeconvolvematrixelement/width) { get; } | Corrisponde all'attributo 'width' sull'elemento 'filter' specificato. |
| [X](../../aspose.svg.filters/svgfeconvolvematrixelement/x) { get; } | Corrisponde all'attributo 'x' sull'elemento 'filtro' specificato. |
| [Y](../../aspose.svg.filters/svgfeconvolvematrixelement/y) { get; } | Corrisponde all'attributo 'y' sull'elemento 'filtro' specificato. |
...
| Nome | Descrizione |
| --- | --- |
| const [SVG_EDGEMODE_DUPLICATE](../../aspose.svg.filters/svgfeconvolvematrixelement/svg_edgemode_duplicate) | Corrisponde al valore 'duplicato'. |
| const [SVG_EDGEMODE_NONE](../../aspose.svg.filters/svgfeconvolvematrixelement/svg_edgemode_none) | Corrisponde al valore 'none'. |
| const [SVG_EDGEMODE_UNKNOWN](../../aspose.svg.filters/svgfeconvolvematrixelement/svg_edgemode_unknown) | Il tipo non è uno dei tipi predefiniti. Non è valido tentare di definire un nuovo valore di questo tipo o tentare di cambiare un valore esistente in questo tipo. |
| const [SVG_EDGEMODE_WRAP](../../aspose.svg.filters/svgfeconvolvematrixelement/svg_edgemode_wrap) | Corrisponde al valore 'wrap'. |
