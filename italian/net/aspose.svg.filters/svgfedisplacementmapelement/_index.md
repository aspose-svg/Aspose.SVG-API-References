...
description: Aspose.Svg.Filters.SVGFEDisplacementMapElement classe. Linterfaccia SVGFEDisplacementMapElement corrisponde allelemento feDisplacementMap.
type: docs
weight: 1710
...
| [Height](../../aspose.svg.filters/svgfedisplacementmapelement/height/) { get; } | Corrisponde all'attributo 'altezza' sull'elemento 'filtro' dato. |
...
| [In1](../../aspose.svg.filters/svgfedisplacementmapelement/in1/) { get; } | Corrisponde all'attributo 'in' sull'elemento 'feDisplacementMap' dato. |
| [In2](../../aspose.svg.filters/svgfedisplacementmapelement/in2/) { get; } | Corrisponde all'attributo 'in2' sull'elemento 'feDisplacementMap' dato. |
...
| [Result](../../aspose.svg.filters/svgfedisplacementmapelement/result/) { get; } | Corrisponde all'attributo 'risultato' sull'elemento 'filtro' dato. |
| [Scale](../../aspose.svg.filters/svgfedisplacementmapelement/scale/) { get; } | Corrisponde all'attributo 'scale' sull'elemento 'feDisplacementMap' dato. |
...
| [Width](../../aspose.svg.filters/svgfedisplacementmapelement/width/) { get; } | Corrisponde all'attributo 'width' sull'elemento 'filter' dato. |
| [X](../../aspose.svg.filters/svgfedisplacementmapelement/x/) { get; } | Corrisponde all'attributo 'x' sull'elemento 'filtro' dato. |
| [XChannelSelector](../../aspose.svg.filters/svgfedisplacementmapelement/xchannelselector/) { get; } | Corrisponde all'attributo 'xChannelSelector' sull'elemento 'feDisplacementMap' dato. Accetta una delle costanti SVG_CHANNEL_* definite su questa interfaccia. |
| [Y](../../aspose.svg.filters/svgfedisplacementmapelement/y/) { get; } | Corrisponde all'attributo 'y' sull'elemento 'filtro' dato. |
| [YChannelSelector](../../aspose.svg.filters/svgfedisplacementmapelement/ychannelselector/) { get; } | Corrisponde all'attributo 'yChannelSelector' sull'elemento 'feDisplacementMap' dato. Accetta una delle costanti SVG_CHANNEL_* definite su questa interfaccia. |
...
| const [SVG_CHANNEL_UNKNOWN](../../aspose.svg.filters/svgfedisplacementmapelement/svg_channel_unknown/) | Il tipo non è uno dei tipi predefiniti. Non è valido tentare di definire un nuovo valore di questo tipo o tentare di convertire un valore esistente in questo tipo. |
