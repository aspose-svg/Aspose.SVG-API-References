...
description: Linterfaccia SVGFEDisplacementMapElement corrisponde allelemento feDisplacementMap.
type: docs
weight: 1710
url: /it/net/aspose.svg.filters/svgfedisplacementmapelement/
---
...
| [Height](../../aspose.svg.filters/svgfedisplacementmapelement/height) { get; } | Corrisponde all'attributo 'height' sull'elemento 'filter' specificato. |
...
| [In1](../../aspose.svg.filters/svgfedisplacementmapelement/in1) { get; } | Corrisponde all'attributo 'in' sull'elemento 'feDisplacementMap' specificato. |
| [In2](../../aspose.svg.filters/svgfedisplacementmapelement/in2) { get; } | Corrisponde all'attributo 'in2' sull'elemento 'feDisplacementMap' specificato. |
...
| [Result](../../aspose.svg.filters/svgfedisplacementmapelement/result) { get; } | Corrisponde all'attributo 'risultato' sull'elemento 'filtro' specificato. |
| [Scale](../../aspose.svg.filters/svgfedisplacementmapelement/scale) { get; } | Corrisponde all'attributo 'scale' sull'elemento 'feDisplacementMap' specificato. |
...
| [Width](../../aspose.svg.filters/svgfedisplacementmapelement/width) { get; } | Corrisponde all'attributo 'width' sull'elemento 'filter' specificato. |
| [X](../../aspose.svg.filters/svgfedisplacementmapelement/x) { get; } | Corrisponde all'attributo 'x' sull'elemento 'filtro' specificato. |
| [XChannelSelector](../../aspose.svg.filters/svgfedisplacementmapelement/xchannelselector) { get; } | Corrisponde all'attributo 'xChannelSelector' sull'elemento 'feDisplacementMap' specificato. Accetta una delle costanti SVG_CHANNEL_* definite su questa interfaccia. |
| [Y](../../aspose.svg.filters/svgfedisplacementmapelement/y) { get; } | Corrisponde all'attributo 'y' sull'elemento 'filtro' specificato. |
| [YChannelSelector](../../aspose.svg.filters/svgfedisplacementmapelement/ychannelselector) { get; } | Corrisponde all'attributo 'yChannelSelector' sull'elemento 'feDisplacementMap' specificato. Accetta una delle costanti SVG_CHANNEL_* definite su questa interfaccia. |
...
| Nome | Descrizione |
| --- | --- |
| const [SVG_CHANNEL_A](../../aspose.svg.filters/svgfedisplacementmapelement/svg_channel_a) | Corrisponde al valore 'A'. |
| const [SVG_CHANNEL_B](../../aspose.svg.filters/svgfedisplacementmapelement/svg_channel_b) | Corrisponde al valore 'B'. |
| const [SVG_CHANNEL_G](../../aspose.svg.filters/svgfedisplacementmapelement/svg_channel_g) | Corrisponde al valore 'G'. |
| const [SVG_CHANNEL_R](../../aspose.svg.filters/svgfedisplacementmapelement/svg_channel_r) | Corrisponde al valore 'R'. |
| const [SVG_CHANNEL_UNKNOWN](../../aspose.svg.filters/svgfedisplacementmapelement/svg_channel_unknown) | Il tipo non è uno dei tipi predefiniti. Non è valido tentare di definire un nuovo valore di questo tipo o tentare di cambiare un valore esistente in questo tipo. |
