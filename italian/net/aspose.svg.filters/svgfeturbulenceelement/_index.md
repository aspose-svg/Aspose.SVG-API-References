...
description: Linterfaccia SVGFETurbulenceElement corrisponde allelemento feTurbulence.
type: docs
weight: 1890
url: /it/net/aspose.svg.filters/svgfeturbulenceelement/
---
...
| [BaseFrequencyX](../../aspose.svg.filters/svgfeturbulenceelement/basefrequencyx) { get; } | Corrisponde all'attributo 'baseFrequency' sull'elemento 'feTurbulence' specificato. Contiene il componente X dell'attributo 'baseFrequency'. |
| [BaseFrequencyY](../../aspose.svg.filters/svgfeturbulenceelement/basefrequencyy) { get; } | Corrisponde all'attributo 'baseFrequency' sull'elemento 'feTurbulence' specificato. Contiene il componente Y dell'attributo (forse calcolato automaticamente) 'baseFrequency'. |
...
| [Height](../../aspose.svg.filters/svgfeturbulenceelement/height) { get; } | Corrisponde all'attributo 'height' sull'elemento 'filter' specificato. |
...
| [NumOctaves](../../aspose.svg.filters/svgfeturbulenceelement/numoctaves) { get; } | Corrisponde all'attributo 'numOctaves' sull'elemento 'feTurbulence' specificato. |
...
| [Result](../../aspose.svg.filters/svgfeturbulenceelement/result) { get; } | Corrisponde all'attributo 'risultato' sull'elemento 'filtro' specificato. |
| [SchemaTypeInfo](../../aspose.svg.dom/element/schematypeinfo) { get; } | Le informazioni sul tipo associate a questo elemento. |
| [Seed](../../aspose.svg.filters/svgfeturbulenceelement/seed) { get; } | Corrisponde all'attributo 'seed' sull'elemento 'feTurbulence' specificato. |
...
| [StitchTiles](../../aspose.svg.filters/svgfeturbulenceelement/stitchtiles) { get; } | Corrisponde all'attributo 'stitchTiles' sull'elemento 'feTurbulence' specificato. Accetta una delle costanti SVG_STITCHTYPE_* definite su questa interfaccia. |
...
| [Type](../../aspose.svg.filters/svgfeturbulenceelement/type) { get; } | Corrisponde all'attributo 'type' sull'elemento 'feTurbulence' specificato. Accetta una delle costanti SVG_TURBULENCE_TYPE_* definite su questa interfaccia. |
...
| [Width](../../aspose.svg.filters/svgfeturbulenceelement/width) { get; } | Corrisponde all'attributo 'width' sull'elemento 'filter' specificato. |
| [X](../../aspose.svg.filters/svgfeturbulenceelement/x) { get; } | Corrisponde all'attributo 'x' sull'elemento 'filtro' specificato. |
| [Y](../../aspose.svg.filters/svgfeturbulenceelement/y) { get; } | Corrisponde all'attributo 'y' sull'elemento 'filtro' specificato. |
...
| Nome | Descrizione |
| --- | --- |
| const [SVG_STITCHTYPE_NOSTITCH](../../aspose.svg.filters/svgfeturbulenceelement/svg_stitchtype_nostitch) | Corrisponde al valore 'noStitch'. |
| const [SVG_STITCHTYPE_STITCH](../../aspose.svg.filters/svgfeturbulenceelement/svg_stitchtype_stitch) | Corrisponde al valore 'punto'. |
| const [SVG_STITCHTYPE_UNKNOWN](../../aspose.svg.filters/svgfeturbulenceelement/svg_stitchtype_unknown) | Il tipo non è uno dei tipi predefiniti. Non è valido tentare di definire un nuovo valore di questo tipo o tentare di cambiare un valore esistente in questo tipo. |
| const [SVG_TURBULENCE_TYPE_FRACTALNOISE](../../aspose.svg.filters/svgfeturbulenceelement/svg_turbulence_type_fractalnoise) | Corrisponde al valore 'fractalNoise'. |
| const [SVG_TURBULENCE_TYPE_TURBULENCE](../../aspose.svg.filters/svgfeturbulenceelement/svg_turbulence_type_turbulence) | Corrisponde al valore 'turbolenza'. |
| const [SVG_TURBULENCE_TYPE_UNKNOWN](../../aspose.svg.filters/svgfeturbulenceelement/svg_turbulence_type_unknown) | Il tipo non è uno dei tipi predefiniti. Non è valido tentare di definire un nuovo valore di questo tipo o tentare di cambiare un valore esistente in questo tipo. |
