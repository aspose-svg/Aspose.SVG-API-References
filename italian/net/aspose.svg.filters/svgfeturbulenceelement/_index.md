...
description: Aspose.Svg.Filters.SVGFETurbulenceElement classe. Linterfaccia SVGFETurbulenceElement corrisponde allelemento feTurbulence.
type: docs
weight: 1890
...
| [BaseFrequencyX](../../aspose.svg.filters/svgfeturbulenceelement/basefrequencyx/) { get; } | Corrisponde all'attributo 'baseFrequency' sull'elemento 'feTurbulence' dato. Contiene il componente X dell'attributo 'baseFrequency'. |
| [BaseFrequencyY](../../aspose.svg.filters/svgfeturbulenceelement/basefrequencyy/) { get; } | Corrisponde all'attributo 'baseFrequency' sull'elemento 'feTurbulence' dato. Contiene il componente Y dell'attributo (possibilmente calcolato automaticamente) 'baseFrequency'. |
...
| [Height](../../aspose.svg.filters/svgfeturbulenceelement/height/) { get; } | Corrisponde all'attributo 'altezza' sull'elemento 'filtro' dato. |
...
| [NumOctaves](../../aspose.svg.filters/svgfeturbulenceelement/numoctaves/) { get; } | Corrisponde all'attributo 'numOctaves' sull'elemento 'feTurbulence' dato. |
...
| [Result](../../aspose.svg.filters/svgfeturbulenceelement/result/) { get; } | Corrisponde all'attributo 'risultato' sull'elemento 'filtro' dato. |
| [SchemaTypeInfo](../../aspose.svg.dom/element/schematypeinfo/) { get; } | Le informazioni sul tipo associate a questo elemento. |
| [Seed](../../aspose.svg.filters/svgfeturbulenceelement/seed/) { get; } | Corrisponde all'attributo 'seed' sull'elemento 'feTurbulence' dato. |
...
| [StitchTiles](../../aspose.svg.filters/svgfeturbulenceelement/stitchtiles/) { get; } | Corrisponde all'attributo 'stitchTiles' sull'elemento 'feTurbulence' dato. Accetta una delle costanti SVG_STITCHTYPE_* definite su questa interfaccia. |
...
| [Type](../../aspose.svg.filters/svgfeturbulenceelement/type/) { get; } | Corrisponde all'attributo 'tipo' sull'elemento 'feTurbulence' dato. Accetta una delle costanti SVG_TURBULENCE_TYPE_* definite su questa interfaccia. |
...
| [Width](../../aspose.svg.filters/svgfeturbulenceelement/width/) { get; } | Corrisponde all'attributo 'width' sull'elemento 'filter' dato. |
| [X](../../aspose.svg.filters/svgfeturbulenceelement/x/) { get; } | Corrisponde all'attributo 'x' sull'elemento 'filtro' dato. |
| [Y](../../aspose.svg.filters/svgfeturbulenceelement/y/) { get; } | Corrisponde all'attributo 'y' sull'elemento 'filtro' dato. |
...
| const [SVG_STITCHTYPE_UNKNOWN](../../aspose.svg.filters/svgfeturbulenceelement/svg_stitchtype_unknown/) | Il tipo non è uno dei tipi predefiniti. Non è valido tentare di definire un nuovo valore di questo tipo o tentare di convertire un valore esistente in questo tipo. |
...
| const [SVG_TURBULENCE_TYPE_TURBULENCE](../../aspose.svg.filters/svgfeturbulenceelement/svg_turbulence_type_turbulence/) | Corrisponde al valore 'turbulenza'. |
| const [SVG_TURBULENCE_TYPE_UNKNOWN](../../aspose.svg.filters/svgfeturbulenceelement/svg_turbulence_type_unknown/) | Il tipo non è uno dei tipi predefiniti. Non è valido tentare di definire un nuovo valore di questo tipo o tentare di convertire un valore esistente in questo tipo. |
