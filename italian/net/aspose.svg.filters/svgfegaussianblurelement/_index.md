...
description: Aspose.Svg.Filters.SVGFEGaussianBlurElement classe. Linterfaccia SVGFEGaussianBlurElement corrisponde allelemento feGaussianBlur.
type: docs
weight: 1790
...
| [Height](../../aspose.svg.filters/svgfegaussianblurelement/height/) { get; } | Corrisponde all'attributo "altezza" sull'elemento "filtro" dato. |
...
| [In1](../../aspose.svg.filters/svgfegaussianblurelement/in1/) { get; } | Corrisponde all'attributo �in� sull'elemento �feGaussianBlur� dato. |
...
| [Result](../../aspose.svg.filters/svgfegaussianblurelement/result/) { get; } | Corrisponde all'attributo "risultato" sull'elemento "filtro" dato. |
...
| [StdDeviationX](../../aspose.svg.filters/svgfegaussianblurelement/stddeviationx/) { get; } | Corrisponde all'attributo �stdDeviation� sull'elemento �feGaussianBlur� dato. Contiene il componente X dell'attributo �stdDeviation�. |
| [StdDeviationY](../../aspose.svg.filters/svgfegaussianblurelement/stddeviationy/) { get; } | Corrisponde all'attributo �stdDeviation� sull'elemento �feGaussianBlur� dato. Contiene la componente Y (eventualmente calcolata automaticamente) dell'attributo �stdDeviation�. |
...
| [Width](../../aspose.svg.filters/svgfegaussianblurelement/width/) { get; } | Corrisponde all'attributo "larghezza" sull'elemento "filtro" dato. |
| [X](../../aspose.svg.filters/svgfegaussianblurelement/x/) { get; } | Corrisponde all'attributo �x� sull'elemento �filtro� dato. |
| [Y](../../aspose.svg.filters/svgfegaussianblurelement/y/) { get; } | Corrisponde all'attributo �y� sull'elemento �filtro� dato. |
