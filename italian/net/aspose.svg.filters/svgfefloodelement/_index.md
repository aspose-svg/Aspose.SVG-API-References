...
description: Aspose.Svg.Filters.SVGFEFloodElement classe. Linterfaccia SVGFELoodElement corrisponde allelemento feFlood.
type: docs
weight: 1740
...
| [Height](../../aspose.svg.filters/svgfefloodelement/height/) { get; } | Corrisponde all'attributo 'altezza' sull'elemento 'filtro' dato. |
...
| [Result](../../aspose.svg.filters/svgfefloodelement/result/) { get; } | Corrisponde all'attributo 'risultato' sull'elemento 'filtro' dato. |
...
| [Width](../../aspose.svg.filters/svgfefloodelement/width/) { get; } | Corrisponde all'attributo 'width' sull'elemento 'filter' dato. |
| [X](../../aspose.svg.filters/svgfefloodelement/x/) { get; } | Corrisponde all'attributo 'x' sull'elemento 'filtro' dato. |
| [Y](../../aspose.svg.filters/svgfefloodelement/y/) { get; } | Corrisponde all'attributo 'y' sull'elemento 'filtro' dato. |
