...
description: Linterfaccia SVGFEColorMatrixElement corrisponde allelemento feColorMatrix.
type: docs
weight: 1660
url: /it/net/aspose.svg.filters/svgfecolormatrixelement/
---
...
| [Height](../../aspose.svg.filters/svgfecolormatrixelement/height) { get; } | Corrisponde all'attributo 'height' sull'elemento 'filter' specificato. |
...
| [In1](../../aspose.svg.filters/svgfecolormatrixelement/in1) { get; } | Corrisponde all'attributo 'in' sull'elemento 'feColorMatrix' specificato. |
...
| [Result](../../aspose.svg.filters/svgfecolormatrixelement/result) { get; } | Corrisponde all'attributo 'risultato' sull'elemento 'filtro' specificato. |
...
| [Type](../../aspose.svg.filters/svgfecolormatrixelement/type) { get; } | Corrisponde all'attributo 'type' sull'elemento 'feColorMatrix' specificato. Accetta una delle costanti SVG_FECOLORMATRIX_TYPE_* definite su questa interfaccia. |
| [Values](../../aspose.svg.filters/svgfecolormatrixelement/values) { get; } | Corrisponde all'attributo 'values' sull'elemento 'feColorMatrix' specificato. |
...
| [Width](../../aspose.svg.filters/svgfecolormatrixelement/width) { get; } | Corrisponde all'attributo 'width' sull'elemento 'filter' specificato. |
| [X](../../aspose.svg.filters/svgfecolormatrixelement/x) { get; } | Corrisponde all'attributo 'x' sull'elemento 'filtro' specificato. |
| [Y](../../aspose.svg.filters/svgfecolormatrixelement/y) { get; } | Corrisponde all'attributo 'y' sull'elemento 'filtro' specificato. |
...
| Nome | Descrizione |
| --- | --- |
| const [SVG_FECOLORMATRIX_TYPE_HUEROTATE](../../aspose.svg.filters/svgfecolormatrixelement/svg_fecolormatrix_type_huerotate) | Corrisponde al valore 'hueRotate'. |
| const [SVG_FECOLORMATRIX_TYPE_LUMINANCETOALPHA](../../aspose.svg.filters/svgfecolormatrixelement/svg_fecolormatrix_type_luminancetoalpha) | Corrisponde al valore 'luminanceToAlpha'. |
| const [SVG_FECOLORMATRIX_TYPE_MATRIX](../../aspose.svg.filters/svgfecolormatrixelement/svg_fecolormatrix_type_matrix) | Corrisponde al valore 'matrice'. |
| const [SVG_FECOLORMATRIX_TYPE_SATURATE](../../aspose.svg.filters/svgfecolormatrixelement/svg_fecolormatrix_type_saturate) | Corrisponde al valore 'satura'. |
| const [SVG_FECOLORMATRIX_TYPE_UNKNOWN](../../aspose.svg.filters/svgfecolormatrixelement/svg_fecolormatrix_type_unknown) | Il tipo non è uno dei tipi predefiniti. Non è valido tentare di definire un nuovo valore di questo tipo o tentare di cambiare un valore esistente in questo tipo. |
