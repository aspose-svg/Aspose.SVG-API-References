...
description: Aspose.Svg.Filters.SVGFECompositeElement classe. Linterfaccia SVGFECompositeElement corrisponde allelemento feComposite.
type: docs
weight: 1680
...
| [Height](../../aspose.svg.filters/svgfecompositeelement/height/) { get; } | Corrisponde all'attributo 'altezza' sull'elemento 'filtro' dato. |
...
| [In1](../../aspose.svg.filters/svgfecompositeelement/in1/) { get; } | Corrisponde all'attributo 'in' sull'elemento 'feComposite' dato. |
| [In2](../../aspose.svg.filters/svgfecompositeelement/in2/) { get; } | Corrisponde all'attributo 'in2' sull'elemento 'feComposite' dato. |
...
| [K1](../../aspose.svg.filters/svgfecompositeelement/k1/) { get; } | Corrisponde all'attributo 'k1' sull'elemento 'feComposite' dato. |
| [K2](../../aspose.svg.filters/svgfecompositeelement/k2/) { get; } | Corrisponde all'attributo 'k2' sull'elemento 'feComposite' dato. |
| [K3](../../aspose.svg.filters/svgfecompositeelement/k3/) { get; } | Corrisponde all'attributo 'k3' sull'elemento 'feComposite' dato. |
| [K4](../../aspose.svg.filters/svgfecompositeelement/k4/) { get; } | Corrisponde all'attributo 'k4' sull'elemento 'feComposite' dato. |
...
| [Operator](../../aspose.svg.filters/svgfecompositeelement/operator/) { get; } | Corrisponde all'attributo 'operator' sull'elemento 'feComposite' dato. Accetta una delle costanti SVG_FECOMPOSITE_OPERATOR_* definite su questa interfaccia. |
...
| [Result](../../aspose.svg.filters/svgfecompositeelement/result/) { get; } | Corrisponde all'attributo 'risultato' sull'elemento 'filtro' dato. |
...
| [Width](../../aspose.svg.filters/svgfecompositeelement/width/) { get; } | Corrisponde all'attributo 'width' sull'elemento 'filter' dato. |
| [X](../../aspose.svg.filters/svgfecompositeelement/x/) { get; } | Corrisponde all'attributo 'x' sull'elemento 'filtro' dato. |
| [Y](../../aspose.svg.filters/svgfecompositeelement/y/) { get; } | Corrisponde all'attributo 'y' sull'elemento 'filtro' dato. |
...
| const [SVG_FECOMPOSITE_OPERATOR_ATOP](../../aspose.svg.filters/svgfecompositeelement/svg_fecomposite_operator_atop/) | Corrisponde al valore 'sopra'. |
...
| const [SVG_FECOMPOSITE_OPERATOR_UNKNOWN](../../aspose.svg.filters/svgfecompositeelement/svg_fecomposite_operator_unknown/) | Il tipo non è uno dei tipi predefiniti. Non è valido tentare di definire un nuovo valore di questo tipo o tentare di convertire un valore esistente in questo tipo. |
