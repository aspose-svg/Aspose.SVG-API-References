...
description: Linterfaccia SVGFECompositeElement corrisponde allelemento feComposite.
type: docs
weight: 1680
url: /it/net/aspose.svg.filters/svgfecompositeelement/
---
...
| [Height](../../aspose.svg.filters/svgfecompositeelement/height) { get; } | Corrisponde all'attributo 'height' sull'elemento 'filter' specificato. |
...
| [In1](../../aspose.svg.filters/svgfecompositeelement/in1) { get; } | Corrisponde all'attributo 'in' sull'elemento 'feComposite' specificato. |
| [In2](../../aspose.svg.filters/svgfecompositeelement/in2) { get; } | Corrisponde all'attributo 'in2' sull'elemento 'feComposite' specificato. |
...
| [K1](../../aspose.svg.filters/svgfecompositeelement/k1) { get; } | Corrisponde all'attributo 'k1' sull'elemento 'feComposite' specificato. |
| [K2](../../aspose.svg.filters/svgfecompositeelement/k2) { get; } | Corrisponde all'attributo 'k2' sull'elemento 'feComposite' specificato. |
| [K3](../../aspose.svg.filters/svgfecompositeelement/k3) { get; } | Corrisponde all'attributo 'k3' sull'elemento 'feComposite' specificato. |
| [K4](../../aspose.svg.filters/svgfecompositeelement/k4) { get; } | Corrisponde all'attributo 'k4' sull'elemento 'feComposite' specificato. |
...
| [Operator](../../aspose.svg.filters/svgfecompositeelement/operator) { get; } | Corrisponde all'attributo 'operator' sull'elemento 'feComposite' specificato. Accetta una delle costanti SVG_FECOMPOSITE_OPERATOR_* definite su questa interfaccia. |
...
| [Result](../../aspose.svg.filters/svgfecompositeelement/result) { get; } | Corrisponde all'attributo 'risultato' sull'elemento 'filtro' specificato. |
...
| [Width](../../aspose.svg.filters/svgfecompositeelement/width) { get; } | Corrisponde all'attributo 'width' sull'elemento 'filter' specificato. |
| [X](../../aspose.svg.filters/svgfecompositeelement/x) { get; } | Corrisponde all'attributo 'x' sull'elemento 'filtro' specificato. |
| [Y](../../aspose.svg.filters/svgfecompositeelement/y) { get; } | Corrisponde all'attributo 'y' sull'elemento 'filtro' specificato. |
...
| Nome | Descrizione |
| --- | --- |
| const [SVG_FECOMPOSITE_OPERATOR_ARITHMETIC](../../aspose.svg.filters/svgfecompositeelement/svg_fecomposite_operator_arithmetic) | Corrisponde al valore 'aritmetico'. |
| const [SVG_FECOMPOSITE_OPERATOR_ATOP](../../aspose.svg.filters/svgfecompositeelement/svg_fecomposite_operator_atop) | Corrisponde al valore 'in cima'. |
| const [SVG_FECOMPOSITE_OPERATOR_IN](../../aspose.svg.filters/svgfecompositeelement/svg_fecomposite_operator_in) | Corrisponde al valore 'in'. |
| const [SVG_FECOMPOSITE_OPERATOR_OUT](../../aspose.svg.filters/svgfecompositeelement/svg_fecomposite_operator_out) | Corrisponde al valore 'out'. |
| const [SVG_FECOMPOSITE_OPERATOR_OVER](../../aspose.svg.filters/svgfecompositeelement/svg_fecomposite_operator_over) | Corrisponde al valore 'over'. |
| const [SVG_FECOMPOSITE_OPERATOR_UNKNOWN](../../aspose.svg.filters/svgfecompositeelement/svg_fecomposite_operator_unknown) | Il tipo non è uno dei tipi predefiniti. Non è valido tentare di definire un nuovo valore di questo tipo o tentare di cambiare un valore esistente in questo tipo. |
| const [SVG_FECOMPOSITE_OPERATOR_XOR](../../aspose.svg.filters/svgfecompositeelement/svg_fecomposite_operator_xor) | Corrisponde al valore 'xor'. |
