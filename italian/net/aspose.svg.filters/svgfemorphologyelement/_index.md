...
description: Aspose.Svg.Filters.SVGFEMorphologyElement classe. Linterfaccia SVGFEMorphologyElement corrisponde allelemento feMorphology.
type: docs
weight: 1830
...
| [Height](../../aspose.svg.filters/svgfemorphologyelement/height/) { get; } | Corrisponde all'attributo 'altezza' sull'elemento 'filtro' dato. |
...
| [In1](../../aspose.svg.filters/svgfemorphologyelement/in1/) { get; } | Corrisponde all'attributo 'in' sull'elemento 'feMorphology' dato. |
...
| [Operator](../../aspose.svg.filters/svgfemorphologyelement/operator/) { get; } | Corrisponde all'attributo 'operator' sull'elemento 'feMorphology' dato. Accetta una delle costanti SVG_MORPHOLOGY_OPERATOR_* definite su questa interfaccia. |
...
| [RadiusX](../../aspose.svg.filters/svgfemorphologyelement/radiusx/) { get; } | Corrisponde all'attributo 'radius' sull'elemento 'feMorphology' dato. |
| [RadiusY](../../aspose.svg.filters/svgfemorphologyelement/radiusy/) { get; } | Corrisponde all'attributo 'radius' sull'elemento 'feMorphology' dato. |
| [Result](../../aspose.svg.filters/svgfemorphologyelement/result/) { get; } | Corrisponde all'attributo 'risultato' sull'elemento 'filtro' dato. |
...
| [Width](../../aspose.svg.filters/svgfemorphologyelement/width/) { get; } | Corrisponde all'attributo 'width' sull'elemento 'filter' dato. |
| [X](../../aspose.svg.filters/svgfemorphologyelement/x/) { get; } | Corrisponde all'attributo 'x' sull'elemento 'filtro' dato. |
| [Y](../../aspose.svg.filters/svgfemorphologyelement/y/) { get; } | Corrisponde all'attributo 'y' sull'elemento 'filtro' dato. |
...
| Nome | Descrizione |
| --- | --- |
| const [SVG_MORPHOLOGY_OPERATOR_DILATE](../../aspose.svg.filters/svgfemorphologyelement/svg_morphology_operator_dilate/) | Corrisponde al valore 'dilate'. |
| const [SVG_MORPHOLOGY_OPERATOR_ERODE](../../aspose.svg.filters/svgfemorphologyelement/svg_morphology_operator_erode/) | Corrisponde al valore 'erodere'. |
| const [SVG_MORPHOLOGY_OPERATOR_UNKNOWN](../../aspose.svg.filters/svgfemorphologyelement/svg_morphology_operator_unknown/) | Il tipo non è uno dei tipi predefiniti. Non è valido tentare di definire un nuovo valore di questo tipo o tentare di convertire un valore esistente in questo tipo. |
