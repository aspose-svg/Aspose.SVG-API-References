...
description: Linterfaccia SVGFEMorfologyElement corrisponde allelemento feMorphology.
type: docs
weight: 1830
url: /it/net/aspose.svg.filters/svgfemorphologyelement/
---
## SVGFEMorphologyElement class

L'interfaccia SVGFEMorfologyElement corrisponde all'elemento 'feMorphology'.
...
| [Height](../../aspose.svg.filters/svgfemorphologyelement/height) { get; } | Corrisponde all'attributo 'height' sull'elemento 'filter' specificato. |
...
| [In1](../../aspose.svg.filters/svgfemorphologyelement/in1) { get; } | Corrisponde all'attributo 'in' sull'elemento 'feMorfology' specificato. |
...
| [Operator](../../aspose.svg.filters/svgfemorphologyelement/operator) { get; } | Corrisponde all'attributo 'operator' sull'elemento 'feMorphology' specificato. Accetta una delle costanti SVG_MORPHOLOGY_OPERATOR_* definite su questa interfaccia. |
...
| [RadiusX](../../aspose.svg.filters/svgfemorphologyelement/radiusx) { get; } | Corrisponde all'attributo 'radius' sull'elemento 'feMorphology' specificato. |
| [RadiusY](../../aspose.svg.filters/svgfemorphologyelement/radiusy) { get; } | Corrisponde all'attributo 'radius' sull'elemento 'feMorphology' specificato. |
| [Result](../../aspose.svg.filters/svgfemorphologyelement/result) { get; } | Corrisponde all'attributo 'risultato' sull'elemento 'filtro' specificato. |
...
| [Width](../../aspose.svg.filters/svgfemorphologyelement/width) { get; } | Corrisponde all'attributo 'width' sull'elemento 'filter' specificato. |
| [X](../../aspose.svg.filters/svgfemorphologyelement/x) { get; } | Corrisponde all'attributo 'x' sull'elemento 'filtro' specificato. |
| [Y](../../aspose.svg.filters/svgfemorphologyelement/y) { get; } | Corrisponde all'attributo 'y' sull'elemento 'filtro' specificato. |
...
| Nome | Descrizione |
| --- | --- |
| const [SVG_MORPHOLOGY_OPERATOR_DILATE](../../aspose.svg.filters/svgfemorphologyelement/svg_morphology_operator_dilate) | Corrisponde al valore 'dilata'. |
| const [SVG_MORPHOLOGY_OPERATOR_ERODE](../../aspose.svg.filters/svgfemorphologyelement/svg_morphology_operator_erode) | Corrisponde al valore 'erode'. |
| const [SVG_MORPHOLOGY_OPERATOR_UNKNOWN](../../aspose.svg.filters/svgfemorphologyelement/svg_morphology_operator_unknown) | Il tipo non è uno dei tipi predefiniti. Non è valido tentare di definire un nuovo valore di questo tipo o tentare di cambiare un valore esistente in questo tipo. |
