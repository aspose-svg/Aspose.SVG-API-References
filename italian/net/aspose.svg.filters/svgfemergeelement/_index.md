...
description: Aspose.Svg.Filters.SVGFEMergeElement classe. Linterfaccia SVGFEMergeElement corrisponde allelemento feMerge.
type: docs
weight: 1810
...
| [Height](../../aspose.svg.filters/svgfemergeelement/height/) { get; } | Corrisponde all'attributo 'altezza' sull'elemento 'filtro' dato. |
...
| [Result](../../aspose.svg.filters/svgfemergeelement/result/) { get; } | Corrisponde all'attributo 'risultato' sull'elemento 'filtro' dato. |
...
| [Width](../../aspose.svg.filters/svgfemergeelement/width/) { get; } | Corrisponde all'attributo 'width' sull'elemento 'filter' dato. |
| [X](../../aspose.svg.filters/svgfemergeelement/x/) { get; } | Corrisponde all'attributo 'x' sull'elemento 'filtro' dato. |
| [Y](../../aspose.svg.filters/svgfemergeelement/y/) { get; } | Corrisponde all'attributo 'y' sull'elemento 'filtro' dato. |
