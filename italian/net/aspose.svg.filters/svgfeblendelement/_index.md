...
description: Aspose.Svg.Filters.SVGFEBlendElement classe. Linterfaccia SVGFEBlendElement corrisponde allelemento feBlend.
type: docs
weight: 1650
...
| [Height](../../aspose.svg.filters/svgfeblendelement/height/) { get; } | Corrisponde all'attributo 'altezza' sull'elemento 'filtro' dato. |
...
| [In1](../../aspose.svg.filters/svgfeblendelement/in1/) { get; } | Corrisponde all'attributo 'in' sull'elemento 'feBlend' dato. |
| [In2](../../aspose.svg.filters/svgfeblendelement/in2/) { get; } | Corrisponde all'attributo 'in2' sull'elemento 'feBlend' dato. |
...
| [Mode](../../aspose.svg.filters/svgfeblendelement/mode/) { get; } | Corrisponde all'attributo 'mode' sull'elemento 'feBlend' dato. Accetta una delle costanti SVG_FEBLEND_MODE_* definite su questa interfaccia. |
...
| [Result](../../aspose.svg.filters/svgfeblendelement/result/) { get; } | Corrisponde all'attributo 'risultato' sull'elemento 'filtro' dato. |
...
| [Width](../../aspose.svg.filters/svgfeblendelement/width/) { get; } | Corrisponde all'attributo 'width' sull'elemento 'filter' dato. |
| [X](../../aspose.svg.filters/svgfeblendelement/x/) { get; } | Corrisponde all'attributo 'x' sull'elemento 'filtro' dato. |
| [Y](../../aspose.svg.filters/svgfeblendelement/y/) { get; } | Corrisponde all'attributo 'y' sull'elemento 'filtro' dato. |
...
| const [SVG_FEBLEND_MODE_DARKEN](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_darken/) | Corrisponde al valore 'scuro'. |
...
| const [SVG_FEBLEND_MODE_HUE](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_hue/) | Corrisponde al valore 'tonalità'. |
| const [SVG_FEBLEND_MODE_LIGHTEN](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_lighten/) | Corrisponde al valore 'schiarire'. |
...
| const [SVG_FEBLEND_MODE_UNKNOWN](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_unknown/) | Il tipo non è uno dei tipi predefiniti. Non è valido tentare di definire un nuovo valore di questo tipo o tentare di convertire un valore esistente in questo tipo. |
