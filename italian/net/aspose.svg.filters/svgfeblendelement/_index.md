...
description: Linterfaccia SVGFEBlendElement corrisponde allelemento feBlend.
type: docs
weight: 1650
url: /it/net/aspose.svg.filters/svgfeblendelement/
---
...
| [Height](../../aspose.svg.filters/svgfeblendelement/height) { get; } | Corrisponde all'attributo 'height' sull'elemento 'filter' specificato. |
...
| [In1](../../aspose.svg.filters/svgfeblendelement/in1) { get; } | Corrisponde all'attributo 'in' sull'elemento 'feBlend' specificato. |
| [In2](../../aspose.svg.filters/svgfeblendelement/in2) { get; } | Corrisponde all'attributo 'in2' sull'elemento 'feBlend' specificato. |
...
| [Mode](../../aspose.svg.filters/svgfeblendelement/mode) { get; } | Corrisponde all'attributo 'mode' sull'elemento 'feBlend' specificato. Accetta una delle costanti SVG_FEBLEND_MODE_* definite su questa interfaccia. |
...
| [Result](../../aspose.svg.filters/svgfeblendelement/result) { get; } | Corrisponde all'attributo 'risultato' sull'elemento 'filtro' specificato. |
...
| [Width](../../aspose.svg.filters/svgfeblendelement/width) { get; } | Corrisponde all'attributo 'width' sull'elemento 'filter' specificato. |
| [X](../../aspose.svg.filters/svgfeblendelement/x) { get; } | Corrisponde all'attributo 'x' sull'elemento 'filtro' specificato. |
| [Y](../../aspose.svg.filters/svgfeblendelement/y) { get; } | Corrisponde all'attributo 'y' sull'elemento 'filtro' specificato. |
...
| Nome | Descrizione |
| --- | --- |
| const [SVG_FEBLEND_MODE_COLOR](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_color) | Corrisponde al valore 'colore'. |
| const [SVG_FEBLEND_MODE_COLOR_BURN](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_color_burn) | Corrisponde al valore 'color_burn'. |
| const [SVG_FEBLEND_MODE_COLOR_DODGE](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_color_dodge) | Corrisponde al valore 'color_dodge'. |
| const [SVG_FEBLEND_MODE_DARKEN](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_darken) | Corrisponde al valore 'darken'. |
| const [SVG_FEBLEND_MODE_DIFFERENCE](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_difference) | Corrisponde al valore 'differenza'. |
| const [SVG_FEBLEND_MODE_EXCLUSION](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_exclusion) | Corrisponde al valore 'esclusione'. |
| const [SVG_FEBLEND_MODE_HARD_LIGHT](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_hard_light) | Corrisponde al valore 'hard_light'. |
| const [SVG_FEBLEND_MODE_HUE](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_hue) | Corrisponde al valore 'hue'. |
| const [SVG_FEBLEND_MODE_LIGHTEN](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_lighten) | Corrisponde al valore 'schiarisci'. |
| const [SVG_FEBLEND_MODE_LUMINOSITY](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_luminosity) | Corrisponde al valore 'luminosità'. |
| const [SVG_FEBLEND_MODE_MULTIPLY](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_multiply) | Corrisponde al valore 'moltiplica'. |
| const [SVG_FEBLEND_MODE_NORMAL](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_normal) | Corrisponde al valore 'normale'. |
| const [SVG_FEBLEND_MODE_OVERLAY](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_overlay) | Corrisponde al valore 'overlay'. |
| const [SVG_FEBLEND_MODE_SATURATION](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_saturation) | Corrisponde al valore 'saturazione'. |
| const [SVG_FEBLEND_MODE_SCREEN](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_screen) | Corrisponde al valore 'schermo'. |
| const [SVG_FEBLEND_MODE_SOFT_LIGHT](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_soft_light) | Corrisponde al valore 'soft_light'. |
| const [SVG_FEBLEND_MODE_UNKNOWN](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_unknown) | Il tipo non è uno dei tipi predefiniti. Non è valido tentare di definire un nuovo valore di questo tipo o tentare di cambiare un valore esistente in questo tipo. |
