...
| useCapture | Boolean | Se true, useCapture indica che l'utente desidera avviare l'acquisizione. Dopo l'avvio dell'acquisizione, tutti gli eventi del tipo specificato verranno inviati all'oggetto Registered [`IEventListener`](../../../aspose.svg.dom.events/ieventlistener/) prima di essere inviato a qualsiasi Event Target sotto di loro nell'albero. Gli eventi che stanno ribollendo verso l'alto attraverso l'albero non attiveranno un[`IEventListener`](../../../aspose.svg.dom.events/ieventlistener/) designato per utilizzare la cattura. |

### Osservazioni

Se an[`IEventListener`](../../../aspose.svg.dom.events/ieventlistener/) viene aggiunto ad un[`EventTarget`](../) mentre sta elaborando un evento, non verrà attivato dalle azioni correnti ma potrebbe essere attivato durante una fase successiva del flusso di eventi, come la fase di bubbling.

Se sullo stesso sono registrati più Event Listener identici[`EventTarget`](../)con gli stessi parametri le istanze duplicate vengono scartate. Non provocano il[`IEventListener`](../../../aspose.svg.dom.events/ieventlistener/) essere chiamati due volte e poiché vengono scartati non è necessario rimuoverli con the [`RemoveEventListener`](../removeeventlistener/) metodo.
