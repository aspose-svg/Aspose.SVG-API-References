...
description: Aspose.Svg.Dom.Node classe. Linterfaccia Node è il tipo di dati primario per lintero Document object Model. Rappresenta un singolo nodo nellalbero del documento.
type: docs
weight: 1150
...
| abstract [NodeName](../../aspose.svg.dom/node/nodename/) { get; } | Il nome di questo nodo, a seconda del suo tipo. |
...
| [CloneNode](../../aspose.svg.dom/node/clonenode/#clonenode)() | Restituisce un duplicato di questo nodo, ovvero funge da costruttore di copie generico per i nodi. Il nodo duplicato non ha un genitore (parentNode è nullo) e nessun dato utente. |
| [CloneNode](../../aspose.svg.dom/node/clonenode/#clonenode_1)(bool) | Restituisce un duplicato di questo nodo, ovvero funge da costruttore di copie generico per i nodi. Il nodo duplicato non ha un genitore (parentNode è nullo) e nessun dato utente. |
...
| const [CDATA_SECTION_NODE](../../aspose.svg.dom/node/cdata_section_node/) | Una sezione cdata node |
| const [COMMENT_NODE](../../aspose.svg.dom/node/comment_node/) | Un nodo di commento |
| const [DOCUMENT_FRAGMENT_NODE](../../aspose.svg.dom/node/document_fragment_node/) | Un frammento di documento node |
...
| const [ENTITY_REFERENCE_NODE](../../aspose.svg.dom/node/entity_reference_node/) | Un nodo di riferimento entità |
| const [NOTATION_NODE](../../aspose.svg.dom/node/notation_node/) | Una notazione node |
