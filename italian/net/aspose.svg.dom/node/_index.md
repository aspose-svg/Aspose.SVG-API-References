...
description: Linterfaccia Node è il tipo di dati principale per lintero modello a oggetti del documento. Rappresenta un singolo nodo nellalbero dei documenti.
type: docs
weight: 1150
url: /it/net/aspose.svg.dom/node/
---
## Node class

L'interfaccia Node è il tipo di dati principale per l'intero modello a oggetti del documento. Rappresenta un singolo nodo nell'albero dei documenti.
...
| [CloneNode](../../aspose.svg.dom/node/clonenode#clonenode)() | Restituisce un duplicato di questo nodo, cioè funge da costruttore di copia generico per i nodi. Il nodo duplicato non ha padre (parentNode è null) e nessun dato utente. |
| [CloneNode](../../aspose.svg.dom/node/clonenode#clonenode_1)(bool) | Restituisce un duplicato di questo nodo, cioè funge da costruttore di copia generico per i nodi. Il nodo duplicato non ha padre (parentNode è null) e nessun dato utente. |
...
| Nome | Descrizione |
| --- | --- |
| const [ATTRIBUTE_NODE](../../aspose.svg.dom/node/attribute_node) | Un attributo node |
| const [CDATA_SECTION_NODE](../../aspose.svg.dom/node/cdata_section_node) | Un nodo di sezione cdata |
| const [COMMENT_NODE](../../aspose.svg.dom/node/comment_node) | Un nodo di commento |
| const [DOCUMENT_FRAGMENT_NODE](../../aspose.svg.dom/node/document_fragment_node) | Un nodo frammento di documento |
| const [DOCUMENT_NODE](../../aspose.svg.dom/node/document_node) | Un nodo documento |
| const [DOCUMENT_TYPE_NODE](../../aspose.svg.dom/node/document_type_node) | Un tipo di documento node |
| const [ELEMENT_NODE](../../aspose.svg.dom/node/element_node) | Un nodo elemento |
| const [ENTITY_NODE](../../aspose.svg.dom/node/entity_node) | Un nodo entità |
| const [ENTITY_REFERENCE_NODE](../../aspose.svg.dom/node/entity_reference_node) | Un nodo di riferimento di entità |
| const [NOTATION_NODE](../../aspose.svg.dom/node/notation_node) | Un nodo di notazione |
| const [PROCESSING_INSTRUCTION_NODE](../../aspose.svg.dom/node/processing_instruction_node) | Un'istruzione di elaborazione node |
| const [TEXT_NODE](../../aspose.svg.dom/node/text_node) | Un nodo di testo |
