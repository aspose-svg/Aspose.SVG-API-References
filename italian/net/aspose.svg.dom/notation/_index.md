...
description: Aspose.Svg.Dom.Notation classe. Rappresenta una notazione dichiarata nel DTD.
type: docs
weight: 1160
url: /it/net/aspose.svg.dom/notation/
---
## Notation class
...
| override [NodeName](../../aspose.svg.dom/notation/nodename/) { get; } | Il nome di questo nodo, a seconda del suo tipo. |
| override [NodeType](../../aspose.svg.dom/notation/nodetype/) { get; } | Un codice che rappresenta il tipo dell'oggetto sottostante. |
...
| [PublicId](../../aspose.svg.dom/notation/publicid/) { get; } | L'identificatore pubblico di questa notazione. Se l'identificatore pubblico non è stato specificato, questo è null. |
| [SystemId](../../aspose.svg.dom/notation/systemid/) { get; } | L'identificatore di sistema di questa notazione. Se l'identificatore di sistema non è stato specificato, questo è nullo. Questo può essere un URI assoluto o meno. |
