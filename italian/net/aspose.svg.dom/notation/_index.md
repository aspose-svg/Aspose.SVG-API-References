...
description: Rappresenta una notazione dichiarata nel DTD.
type: docs
weight: 1160
...
| override [NodeName](../../aspose.svg.dom/notation/nodename) { get; } | Il nome di questo nodo, a seconda del tipo. |
...
| [PublicId](../../aspose.svg.dom/notation/publicid) { get; } | L'identificatore pubblico di questa notazione. Se l'identificatore pubblico non è stato specificato, è null. |
| [SystemId](../../aspose.svg.dom/notation/systemid) { get; } | L'identificatore di sistema di questa notazione. Se l'identificatore di sistema non è stato specificato, questo è null. Questo può essere un URI assoluto o meno. |
