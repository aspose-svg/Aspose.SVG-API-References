...
description: Aspose.Svg.Dom.DocumentType classe. DocumentType fornisce uninterfaccia allelenco di entità definite per il documento
type: docs
weight: 830
...
| [InternalSubset](../../aspose.svg.dom/documenttype/internalsubset/) { get; } | Il sottoinsieme interno come stringa o null se non ce n'è nessuno. |
...
| [Name](../../aspose.svg.dom/documenttype/name/) { get; } | Il nome del DTD; cioè, il nome che segue immediatamente la parola chiave DOCTYPE. |
...
| override [NodeName](../../aspose.svg.dom/documenttype/nodename/) { get; } | Il nome di questo nodo, a seconda del suo tipo. |
