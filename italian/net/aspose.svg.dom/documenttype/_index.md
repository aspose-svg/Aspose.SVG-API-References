...
description: Il DocumentType fornisce uninterfaccia allelenco di entità definite per il documento
type: docs
weight: 830
url: /it/net/aspose.svg.dom/documenttype/
---
## DocumentType class

Il DocumentType fornisce un'interfaccia all'elenco di entità definite per il documento
...
| Nome | Descrizione |
| --- | --- |
| [DocumentType](documenttype)(string, string, string, string, Document) | Inizializza una nuova istanza di[`DocumentType`](../documenttype) classe. |
...
| [InternalSubset](../../aspose.svg.dom/documenttype/internalsubset) { get; } | Il sottoinsieme interno come stringa o null se non ce n'è. |
...
| [Name](../../aspose.svg.dom/documenttype/name) { get; } | Il nome di DTD; cioè il nome immediatamente successivo alla parola chiave DOCTYPE. |
...
| override [NodeName](../../aspose.svg.dom/documenttype/nodename) { get; } | Il nome di questo nodo, a seconda del tipo. |
| override [NodeType](../../aspose.svg.dom/documenttype/nodetype) { get; } | Un codice che rappresenta il tipo dell'oggetto sottostante. |
...
| [PublicId](../../aspose.svg.dom/documenttype/publicid) { get; } | L'identificatore pubblico del sottoinsieme esterno. |
| [SystemId](../../aspose.svg.dom/documenttype/systemid) { get; } | L'identificatore di sistema del sottoinsieme esterno. Questo può essere un URI assoluto o meno. |
...
| override [ToString](../../aspose.svg.dom/documenttype/tostring)() | Restituisce aString che rappresenta questa istanza. |
