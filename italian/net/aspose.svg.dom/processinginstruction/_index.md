...
description: ProcessingInstruction rappresenta una istruzione di elaborazione utilizzata in XML come un modo per mantenere le informazioni specifiche del processore nel testo del documento.
type: docs
weight: 1170
...
| override [NodeName](../../aspose.svg.dom/processinginstruction/nodename) { get; } | Il nome di questo nodo, a seconda del tipo. |
...
| override [NodeValue](../../aspose.svg.dom/processinginstruction/nodevalue) { get; set; } | Il valore di questo nodo, a seconda del tipo. |
...
| override [TextContent](../../aspose.svg.dom/processinginstruction/textcontent) { get; set; } | Questo attributo restituisce il contenuto di testo di questo nodo e dei suoi discendenti. Quando è definito null, l'impostazione non ha alcun effetto. Al momento dell'impostazione, tutti i possibili figli di questo nodo vengono rimossi e, se la nuova stringa non è vuota o nulla, viene sostituita da un singolo nodo di testo contenente la stringa su cui è impostato questo attributo. |
