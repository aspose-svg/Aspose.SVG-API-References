...
description: Aspose.Svg.Dom.ProcessingInstruction classe. ProcessingInstruction rappresenta una istruzione di elaborazione utilizzata in XML come un modo per mantenere le informazioni specifiche del processore nel testo del documento.
type: docs
weight: 1170
url: /it/net/aspose.svg.dom/processinginstruction/
---
...
| override [NodeName](../../aspose.svg.dom/processinginstruction/nodename/) { get; } | Il nome di questo nodo, a seconda del suo tipo. |
| override [NodeType](../../aspose.svg.dom/processinginstruction/nodetype/) { get; } | Un codice che rappresenta il tipo dell'oggetto sottostante. |
| override [NodeValue](../../aspose.svg.dom/processinginstruction/nodevalue/) { get; set; } | Il valore di questo nodo, a seconda del suo tipo. |
...
| [Target](../../aspose.svg.dom/processinginstruction/target/) { get; } | La destinazione di questa istruzione di elaborazione. |
| override [TextContent](../../aspose.svg.dom/processinginstruction/textcontent/) { get; set; } | Questo attributo restituisce il contenuto testuale di questo nodo e dei suoi discendenti. Quando è definito nullo, impostarlo non ha alcun effetto. Al momento dell'impostazione, tutti i possibili figli che questo nodo può avere vengono rimossi e, se la nuova stringa non è vuota o nulla, sostituita da un singolo nodo di testo contenente la stringa su cui è impostato questo attributo. |
