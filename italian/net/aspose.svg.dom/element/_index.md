...
description: Linterfaccia Element rappresenta un elemento in un documento HTML o XML.
type: docs
weight: 840
url: /it/net/aspose.svg.dom/element/
---
## Element class
...
| Nome | Descrizione |
| --- | --- |
| [Element](element)(IElementInit) | Inizializza una nuova istanza di[`Element`](../element)classe. Non chiamare direttamente questo costruttore, usa[`CreateElement`](../document/createelement) o[`CreateElementNS`](../document/createelementns) . |
...
| [Id](../../aspose.svg.dom/element/id) { get; set; } | Identificatore dell'elemento. Vedere la definizione dell'attributo id in HTML 4.01. |
