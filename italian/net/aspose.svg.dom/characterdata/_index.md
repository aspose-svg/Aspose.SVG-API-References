...
description: Aspose.Svg.Dom.CharacterData classe. CharacterData estende Node con un set di attributi e metodi per accedere ai dati dei personaggi nel DOM.
type: docs
weight: 450
