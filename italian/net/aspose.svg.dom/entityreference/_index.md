...
description: I nodi EntityReference possono essere utilizzati per rappresentare un riferimento a unentità nellalbero.
type: docs
weight: 860
...
| override [NodeName](../../aspose.svg.dom/entityreference/nodename) { get; } | Il nome di questo nodo, a seconda del tipo. |
