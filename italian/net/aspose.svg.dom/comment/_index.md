...
description: Aspose.Svg.Dom.Comment classe. Eredita da CharacterData e rappresenta il contenuto di un commento ovvero tutti i caratteri compresi tra liniziale  .
type: docs
weight: 460
...
| override [NodeName](../../aspose.svg.dom/comment/nodename/) { get; } | Il nome di questo nodo, a seconda del suo tipo. |
| override [NodeType](../../aspose.svg.dom/comment/nodetype/) { get; } | Un codice che rappresenta il tipo dell'oggetto sottostante. |
| override [NodeValue](../../aspose.svg.dom/comment/nodevalue/) { get; set; } | Il valore di questo nodo, a seconda del suo tipo. |
...
| override [TextContent](../../aspose.svg.dom/comment/textcontent/) { get; set; } | Questo attributo restituisce il contenuto testuale di questo nodo e dei suoi discendenti. Quando è definito nullo, impostarlo non ha alcun effetto. Al momento dell'impostazione, tutti i possibili figli che questo nodo può avere vengono rimossi e, se la nuova stringa non è vuota o nulla, sostituita da un singolo nodo di testo contenente la stringa su cui è impostato questo attributo. |
