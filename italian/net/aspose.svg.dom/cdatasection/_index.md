...
description: Le sezioni CDATA vengono utilizzate per sfuggire a blocchi di testo contenenti caratteri che altrimenti verrebbero considerati markup.
type: docs
weight: 440
...
Le sezioni CDATA vengono utilizzate per sfuggire a blocchi di testo contenenti caratteri che altrimenti verrebbero considerati markup.
...
| [IsElementContentWhitespace](../../aspose.svg.dom/text/iselementcontentwhitespace) { get; } | Restituisce se questo nodo di testo contiene spazi bianchi del contenuto dell'elemento, spesso chiamati abusivamente "spazi bianchi ignorabili". |
...
| override [NodeName](../../aspose.svg.dom/cdatasection/nodename) { get; } | Il nome di questo nodo, a seconda del tipo. |
| override [NodeType](../../aspose.svg.dom/cdatasection/nodetype) { get; } | Un codice che rappresenta il tipo dell'oggetto sottostante. |
| override [NodeValue](../../aspose.svg.dom/text/nodevalue) { get; set; } | Il valore di questo nodo, a seconda del tipo. |
...
| override [TextContent](../../aspose.svg.dom/text/textcontent) { get; set; } | Questo attributo restituisce il contenuto di testo di questo nodo e dei suoi discendenti. Quando è definito null, l'impostazione non ha alcun effetto. Al momento dell'impostazione, tutti i possibili figli di questo nodo vengono rimossi e, se la nuova stringa non è vuota o nulla, viene sostituita da un singolo nodo di testo contenente la stringa su cui è impostato questo attributo. |
| [WholeText](../../aspose.svg.dom/text/wholetext) { get; } | Restituisce tutto il testo dei nodi di testo nodi di testo logicamente adiacenti a questo nodo, concatenati nell'ordine del documento. |
