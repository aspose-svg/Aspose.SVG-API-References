...
description: Linterfaccia Text eredita da CharacterData e rappresenta il contenuto testuale denominato dati carattere in XML di un Elemento o Attr.
type: docs
weight: 1200
url: /it/net/aspose.svg.dom/text/
---
## Text class
...
| override [NodeName](../../aspose.svg.dom/text/nodename) { get; } | Il nome di questo nodo, a seconda del tipo. |
| override [NodeType](../../aspose.svg.dom/text/nodetype) { get; } | Un codice che rappresenta il tipo dell'oggetto sottostante. |
