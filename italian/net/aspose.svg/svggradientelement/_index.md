...
description: Aspose.Svg.SVGGradientElement classe. Linterfaccia SVGGradientElement è uninterfaccia di base utilizzata da SVGLinearGradientElement e SVGRadialGradientElement.
type: docs
weight: 3280
...
| const [SVG_SPREADMETHOD_REFLECT](../../aspose.svg/svggradientelement/svg_spreadmethod_reflect/) | Corrisponde al valore 'reflect'. |
| const [SVG_SPREADMETHOD_REPEAT](../../aspose.svg/svggradientelement/svg_spreadmethod_repeat/) | Corrisponde al valore 'ripeti'. |
| const [SVG_SPREADMETHOD_UNKNOWN](../../aspose.svg/svggradientelement/svg_spreadmethod_unknown/) | Il tipo non è uno dei tipi predefiniti. Non è valido tentare di definire un nuovo valore di questo tipo o tentare di convertire un valore esistente in questo tipo. |
