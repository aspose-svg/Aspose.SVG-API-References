...
description: Linterfaccia SVGGradientElement è uninterfaccia di base utilizzata da SVGLinearGradientElement e SVGRadialGradientElement.
type: docs
weight: 3230
url: /it/net/aspose.svg/svggradientelement/
---
...
| Nome | Descrizione |
| --- | --- |
| const [SVG_SPREADMETHOD_PAD](../../aspose.svg/svggradientelement/svg_spreadmethod_pad) | Corrisponde al valore 'pad'. |
| const [SVG_SPREADMETHOD_REFLECT](../../aspose.svg/svggradientelement/svg_spreadmethod_reflect) | Corrisponde al valore 'riflettere'. |
| const [SVG_SPREADMETHOD_REPEAT](../../aspose.svg/svggradientelement/svg_spreadmethod_repeat) | Corrisponde al valore 'repeat'. |
| const [SVG_SPREADMETHOD_UNKNOWN](../../aspose.svg/svggradientelement/svg_spreadmethod_unknown) | Il tipo non è uno dei tipi predefiniti. Non è valido tentare di definire un nuovo valore di questo tipo o tentare di cambiare un valore esistente in questo tipo. |
