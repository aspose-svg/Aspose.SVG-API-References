...
description: Linterfaccia SVGAnimateTransformElement corrisponde allelemento animateTransform. Laccesso orientato agli oggetti agli attributi dellelemento animateTransform tramite il DOM SVG non è disponibile.
type: docs
weight: 3060
url: /it/net/aspose.svg/svganimatetransformelement/
---
## SVGAnimateTransformElement class

L'interfaccia SVGAnimateTransformElement corrisponde all'elemento 'animateTransform'. L'accesso orientato agli oggetti agli attributi dell'elemento 'animateTransform' tramite il DOM SVG non è disponibile.
...
| [RequiredExtensions](../../aspose.svg/svganimationelement/requiredextensions) { get; } | Corrisponde all'attributo 'requiredExtensions' sull'elemento specificato. |
| [RequiredFeatures](../../aspose.svg/svganimationelement/requiredfeatures) { get; } | Corrisponde all'attributo 'requiredFeatures' sull'elemento specificato. |
...
| [SystemLanguage](../../aspose.svg/svganimationelement/systemlanguage) { get; } | Corrisponde all'attributo 'systemLanguage' sull'elemento specificato. |
| [TagName](../../aspose.svg.dom/element/tagname) { get; } | Il nome dell'elemento. |
| [TargetElement](../../aspose.svg/svganimationelement/targetelement) { get; } | L'elemento che viene animato. |
