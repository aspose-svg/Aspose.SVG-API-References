...
description: Aspose.Svg.SVGPatternElement classe. Linterfaccia SVGPatternElement corrisponde allelemento pattern.
type: docs
weight: 3380
...
| [Height](../../aspose.svg/svgpatternelement/height/) { get; } | Corrisponde all'attributo 'height' sull'elemento 'pattern' dato. |
| [Href](../../aspose.svg/svgpatternelement/href/) { get; } | Corrisponde all'attributo 'xlink:href' sull'elemento dato. |
...
| [PatternContentUnits](../../aspose.svg/svgpatternelement/patterncontentunits/) { get; } | Corrisponde all'attributo 'patternContentUnits' sull'elemento 'pattern' dato. Accetta una delle costanti definite in SVGUnitTypes. |
| [PatternTransform](../../aspose.svg/svgpatternelement/patterntransform/) { get; } | Corrisponde all'attributo 'patternTransform' sull'elemento 'pattern' dato. |
| [PatternUnits](../../aspose.svg/svgpatternelement/patternunits/) { get; } | Corrisponde all'attributo 'patternUnits' sull'elemento 'pattern' dato. Accetta una delle costanti definite in SVGUnitTypes. |
...
| [PreserveAspectRatio](../../aspose.svg/svgpatternelement/preserveaspectratio/) { get; } | Corrisponde all'attributo 'preserveAspectRatio' sull'elemento dato. |
...
| [RequiredExtensions](../../aspose.svg/svgpatternelement/requiredextensions/) { get; } | Corrisponde all'attributo 'requiredExtensions' sull'elemento dato. |
| [RequiredFeatures](../../aspose.svg/svgpatternelement/requiredfeatures/) { get; } | Corrisponde all'attributo 'requiredFeatures' sull'elemento dato. |
...
| [SystemLanguage](../../aspose.svg/svgpatternelement/systemlanguage/) { get; } | Corrisponde all'attributo 'systemLanguage' sull'elemento dato. |
...
| [ViewBox](../../aspose.svg/svgpatternelement/viewbox/) { get; } | Corrisponde all'attributo 'viewBox' sull'elemento dato. |
...
| [Width](../../aspose.svg/svgpatternelement/width/) { get; } | Corrisponde all'attributo 'width' sull'elemento 'pattern' dato. |
| [X](../../aspose.svg/svgpatternelement/x/) { get; } | Corrisponde all'attributo 'x' sull'elemento 'pattern' dato. |
| [Y](../../aspose.svg/svgpatternelement/y/) { get; } | Corrisponde all'attributo 'y' sull'elemento 'pattern' dato. |
