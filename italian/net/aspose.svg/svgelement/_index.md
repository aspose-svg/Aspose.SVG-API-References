...
description: Tutte le interfacce DOM SVG che corrispondono direttamente agli elementi nel linguaggio SVG come linterfaccia SVGPathElement per lelemento percorso derivano dallinterfaccia SVGElement.
type: docs
weight: 3150
url: /it/net/aspose.svg/svgelement/
---
## SVGElement class

Tutte le interfacce DOM SVG che corrispondono direttamente agli elementi nel linguaggio SVG (come l'interfaccia SVGPathElement per l'elemento 'percorso') derivano dall'interfaccia SVGElement.
