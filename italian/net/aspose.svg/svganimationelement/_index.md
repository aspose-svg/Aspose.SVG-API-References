...
description: Aspose.Svg.SVGAnimationElement classe. Linterfaccia SVGAnimationElement è linterfaccia di base per tutte le interfacce degli elementi di animazione SVGAnimateElement SVGSetElement SVGAnimateColorElement SVGAnimateMotionElement e SVGAnimateTransformElement.
type: docs
weight: 3120
...
| [RequiredExtensions](../../aspose.svg/svganimationelement/requiredextensions/) { get; } | Corrisponde all'attributo 'requiredExtensions' sull'elemento dato. |
| [RequiredFeatures](../../aspose.svg/svganimationelement/requiredfeatures/) { get; } | Corrisponde all'attributo 'requiredFeatures' sull'elemento dato. |
...
| [SystemLanguage](../../aspose.svg/svganimationelement/systemlanguage/) { get; } | Corrisponde all'attributo 'systemLanguage' sull'elemento dato. |
