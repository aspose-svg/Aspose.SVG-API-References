...
description: Aspose.Svg.SVGPathElement classe. Linterfaccia SVGPathElement corrisponde allelemento path.
type: docs
weight: 3370
...
| [PathLength](../../aspose.svg/svggeometryelement/pathlength/) { get; } | Corrisponde all'attributo pathLength sull'elemento dato. |
| [PathSegList](../../aspose.svg/svgpathelement/pathseglist/) { get; set; } | Fornisce l'accesso ai contenuti di base (cioè statici) dell'attributo 'd' in una forma che corrisponde uno a uno con la sintassi di SVG. Pertanto, se l'attributo 'd' ha un comando "absolute moveto (M)" e un comando "absolute arcto (A)", pathSegList avrà due voci: un SVG_PATHSEG_MOVETO_ABS e un SVG_PATHSEG_ARC_ABS. |
...
| [CreateSVGPathSegArcAbs](../../aspose.svg/svgpathelement/createsvgpathsegarcabs/)(float, float, float, float, float, bool, bool) | Restituisce un oggetto SVGPathSegArcAbs autonomo e parentless. |
| [CreateSVGPathSegArcRel](../../aspose.svg/svgpathelement/createsvgpathsegarcrel/)(float, float, float, float, float, bool, bool) | Restituisce un oggetto SVGPathSegArcRel autonomo e parentless. |
| [CreateSVGPathSegClosePath](../../aspose.svg/svgpathelement/createsvgpathsegclosepath/)() | Restituisce un oggetto SVGPathSegClosePath autonomo e parentless. |
| [CreateSVGPathSegCurvetoCubicAbs](../../aspose.svg/svgpathelement/createsvgpathsegcurvetocubicabs/)(float, float, float, float, float, float) | Restituisce un oggetto SVGPathSegCurvetoCubicAbs autonomo e parentless. |
| [CreateSVGPathSegCurvetoCubicRel](../../aspose.svg/svgpathelement/createsvgpathsegcurvetocubicrel/)(float, float, float, float, float, float) | Restituisce un oggetto SVGPathSegCurvetoCubicRel autonomo e parentless. |
| [CreateSVGPathSegCurvetoCubicSmoothAbs](../../aspose.svg/svgpathelement/createsvgpathsegcurvetocubicsmoothabs/)(float, float, float, float) | Restituisce un oggetto SVGPathSegCurvetoCubicSmoothAbs autonomo e parentless. |
| [CreateSVGPathSegCurvetoCubicSmoothRel](../../aspose.svg/svgpathelement/createsvgpathsegcurvetocubicsmoothrel/)(float, float, float, float) | Restituisce un oggetto SVGPathSegCurvetoCubicSmoothRel autonomo e parentless. |
| [CreateSVGPathSegCurvetoQuadraticAbs](../../aspose.svg/svgpathelement/createsvgpathsegcurvetoquadraticabs/)(float, float, float, float) | Restituisce un oggetto SVGPathSegCurvetoQuadraticAbs autonomo e parentless. |
| [CreateSVGPathSegCurvetoQuadraticRel](../../aspose.svg/svgpathelement/createsvgpathsegcurvetoquadraticrel/)(float, float, float, float) | Restituisce un oggetto SVGPathSegCurvetoQuadraticRel autonomo e parentless. |
| [CreateSVGPathSegCurvetoQuadraticSmoothAbs](../../aspose.svg/svgpathelement/createsvgpathsegcurvetoquadraticsmoothabs/)(float, float) | Restituisce un oggetto SVGPathSegCurvetoQuadraticSmoothAbs autonomo e parentless. |
| [CreateSVGPathSegCurvetoQuadraticSmoothRel](../../aspose.svg/svgpathelement/createsvgpathsegcurvetoquadraticsmoothrel/)(float, float) | Restituisce un oggetto SVGPathSegCurvetoQuadraticSmoothRel autonomo e parentless. |
| [CreateSVGPathSegLinetoAbs](../../aspose.svg/svgpathelement/createsvgpathseglinetoabs/)(float, float) | Restituisce un oggetto SVGPathSegLinetoAbs autonomo e parentless. |
| [CreateSVGPathSegLinetoHorizontalAbs](../../aspose.svg/svgpathelement/createsvgpathseglinetohorizontalabs/)(float) | Restituisce un oggetto SVGPathSegLinetoHorizontalAbs autonomo e parentless. |
| [CreateSVGPathSegLinetoHorizontalRel](../../aspose.svg/svgpathelement/createsvgpathseglinetohorizontalrel/)(float) | Restituisce un oggetto SVGPathSegLinetoHorizontalRel autonomo e parentless. |
| [CreateSVGPathSegLinetoRel](../../aspose.svg/svgpathelement/createsvgpathseglinetorel/)(float, float) | Restituisce un oggetto SVGPathSegLinetoRel autonomo e parentless. |
| [CreateSVGPathSegLinetoVerticalAbs](../../aspose.svg/svgpathelement/createsvgpathseglinetoverticalabs/)(float) | Restituisce un oggetto SVGPathSegLinetoVerticalAbs autonomo e parentless. |
| [CreateSVGPathSegLinetoVerticalRel](../../aspose.svg/svgpathelement/createsvgpathseglinetoverticalrel/)(float) | Restituisce un oggetto SVGPathSegLinetoVerticalRel autonomo e parentless. |
| [CreateSVGPathSegMovetoAbs](../../aspose.svg/svgpathelement/createsvgpathsegmovetoabs/)(float, float) | Restituisce un oggetto SVGPathSegMovetoAbs autonomo e parentless. |
| [CreateSVGPathSegMovetoRel](../../aspose.svg/svgpathelement/createsvgpathsegmovetorel/)(float, float) | Restituisce un oggetto SVGPathSegMovetoRel autonomo e parentless. |
...
| [GetEquivalentPath](../../aspose.svg/svggeometryelement/getequivalentpath/)() | Restituisce una nuova istanza di[`SVGPathSegList`](../../aspose.svg.paths/svgpathseglist/) che rappresenta[`SVGGeometryElement`](../svggeometryelement/) come segmenti di percorso. |
...
| [GetPointAtLength](../../aspose.svg/svggeometryelement/getpointatlength/)(float) | Restituisce la coordinata (x,y) nello spazio utente che è unità di distanza lungo il percorso, utilizzando l'algoritmo di distanza lungo un percorso dell'agente utente. |
...
| [GetTotalLength](../../aspose.svg/svggeometryelement/gettotallength/)() | Restituisce il valore calcolato dall'agente utente per la lunghezza totale del percorso utilizzando l'algoritmo distance-along-a-path dell'agente utente, come distanza nel sistema di coordinate dell'utente corrente. |
