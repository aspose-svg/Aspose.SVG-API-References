...
description: Aspose.Svg.SVGComponentTransferFunctionElement classe. Questa interfaccia definisce uninterfaccia di base utilizzata dalle interfacce della funzione di trasferimento dei componenti.
type: docs
weight: 3150
...
| [Exponent](../../aspose.svg/svgcomponenttransferfunctionelement/exponent/) { get; } | Corrisponde all'attributo 'esponente' sull'elemento dato. |
...
| [Intercept](../../aspose.svg/svgcomponenttransferfunctionelement/intercept/) { get; } | Corrisponde all'attributo 'intercept' sull'elemento dato. |
...
| [Offset](../../aspose.svg/svgcomponenttransferfunctionelement/offset/) { get; } | Corrisponde all'attributo 'offset' sull'elemento dato. |
...
| [Slope](../../aspose.svg/svgcomponenttransferfunctionelement/slope/) { get; } | Corrisponde all'attributo 'pendenza' sull'elemento dato. |
...
| [TableValues](../../aspose.svg/svgcomponenttransferfunctionelement/tablevalues/) { get; } | Corrisponde all'attributo 'tableValues' sull'elemento dato. |
...
| [Type](../../aspose.svg/svgcomponenttransferfunctionelement/type/) { get; } | Corrisponde all'attributo 'tipo' sull'elemento dato. Accetta una delle costanti SVG_FECOMPONENTTRANSFER_TYPE_* definite su questa interfaccia. |
...
| const [SVG_FECOMPONENTTRANSFER_TYPE_IDENTITY](../../aspose.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_identity/) | Corrisponde al valore 'identità'. |
...
| const [SVG_FECOMPONENTTRANSFER_TYPE_UNKNOWN](../../aspose.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_unknown/) | Il tipo non è uno dei tipi predefiniti. Non è valido tentare di definire un nuovo valore di questo tipo o tentare di convertire un valore esistente in questo tipo. |
