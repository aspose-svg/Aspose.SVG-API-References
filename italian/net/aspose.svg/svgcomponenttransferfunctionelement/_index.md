...
description: Questa interfaccia definisce uninterfaccia di base utilizzata dalle interfacce della funzione di trasferimento dei componenti.
type: docs
weight: 3100
url: /it/net/aspose.svg/svgcomponenttransferfunctionelement/
---
...
| Nome | Descrizione |
| --- | --- |
| [Amplitude](../../aspose.svg/svgcomponenttransferfunctionelement/amplitude) { get; } | Corrisponde all'attributo 'ampiezza' sull'elemento dato. |
...
| [Exponent](../../aspose.svg/svgcomponenttransferfunctionelement/exponent) { get; } | Corrisponde all'attributo 'esponente' sull'elemento specificato. |
...
| [Intercept](../../aspose.svg/svgcomponenttransferfunctionelement/intercept) { get; } | Corrisponde all'attributo 'intercetta' sull'elemento dato. |
...
| [Offset](../../aspose.svg/svgcomponenttransferfunctionelement/offset) { get; } | Corrisponde all'attributo 'offset' sull'elemento specificato. |
...
| [Slope](../../aspose.svg/svgcomponenttransferfunctionelement/slope) { get; } | Corrisponde all'attributo 'slope' sull'elemento specificato. |
...
| [TableValues](../../aspose.svg/svgcomponenttransferfunctionelement/tablevalues) { get; } | Corrisponde all'attributo 'tableValues' sull'elemento specificato. |
...
| [Type](../../aspose.svg/svgcomponenttransferfunctionelement/type) { get; } | Corrisponde all'attributo 'type' sull'elemento dato. Accetta una delle costanti SVG_FECOMPONENTTRANSFER_TYPE_* definite su questa interfaccia. |
...
| Nome | Descrizione |
| --- | --- |
| const [SVG_FECOMPONENTTRANSFER_TYPE_DISCRETE](../../aspose.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_discrete) | Corrisponde al valore 'discreto'. |
| const [SVG_FECOMPONENTTRANSFER_TYPE_GAMMA](../../aspose.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_gamma) | Corrisponde al valore 'gamma'. |
| const [SVG_FECOMPONENTTRANSFER_TYPE_IDENTITY](../../aspose.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_identity) | Corrisponde al valore 'identity'. |
| const [SVG_FECOMPONENTTRANSFER_TYPE_LINEAR](../../aspose.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_linear) | Corrisponde al valore 'lineare'. |
| const [SVG_FECOMPONENTTRANSFER_TYPE_TABLE](../../aspose.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_table) | Corrisponde al valore 'tabella'. |
| const [SVG_FECOMPONENTTRANSFER_TYPE_UNKNOWN](../../aspose.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_unknown) | Il tipo non è uno dei tipi predefiniti. Non è valido tentare di definire un nuovo valore di questo tipo o tentare di cambiare un valore esistente in questo tipo. |
