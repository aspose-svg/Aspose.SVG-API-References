...
description: Aspose.Svg.SVGStyleElement classe. Linterfaccia SVGStyleElement corrisponde allelemento style.
type: docs
weight: 3480
...
| [Media](../../aspose.svg/svgstyleelement/media/) { get; set; } | Corrisponde all'attributo 'media' sull'elemento dato. |
...
| [Title](../../aspose.svg/svgstyleelement/title/) { get; set; } | Corrisponde all'attributo 'titolo' sull'elemento dato. |
| [Type](../../aspose.svg/svgstyleelement/type/) { get; set; } | Corrisponde all'attributo 'tipo' sull'elemento dato. |
