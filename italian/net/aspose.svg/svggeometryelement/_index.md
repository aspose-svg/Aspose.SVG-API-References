...
description: Aspose.Svg.SVGGeometryElement classe. Interfaccia SVGGeometryElement rappresenta gli elementi SVG il cui rendering è definito dalla geometria con un percorso equivalente e che possono essere riempiti e tracciati. Ciò include i percorsi e le forme di base.
type: docs
weight: 3270
...
| [GetEquivalentPath](../../aspose.svg/svggeometryelement/getequivalentpath/)() | Restituisce una nuova istanza di[`SVGPathSegList`](../../aspose.svg.paths/svgpathseglist/) che rappresenta`SVGGeometryElement` come segmenti di percorso. |
