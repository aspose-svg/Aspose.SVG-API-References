...
| --- | --- | --- |
| licenseName | String | Può essere un nome di file completo o breve o il nome di una risorsa incorporata. Utilizzare una stringa vuota per passare alla modalità di valutazione. |
