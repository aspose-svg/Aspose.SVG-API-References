...
description: Aspose.Svg.SVGTextPathElement classe. Linterfaccia SVGTextPathElement corrisponde allelemento textPath.
type: docs
weight: 3540
...
| [Href](../../aspose.svg/svgtextpathelement/href/) { get; } | Corrisponde all'attributo 'xlink:href' sull'elemento dato. |
...
| [LengthAdjust](../../aspose.svg/svgtextcontentelement/lengthadjust/) { get; } | Corrisponde all'attributo 'lengthAdjust' sull'elemento dato. Il valore deve essere una delle costanti di regolazione della lunghezza definite su questa interfaccia. |
...
| [Method](../../aspose.svg/svgtextpathelement/method/) { get; } | Corrisponde all'attributo 'metodo' sull'elemento 'textPath' dato. |
...
| [Spacing](../../aspose.svg/svgtextpathelement/spacing/) { get; } | Corrisponde all'attributo 'spaziatura' sull'elemento 'textPath' dato. |
| [StartOffset](../../aspose.svg/svgtextpathelement/startoffset/) { get; } | Corrisponde all'attributo 'startOffset' sull'elemento 'textPath' dato. |
...
| [TextLength](../../aspose.svg/svgtextcontentelement/textlength/) { get; } | Corrisponde all'attributo 'textLength' sull'elemento dato. |
...
| [GetNumberOfChars](../../aspose.svg/svgtextcontentelement/getnumberofchars/)() | Restituisce il numero totale di caratteri disponibili per il rendering all'interno dell'elemento corrente, che include i caratteri referenziati dal riferimento 'tref', indipendentemente dal fatto che verranno visualizzati. In effetti, questo è equivalente alla lunghezza dell'attributo Node::textContent dal DOM Level 3 Core ([DOM3], sezione 1.4), se tale attributo ha anche espanso gli elementi 'tref'. |
...
| const [TEXTPATH_METHODTYPE_UNKNOWN](../../aspose.svg/svgtextpathelement/textpath_methodtype_unknown/) | L'enumerazione è stata impostata su un valore che non è uno dei tipi predefiniti. Non è valido tentare di definire un nuovo valore di questo tipo o tentare di convertire un valore esistente in questo tipo. |
...
| const [TEXTPATH_SPACINGTYPE_UNKNOWN](../../aspose.svg/svgtextpathelement/textpath_spacingtype_unknown/) | L'enumerazione è stata impostata su un valore che non è uno dei tipi predefiniti. Non è valido tentare di definire un nuovo valore di questo tipo o tentare di convertire un valore esistente in questo tipo. |
