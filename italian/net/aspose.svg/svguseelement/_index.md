...
description: Aspose.Svg.SVGUseElement classe. Linterfaccia SVGUseElement corrisponde allelemento use.
type: docs
weight: 3580
...
| [Href](../../aspose.svg/svguseelement/href/) { get; } | Corrisponde all'attributo 'xlink:href' sull'elemento dato. |
...
| [X](../../aspose.svg/svguseelement/x/) { get; } | Corrisponde all'attributo 'x' sull'elemento 'use' dato. |
| [Y](../../aspose.svg/svguseelement/y/) { get; } | Corrisponde all'attributo 'y' sull'elemento 'use' dato. |
