...
description: Aspose.Svg.SVGMaskElement classe. Linterfaccia SVGMaskElement corrisponde allelemento maschera.
type: docs
weight: 3350
...
| [Height](../../aspose.svg/svgmaskelement/height/) { get; } | Corrisponde all'attributo 'altezza' sull'elemento 'maschera' dato. Accetta una delle costanti definite in SVGUnitTypes. |
...
| [MaskUnits](../../aspose.svg/svgmaskelement/maskunits/) { get; } | Corrisponde all'attributo 'maskUnits' sull'elemento 'mask' dato. Accetta una delle costanti definite in SVGUnitTypes. |
...
| [RequiredExtensions](../../aspose.svg/svgmaskelement/requiredextensions/) { get; } | Corrisponde all'attributo 'requiredExtensions' sull'elemento dato. |
| [RequiredFeatures](../../aspose.svg/svgmaskelement/requiredfeatures/) { get; } | Corrisponde all'attributo 'requiredFeatures' sull'elemento dato. |
...
| [SystemLanguage](../../aspose.svg/svgmaskelement/systemlanguage/) { get; } | Corrisponde all'attributo 'systemLanguage' sull'elemento dato. |
...
| [Width](../../aspose.svg/svgmaskelement/width/) { get; } | Corrisponde all'attributo 'width' sull'elemento 'mask' dato. Accetta una delle costanti definite in SVGUnitTypes. |
| [X](../../aspose.svg/svgmaskelement/x/) { get; } | Corrisponde all'attributo 'x' sull'elemento 'mask' dato. Accetta una delle costanti definite in SVGUnitTypes. |
| [Y](../../aspose.svg/svgmaskelement/y/) { get; } | Corrisponde all'attributo 'y' sull'elemento 'mask' dato. Accetta una delle costanti definite in SVGUnitTypes. |
