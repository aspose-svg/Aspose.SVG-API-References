...
description: Aspose.Svg.SVGRadialGradientElement classe. Linterfaccia SVGRadialGradientElement corrisponde allelemento radialGradient.
type: docs
weight: 3410
...
| [Cx](../../aspose.svg/svgradialgradientelement/cx/) { get; } | Corrisponde all'attributo 'cx' sull'elemento 'radialGradient' dato. |
| [Cy](../../aspose.svg/svgradialgradientelement/cy/) { get; } | Corrisponde all'attributo 'cy' sull'elemento 'radialGradient' dato. |
...
| [Fr](../../aspose.svg/svgradialgradientelement/fr/) { get; } | Corrisponde all'attributo 'fr' sull'elemento 'radialGradient' dato. |
| [Fx](../../aspose.svg/svgradialgradientelement/fx/) { get; } | Corrisponde all'attributo 'fx' sull'elemento 'radialGradient' dato. |
| [Fy](../../aspose.svg/svgradialgradientelement/fy/) { get; } | Corrisponde all'attributo 'fy' sull'elemento 'radialGradient' dato. |
| [GradientTransform](../../aspose.svg/svggradientelement/gradienttransform/) { get; } | Corrisponde all'attributo 'gradientTransform' sull'elemento dato. |
| [GradientUnits](../../aspose.svg/svggradientelement/gradientunits/) { get; } | Corrisponde all'attributo 'gradientUnits' sull'elemento dato. Accetta una delle costanti definite in SVGUnitTypes. |
| [Href](../../aspose.svg/svggradientelement/href/) { get; } | Corrisponde all'attributo 'xlink:href' sull'elemento dato. |
...
| [R](../../aspose.svg/svgradialgradientelement/r/) { get; } | Corrisponde all'attributo 'r' sull'elemento 'radialGradient' dato. |
...
| [SpreadMethod](../../aspose.svg/svggradientelement/spreadmethod/) { get; } | Corrisponde all'attributo 'spreadMethod' sull'elemento dato. Uno dei tipi di metodo di diffusione definiti su questa interfaccia. |
