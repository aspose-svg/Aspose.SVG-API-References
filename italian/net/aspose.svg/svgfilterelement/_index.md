...
description: Aspose.Svg.SVGFilterElement classe. Linterfaccia SVGFilterElement corrisponde allelemento filtro.
type: docs
weight: 3240
...
| [FilterUnits](../../aspose.svg/svgfilterelement/filterunits/) { get; } | Corrisponde all'attributo 'filterUnits' sull'elemento 'filter' dato. Accetta una delle costanti definite in SVGUnitTypes. |
...
| [Height](../../aspose.svg/svgfilterelement/height/) { get; } | Corrisponde all'attributo 'altezza' sull'elemento 'filtro' dato. |
| [Href](../../aspose.svg/svgfilterelement/href/) { get; } | Corrisponde all'attributo 'xlink:href' sull'elemento dato. |
...
| [PrimitiveUnits](../../aspose.svg/svgfilterelement/primitiveunits/) { get; } | Corrisponde all'attributo 'primitiveUnits' sull'elemento 'filter' dato. Accetta una delle costanti definite in SVGUnitTypes. |
...
| [Width](../../aspose.svg/svgfilterelement/width/) { get; } | Corrisponde all'attributo 'width' sull'elemento 'filter' dato. |
| [X](../../aspose.svg/svgfilterelement/x/) { get; } | Corrisponde all'attributo 'x' sull'elemento 'filtro' dato. |
| [Y](../../aspose.svg/svgfilterelement/y/) { get; } | Corrisponde all'attributo 'y' sull'elemento 'filtro' dato. |
