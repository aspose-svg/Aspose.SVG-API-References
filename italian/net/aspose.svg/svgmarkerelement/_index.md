...
description: Aspose.Svg.SVGMarkerElement classe. Linterfaccia SVGMarkerElement corrisponde allelemento marker.
type: docs
weight: 3340
...
| [MarkerHeight](../../aspose.svg/svgmarkerelement/markerheight/) { get; } | Corrisponde all'attributo 'markerHeight' sull'elemento 'marker' dato. |
| [MarkerUnits](../../aspose.svg/svgmarkerelement/markerunits/) { get; } | Corrisponde all'attributo 'markerUnits' sull'elemento 'marker' dato. Uno dei tipi di unità di marcatura definiti su questa interfaccia. |
| [MarkerWidth](../../aspose.svg/svgmarkerelement/markerwidth/) { get; } | Corrisponde all'attributo 'markerWidth' sull'elemento 'marker' dato. |
...
| [OrientType](../../aspose.svg/svgmarkerelement/orienttype/) { get; } | Corrisponde all'attributo 'orient' sull'elemento 'marker' dato. Uno dei tipi di orientamento del marker definiti su questa interfaccia. |
...
| [PreserveAspectRatio](../../aspose.svg/svgmarkerelement/preserveaspectratio/) { get; } | Corrisponde all'attributo 'preserveAspectRatio' sull'elemento dato. |
...
| [RefX](../../aspose.svg/svgmarkerelement/refx/) { get; } | Corrisponde all'attributo 'refX' sull'elemento 'marker' dato. |
| [RefY](../../aspose.svg/svgmarkerelement/refy/) { get; } | Corrisponde all'attributo 'refY' sull'elemento 'marker' dato. |
...
| [ViewBox](../../aspose.svg/svgmarkerelement/viewbox/) { get; } | Corrisponde all'attributo 'viewBox' sull'elemento dato. |
...
| const [SVG_MARKERUNITS_UNKNOWN](../../aspose.svg/svgmarkerelement/svg_markerunits_unknown/) | Il tipo di unità marcatore non è uno dei tipi predefiniti. Non è valido tentare di definire un nuovo valore di questo tipo o tentare di convertire un valore esistente in questo tipo. |
...
| const [SVG_MARKER_ORIENT_ANGLE](../../aspose.svg/svgmarkerelement/svg_marker_orient_angle/) | L'attributo 'orient' ha un valore angolare. |
| const [SVG_MARKER_ORIENT_AUTO](../../aspose.svg/svgmarkerelement/svg_marker_orient_auto/) | L'attributo 'orient' ha valore 'auto'. |
| const [SVG_MARKER_ORIENT_UNKNOWN](../../aspose.svg/svgmarkerelement/svg_marker_orient_unknown/) | L'orientamento del marker non è uno dei tipi predefiniti. Non è valido tentare di definire un nuovo valore di questo tipo o tentare di convertire un valore esistente in questo tipo. |
