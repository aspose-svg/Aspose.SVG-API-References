...
description: Linterfaccia SVGMarkerElement corrisponde allelemento marker.
type: docs
weight: 3290
url: /it/net/aspose.svg/svgmarkerelement/
---
...
| [MarkerHeight](../../aspose.svg/svgmarkerelement/markerheight) { get; } | Corrisponde all'attributo 'markerHeight' sull'elemento 'marker' specificato. |
| [MarkerUnits](../../aspose.svg/svgmarkerelement/markerunits) { get; } | Corrisponde all'attributo 'markerUnits' sull'elemento 'marker' specificato. Uno dei tipi di unità marker definiti su questa interfaccia. |
| [MarkerWidth](../../aspose.svg/svgmarkerelement/markerwidth) { get; } | Corrisponde all'attributo 'markerWidth' sull'elemento 'marker' specificato. |
...
| [OrientAngle](../../aspose.svg/svgmarkerelement/orientangle) { get; } | Corrisponde all'attributo 'orient' sull'elemento 'marker' dato. Se markerUnits è SVG_MARKER_ORIENT_ANGLE, il valore dell'angolo per l'attributo 'orient'; in caso contrario, verrà impostato su zero. |
| [OrientType](../../aspose.svg/svgmarkerelement/orienttype) { get; } | Corrisponde all'attributo 'orient' sull'elemento 'marker' dato. Uno dei tipi di orientamento dei marker definiti su questa interfaccia. |
...
| [PreserveAspectRatio](../../aspose.svg/svgmarkerelement/preserveaspectratio) { get; } | Corrisponde all'attributo 'preserveAspectRatio' sull'elemento specificato. |
...
| [RefX](../../aspose.svg/svgmarkerelement/refx) { get; } | Corrisponde all'attributo 'refX' sull'elemento 'marker' specificato. |
| [RefY](../../aspose.svg/svgmarkerelement/refy) { get; } | Corrisponde all'attributo 'refY' sull'elemento 'marker' specificato. |
...
| [ViewBox](../../aspose.svg/svgmarkerelement/viewbox) { get; } | Corrisponde all'attributo 'viewBox' sull'elemento specificato. |
...
| [SetOrientToAngle](../../aspose.svg/svgmarkerelement/setorienttoangle)(SVGAngle) | Imposta il valore dell'attributo 'orient' sull'angolo dato. |
| [SetOrientToAuto](../../aspose.svg/svgmarkerelement/setorienttoauto)() | Imposta il valore dell'attributo 'orient' su 'auto'. |
...
| Nome | Descrizione |
| --- | --- |
| const [SVG_MARKERUNITS_STROKEWIDTH](../../aspose.svg/svgmarkerelement/svg_markerunits_strokewidth) | Il valore dell'attributo 'markerUnits' è 'strokeWidth'. |
| const [SVG_MARKERUNITS_UNKNOWN](../../aspose.svg/svgmarkerelement/svg_markerunits_unknown) | Il tipo di unità indicatore non è uno dei tipi predefiniti. Non è valido tentare di definire un nuovo valore di questo tipo o tentare di cambiare un valore esistente in questo tipo. |
| const [SVG_MARKERUNITS_USERSPACEONUSE](../../aspose.svg/svgmarkerelement/svg_markerunits_userspaceonuse) | Il valore dell'attributo 'markerUnits' è 'userSpaceOnUse'. |
| const [SVG_MARKER_ORIENT_ANGLE](../../aspose.svg/svgmarkerelement/svg_marker_orient_angle) | L'attributo 'orient' ha un valore di angolo. |
| const [SVG_MARKER_ORIENT_AUTO](../../aspose.svg/svgmarkerelement/svg_marker_orient_auto) | L'attributo 'orient' ha valore 'auto'. |
| const [SVG_MARKER_ORIENT_UNKNOWN](../../aspose.svg/svgmarkerelement/svg_marker_orient_unknown) | L'orientamento del marker non è di tipo predefinito. Non è valido tentare di definire un nuovo valore di questo tipo o tentare di cambiare un valore esistente in questo tipo. |
