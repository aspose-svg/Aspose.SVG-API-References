...
description: Linterfaccia SVGViewElement corrisponde allelemento view.
type: docs
weight: 3540
url: /it/net/aspose.svg/svgviewelement/
---
...
| [PreserveAspectRatio](../../aspose.svg/svgviewelement/preserveaspectratio) { get; } | Corrisponde all'attributo 'preserveAspectRatio' sull'elemento specificato. |
...
| [ViewBox](../../aspose.svg/svgviewelement/viewbox) { get; } | Corrisponde all'attributo 'viewBox' sull'elemento specificato. |
...
| [ViewTarget](../../aspose.svg/svgviewelement/viewtarget) { get; } | Corrisponde all'attributo 'viewTarget' sull'elemento 'view' specificato. Un elenco di valori DOMString che contengono i nomi elencati nell'attributo 'viewTarget'. Ciascuno dei valori DOMString può essere associato all'elemento corrispondente utilizzando la chiamata al metodo getElementById(). |
| [ZoomAndPan](../../aspose.svg/svgviewelement/zoomandpan) { get; set; } | Corrisponde all'attributo 'zoomAndPan' sull'elemento dato. Il valore deve essere una delle costanti SVG_ZOOMANDDPAN_* definite su questa interfaccia. |
