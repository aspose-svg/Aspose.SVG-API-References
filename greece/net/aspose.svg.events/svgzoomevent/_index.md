...
description: Aspose.Svg.Events.SVGZoomEvent τάξη. Το συμβάν ζουμ συμβαίνει όταν ο χρήστης εκκινεί μια ενέργεια που προκαλεί την αλλαγή κλίμακας της τρέχουσας προβολής του τμήματος εγγράφου SVG. Οι χειριστές συμβάντων αναγνωρίζονται μόνο σε στοιχεία svg.
type: docs
weight: 1620
...
| [NewTranslate](../../aspose.svg.events/svgzoomevent/newtranslate/) { get; } | Οι τιμές μετάφρασης που θα υπάρχουν μετά την επεξεργασία της λειτουργίας ζουμ. Το αντικείμενο SVGPoint είναι μόνο για ανάγνωση. |
| [PreviousScale](../../aspose.svg.events/svgzoomevent/previousscale/) { get; } | Ο συντελεστής κλίμακας από προηγούμενες λειτουργίες μεγέθυνσης που υπήρχε πριν από τη λειτουργία ζουμ. |
| [PreviousTranslate](../../aspose.svg.events/svgzoomevent/previoustranslate/) { get; } | Οι τιμές μετάφρασης από προηγούμενες λειτουργίες ζουμ που υπήρχαν πριν από τη λειτουργία ζουμ. Το αντικείμενο SVGPoint είναι μόνο για ανάγνωση. |
