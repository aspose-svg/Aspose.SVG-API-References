...
description: Aspose.Svg.Filters.SVGFEGaussianBlurElement τάξη. Η διεπαφή SVGFEGaussianBlurElement αντιστοιχεί στο στοιχείο feGaussianBlur.
type: docs
weight: 1790
...
| [Height](../../aspose.svg.filters/svgfegaussianblurelement/height/) { get; } | Αντιστοιχεί στο χαρακτηριστικό �height� στο δεδομένο στοιχείο �φίλτρου». |
...
| [In1](../../aspose.svg.filters/svgfegaussianblurelement/in1/) { get; } | Αντιστοιχεί στο χαρακτηριστικό �in� στο δεδομένο στοιχείο �feGaussianBlur�. |
...
| [Result](../../aspose.svg.filters/svgfegaussianblurelement/result/) { get; } | Αντιστοιχεί στο χαρακτηριστικό �result� στο δεδομένο στοιχείο �φίλτρου». |
...
| [StdDeviationX](../../aspose.svg.filters/svgfegaussianblurelement/stddeviationx/) { get; } | Αντιστοιχεί στο χαρακτηριστικό �stdDeviation� στο δεδομένο στοιχείο �feGaussianBlur�. Περιέχει το στοιχείο X του χαρακτηριστικού �stdDeviation�. |
| [StdDeviationY](../../aspose.svg.filters/svgfegaussianblurelement/stddeviationy/) { get; } | Αντιστοιχεί στο χαρακτηριστικό �stdDeviation� στο δεδομένο στοιχείο �feGaussianBlur�. Περιέχει το στοιχείο Y (ενδεχομένως να υπολογίζεται αυτόματα) του χαρακτηριστικού �stdDeviation�. |
...
| [Width](../../aspose.svg.filters/svgfegaussianblurelement/width/) { get; } | Αντιστοιχεί στο χαρακτηριστικό �width� στο δεδομένο στοιχείο �φίλτρου». |
| [X](../../aspose.svg.filters/svgfegaussianblurelement/x/) { get; } | Αντιστοιχεί στο χαρακτηριστικό �x� στο δεδομένο στοιχείο �φίλτρου». |
| [Y](../../aspose.svg.filters/svgfegaussianblurelement/y/) { get; } | Αντιστοιχεί στο χαρακτηριστικό �y� στο δεδομένο στοιχείο �φίλτρο». |
