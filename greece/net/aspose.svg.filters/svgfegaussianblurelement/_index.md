...
description: "Aspose.Svg.Filters.SVGFEGaussianBlurElement κλάση. Η SVGFEGaussianBlurElement διεπαφή αντιστοιχεί στο στοιχείο feGaussianBlur."
type: docs
weight: 3880
url: /el/net/aspose.svg.filters/svgfegaussianblurelement/
---
## SVGFEGaussianBlurElement class

Το interface SVGFEGaussianBlurElement αντιστοιχεί στο στοιχείο �feGaussianBlur�.
...
| [Height](../../aspose.svg.filters/svgfegaussianblurelement/height/) { get; } | Αντιστοιχεί στο χαρακτηριστικό �height� του δεδομένου στοιχείου �filter�. |
...
| [In1](../../aspose.svg.filters/svgfegaussianblurelement/in1/) { get; } | Αντιστοιχεί στο χαρακτηριστικό �in� του δεδομένου στοιχείου �feGaussianBlur�. |
...
| [Result](../../aspose.svg.filters/svgfegaussianblurelement/result/) { get; } | Αντιστοιχεί στο χαρακτηριστικό �result� του δεδομένου στοιχείου �filter�. |
...
| [StdDeviationX](../../aspose.svg.filters/svgfegaussianblurelement/stddeviationx/) { get; } | Αντιστοιχεί στο χαρακτηριστικό �stdDeviation� του δεδομένου στοιχείου �feGaussianBlur�. Περιέχει το X συστατικό του χαρακτηριστικού �stdDeviation�. |
| [StdDeviationY](../../aspose.svg.filters/svgfegaussianblurelement/stddeviationy/) { get; } | Αντιστοιχεί στο χαρακτηριστικό �stdDeviation� του δεδομένου στοιχείου �feGaussianBlur�. Περιέχει το Y συστατικό (πιθανώς υπολογιζόμενο αυτόματα) του χαρακτηριστικού �stdDeviation�. |
...
| [Width](../../aspose.svg.filters/svgfegaussianblurelement/width/) { get; } | Αντιστοιχεί στο χαρακτηριστικό �width� του δεδομένου στοιχείου �filter�. |
| [X](../../aspose.svg.filters/svgfegaussianblurelement/x/) { get; } | Αντιστοιχεί στο χαρακτηριστικό �x� του δεδομένου στοιχείου �filter�. |
| [Y](../../aspose.svg.filters/svgfegaussianblurelement/y/) { get; } | Αντιστοιχεί στο χαρακτηριστικό �y� στο δεδομένο στοιχείο �filter�. |
...
| [SetStdDeviation](../../aspose.svg.filters/svgfegaussianblurelement/setstddeviation/)(*float, float*) | Ορίζει τις τιμές για το χαρακτηριστικό �stdDeviation�. |
