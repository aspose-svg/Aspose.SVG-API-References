...
description: Aspose.Svg.Filters.SVGFEImageElement τάξη. Η διεπαφή SVGFEImageElement αντιστοιχεί στο στοιχείο feImage.
type: docs
weight: 1800
...
| [Height](../../aspose.svg.filters/svgfeimageelement/height/) { get; } | Αντιστοιχεί στο χαρακτηριστικό "ύψος" στο δεδομένο στοιχείο "φίλτρο". |
| [Href](../../aspose.svg.filters/svgfeimageelement/href/) { get; } | Αντιστοιχεί στο χαρακτηριστικό 'xlink:href' στο δεδομένο στοιχείο. |
...
| [PreserveAspectRatio](../../aspose.svg.filters/svgfeimageelement/preserveaspectratio/) { get; } | Αντιστοιχεί στο χαρακτηριστικό "preserveAspectRatio" στο δεδομένο στοιχείο "feImage". |
...
| [Result](../../aspose.svg.filters/svgfeimageelement/result/) { get; } | Αντιστοιχεί στο χαρακτηριστικό 'result' στο δεδομένο στοιχείο 'filter'. |
...
| [Width](../../aspose.svg.filters/svgfeimageelement/width/) { get; } | Αντιστοιχεί στο χαρακτηριστικό 'width' στο δεδομένο στοιχείο 'filter'. |
| [X](../../aspose.svg.filters/svgfeimageelement/x/) { get; } | Αντιστοιχεί στο χαρακτηριστικό "x" στο δεδομένο στοιχείο "φίλτρο". |
| [Y](../../aspose.svg.filters/svgfeimageelement/y/) { get; } | Αντιστοιχεί στο χαρακτηριστικό 'y' στο δεδομένο στοιχείο 'φίλτρο'. |
