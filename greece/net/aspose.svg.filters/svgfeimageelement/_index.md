---
title: "Τάξη SVGFEImageElement"
second_title: "Aspose.SVG για .NET API Αναφορά"
description: "Aspose.Svg.Filters.SVGFEImageElement κλάση. Η διεπαφή SVGFEImageElement αντιστοιχεί στο στοιχείο feImage."
type: docs
weight: 3890
url: /el/net/aspose.svg.filters/svgfeimageelement/
---
## SVGFEImageElement class

Το interface SVGFEImageElement αντιστοιχεί στο στοιχείο ‘feImage’.
...
| [Height](../../aspose.svg.filters/svgfeimageelement/height/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘height’ του δεδομένου στοιχείου ‘filter’. |
| [Href](../../aspose.svg.filters/svgfeimageelement/href/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘xlink:href’ του δεδομένου στοιχείου. |
...
| [PreserveAspectRatio](../../aspose.svg.filters/svgfeimageelement/preserveaspectratio/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘preserveAspectRatio’ του δεδομένου στοιχείου ‘feImage’. |
...
| [Result](../../aspose.svg.filters/svgfeimageelement/result/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘result’ στο δοσμένο στοιχείο ‘filter’. |
...
| [Width](../../aspose.svg.filters/svgfeimageelement/width/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘width’ του δεδομένου στοιχείου ‘filter’. |
| [X](../../aspose.svg.filters/svgfeimageelement/x/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘x’ του δεδομένου στοιχείου ‘filter’. |
| [Y](../../aspose.svg.filters/svgfeimageelement/y/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘y’ του δεδομένου στοιχείου ‘filter’. |
