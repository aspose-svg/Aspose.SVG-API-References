...
description: "Aspose.Svg.Filters.SVGFEDropShadowElement κλάση. Η διεπαφή SVGFEDropShadowElement αντιστοιχεί στο στοιχείο feDropShadow"
type: docs
weight: 3820
url: /el/net/aspose.svg.filters/svgfedropshadowelement/
---
## SVGFEDropShadowElement class

Το interface SVGFEDropShadowElement αντιστοιχεί στο στοιχείο ‘feDropShadow’.
...
| [Dx](../../aspose.svg.filters/svgfedropshadowelement/dx/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘dx’ στο δοσμένο στοιχείο ‘feDropShadow’. |
| [Dy](../../aspose.svg.filters/svgfedropshadowelement/dy/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘dy’ στο δοσμένο στοιχείο ‘feDropShadow’. |
...
| [Height](../../aspose.svg.filters/svgfedropshadowelement/height/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘height’ στο δοσμένο στοιχείο ‘feDropShadow’. |
...
| [In1](../../aspose.svg.filters/svgfedropshadowelement/in1/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘in’ στο δοσμένο στοιχείο ‘feDropShadow’. |
...
| [Result](../../aspose.svg.filters/svgfedropshadowelement/result/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘result’ στο δοσμένο στοιχείο ‘feDropShadow’. |
...
| [StdDeviationX](../../aspose.svg.filters/svgfedropshadowelement/stddeviationx/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘stdDeviation’ στο δοσμένο στοιχείο ‘feDropShadow’. Περιέχει το στοιχείο X του χαρακτηριστικού ‘stdDeviation’. |
| [StdDeviationY](../../aspose.svg.filters/svgfedropshadowelement/stddeviationy/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘stdDeviation’ στο δοσμένο στοιχείο ‘feDropShadow’. Περιέχει το στοιχείο Y (πιθανώς υπολογιζόμενο αυτόματα) του χαρακτηριστικού ‘stdDeviation’. |
...
| [Width](../../aspose.svg.filters/svgfedropshadowelement/width/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘width’ στο δοσμένο στοιχείο ‘feDropShadow’. |
| [X](../../aspose.svg.filters/svgfedropshadowelement/x/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘x’ στο δοσμένο στοιχείο ‘feDropShadow’. |
| [Y](../../aspose.svg.filters/svgfedropshadowelement/y/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘y’ στο δοσμένο στοιχείο ‘feDropShadow’. |
...
| [SetStdDeviation](../../aspose.svg.filters/svgfedropshadowelement/setstddeviation/)(*float, float*) | Ορίζει τις τιμές για το χαρακτηριστικό ‘stdDeviation’. |
