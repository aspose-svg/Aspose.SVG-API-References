...
description: Aspose.Svg.Filters.SVGFEDropShadowElement τάξη. Η διεπαφή SVGFEDropShadowElement αντιστοιχεί στο στοιχείο feDropShadow.
type: docs
weight: 1730
...
| [Dx](../../aspose.svg.filters/svgfedropshadowelement/dx/) { get; } | Αντιστοιχεί στο χαρακτηριστικό "dx" στο δεδομένο στοιχείο "feDropShadow". |
| [Dy](../../aspose.svg.filters/svgfedropshadowelement/dy/) { get; } | Αντιστοιχεί στο χαρακτηριστικό "dy" στο δεδομένο στοιχείο "feDropShadow". |
...
| [Height](../../aspose.svg.filters/svgfedropshadowelement/height/) { get; } | Αντιστοιχεί στο χαρακτηριστικό 'height' στο δεδομένο στοιχείο 'feDropShadow'. |
...
| [In1](../../aspose.svg.filters/svgfedropshadowelement/in1/) { get; } | Αντιστοιχεί στο χαρακτηριστικό "in" στο δεδομένο στοιχείο "feDropShadow". |
...
| [Result](../../aspose.svg.filters/svgfedropshadowelement/result/) { get; } | Αντιστοιχεί στο χαρακτηριστικό 'result' στο δεδομένο στοιχείο 'feDropShadow'. |
...
| [StdDeviationX](../../aspose.svg.filters/svgfedropshadowelement/stddeviationx/) { get; } | Αντιστοιχεί στο χαρακτηριστικό 'stdDeviation' στο δεδομένο στοιχείο 'feDropShadow'. Περιέχει το στοιχείο X του χαρακτηριστικού 'stdDeviation'. |
| [StdDeviationY](../../aspose.svg.filters/svgfedropshadowelement/stddeviationy/) { get; } | Αντιστοιχεί στο χαρακτηριστικό 'stdDeviation' στο δεδομένο στοιχείο 'feDropShadow'. Περιέχει το στοιχείο Y (ενδεχομένως να υπολογίζεται αυτόματα) του χαρακτηριστικού 'stdDeviation'. |
...
| [Width](../../aspose.svg.filters/svgfedropshadowelement/width/) { get; } | Αντιστοιχεί στο χαρακτηριστικό "width" στο δεδομένο στοιχείο "feDropShadow". |
| [X](../../aspose.svg.filters/svgfedropshadowelement/x/) { get; } | Αντιστοιχεί στο χαρακτηριστικό "x" στο δεδομένο στοιχείο "feDropShadow". |
| [Y](../../aspose.svg.filters/svgfedropshadowelement/y/) { get; } | Αντιστοιχεί στο χαρακτηριστικό 'y' στο δεδομένο στοιχείο 'feDropShadow'. |
