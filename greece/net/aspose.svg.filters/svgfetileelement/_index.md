---
title: "SVGFETileElement Κλάση"
second_title: "Aspose.SVG για .NET API Αναφορά"
description: "Aspose.Svg.Filters.SVGFETileElement κλάση. Η διεπαφή SVGFETileElement αντιστοιχεί στο στοιχείο feTile"
type: docs
weight: 3970
url: /el/net/aspose.svg.filters/svgfetileelement/
---
...
| [Height](../../aspose.svg.filters/svgfetileelement/height/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘height’ του δεδομένου στοιχείου ‘filter’. |
...
| [In1](../../aspose.svg.filters/svgfetileelement/in1/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘in’ στο δοσμένο στοιχείο ‘feTile’. |
...
| [Result](../../aspose.svg.filters/svgfetileelement/result/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘result’ στο δοσμένο στοιχείο ‘filter’. |
...
| [Width](../../aspose.svg.filters/svgfetileelement/width/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘width’ του δεδομένου στοιχείου ‘filter’. |
| [X](../../aspose.svg.filters/svgfetileelement/x/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘x’ του δεδομένου στοιχείου ‘filter’. |
| [Y](../../aspose.svg.filters/svgfetileelement/y/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘y’ του δεδομένου στοιχείου ‘filter’. |
