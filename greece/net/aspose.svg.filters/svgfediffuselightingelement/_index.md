...
description: Aspose.Svg.Filters.SVGFEDiffuseLightingElement τάξη. Η διεπαφή SVGFEDiffuseLightingElement αντιστοιχεί στο στοιχείο feDiffuseLighting.
type: docs
weight: 1700
...
| [DiffuseConstant](../../aspose.svg.filters/svgfediffuselightingelement/diffuseconstant/) { get; } | Αντιστοιχεί στο χαρακτηριστικό 'diffuseConstant' στο δεδομένο στοιχείο 'feDiffuseLighting'. |
...
| [Height](../../aspose.svg.filters/svgfediffuselightingelement/height/) { get; } | Αντιστοιχεί στο χαρακτηριστικό "ύψος" στο δεδομένο στοιχείο "φίλτρο". |
...
| [In1](../../aspose.svg.filters/svgfediffuselightingelement/in1/) { get; } | Αντιστοιχεί στο χαρακτηριστικό "in" στο δεδομένο στοιχείο "feDiffuseLighting". |
...
| [KernelUnitLengthX](../../aspose.svg.filters/svgfediffuselightingelement/kernelunitlengthx/) { get; } | Αντιστοιχεί στο χαρακτηριστικό "kernelUnitLength" στο δεδομένο στοιχείο "feDiffuseLighting". |
| [KernelUnitLengthY](../../aspose.svg.filters/svgfediffuselightingelement/kernelunitlengthy/) { get; } | Αντιστοιχεί στο χαρακτηριστικό "kernelUnitLength" στο δεδομένο στοιχείο "feDiffuseLighting". |
...
| [Result](../../aspose.svg.filters/svgfediffuselightingelement/result/) { get; } | Αντιστοιχεί στο χαρακτηριστικό 'result' στο δεδομένο στοιχείο 'filter'. |
...
| [SurfaceScale](../../aspose.svg.filters/svgfediffuselightingelement/surfacescale/) { get; } | Αντιστοιχεί στο χαρακτηριστικό "surfaceScale" στο δεδομένο στοιχείο "feDiffuseLighting". |
...
| [Width](../../aspose.svg.filters/svgfediffuselightingelement/width/) { get; } | Αντιστοιχεί στο χαρακτηριστικό 'width' στο δεδομένο στοιχείο 'filter'. |
| [X](../../aspose.svg.filters/svgfediffuselightingelement/x/) { get; } | Αντιστοιχεί στο χαρακτηριστικό "x" στο δεδομένο στοιχείο "φίλτρο". |
| [Y](../../aspose.svg.filters/svgfediffuselightingelement/y/) { get; } | Αντιστοιχεί στο χαρακτηριστικό 'y' στο δεδομένο στοιχείο 'φίλτρο'. |
