...
description: "Aspose.Svg.Filters.SVGFEDiffuseLightingElement κλάση. Η SVGFEDiffuseLightingElement διεπαφή αντιστοιχεί στο στοιχείο feDiffuseLighting."
type: docs
weight: 3790
url: /el/net/aspose.svg.filters/svgfediffuselightingelement/
---
## SVGFEDiffuseLightingElement class

Το interface SVGFEDiffuseLightingElement αντιστοιχεί στο στοιχείο ‘feDiffuseLighting’.
...
| [DiffuseConstant](../../aspose.svg.filters/svgfediffuselightingelement/diffuseconstant/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘diffuseConstant’ του δεδομένου στοιχείου ‘feDiffuseLighting’. |
...
| [Height](../../aspose.svg.filters/svgfediffuselightingelement/height/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘height’ του δεδομένου στοιχείου ‘filter’. |
...
| [In1](../../aspose.svg.filters/svgfediffuselightingelement/in1/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘in’ του δεδομένου στοιχείου ‘feDiffuseLighting’. |
...
| [KernelUnitLengthX](../../aspose.svg.filters/svgfediffuselightingelement/kernelunitlengthx/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘kernelUnitLength’ του δεδομένου στοιχείου ‘feDiffuseLighting’. |
| [KernelUnitLengthY](../../aspose.svg.filters/svgfediffuselightingelement/kernelunitlengthy/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘kernelUnitLength’ του δεδομένου στοιχείου ‘feDiffuseLighting’. |
...
| [Result](../../aspose.svg.filters/svgfediffuselightingelement/result/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘result’ στο δοσμένο στοιχείο ‘filter’. |
...
| [SurfaceScale](../../aspose.svg.filters/svgfediffuselightingelement/surfacescale/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘surfaceScale’ του δεδομένου στοιχείου ‘feDiffuseLighting’. |
...
| [Width](../../aspose.svg.filters/svgfediffuselightingelement/width/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘width’ του δεδομένου στοιχείου ‘filter’. |
| [X](../../aspose.svg.filters/svgfediffuselightingelement/x/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘x’ του δεδομένου στοιχείου ‘filter’. |
| [Y](../../aspose.svg.filters/svgfediffuselightingelement/y/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘y’ του δεδομένου στοιχείου ‘filter’. |
