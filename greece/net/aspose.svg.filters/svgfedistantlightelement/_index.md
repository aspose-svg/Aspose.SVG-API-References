...
description: Aspose.Svg.Filters.SVGFEDistantLightElement τάξη. Η διεπαφή SVGFEDistantLightElement αντιστοιχεί στο στοιχείο feDistantLight.
type: docs
weight: 1720
...
| [Azimuth](../../aspose.svg.filters/svgfedistantlightelement/azimuth/) { get; } | Αντιστοιχεί στο χαρακτηριστικό "αζιμούθιο" στο δεδομένο στοιχείο "feDistantLight". |
...
| [Elevation](../../aspose.svg.filters/svgfedistantlightelement/elevation/) { get; } | Αντιστοιχεί στο χαρακτηριστικό "elevation" στο δεδομένο στοιχείο "feDistantLight". |
