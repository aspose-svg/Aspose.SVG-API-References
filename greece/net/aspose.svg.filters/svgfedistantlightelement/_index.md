---
title: "Τάξη SVGFEDistantLightElement"
second_title: "Aspose.SVG για .NET API Αναφορά"
description: "Aspose.Svg.Filters.SVGFEDistantLightElement κλάση. Η διεπαφή SVGFEDistantLightElement αντιστοιχεί στο στοιχείο feDistantLight"
type: docs
weight: 3810
url: /el/net/aspose.svg.filters/svgfedistantlightelement/
---
## SVGFEDistantLightElement class

Το interface SVGFEDistantLightElement αντιστοιχεί στο στοιχείο ‘feDistantLight’.
...
| [Azimuth](../../aspose.svg.filters/svgfedistantlightelement/azimuth/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘azimuth’ του δεδομένου στοιχείου ‘feDistantLight’. |
...
| [Elevation](../../aspose.svg.filters/svgfedistantlightelement/elevation/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘elevation’ του δεδομένου στοιχείου ‘feDistantLight’. |
