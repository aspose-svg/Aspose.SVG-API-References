...
description: "Aspose.Svg.Filters.SVGFEConvolveMatrixElement κλάση. Η διεπαφή SVGFEConvolveMatrixElement αντιστοιχεί στο στοιχείο feConvolveMatrix."
type: docs
weight: 3780
url: /el/net/aspose.svg.filters/svgfeconvolvematrixelement/
---
## SVGFEConvolveMatrixElement class

Το interface SVGFEConvolveMatrixElement αντιστοιχεί στο στοιχείο ‘feConvolveMatrix’.
...
| [Bias](../../aspose.svg.filters/svgfeconvolvematrixelement/bias/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘bias’ στο δεδομένο στοιχείο ‘feConvolveMatrix’. |
...
| [Divisor](../../aspose.svg.filters/svgfeconvolvematrixelement/divisor/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘divisor’ στο δεδομένο στοιχείο ‘feConvolveMatrix’. |
| [EdgeMode](../../aspose.svg.filters/svgfeconvolvematrixelement/edgemode/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘edgeMode’ στο δεδομένο στοιχείο ‘feConvolveMatrix’. |
...
| [Height](../../aspose.svg.filters/svgfeconvolvematrixelement/height/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘height’ του δεδομένου στοιχείου ‘filter’. |
...
| [In1](../../aspose.svg.filters/svgfeconvolvematrixelement/in1/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘in’ στο δεδομένο στοιχείο ‘feConvolveMatrix’. |
...
| [KernelMatrix](../../aspose.svg.filters/svgfeconvolvematrixelement/kernelmatrix/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘kernelMatrix’ στο δεδομένο στοιχείο ‘feConvolveMatrix’. |
| [KernelUnitLengthX](../../aspose.svg.filters/svgfeconvolvematrixelement/kernelunitlengthx/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘kernelUnitLength’ στο δεδομένο στοιχείο ‘feConvolveMatrix’. |
| [KernelUnitLengthY](../../aspose.svg.filters/svgfeconvolvematrixelement/kernelunitlengthy/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘kernelUnitLength’ στο δεδομένο στοιχείο ‘feConvolveMatrix’. |
...
| [OrderX](../../aspose.svg.filters/svgfeconvolvematrixelement/orderx/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘order’ στο δεδομένο στοιχείο ‘feConvolveMatrix’. |
| [OrderY](../../aspose.svg.filters/svgfeconvolvematrixelement/ordery/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘order’ στο δεδομένο στοιχείο ‘feConvolveMatrix’. |
...
| [PreserveAlpha](../../aspose.svg.filters/svgfeconvolvematrixelement/preservealpha/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘preserveAlpha’ στο δεδομένο στοιχείο ‘feConvolveMatrix’. |
...
| [Result](../../aspose.svg.filters/svgfeconvolvematrixelement/result/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘result’ στο δοσμένο στοιχείο ‘filter’. |
...
| [TargetX](../../aspose.svg.filters/svgfeconvolvematrixelement/targetx/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘targetX’ στο δεδομένο στοιχείο ‘feConvolveMatrix’. |
| [TargetY](../../aspose.svg.filters/svgfeconvolvematrixelement/targety/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘targetY’ στο δεδομένο στοιχείο ‘feConvolveMatrix’. |
...
| [Width](../../aspose.svg.filters/svgfeconvolvematrixelement/width/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘width’ του δεδομένου στοιχείου ‘filter’. |
| [X](../../aspose.svg.filters/svgfeconvolvematrixelement/x/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘x’ του δεδομένου στοιχείου ‘filter’. |
| [Y](../../aspose.svg.filters/svgfeconvolvematrixelement/y/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘y’ του δεδομένου στοιχείου ‘filter’. |
...
| Όνομα | Περιγραφή |
| --- | --- |
| const [SVG_EDGEMODE_DUPLICATE](../../aspose.svg.filters/svgfeconvolvematrixelement/svg_edgemode_duplicate/) | Αντιστοιχεί στην τιμή 'duplicate'. |
| const [SVG_EDGEMODE_NONE](../../aspose.svg.filters/svgfeconvolvematrixelement/svg_edgemode_none/) | Αντιστοιχεί στην τιμή 'none'. |
| const [SVG_EDGEMODE_UNKNOWN](../../aspose.svg.filters/svgfeconvolvematrixelement/svg_edgemode_unknown/) | Ο τύπος δεν είναι ένας από τους προκαθορισμένους τύπους. Είναι μη έγκυρο να προσπαθήσετε να ορίσετε μια νέα τιμή αυτού του τύπου ή να προσπαθήσετε να αλλάξετε μια υπάρχουσα τιμή σε αυτόν τον τύπο. |
| const [SVG_EDGEMODE_WRAP](../../aspose.svg.filters/svgfeconvolvematrixelement/svg_edgemode_wrap/) | Αντιστοιχεί στην τιμή 'wrap'. |
