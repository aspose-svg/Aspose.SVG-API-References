...
description: Aspose.Svg.Filters.SVGFEBlendElement τάξη. Η διεπαφή SVGFEBlendElement αντιστοιχεί στο στοιχείο feBlend.
type: docs
weight: 1650
...
| [Height](../../aspose.svg.filters/svgfeblendelement/height/) { get; } | Αντιστοιχεί στο χαρακτηριστικό "ύψος" στο δεδομένο στοιχείο "φίλτρο". |
...
| [In1](../../aspose.svg.filters/svgfeblendelement/in1/) { get; } | Αντιστοιχεί στο χαρακτηριστικό 'in' στο δεδομένο στοιχείο 'feBlend'. |
| [In2](../../aspose.svg.filters/svgfeblendelement/in2/) { get; } | Αντιστοιχεί στο χαρακτηριστικό 'in2' στο δεδομένο στοιχείο 'feBlend'. |
...
| [Mode](../../aspose.svg.filters/svgfeblendelement/mode/) { get; } | Αντιστοιχεί στο χαρακτηριστικό 'mode' στο δεδομένο στοιχείο 'feBlend'. Λαμβάνει μία από τις σταθερές SVG_FEBLEND_MODE_* που ορίζονται σε αυτήν τη διεπαφή. |
...
| [Result](../../aspose.svg.filters/svgfeblendelement/result/) { get; } | Αντιστοιχεί στο χαρακτηριστικό 'result' στο δεδομένο στοιχείο 'filter'. |
...
| [Width](../../aspose.svg.filters/svgfeblendelement/width/) { get; } | Αντιστοιχεί στο χαρακτηριστικό 'width' στο δεδομένο στοιχείο 'filter'. |
| [X](../../aspose.svg.filters/svgfeblendelement/x/) { get; } | Αντιστοιχεί στο χαρακτηριστικό "x" στο δεδομένο στοιχείο "φίλτρο". |
| [Y](../../aspose.svg.filters/svgfeblendelement/y/) { get; } | Αντιστοιχεί στο χαρακτηριστικό 'y' στο δεδομένο στοιχείο 'φίλτρο'. |
...
| const [SVG_FEBLEND_MODE_DARKEN](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_darken/) | Αντιστοιχεί στην τιμή 'σκοτεινό'. |
| const [SVG_FEBLEND_MODE_DIFFERENCE](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_difference/) | Αντιστοιχεί στην τιμή 'διαφορά'. |
...
| const [SVG_FEBLEND_MODE_LUMINOSITY](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_luminosity/) | Αντιστοιχεί στην τιμή 'φωτεινότητα'. |
| const [SVG_FEBLEND_MODE_MULTIPLY](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_multiply/) | Αντιστοιχεί στην τιμή 'πολλαπλασιάζω'. |
| const [SVG_FEBLEND_MODE_NORMAL](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_normal/) | Αντιστοιχεί στην τιμή "κανονικό". |
| const [SVG_FEBLEND_MODE_OVERLAY](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_overlay/) | Αντιστοιχεί στην τιμή 'επικάλυψη'. |
...
| const [SVG_FEBLEND_MODE_UNKNOWN](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_unknown/) | Ο τύπος δεν είναι ένας από τους προκαθορισμένους τύπους. Δεν είναι έγκυρο να επιχειρήσετε να ορίσετε μια νέα τιμή αυτού του τύπου ή να προσπαθήσετε να αλλάξετε μια υπάρχουσα τιμή σε αυτόν τον τύπο. |
