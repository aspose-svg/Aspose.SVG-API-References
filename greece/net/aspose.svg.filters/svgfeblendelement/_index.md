---
title: "Κλάση SVGFEBlendElement"
second_title: "Aspose.SVG για .NET API Αναφορά"
description: "Aspose.Svg.Filters.SVGFEBlendElement κλάση. Η διεπαφή SVGFEBlendElement αντιστοιχεί στο στοιχείο feBlend"
type: docs
weight: 3740
url: /el/net/aspose.svg.filters/svgfeblendelement/
---
## SVGFEBlendElement class

Το interface SVGFEBlendElement αντιστοιχεί στο στοιχείο ‘feBlend’.
...
| [Height](../../aspose.svg.filters/svgfeblendelement/height/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘height’ του δεδομένου στοιχείου ‘filter’. |
...
| [In1](../../aspose.svg.filters/svgfeblendelement/in1/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘in’ του δεδομένου στοιχείου ‘feBlend’. |
| [In2](../../aspose.svg.filters/svgfeblendelement/in2/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘in2’ του δεδομένου στοιχείου ‘feBlend’. |
...
| [Mode](../../aspose.svg.filters/svgfeblendelement/mode/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘mode’ του δεδομένου στοιχείου ‘feBlend’. Παίρνει μία από τις σταθερές SVG_FEBLEND_MODE_* που ορίζονται σε αυτή τη διεπαφή. |
...
| [Result](../../aspose.svg.filters/svgfeblendelement/result/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘result’ στο δοσμένο στοιχείο ‘filter’. |
...
| [Width](../../aspose.svg.filters/svgfeblendelement/width/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘width’ του δεδομένου στοιχείου ‘filter’. |
| [X](../../aspose.svg.filters/svgfeblendelement/x/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘x’ του δεδομένου στοιχείου ‘filter’. |
| [Y](../../aspose.svg.filters/svgfeblendelement/y/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘y’ του δεδομένου στοιχείου ‘filter’. |
...
| Όνομα | Περιγραφή |
| --- | --- |
| const [SVG_FEBLEND_MODE_COLOR](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_color/) | Αντιστοιχεί στην τιμή 'color'. |
| const [SVG_FEBLEND_MODE_COLOR_BURN](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_color_burn/) | Αντιστοιχεί στην τιμή 'color_burn'. |
| const [SVG_FEBLEND_MODE_COLOR_DODGE](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_color_dodge/) | Αντιστοιχεί στην τιμή 'color_dodge'. |
| const [SVG_FEBLEND_MODE_DARKEN](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_darken/) | Αντιστοιχεί στην τιμή 'darken'. |
| const [SVG_FEBLEND_MODE_DIFFERENCE](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_difference/) | Αντιστοιχεί στην τιμή 'difference'. |
| const [SVG_FEBLEND_MODE_EXCLUSION](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_exclusion/) | Αντιστοιχεί στην τιμή 'exclusion'. |
| const [SVG_FEBLEND_MODE_HARD_LIGHT](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_hard_light/) | Αντιστοιχεί στην τιμή 'hard_light'. |
| const [SVG_FEBLEND_MODE_HUE](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_hue/) | Αντιστοιχεί στην τιμή 'hue'. |
| const [SVG_FEBLEND_MODE_LIGHTEN](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_lighten/) | Αντιστοιχεί στην τιμή 'lighten'. |
| const [SVG_FEBLEND_MODE_LUMINOSITY](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_luminosity/) | Αντιστοιχεί στην τιμή 'luminosity'. |
| const [SVG_FEBLEND_MODE_MULTIPLY](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_multiply/) | Αντιστοιχεί στην τιμή 'multiply'. |
| const [SVG_FEBLEND_MODE_NORMAL](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_normal/) | Αντιστοιχεί στην τιμή 'normal'. |
| const [SVG_FEBLEND_MODE_OVERLAY](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_overlay/) | Αντιστοιχεί στην τιμή 'overlay'. |
| const [SVG_FEBLEND_MODE_SATURATION](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_saturation/) | Αντιστοιχεί στην τιμή 'saturation'. |
| const [SVG_FEBLEND_MODE_SCREEN](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_screen/) | Αντιστοιχεί στην τιμή 'screen'. |
| const [SVG_FEBLEND_MODE_SOFT_LIGHT](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_soft_light/) | Αντιστοιχεί στην τιμή 'soft_light'. |
| const [SVG_FEBLEND_MODE_UNKNOWN](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_unknown/) | Ο τύπος δεν είναι ένας από τους προκαθορισμένους τύπους. Είναι μη έγκυρο να προσπαθήσετε να ορίσετε μια νέα τιμή αυτού του τύπου ή να προσπαθήσετε να αλλάξετε μια υπάρχουσα τιμή σε αυτόν τον τύπο. |
