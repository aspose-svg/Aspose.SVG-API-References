---
title: "Κλάση SVGFEMergeNodeElement"
second_title: "Aspose.SVG για .NET API Αναφορά"
description: "Aspose.Svg.Filters.SVGFEMergeNodeElement κλάση. Η διεπαφή SVGFEMergeNodeElement αντιστοιχεί στο στοιχείο feMergeNode"
type: docs
weight: 3910
url: /el/net/aspose.svg.filters/svgfemergenodeelement/
---
...
| [In1](../../aspose.svg.filters/svgfemergenodeelement/in1/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘in’ του δεδομένου στοιχείου ‘feMergeNode’. |
