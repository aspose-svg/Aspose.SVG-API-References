...
description: Aspose.Svg.Filters.SVGFEMergeNodeElement τάξη. Η διεπαφή SVGFEMergeNodeElement αντιστοιχεί στο στοιχείο feMergeNode.
type: docs
weight: 1820
...
| [In1](../../aspose.svg.filters/svgfemergenodeelement/in1/) { get; } | Αντιστοιχεί στο χαρακτηριστικό "in" στο δεδομένο στοιχείο "feMergeNode". |
