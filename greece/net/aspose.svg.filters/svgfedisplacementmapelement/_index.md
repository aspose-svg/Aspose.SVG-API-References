...
description: "Aspose.Svg.Filters.SVGFEDisplacementMapElement κλάση. Η διεπαφή SVGFEDisplacementMapElement αντιστοιχεί στο στοιχείο feDisplacementMap."
type: docs
weight: 3800
url: /el/net/aspose.svg.filters/svgfedisplacementmapelement/
---
## SVGFEDisplacementMapElement class

Το interface SVGFEDisplacementMapElement αντιστοιχεί στο στοιχείο ‘feDisplacementMap’.
...
| [Height](../../aspose.svg.filters/svgfedisplacementmapelement/height/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘height’ του δεδομένου στοιχείου ‘filter’. |
...
| [In1](../../aspose.svg.filters/svgfedisplacementmapelement/in1/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘in’ στο δεδομένο στοιχείο ‘feDisplacementMap’. |
| [In2](../../aspose.svg.filters/svgfedisplacementmapelement/in2/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘in2’ στο δεδομένο στοιχείο ‘feDisplacementMap’. |
...
| [Result](../../aspose.svg.filters/svgfedisplacementmapelement/result/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘result’ στο δοσμένο στοιχείο ‘filter’. |
| [Scale](../../aspose.svg.filters/svgfedisplacementmapelement/scale/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘scale’ στο δεδομένο στοιχείο ‘feDisplacementMap’. |
...
| [Width](../../aspose.svg.filters/svgfedisplacementmapelement/width/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘width’ του δεδομένου στοιχείου ‘filter’. |
| [X](../../aspose.svg.filters/svgfedisplacementmapelement/x/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘x’ του δεδομένου στοιχείου ‘filter’. |
| [XChannelSelector](../../aspose.svg.filters/svgfedisplacementmapelement/xchannelselector/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘xChannelSelector’ στο δεδομένο στοιχείο ‘feDisplacementMap’. Δέχεται μία από τις σταθερές SVG_CHANNEL_* που ορίζονται σε αυτή τη διεπαφή. |
| [Y](../../aspose.svg.filters/svgfedisplacementmapelement/y/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘y’ του δεδομένου στοιχείου ‘filter’. |
| [YChannelSelector](../../aspose.svg.filters/svgfedisplacementmapelement/ychannelselector/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘yChannelSelector’ στο δεδομένο στοιχείο ‘feDisplacementMap’. Δέχεται μία από τις σταθερές SVG_CHANNEL_* που ορίζονται σε αυτή τη διεπαφή. |
...
| Όνομα | Περιγραφή |
| --- | --- |
| const [SVG_CHANNEL_A](../../aspose.svg.filters/svgfedisplacementmapelement/svg_channel_a/) | Αντιστοιχεί στην τιμή 'A'. |
| const [SVG_CHANNEL_B](../../aspose.svg.filters/svgfedisplacementmapelement/svg_channel_b/) | Αντιστοιχεί στην τιμή 'B'. |
| const [SVG_CHANNEL_G](../../aspose.svg.filters/svgfedisplacementmapelement/svg_channel_g/) | Αντιστοιχεί στην τιμή 'G'. |
| const [SVG_CHANNEL_R](../../aspose.svg.filters/svgfedisplacementmapelement/svg_channel_r/) | Αντιστοιχεί στην τιμή 'R'. |
| const [SVG_CHANNEL_UNKNOWN](../../aspose.svg.filters/svgfedisplacementmapelement/svg_channel_unknown/) | Ο τύπος δεν είναι ένας από τους προκαθορισμένους τύπους. Είναι μη έγκυρο να προσπαθήσετε να ορίσετε μια νέα τιμή αυτού του τύπου ή να προσπαθήσετε να αλλάξετε μια υπάρχουσα τιμή σε αυτόν τον τύπο. |
