...
description: Aspose.Svg.Filters.SVGFEPointLightElement τάξη. Η διεπαφή SVGFEPointLightElement αντιστοιχεί στο στοιχείο fePointLight.
type: docs
weight: 1850
...
| [X](../../aspose.svg.filters/svgfepointlightelement/x/) { get; } | Αντιστοιχεί στο χαρακτηριστικό "x" στο δεδομένο στοιχείο "fePointLight". |
| [Y](../../aspose.svg.filters/svgfepointlightelement/y/) { get; } | Αντιστοιχεί στο χαρακτηριστικό 'y' στο δεδομένο στοιχείο 'fePointLight'. |
| [Z](../../aspose.svg.filters/svgfepointlightelement/z/) { get; } | Αντιστοιχεί στο χαρακτηριστικό 'z' στο δεδομένο στοιχείο 'fePointLight'. |
