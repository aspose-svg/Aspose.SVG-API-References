---
title: "Κλάση SVGFEOffsetElement"
second_title: "Aspose.SVG για .NET API Αναφορά"
description: "Η κλάση Aspose.Svg.Filters.SVGFEOffsetElement. Η διεπαφή SVGFEOffsetElement αντιστοιχεί στο στοιχείο feOffset"
type: docs
weight: 3930
url: /el/net/aspose.svg.filters/svgfeoffsetelement/
---
...
| [Dx](../../aspose.svg.filters/svgfeoffsetelement/dx/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘dx’ στο δεδομένο στοιχείο ‘feOffset’. |
| [Dy](../../aspose.svg.filters/svgfeoffsetelement/dy/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘dy’ στο δεδομένο στοιχείο ‘feOffset’. |
...
| [Height](../../aspose.svg.filters/svgfeoffsetelement/height/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘height’ του δεδομένου στοιχείου ‘filter’. |
...
| [In1](../../aspose.svg.filters/svgfeoffsetelement/in1/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘in’ του δεδομένου στοιχείου ‘feOffset’. |
...
| [Result](../../aspose.svg.filters/svgfeoffsetelement/result/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘result’ στο δοσμένο στοιχείο ‘filter’. |
...
| [Width](../../aspose.svg.filters/svgfeoffsetelement/width/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘width’ του δεδομένου στοιχείου ‘filter’. |
| [X](../../aspose.svg.filters/svgfeoffsetelement/x/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘x’ του δεδομένου στοιχείου ‘filter’. |
| [Y](../../aspose.svg.filters/svgfeoffsetelement/y/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘y’ του δεδομένου στοιχείου ‘filter’. |
