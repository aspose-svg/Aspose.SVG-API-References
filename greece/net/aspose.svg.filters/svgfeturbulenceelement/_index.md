...
description: Aspose.Svg.Filters.SVGFETurbulenceElement τάξη. Η διεπαφή SVGFETturbulenceElement αντιστοιχεί στο στοιχείο feTurbulence.
type: docs
weight: 1890
...
| [BaseFrequencyX](../../aspose.svg.filters/svgfeturbulenceelement/basefrequencyx/) { get; } | Αντιστοιχεί στο χαρακτηριστικό «baseFrequency» στο δεδομένο στοιχείο «feTurbulence». Περιέχει το στοιχείο X του χαρακτηριστικού 'baseFrequency'. |
| [BaseFrequencyY](../../aspose.svg.filters/svgfeturbulenceelement/basefrequencyy/) { get; } | Αντιστοιχεί στο χαρακτηριστικό «baseFrequency» στο δεδομένο στοιχείο «feTurbulence». Περιέχει το στοιχείο Υ του χαρακτηριστικού «baseFrequency» (ενδεχομένως να υπολογίζεται αυτόματα). |
...
| [Height](../../aspose.svg.filters/svgfeturbulenceelement/height/) { get; } | Αντιστοιχεί στο χαρακτηριστικό "ύψος" στο δεδομένο στοιχείο "φίλτρο". |
...
| [Result](../../aspose.svg.filters/svgfeturbulenceelement/result/) { get; } | Αντιστοιχεί στο χαρακτηριστικό 'result' στο δεδομένο στοιχείο 'filter'. |
...
| [StitchTiles](../../aspose.svg.filters/svgfeturbulenceelement/stitchtiles/) { get; } | Αντιστοιχεί στο χαρακτηριστικό 'stitchTiles' στο δεδομένο στοιχείο 'feTurbulence'. Λαμβάνει μία από τις σταθερές SVG_STITCHTYPE_* που ορίζονται σε αυτήν τη διεπαφή. |
...
| [Type](../../aspose.svg.filters/svgfeturbulenceelement/type/) { get; } | Αντιστοιχεί στο χαρακτηριστικό 'type' στο δεδομένο στοιχείο 'feTurbulence'. Λαμβάνει μία από τις σταθερές SVG_TURBULENCE_TYPE_* που ορίζονται σε αυτήν τη διεπαφή. |
...
| [Width](../../aspose.svg.filters/svgfeturbulenceelement/width/) { get; } | Αντιστοιχεί στο χαρακτηριστικό 'width' στο δεδομένο στοιχείο 'filter'. |
| [X](../../aspose.svg.filters/svgfeturbulenceelement/x/) { get; } | Αντιστοιχεί στο χαρακτηριστικό "x" στο δεδομένο στοιχείο "φίλτρο". |
| [Y](../../aspose.svg.filters/svgfeturbulenceelement/y/) { get; } | Αντιστοιχεί στο χαρακτηριστικό 'y' στο δεδομένο στοιχείο 'φίλτρο'. |
...
| const [SVG_STITCHTYPE_UNKNOWN](../../aspose.svg.filters/svgfeturbulenceelement/svg_stitchtype_unknown/) | Ο τύπος δεν είναι ένας από τους προκαθορισμένους τύπους. Δεν είναι έγκυρο να επιχειρήσετε να ορίσετε μια νέα τιμή αυτού του τύπου ή να προσπαθήσετε να αλλάξετε μια υπάρχουσα τιμή σε αυτόν τον τύπο. |
...
| const [SVG_TURBULENCE_TYPE_UNKNOWN](../../aspose.svg.filters/svgfeturbulenceelement/svg_turbulence_type_unknown/) | Ο τύπος δεν είναι ένας από τους προκαθορισμένους τύπους. Δεν είναι έγκυρο να επιχειρήσετε να ορίσετε μια νέα τιμή αυτού του τύπου ή να προσπαθήσετε να αλλάξετε μια υπάρχουσα τιμή σε αυτόν τον τύπο. |
