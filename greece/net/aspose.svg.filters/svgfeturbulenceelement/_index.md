...
description: "Aspose.Svg.Filters.SVGFETurbulenceElement κλάση. Η διεπαφή SVGFETurbulenceElement αντιστοιχεί στο στοιχείο feTurbulence."
type: docs
weight: 3980
url: /el/net/aspose.svg.filters/svgfeturbulenceelement/
---
...
| [BaseFrequencyX](../../aspose.svg.filters/svgfeturbulenceelement/basefrequencyx/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘baseFrequency’ στο δεδομένο στοιχείο ‘feTurbulence’. Περιέχει το συστατικό X του χαρακτηριστικού ‘baseFrequency’. |
| [BaseFrequencyY](../../aspose.svg.filters/svgfeturbulenceelement/basefrequencyy/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘baseFrequency’ στο δεδομένο στοιχείο ‘feTurbulence’. Περιέχει το συστατικό Y του (ενδεχομένως υπολογιζόμενου αυτόματα) χαρακτηριστικού ‘baseFrequency’. |
...
| [Height](../../aspose.svg.filters/svgfeturbulenceelement/height/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘height’ του δεδομένου στοιχείου ‘filter’. |
...
| [NumOctaves](../../aspose.svg.filters/svgfeturbulenceelement/numoctaves/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘numOctaves’ στο δεδομένο στοιχείο ‘feTurbulence’. |
...
| [Result](../../aspose.svg.filters/svgfeturbulenceelement/result/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘result’ στο δοσμένο στοιχείο ‘filter’. |
| [Seed](../../aspose.svg.filters/svgfeturbulenceelement/seed/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘seed’ στο δεδομένο στοιχείο ‘feTurbulence’. |
...
| [StitchTiles](../../aspose.svg.filters/svgfeturbulenceelement/stitchtiles/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘stitchTiles’ στο δεδομένο στοιχείο ‘feTurbulence’. Δέχεται μία από τις σταθερές SVG_STITCHTYPE_* που ορίζονται σε αυτή τη διεπαφή. |
...
| [Type](../../aspose.svg.filters/svgfeturbulenceelement/type/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘type’ στο δεδομένο στοιχείο ‘feTurbulence’. Δέχεται μία από τις σταθερές SVG_TURBULENCE_TYPE_* που ορίζονται σε αυτή τη διεπαφή. |
...
| [Width](../../aspose.svg.filters/svgfeturbulenceelement/width/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘width’ του δεδομένου στοιχείου ‘filter’. |
| [X](../../aspose.svg.filters/svgfeturbulenceelement/x/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘x’ του δεδομένου στοιχείου ‘filter’. |
| [Y](../../aspose.svg.filters/svgfeturbulenceelement/y/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘y’ του δεδομένου στοιχείου ‘filter’. |
...
| Όνομα | Περιγραφή |
| --- | --- |
| const [SVG_STITCHTYPE_NOSTITCH](../../aspose.svg.filters/svgfeturbulenceelement/svg_stitchtype_nostitch/) | Αντιστοιχεί στην τιμή 'noStitch'. |
| const [SVG_STITCHTYPE_STITCH](../../aspose.svg.filters/svgfeturbulenceelement/svg_stitchtype_stitch/) | Αντιστοιχεί στην τιμή 'stitch'. |
| const [SVG_STITCHTYPE_UNKNOWN](../../aspose.svg.filters/svgfeturbulenceelement/svg_stitchtype_unknown/) | Ο τύπος δεν είναι ένας από τους προκαθορισμένους τύπους. Είναι μη έγκυρο να προσπαθήσετε να ορίσετε μια νέα τιμή αυτού του τύπου ή να προσπαθήσετε να αλλάξετε μια υπάρχουσα τιμή σε αυτόν τον τύπο. |
| const [SVG_TURBULENCE_TYPE_FRACTALNOISE](../../aspose.svg.filters/svgfeturbulenceelement/svg_turbulence_type_fractalnoise/) | Αντιστοιχεί στην τιμή 'fractalNoise'. |
| const [SVG_TURBULENCE_TYPE_TURBULENCE](../../aspose.svg.filters/svgfeturbulenceelement/svg_turbulence_type_turbulence/) | Αντιστοιχεί στην τιμή 'turbulence'. |
| const [SVG_TURBULENCE_TYPE_UNKNOWN](../../aspose.svg.filters/svgfeturbulenceelement/svg_turbulence_type_unknown/) | Ο τύπος δεν είναι ένας από τους προκαθορισμένους τύπους. Είναι μη έγκυρο να προσπαθήσετε να ορίσετε μια νέα τιμή αυτού του τύπου ή να προσπαθήσετε να αλλάξετε μια υπάρχουσα τιμή σε αυτόν τον τύπο. |
