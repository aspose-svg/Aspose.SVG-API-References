---
title: "Τάξη SVGFESpotLightElement"
second_title: "Aspose.SVG για .NET API Αναφορά"
description: "Aspose.Svg.Filters.SVGFESpotLightElement κλάση. Η διεπαφή SVGFESpotLightElement αντιστοιχεί στο στοιχείο feSpotLight."
type: docs
weight: 3960
url: /el/net/aspose.svg.filters/svgfespotlightelement/
---
...
| [LimitingConeAngle](../../aspose.svg.filters/svgfespotlightelement/limitingconeangle/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘limitingConeAngle’ του δεδομένου στοιχείου ‘feSpotLight’. |
...
| [PointsAtX](../../aspose.svg.filters/svgfespotlightelement/pointsatx/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘pointsAtX’ του δεδομένου στοιχείου ‘feSpotLight’. |
| [PointsAtY](../../aspose.svg.filters/svgfespotlightelement/pointsaty/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘pointsAtY’ του δεδομένου στοιχείου ‘feSpotLight’. |
| [PointsAtZ](../../aspose.svg.filters/svgfespotlightelement/pointsatz/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘pointsAtZ’ του δεδομένου στοιχείου ‘feSpotLight’. |
...
| [SpecularExponent](../../aspose.svg.filters/svgfespotlightelement/specularexponent/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘specularExponent’ του δεδομένου στοιχείου ‘feSpotLight’. |
...
| [X](../../aspose.svg.filters/svgfespotlightelement/x/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘x’ του δεδομένου στοιχείου ‘feSpotLight’. |
| [Y](../../aspose.svg.filters/svgfespotlightelement/y/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘y’ του δεδομένου στοιχείου ‘feSpotLight’. |
| [Z](../../aspose.svg.filters/svgfespotlightelement/z/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘z’ του δεδομένου στοιχείου ‘feSpotLight’. |
