...
description: Aspose.Svg.Filters.SVGFESpotLightElement τάξη. Η διεπαφή SVGFESpotLightElement αντιστοιχεί στο στοιχείο feSpotLight.
type: docs
weight: 1870
...
| [LimitingConeAngle](../../aspose.svg.filters/svgfespotlightelement/limitingconeangle/) { get; } | Αντιστοιχεί στο χαρακτηριστικό 'limitingConeAngle' στο δεδομένο στοιχείο 'feSpotLight'. |
...
| [PointsAtX](../../aspose.svg.filters/svgfespotlightelement/pointsatx/) { get; } | Αντιστοιχεί στο χαρακτηριστικό 'pointsAtX' στο δεδομένο στοιχείο 'feSpotLight'. |
| [PointsAtY](../../aspose.svg.filters/svgfespotlightelement/pointsaty/) { get; } | Αντιστοιχεί στο χαρακτηριστικό 'pointsAtY' στο δεδομένο στοιχείο 'feSpotLight'. |
| [PointsAtZ](../../aspose.svg.filters/svgfespotlightelement/pointsatz/) { get; } | Αντιστοιχεί στο χαρακτηριστικό 'pointsAtZ' στο δεδομένο στοιχείο 'feSpotLight'. |
...
| [SpecularExponent](../../aspose.svg.filters/svgfespotlightelement/specularexponent/) { get; } | Αντιστοιχεί στο χαρακτηριστικό 'specularExponent' στο δεδομένο στοιχείο 'feSpotLight'. |
...
| [X](../../aspose.svg.filters/svgfespotlightelement/x/) { get; } | Αντιστοιχεί στο χαρακτηριστικό "x" στο δεδομένο στοιχείο "feSpotLight". |
| [Y](../../aspose.svg.filters/svgfespotlightelement/y/) { get; } | Αντιστοιχεί στο χαρακτηριστικό 'y' στο δεδομένο στοιχείο 'feSpotLight'. |
| [Z](../../aspose.svg.filters/svgfespotlightelement/z/) { get; } | Αντιστοιχεί στο χαρακτηριστικό 'z' στο δεδομένο στοιχείο 'feSpotLight'. |
