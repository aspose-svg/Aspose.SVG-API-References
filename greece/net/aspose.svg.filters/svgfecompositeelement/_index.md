...
description: Aspose.Svg.Filters.SVGFECompositeElement τάξη. Η διεπαφή SVGFECompositeElement αντιστοιχεί στο στοιχείο feComposite.
type: docs
weight: 1680
...
| [Height](../../aspose.svg.filters/svgfecompositeelement/height/) { get; } | Αντιστοιχεί στο χαρακτηριστικό "ύψος" στο δεδομένο στοιχείο "φίλτρο". |
...
| [Operator](../../aspose.svg.filters/svgfecompositeelement/operator/) { get; } | Αντιστοιχεί στο χαρακτηριστικό 'operator' στο δεδομένο στοιχείο 'feComposite'. Λαμβάνει μία από τις σταθερές SVG_FECOMPOSITE_OPERATOR_* που ορίζονται σε αυτήν τη διεπαφή. |
...
| [Result](../../aspose.svg.filters/svgfecompositeelement/result/) { get; } | Αντιστοιχεί στο χαρακτηριστικό 'result' στο δεδομένο στοιχείο 'filter'. |
...
| [Width](../../aspose.svg.filters/svgfecompositeelement/width/) { get; } | Αντιστοιχεί στο χαρακτηριστικό 'width' στο δεδομένο στοιχείο 'filter'. |
| [X](../../aspose.svg.filters/svgfecompositeelement/x/) { get; } | Αντιστοιχεί στο χαρακτηριστικό "x" στο δεδομένο στοιχείο "φίλτρο". |
| [Y](../../aspose.svg.filters/svgfecompositeelement/y/) { get; } | Αντιστοιχεί στο χαρακτηριστικό 'y' στο δεδομένο στοιχείο 'φίλτρο'. |
...
| Ονομα | Περιγραφή |
| --- | --- |
| const [SVG_FECOMPOSITE_OPERATOR_ARITHMETIC](../../aspose.svg.filters/svgfecompositeelement/svg_fecomposite_operator_arithmetic/) | Αντιστοιχεί στην τιμή 'αριθμητική'. |
...
| const [SVG_FECOMPOSITE_OPERATOR_UNKNOWN](../../aspose.svg.filters/svgfecompositeelement/svg_fecomposite_operator_unknown/) | Ο τύπος δεν είναι ένας από τους προκαθορισμένους τύπους. Δεν είναι έγκυρο να επιχειρήσετε να ορίσετε μια νέα τιμή αυτού του τύπου ή να προσπαθήσετε να αλλάξετε μια υπάρχουσα τιμή σε αυτόν τον τύπο. |
