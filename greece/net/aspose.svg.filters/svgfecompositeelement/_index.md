...
description: "Η κλάση Aspose.Svg.Filters.SVGFECompositeElement. Η διεπαφή SVGFECompositeElement αντιστοιχεί στο στοιχείο feComposite"
type: docs
weight: 3770
url: /el/net/aspose.svg.filters/svgfecompositeelement/
---
## SVGFECompositeElement class

Το interface SVGFECompositeElement αντιστοιχεί στο στοιχείο ‘feComposite’.
...
| [Height](../../aspose.svg.filters/svgfecompositeelement/height/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘height’ του δεδομένου στοιχείου ‘filter’. |
...
| [In1](../../aspose.svg.filters/svgfecompositeelement/in1/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘in’ στο δεδομένο στοιχείο ‘feComposite’. |
| [In2](../../aspose.svg.filters/svgfecompositeelement/in2/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘in2’ στο δεδομένο στοιχείο ‘feComposite’. |
...
| [K1](../../aspose.svg.filters/svgfecompositeelement/k1/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘k1’ στο δεδομένο στοιχείο ‘feComposite’. |
| [K2](../../aspose.svg.filters/svgfecompositeelement/k2/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘k2’ στο δεδομένο στοιχείο ‘feComposite’. |
| [K3](../../aspose.svg.filters/svgfecompositeelement/k3/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘k3’ στο δεδομένο στοιχείο ‘feComposite’. |
| [K4](../../aspose.svg.filters/svgfecompositeelement/k4/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘k4’ στο δεδομένο στοιχείο ‘feComposite’. |
...
| [Operator](../../aspose.svg.filters/svgfecompositeelement/operator/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘operator’ στο δεδομένο στοιχείο ‘feComposite’. Παίρνει μία από τις σταθερές SVG_FECOMPOSITE_OPERATOR_* που ορίζονται σε αυτή τη διεπαφή. |
...
| [Result](../../aspose.svg.filters/svgfecompositeelement/result/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘result’ στο δοσμένο στοιχείο ‘filter’. |
...
| [Width](../../aspose.svg.filters/svgfecompositeelement/width/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘width’ του δεδομένου στοιχείου ‘filter’. |
| [X](../../aspose.svg.filters/svgfecompositeelement/x/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘x’ του δεδομένου στοιχείου ‘filter’. |
| [Y](../../aspose.svg.filters/svgfecompositeelement/y/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘y’ του δεδομένου στοιχείου ‘filter’. |
...
| Όνομα | Περιγραφή |
| --- | --- |
| const [SVG_FECOMPOSITE_OPERATOR_ARITHMETIC](../../aspose.svg.filters/svgfecompositeelement/svg_fecomposite_operator_arithmetic/) | Αντιστοιχεί στην τιμή 'arithmetic'. |
| const [SVG_FECOMPOSITE_OPERATOR_ATOP](../../aspose.svg.filters/svgfecompositeelement/svg_fecomposite_operator_atop/) | Αντιστοιχεί στην τιμή 'atop'. |
| const [SVG_FECOMPOSITE_OPERATOR_IN](../../aspose.svg.filters/svgfecompositeelement/svg_fecomposite_operator_in/) | Αντιστοιχεί στην τιμή 'in'. |
| const [SVG_FECOMPOSITE_OPERATOR_OUT](../../aspose.svg.filters/svgfecompositeelement/svg_fecomposite_operator_out/) | Αντιστοιχεί στην τιμή 'out'. |
| const [SVG_FECOMPOSITE_OPERATOR_OVER](../../aspose.svg.filters/svgfecompositeelement/svg_fecomposite_operator_over/) | Αντιστοιχεί στην τιμή 'over'. |
| const [SVG_FECOMPOSITE_OPERATOR_UNKNOWN](../../aspose.svg.filters/svgfecompositeelement/svg_fecomposite_operator_unknown/) | Ο τύπος δεν είναι ένας από τους προκαθορισμένους τύπους. Είναι μη έγκυρο να προσπαθήσετε να ορίσετε μια νέα τιμή αυτού του τύπου ή να προσπαθήσετε να αλλάξετε μια υπάρχουσα τιμή σε αυτόν τον τύπο. |
| const [SVG_FECOMPOSITE_OPERATOR_XOR](../../aspose.svg.filters/svgfecompositeelement/svg_fecomposite_operator_xor/) | Αντιστοιχεί στην τιμή 'xor'. |
