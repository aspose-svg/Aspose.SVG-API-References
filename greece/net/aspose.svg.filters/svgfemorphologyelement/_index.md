---
title: "Τάξη SVGFEMorphologyElement"
second_title: "Aspose.SVG για .NET API Αναφορά"
description: "Aspose.Svg.Filters.SVGFEMorphologyElement κλάση. Η διεπαφή SVGFEMorphologyElement αντιστοιχεί στο στοιχείο feMorphology."
type: docs
weight: 3920
url: /el/net/aspose.svg.filters/svgfemorphologyelement/
---
...
| [Height](../../aspose.svg.filters/svgfemorphologyelement/height/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘height’ του δεδομένου στοιχείου ‘filter’. |
...
| [In1](../../aspose.svg.filters/svgfemorphologyelement/in1/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘in’ του δεδομένου στοιχείου ‘feMorphology’. |
...
| [Operator](../../aspose.svg.filters/svgfemorphologyelement/operator/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘operator’ του δεδομένου στοιχείου ‘feMorphology’. Παίρνει μία από τις σταθερές SVG_MORPHOLOGY_OPERATOR_* που ορίζονται σε αυτή τη διεπαφή. |
...
| [RadiusX](../../aspose.svg.filters/svgfemorphologyelement/radiusx/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘radius’ στο δεδομένο στοιχείο ‘feMorphology’. |
| [RadiusY](../../aspose.svg.filters/svgfemorphologyelement/radiusy/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘radius’ στο δεδομένο στοιχείο ‘feMorphology’. |
| [Result](../../aspose.svg.filters/svgfemorphologyelement/result/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘result’ στο δοσμένο στοιχείο ‘filter’. |
...
| [Width](../../aspose.svg.filters/svgfemorphologyelement/width/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘width’ του δεδομένου στοιχείου ‘filter’. |
| [X](../../aspose.svg.filters/svgfemorphologyelement/x/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘x’ του δεδομένου στοιχείου ‘filter’. |
| [Y](../../aspose.svg.filters/svgfemorphologyelement/y/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘y’ του δεδομένου στοιχείου ‘filter’. |
...
| Όνομα | Περιγραφή |
| --- | --- |
| const [SVG_MORPHOLOGY_OPERATOR_DILATE](../../aspose.svg.filters/svgfemorphologyelement/svg_morphology_operator_dilate/) | Αντιστοιχεί στην τιμή 'dilate'. |
| const [SVG_MORPHOLOGY_OPERATOR_ERODE](../../aspose.svg.filters/svgfemorphologyelement/svg_morphology_operator_erode/) | Αντιστοιχεί στην τιμή 'erode'. |
