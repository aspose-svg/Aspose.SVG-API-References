...
description: Aspose.Svg.Filters.SVGFEMorphologyElement τάξη. Η διεπαφή SVGFEMorphologyElement αντιστοιχεί στο στοιχείο feMorphology.
type: docs
weight: 1830
...
| [Height](../../aspose.svg.filters/svgfemorphologyelement/height/) { get; } | Αντιστοιχεί στο χαρακτηριστικό "ύψος" στο δεδομένο στοιχείο "φίλτρο". |
...
| [In1](../../aspose.svg.filters/svgfemorphologyelement/in1/) { get; } | Αντιστοιχεί στο χαρακτηριστικό 'in' στο δεδομένο στοιχείο 'feMorphology'. |
...
| [Operator](../../aspose.svg.filters/svgfemorphologyelement/operator/) { get; } | Αντιστοιχεί στο χαρακτηριστικό «τελεστής» στο δεδομένο στοιχείο «feMorphology». Λαμβάνει μία από τις σταθερές SVG_MORPHOLOGY_OPERATOR_* που ορίζονται σε αυτήν τη διεπαφή. |
...
| [RadiusX](../../aspose.svg.filters/svgfemorphologyelement/radiusx/) { get; } | Αντιστοιχεί στο χαρακτηριστικό "ακτίνα" στο δεδομένο στοιχείο "feMorphology". |
| [RadiusY](../../aspose.svg.filters/svgfemorphologyelement/radiusy/) { get; } | Αντιστοιχεί στο χαρακτηριστικό "ακτίνα" στο δεδομένο στοιχείο "feMorphology". |
| [Result](../../aspose.svg.filters/svgfemorphologyelement/result/) { get; } | Αντιστοιχεί στο χαρακτηριστικό 'result' στο δεδομένο στοιχείο 'filter'. |
...
| [Width](../../aspose.svg.filters/svgfemorphologyelement/width/) { get; } | Αντιστοιχεί στο χαρακτηριστικό 'width' στο δεδομένο στοιχείο 'filter'. |
| [X](../../aspose.svg.filters/svgfemorphologyelement/x/) { get; } | Αντιστοιχεί στο χαρακτηριστικό "x" στο δεδομένο στοιχείο "φίλτρο". |
| [Y](../../aspose.svg.filters/svgfemorphologyelement/y/) { get; } | Αντιστοιχεί στο χαρακτηριστικό 'y' στο δεδομένο στοιχείο 'φίλτρο'. |
