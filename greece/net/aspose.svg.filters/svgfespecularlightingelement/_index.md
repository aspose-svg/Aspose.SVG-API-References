...
description: "Aspose.Svg.Filters.SVGFESpecularLightingElement κλάση. Η SVGFESpecularLightingElement διεπαφή αντιστοιχεί στο στοιχείο feSpecularLighting."
type: docs
weight: 3950
url: /el/net/aspose.svg.filters/svgfespecularlightingelement/
---
...
| [Height](../../aspose.svg.filters/svgfespecularlightingelement/height/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘height’ του δεδομένου στοιχείου ‘filter’. |
...
| [In1](../../aspose.svg.filters/svgfespecularlightingelement/in1/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘in’ του δεδομένου στοιχείου ‘feSpecularLighting’. |
...
| [KernelUnitLengthX](../../aspose.svg.filters/svgfespecularlightingelement/kernelunitlengthx/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘kernelUnitLength’ του δεδομένου στοιχείου ‘feSpecularLighting’. |
| [KernelUnitLengthY](../../aspose.svg.filters/svgfespecularlightingelement/kernelunitlengthy/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘kernelUnitLength’ του δεδομένου στοιχείου ‘feSpecularLighting’. |
...
| [Result](../../aspose.svg.filters/svgfespecularlightingelement/result/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘result’ στο δοσμένο στοιχείο ‘filter’. |
...
| [SpecularConstant](../../aspose.svg.filters/svgfespecularlightingelement/specularconstant/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘specularConstant’ του δεδομένου στοιχείου ‘feSpecularLighting’. |
| [SpecularExponent](../../aspose.svg.filters/svgfespecularlightingelement/specularexponent/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘specularExponent’ του δεδομένου στοιχείου ‘feSpecularLighting’. |
...
| [SurfaceScale](../../aspose.svg.filters/svgfespecularlightingelement/surfacescale/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘surfaceScale’ του δεδομένου στοιχείου ‘feSpecularLighting’. |
...
| [Width](../../aspose.svg.filters/svgfespecularlightingelement/width/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘width’ του δεδομένου στοιχείου ‘filter’. |
| [X](../../aspose.svg.filters/svgfespecularlightingelement/x/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘x’ του δεδομένου στοιχείου ‘filter’. |
| [Y](../../aspose.svg.filters/svgfespecularlightingelement/y/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘y’ του δεδομένου στοιχείου ‘filter’. |
