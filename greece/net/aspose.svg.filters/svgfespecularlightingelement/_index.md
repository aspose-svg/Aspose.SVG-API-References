...
description: Aspose.Svg.Filters.SVGFESpecularLightingElement τάξη. Η διεπαφή SVGFESpecularLightingElement αντιστοιχεί στο στοιχείο feSpecularLighting.
type: docs
weight: 1860
...
| [Height](../../aspose.svg.filters/svgfespecularlightingelement/height/) { get; } | Αντιστοιχεί στο χαρακτηριστικό "ύψος" στο δεδομένο στοιχείο "φίλτρο". |
...
| [In1](../../aspose.svg.filters/svgfespecularlightingelement/in1/) { get; } | Αντιστοιχεί στο χαρακτηριστικό "in" στο δεδομένο στοιχείο "feSpecularLighting". |
...
| [KernelUnitLengthX](../../aspose.svg.filters/svgfespecularlightingelement/kernelunitlengthx/) { get; } | Αντιστοιχεί στο χαρακτηριστικό "kernelUnitLength" στο δεδομένο στοιχείο "feSpecularLighting". |
| [KernelUnitLengthY](../../aspose.svg.filters/svgfespecularlightingelement/kernelunitlengthy/) { get; } | Αντιστοιχεί στο χαρακτηριστικό "kernelUnitLength" στο δεδομένο στοιχείο "feSpecularLighting". |
...
| [Result](../../aspose.svg.filters/svgfespecularlightingelement/result/) { get; } | Αντιστοιχεί στο χαρακτηριστικό 'result' στο δεδομένο στοιχείο 'filter'. |
...
| [SpecularConstant](../../aspose.svg.filters/svgfespecularlightingelement/specularconstant/) { get; } | Αντιστοιχεί στο χαρακτηριστικό 'specularConstant' στο δεδομένο στοιχείο 'feSpecularLighting'. |
| [SpecularExponent](../../aspose.svg.filters/svgfespecularlightingelement/specularexponent/) { get; } | Αντιστοιχεί στο χαρακτηριστικό 'specularExponent' στο δεδομένο στοιχείο 'feSpecularLighting'. |
...
| [SurfaceScale](../../aspose.svg.filters/svgfespecularlightingelement/surfacescale/) { get; } | Αντιστοιχεί στο χαρακτηριστικό "surfaceScale" στο δεδομένο στοιχείο "feSpecularLighting". |
...
| [Width](../../aspose.svg.filters/svgfespecularlightingelement/width/) { get; } | Αντιστοιχεί στο χαρακτηριστικό 'width' στο δεδομένο στοιχείο 'filter'. |
| [X](../../aspose.svg.filters/svgfespecularlightingelement/x/) { get; } | Αντιστοιχεί στο χαρακτηριστικό "x" στο δεδομένο στοιχείο "φίλτρο". |
| [Y](../../aspose.svg.filters/svgfespecularlightingelement/y/) { get; } | Αντιστοιχεί στο χαρακτηριστικό 'y' στο δεδομένο στοιχείο 'φίλτρο'. |
