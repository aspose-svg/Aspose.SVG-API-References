---
title: "SVGFEColorMatrixElement Κλάση"
second_title: "Aspose.SVG για .NET API Αναφορά"
description: "Aspose.Svg.Filters.SVGFEColorMatrixElement κλάση. Η διεπαφή SVGFEColorMatrixElement αντιστοιχεί στο στοιχείο feColorMatrix"
type: docs
weight: 3750
url: /el/net/aspose.svg.filters/svgfecolormatrixelement/
---
## SVGFEColorMatrixElement class

Το interface SVGFEColorMatrixElement αντιστοιχεί στο στοιχείο ‘feColorMatrix’.
...
| [Height](../../aspose.svg.filters/svgfecolormatrixelement/height/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘height’ του δεδομένου στοιχείου ‘filter’. |
...
| [In1](../../aspose.svg.filters/svgfecolormatrixelement/in1/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘in’ στο δοσμένο στοιχείο ‘feColorMatrix’. |
...
| [Result](../../aspose.svg.filters/svgfecolormatrixelement/result/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘result’ στο δοσμένο στοιχείο ‘filter’. |
...
| [Type](../../aspose.svg.filters/svgfecolormatrixelement/type/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘type’ στο δοσμένο στοιχείο ‘feColorMatrix’. Παίρνει μία από τις σταθερές SVG_FECOLORMATRIX_TYPE_* που ορίζονται σε αυτή τη διεπαφή. |
| [Values](../../aspose.svg.filters/svgfecolormatrixelement/values/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘values’ στο δοσμένο στοιχείο ‘feColorMatrix’. |
...
| [Width](../../aspose.svg.filters/svgfecolormatrixelement/width/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘width’ του δεδομένου στοιχείου ‘filter’. |
| [X](../../aspose.svg.filters/svgfecolormatrixelement/x/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘x’ του δεδομένου στοιχείου ‘filter’. |
| [Y](../../aspose.svg.filters/svgfecolormatrixelement/y/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘y’ του δεδομένου στοιχείου ‘filter’. |
...
| Όνομα | Περιγραφή |
| --- | --- |
| const [SVG_FECOLORMATRIX_TYPE_HUEROTATE](../../aspose.svg.filters/svgfecolormatrixelement/svg_fecolormatrix_type_huerotate/) | Αντιστοιχεί στην τιμή 'hueRotate'. |
| const [SVG_FECOLORMATRIX_TYPE_LUMINANCETOALPHA](../../aspose.svg.filters/svgfecolormatrixelement/svg_fecolormatrix_type_luminancetoalpha/) | Αντιστοιχεί στην τιμή 'luminanceToAlpha'. |
| const [SVG_FECOLORMATRIX_TYPE_MATRIX](../../aspose.svg.filters/svgfecolormatrixelement/svg_fecolormatrix_type_matrix/) | Αντιστοιχεί στην τιμή 'matrix'. |
| const [SVG_FECOLORMATRIX_TYPE_SATURATE](../../aspose.svg.filters/svgfecolormatrixelement/svg_fecolormatrix_type_saturate/) | Αντιστοιχεί στην τιμή 'saturate'. |
| const [SVG_FECOLORMATRIX_TYPE_UNKNOWN](../../aspose.svg.filters/svgfecolormatrixelement/svg_fecolormatrix_type_unknown/) | Ο τύπος δεν είναι ένας από τους προκαθορισμένους τύπους. Είναι μη έγκυρο να προσπαθήσετε να ορίσετε μια νέα τιμή αυτού του τύπου ή να προσπαθήσετε να αλλάξετε μια υπάρχουσα τιμή σε αυτόν τον τύπο. |
