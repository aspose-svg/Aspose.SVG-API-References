...
description: Aspose.Svg.Filters.SVGFEColorMatrixElement τάξη. Η διεπαφή SVGFEColorMatrixElement αντιστοιχεί στο στοιχείο feColorMatrix.
type: docs
weight: 1660
...
| [Height](../../aspose.svg.filters/svgfecolormatrixelement/height/) { get; } | Αντιστοιχεί στο χαρακτηριστικό "ύψος" στο δεδομένο στοιχείο "φίλτρο". |
...
| [In1](../../aspose.svg.filters/svgfecolormatrixelement/in1/) { get; } | Αντιστοιχεί στο χαρακτηριστικό "in" στο δεδομένο στοιχείο "feColorMatrix". |
...
| [Result](../../aspose.svg.filters/svgfecolormatrixelement/result/) { get; } | Αντιστοιχεί στο χαρακτηριστικό 'result' στο δεδομένο στοιχείο 'filter'. |
...
| [Type](../../aspose.svg.filters/svgfecolormatrixelement/type/) { get; } | Αντιστοιχεί στο χαρακτηριστικό 'type' στο δεδομένο στοιχείο 'feColorMatrix'. Λαμβάνει μία από τις σταθερές SVG_FECOLORMATRIX_TYPE_* που ορίζονται σε αυτήν τη διεπαφή. |
| [Values](../../aspose.svg.filters/svgfecolormatrixelement/values/) { get; } | Αντιστοιχεί στο χαρακτηριστικό "values" στο δεδομένο στοιχείο "feColorMatrix". |
...
| [Width](../../aspose.svg.filters/svgfecolormatrixelement/width/) { get; } | Αντιστοιχεί στο χαρακτηριστικό 'width' στο δεδομένο στοιχείο 'filter'. |
| [X](../../aspose.svg.filters/svgfecolormatrixelement/x/) { get; } | Αντιστοιχεί στο χαρακτηριστικό "x" στο δεδομένο στοιχείο "φίλτρο". |
| [Y](../../aspose.svg.filters/svgfecolormatrixelement/y/) { get; } | Αντιστοιχεί στο χαρακτηριστικό 'y' στο δεδομένο στοιχείο 'φίλτρο'. |
...
| const [SVG_FECOLORMATRIX_TYPE_UNKNOWN](../../aspose.svg.filters/svgfecolormatrixelement/svg_fecolormatrix_type_unknown/) | Ο τύπος δεν είναι ένας από τους προκαθορισμένους τύπους. Δεν είναι έγκυρο να επιχειρήσετε να ορίσετε μια νέα τιμή αυτού του τύπου ή να προσπαθήσετε να αλλάξετε μια υπάρχουσα τιμή σε αυτόν τον τύπο. |
