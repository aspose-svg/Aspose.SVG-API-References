...
description: "Η κλάση Aspose.Svg.Filters.SVGFEComponentTransferElement. Η διεπαφή SVGFEComponentTransferElement αντιστοιχεί στο στοιχείο feComponentTransfer"
type: docs
weight: 3760
url: /el/net/aspose.svg.filters/svgfecomponenttransferelement/
---
## SVGFEComponentTransferElement class

Το interface SVGFEComponentTransferElement αντιστοιχεί στο στοιχείο ‘feComponentTransfer’.
...
| [Height](../../aspose.svg.filters/svgfecomponenttransferelement/height/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘height’ του δεδομένου στοιχείου ‘filter’. |
...
| [In1](../../aspose.svg.filters/svgfecomponenttransferelement/in1/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘in’ στο δεδομένο στοιχείο ‘feComponentTransfer’. |
...
| [Result](../../aspose.svg.filters/svgfecomponenttransferelement/result/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘result’ στο δοσμένο στοιχείο ‘filter’. |
...
| [Width](../../aspose.svg.filters/svgfecomponenttransferelement/width/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘width’ του δεδομένου στοιχείου ‘filter’. |
| [X](../../aspose.svg.filters/svgfecomponenttransferelement/x/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘x’ του δεδομένου στοιχείου ‘filter’. |
| [Y](../../aspose.svg.filters/svgfecomponenttransferelement/y/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘y’ του δεδομένου στοιχείου ‘filter’. |
