...
description: "Aspose.Svg.Dom.Events.FocusEvent κλάση. Η διεπαφή FocusEvent παρέχει συγκεκριμένες συμφραζόμενες πληροφορίες που σχετίζονται με γεγονότα εστίασης."
type: docs
weight: 2930
...
Η διεπαφή FocusEvent παρέχει συγκεκριμένες πληροφορίες συμφραζομένων που σχετίζονται με γεγονότα εστίασης.
...
| [FocusEvent](focusevent/#constructor_1)(*string, IDictionary&lt;string, object&gt;*) | Αρχικοποιεί ένα νέο στιγμιότυπο της κλάσης `FocusEvent`. |
...
| [RelatedTarget](../../aspose.svg.dom.events/focusevent/relatedtarget/) { get; } | Χρησιμοποιείται για την ταυτοποίηση ενός δευτερεύοντος EventTarget που σχετίζεται με ένα Focus event, ανάλογα με τον τύπο του event. |
