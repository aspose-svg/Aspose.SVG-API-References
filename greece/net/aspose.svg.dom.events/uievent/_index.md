...
description: "Aspose.Svg.Dom.Events.UIEvent κλάση. Η διεπαφή UIEvent παρέχει συγκεκριμένες συμφραζόμενες πληροφορίες που σχετίζονται με γεγονότα Διεπαφής Χρήστη."
type: docs
weight: 3000
url: /el/net/aspose.svg.dom.events/uievent/
---
## UIEvent class

Η διεπαφή UIEvent παρέχει συγκεκριμένες πληροφορίες συμφραζομένων που σχετίζονται με γεγονότα διεπαφής χρήστη.
...
| [UIEvent](uievent/#constructor_1)(*string, IDictionary&lt;string, object&gt;*) | Αρχικοποιεί ένα νέο αντικείμενο της κλάσης `UIEvent`. |
