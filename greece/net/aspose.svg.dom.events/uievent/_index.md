...
description: Aspose.Svg.Dom.Events.UIEvent τάξη. Η διεπαφή UIEvent παρέχει συγκεκριμένες πληροφορίες σχετικά με τα συμφραζόμενα που σχετίζονται με συμβάντα διεπαφής χρήστη.
type: docs
weight: 1000
