...
description: Aspose.Svg.Dom.Events.MouseEvent τάξη. Η διεπαφή MouseEvent παρέχει συγκεκριμένες πληροφορίες σχετικά με τα συμφραζόμενα που σχετίζονται με συμβάντα Mouse.
type: docs
weight: 990
