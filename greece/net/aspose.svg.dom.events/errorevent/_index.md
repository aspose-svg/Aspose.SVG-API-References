...
description: "Aspose.Svg.Dom.Events.ErrorEvent κλάση. Το ErrorEvent παρέχει πληροφορίες περιβάλλοντος σχετικά με σφάλματα που συνέβησαν κατά την εκτέλεση"
type: docs
weight: 2910
...
Το `ErrorEvent` παρέχει πληροφορίες περιβάλλοντος σχετικά με σφάλματα που συνέβησαν κατά την εκτέλεση.
...
| Όνομα | Περιγραφή |
| --- | --- |
| [ErrorEvent](errorevent/#constructor_1)(*Exception*) | Αρχικοποιεί ένα νέο αντικείμενο της κλάσης `ErrorEvent`. |
| [ErrorEvent](errorevent/#constructor)(*IDictionary&lt;string, object&gt;*) | Αρχικοποιεί ένα νέο αντικείμενο της κλάσης `ErrorEvent`. |
