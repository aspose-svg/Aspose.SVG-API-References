...
description: Aspose.Svg.Dom.Events.ErrorEvent τάξη. ΤοErrorEvent παρέχει πληροφορίες σχετικά με τα συμφραζόμενα σχετικά με σφάλματα που παρουσιάστηκαν κατά τη διάρκεια του χρόνου εκτέλεσης.
type: docs
weight: 910
url: /el/net/aspose.svg.dom.events/errorevent/
---
## ErrorEvent class
...
| [ColNo](../../aspose.svg.dom.events/errorevent/colno/) { get; } | Το χαρακτηριστικό colno πρέπει να επιστρέψει την τιμή στην οποία είχε αρχικοποιηθεί. Όταν δημιουργείται το αντικείμενο, αυτό το χαρακτηριστικό πρέπει να αρχικοποιηθεί στο μηδέν. Αντιπροσωπεύει τον αριθμό της στήλης όπου παρουσιάστηκε το σφάλμα στο σενάριο. |
...
| [Error](../../aspose.svg.dom.events/errorevent/error/) { get; } | Το χαρακτηριστικό σφάλματος πρέπει να επιστρέψει την τιμή στην οποία είχε αρχικοποιηθεί. Όταν δημιουργείται το αντικείμενο, αυτό το χαρακτηριστικό πρέπει να αρχικοποιηθεί σε null. Όπου ενδείκνυται, ορίζεται στο αντικείμενο που αντιπροσωπεύει το σφάλμα (π.χ. το αντικείμενο εξαίρεσης στην περίπτωση μιας εξαίρεσης DOM που δεν έχει εντοπιστεί). |
...
| [LineNo](../../aspose.svg.dom.events/errorevent/lineno/) { get; } | Το χαρακτηριστικό lineno πρέπει να επιστρέψει την τιμή στην οποία είχε αρχικοποιηθεί. Όταν δημιουργείται το αντικείμενο, αυτό το χαρακτηριστικό πρέπει να αρχικοποιηθεί στο μηδέν. Αντιπροσωπεύει τον αριθμό γραμμής όπου παρουσιάστηκε το σφάλμα στο σενάριο. |
| [Message](../../aspose.svg.dom.events/errorevent/message/) { get; } | Το χαρακτηριστικό μήνυμα πρέπει να επιστρέψει την τιμή στην οποία είχε αρχικοποιηθεί. Όταν δημιουργείται το αντικείμενο, αυτό το χαρακτηριστικό πρέπει να αρχικοποιηθεί στην κενή συμβολοσειρά. Αντιπροσωπεύει το μήνυμα σφάλματος. |
