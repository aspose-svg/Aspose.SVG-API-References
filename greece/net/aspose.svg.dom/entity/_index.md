...
description: Aspose.Svg.Dom.Entity τάξη. Αντιπροσωπεύει μια γνωστή οντότητα είτε αναλυμένη είτε χωρίς ανάλυση σε ένα έγγραφο XML.
type: docs
weight: 850
...
| override [NodeType](../../aspose.svg.dom/entity/nodetype/) { get; } | Ένας κωδικός που αντιπροσωπεύει τον τύπο του υποκείμενου αντικειμένου. |
| virtual [NodeValue](../../aspose.svg.dom/node/nodevalue/) { get; set; } | Η τιμή αυτού του κόμβου, ανάλογα με τον τύπο του. |
| [NotationName](../../aspose.svg.dom/entity/notationname/) { get; } | Για μη αναλυμένες οντότητες, το όνομα της σημείωσης για την οντότητα. Για αναλυμένες οντότητες, αυτό είναι null. |
...
| [PublicId](../../aspose.svg.dom/entity/publicid/) { get; } | Το δημόσιο αναγνωριστικό που σχετίζεται με την οντότητα, εάν καθορίζεται, και μηδενικό διαφορετικά. |
| [SystemId](../../aspose.svg.dom/entity/systemid/) { get; } | Το αναγνωριστικό συστήματος που σχετίζεται με την οντότητα, εάν καθορίζεται, και μηδενίζεται διαφορετικά. Αυτό μπορεί να είναι απόλυτο URI ή όχι. |
...
| [XmlEncoding](../../aspose.svg.dom/entity/xmlencoding/) { get; } | Χαρακτηριστικό που προσδιορίζει, ως μέρος της δήλωσης κειμένου, την κωδικοποίηση αυτής της οντότητας, όταν πρόκειται για μια εξωτερική αναλυμένη οντότητα. Αυτό είναι μηδενικό διαφορετικά. |
| [XmlVersion](../../aspose.svg.dom/entity/xmlversion/) { get; } | Χαρακτηριστικό που καθορίζει, ως μέρος της δήλωσης κειμένου, τον αριθμό έκδοσης αυτής της οντότητας, όταν πρόκειται για εξωτερική οντότητα ανάλυσης. Αυτό είναι μηδενικό διαφορετικά. |
