...
description: "Aspose.Svg.Dom.Entity class. Αντιπροσωπεύει μια γνωστή οντότητα είτε αναλυμένη είτε μη αναλυμένη σε ένα έγγραφο XML."
type: docs
weight: 2850
url: /el/net/aspose.svg.dom/entity/
---
## Entity class
...
| [InputEncoding](../../aspose.svg.dom/entity/inputencoding/) { get; } | Ένα χαρακτηριστικό που καθορίζει την κωδικοποίηση που χρησιμοποιείται για αυτήν την οντότητα κατά την ανάλυση, όταν είναι εξωτερική αναλυμένη οντότητα. Είναι null εάν είναι οντότητα από το εσωτερικό υποσύνολο ή εάν δεν είναι γνωστή. |
...
| override [NodeName](../../aspose.svg.dom/entity/nodename/) { get; } | Το όνομα αυτού του κόμβου, ανάλογα με τον τύπο του. |
| override [NodeType](../../aspose.svg.dom/entity/nodetype/) { get; } | Ένας κώδικας που αντιπροσωπεύει τον τύπο του υποκείμενου αντικειμένου. |
| virtual [NodeValue](../../aspose.svg.dom/node/nodevalue/) { get; set; } | Επιστρέφει ή ορίζει την τιμή του τρέχοντος κόμβου. |
| [NotationName](../../aspose.svg.dom/entity/notationname/) { get; } | Για μη αναλυμένες οντότητες, το όνομα της σημειογραφίας για την οντότητα. Για αναλυμένες οντότητες, είναι null. |
...
| [PublicId](../../aspose.svg.dom/entity/publicid/) { get; } | Το δημόσιο αναγνωριστικό που σχετίζεται με την οντότητα εάν έχει καθοριστεί, και null διαφορετικά. |
| [SystemId](../../aspose.svg.dom/entity/systemid/) { get; } | Το σύστημα αναγνωριστικό που σχετίζεται με την οντότητα εάν έχει καθοριστεί, και null διαφορετικά. Αυτό μπορεί να είναι απόλυτο URI ή όχι. |
...
| [XmlEncoding](../../aspose.svg.dom/entity/xmlencoding/) { get; } | Ένα χαρακτηριστικό που καθορίζει, ως μέρος της δήλωσης κειμένου, την κωδικοποίηση αυτής της οντότητας, όταν είναι εξωτερική αναλυμένη οντότητα. Είναι null διαφορετικά. |
| [XmlVersion](../../aspose.svg.dom/entity/xmlversion/) { get; } | Ένα χαρακτηριστικό που καθορίζει, ως μέρος της δήλωσης κειμένου, τον αριθμό έκδοσης αυτής της οντότητας, όταν είναι εξωτερική αναλυμένη οντότητα. Είναι null διαφορετικά. |
