...
description: Aspose.Svg.Dom.Element τάξη. Η διεπαφή Element αντιπροσωπεύει ένα στοιχείο σε ένα έγγραφο HTML ή XML.
type: docs
weight: 840
...
| [Id](../../aspose.svg.dom/element/id/) { get; set; } | Το αναγνωριστικό του στοιχείου. Δείτε τον ορισμό του χαρακτηριστικού id στην HTML 4.01. |
...
| [ParentElement](../../aspose.svg.dom/node/parentelement/) { get; } | Παίρνει τον γονέα`Element` αυτού του κόμβου. |
