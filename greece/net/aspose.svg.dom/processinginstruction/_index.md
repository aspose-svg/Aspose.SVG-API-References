...
description: Aspose.Svg.Dom.ProcessingInstruction τάξη. Το ProcessingInstruction αντιπροσωπεύει μια εντολή επεξεργασίας που χρησιμοποιείται σε XML ως ένας τρόπος για να διατηρούνται πληροφορίες για τον επεξεργαστή στο κείμενο του εγγράφου.
type: docs
weight: 1170
...
| override [NodeType](../../aspose.svg.dom/processinginstruction/nodetype/) { get; } | Ένας κωδικός που αντιπροσωπεύει τον τύπο του υποκείμενου αντικειμένου. |
...
| [Target](../../aspose.svg.dom/processinginstruction/target/) { get; } | Ο στόχος αυτής της εντολής επεξεργασίας. |
