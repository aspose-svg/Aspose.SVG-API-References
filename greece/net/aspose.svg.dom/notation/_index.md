...
description: "Aspose.Svg.Dom.Notation class. Αντιπροσωπεύει μια σημείωση που δηλώνεται στο DTD."
type: docs
weight: 3150
url: /el/net/aspose.svg.dom/notation/
---
## Notation class
...
| override [NodeName](../../aspose.svg.dom/notation/nodename/) { get; } | Το όνομα αυτού του κόμβου, ανάλογα με τον τύπο του. |
| override [NodeType](../../aspose.svg.dom/notation/nodetype/) { get; } | Ένας κώδικας που αντιπροσωπεύει τον τύπο του υποκείμενου αντικειμένου. |
...
| [PublicId](../../aspose.svg.dom/notation/publicid/) { get; } | Το δημόσιο αναγνωριστικό αυτής της σημείωσης. Εάν το δημόσιο αναγνωριστικό δεν έχει καθοριστεί, είναι null. |
| [SystemId](../../aspose.svg.dom/notation/systemid/) { get; } | Το αναγνωριστικό συστήματος αυτής της σημείωσης. Εάν το αναγνωριστικό συστήματος δεν έχει καθοριστεί, είναι null. Αυτό μπορεί να είναι απόλυτο URI ή όχι. |
