...
description: Aspose.Svg.Dom.Notation τάξη. Αντιπροσωπεύει μια σημείωση που δηλώνεται στο DTD.
type: docs
weight: 1160
...
| override [NodeType](../../aspose.svg.dom/notation/nodetype/) { get; } | Ένας κωδικός που αντιπροσωπεύει τον τύπο του υποκείμενου αντικειμένου. |
...
| [PublicId](../../aspose.svg.dom/notation/publicid/) { get; } | Το δημόσιο αναγνωριστικό αυτού του συμβολισμού. Εάν το δημόσιο αναγνωριστικό δεν καθορίστηκε, αυτό είναι null. |
| [SystemId](../../aspose.svg.dom/notation/systemid/) { get; } | Το αναγνωριστικό συστήματος αυτού του συμβολισμού. Εάν το αναγνωριστικό συστήματος δεν καθορίστηκε, αυτό είναι μηδενικό. Αυτό μπορεί να είναι απόλυτο URI ή όχι. |
