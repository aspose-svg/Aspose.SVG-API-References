...
description: Aspose.Svg.Dom.DocumentType τάξη. Το DocumentType παρέχει μια διεπαφή στη λίστα των οντοτήτων που έχουν οριστεί για το document
type: docs
weight: 830
...
| [InternalSubset](../../aspose.svg.dom/documenttype/internalsubset/) { get; } | Το εσωτερικό υποσύνολο ως συμβολοσειρά ή μηδενικό αν δεν υπάρχει. |
...
| [Name](../../aspose.svg.dom/documenttype/name/) { get; } | Το όνομα του DTD. δηλαδή το όνομα αμέσως μετά τη λέξη-κλειδί DOCTYPE. |
...
| override [NodeType](../../aspose.svg.dom/documenttype/nodetype/) { get; } | Ένας κωδικός που αντιπροσωπεύει τον τύπο του υποκείμενου αντικειμένου. |
...
| override [ToString](../../aspose.svg.dom/documenttype/tostring/)() | Επιστρέφει αString που αντιπροσωπεύει αυτήν την περίπτωση. |
