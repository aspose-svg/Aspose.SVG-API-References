...
description: "Aspose.Svg.Dom.DocumentType class. Η DocumentType παρέχει μια διεπαφή στη λίστα των οντοτήτων που ορίζονται για το έγγραφο."
type: docs
weight: 2830
url: /el/net/aspose.svg.dom/documenttype/
---
## DocumentType class
...
| Όνομα | Περιγραφή |
| --- | --- |
| [DocumentType](documenttype/)(*string, string, string, string, [Document](../document/)*) | Αρχικοποιεί ένα νέο στιγμιότυπο της κλάσης `DocumentType`. |
...
| [InternalSubset](../../aspose.svg.dom/documenttype/internalsubset/) { get; } | Το εσωτερικό υποσύνολο ως συμβολοσειρά, ή null εάν δεν υπάρχει. |
...
| [Name](../../aspose.svg.dom/documenttype/name/) { get; } | Το όνομα του DTD· δηλαδή, το όνομα που ακολουθεί αμέσως τη λέξη-κλειδί DOCTYPE. |
...
| override [NodeName](../../aspose.svg.dom/documenttype/nodename/) { get; } | Το όνομα αυτού του κόμβου, ανάλογα με τον τύπο του. |
| override [NodeType](../../aspose.svg.dom/documenttype/nodetype/) { get; } | Ένας κώδικας που αντιπροσωπεύει τον τύπο του υποκείμενου αντικειμένου. |
...
| [PublicId](../../aspose.svg.dom/documenttype/publicid/) { get; } | Το δημόσιο αναγνωριστικό του εξωτερικού υποσυνόλου. |
| [SystemId](../../aspose.svg.dom/documenttype/systemid/) { get; } | Το αναγνωριστικό συστήματος του εξωτερικού υποσυνόλου. Αυτό μπορεί να είναι απόλυτο URI ή όχι. |
...
| override [ToString](../../aspose.svg.dom/documenttype/tostring/)() | Επιστρέφει ένα String που αντιπροσωπεύει αυτήν την παρουσία. |
