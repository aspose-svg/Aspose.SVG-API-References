...
description: Aspose.Svg.Dom.EntityReference τάξη. Οι κόμβοι EntityReference μπορούν να χρησιμοποιηθούν για την αναπαράσταση μιας αναφοράς οντότητας στο δέντρο.
type: docs
weight: 860
...
| override [NodeType](../../aspose.svg.dom/entityreference/nodetype/) { get; } | Ένας κωδικός που αντιπροσωπεύει τον τύπο του υποκείμενου αντικειμένου. |
