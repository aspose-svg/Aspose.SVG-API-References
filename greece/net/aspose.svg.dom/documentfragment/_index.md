...
description: Aspose.Svg.Dom.DocumentFragment τάξη. Το DocumentFragment είναι ένα ελαφρύ ή ελάχιστο αντικείμενο Document. Είναι πολύ συνηθισμένο να θέλετε να μπορείτε να εξαγάγετε ένα τμήμα του δέντρου ενός εγγράφου ή να δημιουργήσετε ένα νέο τμήμα ενός εγγράφου.
type: docs
weight: 820
url: /el/net/aspose.svg.dom/documentfragment/
---
