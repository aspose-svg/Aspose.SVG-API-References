...
description: Aspose.Svg.Dom.CharacterData τάξη. Το CharacterData επεκτείνει τον κόμβο με ένα σύνολο χαρακτηριστικών και μεθόδων για την πρόσβαση σε δεδομένα χαρακτήρων στο DOM.
type: docs
weight: 450
url: /el/net/aspose.svg.dom/characterdata/
---
## CharacterData class
