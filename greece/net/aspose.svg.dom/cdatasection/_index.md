...
description: Aspose.Svg.Dom.CDATASection τάξη. Οι ενότητες CDATA χρησιμοποιούνται για τη διαφυγή μπλοκ κειμένου που περιέχει χαρακτήρες που διαφορετικά θα θεωρούνταν ως σήμανση.
type: docs
weight: 440
...
| override [NodeType](../../aspose.svg.dom/cdatasection/nodetype/) { get; } | Ένας κωδικός που αντιπροσωπεύει τον τύπο του υποκείμενου αντικειμένου. |
