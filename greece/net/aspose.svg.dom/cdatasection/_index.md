...
description: "Aspose.Svg.Dom.CDATASection κλάση. Οι ενότητες CDATA χρησιμοποιούνται για την απόδραση τμημάτων κειμένου που περιέχουν χαρακτήρες που διαφορετικά θα θεωρούνταν σήμανση"
type: docs
weight: 2440
url: /el/net/aspose.svg.dom/cdatasection/
---
## CDATASection class

Τα τμήματα CDATA χρησιμοποιούνται για την απόδραση τμημάτων κειμένου που περιέχουν χαρακτήρες που διαφορετικά θα θεωρούνταν ως σήμανση.
...
| override [NodeName](../../aspose.svg.dom/cdatasection/nodename/) { get; } | Το όνομα αυτού του κόμβου, ανάλογα με τον τύπο του. |
| override [NodeType](../../aspose.svg.dom/cdatasection/nodetype/) { get; } | Ένας κώδικας που αντιπροσωπεύει τον τύπο του υποκείμενου αντικειμένου. |
