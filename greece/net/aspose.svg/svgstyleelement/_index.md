...
description: "Κλάση Aspose.Svg.SVGStyleElement. Η διεπαφή SVGStyleElement αντιστοιχεί στο στοιχείο style"
type: docs
weight: 5550
url: /el/net/aspose.svg/svgstyleelement/
---
...
| [Media](../../aspose.svg/svgstyleelement/media/) { get; set; } | Αντιστοιχεί στο χαρακτηριστικό ‘media’ του δεδομένου στοιχείου. |
...
| [Sheet](../../aspose.svg/svgstyleelement/sheet/) { get; } | Λαμβάνει το σχετικό φύλλο στυλ. |
...
| [Title](../../aspose.svg/svgstyleelement/title/) { get; set; } | Αντιστοιχεί στο χαρακτηριστικό ‘title’ του δεδομένου στοιχείου. |
| [Type](../../aspose.svg/svgstyleelement/type/) { get; set; } | Αντιστοιχεί στο χαρακτηριστικό ‘type’ του δεδομένου στοιχείου. |
