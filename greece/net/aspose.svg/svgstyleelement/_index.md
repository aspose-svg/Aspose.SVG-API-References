...
description: Aspose.Svg.SVGStyleElement τάξη. Η διεπαφή SVGStyleElement αντιστοιχεί στο στοιχείο style.
type: docs
weight: 3480
...
| [Media](../../aspose.svg/svgstyleelement/media/) { get; set; } | Αντιστοιχεί στο χαρακτηριστικό "μέσα" στο δεδομένο στοιχείο. |
...
| [Title](../../aspose.svg/svgstyleelement/title/) { get; set; } | Αντιστοιχεί στο χαρακτηριστικό 'title' στο δεδομένο στοιχείο. |
| [Type](../../aspose.svg/svgstyleelement/type/) { get; set; } | Αντιστοιχεί στο χαρακτηριστικό 'type' στο δεδομένο στοιχείο. |
