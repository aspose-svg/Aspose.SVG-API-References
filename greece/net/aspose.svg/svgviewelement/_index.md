...
description: Aspose.Svg.SVGViewElement τάξη. Η διεπαφή SVGViewElement αντιστοιχεί στο στοιχείο view.
type: docs
weight: 3590
url: /el/net/aspose.svg/svgviewelement/
---
...
| [PreserveAspectRatio](../../aspose.svg/svgviewelement/preserveaspectratio/) { get; } | Αντιστοιχεί στο χαρακτηριστικό "preserveAspectRatio" στο δεδομένο στοιχείο. |
...
| [ViewBox](../../aspose.svg/svgviewelement/viewbox/) { get; } | Αντιστοιχεί στο χαρακτηριστικό "viewBox" στο δεδομένο στοιχείο. |
...
| [ViewTarget](../../aspose.svg/svgviewelement/viewtarget/) { get; } | Αντιστοιχεί στο χαρακτηριστικό "viewTarget" στο δεδομένο στοιχείο "view". Μια λίστα με τιμές DOMString που περιέχουν τα ονόματα που αναφέρονται στο χαρακτηριστικό "viewTarget". Κάθε μία από τις τιμές DOMString μπορεί να συσχετιστεί με το αντίστοιχο στοιχείο χρησιμοποιώντας την κλήση της μεθόδου getElementById(). |
| [ZoomAndPan](../../aspose.svg/svgviewelement/zoomandpan/) { get; set; } | Αντιστοιχεί στο χαρακτηριστικό 'zoomAndPan' στο δεδομένο στοιχείο. Η τιμή πρέπει να είναι μία από τις σταθερές SVG_ZOOMANDPAN_* που ορίζονται σε αυτήν τη διεπαφή. |
