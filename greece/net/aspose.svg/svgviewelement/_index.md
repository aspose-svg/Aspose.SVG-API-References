...
description: "Aspose.Svg.SVGViewElement κλάση. Η διεπαφή SVGViewElement αντιστοιχεί στο στοιχείο view."
type: docs
weight: 5660
...
| [PreserveAspectRatio](../../aspose.svg/svgviewelement/preserveaspectratio/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘preserveAspectRatio’ του δεδομένου στοιχείου. |
...
| [ViewBox](../../aspose.svg/svgviewelement/viewbox/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘viewBox’ του δεδομένου στοιχείου. |
...
| [ViewTarget](../../aspose.svg/svgviewelement/viewtarget/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘viewTarget’ του δεδομένου στοιχείου ‘view’. Μια λίστα τιμών DOMString που περιέχουν τα ονόματα που αναφέρονται στο χαρακτηριστικό ‘viewTarget’. Κάθε τιμή DOMString μπορεί να συσχετιστεί με το αντίστοιχο στοιχείο χρησιμοποιώντας την κλήση μεθόδου getElementById(). |
| [ZoomAndPan](../../aspose.svg/svgviewelement/zoomandpan/) { get; set; } | Αντιστοιχεί στο χαρακτηριστικό ‘zoomAndPan’ του δεδομένου στοιχείου. Η τιμή πρέπει να είναι μία από τις σταθερές SVG_ZOOMANDPAN_* που ορίζονται σε αυτή τη διεπαφή. |
