...
description: Aspose.Svg.SVGSetElement τάξη. Η διεπαφή SVGSetElement αντιστοιχεί στο στοιχείο set. Η αντικειμενοστραφή πρόσβαση στα χαρακτηριστικά του στοιχείου set μέσω του SVG DOM δεν είναι διαθέσιμη.
type: docs
weight: 3460
