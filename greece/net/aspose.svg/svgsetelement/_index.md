...
description: "Κλάση Aspose.Svg.SVGSetElement. Η διεπαφή SVGSetElement αντιστοιχεί στο στοιχείο set. Η αντικειμενοστραφής πρόσβαση στα χαρακτηριστικά του στοιχείου set μέσω του SVG DOM δεν είναι διαθέσιμη."
type: docs
weight: 5530
url: /el/net/aspose.svg/svgsetelement/
---
## SVGSetElement class

Η διεπαφή SVGSetElement αντιστοιχεί στο στοιχείο ‘set’. Η αντικειμενοστραφής πρόσβαση στα χαρακτηριστικά του στοιχείου ‘set’ μέσω του SVG DOM δεν είναι διαθέσιμη.
...
| [RequiredExtensions](../../aspose.svg/svganimationelement/requiredextensions/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘requiredExtensions’ του δεδομένου στοιχείου. |
| [RequiredFeatures](../../aspose.svg/svganimationelement/requiredfeatures/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘requiredFeatures’ του δεδομένου στοιχείου. |
...
| [SystemLanguage](../../aspose.svg/svganimationelement/systemlanguage/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘systemLanguage’ του δεδομένου στοιχείου. |
| [TagName](../../aspose.svg.dom/element/tagname/) { get; } | Το όνομα του στοιχείου. |
| [TargetElement](../../aspose.svg/svganimationelement/targetelement/) { get; } | Το στοιχείο που ανιματίζεται. |
