---
title: "Κλάση SVGFilterElement"
second_title: "Aspose.SVG για .NET API Αναφορά"
description: "Κλάση Aspose.Svg.SVGFilterElement. Η διεπαφή SVGFilterElement αντιστοιχεί στο στοιχείο filter"
type: docs
weight: 5310
url: /el/net/aspose.svg/svgfilterelement/
---
...
| [FilterUnits](../../aspose.svg/svgfilterelement/filterunits/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘filterUnits’ του δεδομένου στοιχείου ‘filter’. Παίρνει μία από τις σταθερές που ορίζονται στο SVGUnitTypes. |
...
| [Height](../../aspose.svg/svgfilterelement/height/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘height’ του δεδομένου στοιχείου ‘filter’. |
| [Href](../../aspose.svg/svgfilterelement/href/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘xlink:href’ του δεδομένου στοιχείου. |
...
| [PrimitiveUnits](../../aspose.svg/svgfilterelement/primitiveunits/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘primitiveUnits’ του δεδομένου στοιχείου ‘filter’. Παίρνει μία από τις σταθερές που ορίζονται στο SVGUnitTypes. |
...
| [Width](../../aspose.svg/svgfilterelement/width/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘width’ του δεδομένου στοιχείου ‘filter’. |
| [X](../../aspose.svg/svgfilterelement/x/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘x’ του δεδομένου στοιχείου ‘filter’. |
| [Y](../../aspose.svg/svgfilterelement/y/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘y’ του δεδομένου στοιχείου ‘filter’. |
