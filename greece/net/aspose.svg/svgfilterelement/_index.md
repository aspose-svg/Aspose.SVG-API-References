...
description: Aspose.Svg.SVGFilterElement τάξη. Η διεπαφή SVGFilterElement αντιστοιχεί στο στοιχείο φίλτρο.
type: docs
weight: 3240
...
| [FilterUnits](../../aspose.svg/svgfilterelement/filterunits/) { get; } | Αντιστοιχεί στο χαρακτηριστικό 'filterUnits' στο δεδομένο στοιχείο 'filter'. Λαμβάνει μία από τις σταθερές που ορίζονται στο SVGUnitTypes. |
...
| [Height](../../aspose.svg/svgfilterelement/height/) { get; } | Αντιστοιχεί στο χαρακτηριστικό "ύψος" στο δεδομένο στοιχείο "φίλτρο". |
| [Href](../../aspose.svg/svgfilterelement/href/) { get; } | Αντιστοιχεί στο χαρακτηριστικό 'xlink:href' στο δεδομένο στοιχείο. |
...
| [PrimitiveUnits](../../aspose.svg/svgfilterelement/primitiveunits/) { get; } | Αντιστοιχεί στο χαρακτηριστικό 'primitiveUnits' στο δεδομένο στοιχείο 'φίλτρο'. Λαμβάνει μία από τις σταθερές που ορίζονται στο SVGUnitTypes. |
...
| [Width](../../aspose.svg/svgfilterelement/width/) { get; } | Αντιστοιχεί στο χαρακτηριστικό 'width' στο δεδομένο στοιχείο 'filter'. |
| [X](../../aspose.svg/svgfilterelement/x/) { get; } | Αντιστοιχεί στο χαρακτηριστικό "x" στο δεδομένο στοιχείο "φίλτρο". |
| [Y](../../aspose.svg/svgfilterelement/y/) { get; } | Αντιστοιχεί στο χαρακτηριστικό 'y' στο δεδομένο στοιχείο 'φίλτρο'. |
