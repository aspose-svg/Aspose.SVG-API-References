...
description: "Aspose.Svg.SVGCursorElement class. Η διεπαφή SVGCursorElement αντιστοιχεί στο στοιχείο cursor"
type: docs
weight: 5230
url: /el/net/aspose.svg/svgcursorelement/
---
...
| [Href](../../aspose.svg/svgcursorelement/href/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘xlink:href’ του δεδομένου στοιχείου. |
...
| [RequiredExtensions](../../aspose.svg/svgcursorelement/requiredextensions/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘requiredExtensions’ του δεδομένου στοιχείου. |
| [RequiredFeatures](../../aspose.svg/svgcursorelement/requiredfeatures/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘requiredFeatures’ του δεδομένου στοιχείου. |
...
| [SystemLanguage](../../aspose.svg/svgcursorelement/systemlanguage/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘systemLanguage’ του δεδομένου στοιχείου. |
...
| [X](../../aspose.svg/svgcursorelement/x/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘x’ του δεδομένου στοιχείου ‘cursor’. |
| [Y](../../aspose.svg/svgcursorelement/y/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘y’ του δεδομένου στοιχείου ‘cursor’. |
