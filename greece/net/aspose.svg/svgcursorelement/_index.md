...
description: Aspose.Svg.SVGCursorElement τάξη. Η διεπαφή SVGCursorElement αντιστοιχεί στο στοιχείο δρομέας.
type: docs
weight: 3160
...
| [Href](../../aspose.svg/svgcursorelement/href/) { get; } | Αντιστοιχεί στο χαρακτηριστικό 'xlink:href' στο δεδομένο στοιχείο. |
...
| [RequiredExtensions](../../aspose.svg/svgcursorelement/requiredextensions/) { get; } | Αντιστοιχεί στο χαρακτηριστικό 'requiredExtensions' στο δεδομένο στοιχείο. |
| [RequiredFeatures](../../aspose.svg/svgcursorelement/requiredfeatures/) { get; } | Αντιστοιχεί στο χαρακτηριστικό 'requiredFeatures' στο δεδομένο στοιχείο. |
...
| [SystemLanguage](../../aspose.svg/svgcursorelement/systemlanguage/) { get; } | Αντιστοιχεί στο χαρακτηριστικό 'systemLanguage' στο δεδομένο στοιχείο. |
...
| [X](../../aspose.svg/svgcursorelement/x/) { get; } | Αντιστοιχεί στο χαρακτηριστικό "x" στο δεδομένο στοιχείο "δρομέας". |
| [Y](../../aspose.svg/svgcursorelement/y/) { get; } | Αντιστοιχεί στο χαρακτηριστικό "y" στο δεδομένο στοιχείο "δρομέας". |
