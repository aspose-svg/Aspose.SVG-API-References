...
description: "Κλάση Aspose.Svg.SVGRadialGradientElement. Η διεπαφή SVGRadialGradientElement αντιστοιχεί στο στοιχείο radialGradient"
type: docs
weight: 5480
url: /el/net/aspose.svg/svgradialgradientelement/
---
...
| [Cx](../../aspose.svg/svgradialgradientelement/cx/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘cx’ του δεδομένου στοιχείου ‘radialGradient’. |
| [Cy](../../aspose.svg/svgradialgradientelement/cy/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘cy’ του δεδομένου στοιχείου ‘radialGradient’. |
...
| [Fr](../../aspose.svg/svgradialgradientelement/fr/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘fr’ του δεδομένου στοιχείου ‘radialGradient’. |
| [Fx](../../aspose.svg/svgradialgradientelement/fx/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘fx’ του δεδομένου στοιχείου ‘radialGradient’. |
| [Fy](../../aspose.svg/svgradialgradientelement/fy/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘fy’ του δεδομένου στοιχείου ‘radialGradient’. |
| [GradientTransform](../../aspose.svg/svggradientelement/gradienttransform/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘gradientTransform’ του δεδομένου στοιχείου. |
| [GradientUnits](../../aspose.svg/svggradientelement/gradientunits/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘gradientUnits’ του δεδομένου στοιχείου. Παίρνει μία από τις σταθερές που ορίζονται στο SVGUnitTypes. |
| [Href](../../aspose.svg/svggradientelement/href/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘xlink:href’ του δεδομένου στοιχείου. |
...
| [R](../../aspose.svg/svgradialgradientelement/r/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘r’ του δεδομένου στοιχείου ‘radialGradient’. |
...
| [SpreadMethod](../../aspose.svg/svggradientelement/spreadmethod/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘spreadMethod’ του δεδομένου στοιχείου. Ένας από τους τύπους Spread Method που ορίζονται σε αυτή τη διεπαφή. |
