...
description: Aspose.Svg.SVGRadialGradientElement τάξη. Η διεπαφή SVGRadialGradientElement αντιστοιχεί στο στοιχείο radialGradient.
type: docs
weight: 3410
...
| [Cx](../../aspose.svg/svgradialgradientelement/cx/) { get; } | Αντιστοιχεί στο χαρακτηριστικό 'cx' στο δεδομένο στοιχείο 'radialGradient'. |
| [Cy](../../aspose.svg/svgradialgradientelement/cy/) { get; } | Αντιστοιχεί στο χαρακτηριστικό 'cy' στο δεδομένο στοιχείο 'radialGradient'. |
...
| [Fr](../../aspose.svg/svgradialgradientelement/fr/) { get; } | Αντιστοιχεί στο χαρακτηριστικό 'fr' στο δεδομένο στοιχείο 'radialGradient'. |
| [Fx](../../aspose.svg/svgradialgradientelement/fx/) { get; } | Αντιστοιχεί στο χαρακτηριστικό 'fx' στο δεδομένο στοιχείο 'radialGradient'. |
| [Fy](../../aspose.svg/svgradialgradientelement/fy/) { get; } | Αντιστοιχεί στο χαρακτηριστικό "fy" στο δεδομένο στοιχείο "radialGradient". |
| [GradientTransform](../../aspose.svg/svggradientelement/gradienttransform/) { get; } | Αντιστοιχεί στο χαρακτηριστικό 'gradientTransform' στο δεδομένο στοιχείο. |
| [GradientUnits](../../aspose.svg/svggradientelement/gradientunits/) { get; } | Αντιστοιχεί στο χαρακτηριστικό 'gradientUnits' στο δεδομένο στοιχείο. Λαμβάνει μία από τις σταθερές που ορίζονται στο SVGUnitTypes. |
| [Href](../../aspose.svg/svggradientelement/href/) { get; } | Αντιστοιχεί στο χαρακτηριστικό 'xlink:href' στο δεδομένο στοιχείο. |
...
| [R](../../aspose.svg/svgradialgradientelement/r/) { get; } | Αντιστοιχεί στο χαρακτηριστικό 'r' στο δεδομένο στοιχείο 'radialGradient'. |
...
| [SpreadMethod](../../aspose.svg/svggradientelement/spreadmethod/) { get; } | Αντιστοιχεί στο χαρακτηριστικό 'spreadMethod' στο δεδομένο στοιχείο. Ένας από τους τύπους μεθόδου διάδοσης που ορίζεται σε αυτήν τη διεπαφή. |
