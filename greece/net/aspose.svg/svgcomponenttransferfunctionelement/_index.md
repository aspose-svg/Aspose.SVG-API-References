...
description: Aspose.Svg.SVGComponentTransferFunctionElement τάξη. Αυτή η διεπαφή ορίζει μια βασική διεπαφή που χρησιμοποιείται από τις διεπαφές συναρτήσεων μεταφοράς στοιχείων.
type: docs
weight: 3150
...
| Ονομα | Περιγραφή |
| --- | --- |
| [Amplitude](../../aspose.svg/svgcomponenttransferfunctionelement/amplitude/) { get; } | Αντιστοιχεί στο χαρακτηριστικό 'πλάτος' στο δεδομένο στοιχείο. |
...
| [Exponent](../../aspose.svg/svgcomponenttransferfunctionelement/exponent/) { get; } | Αντιστοιχεί στο χαρακτηριστικό 'εκθέτης' στο δεδομένο στοιχείο. |
...
| [Type](../../aspose.svg/svgcomponenttransferfunctionelement/type/) { get; } | Αντιστοιχεί στο χαρακτηριστικό 'type' στο δεδομένο στοιχείο. Λαμβάνει μία από τις σταθερές SVG_FECOMPONENTTRANSFER_TYPE_* που ορίζονται σε αυτήν τη διεπαφή. |
...
| const [SVG_FECOMPONENTTRANSFER_TYPE_GAMMA](../../aspose.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_gamma/) | Αντιστοιχεί στην τιμή "γάμα". |
| const [SVG_FECOMPONENTTRANSFER_TYPE_IDENTITY](../../aspose.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_identity/) | Αντιστοιχεί στην τιμή "ταυτότητα". |
| const [SVG_FECOMPONENTTRANSFER_TYPE_LINEAR](../../aspose.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_linear/) | Αντιστοιχεί στην τιμή 'γραμμική'. |
| const [SVG_FECOMPONENTTRANSFER_TYPE_TABLE](../../aspose.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_table/) | Αντιστοιχεί στην τιμή "πίνακας". |
