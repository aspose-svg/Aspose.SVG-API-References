...
description: "Aspose.Svg.SVGComponentTransferFunctionElement κλάση. Αυτή η διεπαφή ορίζει μια βασική διεπαφή που χρησιμοποιείται από τις διεπαφές λειτουργίας μεταφοράς."
type: docs
weight: 5220
url: /el/net/aspose.svg/svgcomponenttransferfunctionelement/
---
## SVGComponentTransferFunctionElement class

Αυτή η διεπαφή ορίζει μια βασική διεπαφή που χρησιμοποιείται από τις διεπαφές λειτουργίας μεταφοράς του στοιχείου.
...
| Όνομα | Περιγραφή |
| --- | --- |
| [Amplitude](../../aspose.svg/svgcomponenttransferfunctionelement/amplitude/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘amplitude’ στο δεδομένο στοιχείο. |
...
| [Exponent](../../aspose.svg/svgcomponenttransferfunctionelement/exponent/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘exponent’ στο δεδομένο στοιχείο. |
...
| [Intercept](../../aspose.svg/svgcomponenttransferfunctionelement/intercept/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘intercept’ στο δεδομένο στοιχείο. |
...
| [Offset](../../aspose.svg/svgcomponenttransferfunctionelement/offset/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘offset’ στο δεδομένο στοιχείο. |
...
| [Slope](../../aspose.svg/svgcomponenttransferfunctionelement/slope/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘slope’ στο δεδομένο στοιχείο. |
...
| [TableValues](../../aspose.svg/svgcomponenttransferfunctionelement/tablevalues/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘tableValues’ στο δεδομένο στοιχείο. |
...
| [Type](../../aspose.svg/svgcomponenttransferfunctionelement/type/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘type’ στο δεδομένο στοιχείο. Παίρνει μία από τις σταθερές SVG_FECOMPONENTTRANSFER_TYPE_* που ορίζονται σε αυτή τη διεπαφή. |
...
| Όνομα | Περιγραφή |
| --- | --- |
| const [SVG_FECOMPONENTTRANSFER_TYPE_DISCRETE](../../aspose.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_discrete/) | Αντιστοιχεί στην τιμή 'discrete'. |
| const [SVG_FECOMPONENTTRANSFER_TYPE_GAMMA](../../aspose.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_gamma/) | Αντιστοιχεί στην τιμή 'gamma'. |
| const [SVG_FECOMPONENTTRANSFER_TYPE_IDENTITY](../../aspose.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_identity/) | Αντιστοιχεί στην τιμή 'identity'. |
| const [SVG_FECOMPONENTTRANSFER_TYPE_LINEAR](../../aspose.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_linear/) | Αντιστοιχεί στην τιμή 'linear'. |
| const [SVG_FECOMPONENTTRANSFER_TYPE_TABLE](../../aspose.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_table/) | Αντιστοιχεί στην τιμή 'table'. |
