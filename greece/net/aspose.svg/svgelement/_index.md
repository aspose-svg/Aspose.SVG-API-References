...
description: "Aspose.Svg.SVGElement κλάση. Όλες οι διεπαφές SVG DOM που αντιστοιχούν άμεσα σε στοιχεία της γλώσσας SVG, όπως η διεπαφή SVGPathElement για το στοιχείο path, κληρονομούν από τη διεπαφή SVGElement."
type: docs
weight: 5270
