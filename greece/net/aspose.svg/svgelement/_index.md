...
description: Aspose.Svg.SVGElement τάξη. Όλες οι διεπαφές SVG DOM που αντιστοιχούν απευθείας σε στοιχεία στη γλώσσα SVG όπως η διεπαφή SVGPathElement για το στοιχείο διαδρομή προέρχονται από τη διεπαφή SVGElement.
type: docs
weight: 3200
url: /el/net/aspose.svg/svgelement/
---
## SVGElement class
