...
description: "Aspose.Svg.SVGUseElement κλάση. Η SVGUseElement διασύνδεση αντιστοιχεί στο στοιχείο use"
type: docs
weight: 5650
url: /el/net/aspose.svg/svguseelement/
---
## SVGUseElement class
...
| [Height](../../aspose.svg/svguseelement/height/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘height’ του δεδομένου στοιχείου ‘use’ |
| [Href](../../aspose.svg/svguseelement/href/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘xlink:href’ του δεδομένου στοιχείου. |
...
| [Width](../../aspose.svg/svguseelement/width/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘width’ του δεδομένου στοιχείου ‘use’ |
| [X](../../aspose.svg/svguseelement/x/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘x’ του δεδομένου στοιχείου ‘use’ |
| [Y](../../aspose.svg/svguseelement/y/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘y’ του δεδομένου στοιχείου ‘use’ |
