...
description: Aspose.Svg.SVGUseElement τάξη. Η διεπαφή SVGUseElement αντιστοιχεί στο στοιχείο use.
type: docs
weight: 3580
...
| [Height](../../aspose.svg/svguseelement/height/) { get; } | Αντιστοιχεί στο χαρακτηριστικό 'height' στο δεδομένο στοιχείο 'use'. |
| [Href](../../aspose.svg/svguseelement/href/) { get; } | Αντιστοιχεί στο χαρακτηριστικό 'xlink:href' στο δεδομένο στοιχείο. |
...
| [Width](../../aspose.svg/svguseelement/width/) { get; } | Αντιστοιχεί στο χαρακτηριστικό 'width' στο δεδομένο στοιχείο 'use'. |
| [X](../../aspose.svg/svguseelement/x/) { get; } | Αντιστοιχεί στο χαρακτηριστικό 'x' στο δεδομένο στοιχείο 'use'. |
| [Y](../../aspose.svg/svguseelement/y/) { get; } | Αντιστοιχεί στο χαρακτηριστικό 'y' στο δεδομένο στοιχείο 'use'. |
