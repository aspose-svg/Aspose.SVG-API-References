...
description: "Κλάση Aspose.Svg.SVGMarkerElement. Η διεπαφή SVGMarkerElement αντιστοιχεί στο στοιχείο marker."
type: docs
weight: 5410
url: /el/net/aspose.svg/svgmarkerelement/
---
...
| [MarkerHeight](../../aspose.svg/svgmarkerelement/markerheight/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘markerHeight’ του δεδομένου στοιχείου ‘marker’. |
| [MarkerUnits](../../aspose.svg/svgmarkerelement/markerunits/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘markerUnits’ του δεδομένου στοιχείου ‘marker’. Ένας από τους Marker Unit Types που ορίζονται σε αυτή τη διεπαφή. |
| [MarkerWidth](../../aspose.svg/svgmarkerelement/markerwidth/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘markerWidth’ του δεδομένου στοιχείου ‘marker’. |
...
| [OrientAngle](../../aspose.svg/svgmarkerelement/orientangle/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘orient’ του δεδομένου στοιχείου ‘marker’. Εάν το markerUnits είναι SVG_MARKER_ORIENT_ANGLE, η τιμή γωνίας για το χαρακτηριστικό ‘orient’; διαφορετικά, θα οριστεί στο μηδέν. |
| [OrientType](../../aspose.svg/svgmarkerelement/orienttype/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘orient’ του δεδομένου στοιχείου ‘marker’. Ένας από τους Marker Orientation Types που ορίζονται σε αυτή τη διεπαφή. |
...
| [PreserveAspectRatio](../../aspose.svg/svgmarkerelement/preserveaspectratio/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘preserveAspectRatio’ του δεδομένου στοιχείου. |
...
| [RefX](../../aspose.svg/svgmarkerelement/refx/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘refX’ του δεδομένου στοιχείου ‘marker’. |
| [RefY](../../aspose.svg/svgmarkerelement/refy/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘refY’ του δεδομένου στοιχείου ‘marker’. |
...
| [ViewBox](../../aspose.svg/svgmarkerelement/viewbox/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘viewBox’ του δεδομένου στοιχείου. |
...
| [SetOrientToAngle](../../aspose.svg/svgmarkerelement/setorienttoangle/)(*[SVGAngle](../../aspose.svg.datatypes/svgangle/)*) | Ορίζει την τιμή του χαρακτηριστικού ‘orient’ στην δεδομένη γωνία. |
| [SetOrientToAuto](../../aspose.svg/svgmarkerelement/setorienttoauto/)() | Ορίζει την τιμή του χαρακτηριστικού ‘orient’ σε 'auto'. |
...
| Όνομα | Περιγραφή |
| --- | --- |
| const [SVG_MARKERUNITS_STROKEWIDTH](../../aspose.svg/svgmarkerelement/svg_markerunits_strokewidth/) | Η τιμή του χαρακτηριστικού ‘markerUnits’ είναι 'strokeWidth'. |
| const [SVG_MARKERUNITS_UNKNOWN](../../aspose.svg/svgmarkerelement/svg_markerunits_unknown/) | Ο τύπος μονάδας δείκτη δεν είναι ένας από τους προκαθορισμένους τύπους. Είναι μη έγκυρο να προσπαθήσετε να ορίσετε μια νέα τιμή αυτού του τύπου ή να προσπαθήσετε να αλλάξετε μια υπάρχουσα τιμή σε αυτόν τον τύπο. |
| const [SVG_MARKERUNITS_USERSPACEONUSE](../../aspose.svg/svgmarkerelement/svg_markerunits_userspaceonuse/) | Η τιμή του χαρακτηριστικού ‘markerUnits’ είναι 'userSpaceOnUse'. |
| const [SVG_MARKER_ORIENT_ANGLE](../../aspose.svg/svgmarkerelement/svg_marker_orient_angle/) | Το χαρακτηριστικό ‘orient’ έχει τιμή γωνίας. |
| const [SVG_MARKER_ORIENT_AUTO](../../aspose.svg/svgmarkerelement/svg_marker_orient_auto/) | Το χαρακτηριστικό ‘orient’ έχει τιμή 'auto'. |
| const [SVG_MARKER_ORIENT_UNKNOWN](../../aspose.svg/svgmarkerelement/svg_marker_orient_unknown/) | Ο προσανατολισμός του δείκτη δεν είναι ένας από τους προκαθορισμένους τύπους. Είναι μη έγκυρο να προσπαθήσετε να ορίσετε μια νέα τιμή αυτού του τύπου ή να προσπαθήσετε να αλλάξετε μια υπάρχουσα τιμή σε αυτόν τον τύπο. |
