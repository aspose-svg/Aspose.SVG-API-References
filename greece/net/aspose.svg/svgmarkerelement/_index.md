...
description: Aspose.Svg.SVGMarkerElement τάξη. Η διεπαφή SVGMarkerElement αντιστοιχεί στο στοιχείο δείκτη.
type: docs
weight: 3340
...
| [MarkerHeight](../../aspose.svg/svgmarkerelement/markerheight/) { get; } | Αντιστοιχεί στο χαρακτηριστικό 'markerHeight' στο δεδομένο στοιχείο 'marker'. |
| [MarkerUnits](../../aspose.svg/svgmarkerelement/markerunits/) { get; } | Αντιστοιχεί στο χαρακτηριστικό "markerUnits" στο δεδομένο στοιχείο "marker". Ένας από τους τύπους μονάδας δείκτη που ορίζεται σε αυτήν τη διεπαφή. |
| [MarkerWidth](../../aspose.svg/svgmarkerelement/markerwidth/) { get; } | Αντιστοιχεί στο χαρακτηριστικό "markerWidth" στο δεδομένο στοιχείο "marker". |
...
| [OrientAngle](../../aspose.svg/svgmarkerelement/orientangle/) { get; } | Αντιστοιχεί στο χαρακτηριστικό 'orient' στο δεδομένο στοιχείο 'marker'. Εάν το markerUnits είναι SVG_MARKER_ORIENT_ANGLE, η τιμή γωνίας για το χαρακτηριστικό 'orient'. διαφορετικά, θα οριστεί στο μηδέν. |
| [OrientType](../../aspose.svg/svgmarkerelement/orienttype/) { get; } | Αντιστοιχεί στο χαρακτηριστικό 'orient' στο δεδομένο στοιχείο 'marker'. Ένας από τους τύπους προσανατολισμού δείκτη που ορίζεται σε αυτήν τη διεπαφή. |
...
| [PreserveAspectRatio](../../aspose.svg/svgmarkerelement/preserveaspectratio/) { get; } | Αντιστοιχεί στο χαρακτηριστικό "preserveAspectRatio" στο δεδομένο στοιχείο. |
...
| [RefX](../../aspose.svg/svgmarkerelement/refx/) { get; } | Αντιστοιχεί στο χαρακτηριστικό "refX" στο δεδομένο στοιχείο "δείκτη". |
| [RefY](../../aspose.svg/svgmarkerelement/refy/) { get; } | Αντιστοιχεί στο χαρακτηριστικό "refY" στο δεδομένο στοιχείο "δείκτη". |
...
| [ViewBox](../../aspose.svg/svgmarkerelement/viewbox/) { get; } | Αντιστοιχεί στο χαρακτηριστικό "viewBox" στο δεδομένο στοιχείο. |
...
| [SetOrientToAngle](../../aspose.svg/svgmarkerelement/setorienttoangle/)(SVGAngle) | Ορίζει την τιμή του χαρακτηριστικού 'orient' στη δεδομένη γωνία. |
...
| const [SVG_MARKERUNITS_UNKNOWN](../../aspose.svg/svgmarkerelement/svg_markerunits_unknown/) | Ο τύπος μονάδας δείκτη δεν είναι ένας από τους προκαθορισμένους τύπους. Δεν είναι έγκυρο να επιχειρήσετε να ορίσετε μια νέα τιμή αυτού του τύπου ή να προσπαθήσετε να αλλάξετε μια υπάρχουσα τιμή σε αυτόν τον τύπο. |
...
| const [SVG_MARKER_ORIENT_UNKNOWN](../../aspose.svg/svgmarkerelement/svg_marker_orient_unknown/) | Ο προσανατολισμός του δείκτη δεν είναι ένας από τους προκαθορισμένους τύπους. Δεν είναι έγκυρο να επιχειρήσετε να ορίσετε μια νέα τιμή αυτού του τύπου ή να προσπαθήσετε να αλλάξετε μια υπάρχουσα τιμή σε αυτόν τον τύπο. |
