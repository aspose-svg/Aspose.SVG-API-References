...
description: Aspose.Svg.SVGAnimateElement τάξη. Η διεπαφή SVGAnimateElement αντιστοιχεί στο στοιχείο animate. Η αντικειμενοστραφή πρόσβαση στα χαρακτηριστικά του στοιχείου animate μέσω του SVG DOM δεν είναι διαθέσιμη.
type: docs
weight: 3090
