...
description: "Aspose.Svg.SVGAnimateElement κλάση. Η διεπαφή SVGAnimateElement αντιστοιχεί στο στοιχείο animate. Η αντικειμενοστραφής πρόσβαση στα χαρακτηριστικά του στοιχείου animate μέσω του SVG DOM δεν είναι διαθέσιμη."
type: docs
weight: 5160
url: /el/net/aspose.svg/svganimateelement/
---
