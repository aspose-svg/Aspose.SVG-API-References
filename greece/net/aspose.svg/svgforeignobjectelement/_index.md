...
description: "Κλάση Aspose.Svg.SVGForeignObjectElement. Η διεπαφή SVGForeignObjectElement αντιστοιχεί στο στοιχείο foreignObject."
type: docs
weight: 5320
url: /el/net/aspose.svg/svgforeignobjectelement/
---
...
| [Height](../../aspose.svg/svgforeignobjectelement/height/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘height’ του δεδομένου στοιχείου ‘foreignObject’. |
...
| [Width](../../aspose.svg/svgforeignobjectelement/width/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘width’ του δεδομένου στοιχείου ‘foreignObject’. |
| [X](../../aspose.svg/svgforeignobjectelement/x/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘x’ του δεδομένου στοιχείου ‘foreignObject’. |
| [Y](../../aspose.svg/svgforeignobjectelement/y/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘y’ του δεδομένου στοιχείου ‘foreignObject’. |
