...
description: "Aspose.Svg.SVGPolylineElement κλάση. Η διεπαφή SVGPolylineElement αντιστοιχεί στο στοιχείο polyline."
type: docs
weight: 5470
url: /el/net/aspose.svg/svgpolylineelement/
---
...
| Όνομα | Περιγραφή |
| --- | --- |
| [AnimatedPoints](../../aspose.svg/svgpolylineelement/animatedpoints/) { get; } | Παρέχει πρόσβαση στα τρέχοντα κινούμενα περιεχόμενα του χαρακτηριστικού ‘points’. Εάν το δεδομένο χαρακτηριστικό ή ιδιότητα είναι σε κίνηση, περιέχει την τρέχουσα κινούμενη τιμή του χαρακτηριστικού ή της ιδιότητας. Εάν το δεδομένο χαρακτηριστικό ή ιδιότητα δεν είναι αυτή τη στιγμή σε κίνηση, περιέχει την ίδια τιμή με το points. |
...
| [Points](../../aspose.svg/svgpolylineelement/points/) { get; } | Παρέχει πρόσβαση στα βασικά (δηλαδή στατικά) περιεχόμενα του χαρακτηριστικού ‘points’. |
