...
description: Aspose.Svg.SVGLinearGradientElement τάξη. Η διεπαφή SVGLinearGradientElement αντιστοιχεί στο στοιχείο linearGradient.
type: docs
weight: 3320
...
| [X1](../../aspose.svg/svglineargradientelement/x1/) { get; } | Αντιστοιχεί στο χαρακτηριστικό 'x1' στο δεδομένο στοιχείο 'linearGradient'. |
| [X2](../../aspose.svg/svglineargradientelement/x2/) { get; } | Αντιστοιχεί στο χαρακτηριστικό 'x2' στο δεδομένο στοιχείο 'linearGradient'. |
| [Y1](../../aspose.svg/svglineargradientelement/y1/) { get; } | Αντιστοιχεί στο χαρακτηριστικό 'y1' στο δεδομένο στοιχείο 'linearGradient'. |
| [Y2](../../aspose.svg/svglineargradientelement/y2/) { get; } | Αντιστοιχεί στο χαρακτηριστικό 'y2' στο δεδομένο στοιχείο 'linearGradient'. |
