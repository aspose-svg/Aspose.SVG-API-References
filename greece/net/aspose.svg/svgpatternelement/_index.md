...
description: Aspose.Svg.SVGPatternElement τάξη. Η διεπαφή SVGPatternElement αντιστοιχεί στο στοιχείο μοτίβο.
type: docs
weight: 3380
...
| [Height](../../aspose.svg/svgpatternelement/height/) { get; } | Αντιστοιχεί στο χαρακτηριστικό 'height' στο δεδομένο στοιχείο 'pattern'. |
| [Href](../../aspose.svg/svgpatternelement/href/) { get; } | Αντιστοιχεί στο χαρακτηριστικό 'xlink:href' στο δεδομένο στοιχείο. |
...
| [PatternContentUnits](../../aspose.svg/svgpatternelement/patterncontentunits/) { get; } | Αντιστοιχεί στο χαρακτηριστικό "patternContentUnits" στο δεδομένο στοιχείο "pattern". Λαμβάνει μία από τις σταθερές που ορίζονται στο SVGUnitTypes. |
| [PatternTransform](../../aspose.svg/svgpatternelement/patterntransform/) { get; } | Αντιστοιχεί στο χαρακτηριστικό "patternTransform" στο δεδομένο στοιχείο "pattern". |
| [PatternUnits](../../aspose.svg/svgpatternelement/patternunits/) { get; } | Αντιστοιχεί στο χαρακτηριστικό "patternUnits" στο δεδομένο στοιχείο "pattern". Λαμβάνει μία από τις σταθερές που ορίζονται στο SVGUnitTypes. |
...
| [PreserveAspectRatio](../../aspose.svg/svgpatternelement/preserveaspectratio/) { get; } | Αντιστοιχεί στο χαρακτηριστικό "preserveAspectRatio" στο δεδομένο στοιχείο. |
...
| [RequiredExtensions](../../aspose.svg/svgpatternelement/requiredextensions/) { get; } | Αντιστοιχεί στο χαρακτηριστικό 'requiredExtensions' στο δεδομένο στοιχείο. |
| [RequiredFeatures](../../aspose.svg/svgpatternelement/requiredfeatures/) { get; } | Αντιστοιχεί στο χαρακτηριστικό 'requiredFeatures' στο δεδομένο στοιχείο. |
...
| [SystemLanguage](../../aspose.svg/svgpatternelement/systemlanguage/) { get; } | Αντιστοιχεί στο χαρακτηριστικό 'systemLanguage' στο δεδομένο στοιχείο. |
...
| [ViewBox](../../aspose.svg/svgpatternelement/viewbox/) { get; } | Αντιστοιχεί στο χαρακτηριστικό "viewBox" στο δεδομένο στοιχείο. |
...
| [Width](../../aspose.svg/svgpatternelement/width/) { get; } | Αντιστοιχεί στο χαρακτηριστικό 'width' στο δεδομένο στοιχείο 'pattern'. |
| [X](../../aspose.svg/svgpatternelement/x/) { get; } | Αντιστοιχεί στο χαρακτηριστικό "x" στο δεδομένο στοιχείο "μοτίβο". |
| [Y](../../aspose.svg/svgpatternelement/y/) { get; } | Αντιστοιχεί στο χαρακτηριστικό "y" στο δεδομένο στοιχείο "μοτίβο". |
