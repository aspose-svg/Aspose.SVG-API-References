...
description: "Aspose.Svg.SVGPatternElement class. Η διεπαφή SVGPatternElement αντιστοιχεί στο στοιχείο pattern."
type: docs
weight: 5450
url: /el/net/aspose.svg/svgpatternelement/
---
...
| [Height](../../aspose.svg/svgpatternelement/height/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘height’ του συγκεκριμένου στοιχείου ‘pattern’. |
| [Href](../../aspose.svg/svgpatternelement/href/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘xlink:href’ του δεδομένου στοιχείου. |
...
| [PatternContentUnits](../../aspose.svg/svgpatternelement/patterncontentunits/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘patternContentUnits’ του συγκεκριμένου στοιχείου ‘pattern’. Παίρνει μία από τις σταθερές που ορίζονται στο SVGUnitTypes. |
| [PatternTransform](../../aspose.svg/svgpatternelement/patterntransform/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘patternTransform’ του συγκεκριμένου στοιχείου ‘pattern’. |
| [PatternUnits](../../aspose.svg/svgpatternelement/patternunits/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘patternUnits’ του δεδομένου στοιχείου ‘pattern’. Παίρνει μία από τις σταθερές που ορίζονται στο SVGUnitTypes. |
...
| [PreserveAspectRatio](../../aspose.svg/svgpatternelement/preserveaspectratio/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘preserveAspectRatio’ του δεδομένου στοιχείου. |
...
| [RequiredExtensions](../../aspose.svg/svgpatternelement/requiredextensions/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘requiredExtensions’ του δεδομένου στοιχείου. |
| [RequiredFeatures](../../aspose.svg/svgpatternelement/requiredfeatures/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘requiredFeatures’ του δεδομένου στοιχείου. |
...
| [SystemLanguage](../../aspose.svg/svgpatternelement/systemlanguage/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘systemLanguage’ του δεδομένου στοιχείου. |
...
| [ViewBox](../../aspose.svg/svgpatternelement/viewbox/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘viewBox’ του δεδομένου στοιχείου. |
...
| [Width](../../aspose.svg/svgpatternelement/width/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘width’ του δεδομένου στοιχείου ‘pattern’. |
| [X](../../aspose.svg/svgpatternelement/x/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘x’ του δεδομένου στοιχείου ‘pattern’. |
| [Y](../../aspose.svg/svgpatternelement/y/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘y’ του δεδομένου στοιχείου ‘pattern’. |
