...
| Ονομα | Περιγραφή |
| --- | --- |
| [SVGDocument](svgdocument/#constructor)() | Αρχικοποιεί μια νέα παρουσία του`SVGDocument` τάξη. |
| [SVGDocument](svgdocument/#constructor_1)(Configuration) | Αρχικοποιεί μια νέα παρουσία του`SVGDocument` τάξη. |
| [SVGDocument](svgdocument/#constructor_2)(RequestMessage) | Αρχικοποιεί μια νέα παρουσία του`SVGDocument`τάξη. Ο κατασκευαστής λειτουργεί συγχρονισμένα, περιμένει τη φόρτωση όλων των εξωτερικών πόρων (εικόνες, σενάρια κ.λπ.). Για ασύγχρονη φόρτωση εγγράφου χρησιμοποιήστε τη μέθοδο[`Navigate`](../../aspose.svg.dom/document/navigate/) ή τις υπερφορτώσεις του. Ή μπορείτε να απενεργοποιήσετε τη φόρτωση ορισμένων εξωτερικών πόρων ορίζοντας τις κατάλληλες σημαίες στο[`Security`](../../aspose.svg.dom/ibrowsingcontext/security/) . |
| [SVGDocument](svgdocument/#constructor_10)(string) | Αρχικοποιεί μια νέα παρουσία του`SVGDocument`τάξη. Ο κατασκευαστής λειτουργεί συγχρονισμένα, περιμένει τη φόρτωση όλων των εξωτερικών πόρων (εικόνες, σενάρια κ.λπ.). Για ασύγχρονη φόρτωση εγγράφου χρησιμοποιήστε τη μέθοδο[`Navigate`](../../aspose.svg.dom/document/navigate/) ή τις υπερφορτώσεις του. Ή μπορείτε να απενεργοποιήσετε τη φόρτωση ορισμένων εξωτερικών πόρων ορίζοντας τις κατάλληλες σημαίες στο[`Security`](../../aspose.svg.dom/ibrowsingcontext/security/) . |
| [SVGDocument](svgdocument/#constructor_4)(Url) | Αρχικοποιεί μια νέα παρουσία του`SVGDocument`τάξη. Ο κατασκευαστής λειτουργεί συγχρονισμένα, περιμένει τη φόρτωση όλων των εξωτερικών πόρων (εικόνες, σενάρια κ.λπ.). Για ασύγχρονη φόρτωση εγγράφου χρησιμοποιήστε τη μέθοδο[`Navigate`](../../aspose.svg.dom/document/navigate/) ή τις υπερφορτώσεις του. Ή μπορείτε να απενεργοποιήσετε τη φόρτωση ορισμένων εξωτερικών πόρων ορίζοντας τις κατάλληλες σημαίες στο[`Security`](../../aspose.svg.dom/ibrowsingcontext/security/) . |
| [SVGDocument](svgdocument/#constructor_3)(RequestMessage, Configuration) | Αρχικοποιεί μια νέα παρουσία του`SVGDocument`τάξη. Ο κατασκευαστής λειτουργεί συγχρονισμένα, περιμένει τη φόρτωση όλων των εξωτερικών πόρων (εικόνες, σενάρια κ.λπ.). Για ασύγχρονη φόρτωση εγγράφου χρησιμοποιήστε τη μέθοδο[`Navigate`](../../aspose.svg.dom/document/navigate/) ή τις υπερφορτώσεις του. Ή μπορείτε να απενεργοποιήσετε τη φόρτωση ορισμένων εξωτερικών πόρων ορίζοντας τις κατάλληλες σημαίες στο[`Security`](../../aspose.svg.dom/ibrowsingcontext/security/) . |
| [SVGDocument](svgdocument/#constructor_8)(Stream, string) | Αρχικοποιεί μια νέα παρουσία του`SVGDocument`τάξη. Ο κατασκευαστής λειτουργεί συγχρονισμένα, περιμένει τη φόρτωση όλων των εξωτερικών πόρων (εικόνες, σενάρια κ.λπ.). Για ασύγχρονη φόρτωση εγγράφου χρησιμοποιήστε τη μέθοδο[`Navigate`](../../aspose.svg.dom/document/navigate/) ή τις υπερφορτώσεις του. Ή μπορείτε να απενεργοποιήσετε τη φόρτωση ορισμένων εξωτερικών πόρων ορίζοντας τις κατάλληλες σημαίες στο[`Security`](../../aspose.svg.dom/ibrowsingcontext/security/) . Η φόρτωση του εγγράφου ξεκινά από την τρέχουσα θέση στη ροή. |
| [SVGDocument](svgdocument/#constructor_6)(Stream, Url) | Αρχικοποιεί μια νέα παρουσία του`SVGDocument`τάξη. Ο κατασκευαστής λειτουργεί συγχρονισμένα, περιμένει τη φόρτωση όλων των εξωτερικών πόρων (εικόνες, σενάρια κ.λπ.). Για ασύγχρονη φόρτωση εγγράφου χρησιμοποιήστε τη μέθοδο[`Navigate`](../../aspose.svg.dom/document/navigate/) ή τις υπερφορτώσεις του. Ή μπορείτε να απενεργοποιήσετε τη φόρτωση ορισμένων εξωτερικών πόρων ορίζοντας τις κατάλληλες σημαίες στο[`Security`](../../aspose.svg.dom/ibrowsingcontext/security/) . Η φόρτωση του εγγράφου ξεκινά από την τρέχουσα θέση στη ροή. |
| [SVGDocument](svgdocument/#constructor_11)(string, Configuration) | Αρχικοποιεί μια νέα παρουσία του`SVGDocument`τάξη. Ο κατασκευαστής λειτουργεί συγχρονισμένα, περιμένει τη φόρτωση όλων των εξωτερικών πόρων (εικόνες, σενάρια κ.λπ.). Για ασύγχρονη φόρτωση εγγράφου χρησιμοποιήστε τη μέθοδο[`Navigate`](../../aspose.svg.dom/document/navigate/) ή τις υπερφορτώσεις του. Ή μπορείτε να απενεργοποιήσετε τη φόρτωση ορισμένων εξωτερικών πόρων ορίζοντας τις κατάλληλες σημαίες στο[`Security`](../../aspose.svg.dom/ibrowsingcontext/security/) . |
| [SVGDocument](svgdocument/#constructor_14)(string, string) | Αρχικοποιεί μια νέα παρουσία του`SVGDocument`τάξη. Ο κατασκευαστής λειτουργεί συγχρονισμένα, περιμένει τη φόρτωση όλων των εξωτερικών πόρων (εικόνες, σενάρια κ.λπ.). Για ασύγχρονη φόρτωση εγγράφου χρησιμοποιήστε τη μέθοδο[`Navigate`](../../aspose.svg.dom/document/navigate/) ή τις υπερφορτώσεις του. Ή μπορείτε να απενεργοποιήσετε τη φόρτωση ορισμένων εξωτερικών πόρων ορίζοντας τις κατάλληλες σημαίες στο[`Security`](../../aspose.svg.dom/ibrowsingcontext/security/) . |
| [SVGDocument](svgdocument/#constructor_12)(string, Url) | Αρχικοποιεί μια νέα παρουσία του`SVGDocument`τάξη. Ο κατασκευαστής λειτουργεί συγχρονισμένα, περιμένει τη φόρτωση όλων των εξωτερικών πόρων (εικόνες, σενάρια κ.λπ.). Για ασύγχρονη φόρτωση εγγράφου χρησιμοποιήστε τη μέθοδο[`Navigate`](../../aspose.svg.dom/document/navigate/) ή τις υπερφορτώσεις του. Ή μπορείτε να απενεργοποιήσετε τη φόρτωση ορισμένων εξωτερικών πόρων ορίζοντας τις κατάλληλες σημαίες στο[`Security`](../../aspose.svg.dom/ibrowsingcontext/security/) . |
| [SVGDocument](svgdocument/#constructor_5)(Url, Configuration) | Αρχικοποιεί μια νέα παρουσία του`SVGDocument`τάξη. Ο κατασκευαστής λειτουργεί συγχρονισμένα, περιμένει τη φόρτωση όλων των εξωτερικών πόρων (εικόνες, σενάρια κ.λπ.). Για ασύγχρονη φόρτωση εγγράφου χρησιμοποιήστε τη μέθοδο[`Navigate`](../../aspose.svg.dom/document/navigate/) ή τις υπερφορτώσεις του. Ή μπορείτε να απενεργοποιήσετε τη φόρτωση ορισμένων εξωτερικών πόρων ορίζοντας τις κατάλληλες σημαίες στο[`Security`](../../aspose.svg.dom/ibrowsingcontext/security/) . |
| [SVGDocument](svgdocument/#constructor_9)(Stream, string, Configuration) | Αρχικοποιεί μια νέα παρουσία του`SVGDocument`τάξη. Ο κατασκευαστής λειτουργεί συγχρονισμένα, περιμένει τη φόρτωση όλων των εξωτερικών πόρων (εικόνες, σενάρια κ.λπ.). Για ασύγχρονη φόρτωση εγγράφου χρησιμοποιήστε τη μέθοδο[`Navigate`](../../aspose.svg.dom/document/navigate/) ή τις υπερφορτώσεις του. Ή μπορείτε να απενεργοποιήσετε τη φόρτωση ορισμένων εξωτερικών πόρων ορίζοντας τις κατάλληλες σημαίες στο[`Security`](../../aspose.svg.dom/ibrowsingcontext/security/) . Η φόρτωση του εγγράφου ξεκινά από την τρέχουσα θέση στη ροή. |
| [SVGDocument](svgdocument/#constructor_7)(Stream, Url, Configuration) | Αρχικοποιεί μια νέα παρουσία του`SVGDocument`τάξη. Ο κατασκευαστής λειτουργεί συγχρονισμένα, περιμένει τη φόρτωση όλων των εξωτερικών πόρων (εικόνες, σενάρια κ.λπ.). Για ασύγχρονη φόρτωση εγγράφου χρησιμοποιήστε τη μέθοδο[`Navigate`](../../aspose.svg.dom/document/navigate/) ή τις υπερφορτώσεις του. Ή μπορείτε να απενεργοποιήσετε τη φόρτωση ορισμένων εξωτερικών πόρων ορίζοντας τις κατάλληλες σημαίες στο[`Security`](../../aspose.svg.dom/ibrowsingcontext/security/) . Η φόρτωση του εγγράφου ξεκινά από την τρέχουσα θέση στη ροή. |
| [SVGDocument](svgdocument/#constructor_15)(string, string, Configuration) | Αρχικοποιεί μια νέα παρουσία του`SVGDocument`τάξη. Ο κατασκευαστής λειτουργεί συγχρονισμένα, περιμένει τη φόρτωση όλων των εξωτερικών πόρων (εικόνες, σενάρια κ.λπ.). Για ασύγχρονη φόρτωση εγγράφου χρησιμοποιήστε τη μέθοδο[`Navigate`](../../aspose.svg.dom/document/navigate/) ή τις υπερφορτώσεις του. Ή μπορείτε να απενεργοποιήσετε τη φόρτωση ορισμένων εξωτερικών πόρων ορίζοντας τις κατάλληλες σημαίες στο[`Security`](../../aspose.svg.dom/ibrowsingcontext/security/) . |
| [SVGDocument](svgdocument/#constructor_13)(string, Url, Configuration) | Αρχικοποιεί μια νέα παρουσία του`SVGDocument`τάξη. Ο κατασκευαστής λειτουργεί συγχρονισμένα, περιμένει τη φόρτωση όλων των εξωτερικών πόρων (εικόνες, σενάρια κ.λπ.). Για ασύγχρονη φόρτωση εγγράφου χρησιμοποιήστε τη μέθοδο[`Navigate`](../../aspose.svg.dom/document/navigate/) ή τις υπερφορτώσεις του. Ή μπορείτε να απενεργοποιήσετε τη φόρτωση ορισμένων εξωτερικών πόρων ορίζοντας τις κατάλληλες σημαίες στο[`Security`](../../aspose.svg.dom/ibrowsingcontext/security/) . |
...
| [Domain](../../aspose.svg/svgdocument/domain/) { get; } | Το όνομα τομέα του διακομιστή που εξυπηρέτησε το έγγραφο ή μια μηδενική συμβολοσειρά εάν ο διακομιστής δεν μπορεί να αναγνωριστεί από ένα όνομα τομέα. |
...
| [Referrer](../../aspose.svg/svgdocument/referrer/) { get; } | Επιστρέφει το URI της σελίδας που συνδέθηκε με αυτήν τη σελίδα. Η τιμή είναι μια κενή συμβολοσειρά εάν ο χρήστης πλοηγήθηκε απευθείας στη σελίδα (όχι μέσω συνδέσμου, αλλά, για παράδειγμα, μέσω ενός σελιδοδείκτη). |
...
| [Title](../../aspose.svg/svgdocument/title/) { get; } | Ο τίτλος ενός εγγράφου όπως προσδιορίζεται από το υποστοιχείο «title» του ριζικού στοιχείου «svg» (δηλ.Εδώ είναι ο τίτλος... ) |
...
| [CreateNodeIterator](../../aspose.svg.dom/document/createnodeiterator/)(Node) | Δημιουργήστε ένα νέο NodeIterator πάνω από το υποδέντρο που έχει ρίζες στον καθορισμένο κόμβο . |
| [CreateNodeIterator](../../aspose.svg.dom/document/createnodeiterator/)(Node, long) | Δημιουργήστε ένα νέο NodeIterator πάνω από το υποδέντρο που έχει ρίζες στον καθορισμένο κόμβο . |
| [CreateNodeIterator](../../aspose.svg.dom/document/createnodeiterator/)(Node, long, INodeFilter) | Δημιουργήστε ένα νέο NodeIterator πάνω από το υποδέντρο που έχει ρίζες στον καθορισμένο κόμβο . |
...
| [CreateTreeWalker](../../aspose.svg.dom/document/createtreewalker/)(Node) | Δημιουργήστε ένα νέο TreeWalker πάνω από το υποδέντρο που έχει ρίζες στον καθορισμένο κόμβο . |
| [CreateTreeWalker](../../aspose.svg.dom/document/createtreewalker/)(Node, long) | Δημιουργήστε ένα νέο TreeWalker πάνω από το υποδέντρο που έχει ρίζες στον καθορισμένο κόμβο . |
| [CreateTreeWalker](../../aspose.svg.dom/document/createtreewalker/)(Node, long, INodeFilter) | Δημιουργήστε ένα νέο TreeWalker πάνω από το υποδέντρο που έχει ρίζες στον καθορισμένο κόμβο . |
...
| [GetOverrideStyle](../../aspose.svg/svgdocument/getoverridestyle/)(Element, string) | Αυτή η μέθοδος χρησιμοποιείται για την ανάκτηση της δήλωσης στυλ παράκαμψης για ένα καθορισμένο στοιχείο και ένα καθορισμένο ψευδοστοιχείο. |
...
| [Navigate](../../aspose.svg.dom/document/navigate/)(RequestMessage) | Φορτώνει το έγγραφο με βάση το καθορισμένο αντικείμενο αιτήματος, αντικαθιστώντας το προηγούμενο περιεχόμενο. |
| [Navigate](../../aspose.svg.dom/document/navigate/)(string) | Φορτώνει το έγγραφο στον καθορισμένο Uniform Resource Locator (URL) στην τρέχουσα παρουσία, αντικαθιστώντας το προηγούμενο περιεχόμενο. |
| [Navigate](../../aspose.svg.dom/document/navigate/)(Url) | Φορτώνει το έγγραφο στον καθορισμένο Uniform Resource Locator (URL) στην τρέχουσα παρουσία, αντικαθιστώντας το προηγούμενο περιεχόμενο. |
| [Navigate](../../aspose.svg.dom/document/navigate/)(Stream, string) | Φορτώνει το έγγραφο από καθορισμένο περιεχόμενο και χρησιμοποιεί το baseUri για την επίλυση σχετικών πόρων, αντικαθιστώντας το προηγούμενο περιεχόμενο. Η φόρτωση του εγγράφου ξεκινά από την τρέχουσα θέση στη ροή. |
| [Navigate](../../aspose.svg.dom/document/navigate/)(Stream, Url) | Φορτώνει το έγγραφο από καθορισμένο περιεχόμενο και χρησιμοποιεί το baseUri για την επίλυση σχετικών πόρων, αντικαθιστώντας το προηγούμενο περιεχόμενο. Η φόρτωση του εγγράφου ξεκινά από την τρέχουσα θέση στη ροή. |
| [Navigate](../../aspose.svg.dom/document/navigate/)(string, string) | Φορτώνει το έγγραφο από καθορισμένο περιεχόμενο και χρησιμοποιεί το baseUri για την επίλυση σχετικών πόρων, αντικαθιστώντας το προηγούμενο περιεχόμενο. |
| [Navigate](../../aspose.svg.dom/document/navigate/)(string, Url) | Φορτώνει το έγγραφο από καθορισμένο περιεχόμενο και χρησιμοποιεί το baseUri για την επίλυση σχετικών πόρων, αντικαθιστώντας το προηγούμενο περιεχόμενο. |
...
| override [RenderTo](../../aspose.svg/svgdocument/renderto/)(IDevice) | Αυτή η μέθοδος χρησιμοποιείται για την εκτύπωση των περιεχομένων του τρέχοντος εγγράφου στην καθορισμένη συσκευή. |
...
| [Save](../../aspose.svg/svgdocument/save/#save)(IOutputStorage) | Αποθηκεύει το περιεχόμενο και τους πόρους του εγγράφου στον χώρο αποθήκευσης εξόδου. |
| [Save](../../aspose.svg/svgdocument/save/#save_6)(string) | Αποθηκεύει το έγγραφο σε τοπικό αρχείο που καθορίζεται από`μονοπάτι` . Όλοι οι πόροι που χρησιμοποιούνται σε αυτό το έγγραφο θα αποθηκευτούν στο σε παρακείμενο φάκελο, το όνομα του οποίου θα κατασκευαστεί ως: output_file_name + "_files". |
| [Save](../../aspose.svg/svgdocument/save/#save_3)(Url) | Αποθηκεύει το έγγραφο σε τοπικό αρχείο που καθορίζεται από`url` . Όλοι οι πόροι που χρησιμοποιούνται σε αυτό το έγγραφο θα αποθηκευτούν στο σε παρακείμενο φάκελο, το όνομα του οποίου θα κατασκευαστεί ως: output_file_name + "_files". |
| [Save](../../aspose.svg/svgdocument/save/#save_1)(IOutputStorage, SVGSaveFormat) | Αποθηκεύει το περιεχόμενο και τους πόρους του εγγράφου στον χώρο αποθήκευσης εξόδου. |
| [Save](../../aspose.svg/svgdocument/save/#save_2)(IOutputStorage, SVGSaveOptions) | Αποθηκεύει το περιεχόμενο και τους πόρους του εγγράφου στον χώρο αποθήκευσης εξόδου. |
| [Save](../../aspose.svg/svgdocument/save/#save_7)(string, SVGSaveFormat) | Αποθηκεύει το έγγραφο σε τοπικό αρχείο που καθορίζεται από`μονοπάτι` . Όλοι οι πόροι που χρησιμοποιούνται σε αυτό το έγγραφο θα αποθηκευτούν στο σε παρακείμενο φάκελο, το όνομα του οποίου θα κατασκευαστεί ως: output_file_name + "_files". |
| [Save](../../aspose.svg/svgdocument/save/#save_8)(string, SVGSaveOptions) | Αποθηκεύει το έγγραφο σε τοπικό αρχείο που καθορίζεται από`μονοπάτι` . Όλοι οι πόροι που χρησιμοποιούνται σε αυτό το έγγραφο θα αποθηκευτούν στο σε παρακείμενο φάκελο, το όνομα του οποίου θα κατασκευαστεί ως: output_file_name + "_files". |
| [Save](../../aspose.svg/svgdocument/save/#save_4)(Url, SVGSaveFormat) | Αποθηκεύει το έγγραφο σε τοπικό αρχείο που καθορίζεται από`url` . Όλοι οι πόροι που χρησιμοποιούνται σε αυτό το έγγραφο θα αποθηκευτούν στο σε παρακείμενο φάκελο, το όνομα του οποίου θα κατασκευαστεί ως: output_file_name + "_files". |
| [Save](../../aspose.svg/svgdocument/save/#save_5)(Url, SVGSaveOptions) | Αποθηκεύει το έγγραφο σε τοπικό αρχείο που καθορίζεται από`url` . Όλοι οι πόροι που χρησιμοποιούνται σε αυτό το έγγραφο θα αποθηκευτούν στο σε παρακείμενο φάκελο, το όνομα του οποίου θα κατασκευαστεί ως: output_file_name + "_files". |
