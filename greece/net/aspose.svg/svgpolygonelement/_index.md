...
description: "Κλάση Aspose.Svg.SVGPolygonElement. Η διεπαφή SVGPolygonElement αντιστοιχεί στο στοιχείο polygon"
type: docs
weight: 5460
url: /el/net/aspose.svg/svgpolygonelement/
---
...
| Όνομα | Περιγραφή |
| --- | --- |
| [AnimatedPoints](../../aspose.svg/svgpolygonelement/animatedpoints/) { get; } | Παρέχει πρόσβαση στα τρέχοντα κινούμενα περιεχόμενα του χαρακτηριστικού ‘points’. Εάν το δεδομένο χαρακτηριστικό ή ιδιότητα είναι σε κίνηση, περιέχει την τρέχουσα κινούμενη τιμή του χαρακτηριστικού ή της ιδιότητας. Εάν το δεδομένο χαρακτηριστικό ή ιδιότητα δεν είναι αυτή τη στιγμή σε κίνηση, περιέχει την ίδια τιμή με το points. |
...
| [Points](../../aspose.svg/svgpolygonelement/points/) { get; } | Παρέχει πρόσβαση στα βασικά (δηλαδή στατικά) περιεχόμενα του χαρακτηριστικού ‘points’. |
