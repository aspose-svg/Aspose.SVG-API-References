...
description: "Κλάση Aspose.Svg.SVGAnimateTransformElement. Η διεπαφή SVGAnimateTransformElement αντιστοιχεί στο στοιχείο animateTransform. Η αντικειμενοστραφής πρόσβαση στα χαρακτηριστικά του στοιχείου animateTransform μέσω του SVG DOM δεν είναι διαθέσιμη"
type: docs
weight: 5180
url: /el/net/aspose.svg/svganimatetransformelement/
---
