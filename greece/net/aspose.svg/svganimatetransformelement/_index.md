...
description: Aspose.Svg.SVGAnimateTransformElement τάξη. Η διεπαφή SVGAnimateTransformElement αντιστοιχεί στο στοιχείο animateTransform. Η αντικειμενοστραφή πρόσβαση στα χαρακτηριστικά του στοιχείου animateTransform μέσω του SVG DOM δεν είναι διαθέσιμη.
type: docs
weight: 3110
