...
description: "Aspose.Svg.SVGMaskElement κλάση. Η διεπαφή SVGMaskElement αντιστοιχεί στο στοιχείο mask"
type: docs
weight: 5420
...
| [Height](../../aspose.svg/svgmaskelement/height/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘height’ στο δεδομένο στοιχείο ‘mask’. Παίρνει μία από τις σταθερές που ορίζονται στο SVGUnitTypes. |
...
| [MaskContentUnits](../../aspose.svg/svgmaskelement/maskcontentunits/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘maskContentUnits’ στο δεδομένο στοιχείο ‘mask’. Παίρνει μία από τις σταθερές που ορίζονται στο SVGUnitTypes. |
| [MaskUnits](../../aspose.svg/svgmaskelement/maskunits/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘maskUnits’ στο δεδομένο στοιχείο ‘mask’. Παίρνει μία από τις σταθερές που ορίζονται στο SVGUnitTypes. |
...
| [RequiredExtensions](../../aspose.svg/svgmaskelement/requiredextensions/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘requiredExtensions’ του δεδομένου στοιχείου. |
| [RequiredFeatures](../../aspose.svg/svgmaskelement/requiredfeatures/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘requiredFeatures’ του δεδομένου στοιχείου. |
...
| [SystemLanguage](../../aspose.svg/svgmaskelement/systemlanguage/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘systemLanguage’ του δεδομένου στοιχείου. |
...
| [Width](../../aspose.svg/svgmaskelement/width/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘width’ στο δεδομένο στοιχείο ‘mask’. Παίρνει μία από τις σταθερές που ορίζονται στο SVGUnitTypes. |
| [X](../../aspose.svg/svgmaskelement/x/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘x’ στο δεδομένο στοιχείο ‘mask’. Παίρνει μία από τις σταθερές που ορίζονται στο SVGUnitTypes. |
| [Y](../../aspose.svg/svgmaskelement/y/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘y’ στο δεδομένο στοιχείο ‘mask’. Παίρνει μία από τις σταθερές που ορίζονται στο SVGUnitTypes. |
