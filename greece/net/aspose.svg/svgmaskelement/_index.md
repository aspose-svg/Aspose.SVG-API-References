...
description: Aspose.Svg.SVGMaskElement τάξη. Η διεπαφή SVGMaskElement αντιστοιχεί στο στοιχείο μάσκα.
type: docs
weight: 3350
url: /el/net/aspose.svg/svgmaskelement/
---
...
| [Height](../../aspose.svg/svgmaskelement/height/) { get; } | Αντιστοιχεί στο χαρακτηριστικό «ύψος» στο δεδομένο στοιχείο «μάσκα». Λαμβάνει μία από τις σταθερές που ορίζονται στο SVGUnitTypes. |
...
| [MaskContentUnits](../../aspose.svg/svgmaskelement/maskcontentunits/) { get; } | Αντιστοιχεί στο χαρακτηριστικό «maskContentUnits» στο δεδομένο στοιχείο «μάσκα». Λαμβάνει μία από τις σταθερές που ορίζονται στο SVGUnitTypes. |
| [MaskUnits](../../aspose.svg/svgmaskelement/maskunits/) { get; } | Αντιστοιχεί στο χαρακτηριστικό 'maskUnits' στο δεδομένο στοιχείο 'mask'. Λαμβάνει μία από τις σταθερές που ορίζονται στο SVGUnitTypes. |
...
| [RequiredExtensions](../../aspose.svg/svgmaskelement/requiredextensions/) { get; } | Αντιστοιχεί στο χαρακτηριστικό 'requiredExtensions' στο δεδομένο στοιχείο. |
| [RequiredFeatures](../../aspose.svg/svgmaskelement/requiredfeatures/) { get; } | Αντιστοιχεί στο χαρακτηριστικό 'requiredFeatures' στο δεδομένο στοιχείο. |
...
| [SystemLanguage](../../aspose.svg/svgmaskelement/systemlanguage/) { get; } | Αντιστοιχεί στο χαρακτηριστικό 'systemLanguage' στο δεδομένο στοιχείο. |
...
| [Width](../../aspose.svg/svgmaskelement/width/) { get; } | Αντιστοιχεί στο χαρακτηριστικό 'width' στο δεδομένο στοιχείο 'mask'. Λαμβάνει μία από τις σταθερές που ορίζονται στο SVGUnitTypes. |
| [X](../../aspose.svg/svgmaskelement/x/) { get; } | Αντιστοιχεί στο χαρακτηριστικό «x» στο δεδομένο στοιχείο «μάσκα». Λαμβάνει μία από τις σταθερές που ορίζονται στο SVGUnitTypes. |
| [Y](../../aspose.svg/svgmaskelement/y/) { get; } | Αντιστοιχεί στο χαρακτηριστικό «y» στο δεδομένο στοιχείο «μάσκα». Λαμβάνει μία από τις σταθερές που ορίζονται στο SVGUnitTypes. |
