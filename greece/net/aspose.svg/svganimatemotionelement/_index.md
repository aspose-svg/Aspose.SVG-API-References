...
description: "Aspose.Svg.SVGAnimateMotionElement κλάση. Η SVGAnimateMotionElement διασύνδεση αντιστοιχεί στο στοιχείο animateMotion. Η αντικειμενοστραφής πρόσβαση στα χαρακτηριστικά του στοιχείου animateMotion μέσω του SVG DOM δεν είναι διαθέσιμη"
type: docs
weight: 5170
url: /el/net/aspose.svg/svganimatemotionelement/
---
