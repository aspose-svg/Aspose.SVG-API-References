...
description: Aspose.Svg.SVGAnimateMotionElement τάξη. Η διεπαφή SVGAnimateMotionElement αντιστοιχεί στο στοιχείο animateMotion. Η αντικειμενοστραφή πρόσβαση στα χαρακτηριστικά του στοιχείου animateMotion μέσω του SVG DOM δεν είναι διαθέσιμη.
type: docs
weight: 3100
