...
description: Aspose.Svg.SVGGeometryElement τάξη. Διασύνδεση SVGGeometryElement αντιπροσωπεύει στοιχεία SVG των οποίων η απόδοση ορίζεται από γεωμετρία με ισοδύναμη διαδρομή και τα οποία μπορούν να συμπληρωθούν και να περαστούν. Αυτό περιλαμβάνει μονοπάτια και τα βασικά σχήματα.
type: docs
weight: 3270
url: /el/net/aspose.svg/svggeometryelement/
---
...
| [GetEquivalentPath](../../aspose.svg/svggeometryelement/getequivalentpath/)() | Επιστρέφει μια νέα παρουσία του[`SVGPathSegList`](../../aspose.svg.paths/svgpathseglist/) που αντιπροσωπεύει`SVGGeometryElement` ως τμήματα διαδρομής. |
