...
description: "Κλάση Aspose.Svg.SVGImageElement. Η διεπαφή SVGImageElement αντιστοιχεί στο στοιχείο εικόνας."
type: docs
weight: 5370
url: /el/net/aspose.svg/svgimageelement/
---
...
| [Height](../../aspose.svg/svgimageelement/height/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘height’ του δεδομένου στοιχείου ‘image’. |
| [Href](../../aspose.svg/svgimageelement/href/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘xlink:href’ του δεδομένου στοιχείου. |
...
| [PreserveAspectRatio](../../aspose.svg/svgimageelement/preserveaspectratio/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘preserveAspectRatio’ του δεδομένου στοιχείου ‘image’. |
...
| [Width](../../aspose.svg/svgimageelement/width/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘width’ του δεδομένου στοιχείου ‘image’. |
| [X](../../aspose.svg/svgimageelement/x/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘x’ του δεδομένου στοιχείου ‘image’. |
| [Y](../../aspose.svg/svgimageelement/y/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘y’ του δεδομένου στοιχείου ‘image’. |
