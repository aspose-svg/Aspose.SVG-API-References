...
description: Aspose.Svg.SVGImageElement τάξη. Η διεπαφή SVGImageElement αντιστοιχεί στο στοιχείο εικόνα.
type: docs
weight: 3300
...
| [Height](../../aspose.svg/svgimageelement/height/) { get; } | Αντιστοιχεί στο χαρακτηριστικό 'height' στο δεδομένο στοιχείο 'image'. |
| [Href](../../aspose.svg/svgimageelement/href/) { get; } | Αντιστοιχεί στο χαρακτηριστικό 'xlink:href' στο δεδομένο στοιχείο. |
...
| [PreserveAspectRatio](../../aspose.svg/svgimageelement/preserveaspectratio/) { get; } | Αντιστοιχεί στο χαρακτηριστικό "preserveAspectRatio" στο δεδομένο στοιχείο "image". |
...
| [Width](../../aspose.svg/svgimageelement/width/) { get; } | Αντιστοιχεί στο χαρακτηριστικό 'width' στο δεδομένο στοιχείο 'image'. |
| [X](../../aspose.svg/svgimageelement/x/) { get; } | Αντιστοιχεί στο χαρακτηριστικό "x" στο δεδομένο στοιχείο "εικόνα". |
| [Y](../../aspose.svg/svgimageelement/y/) { get; } | Αντιστοιχεί στο χαρακτηριστικό 'y' στο δεδομένο στοιχείο 'image'. |
