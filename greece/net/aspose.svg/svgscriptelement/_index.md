...
description: "Κλάση Aspose.Svg.SVGScriptElement. Η διεπαφή SVGScriptElement αντιστοιχεί στο στοιχείο script"
type: docs
weight: 5520
url: /el/net/aspose.svg/svgscriptelement/
---
...
| [CrossOrigin](../../aspose.svg/svgscriptelement/crossorigin/) { get; set; } | Αντιστοιχεί στο χαρακτηριστικό ‘crossorigin’ του δεδομένου στοιχείου ‘script’. |
...
| [Href](../../aspose.svg/svgscriptelement/href/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘xlink:href’ του δεδομένου στοιχείου. |
...
| [Type](../../aspose.svg/svgscriptelement/type/) { get; set; } | Αντιστοιχεί στο χαρακτηριστικό ‘type’ του δεδομένου στοιχείου ‘script’. |
