...
description: Aspose.Svg.SVGScriptElement τάξη. Η διεπαφή SVGScriptElement αντιστοιχεί στο στοιχείο script.
type: docs
weight: 3450
...
| [CrossOrigin](../../aspose.svg/svgscriptelement/crossorigin/) { get; set; } | Αντιστοιχεί στο χαρακτηριστικό 'crossorigin' στο δεδομένο στοιχείο 'script'. |
...
| [Href](../../aspose.svg/svgscriptelement/href/) { get; } | Αντιστοιχεί στο χαρακτηριστικό 'xlink:href' στο δεδομένο στοιχείο. |
...
| [Type](../../aspose.svg/svgscriptelement/type/) { get; set; } | Αντιστοιχεί στο χαρακτηριστικό "type" στο δεδομένο στοιχείο "script". |
