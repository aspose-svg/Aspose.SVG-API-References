...
description: Aspose.Svg.SVGTextPathElement τάξη. Η διεπαφή SVGTextPathElement αντιστοιχεί στο στοιχείο textPath.
type: docs
weight: 3540
...
| [Href](../../aspose.svg/svgtextpathelement/href/) { get; } | Αντιστοιχεί στο χαρακτηριστικό 'xlink:href' στο δεδομένο στοιχείο. |
...
| [LengthAdjust](../../aspose.svg/svgtextcontentelement/lengthadjust/) { get; } | Αντιστοιχεί στο χαρακτηριστικό 'lengthAdjust' στο δεδομένο στοιχείο. Η τιμή πρέπει να είναι μία από τις σταθερές προσαρμογής μήκους που ορίζονται σε αυτήν τη διεπαφή. |
...
| [TextLength](../../aspose.svg/svgtextcontentelement/textlength/) { get; } | Αντιστοιχεί στο χαρακτηριστικό "textLength" στο δεδομένο στοιχείο. |
...
| const [TEXTPATH_SPACINGTYPE_EXACT](../../aspose.svg/svgtextpathelement/textpath_spacingtype_exact/) | Αντιστοιχεί στην τιμή 'acact'. |
