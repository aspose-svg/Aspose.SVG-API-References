...
description: "Aspose.Svg.SVGTextPathElement κλάση. Η διεπαφή SVGTextPathElement αντιστοιχεί στο στοιχείο textPath"
type: docs
weight: 5610
url: /el/net/aspose.svg/svgtextpathelement/
---
...
| [FarthestViewportElement](../../aspose.svg/svggraphicselement/farthestviewportelement/) { get; } | Το πιο απομακρυσμένο πρόγονο στοιχείο ‘svg’. Null εάν το τρέχον στοιχείο είναι το εξωτερικότερο στοιχείο svg. |
...
| [Href](../../aspose.svg/svgtextpathelement/href/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘xlink:href’ του δεδομένου στοιχείου. |
...
| [LengthAdjust](../../aspose.svg/svgtextcontentelement/lengthadjust/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘lengthAdjust’ του δεδομένου στοιχείου. Η τιμή πρέπει να είναι μία από τις σταθερές προσαρμογής μήκους που ορίζονται σε αυτή τη διεπαφή. |
...
| [Method](../../aspose.svg/svgtextpathelement/method/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘method’ στο δεδομένο στοιχείο ‘textPath’. |
...
| [NearestViewportElement](../../aspose.svg/svggraphicselement/nearestviewportelement/) { get; } | Το στοιχείο που καθόρισε το τρέχον παράθυρο προβολής. Συχνά, το πλησιέστερο πρόγονο στοιχείο ‘svg’. Null εάν το τρέχον στοιχείο είναι το εξωτερικότερο στοιχείο svg. |
...
| [RequiredExtensions](../../aspose.svg/svggraphicselement/requiredextensions/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘requiredExtensions’ του δεδομένου στοιχείου. |
| [RequiredFeatures](../../aspose.svg/svggraphicselement/requiredfeatures/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘requiredFeatures’ του δεδομένου στοιχείου. |
...
| [Spacing](../../aspose.svg/svgtextpathelement/spacing/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘spacing’ στο δεδομένο στοιχείο ‘textPath’. |
| [StartOffset](../../aspose.svg/svgtextpathelement/startoffset/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘startOffset’ στο δεδομένο στοιχείο ‘textPath’. |
...
| [SystemLanguage](../../aspose.svg/svggraphicselement/systemlanguage/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘systemLanguage’ του δεδομένου στοιχείου. |
...
| [TextLength](../../aspose.svg/svgtextcontentelement/textlength/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘textLength’ του δεδομένου στοιχείου. |
| [Transform](../../aspose.svg/svggraphicselement/transform/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘transform’ του δεδομένου στοιχείου. |
...
| [GetBBox](../../aspose.svg/svggraphicselement/getbbox/)() | Επιστρέφει το ακριβές πλαίσιο περιγράμματος στον τρέχον χώρο χρήστη (δηλαδή, μετά την εφαρμογή του χαρακτηριστικού ‘transform’, εάν υπάρχει) στη γεωμετρία όλων των περιεχόμενων στοιχείων γραφικών, εξαιρουμένου του στυλ γραμμής, του κλαπινγκ, της μάσκας και των εφέ φίλτρου). Σημειώστε ότι η μέθοδος getBBox πρέπει να επιστρέφει το πραγματικό πλαίσιο περιγράμματος τη στιγμή που κλήθηκε, ακόμη και στην περίπτωση που το στοιχείο δεν έχει ακόμη αποδοθεί. |
| [GetComputedTextLength](../../aspose.svg/svgtextcontentelement/getcomputedtextlength/)() | Το συνολικό άθροισμα όλων των τιμών προόδου από την απόδοση όλων των χαρακτήρων εντός αυτού του στοιχείου, συμπεριλαμβανομένης της τιμής προόδου στα γλύφους (οριζόντια ή κάθετη), της επίδρασης των ιδιοτήτων ‘kerning’, ‘letter-spacing’ και ‘word-spacing’ και των προσαρμογών λόγω των χαρακτηριστικών ‘dx’ και ‘dy’ στα στοιχεία ‘tspan’. Για περιβάλλοντα χωρίς απόδοση, ο πράκτορας χρήστη πρέπει να κάνει λογικές υποθέσεις σχετικά με τις μετρικές των γλύφων. |
| [GetCTM](../../aspose.svg/svggraphicselement/getctm/)() | Επιστρέφει τον πίνακα μετασχηματισμού από τις τρέχουσες μονάδες χρήστη (δηλαδή, μετά την εφαρμογή του χαρακτηριστικού ‘transform’, εάν υπάρχει) στο σύστημα συντεταγμένων του παραθύρου προβολής για το nearestViewportElement. |
...
| Όνομα | Περιγραφή |
| --- | --- |
| const [TEXTPATH_METHODTYPE_ALIGN](../../aspose.svg/svgtextpathelement/textpath_methodtype_align/) | Αντιστοιχεί στην τιμή 'align'. |
| const [TEXTPATH_METHODTYPE_STRETCH](../../aspose.svg/svgtextpathelement/textpath_methodtype_stretch/) | Αντιστοιχεί στην τιμή 'stretch'. |
| const [TEXTPATH_METHODTYPE_UNKNOWN](../../aspose.svg/svgtextpathelement/textpath_methodtype_unknown/) | Η απαρίθμηση ορίστηκε σε τιμή που δεν είναι μία από τις προκαθορισμένους τύπους. Είναι άκυρο να προσπαθήσετε να ορίσετε μια νέα τιμή αυτού του τύπου ή να προσπαθήσετε να αλλάξετε μια υπάρχουσα τιμή σε αυτόν τον τύπο. |
| const [TEXTPATH_SPACINGTYPE_AUTO](../../aspose.svg/svgtextpathelement/textpath_spacingtype_auto/) | Αντιστοιχεί στην τιμή 'auto'. |
| const [TEXTPATH_SPACINGTYPE_EXACT](../../aspose.svg/svgtextpathelement/textpath_spacingtype_exact/) | Αντιστοιχεί στην τιμή 'exact'. |
| const [TEXTPATH_SPACINGTYPE_UNKNOWN](../../aspose.svg/svgtextpathelement/textpath_spacingtype_unknown/) | Η απαρίθμηση ορίστηκε σε τιμή που δεν είναι μία από τις προκαθορισμένους τύπους. Είναι άκυρο να προσπαθήσετε να ορίσετε μια νέα τιμή αυτού του τύπου ή να προσπαθήσετε να αλλάξετε μια υπάρχουσα τιμή σε αυτόν τον τύπο. |
