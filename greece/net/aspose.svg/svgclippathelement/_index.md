...
description: Aspose.Svg.SVGClipPathElement τάξη. Η διεπαφή SVGClipPathElement αντιστοιχεί στο στοιχείο clipPath.
type: docs
weight: 3140
...
| [ClipPathUnits](../../aspose.svg/svgclippathelement/clippathunits/) { get; } | Αντιστοιχεί στο χαρακτηριστικό 'clipPathUnits' στο δεδομένο στοιχείο 'clipPath'. Λαμβάνει μία από τις σταθερές που ορίζονται στο SVGUnitTypes. |
...
| [Transform](../../aspose.svg/svgclippathelement/transform/) { get; } | Αντιστοιχεί στο χαρακτηριστικό 'transform' στο δεδομένο στοιχείο. |
