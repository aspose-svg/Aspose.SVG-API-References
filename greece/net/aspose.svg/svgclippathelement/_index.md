...
description: "Κλάση Aspose.Svg.SVGClipPathElement. Η διεπαφή SVGClipPathElement αντιστοιχεί στο στοιχείο clipPath."
type: docs
weight: 5210
url: /el/net/aspose.svg/svgclippathelement/
---
...
| [ClipPathUnits](../../aspose.svg/svgclippathelement/clippathunits/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘clipPathUnits’ του δεδομένου στοιχείου ‘clipPath’. Παίρνει μία από τις σταθερές που ορίζονται στην SVGUnitTypes. |
...
| [Transform](../../aspose.svg/svgclippathelement/transform/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘transform’ του δεδομένου στοιχείου. |
