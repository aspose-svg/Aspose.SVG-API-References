...
description: Aspose.Svg.SVGPathElement τάξη. Η διεπαφή SVGPathElement αντιστοιχεί στο στοιχείο διαδρομή.
type: docs
weight: 3370
url: /el/net/aspose.svg/svgpathelement/
---
...
| [FarthestViewportElement](../../aspose.svg/svggraphicselement/farthestviewportelement/) { get; } | Ο πιο μακρινός πρόγονος 'svg' στοιχείο. Μηδενικό αν το τρέχον στοιχείο είναι το πιο εξωτερικό στοιχείο svg. |
...
| [NearestViewportElement](../../aspose.svg/svggraphicselement/nearestviewportelement/) { get; } | Το στοιχείο που δημιούργησε την τρέχουσα θύρα προβολής. Συχνά, ο πλησιέστερος πρόγονος στοιχείο 'svg'. Μηδενικό αν το τρέχον στοιχείο είναι το πιο εξωτερικό στοιχείο svg. |
...
| [RequiredExtensions](../../aspose.svg/svggraphicselement/requiredextensions/) { get; } | Αντιστοιχεί στο χαρακτηριστικό 'requiredExtensions' στο δεδομένο στοιχείο. |
| [RequiredFeatures](../../aspose.svg/svggraphicselement/requiredfeatures/) { get; } | Αντιστοιχεί στο χαρακτηριστικό 'requiredFeatures' στο δεδομένο στοιχείο. |
...
| [SystemLanguage](../../aspose.svg/svggraphicselement/systemlanguage/) { get; } | Αντιστοιχεί στο χαρακτηριστικό 'systemLanguage' στο δεδομένο στοιχείο. |
...
| [Transform](../../aspose.svg/svggraphicselement/transform/) { get; } | Αντιστοιχεί στο χαρακτηριστικό 'transform' στο δεδομένο στοιχείο. |
...
| [CreateSVGPathSegArcAbs](../../aspose.svg/svgpathelement/createsvgpathsegarcabs/)(float, float, float, float, float, bool, bool) | Επιστρέφει ένα αυτόνομο, χωρίς γονικό αντικείμενο SVGPathSegArcAbs. |
| [CreateSVGPathSegArcRel](../../aspose.svg/svgpathelement/createsvgpathsegarcrel/)(float, float, float, float, float, bool, bool) | Επιστρέφει ένα αυτόνομο, χωρίς γονικό αντικείμενο SVGPathSegArcRel. |
| [CreateSVGPathSegClosePath](../../aspose.svg/svgpathelement/createsvgpathsegclosepath/)() | Επιστρέφει ένα αυτόνομο, χωρίς γονικό αντικείμενο SVGPathSegClosePath. |
| [CreateSVGPathSegCurvetoCubicAbs](../../aspose.svg/svgpathelement/createsvgpathsegcurvetocubicabs/)(float, float, float, float, float, float) | Επιστρέφει ένα αυτόνομο, χωρίς γονικό αντικείμενο SVGPathSegCurvetoCubicAbs. |
| [CreateSVGPathSegCurvetoCubicRel](../../aspose.svg/svgpathelement/createsvgpathsegcurvetocubicrel/)(float, float, float, float, float, float) | Επιστρέφει ένα αυτόνομο, χωρίς γονικό αντικείμενο SVGPathSegCurvetoCubicRel. |
| [CreateSVGPathSegCurvetoCubicSmoothAbs](../../aspose.svg/svgpathelement/createsvgpathsegcurvetocubicsmoothabs/)(float, float, float, float) | Επιστρέφει ένα αυτόνομο, χωρίς γονικό αντικείμενο SVGPathSegCurvetoCubicSmoothAbs. |
| [CreateSVGPathSegCurvetoCubicSmoothRel](../../aspose.svg/svgpathelement/createsvgpathsegcurvetocubicsmoothrel/)(float, float, float, float) | Επιστρέφει ένα αυτόνομο, χωρίς γονικό αντικείμενο SVGPathSegCurvetoCubicSmoothRel. |
| [CreateSVGPathSegCurvetoQuadraticAbs](../../aspose.svg/svgpathelement/createsvgpathsegcurvetoquadraticabs/)(float, float, float, float) | Επιστρέφει ένα αυτόνομο, χωρίς γονικό αντικείμενο SVGPathSegCurvetoQuadraticAbs. |
| [CreateSVGPathSegCurvetoQuadraticRel](../../aspose.svg/svgpathelement/createsvgpathsegcurvetoquadraticrel/)(float, float, float, float) | Επιστρέφει ένα αυτόνομο, χωρίς γονικό αντικείμενο SVGPathSegCurvetoQuadraticRel. |
| [CreateSVGPathSegCurvetoQuadraticSmoothAbs](../../aspose.svg/svgpathelement/createsvgpathsegcurvetoquadraticsmoothabs/)(float, float) | Επιστρέφει ένα αυτόνομο, χωρίς γονικό αντικείμενο SVGPathSegCurvetoQuadraticSmoothAbs. |
| [CreateSVGPathSegCurvetoQuadraticSmoothRel](../../aspose.svg/svgpathelement/createsvgpathsegcurvetoquadraticsmoothrel/)(float, float) | Επιστρέφει ένα αυτόνομο, χωρίς γονικό αντικείμενο SVGPathSegCurvetoQuadraticSmoothRel. |
| [CreateSVGPathSegLinetoAbs](../../aspose.svg/svgpathelement/createsvgpathseglinetoabs/)(float, float) | Επιστρέφει ένα αυτόνομο, χωρίς γονικό αντικείμενο SVGPathSegLinetoAbs. |
| [CreateSVGPathSegLinetoHorizontalAbs](../../aspose.svg/svgpathelement/createsvgpathseglinetohorizontalabs/)(float) | Επιστρέφει ένα αυτόνομο, χωρίς γονικό αντικείμενο SVGPathSegLinetoHorizontalAbs. |
| [CreateSVGPathSegLinetoHorizontalRel](../../aspose.svg/svgpathelement/createsvgpathseglinetohorizontalrel/)(float) | Επιστρέφει ένα αυτόνομο, χωρίς γονικό αντικείμενο SVGPathSegLinetoHorizontalRel. |
| [CreateSVGPathSegLinetoRel](../../aspose.svg/svgpathelement/createsvgpathseglinetorel/)(float, float) | Επιστρέφει ένα αυτόνομο, χωρίς γονικό αντικείμενο SVGPathSegLinetoRel. |
| [CreateSVGPathSegLinetoVerticalAbs](../../aspose.svg/svgpathelement/createsvgpathseglinetoverticalabs/)(float) | Επιστρέφει ένα αυτόνομο, χωρίς γονικό αντικείμενο SVGPathSegLinetoVerticalAbs. |
| [CreateSVGPathSegLinetoVerticalRel](../../aspose.svg/svgpathelement/createsvgpathseglinetoverticalrel/)(float) | Επιστρέφει ένα αυτόνομο, χωρίς γονικό αντικείμενο SVGPathSegLinetoVerticalRel. |
| [CreateSVGPathSegMovetoAbs](../../aspose.svg/svgpathelement/createsvgpathsegmovetoabs/)(float, float) | Επιστρέφει ένα αυτόνομο, χωρίς γονικό αντικείμενο SVGPathSegMovetoAbs. |
| [CreateSVGPathSegMovetoRel](../../aspose.svg/svgpathelement/createsvgpathsegmovetorel/)(float, float) | Επιστρέφει ένα αυτόνομο, χωρίς γονικό αντικείμενο SVGPathSegMovetoRel. |
...
| [GetEquivalentPath](../../aspose.svg/svggeometryelement/getequivalentpath/)() | Επιστρέφει μια νέα παρουσία του[`SVGPathSegList`](../../aspose.svg.paths/svgpathseglist/) που αντιπροσωπεύει[`SVGGeometryElement`](../svggeometryelement/) ως τμήματα διαδρομής. |
