...
description: "Κλάση Aspose.Svg.SVGGradientElement. Η διεπαφή SVGGradientElement είναι μια βασική διεπαφή που χρησιμοποιείται από τις SVGLinearGradientElement και SVGRadialGradientElement."
type: docs
weight: 5350
url: /el/net/aspose.svg/svggradientelement/
---
...
| Όνομα | Περιγραφή |
| --- | --- |
| const [SVG_SPREADMETHOD_PAD](../../aspose.svg/svggradientelement/svg_spreadmethod_pad/) | Αντιστοιχεί στην τιμή 'pad'. |
| const [SVG_SPREADMETHOD_REFLECT](../../aspose.svg/svggradientelement/svg_spreadmethod_reflect/) | Αντιστοιχεί στην τιμή 'reflect'. |
| const [SVG_SPREADMETHOD_REPEAT](../../aspose.svg/svggradientelement/svg_spreadmethod_repeat/) | Αντιστοιχεί στην τιμή 'repeat'. |
| const [SVG_SPREADMETHOD_UNKNOWN](../../aspose.svg/svggradientelement/svg_spreadmethod_unknown/) | Ο τύπος δεν είναι ένας από τους προκαθορισμένους τύπους. Είναι μη έγκυρο να προσπαθήσετε να ορίσετε μια νέα τιμή αυτού του τύπου ή να προσπαθήσετε να αλλάξετε μια υπάρχουσα τιμή σε αυτόν τον τύπο. |
