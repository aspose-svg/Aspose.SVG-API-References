...
type: docs
weight: 3440
url: /el/net/aspose.svg/svgsvgelement/
---
## SVGSVGElement class
...
| [Height](../../aspose.svg/svgsvgelement/height/) { get; } | Αντιστοιχεί στο χαρακτηριστικό 'height' στο δεδομένο στοιχείο 'svg'. |
...
| [PreserveAspectRatio](../../aspose.svg/svgsvgelement/preserveaspectratio/) { get; } | Αντιστοιχεί στο χαρακτηριστικό "preserveAspectRatio" στο δεδομένο στοιχείο. |
...
| [ViewBox](../../aspose.svg/svgsvgelement/viewbox/) { get; } | Αντιστοιχεί στο χαρακτηριστικό "viewBox" στο δεδομένο στοιχείο. |
...
| [Width](../../aspose.svg/svgsvgelement/width/) { get; } | Αντιστοιχεί στο χαρακτηριστικό 'width' στο δεδομένο στοιχείο 'svg'. |
| [X](../../aspose.svg/svgsvgelement/x/) { get; } | Αντιστοιχεί στο χαρακτηριστικό 'x' στο δεδομένο στοιχείο 'svg'. |
| [Y](../../aspose.svg/svgsvgelement/y/) { get; } | Αντιστοιχεί στο χαρακτηριστικό 'y' στο δεδομένο στοιχείο 'svg'. |
| [ZoomAndPan](../../aspose.svg/svgsvgelement/zoomandpan/) { get; set; } | Αντιστοιχεί στο χαρακτηριστικό 'zoomAndPan' στο δεδομένο στοιχείο. Η τιμή πρέπει να είναι μία από τις σταθερές SVG_ZOOMANDPAN_* που ορίζονται σε αυτήν τη διεπαφή. |
...
| [AnimationsPaused](../../aspose.svg/svgsvgelement/animationspaused/)() | Επιστρέφει true εάν αυτό το τμήμα εγγράφου SVG βρίσκεται σε παύση. |
...
| [CreateEvent](../../aspose.svg/svgsvgelement/createevent/)(string) | Δημιουργεί ένα[`Event`](../../aspose.svg.dom.events/event/) τύπου που υποστηρίζεται από την υλοποίηση. |
| [CreateSVGAngle](../../aspose.svg/svgsvgelement/createsvgangle/)() | Δημιουργεί ένα αντικείμενο SVGAngle έξω από οποιαδήποτε δέντρα εγγράφων. Το αντικείμενο αρχικοποιείται στην τιμή 0 μοίρες (unitless). |
| [CreateSVGLength](../../aspose.svg/svgsvgelement/createsvglength/)() | Δημιουργεί ένα αντικείμενο SVGLength εκτός οποιωνδήποτε δέντρων εγγράφων. Το αντικείμενο αρχικοποιείται στην τιμή 0 μονάδων χρήστη. |
| [CreateSVGMatrix](../../aspose.svg/svgsvgelement/createsvgmatrix/)() | Δημιουργεί ένα αντικείμενο SVGMatrix εκτός οποιωνδήποτε δέντρων εγγράφων. Το αντικείμενο αρχικοποιείται στον πίνακα ταυτότητας. |
| [CreateSVGNumber](../../aspose.svg/svgsvgelement/createsvgnumber/)() | Δημιουργεί ένα αντικείμενο SVGNumber εκτός οποιωνδήποτε δέντρων εγγράφων. Το αντικείμενο αρχικοποιείται σε τιμή μηδέν. |
| [CreateSVGPoint](../../aspose.svg/svgsvgelement/createsvgpoint/)() | Δημιουργεί ένα αντικείμενο SVGPoint εκτός οποιωνδήποτε δέντρων εγγράφων. Το αντικείμενο αρχικοποιείται στο σημείο (0,0) στο σύστημα συντεταγμένων του χρήστη. |
| [CreateSVGRect](../../aspose.svg/svgsvgelement/createsvgrect/)() | Δημιουργεί ένα αντικείμενο SVGRect εκτός οποιωνδήποτε δέντρων εγγράφων. Το αντικείμενο αρχικοποιείται έτσι ώστε όλες οι τιμές να ορίζονται σε 0 μονάδες χρήστη. |
| [CreateSVGTransform](../../aspose.svg/svgsvgelement/createsvgtransform/)() | Δημιουργεί ένα αντικείμενο SVGTransform εκτός οποιωνδήποτε δέντρων εγγράφων. Το αντικείμενο αρχικοποιείται σε μετασχηματισμό μήτρας ταυτότητας (SVG_TRANSFORM_MATRIX). |
...
| [UnpauseAnimations](../../aspose.svg/svgsvgelement/unpauseanimations/)() | Καταργεί την αναστολή (δηλαδή, καταργεί την παύση) κινούμενων εικόνων που εκτελούνται αυτήν τη στιγμή που ορίζονται στο τμήμα του εγγράφου SVG, με αποτέλεσμα το ρολόι της κινούμενης εικόνας να συνεχίσει από τη στιγμή που είχε ανασταλεί. |
