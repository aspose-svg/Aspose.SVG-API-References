---
title: "SVGTextPositioningElement Κλάση"
second_title: "Aspose.SVG για .NET API Αναφορά"
description: "Aspose.Svg.SVGTextPositioningElement κλάση. Η διεπαφή SVGTextPositioningElement κληρονομείται από τις διεπαφές σχετικές με κείμενο SVGTextElement SVGTSpanElement SVGTRefElement και SVGAltGlyphElement"
type: docs
weight: 5620
url: /el/net/aspose.svg/svgtextpositioningelement/
---
## SVGTextPositioningElement class

Η διεπαφή SVGTextPositioningElement κληρονομείται από διεπαφές σχετικές με κείμενο: SVGTextElement, SVGTSpanElement, SVGTRefElement και SVGAltGlyphElement.
...
| [Dx](../../aspose.svg/svgtextpositioningelement/dx/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘dx’ του δεδομένου στοιχείου. |
| [Dy](../../aspose.svg/svgtextpositioningelement/dy/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘dy’ του δεδομένου στοιχείου. |
...
| [Rotate](../../aspose.svg/svgtextpositioningelement/rotate/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘rotate’ του δεδομένου στοιχείου. |
...
| [X](../../aspose.svg/svgtextpositioningelement/x/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘x’ του δεδομένου στοιχείου. |
| [Y](../../aspose.svg/svgtextpositioningelement/y/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘y’ του δεδομένου στοιχείου. |
