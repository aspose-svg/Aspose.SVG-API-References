...
description: "Aspose.Svg.SVGRectElement κλάση. Η SVGRectElement διασύνδεση αντιστοιχεί στο στοιχείο rect"
type: docs
weight: 5490
url: /el/net/aspose.svg/svgrectelement/
---
...
| [Height](../../aspose.svg/svgrectelement/height/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘height’ του δεδομένου στοιχείου ‘rect’ |
...
| [PathLength](../../aspose.svg/svggeometryelement/pathlength/) { get; } | Αντιστοιχεί στο χαρακτηριστικό pathLength του δεδομένου στοιχείου. |
...
| [Rx](../../aspose.svg/svgrectelement/rx/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘rx’ του δεδομένου στοιχείου ‘rect’ |
| [Ry](../../aspose.svg/svgrectelement/ry/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘ry’ του δεδομένου στοιχείου ‘rect’ |
...
| [Width](../../aspose.svg/svgrectelement/width/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘width’ του δεδομένου στοιχείου ‘rect’ |
| [X](../../aspose.svg/svgrectelement/x/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘x’ του δεδομένου στοιχείου ‘rect’ |
| [Y](../../aspose.svg/svgrectelement/y/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘y’ του δεδομένου στοιχείου ‘rect’ |
...
| [Combine](../../aspose.svg/svggeometryelement/combine/)(*[SVGGeometryElement](../svggeometryelement/), [BooleanPathOp](../../aspose.svg.rendering/booleanpathop/)*) | Συνδυάζει αυτή τη γεωμετρία με άλλη γεωμετρία SVG χρησιμοποιώντας λογική πράξη και επιστρέφει ένα νέο στοιχείο `<path>` που περιέχει το αποτέλεσμα. |
...
| [GetEquivalentPath](../../aspose.svg/svggeometryelement/getequivalentpath/)() | Επιστρέφει μια νέα παρουσία του [`SVGPathSegList`](../../aspose.svg.paths/svgpathseglist/) που αντιπροσωπεύει το [`SVGGeometryElement`](../svggeometryelement/) ως τμήματα διαδρομής. |
...
| [GetPointAtLength](../../aspose.svg/svggeometryelement/getpointatlength/)(*float*) | Επιστρέφει τις συντεταγμένες (x,y) στο χώρο χρήστη που είναι μονάδες απόστασης κατά μήκος της διαδρομής, χρησιμοποιώντας τον αλγόριθμο distance‑along‑a‑path του πράκτορα χρήστη. |
...
| [GetTotalLength](../../aspose.svg/svggeometryelement/gettotallength/)() | Επιστρέφει την υπολογισμένη τιμή του πράκτορα χρήστη για το συνολικό μήκος της διαδρομής χρησιμοποιώντας τον αλγόριθμο distance‑along‑a‑path του πράκτορα χρήστη, ως απόσταση στο τρέχον σύστημα συντεταγμένων του χρήστη. |
