---
title: "Κλάση SVGPathSegMovetoRel"
second_title: "Aspose.SVG για .NET API Αναφορά"
description: "Aspose.Svg.Paths.SVGPathSegMovetoRel κλάση. Η διεπαφή SVGPathSegMovetoRel αντιστοιχεί σε μια σχετική εντολή δεδομένων διαδρομής moveto m."
type: docs
weight: 4760
url: /el/net/aspose.svg.paths/svgpathsegmovetorel/
---
## SVGPathSegMovetoRel class

Η διεπαφή SVGPathSegMovetoRel αντιστοιχεί σε μια "σχετική μετακίνηση" (m) εντολή δεδομένων διαδρομής.
...
| [X](../../aspose.svg.paths/svgpathsegmovetorel/x/) { get; set; } | Η σχετική συντεταγμένη X για το σημείο λήξης αυτού του τμήματος διαδρομής. |
| [Y](../../aspose.svg.paths/svgpathsegmovetorel/y/) { get; set; } | Η σχετική συντεταγμένη Y για το σημείο λήξης αυτού του τμήματος διαδρομής. |
