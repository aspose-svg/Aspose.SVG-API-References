...
description: Aspose.Svg.Paths.SVGPathSegCurvetoQuadraticSmoothRel τάξη. Η διεπαφή SVGPathSegCurvetoQuadraticSmoothRel αντιστοιχεί σε μια εντολή δεδομένων διαδρομής σχετικά ομαλή κυβική καμπύλη t.
type: docs
weight: 2600
url: /el/net/aspose.svg.paths/svgpathsegcurvetoquadraticsmoothrel/
---
## SVGPathSegCurvetoQuadraticSmoothRel class

Η διεπαφή SVGPathSegCurvetoQuadraticSmoothRel αντιστοιχεί σε μια εντολή δεδομένων διαδρομής "σχετικά ομαλή κυβική καμπύλη" (t).
...
| [X](../../aspose.svg.paths/svgpathsegcurvetoquadraticsmoothrel/x/) { get; set; } | Η σχετική συντεταγμένη X για το τελικό σημείο αυτού του τμήματος διαδρομής. |
| [Y](../../aspose.svg.paths/svgpathsegcurvetoquadraticsmoothrel/y/) { get; set; } | Η σχετική συντεταγμένη Y για το τελικό σημείο αυτού του τμήματος διαδρομής. |
