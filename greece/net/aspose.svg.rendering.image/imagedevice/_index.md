---
title: "Κλάση ImageDevice"
second_title: "Aspose.SVG για .NET API Αναφορά"
description: "Aspose.Svg.Rendering.Image.ImageDevice class. Αντιπροσωπεύει την απόδοση σε μορφές raster jpeg png bmp gif tiff"
type: docs
weight: 4910
...
| Όνομα | Περιγραφή |
| --- | --- |
| [ImageDevice](imagedevice/#constructor)(*[ICreateStreamProvider](../../aspose.svg.io/icreatestreamprovider/)*) | Αρχικοποιεί ένα νέο αντικείμενο της κλάσης `ImageDevice`. |
| [ImageDevice](imagedevice/#constructor_4)(*Stream*) | Αρχικοποιεί ένα νέο αντικείμενο της κλάσης `ImageDevice`. |
| [ImageDevice](imagedevice/#constructor_5)(*string*) | Αρχικοποιεί ένα νέο αντικείμενο της κλάσης `ImageDevice`. |
| [ImageDevice](imagedevice/#constructor_1)(*[ImageRenderingOptions](../imagerenderingoptions/), [ICreateStreamProvider](../../aspose.svg.io/icreatestreamprovider/)*) | Αρχικοποιεί ένα νέο αντικείμενο της κλάσης `ImageDevice` με επιλογές απόδοσης και πάροχο ροής. |
| [ImageDevice](imagedevice/#constructor_2)(*[ImageRenderingOptions](../imagerenderingoptions/), Stream*) | Αρχικοποιεί ένα νέο αντικείμενο της κλάσης `ImageDevice` με επιλογές απόδοσης και ροή εξόδου. |
| [ImageDevice](imagedevice/#constructor_3)(*[ImageRenderingOptions](../imagerenderingoptions/), string*) | Αρχικοποιεί ένα νέο αντικείμενο της κλάσης `ImageDevice` με επιλογές απόδοσης και όνομα αρχείου εξόδου. |
...
| Όνομα | Περιγραφή |
| --- | --- |
| class [ImageGraphicContext](../../aspose.svg.rendering.image/imagedevice.imagegraphiccontext) | Κρατά τις τρέχουσες παραμέτρους ελέγχου γραφικών για το `ImageDevice`. Αυτές οι παράμετροι ορίζουν το παγκόσμιο πλαίσιο μέσα στο οποίο εκτελούνται οι τελεστές γραφικών. |
