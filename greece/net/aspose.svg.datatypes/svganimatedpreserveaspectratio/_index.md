...
description: Aspose.Svg.DataTypes.SVGAnimatedPreserveAspectRatio τάξη. Χρησιμοποιείται για χαρακτηριστικά τύπου SVGPreserveAspectRatio που μπορούν να κινηθούν.
type: docs
weight: 170
url: /el/net/aspose.svg.datatypes/svganimatedpreserveaspectratio/
---
## SVGAnimatedPreserveAspectRatio class

Χρησιμοποιείται για χαρακτηριστικά τύπου SVGPreserveAspectRatio που μπορούν να κινηθούν.
...
| override [ToString](../../aspose.svg.datatypes/svganimatedpreserveaspectratio/tostring/)() | Επιστρέφει αString που αντιπροσωπεύει αυτήν την περίπτωση. |
