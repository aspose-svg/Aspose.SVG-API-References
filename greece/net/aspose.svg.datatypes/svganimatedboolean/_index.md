...
description: Aspose.Svg.DataTypes.SVGAnimatedBoolean τάξη. Χρησιμοποιείται για χαρακτηριστικά τύπου boolean που μπορούν να κινηθούν.
type: docs
weight: 100
url: /el/net/aspose.svg.datatypes/svganimatedboolean/
---
...
| override [ToString](../../aspose.svg.datatypes/svganimatedboolean/tostring/)() | Επιστρέφει αString που αντιπροσωπεύει αυτήν την περίπτωση. |
