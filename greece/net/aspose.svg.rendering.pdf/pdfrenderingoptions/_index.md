---
title: "PdfRenderingOptions Κλάση"
second_title: "Aspose.SVG για .NET API Αναφορά"
description: "Η κλάση Aspose.Svg.Rendering.Pdf.PdfRenderingOptions. Αντιπροσωπεύει τις επιλογές απόδοσης για το PdfDevice."
type: docs
weight: 5050
url: /el/net/aspose.svg.rendering.pdf/pdfrenderingoptions/
---
## PdfRenderingOptions class

Αντιπροσωπεύει τις επιλογές απόδοσης για το [`PdfDevice`](../pdfdevice/).
...
| Όνομα | Περιγραφή |
| --- | --- |
| [PdfRenderingOptions](pdfrenderingoptions/)() | Αρχικοποιεί ένα νέο στιγμιότυπο της κλάσης `PdfRenderingOptions`. |
...
| [DocumentInfo](../../aspose.svg.rendering.pdf/pdfrenderingoptions/documentinfo/) { get; } | Περιέχει πληροφορίες σχετικά με το έγγραφο PDF εξόδου. |
| [Encryption](../../aspose.svg.rendering.pdf/pdfrenderingoptions/encryption/) { get; set; } | Λαμβάνει ή ορίζει λεπτομέρειες κρυπτογράφησης. Εάν δεν οριστεί, δεν θα εκτελεστεί κρυπτογράφηση. |
| [FormFieldBehaviour](../../aspose.svg.rendering.pdf/pdfrenderingoptions/formfieldbehaviour/) { get; set; } | Καθορίζει τη συμπεριφορά των πεδίων φόρμας στο έγγραφο PDF εξόδου. |
...
| [IsTaggedPdf](../../aspose.svg.rendering.pdf/pdfrenderingoptions/istaggedpdf/) { get; set; } | Δημιουργεί μια δομή ετικετών εάν `true`. |
| [JpegQuality](../../aspose.svg.rendering.pdf/pdfrenderingoptions/jpegquality/) { get; set; } | Καθορίζει την ποιότητα της συμπίεσης JPEG για εικόνες (εάν χρησιμοποιείται συμπίεση JPEG). Η προεπιλογή είναι 95. |
