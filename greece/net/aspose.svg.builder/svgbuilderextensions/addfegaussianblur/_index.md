...
description: "Μέθοδος SVGBuilderExtensions AddFeGaussianBlur. Προσθέτει μια διαμόρφωση στοιχείου feGaussianBlur στον builder. Αυτό το στοιχείο εφαρμόζει θολό Gaussian στην εικόνα εισόδου."
type: docs
weight: 220
url: /el/net/aspose.svg.builder/svgbuilderextensions/addfegaussianblur/
---
## AddFeGaussianBlur<TBuilder>(*this TBuilder, Action&lt;SVGFEGaussianBlurElementBuilder&gt;*) {#addfegaussianblur_1}

Προσθέτει μια διαμόρφωση στοιχείου 'feGaussianBlur' στον δημιουργό. Αυτό το στοιχείο εφαρμόζει μια Γκαουσιανή θόλωση στην εισερχόμενη εικόνα.
...
| ρυθμίστε | Η ενέργεια διαμόρφωσης για το στοιχείο 'feGaussianBlur'. |
...
Προσθέτει ένα στοιχείο 'feGaussianBlur' στον δημιουργό SVG, εφαρμόζοντας ένα εφέ Γκαουσιανής θόλωσης στην εισερχόμενη εικόνα.
...
| builder | Η παρουσία του SVG builder στην οποία θα προστεθεί το στοιχείο 'feGaussianBlur'. |
| stdDeviation | Η τυπική απόκλιση για την λειτουργία θόλωσης. Μπορεί να είναι double ή ValueTuple δύο doubles. Προαιρετική παράμετρος. |
| in | Η εικόνα εισόδου στην οποία θα εφαρμοστεί το Gaussian blur. Μπορεί να είναι string ή FilterInput. Προαιρετική παράμετρος. |
...
| extend | Μια προαιρετική ενέργεια για περαιτέρω διαμόρφωση του SVGFEGaussianBlurElementBuilder. |
