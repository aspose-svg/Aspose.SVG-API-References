...
description: "Μέθοδος SVGBuilderExtensions AddFeOffset. Προσθέτει μια διαμόρφωση στοιχείου feOffset στον δημιουργό. Αυτό το στοιχείο μετατοπίζει την είσοδο εικόνας κατά ένα καθορισμένο διάνυσμα"
type: docs
weight: 260
url: /el/net/aspose.svg.builder/svgbuilderextensions/addfeoffset/
---
## AddFeOffset<TBuilder>(*this TBuilder, Action&lt;SVGFEOffsetElementBuilder&gt;*) {#addfeoffset}

Προσθέτει μια διαμόρφωση στοιχείου 'feOffset' στον δημιουργό. Αυτό το στοιχείο μετατοπίζει την εισερχόμενη εικόνα με έναν καθορισμένο διανύσματος.
...
| ρυθμίστε | Η ενέργεια διαμόρφωσης για το στοιχείο 'feOffset'. |
...
| builder | Το στιγμιότυπο του SVG builder στο οποίο θα προστεθεί το στοιχείο 'feOffset'. |
| dx | Η οριζόντια απόσταση μετατόπισης. Προαιρετική παράμετρος. |
| dy | Η κάθετη απόσταση μετατόπισης. Προαιρετική παράμετρος. |
| in | Η εικόνα εισόδου στην οποία θα εφαρμοστεί η μετατόπιση. Μπορεί να είναι συμβολοσειρά ή FilterInput. Προαιρετική παράμετρος. |
...
| extend | Μια προαιρετική ενέργεια για περαιτέρω διαμόρφωση του SVGFEOffsetElementBuilder. |
