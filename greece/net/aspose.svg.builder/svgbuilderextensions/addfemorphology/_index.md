...
description: "Μέθοδος SVGBuilderExtensions AddFeMorphology. Προσθέτει μια διαμόρφωση στοιχείου feMorphology στον builder. Αυτό το στοιχείο χρησιμοποιείται για την εφαρμογή μορφολογικών λειτουργιών όπως διάταση ή διάβρωση στην εικόνα εισόδου"
type: docs
weight: 250
url: /el/net/aspose.svg.builder/svgbuilderextensions/addfemorphology/
---
## AddFeMorphology<TBuilder>(*this TBuilder, Action&lt;SVGFEMorphologyElementBuilder&gt;*) {#addfemorphology}

Προσθέτει μια διαμόρφωση στοιχείου 'feMorphology' στον δημιουργό. Αυτό το στοιχείο χρησιμοποιείται για την εφαρμογή μορφολογικών λειτουργιών όπως η διεύρυνση ή η διάβρωση στην εισερχόμενη εικόνα.
...
| ρυθμίστε | Η ενέργεια διαμόρφωσης για το στοιχείο 'feMorphology'. |
...
Προσθέτει ένα στοιχείο 'feMorphology' στον δημιουργό SVG, εφαρμόζοντας μια μορφολογική λειτουργία στην εισερχόμενη εικόνα.
...
| builder | Το αντικείμενο δημιουργού SVG στο οποίο θα προστεθεί το στοιχείο 'feMorphology'. |
| τελεστής | Ο μορφολογικός τελεστής που θα εφαρμοστεί. Προαιρετική παράμετρος. |
| ακτίνα | Η ακτίνα για τη μορφολογική λειτουργία. Μπορεί να είναι δεκαδικός αριθμός ή ValueTuple από δύο δεκαδικούς αριθμούς. Προαιρετική παράμετρος. |
| in | Η εικόνα εισόδου στην οποία θα εφαρμοστεί η μορφολογική λειτουργία. Μπορεί να είναι συμβολοσειρά ή FilterInput. Προαιρετική παράμετρος. |
...
| extend | Μια προαιρετική ενέργεια για περαιτέρω διαμόρφωση του SVGFEMorphologyElementBuilder. |
