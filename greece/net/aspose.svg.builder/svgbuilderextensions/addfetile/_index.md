...
description: "SVGBuilderExtensions AddFeTile μέθοδος. Προσθέτει μια διαμόρφωση στοιχείου feTile στον κατασκευαστή. Αυτό το στοιχείο γεμίζει ένα ορθογώνιο με το επαναλαμβανόμενο μοτίβο πλακιδίων μιας εισαγόμενης εικόνας"
type: docs
weight: 280
url: /el/net/aspose.svg.builder/svgbuilderextensions/addfetile/
---
## AddFeTile<TBuilder>(*this TBuilder, Action&lt;SVGFETileElementBuilder&gt;*) {#addfetile_1}

Προσθέτει μια διαμόρφωση στοιχείου 'feTile' στον δημιουργό. Αυτό το στοιχείο γεμίζει ένα ορθογώνιο με το επαναλαμβανόμενο, πλακιδικό μοτίβο μιας εισερχόμενης εικόνας.
...
| ρυθμίστε | Η ενέργεια διαμόρφωσης για το στοιχείο 'feTile'. |
...
| builder | Η παρουσία του κατασκευαστή SVG στην οποία θα προστεθεί το στοιχείο 'feTile'. |
| in | Η εικόνα εισόδου που θα αντιγραφεί σε πλακίδια. Μπορεί να είναι συμβολοσειρά ή FilterInput. Προαιρετική παράμετρος. |
...
| extend | Μια προαιρετική ενέργεια για περαιτέρω διαμόρφωση του SVGFETileElementBuilder. |
