...
description: "SVGBuilderExtensions AddFeImage μέθοδος. Προσθέτει μια διαμόρφωση στοιχείου feImage στον builder. Αυτό το στοιχείο ανακτά μια εξωτερική εικόνα και την περιλαμβάνει στη σειρά φίλτρων."
type: docs
weight: 230
url: /el/net/aspose.svg.builder/svgbuilderextensions/addfeimage/
---
## AddFeImage<TBuilder>(*this TBuilder, Action&lt;SVGFEImageElementBuilder&gt;*) {#addfeimage}

Προσθέτει μια διαμόρφωση στοιχείου 'feImage' στον δημιουργό. Αυτό το στοιχείο ανακτά μια εξωτερική εικόνα και την ενσωματώνει στην αλυσίδα φίλτρων.
...
| ρυθμίστε | Η ενέργεια διαμόρφωσης για το στοιχείο 'feImage'. |
...
Προσθέτει ένα στοιχείο 'feImage' στον δημιουργό SVG, ενσωματώνοντας μια εξωτερική εικόνα στο εφέ του φίλτρου.
...
| builder | Η παρουσία του SVG builder στην οποία θα προστεθεί το στοιχείο 'feImage'. |
...
| extend | Μια προαιρετική ενέργεια για περαιτέρω διαμόρφωση του SVGFEImageElementBuilder. |
