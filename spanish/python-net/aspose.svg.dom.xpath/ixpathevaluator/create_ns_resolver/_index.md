...
type: docs
weight: 30
url: /es/python-net/aspose.svg.dom.xpath/ixpathevaluator/create_ns_resolver/
is_root: false
---
...
[`IXPathNSResolver`](/svg/python-net/aspose.svg.dom.xpath/ixpathnsresolver) which resolves namespaces with respect to the definitions
...
| :- | :- | :- |
| node_resolver | [`Node`](/svg/python-net/aspose.svg.dom/node) | The node to be used as a context for namespace resolution. |
