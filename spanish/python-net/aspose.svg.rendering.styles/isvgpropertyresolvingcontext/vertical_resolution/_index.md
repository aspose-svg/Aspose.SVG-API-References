...
type: docs
weight: 150
url: /es/python-net/aspose.svg.rendering.styles/isvgpropertyresolvingcontext/vertical_resolution/
is_root: false
---
...
Gets the vertical resolution of the context. See [`Resolution`](/svg/python-net/aspose.svg.drawing/resolution).
### Definition:
```python
@property
