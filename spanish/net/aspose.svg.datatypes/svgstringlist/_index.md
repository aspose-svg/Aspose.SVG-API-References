...
description: Aspose.Svg.DataTypes.SVGStringList clase. SVGStringList tiene los mismos atributos y métodos que otras interfaces SVGxxxList. Los implementadores pueden considerar el uso de una sola clase base para implementar las diversas interfaces SVGxxxList.
type: docs
weight: 310
...
| Nombre | Descripción |
| --- | --- |
| [SVGStringList](svgstringlist/#constructor)() | Inicializa una nueva instancia del`SVGStringList` clase. |
| [SVGStringList](svgstringlist/#constructor_1)(IEnumerable&lt;string&gt;) | Inicializa una nueva instancia del`SVGStringList` clase. |
