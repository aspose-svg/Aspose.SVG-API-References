...
description: AMutationObserver./mutationobserver El objeto se puede utilizar para observar mutaciones en el árbol deNode../aspose.svg.dom/node .
type: docs
weight: 1120
...
A[`MutationObserver`](../mutationobserver) El objeto se puede utilizar para observar mutaciones en el árbol de[`Node`](../../aspose.svg.dom/node) .
