...
description: Aspose.Svg.SVGStyleElement clase. La interfaz SVGStyleElement corresponde al elemento estilo.
type: docs
weight: 3480
url: /es/net/aspose.svg/svgstyleelement/
---
...
| [Media](../../aspose.svg/svgstyleelement/media/) { get; set; } | Corresponde al atributo 'medios' en el elemento dado. |
...
| [Sheet](../../aspose.svg/svgstyleelement/sheet/) { get; } | Obtiene la hoja de estilo asociada. |
...
| [Title](../../aspose.svg/svgstyleelement/title/) { get; set; } | Corresponde al atributo 'título' en el elemento dado. |
| [Type](../../aspose.svg/svgstyleelement/type/) { get; set; } | Corresponde al atributo 'tipo' en el elemento dado. |
