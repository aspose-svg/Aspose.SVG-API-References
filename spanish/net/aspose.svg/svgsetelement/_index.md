...
description: Aspose.Svg.SVGSetElement clase. La interfaz SVGSetElement corresponde al elemento set. El acceso orientado a objetos a los atributos del elemento set a través del DOM SVG no está disponible.
type: docs
weight: 3460
url: /es/net/aspose.svg/svgsetelement/
---
## SVGSetElement class
