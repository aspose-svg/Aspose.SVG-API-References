...
description: Aspose.Svg.SVGMaskElement clase. La interfaz SVGMaskElement corresponde al elemento máscara.
type: docs
weight: 3350
url: /es/net/aspose.svg/svgmaskelement/
---
...
| [Height](../../aspose.svg/svgmaskelement/height/) { get; } | Corresponde al atributo 'altura' en el elemento 'máscara' dado. Toma una de las constantes definidas en SVGUnitTypes. |
...
| [MaskContentUnits](../../aspose.svg/svgmaskelement/maskcontentunits/) { get; } | Corresponde al atributo 'maskContentUnits' en el elemento 'mask' dado. Toma una de las constantes definidas en SVGUnitTypes. |
| [MaskUnits](../../aspose.svg/svgmaskelement/maskunits/) { get; } | Corresponde al atributo 'maskUnits' en el elemento 'mask' dado. Toma una de las constantes definidas en SVGUnitTypes. |
...
| [RequiredExtensions](../../aspose.svg/svgmaskelement/requiredextensions/) { get; } | Corresponde al atributo 'extensiones requeridas' en el elemento dado. |
| [RequiredFeatures](../../aspose.svg/svgmaskelement/requiredfeatures/) { get; } | Corresponde al atributo 'requiredFeatures' en el elemento dado. |
...
| [SystemLanguage](../../aspose.svg/svgmaskelement/systemlanguage/) { get; } | Corresponde al atributo 'systemLanguage' en el elemento dado. |
...
| [Width](../../aspose.svg/svgmaskelement/width/) { get; } | Corresponde al atributo 'ancho' en el elemento 'máscara' dado. Toma una de las constantes definidas en SVGUnitTypes. |
| [X](../../aspose.svg/svgmaskelement/x/) { get; } | Corresponde al atributo 'x' en el elemento 'máscara' dado. Toma una de las constantes definidas en SVGUnitTypes. |
| [Y](../../aspose.svg/svgmaskelement/y/) { get; } | Corresponde al atributo 'y' en el elemento 'máscara' dado. Toma una de las constantes definidas en SVGUnitTypes. |
