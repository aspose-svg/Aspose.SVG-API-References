...
description: Aspose.Svg.SVGComponentTransferFunctionElement clase. Esta interfaz define una interfaz base utilizada por las interfaces de la función de transferencia de componentes.
type: docs
weight: 3150
url: /es/net/aspose.svg/svgcomponenttransferfunctionelement/
---
...
| Nombre | Descripción |
| --- | --- |
| [Amplitude](../../aspose.svg/svgcomponenttransferfunctionelement/amplitude/) { get; } | Corresponde al atributo 'amplitud' en el elemento dado. |
...
| [Exponent](../../aspose.svg/svgcomponenttransferfunctionelement/exponent/) { get; } | Corresponde al atributo 'exponente' en el elemento dado. |
...
| [Intercept](../../aspose.svg/svgcomponenttransferfunctionelement/intercept/) { get; } | Corresponde al atributo 'intercepción' en el elemento dado. |
...
| [Offset](../../aspose.svg/svgcomponenttransferfunctionelement/offset/) { get; } | Corresponde al atributo 'desplazamiento' en el elemento dado. |
...
| [Slope](../../aspose.svg/svgcomponenttransferfunctionelement/slope/) { get; } | Corresponde al atributo 'pendiente' en el elemento dado. |
...
| [TableValues](../../aspose.svg/svgcomponenttransferfunctionelement/tablevalues/) { get; } | Corresponde al atributo 'tableValues' en el elemento dado. |
...
| [Type](../../aspose.svg/svgcomponenttransferfunctionelement/type/) { get; } | Corresponde al atributo 'tipo' en el elemento dado. Toma una de las constantes SVG_FECOMPONENTTRANSFER_TYPE_* definidas en esta interfaz. |
...
| Nombre | Descripción |
| --- | --- |
| const [SVG_FECOMPONENTTRANSFER_TYPE_DISCRETE](../../aspose.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_discrete/) | Corresponde al valor 'discreto'. |
| const [SVG_FECOMPONENTTRANSFER_TYPE_GAMMA](../../aspose.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_gamma/) | Corresponde al valor 'gamma'. |
| const [SVG_FECOMPONENTTRANSFER_TYPE_IDENTITY](../../aspose.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_identity/) | Corresponde al valor 'identidad'. |
| const [SVG_FECOMPONENTTRANSFER_TYPE_LINEAR](../../aspose.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_linear/) | Corresponde al valor 'lineal'. |
| const [SVG_FECOMPONENTTRANSFER_TYPE_TABLE](../../aspose.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_table/) | Corresponde al valor 'tabla'. |
| const [SVG_FECOMPONENTTRANSFER_TYPE_UNKNOWN](../../aspose.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_unknown/) | El tipo no es uno de los tipos predefinidos. No es válido intentar definir un nuevo valor de este tipo o intentar cambiar un valor existente a este tipo. |
