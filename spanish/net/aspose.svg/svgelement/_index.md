...
description: Aspose.Svg.SVGElement clase. Todas las interfaces SVGDOM que corresponden directamente a elementos en el lenguaje SVG como la interfaz SVGPathElement para el elemento ruta se derivan de la interfaz SVGElement.
type: docs
weight: 3200
url: /es/net/aspose.svg/svgelement/
---
## SVGElement class
