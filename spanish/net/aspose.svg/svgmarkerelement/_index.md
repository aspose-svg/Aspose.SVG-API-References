...
description: Aspose.Svg.SVGMarkerElement clase. La interfaz SVGMarkerElement corresponde al elemento marcador.
type: docs
weight: 3340
url: /es/net/aspose.svg/svgmarkerelement/
---
...
| [MarkerHeight](../../aspose.svg/svgmarkerelement/markerheight/) { get; } | Corresponde al atributo 'markerHeight' en el elemento 'marker' dado. |
| [MarkerUnits](../../aspose.svg/svgmarkerelement/markerunits/) { get; } | Corresponde al atributo 'markerUnits' en el elemento 'marker' dado. Uno de los tipos de unidad de marcador definidos en esta interfaz. |
| [MarkerWidth](../../aspose.svg/svgmarkerelement/markerwidth/) { get; } | Corresponde al atributo 'markerWidth' en el elemento 'marker' dado. |
...
| [OrientAngle](../../aspose.svg/svgmarkerelement/orientangle/) { get; } | Corresponde al atributo 'orientar' en el elemento 'marcador' dado. Si markerUnits es SVG_MARKER_ORIENT_ANGLE, el valor del ángulo para el atributo 'orientar'; de lo contrario, se establecerá en cero. |
| [OrientType](../../aspose.svg/svgmarkerelement/orienttype/) { get; } | Corresponde al atributo 'orientar' en el elemento 'marcador' dado. Uno de los tipos de orientación de marcador definidos en esta interfaz. |
...
| [PreserveAspectRatio](../../aspose.svg/svgmarkerelement/preserveaspectratio/) { get; } | Corresponde al atributo 'preserveAspectRatio' en el elemento dado. |
...
| [RefX](../../aspose.svg/svgmarkerelement/refx/) { get; } | Corresponde al atributo 'refX' en el elemento 'marcador' dado. |
| [RefY](../../aspose.svg/svgmarkerelement/refy/) { get; } | Corresponde al atributo 'refY' en el elemento 'marcador' dado. |
...
| [ViewBox](../../aspose.svg/svgmarkerelement/viewbox/) { get; } | Corresponde al atributo 'viewBox' en el elemento dado. |
...
| [SetOrientToAngle](../../aspose.svg/svgmarkerelement/setorienttoangle/)(SVGAngle) | Establece el valor del atributo 'orientar' al ángulo dado. |
| [SetOrientToAuto](../../aspose.svg/svgmarkerelement/setorienttoauto/)() | Establece el valor del atributo 'orientar' en 'auto'. |
...
| Nombre | Descripción |
| --- | --- |
| const [SVG_MARKERUNITS_STROKEWIDTH](../../aspose.svg/svgmarkerelement/svg_markerunits_strokewidth/) | El valor del atributo 'markerUnits' es 'strokeWidth'. |
| const [SVG_MARKERUNITS_UNKNOWN](../../aspose.svg/svgmarkerelement/svg_markerunits_unknown/) | El tipo de unidad de marcador no es uno de los tipos predefinidos. No es válido intentar definir un nuevo valor de este tipo o intentar cambiar un valor existente a este tipo. |
| const [SVG_MARKERUNITS_USERSPACEONUSE](../../aspose.svg/svgmarkerelement/svg_markerunits_userspaceonuse/) | El valor del atributo 'markerUnits' es 'userSpaceOnUse'. |
| const [SVG_MARKER_ORIENT_ANGLE](../../aspose.svg/svgmarkerelement/svg_marker_orient_angle/) | El atributo 'orientar' tiene un valor de ángulo. |
| const [SVG_MARKER_ORIENT_AUTO](../../aspose.svg/svgmarkerelement/svg_marker_orient_auto/) | El atributo 'orient' tiene el valor 'auto'. |
| const [SVG_MARKER_ORIENT_UNKNOWN](../../aspose.svg/svgmarkerelement/svg_marker_orient_unknown/) | La orientación del marcador no es uno de los tipos predefinidos. No es válido intentar definir un nuevo valor de este tipo o intentar cambiar un valor existente a este tipo. |
