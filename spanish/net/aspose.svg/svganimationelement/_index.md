...
description: Aspose.Svg.SVGAnimationElement clase. La interfaz SVGAnimationElement es la interfaz base para todas las interfaces de elementos de animación SVGAnimateElement SVGSetElement SVGAnimateColorElement SVGAnimateMotionElement y SVGAnimateTransformElement.
type: docs
weight: 3120
url: /es/net/aspose.svg/svganimationelement/
---
...
| [RequiredExtensions](../../aspose.svg/svganimationelement/requiredextensions/) { get; } | Corresponde al atributo 'extensiones requeridas' en el elemento dado. |
| [RequiredFeatures](../../aspose.svg/svganimationelement/requiredfeatures/) { get; } | Corresponde al atributo 'requiredFeatures' en el elemento dado. |
...
| [SystemLanguage](../../aspose.svg/svganimationelement/systemlanguage/) { get; } | Corresponde al atributo 'systemLanguage' en el elemento dado. |
| [TagName](../../aspose.svg.dom/element/tagname/) { get; } | El nombre del elemento. |
| [TargetElement](../../aspose.svg/svganimationelement/targetelement/) { get; } | El elemento que se está animando. |
