...
| [Save](../../aspose.svg/svgdocument/save/#save_6)(string) | Guarda el documento en el archivo local especificado por`camino` . Todos los recursos utilizados en este documento se guardarán en en la carpeta adyacente, cuyo nombre se construirá como: nombre_archivo_salida + "_archivos". |
...
| [Save](../../aspose.svg/svgdocument/save/#save_7)(string, SVGSaveFormat) | Guarda el documento en el archivo local especificado por`camino` . Todos los recursos utilizados en este documento se guardarán en en la carpeta adyacente, cuyo nombre se construirá como: nombre_archivo_salida + "_archivos". |
| [Save](../../aspose.svg/svgdocument/save/#save_8)(string, SVGSaveOptions) | Guarda el documento en el archivo local especificado por`camino` . Todos los recursos utilizados en este documento se guardarán en en la carpeta adyacente, cuyo nombre se construirá como: nombre_archivo_salida + "_archivos". |
