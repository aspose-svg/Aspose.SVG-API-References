...
description: Aspose.Svg.SVGViewElement clase. La interfaz SVGViewElement corresponde al elemento vista.
type: docs
weight: 3590
url: /es/net/aspose.svg/svgviewelement/
---
...
| [PreserveAspectRatio](../../aspose.svg/svgviewelement/preserveaspectratio/) { get; } | Corresponde al atributo 'preserveAspectRatio' en el elemento dado. |
...
| [ViewBox](../../aspose.svg/svgviewelement/viewbox/) { get; } | Corresponde al atributo 'viewBox' en el elemento dado. |
...
| [ViewTarget](../../aspose.svg/svgviewelement/viewtarget/) { get; } | Corresponde al atributo 'viewTarget' en el elemento 'view' dado. Una lista de valores DOMString que contienen los nombres enumerados en el atributo 'viewTarget'. Cada uno de los valores de DOMString se puede asociar con el elemento correspondiente mediante la llamada al método getElementById(). |
| [ZoomAndPan](../../aspose.svg/svgviewelement/zoomandpan/) { get; set; } | Corresponde al atributo 'zoomAndPan' en el elemento dado. El valor debe ser una de las constantes SVG_ZOOMANDPAN_* definidas en esta interfaz. |
