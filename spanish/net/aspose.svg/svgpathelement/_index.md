...
description: Aspose.Svg.SVGPathElement clase. La interfaz SVGPathElement corresponde al elemento ruta.
type: docs
weight: 3370
url: /es/net/aspose.svg/svgpathelement/
---
...
| [PathLength](../../aspose.svg/svggeometryelement/pathlength/) { get; } | Corresponde al atributo pathLength en el elemento dado. |
| [PathSegList](../../aspose.svg/svgpathelement/pathseglist/) { get; set; } | Proporciona acceso al contenido base (es decir, estático) del atributo 'd' en una forma que coincide uno a uno con la sintaxis de SVG. Por lo tanto, si el atributo 'd' tiene un comando "absolute moveto (M)" y "absolute arcto (A)", entonces pathSegList tendrá dos entradas: un SVG_PATHSEG_MOVETO_ABS y un SVG_PATHSEG_ARC_ABS. |
...
| [CreateSVGPathSegArcAbs](../../aspose.svg/svgpathelement/createsvgpathsegarcabs/)(float, float, float, float, float, bool, bool) | Devuelve un objeto SVGPathSegArcAbs independiente y sin padres. |
| [CreateSVGPathSegArcRel](../../aspose.svg/svgpathelement/createsvgpathsegarcrel/)(float, float, float, float, float, bool, bool) | Devuelve un objeto SVGPathSegArcRel independiente y sin padres. |
| [CreateSVGPathSegClosePath](../../aspose.svg/svgpathelement/createsvgpathsegclosepath/)() | Devuelve un objeto SVGPathSegClosePath independiente y sin padres. |
| [CreateSVGPathSegCurvetoCubicAbs](../../aspose.svg/svgpathelement/createsvgpathsegcurvetocubicabs/)(float, float, float, float, float, float) | Devuelve un objeto SVGPathSegCurvetoCubicAbs independiente y sin padres. |
| [CreateSVGPathSegCurvetoCubicRel](../../aspose.svg/svgpathelement/createsvgpathsegcurvetocubicrel/)(float, float, float, float, float, float) | Devuelve un objeto SVGPathSegCurvetoCubicRel independiente y sin padres. |
| [CreateSVGPathSegCurvetoCubicSmoothAbs](../../aspose.svg/svgpathelement/createsvgpathsegcurvetocubicsmoothabs/)(float, float, float, float) | Devuelve un objeto SVGPathSegCurvetoCubicSmoothAbs independiente y sin padres. |
| [CreateSVGPathSegCurvetoCubicSmoothRel](../../aspose.svg/svgpathelement/createsvgpathsegcurvetocubicsmoothrel/)(float, float, float, float) | Devuelve un objeto SVGPathSegCurvetoCubicSmoothRel independiente y sin padre. |
| [CreateSVGPathSegCurvetoQuadraticAbs](../../aspose.svg/svgpathelement/createsvgpathsegcurvetoquadraticabs/)(float, float, float, float) | Devuelve un objeto SVGPathSegCurvetoQuadraticAbs independiente y sin padre. |
| [CreateSVGPathSegCurvetoQuadraticRel](../../aspose.svg/svgpathelement/createsvgpathsegcurvetoquadraticrel/)(float, float, float, float) | Devuelve un objeto SVGPathSegCurvetoQuadraticRel independiente y sin padres. |
| [CreateSVGPathSegCurvetoQuadraticSmoothAbs](../../aspose.svg/svgpathelement/createsvgpathsegcurvetoquadraticsmoothabs/)(float, float) | Devuelve un objeto SVGPathSegCurvetoQuadraticSmoothAbs independiente y sin padre. |
| [CreateSVGPathSegCurvetoQuadraticSmoothRel](../../aspose.svg/svgpathelement/createsvgpathsegcurvetoquadraticsmoothrel/)(float, float) | Devuelve un objeto SVGPathSegCurvetoQuadraticSmoothRel independiente y sin padre. |
| [CreateSVGPathSegLinetoAbs](../../aspose.svg/svgpathelement/createsvgpathseglinetoabs/)(float, float) | Devuelve un objeto SVGPathSegLinetoAbs independiente y sin padres. |
| [CreateSVGPathSegLinetoHorizontalAbs](../../aspose.svg/svgpathelement/createsvgpathseglinetohorizontalabs/)(float) | Devuelve un objeto SVGPathSegLinetoHorizontalAbs independiente y sin padre. |
| [CreateSVGPathSegLinetoHorizontalRel](../../aspose.svg/svgpathelement/createsvgpathseglinetohorizontalrel/)(float) | Devuelve un objeto SVGPathSegLinetoHorizontalRel independiente y sin padre. |
| [CreateSVGPathSegLinetoRel](../../aspose.svg/svgpathelement/createsvgpathseglinetorel/)(float, float) | Devuelve un objeto SVGPathSegLinetoRel independiente y sin padre. |
| [CreateSVGPathSegLinetoVerticalAbs](../../aspose.svg/svgpathelement/createsvgpathseglinetoverticalabs/)(float) | Devuelve un objeto SVGPathSegLinetoVerticalAbs independiente y sin padres. |
| [CreateSVGPathSegLinetoVerticalRel](../../aspose.svg/svgpathelement/createsvgpathseglinetoverticalrel/)(float) | Devuelve un objeto SVGPathSegLinetoVerticalRel independiente y sin padres. |
| [CreateSVGPathSegMovetoAbs](../../aspose.svg/svgpathelement/createsvgpathsegmovetoabs/)(float, float) | Devuelve un objeto SVGPathSegMovetoAbs independiente y sin padres. |
| [CreateSVGPathSegMovetoRel](../../aspose.svg/svgpathelement/createsvgpathsegmovetorel/)(float, float) | Devuelve un objeto SVGPathSegMovetoRel independiente y sin padres. |
...
| [GetEquivalentPath](../../aspose.svg/svggeometryelement/getequivalentpath/)() | Devuelve una nueva instancia instancia del[`SVGPathSegList`](../../aspose.svg.paths/svgpathseglist/) que representa[`SVGGeometryElement`](../svggeometryelement/) como segmentos de ruta. |
...
| [GetPointAtLength](../../aspose.svg/svggeometryelement/getpointatlength/)(float) | Devuelve la coordenada (x,y) en el espacio del usuario, que son unidades de distancia a lo largo de la ruta, utilizando el algoritmo de distancia a lo largo de una ruta del agente de usuario. |
...
| [GetTotalLength](../../aspose.svg/svggeometryelement/gettotallength/)() | Devuelve el valor calculado por el agente de usuario para la longitud total de la ruta usando el algoritmo de distancia a lo largo de un camino del agente de usuario, como una distancia en el sistema de coordenadas del usuario actual. |
