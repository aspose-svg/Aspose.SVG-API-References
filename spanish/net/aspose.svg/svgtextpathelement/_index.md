...
description: Aspose.Svg.SVGTextPathElement clase. La interfaz SVGTextPathElement corresponde al elemento textPath.
type: docs
weight: 3540
url: /es/net/aspose.svg/svgtextpathelement/
---
...
| [Href](../../aspose.svg/svgtextpathelement/href/) { get; } | Corresponde al atributo 'xlink:href' en el elemento dado. |
...
| [LengthAdjust](../../aspose.svg/svgtextcontentelement/lengthadjust/) { get; } | Corresponde al atributo 'lengthAdjust' en el elemento dado. El valor debe ser una de las constantes de ajuste de longitud definidas en esta interfaz. |
...
| [Method](../../aspose.svg/svgtextpathelement/method/) { get; } | Corresponde al atributo 'método' en el elemento 'textPath' dado. |
...
| [Spacing](../../aspose.svg/svgtextpathelement/spacing/) { get; } | Corresponde al atributo 'espaciado' en el elemento 'textPath' dado. |
| [StartOffset](../../aspose.svg/svgtextpathelement/startoffset/) { get; } | Corresponde al atributo 'startOffset' en el elemento 'textPath' dado. |
...
| [TextLength](../../aspose.svg/svgtextcontentelement/textlength/) { get; } | Corresponde al atributo 'textLength' en el elemento dado. |
...
| [GetComputedTextLength](../../aspose.svg/svgtextcontentelement/getcomputedtextlength/)() | La suma total de todos los valores de avance de la representación de todos los caracteres dentro de este elemento, incluido el valor de avance en los glifos (horizontal o vertical), el efecto de las propiedades 'kerning', 'letter-spacing' y 'word- espaciado' y ajustes debido a los atributos 'dx' y 'dy' en los elementos 'tspan'. Para entornos que no son de representación, el agente de usuario deberá hacer suposiciones razonables sobre las métricas de glifos. |
...
| Nombre | Descripción |
| --- | --- |
| const [TEXTPATH_METHODTYPE_ALIGN](../../aspose.svg/svgtextpathelement/textpath_methodtype_align/) | Corresponde al valor 'alinear'. |
| const [TEXTPATH_METHODTYPE_STRETCH](../../aspose.svg/svgtextpathelement/textpath_methodtype_stretch/) | Corresponde al valor 'estiramiento'. |
| const [TEXTPATH_METHODTYPE_UNKNOWN](../../aspose.svg/svgtextpathelement/textpath_methodtype_unknown/) | La enumeración se estableció en un valor que no es uno de los tipos predefinidos. No es válido intentar definir un nuevo valor de este tipo o intentar cambiar un valor existente a este tipo. |
| const [TEXTPATH_SPACINGTYPE_AUTO](../../aspose.svg/svgtextpathelement/textpath_spacingtype_auto/) | Corresponde al valor 'auto'. |
| const [TEXTPATH_SPACINGTYPE_EXACT](../../aspose.svg/svgtextpathelement/textpath_spacingtype_exact/) | Corresponde al valor 'exacto'. |
| const [TEXTPATH_SPACINGTYPE_UNKNOWN](../../aspose.svg/svgtextpathelement/textpath_spacingtype_unknown/) | La enumeración se estableció en un valor que no es uno de los tipos predefinidos. No es válido intentar definir un nuevo valor de este tipo o intentar cambiar un valor existente a este tipo. |
