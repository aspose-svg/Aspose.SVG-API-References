...
description: Aspose.Svg.SVGPatternElement clase. La interfaz SVGPatternElement corresponde al elemento patrón.
type: docs
weight: 3380
url: /es/net/aspose.svg/svgpatternelement/
---
...
| [Height](../../aspose.svg/svgpatternelement/height/) { get; } | Corresponde al atributo 'altura' en el elemento 'patrón' dado. |
| [Href](../../aspose.svg/svgpatternelement/href/) { get; } | Corresponde al atributo 'xlink:href' en el elemento dado. |
...
| [PatternContentUnits](../../aspose.svg/svgpatternelement/patterncontentunits/) { get; } | Corresponde al atributo 'patternContentUnits' en el elemento 'pattern' dado. Toma una de las constantes definidas en SVGUnitTypes. |
| [PatternTransform](../../aspose.svg/svgpatternelement/patterntransform/) { get; } | Corresponde al atributo 'patternTransform' en el elemento 'pattern' dado. |
| [PatternUnits](../../aspose.svg/svgpatternelement/patternunits/) { get; } | Corresponde al atributo 'patternUnits' en el elemento 'pattern' dado. Toma una de las constantes definidas en SVGUnitTypes. |
...
| [PreserveAspectRatio](../../aspose.svg/svgpatternelement/preserveaspectratio/) { get; } | Corresponde al atributo 'preserveAspectRatio' en el elemento dado. |
...
| [RequiredExtensions](../../aspose.svg/svgpatternelement/requiredextensions/) { get; } | Corresponde al atributo 'extensiones requeridas' en el elemento dado. |
| [RequiredFeatures](../../aspose.svg/svgpatternelement/requiredfeatures/) { get; } | Corresponde al atributo 'requiredFeatures' en el elemento dado. |
...
| [SystemLanguage](../../aspose.svg/svgpatternelement/systemlanguage/) { get; } | Corresponde al atributo 'systemLanguage' en el elemento dado. |
...
| [ViewBox](../../aspose.svg/svgpatternelement/viewbox/) { get; } | Corresponde al atributo 'viewBox' en el elemento dado. |
...
| [Width](../../aspose.svg/svgpatternelement/width/) { get; } | Corresponde al atributo 'ancho' en el elemento 'patrón' dado. |
| [X](../../aspose.svg/svgpatternelement/x/) { get; } | Corresponde al atributo 'x' en el elemento 'patrón' dado. |
| [Y](../../aspose.svg/svgpatternelement/y/) { get; } | Corresponde al atributo 'y' en el elemento 'patrón' dado. |
