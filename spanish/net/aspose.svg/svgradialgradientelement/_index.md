...
description: Aspose.Svg.SVGRadialGradientElement clase. La interfaz SVGRadialGradientElement corresponde al elemento radialGradient.
type: docs
weight: 3410
url: /es/net/aspose.svg/svgradialgradientelement/
---
...
| [Cx](../../aspose.svg/svgradialgradientelement/cx/) { get; } | Corresponde al atributo 'cx' en el elemento 'radialGradient' dado. |
| [Cy](../../aspose.svg/svgradialgradientelement/cy/) { get; } | Corresponde al atributo 'cy' en el elemento 'radialGradient' dado. |
...
| [Fr](../../aspose.svg/svgradialgradientelement/fr/) { get; } | Corresponde al atributo 'fr' en el elemento 'radialGradient' dado. |
| [Fx](../../aspose.svg/svgradialgradientelement/fx/) { get; } | Corresponde al atributo 'fx' en el elemento 'radialGradient' dado. |
| [Fy](../../aspose.svg/svgradialgradientelement/fy/) { get; } | Corresponde al atributo 'fy' en el elemento 'radialGradient' dado. |
| [GradientTransform](../../aspose.svg/svggradientelement/gradienttransform/) { get; } | Corresponde al atributo 'gradientTransform' en el elemento dado. |
| [GradientUnits](../../aspose.svg/svggradientelement/gradientunits/) { get; } | Corresponde al atributo 'gradientUnits' en el elemento dado. Toma una de las constantes definidas en SVGUnitTypes. |
| [Href](../../aspose.svg/svggradientelement/href/) { get; } | Corresponde al atributo 'xlink:href' en el elemento dado. |
...
| [R](../../aspose.svg/svgradialgradientelement/r/) { get; } | Corresponde al atributo 'r' en el elemento 'radialGradient' dado. |
...
| [SpreadMethod](../../aspose.svg/svggradientelement/spreadmethod/) { get; } | Corresponde al atributo 'spreadMethod' en el elemento dado. Uno de los tipos de métodos de propagación definidos en esta interfaz. |
