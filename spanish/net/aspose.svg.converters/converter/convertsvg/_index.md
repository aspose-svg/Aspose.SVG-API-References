...
description: Converter método. Convertir fuente svg a pdf. El resultado es un archivo pdf.
type: docs
weight: 10
url: /es/net/aspose.svg.converters/converter/convertsvg/
---
...
* class [Converter](../)
* espacio de nombres [Aspose.Svg.Converters](../../converter/)
* asamblea [Aspose.SVG](../../../)
...
| options | PdfSaveOptions | Opciones de conversión. |
| provider | ICreateStreamProvider | Implementacion de[`ICreateStreamProvider`](../../../aspose.svg.io/icreatestreamprovider/)interfaz, que se utilizará para obtener un flujo de salida. |
