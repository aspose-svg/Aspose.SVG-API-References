...
description: Aspose.Svg.Dom.XPath.IXPathResult interfaz. ElXPathResult La interfaz representa el resultado de la evaluación de una expresión XPath 1.0 dentro del contexto de un nodo en particular. Dado que la evaluación de una expresión XPath puede generar varios tipos de resultados este objeto hace posible descubrir y manipular el tipo y el valor del resultado.
type: docs
weight: 1350
