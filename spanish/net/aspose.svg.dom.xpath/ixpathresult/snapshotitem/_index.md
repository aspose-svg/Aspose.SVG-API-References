...
| excepción | condición |
| --- | --- |
| [DOMException](../../../aspose.svg.dom/domexception) | TYPE_ERR: planteado si`tipo de resultado` no es `Instantánea de nodo desordenado` tipo o`Instantánea de nodo ordenado` escribe. |
