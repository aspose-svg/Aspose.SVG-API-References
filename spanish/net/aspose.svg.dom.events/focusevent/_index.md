...
description: Aspose.Svg.Dom.Events.FocusEvent clase. La interfaz FocusEvent proporciona información contextual específica asociada con eventos Focus.
type: docs
weight: 930
url: /es/net/aspose.svg.dom.events/focusevent/
---
## FocusEvent class
...
| [RelatedTarget](../../aspose.svg.dom.events/focusevent/relatedtarget/) { get; } | Se utiliza para identificar un EventTarget secundario relacionado con un evento Focus, según el tipo de evento. |
