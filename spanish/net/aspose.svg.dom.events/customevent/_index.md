...
description: Aspose.Svg.Dom.Events.CustomEvent clase. Los eventos que usan la interfaz CustomEvent se pueden usar para transportar datos personalizados.
type: docs
weight: 880
url: /es/net/aspose.svg.dom.events/customevent/
---
## CustomEvent class
...
| [Detail](../../aspose.svg.dom.events/customevent/detail/) { get; } | Obtiene los datos personalizados. |
...
| [InitCustomEvent](../../aspose.svg.dom.events/customevent/initcustomevent/)(string, bool, bool, object) | /// El[`InitEvent`](../event/initevent/) El método se utiliza para inicializar el valor de un[`Event`](../event/) creado a través de la[`IDocumentEvent`](../idocumentevent/) interfaz. |
