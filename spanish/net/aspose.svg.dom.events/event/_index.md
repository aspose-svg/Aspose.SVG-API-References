...
description: Aspose.Svg.Dom.Events.Event clase. ElEvent se utiliza para proporcionar información contextual sobre un evento al controlador que procesa el evento.
type: docs
weight: 920
...
| [InitEvent](../../aspose.svg.dom.events/event/initevent/)(string, bool, bool) | El[`InitEvent`](./initevent/) El método se utiliza para inicializar el valor de un`Event` creado a través de the [`IDocumentEvent`](../idocumentevent/) interfaz. |
