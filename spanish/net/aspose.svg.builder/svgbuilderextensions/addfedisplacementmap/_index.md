...
description: "Método AddFeDisplacementMap de SVGBuilderExtensions. Añade una configuración de elemento feDisplacementMap al constructor. Este elemento desplaza una imagen mediante un mapa vectorial especificado"
type: docs
weight: 190
url: /es/net/aspose.svg.builder/svgbuilderextensions/addfedisplacementmap/
---
## AddFeDisplacementMap<TBuilder>(*this TBuilder, Action&lt;SVGFEDisplacementMapElementBuilder&gt;*) {#addfedisplacementmap}

Agrega una configuración de elemento 'feDisplacementMap' al creador. Este elemento desplaza una imagen mediante un mapa vectorial especificado.
...
| configurar | La acción de configuración para el elemento 'feDisplacementMap'. |
...
Agrega un elemento 'feDisplacementMap' al creador SVG, creando un efecto que distorsiona una imagen basándose en los datos de color de una segunda fuente.
...
| constructor | La instancia del constructor SVG a la que se añadirá el elemento 'feDisplacementMap'. |
| escala | El factor de escala que determina la cantidad de desplazamiento. Parámetro opcional. |
| xChannelSelector | El canal de la imagen in2 que se usará para el desplazamiento a lo largo del eje x. Parámetro opcional. |
| yChannelSelector | El canal de la imagen in2 que se usará para el desplazamiento a lo largo del eje y. Parámetro opcional. |
| in | La imagen de entrada que será desplazada. Puede ser una cadena o un FilterInput. Parámetro opcional. |
| in2 | La imagen que proporciona los datos de desplazamiento. Puede ser una cadena o un FilterInput. Parámetro opcional. |
...
| extender | Una acción opcional para configurar más el SVGFEDisplacementMapElementBuilder. |
