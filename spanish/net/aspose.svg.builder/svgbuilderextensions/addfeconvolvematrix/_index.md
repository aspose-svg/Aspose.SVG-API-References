...
description: "Método AddFeConvolveMatrix de SVGBuilderExtensions. Añade una configuración del elemento feConvolveMatrix al builder. Este elemento aplica un efecto de filtro de convolución de matriz."
type: docs
weight: 170
url: /es/net/aspose.svg.builder/svgbuilderextensions/addfeconvolvematrix/
---
## AddFeConvolveMatrix<TBuilder>(*this TBuilder, Action&lt;SVGFEConvolveMatrixElementBuilder&gt;*) {#addfeconvolvematrix_1}

Agrega una configuración de elemento 'feConvolveMatrix' al creador. Este elemento aplica un efecto de filtro de convolución matricial.
...
| configurar | La acción de configuración para el elemento 'feConvolveMatrix'. |
...
Agrega un elemento 'feConvolveMatrix' al creador SVG, aplicando un efecto de filtro de convolución matricial.
...
| constructor | La instancia del builder SVG a la que se añadirá el elemento 'feConvolveMatrix'. |
| kernelMatrix | La matriz de valores para la convolución. Parámetro opcional. |
| divisor | El divisor para la convolución. Parámetro opcional. |
| bias | El sesgo que se añadirá al resultado de la convolución. Parámetro opcional. |
| targetX | La coordenada x del píxel objetivo en la matriz kernel. Parámetro opcional. |
| targetY | La coordenada y del píxel objetivo en la matriz del kernel. Parámetro opcional. |
| edgeMode | Define cómo manejar los píxeles de borde en la convolución. Parámetro opcional. |
| preserveAlpha | Indica si se debe preservar el canal alfa. Parámetro opcional. |
| order | El orden de la matriz del kernel. Puede ser un entero o una ValueTuple de dos enteros. Parámetro opcional. |
| in | La entrada para el efecto de convolución. Puede ser una cadena o un FilterInput. Parámetro opcional. |
...
| extender | Una acción opcional para configurar más el SVGFEConvolveMatrixElementBuilder. |
