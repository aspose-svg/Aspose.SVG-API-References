...
description: "Método RefY de SVGBuilderExtensions. Establece el atributo refY para un elemento SVG."
type: docs
weight: 1940
url: /es/net/aspose.svg.builder/svgbuilderextensions/refy/
---
## RefY<TBuilder>(*this TBuilder, double, [LengthType](../../lengthtype/)*) {#refy_1}

Establece el atributo 'refY' para un elemento SVG.
...
| value | La coordenada Y de referencia. |
...
Establece el atributo 'refY' para un elemento SVG usando una posición vertical predefinida.
...
| TBuilder | El tipo del constructor de elementos SVG. |
| constructor | La instancia del constructor. |
| value | La posición vertical predefinida. |
