...
description: Aspose.Svg.Paths.SVGPathSegMovetoAbs clase. La interfaz SVGPathSegMovetoAbs corresponde a un comando de datos de ruta de movimiento absoluto M.
type: docs
weight: 2680
url: /es/net/aspose.svg.paths/svgpathsegmovetoabs/
---
...
| [X](../../aspose.svg.paths/svgpathsegmovetoabs/x/) { get; set; } | La coordenada X absoluta para el punto final de este segmento de ruta. |
| [Y](../../aspose.svg.paths/svgpathsegmovetoabs/y/) { get; set; } | La coordenada Y absoluta para el punto final de este segmento de ruta. |
