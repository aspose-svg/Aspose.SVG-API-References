...
description: Aspose.Svg.Paths.SVGPathSegMovetoRel clase. La interfaz SVGPathSegMovetoRel corresponde a un comando de datos de ruta de movimiento relativo m.
type: docs
weight: 2690
url: /es/net/aspose.svg.paths/svgpathsegmovetorel/
---
...
| [X](../../aspose.svg.paths/svgpathsegmovetorel/x/) { get; set; } | La coordenada X relativa para el punto final de este segmento de ruta. |
| [Y](../../aspose.svg.paths/svgpathsegmovetorel/y/) { get; set; } | La coordenada Y relativa para el punto final de este segmento de ruta. |
