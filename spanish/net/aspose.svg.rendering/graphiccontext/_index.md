...
description: Aspose.Svg.Rendering.GraphicContext clase. Contiene los parámetros de control de gráficos actuales. Estos parámetros definen el marco global dentro del cual se ejecutan los operadores de gráficos.
type: docs
weight: 2800
url: /es/net/aspose.svg.rendering/graphiccontext/
---
...
| virtual [TextInfo](../../aspose.svg.rendering/graphiccontext/textinfo/) { get; } | Obtiene un[`TextInfo`](../textinfo/) objeto que contiene información sobre el texto renderizado. |
...
| Nombre | Descripción |
| --- | --- |
| virtual [Clone](../../aspose.svg.rendering/graphiccontext/clone/)() | Crea una nueva instancia de una clase GraphicContext con los mismos valores de propiedad que una instancia existente. |
