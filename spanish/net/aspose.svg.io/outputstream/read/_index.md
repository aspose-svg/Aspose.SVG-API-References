...
El número total de bytes leídos en el búfer. Puede ser menor que el número de bytes solicitados si esa cantidad de bytes no está disponible actualmente, o cero (0) si se alcanzó el final de la secuencia.
