...
description: Aspose.Svg.Filters.SVGFETurbulenceElement clase. La interfaz SVGFETurbulenceElement corresponde al elemento feTurbulence.
type: docs
weight: 1890
url: /es/net/aspose.svg.filters/svgfeturbulenceelement/
---
...
| [BaseFrequencyX](../../aspose.svg.filters/svgfeturbulenceelement/basefrequencyx/) { get; } | Corresponde al atributo 'baseFrequency' en el elemento 'feTurbulence' dado. Contiene el componente X del atributo 'baseFrequency'. |
| [BaseFrequencyY](../../aspose.svg.filters/svgfeturbulenceelement/basefrequencyy/) { get; } | Corresponde al atributo 'baseFrequency' en el elemento 'feTurbulence' dado. Contiene el componente Y del atributo 'baseFrequency' (posiblemente calculado automáticamente). |
...
| [Height](../../aspose.svg.filters/svgfeturbulenceelement/height/) { get; } | Corresponde al atributo 'altura' en el elemento 'filtro' dado. |
...
| [NumOctaves](../../aspose.svg.filters/svgfeturbulenceelement/numoctaves/) { get; } | Corresponde al atributo 'numOctaves' en el elemento 'feTurbulence' dado. |
...
| [Result](../../aspose.svg.filters/svgfeturbulenceelement/result/) { get; } | Corresponde al atributo 'resultado' en el elemento 'filtro' dado. |
| [SchemaTypeInfo](../../aspose.svg.dom/element/schematypeinfo/) { get; } | La información de tipo asociada con este elemento. |
| [Seed](../../aspose.svg.filters/svgfeturbulenceelement/seed/) { get; } | Corresponde al atributo 'seed' en el elemento 'feTurbulence' dado. |
| [ShadowRoot](../../aspose.svg.dom/element/shadowroot/) { get; } | Devuelve shadowRoot almacenado en este elemento o nulo si está cerrado. |
| [StitchTiles](../../aspose.svg.filters/svgfeturbulenceelement/stitchtiles/) { get; } | Corresponde al atributo 'stitchTiles' en el elemento 'feTurbulence' dado. Toma una de las constantes SVG_STITCHTYPE_* definidas en esta interfaz. |
...
| [Type](../../aspose.svg.filters/svgfeturbulenceelement/type/) { get; } | Corresponde al atributo 'tipo' en el elemento 'feTurbulence' dado. Toma una de las constantes SVG_TURBULENCE_TYPE_* definidas en esta interfaz. |
...
| [Width](../../aspose.svg.filters/svgfeturbulenceelement/width/) { get; } | Corresponde al atributo 'ancho' en el elemento 'filtro' dado. |
| [X](../../aspose.svg.filters/svgfeturbulenceelement/x/) { get; } | Corresponde al atributo 'x' en el elemento 'filtro' dado. |
| [Y](../../aspose.svg.filters/svgfeturbulenceelement/y/) { get; } | Corresponde al atributo 'y' en el elemento 'filtro' dado. |
...
| Nombre | Descripción |
| --- | --- |
| const [SVG_STITCHTYPE_NOSTITCH](../../aspose.svg.filters/svgfeturbulenceelement/svg_stitchtype_nostitch/) | Corresponde al valor 'noStitch'. |
| const [SVG_STITCHTYPE_STITCH](../../aspose.svg.filters/svgfeturbulenceelement/svg_stitchtype_stitch/) | Corresponde al valor 'puntada'. |
| const [SVG_STITCHTYPE_UNKNOWN](../../aspose.svg.filters/svgfeturbulenceelement/svg_stitchtype_unknown/) | El tipo no es uno de los tipos predefinidos. No es válido intentar definir un nuevo valor de este tipo o intentar cambiar un valor existente a este tipo. |
| const [SVG_TURBULENCE_TYPE_FRACTALNOISE](../../aspose.svg.filters/svgfeturbulenceelement/svg_turbulence_type_fractalnoise/) | Corresponde al valor 'fractalNoise'. |
| const [SVG_TURBULENCE_TYPE_TURBULENCE](../../aspose.svg.filters/svgfeturbulenceelement/svg_turbulence_type_turbulence/) | Corresponde al valor 'turbulencia'. |
| const [SVG_TURBULENCE_TYPE_UNKNOWN](../../aspose.svg.filters/svgfeturbulenceelement/svg_turbulence_type_unknown/) | El tipo no es uno de los tipos predefinidos. No es válido intentar definir un nuevo valor de este tipo o intentar cambiar un valor existente a este tipo. |
