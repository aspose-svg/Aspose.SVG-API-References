...
description: Aspose.Svg.Filters.SVGFEConvolveMatrixElement clase. La interfaz SVGFEConvolveMatrixElement corresponde al elemento feConvolveMatrix.
type: docs
weight: 1690
url: /es/net/aspose.svg.filters/svgfeconvolvematrixelement/
---
...
| [Bias](../../aspose.svg.filters/svgfeconvolvematrixelement/bias/) { get; } | Corresponde al atributo 'sesgo' en el elemento 'feConvolveMatrix' dado. |
...
| [Divisor](../../aspose.svg.filters/svgfeconvolvematrixelement/divisor/) { get; } | Corresponde al atributo 'divisor' en el elemento 'feConvolveMatrix' dado. |
| [EdgeMode](../../aspose.svg.filters/svgfeconvolvematrixelement/edgemode/) { get; } | Corresponde al atributo 'edgeMode' en el elemento 'feConvolveMatrix' dado. |
...
| [Height](../../aspose.svg.filters/svgfeconvolvematrixelement/height/) { get; } | Corresponde al atributo 'altura' en el elemento 'filtro' dado. |
...
| [In1](../../aspose.svg.filters/svgfeconvolvematrixelement/in1/) { get; } | Corresponde al atributo 'in' en el elemento 'feConvolveMatrix' dado. |
...
| [KernelMatrix](../../aspose.svg.filters/svgfeconvolvematrixelement/kernelmatrix/) { get; } | Corresponde al atributo 'kernelMatrix' en el elemento 'feConvolveMatrix' dado. |
| [KernelUnitLengthX](../../aspose.svg.filters/svgfeconvolvematrixelement/kernelunitlengthx/) { get; } | Corresponde al atributo 'kernelUnitLength' en el elemento 'feConvolveMatrix' dado. |
| [KernelUnitLengthY](../../aspose.svg.filters/svgfeconvolvematrixelement/kernelunitlengthy/) { get; } | Corresponde al atributo 'kernelUnitLength' en el elemento 'feConvolveMatrix' dado. |
...
| [OrderX](../../aspose.svg.filters/svgfeconvolvematrixelement/orderx/) { get; } | Corresponde al atributo 'orden' en el elemento 'feConvolveMatrix' dado. |
| [OrderY](../../aspose.svg.filters/svgfeconvolvematrixelement/ordery/) { get; } | Corresponde al atributo 'orden' en el elemento 'feConvolveMatrix' dado. |
...
| [PreserveAlpha](../../aspose.svg.filters/svgfeconvolvematrixelement/preservealpha/) { get; } | Corresponde al atributo 'preserveAlpha' en el elemento 'feConvolveMatrix' dado. |
...
| [Result](../../aspose.svg.filters/svgfeconvolvematrixelement/result/) { get; } | Corresponde al atributo 'resultado' en el elemento 'filtro' dado. |
...
| [TargetX](../../aspose.svg.filters/svgfeconvolvematrixelement/targetx/) { get; } | Corresponde al atributo 'targetX' en el elemento 'feConvolveMatrix' dado. |
| [TargetY](../../aspose.svg.filters/svgfeconvolvematrixelement/targety/) { get; } | Corresponde al atributo 'targetY' en el elemento 'feConvolveMatrix' dado. |
...
| [Width](../../aspose.svg.filters/svgfeconvolvematrixelement/width/) { get; } | Corresponde al atributo 'ancho' en el elemento 'filtro' dado. |
| [X](../../aspose.svg.filters/svgfeconvolvematrixelement/x/) { get; } | Corresponde al atributo 'x' en el elemento 'filtro' dado. |
| [Y](../../aspose.svg.filters/svgfeconvolvematrixelement/y/) { get; } | Corresponde al atributo 'y' en el elemento 'filtro' dado. |
...
| Nombre | Descripción |
| --- | --- |
| const [SVG_EDGEMODE_DUPLICATE](../../aspose.svg.filters/svgfeconvolvematrixelement/svg_edgemode_duplicate/) | Corresponde al valor 'duplicado'. |
| const [SVG_EDGEMODE_NONE](../../aspose.svg.filters/svgfeconvolvematrixelement/svg_edgemode_none/) | Corresponde al valor 'ninguno'. |
| const [SVG_EDGEMODE_UNKNOWN](../../aspose.svg.filters/svgfeconvolvematrixelement/svg_edgemode_unknown/) | El tipo no es uno de los tipos predefinidos. No es válido intentar definir un nuevo valor de este tipo o intentar cambiar un valor existente a este tipo. |
| const [SVG_EDGEMODE_WRAP](../../aspose.svg.filters/svgfeconvolvematrixelement/svg_edgemode_wrap/) | Corresponde al valor 'envolver'. |
