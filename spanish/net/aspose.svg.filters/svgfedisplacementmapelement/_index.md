...
description: Aspose.Svg.Filters.SVGFEDisplacementMapElement clase. La interfaz SVGFEDisplacementMapElement corresponde al elemento feDisplacementMap.
type: docs
weight: 1710
url: /es/net/aspose.svg.filters/svgfedisplacementmapelement/
---
...
| [Height](../../aspose.svg.filters/svgfedisplacementmapelement/height/) { get; } | Corresponde al atributo 'altura' en el elemento 'filtro' dado. |
...
| [In1](../../aspose.svg.filters/svgfedisplacementmapelement/in1/) { get; } | Corresponde al atributo 'in' en el elemento 'feDisplacementMap' dado. |
| [In2](../../aspose.svg.filters/svgfedisplacementmapelement/in2/) { get; } | Corresponde al atributo 'in2' en el elemento 'feDisplacementMap' dado. |
...
| [Result](../../aspose.svg.filters/svgfedisplacementmapelement/result/) { get; } | Corresponde al atributo 'resultado' en el elemento 'filtro' dado. |
| [Scale](../../aspose.svg.filters/svgfedisplacementmapelement/scale/) { get; } | Corresponde al atributo 'escala' en el elemento 'feDisplacementMap' dado. |
...
| [Width](../../aspose.svg.filters/svgfedisplacementmapelement/width/) { get; } | Corresponde al atributo 'ancho' en el elemento 'filtro' dado. |
| [X](../../aspose.svg.filters/svgfedisplacementmapelement/x/) { get; } | Corresponde al atributo 'x' en el elemento 'filtro' dado. |
| [XChannelSelector](../../aspose.svg.filters/svgfedisplacementmapelement/xchannelselector/) { get; } | Corresponde al atributo 'xChannelSelector' en el elemento 'feDisplacementMap' dado. Toma una de las constantes SVG_CHANNEL_* definidas en esta interfaz. |
| [Y](../../aspose.svg.filters/svgfedisplacementmapelement/y/) { get; } | Corresponde al atributo 'y' en el elemento 'filtro' dado. |
| [YChannelSelector](../../aspose.svg.filters/svgfedisplacementmapelement/ychannelselector/) { get; } | Corresponde al atributo 'yChannelSelector' en el elemento 'feDisplacementMap' dado. Toma una de las constantes SVG_CHANNEL_* definidas en esta interfaz. |
...
| Nombre | Descripción |
| --- | --- |
| const [SVG_CHANNEL_A](../../aspose.svg.filters/svgfedisplacementmapelement/svg_channel_a/) | Corresponde al valor 'A'. |
| const [SVG_CHANNEL_B](../../aspose.svg.filters/svgfedisplacementmapelement/svg_channel_b/) | Corresponde al valor 'B'. |
| const [SVG_CHANNEL_G](../../aspose.svg.filters/svgfedisplacementmapelement/svg_channel_g/) | Corresponde al valor 'G'. |
| const [SVG_CHANNEL_R](../../aspose.svg.filters/svgfedisplacementmapelement/svg_channel_r/) | Corresponde al valor 'R'. |
| const [SVG_CHANNEL_UNKNOWN](../../aspose.svg.filters/svgfedisplacementmapelement/svg_channel_unknown/) | El tipo no es uno de los tipos predefinidos. No es válido intentar definir un nuevo valor de este tipo o intentar cambiar un valor existente a este tipo. |
