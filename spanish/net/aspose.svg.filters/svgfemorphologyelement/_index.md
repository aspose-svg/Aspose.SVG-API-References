...
description: Aspose.Svg.Filters.SVGFEMorphologyElement clase. La interfaz SVGFEMorphologyElement corresponde al elemento feMorphology.
type: docs
weight: 1830
url: /es/net/aspose.svg.filters/svgfemorphologyelement/
---
...
| [Height](../../aspose.svg.filters/svgfemorphologyelement/height/) { get; } | Corresponde al atributo 'altura' en el elemento 'filtro' dado. |
...
| [In1](../../aspose.svg.filters/svgfemorphologyelement/in1/) { get; } | Corresponde al atributo 'in' en el elemento 'feMorphology' dado. |
...
| [Operator](../../aspose.svg.filters/svgfemorphologyelement/operator/) { get; } | Corresponde al atributo 'operador' en el elemento 'feMorphology' dado. Toma una de las constantes SVG_MORPHOLOGY_OPERATOR_* definidas en esta interfaz. |
...
| [RadiusX](../../aspose.svg.filters/svgfemorphologyelement/radiusx/) { get; } | Corresponde al atributo 'radius' en el elemento 'feMorphology' dado. |
| [RadiusY](../../aspose.svg.filters/svgfemorphologyelement/radiusy/) { get; } | Corresponde al atributo 'radius' en el elemento 'feMorphology' dado. |
| [Result](../../aspose.svg.filters/svgfemorphologyelement/result/) { get; } | Corresponde al atributo 'resultado' en el elemento 'filtro' dado. |
...
| [Width](../../aspose.svg.filters/svgfemorphologyelement/width/) { get; } | Corresponde al atributo 'ancho' en el elemento 'filtro' dado. |
| [X](../../aspose.svg.filters/svgfemorphologyelement/x/) { get; } | Corresponde al atributo 'x' en el elemento 'filtro' dado. |
| [Y](../../aspose.svg.filters/svgfemorphologyelement/y/) { get; } | Corresponde al atributo 'y' en el elemento 'filtro' dado. |
...
| Nombre | Descripción |
| --- | --- |
| const [SVG_MORPHOLOGY_OPERATOR_DILATE](../../aspose.svg.filters/svgfemorphologyelement/svg_morphology_operator_dilate/) | Corresponde al valor 'dilatar'. |
| const [SVG_MORPHOLOGY_OPERATOR_ERODE](../../aspose.svg.filters/svgfemorphologyelement/svg_morphology_operator_erode/) | Corresponde al valor 'erode'. |
| const [SVG_MORPHOLOGY_OPERATOR_UNKNOWN](../../aspose.svg.filters/svgfemorphologyelement/svg_morphology_operator_unknown/) | El tipo no es uno de los tipos predefinidos. No es válido intentar definir un nuevo valor de este tipo o intentar cambiar un valor existente a este tipo. |
