...
description: Aspose.Svg.Filters.SVGFEDiffuseLightingElement clase. La interfaz SVGFEDiffuseLightingElement corresponde al elemento feDiffuseLighting.
type: docs
weight: 1700
url: /es/net/aspose.svg.filters/svgfediffuselightingelement/
---
...
| [DiffuseConstant](../../aspose.svg.filters/svgfediffuselightingelement/diffuseconstant/) { get; } | Corresponde al atributo 'diffuseConstant' en el elemento 'feDiffuseLighting' dado. |
...
| [Height](../../aspose.svg.filters/svgfediffuselightingelement/height/) { get; } | Corresponde al atributo 'altura' en el elemento 'filtro' dado. |
...
| [In1](../../aspose.svg.filters/svgfediffuselightingelement/in1/) { get; } | Corresponde al atributo 'in' en el elemento 'feDiffuseLighting' dado. |
...
| [KernelUnitLengthX](../../aspose.svg.filters/svgfediffuselightingelement/kernelunitlengthx/) { get; } | Corresponde al atributo 'kernelUnitLength' en el elemento 'feDiffuseLighting' dado. |
| [KernelUnitLengthY](../../aspose.svg.filters/svgfediffuselightingelement/kernelunitlengthy/) { get; } | Corresponde al atributo 'kernelUnitLength' en el elemento 'feDiffuseLighting' dado. |
...
| [Result](../../aspose.svg.filters/svgfediffuselightingelement/result/) { get; } | Corresponde al atributo 'resultado' en el elemento 'filtro' dado. |
...
| [SurfaceScale](../../aspose.svg.filters/svgfediffuselightingelement/surfacescale/) { get; } | Corresponde al atributo 'surfaceScale' en el elemento 'feDiffuseLighting' dado. |
...
| [Width](../../aspose.svg.filters/svgfediffuselightingelement/width/) { get; } | Corresponde al atributo 'ancho' en el elemento 'filtro' dado. |
| [X](../../aspose.svg.filters/svgfediffuselightingelement/x/) { get; } | Corresponde al atributo 'x' en el elemento 'filtro' dado. |
| [Y](../../aspose.svg.filters/svgfediffuselightingelement/y/) { get; } | Corresponde al atributo 'y' en el elemento 'filtro' dado. |
