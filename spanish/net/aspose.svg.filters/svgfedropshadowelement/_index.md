...
description: Aspose.Svg.Filters.SVGFEDropShadowElement clase. La interfaz SVGFEDropShadowElement corresponde al elemento feDropShadow.
type: docs
weight: 1730
url: /es/net/aspose.svg.filters/svgfedropshadowelement/
---
...
| [Dx](../../aspose.svg.filters/svgfedropshadowelement/dx/) { get; } | Corresponde al atributo 'dx' en el elemento 'feDropShadow' dado. |
| [Dy](../../aspose.svg.filters/svgfedropshadowelement/dy/) { get; } | Corresponde al atributo 'dy' en el elemento 'feDropShadow' dado. |
...
| [Height](../../aspose.svg.filters/svgfedropshadowelement/height/) { get; } | Corresponde al atributo 'altura' en el elemento 'feDropShadow' dado. |
...
| [In1](../../aspose.svg.filters/svgfedropshadowelement/in1/) { get; } | Corresponde al atributo 'in' en el elemento 'feDropShadow' dado. |
...
| [Result](../../aspose.svg.filters/svgfedropshadowelement/result/) { get; } | Corresponde al atributo 'resultado' en el elemento 'feDropShadow' dado. |
...
| [StdDeviationX](../../aspose.svg.filters/svgfedropshadowelement/stddeviationx/) { get; } | Corresponde al atributo 'stdDeviation' en el elemento 'feDropShadow' dado. Contiene el componente X del atributo 'stdDeviation'. |
| [StdDeviationY](../../aspose.svg.filters/svgfedropshadowelement/stddeviationy/) { get; } | Corresponde al atributo 'stdDeviation' en el elemento 'feDropShadow' dado. Contiene el componente Y (posiblemente calculado automáticamente) del atributo 'stdDeviation'. |
...
| [Width](../../aspose.svg.filters/svgfedropshadowelement/width/) { get; } | Corresponde al atributo 'ancho' en el elemento 'feDropShadow' dado. |
| [X](../../aspose.svg.filters/svgfedropshadowelement/x/) { get; } | Corresponde al atributo 'x' en el elemento 'feDropShadow' dado. |
| [Y](../../aspose.svg.filters/svgfedropshadowelement/y/) { get; } | Corresponde al atributo 'y' en el elemento 'feDropShadow' dado. |
...
| [SetStdDeviation](../../aspose.svg.filters/svgfedropshadowelement/setstddeviation/)(float, float) | Establece los valores para el atributo 'stdDeviation'. |
