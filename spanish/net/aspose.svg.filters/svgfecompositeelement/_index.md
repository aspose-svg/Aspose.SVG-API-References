...
description: Aspose.Svg.Filters.SVGFECompositeElement clase. La interfaz SVGFECompositeElement corresponde al elemento feComposite.
type: docs
weight: 1680
url: /es/net/aspose.svg.filters/svgfecompositeelement/
---
...
| [Height](../../aspose.svg.filters/svgfecompositeelement/height/) { get; } | Corresponde al atributo 'altura' en el elemento 'filtro' dado. |
...
| [In1](../../aspose.svg.filters/svgfecompositeelement/in1/) { get; } | Corresponde al atributo 'in' en el elemento 'feComposite' dado. |
| [In2](../../aspose.svg.filters/svgfecompositeelement/in2/) { get; } | Corresponde al atributo 'in2' en el elemento 'feComposite' dado. |
...
| [K1](../../aspose.svg.filters/svgfecompositeelement/k1/) { get; } | Corresponde al atributo 'k1' en el elemento 'feComposite' dado. |
| [K2](../../aspose.svg.filters/svgfecompositeelement/k2/) { get; } | Corresponde al atributo 'k2' en el elemento 'feComposite' dado. |
| [K3](../../aspose.svg.filters/svgfecompositeelement/k3/) { get; } | Corresponde al atributo 'k3' en el elemento 'feComposite' dado. |
| [K4](../../aspose.svg.filters/svgfecompositeelement/k4/) { get; } | Corresponde al atributo 'k4' en el elemento 'feComposite' dado. |
...
| [Operator](../../aspose.svg.filters/svgfecompositeelement/operator/) { get; } | Corresponde al atributo 'operador' en el elemento 'feComposite' dado. Toma una de las constantes SVG_FECOMPOSITE_OPERATOR_* definidas en esta interfaz. |
...
| [Result](../../aspose.svg.filters/svgfecompositeelement/result/) { get; } | Corresponde al atributo 'resultado' en el elemento 'filtro' dado. |
...
| [Width](../../aspose.svg.filters/svgfecompositeelement/width/) { get; } | Corresponde al atributo 'ancho' en el elemento 'filtro' dado. |
| [X](../../aspose.svg.filters/svgfecompositeelement/x/) { get; } | Corresponde al atributo 'x' en el elemento 'filtro' dado. |
| [Y](../../aspose.svg.filters/svgfecompositeelement/y/) { get; } | Corresponde al atributo 'y' en el elemento 'filtro' dado. |
...
| Nombre | Descripción |
| --- | --- |
| const [SVG_FECOMPOSITE_OPERATOR_ARITHMETIC](../../aspose.svg.filters/svgfecompositeelement/svg_fecomposite_operator_arithmetic/) | Corresponde al valor 'aritmética'. |
| const [SVG_FECOMPOSITE_OPERATOR_ATOP](../../aspose.svg.filters/svgfecompositeelement/svg_fecomposite_operator_atop/) | Corresponde al valor 'encima'. |
| const [SVG_FECOMPOSITE_OPERATOR_IN](../../aspose.svg.filters/svgfecompositeelement/svg_fecomposite_operator_in/) | Corresponde al valor 'in'. |
| const [SVG_FECOMPOSITE_OPERATOR_OUT](../../aspose.svg.filters/svgfecompositeelement/svg_fecomposite_operator_out/) | Corresponde al valor 'out'. |
| const [SVG_FECOMPOSITE_OPERATOR_OVER](../../aspose.svg.filters/svgfecompositeelement/svg_fecomposite_operator_over/) | Corresponde al valor 'sobre'. |
| const [SVG_FECOMPOSITE_OPERATOR_UNKNOWN](../../aspose.svg.filters/svgfecompositeelement/svg_fecomposite_operator_unknown/) | El tipo no es uno de los tipos predefinidos. No es válido intentar definir un nuevo valor de este tipo o intentar cambiar un valor existente a este tipo. |
| const [SVG_FECOMPOSITE_OPERATOR_XOR](../../aspose.svg.filters/svgfecompositeelement/svg_fecomposite_operator_xor/) | Corresponde al valor 'xor'. |
