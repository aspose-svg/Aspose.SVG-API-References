...
description: Aspose.Svg.Filters.SVGFEColorMatrixElement clase. La interfaz SVGFEColorMatrixElement corresponde al elemento feColorMatrix.
type: docs
weight: 1660
url: /es/net/aspose.svg.filters/svgfecolormatrixelement/
---
...
| [Height](../../aspose.svg.filters/svgfecolormatrixelement/height/) { get; } | Corresponde al atributo 'altura' en el elemento 'filtro' dado. |
...
| [In1](../../aspose.svg.filters/svgfecolormatrixelement/in1/) { get; } | Corresponde al atributo 'in' en el elemento 'feColorMatrix' dado. |
...
| [Result](../../aspose.svg.filters/svgfecolormatrixelement/result/) { get; } | Corresponde al atributo 'resultado' en el elemento 'filtro' dado. |
...
| [Type](../../aspose.svg.filters/svgfecolormatrixelement/type/) { get; } | Corresponde al atributo 'tipo' en el elemento 'feColorMatrix' dado. Toma una de las constantes SVG_FECOLORMATRIX_TYPE_* definidas en esta interfaz. |
| [Values](../../aspose.svg.filters/svgfecolormatrixelement/values/) { get; } | Corresponde al atributo 'valores' en el elemento 'feColorMatrix' dado. |
...
| [Width](../../aspose.svg.filters/svgfecolormatrixelement/width/) { get; } | Corresponde al atributo 'ancho' en el elemento 'filtro' dado. |
| [X](../../aspose.svg.filters/svgfecolormatrixelement/x/) { get; } | Corresponde al atributo 'x' en el elemento 'filtro' dado. |
| [Y](../../aspose.svg.filters/svgfecolormatrixelement/y/) { get; } | Corresponde al atributo 'y' en el elemento 'filtro' dado. |
...
| Nombre | Descripción |
| --- | --- |
| const [SVG_FECOLORMATRIX_TYPE_HUEROTATE](../../aspose.svg.filters/svgfecolormatrixelement/svg_fecolormatrix_type_huerotate/) | Corresponde al valor 'hueRotate'. |
| const [SVG_FECOLORMATRIX_TYPE_LUMINANCETOALPHA](../../aspose.svg.filters/svgfecolormatrixelement/svg_fecolormatrix_type_luminancetoalpha/) | Corresponde al valor 'luminanceToAlpha'. |
| const [SVG_FECOLORMATRIX_TYPE_MATRIX](../../aspose.svg.filters/svgfecolormatrixelement/svg_fecolormatrix_type_matrix/) | Corresponde al valor 'matriz'. |
| const [SVG_FECOLORMATRIX_TYPE_SATURATE](../../aspose.svg.filters/svgfecolormatrixelement/svg_fecolormatrix_type_saturate/) | Corresponde al valor 'saturar'. |
| const [SVG_FECOLORMATRIX_TYPE_UNKNOWN](../../aspose.svg.filters/svgfecolormatrixelement/svg_fecolormatrix_type_unknown/) | El tipo no es uno de los tipos predefinidos. No es válido intentar definir un nuevo valor de este tipo o intentar cambiar un valor existente a este tipo. |
