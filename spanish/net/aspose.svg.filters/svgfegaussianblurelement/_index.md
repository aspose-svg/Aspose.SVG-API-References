...
description: Aspose.Svg.Filters.SVGFEGaussianBlurElement clase. La interfaz SVGFEGaussianBlurElement corresponde al elemento feGaussianBlur.
type: docs
weight: 1790
url: /es/net/aspose.svg.filters/svgfegaussianblurelement/
---
...
| [Height](../../aspose.svg.filters/svgfegaussianblurelement/height/) { get; } | Corresponde al atributo �altura� en el elemento �filtro� dado. |
...
| [In1](../../aspose.svg.filters/svgfegaussianblurelement/in1/) { get; } | Corresponde al atributo �in� en el elemento �feGaussianBlur� dado. |
...
| [Result](../../aspose.svg.filters/svgfegaussianblurelement/result/) { get; } | Corresponde al atributo �resultado� en el elemento �filtro� dado. |
...
| [StdDeviationX](../../aspose.svg.filters/svgfegaussianblurelement/stddeviationx/) { get; } | Corresponde al atributo �stdDeviation� en el elemento �feGaussianBlur� dado. Contiene el componente X del atributo �stdDeviation�. |
| [StdDeviationY](../../aspose.svg.filters/svgfegaussianblurelement/stddeviationy/) { get; } | Corresponde al atributo �stdDeviation� en el elemento �feGaussianBlur� dado. Contiene el componente Y (posiblemente calculado automáticamente) del atributo �stdDeviation�. |
...
| [Width](../../aspose.svg.filters/svgfegaussianblurelement/width/) { get; } | Corresponde al atributo �ancho� en el elemento �filtro� dado. |
| [X](../../aspose.svg.filters/svgfegaussianblurelement/x/) { get; } | Corresponde al atributo �x� en el elemento �filtro� dado. |
| [Y](../../aspose.svg.filters/svgfegaussianblurelement/y/) { get; } | Corresponde al atributo �y� en el elemento �filtro� dado. |
...
| [SetStdDeviation](../../aspose.svg.filters/svgfegaussianblurelement/setstddeviation/)(float, float) | Establece los valores para el atributo �stdDeviation�. |
