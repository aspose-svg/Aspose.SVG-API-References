...
description: Aspose.Svg.Filters.SVGFESpecularLightingElement clase. La interfaz SVGFESpecularLightingElement corresponde al elemento feSpecularLighting.
type: docs
weight: 1860
url: /es/net/aspose.svg.filters/svgfespecularlightingelement/
---
...
| [Height](../../aspose.svg.filters/svgfespecularlightingelement/height/) { get; } | Corresponde al atributo 'altura' en el elemento 'filtro' dado. |
...
| [In1](../../aspose.svg.filters/svgfespecularlightingelement/in1/) { get; } | Corresponde al atributo 'in' en el elemento 'feSpecularLighting' dado. |
...
| [KernelUnitLengthX](../../aspose.svg.filters/svgfespecularlightingelement/kernelunitlengthx/) { get; } | Corresponde al atributo 'kernelUnitLength' en el elemento 'feSpecularLighting' dado. |
| [KernelUnitLengthY](../../aspose.svg.filters/svgfespecularlightingelement/kernelunitlengthy/) { get; } | Corresponde al atributo 'kernelUnitLength' en el elemento 'feSpecularLighting' dado. |
...
| [Result](../../aspose.svg.filters/svgfespecularlightingelement/result/) { get; } | Corresponde al atributo 'resultado' en el elemento 'filtro' dado. |
...
| [SpecularConstant](../../aspose.svg.filters/svgfespecularlightingelement/specularconstant/) { get; } | Corresponde al atributo 'specularConstant' en el elemento 'feSpecularLighting' dado. |
| [SpecularExponent](../../aspose.svg.filters/svgfespecularlightingelement/specularexponent/) { get; } | Corresponde al atributo 'exponenteespecular' en el elemento 'feSpecularLighting' dado. |
...
| [SurfaceScale](../../aspose.svg.filters/svgfespecularlightingelement/surfacescale/) { get; } | Corresponde al atributo 'surfaceScale' en el elemento 'feSpecularLighting' dado. |
...
| [Width](../../aspose.svg.filters/svgfespecularlightingelement/width/) { get; } | Corresponde al atributo 'ancho' en el elemento 'filtro' dado. |
| [X](../../aspose.svg.filters/svgfespecularlightingelement/x/) { get; } | Corresponde al atributo 'x' en el elemento 'filtro' dado. |
| [Y](../../aspose.svg.filters/svgfespecularlightingelement/y/) { get; } | Corresponde al atributo 'y' en el elemento 'filtro' dado. |
