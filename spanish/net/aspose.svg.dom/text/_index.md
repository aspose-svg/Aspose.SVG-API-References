...
description: Aspose.Svg.Dom.Text clase. La interfaz de texto hereda de CharacterData y representa el contenido textual denominado datos de caracteres en XML de un elemento o atributo.
type: docs
weight: 1200
url: /es/net/aspose.svg.dom/text/
---
## Text class
...
| override [NodeName](../../aspose.svg.dom/text/nodename/) { get; } | El nombre de este nodo, dependiendo de su tipo. |
| override [NodeType](../../aspose.svg.dom/text/nodetype/) { get; } | Un código que representa el tipo del objeto subyacente. |
