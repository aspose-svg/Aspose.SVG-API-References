...
description: Aspose.Svg.Dom.Node clase. La interfaz de nodo es el tipo de datos principal para todo el modelo de objetos de documento. Representa un solo nodo en el árbol del documento.
type: docs
weight: 1150
