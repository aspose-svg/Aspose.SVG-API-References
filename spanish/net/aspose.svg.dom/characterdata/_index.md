...
description: Aspose.Svg.Dom.CharacterData clase. CharacterData amplía el nodo con un conjunto de atributos y métodos para acceder a los datos de caracteres en el DOM.
type: docs
weight: 450
url: /es/net/aspose.svg.dom/characterdata/
---
## CharacterData class
