...
description: Aspose.Svg.Dom.Notation clase. Representa una notación declarada en la DTD.
type: docs
weight: 1160
url: /es/net/aspose.svg.dom/notation/
---
## Notation class
...
| override [NodeName](../../aspose.svg.dom/notation/nodename/) { get; } | El nombre de este nodo, dependiendo de su tipo. |
| override [NodeType](../../aspose.svg.dom/notation/nodetype/) { get; } | Un código que representa el tipo del objeto subyacente. |
...
| [PublicId](../../aspose.svg.dom/notation/publicid/) { get; } | El identificador público de esta notación. Si no se especificó el identificador público, este es nulo. |
| [SystemId](../../aspose.svg.dom/notation/systemid/) { get; } | El identificador del sistema de esta notación. Si no se especificó el identificador del sistema, es nulo. Puede ser un URI absoluto o no. |
