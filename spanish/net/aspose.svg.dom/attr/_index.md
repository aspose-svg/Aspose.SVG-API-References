...
description: Aspose.Svg.Dom.Attr clase. La interfaz Attr representa un atributo en un objeto Elemento. Normalmente los valores permitidos para el atributo se definen en un esquema asociado con el documento.
type: docs
weight: 350
