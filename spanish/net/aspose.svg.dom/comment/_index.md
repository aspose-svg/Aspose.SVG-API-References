...
description: Aspose.Svg.Dom.Comment clase. Hereda de CharacterData y representa el contenido de un comentario es decir todos los caracteres entre el inicio  .
type: docs
weight: 460
url: /es/net/aspose.svg.dom/comment/
---
## Comment class
...
| override [NodeName](../../aspose.svg.dom/comment/nodename/) { get; } | El nombre de este nodo, dependiendo de su tipo. |
| override [NodeType](../../aspose.svg.dom/comment/nodetype/) { get; } | Un código que representa el tipo del objeto subyacente. |
| override [NodeValue](../../aspose.svg.dom/comment/nodevalue/) { get; set; } | El valor de este nodo, según su tipo. |
