...
description: Aspose.Svg.Dom.DocumentType clase. DocumentType proporciona una interfaz a la lista de entidades definidas para document
type: docs
weight: 830
url: /es/net/aspose.svg.dom/documenttype/
---
## DocumentType class
...
| [InternalSubset](../../aspose.svg.dom/documenttype/internalsubset/) { get; } | El subconjunto interno como cadena, o nulo si no lo hay. |
...
| [Name](../../aspose.svg.dom/documenttype/name/) { get; } | El nombre de DTD; es decir, el nombre que sigue inmediatamente a la palabra clave DOCTYPE. |
...
| override [NodeName](../../aspose.svg.dom/documenttype/nodename/) { get; } | El nombre de este nodo, dependiendo de su tipo. |
| override [NodeType](../../aspose.svg.dom/documenttype/nodetype/) { get; } | Un código que representa el tipo del objeto subyacente. |
...
| [PublicId](../../aspose.svg.dom/documenttype/publicid/) { get; } | El identificador público del subconjunto externo. |
| [SystemId](../../aspose.svg.dom/documenttype/systemid/) { get; } | El identificador del sistema del subconjunto externo. Puede ser un URI absoluto o no. |
...
| override [ToString](../../aspose.svg.dom/documenttype/tostring/)() | Devuelve unString que representa esta instancia. |
