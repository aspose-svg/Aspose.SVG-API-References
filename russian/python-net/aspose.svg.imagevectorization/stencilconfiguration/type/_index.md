...
type: docs
weight: 40
url: /ru/python-net/aspose.svg.imagevectorization/stencilconfiguration/type/
is_root: false
---
...
Gets or sets the [`StencilType`](/svg/python-net/aspose.svg.imagevectorization/stenciltype).
### Definition:
```python
@property
def type(self):
