...
description: Пространство имен Aspose.Svg.Dom.Attributes содержит унифицированные классы атрибутов которые определяют или квалифицируют любой объект узел элемент ... особенность или поведение.
type: docs
weight: 60
url: /ru/net/aspose.svg.dom.attributes/
---
Пространство имен **Aspose.Svg.Dom.Attributes** содержит унифицированные классы атрибутов, которые определяют или квалифицируют любой объект (узел, элемент, ...) особенность или поведение.
