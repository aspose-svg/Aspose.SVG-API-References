...
description: "Aspose.Svg.Dom.Entity класс. Представляет известную сущность, либо разобранную, либо неразобранную в XML-документе."
type: docs
weight: 2850
...
Представляет известную сущность, разобранную или неразобранную, в документе XML.
...
| [InputEncoding](../../aspose.svg.dom/entity/inputencoding/) { get; } | Атрибут, указывающий кодировку, используемую для этой сущности во время разбора, когда это внешняя разобранная сущность. Значение null, если это сущность из внутреннего подмножества или если кодировка неизвестна. |
...
| [NotationName](../../aspose.svg.dom/entity/notationname/) { get; } | Для неразобранных сущностей — имя нотации для сущности. Для разобранных сущностей значение null. |
...
| [PublicId](../../aspose.svg.dom/entity/publicid/) { get; } | Публичный идентификатор, связанный с сущностью, если указан, иначе null. |
| [SystemId](../../aspose.svg.dom/entity/systemid/) { get; } | Системный идентификатор, связанный с сущностью, если указан, иначе null. Это может быть абсолютный URI или нет. |
| virtual [TextContent](../../aspose.svg.dom/node/textcontent/) { get; set; } | Представляет текстовое содержимое узла и его потомков. |
| [XmlEncoding](../../aspose.svg.dom/entity/xmlencoding/) { get; } | Атрибут, указывающий, как часть текстового объявления, кодировку этой сущности, когда это внешняя разобранная сущность. В остальных случаях значение null. |
| [XmlVersion](../../aspose.svg.dom/entity/xmlversion/) { get; } | Атрибут, указывающий, как часть текстового объявления, номер версии этой сущности, когда это внешняя разобранная сущность. В остальных случаях значение null. |
