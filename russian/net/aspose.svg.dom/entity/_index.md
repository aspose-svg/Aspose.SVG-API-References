...
| [InputEncoding](../../aspose.svg.dom/entity/inputencoding) { get; } | Атрибут, указывающий кодировку, используемую для этого объекта во время синтаксического анализа, когда он является внешним анализируемым объектом. Это нуль, если это сущность из внутреннего подмножества или если она неизвестна. |
...
| [NotationName](../../aspose.svg.dom/entity/notationname) { get; } | Для неразобранных сущностей имя нотации для сущности. Для проанализированных сущностей это значение равно null. |
...
| [PublicId](../../aspose.svg.dom/entity/publicid) { get; } | Открытый идентификатор, связанный с сущностью, если он указан, и null в противном случае. |
| [SystemId](../../aspose.svg.dom/entity/systemid) { get; } | Системный идентификатор, связанный с объектом, если он указан, и null в противном случае. Это может быть абсолютный URI или нет. |
