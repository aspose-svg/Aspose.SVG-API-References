...
| [PublicId](../../aspose.svg.dom/notation/publicid) { get; } | Общедоступный идентификатор этой нотации. Если общедоступный идентификатор не был указан, это значение равно null. |
