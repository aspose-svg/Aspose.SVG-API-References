...
| override [LocalName](../../aspose.svg.dom/attr/localname) { get; } | Возвращает локальную часть полного имени этого узла. Для узлов любого типа, кроме ELEMENT_NODE и ATTRIBUTE_NODE, и узлов, созданных с помощью метода DOM уровня 1, например Document.createElement(), всегда равно null. |
| [Name](../../aspose.svg.dom/attr/name) { get; } | Возвращает имя этого атрибута. |
| override [NamespaceURI](../../aspose.svg.dom/attr/namespaceuri) { get; } | URI пространства имен этого узла или нуль, если он не указан. |
...
| [Specified](../../aspose.svg.dom/attr/specified) { get; } | Истинно, если этому атрибуту было явно присвоено значение в экземпляре документа, в противном случае - ложь. |
