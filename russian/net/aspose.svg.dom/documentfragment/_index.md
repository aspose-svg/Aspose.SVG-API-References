...
description: Aspose.Svg.Dom.DocumentFragment сорт. DocumentFragment  это облегченный или минимальный объект Document. Очень часто требуется извлечь часть дерева документа или создать новый фрагмент документа.
type: docs
weight: 820
