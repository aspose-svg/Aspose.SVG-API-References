...
description: Возвращает фрагмент HTML или XML представляющий элемент и его содержимое. Может быть установлено чтобы заменить элемент узлами проанализированными из заданной строки.
type: docs
weight: 90
