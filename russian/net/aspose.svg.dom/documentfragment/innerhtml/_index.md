...
description: Возвращает фрагмент HTML или XML представляющий содержимое элемента. Можно установить чтобы заменить содержимое элемента узлами проанализированными из заданной строки.
type: docs
weight: 40
