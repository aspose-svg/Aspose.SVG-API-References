...
description: Aspose.Svg.Dom.CDATASection сорт. Разделы CDATA используются для экранирования блоков текста содержащих символы которые в противном случае считались бы разметкой.
type: docs
weight: 440
