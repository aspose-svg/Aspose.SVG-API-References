...
description: Aspose.Svg.Dom.Document сорт. Документ представляет собой весь документ HTML XML или SVG. Концептуально это корень дерева документов и обеспечивает основной доступ к данным документа.
type: docs
weight: 810
