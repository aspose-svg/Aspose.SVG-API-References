...
description: Интерфейс DOMException представляет собой ненормальное событие называемое исключением которое возникает в результате вызова метода или доступа к свойству вебAPI. В основном это то как состояния ошибок описываются в вебAPI.
type: docs
weight: 790
...
| Имя | Описание |
| --- | --- |
| [DOMException](domexception#constructor)(string) | Инициализирует новый экземпляр[`DOMException`](../domexception) класс. |
| [DOMException](domexception#constructor_1)(string, string) | Инициализирует новый экземпляр[`DOMException`](../domexception) класс. |
