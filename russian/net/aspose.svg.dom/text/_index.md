...
description: "Класс Aspose.Svg.Dom.Text. Интерфейс Text наследуется от CharacterData и представляет текстовое содержимое, называемое символьными данными в XML элемента или атрибута."
type: docs
weight: 3200
...
Интерфейс Text наследуется от CharacterData и представляет текстовое содержимое (именуемое символьными данными в XML) элемента или атрибута.
