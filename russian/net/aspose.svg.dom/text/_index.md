...
description: Aspose.Svg.Dom.Text сорт. Текстовый интерфейс наследуется от CharacterData и представляет текстовое содержимое называемое символьными данными в XML элемента или атрибута.
type: docs
weight: 1200
...
| [IsElementContentWhitespace](../../aspose.svg.dom/text/iselementcontentwhitespace/) { get; } | Возвращает, содержит ли этот текстовый узел пробелы в содержимом элемента, часто оскорбительно называемые «игнорируемыми пробелами». |
...
| [SplitText](../../aspose.svg.dom/text/splittext/)(int) | Разбивает этот узел на два узла по указанному смещению, сохраняя оба узла в дереве как братья и сестры. |
