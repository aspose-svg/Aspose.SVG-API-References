...
description: DocumentType предоставляет интерфейс к списку сущностей определенных для document
type: docs
weight: 830
...
| Имя | Описание |
| --- | --- |
| [DocumentType](documenttype)(string, string, string, string, Document) | Инициализирует новый экземпляр[`DocumentType`](../documenttype) класс. |
...
| [Name](../../aspose.svg.dom/documenttype/name) { get; } | Имя DTD; т. е. имя, непосредственно следующее за ключевым словом DOCTYPE. |
...
| [PublicId](../../aspose.svg.dom/documenttype/publicid) { get; } | Общедоступный идентификатор внешнего подмножества. |
...
| override [ToString](../../aspose.svg.dom/documenttype/tostring)() | ВозвращаетString который представляет этот экземпляр. |
