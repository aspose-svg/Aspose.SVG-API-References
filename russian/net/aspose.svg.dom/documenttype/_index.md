...
description: "Aspose.Svg.Dom.DocumentType класс. DocumentType предоставляет интерфейс к списку сущностей, определённых для документа."
type: docs
weight: 2830
url: /ru/net/aspose.svg.dom/documenttype/
---
## DocumentType class
...
| Имя | Описание |
| --- | --- |
| [DocumentType](documenttype/)(*string, string, string, string, [Document](../document/)*) | Инициализирует новый экземпляр класса `DocumentType`. |
...
| [InternalSubset](../../aspose.svg.dom/documenttype/internalsubset/) { get; } | Внутреннее подмножество в виде строки, или null, если его нет. |
...
| [Name](../../aspose.svg.dom/documenttype/name/) { get; } | Имя DTD; то есть имя, сразу следующее за ключевым словом DOCTYPE. |
...
| override [NodeName](../../aspose.svg.dom/documenttype/nodename/) { get; } | Имя этого узла, в зависимости от его типа. |
| override [NodeType](../../aspose.svg.dom/documenttype/nodetype/) { get; } | Код, представляющий тип базового объекта. |
...
| [PublicId](../../aspose.svg.dom/documenttype/publicid/) { get; } | Публичный идентификатор внешнего подмножества. |
| [SystemId](../../aspose.svg.dom/documenttype/systemid/) { get; } | Системный идентификатор внешнего подмножества. Это может быть абсолютный URI или нет. |
...
| override [ToString](../../aspose.svg.dom/documenttype/tostring/)() | Возвращает строку, представляющую этот экземпляр. |
