...
| event [OnKeyDown](../../aspose.svg.dom/iglobaleventhandlers/onkeydown/) | Получает или задает обработчик события OnKeyDown. |
| event [OnKeyPress](../../aspose.svg.dom/iglobaleventhandlers/onkeypress/) | Получает или задает обработчик события OnKeyPress. |
| event [OnKeyUp](../../aspose.svg.dom/iglobaleventhandlers/onkeyup/) | Получает или задает обработчик события OnKeyUp. |
| event [OnLoad](../../aspose.svg.dom/iglobaleventhandlers/onload/) | Получает или задает обработчик события OnLoad. |
| event [OnLoadedData](../../aspose.svg.dom/iglobaleventhandlers/onloadeddata/) | Получает или задает обработчик события OnLoadedData. |
| event [OnLoadedMetadata](../../aspose.svg.dom/iglobaleventhandlers/onloadedmetadata/) | Получает или задает обработчик события OnLoadedMetadata. |
| event [OnLoadStart](../../aspose.svg.dom/iglobaleventhandlers/onloadstart/) | Получает или задает обработчик события OnLoadStart. |
| event [OnMouseDown](../../aspose.svg.dom/iglobaleventhandlers/onmousedown/) | Получает или задает обработчик события OnMouseDown. |
| event [OnMouseEnter](../../aspose.svg.dom/iglobaleventhandlers/onmouseenter/) | Получает или задает обработчик события OnMouseEnter. |
| event [OnMouseLeave](../../aspose.svg.dom/iglobaleventhandlers/onmouseleave/) | Получает или задает обработчик события OnMouseLeave. |
| event [OnMouseMove](../../aspose.svg.dom/iglobaleventhandlers/onmousemove/) | Получает или задает обработчик события OnMouseMove. |
| event [OnMouseOut](../../aspose.svg.dom/iglobaleventhandlers/onmouseout/) | Получает или задает обработчик события OnMouseOut. |
| event [OnMouseOver](../../aspose.svg.dom/iglobaleventhandlers/onmouseover/) | Получает или задает обработчик события OnMouseOver. |
| event [OnMouseUp](../../aspose.svg.dom/iglobaleventhandlers/onmouseup/) | Получает или задает обработчик события OnMouseUp. |
| event [OnMouseWheel](../../aspose.svg.dom/iglobaleventhandlers/onmousewheel/) | Получает или задает обработчик события OnMouseWheel. |
| event [OnPause](../../aspose.svg.dom/iglobaleventhandlers/onpause/) | Получает или задает обработчик события OnPause. |
| event [OnPlay](../../aspose.svg.dom/iglobaleventhandlers/onplay/) | Получает или задает обработчик события OnPlay. |
| event [OnPlaying](../../aspose.svg.dom/iglobaleventhandlers/onplaying/) | Получает или задает обработчик события OnPlaying. |
| event [OnProgress](../../aspose.svg.dom/iglobaleventhandlers/onprogress/) | Получает или задает обработчик события OnProgress. |
