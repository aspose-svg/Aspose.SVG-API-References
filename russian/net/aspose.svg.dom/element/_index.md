...
description: Aspose.Svg.Dom.Element сорт. Интерфейс Element представляет элемент в документе HTML или XML.
type: docs
weight: 840
...
| [ParentElement](../../aspose.svg.dom/node/parentelement/) { get; } | Получает родителя`Element` этого узла. |
