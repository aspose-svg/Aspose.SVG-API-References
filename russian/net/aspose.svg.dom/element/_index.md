...
| Имя | Описание |
| --- | --- |
| [Element](element)(IElementInit) | Инициализирует новый экземпляр[`Element`](../element)учебный класс. Не вызывайте этот конструктор напрямую, используйте[`CreateElement`](../document/createelement) или же[`CreateElementNS`](../document/createelementns) . |
