...
description: Aspose.Svg.Dom.Node сорт. Интерфейс узла является основным типом данных для всей объектной модели документа. Он представляет один узел в дереве документа.
type: docs
weight: 1150
