...
description: Объект документа связанный с этим узлом. Это также объект Document используемый для создания новых узлов. Когда этот узел является документом или типом документа который еще не используется ни с одним документом это значение равно null.
type: docs
weight: 120
