...
description: ProcessingInstruction представляет собой инструкцию по обработке используемую в XML как способ сохранения информации о процессоре в тексте документа.
type: docs
weight: 1170
