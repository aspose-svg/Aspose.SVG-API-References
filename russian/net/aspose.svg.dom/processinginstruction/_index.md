---
title: "ProcessingInstruction Класс"
second_title: "Aspose.SVG для .NET справочник API"
description: "Aspose.Svg.Dom.ProcessingInstruction класс. ProcessingInstruction представляет инструкцию обработки, используемую в XML как способ хранить специфичную для процессора информацию в тексте документа."
type: docs
weight: 3160
url: /ru/net/aspose.svg.dom/processinginstruction/
---
...
| override [NodeName](../../aspose.svg.dom/processinginstruction/nodename/) { get; } | Имя этого узла, в зависимости от его типа. |
| override [NodeType](../../aspose.svg.dom/processinginstruction/nodetype/) { get; } | Код, представляющий тип базового объекта. |
| override [NodeValue](../../aspose.svg.dom/processinginstruction/nodevalue/) { get; set; } | Значение этого узла, в зависимости от его типа. |
...
| [Target](../../aspose.svg.dom/processinginstruction/target/) { get; } | Цель этой инструкции обработки. |
| override [TextContent](../../aspose.svg.dom/processinginstruction/textcontent/) { get; set; } | Этот атрибут возвращает текстовое содержимое этого узла и его потомков. Когда он определён как null, попытка установить его не оказывает эффекта. При установке все возможные дочерние узлы этого узла удаляются, и если новая строка не пуста и не null, она заменяется одним текстовым узлом, содержащим эту строку. |
