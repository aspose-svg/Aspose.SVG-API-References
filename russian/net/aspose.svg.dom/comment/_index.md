...
description: Aspose.Svg.Dom.Comment сорт. Наследуется от CharacterData и представляет содержимое комментария т. е. все символы между начальным  .
type: docs
weight: 460
