...
description: "Класс Aspose.Svg.SVGGradientElement. Интерфейс SVGGradientElement является базовым интерфейсом, используемым SVGLinearGradientElement и SVGRadialGradientElement."
type: docs
weight: 5350
...
| [GradientTransform](../../aspose.svg/svggradientelement/gradienttransform/) { get; } | Соответствует атрибуту ‘gradientTransform’ в данном элементе. |
| [GradientUnits](../../aspose.svg/svggradientelement/gradientunits/) { get; } | Соответствует атрибуту ‘gradientUnits’ в данном элементе. Принимает одну из констант, определённых в SVGUnitTypes. |
| [Href](../../aspose.svg/svggradientelement/href/) { get; } | Соответствует атрибуту ‘xlink:href’ у указанного элемента. |
...
| [SpreadMethod](../../aspose.svg/svggradientelement/spreadmethod/) { get; } | Соответствует атрибуту ‘spreadMethod’ в данном элементе. Одна из типов Spread Method, определённых в этом интерфейсе. |
...
| const [SVG_SPREADMETHOD_REFLECT](../../aspose.svg/svggradientelement/svg_spreadmethod_reflect/) | Соответствует значению 'reflect'. |
| const [SVG_SPREADMETHOD_REPEAT](../../aspose.svg/svggradientelement/svg_spreadmethod_repeat/) | Соответствует значению 'repeat'. |
| const [SVG_SPREADMETHOD_UNKNOWN](../../aspose.svg/svggradientelement/svg_spreadmethod_unknown/) | Тип не является одним из предопределённых типов. Недопустимо пытаться определить новое значение этого типа или попытаться переключить существующее значение на этот тип. |
