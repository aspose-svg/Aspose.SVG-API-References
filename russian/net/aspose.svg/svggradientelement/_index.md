...
description: Aspose.Svg.SVGGradientElement сорт. Интерфейс SVGGradientElement  это базовый интерфейс используемый SVGLinearGradientElement и SVGRadialGradientElement.
type: docs
weight: 3280
...
| const [SVG_SPREADMETHOD_REPEAT](../../aspose.svg/svggradientelement/svg_spreadmethod_repeat/) | Соответствует значению «повторить». |
