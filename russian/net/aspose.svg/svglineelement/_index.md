...
description: "Класс Aspose.Svg.SVGLineElement. Интерфейс SVGLineElement соответствует элементу line."
type: docs
weight: 5380
...
| [X1](../../aspose.svg/svglineelement/x1/) { get; } | Соответствует атрибуту ‘x1’ указанного элемента ‘line’. |
| [X2](../../aspose.svg/svglineelement/x2/) { get; } | Соответствует атрибуту ‘x2’ указанного элемента ‘line’. |
| [Y1](../../aspose.svg/svglineelement/y1/) { get; } | Соответствует атрибуту ‘y1’ указанного элемента ‘line’. |
| [Y2](../../aspose.svg/svglineelement/y2/) { get; } | Соответствует атрибуту ‘y2’ указанного элемента ‘line’. |
