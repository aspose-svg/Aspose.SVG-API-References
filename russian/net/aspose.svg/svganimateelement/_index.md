...
description: Интерфейс SVGAnimateElement соответствует элементу animate. Объектно-ориентированный доступ к атрибутам анимированного элемента через SVG DOM недоступен.
type: docs
weight: 3030
url: /ru/net/aspose.svg/svganimateelement/
---
## SVGAnimateElement class

Интерфейс SVGAnimateElement соответствует элементу 'animate'. Объектно-ориентированный доступ к атрибутам анимированного элемента через SVG DOM недоступен.
...
| [RequiredExtensions](../../aspose.svg/svganimationelement/requiredextensions) { get; } | Соответствует атрибуту 'requiredExtensions' данного элемента. |
| [RequiredFeatures](../../aspose.svg/svganimationelement/requiredfeatures) { get; } | Соответствует атрибуту 'requiredFeatures' данного элемента. |
...
| [SystemLanguage](../../aspose.svg/svganimationelement/systemlanguage) { get; } | Соответствует атрибуту 'systemLanguage' данного элемента. |
| [TagName](../../aspose.svg.dom/element/tagname) { get; } | Имя элемента. |
| [TargetElement](../../aspose.svg/svganimationelement/targetelement) { get; } | Анимируемый элемент. |
