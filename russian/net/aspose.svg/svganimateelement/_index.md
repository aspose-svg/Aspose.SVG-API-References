...
description: "Aspose.Svg.SVGAnimateElement class. Интерфейс SVGAnimateElement соответствует элементу animate. Объектно-ориентированный доступ к атрибутам элемента animate через SVG DOM недоступен."
type: docs
weight: 5160
