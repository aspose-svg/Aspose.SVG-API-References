...
description: Интерфейс SVGAnimateElement соответствует анимируемому элементу. Объектноориентированный доступ к атрибутам анимируемого элемента через SVG DOM недоступен.
type: docs
weight: 3040
