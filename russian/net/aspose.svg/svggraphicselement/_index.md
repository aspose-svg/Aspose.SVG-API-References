...
description: "Класс Aspose.Svg.SVGGraphicsElement. Интерфейс SVGGraphicsElement представляет SVG‑элементы, основная цель которых — непосредственно отрисовывать графику в группе."
type: docs
weight: 5360
...
Интерфейс SVGGraphicsElement представляет SVG‑элементы, основное назначение которых — напрямую отрисовывать графику в группу.
