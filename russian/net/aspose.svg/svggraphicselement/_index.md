...
description: Aspose.Svg.SVGGraphicsElement сорт. Интерфейс SVGGraphicsElement представляет элементы SVG основной целью которых является непосредственное отображение графики в группе.
type: docs
weight: 3290
