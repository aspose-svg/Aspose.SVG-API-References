...
description: Aspose.Svg.SVGStyleElement сорт. Интерфейс SVGStyleElement соответствует элементу style.
type: docs
weight: 3480
...
| [Type](../../aspose.svg/svgstyleelement/type/) { get; set; } | Соответствует типу атрибута данного элемента. |
