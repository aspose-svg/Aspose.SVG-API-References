...
description: "Класс Aspose.Svg.SVGStyleElement. Интерфейс SVGStyleElement соответствует элементу style"
type: docs
weight: 5550
...
| [Media](../../aspose.svg/svgstyleelement/media/) { get; set; } | Соответствует атрибуту ‘media’ в данном элементе. |
...
| [Sheet](../../aspose.svg/svgstyleelement/sheet/) { get; } | Получает связанный лист стилей. |
...
| [Title](../../aspose.svg/svgstyleelement/title/) { get; set; } | Соответствует атрибуту ‘title’ в данном элементе. |
| [Type](../../aspose.svg/svgstyleelement/type/) { get; set; } | Соответствует атрибуту ‘type’ в данном элементе. |
