...
description: "Класс Aspose.Svg.SVGScriptElement. Интерфейс SVGScriptElement соответствует элементу script"
type: docs
weight: 5520
...
| [CrossOrigin](../../aspose.svg/svgscriptelement/crossorigin/) { get; set; } | Соответствует атрибуту ‘crossorigin’ в данном элементе ‘script’. |
...
| [Href](../../aspose.svg/svgscriptelement/href/) { get; } | Соответствует атрибуту ‘xlink:href’ у указанного элемента. |
...
| [Type](../../aspose.svg/svgscriptelement/type/) { get; set; } | Соответствует атрибуту ‘type’ в данном элементе ‘script’. |
