...
description: "Класс Aspose.Svg.SVGUseElement. Интерфейс SVGUseElement соответствует элементу use"
type: docs
weight: 5650
...
| [Height](../../aspose.svg/svguseelement/height/) { get; } | Соответствует атрибуту ‘height’ в данном элементе ‘use’ |
| [Href](../../aspose.svg/svguseelement/href/) { get; } | Соответствует атрибуту ‘xlink:href’ у указанного элемента. |
...
| [Width](../../aspose.svg/svguseelement/width/) { get; } | Соответствует атрибуту ‘width’ в данном элементе ‘use’ |
| [X](../../aspose.svg/svguseelement/x/) { get; } | Соответствует атрибуту ‘x’ в данном элементе ‘use’ |
| [Y](../../aspose.svg/svguseelement/y/) { get; } | Соответствует атрибуту ‘y’ в данном элементе ‘use’ |
