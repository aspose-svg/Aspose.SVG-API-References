...
description: Aspose.Svg.SVGUseElement сорт. Интерфейс SVGUseElement соответствует элементу use.
type: docs
weight: 3580
...
| [Height](../../aspose.svg/svguseelement/height/) { get; } | Соответствует атрибуту "высота" данного элемента "использования". |
