...
description: "Класс Aspose.Svg.SVGLinearGradientElement. Интерфейс SVGLinearGradientElement соответствует элементу linearGradient."
type: docs
weight: 5390
...
| [X1](../../aspose.svg/svglineargradientelement/x1/) { get; } | Соответствует атрибуту ‘x1’ в указанном элементе ‘linearGradient’. |
| [X2](../../aspose.svg/svglineargradientelement/x2/) { get; } | Соответствует атрибуту ‘x2’ в указанном элементе ‘linearGradient’. |
| [Y1](../../aspose.svg/svglineargradientelement/y1/) { get; } | Соответствует атрибуту ‘y1’ в указанном элементе ‘linearGradient’. |
| [Y2](../../aspose.svg/svglineargradientelement/y2/) { get; } | Соответствует атрибуту ‘y2’ в указанном элементе ‘linearGradient’. |
