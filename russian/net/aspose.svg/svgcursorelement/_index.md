...
description: "Aspose.Svg.SVGCursorElement class. Интерфейс SVGCursorElement соответствует элементу cursor"
type: docs
weight: 5230
...
| [Href](../../aspose.svg/svgcursorelement/href/) { get; } | Соответствует атрибуту ‘xlink:href’ у указанного элемента. |
...
| [X](../../aspose.svg/svgcursorelement/x/) { get; } | Соответствует атрибуту ‘x’ в данном элементе ‘cursor’. |
| [Y](../../aspose.svg/svgcursorelement/y/) { get; } | Соответствует атрибуту ‘y’ в данном элементе ‘cursor’. |
