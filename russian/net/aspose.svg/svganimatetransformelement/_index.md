...
description: "Класс Aspose.Svg.SVGAnimateTransformElement. Интерфейс SVGAnimateTransformElement соответствует элементу animateTransform. Объектно‑ориентированный доступ к атрибутам элемента animateTransform через SVG DOM недоступен"
type: docs
weight: 5180
