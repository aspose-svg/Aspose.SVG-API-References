...
description: Aspose.Svg.SVGAnimateTransformElement сорт. Интерфейс SVGAnimateTransformElement соответствует элементу animateTransform. Объектноориентированный доступ к атрибутам элемента animateTransform через SVG DOM недоступен.
type: docs
weight: 3110
