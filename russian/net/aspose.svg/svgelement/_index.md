...
description: Aspose.Svg.SVGElement сорт. Все интерфейсы SVG DOM которые непосредственно соответствуют элементам языка SVG например интерфейс SVGPathElement для элемента path являются производными от интерфейса SVGElement.
type: docs
weight: 3200
