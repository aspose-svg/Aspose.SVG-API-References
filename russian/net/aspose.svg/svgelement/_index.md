...
description: "Класс Aspose.Svg.SVGElement. Все интерфейсы SVG DOM, которые напрямую соответствуют элементам языка SVG, такие как интерфейс SVGPathElement для элемента path, наследуются от интерфейса SVGElement."
type: docs
weight: 5270
