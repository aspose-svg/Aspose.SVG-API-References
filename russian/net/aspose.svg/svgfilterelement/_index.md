...
description: Aspose.Svg.SVGFilterElement сорт. Интерфейс SVGFilterElement соответствует элементу filter.
type: docs
weight: 3240
...
| [Width](../../aspose.svg/svgfilterelement/width/) { get; } | Соответствует атрибуту «ширина» данного элемента «фильтр». |
| [X](../../aspose.svg/svgfilterelement/x/) { get; } | Соответствует атрибуту «x» данного элемента «фильтр». |
