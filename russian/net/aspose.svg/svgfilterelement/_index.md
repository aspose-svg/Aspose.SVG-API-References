---
title: "Класс SVGFilterElement"
second_title: "Aspose.SVG для .NET справочник API"
description: "Класс Aspose.Svg.SVGFilterElement. Интерфейс SVGFilterElement соответствует элементу filter"
type: docs
weight: 5310
...
| [FilterUnits](../../aspose.svg/svgfilterelement/filterunits/) { get; } | Соответствует атрибуту ‘filterUnits’ в данном элементе ‘filter’. Принимает одну из констант, определённых в SVGUnitTypes. |
...
| [Height](../../aspose.svg/svgfilterelement/height/) { get; } | Соответствует атрибуту ‘height’ в данном элементе ‘filter’. |
| [Href](../../aspose.svg/svgfilterelement/href/) { get; } | Соответствует атрибуту ‘xlink:href’ у указанного элемента. |
...
| [PrimitiveUnits](../../aspose.svg/svgfilterelement/primitiveunits/) { get; } | Соответствует атрибуту ‘primitiveUnits’ в данном элементе ‘filter’. Принимает одну из констант, определённых в SVGUnitTypes. |
...
| [Width](../../aspose.svg/svgfilterelement/width/) { get; } | Соответствует атрибуту ‘width’ в данном элементе ‘filter’. |
| [X](../../aspose.svg/svgfilterelement/x/) { get; } | Соответствует атрибуту ‘x’ в данном элементе ‘filter’. |
| [Y](../../aspose.svg/svgfilterelement/y/) { get; } | Соответствует атрибуту ‘y’ в данном элементе ‘filter’. |
