...
description: Aspose.Svg.SVGImageElement сорт. Интерфейс SVGImageElement соответствует элементу изображения.
type: docs
weight: 3300
...
| [PreserveAspectRatio](../../aspose.svg/svgimageelement/preserveaspectratio/) { get; } | Соответствует атрибуту preserveAspectRatio данного элемента изображения. |
...
| [X](../../aspose.svg/svgimageelement/x/) { get; } | Соответствует атрибуту «x» данного элемента «изображения». |
