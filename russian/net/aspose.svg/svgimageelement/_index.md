...
description: "Класс Aspose.Svg.SVGImageElement. Интерфейс SVGImageElement соответствует элементу image."
type: docs
weight: 5370
...
| [Height](../../aspose.svg/svgimageelement/height/) { get; } | Соответствует атрибуту ‘height’ у указанного элемента ‘image’. |
| [Href](../../aspose.svg/svgimageelement/href/) { get; } | Соответствует атрибуту ‘xlink:href’ у указанного элемента. |
...
| [PreserveAspectRatio](../../aspose.svg/svgimageelement/preserveaspectratio/) { get; } | Соответствует атрибуту ‘preserveAspectRatio’ у указанного элемента ‘image’. |
...
| [Width](../../aspose.svg/svgimageelement/width/) { get; } | Соответствует атрибуту ‘width’ у указанного элемента ‘image’. |
| [X](../../aspose.svg/svgimageelement/x/) { get; } | Соответствует атрибуту ‘x’ у указанного элемента ‘image’. |
| [Y](../../aspose.svg/svgimageelement/y/) { get; } | Соответствует атрибуту ‘y’ у указанного элемента ‘image’. |
