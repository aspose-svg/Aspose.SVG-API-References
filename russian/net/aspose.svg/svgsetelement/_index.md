...
description: "Класс Aspose.Svg.SVGSetElement. Интерфейс SVGSetElement соответствует элементу set. Объектно-ориентированный доступ к атрибутам элемента set через SVG DOM недоступен"
type: docs
weight: 5530
