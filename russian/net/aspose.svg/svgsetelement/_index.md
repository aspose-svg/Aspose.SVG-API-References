...
description: Aspose.Svg.SVGSetElement сорт. Интерфейс SVGSetElement соответствует элементу set. Объектноориентированный доступ к атрибутам элемента set через SVG DOM недоступен.
type: docs
weight: 3460
