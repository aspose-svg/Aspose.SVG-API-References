...
description: "Класс Aspose.Svg.SVGClipPathElement. Интерфейс SVGClipPathElement соответствует элементу clipPath."
type: docs
weight: 5210
...
| [ClipPathUnits](../../aspose.svg/svgclippathelement/clippathunits/) { get; } | Соответствует атрибуту ‘clipPathUnits’ указанного элемента ‘clipPath’. Принимает одну из констант, определённых в SVGUnitTypes. |
...
| [Transform](../../aspose.svg/svgclippathelement/transform/) { get; } | Соответствует атрибуту ‘transform’ у указанного элемента. |
