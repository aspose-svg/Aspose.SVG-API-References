...
description: Aspose.Svg.SVGClipPathElement сорт. Интерфейс SVGClipPathElement соответствует элементу clipPath.
type: docs
weight: 3140
...
| [Transform](../../aspose.svg/svgclippathelement/transform/) { get; } | Соответствует атрибуту «преобразование» данного элемента. |
