...
type: docs
weight: 3080
url: /ru/net/aspose.svg/svgclippathelement/
---
...
| [ClipPathUnits](../../aspose.svg/svgclippathelement/clippathunits) { get; } | Соответствует атрибуту 'clipPathUnits' данного элемента 'clipPath'. Принимает одну из констант, определенных в SVGUnitTypes. |
...
| [Transform](../../aspose.svg/svgclippathelement/transform) { get; } | Соответствует атрибуту 'transform' данного элемента. |
