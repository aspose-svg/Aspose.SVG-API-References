...
description: Возвращает координату xy в пользовательском пространстве которая является единицами расстояния вдоль пути используя алгоритм пользовательского агента расстояния вдоль пути.
type: docs
weight: 20
