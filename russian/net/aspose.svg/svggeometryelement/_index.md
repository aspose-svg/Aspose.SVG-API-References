...
description: Интерфейс SVGGeometryElement представляет элементы SVG визуализация которых определяется геометрией с эквивалентным путем и которые можно заполнять и обводить. Сюда входят пути и основные формы.
type: docs
weight: 3220
