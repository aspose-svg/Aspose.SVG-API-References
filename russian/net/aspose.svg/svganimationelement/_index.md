...
description: Aspose.Svg.SVGAnimationElement сорт. Интерфейс SVGAnimationElement является базовым интерфейсом для всех интерфейсов элементов анимации SVGAnimateElement SVGSetElement SVGAnimateColorElement SVGAnimateMotionElement и SVGAnimateTransformElement.
type: docs
weight: 3120
