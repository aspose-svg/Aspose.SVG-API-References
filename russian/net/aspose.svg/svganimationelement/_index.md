...
description: "Класс Aspose.Svg.SVGAnimationElement. Интерфейс SVGAnimationElement является базовым интерфейсом для всех интерфейсов анимационных элементов SVGAnimateElement, SVGSetElement, SVGAnimateColorElement, SVGAnimateMotionElement и SVGAnimateTransformElement."
type: docs
weight: 5190
...
| [TargetElement](../../aspose.svg/svganimationelement/targetelement/) { get; } | Элемент, который анимируется. |
