...
description: "Класс Aspose.Svg.SVGMPathElement. Интерфейс SVGMPathElement соответствует элементу mpath."
type: docs
weight: 5400
...
| [Href](../../aspose.svg/svgmpathelement/href/) { get; } | Соответствует атрибуту ‘xlink:href’ у указанного элемента. |
