...
| [CurrentTranslate](../../aspose.svg/svgsvgelement/currenttranslate/) { get; } | Для самого внешнего элемента svg соответствующий коэффициент перевода, учитывающий пользовательское «увеличение». |
...
| [Width](../../aspose.svg/svgsvgelement/width/) { get; } | Соответствует атрибуту «ширина» данного элемента «svg». |
...
| [CreateSVGAngle](../../aspose.svg/svgsvgelement/createsvgangle/)() | Создает объект SVGAngle вне каких-либо деревьев документов. Объект инициализируется значением 0 градусов (безразмерно). |
