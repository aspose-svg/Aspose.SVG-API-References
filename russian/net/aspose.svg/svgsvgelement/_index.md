...
type: docs
weight: 3380
url: /ru/net/aspose.svg/svgsvgelement/
---
## SVGSVGElement class
...
| [CurrentTranslate](../../aspose.svg/svgsvgelement/currenttranslate) { get; } | Для самого внешнего элемента svg соответствующий коэффициент перевода, учитывающий пользовательское «увеличение». При доступе к элементу 'svg', который не является самым внешним элементом svg, поведение этого атрибута не определено. |
...
| [Height](../../aspose.svg/svgsvgelement/height) { get; } | Соответствует атрибуту «высота» данного элемента «svg». |
...
| [PreserveAspectRatio](../../aspose.svg/svgsvgelement/preserveaspectratio) { get; } | Соответствует атрибуту preserveAspectRatio данного элемента. |
...
| [ViewBox](../../aspose.svg/svgsvgelement/viewbox) { get; } | Соответствует атрибуту 'viewBox' данного элемента. |
...
| [Width](../../aspose.svg/svgsvgelement/width) { get; } | Соответствует атрибуту 'width' данного элемента 'svg'. |
| [X](../../aspose.svg/svgsvgelement/x) { get; } | Соответствует атрибуту 'x' данного элемента 'svg'. |
| [Y](../../aspose.svg/svgsvgelement/y) { get; } | Соответствует атрибуту 'y' данного элемента 'svg'. |
| [ZoomAndPan](../../aspose.svg/svgsvgelement/zoomandpan) { get; set; } | Соответствует атрибуту 'zoomAndPan' данного элемента. Значение должно быть одной из констант SVG_ZOOMANDPAN_*, определенных в этом интерфейсе. |
...
| [AnimationsPaused](../../aspose.svg/svgsvgelement/animationspaused)() | Возвращает true, если этот фрагмент документа SVG находится в состоянии паузы. |
...
| [CreateEvent](../../aspose.svg/svgsvgelement/createevent)(string) | Создает[`Event`](../../aspose.svg.dom.events/event)типа, поддерживаемого реализацией. |
| [CreateSVGAngle](../../aspose.svg/svgsvgelement/createsvgangle)() | Создает объект SVGAngle вне каких-либо деревьев документов. Объект инициализируется значением 0 градусов (безразмерное). |
| [CreateSVGLength](../../aspose.svg/svgsvgelement/createsvglength)() | Создает объект SVGLength вне каких-либо деревьев документов. Объект инициализируется значением 0 пользовательских единиц. |
| [CreateSVGMatrix](../../aspose.svg/svgsvgelement/createsvgmatrix)() | Создает объект SVGMatrix вне каких-либо деревьев документов. Объект инициализируется единичной матрицей. |
| [CreateSVGNumber](../../aspose.svg/svgsvgelement/createsvgnumber)() | Создает объект SVGNumber вне каких-либо деревьев документов. Объект инициализируется нулевым значением. |
| [CreateSVGPoint](../../aspose.svg/svgsvgelement/createsvgpoint)() | Создает объект SVGPoint вне каких-либо деревьев документов. Объект инициализируется точкой (0,0) в пользовательской системе координат. |
| [CreateSVGRect](../../aspose.svg/svgsvgelement/createsvgrect)() | Создает объект SVGRect вне каких-либо деревьев документов. Объект инициализируется таким образом, что все значения установлены на 0 пользовательских единиц. |
| [CreateSVGTransform](../../aspose.svg/svgsvgelement/createsvgtransform)() | Создает объект SVGTransform вне каких-либо деревьев документов. Объект инициализируется преобразованием матрицы идентичности (SVG_TRANSFORM_MATRIX). |
...
| [GetCurrentTime](../../aspose.svg/svgsvgelement/getcurrenttime)() | Возвращает текущее время в секундах относительно времени начала для текущего фрагмента документа SVG. Если getCurrentTime вызывается до начала временной шкалы документа (например, из-за запуска скрипта в элементе script до отправки события SVGLoad документа), то возвращается 0. |
| [GetElementById](../../aspose.svg/svgsvgelement/getelementbyid)(string) | Выполняет поиск в этом фрагменте документа SVG (т. е. поиск ограничен подмножеством дерева документа) элемента, идентификатор которого задан elementId. Если элемент найден, этот элемент возвращается. Если такого элемента не существует, возвращает null. Поведение не определено, если этот идентификатор имеет более одного элемента. |
...
| [PauseAnimations](../../aspose.svg/svgsvgelement/pauseanimations)() | Приостанавливает (т. е. приостанавливает) все запущенные в данный момент анимации, которые определены в фрагменте документа SVG, соответствующем этому элементу 'svg', в результате чего часы анимации, соответствующие этому фрагменту документа, останавливаются до тех пор, пока это без паузы. |
...
| [UnpauseAnimations](../../aspose.svg/svgsvgelement/unpauseanimations)() | Разблокирует (т. е. возобновляет паузу) текущую анимацию, которая определена во фрагменте документа SVG, в результате чего часы анимации продолжаются с того момента, когда они были приостановлены. |
