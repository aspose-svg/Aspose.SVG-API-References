...
description: Aspose.Svg.SVGTextPositioningElement сорт. Интерфейс SVGTextPositioningElement наследуется текстовыми интерфейсами SVGTextElement SVGTSpanElement SVGTRefElement и SVGAltGlyphElement.
type: docs
weight: 3550
...
| [Rotate](../../aspose.svg/svgtextpositioningelement/rotate/) { get; } | Соответствует атрибуту «поворот» данного элемента. |
