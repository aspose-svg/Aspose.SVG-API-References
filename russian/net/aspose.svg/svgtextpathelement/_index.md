...
description: "Класс Aspose.Svg.SVGTextPathElement. Интерфейс SVGTextPathElement соответствует элементу textPath"
type: docs
weight: 5610
...
| [Href](../../aspose.svg/svgtextpathelement/href/) { get; } | Соответствует атрибуту ‘xlink:href’ у указанного элемента. |
...
| [Method](../../aspose.svg/svgtextpathelement/method/) { get; } | Соответствует атрибуту ‘method’ у данного элемента ‘textPath’ |
...
| [Spacing](../../aspose.svg/svgtextpathelement/spacing/) { get; } | Соответствует атрибуту ‘spacing’ у данного элемента ‘textPath’ |
| [StartOffset](../../aspose.svg/svgtextpathelement/startoffset/) { get; } | Соответствует атрибуту ‘startOffset’ у данного элемента ‘textPath’ |
...
| const [TEXTPATH_METHODTYPE_STRETCH](../../aspose.svg/svgtextpathelement/textpath_methodtype_stretch/) | Соответствует значению 'stretch' |
| const [TEXTPATH_METHODTYPE_UNKNOWN](../../aspose.svg/svgtextpathelement/textpath_methodtype_unknown/) | Перечисление было установлено в значение, которое не является одним из предопределённых типов. Недопустимо пытаться определить новое значение этого типа или пытаться переключить существующее значение на этот тип. |
| const [TEXTPATH_SPACINGTYPE_AUTO](../../aspose.svg/svgtextpathelement/textpath_spacingtype_auto/) | Соответствует значению 'auto' |
| const [TEXTPATH_SPACINGTYPE_EXACT](../../aspose.svg/svgtextpathelement/textpath_spacingtype_exact/) | Соответствует значению 'exact' |
| const [TEXTPATH_SPACINGTYPE_UNKNOWN](../../aspose.svg/svgtextpathelement/textpath_spacingtype_unknown/) | Перечисление было установлено в значение, которое не является одним из предопределённых типов. Недопустимо пытаться определить новое значение этого типа или пытаться переключить существующее значение на этот тип. |
