...
type: docs
weight: 3480
url: /ru/net/aspose.svg/svgtextpathelement/
---
...
| [Href](../../aspose.svg/svgtextpathelement/href) { get; } | Соответствует атрибуту 'xlink:href' данного элемента. |
...
| [LengthAdjust](../../aspose.svg/svgtextcontentelement/lengthadjust) { get; } | Соответствует атрибуту lengthAdjust данного элемента. Значение должно быть одной из констант регулировки длины, определенных в этом интерфейсе. |
...
| [Method](../../aspose.svg/svgtextpathelement/method) { get; } | Соответствует атрибуту 'метод' данного элемента 'textPath'. |
...
| [Spacing](../../aspose.svg/svgtextpathelement/spacing) { get; } | Соответствует атрибуту 'spacing' данного элемента 'textPath'. |
| [StartOffset](../../aspose.svg/svgtextpathelement/startoffset) { get; } | Соответствует атрибуту 'startOffset' данного элемента 'textPath'. |
...
| [TextLength](../../aspose.svg/svgtextcontentelement/textlength) { get; } | Соответствует атрибуту 'textLength' данного элемента. |
...
| Имя | Описание |
| --- | --- |
| const [TEXTPATH_METHODTYPE_ALIGN](../../aspose.svg/svgtextpathelement/textpath_methodtype_align) | Соответствует значению 'align'. |
| const [TEXTPATH_METHODTYPE_STRETCH](../../aspose.svg/svgtextpathelement/textpath_methodtype_stretch) | Соответствует значению 'растянуть'. |
| const [TEXTPATH_METHODTYPE_UNKNOWN](../../aspose.svg/svgtextpathelement/textpath_methodtype_unknown) | Перечисление было установлено на значение, которое не является одним из предопределенных типов. Недопустимо пытаться определить новое значение этого типа или пытаться переключить существующее значение на этот тип. |
| const [TEXTPATH_SPACINGTYPE_AUTO](../../aspose.svg/svgtextpathelement/textpath_spacingtype_auto) | Соответствует значению 'auto'. |
| const [TEXTPATH_SPACINGTYPE_EXACT](../../aspose.svg/svgtextpathelement/textpath_spacingtype_exact) | Соответствует значению «точно». |
| const [TEXTPATH_SPACINGTYPE_UNKNOWN](../../aspose.svg/svgtextpathelement/textpath_spacingtype_unknown) | Перечисление было установлено на значение, которое не является одним из предопределенных типов. Недопустимо пытаться определить новое значение этого типа или пытаться переключить существующее значение на этот тип. |
