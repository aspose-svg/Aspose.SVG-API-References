...
description: Aspose.Svg.SVGTextPathElement сорт. Интерфейс SVGTextPathElement соответствует элементу textPath.
type: docs
weight: 3540
...
| [Method](../../aspose.svg/svgtextpathelement/method/) { get; } | Соответствует атрибуту 'method' данного элемента 'textPath'. |
...
| const [TEXTPATH_SPACINGTYPE_EXACT](../../aspose.svg/svgtextpathelement/textpath_spacingtype_exact/) | Соответствует точному значению. |
