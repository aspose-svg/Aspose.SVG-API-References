...
description: "Класс Aspose.Svg.SVGMarkerElement. Интерфейс SVGMarkerElement соответствует элементу marker."
type: docs
weight: 5410
...
| [MarkerHeight](../../aspose.svg/svgmarkerelement/markerheight/) { get; } | Соответствует атрибуту ‘markerHeight’ в данном элементе ‘marker’. |
| [MarkerUnits](../../aspose.svg/svgmarkerelement/markerunits/) { get; } | Соответствует атрибуту ‘markerUnits’ в данном элементе ‘marker’. Один из типов единиц маркера, определённых в этом интерфейсе. |
| [MarkerWidth](../../aspose.svg/svgmarkerelement/markerwidth/) { get; } | Соответствует атрибуту ‘markerWidth’ в данном элементе ‘marker’. |
...
| [OrientAngle](../../aspose.svg/svgmarkerelement/orientangle/) { get; } | Соответствует атрибуту ‘orient’ в данном элементе ‘marker’. Если markerUnits имеет значение SVG_MARKER_ORIENT_ANGLE, используется значение угла для атрибута ‘orient’; в противном случае будет установлено значение ноль. |
| [OrientType](../../aspose.svg/svgmarkerelement/orienttype/) { get; } | Соответствует атрибуту ‘orient’ в данном элементе ‘marker’. Один из типов ориентации маркера, определённых в этом интерфейсе. |
...
| [PreserveAspectRatio](../../aspose.svg/svgmarkerelement/preserveaspectratio/) { get; } | Соответствует атрибуту ‘preserveAspectRatio’ заданного элемента. |
...
| [RefX](../../aspose.svg/svgmarkerelement/refx/) { get; } | Соответствует атрибуту ‘refX’ в данном элементе ‘marker’. |
| [RefY](../../aspose.svg/svgmarkerelement/refy/) { get; } | Соответствует атрибуту ‘refY’ в данном элементе ‘marker’. |
...
| [ViewBox](../../aspose.svg/svgmarkerelement/viewbox/) { get; } | Соответствует атрибуту ‘viewBox’ заданного элемента. |
...
| [SetOrientToAngle](../../aspose.svg/svgmarkerelement/setorienttoangle/)(*[SVGAngle](../../aspose.svg.datatypes/svgangle/)*) | Устанавливает значение атрибута ‘orient’ в заданный угол. |
| [SetOrientToAuto](../../aspose.svg/svgmarkerelement/setorienttoauto/)() | Устанавливает значение атрибута ‘orient’ в 'auto'. |
...
| Имя | Описание |
| --- | --- |
| const [SVG_MARKERUNITS_STROKEWIDTH](../../aspose.svg/svgmarkerelement/svg_markerunits_strokewidth/) | Значение атрибута ‘markerUnits’ равно 'strokeWidth'. |
| const [SVG_MARKERUNITS_UNKNOWN](../../aspose.svg/svgmarkerelement/svg_markerunits_unknown/) | Тип единицы маркера не относится к предопределённым типам. Недопустимо пытаться определить новое значение этого типа или пытаться переключить существующее значение на этот тип. |
| const [SVG_MARKERUNITS_USERSPACEONUSE](../../aspose.svg/svgmarkerelement/svg_markerunits_userspaceonuse/) | Значение атрибута ‘markerUnits’ равно 'userSpaceOnUse'. |
| const [SVG_MARKER_ORIENT_ANGLE](../../aspose.svg/svgmarkerelement/svg_marker_orient_angle/) | Атрибут ‘orient’ имеет угловое значение. |
| const [SVG_MARKER_ORIENT_AUTO](../../aspose.svg/svgmarkerelement/svg_marker_orient_auto/) | Атрибут ‘orient’ имеет значение 'auto'. |
| const [SVG_MARKER_ORIENT_UNKNOWN](../../aspose.svg/svgmarkerelement/svg_marker_orient_unknown/) | Ориентация маркера не относится к предопределённым типам. Недопустимо пытаться определить новое значение этого типа или пытаться переключить существующее значение на этот тип. |
