...
type: docs
weight: 3280
url: /ru/net/aspose.svg/svgmarkerelement/
---
...
| [MarkerHeight](../../aspose.svg/svgmarkerelement/markerheight) { get; } | Соответствует атрибуту 'markerHeight' данного элемента 'marker'. |
| [MarkerUnits](../../aspose.svg/svgmarkerelement/markerunits) { get; } | Соответствует атрибуту 'markerUnits' данного элемента 'marker'. Один из типов маркеров, определенных в этом интерфейсе. |
| [MarkerWidth](../../aspose.svg/svgmarkerelement/markerwidth) { get; } | Соответствует атрибуту 'markerWidth' данного элемента 'marker'. |
...
| [OrientAngle](../../aspose.svg/svgmarkerelement/orientangle) { get; } | Соответствует атрибуту 'ориентация' данного элемента 'маркер'. Если markerUnits равно SVG_MARKER_ORIENT_ANGLE, значение угла для атрибута 'ориентация'; в противном случае он будет установлен равным нулю. |
| [OrientType](../../aspose.svg/svgmarkerelement/orienttype) { get; } | Соответствует атрибуту 'ориентация' данного элемента 'маркер'. Один из типов ориентации маркера, определенных в этом интерфейсе. |
...
| [PreserveAspectRatio](../../aspose.svg/svgmarkerelement/preserveaspectratio) { get; } | Соответствует атрибуту preserveAspectRatio данного элемента. |
...
| [RefX](../../aspose.svg/svgmarkerelement/refx) { get; } | Соответствует атрибуту 'refX' данного элемента 'marker'. |
| [RefY](../../aspose.svg/svgmarkerelement/refy) { get; } | Соответствует атрибуту 'refY' данного элемента 'marker'. |
...
| [ViewBox](../../aspose.svg/svgmarkerelement/viewbox) { get; } | Соответствует атрибуту 'viewBox' данного элемента. |
...
| [SetOrientToAngle](../../aspose.svg/svgmarkerelement/setorienttoangle)(SVGAngle) | Устанавливает значение атрибута 'ориентация' на заданный угол. |
| [SetOrientToAuto](../../aspose.svg/svgmarkerelement/setorienttoauto)() | Устанавливает значение атрибута 'ориентация' в 'авто'. |
...
| Имя | Описание |
| --- | --- |
| const [SVG_MARKERUNITS_STROKEWIDTH](../../aspose.svg/svgmarkerelement/svg_markerunits_strokewidth) | Значением атрибута 'markerUnits' является 'strokeWidth'. |
| const [SVG_MARKERUNITS_UNKNOWN](../../aspose.svg/svgmarkerelement/svg_markerunits_unknown) | Тип блока маркера не является одним из предопределенных типов. Недопустимо пытаться определить новое значение этого типа или пытаться переключить существующее значение на этот тип. |
| const [SVG_MARKERUNITS_USERSPACEONUSE](../../aspose.svg/svgmarkerelement/svg_markerunits_userspaceonuse) | Значением атрибута 'markerUnits' является 'userSpaceOnUse'. |
| const [SVG_MARKER_ORIENT_ANGLE](../../aspose.svg/svgmarkerelement/svg_marker_orient_angle) | Атрибут 'ориентация' имеет значение угла. |
| const [SVG_MARKER_ORIENT_AUTO](../../aspose.svg/svgmarkerelement/svg_marker_orient_auto) | Атрибут 'ориентация' имеет значение 'авто'. |
| const [SVG_MARKER_ORIENT_UNKNOWN](../../aspose.svg/svgmarkerelement/svg_marker_orient_unknown) | Ориентация маркера не относится к одному из предопределенных типов. Недопустимо пытаться определить новое значение этого типа или пытаться переключить существующее значение на этот тип. |
