---
title: "SVGPathElement класс"
second_title: "Aspose.SVG для .NET справочник API"
description: "Aspose.Svg.SVGPathElement класс. Интерфейс SVGPathElement соответствует элементу path."
type: docs
weight: 5440
...
| [CreateSVGPathSegArcAbs](../../aspose.svg/svgpathelement/createsvgpathsegarcabs/)(*float, float, float, float, float, bool, bool*) | Возвращает отдельный, безродительский объект SVGPathSegArcAbs. |
| [CreateSVGPathSegArcRel](../../aspose.svg/svgpathelement/createsvgpathsegarcrel/)(*float, float, float, float, float, bool, bool*) | Возвращает отдельный, безродительский объект SVGPathSegArcRel. |
| [CreateSVGPathSegClosePath](../../aspose.svg/svgpathelement/createsvgpathsegclosepath/)() | Возвращает отдельный, безродительский объект SVGPathSegClosePath. |
| [CreateSVGPathSegCurvetoCubicAbs](../../aspose.svg/svgpathelement/createsvgpathsegcurvetocubicabs/)(*float, float, float, float, float, float*) | Возвращает отдельный, безродительский объект SVGPathSegCurvetoCubicAbs. |
| [CreateSVGPathSegCurvetoCubicRel](../../aspose.svg/svgpathelement/createsvgpathsegcurvetocubicrel/)(*float, float, float, float, float, float*) | Возвращает отдельный, безродительский объект SVGPathSegCurvetoCubicRel. |
| [CreateSVGPathSegCurvetoCubicSmoothAbs](../../aspose.svg/svgpathelement/createsvgpathsegcurvetocubicsmoothabs/)(*float, float, float, float*) | Возвращает отдельный, безродительский объект SVGPathSegCurvetoCubicSmoothAbs. |
| [CreateSVGPathSegCurvetoCubicSmoothRel](../../aspose.svg/svgpathelement/createsvgpathsegcurvetocubicsmoothrel/)(*float, float, float, float*) | Возвращает отдельный, безродительский объект SVGPathSegCurvetoCubicSmoothRel. |
| [CreateSVGPathSegCurvetoQuadraticAbs](../../aspose.svg/svgpathelement/createsvgpathsegcurvetoquadraticabs/)(*float, float, float, float*) | Возвращает отдельный, безродительский объект SVGPathSegCurvetoQuadraticAbs. |
| [CreateSVGPathSegCurvetoQuadraticRel](../../aspose.svg/svgpathelement/createsvgpathsegcurvetoquadraticrel/)(*float, float, float, float*) | Возвращает отдельный, безродительский объект SVGPathSegCurvetoQuadraticRel. |
| [CreateSVGPathSegCurvetoQuadraticSmoothAbs](../../aspose.svg/svgpathelement/createsvgpathsegcurvetoquadraticsmoothabs/)(*float, float*) | Возвращает отдельный, безродительский объект SVGPathSegCurvetoQuadraticSmoothAbs. |
| [CreateSVGPathSegCurvetoQuadraticSmoothRel](../../aspose.svg/svgpathelement/createsvgpathsegcurvetoquadraticsmoothrel/)(*float, float*) | Возвращает отдельный, безродительский объект SVGPathSegCurvetoQuadraticSmoothRel. |
| [CreateSVGPathSegLinetoAbs](../../aspose.svg/svgpathelement/createsvgpathseglinetoabs/)(*float, float*) | Возвращает отдельный, безродительский объект SVGPathSegLinetoAbs. |
| [CreateSVGPathSegLinetoHorizontalAbs](../../aspose.svg/svgpathelement/createsvgpathseglinetohorizontalabs/)(*float*) | Возвращает отдельный, безродительский объект SVGPathSegLinetoHorizontalAbs. |
| [CreateSVGPathSegLinetoHorizontalRel](../../aspose.svg/svgpathelement/createsvgpathseglinetohorizontalrel/)(*float*) | Возвращает отдельный, безродительский объект SVGPathSegLinetoHorizontalRel. |
| [CreateSVGPathSegLinetoRel](../../aspose.svg/svgpathelement/createsvgpathseglinetorel/)(*float, float*) | Возвращает отдельный, безродительский объект SVGPathSegLinetoRel. |
| [CreateSVGPathSegLinetoVerticalAbs](../../aspose.svg/svgpathelement/createsvgpathseglinetoverticalabs/)(*float*) | Возвращает отдельный, безродительский объект SVGPathSegLinetoVerticalAbs. |
| [CreateSVGPathSegLinetoVerticalRel](../../aspose.svg/svgpathelement/createsvgpathseglinetoverticalrel/)(*float*) | Возвращает отдельный, безродительский объект SVGPathSegLinetoVerticalRel. |
| [CreateSVGPathSegMovetoAbs](../../aspose.svg/svgpathelement/createsvgpathsegmovetoabs/)(*float, float*) | Возвращает отдельный, безродительский объект SVGPathSegMovetoAbs. |
| [CreateSVGPathSegMovetoRel](../../aspose.svg/svgpathelement/createsvgpathsegmovetorel/)(*float, float*) | Возвращает отдельный, не имеющий родителя объект SVGPathSegMovetoRel. |
