...
description: "Aspose.Svg.SVGSymbolElement класс. Интерфейс SVGSymbolElement соответствует элементу symbol"
type: docs
weight: 5570
...
| [PreserveAspectRatio](../../aspose.svg/svgsymbolelement/preserveaspectratio/) { get; } | Соответствует атрибуту ‘preserveAspectRatio’ заданного элемента. |
...
| [ViewBox](../../aspose.svg/svgsymbolelement/viewbox/) { get; } | Соответствует атрибуту ‘viewBox’ заданного элемента. |
