...
description: Aspose.Svg.Sandbox перечисление. Набор флагов песочницы  это набор из нуля или более следующих флагов которые используются для ограничения возможностей потенциально ненадежных ресурсов.
type: docs
weight: 3610
