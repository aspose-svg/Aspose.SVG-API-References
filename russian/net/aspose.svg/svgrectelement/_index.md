...
description: Aspose.Svg.SVGRectElement сорт. Интерфейс SVGRectElement соответствует элементу rect.
type: docs
weight: 3420
...
| [Height](../../aspose.svg/svgrectelement/height/) { get; } | Соответствует атрибуту "высота" данного элемента "прямоугольник". |
...
| [Width](../../aspose.svg/svgrectelement/width/) { get; } | Соответствует атрибуту «ширина» данного элемента «прямоугольник». |
