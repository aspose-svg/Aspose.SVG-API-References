...
type: docs
weight: 3320
url: /ru/net/aspose.svg/svgpatternelement/
---
...
| [Height](../../aspose.svg/svgpatternelement/height) { get; } | Соответствует атрибуту 'высота' данного элемента 'шаблона'. |
| [Href](../../aspose.svg/svgpatternelement/href) { get; } | Соответствует атрибуту 'xlink:href' данного элемента. |
...
| [PatternContentUnits](../../aspose.svg/svgpatternelement/patterncontentunits) { get; } | Соответствует атрибуту 'patternContentUnits' данного элемента 'pattern'. Принимает одну из констант, определенных в SVGUnitTypes. |
| [PatternTransform](../../aspose.svg/svgpatternelement/patterntransform) { get; } | Соответствует атрибуту 'patternTransform' данного элемента 'pattern'. |
| [PatternUnits](../../aspose.svg/svgpatternelement/patternunits) { get; } | Соответствует атрибуту 'patternUnits' данного элемента 'pattern'. Принимает одну из констант, определенных в SVGUnitTypes. |
...
| [PreserveAspectRatio](../../aspose.svg/svgpatternelement/preserveaspectratio) { get; } | Соответствует атрибуту preserveAspectRatio данного элемента. |
...
| [RequiredExtensions](../../aspose.svg/svgpatternelement/requiredextensions) { get; } | Соответствует атрибуту 'requiredExtensions' данного элемента. |
| [RequiredFeatures](../../aspose.svg/svgpatternelement/requiredfeatures) { get; } | Соответствует атрибуту 'requiredFeatures' данного элемента. |
...
| [SystemLanguage](../../aspose.svg/svgpatternelement/systemlanguage) { get; } | Соответствует атрибуту 'systemLanguage' данного элемента. |
...
| [ViewBox](../../aspose.svg/svgpatternelement/viewbox) { get; } | Соответствует атрибуту 'viewBox' данного элемента. |
...
| [Width](../../aspose.svg/svgpatternelement/width) { get; } | Соответствует атрибуту 'width' данного элемента 'pattern'. |
| [X](../../aspose.svg/svgpatternelement/x) { get; } | Соответствует атрибуту 'x' данного элемента 'pattern'. |
| [Y](../../aspose.svg/svgpatternelement/y) { get; } | Соответствует атрибуту 'y' данного элемента 'pattern'. |
