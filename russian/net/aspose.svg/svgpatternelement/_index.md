...
description: Aspose.Svg.SVGPatternElement сорт. Интерфейс SVGPatternElement соответствует элементу шаблон.
type: docs
weight: 3380
...
| [PatternUnits](../../aspose.svg/svgpatternelement/patternunits/) { get; } | Соответствует атрибуту 'patternUnits' данного элемента 'шаблона'. Принимает одну из констант, определенных в SVGUnitTypes. |
...
| [Width](../../aspose.svg/svgpatternelement/width/) { get; } | Соответствует атрибуту «ширина» данного элемента «шаблона». |
| [X](../../aspose.svg/svgpatternelement/x/) { get; } | Соответствует атрибуту «x» данного элемента «шаблона». |
