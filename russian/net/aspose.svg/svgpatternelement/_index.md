...
description: "Класс Aspose.Svg.SVGPatternElement. Интерфейс SVGPatternElement соответствует элементу pattern."
type: docs
weight: 5450
...
| [Height](../../aspose.svg/svgpatternelement/height/) { get; } | Соответствует атрибуту ‘height’ в указанном элементе ‘pattern’. |
| [Href](../../aspose.svg/svgpatternelement/href/) { get; } | Соответствует атрибуту ‘xlink:href’ у указанного элемента. |
...
| [PatternContentUnits](../../aspose.svg/svgpatternelement/patterncontentunits/) { get; } | Соответствует атрибуту ‘patternContentUnits’ в указанном элементе ‘pattern’. Принимает одну из констант, определённых в SVGUnitTypes. |
| [PatternTransform](../../aspose.svg/svgpatternelement/patterntransform/) { get; } | Соответствует атрибуту ‘patternTransform’ в указанном элементе ‘pattern’. |
| [PatternUnits](../../aspose.svg/svgpatternelement/patternunits/) { get; } | Соответствует атрибуту ‘patternUnits’ в данном элементе ‘pattern’. Принимает одну из констант, определённых в SVGUnitTypes. |
...
| [PreserveAspectRatio](../../aspose.svg/svgpatternelement/preserveaspectratio/) { get; } | Соответствует атрибуту ‘preserveAspectRatio’ заданного элемента. |
...
| [ViewBox](../../aspose.svg/svgpatternelement/viewbox/) { get; } | Соответствует атрибуту ‘viewBox’ заданного элемента. |
...
| [Width](../../aspose.svg/svgpatternelement/width/) { get; } | Соответствует атрибуту ‘width’ в данном элементе ‘pattern’. |
| [X](../../aspose.svg/svgpatternelement/x/) { get; } | Соответствует атрибуту ‘x’ в данном элементе ‘pattern’. |
| [Y](../../aspose.svg/svgpatternelement/y/) { get; } | Соответствует атрибуту ‘y’ в данном элементе ‘pattern’. |
