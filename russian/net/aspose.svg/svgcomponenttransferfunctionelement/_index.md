...
description: "Aspose.Svg.SVGComponentTransferFunctionElement класс. Этот интерфейс определяет базовый интерфейс, используемый интерфейсами функций передачи компонентов"
type: docs
weight: 5220
...
Этот интерфейс определяет базовый интерфейс, используемый интерфейсами функций передачи компонента.
...
| Имя | Описание |
| --- | --- |
| [Amplitude](../../aspose.svg/svgcomponenttransferfunctionelement/amplitude/) { get; } | Соответствует атрибуту ‘amplitude’ в данном элементе. |
...
| [Exponent](../../aspose.svg/svgcomponenttransferfunctionelement/exponent/) { get; } | Соответствует атрибуту ‘exponent’ в данном элементе. |
...
| [Intercept](../../aspose.svg/svgcomponenttransferfunctionelement/intercept/) { get; } | Соответствует атрибуту ‘intercept’ в данном элементе. |
...
| [Offset](../../aspose.svg/svgcomponenttransferfunctionelement/offset/) { get; } | Соответствует атрибуту ‘offset’ в данном элементе. |
...
| [Slope](../../aspose.svg/svgcomponenttransferfunctionelement/slope/) { get; } | Соответствует атрибуту ‘slope’ в данном элементе. |
...
| [TableValues](../../aspose.svg/svgcomponenttransferfunctionelement/tablevalues/) { get; } | Соответствует атрибуту ‘tableValues’ в данном элементе. |
...
| [Type](../../aspose.svg/svgcomponenttransferfunctionelement/type/) { get; } | Соответствует атрибуту ‘type’ в данном элементе. Принимает одну из констант SVG_FECOMPONENTTRANSFER_TYPE_*, определённых в этом интерфейсе. |
...
| Имя | Описание |
| --- | --- |
| const [SVG_FECOMPONENTTRANSFER_TYPE_DISCRETE](../../aspose.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_discrete/) | Соответствует значению 'discrete'. |
...
| const [SVG_FECOMPONENTTRANSFER_TYPE_LINEAR](../../aspose.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_linear/) | Соответствует значению 'linear'. |
| const [SVG_FECOMPONENTTRANSFER_TYPE_TABLE](../../aspose.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_table/) | Соответствует значению 'table'. |
| const [SVG_FECOMPONENTTRANSFER_TYPE_UNKNOWN](../../aspose.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_unknown/) | Тип не является одним из предопределённых типов. Недопустимо пытаться определить новое значение этого типа или попытаться переключить существующее значение на этот тип. |
