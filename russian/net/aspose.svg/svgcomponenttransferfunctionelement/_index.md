...
description: Aspose.Svg.SVGComponentTransferFunctionElement сорт. Этот интерфейс определяет базовый интерфейс используемый интерфейсами функции передачи компонентов.
type: docs
weight: 3150
...
| [Exponent](../../aspose.svg/svgcomponenttransferfunctionelement/exponent/) { get; } | Соответствует атрибуту «показатель степени» данного элемента. |
...
| [Intercept](../../aspose.svg/svgcomponenttransferfunctionelement/intercept/) { get; } | Соответствует атрибуту «перехват» данного элемента. |
...
| [Offset](../../aspose.svg/svgcomponenttransferfunctionelement/offset/) { get; } | Соответствует смещению атрибута данного элемента. |
...
| [Type](../../aspose.svg/svgcomponenttransferfunctionelement/type/) { get; } | Соответствует типу атрибута данного элемента. Принимает одну из констант SVG_FECOMPONENTTRANSFER_TYPE_*, определенных в этом интерфейсе. |
...
| const [SVG_FECOMPONENTTRANSFER_TYPE_GAMMA](../../aspose.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_gamma/) | Соответствует значению «гамма». |
