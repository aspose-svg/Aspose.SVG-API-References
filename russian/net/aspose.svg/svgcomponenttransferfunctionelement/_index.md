...
description: Этот интерфейс определяет базовый интерфейс используемый интерфейсами передаточной функции компонента.
type: docs
weight: 3090
url: /ru/net/aspose.svg/svgcomponenttransferfunctionelement/
---
## SVGComponentTransferFunctionElement class

Этот интерфейс определяет базовый интерфейс, используемый интерфейсами передаточной функции компонента.
...
| Имя | Описание |
| --- | --- |
| [Amplitude](../../aspose.svg/svgcomponenttransferfunctionelement/amplitude) { get; } | Соответствует атрибуту 'амплитуда' данного элемента. |
...
| [Exponent](../../aspose.svg/svgcomponenttransferfunctionelement/exponent) { get; } | Соответствует атрибуту exponent данного элемента. |
...
| [Intercept](../../aspose.svg/svgcomponenttransferfunctionelement/intercept) { get; } | Соответствует атрибуту 'intercept' данного элемента. |
...
| [Offset](../../aspose.svg/svgcomponenttransferfunctionelement/offset) { get; } | Соответствует атрибуту 'смещение' данного элемента. |
...
| [Slope](../../aspose.svg/svgcomponenttransferfunctionelement/slope) { get; } | Соответствует атрибуту 'наклон' данного элемента. |
...
| [TableValues](../../aspose.svg/svgcomponenttransferfunctionelement/tablevalues) { get; } | Соответствует атрибуту 'tableValues' данного элемента. |
...
| [Type](../../aspose.svg/svgcomponenttransferfunctionelement/type) { get; } | Соответствует атрибуту 'type' данного элемента. Принимает одну из констант SVG_FECOMPONENTTRANSFER_TYPE_*, определенных в этом интерфейсе. |
...
| Имя | Описание |
| --- | --- |
| const [SVG_FECOMPONENTTRANSFER_TYPE_DISCRETE](../../aspose.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_discrete) | Соответствует значению 'дискретный'. |
| const [SVG_FECOMPONENTTRANSFER_TYPE_GAMMA](../../aspose.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_gamma) | Соответствует значению 'gamma'. |
| const [SVG_FECOMPONENTTRANSFER_TYPE_IDENTITY](../../aspose.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_identity) | Соответствует значению 'identity'. |
| const [SVG_FECOMPONENTTRANSFER_TYPE_LINEAR](../../aspose.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_linear) | Соответствует значению 'линейный'. |
| const [SVG_FECOMPONENTTRANSFER_TYPE_TABLE](../../aspose.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_table) | Соответствует значению 'таблица'. |
| const [SVG_FECOMPONENTTRANSFER_TYPE_UNKNOWN](../../aspose.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_unknown) | Тип не является одним из предопределенных типов. Недопустимо пытаться определить новое значение этого типа или пытаться переключить существующее значение на этот тип. |
