---
title: "Класс SVGMaskElement"
second_title: "Aspose.SVG для .NET справочник API"
description: "Класс Aspose.Svg.SVGMaskElement. Интерфейс SVGMaskElement соответствует элементу mask"
type: docs
weight: 5420
...
| [Height](../../aspose.svg/svgmaskelement/height/) { get; } | Соответствует атрибуту ‘height’ у данного элемента ‘mask’. Принимает одну из констант, определённых в SVGUnitTypes. |
...
| [MaskContentUnits](../../aspose.svg/svgmaskelement/maskcontentunits/) { get; } | Соответствует атрибуту ‘maskContentUnits’ у данного элемента ‘mask’. Принимает одну из констант, определённых в SVGUnitTypes. |
| [MaskUnits](../../aspose.svg/svgmaskelement/maskunits/) { get; } | Соответствует атрибуту ‘maskUnits’ у данного элемента ‘mask’. Принимает одну из констант, определённых в SVGUnitTypes. |
...
| [Width](../../aspose.svg/svgmaskelement/width/) { get; } | Соответствует атрибуту ‘width’ у данного элемента ‘mask’. Принимает одну из констант, определённых в SVGUnitTypes. |
| [X](../../aspose.svg/svgmaskelement/x/) { get; } | Соответствует атрибуту ‘x’ у данного элемента ‘mask’. Принимает одну из констант, определённых в SVGUnitTypes. |
| [Y](../../aspose.svg/svgmaskelement/y/) { get; } | Соответствует атрибуту ‘y’ у данного элемента ‘mask’. Принимает одну из констант, определённых в SVGUnitTypes. |
