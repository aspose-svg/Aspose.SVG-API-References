...
type: docs
weight: 3290
url: /ru/net/aspose.svg/svgmaskelement/
---
...
| [Height](../../aspose.svg/svgmaskelement/height) { get; } | Соответствует атрибуту 'высота' данного элемента 'маски'. Принимает одну из констант, определенных в SVGUnitTypes. |
...
| [MaskContentUnits](../../aspose.svg/svgmaskelement/maskcontentunits) { get; } | Соответствует атрибуту 'maskContentUnits' данного элемента 'mask'. Принимает одну из констант, определенных в SVGUnitTypes. |
| [MaskUnits](../../aspose.svg/svgmaskelement/maskunits) { get; } | Соответствует атрибуту 'maskUnits' данного элемента 'mask'. Принимает одну из констант, определенных в SVGUnitTypes. |
...
| [RequiredExtensions](../../aspose.svg/svgmaskelement/requiredextensions) { get; } | Соответствует атрибуту 'requiredExtensions' данного элемента. |
| [RequiredFeatures](../../aspose.svg/svgmaskelement/requiredfeatures) { get; } | Соответствует атрибуту 'requiredFeatures' данного элемента. |
...
| [SystemLanguage](../../aspose.svg/svgmaskelement/systemlanguage) { get; } | Соответствует атрибуту 'systemLanguage' данного элемента. |
...
| [Width](../../aspose.svg/svgmaskelement/width) { get; } | Соответствует атрибуту 'ширина' данного элемента 'маски'. Принимает одну из констант, определенных в SVGUnitTypes. |
| [X](../../aspose.svg/svgmaskelement/x) { get; } | Соответствует атрибуту 'x' данного элемента 'mask'. Принимает одну из констант, определенных в SVGUnitTypes. |
| [Y](../../aspose.svg/svgmaskelement/y) { get; } | Соответствует атрибуту 'y' данного элемента 'mask'. Принимает одну из констант, определенных в SVGUnitTypes. |
