...
description: Aspose.Svg.SVGForeignObjectElement сорт. Интерфейс SVGForeignObjectElement соответствует элементу foreignObject.
type: docs
weight: 3250
...
| [Height](../../aspose.svg/svgforeignobjectelement/height/) { get; } | Соответствует атрибуту «высота» данного элемента «foreignObject». |
