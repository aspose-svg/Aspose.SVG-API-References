...
description: "Класс Aspose.Svg.SVGForeignObjectElement. Интерфейс SVGForeignObjectElement соответствует элементу foreignObject."
type: docs
weight: 5320
...
| [Height](../../aspose.svg/svgforeignobjectelement/height/) { get; } | Соответствует атрибуту ‘height’ в данном элементе ‘foreignObject’. |
...
| [Width](../../aspose.svg/svgforeignobjectelement/width/) { get; } | Соответствует атрибуту ‘width’ в данном элементе ‘foreignObject’. |
| [X](../../aspose.svg/svgforeignobjectelement/x/) { get; } | Соответствует атрибуту ‘x’ в данном элементе ‘foreignObject’. |
| [Y](../../aspose.svg/svgforeignobjectelement/y/) { get; } | Соответствует атрибуту ‘y’ в данном элементе ‘foreignObject’. |
