...
description: "Класс Aspose.Svg.SVGViewElement. Интерфейс SVGViewElement соответствует элементу view."
type: docs
weight: 5660
...
| [PreserveAspectRatio](../../aspose.svg/svgviewelement/preserveaspectratio/) { get; } | Соответствует атрибуту ‘preserveAspectRatio’ заданного элемента. |
...
| [ViewBox](../../aspose.svg/svgviewelement/viewbox/) { get; } | Соответствует атрибуту ‘viewBox’ заданного элемента. |
...
| [ViewTarget](../../aspose.svg/svgviewelement/viewtarget/) { get; } | Соответствует атрибуту ‘viewTarget’ в указанном элементе ‘view’. Список значений DOMString, содержащих имена, указанные в атрибуте ‘viewTarget’. Каждое значение DOMString может быть связано с соответствующим элементом с помощью вызова метода getElementById(). |
| [ZoomAndPan](../../aspose.svg/svgviewelement/zoomandpan/) { get; set; } | Соответствует атрибуту ‘zoomAndPan’ заданного элемента. Значение должно быть одной из констант SVG_ZOOMANDPAN_*, определённых в этом интерфейсе. |
