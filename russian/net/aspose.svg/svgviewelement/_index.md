...
type: docs
weight: 3530
url: /ru/net/aspose.svg/svgviewelement/
---
...
| [PreserveAspectRatio](../../aspose.svg/svgviewelement/preserveaspectratio) { get; } | Соответствует атрибуту preserveAspectRatio данного элемента. |
...
| [ViewBox](../../aspose.svg/svgviewelement/viewbox) { get; } | Соответствует атрибуту 'viewBox' данного элемента. |
...
| [ViewTarget](../../aspose.svg/svgviewelement/viewtarget) { get; } | Соответствует атрибуту 'viewTarget' данного элемента 'view'. Список значений DOMString, содержащих имена, перечисленные в атрибуте viewTarget. Каждое из значений DOMString может быть связано с соответствующим элементом с помощью вызова метода getElementById(). |
| [ZoomAndPan](../../aspose.svg/svgviewelement/zoomandpan) { get; set; } | Соответствует атрибуту 'zoomAndPan' данного элемента. Значение должно быть одной из констант SVG_ZOOMANDPAN_*, определенных в этом интерфейсе. |
