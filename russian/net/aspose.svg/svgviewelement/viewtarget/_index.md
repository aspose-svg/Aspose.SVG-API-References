...
description: Соответствует атрибуту viewTarget данного элемента представление. Список значений DOMString содержащих имена перечисленные в атрибуте viewTarget. Каждое из значений DOMString может быть связано с соответствующим элементом с помощью вызова метода getElementById.
type: docs
weight: 30
