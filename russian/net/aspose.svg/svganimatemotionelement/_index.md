---
title: "Класс SVGAnimateMotionElement"
second_title: "Aspose.SVG для .NET справочник API"
description: "Класс Aspose.Svg.SVGAnimateMotionElement. Интерфейс SVGAnimateMotionElement соответствует элементу animateMotion. Объектно‑ориентированный доступ к атрибутам элемента animateMotion через SVG DOM недоступен"
type: docs
weight: 5170
