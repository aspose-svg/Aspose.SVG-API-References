...
description: Интерфейс SVGAnimateMotionElement соответствует элементу animateMotion. Объектноориентированный доступ к атрибутам элемента animateMotion через SVG DOM недоступен.
type: docs
weight: 3050
