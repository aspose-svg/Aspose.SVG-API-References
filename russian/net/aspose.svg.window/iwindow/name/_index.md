...
description: Атрибут name объекта Window должен при получении возвращать текущее имя контекста просмотра а при настройке устанавливать имя контекста просмотра в новое значение.
type: docs
weight: 40
