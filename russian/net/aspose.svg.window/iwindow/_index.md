...
description: Aspose.Svg.Window.IWindow интерфейс. Объект окна представляет собой окно содержащее документ DOM.
type: docs
weight: 3820
...
| [Name](../../aspose.svg.window/iwindow/name/) { get; set; } | Атрибут name объекта Window должен при получении возвращать текущее имя контекста просмотра, а при настройке устанавливать имя контекста просмотра в новое значение. |
...
| Имя | Описание |
| --- | --- |
| [Alert](../../aspose.svg.window/iwindow/alert/)(string) | Отображает модальное предупреждение с заданным сообщением и ждет, пока пользователь его закроет |
| [Confirm](../../aspose.svg.window/iwindow/confirm/)(string) | Отображает модальное приглашение OK/Cancel с данным сообщением, ожидает, пока пользователь отклонит его, и возвращает true, если пользователь нажимает OK, и false, если пользователь нажимает Cancel. |
