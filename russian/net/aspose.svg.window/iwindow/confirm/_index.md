...
description: Отображает модальное приглашение OK/Cancel с данным сообщением ожидает пока пользователь отклонит его и возвращает true если пользователь нажимает OK и false если пользователь нажимает Cancel.
type: docs
weight: 110
