...
type: docs
weight: 1700
url: /ru/net/aspose.svg.filters/svgfedisplacementmapelement/
---
...
| [Height](../../aspose.svg.filters/svgfedisplacementmapelement/height) { get; } | Соответствует атрибуту 'высота' данного элемента 'фильтра'. |
| [Id](../../aspose.svg/svgelement/id) { get; set; } | Значение атрибута 'id' данного элемента или пустая строка, если 'id' отсутствует. |
| [In1](../../aspose.svg.filters/svgfedisplacementmapelement/in1) { get; } | Соответствует атрибуту 'in' данного элемента 'feDisplacementMap'. |
| [In2](../../aspose.svg.filters/svgfedisplacementmapelement/in2) { get; } | Соответствует атрибуту 'in2' данного элемента 'feDisplacementMap'. |
...
| [Result](../../aspose.svg.filters/svgfedisplacementmapelement/result) { get; } | Соответствует атрибуту 'result' данного элемента 'filter'. |
| [Scale](../../aspose.svg.filters/svgfedisplacementmapelement/scale) { get; } | Соответствует атрибуту 'scale' данного элемента 'feDisplacementMap'. |
...
| [Width](../../aspose.svg.filters/svgfedisplacementmapelement/width) { get; } | Соответствует атрибуту 'width' данного элемента 'filter'. |
| [X](../../aspose.svg.filters/svgfedisplacementmapelement/x) { get; } | Соответствует атрибуту 'x' данного элемента 'filter'. |
| [XChannelSelector](../../aspose.svg.filters/svgfedisplacementmapelement/xchannelselector) { get; } | Соответствует атрибуту 'xChannelSelector' данного элемента 'feDisplacementMap'. Принимает одну из констант SVG_CHANNEL_*, определенных в этом интерфейсе. |
| [Y](../../aspose.svg.filters/svgfedisplacementmapelement/y) { get; } | Соответствует атрибуту 'y' данного элемента 'filter'. |
| [YChannelSelector](../../aspose.svg.filters/svgfedisplacementmapelement/ychannelselector) { get; } | Соответствует атрибуту yChannelSelector данного элемента feDisplacementMap. Принимает одну из констант SVG_CHANNEL_*, определенных в этом интерфейсе. |
...
| Имя | Описание |
| --- | --- |
| const [SVG_CHANNEL_A](../../aspose.svg.filters/svgfedisplacementmapelement/svg_channel_a) | Соответствует значению 'A'. |
| const [SVG_CHANNEL_B](../../aspose.svg.filters/svgfedisplacementmapelement/svg_channel_b) | Соответствует значению 'B'. |
| const [SVG_CHANNEL_G](../../aspose.svg.filters/svgfedisplacementmapelement/svg_channel_g) | Соответствует значению 'G'. |
| const [SVG_CHANNEL_R](../../aspose.svg.filters/svgfedisplacementmapelement/svg_channel_r) | Соответствует значению 'R'. |
| const [SVG_CHANNEL_UNKNOWN](../../aspose.svg.filters/svgfedisplacementmapelement/svg_channel_unknown) | Тип не является одним из предопределенных типов. Недопустимо пытаться определить новое значение этого типа или пытаться переключить существующее значение на этот тип. |
