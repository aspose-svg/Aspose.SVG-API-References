...
description: Aspose.Svg.Filters.SVGFEDisplacementMapElement сорт. Интерфейс SVGFEDisplacementMapElement соответствует элементу feDisplacementMap.
type: docs
weight: 1710
...
| [Result](../../aspose.svg.filters/svgfedisplacementmapelement/result/) { get; } | Соответствует атрибуту «результат» данного элемента «фильтр». |
| [Scale](../../aspose.svg.filters/svgfedisplacementmapelement/scale/) { get; } | Соответствует атрибуту «масштаб» данного элемента «feDisplacementMap». |
...
| [Width](../../aspose.svg.filters/svgfedisplacementmapelement/width/) { get; } | Соответствует атрибуту «ширина» данного элемента «фильтр». |
| [X](../../aspose.svg.filters/svgfedisplacementmapelement/x/) { get; } | Соответствует атрибуту «x» данного элемента «фильтр». |
| [XChannelSelector](../../aspose.svg.filters/svgfedisplacementmapelement/xchannelselector/) { get; } | Соответствует атрибуту xChannelSelector данного элемента feDisplacementMap. Принимает одну из констант SVG_CHANNEL_*, определенных на этом интерфейсе. |
| [Y](../../aspose.svg.filters/svgfedisplacementmapelement/y/) { get; } | Соответствует атрибуту 'y' данного элемента 'filter'. |
| [YChannelSelector](../../aspose.svg.filters/svgfedisplacementmapelement/ychannelselector/) { get; } | Соответствует атрибуту yChannelSelector данного элемента feDisplacementMap. Принимает одну из констант SVG_CHANNEL_*, определенных на этом интерфейсе. |
