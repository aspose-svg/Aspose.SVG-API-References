...
description: "Класс Aspose.Svg.Filters.SVGFEDisplacementMapElement. Интерфейс SVGFEDisplacementMapElement соответствует элементу feDisplacementMap"
type: docs
weight: 3800
...
| [Height](../../aspose.svg.filters/svgfedisplacementmapelement/height/) { get; } | Соответствует атрибуту ‘height’ в данном элементе ‘filter’. |
| [Id](../../aspose.svg/svgelement/id/) { get; set; } | Значение атрибута ‘id’ данного элемента, или пустая строка, если атрибут ‘id’ отсутствует. |
| [In1](../../aspose.svg.filters/svgfedisplacementmapelement/in1/) { get; } | Соответствует атрибуту ‘in’ в данном элементе ‘feDisplacementMap’. |
| [In2](../../aspose.svg.filters/svgfedisplacementmapelement/in2/) { get; } | Соответствует атрибуту ‘in2’ в данном элементе ‘feDisplacementMap’. |
...
| [Result](../../aspose.svg.filters/svgfedisplacementmapelement/result/) { get; } | Соответствует атрибуту ‘result’ указанного элемента ‘filter’. |
| [Scale](../../aspose.svg.filters/svgfedisplacementmapelement/scale/) { get; } | Соответствует атрибуту ‘scale’ в данном элементе ‘feDisplacementMap’. |
...
| [Width](../../aspose.svg.filters/svgfedisplacementmapelement/width/) { get; } | Соответствует атрибуту ‘width’ в данном элементе ‘filter’. |
| [X](../../aspose.svg.filters/svgfedisplacementmapelement/x/) { get; } | Соответствует атрибуту ‘x’ в данном элементе ‘filter’. |
| [XChannelSelector](../../aspose.svg.filters/svgfedisplacementmapelement/xchannelselector/) { get; } | Соответствует атрибуту ‘xChannelSelector’ в данном элементе ‘feDisplacementMap’. Принимает одну из констант SVG_CHANNEL_*, определённых в этом интерфейсе. |
| [Y](../../aspose.svg.filters/svgfedisplacementmapelement/y/) { get; } | Соответствует атрибуту ‘y’ в данном элементе ‘filter’. |
| [YChannelSelector](../../aspose.svg.filters/svgfedisplacementmapelement/ychannelselector/) { get; } | Соответствует атрибуту ‘yChannelSelector’ в данном элементе ‘feDisplacementMap’. Принимает одну из констант SVG_CHANNEL_*, определённых в этом интерфейсе. |
...
| const [SVG_CHANNEL_UNKNOWN](../../aspose.svg.filters/svgfedisplacementmapelement/svg_channel_unknown/) | Тип не является одним из предопределённых типов. Недопустимо пытаться определить новое значение этого типа или попытаться переключить существующее значение на этот тип. |
