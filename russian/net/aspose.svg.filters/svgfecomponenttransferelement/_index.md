...
description: Aspose.Svg.Filters.SVGFEComponentTransferElement сорт. Интерфейс SVGFEComponentTransferElement соответствует элементу feComponentTransfer.
type: docs
weight: 1670
...
| [Result](../../aspose.svg.filters/svgfecomponenttransferelement/result/) { get; } | Соответствует атрибуту «результат» данного элемента «фильтр». |
...
| [Width](../../aspose.svg.filters/svgfecomponenttransferelement/width/) { get; } | Соответствует атрибуту «ширина» данного элемента «фильтр». |
| [X](../../aspose.svg.filters/svgfecomponenttransferelement/x/) { get; } | Соответствует атрибуту «x» данного элемента «фильтр». |
