...
description: "Aspose.Svg.Filters.SVGFEComponentTransferElement класс. Интерфейс SVGFEComponentTransferElement соответствует элементу feComponentTransfer"
type: docs
weight: 3760
...
| [Height](../../aspose.svg.filters/svgfecomponenttransferelement/height/) { get; } | Соответствует атрибуту ‘height’ в данном элементе ‘filter’. |
| [Id](../../aspose.svg/svgelement/id/) { get; set; } | Значение атрибута ‘id’ данного элемента, или пустая строка, если атрибут ‘id’ отсутствует. |
| [In1](../../aspose.svg.filters/svgfecomponenttransferelement/in1/) { get; } | Соответствует атрибуту ‘in’ в данном элементе ‘feComponentTransfer’. |
...
| [Result](../../aspose.svg.filters/svgfecomponenttransferelement/result/) { get; } | Соответствует атрибуту ‘result’ указанного элемента ‘filter’. |
...
| [Width](../../aspose.svg.filters/svgfecomponenttransferelement/width/) { get; } | Соответствует атрибуту ‘width’ в данном элементе ‘filter’. |
| [X](../../aspose.svg.filters/svgfecomponenttransferelement/x/) { get; } | Соответствует атрибуту ‘x’ в данном элементе ‘filter’. |
| [Y](../../aspose.svg.filters/svgfecomponenttransferelement/y/) { get; } | Соответствует атрибуту ‘y’ в данном элементе ‘filter’. |
