...
type: docs
weight: 1850
url: /ru/net/aspose.svg.filters/svgfespecularlightingelement/
---
...
| [Height](../../aspose.svg.filters/svgfespecularlightingelement/height) { get; } | Соответствует атрибуту 'высота' данного элемента 'фильтра'. |
| [Id](../../aspose.svg/svgelement/id) { get; set; } | Значение атрибута 'id' данного элемента или пустая строка, если 'id' отсутствует. |
| [In1](../../aspose.svg.filters/svgfespecularlightingelement/in1) { get; } | Соответствует атрибуту 'in' данного элемента 'feSpecularLighting'. |
...
| [KernelUnitLengthX](../../aspose.svg.filters/svgfespecularlightingelement/kernelunitlengthx) { get; } | Соответствует атрибуту 'kernelUnitLength' данного элемента 'feSpecularLighting'. |
| [KernelUnitLengthY](../../aspose.svg.filters/svgfespecularlightingelement/kernelunitlengthy) { get; } | Соответствует атрибуту 'kernelUnitLength' данного элемента 'feSpecularLighting'. |
...
| [Result](../../aspose.svg.filters/svgfespecularlightingelement/result) { get; } | Соответствует атрибуту 'result' данного элемента 'filter'. |
...
| [SpecularConstant](../../aspose.svg.filters/svgfespecularlightingelement/specularconstant) { get; } | Соответствует атрибуту 'specularConstant' данного элемента 'feSpecularLighting'. |
| [SpecularExponent](../../aspose.svg.filters/svgfespecularlightingelement/specularexponent) { get; } | Соответствует атрибуту 'specularExponent' данного элемента 'feSpecularLighting'. |
...
| [SurfaceScale](../../aspose.svg.filters/svgfespecularlightingelement/surfacescale) { get; } | Соответствует атрибуту 'surfaceScale' данного элемента 'feSpecularLighting'. |
...
| [Width](../../aspose.svg.filters/svgfespecularlightingelement/width) { get; } | Соответствует атрибуту 'width' данного элемента 'filter'. |
| [X](../../aspose.svg.filters/svgfespecularlightingelement/x) { get; } | Соответствует атрибуту 'x' данного элемента 'filter'. |
| [Y](../../aspose.svg.filters/svgfespecularlightingelement/y) { get; } | Соответствует атрибуту 'y' данного элемента 'filter'. |
