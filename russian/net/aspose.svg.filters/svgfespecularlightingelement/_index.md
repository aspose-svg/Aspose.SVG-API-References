...
description: Aspose.Svg.Filters.SVGFESpecularLightingElement сорт. Интерфейс SVGFESpecularLightingElement соответствует элементу feSpecularLighting.
type: docs
weight: 1860
...
| [Result](../../aspose.svg.filters/svgfespecularlightingelement/result/) { get; } | Соответствует атрибуту «результат» данного элемента «фильтр». |
...
| [Width](../../aspose.svg.filters/svgfespecularlightingelement/width/) { get; } | Соответствует атрибуту «ширина» данного элемента «фильтр». |
| [X](../../aspose.svg.filters/svgfespecularlightingelement/x/) { get; } | Соответствует атрибуту «x» данного элемента «фильтр». |
