...
description: Aspose.Svg.Filters.SVGFEMergeElement сорт. Интерфейс SVGFEMergeElement соответствует элементу feMerge.
type: docs
weight: 1810
...
| [Result](../../aspose.svg.filters/svgfemergeelement/result/) { get; } | Соответствует атрибуту «результат» данного элемента «фильтр». |
...
| [Width](../../aspose.svg.filters/svgfemergeelement/width/) { get; } | Соответствует атрибуту «ширина» данного элемента «фильтр». |
| [X](../../aspose.svg.filters/svgfemergeelement/x/) { get; } | Соответствует атрибуту «x» данного элемента «фильтр». |
