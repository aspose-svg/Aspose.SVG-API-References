...
description: Aspose.Svg.Filters.SVGFETileElement сорт. Интерфейс SVGFETileElement соответствует элементу feTile.
type: docs
weight: 1880
...
| [Result](../../aspose.svg.filters/svgfetileelement/result/) { get; } | Соответствует атрибуту «результат» данного элемента «фильтр». |
...
| [Width](../../aspose.svg.filters/svgfetileelement/width/) { get; } | Соответствует атрибуту «ширина» данного элемента «фильтр». |
| [X](../../aspose.svg.filters/svgfetileelement/x/) { get; } | Соответствует атрибуту «x» данного элемента «фильтр». |
