...
description: "Aspose.Svg.Filters.SVGFETileElement класс. Интерфейс SVGFETileElement соответствует элементу feTile."
type: docs
weight: 3970
...
| [Height](../../aspose.svg.filters/svgfetileelement/height/) { get; } | Соответствует атрибуту ‘height’ в данном элементе ‘filter’. |
| [Id](../../aspose.svg/svgelement/id/) { get; set; } | Значение атрибута ‘id’ данного элемента, или пустая строка, если атрибут ‘id’ отсутствует. |
| [In1](../../aspose.svg.filters/svgfetileelement/in1/) { get; } | Соответствует атрибуту ‘in’ указанного элемента ‘feTile’. |
...
| [Result](../../aspose.svg.filters/svgfetileelement/result/) { get; } | Соответствует атрибуту ‘result’ указанного элемента ‘filter’. |
...
| [Width](../../aspose.svg.filters/svgfetileelement/width/) { get; } | Соответствует атрибуту ‘width’ в данном элементе ‘filter’. |
| [X](../../aspose.svg.filters/svgfetileelement/x/) { get; } | Соответствует атрибуту ‘x’ в данном элементе ‘filter’. |
| [Y](../../aspose.svg.filters/svgfetileelement/y/) { get; } | Соответствует атрибуту ‘y’ в данном элементе ‘filter’. |
