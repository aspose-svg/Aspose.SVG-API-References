...
description: Aspose.Svg.Filters.SVGFEImageElement сорт. Интерфейс SVGFEImageElement соответствует элементу feImage.
type: docs
weight: 1800
...
| [Result](../../aspose.svg.filters/svgfeimageelement/result/) { get; } | Соответствует атрибуту «результат» данного элемента «фильтр». |
...
| [Width](../../aspose.svg.filters/svgfeimageelement/width/) { get; } | Соответствует атрибуту «ширина» данного элемента «фильтр». |
| [X](../../aspose.svg.filters/svgfeimageelement/x/) { get; } | Соответствует атрибуту «x» данного элемента «фильтр». |
