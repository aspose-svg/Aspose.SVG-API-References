...
description: "Aspose.Svg.Filters.SVGFEDistantLightElement класс. Интерфейс SVGFEDistantLightElement соответствует элементу feDistantLight."
type: docs
weight: 3810
...
| [Azimuth](../../aspose.svg.filters/svgfedistantlightelement/azimuth/) { get; } | Соответствует атрибуту ‘azimuth’ в данном элементе ‘feDistantLight’. |
...
| [Elevation](../../aspose.svg.filters/svgfedistantlightelement/elevation/) { get; } | Соответствует атрибуту ‘elevation’ в данном элементе ‘feDistantLight’. |
