...
description: "Aspose.Svg.Filters.SVGFESpotLightElement класс. Интерфейс SVGFESpotLightElement соответствует элементу feSpotLight."
type: docs
weight: 3960
...
| [LimitingConeAngle](../../aspose.svg.filters/svgfespotlightelement/limitingconeangle/) { get; } | Соответствует атрибуту ‘limitingConeAngle’ в данном элементе ‘feSpotLight’. |
...
| [PointsAtX](../../aspose.svg.filters/svgfespotlightelement/pointsatx/) { get; } | Соответствует атрибуту ‘pointsAtX’ в данном элементе ‘feSpotLight’. |
| [PointsAtY](../../aspose.svg.filters/svgfespotlightelement/pointsaty/) { get; } | Соответствует атрибуту ‘pointsAtY’ в данном элементе ‘feSpotLight’. |
| [PointsAtZ](../../aspose.svg.filters/svgfespotlightelement/pointsatz/) { get; } | Соответствует атрибуту ‘pointsAtZ’ в данном элементе ‘feSpotLight’. |
...
| [SpecularExponent](../../aspose.svg.filters/svgfespotlightelement/specularexponent/) { get; } | Соответствует атрибуту ‘specularExponent’ в данном элементе ‘feSpotLight’. |
...
| [X](../../aspose.svg.filters/svgfespotlightelement/x/) { get; } | Соответствует атрибуту ‘x’ в данном элементе ‘feSpotLight’. |
| [Y](../../aspose.svg.filters/svgfespotlightelement/y/) { get; } | Соответствует атрибуту ‘y’ в данном элементе ‘feSpotLight’. |
| [Z](../../aspose.svg.filters/svgfespotlightelement/z/) { get; } | Соответствует атрибуту ‘z’ в данном элементе ‘feSpotLight’. |
