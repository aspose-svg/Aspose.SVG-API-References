...
description: Aspose.Svg.Filters.SVGFEBlendElement сорт. Интерфейс SVGFEBlendElement соответствует элементу feBlend.
type: docs
weight: 1650
...
| [Mode](../../aspose.svg.filters/svgfeblendelement/mode/) { get; } | Соответствует атрибуту «режим» данного элемента «feBlend». Принимает одну из констант SVG_FEBLEND_MODE_*, определенных в этом интерфейсе. |
...
| [Result](../../aspose.svg.filters/svgfeblendelement/result/) { get; } | Соответствует атрибуту «результат» данного элемента «фильтр». |
...
| [Width](../../aspose.svg.filters/svgfeblendelement/width/) { get; } | Соответствует атрибуту «ширина» данного элемента «фильтр». |
| [X](../../aspose.svg.filters/svgfeblendelement/x/) { get; } | Соответствует атрибуту «x» данного элемента «фильтр». |
...
| Имя | Описание |
| --- | --- |
| const [SVG_FEBLEND_MODE_COLOR](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_color/) | Соответствует значению "цвет". |
...
| const [SVG_FEBLEND_MODE_HUE](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_hue/) | Соответствует значению «оттенок». |
...
| const [SVG_FEBLEND_MODE_LUMINOSITY](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_luminosity/) | Соответствует значению «светимость». |
