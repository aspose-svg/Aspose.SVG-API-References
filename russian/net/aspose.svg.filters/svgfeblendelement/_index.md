---
title: "Класс SVGFEBlendElement"
second_title: "Aspose.SVG для .NET справочник API"
description: "Класс Aspose.Svg.Filters.SVGFEBlendElement. Интерфейс SVGFEBlendElement соответствует элементу feBlend"
type: docs
weight: 3740
...
| [Height](../../aspose.svg.filters/svgfeblendelement/height/) { get; } | Соответствует атрибуту ‘height’ в данном элементе ‘filter’. |
| [Id](../../aspose.svg/svgelement/id/) { get; set; } | Значение атрибута ‘id’ данного элемента, или пустая строка, если атрибут ‘id’ отсутствует. |
| [In1](../../aspose.svg.filters/svgfeblendelement/in1/) { get; } | Соответствует атрибуту ‘in’ в данном элементе ‘feBlend’. |
| [In2](../../aspose.svg.filters/svgfeblendelement/in2/) { get; } | Соответствует атрибуту ‘in2’ в данном элементе ‘feBlend’. |
...
| [Mode](../../aspose.svg.filters/svgfeblendelement/mode/) { get; } | Соответствует атрибуту ‘mode’ в данном элементе ‘feBlend’. Принимает одну из констант SVG_FEBLEND_MODE_* определённых в этом интерфейсе. |
...
| [Result](../../aspose.svg.filters/svgfeblendelement/result/) { get; } | Соответствует атрибуту ‘result’ указанного элемента ‘filter’. |
...
| [Width](../../aspose.svg.filters/svgfeblendelement/width/) { get; } | Соответствует атрибуту ‘width’ в данном элементе ‘filter’. |
| [X](../../aspose.svg.filters/svgfeblendelement/x/) { get; } | Соответствует атрибуту ‘x’ в данном элементе ‘filter’. |
| [Y](../../aspose.svg.filters/svgfeblendelement/y/) { get; } | Соответствует атрибуту ‘y’ в данном элементе ‘filter’. |
...
| const [SVG_FEBLEND_MODE_DARKEN](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_darken/) | Соответствует значению 'darken'. |
| const [SVG_FEBLEND_MODE_DIFFERENCE](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_difference/) | Соответствует значению 'difference'. |
| const [SVG_FEBLEND_MODE_EXCLUSION](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_exclusion/) | Соответствует значению 'exclusion'. |
...
| const [SVG_FEBLEND_MODE_LIGHTEN](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_lighten/) | Соответствует значению 'lighten'. |
| const [SVG_FEBLEND_MODE_LUMINOSITY](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_luminosity/) | Соответствует значению 'luminosity'. |
| const [SVG_FEBLEND_MODE_MULTIPLY](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_multiply/) | Соответствует значению 'multiply'. |
| const [SVG_FEBLEND_MODE_NORMAL](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_normal/) | Соответствует значению 'normal'. |
...
| const [SVG_FEBLEND_MODE_SATURATION](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_saturation/) | Соответствует значению 'saturation'. |
| const [SVG_FEBLEND_MODE_SCREEN](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_screen/) | Соответствует значению 'screen'. |
...
| const [SVG_FEBLEND_MODE_UNKNOWN](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_unknown/) | Тип не является одним из предопределённых типов. Недопустимо пытаться определить новое значение этого типа или попытаться переключить существующее значение на этот тип. |
