...
description: Aspose.Svg.Filters.SVGFEFloodElement сорт. Интерфейс SVGFEFloodElement соответствует элементу feFlood.
type: docs
weight: 1740
...
| [Result](../../aspose.svg.filters/svgfefloodelement/result/) { get; } | Соответствует атрибуту «результат» данного элемента «фильтр». |
...
| [Width](../../aspose.svg.filters/svgfefloodelement/width/) { get; } | Соответствует атрибуту «ширина» данного элемента «фильтр». |
| [X](../../aspose.svg.filters/svgfefloodelement/x/) { get; } | Соответствует атрибуту «x» данного элемента «фильтр». |
