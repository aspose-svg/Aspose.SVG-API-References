...
description: Aspose.Svg.Filters.SVGFEMorphologyElement сорт. Интерфейс SVGFEMorphologyElement соответствует элементу feMorphology.
type: docs
weight: 1830
...
| [Operator](../../aspose.svg.filters/svgfemorphologyelement/operator/) { get; } | Соответствует атрибуту «оператор» данного элемента «feMorphology». Принимает одну из констант SVG_MORPHOLOGY_OPERATOR_*, определенных в этом интерфейсе. |
...
| [Result](../../aspose.svg.filters/svgfemorphologyelement/result/) { get; } | Соответствует атрибуту «результат» данного элемента «фильтр». |
...
| [Width](../../aspose.svg.filters/svgfemorphologyelement/width/) { get; } | Соответствует атрибуту «ширина» данного элемента «фильтр». |
| [X](../../aspose.svg.filters/svgfemorphologyelement/x/) { get; } | Соответствует атрибуту «x» данного элемента «фильтр». |
...
| const [SVG_MORPHOLOGY_OPERATOR_ERODE](../../aspose.svg.filters/svgfemorphologyelement/svg_morphology_operator_erode/) | Соответствует значению 'разрушение'. |
