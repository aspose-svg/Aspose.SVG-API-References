---
title: "SVGFEMorphologyElement Класс"
second_title: "Aspose.SVG для .NET справочник API"
description: "Aspose.Svg.Filters.SVGFEMorphologyElement класс. Интерфейс SVGFEMorphologyElement соответствует элементу feMorphology."
type: docs
weight: 3920
...
| [Height](../../aspose.svg.filters/svgfemorphologyelement/height/) { get; } | Соответствует атрибуту ‘height’ в данном элементе ‘filter’. |
| [Id](../../aspose.svg/svgelement/id/) { get; set; } | Значение атрибута ‘id’ данного элемента, или пустая строка, если атрибут ‘id’ отсутствует. |
| [In1](../../aspose.svg.filters/svgfemorphologyelement/in1/) { get; } | Соответствует атрибуту ‘in’ в данном элементе ‘feMorphology’. |
...
| [Operator](../../aspose.svg.filters/svgfemorphologyelement/operator/) { get; } | Соответствует атрибуту ‘operator’ в данном элементе ‘feMorphology’. Принимает одну из констант SVG_MORPHOLOGY_OPERATOR_* , определённых в этом интерфейсе. |
...
| [RadiusX](../../aspose.svg.filters/svgfemorphologyelement/radiusx/) { get; } | Соответствует атрибуту ‘radius’ в данном элементе ‘feMorphology’. |
| [RadiusY](../../aspose.svg.filters/svgfemorphologyelement/radiusy/) { get; } | Соответствует атрибуту ‘radius’ в данном элементе ‘feMorphology’. |
| [Result](../../aspose.svg.filters/svgfemorphologyelement/result/) { get; } | Соответствует атрибуту ‘result’ указанного элемента ‘filter’. |
...
| [Width](../../aspose.svg.filters/svgfemorphologyelement/width/) { get; } | Соответствует атрибуту ‘width’ в данном элементе ‘filter’. |
| [X](../../aspose.svg.filters/svgfemorphologyelement/x/) { get; } | Соответствует атрибуту ‘x’ в данном элементе ‘filter’. |
| [Y](../../aspose.svg.filters/svgfemorphologyelement/y/) { get; } | Соответствует атрибуту ‘y’ в данном элементе ‘filter’. |
...
| Имя | Описание |
| --- | --- |
| const [SVG_MORPHOLOGY_OPERATOR_DILATE](../../aspose.svg.filters/svgfemorphologyelement/svg_morphology_operator_dilate/) | Соответствует значению 'dilate'. |
| const [SVG_MORPHOLOGY_OPERATOR_ERODE](../../aspose.svg.filters/svgfemorphologyelement/svg_morphology_operator_erode/) | Соответствует значению 'erode'. |
| const [SVG_MORPHOLOGY_OPERATOR_UNKNOWN](../../aspose.svg.filters/svgfemorphologyelement/svg_morphology_operator_unknown/) | Тип не является одним из предопределённых типов. Недопустимо пытаться определить новое значение этого типа или попытаться переключить существующее значение на этот тип. |
