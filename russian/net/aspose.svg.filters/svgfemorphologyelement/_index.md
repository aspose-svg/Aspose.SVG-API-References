...
type: docs
weight: 1820
url: /ru/net/aspose.svg.filters/svgfemorphologyelement/
---
...
| [Height](../../aspose.svg.filters/svgfemorphologyelement/height) { get; } | Соответствует атрибуту 'высота' данного элемента 'фильтра'. |
| [Id](../../aspose.svg/svgelement/id) { get; set; } | Значение атрибута 'id' данного элемента или пустая строка, если 'id' отсутствует. |
| [In1](../../aspose.svg.filters/svgfemorphologyelement/in1) { get; } | Соответствует атрибуту 'in' данного элемента 'feMorphology'. |
...
| [Operator](../../aspose.svg.filters/svgfemorphologyelement/operator) { get; } | Соответствует атрибуту 'operator' данного элемента 'feMorphology'. Принимает одну из констант SVG_MORPHOLOGY_OPERATOR_*, определенных в этом интерфейсе. |
...
| [RadiusX](../../aspose.svg.filters/svgfemorphologyelement/radiusx) { get; } | Соответствует атрибуту 'radius' данного элемента 'feMorphology'. |
| [RadiusY](../../aspose.svg.filters/svgfemorphologyelement/radiusy) { get; } | Соответствует атрибуту 'radius' данного элемента 'feMorphology'. |
| [Result](../../aspose.svg.filters/svgfemorphologyelement/result) { get; } | Соответствует атрибуту 'result' данного элемента 'filter'. |
...
| [Width](../../aspose.svg.filters/svgfemorphologyelement/width) { get; } | Соответствует атрибуту 'width' данного элемента 'filter'. |
| [X](../../aspose.svg.filters/svgfemorphologyelement/x) { get; } | Соответствует атрибуту 'x' данного элемента 'filter'. |
| [Y](../../aspose.svg.filters/svgfemorphologyelement/y) { get; } | Соответствует атрибуту 'y' данного элемента 'filter'. |
...
| Имя | Описание |
| --- | --- |
| const [SVG_MORPHOLOGY_OPERATOR_DILATE](../../aspose.svg.filters/svgfemorphologyelement/svg_morphology_operator_dilate) | Соответствует значению 'расширить'. |
| const [SVG_MORPHOLOGY_OPERATOR_ERODE](../../aspose.svg.filters/svgfemorphologyelement/svg_morphology_operator_erode) | Соответствует значению 'разъедать'. |
| const [SVG_MORPHOLOGY_OPERATOR_UNKNOWN](../../aspose.svg.filters/svgfemorphologyelement/svg_morphology_operator_unknown) | Тип не является одним из предопределенных типов. Недопустимо пытаться определить новое значение этого типа или пытаться переключить существующее значение на этот тип. |
