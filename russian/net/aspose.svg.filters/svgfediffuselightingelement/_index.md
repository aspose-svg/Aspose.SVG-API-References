...
description: Aspose.Svg.Filters.SVGFEDiffuseLightingElement сорт. Интерфейс SVGFEDiffuseLightingElement соответствует элементу feDiffuseLighting.
type: docs
weight: 1700
...
| [Result](../../aspose.svg.filters/svgfediffuselightingelement/result/) { get; } | Соответствует атрибуту «результат» данного элемента «фильтр». |
...
| [Width](../../aspose.svg.filters/svgfediffuselightingelement/width/) { get; } | Соответствует атрибуту «ширина» данного элемента «фильтр». |
| [X](../../aspose.svg.filters/svgfediffuselightingelement/x/) { get; } | Соответствует атрибуту «x» данного элемента «фильтр». |
