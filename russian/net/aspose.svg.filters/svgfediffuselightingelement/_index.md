...
description: "Класс Aspose.Svg.Filters.SVGFEDiffuseLightingElement. Интерфейс SVGFEDiffuseLightingElement соответствует элементу feDiffuseLighting"
type: docs
weight: 3790
...
| [DiffuseConstant](../../aspose.svg.filters/svgfediffuselightingelement/diffuseconstant/) { get; } | Соответствует атрибуту ‘diffuseConstant’ в данном элементе ‘feDiffuseLighting’. |
...
| [Height](../../aspose.svg.filters/svgfediffuselightingelement/height/) { get; } | Соответствует атрибуту ‘height’ в данном элементе ‘filter’. |
| [Id](../../aspose.svg/svgelement/id/) { get; set; } | Значение атрибута ‘id’ данного элемента, или пустая строка, если атрибут ‘id’ отсутствует. |
| [In1](../../aspose.svg.filters/svgfediffuselightingelement/in1/) { get; } | Соответствует атрибуту ‘in’ в данном элементе ‘feDiffuseLighting’. |
...
| [KernelUnitLengthX](../../aspose.svg.filters/svgfediffuselightingelement/kernelunitlengthx/) { get; } | Соответствует атрибуту ‘kernelUnitLength’ в данном элементе ‘feDiffuseLighting’. |
| [KernelUnitLengthY](../../aspose.svg.filters/svgfediffuselightingelement/kernelunitlengthy/) { get; } | Соответствует атрибуту ‘kernelUnitLength’ в данном элементе ‘feDiffuseLighting’. |
...
| [Result](../../aspose.svg.filters/svgfediffuselightingelement/result/) { get; } | Соответствует атрибуту ‘result’ указанного элемента ‘filter’. |
...
| [SurfaceScale](../../aspose.svg.filters/svgfediffuselightingelement/surfacescale/) { get; } | Соответствует атрибуту ‘surfaceScale’ в данном элементе ‘feDiffuseLighting’. |
...
| [Width](../../aspose.svg.filters/svgfediffuselightingelement/width/) { get; } | Соответствует атрибуту ‘width’ в данном элементе ‘filter’. |
| [X](../../aspose.svg.filters/svgfediffuselightingelement/x/) { get; } | Соответствует атрибуту ‘x’ в данном элементе ‘filter’. |
| [Y](../../aspose.svg.filters/svgfediffuselightingelement/y/) { get; } | Соответствует атрибуту ‘y’ в данном элементе ‘filter’. |
