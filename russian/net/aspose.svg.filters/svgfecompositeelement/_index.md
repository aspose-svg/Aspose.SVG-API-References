...
description: Aspose.Svg.Filters.SVGFECompositeElement сорт. Интерфейс SVGFECompositeElement соответствует элементу feComposite.
type: docs
weight: 1680
...
| [Operator](../../aspose.svg.filters/svgfecompositeelement/operator/) { get; } | Соответствует атрибуту «оператор» данного элемента «feComposite». Принимает одну из констант SVG_FECOMPOSITE_OPERATOR_*, определенных в этом интерфейсе. |
...
| [Result](../../aspose.svg.filters/svgfecompositeelement/result/) { get; } | Соответствует атрибуту «результат» данного элемента «фильтр». |
...
| [Width](../../aspose.svg.filters/svgfecompositeelement/width/) { get; } | Соответствует атрибуту «ширина» данного элемента «фильтр». |
| [X](../../aspose.svg.filters/svgfecompositeelement/x/) { get; } | Соответствует атрибуту «x» данного элемента «фильтр». |
