...
description: "Aspose.Svg.Filters.SVGFECompositeElement класс. Интерфейс SVGFECompositeElement соответствует элементу feComposite"
type: docs
weight: 3770
...
| [Height](../../aspose.svg.filters/svgfecompositeelement/height/) { get; } | Соответствует атрибуту ‘height’ в данном элементе ‘filter’. |
| [Id](../../aspose.svg/svgelement/id/) { get; set; } | Значение атрибута ‘id’ данного элемента, или пустая строка, если атрибут ‘id’ отсутствует. |
| [In1](../../aspose.svg.filters/svgfecompositeelement/in1/) { get; } | Соответствует атрибуту ‘in’ в данном элементе ‘feComposite’. |
| [In2](../../aspose.svg.filters/svgfecompositeelement/in2/) { get; } | Соответствует атрибуту ‘in2’ в данном элементе ‘feComposite’. |
...
| [K1](../../aspose.svg.filters/svgfecompositeelement/k1/) { get; } | Соответствует атрибуту ‘k1’ в данном элементе ‘feComposite’. |
| [K2](../../aspose.svg.filters/svgfecompositeelement/k2/) { get; } | Соответствует атрибуту ‘k2’ в данном элементе ‘feComposite’. |
| [K3](../../aspose.svg.filters/svgfecompositeelement/k3/) { get; } | Соответствует атрибуту ‘k3’ в данном элементе ‘feComposite’. |
| [K4](../../aspose.svg.filters/svgfecompositeelement/k4/) { get; } | Соответствует атрибуту ‘k4’ в данном элементе ‘feComposite’. |
...
| [Operator](../../aspose.svg.filters/svgfecompositeelement/operator/) { get; } | Соответствует атрибуту ‘operator’ в данном элементе ‘feComposite’. Принимает одну из констант SVG_FECOMPOSITE_OPERATOR_* , определённых в этом интерфейсе. |
...
| [Result](../../aspose.svg.filters/svgfecompositeelement/result/) { get; } | Соответствует атрибуту ‘result’ указанного элемента ‘filter’. |
...
| [Width](../../aspose.svg.filters/svgfecompositeelement/width/) { get; } | Соответствует атрибуту ‘width’ в данном элементе ‘filter’. |
| [X](../../aspose.svg.filters/svgfecompositeelement/x/) { get; } | Соответствует атрибуту ‘x’ в данном элементе ‘filter’. |
| [Y](../../aspose.svg.filters/svgfecompositeelement/y/) { get; } | Соответствует атрибуту ‘y’ в данном элементе ‘filter’. |
...
| Имя | Описание |
| --- | --- |
| const [SVG_FECOMPOSITE_OPERATOR_ARITHMETIC](../../aspose.svg.filters/svgfecompositeelement/svg_fecomposite_operator_arithmetic/) | Соответствует значению 'arithmetic'. |
| const [SVG_FECOMPOSITE_OPERATOR_ATOP](../../aspose.svg.filters/svgfecompositeelement/svg_fecomposite_operator_atop/) | Соответствует значению 'atop'. |
...
| const [SVG_FECOMPOSITE_OPERATOR_OVER](../../aspose.svg.filters/svgfecompositeelement/svg_fecomposite_operator_over/) | Соответствует значению 'over'. |
| const [SVG_FECOMPOSITE_OPERATOR_UNKNOWN](../../aspose.svg.filters/svgfecompositeelement/svg_fecomposite_operator_unknown/) | Тип не является одним из предопределённых типов. Недопустимо пытаться определить новое значение этого типа или попытаться переключить существующее значение на этот тип. |
