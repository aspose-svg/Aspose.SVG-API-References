...
type: docs
weight: 1670
url: /ru/net/aspose.svg.filters/svgfecompositeelement/
---
...
| [Height](../../aspose.svg.filters/svgfecompositeelement/height) { get; } | Соответствует атрибуту 'высота' данного элемента 'фильтра'. |
| [Id](../../aspose.svg/svgelement/id) { get; set; } | Значение атрибута 'id' данного элемента или пустая строка, если 'id' отсутствует. |
| [In1](../../aspose.svg.filters/svgfecompositeelement/in1) { get; } | Соответствует атрибуту 'in' данного элемента 'feComposite'. |
| [In2](../../aspose.svg.filters/svgfecompositeelement/in2) { get; } | Соответствует атрибуту 'in2' данного элемента 'feComposite'. |
...
| [K1](../../aspose.svg.filters/svgfecompositeelement/k1) { get; } | Соответствует атрибуту 'k1' данного элемента 'feComposite'. |
| [K2](../../aspose.svg.filters/svgfecompositeelement/k2) { get; } | Соответствует атрибуту 'k2' данного элемента 'feComposite'. |
| [K3](../../aspose.svg.filters/svgfecompositeelement/k3) { get; } | Соответствует атрибуту 'k3' данного элемента 'feComposite'. |
| [K4](../../aspose.svg.filters/svgfecompositeelement/k4) { get; } | Соответствует атрибуту 'k4' данного элемента 'feComposite'. |
...
| [Operator](../../aspose.svg.filters/svgfecompositeelement/operator) { get; } | Соответствует атрибуту 'operator' данного элемента 'feComposite'. Принимает одну из констант SVG_FECOMPOSITE_OPERATOR_*, определенных в этом интерфейсе. |
...
| [Result](../../aspose.svg.filters/svgfecompositeelement/result) { get; } | Соответствует атрибуту 'result' данного элемента 'filter'. |
...
| [Width](../../aspose.svg.filters/svgfecompositeelement/width) { get; } | Соответствует атрибуту 'width' данного элемента 'filter'. |
| [X](../../aspose.svg.filters/svgfecompositeelement/x) { get; } | Соответствует атрибуту 'x' данного элемента 'filter'. |
| [Y](../../aspose.svg.filters/svgfecompositeelement/y) { get; } | Соответствует атрибуту 'y' данного элемента 'filter'. |
...
| Имя | Описание |
| --- | --- |
| const [SVG_FECOMPOSITE_OPERATOR_ARITHMETIC](../../aspose.svg.filters/svgfecompositeelement/svg_fecomposite_operator_arithmetic) | Соответствует значению 'арифметика'. |
| const [SVG_FECOMPOSITE_OPERATOR_ATOP](../../aspose.svg.filters/svgfecompositeelement/svg_fecomposite_operator_atop) | Соответствует значению 'поверх'. |
| const [SVG_FECOMPOSITE_OPERATOR_IN](../../aspose.svg.filters/svgfecompositeelement/svg_fecomposite_operator_in) | Соответствует значению 'in'. |
| const [SVG_FECOMPOSITE_OPERATOR_OUT](../../aspose.svg.filters/svgfecompositeelement/svg_fecomposite_operator_out) | Соответствует значению 'out'. |
| const [SVG_FECOMPOSITE_OPERATOR_OVER](../../aspose.svg.filters/svgfecompositeelement/svg_fecomposite_operator_over) | Соответствует значению «больше». |
| const [SVG_FECOMPOSITE_OPERATOR_UNKNOWN](../../aspose.svg.filters/svgfecompositeelement/svg_fecomposite_operator_unknown) | Тип не является одним из предопределенных типов. Недопустимо пытаться определить новое значение этого типа или пытаться переключить существующее значение на этот тип. |
| const [SVG_FECOMPOSITE_OPERATOR_XOR](../../aspose.svg.filters/svgfecompositeelement/svg_fecomposite_operator_xor) | Соответствует значению 'xor'. |
