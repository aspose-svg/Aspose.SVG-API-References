...
description: Aspose.Svg.Filters.SVGFEOffsetElement сорт. Интерфейс SVGFEOffsetElement соответствует элементу feOffset.
type: docs
weight: 1840
...
| [Result](../../aspose.svg.filters/svgfeoffsetelement/result/) { get; } | Соответствует атрибуту «результат» данного элемента «фильтр». |
...
| [Width](../../aspose.svg.filters/svgfeoffsetelement/width/) { get; } | Соответствует атрибуту «ширина» данного элемента «фильтр». |
| [X](../../aspose.svg.filters/svgfeoffsetelement/x/) { get; } | Соответствует атрибуту «x» данного элемента «фильтр». |
