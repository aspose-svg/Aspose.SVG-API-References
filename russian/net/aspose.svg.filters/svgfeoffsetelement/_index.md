...
description: "Aspose.Svg.Filters.SVGFEOffsetElement класс. Интерфейс SVGFEOffsetElement соответствует элементу feOffset"
type: docs
weight: 3930
...
| [Dx](../../aspose.svg.filters/svgfeoffsetelement/dx/) { get; } | Соответствует атрибуту ‘dx’ в данном элементе ‘feOffset’. |
| [Dy](../../aspose.svg.filters/svgfeoffsetelement/dy/) { get; } | Соответствует атрибуту ‘dy’ в данном элементе ‘feOffset’. |
...
| [Height](../../aspose.svg.filters/svgfeoffsetelement/height/) { get; } | Соответствует атрибуту ‘height’ в данном элементе ‘filter’. |
| [Id](../../aspose.svg/svgelement/id/) { get; set; } | Значение атрибута ‘id’ данного элемента, или пустая строка, если атрибут ‘id’ отсутствует. |
| [In1](../../aspose.svg.filters/svgfeoffsetelement/in1/) { get; } | Соответствует атрибуту ‘in’ в данном элементе ‘feOffset’. |
...
| [Result](../../aspose.svg.filters/svgfeoffsetelement/result/) { get; } | Соответствует атрибуту ‘result’ указанного элемента ‘filter’. |
...
| [Width](../../aspose.svg.filters/svgfeoffsetelement/width/) { get; } | Соответствует атрибуту ‘width’ в данном элементе ‘filter’. |
| [X](../../aspose.svg.filters/svgfeoffsetelement/x/) { get; } | Соответствует атрибуту ‘x’ в данном элементе ‘filter’. |
| [Y](../../aspose.svg.filters/svgfeoffsetelement/y/) { get; } | Соответствует атрибуту ‘y’ в данном элементе ‘filter’. |
