...
description: "Класс Aspose.Svg.Filters.SVGFEPointLightElement. Интерфейс SVGFEPointLightElement соответствует элементу fePointLight"
type: docs
weight: 3940
...
| [X](../../aspose.svg.filters/svgfepointlightelement/x/) { get; } | Соответствует атрибуту ‘x’ в данном элементе ‘fePointLight’. |
| [Y](../../aspose.svg.filters/svgfepointlightelement/y/) { get; } | Соответствует атрибуту ‘y’ в данном элементе ‘fePointLight’. |
| [Z](../../aspose.svg.filters/svgfepointlightelement/z/) { get; } | Соответствует атрибуту ‘z’ в данном элементе ‘fePointLight’. |
