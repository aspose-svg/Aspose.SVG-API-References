...
type: docs
weight: 1680
url: /ru/net/aspose.svg.filters/svgfeconvolvematrixelement/
---
...
| [Bias](../../aspose.svg.filters/svgfeconvolvematrixelement/bias) { get; } | Соответствует атрибуту 'bias' данного элемента 'feConvolveMatrix'. |
...
| [Divisor](../../aspose.svg.filters/svgfeconvolvematrixelement/divisor) { get; } | Соответствует атрибуту 'divisor' данного элемента 'feConvolveMatrix'. |
| [EdgeMode](../../aspose.svg.filters/svgfeconvolvematrixelement/edgemode) { get; } | Соответствует атрибуту 'edgeMode' данного элемента 'feConvolveMatrix'. |
...
| [Height](../../aspose.svg.filters/svgfeconvolvematrixelement/height) { get; } | Соответствует атрибуту 'высота' данного элемента 'фильтра'. |
| [Id](../../aspose.svg/svgelement/id) { get; set; } | Значение атрибута 'id' данного элемента или пустая строка, если 'id' отсутствует. |
| [In1](../../aspose.svg.filters/svgfeconvolvematrixelement/in1) { get; } | Соответствует атрибуту 'in' данного элемента 'feConvolveMatrix'. |
...
| [KernelMatrix](../../aspose.svg.filters/svgfeconvolvematrixelement/kernelmatrix) { get; } | Соответствует атрибуту 'kernelMatrix' данного элемента 'feConvolveMatrix'. |
| [KernelUnitLengthX](../../aspose.svg.filters/svgfeconvolvematrixelement/kernelunitlengthx) { get; } | Соответствует атрибуту 'kernelUnitLength' данного элемента 'feConvolveMatrix'. |
| [KernelUnitLengthY](../../aspose.svg.filters/svgfeconvolvematrixelement/kernelunitlengthy) { get; } | Соответствует атрибуту 'kernelUnitLength' данного элемента 'feConvolveMatrix'. |
...
| [OrderX](../../aspose.svg.filters/svgfeconvolvematrixelement/orderx) { get; } | Соответствует атрибуту 'order' данного элемента 'feConvolveMatrix'. |
| [OrderY](../../aspose.svg.filters/svgfeconvolvematrixelement/ordery) { get; } | Соответствует атрибуту 'order' данного элемента 'feConvolveMatrix'. |
...
| [PreserveAlpha](../../aspose.svg.filters/svgfeconvolvematrixelement/preservealpha) { get; } | Соответствует атрибуту preserveAlpha данного элемента feConvolveMatrix. |
...
| [Result](../../aspose.svg.filters/svgfeconvolvematrixelement/result) { get; } | Соответствует атрибуту 'result' данного элемента 'filter'. |
...
| [TargetX](../../aspose.svg.filters/svgfeconvolvematrixelement/targetx) { get; } | Соответствует атрибуту targetX данного элемента feConvolveMatrix. |
| [TargetY](../../aspose.svg.filters/svgfeconvolvematrixelement/targety) { get; } | Соответствует атрибуту targetY данного элемента feConvolveMatrix. |
...
| [Width](../../aspose.svg.filters/svgfeconvolvematrixelement/width) { get; } | Соответствует атрибуту 'width' данного элемента 'filter'. |
| [X](../../aspose.svg.filters/svgfeconvolvematrixelement/x) { get; } | Соответствует атрибуту 'x' данного элемента 'filter'. |
| [Y](../../aspose.svg.filters/svgfeconvolvematrixelement/y) { get; } | Соответствует атрибуту 'y' данного элемента 'filter'. |
...
| Имя | Описание |
| --- | --- |
| const [SVG_EDGEMODE_DUPLICATE](../../aspose.svg.filters/svgfeconvolvematrixelement/svg_edgemode_duplicate) | Соответствует значению 'дубликат'. |
| const [SVG_EDGEMODE_NONE](../../aspose.svg.filters/svgfeconvolvematrixelement/svg_edgemode_none) | Соответствует значению 'none'. |
| const [SVG_EDGEMODE_UNKNOWN](../../aspose.svg.filters/svgfeconvolvematrixelement/svg_edgemode_unknown) | Тип не является одним из предопределенных типов. Недопустимо пытаться определить новое значение этого типа или пытаться переключить существующее значение на этот тип. |
| const [SVG_EDGEMODE_WRAP](../../aspose.svg.filters/svgfeconvolvematrixelement/svg_edgemode_wrap) | Соответствует значению 'wrap'. |
