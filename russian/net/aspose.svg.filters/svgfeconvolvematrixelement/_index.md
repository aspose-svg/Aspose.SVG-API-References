---
title: "Класс SVGFEConvolveMatrixElement"
second_title: "Aspose.SVG для .NET справочник API"
description: "Класс Aspose.Svg.Filters.SVGFEConvolveMatrixElement. Интерфейс SVGFEConvolveMatrixElement соответствует элементу feConvolveMatrix"
type: docs
weight: 3780
...
| [Bias](../../aspose.svg.filters/svgfeconvolvematrixelement/bias/) { get; } | Соответствует атрибуту ‘bias’ в данном элементе ‘feConvolveMatrix’. |
...
| [Divisor](../../aspose.svg.filters/svgfeconvolvematrixelement/divisor/) { get; } | Соответствует атрибуту ‘divisor’ в данном элементе ‘feConvolveMatrix’. |
| [EdgeMode](../../aspose.svg.filters/svgfeconvolvematrixelement/edgemode/) { get; } | Соответствует атрибуту ‘edgeMode’ в данном элементе ‘feConvolveMatrix’. |
...
| [Height](../../aspose.svg.filters/svgfeconvolvematrixelement/height/) { get; } | Соответствует атрибуту ‘height’ в данном элементе ‘filter’. |
| [Id](../../aspose.svg/svgelement/id/) { get; set; } | Значение атрибута ‘id’ данного элемента, или пустая строка, если атрибут ‘id’ отсутствует. |
| [In1](../../aspose.svg.filters/svgfeconvolvematrixelement/in1/) { get; } | Соответствует атрибуту ‘in’ в данном элементе ‘feConvolveMatrix’. |
...
| [KernelMatrix](../../aspose.svg.filters/svgfeconvolvematrixelement/kernelmatrix/) { get; } | Соответствует атрибуту ‘kernelMatrix’ в данном элементе ‘feConvolveMatrix’. |
| [KernelUnitLengthX](../../aspose.svg.filters/svgfeconvolvematrixelement/kernelunitlengthx/) { get; } | Соответствует атрибуту ‘kernelUnitLength’ в данном элементе ‘feConvolveMatrix’. |
| [KernelUnitLengthY](../../aspose.svg.filters/svgfeconvolvematrixelement/kernelunitlengthy/) { get; } | Соответствует атрибуту ‘kernelUnitLength’ в данном элементе ‘feConvolveMatrix’. |
...
| [OrderX](../../aspose.svg.filters/svgfeconvolvematrixelement/orderx/) { get; } | Соответствует атрибуту ‘order’ в данном элементе ‘feConvolveMatrix’. |
| [OrderY](../../aspose.svg.filters/svgfeconvolvematrixelement/ordery/) { get; } | Соответствует атрибуту ‘order’ в данном элементе ‘feConvolveMatrix’. |
...
| [PreserveAlpha](../../aspose.svg.filters/svgfeconvolvematrixelement/preservealpha/) { get; } | Соответствует атрибуту ‘preserveAlpha’ в данном элементе ‘feConvolveMatrix’. |
...
| [Result](../../aspose.svg.filters/svgfeconvolvematrixelement/result/) { get; } | Соответствует атрибуту ‘result’ указанного элемента ‘filter’. |
...
| [TargetX](../../aspose.svg.filters/svgfeconvolvematrixelement/targetx/) { get; } | Соответствует атрибуту ‘targetX’ в данном элементе ‘feConvolveMatrix’. |
| [TargetY](../../aspose.svg.filters/svgfeconvolvematrixelement/targety/) { get; } | Соответствует атрибуту ‘targetY’ в данном элементе ‘feConvolveMatrix’. |
...
| [Width](../../aspose.svg.filters/svgfeconvolvematrixelement/width/) { get; } | Соответствует атрибуту ‘width’ в данном элементе ‘filter’. |
| [X](../../aspose.svg.filters/svgfeconvolvematrixelement/x/) { get; } | Соответствует атрибуту ‘x’ в данном элементе ‘filter’. |
| [Y](../../aspose.svg.filters/svgfeconvolvematrixelement/y/) { get; } | Соответствует атрибуту ‘y’ в данном элементе ‘filter’. |
...
| Имя | Описание |
| --- | --- |
| const [SVG_EDGEMODE_DUPLICATE](../../aspose.svg.filters/svgfeconvolvematrixelement/svg_edgemode_duplicate/) | Соответствует значению 'duplicate'. |
| const [SVG_EDGEMODE_NONE](../../aspose.svg.filters/svgfeconvolvematrixelement/svg_edgemode_none/) | Соответствует значению 'none'. |
| const [SVG_EDGEMODE_UNKNOWN](../../aspose.svg.filters/svgfeconvolvematrixelement/svg_edgemode_unknown/) | Тип не является одним из предопределённых типов. Недопустимо пытаться определить новое значение этого типа или попытаться переключить существующее значение на этот тип. |
