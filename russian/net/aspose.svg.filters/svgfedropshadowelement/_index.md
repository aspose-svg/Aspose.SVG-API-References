...
description: "Aspose.Svg.Filters.SVGFEDropShadowElement класс. Интерфейс SVGFEDropShadowElement соответствует элементу feDropShadow."
type: docs
weight: 3820
...
| [Dx](../../aspose.svg.filters/svgfedropshadowelement/dx/) { get; } | Соответствует атрибуту ‘dx’ указанного элемента ‘feDropShadow’. |
| [Dy](../../aspose.svg.filters/svgfedropshadowelement/dy/) { get; } | Соответствует атрибуту ‘dy’ указанного элемента ‘feDropShadow’. |
...
| [Height](../../aspose.svg.filters/svgfedropshadowelement/height/) { get; } | Соответствует атрибуту ‘height’ указанного элемента ‘feDropShadow’. |
| [Id](../../aspose.svg/svgelement/id/) { get; set; } | Значение атрибута ‘id’ данного элемента, или пустая строка, если атрибут ‘id’ отсутствует. |
| [In1](../../aspose.svg.filters/svgfedropshadowelement/in1/) { get; } | Соответствует атрибуту ‘in’ указанного элемента ‘feDropShadow’. |
...
| [Result](../../aspose.svg.filters/svgfedropshadowelement/result/) { get; } | Соответствует атрибуту ‘result’ указанного элемента ‘feDropShadow’. |
...
| [StdDeviationX](../../aspose.svg.filters/svgfedropshadowelement/stddeviationx/) { get; } | Соответствует атрибуту ‘stdDeviation’ указанного элемента ‘feDropShadow’. Содержит X‑компонент атрибута ‘stdDeviation’. |
| [StdDeviationY](../../aspose.svg.filters/svgfedropshadowelement/stddeviationy/) { get; } | Соответствует атрибуту ‘stdDeviation’ указанного элемента ‘feDropShadow’. Содержит Y‑компонент (возможно вычисляемый автоматически) атрибута ‘stdDeviation’. |
...
| [Width](../../aspose.svg.filters/svgfedropshadowelement/width/) { get; } | Соответствует атрибуту ‘width’ указанного элемента ‘feDropShadow’. |
| [X](../../aspose.svg.filters/svgfedropshadowelement/x/) { get; } | Соответствует атрибуту ‘x’ указанного элемента ‘feDropShadow’. |
| [Y](../../aspose.svg.filters/svgfedropshadowelement/y/) { get; } | Соответствует атрибуту ‘y’ указанного элемента ‘feDropShadow’. |
...
| [SetStdDeviation](../../aspose.svg.filters/svgfedropshadowelement/setstddeviation/)(*float, float*) | Устанавливает значения атрибута ‘stdDeviation’. |
