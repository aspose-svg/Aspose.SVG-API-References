...
type: docs
weight: 1720
url: /ru/net/aspose.svg.filters/svgfedropshadowelement/
---
...
| [Dx](../../aspose.svg.filters/svgfedropshadowelement/dx) { get; } | Соответствует атрибуту 'dx' данного элемента 'feDropShadow'. |
| [Dy](../../aspose.svg.filters/svgfedropshadowelement/dy) { get; } | Соответствует атрибуту 'dy' данного элемента 'feDropShadow'. |
...
| [Height](../../aspose.svg.filters/svgfedropshadowelement/height) { get; } | Соответствует атрибуту «высота» данного элемента «feDropShadow». |
| [Id](../../aspose.svg/svgelement/id) { get; set; } | Значение атрибута 'id' данного элемента или пустая строка, если 'id' отсутствует. |
| [In1](../../aspose.svg.filters/svgfedropshadowelement/in1) { get; } | Соответствует атрибуту 'in' данного элемента feDropShadow. |
...
| [Result](../../aspose.svg.filters/svgfedropshadowelement/result) { get; } | Соответствует атрибуту «результат» данного элемента «feDropShadow». |
...
| [StdDeviationX](../../aspose.svg.filters/svgfedropshadowelement/stddeviationx) { get; } | Соответствует атрибуту 'stdDeviation' данного элемента 'feDropShadow'. Содержит компонент X атрибута 'stdDeviation'. |
| [StdDeviationY](../../aspose.svg.filters/svgfedropshadowelement/stddeviationy) { get; } | Соответствует атрибуту 'stdDeviation' данного элемента 'feDropShadow'. Содержит компонент Y (возможно, вычисляемый автоматически) атрибута 'stdDeviation'. |
...
| [Width](../../aspose.svg.filters/svgfedropshadowelement/width) { get; } | Соответствует атрибуту 'width' данного элемента feDropShadow. |
| [X](../../aspose.svg.filters/svgfedropshadowelement/x) { get; } | Соответствует атрибуту 'x' данного элемента feDropShadow. |
| [Y](../../aspose.svg.filters/svgfedropshadowelement/y) { get; } | Соответствует атрибуту 'y' данного элемента feDropShadow. |
...
| [SetStdDeviation](../../aspose.svg.filters/svgfedropshadowelement/setstddeviation)(float, float) | Устанавливает значения для атрибута 'stdDeviation'. |
