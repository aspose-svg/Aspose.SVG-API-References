...
description: Aspose.Svg.Filters.SVGFEDropShadowElement сорт. Интерфейс SVGFEDropShadowElement соответствует элементу feDropShadow.
type: docs
weight: 1730
...
| [Dy](../../aspose.svg.filters/svgfedropshadowelement/dy/) { get; } | Соответствует атрибуту dy в данном элементе feDropShadow. |
