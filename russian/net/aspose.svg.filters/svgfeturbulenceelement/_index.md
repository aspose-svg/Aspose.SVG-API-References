...
description: "Класс Aspose.Svg.Filters.SVGFETurbulenceElement. Интерфейс SVGFETurbulenceElement соответствует элементу feTurbulence"
type: docs
weight: 3980
...
| [BaseFrequencyX](../../aspose.svg.filters/svgfeturbulenceelement/basefrequencyx/) { get; } | Соответствует атрибуту ‘baseFrequency’ в данном элементе ‘feTurbulence’. Содержит X‑компонент атрибута ‘baseFrequency’. |
| [BaseFrequencyY](../../aspose.svg.filters/svgfeturbulenceelement/basefrequencyy/) { get; } | Соответствует атрибуту ‘baseFrequency’ в данном элементе ‘feTurbulence’. Содержит Y‑компонент (возможно вычисляемый автоматически) атрибута ‘baseFrequency’. |
...
| [Height](../../aspose.svg.filters/svgfeturbulenceelement/height/) { get; } | Соответствует атрибуту ‘height’ в данном элементе ‘filter’. |
...
| [NumOctaves](../../aspose.svg.filters/svgfeturbulenceelement/numoctaves/) { get; } | Соответствует атрибуту ‘numOctaves’ в данном элементе ‘feTurbulence’. |
...
| [Result](../../aspose.svg.filters/svgfeturbulenceelement/result/) { get; } | Соответствует атрибуту ‘result’ указанного элемента ‘filter’. |
| [Seed](../../aspose.svg.filters/svgfeturbulenceelement/seed/) { get; } | Соответствует атрибуту ‘seed’ в данном элементе ‘feTurbulence’. |
...
| [StitchTiles](../../aspose.svg.filters/svgfeturbulenceelement/stitchtiles/) { get; } | Соответствует атрибуту ‘stitchTiles’ в данном элементе ‘feTurbulence’. Принимает одну из констант SVG_STITCHTYPE_*, определённых в этом интерфейсе. |
...
| [Type](../../aspose.svg.filters/svgfeturbulenceelement/type/) { get; } | Соответствует атрибуту ‘type’ в данном элементе ‘feTurbulence’. Принимает одну из констант SVG_TURBULENCE_TYPE_*, определённых в этом интерфейсе. |
...
| [Width](../../aspose.svg.filters/svgfeturbulenceelement/width/) { get; } | Соответствует атрибуту ‘width’ в данном элементе ‘filter’. |
| [X](../../aspose.svg.filters/svgfeturbulenceelement/x/) { get; } | Соответствует атрибуту ‘x’ в данном элементе ‘filter’. |
| [Y](../../aspose.svg.filters/svgfeturbulenceelement/y/) { get; } | Соответствует атрибуту ‘y’ в данном элементе ‘filter’. |
...
| const [SVG_STITCHTYPE_UNKNOWN](../../aspose.svg.filters/svgfeturbulenceelement/svg_stitchtype_unknown/) | Тип не является одним из предопределённых типов. Недопустимо пытаться определить новое значение этого типа или попытаться переключить существующее значение на этот тип. |
...
| const [SVG_TURBULENCE_TYPE_TURBULENCE](../../aspose.svg.filters/svgfeturbulenceelement/svg_turbulence_type_turbulence/) | Соответствует значению 'turbulence'. |
| const [SVG_TURBULENCE_TYPE_UNKNOWN](../../aspose.svg.filters/svgfeturbulenceelement/svg_turbulence_type_unknown/) | Тип не является одним из предопределённых типов. Недопустимо пытаться определить новое значение этого типа или попытаться переключить существующее значение на этот тип. |
