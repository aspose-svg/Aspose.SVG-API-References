...
type: docs
weight: 1880
url: /ru/net/aspose.svg.filters/svgfeturbulenceelement/
---
...
| [BaseFrequencyX](../../aspose.svg.filters/svgfeturbulenceelement/basefrequencyx) { get; } | Соответствует атрибуту baseFrequency данного элемента feTurbulence. Содержит компонент X атрибута baseFrequency. |
| [BaseFrequencyY](../../aspose.svg.filters/svgfeturbulenceelement/basefrequencyy) { get; } | Соответствует атрибуту baseFrequency данного элемента feTurbulence. Содержит компонент Y атрибута baseFrequency (возможно, вычисляемый автоматически). |
...
| [Height](../../aspose.svg.filters/svgfeturbulenceelement/height) { get; } | Соответствует атрибуту 'высота' данного элемента 'фильтра'. |
...
| [NumOctaves](../../aspose.svg.filters/svgfeturbulenceelement/numoctaves) { get; } | Соответствует атрибуту 'numOctaves' данного элемента 'feTurbulence'. |
...
| [Result](../../aspose.svg.filters/svgfeturbulenceelement/result) { get; } | Соответствует атрибуту 'result' данного элемента 'filter'. |
| [SchemaTypeInfo](../../aspose.svg.dom/element/schematypeinfo) { get; } | Информация о типе, связанная с этим элементом. |
| [Seed](../../aspose.svg.filters/svgfeturbulenceelement/seed) { get; } | Соответствует атрибуту «seed» данного элемента «feTurbulence». |
...
| [StitchTiles](../../aspose.svg.filters/svgfeturbulenceelement/stitchtiles) { get; } | Соответствует атрибуту 'stitchTiles' данного элемента 'feTurbulence'. Принимает одну из констант SVG_STITCHTYPE_*, определенных в этом интерфейсе. |
...
| [Type](../../aspose.svg.filters/svgfeturbulenceelement/type) { get; } | Соответствует атрибуту 'type' данного элемента 'feTurbulence'. Принимает одну из констант SVG_TURBULENCE_TYPE_*, определенных в этом интерфейсе. |
...
| [Width](../../aspose.svg.filters/svgfeturbulenceelement/width) { get; } | Соответствует атрибуту 'width' данного элемента 'filter'. |
| [X](../../aspose.svg.filters/svgfeturbulenceelement/x) { get; } | Соответствует атрибуту 'x' данного элемента 'filter'. |
| [Y](../../aspose.svg.filters/svgfeturbulenceelement/y) { get; } | Соответствует атрибуту 'y' данного элемента 'filter'. |
...
| Имя | Описание |
| --- | --- |
| const [SVG_STITCHTYPE_NOSTITCH](../../aspose.svg.filters/svgfeturbulenceelement/svg_stitchtype_nostitch) | Соответствует значению 'noStitch'. |
| const [SVG_STITCHTYPE_STITCH](../../aspose.svg.filters/svgfeturbulenceelement/svg_stitchtype_stitch) | Соответствует значению 'stitch'. |
| const [SVG_STITCHTYPE_UNKNOWN](../../aspose.svg.filters/svgfeturbulenceelement/svg_stitchtype_unknown) | Тип не является одним из предопределенных типов. Недопустимо пытаться определить новое значение этого типа или пытаться переключить существующее значение на этот тип. |
| const [SVG_TURBULENCE_TYPE_FRACTALNOISE](../../aspose.svg.filters/svgfeturbulenceelement/svg_turbulence_type_fractalnoise) | Соответствует значению 'fractalNoise'. |
| const [SVG_TURBULENCE_TYPE_TURBULENCE](../../aspose.svg.filters/svgfeturbulenceelement/svg_turbulence_type_turbulence) | Соответствует значению 'турбулентность'. |
| const [SVG_TURBULENCE_TYPE_UNKNOWN](../../aspose.svg.filters/svgfeturbulenceelement/svg_turbulence_type_unknown) | Тип не является одним из предопределенных типов. Недопустимо пытаться определить новое значение этого типа или пытаться переключить существующее значение на этот тип. |
