...
description: "Класс Aspose.Svg.Filters.SVGFEGaussianBlurElement. Интерфейс SVGFEGaussianBlurElement соответствует элементу feGaussianBlur"
type: docs
weight: 3880
...
| [Height](../../aspose.svg.filters/svgfegaussianblurelement/height/) { get; } | Соответствует атрибуту �height� в данном элементе �filter�. |
| [Id](../../aspose.svg/svgelement/id/) { get; set; } | Значение атрибута ‘id’ данного элемента, или пустая строка, если атрибут ‘id’ отсутствует. |
| [In1](../../aspose.svg.filters/svgfegaussianblurelement/in1/) { get; } | Соответствует атрибуту �in� в данном элементе �feGaussianBlur�. |
...
| [Result](../../aspose.svg.filters/svgfegaussianblurelement/result/) { get; } | Соответствует атрибуту �result� в данном элементе �filter�. |
...
| [StdDeviationX](../../aspose.svg.filters/svgfegaussianblurelement/stddeviationx/) { get; } | Соответствует атрибуту �stdDeviation� в данном элементе �feGaussianBlur�. Содержит X‑компонент атрибута �stdDeviation�. |
| [StdDeviationY](../../aspose.svg.filters/svgfegaussianblurelement/stddeviationy/) { get; } | Соответствует атрибуту �stdDeviation� в данном элементе �feGaussianBlur�. Содержит Y‑компонент (возможно вычисляемый автоматически) атрибута �stdDeviation�. |
...
| [Width](../../aspose.svg.filters/svgfegaussianblurelement/width/) { get; } | Соответствует атрибуту �width� в данном элементе �filter�. |
| [X](../../aspose.svg.filters/svgfegaussianblurelement/x/) { get; } | Соответствует атрибуту �x� в данном элементе �filter�. |
| [Y](../../aspose.svg.filters/svgfegaussianblurelement/y/) { get; } | Соответствует атрибуту �y� в данном элементе �filter�. |
