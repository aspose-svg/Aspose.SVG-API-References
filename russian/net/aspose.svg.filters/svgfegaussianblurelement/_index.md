...
description: Aspose.Svg.Filters.SVGFEGaussianBlurElement сорт. Интерфейс SVGFEGaussianBlurElement соответствует элементу feGaussianBlur.
type: docs
weight: 1790
...
| [Height](../../aspose.svg.filters/svgfegaussianblurelement/height/) { get; } | Соответствует атрибуту «высота» данного элемента «фильтра». |
...
| [Width](../../aspose.svg.filters/svgfegaussianblurelement/width/) { get; } | Соответствует атрибуту «width» данного элемента «filter». |
| [X](../../aspose.svg.filters/svgfegaussianblurelement/x/) { get; } | Соответствует атрибуту "x" данного элемента "filter". |
