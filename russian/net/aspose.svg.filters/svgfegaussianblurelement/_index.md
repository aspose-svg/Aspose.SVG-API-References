...
type: docs
weight: 1780
url: /ru/net/aspose.svg.filters/svgfegaussianblurelement/
---
...
| [Height](../../aspose.svg.filters/svgfegaussianblurelement/height) { get; } | Соответствует атрибуту «высота» данного элемента «фильтр». |
| [Id](../../aspose.svg/svgelement/id) { get; set; } | Значение атрибута 'id' данного элемента или пустая строка, если 'id' отсутствует. |
| [In1](../../aspose.svg.filters/svgfegaussianblurelement/in1) { get; } | Соответствует атрибуту in данного элемента feGaussianBlur. |
...
| [Result](../../aspose.svg.filters/svgfegaussianblurelement/result) { get; } | Соответствует атрибуту «результат» данного элемента «фильтр». |
...
| [StdDeviationX](../../aspose.svg.filters/svgfegaussianblurelement/stddeviationx) { get; } | Соответствует атрибуту stdDeviation данного элемента feGaussianBlur. Содержит компонент X атрибута «stdDeviation». |
| [StdDeviationY](../../aspose.svg.filters/svgfegaussianblurelement/stddeviationy) { get; } | Соответствует атрибуту stdDeviation данного элемента feGaussianBlur. Содержит компонент Y (возможно, вычисляемый автоматически) атрибута «stdDeviation». |
...
| [Width](../../aspose.svg.filters/svgfegaussianblurelement/width) { get; } | Соответствует атрибуту «ширина» данного элемента «фильтр». |
| [X](../../aspose.svg.filters/svgfegaussianblurelement/x) { get; } | Соответствует атрибуту «x» данного элемента «фильтр». |
| [Y](../../aspose.svg.filters/svgfegaussianblurelement/y) { get; } | Соответствует атрибуту «y» данного элемента «фильтр». |
...
| [SetStdDeviation](../../aspose.svg.filters/svgfegaussianblurelement/setstddeviation)(float, float) | Устанавливает значения для атрибута «stdDeviation». |
