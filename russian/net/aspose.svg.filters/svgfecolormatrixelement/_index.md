...
description: Aspose.Svg.Filters.SVGFEColorMatrixElement сорт. Интерфейс SVGFEColorMatrixElement соответствует элементу feColorMatrix.
type: docs
weight: 1660
...
| [Result](../../aspose.svg.filters/svgfecolormatrixelement/result/) { get; } | Соответствует атрибуту «результат» данного элемента «фильтр». |
...
| [Values](../../aspose.svg.filters/svgfecolormatrixelement/values/) { get; } | Соответствует значениям атрибута данного элемента feColorMatrix. |
...
| [Width](../../aspose.svg.filters/svgfecolormatrixelement/width/) { get; } | Соответствует атрибуту «ширина» данного элемента «фильтр». |
| [X](../../aspose.svg.filters/svgfecolormatrixelement/x/) { get; } | Соответствует атрибуту «x» данного элемента «фильтр». |
...
| const [SVG_FECOLORMATRIX_TYPE_MATRIX](../../aspose.svg.filters/svgfecolormatrixelement/svg_fecolormatrix_type_matrix/) | Соответствует значению «матрица». |
| const [SVG_FECOLORMATRIX_TYPE_SATURATE](../../aspose.svg.filters/svgfecolormatrixelement/svg_fecolormatrix_type_saturate/) | Соответствует значению «насыщение». |
