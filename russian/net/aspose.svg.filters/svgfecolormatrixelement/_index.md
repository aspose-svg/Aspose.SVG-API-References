...
description: "Aspose.Svg.Filters.SVGFEColorMatrixElement класс. Интерфейс SVGFEColorMatrixElement соответствует элементу feColorMatrix."
type: docs
weight: 3750
...
| [Height](../../aspose.svg.filters/svgfecolormatrixelement/height/) { get; } | Соответствует атрибуту ‘height’ в данном элементе ‘filter’. |
| [Id](../../aspose.svg/svgelement/id/) { get; set; } | Значение атрибута ‘id’ данного элемента, или пустая строка, если атрибут ‘id’ отсутствует. |
| [In1](../../aspose.svg.filters/svgfecolormatrixelement/in1/) { get; } | Соответствует атрибуту ‘in’ указанного элемента ‘feColorMatrix’. |
...
| [Result](../../aspose.svg.filters/svgfecolormatrixelement/result/) { get; } | Соответствует атрибуту ‘result’ указанного элемента ‘filter’. |
...
| [Type](../../aspose.svg.filters/svgfecolormatrixelement/type/) { get; } | Соответствует атрибуту ‘type’ указанного элемента ‘feColorMatrix’. Принимает одну из констант SVG_FECOLORMATRIX_TYPE_*, определённых в этом интерфейсе. |
| [Values](../../aspose.svg.filters/svgfecolormatrixelement/values/) { get; } | Соответствует атрибуту ‘values’ указанного элемента ‘feColorMatrix’. |
...
| [Width](../../aspose.svg.filters/svgfecolormatrixelement/width/) { get; } | Соответствует атрибуту ‘width’ в данном элементе ‘filter’. |
| [X](../../aspose.svg.filters/svgfecolormatrixelement/x/) { get; } | Соответствует атрибуту ‘x’ в данном элементе ‘filter’. |
| [Y](../../aspose.svg.filters/svgfecolormatrixelement/y/) { get; } | Соответствует атрибуту ‘y’ в данном элементе ‘filter’. |
...
| const [SVG_FECOLORMATRIX_TYPE_SATURATE](../../aspose.svg.filters/svgfecolormatrixelement/svg_fecolormatrix_type_saturate/) | Соответствует значению 'saturate'. |
| const [SVG_FECOLORMATRIX_TYPE_UNKNOWN](../../aspose.svg.filters/svgfecolormatrixelement/svg_fecolormatrix_type_unknown/) | Тип не является одним из предопределённых типов. Недопустимо пытаться определить новое значение этого типа или попытаться переключить существующее значение на этот тип. |
