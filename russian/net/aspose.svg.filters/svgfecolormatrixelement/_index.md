...
type: docs
weight: 1650
url: /ru/net/aspose.svg.filters/svgfecolormatrixelement/
---
...
| [Height](../../aspose.svg.filters/svgfecolormatrixelement/height) { get; } | Соответствует атрибуту 'высота' данного элемента 'фильтра'. |
| [Id](../../aspose.svg/svgelement/id) { get; set; } | Значение атрибута 'id' данного элемента или пустая строка, если 'id' отсутствует. |
| [In1](../../aspose.svg.filters/svgfecolormatrixelement/in1) { get; } | Соответствует атрибуту 'in' данного элемента 'feColorMatrix'. |
...
| [Result](../../aspose.svg.filters/svgfecolormatrixelement/result) { get; } | Соответствует атрибуту 'result' данного элемента 'filter'. |
...
| [Type](../../aspose.svg.filters/svgfecolormatrixelement/type) { get; } | Соответствует атрибуту type данного элемента feColorMatrix. Принимает одну из констант SVG_FECOLORMATRIX_TYPE_*, определенных в этом интерфейсе. |
| [Values](../../aspose.svg.filters/svgfecolormatrixelement/values) { get; } | Соответствует атрибуту 'values' данного элемента 'feColorMatrix'. |
...
| [Width](../../aspose.svg.filters/svgfecolormatrixelement/width) { get; } | Соответствует атрибуту 'width' данного элемента 'filter'. |
| [X](../../aspose.svg.filters/svgfecolormatrixelement/x) { get; } | Соответствует атрибуту 'x' данного элемента 'filter'. |
| [Y](../../aspose.svg.filters/svgfecolormatrixelement/y) { get; } | Соответствует атрибуту 'y' данного элемента 'filter'. |
...
| Имя | Описание |
| --- | --- |
| const [SVG_FECOLORMATRIX_TYPE_HUEROTATE](../../aspose.svg.filters/svgfecolormatrixelement/svg_fecolormatrix_type_huerotate) | Соответствует значению 'hueRotate'. |
| const [SVG_FECOLORMATRIX_TYPE_LUMINANCETOALPHA](../../aspose.svg.filters/svgfecolormatrixelement/svg_fecolormatrix_type_luminancetoalpha) | Соответствует значению 'luminanceToAlpha'. |
| const [SVG_FECOLORMATRIX_TYPE_MATRIX](../../aspose.svg.filters/svgfecolormatrixelement/svg_fecolormatrix_type_matrix) | Соответствует значению 'matrix'. |
| const [SVG_FECOLORMATRIX_TYPE_SATURATE](../../aspose.svg.filters/svgfecolormatrixelement/svg_fecolormatrix_type_saturate) | Соответствует значению «насыщенность». |
| const [SVG_FECOLORMATRIX_TYPE_UNKNOWN](../../aspose.svg.filters/svgfecolormatrixelement/svg_fecolormatrix_type_unknown) | Тип не является одним из предопределенных типов. Недопустимо пытаться определить новое значение этого типа или пытаться переключить существующее значение на этот тип. |
