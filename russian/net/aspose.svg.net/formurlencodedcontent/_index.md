...
description: Aspose.Svg.Net.FormUrlEncodedContent сорт. Контейнер для кортежей имени/значения закодированных с использованием MIMEтипа application/xwwwformurlencoded.
type: docs
weight: 2250
...
| Имя | Описание |
| --- | --- |
| [FormUrlEncodedContent](formurlencodedcontent/)(IEnumerable&lt;KeyValuePair&lt;string, string&gt;&gt;) | Инициализирует новый экземпляр`FormUrlEncodedContent` класс. |
