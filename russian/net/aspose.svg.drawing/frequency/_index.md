---
title: "Frequency Класс"
second_title: "Aspose.SVG для .NET справочник API"
description: "Aspose.Svg.Drawing.Frequency класс. Единица частоты"
type: docs
weight: 3430
url: /ru/net/aspose.svg.drawing/frequency/
---
## Frequency class
...
| [operator +](../../aspose.svg.drawing/frequency/op_addition/) | Реализует оператор +. |
| [operator ==](../../aspose.svg.drawing/frequency/op_equality/) | Реализует оператор ==. |
| [operator >](../../aspose.svg.drawing/frequency/op_greaterthan/) | Реализует оператор >. |
| [operator >=](../../aspose.svg.drawing/frequency/op_greaterthanorequal/) | Реализует оператор >=. |
| [operator !=](../../aspose.svg.drawing/frequency/op_inequality/) | Реализует оператор !=. |
| [operator <](../../aspose.svg.drawing/frequency/op_lessthan/) | Реализует оператор <. |
| [operator <=](../../aspose.svg.drawing/frequency/op_lessthanorequal/) | Реализует оператор <=. |
| [operator -](../../aspose.svg.drawing/frequency/op_subtraction/) | Реализует оператор -. |
