...
| override [Equals](../../aspose.svg.drawing/numeric/equals#equals)(Unit) | Определяет, является ли указанный[`Unit`](../unit) , равно этому экземпляру. |
...
| [GetValue](../../aspose.svg.drawing/numeric/getvalue#getvalue_1)(UnitType) | Получает значение, преобразованное в указанное[`UnitType`](../unittype) . |
| override [ToString](../../aspose.svg.drawing/numeric/tostring)() | ВозвращаетString который представляет этот экземпляр. |
