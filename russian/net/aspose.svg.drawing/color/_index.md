...
| Имя | Описание |
| --- | --- |
| [Color](color#constructor)() | Инициализирует новый экземпляр[`Color`](../color) class. По умолчанию черный цвет. |
| [Color](color#constructor_1)(byte, byte, byte) | Инициализирует новый экземпляр[`Color`](../color)class. Все компоненты цвета должны быть в диапазоне 0-255. |
| [Color](color#constructor_5)(float, float, float) | Инициализирует новый экземпляр[`Color`](../color) class. Все компоненты цвета должны быть в диапазоне 0-1. |
| [Color](color#constructor_3)(int, int, int) | Инициализирует новый экземпляр[`Color`](../color)class. Все компоненты цвета должны быть в диапазоне 0-255. |
| [Color](color#constructor_2)(byte, byte, byte, byte) | Инициализирует новый экземпляр[`Color`](../color)class. Все компоненты цвета должны быть в диапазоне 0-255. |
| [Color](color#constructor_6)(float, float, float, float) | Инициализирует новый экземпляр[`Color`](../color) class. Все компоненты цвета должны быть в диапазоне 0-1. |
| [Color](color#constructor_4)(int, int, int, int) | Инициализирует новый экземпляр[`Color`](../color)class. Все компоненты цвета должны быть в диапазоне 0-255. |
...
| override [Equals](../../aspose.svg.drawing/color/equals)(object) | Определяет, является ли указанный[`Color`](../color) равен этому экземпляру. |
