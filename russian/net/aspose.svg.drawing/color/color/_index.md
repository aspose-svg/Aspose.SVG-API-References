...
description: Инициализирует новый экземплярColoraspose.svg.drawing/color class. По умолчанию черный цвет.
type: docs
weight: 10
...
Инициализирует новый экземпляр[`Color`](../../color) class. По умолчанию черный цвет.
...
Инициализирует новый экземпляр[`Color`](../../color) class. Все компоненты цвета должны быть в диапазоне 0-1.
...
Инициализирует новый экземпляр[`Color`](../../color)class. Все компоненты цвета должны быть в диапазоне 0-255.
