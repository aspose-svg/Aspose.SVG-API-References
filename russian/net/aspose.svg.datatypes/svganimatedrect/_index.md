...
type: docs
weight: 180
url: /ru/net/aspose.svg.datatypes/svganimatedrect/
---
...
| override [ToString](../../aspose.svg.datatypes/svganimatedrect/tostring)() | ВозвращаетString который представляет этот экземпляр. |
