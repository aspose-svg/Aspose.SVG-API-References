...
| [Value](../../aspose.svg.datatypes/svglength/value) { get; set; } | Значение в виде числа с плавающей запятой в пользовательских единицах. Установка этого атрибута приведет к автоматическому обновлению valueInSpecifiedUnits и valueAsString, чтобы отразить этот параметр. |
...
| [ValueInSpecifiedUnits](../../aspose.svg.datatypes/svglength/valueinspecifiedunits) { get; set; } | Значение в виде значения с плавающей запятой в единицах, выраженных unitType. Установка этого атрибута приведет к автоматическому обновлению value и valueAsString, чтобы отразить этот параметр. |
...
| override [ToString](../../aspose.svg.datatypes/svglength/tostring)() | ВозвращаетString, представляющий этот экземпляр. |
...
| const [SVG_LENGTHTYPE_PC](../../aspose.svg.datatypes/svglength/svg_lengthtype_pc) | Значение было указано в единицах pc, определенных в CSS2. |
