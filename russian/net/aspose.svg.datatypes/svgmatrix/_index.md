...
description: Многие графические операции SVG используют матрицы 2x3 в форме ace bdf  которые при преобразовании в Матрица 3x3 для целей матричной арифметики ace bdf 0 0 1
type: docs
weight: 250
...
Многие графические операции SVG используют матрицы 2x3 в форме: [ace] [bdf] , которые при преобразовании в Матрица 3x3 для целей матричной арифметики: [ace] [bdf] [0 0 1]
...
| [F](../../aspose.svg.datatypes/svgmatrix/f) { get; set; } | F-компонента матрицы. |
...
| [Rotate](../../aspose.svg.datatypes/svgmatrix/rotate)(float) | Пост-умножает преобразование вращения на текущую матрицу и возвращает результирующую матрицу. |
...
| override [ToString](../../aspose.svg.datatypes/svgmatrix/tostring)() | ВозвращаетString, представляющий этот экземпляр. |
