...
description: SVGTransform метод. Устанавливает тип преобразования на SVG_TRANSFORM_ROTATE с параметром angle определяющим угол поворота и параметрами cx и cy определяющими необязательный центр вращения.
type: docs
weight: 50
