...
| Имя | Описание |
| --- | --- |
| [Angle](../../aspose.svg.datatypes/svgtransform/angle) { get; } | Удобный атрибут для SVG_TRANSFORM_ROTATE, SVG_TRANSFORM_SKEWX и SVG_TRANSFORM_SKEWY. Он удерживает заданный угол. Для SVG_TRANSFORM_MATRIX, SVG_TRANSFORM_TRANSLATE и SVG_TRANSFORM_SCALE угол будет равен нулю. |
...
| [SetRotate](../../aspose.svg.datatypes/svgtransform/setrotate)(float, float, float) | Устанавливает тип преобразования SVG_TRANSFORM_ROTATE, с параметром angle, определяющим угол поворота, и параметрами cx и cy, определяющими необязательный центр вращения. |
...
| [SetSkewX](../../aspose.svg.datatypes/svgtransform/setskewx)(float) | Задает тип преобразования SVG_TRANSFORM_SKEWX с параметром angle, определяющим величину перекоса. |
| [SetSkewY](../../aspose.svg.datatypes/svgtransform/setskewy)(float) | Задает тип преобразования SVG_TRANSFORM_SKEWY с параметром angle, определяющим величину перекоса. |
...
| override [ToString](../../aspose.svg.datatypes/svgtransform/tostring)() | ВозвращаетString, представляющий этот экземпляр. |

## Поля

| Имя | Описание |
| --- | --- |
| const [SVG_TRANSFORM_MATRIX](../../aspose.svg.datatypes/svgtransform/svg_transform_matrix) | Преобразование 'матрицы(…)'. |
...
| const [SVG_TRANSFORM_UNKNOWN](../../aspose.svg.datatypes/svgtransform/svg_transform_unknown) | Тип объекта не является одним из предопределенных типов. Недопустимо пытаться определить новое значение этого типа или пытаться переключить существующее значение на этот тип. |
