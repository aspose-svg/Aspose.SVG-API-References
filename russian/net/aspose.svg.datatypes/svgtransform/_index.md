...
description: SVGTransform  это интерфейс для одного из преобразований компонентов в SVGTransformList таким образом объект SVGTransform соответствует одному компоненту например масштаб  или матрица  в спецификации атрибута преобразования.
type: docs
weight: 320
