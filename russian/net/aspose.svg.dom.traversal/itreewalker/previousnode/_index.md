...
description: Перемещает TreeWalker на предыдущий видимый узел в порядке документа относительно текущего узла и возвращает узел new . Если текущий узел не имеет предыдущего узла или если поиск предыдущего узла пытается перейти вверх от корневого узла TreeWalker возвращает null и сохраняет текущий узел.
type: docs
weight: 70
