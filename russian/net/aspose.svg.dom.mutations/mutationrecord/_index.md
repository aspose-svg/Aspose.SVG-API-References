...
description: MutationRecord представляет собой индивидуальную мутацию DOM. Это объект который передаетсяMutationObserver./mutationobserver сMutationCallback./mutationcallback .
type: docs
weight: 1140
