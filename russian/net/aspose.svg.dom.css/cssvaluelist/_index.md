...
| Имя | Описание |
| --- | --- |
| [CSSValueList](cssvaluelist#constructor)() | Инициализирует новый экземпляр[`CSSValueList`](../cssvaluelist) класс. |
| [CSSValueList](cssvaluelist#constructor_1)(params CSSValue[]) | Инициализирует новый экземпляр[`CSSValueList`](../cssvaluelist) класс. |
| [CSSValueList](cssvaluelist#constructor_2)(IEnumerable&lt;CSSValue&gt;) | Инициализирует новый экземпляр[`CSSValueList`](../cssvaluelist) класс. |
