...
description: Значение является примитивным значением и экземпляр интерфейса CSSPrimitiveValue можно получить с помощью методов приведения специфичных для привязки для этого экземпляра интерфейса CSSValue.
type: docs
weight: 90
