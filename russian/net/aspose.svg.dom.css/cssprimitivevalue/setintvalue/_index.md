...
description: Метод установки значения int с указанными единицами измерения. Если свойство связанное с этим значением не может принять указанную единицу измерения или значение int значение останется неизменным и будет возбуждено исключение DOMException.
type: docs
weight: 90
