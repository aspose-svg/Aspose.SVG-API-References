...
description: Aspose.Svg.Dom.Css.IStyleSheet интерфейс. Интерфейс StyleSheet является абстрактным базовым интерфейсом для любого типа таблицы стилей. Он представляет собой единую таблицу стилей связанную со структурированным документом.
type: docs
weight: 740
