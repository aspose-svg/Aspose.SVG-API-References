...
| [Length](../../aspose.svg.dom.css/istylesheetlist/length) { get; } | Количество таблиц стилей в списке. Диапазон допустимых индексов дочерних таблиц стилей — от 0 до length-1 включительно. |
