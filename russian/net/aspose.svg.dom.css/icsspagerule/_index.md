...
description: Интерфейс CSSPageRule представляет собой правило page в таблице стилей CSS. Правило page используется для указания размеров ориентации полей и т. д. страничного блока для постраничных медиафайлов.
type: docs
weight: 610
