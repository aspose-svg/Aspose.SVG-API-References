...
description: Интерфейс CSSImportRule представляет правилоimport в таблице стилей CSS. Правилоimport используется для импорта правил стиля из других таблиц стилей.
type: docs
weight: 570
