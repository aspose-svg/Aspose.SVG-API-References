...
| Имя | Описание |
| --- | --- |
| override [Clone](../../aspose.svg.rendering.xps/xpsgraphiccontext/clone)() | Создает новый экземпляр класса XpsGraphicContext с теми же значениями свойств, что и у существующего экземпляра. |
