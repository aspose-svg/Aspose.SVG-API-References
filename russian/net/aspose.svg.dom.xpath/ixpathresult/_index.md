...
description: Aspose.Svg.Dom.XPath.IXPathResult интерфейс. XPathResult Интерфейс представляет собой результат оценки выражения XPath 1.0 в контексте конкретного узла. Поскольку вычисление выражения XPath может привести к различным типам результатов этот объект позволяет обнаруживать и управлять типом и значением результата.
type: docs
weight: 1350
