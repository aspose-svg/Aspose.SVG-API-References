...
description: Найдите URI пространства имен связанный с данным префиксом пространства имен. Оценщик XPath никогда не должен вызывать это снулевой или пустой аргумент  потому что результат этого не определен.
type: docs
weight: 10
