...
description: Aspose.Svg.Events.SVGZoomEvent сорт. Событие масштабирования происходит когда пользователь инициирует действие которое приводит к изменению масштаба текущего представления фрагмента документа SVG. Обработчики событий распознаются только для элементов svg.
type: docs
weight: 1620
