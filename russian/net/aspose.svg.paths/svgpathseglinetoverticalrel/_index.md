...
description: Aspose.Svg.Paths.SVGPathSegLinetoVerticalRel сорт. Интерфейс SVGPathSegLinetoVerticalRel соответствует команде данных пути относительная вертикальная линия к v.
type: docs
weight: 2660
