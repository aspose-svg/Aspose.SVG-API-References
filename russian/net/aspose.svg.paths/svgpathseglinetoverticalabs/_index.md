...
description: Aspose.Svg.Paths.SVGPathSegLinetoVerticalAbs сорт. Интерфейс SVGPathSegLinetoVerticalAbs соответствует команде данных пути абсолютная вертикальная линия до V.
type: docs
weight: 2650
