...
description: Aspose.Svg.Paths.ISVGAnimatedPathData интерфейс. Интерфейс SVGAnimatedPathData поддерживает элементы с атрибутом d который содержит данные пути SVG и поддерживает возможность анимации этого атрибута.
type: docs
weight: 2480
