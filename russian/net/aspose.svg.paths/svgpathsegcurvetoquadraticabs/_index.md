...
description: Aspose.Svg.Paths.SVGPathSegCurvetoQuadraticAbs сорт. Интерфейс SVGPathSegCurvetoQuadraticAbs соответствует команде данных пути абсолютная квадратичная кривая Безье Q.
type: docs
weight: 2570
