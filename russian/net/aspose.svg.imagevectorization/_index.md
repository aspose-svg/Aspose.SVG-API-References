...
| [ImageVectorizerConfiguration](./imagevectorizerconfiguration) | Класс ImageVectorizerConfiguration определяет конфигурацию методов и параметров векторизации изображений. Конфигурация используется для инициализации ImageVectorizer и предоставляет параметры конфигурации для векторизации изображений. |
