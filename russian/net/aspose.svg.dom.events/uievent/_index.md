...
| Имя | Описание |
| --- | --- |
| [UIEvent](uievent#constructor)(string) | Инициализирует новый экземпляр[`UIEvent`](../uievent) класс. |
| [UIEvent](uievent#constructor_1)(string, IDictionary&lt;string, object&gt;) | Инициализирует новый экземпляр[`UIEvent`](../uievent) класс. |
