...
description: Aspose.Svg.Dom.Events.WheelEvent сорт. Интерфейс WheelEvent предоставляет конкретную контекстную информацию связанную с событиями колеса. Чтобы создать экземпляр интерфейса WheelEvent используйте конструктор WheelEvent передав необязательный словарь WheelEventInit.
type: docs
weight: 1010
