...
description: ErrorEvent./errorevent предоставляет контекстную информацию об ошибках возникших во время выполнения.
type: docs
weight: 910
...
| Имя | Описание |
| --- | --- |
| [ErrorEvent](errorevent#constructor_1)(Exception) | Инициализирует новый экземпляр[`ErrorEvent`](../errorevent) класс. |
| [ErrorEvent](errorevent#constructor)(IDictionary&lt;string, object&gt;) | Инициализирует новый экземпляр[`ErrorEvent`](../errorevent) класс. |
