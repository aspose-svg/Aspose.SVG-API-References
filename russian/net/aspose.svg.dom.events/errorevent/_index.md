...
description: "Класс Aspose.Svg.Dom.Events.ErrorEvent. ErrorEvent предоставляет контекстную информацию об ошибках, произошедших во время выполнения."
type: docs
weight: 2910
...
| [ErrorEvent](errorevent/#constructor)(*IDictionary&lt;string, object&gt;*) | Инициализирует новый экземпляр класса `ErrorEvent`. |
