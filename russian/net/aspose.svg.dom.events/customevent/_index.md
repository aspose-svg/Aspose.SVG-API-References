...
| Имя | Описание |
| --- | --- |
| [CustomEvent](customevent#constructor)(string) | Инициализирует новый экземпляр[`CustomEvent`](../customevent) класс. |
| [CustomEvent](customevent#constructor_1)(string, IDictionary&lt;string, object&gt;) | Инициализирует новый экземпляр[`CustomEvent`](../customevent) класс. |
