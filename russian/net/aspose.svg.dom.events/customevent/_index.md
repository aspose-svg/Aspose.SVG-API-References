...
description: Aspose.Svg.Dom.Events.CustomEvent сорт. События использующие интерфейс CustomEvent могут использоваться для переноса пользовательских данных.
type: docs
weight: 880
...
| [InitCustomEvent](../../aspose.svg.dom.events/customevent/initcustomevent/)(string, bool, bool, object) | ///[`InitEvent`](../event/initevent/) метод используется для инициализации значения[`Event`](../event/) созданный с помощью[`IDocumentEvent`](../idocumentevent/) интерфейс. |
