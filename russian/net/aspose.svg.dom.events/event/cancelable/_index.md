...
description: Используется для указания того можно ли предотвратить событие по умолчанию. Если действие по умолчанию можно предотвратить значение равно true в противном случае значение равно false.
type: docs
weight: 30
