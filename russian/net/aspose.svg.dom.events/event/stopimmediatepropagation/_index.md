...
description: Вызов этого метода не позволяет событию достичь какихлибо прослушивателей событий зарегистрированных после текущего а при отправке в дерево также предотвращает достижение событием какихлибо других объектов.
type: docs
weight: 130
