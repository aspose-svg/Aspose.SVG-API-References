...
description: "Класс Aspose.Svg.Dom.Events.FocusEvent. Интерфейс FocusEvent предоставляет специфическую контекстную информацию, связанную с событиями фокуса."
type: docs
weight: 2930
...
| [FocusEvent](focusevent/#constructor_1)(*string, IDictionary&lt;string, object&gt;*) | Инициализирует новый экземпляр класса `FocusEvent`. |
...
| [RelatedTarget](../../aspose.svg.dom.events/focusevent/relatedtarget/) { get; } | Используется для идентификации вторичного EventTarget, связанного с событием Focus, в зависимости от типа события. |
