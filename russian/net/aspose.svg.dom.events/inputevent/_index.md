...
description: События ввода отправляются в виде уведомлений при каждом обновлении DOM.
type: docs
weight: 970
...
| Имя | Описание |
| --- | --- |
| [InputEvent](inputevent#constructor)(string) | Инициализирует новый экземпляр[`InputEvent`](../inputevent) класс. |
| [InputEvent](inputevent#constructor_1)(string, IDictionary&lt;string, object&gt;) | Инициализирует новый экземпляр[`InputEvent`](../inputevent) класс. |
