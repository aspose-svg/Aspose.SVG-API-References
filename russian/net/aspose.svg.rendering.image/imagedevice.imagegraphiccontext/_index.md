...
description: "Класс Aspose.Svg.Rendering.Image.ImageDeviceImageGraphicContext. Содержит текущие параметры управления графикой для ImageDevice. Эти параметры определяют глобальную структуру, в которой выполняются графические операторы."
type: docs
weight: 4920
...
| Имя | Описание |
| --- | --- |
| [ImageGraphicContext](../../aspose.svg.rendering.image/imagedevice.imagegraphiccontext/.ctor)() | Конструктор по умолчанию. |
