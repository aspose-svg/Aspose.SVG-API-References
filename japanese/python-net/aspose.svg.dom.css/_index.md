...
type: docs
weight: 10
url: /ja/python-net/aspose.svg.dom.css/
is_root: false
---
...
| [`IPercentResolvingContext`](/svg/python-net/aspose.svg.dom.css/ipercentresolvingcontext) | Represents a context for resolving percentage values during layout calculations. |
| [`IResolvedStyleDeclaration`](/svg/python-net/aspose.svg.dom.css/iresolvedstyledeclaration) | Represents a resolved style declaration that provides access to various style properties. |
