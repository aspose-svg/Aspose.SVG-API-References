...
description: "SVGBuilderExtensions RefX メソッド。SVG 要素の refX 属性を設定します。"
type: docs
weight: 1930
url: /ja/net/aspose.svg.builder/svgbuilderextensions/refx/
---
## RefX<TBuilder>(*this TBuilder, double, [LengthType](../../lengthtype/)*) {#refx_1}

SVG 要素の 'refX' 属性を設定します。
...
事前定義された水平位置を使用して SVG 要素の 'refX' 属性を設定します。
