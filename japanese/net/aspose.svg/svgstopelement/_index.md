...
description: Aspose.Svg.SVGStopElement クラス. SVGStopElement インターフェイスは停止要素に対応します
type: docs
weight: 3470
...
| [Offset](../../aspose.svg/svgstopelement/offset/) { get; } | 指定された「radialGradient」要素の属性「オフセット」に対応します。 |
