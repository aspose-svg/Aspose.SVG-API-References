...
description: "Aspose.Svg.SVGMaskElement クラス。SVGMaskElement インターフェイスは mask 要素に対応します。"
type: docs
weight: 5420
url: /ja/net/aspose.svg/svgmaskelement/
---
...
| [Height](../../aspose.svg/svgmaskelement/height/) { get; } | 指定された ‘mask’ 要素の属性 ‘height’ に対応します。SVGUnitTypes で定義された定数のいずれかを取ります。 |
...
| [MaskContentUnits](../../aspose.svg/svgmaskelement/maskcontentunits/) { get; } | 指定された ‘mask’ 要素の属性 ‘maskContentUnits’ に対応します。SVGUnitTypes で定義された定数のいずれかを取ります。 |
| [MaskUnits](../../aspose.svg/svgmaskelement/maskunits/) { get; } | 指定された ‘mask’ 要素の属性 ‘maskUnits’ に対応します。SVGUnitTypes で定義された定数のいずれかを取ります。 |
...
| [RequiredExtensions](../../aspose.svg/svgmaskelement/requiredextensions/) { get; } | 指定された要素の属性 ‘requiredExtensions’ に対応します。 |
| [RequiredFeatures](../../aspose.svg/svgmaskelement/requiredfeatures/) { get; } | 指定された要素の属性 ‘requiredFeatures’ に対応します。 |
...
| [SystemLanguage](../../aspose.svg/svgmaskelement/systemlanguage/) { get; } | 指定された要素の属性 ‘systemLanguage’ に対応します。 |
...
| [Width](../../aspose.svg/svgmaskelement/width/) { get; } | 指定された ‘mask’ 要素の属性 ‘width’ に対応します。SVGUnitTypes で定義された定数のいずれかを取ります。 |
| [X](../../aspose.svg/svgmaskelement/x/) { get; } | 指定された ‘mask’ 要素の属性 ‘x’ に対応します。SVGUnitTypes で定義された定数のいずれかを取ります。 |
| [Y](../../aspose.svg/svgmaskelement/y/) { get; } | 指定された ‘mask’ 要素の属性 ‘y’ に対応します。SVGUnitTypes で定義された定数のいずれかを取ります。 |
