...
description: Aspose.Svg.SVGMaskElement クラス. SVGMaskElement インターフェイスはマスク要素に対応します
type: docs
weight: 3350
...
| [Height](../../aspose.svg/svgmaskelement/height/) { get; } | 指定された「マスク」要素の属性「高さ」に対応します。 SVGUnitTypes. で定義された定数の 1 つを取ります |
...
| [MaskContentUnits](../../aspose.svg/svgmaskelement/maskcontentunits/) { get; } | 指定された「マスク」要素の属性「maskContentUnits」に対応します。 SVGUnitTypes. で定義された定数の 1 つを取ります |
| [MaskUnits](../../aspose.svg/svgmaskelement/maskunits/) { get; } | 指定された「マスク」要素の属性「maskUnits」に対応します。 SVGUnitTypes. で定義された定数の 1 つを取ります |
...
| [Width](../../aspose.svg/svgmaskelement/width/) { get; } | 指定された「マスク」要素の属性「幅」に対応します。 SVGUnitTypes. で定義された定数の 1 つを取ります |
| [X](../../aspose.svg/svgmaskelement/x/) { get; } | 指定された「マスク」要素の属性「x」に対応します。 SVGUnitTypes. で定義された定数の 1 つを取ります |
| [Y](../../aspose.svg/svgmaskelement/y/) { get; } | 指定された「マスク」要素の属性「y」に対応します。 SVGUnitTypes. で定義された定数の 1 つを取ります |
