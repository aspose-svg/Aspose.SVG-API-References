...
description: "Aspose.Svg.SVGElement クラス。SVG 言語の要素に直接対応するすべての SVG DOM インターフェイス（例：path 要素の SVGPathElement インターフェイスなど）は SVGElement インターフェイスから派生します。"
type: docs
weight: 5270
url: /ja/net/aspose.svg/svgelement/
---
## SVGElement class
