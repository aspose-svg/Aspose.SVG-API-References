...
description: "Aspose.Svg.SVGMarkerElement クラス。SVGMarkerElement インターフェイスはマーカー要素に対応します"
type: docs
weight: 5410
url: /ja/net/aspose.svg/svgmarkerelement/
---
...
| [MarkerHeight](../../aspose.svg/svgmarkerelement/markerheight/) { get; } | 指定された ‘marker’ 要素の属性 ‘markerHeight’ に対応します。 |
| [MarkerUnits](../../aspose.svg/svgmarkerelement/markerunits/) { get; } | 指定された ‘marker’ 要素の属性 ‘markerUnits’ に対応します。このインターフェイスで定義されているマーカー単位タイプのいずれかです。 |
| [MarkerWidth](../../aspose.svg/svgmarkerelement/markerwidth/) { get; } | 指定された ‘marker’ 要素の属性 ‘markerWidth’ に対応します。 |
...
| [OrientAngle](../../aspose.svg/svgmarkerelement/orientangle/) { get; } | 指定された ‘marker’ 要素の属性 ‘orient’ に対応します。markerUnits が SVG_MARKER_ORIENT_ANGLE の場合、属性 ‘orient’ の角度値が使用されます。それ以外の場合は 0 に設定されます。 |
| [OrientType](../../aspose.svg/svgmarkerelement/orienttype/) { get; } | 指定された ‘marker’ 要素の属性 ‘orient’ に対応します。このインターフェイスで定義されているマーカー方向タイプのいずれかです。 |
...
| [PreserveAspectRatio](../../aspose.svg/svgmarkerelement/preserveaspectratio/) { get; } | 指定された要素の属性 ‘preserveAspectRatio’ に対応します。 |
...
| [RefX](../../aspose.svg/svgmarkerelement/refx/) { get; } | 指定された ‘marker’ 要素の属性 ‘refX’ に対応します。 |
| [RefY](../../aspose.svg/svgmarkerelement/refy/) { get; } | 指定された ‘marker’ 要素の属性 ‘refY’ に対応します。 |
...
| [ViewBox](../../aspose.svg/svgmarkerelement/viewbox/) { get; } | 指定された要素の属性 ‘viewBox’ に対応します。 |
...
| [SetOrientToAngle](../../aspose.svg/svgmarkerelement/setorienttoangle/)(*[SVGAngle](../../aspose.svg.datatypes/svgangle/)*) | 属性 ‘orient’ の値を指定された角度に設定します。 |
| [SetOrientToAuto](../../aspose.svg/svgmarkerelement/setorienttoauto/)() | 属性 ‘orient’ の値を 'auto' に設定します。 |
...
| 名前 | 説明 |
| --- | --- |
| const [SVG_MARKERUNITS_STROKEWIDTH](../../aspose.svg/svgmarkerelement/svg_markerunits_strokewidth/) | 属性 ‘markerUnits’ の値は 'strokeWidth' です。 |
| const [SVG_MARKERUNITS_UNKNOWN](../../aspose.svg/svgmarkerelement/svg_markerunits_unknown/) | マーカー単位タイプは事前定義されたタイプのいずれでもありません。このタイプの新しい値を定義しようとしたり、既存の値をこのタイプに変更しようとすることは無効です。 |
| const [SVG_MARKERUNITS_USERSPACEONUSE](../../aspose.svg/svgmarkerelement/svg_markerunits_userspaceonuse/) | 属性 ‘markerUnits’ の値は 'userSpaceOnUse' です。 |
| const [SVG_MARKER_ORIENT_ANGLE](../../aspose.svg/svgmarkerelement/svg_marker_orient_angle/) | 属性 ‘orient’ には角度値があります。 |
| const [SVG_MARKER_ORIENT_AUTO](../../aspose.svg/svgmarkerelement/svg_marker_orient_auto/) | 属性 ‘orient’ の値は 'auto' です。 |
| const [SVG_MARKER_ORIENT_UNKNOWN](../../aspose.svg/svgmarkerelement/svg_marker_orient_unknown/) | マーカーの方向は事前定義されたタイプのいずれでもありません。このタイプの新しい値を定義しようとしたり、既存の値をこのタイプに変更しようとすることは無効です。 |
