...
| [MarkerHeight](../../aspose.svg/svgmarkerelement/markerheight/) { get; } | 指定された「マーカー」要素の属性「markerHeight」に対応します。 |
| [MarkerUnits](../../aspose.svg/svgmarkerelement/markerunits/) { get; } | 指定された「marker」要素の属性「markerUnits」に対応します。このインターフェイスで定義されているマーカー ユニット タイプの 1 つ。 |
| [MarkerWidth](../../aspose.svg/svgmarkerelement/markerwidth/) { get; } | 指定された「マーカー」要素の属性「markerWidth」に対応します。 |
...
| [OrientAngle](../../aspose.svg/svgmarkerelement/orientangle/) { get; } | 指定された「マーカー」要素の属性「方向」に対応します。 markerUnits が SVG_MARKER_ORIENT_ANGLE の場合、属性「orient」の角度値。それ以外の場合は、ゼロに設定されます. |
| [OrientType](../../aspose.svg/svgmarkerelement/orienttype/) { get; } | 指定された「マーカー」要素の属性「方向」に対応します。このインターフェイスで定義されているマーカー方向タイプの 1 つ。 |
...
| [RefX](../../aspose.svg/svgmarkerelement/refx/) { get; } | 指定された「マーカー」要素の属性「refX」に対応します。 |
| [RefY](../../aspose.svg/svgmarkerelement/refy/) { get; } | 指定された「マーカー」要素の属性「refY」に対応します。 |
...
| [SetOrientToAngle](../../aspose.svg/svgmarkerelement/setorienttoangle/)(SVGAngle) | 属性 'orient' の値を指定された角度に設定します. |
...
| const [SVG_MARKERUNITS_UNKNOWN](../../aspose.svg/svgmarkerelement/svg_markerunits_unknown/) | マーカー ユニットのタイプが事前定義されたタイプの 1 つではありません。この型の新しい値を定義しようとしたり、既存の値をこの型に切り替えようとしたりすることは無効です. |
...
| const [SVG_MARKER_ORIENT_UNKNOWN](../../aspose.svg/svgmarkerelement/svg_marker_orient_unknown/) | マーカーの向きは事前定義されたタイプの 1 つではありません。この型の新しい値を定義しようとしたり、既存の値をこの型に切り替えようとしたりすることは無効です. |
