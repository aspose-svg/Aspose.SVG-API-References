...
description: "Aspose.Svg.SVGUseElement クラス。SVGUseElement インターフェイスは use 要素に対応します。"
type: docs
weight: 5650
url: /ja/net/aspose.svg/svguseelement/
---
## SVGUseElement class
...
| [Height](../../aspose.svg/svguseelement/height/) { get; } | 指定された ‘use’ 要素の属性 ‘height’ に対応します。 |
| [Href](../../aspose.svg/svguseelement/href/) { get; } | 指定された要素の属性 ‘xlink:href’ に対応します。 |
...
| [Width](../../aspose.svg/svguseelement/width/) { get; } | 指定された ‘use’ 要素の属性 ‘width’ に対応します。 |
| [X](../../aspose.svg/svguseelement/x/) { get; } | 指定された ‘use’ 要素の属性 ‘x’ に対応します。 |
| [Y](../../aspose.svg/svguseelement/y/) { get; } | 指定された ‘use’ 要素の属性 ‘y’ に対応します。 |
