...
description: "Aspose.Svg.SVGTextPathElement クラス。SVGTextPathElement インターフェイスは textPath 要素に対応します"
type: docs
weight: 5610
url: /ja/net/aspose.svg/svgtextpathelement/
---
...
| [Href](../../aspose.svg/svgtextpathelement/href/) { get; } | 指定された要素の属性 ‘xlink:href’ に対応します。 |
...
| [LengthAdjust](../../aspose.svg/svgtextcontentelement/lengthadjust/) { get; } | 指定された要素の属性 ‘lengthAdjust’ に対応します。この値は、このインターフェイスで定義されている length adjust 定数のいずれかでなければなりません。 |
...
| [Method](../../aspose.svg/svgtextpathelement/method/) { get; } | 指定された ‘textPath’ 要素の属性 ‘method’ に対応します。 |
...
| [Spacing](../../aspose.svg/svgtextpathelement/spacing/) { get; } | 指定された ‘textPath’ 要素の属性 ‘spacing’ に対応します。 |
| [StartOffset](../../aspose.svg/svgtextpathelement/startoffset/) { get; } | 指定された ‘textPath’ 要素の属性 ‘startOffset’ に対応します。 |
...
| [TextLength](../../aspose.svg/svgtextcontentelement/textlength/) { get; } | 指定された要素の属性 ‘textLength’ に対応します。 |
...
| [GetComputedTextLength](../../aspose.svg/svgtextcontentelement/getcomputedtextlength/)() | この要素内のすべての文字をレンダリングする際の総アドバンス値の合計で、グリフのアドバンス値（水平または垂直）、プロパティ ‘kerning’、‘letter-spacing’、‘word-spacing’ の効果、および ‘tspan’ 要素の属性 ‘dx’ と ‘dy’ による調整を含みます。非レンダリング環境では、ユーザーエージェントはグリフメトリックについて合理的な仮定を行うものとします。 |
...
| [GetNumberOfChars](../../aspose.svg/svgtextcontentelement/getnumberofchars/)() | 現在の要素内でレンダリング可能な文字数の総計を返します。これには ‘tref’ 参照からの文字も含まれ、レンダリングされるかどうかに関わりません。実質的には、DOM Level 3 Core（[DOM3]、セクション 1.4）の Node::textContent 属性の長さに相当し、その属性が ‘tref’ 要素も展開している場合と同等です。 |
...
| 名前 | 説明 |
| --- | --- |
| const [TEXTPATH_METHODTYPE_ALIGN](../../aspose.svg/svgtextpathelement/textpath_methodtype_align/) | 値 'align' に対応します。 |
| const [TEXTPATH_METHODTYPE_STRETCH](../../aspose.svg/svgtextpathelement/textpath_methodtype_stretch/) | 値 'stretch' に対応します。 |
| const [TEXTPATH_METHODTYPE_UNKNOWN](../../aspose.svg/svgtextpathelement/textpath_methodtype_unknown/) | 列挙は事前定義された型のいずれでもない値に設定されました。この型の新しい値を定義しようとしたり、既存の値をこの型に切り替えようとすることは無効です。 |
| const [TEXTPATH_SPACINGTYPE_AUTO](../../aspose.svg/svgtextpathelement/textpath_spacingtype_auto/) | 値 'auto' に対応します。 |
| const [TEXTPATH_SPACINGTYPE_EXACT](../../aspose.svg/svgtextpathelement/textpath_spacingtype_exact/) | 値 'exact' に対応します。 |
| const [TEXTPATH_SPACINGTYPE_UNKNOWN](../../aspose.svg/svgtextpathelement/textpath_spacingtype_unknown/) | 列挙は事前定義された型のいずれでもない値に設定されました。この型の新しい値を定義しようとしたり、既存の値をこの型に切り替えようとすることは無効です。 |
