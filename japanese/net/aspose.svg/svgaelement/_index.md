...
description: "Aspose.Svg.SVGAElement クラス。SVGAElement インターフェイスは a 要素に対応します。"
type: docs
weight: 5150
url: /ja/net/aspose.svg/svgaelement/
---
## SVGAElement class
...
| [Href](../../aspose.svg/svgaelement/href/) { get; } | 指定された要素の属性 ‘xlink:href’ に対応します。 |
...
| [Target](../../aspose.svg/svgaelement/target/) { get; } | 指定された ‘a’ 要素の属性 ‘target’ に対応します。 |
