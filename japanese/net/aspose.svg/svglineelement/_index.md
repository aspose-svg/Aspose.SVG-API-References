...
description: Aspose.Svg.SVGLineElement クラス. SVGLineElement インターフェイスはline要素に対応します
type: docs
weight: 3310
...
| [X1](../../aspose.svg/svglineelement/x1/) { get; } | 指定された「ライン」要素の属性「x1」に対応します。 |
| [X2](../../aspose.svg/svglineelement/x2/) { get; } | 指定された「ライン」要素の属性「x2」に対応します。 |
| [Y1](../../aspose.svg/svglineelement/y1/) { get; } | 指定された「ライン」要素の属性「y1」に対応します。 |
| [Y2](../../aspose.svg/svglineelement/y2/) { get; } | 指定された「ライン」要素の属性「y2」に対応します。 |
