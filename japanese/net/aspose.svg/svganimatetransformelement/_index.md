...
description: "Aspose.Svg.SVGAnimateTransformElement クラス。SVGAnimateTransformElement インターフェイスは animateTransform 要素に対応します。SVG DOM を介した animateTransform 要素の属性へのオブジェクト指向アクセスは利用できません。"
type: docs
weight: 5180
url: /ja/net/aspose.svg/svganimatetransformelement/
---
