...
description: Aspose.Svg.SVGAnimateTransformElement クラス. SVGAnimateTransformElement インターフェイスはanimateTransform要素に対応します SVG DOM を介したanimateTransform要素の属性へのオブジェクト指向アクセスは利用できません
type: docs
weight: 3110
