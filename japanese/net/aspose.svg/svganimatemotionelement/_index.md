...
description: Aspose.Svg.SVGAnimateMotionElement クラス. SVGAnimateMotionElement インターフェイスはanimateMotion要素に対応します SVG DOM を介したanimateMotion要素の属性へのオブジェクト指向アクセスは利用できません
type: docs
weight: 3100
