...
description: "Aspose.Svg.SVGAnimateMotionElement クラス。SVGAnimateMotionElement インターフェイスは animateMotion 要素に対応します。SVG DOM を介した animateMotion 要素の属性へのオブジェクト指向アクセスは利用できません。"
type: docs
weight: 5170
url: /ja/net/aspose.svg/svganimatemotionelement/
---
