...
description: "Aspose.Svg.SVGGradientElement クラス。インターフェイス SVGGradientElement は、SVGLinearGradientElement と SVGRadialGradientElement が使用する基本インターフェイスです。"
type: docs
weight: 5350
url: /ja/net/aspose.svg/svggradientelement/
---
...
| 名前 | 説明 |
| --- | --- |
| const [SVG_SPREADMETHOD_PAD](../../aspose.svg/svggradientelement/svg_spreadmethod_pad/) | ‘pad’ の値に対応します。 |
| const [SVG_SPREADMETHOD_REFLECT](../../aspose.svg/svggradientelement/svg_spreadmethod_reflect/) | ‘reflect’ の値に対応します。 |
| const [SVG_SPREADMETHOD_REPEAT](../../aspose.svg/svggradientelement/svg_spreadmethod_repeat/) | ‘repeat’ の値に対応します。 |
| const [SVG_SPREADMETHOD_UNKNOWN](../../aspose.svg/svggradientelement/svg_spreadmethod_unknown/) | この型は事前定義された型のいずれでもありません。この型の新しい値を定義しようとしたり、既存の値をこの型に切り替えようとしたりすることは無効です。 |
