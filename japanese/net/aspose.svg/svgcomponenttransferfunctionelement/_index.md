...
description: "Aspose.Svg.SVGComponentTransferFunctionElement クラス。このインターフェイスはコンポーネント転送関数インターフェイスで使用される基底インターフェイスを定義します。"
type: docs
weight: 5220
url: /ja/net/aspose.svg/svgcomponenttransferfunctionelement/
---
...
| 名前 | 説明 |
| --- | --- |
| [Amplitude](../../aspose.svg/svgcomponenttransferfunctionelement/amplitude/) { get; } | 指定された要素の属性 ‘amplitude’ に対応します。 |
...
| [Exponent](../../aspose.svg/svgcomponenttransferfunctionelement/exponent/) { get; } | 指定された要素の属性 ‘exponent’ に対応します。 |
...
| [Intercept](../../aspose.svg/svgcomponenttransferfunctionelement/intercept/) { get; } | 指定された要素の属性 ‘intercept’ に対応します。 |
...
| [Offset](../../aspose.svg/svgcomponenttransferfunctionelement/offset/) { get; } | 指定された要素の属性 ‘offset’ に対応します。 |
...
| [Slope](../../aspose.svg/svgcomponenttransferfunctionelement/slope/) { get; } | 指定された要素の属性 ‘slope’ に対応します。 |
...
| [TableValues](../../aspose.svg/svgcomponenttransferfunctionelement/tablevalues/) { get; } | 指定された要素の属性 ‘tableValues’ に対応します。 |
...
| [Type](../../aspose.svg/svgcomponenttransferfunctionelement/type/) { get; } | 指定された要素の属性 ‘type’ に対応します。このインターフェイスで定義された SVG_FECOMPONENTTRANSFER_TYPE_* 定数のいずれかを取ります。 |
...
| 名前 | 説明 |
| --- | --- |
| const [SVG_FECOMPONENTTRANSFER_TYPE_DISCRETE](../../aspose.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_discrete/) | 値 'discrete' に対応します。 |
| const [SVG_FECOMPONENTTRANSFER_TYPE_GAMMA](../../aspose.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_gamma/) | 値 'gamma' に対応します。 |
| const [SVG_FECOMPONENTTRANSFER_TYPE_IDENTITY](../../aspose.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_identity/) | 値 'identity' に対応します。 |
| const [SVG_FECOMPONENTTRANSFER_TYPE_LINEAR](../../aspose.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_linear/) | 値 'linear' に対応します。 |
| const [SVG_FECOMPONENTTRANSFER_TYPE_TABLE](../../aspose.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_table/) | 値 'table' に対応します。 |
| const [SVG_FECOMPONENTTRANSFER_TYPE_UNKNOWN](../../aspose.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_unknown/) | この型は事前定義された型のいずれでもありません。この型の新しい値を定義しようとしたり、既存の値をこの型に切り替えようとしたりすることは無効です。 |
