...
description: Aspose.Svg.SVGComponentTransferFunctionElement クラス. このインターフェイスはコンポーネント伝達関数インターフェイスで使用される基本インターフェイスを定義します
type: docs
weight: 3150
...
| 名前 | 説明 |
| --- | --- |
| [Amplitude](../../aspose.svg/svgcomponenttransferfunctionelement/amplitude/) { get; } | 指定された要素の属性「振幅」に対応します。 |
...
| [Exponent](../../aspose.svg/svgcomponenttransferfunctionelement/exponent/) { get; } | 指定された要素の属性「指数」に対応します。 |
...
| [Intercept](../../aspose.svg/svgcomponenttransferfunctionelement/intercept/) { get; } | 指定された要素の属性「インターセプト」に対応します。 |
...
| [Offset](../../aspose.svg/svgcomponenttransferfunctionelement/offset/) { get; } | 指定された要素の属性「オフセット」に対応します。 |
...
| [Slope](../../aspose.svg/svgcomponenttransferfunctionelement/slope/) { get; } | 指定された要素の属性「勾配」に対応します。 |
...
| [Type](../../aspose.svg/svgcomponenttransferfunctionelement/type/) { get; } | 指定された要素の属性 'type' に対応します。このインターフェイスで定義された SVG_FECOMPONENTTRANSFER_TYPE_* 定数の 1 つを取ります。 |
...
| const [SVG_FECOMPONENTTRANSFER_TYPE_GAMMA](../../aspose.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_gamma/) | 値「ガンマ」に対応します。 |
...
| const [SVG_FECOMPONENTTRANSFER_TYPE_TABLE](../../aspose.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_table/) | 値「テーブル」に対応します。 |
| const [SVG_FECOMPONENTTRANSFER_TYPE_UNKNOWN](../../aspose.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_unknown/) | タイプは定義済みのタイプではありません。この型の新しい値を定義しようとしたり、既存の値をこの型に切り替えようとしたりすることは無効です. |
