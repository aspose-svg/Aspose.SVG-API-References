...
description: "Aspose.Svg.SVGClipPathElement クラス。SVGClipPathElement インターフェイスは clipPath 要素に対応します。"
type: docs
weight: 5210
url: /ja/net/aspose.svg/svgclippathelement/
---
...
| [ClipPathUnits](../../aspose.svg/svgclippathelement/clippathunits/) { get; } | 指定された ‘clipPath’ 要素の属性 ‘clipPathUnits’ に対応します。SVGUnitTypes で定義された定数のいずれかを取ります。 |
...
| [Transform](../../aspose.svg/svgclippathelement/transform/) { get; } | 指定された要素の属性 ‘transform’ に対応します。 |
