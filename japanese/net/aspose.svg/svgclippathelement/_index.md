...
description: Aspose.Svg.SVGClipPathElement クラス. SVGClipPathElement インターフェイスはclipPath要素に対応します
type: docs
weight: 3140
...
| [ClipPathUnits](../../aspose.svg/svgclippathelement/clippathunits/) { get; } | 指定された「clipPath」要素の属性「clipPathUnits」に対応します。 SVGUnitTypes. で定義された定数の 1 つを取ります |
...
| [Transform](../../aspose.svg/svgclippathelement/transform/) { get; } | 指定された要素の属性「変換」に対応します。 |
