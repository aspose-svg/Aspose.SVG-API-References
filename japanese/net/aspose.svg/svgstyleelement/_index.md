...
description: Aspose.Svg.SVGStyleElement クラス. SVGStyleElement インターフェイスはスタイル要素に対応します
type: docs
weight: 3480
...
| [Media](../../aspose.svg/svgstyleelement/media/) { get; set; } | 指定された要素の属性「メディア」に対応します。 |
...
| [Sheet](../../aspose.svg/svgstyleelement/sheet/) { get; } | 関連付けられたスタイル シートを取得します。 |
...
| [Title](../../aspose.svg/svgstyleelement/title/) { get; set; } | 指定された要素の属性「タイトル」に対応します。 |
| [Type](../../aspose.svg/svgstyleelement/type/) { get; set; } | 指定された要素の属性「タイプ」に対応します。 |
