...
description: "Aspose.Svg.SVGStyleElement クラス。SVGStyleElement インターフェイスは style 要素に対応します。"
type: docs
weight: 5550
url: /ja/net/aspose.svg/svgstyleelement/
---
...
| [Media](../../aspose.svg/svgstyleelement/media/) { get; set; } | 指定された要素の属性 ‘media’ に対応します。 |
...
| [Sheet](../../aspose.svg/svgstyleelement/sheet/) { get; } | 関連付けられたスタイルシートを取得します。 |
...
| [Title](../../aspose.svg/svgstyleelement/title/) { get; set; } | 指定された要素の属性 ‘title’ に対応します。 |
| [Type](../../aspose.svg/svgstyleelement/type/) { get; set; } | 指定された要素の属性 ‘type’ に対応します。 |
