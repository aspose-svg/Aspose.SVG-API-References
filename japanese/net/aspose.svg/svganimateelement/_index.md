...
description: "Aspose.Svg.SVGAnimateElement クラス。SVGAnimateElement インターフェイスは animate 要素に対応します。SVG DOM を介した animate 要素の属性へのオブジェクト指向アクセスは利用できません。"
type: docs
weight: 5160
url: /ja/net/aspose.svg/svganimateelement/
---
