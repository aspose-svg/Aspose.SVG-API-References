...
description: "Aspose.Svg.SVGImageElement クラス。SVGImageElement インターフェイスは image 要素に対応します。"
type: docs
weight: 5370
url: /ja/net/aspose.svg/svgimageelement/
---
...
| [Height](../../aspose.svg/svgimageelement/height/) { get; } | 指定された ‘image’ 要素の属性 ‘height’ に対応します。 |
| [Href](../../aspose.svg/svgimageelement/href/) { get; } | 指定された要素の属性 ‘xlink:href’ に対応します。 |
...
| [PreserveAspectRatio](../../aspose.svg/svgimageelement/preserveaspectratio/) { get; } | 指定された ‘image’ 要素の属性 ‘preserveAspectRatio’ に対応します。 |
...
| [Width](../../aspose.svg/svgimageelement/width/) { get; } | 指定された ‘image’ 要素の属性 ‘width’ に対応します。 |
| [X](../../aspose.svg/svgimageelement/x/) { get; } | 指定された ‘image’ 要素の属性 ‘x’ に対応します。 |
| [Y](../../aspose.svg/svgimageelement/y/) { get; } | 指定された ‘image’ 要素の属性 ‘y’ に対応します。 |
