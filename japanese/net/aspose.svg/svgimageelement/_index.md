...
description: Aspose.Svg.SVGImageElement クラス. SVGImageElement インターフェイスはimage要素に対応します
type: docs
weight: 3300
...
| [Height](../../aspose.svg/svgimageelement/height/) { get; } | 指定された「イメージ」要素の属性「高さ」に対応します。 |
...
| [PreserveAspectRatio](../../aspose.svg/svgimageelement/preserveaspectratio/) { get; } | 指定された「イメージ」要素の属性「preserveAspectRatio」に対応します。 |
...
| [Width](../../aspose.svg/svgimageelement/width/) { get; } | 指定された「イメージ」要素の属性「幅」に対応します。 |
| [X](../../aspose.svg/svgimageelement/x/) { get; } | 指定された「画像」要素の属性「x」に対応します。 |
| [Y](../../aspose.svg/svgimageelement/y/) { get; } | 指定された「イメージ」要素の属性「y」に対応します。 |
