...
description: "Aspose.Svg.SVGViewElement クラス。インターフェイス SVGViewElement は view 要素に対応します。"
type: docs
weight: 5660
url: /ja/net/aspose.svg/svgviewelement/
---
...
| [PreserveAspectRatio](../../aspose.svg/svgviewelement/preserveaspectratio/) { get; } | 指定された要素の属性 ‘preserveAspectRatio’ に対応します。 |
...
| [ViewBox](../../aspose.svg/svgviewelement/viewbox/) { get; } | 指定された要素の属性 ‘viewBox’ に対応します。 |
...
| [ViewTarget](../../aspose.svg/svgviewelement/viewtarget/) { get; } | 指定された ‘view’ 要素の属性 ‘viewTarget’ に対応します。‘viewTarget’ 属性に列挙された名前を含む DOMString 値のリストです。各 DOMString 値は getElementById() メソッド呼び出しを使用して対応する要素に関連付けることができます。 |
| [ZoomAndPan](../../aspose.svg/svgviewelement/zoomandpan/) { get; set; } | 指定された要素の属性 ‘zoomAndPan’ に対応します。この値はこのインターフェイスで定義された SVG_ZOOMANDPAN_* 定数のいずれかでなければなりません。 |
