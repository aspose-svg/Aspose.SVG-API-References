...
description: "Aspose.Svg.SVGAnimationElement クラス。SVGAnimationElement インターフェイスは、すべてのアニメーション要素インターフェイス（SVGAnimateElement、SVGSetElement、SVGAnimateColorElement、SVGAnimateMotionElement、SVGAnimateTransformElement）の基底インターフェイスです。"
type: docs
weight: 5190
url: /ja/net/aspose.svg/svganimationelement/
---
...
| [RequiredExtensions](../../aspose.svg/svganimationelement/requiredextensions/) { get; } | 指定された要素の属性 ‘requiredExtensions’ に対応します。 |
| [RequiredFeatures](../../aspose.svg/svganimationelement/requiredfeatures/) { get; } | 指定された要素の属性 ‘requiredFeatures’ に対応します。 |
...
| [SystemLanguage](../../aspose.svg/svganimationelement/systemlanguage/) { get; } | 指定された要素の属性 ‘systemLanguage’ に対応します。 |
| [TagName](../../aspose.svg.dom/element/tagname/) { get; } | 要素の名前。 |
| [TargetElement](../../aspose.svg/svganimationelement/targetelement/) { get; } | アニメーション対象の要素。 |
