...
description: Aspose.Svg.SVGAnimationElement クラス. SVGAnimationElement インターフェイスはすべてのアニメーション要素インターフェイスの基本インターフェイスです SVGAnimateElementSVGSetElementSVGAnimateColorElementSVGAnimateMotionElementおよび SVGAnimateTransformElement.
type: docs
weight: 3120
...
| [TargetElement](../../aspose.svg/svganimationelement/targetelement/) { get; } | アニメ化されている要素. |
