...
description: "Aspose.Svg.SVGSetElement クラス。SVGSetElement インターフェイスは set 要素に対応します。SVG DOM を介した set 要素の属性へのオブジェクト指向アクセスは利用できません"
type: docs
weight: 5530
url: /ja/net/aspose.svg/svgsetelement/
---
## SVGSetElement class
