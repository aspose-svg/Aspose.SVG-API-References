...
description: "Aspose.Svg.SVGGraphicsElement クラス。SVGGraphicsElement インターフェイスは、主な目的がグループ内に直接グラフィックを描画する SVG 要素を表します。"
type: docs
weight: 5360
url: /ja/net/aspose.svg/svggraphicselement/
---
## SVGGraphicsElement class

SVGGraphicsElement インターフェイスは、主な目的がグループ内に直接グラフィックを描画することにある SVG 要素を表します。
