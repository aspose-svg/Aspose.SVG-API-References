...
description: "Aspose.Svg.SVGPatternElement クラス。SVGPatternElement インターフェイスは pattern 要素に対応します。"
type: docs
weight: 5450
url: /ja/net/aspose.svg/svgpatternelement/
---
...
| [Height](../../aspose.svg/svgpatternelement/height/) { get; } | 指定された ‘pattern’ 要素の属性 ‘height’ に対応します。 |
| [Href](../../aspose.svg/svgpatternelement/href/) { get; } | 指定された要素の属性 ‘xlink:href’ に対応します。 |
...
| [PatternContentUnits](../../aspose.svg/svgpatternelement/patterncontentunits/) { get; } | 指定された ‘pattern’ 要素の属性 ‘patternContentUnits’ に対応します。SVGUnitTypes で定義された定数のいずれかを取ります。 |
| [PatternTransform](../../aspose.svg/svgpatternelement/patterntransform/) { get; } | 指定された ‘pattern’ 要素の属性 ‘patternTransform’ に対応します。 |
| [PatternUnits](../../aspose.svg/svgpatternelement/patternunits/) { get; } | 指定された ‘pattern’ 要素の属性 ‘patternUnits’ に対応します。SVGUnitTypes で定義された定数のいずれかを取ります。 |
| override [Prefix](../../aspose.svg.dom/element/prefix/) { get; } | このノードの名前空間プレフィックス、または未指定の場合は null。null に設定されている場合、設定しても効果はありません。 |
| [PreserveAspectRatio](../../aspose.svg/svgpatternelement/preserveaspectratio/) { get; } | 指定された要素の属性 ‘preserveAspectRatio’ に対応します。 |
...
| [RequiredExtensions](../../aspose.svg/svgpatternelement/requiredextensions/) { get; } | 指定された要素の属性 ‘requiredExtensions’ に対応します。 |
| [RequiredFeatures](../../aspose.svg/svgpatternelement/requiredfeatures/) { get; } | 指定された要素の属性 ‘requiredFeatures’ に対応します。 |
...
| [SystemLanguage](../../aspose.svg/svgpatternelement/systemlanguage/) { get; } | 指定された要素の属性 ‘systemLanguage’ に対応します。 |
...
| [ViewBox](../../aspose.svg/svgpatternelement/viewbox/) { get; } | 指定された要素の属性 ‘viewBox’ に対応します。 |
...
| [Width](../../aspose.svg/svgpatternelement/width/) { get; } | 指定された ‘pattern’ 要素の属性 ‘width’ に対応します。 |
| [X](../../aspose.svg/svgpatternelement/x/) { get; } | 指定された ‘pattern’ 要素の属性 ‘x’ に対応します。 |
| [Y](../../aspose.svg/svgpatternelement/y/) { get; } | 指定された ‘pattern’ 要素の属性 ‘y’ に対応します。 |
