...
description: Aspose.Svg.SVGPatternElement クラス. SVGPatternElement インターフェイスはpattern要素に対応します
type: docs
weight: 3380
...
| [Height](../../aspose.svg/svgpatternelement/height/) { get; } | 指定された「パターン」要素の属性「高さ」に対応します。 |
...
| [PatternContentUnits](../../aspose.svg/svgpatternelement/patterncontentunits/) { get; } | 指定された「pattern」要素の属性「patternContentUnits」に対応します。 SVGUnitTypes. で定義された定数の 1 つを取ります |
| [PatternTransform](../../aspose.svg/svgpatternelement/patterntransform/) { get; } | 指定された「パターン」要素の属性「patternTransform」に対応します。 |
| [PatternUnits](../../aspose.svg/svgpatternelement/patternunits/) { get; } | 指定された「pattern」要素の属性「patternUnits」に対応します。 SVGUnitTypes. で定義された定数の 1 つを取ります |
...
| [Width](../../aspose.svg/svgpatternelement/width/) { get; } | 指定された「パターン」要素の属性「幅」に対応します。 |
| [X](../../aspose.svg/svgpatternelement/x/) { get; } | 指定された「パターン」要素の属性「x」に対応します。 |
| [Y](../../aspose.svg/svgpatternelement/y/) { get; } | 指定された「パターン」要素の属性「y」に対応します。 |
