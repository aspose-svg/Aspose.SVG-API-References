...
description: "Aspose.Svg.SVGGeometryElement クラス。インターフェイス SVGGeometryElement は、幾何形状と同等のパスで描画が定義され、塗りつぶしやストロークが可能な SVG 要素を表します。これにはパスと基本形状が含まれます。"
type: docs
weight: 5340
url: /ja/net/aspose.svg/svggeometryelement/
---
...
| [Combine](../../aspose.svg/svggeometryelement/combine/)(*SVGGeometryElement, [BooleanPathOp](../../aspose.svg.rendering/booleanpathop/)*) | このジオメトリを別の SVG ジオメトリとブール演算で結合し、結果を含む新しい `<path>` 要素を返します。 |
...
| [GetEquivalentPath](../../aspose.svg/svggeometryelement/getequivalentpath/)() | [`SVGPathSegList`](../../aspose.svg.paths/svgpathseglist/) の新しいインスタンスを返します。このインスタンスは `SVGGeometryElement` をパスセグメントとして表します。 |
