...
description: Aspose.Svg.SVGRadialGradientElement クラス. SVGRadialGradientElement インターフェイスはradialGradient要素に対応します
type: docs
weight: 3410
...
| [GradientUnits](../../aspose.svg/svggradientelement/gradientunits/) { get; } | 指定された要素の属性「gradientUnits」に対応します。 SVGUnitTypes. で定義された定数の 1 つを取ります |
...
| [SpreadMethod](../../aspose.svg/svggradientelement/spreadmethod/) { get; } | 指定された要素の属性 'spreadMethod' に対応します。このインターフェイスで定義されている拡散方法タイプの 1 つ。 |
