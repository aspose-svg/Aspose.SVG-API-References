...
description: "Aspose.Svg.SVGRadialGradientElement クラス。SVGRadialGradientElement インターフェイスは radialGradient 要素に対応します。"
type: docs
weight: 5480
url: /ja/net/aspose.svg/svgradialgradientelement/
---
...
| [Cx](../../aspose.svg/svgradialgradientelement/cx/) { get; } | 指定された ‘radialGradient’ 要素の属性 ‘cx’ に対応します。 |
| [Cy](../../aspose.svg/svgradialgradientelement/cy/) { get; } | 指定された ‘radialGradient’ 要素の属性 ‘cy’ に対応します。 |
...
| [Fr](../../aspose.svg/svgradialgradientelement/fr/) { get; } | 指定された ‘radialGradient’ 要素の属性 ‘fr’ に対応します。 |
| [Fx](../../aspose.svg/svgradialgradientelement/fx/) { get; } | 指定された ‘radialGradient’ 要素の属性 ‘fx’ に対応します。 |
| [Fy](../../aspose.svg/svgradialgradientelement/fy/) { get; } | 指定された ‘radialGradient’ 要素の属性 ‘fy’ に対応します。 |
| [GradientTransform](../../aspose.svg/svggradientelement/gradienttransform/) { get; } | 指定された要素の属性 ‘gradientTransform’ に対応します。 |
| [GradientUnits](../../aspose.svg/svggradientelement/gradientunits/) { get; } | 指定された要素の属性 ‘gradientUnits’ に対応します。SVGUnitTypes で定義された定数のいずれかを取ります。 |
| [Href](../../aspose.svg/svggradientelement/href/) { get; } | 指定された要素の属性 ‘xlink:href’ に対応します。 |
...
| [R](../../aspose.svg/svgradialgradientelement/r/) { get; } | 指定された ‘radialGradient’ 要素の属性 ‘r’ に対応します。 |
| [ShadowRoot](../../aspose.svg.dom/element/shadowroot/) { get; } | この要素に格納されている shadowRoot を返します。閉じている場合は null を返します。 |
| [SpreadMethod](../../aspose.svg/svggradientelement/spreadmethod/) { get; } | 指定された要素の属性 ‘spreadMethod’ に対応します。このインターフェイスで定義された Spread Method Types のいずれかです。 |
