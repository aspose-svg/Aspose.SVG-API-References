...
description: Aspose.Svg.SVGForeignObjectElement クラス. SVGForeignObjectElement インターフェイスはforeignObject要素に対応します
type: docs
weight: 3250
...
| [Width](../../aspose.svg/svgforeignobjectelement/width/) { get; } | 指定された「foreignObject」要素の属性「幅」に対応します。 |
