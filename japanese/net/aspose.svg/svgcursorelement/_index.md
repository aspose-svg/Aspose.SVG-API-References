...
description: "Aspose.Svg.SVGCursorElement クラス。SVGCursorElement インターフェイスは cursor 要素に対応します"
type: docs
weight: 5230
url: /ja/net/aspose.svg/svgcursorelement/
---
...
| [Href](../../aspose.svg/svgcursorelement/href/) { get; } | 指定された要素の属性 ‘xlink:href’ に対応します。 |
...
| [RequiredExtensions](../../aspose.svg/svgcursorelement/requiredextensions/) { get; } | 指定された要素の属性 ‘requiredExtensions’ に対応します。 |
| [RequiredFeatures](../../aspose.svg/svgcursorelement/requiredfeatures/) { get; } | 指定された要素の属性 ‘requiredFeatures’ に対応します。 |
...
| [SystemLanguage](../../aspose.svg/svgcursorelement/systemlanguage/) { get; } | 指定された要素の属性 ‘systemLanguage’ に対応します。 |
...
| [X](../../aspose.svg/svgcursorelement/x/) { get; } | 指定された ‘cursor’ 要素の属性 ‘x’ に対応します。 |
| [Y](../../aspose.svg/svgcursorelement/y/) { get; } | 指定された ‘cursor’ 要素の属性 ‘y’ に対応します。 |
