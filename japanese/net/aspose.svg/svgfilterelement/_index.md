...
description: "Aspose.Svg.SVGFilterElement クラス。SVGFilterElement インターフェイスは filter 要素に対応します。"
type: docs
weight: 5310
url: /ja/net/aspose.svg/svgfilterelement/
---
...
| [FilterUnits](../../aspose.svg/svgfilterelement/filterunits/) { get; } | 指定された ‘filter’ 要素の属性 ‘filterUnits’ に対応します。SVGUnitTypes で定義された定数のいずれかを取ります。 |
...
| [Height](../../aspose.svg/svgfilterelement/height/) { get; } | 指定された ‘filter’ 要素の属性 ‘height’ に対応します。 |
| [Href](../../aspose.svg/svgfilterelement/href/) { get; } | 指定された要素の属性 ‘xlink:href’ に対応します。 |
...
| [PrimitiveUnits](../../aspose.svg/svgfilterelement/primitiveunits/) { get; } | 指定された ‘filter’ 要素の属性 ‘primitiveUnits’ に対応します。SVGUnitTypes で定義された定数のいずれかを取ります。 |
...
| [Width](../../aspose.svg/svgfilterelement/width/) { get; } | 指定された ‘filter’ 要素の属性 ‘width’ に対応します。 |
| [X](../../aspose.svg/svgfilterelement/x/) { get; } | 指定された ‘filter’ 要素の属性 ‘x’ に対応します。 |
| [Y](../../aspose.svg/svgfilterelement/y/) { get; } | 指定された ‘filter’ 要素の属性 ‘y’ に対応します。 |
