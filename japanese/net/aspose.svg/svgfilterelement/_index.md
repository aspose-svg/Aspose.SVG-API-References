...
description: Aspose.Svg.SVGFilterElement クラス. SVGFilterElement インターフェイスはfilter要素に対応します
type: docs
weight: 3240
...
| [FilterUnits](../../aspose.svg/svgfilterelement/filterunits/) { get; } | 指定された「filter」要素の属性「filterUnits」に対応します。 SVGUnitTypes. で定義された定数の 1 つを取ります |
...
| [Height](../../aspose.svg/svgfilterelement/height/) { get; } | 指定された「フィルター」要素の属性「高さ」に対応します。 |
...
| [PrimitiveUnits](../../aspose.svg/svgfilterelement/primitiveunits/) { get; } | 指定された「filter」要素の属性「primitiveUnits」に対応します。 SVGUnitTypes. で定義された定数の 1 つを取ります |
...
| [Width](../../aspose.svg/svgfilterelement/width/) { get; } | 指定された「フィルター」要素の属性「幅」に対応します。 |
| [X](../../aspose.svg/svgfilterelement/x/) { get; } | 指定された「フィルター」要素の属性「x」に対応します。 |
| [Y](../../aspose.svg/svgfilterelement/y/) { get; } | 指定された「フィルター」要素の属性「y」に対応します。 |
