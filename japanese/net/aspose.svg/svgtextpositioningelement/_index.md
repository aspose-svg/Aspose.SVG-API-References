...
description: "Aspose.Svg.SVGTextPositioningElement クラス。SVGTextPositioningElement インターフェイスは、テキスト関連インターフェイスである SVGTextElement、SVGTSpanElement、SVGTRefElement、SVGAltGlyphElement に継承されます。"
type: docs
weight: 5620
url: /ja/net/aspose.svg/svgtextpositioningelement/
---
...
| [Dx](../../aspose.svg/svgtextpositioningelement/dx/) { get; } | 指定された要素の属性 ‘dx’ に対応します。 |
| [Dy](../../aspose.svg/svgtextpositioningelement/dy/) { get; } | 指定された要素の属性 ‘dy’ に対応します。 |
...
| [Rotate](../../aspose.svg/svgtextpositioningelement/rotate/) { get; } | 指定された要素の属性 ‘rotate’ に対応します。 |
...
| [X](../../aspose.svg/svgtextpositioningelement/x/) { get; } | 指定された要素の属性 ‘x’ に対応します。 |
| [Y](../../aspose.svg/svgtextpositioningelement/y/) { get; } | 指定された要素の属性 ‘y’ に対応します。 |
