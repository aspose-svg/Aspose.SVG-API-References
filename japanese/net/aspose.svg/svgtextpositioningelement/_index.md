...
description: Aspose.Svg.SVGTextPositioningElement クラス. SVGTextPositioningElement インターフェイスはテキスト関連のインターフェイス SVGTextElementSVGTSpanElementSVGTRefElementおよび SVGAltGlyphElement によって継承されます
type: docs
weight: 3550
...
| [Rotate](../../aspose.svg/svgtextpositioningelement/rotate/) { get; } | 指定された要素の属性「回転」に対応します。 |
