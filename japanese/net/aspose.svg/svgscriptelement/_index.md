...
description: "Aspose.Svg.SVGScriptElement クラス。SVGScriptElement インターフェイスは script 要素に対応します。"
type: docs
weight: 5520
...
| [Type](../../aspose.svg/svgscriptelement/type/) { get; set; } | 指定された ‘script’ 要素の属性 ‘type’ に対応します。 |
