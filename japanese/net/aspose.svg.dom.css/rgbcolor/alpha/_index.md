...
description: "RGBColor Alpha プロパティ。 この Color クラスのアルファ成分の値を取得します。"
type: docs
weight: 10
url: /ja/net/aspose.svg.dom.css/rgbcolor/alpha/
---
## RGBColor.Alpha property

この Color クラスのアルファ成分の値を取得します。
