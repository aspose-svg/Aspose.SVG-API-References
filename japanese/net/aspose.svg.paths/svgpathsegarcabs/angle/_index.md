...
description: "SVGPathSegArcAbs Angle プロパティ。ユーザー座標系の x 軸に対する楕円の x 軸の回転角度（度）"
type: docs
weight: 10
url: /ja/net/aspose.svg.paths/svgpathsegarcabs/angle/
---
## SVGPathSegArcAbs.Angle property

ユーザー座標系の x 軸に対する楕円の x 軸の回転角度（度）です。
