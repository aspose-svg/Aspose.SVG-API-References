...
description: "Aspose.Svg.Dom.Events.FocusEvent クラス。FocusEvent インターフェイスは、フォーカスイベントに関連する特定のコンテキスト情報を提供します。"
type: docs
weight: 2930
...
| [FocusEvent](focusevent/#constructor_1)(*string, IDictionary&lt;string, object&gt;*) | `FocusEvent` クラスの新しいインスタンスを初期化します。 |
...
| [RelatedTarget](../../aspose.svg.dom.events/focusevent/relatedtarget/) { get; } | フォーカスイベントに関連する二次的な EventTarget を、イベントのタイプに応じて識別するために使用されます。 |
