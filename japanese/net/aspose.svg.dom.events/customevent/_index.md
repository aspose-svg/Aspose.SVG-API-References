...
description: Aspose.Svg.Dom.Events.CustomEvent クラス. CustomEvent インターフェイスを使用するイベントはカスタム データを運ぶために使用できます
type: docs
weight: 880
...
| [Detail](../../aspose.svg.dom.events/customevent/detail/) { get; } | カスタム データを取得します。 |
...
| [InitCustomEvent](../../aspose.svg.dom.events/customevent/initcustomevent/)(string, bool, bool, object) | ///[`InitEvent`](../event/initevent/)メソッドは、の値を初期化するために使用されます[`Event`](../event/)を通じて作成された[`IDocumentEvent`](../idocumentevent/)インターフェイス. |
