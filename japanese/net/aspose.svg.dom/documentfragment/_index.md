...
description: Aspose.Svg.Dom.DocumentFragment クラス. DocumentFragment は軽量または最小限の Document オブジェクトですドキュメントのツリーの一部を抽出したりドキュメントの新しいフラグメントを作成したりしたいことは非常に一般的です.
type: docs
weight: 820
url: /ja/net/aspose.svg.dom/documentfragment/
---
