...
description: Aspose.Svg.Dom.Notation クラス. DTD で宣言されている表記を表します
type: docs
weight: 1160
...
| override [NodeName](../../aspose.svg.dom/notation/nodename/) { get; } | タイプに応じたこのノードの名前. |
| override [NodeType](../../aspose.svg.dom/notation/nodetype/) { get; } | 基礎となるオブジェクトのタイプを表すコード. |
...
| [PublicId](../../aspose.svg.dom/notation/publicid/) { get; } | この表記の公開識別子。公開識別子が指定されていない場合、これは null. です。 |
| [SystemId](../../aspose.svg.dom/notation/systemid/) { get; } | この表記のシステム識別子。システム ID が指定されていない場合、これはヌルです。これは、絶対 URI である場合とそうでない場合があります。 |
