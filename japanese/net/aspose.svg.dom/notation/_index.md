...
description: "Aspose.Svg.Dom.Notation クラス。DTD で宣言された表記（notation）を表します"
type: docs
weight: 3150
url: /ja/net/aspose.svg.dom/notation/
---
## Notation class
...
| override [NodeName](../../aspose.svg.dom/notation/nodename/) { get; } | このノードの名前（タイプに応じて）。 |
| override [NodeType](../../aspose.svg.dom/notation/nodetype/) { get; } | 基になるオブジェクトのタイプを表すコード。 |
...
| [PublicId](../../aspose.svg.dom/notation/publicid/) { get; } | この表記の公開識別子。公開識別子が指定されていない場合、null です。 |
| [SystemId](../../aspose.svg.dom/notation/systemid/) { get; } | この表記のシステム識別子。システム識別子が指定されていない場合、null です。絶対 URI の場合もありますし、そうでない場合もあります。 |
