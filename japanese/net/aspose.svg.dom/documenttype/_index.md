...
description: Aspose.Svg.Dom.DocumentType クラス. DocumentType はdocument に対して定義されているエンティティのリストへのインターフェイスを提供します
type: docs
weight: 830
...
| [InternalSubset](../../aspose.svg.dom/documenttype/internalsubset/) { get; } | 文字列としての内部サブセット、または存在しない場合は null. |
...
| [Name](../../aspose.svg.dom/documenttype/name/) { get; } | DTD の名前。つまり、DOCTYPE キーワードの直後の名前. |
...
| override [NodeName](../../aspose.svg.dom/documenttype/nodename/) { get; } | タイプに応じたこのノードの名前. |
| override [NodeType](../../aspose.svg.dom/documenttype/nodetype/) { get; } | 基礎となるオブジェクトのタイプを表すコード. |
...
| [SystemId](../../aspose.svg.dom/documenttype/systemid/) { get; } | 外部サブセットのシステム識別子。これは、絶対 URI である場合とそうでない場合があります。 |
...
| override [ToString](../../aspose.svg.dom/documenttype/tostring/)() | を返しますStringこのインスタンスを表す. |
