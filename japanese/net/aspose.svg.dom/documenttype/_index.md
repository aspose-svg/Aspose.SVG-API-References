...
description: "Aspose.Svg.Dom.DocumentType クラス。DocumentType は、ドキュメントに定義されたエンティティの一覧へのインターフェイスを提供します"
type: docs
weight: 2830
url: /ja/net/aspose.svg.dom/documenttype/
---
## DocumentType class

DocumentType は、ドキュメントに定義されたエンティティの一覧へのインターフェイスを提供します。
...
| 名前 | 説明 |
| --- | --- |
| [DocumentType](documenttype/)(*string, string, string, string, [Document](../document/)*) | `DocumentType` クラスの新しいインスタンスを初期化します。 |
...
| [InternalSubset](../../aspose.svg.dom/documenttype/internalsubset/) { get; } | 内部サブセットを文字列として、存在しない場合は null。 |
...
| [Name](../../aspose.svg.dom/documenttype/name/) { get; } | DTD の名前。つまり、DOCTYPE キーワードの直後に続く名前です。 |
...
| override [NodeName](../../aspose.svg.dom/documenttype/nodename/) { get; } | このノードの名前（タイプに応じて）。 |
| override [NodeType](../../aspose.svg.dom/documenttype/nodetype/) { get; } | 基になるオブジェクトのタイプを表すコード。 |
...
| [PublicId](../../aspose.svg.dom/documenttype/publicid/) { get; } | 外部サブセットの公開識別子。 |
| [SystemId](../../aspose.svg.dom/documenttype/systemid/) { get; } | 外部サブセットのシステム識別子。絶対 URI の場合もありますし、そうでない場合もあります。 |
...
| override [ToString](../../aspose.svg.dom/documenttype/tostring/)() | このインスタンスを表す String を返します。 |
