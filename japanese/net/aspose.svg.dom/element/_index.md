...
description: Aspose.Svg.Dom.Element クラス. Element インターフェイスはHTML または XML ドキュメント内の要素を表します
type: docs
weight: 840
...
| [ParentElement](../../aspose.svg.dom/node/parentelement/) { get; } | 親を取得します`Element`このノードの. |
