...
| [InputEncoding](../../aspose.svg.dom/entity/inputencoding/) { get; } | このエンティティが外部の解析対象エンティティである場合、解析時にこのエンティティに使用されるエンコーディングを指定する属性。内部サブセットのエンティティである場合、または不明な場合は null です。 |
...
| override [NodeName](../../aspose.svg.dom/entity/nodename/) { get; } | タイプに応じたこのノードの名前. |
| override [NodeType](../../aspose.svg.dom/entity/nodetype/) { get; } | 基礎となるオブジェクトのタイプを表すコード. |
| virtual [NodeValue](../../aspose.svg.dom/node/nodevalue/) { get; set; } | タイプに応じたこのノードの値. |
| [NotationName](../../aspose.svg.dom/entity/notationname/) { get; } | 解析されていないエンティティの場合、エンティティの表記の名前。解析されたエンティティの場合、これは null. です。 |
...
| [PublicId](../../aspose.svg.dom/entity/publicid/) { get; } | 指定されている場合はエンティティに関連付けられている公開識別子、それ以外の場合は null. |
| [SystemId](../../aspose.svg.dom/entity/systemid/) { get; } | 指定されている場合はエンティティに関連付けられているシステム識別子、それ以外の場合は null。これは、絶対 URI である場合とそうでない場合があります。 |
...
| [XmlEncoding](../../aspose.svg.dom/entity/xmlencoding/) { get; } | テキスト宣言の一部として、このエンティティが外部の解析済みエンティティである場合のエンコーディングを指定する属性。それ以外の場合は null です。 |
| [XmlVersion](../../aspose.svg.dom/entity/xmlversion/) { get; } | テキスト宣言の一部として、このエンティティが外部の解析済みエンティティである場合に、このエンティティのバージョン番号を指定する属性。それ以外の場合は null です。 |
