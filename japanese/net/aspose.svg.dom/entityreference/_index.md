...
description: "Aspose.Svg.Dom.EntityReference クラス。EntityReference ノードはツリー内のエンティティ参照を表すために使用できます。"
type: docs
weight: 2860
...
| override [NodeName](../../aspose.svg.dom/entityreference/nodename/) { get; } | このノードの名前（タイプに応じて）。 |
| override [NodeType](../../aspose.svg.dom/entityreference/nodetype/) { get; } | 基になるオブジェクトのタイプを表すコード。 |
