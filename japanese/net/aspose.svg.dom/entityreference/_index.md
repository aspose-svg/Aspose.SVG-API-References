...
description: Aspose.Svg.Dom.EntityReference クラス. EntityReference ノードを使用してツリー内のエンティティ参照を表すことができます
type: docs
weight: 860
url: /ja/net/aspose.svg.dom/entityreference/
---
...
| override [NodeName](../../aspose.svg.dom/entityreference/nodename/) { get; } | タイプに応じたこのノードの名前. |
| override [NodeType](../../aspose.svg.dom/entityreference/nodetype/) { get; } | 基礎となるオブジェクトのタイプを表すコード. |
