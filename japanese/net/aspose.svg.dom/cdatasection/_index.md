...
description: "Aspose.Svg.Dom.CDATASection クラス。CDATA セクションは、マークアップと見なされる可能性のある文字を含むテキストブロックをエスケープするために使用されます。"
type: docs
weight: 2440
url: /ja/net/aspose.svg.dom/cdatasection/
---
## CDATASection class

CDATA セクションは、マークアップと見なされる可能性のある文字を含むテキストブロックをエスケープするために使用されます。
...
| override [NodeName](../../aspose.svg.dom/cdatasection/nodename/) { get; } | このノードの名前（タイプに応じて）。 |
| override [NodeType](../../aspose.svg.dom/cdatasection/nodetype/) { get; } | 基になるオブジェクトのタイプを表すコード。 |
