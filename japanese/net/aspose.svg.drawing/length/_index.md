...
description: Aspose.Svg.Drawing.Length クラス. 長さ測定単位を表します
type: docs
weight: 1520
url: /ja/net/aspose.svg.drawing/length/
---
## Length class
...
| [operator +](../../aspose.svg.drawing/length/op_addition/) | 演算子 +. を実装します |
| [operator ==](../../aspose.svg.drawing/length/op_equality/) | 演算子 ==. を実装します |
| [operator &gt;](../../aspose.svg.drawing/length/op_greaterthan/) | 演算子 &gt;. を実装します。 |
| [operator &gt;=](../../aspose.svg.drawing/length/op_greaterthanorequal/) | 演算子を実装 &gt;=. |
| [operator !=](../../aspose.svg.drawing/length/op_inequality/) | 演算子 !=. を実装します |
| [operator &lt;](../../aspose.svg.drawing/length/op_lessthan/) | 演算子 &lt;. を実装します |
| [operator &lt;=](../../aspose.svg.drawing/length/op_lessthanorequal/) | 演算子 &lt;=. を実装します |
| [operator -](../../aspose.svg.drawing/length/op_subtraction/) | 演算子を実装します -. |
