...
description: "Aspose.Svg.Filters.SVGFETurbulenceElement クラス。SVGFETurbulenceElement インターフェイスは feTurbulence 要素に対応します"
type: docs
weight: 3980
...
| [BaseFrequencyX](../../aspose.svg.filters/svgfeturbulenceelement/basefrequencyx/) { get; } | 指定された ‘feTurbulence’ 要素の属性 ‘baseFrequency’ に対応します。‘baseFrequency’ 属性の X 成分を含みます。 |
| [BaseFrequencyY](../../aspose.svg.filters/svgfeturbulenceelement/basefrequencyy/) { get; } | 指定された ‘feTurbulence’ 要素の属性 ‘baseFrequency’ に対応します。（自動的に計算される可能性のある）‘baseFrequency’ 属性の Y 成分を含みます。 |
...
| [Height](../../aspose.svg.filters/svgfeturbulenceelement/height/) { get; } | 指定された ‘filter’ 要素の属性 ‘height’ に対応します。 |
...
| [Result](../../aspose.svg.filters/svgfeturbulenceelement/result/) { get; } | 指定された ‘filter’ 要素の属性 ‘result’ に対応します。 |
...
| [StitchTiles](../../aspose.svg.filters/svgfeturbulenceelement/stitchtiles/) { get; } | 指定された ‘feTurbulence’ 要素の属性 ‘stitchTiles’ に対応します。このインターフェイスで定義された SVG_STITCHTYPE_* 定数のいずれかを取ります。 |
...
| [Type](../../aspose.svg.filters/svgfeturbulenceelement/type/) { get; } | 指定された ‘feTurbulence’ 要素の属性 ‘type’ に対応します。このインターフェイスで定義された SVG_TURBULENCE_TYPE_* 定数のいずれかを取ります。 |
...
| [Width](../../aspose.svg.filters/svgfeturbulenceelement/width/) { get; } | 指定された ‘filter’ 要素の属性 ‘width’ に対応します。 |
| [X](../../aspose.svg.filters/svgfeturbulenceelement/x/) { get; } | 指定された ‘filter’ 要素の属性 ‘x’ に対応します。 |
| [Y](../../aspose.svg.filters/svgfeturbulenceelement/y/) { get; } | 指定された ‘filter’ 要素の属性 ‘y’ に対応します。 |
...
| const [SVG_STITCHTYPE_UNKNOWN](../../aspose.svg.filters/svgfeturbulenceelement/svg_stitchtype_unknown/) | この型は事前定義された型のいずれでもありません。この型の新しい値を定義しようとしたり、既存の値をこの型に切り替えようとしたりすることは無効です。 |
...
| const [SVG_TURBULENCE_TYPE_TURBULENCE](../../aspose.svg.filters/svgfeturbulenceelement/svg_turbulence_type_turbulence/) | 値 'turbulence' に対応します。 |
| const [SVG_TURBULENCE_TYPE_UNKNOWN](../../aspose.svg.filters/svgfeturbulenceelement/svg_turbulence_type_unknown/) | この型は事前定義された型のいずれでもありません。この型の新しい値を定義しようとしたり、既存の値をこの型に切り替えようとしたりすることは無効です。 |
