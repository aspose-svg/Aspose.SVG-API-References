...
description: Aspose.Svg.Filters.SVGFETurbulenceElement クラス. SVGFETurbulenceElement インターフェイスはfeTurbulence要素に対応します
type: docs
weight: 1890
url: /ja/net/aspose.svg.filters/svgfeturbulenceelement/
---
...
| [BaseFrequencyX](../../aspose.svg.filters/svgfeturbulenceelement/basefrequencyx/) { get; } | 指定された「feTurbulence」要素の属性「baseFrequency」に対応します。 「baseFrequency」属性の X コンポーネントが含まれます。 |
| [BaseFrequencyY](../../aspose.svg.filters/svgfeturbulenceelement/basefrequencyy/) { get; } | 指定された「feTurbulence」要素の属性「baseFrequency」に対応します。 (自動的に計算される可能性がある)「baseFrequency」属性の Y コンポーネントが含まれます。 |
...
| [Height](../../aspose.svg.filters/svgfeturbulenceelement/height/) { get; } | 指定された「フィルター」要素の属性「高さ」に対応します。 |
...
| [NumOctaves](../../aspose.svg.filters/svgfeturbulenceelement/numoctaves/) { get; } | 指定された「feTurbulence」要素の属性「numOctaves」に対応します。 |
...
| [Result](../../aspose.svg.filters/svgfeturbulenceelement/result/) { get; } | 指定された「フィルター」要素の属性「結果」に対応します。 |
| [SchemaTypeInfo](../../aspose.svg.dom/element/schematypeinfo/) { get; } | この要素に関連付けられた型情報。 |
| [Seed](../../aspose.svg.filters/svgfeturbulenceelement/seed/) { get; } | 指定された「feTurbulence」要素の属性「seed」に対応します。 |
| [ShadowRoot](../../aspose.svg.dom/element/shadowroot/) { get; } | この要素に格納されている shadowRoot を返すか、閉じている場合は null を返します。 |
| [StitchTiles](../../aspose.svg.filters/svgfeturbulenceelement/stitchtiles/) { get; } | 指定された「feTurbulence」要素の属性「stitchTiles」に対応します。このインターフェイスで定義された SVG_STITCHTYPE_* 定数の 1 つを取ります。 |
...
| [Type](../../aspose.svg.filters/svgfeturbulenceelement/type/) { get; } | 指定された「feTurbulence」要素の属性「type」に対応します。このインターフェイスで定義された SVG_TURBULENCE_TYPE_* 定数の 1 つを取ります。 |
...
| [Width](../../aspose.svg.filters/svgfeturbulenceelement/width/) { get; } | 指定された「フィルター」要素の属性「幅」に対応します。 |
| [X](../../aspose.svg.filters/svgfeturbulenceelement/x/) { get; } | 指定された「フィルター」要素の属性「x」に対応します。 |
| [Y](../../aspose.svg.filters/svgfeturbulenceelement/y/) { get; } | 指定された「フィルター」要素の属性「y」に対応します。 |
...
| 名前 | 説明 |
| --- | --- |
| const [SVG_STITCHTYPE_NOSTITCH](../../aspose.svg.filters/svgfeturbulenceelement/svg_stitchtype_nostitch/) | 値「noStitch」に対応します。 |
| const [SVG_STITCHTYPE_STITCH](../../aspose.svg.filters/svgfeturbulenceelement/svg_stitchtype_stitch/) | 値「stitch」に対応します。 |
| const [SVG_STITCHTYPE_UNKNOWN](../../aspose.svg.filters/svgfeturbulenceelement/svg_stitchtype_unknown/) | タイプは定義済みのタイプではありません。この型の新しい値を定義しようとしたり、既存の値をこの型に切り替えようとしたりすることは無効です. |
| const [SVG_TURBULENCE_TYPE_FRACTALNOISE](../../aspose.svg.filters/svgfeturbulenceelement/svg_turbulence_type_fractalnoise/) | 値「fractalNoise」に対応します。 |
| const [SVG_TURBULENCE_TYPE_TURBULENCE](../../aspose.svg.filters/svgfeturbulenceelement/svg_turbulence_type_turbulence/) | 値「乱気流」に対応します。 |
| const [SVG_TURBULENCE_TYPE_UNKNOWN](../../aspose.svg.filters/svgfeturbulenceelement/svg_turbulence_type_unknown/) | タイプは定義済みのタイプではありません。この型の新しい値を定義しようとしたり、既存の値をこの型に切り替えようとしたりすることは無効です. |
