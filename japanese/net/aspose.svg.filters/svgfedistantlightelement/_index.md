...
description: Aspose.Svg.Filters.SVGFEDistantLightElement クラス. SVGFEDistantLightElement インターフェイスはfeDistantLight要素に対応します
type: docs
weight: 1720
url: /ja/net/aspose.svg.filters/svgfedistantlightelement/
---
...
| [Azimuth](../../aspose.svg.filters/svgfedistantlightelement/azimuth/) { get; } | 指定された 'feDistantLight' 要素の属性 'azimuth' に対応します。 |
...
| [Elevation](../../aspose.svg.filters/svgfedistantlightelement/elevation/) { get; } | 指定された 'feDistantLight' 要素の属性 'elevation' に対応します。 |
