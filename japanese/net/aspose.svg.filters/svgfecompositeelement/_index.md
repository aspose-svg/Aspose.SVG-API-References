...
description: Aspose.Svg.Filters.SVGFECompositeElement クラス. SVGFECompositeElement インターフェイスはfeComposite要素に対応します
type: docs
weight: 1680
url: /ja/net/aspose.svg.filters/svgfecompositeelement/
---
...
| [Height](../../aspose.svg.filters/svgfecompositeelement/height/) { get; } | 指定された「フィルター」要素の属性「高さ」に対応します。 |
| [Id](../../aspose.svg/svgelement/id/) { get; set; } | 指定された要素の 'id' 属性の値、または 'id' が存在しない場合は空の文字列. |
| [In1](../../aspose.svg.filters/svgfecompositeelement/in1/) { get; } | 指定された「feComposite」要素の属性「in」に対応します。 |
| [In2](../../aspose.svg.filters/svgfecompositeelement/in2/) { get; } | 指定された「feComposite」要素の属性「in2」に対応します。 |
...
| [K1](../../aspose.svg.filters/svgfecompositeelement/k1/) { get; } | 指定された「feComposite」要素の属性「k1」に対応します。 |
| [K2](../../aspose.svg.filters/svgfecompositeelement/k2/) { get; } | 指定された「feComposite」要素の属性「k2」に対応します。 |
| [K3](../../aspose.svg.filters/svgfecompositeelement/k3/) { get; } | 指定された「feComposite」要素の属性「k3」に対応します。 |
| [K4](../../aspose.svg.filters/svgfecompositeelement/k4/) { get; } | 指定された「feComposite」要素の属性「k4」に対応します。 |
...
| [Operator](../../aspose.svg.filters/svgfecompositeelement/operator/) { get; } | 指定された「feComposite」要素の属性「operator」に対応します。このインターフェイスで定義された SVG_FECOMPOSITE_OPERATOR_* 定数の 1 つを取ります。 |
...
| [Result](../../aspose.svg.filters/svgfecompositeelement/result/) { get; } | 指定された「フィルター」要素の属性「結果」に対応します。 |
...
| [Width](../../aspose.svg.filters/svgfecompositeelement/width/) { get; } | 指定された「フィルター」要素の属性「幅」に対応します。 |
| [X](../../aspose.svg.filters/svgfecompositeelement/x/) { get; } | 指定された「フィルター」要素の属性「x」に対応します。 |
| [Y](../../aspose.svg.filters/svgfecompositeelement/y/) { get; } | 指定された「フィルター」要素の属性「y」に対応します。 |
...
| 名前 | 説明 |
| --- | --- |
| const [SVG_FECOMPOSITE_OPERATOR_ARITHMETIC](../../aspose.svg.filters/svgfecompositeelement/svg_fecomposite_operator_arithmetic/) | 値「算術」に対応します。 |
| const [SVG_FECOMPOSITE_OPERATOR_ATOP](../../aspose.svg.filters/svgfecompositeelement/svg_fecomposite_operator_atop/) | 値「atop」に対応します。 |
| const [SVG_FECOMPOSITE_OPERATOR_IN](../../aspose.svg.filters/svgfecompositeelement/svg_fecomposite_operator_in/) | 値「in」に対応します。 |
| const [SVG_FECOMPOSITE_OPERATOR_OUT](../../aspose.svg.filters/svgfecompositeelement/svg_fecomposite_operator_out/) | 値「out」に対応します。 |
| const [SVG_FECOMPOSITE_OPERATOR_OVER](../../aspose.svg.filters/svgfecompositeelement/svg_fecomposite_operator_over/) | 値「over」に対応します。 |
| const [SVG_FECOMPOSITE_OPERATOR_UNKNOWN](../../aspose.svg.filters/svgfecompositeelement/svg_fecomposite_operator_unknown/) | タイプは定義済みのタイプではありません。この型の新しい値を定義しようとしたり、既存の値をこの型に切り替えようとしたりすることは無効です. |
| const [SVG_FECOMPOSITE_OPERATOR_XOR](../../aspose.svg.filters/svgfecompositeelement/svg_fecomposite_operator_xor/) | 値「xor」に対応します。 |
