...
description: "Aspose.Svg.Filters.SVGFECompositeElement クラス。SVGFECompositeElement インターフェイスは feComposite 要素に対応します。"
type: docs
weight: 3770
...
| [Height](../../aspose.svg.filters/svgfecompositeelement/height/) { get; } | 指定された ‘filter’ 要素の属性 ‘height’ に対応します。 |
...
| [Operator](../../aspose.svg.filters/svgfecompositeelement/operator/) { get; } | 指定された ‘feComposite’ 要素の属性 ‘operator’ に対応します。このインターフェイスで定義された SVG_FECOMPOSITE_OPERATOR_* 定数のいずれかを取ります。 |
...
| [Result](../../aspose.svg.filters/svgfecompositeelement/result/) { get; } | 指定された ‘filter’ 要素の属性 ‘result’ に対応します。 |
...
| [Width](../../aspose.svg.filters/svgfecompositeelement/width/) { get; } | 指定された ‘filter’ 要素の属性 ‘width’ に対応します。 |
| [X](../../aspose.svg.filters/svgfecompositeelement/x/) { get; } | 指定された ‘filter’ 要素の属性 ‘x’ に対応します。 |
| [Y](../../aspose.svg.filters/svgfecompositeelement/y/) { get; } | 指定された ‘filter’ 要素の属性 ‘y’ に対応します。 |
...
| 名前 | 説明 |
| --- | --- |
| const [SVG_FECOMPOSITE_OPERATOR_ARITHMETIC](../../aspose.svg.filters/svgfecompositeelement/svg_fecomposite_operator_arithmetic/) | 値 'arithmetic' に対応します。 |
...
| const [SVG_FECOMPOSITE_OPERATOR_UNKNOWN](../../aspose.svg.filters/svgfecompositeelement/svg_fecomposite_operator_unknown/) | この型は事前定義された型のいずれでもありません。この型の新しい値を定義しようとしたり、既存の値をこの型に切り替えようとしたりすることは無効です。 |
