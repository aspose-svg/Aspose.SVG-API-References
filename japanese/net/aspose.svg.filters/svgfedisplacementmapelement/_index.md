...
description: Aspose.Svg.Filters.SVGFEDisplacementMapElement クラス. SVGFEDisplacementMapElement インターフェイスはfeDisplacementMap要素に対応します
type: docs
weight: 1710
url: /ja/net/aspose.svg.filters/svgfedisplacementmapelement/
---
...
| [Height](../../aspose.svg.filters/svgfedisplacementmapelement/height/) { get; } | 指定された「フィルター」要素の属性「高さ」に対応します。 |
| [Id](../../aspose.svg/svgelement/id/) { get; set; } | 指定された要素の 'id' 属性の値、または 'id' が存在しない場合は空の文字列. |
| [In1](../../aspose.svg.filters/svgfedisplacementmapelement/in1/) { get; } | 指定された「feDisplacementMap」要素の属性「in」に対応します。 |
| [In2](../../aspose.svg.filters/svgfedisplacementmapelement/in2/) { get; } | 指定された「feDisplacementMap」要素の属性「in2」に対応します。 |
...
| [Result](../../aspose.svg.filters/svgfedisplacementmapelement/result/) { get; } | 指定された「フィルター」要素の属性「結果」に対応します。 |
| [Scale](../../aspose.svg.filters/svgfedisplacementmapelement/scale/) { get; } | 指定された「feDisplacementMap」要素の属性「scale」に対応します。 |
...
| [Width](../../aspose.svg.filters/svgfedisplacementmapelement/width/) { get; } | 指定された「フィルター」要素の属性「幅」に対応します。 |
| [X](../../aspose.svg.filters/svgfedisplacementmapelement/x/) { get; } | 指定された「フィルター」要素の属性「x」に対応します。 |
| [XChannelSelector](../../aspose.svg.filters/svgfedisplacementmapelement/xchannelselector/) { get; } | 指定された「feDisplacementMap」要素の属性「xChannelSelector」に対応します。このインターフェイスで定義された SVG_CHANNEL_* 定数の 1 つを取ります。 |
| [Y](../../aspose.svg.filters/svgfedisplacementmapelement/y/) { get; } | 指定された「フィルター」要素の属性「y」に対応します。 |
| [YChannelSelector](../../aspose.svg.filters/svgfedisplacementmapelement/ychannelselector/) { get; } | 指定された「feDisplacementMap」要素の属性「yChannelSelector」に対応します。このインターフェイスで定義された SVG_CHANNEL_* 定数の 1 つを取ります。 |
...
| 名前 | 説明 |
| --- | --- |
| const [SVG_CHANNEL_A](../../aspose.svg.filters/svgfedisplacementmapelement/svg_channel_a/) | 値「A」に対応します。 |
| const [SVG_CHANNEL_B](../../aspose.svg.filters/svgfedisplacementmapelement/svg_channel_b/) | 値「B」に対応します。 |
| const [SVG_CHANNEL_G](../../aspose.svg.filters/svgfedisplacementmapelement/svg_channel_g/) | 値「G」に対応します。 |
| const [SVG_CHANNEL_R](../../aspose.svg.filters/svgfedisplacementmapelement/svg_channel_r/) | 値「R」に対応します。 |
| const [SVG_CHANNEL_UNKNOWN](../../aspose.svg.filters/svgfedisplacementmapelement/svg_channel_unknown/) | タイプは定義済みのタイプではありません。この型の新しい値を定義しようとしたり、既存の値をこの型に切り替えようとしたりすることは無効です. |
