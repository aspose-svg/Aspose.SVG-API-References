...
description: "Aspose.Svg.Filters.SVGFEDisplacementMapElement クラス。SVGFEDisplacementMapElement インターフェイスは feDisplacementMap 要素に対応します。"
type: docs
weight: 3800
...
| [Height](../../aspose.svg.filters/svgfedisplacementmapelement/height/) { get; } | 指定された ‘filter’ 要素の属性 ‘height’ に対応します。 |
...
| [Result](../../aspose.svg.filters/svgfedisplacementmapelement/result/) { get; } | 指定された ‘filter’ 要素の属性 ‘result’ に対応します。 |
...
| [Width](../../aspose.svg.filters/svgfedisplacementmapelement/width/) { get; } | 指定された ‘filter’ 要素の属性 ‘width’ に対応します。 |
| [X](../../aspose.svg.filters/svgfedisplacementmapelement/x/) { get; } | 指定された ‘filter’ 要素の属性 ‘x’ に対応します。 |
| [XChannelSelector](../../aspose.svg.filters/svgfedisplacementmapelement/xchannelselector/) { get; } | 指定された ‘feDisplacementMap’ 要素の属性 ‘xChannelSelector’ に対応します。このインターフェイスで定義された SVG_CHANNEL_* 定数のいずれかを取ります。 |
| [Y](../../aspose.svg.filters/svgfedisplacementmapelement/y/) { get; } | 指定された ‘filter’ 要素の属性 ‘y’ に対応します。 |
| [YChannelSelector](../../aspose.svg.filters/svgfedisplacementmapelement/ychannelselector/) { get; } | 指定された ‘feDisplacementMap’ 要素の属性 ‘yChannelSelector’ に対応します。このインターフェイスで定義された SVG_CHANNEL_* 定数のいずれかを取ります。 |
...
| const [SVG_CHANNEL_UNKNOWN](../../aspose.svg.filters/svgfedisplacementmapelement/svg_channel_unknown/) | この型は事前定義された型のいずれでもありません。この型の新しい値を定義しようとしたり、既存の値をこの型に切り替えようとしたりすることは無効です。 |
