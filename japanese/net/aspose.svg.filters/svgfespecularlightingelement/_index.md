...
description: "Aspose.Svg.Filters.SVGFESpecularLightingElement クラス。この SVGFESpecularLightingElement インターフェイスは feSpecularLighting 要素に対応します"
type: docs
weight: 3950
...
| [Height](../../aspose.svg.filters/svgfespecularlightingelement/height/) { get; } | 指定された ‘filter’ 要素の属性 ‘height’ に対応します。 |
| [Id](../../aspose.svg/svgelement/id/) { get; set; } | 指定された要素の ‘id’ 属性の値、または ‘id’ が存在しない場合は空文字列です。 |
| [In1](../../aspose.svg.filters/svgfespecularlightingelement/in1/) { get; } | 指定された ‘feSpecularLighting’ 要素の ‘in’ 属性に対応します。 |
...
| [KernelUnitLengthX](../../aspose.svg.filters/svgfespecularlightingelement/kernelunitlengthx/) { get; } | 指定された ‘feSpecularLighting’ 要素の ‘kernelUnitLength’ 属性に対応します。 |
| [KernelUnitLengthY](../../aspose.svg.filters/svgfespecularlightingelement/kernelunitlengthy/) { get; } | 指定された ‘feSpecularLighting’ 要素の ‘kernelUnitLength’ 属性に対応します。 |
...
| [Result](../../aspose.svg.filters/svgfespecularlightingelement/result/) { get; } | 指定された ‘filter’ 要素の属性 ‘result’ に対応します。 |
...
| [Width](../../aspose.svg.filters/svgfespecularlightingelement/width/) { get; } | 指定された ‘filter’ 要素の属性 ‘width’ に対応します。 |
| [X](../../aspose.svg.filters/svgfespecularlightingelement/x/) { get; } | 指定された ‘filter’ 要素の属性 ‘x’ に対応します。 |
| [Y](../../aspose.svg.filters/svgfespecularlightingelement/y/) { get; } | 指定された ‘filter’ 要素の属性 ‘y’ に対応します。 |
