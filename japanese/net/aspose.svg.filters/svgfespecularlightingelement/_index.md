...
description: Aspose.Svg.Filters.SVGFESpecularLightingElement クラス. SVGFESpecularLightingElement インターフェイスはfeSpecularLighting要素に対応します
type: docs
weight: 1860
url: /ja/net/aspose.svg.filters/svgfespecularlightingelement/
---
...
| [Height](../../aspose.svg.filters/svgfespecularlightingelement/height/) { get; } | 指定された「フィルター」要素の属性「高さ」に対応します。 |
| [Id](../../aspose.svg/svgelement/id/) { get; set; } | 指定された要素の 'id' 属性の値、または 'id' が存在しない場合は空の文字列. |
| [In1](../../aspose.svg.filters/svgfespecularlightingelement/in1/) { get; } | 指定された「feSpecularLighting」要素の属性「in」に対応します。 |
...
| [KernelUnitLengthX](../../aspose.svg.filters/svgfespecularlightingelement/kernelunitlengthx/) { get; } | 指定された「feSpecularLighting」要素の属性「kernelUnitLength」に対応します。 |
| [KernelUnitLengthY](../../aspose.svg.filters/svgfespecularlightingelement/kernelunitlengthy/) { get; } | 指定された「feSpecularLighting」要素の属性「kernelUnitLength」に対応します。 |
...
| [Result](../../aspose.svg.filters/svgfespecularlightingelement/result/) { get; } | 指定された「フィルター」要素の属性「結果」に対応します。 |
...
| [SpecularConstant](../../aspose.svg.filters/svgfespecularlightingelement/specularconstant/) { get; } | 指定された「feSpecularLighting」要素の属性「specularConstant」に対応します。 |
| [SpecularExponent](../../aspose.svg.filters/svgfespecularlightingelement/specularexponent/) { get; } | 指定された「feSpecularLighting」要素の属性「specularExponent」に対応します。 |
...
| [SurfaceScale](../../aspose.svg.filters/svgfespecularlightingelement/surfacescale/) { get; } | 指定された「feSpecularLighting」要素の属性「surfaceScale」に対応します。 |
...
| [Width](../../aspose.svg.filters/svgfespecularlightingelement/width/) { get; } | 指定された「フィルター」要素の属性「幅」に対応します。 |
| [X](../../aspose.svg.filters/svgfespecularlightingelement/x/) { get; } | 指定された「フィルター」要素の属性「x」に対応します。 |
| [Y](../../aspose.svg.filters/svgfespecularlightingelement/y/) { get; } | 指定された「フィルター」要素の属性「y」に対応します。 |
