...
description: Aspose.Svg.Filters.SVGFEGaussianBlurElement クラス. SVGFFEGaussianBlurElement インターフェイスはfeGaussianBlur要素に対応します
type: docs
weight: 1790
url: /ja/net/aspose.svg.filters/svgfegaussianblurelement/
---
...
| [Height](../../aspose.svg.filters/svgfegaussianblurelement/height/) { get; } | 指定された「フィルター」要素の属性「高さ」に対応します。 |
| [Id](../../aspose.svg/svgelement/id/) { get; set; } | 指定された要素の 'id' 属性の値、または 'id' が存在しない場合は空の文字列. |
| [In1](../../aspose.svg.filters/svgfegaussianblurelement/in1/) { get; } | 指定された「feGaussianBlur」要素の属性「in」に対応します。 |
...
| [Result](../../aspose.svg.filters/svgfegaussianblurelement/result/) { get; } | 指定された「フィルター」要素の属性「結果」に対応します。 |
...
| [StdDeviationX](../../aspose.svg.filters/svgfegaussianblurelement/stddeviationx/) { get; } | 与えられた「feGaussianBlur」要素の属性「stdDeviation」に対応します。属性 �stdDeviation�. の X コンポーネントを含みます |
| [StdDeviationY](../../aspose.svg.filters/svgfegaussianblurelement/stddeviationy/) { get; } | 与えられた「feGaussianBlur」要素の属性「stdDeviation」に対応します。属性 �stdDeviation�. の Y コンポーネント (自動的に計算される可能性があります) を含みます |
...
| [Width](../../aspose.svg.filters/svgfegaussianblurelement/width/) { get; } | 指定された「フィルター」要素の属性「幅」に対応します。 |
| [X](../../aspose.svg.filters/svgfegaussianblurelement/x/) { get; } | 指定された「フィルター」要素の属性「x」に対応します。 |
| [Y](../../aspose.svg.filters/svgfegaussianblurelement/y/) { get; } | 指定された「フィルター」要素の属性「y」に対応します。 |
...
| [SetStdDeviation](../../aspose.svg.filters/svgfegaussianblurelement/setstddeviation/)(float, float) | 属性「stdDeviation」の値を設定します。 |
