...
description: "Aspose.Svg.Filters.SVGFEGaussianBlurElement クラス。SVGFEGaussianBlurElement インターフェイスは feGaussianBlur 要素に対応します。"
type: docs
weight: 3880
...
| [Height](../../aspose.svg.filters/svgfegaussianblurelement/height/) { get; } | 指定された �filter� 要素の属性 �height� に対応します。 |
...
| [Result](../../aspose.svg.filters/svgfegaussianblurelement/result/) { get; } | 指定された �filter� 要素の属性 �result� に対応します。 |
| [ShadowRoot](../../aspose.svg.dom/element/shadowroot/) { get; } | この要素に格納されている shadowRoot を返します。閉じている場合は null を返します。 |
| [StdDeviationX](../../aspose.svg.filters/svgfegaussianblurelement/stddeviationx/) { get; } | 指定された �feGaussianBlur� 要素の属性 �stdDeviation� に対応します。属性 �stdDeviation� の X 成分を含みます。 |
| [StdDeviationY](../../aspose.svg.filters/svgfegaussianblurelement/stddeviationy/) { get; } | 指定された �feGaussianBlur� 要素の属性 �stdDeviation� に対応します。属性 �stdDeviation� の Y 成分（自動的に計算される場合があります）を含みます。 |
...
| [Width](../../aspose.svg.filters/svgfegaussianblurelement/width/) { get; } | 指定された �filter� 要素の属性 �width� に対応します。 |
| [X](../../aspose.svg.filters/svgfegaussianblurelement/x/) { get; } | 指定された �filter� 要素の属性 �x� に対応します。 |
| [Y](../../aspose.svg.filters/svgfegaussianblurelement/y/) { get; } | 指定された �filter� 要素の属性 �y� に対応します。 |
