...
description: "Aspose.Svg.Filters.SVGFETileElement クラス。SVGFETileElement インターフェイスは feTile 要素に対応します。"
type: docs
weight: 3970
...
| [Height](../../aspose.svg.filters/svgfetileelement/height/) { get; } | 指定された ‘filter’ 要素の属性 ‘height’ に対応します。 |
...
| [Result](../../aspose.svg.filters/svgfetileelement/result/) { get; } | 指定された ‘filter’ 要素の属性 ‘result’ に対応します。 |
...
| [Width](../../aspose.svg.filters/svgfetileelement/width/) { get; } | 指定された ‘filter’ 要素の属性 ‘width’ に対応します。 |
| [X](../../aspose.svg.filters/svgfetileelement/x/) { get; } | 指定された ‘filter’ 要素の属性 ‘x’ に対応します。 |
| [Y](../../aspose.svg.filters/svgfetileelement/y/) { get; } | 指定された ‘filter’ 要素の属性 ‘y’ に対応します。 |
