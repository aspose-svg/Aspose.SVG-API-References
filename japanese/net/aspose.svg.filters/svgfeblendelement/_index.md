...
description: "Aspose.Svg.Filters.SVGFEBlendElement クラス。SVGFEBlendElement インターフェイスは feBlend 要素に対応します。"
type: docs
weight: 3740
url: /ja/net/aspose.svg.filters/svgfeblendelement/
---
...
| [Height](../../aspose.svg.filters/svgfeblendelement/height/) { get; } | 指定された ‘filter’ 要素の属性 ‘height’ に対応します。 |
| [Id](../../aspose.svg/svgelement/id/) { get; set; } | 指定された要素の ‘id’ 属性の値、または ‘id’ が存在しない場合は空文字列です。 |
| [In1](../../aspose.svg.filters/svgfeblendelement/in1/) { get; } | 指定された ‘feBlend’ 要素の属性 ‘in’ に対応します。 |
| [In2](../../aspose.svg.filters/svgfeblendelement/in2/) { get; } | 指定された ‘feBlend’ 要素の属性 ‘in2’ に対応します。 |
...
| [Mode](../../aspose.svg.filters/svgfeblendelement/mode/) { get; } | 指定された ‘feBlend’ 要素の属性 ‘mode’ に対応します。このインターフェイスで定義された SVG_FEBLEND_MODE_* 定数のいずれかを使用します。 |
...
| [Result](../../aspose.svg.filters/svgfeblendelement/result/) { get; } | 指定された ‘filter’ 要素の属性 ‘result’ に対応します。 |
...
| [Width](../../aspose.svg.filters/svgfeblendelement/width/) { get; } | 指定された ‘filter’ 要素の属性 ‘width’ に対応します。 |
| [X](../../aspose.svg.filters/svgfeblendelement/x/) { get; } | 指定された ‘filter’ 要素の属性 ‘x’ に対応します。 |
| [Y](../../aspose.svg.filters/svgfeblendelement/y/) { get; } | 指定された ‘filter’ 要素の属性 ‘y’ に対応します。 |
...
| 名前 | 説明 |
| --- | --- |
| const [SVG_FEBLEND_MODE_COLOR](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_color/) | 値 'color' に対応します。 |
| const [SVG_FEBLEND_MODE_COLOR_BURN](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_color_burn/) | 値 'color_burn' に対応します。 |
| const [SVG_FEBLEND_MODE_COLOR_DODGE](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_color_dodge/) | 値 'color_dodge' に対応します。 |
| const [SVG_FEBLEND_MODE_DARKEN](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_darken/) | 値 'darken' に対応します。 |
| const [SVG_FEBLEND_MODE_DIFFERENCE](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_difference/) | 値 'difference' に対応します。 |
| const [SVG_FEBLEND_MODE_EXCLUSION](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_exclusion/) | 値 'exclusion' に対応します。 |
| const [SVG_FEBLEND_MODE_HARD_LIGHT](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_hard_light/) | 値 'hard_light' に対応します。 |
| const [SVG_FEBLEND_MODE_HUE](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_hue/) | 値 'hue' に対応します。 |
| const [SVG_FEBLEND_MODE_LIGHTEN](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_lighten/) | 値 'lighten' に対応します。 |
| const [SVG_FEBLEND_MODE_LUMINOSITY](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_luminosity/) | 値 'luminosity' に対応します。 |
| const [SVG_FEBLEND_MODE_MULTIPLY](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_multiply/) | 値 'multiply' に対応します。 |
| const [SVG_FEBLEND_MODE_NORMAL](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_normal/) | 値 'normal' に対応します。 |
| const [SVG_FEBLEND_MODE_OVERLAY](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_overlay/) | 値 'overlay' に対応します。 |
| const [SVG_FEBLEND_MODE_SATURATION](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_saturation/) | 値 'saturation' に対応します。 |
| const [SVG_FEBLEND_MODE_SCREEN](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_screen/) | 値 'screen' に対応します。 |
| const [SVG_FEBLEND_MODE_SOFT_LIGHT](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_soft_light/) | 値 'soft_light' に対応します。 |
| const [SVG_FEBLEND_MODE_UNKNOWN](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_unknown/) | この型は事前定義された型のいずれでもありません。この型の新しい値を定義しようとしたり、既存の値をこの型に切り替えようとしたりすることは無効です。 |
