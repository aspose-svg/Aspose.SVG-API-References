...
description: Aspose.Svg.Filters.SVGFEBlendElement クラス. SVGFEBlendElement インターフェイスはfeBlend要素に対応します
type: docs
weight: 1650
...
| [Height](../../aspose.svg.filters/svgfeblendelement/height/) { get; } | 指定された「フィルター」要素の属性「高さ」に対応します。 |
...
| [Mode](../../aspose.svg.filters/svgfeblendelement/mode/) { get; } | 指定された 'feBlend' 要素の属性 'mode' に対応します。このインターフェイスで定義された SVG_FEBLEND_MODE_* 定数の 1 つを取ります。 |
...
| [Result](../../aspose.svg.filters/svgfeblendelement/result/) { get; } | 指定された「フィルター」要素の属性「結果」に対応します。 |
...
| [Width](../../aspose.svg.filters/svgfeblendelement/width/) { get; } | 指定された「フィルター」要素の属性「幅」に対応します。 |
| [X](../../aspose.svg.filters/svgfeblendelement/x/) { get; } | 指定された「フィルター」要素の属性「x」に対応します。 |
| [Y](../../aspose.svg.filters/svgfeblendelement/y/) { get; } | 指定された「フィルター」要素の属性「y」に対応します。 |
...
| 名前 | 説明 |
| --- | --- |
| const [SVG_FEBLEND_MODE_COLOR](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_color/) | 値「色」に対応します。 |
...
| const [SVG_FEBLEND_MODE_DIFFERENCE](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_difference/) | 値「差」に対応します。 |
| const [SVG_FEBLEND_MODE_EXCLUSION](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_exclusion/) | 値「除外」に対応します。 |
| const [SVG_FEBLEND_MODE_HARD_LIGHT](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_hard_light/) | 値「hard_light」に対応します。 |
| const [SVG_FEBLEND_MODE_HUE](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_hue/) | 値「色相」に対応します。 |
| const [SVG_FEBLEND_MODE_LIGHTEN](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_lighten/) | 値「lighten」に対応します。 |
| const [SVG_FEBLEND_MODE_LUMINOSITY](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_luminosity/) | 値「輝度」に対応します。 |
| const [SVG_FEBLEND_MODE_MULTIPLY](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_multiply/) | 値「乗算」に対応します。 |
| const [SVG_FEBLEND_MODE_NORMAL](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_normal/) | 値「通常」に対応します。 |
| const [SVG_FEBLEND_MODE_OVERLAY](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_overlay/) | 値「overlay」に対応します。 |
| const [SVG_FEBLEND_MODE_SATURATION](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_saturation/) | 値「彩度」に対応します。 |
...
| const [SVG_FEBLEND_MODE_UNKNOWN](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_unknown/) | タイプは定義済みのタイプではありません。この型の新しい値を定義しようとしたり、既存の値をこの型に切り替えようとしたりすることは無効です. |
...
* 名前空間 [Aspose.Svg.Filters](../../aspose.svg.filters/)
* 組み立て [Aspose.SVG](../../)
