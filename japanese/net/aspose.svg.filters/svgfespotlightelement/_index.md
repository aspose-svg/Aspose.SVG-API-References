...
description: Aspose.Svg.Filters.SVGFESpotLightElement クラス. SVGFESpotLightElement インターフェイスはfeSpotLight要素に対応します
type: docs
weight: 1870
url: /ja/net/aspose.svg.filters/svgfespotlightelement/
---
...
| [LimitingConeAngle](../../aspose.svg.filters/svgfespotlightelement/limitingconeangle/) { get; } | 指定された「feSpotLight」要素の属性「limitingConeAngle」に対応します。 |
...
| [PointsAtX](../../aspose.svg.filters/svgfespotlightelement/pointsatx/) { get; } | 指定された「feSpotLight」要素の属性「pointsAtX」に対応します。 |
| [PointsAtY](../../aspose.svg.filters/svgfespotlightelement/pointsaty/) { get; } | 指定された「feSpotLight」要素の属性「pointsAtY」に対応します。 |
| [PointsAtZ](../../aspose.svg.filters/svgfespotlightelement/pointsatz/) { get; } | 指定された「feSpotLight」要素の属性「pointsAtZ」に対応します。 |
...
| [SpecularExponent](../../aspose.svg.filters/svgfespotlightelement/specularexponent/) { get; } | 指定された「feSpotLight」要素の属性「specularExponent」に対応します。 |
...
| [X](../../aspose.svg.filters/svgfespotlightelement/x/) { get; } | 指定された「feSpotLight」要素の属性「x」に対応します。 |
| [Y](../../aspose.svg.filters/svgfespotlightelement/y/) { get; } | 指定された「feSpotLight」要素の属性「y」に対応します。 |
| [Z](../../aspose.svg.filters/svgfespotlightelement/z/) { get; } | 指定された「feSpotLight」要素の属性「z」に対応します。 |
