...
description: "Aspose.Svg.Filters.SVGFEComponentTransferElement クラス。SVGFEComponentTransferElement インターフェイスは feComponentTransfer 要素に対応します。"
type: docs
weight: 3760
...
| [Height](../../aspose.svg.filters/svgfecomponenttransferelement/height/) { get; } | 指定された ‘filter’ 要素の属性 ‘height’ に対応します。 |
...
| [Result](../../aspose.svg.filters/svgfecomponenttransferelement/result/) { get; } | 指定された ‘filter’ 要素の属性 ‘result’ に対応します。 |
...
| [Width](../../aspose.svg.filters/svgfecomponenttransferelement/width/) { get; } | 指定された ‘filter’ 要素の属性 ‘width’ に対応します。 |
| [X](../../aspose.svg.filters/svgfecomponenttransferelement/x/) { get; } | 指定された ‘filter’ 要素の属性 ‘x’ に対応します。 |
| [Y](../../aspose.svg.filters/svgfecomponenttransferelement/y/) { get; } | 指定された ‘filter’ 要素の属性 ‘y’ に対応します。 |
