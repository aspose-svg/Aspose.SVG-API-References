...
description: Aspose.Svg.Filters.SVGFEComponentTransferElement クラス. SVGFEComponentTransferElement インターフェイスはfeComponentTransfer要素に対応します
type: docs
weight: 1670
url: /ja/net/aspose.svg.filters/svgfecomponenttransferelement/
---
...
| [Height](../../aspose.svg.filters/svgfecomponenttransferelement/height/) { get; } | 指定された「フィルター」要素の属性「高さ」に対応します。 |
| [Id](../../aspose.svg/svgelement/id/) { get; set; } | 指定された要素の 'id' 属性の値、または 'id' が存在しない場合は空の文字列. |
| [In1](../../aspose.svg.filters/svgfecomponenttransferelement/in1/) { get; } | 指定された「feComponentTransfer」要素の属性「in」に対応します。 |
...
| [Result](../../aspose.svg.filters/svgfecomponenttransferelement/result/) { get; } | 指定された「フィルター」要素の属性「結果」に対応します。 |
...
| [Width](../../aspose.svg.filters/svgfecomponenttransferelement/width/) { get; } | 指定された「フィルター」要素の属性「幅」に対応します。 |
| [X](../../aspose.svg.filters/svgfecomponenttransferelement/x/) { get; } | 指定された「フィルター」要素の属性「x」に対応します。 |
| [Y](../../aspose.svg.filters/svgfecomponenttransferelement/y/) { get; } | 指定された「フィルター」要素の属性「y」に対応します。 |
