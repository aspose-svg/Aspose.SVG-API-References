...
description: Aspose.Svg.Filters.SVGFEPointLightElement クラス. SVGFEPointLightElement インターフェイスはfePointLight要素に対応します
type: docs
weight: 1850
url: /ja/net/aspose.svg.filters/svgfepointlightelement/
---
...
| [X](../../aspose.svg.filters/svgfepointlightelement/x/) { get; } | 指定された「fePointLight」要素の属性「x」に対応します。 |
| [Y](../../aspose.svg.filters/svgfepointlightelement/y/) { get; } | 指定された「fePointLight」要素の属性「y」に対応します。 |
| [Z](../../aspose.svg.filters/svgfepointlightelement/z/) { get; } | 指定された「fePointLight」要素の属性「z」に対応します。 |
