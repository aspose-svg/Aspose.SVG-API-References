...
description: "Aspose.Svg.Filters.SVGFEImageElement クラス。SVGFEImageElement インターフェイスは feImage 要素に対応します。"
type: docs
weight: 3890
...
| [Height](../../aspose.svg.filters/svgfeimageelement/height/) { get; } | 指定された ‘filter’ 要素の属性 ‘height’ に対応します。 |
...
| [Result](../../aspose.svg.filters/svgfeimageelement/result/) { get; } | 指定された ‘filter’ 要素の属性 ‘result’ に対応します。 |
...
| [Width](../../aspose.svg.filters/svgfeimageelement/width/) { get; } | 指定された ‘filter’ 要素の属性 ‘width’ に対応します。 |
| [X](../../aspose.svg.filters/svgfeimageelement/x/) { get; } | 指定された ‘filter’ 要素の属性 ‘x’ に対応します。 |
| [Y](../../aspose.svg.filters/svgfeimageelement/y/) { get; } | 指定された ‘filter’ 要素の属性 ‘y’ に対応します。 |
