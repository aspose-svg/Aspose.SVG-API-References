...
description: "Aspose.Svg.Filters.SVGFEDropShadowElement クラス。SVGFEDropShadowElement インターフェイスは feDropShadow 要素に対応します"
type: docs
weight: 3820
...
| [Height](../../aspose.svg.filters/svgfedropshadowelement/height/) { get; } | 指定された ‘feDropShadow’ 要素の属性 ‘height’ に対応します。 |
...
| [StdDeviationX](../../aspose.svg.filters/svgfedropshadowelement/stddeviationx/) { get; } | 指定された ‘feDropShadow’ 要素の属性 ‘stdDeviation’ に対応します。属性 ‘stdDeviation’ の X 成分を含みます。 |
| [StdDeviationY](../../aspose.svg.filters/svgfedropshadowelement/stddeviationy/) { get; } | 指定された ‘feDropShadow’ 要素の属性 ‘stdDeviation’ に対応します。属性 ‘stdDeviation’ の Y 成分（自動的に計算される場合があります）を含みます。 |
...
| [Width](../../aspose.svg.filters/svgfedropshadowelement/width/) { get; } | 指定された ‘feDropShadow’ 要素の属性 ‘width’ に対応します。 |
