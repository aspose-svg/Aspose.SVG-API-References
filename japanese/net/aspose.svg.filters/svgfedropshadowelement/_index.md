...
description: Aspose.Svg.Filters.SVGFEDropShadowElement クラス. SVGFEDropShadowElement インターフェイスはfeDropShadow要素に対応します
type: docs
weight: 1730
url: /ja/net/aspose.svg.filters/svgfedropshadowelement/
---
...
| [Dx](../../aspose.svg.filters/svgfedropshadowelement/dx/) { get; } | 指定された「feDropShadow」要素の属性「dx」に対応します。 |
| [Dy](../../aspose.svg.filters/svgfedropshadowelement/dy/) { get; } | 指定された「feDropShadow」要素の属性「dy」に対応します。 |
...
| [Height](../../aspose.svg.filters/svgfedropshadowelement/height/) { get; } | 指定された「feDropShadow」要素の属性「高さ」に対応します。 |
| [Id](../../aspose.svg/svgelement/id/) { get; set; } | 指定された要素の 'id' 属性の値、または 'id' が存在しない場合は空の文字列. |
| [In1](../../aspose.svg.filters/svgfedropshadowelement/in1/) { get; } | 指定された「feDropShadow」要素の属性「in」に対応します。 |
...
| [Result](../../aspose.svg.filters/svgfedropshadowelement/result/) { get; } | 指定された「feDropShadow」要素の属性「result」に対応します。 |
...
| [StdDeviationX](../../aspose.svg.filters/svgfedropshadowelement/stddeviationx/) { get; } | 指定された「feDropShadow」要素の属性「stdDeviation」に対応します。属性 'stdDeviation'. の X コンポーネントを含みます |
| [StdDeviationY](../../aspose.svg.filters/svgfedropshadowelement/stddeviationy/) { get; } | 指定された「feDropShadow」要素の属性「stdDeviation」に対応します。属性 'stdDeviation'. の Y コンポーネント (自動的に計算される可能性があります) を含みます。 |
...
| [Width](../../aspose.svg.filters/svgfedropshadowelement/width/) { get; } | 指定された「feDropShadow」要素の属性「幅」に対応します。 |
| [X](../../aspose.svg.filters/svgfedropshadowelement/x/) { get; } | 指定された「feDropShadow」要素の属性「x」に対応します。 |
| [Y](../../aspose.svg.filters/svgfedropshadowelement/y/) { get; } | 指定された「feDropShadow」要素の属性「y」に対応します。 |
...
| [SetStdDeviation](../../aspose.svg.filters/svgfedropshadowelement/setstddeviation/)(float, float) | 属性「stdDeviation」の値を設定します。 |
