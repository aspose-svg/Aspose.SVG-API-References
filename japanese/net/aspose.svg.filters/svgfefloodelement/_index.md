...
description: Aspose.Svg.Filters.SVGFEFloodElement クラス. SVGFEFloodElement インターフェイスはfeFlood要素に対応します
type: docs
weight: 1740
url: /ja/net/aspose.svg.filters/svgfefloodelement/
---
...
| [Height](../../aspose.svg.filters/svgfefloodelement/height/) { get; } | 指定された「フィルター」要素の属性「高さ」に対応します。 |
...
| [Result](../../aspose.svg.filters/svgfefloodelement/result/) { get; } | 指定された「フィルター」要素の属性「結果」に対応します。 |
...
| [Width](../../aspose.svg.filters/svgfefloodelement/width/) { get; } | 指定された「フィルター」要素の属性「幅」に対応します。 |
| [X](../../aspose.svg.filters/svgfefloodelement/x/) { get; } | 指定された「フィルター」要素の属性「x」に対応します。 |
| [Y](../../aspose.svg.filters/svgfefloodelement/y/) { get; } | 指定された「フィルター」要素の属性「y」に対応します。 |
