...
description: "Aspose.Svg.Filters.SVGFEOffsetElement クラス。SVGFEOffsetElement インターフェイスは feOffset 要素に対応します。"
type: docs
weight: 3930
...
| [Height](../../aspose.svg.filters/svgfeoffsetelement/height/) { get; } | 指定された ‘filter’ 要素の属性 ‘height’ に対応します。 |
...
| [Result](../../aspose.svg.filters/svgfeoffsetelement/result/) { get; } | 指定された ‘filter’ 要素の属性 ‘result’ に対応します。 |
...
| [Width](../../aspose.svg.filters/svgfeoffsetelement/width/) { get; } | 指定された ‘filter’ 要素の属性 ‘width’ に対応します。 |
| [X](../../aspose.svg.filters/svgfeoffsetelement/x/) { get; } | 指定された ‘filter’ 要素の属性 ‘x’ に対応します。 |
| [Y](../../aspose.svg.filters/svgfeoffsetelement/y/) { get; } | 指定された ‘filter’ 要素の属性 ‘y’ に対応します。 |
