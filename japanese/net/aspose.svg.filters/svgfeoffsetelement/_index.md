...
description: Aspose.Svg.Filters.SVGFEOffsetElement クラス. SVGFEOffsetElement インターフェイスはfeOffset要素に対応します
type: docs
weight: 1840
url: /ja/net/aspose.svg.filters/svgfeoffsetelement/
---
...
| [Dx](../../aspose.svg.filters/svgfeoffsetelement/dx/) { get; } | 指定された「feOffset」要素の属性「dx」に対応します。 |
| [Dy](../../aspose.svg.filters/svgfeoffsetelement/dy/) { get; } | 指定された「feOffset」要素の属性「dy」に対応します。 |
...
| [Height](../../aspose.svg.filters/svgfeoffsetelement/height/) { get; } | 指定された「フィルター」要素の属性「高さ」に対応します。 |
| [Id](../../aspose.svg/svgelement/id/) { get; set; } | 指定された要素の 'id' 属性の値、または 'id' が存在しない場合は空の文字列. |
| [In1](../../aspose.svg.filters/svgfeoffsetelement/in1/) { get; } | 指定された「feOffset」要素の属性「in」に対応します。 |
...
| [Result](../../aspose.svg.filters/svgfeoffsetelement/result/) { get; } | 指定された「フィルター」要素の属性「結果」に対応します。 |
...
| [Width](../../aspose.svg.filters/svgfeoffsetelement/width/) { get; } | 指定された「フィルター」要素の属性「幅」に対応します。 |
| [X](../../aspose.svg.filters/svgfeoffsetelement/x/) { get; } | 指定された「フィルター」要素の属性「x」に対応します。 |
| [Y](../../aspose.svg.filters/svgfeoffsetelement/y/) { get; } | 指定された「フィルター」要素の属性「y」に対応します。 |
