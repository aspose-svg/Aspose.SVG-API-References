...
description: "Aspose.Svg.Filters.SVGFEDiffuseLightingElement クラス。SVGFEDiffuseLightingElement インターフェイスは feDiffuseLighting 要素に対応します。"
type: docs
weight: 3790
...
| [Height](../../aspose.svg.filters/svgfediffuselightingelement/height/) { get; } | 指定された ‘filter’ 要素の属性 ‘height’ に対応します。 |
...
| [Result](../../aspose.svg.filters/svgfediffuselightingelement/result/) { get; } | 指定された ‘filter’ 要素の属性 ‘result’ に対応します。 |
...
| [Width](../../aspose.svg.filters/svgfediffuselightingelement/width/) { get; } | 指定された ‘filter’ 要素の属性 ‘width’ に対応します。 |
| [X](../../aspose.svg.filters/svgfediffuselightingelement/x/) { get; } | 指定された ‘filter’ 要素の属性 ‘x’ に対応します。 |
| [Y](../../aspose.svg.filters/svgfediffuselightingelement/y/) { get; } | 指定された ‘filter’ 要素の属性 ‘y’ に対応します。 |
