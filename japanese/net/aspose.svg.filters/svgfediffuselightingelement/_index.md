...
description: Aspose.Svg.Filters.SVGFEDiffuseLightingElement クラス. SVGFEDiffuseLightingElement インターフェイスはfeDiffuseLighting要素に対応します
type: docs
weight: 1700
url: /ja/net/aspose.svg.filters/svgfediffuselightingelement/
---
...
| [DiffuseConstant](../../aspose.svg.filters/svgfediffuselightingelement/diffuseconstant/) { get; } | 指定された「feDiffuseLighting」要素の属性「diffuseConstant」に対応します。 |
...
| [Height](../../aspose.svg.filters/svgfediffuselightingelement/height/) { get; } | 指定された「フィルター」要素の属性「高さ」に対応します。 |
| [Id](../../aspose.svg/svgelement/id/) { get; set; } | 指定された要素の 'id' 属性の値、または 'id' が存在しない場合は空の文字列. |
| [In1](../../aspose.svg.filters/svgfediffuselightingelement/in1/) { get; } | 指定された「feDiffuseLighting」要素の属性「in」に対応します。 |
...
| [KernelUnitLengthX](../../aspose.svg.filters/svgfediffuselightingelement/kernelunitlengthx/) { get; } | 指定された「feDiffuseLighting」要素の属性「kernelUnitLength」に対応します。 |
| [KernelUnitLengthY](../../aspose.svg.filters/svgfediffuselightingelement/kernelunitlengthy/) { get; } | 指定された「feDiffuseLighting」要素の属性「kernelUnitLength」に対応します。 |
...
| [Result](../../aspose.svg.filters/svgfediffuselightingelement/result/) { get; } | 指定された「フィルター」要素の属性「結果」に対応します。 |
...
| [SurfaceScale](../../aspose.svg.filters/svgfediffuselightingelement/surfacescale/) { get; } | 指定された「feDiffuseLighting」要素の属性「surfaceScale」に対応します。 |
...
| [Width](../../aspose.svg.filters/svgfediffuselightingelement/width/) { get; } | 指定された「フィルター」要素の属性「幅」に対応します。 |
| [X](../../aspose.svg.filters/svgfediffuselightingelement/x/) { get; } | 指定された「フィルター」要素の属性「x」に対応します。 |
| [Y](../../aspose.svg.filters/svgfediffuselightingelement/y/) { get; } | 指定された「フィルター」要素の属性「y」に対応します。 |
