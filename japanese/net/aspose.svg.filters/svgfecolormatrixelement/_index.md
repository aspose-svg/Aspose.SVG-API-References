...
description: Aspose.Svg.Filters.SVGFEColorMatrixElement クラス. SVGFEColorMatrixElement インターフェイスはfeColorMatrix要素に対応します
type: docs
weight: 1660
url: /ja/net/aspose.svg.filters/svgfecolormatrixelement/
---
...
| [Height](../../aspose.svg.filters/svgfecolormatrixelement/height/) { get; } | 指定された「フィルター」要素の属性「高さ」に対応します。 |
| [Id](../../aspose.svg/svgelement/id/) { get; set; } | 指定された要素の 'id' 属性の値、または 'id' が存在しない場合は空の文字列. |
| [In1](../../aspose.svg.filters/svgfecolormatrixelement/in1/) { get; } | 指定された「feColorMatrix」要素の属性「in」に対応します。 |
...
| [Result](../../aspose.svg.filters/svgfecolormatrixelement/result/) { get; } | 指定された「フィルター」要素の属性「結果」に対応します。 |
...
| [Type](../../aspose.svg.filters/svgfecolormatrixelement/type/) { get; } | 指定された 'feColorMatrix' 要素の属性 'type' に対応します。このインターフェイスで定義されている SVG_FECOLORMATRIX_TYPE_* 定数の 1 つを取ります。 |
| [Values](../../aspose.svg.filters/svgfecolormatrixelement/values/) { get; } | 指定された「feColorMatrix」要素の属性「値」に対応します。 |
...
| [Width](../../aspose.svg.filters/svgfecolormatrixelement/width/) { get; } | 指定された「フィルター」要素の属性「幅」に対応します。 |
| [X](../../aspose.svg.filters/svgfecolormatrixelement/x/) { get; } | 指定された「フィルター」要素の属性「x」に対応します。 |
| [Y](../../aspose.svg.filters/svgfecolormatrixelement/y/) { get; } | 指定された「フィルター」要素の属性「y」に対応します。 |
...
| 名前 | 説明 |
| --- | --- |
| const [SVG_FECOLORMATRIX_TYPE_HUEROTATE](../../aspose.svg.filters/svgfecolormatrixelement/svg_fecolormatrix_type_huerotate/) | 値「hueRotate」に対応します。 |
| const [SVG_FECOLORMATRIX_TYPE_LUMINANCETOALPHA](../../aspose.svg.filters/svgfecolormatrixelement/svg_fecolormatrix_type_luminancetoalpha/) | 値「luminanceToAlpha」に対応します。 |
| const [SVG_FECOLORMATRIX_TYPE_MATRIX](../../aspose.svg.filters/svgfecolormatrixelement/svg_fecolormatrix_type_matrix/) | 値「マトリックス」に対応します。 |
| const [SVG_FECOLORMATRIX_TYPE_SATURATE](../../aspose.svg.filters/svgfecolormatrixelement/svg_fecolormatrix_type_saturate/) | 値「saturate」に対応します。 |
| const [SVG_FECOLORMATRIX_TYPE_UNKNOWN](../../aspose.svg.filters/svgfecolormatrixelement/svg_fecolormatrix_type_unknown/) | タイプは定義済みのタイプではありません。この型の新しい値を定義しようとしたり、既存の値をこの型に切り替えようとしたりすることは無効です. |
