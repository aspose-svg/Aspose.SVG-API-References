...
description: "Aspose.Svg.Filters.SVGFEConvolveMatrixElement クラス。この SVGFEConvolveMatrixElement インターフェイスは feConvolveMatrix 要素に対応します"
type: docs
weight: 3780
...
| [Bias](../../aspose.svg.filters/svgfeconvolvematrixelement/bias/) { get; } | 指定された ‘feConvolveMatrix’ 要素の ‘bias’ 属性に対応します。 |
...
| [Divisor](../../aspose.svg.filters/svgfeconvolvematrixelement/divisor/) { get; } | 指定された ‘feConvolveMatrix’ 要素の ‘divisor’ 属性に対応します。 |
| [EdgeMode](../../aspose.svg.filters/svgfeconvolvematrixelement/edgemode/) { get; } | 指定された ‘feConvolveMatrix’ 要素の ‘edgeMode’ 属性に対応します。 |
...
| [Height](../../aspose.svg.filters/svgfeconvolvematrixelement/height/) { get; } | 指定された ‘filter’ 要素の属性 ‘height’ に対応します。 |
| [Id](../../aspose.svg/svgelement/id/) { get; set; } | 指定された要素の ‘id’ 属性の値、または ‘id’ が存在しない場合は空文字列です。 |
| [In1](../../aspose.svg.filters/svgfeconvolvematrixelement/in1/) { get; } | 指定された ‘feConvolveMatrix’ 要素の ‘in’ 属性に対応します。 |
...
| [KernelMatrix](../../aspose.svg.filters/svgfeconvolvematrixelement/kernelmatrix/) { get; } | 指定された ‘feConvolveMatrix’ 要素の ‘kernelMatrix’ 属性に対応します。 |
| [KernelUnitLengthX](../../aspose.svg.filters/svgfeconvolvematrixelement/kernelunitlengthx/) { get; } | 指定された ‘feConvolveMatrix’ 要素の ‘kernelUnitLength’ 属性に対応します。 |
| [KernelUnitLengthY](../../aspose.svg.filters/svgfeconvolvematrixelement/kernelunitlengthy/) { get; } | 指定された ‘feConvolveMatrix’ 要素の ‘kernelUnitLength’ 属性に対応します。 |
...
| [OrderX](../../aspose.svg.filters/svgfeconvolvematrixelement/orderx/) { get; } | 指定された ‘feConvolveMatrix’ 要素の ‘order’ 属性に対応します。 |
| [OrderY](../../aspose.svg.filters/svgfeconvolvematrixelement/ordery/) { get; } | 指定された ‘feConvolveMatrix’ 要素の ‘order’ 属性に対応します。 |
...
| [PreserveAlpha](../../aspose.svg.filters/svgfeconvolvematrixelement/preservealpha/) { get; } | 指定された ‘feConvolveMatrix’ 要素の ‘preserveAlpha’ 属性に対応します。 |
...
| [Result](../../aspose.svg.filters/svgfeconvolvematrixelement/result/) { get; } | 指定された ‘filter’ 要素の属性 ‘result’ に対応します。 |
...
| [TargetX](../../aspose.svg.filters/svgfeconvolvematrixelement/targetx/) { get; } | 指定された ‘feConvolveMatrix’ 要素の ‘targetX’ 属性に対応します。 |
| [TargetY](../../aspose.svg.filters/svgfeconvolvematrixelement/targety/) { get; } | 指定された ‘feConvolveMatrix’ 要素の ‘targetY’ 属性に対応します。 |
...
| [Width](../../aspose.svg.filters/svgfeconvolvematrixelement/width/) { get; } | 指定された ‘filter’ 要素の属性 ‘width’ に対応します。 |
| [X](../../aspose.svg.filters/svgfeconvolvematrixelement/x/) { get; } | 指定された ‘filter’ 要素の属性 ‘x’ に対応します。 |
| [Y](../../aspose.svg.filters/svgfeconvolvematrixelement/y/) { get; } | 指定された ‘filter’ 要素の属性 ‘y’ に対応します。 |
...
| 名前 | 説明 |
| --- | --- |
| const [SVG_EDGEMODE_DUPLICATE](../../aspose.svg.filters/svgfeconvolvematrixelement/svg_edgemode_duplicate/) | 値 'duplicate' に対応します。 |
| const [SVG_EDGEMODE_NONE](../../aspose.svg.filters/svgfeconvolvematrixelement/svg_edgemode_none/) | 値 'none' に対応します。 |
| const [SVG_EDGEMODE_UNKNOWN](../../aspose.svg.filters/svgfeconvolvematrixelement/svg_edgemode_unknown/) | この型は事前定義された型のいずれでもありません。この型の新しい値を定義しようとしたり、既存の値をこの型に切り替えようとしたりすることは無効です。 |
