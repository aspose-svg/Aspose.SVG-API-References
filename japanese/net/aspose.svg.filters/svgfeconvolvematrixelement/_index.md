...
description: Aspose.Svg.Filters.SVGFEConvolveMatrixElement クラス. SVGFEConvolveMatrixElement インターフェイスはfeConvolveMatrix要素に対応します
type: docs
weight: 1690
url: /ja/net/aspose.svg.filters/svgfeconvolvematrixelement/
---
...
| [Bias](../../aspose.svg.filters/svgfeconvolvematrixelement/bias/) { get; } | 指定された 'feConvolveMatrix' 要素の属性 'bias' に対応します。 |
...
| [Divisor](../../aspose.svg.filters/svgfeconvolvematrixelement/divisor/) { get; } | 指定された「feConvolveMatrix」要素の属性「除数」に対応します。 |
| [EdgeMode](../../aspose.svg.filters/svgfeconvolvematrixelement/edgemode/) { get; } | 指定された「feConvolveMatrix」要素の属性「edgeMode」に対応します。 |
...
| [Height](../../aspose.svg.filters/svgfeconvolvematrixelement/height/) { get; } | 指定された「フィルター」要素の属性「高さ」に対応します。 |
| [Id](../../aspose.svg/svgelement/id/) { get; set; } | 指定された要素の 'id' 属性の値、または 'id' が存在しない場合は空の文字列. |
| [In1](../../aspose.svg.filters/svgfeconvolvematrixelement/in1/) { get; } | 指定された「feConvolveMatrix」要素の属性「in」に対応します。 |
...
| [KernelMatrix](../../aspose.svg.filters/svgfeconvolvematrixelement/kernelmatrix/) { get; } | 指定された「feConvolveMatrix」要素の属性「kernelMatrix」に対応します。 |
| [KernelUnitLengthX](../../aspose.svg.filters/svgfeconvolvematrixelement/kernelunitlengthx/) { get; } | 指定された「feConvolveMatrix」要素の属性「kernelUnitLength」に対応します。 |
| [KernelUnitLengthY](../../aspose.svg.filters/svgfeconvolvematrixelement/kernelunitlengthy/) { get; } | 指定された「feConvolveMatrix」要素の属性「kernelUnitLength」に対応します。 |
...
| [OrderX](../../aspose.svg.filters/svgfeconvolvematrixelement/orderx/) { get; } | 指定された「feConvolveMatrix」要素の属性「order」に対応します。 |
| [OrderY](../../aspose.svg.filters/svgfeconvolvematrixelement/ordery/) { get; } | 指定された「feConvolveMatrix」要素の属性「order」に対応します。 |
...
| [PreserveAlpha](../../aspose.svg.filters/svgfeconvolvematrixelement/preservealpha/) { get; } | 指定された「feConvolveMatrix」要素の属性「preserveAlpha」に対応します。 |
...
| [Result](../../aspose.svg.filters/svgfeconvolvematrixelement/result/) { get; } | 指定された「フィルター」要素の属性「結果」に対応します。 |
...
| [TargetX](../../aspose.svg.filters/svgfeconvolvematrixelement/targetx/) { get; } | 指定された「feConvolveMatrix」要素の属性「targetX」に対応します。 |
| [TargetY](../../aspose.svg.filters/svgfeconvolvematrixelement/targety/) { get; } | 指定された「feConvolveMatrix」要素の属性「targetY」に対応します。 |
...
| [Width](../../aspose.svg.filters/svgfeconvolvematrixelement/width/) { get; } | 指定された「フィルター」要素の属性「幅」に対応します。 |
| [X](../../aspose.svg.filters/svgfeconvolvematrixelement/x/) { get; } | 指定された「フィルター」要素の属性「x」に対応します。 |
| [Y](../../aspose.svg.filters/svgfeconvolvematrixelement/y/) { get; } | 指定された「フィルター」要素の属性「y」に対応します。 |
...
| 名前 | 説明 |
| --- | --- |
| const [SVG_EDGEMODE_DUPLICATE](../../aspose.svg.filters/svgfeconvolvematrixelement/svg_edgemode_duplicate/) | 値「重複」に対応します。 |
| const [SVG_EDGEMODE_NONE](../../aspose.svg.filters/svgfeconvolvematrixelement/svg_edgemode_none/) | 値「なし」に対応します。 |
| const [SVG_EDGEMODE_UNKNOWN](../../aspose.svg.filters/svgfeconvolvematrixelement/svg_edgemode_unknown/) | タイプは定義済みのタイプではありません。この型の新しい値を定義しようとしたり、既存の値をこの型に切り替えようとしたりすることは無効です. |
| const [SVG_EDGEMODE_WRAP](../../aspose.svg.filters/svgfeconvolvematrixelement/svg_edgemode_wrap/) | 値「wrap」に対応します。 |
