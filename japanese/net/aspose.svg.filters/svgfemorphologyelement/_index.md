...
description: Aspose.Svg.Filters.SVGFEMorphologyElement クラス. SVGFEMorphologyElement インターフェイスはfeMorphology要素に対応します
type: docs
weight: 1830
url: /ja/net/aspose.svg.filters/svgfemorphologyelement/
---
...
| [Height](../../aspose.svg.filters/svgfemorphologyelement/height/) { get; } | 指定された「フィルター」要素の属性「高さ」に対応します。 |
| [Id](../../aspose.svg/svgelement/id/) { get; set; } | 指定された要素の 'id' 属性の値、または 'id' が存在しない場合は空の文字列. |
| [In1](../../aspose.svg.filters/svgfemorphologyelement/in1/) { get; } | 指定された「feMorphology」要素の属性「in」に対応します。 |
...
| [Operator](../../aspose.svg.filters/svgfemorphologyelement/operator/) { get; } | 指定された「feMorphology」要素の属性「operator」に対応します。このインターフェイスで定義された SVG_MORPHOLOGY_OPERATOR_* 定数の 1 つを取ります。 |
...
| [RadiusX](../../aspose.svg.filters/svgfemorphologyelement/radiusx/) { get; } | 指定された「feMorphology」要素の属性「radius」に対応します。 |
| [RadiusY](../../aspose.svg.filters/svgfemorphologyelement/radiusy/) { get; } | 指定された「feMorphology」要素の属性「radius」に対応します。 |
| [Result](../../aspose.svg.filters/svgfemorphologyelement/result/) { get; } | 指定された「フィルター」要素の属性「結果」に対応します。 |
...
| [Width](../../aspose.svg.filters/svgfemorphologyelement/width/) { get; } | 指定された「フィルター」要素の属性「幅」に対応します。 |
| [X](../../aspose.svg.filters/svgfemorphologyelement/x/) { get; } | 指定された「フィルター」要素の属性「x」に対応します。 |
| [Y](../../aspose.svg.filters/svgfemorphologyelement/y/) { get; } | 指定された「フィルター」要素の属性「y」に対応します。 |
...
| 名前 | 説明 |
| --- | --- |
| const [SVG_MORPHOLOGY_OPERATOR_DILATE](../../aspose.svg.filters/svgfemorphologyelement/svg_morphology_operator_dilate/) | 値「拡張」に対応します。 |
| const [SVG_MORPHOLOGY_OPERATOR_ERODE](../../aspose.svg.filters/svgfemorphologyelement/svg_morphology_operator_erode/) | 値「erode」に対応します。 |
| const [SVG_MORPHOLOGY_OPERATOR_UNKNOWN](../../aspose.svg.filters/svgfemorphologyelement/svg_morphology_operator_unknown/) | タイプは定義済みのタイプではありません。この型の新しい値を定義しようとしたり、既存の値をこの型に切り替えようとしたりすることは無効です. |
