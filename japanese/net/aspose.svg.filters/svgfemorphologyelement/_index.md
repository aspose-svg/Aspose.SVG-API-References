...
description: "Aspose.Svg.Filters.SVGFEMorphologyElement クラス。SVGFEMorphologyElement インターフェイスは feMorphology 要素に対応します。"
type: docs
weight: 3920
...
| [Height](../../aspose.svg.filters/svgfemorphologyelement/height/) { get; } | 指定された ‘filter’ 要素の属性 ‘height’ に対応します。 |
...
| [Operator](../../aspose.svg.filters/svgfemorphologyelement/operator/) { get; } | 指定された ‘feMorphology’ 要素の属性 ‘operator’ に対応します。この属性はこのインターフェイスで定義された SVG_MORPHOLOGY_OPERATOR_* 定数のいずれかを取ります。 |
...
| [Result](../../aspose.svg.filters/svgfemorphologyelement/result/) { get; } | 指定された ‘filter’ 要素の属性 ‘result’ に対応します。 |
...
| [Width](../../aspose.svg.filters/svgfemorphologyelement/width/) { get; } | 指定された ‘filter’ 要素の属性 ‘width’ に対応します。 |
| [X](../../aspose.svg.filters/svgfemorphologyelement/x/) { get; } | 指定された ‘filter’ 要素の属性 ‘x’ に対応します。 |
| [Y](../../aspose.svg.filters/svgfemorphologyelement/y/) { get; } | 指定された ‘filter’ 要素の属性 ‘y’ に対応します。 |
...
| 名前 | 説明 |
| --- | --- |
| const [SVG_MORPHOLOGY_OPERATOR_DILATE](../../aspose.svg.filters/svgfemorphologyelement/svg_morphology_operator_dilate/) | 値 'dilate' に対応します。 |
...
| const [SVG_MORPHOLOGY_OPERATOR_UNKNOWN](../../aspose.svg.filters/svgfemorphologyelement/svg_morphology_operator_unknown/) | この型は事前定義された型のいずれでもありません。この型の新しい値を定義しようとしたり、既存の値をこの型に切り替えようとしたりすることは無効です。 |
