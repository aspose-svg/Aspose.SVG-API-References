...
description: Aspose.Svg.Filters.SVGFEMergeElement クラス. SVGFEMergeElement インターフェイスはfeMerge要素に対応します
type: docs
weight: 1810
url: /ja/net/aspose.svg.filters/svgfemergeelement/
---
...
| [Height](../../aspose.svg.filters/svgfemergeelement/height/) { get; } | 指定された「フィルター」要素の属性「高さ」に対応します。 |
...
| [Result](../../aspose.svg.filters/svgfemergeelement/result/) { get; } | 指定された「フィルター」要素の属性「結果」に対応します。 |
...
| [Width](../../aspose.svg.filters/svgfemergeelement/width/) { get; } | 指定された「フィルター」要素の属性「幅」に対応します。 |
| [X](../../aspose.svg.filters/svgfemergeelement/x/) { get; } | 指定された「フィルター」要素の属性「x」に対応します。 |
| [Y](../../aspose.svg.filters/svgfemergeelement/y/) { get; } | 指定された「フィルター」要素の属性「y」に対応します。 |
