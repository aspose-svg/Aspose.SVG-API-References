...
description: Aspose.Svg.Rendering.Xps.XpsDeviceXpsGraphicContext クラス. XpsDevice の現在のグラフィック コントロール パラメータを保持します これらのパラメータはグラフィック オペレータが実行されるグローバル フレームワークを定義します
type: docs
weight: 3060
...
| 名前 | 説明 |
| --- | --- |
| override [Clone](../../aspose.svg.rendering.xps/xpsgraphiccontext/clone/)() | 既存のインスタンスと同じプロパティ値を持つ XpsGraphicContext クラスの新しいインスタンスを作成します。 |
