...
description: "Aspose.Svg.Rendering.Image.ImageDeviceImageGraphicContext クラス。ImageDevice の現在のグラフィック制御パラメータを保持します。これらのパラメータは、グラフィック演算子が実行されるグローバルフレームワークを定義します。"
type: docs
weight: 4920
...
| 名前 | 説明 |
| --- | --- |
| [ImageGraphicContext](../../aspose.svg.rendering.image/imagedevice.imagegraphiccontext/.ctor)() | デフォルトコンストラクタです。 |
