...
description: Aspose.Svg.DataTypes.SVGAnimatedAngle クラス. アニメーション化できる角度の基本データ型の属性に使用されます.
type: docs
weight: 90
url: /ja/net/aspose.svg.datatypes/svganimatedangle/
---
## SVGAnimatedAngle class

アニメーション化できる角度の基本データ型の属性に使用されます.
...
| override [ToString](../../aspose.svg.datatypes/svganimatedangle/tostring/)() | を返しますStringこのインスタンスを表す. |
