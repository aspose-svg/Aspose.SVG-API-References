...
description: Aspose.Svg.DataTypes.SVGAnimatedInteger クラス. アニメートできる基本型整数の属性に使用されます
type: docs
weight: 120
url: /ja/net/aspose.svg.datatypes/svganimatedinteger/
---
...
| override [ToString](../../aspose.svg.datatypes/svganimatedinteger/tostring/)() | を返しますStringこのインスタンスを表す. |
