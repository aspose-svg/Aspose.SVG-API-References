...
description: Aspose.Svg.DataTypes.SVGAnimatedString クラス. アニメーション化できる DOMString 型の属性に使用されます
type: docs
weight: 190
url: /ja/net/aspose.svg.datatypes/svganimatedstring/
---
## SVGAnimatedString class

アニメーション化できる DOMString 型の属性に使用されます。
...
| override [ToString](../../aspose.svg.datatypes/svganimatedstring/tostring/)() | を返しますStringこのインスタンスを表す. |
