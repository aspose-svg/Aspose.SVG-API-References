...
description: Aspose.Svg.Dom.Events.CustomEvent कक्ष. कस्टमइवेंट इंटरफ़ेस क उपयग करने वले ईवेंट क उपयग कस्टम डेट ले जने के लए कय ज सकत है.
type: docs
weight: 880
url: /hi/net/aspose.svg.dom.events/customevent/
---
## CustomEvent class
...
| [Detail](../../aspose.svg.dom.events/customevent/detail/) { get; } | कस्टम डेटा प्राप्त करता है। |
...
| [InitCustomEvent](../../aspose.svg.dom.events/customevent/initcustomevent/)(string, bool, bool, object) | /// द[`InitEvent`](../event/initevent/) विधि का उपयोग किसी के मान को प्रारंभ करने के लिए किया जाता है[`Event`](../event/) के माध्यम से बनाया गया है[`IDocumentEvent`](../idocumentevent/) इंटरफ़ेस. |
