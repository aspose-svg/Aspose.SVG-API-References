...
description: "SVGBuilderExtensions AddScript method. बिल्डर में एक script एलिमेंट कॉन्फ़िगरेशन जोड़ता है।"
type: docs
weight: 460
url: /hi/net/aspose.svg.builder/svgbuilderextensions/addscript/
---
## SVGBuilderExtensions.AddScript<TBuilder> method

बिल्डर में 'script' तत्व कॉन्फ़िगरेशन जोड़ता है।
...
| कॉन्फ़िगर करें | 'script' एलिमेंट के लिए कॉन्फ़िगरेशन एक्शन। |
