...
description: Aspose.Svg.Paths.SVGPathSegLinetoHorizontalAbs कक्ष. SVGPathSegLinetoHorizontalAbs इंटरफ़ेस एक पूर्ण क्षैतज रेख H पथ डेट कमंड से मेल खत है
type: docs
weight: 2620
url: /hi/net/aspose.svg.paths/svgpathseglinetohorizontalabs/
---
## SVGPathSegLinetoHorizontalAbs class

SVGPathSegLinetoHorizontalAbs इंटरफ़ेस एक "पूर्ण क्षैतिज रेखा" (H) पथ डेटा कमांड से मेल खाता है।
...
| [X](../../aspose.svg.paths/svgpathseglinetohorizontalabs/x/) { get; set; } | इस पथ खंड के अंतिम बिंदु के लिए निरपेक्ष X निर्देशांक. |
