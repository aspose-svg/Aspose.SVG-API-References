...
description: Aspose.Svg.Paths.SVGPathSegMovetoAbs कक्ष. SVGPathSegMovetoAbs इंटरफ़ेस एक एब्सल्यूट मूव टू M पथ डेट कमंड से मेल खत है
type: docs
weight: 2680
url: /hi/net/aspose.svg.paths/svgpathsegmovetoabs/
---
## SVGPathSegMovetoAbs class

SVGPathSegMovetoAbs इंटरफ़ेस एक "एब्सोल्यूट मूव टू" (M) पाथ डेटा कमांड से मेल खाता है।
...
| [X](../../aspose.svg.paths/svgpathsegmovetoabs/x/) { get; set; } | इस पथ खंड के अंतिम बिंदु के लिए निरपेक्ष X निर्देशांक. |
| [Y](../../aspose.svg.paths/svgpathsegmovetoabs/y/) { get; set; } | इस पथ खंड के अंत बिंदु के लिए पूर्ण Y निर्देशांक। |
