...
description: Aspose.Svg.Paths.SVGPathSegCurvetoQuadraticSmoothAbs कक्ष. SVGPathSegCurvetoQuadraticSmoothAbs इंटरफ़ेस एक एब्सल्यूट स्मूथ क्यूबक कर्वेट T पथ डेट कमंड से मेल खत है
type: docs
weight: 2590
url: /hi/net/aspose.svg.paths/svgpathsegcurvetoquadraticsmoothabs/
---
...
| [X](../../aspose.svg.paths/svgpathsegcurvetoquadraticsmoothabs/x/) { get; set; } | इस पथ खंड के अंतिम बिंदु के लिए निरपेक्ष X निर्देशांक. |
| [Y](../../aspose.svg.paths/svgpathsegcurvetoquadraticsmoothabs/y/) { get; set; } | इस पथ खंड के अंत बिंदु के लिए पूर्ण Y निर्देशांक। |
