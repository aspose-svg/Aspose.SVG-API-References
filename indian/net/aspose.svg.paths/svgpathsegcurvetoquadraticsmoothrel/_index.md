...
description: Aspose.Svg.Paths.SVGPathSegCurvetoQuadraticSmoothRel कक्ष. SVGPathSegCurvetoQuadraticSmoothRel इंटरफ़ेस एक रलेटव स्मूथ क्यूबक कर्वेट t पथ डेट कमंड से मेल खत है
type: docs
weight: 2600
url: /hi/net/aspose.svg.paths/svgpathsegcurvetoquadraticsmoothrel/
---
...
| [X](../../aspose.svg.paths/svgpathsegcurvetoquadraticsmoothrel/x/) { get; set; } | सापेक्ष एक्स इस पथ खंड के अंत बिंदु के लिए समन्वय करता है। |
| [Y](../../aspose.svg.paths/svgpathsegcurvetoquadraticsmoothrel/y/) { get; set; } | इस पथ खंड के अंत बिंदु के लिए सापेक्ष Y समन्वय करता है। |
