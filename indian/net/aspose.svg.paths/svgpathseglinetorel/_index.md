...
description: Aspose.Svg.Paths.SVGPathSegLinetoRel कक्ष. SVGPathSegLinetoRel इंटरफ़ेस एक रश्तेदर लनेट l पथ डेट कमंड से मेल खत है
type: docs
weight: 2640
url: /hi/net/aspose.svg.paths/svgpathseglinetorel/
---
## SVGPathSegLinetoRel class

SVGPathSegLinetoRel इंटरफ़ेस एक "रिश्तेदार लिनेटो" (l) पाथ डेटा कमांड से मेल खाता है।
...
| [X](../../aspose.svg.paths/svgpathseglinetorel/x/) { get; set; } | सापेक्ष एक्स इस पथ खंड के अंत बिंदु के लिए समन्वय करता है। |
| [Y](../../aspose.svg.paths/svgpathseglinetorel/y/) { get; set; } | इस पथ खंड के अंत बिंदु के लिए सापेक्ष Y समन्वय करता है। |
