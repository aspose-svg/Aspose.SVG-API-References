...
description: "ResourceHandler HandleResource method. यह मेथड संसाधन को संभालने के लिए जिम्मेदार है। इसमें आप Resource को स्ट्रीम में सहेज सकते हैं या इसे पैरेंट रिसोर्स में एम्बेड कर सकते हैं।"
type: docs
weight: 10
url: /hi/net/aspose.svg.saving.resourcehandlers/resourcehandler/handleresource/
---
## ResourceHandler.HandleResource method

यह मेथड संसाधन को संभालने के लिए जिम्मेदार है। इसमें आप [`Resource`](../../../aspose.svg.saving/resource/) को स्ट्रीम में सहेज सकते हैं या इसे पैरेंट रिसोर्स में एम्बेड कर सकते हैं।
