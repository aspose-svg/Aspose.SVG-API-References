...
description: Aspose.Svg.Dom.CharacterData कक्ष. कैरेक्टरडट डओएम में कैरेक्टर डेट तक पहुंचने के लए वशेषतओं और वधयं के एक सेट के सथ नड क वस्तर करत है
type: docs
weight: 450
url: /hi/net/aspose.svg.dom/characterdata/
---
## CharacterData class
