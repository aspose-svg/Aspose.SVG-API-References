...
description: Aspose.Svg.Dom.Comment कक्ष. कैरेक्टरडेट से वरसत में मलत है और एक टप्पण क समग्र क प्रतनधत्व करत है यन शुरुआत के बच के सभ वर्ण .
type: docs
weight: 460
url: /hi/net/aspose.svg.dom/comment/
---
## Comment class
...
| override [NodeName](../../aspose.svg.dom/comment/nodename/) { get; } | इस नोड का नाम, इसके प्रकार पर निर्भर करता है। |
| override [NodeType](../../aspose.svg.dom/comment/nodetype/) { get; } | अंतर्निहित वस्तु के प्रकार का प्रतिनिधित्व करने वाला एक कोड। |
| override [NodeValue](../../aspose.svg.dom/comment/nodevalue/) { get; set; } | इस नोड का मान, इसके प्रकार पर निर्भर करता है। |
