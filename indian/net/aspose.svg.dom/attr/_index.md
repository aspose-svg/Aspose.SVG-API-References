...
description: Aspose.Svg.Dom.Attr कक्ष. Attr इंटरफ़ेस एलमेंट ऑब्जेक्ट में एक वशेषत क प्रतनधत्व करत है आमतर पर वशेषत के लए स्वकर्य मन दस्तवेज़ से जुड़े स्कम में परभषत कए जते हैं
type: docs
weight: 350
url: /hi/net/aspose.svg.dom/attr/
---
## Attr class
...
| [IsId](../../aspose.svg.dom/attr/isid/) { get; } | रिटर्न करता है कि क्या यह विशेषता टाइप आईडी के लिए जानी जाती है (अर्थात इसके मालिक तत्व के लिए एक पहचानकर्ता शामिल है) या नहीं। |
| [LastChild](../../aspose.svg.dom/node/lastchild/) { get; } | इस नोड का अंतिम बच्चा। यदि ऐसा कोई नोड नहीं है, तो यह शून्य वापस आ जाता है। |
| override [LocalName](../../aspose.svg.dom/attr/localname/) { get; } | इस नोड के योग्य नाम का स्थानीय भाग लौटाता है। ELEMENT_NODE और ATTRIBUTE_NODE के अलावा किसी भी प्रकार के नोड्स और DOM स्तर 1 विधि के साथ बनाए गए नोड्स के लिए, जैसे कि Document.createElement (), यह हमेशा शून्य होता है। |
| [Name](../../aspose.svg.dom/attr/name/) { get; } | इस विशेषता का नाम लौटाता है। |
| override [NamespaceURI](../../aspose.svg.dom/attr/namespaceuri/) { get; } | इस नोड का नामस्थान यूआरआई, या अनिर्दिष्ट होने पर शून्य। |
...
| override [NodeName](../../aspose.svg.dom/attr/nodename/) { get; } | इस नोड का नाम, इसके प्रकार पर निर्भर करता है। |
| override [NodeType](../../aspose.svg.dom/attr/nodetype/) { get; } | अंतर्निहित वस्तु के प्रकार का प्रतिनिधित्व करने वाला एक कोड। |
| override [NodeValue](../../aspose.svg.dom/attr/nodevalue/) { get; set; } | इस नोड का मान, इसके प्रकार पर निर्भर करता है। |
...
| [OwnerElement](../../aspose.svg.dom/attr/ownerelement/) { get; } | यदि यह विशेषता उपयोग में नहीं है तो तत्व नोड इस विशेषता से जुड़ा हुआ है या शून्य है। |
...
| override [Prefix](../../aspose.svg.dom/attr/prefix/) { get; } | इस नोड का नामस्थान उपसर्ग, या अनिर्दिष्ट होने पर अशक्त। जब इसे शून्य के रूप में परिभाषित किया जाता है, तो इसे सेट करने से कोई प्रभाव नहीं पड़ता |
...
| [SchemaTypeInfo](../../aspose.svg.dom/attr/schematypeinfo/) { get; } | इस विशेषता से संबंधित प्रकार की जानकारी। |
| [Specified](../../aspose.svg.dom/attr/specified/) { get; } | सच है अगर इस विशेषता को उदाहरण दस्तावेज़ में स्पष्ट रूप से एक मान दिया गया था, अन्यथा झूठा। |
| override [TextContent](../../aspose.svg.dom/attr/textcontent/) { get; set; } | यह विशेषता इस नोड और उसके वंश की पाठ्य सामग्री लौटाती है। जब इसे शून्य के रूप में परिभाषित किया जाता है, तो इसे सेट करने का कोई प्रभाव नहीं पड़ता है। सेट करने पर, इस नोड के किसी भी संभावित बच्चे को हटा दिया जा सकता है और, यदि यह नया स्ट्रिंग खाली या शून्य नहीं है, तो इस विशेषता को सेट करने वाले स्ट्रिंग वाले एकल टेक्स्ट नोड द्वारा प्रतिस्थापित किया जाता है। |
| [Value](../../aspose.svg.dom/attr/value/) { get; set; } | पुनर्प्राप्ति पर, विशेषता का मान एक स्ट्रिंग के रूप में लौटाया जाता है। |
