...
description: Aspose.Svg.Dom.Entity कक्ष. एक XML दस्तवेज़ में एक ज्ञत इकई क प्रतनधत्व करत है य त पर्स य अनपर्स कय गय है
type: docs
weight: 850
url: /hi/net/aspose.svg.dom/entity/
---
## Entity class
...
| [InputEncoding](../../aspose.svg.dom/entity/inputencoding/) { get; } | एक विशेषता जो इस इकाई के लिए पार्सिंग के समय उपयोग किए गए एन्कोडिंग को निर्दिष्ट करती है, जब यह एक बाहरी पार्स की गई इकाई है। यह शून्य है अगर यह आंतरिक उपसमुच्चय से एक इकाई है या यदि यह ज्ञात नहीं है। |
...
| override [NodeName](../../aspose.svg.dom/entity/nodename/) { get; } | इस नोड का नाम, इसके प्रकार पर निर्भर करता है। |
| override [NodeType](../../aspose.svg.dom/entity/nodetype/) { get; } | अंतर्निहित वस्तु के प्रकार का प्रतिनिधित्व करने वाला एक कोड। |
| virtual [NodeValue](../../aspose.svg.dom/node/nodevalue/) { get; set; } | इस नोड का मान, इसके प्रकार पर निर्भर करता है। |
| [NotationName](../../aspose.svg.dom/entity/notationname/) { get; } | पार्स नहीं की गई संस्थाओं के लिए, इकाई के लिए अंकन का नाम। पार्स की गई संस्थाओं के लिए, यह शून्य है। |
...
| [PublicId](../../aspose.svg.dom/entity/publicid/) { get; } | इकाई से जुड़ा सार्वजनिक पहचानकर्ता निर्दिष्ट होने पर, और अन्यथा शून्य। |
| [SystemId](../../aspose.svg.dom/entity/systemid/) { get; } | निर्दिष्ट होने पर इकाई से जुड़ा सिस्टम पहचानकर्ता, और अन्यथा शून्य। यह पूर्ण यूआरआई हो सकता है या नहीं. |
...
| [XmlEncoding](../../aspose.svg.dom/entity/xmlencoding/) { get; } | एक विशेषता निर्दिष्ट करती है, पाठ घोषणा के भाग के रूप में, इस इकाई का एन्कोडिंग, जब यह एक बाहरी पार्स की गई इकाई है। यह शून्य है अन्यथा. |
| [XmlVersion](../../aspose.svg.dom/entity/xmlversion/) { get; } | टेक्स्ट डिक्लेरेशन के भाग के रूप में निर्दिष्ट एक विशेषता, इस इकाई की संस्करण संख्या, जब यह एक बाहरी पार्स की गई इकाई है। यह शून्य है अन्यथा. |
