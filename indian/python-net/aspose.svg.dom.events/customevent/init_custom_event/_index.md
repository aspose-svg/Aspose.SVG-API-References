...
type: docs
weight: 30
url: /hi/python-net/aspose.svg.dom.events/customevent/init_custom_event/
is_root: false
---

## init_custom_event {#str-bool-bool-any}

/// The [`Event.init_event`](/svg/python-net/aspose.svg.dom.events/event/init_event) method is used to initialize the value of an [`Event`](/svg/python-net/aspose.svg.dom.events/event) created through the [`IDocumentEvent`](/svg/python-net/aspose.svg.dom.events/idocumentevent) interface.
