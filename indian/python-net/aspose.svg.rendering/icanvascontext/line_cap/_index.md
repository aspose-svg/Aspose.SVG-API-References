...
type: docs
weight: 140
url: /hi/python-net/aspose.svg.rendering/icanvascontext/line_cap/
is_root: false
---
...
Gets or sets the line cap style. See [`StrokeLineCap`](/svg/python-net/aspose.svg.drawing/strokelinecap).
### Definition:
```python
@property
def line_cap(self):
