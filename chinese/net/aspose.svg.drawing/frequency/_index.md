...
description: Aspose.Svg.Drawing.Frequency 班级. 频率单位
type: docs
weight: 1420
url: /zh/net/aspose.svg.drawing/frequency/
---
## Frequency class
...
| [operator +](../../aspose.svg.drawing/frequency/op_addition/) | 实现运算符 +. |
| [operator ==](../../aspose.svg.drawing/frequency/op_equality/) | 实现运算符 ==. |
| [operator &gt;](../../aspose.svg.drawing/frequency/op_greaterthan/) | 实现运算符 &gt;. |
| [operator &gt;=](../../aspose.svg.drawing/frequency/op_greaterthanorequal/) | 实现运算符 &gt;=. |
| [operator !=](../../aspose.svg.drawing/frequency/op_inequality/) | 实现运算符 !=. |
| [operator &lt;](../../aspose.svg.drawing/frequency/op_lessthan/) | 实现运算符 &lt;. |
| [operator &lt;=](../../aspose.svg.drawing/frequency/op_lessthanorequal/) | 实现运算符 &lt;=. |
| [operator -](../../aspose.svg.drawing/frequency/op_subtraction/) | 实现运算符 -. |
