...
| override [Equals](../../aspose.svg.drawing/numeric/equals#equals)(Unit) | 判断是否指定[`Unit`](../unit) 等于这个实例。 |
...
| [GetValue](../../aspose.svg.drawing/numeric/getvalue#getvalue_1)(UnitType) | 获取转换为指定值的值[`UnitType`](../unittype) . |
| override [ToString](../../aspose.svg.drawing/numeric/tostring)() | 返回一个String代表这个实例。 |
