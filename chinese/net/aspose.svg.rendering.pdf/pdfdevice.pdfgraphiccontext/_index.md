...
description: "Aspose.Svg.Rendering.Pdf.PdfDevicePdfGraphicContext 类。保存 PdfDevice 的当前图形控制参数。这些参数定义了图形操作执行的全局框架。"
type: docs
weight: 5030
...
| 名称 | 描述 |
| --- | --- |
| [PdfGraphicContext](../../aspose.svg.rendering.pdf/pdfdevice.pdfgraphiccontext/.ctor)() | 默认构造函数。 |
