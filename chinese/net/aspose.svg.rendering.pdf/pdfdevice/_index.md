...
description: "Aspose.Svg.Rendering.Pdf.PdfDevice 类。表示将渲染到 PDF 文档。"
type: docs
weight: 5020
...
| 名称 | 描述 |
| --- | --- |
| [PdfDevice](pdfdevice/#constructor)(*[ICreateStreamProvider](../../aspose.svg.io/icreatestreamprovider/)*) | 初始化 `PdfDevice` 类的新实例。 |
| [PdfDevice](pdfdevice/#constructor_4)(*Stream*) | 初始化 `PdfDevice` 类的新实例。 |
| [PdfDevice](pdfdevice/#constructor_5)(*string*) | 初始化 `PdfDevice` 类的新实例。 |
| [PdfDevice](pdfdevice/#constructor_1)(*[PdfRenderingOptions](../pdfrenderingoptions/), [ICreateStreamProvider](../../aspose.svg.io/icreatestreamprovider/)*) | 通过渲染选项和流提供程序初始化 `PdfDevice` 类的新实例。 |
| [PdfDevice](pdfdevice/#constructor_2)(*[PdfRenderingOptions](../pdfrenderingoptions/), Stream*) | 通过渲染选项和输出流初始化 `PdfDevice` 类的新实例。 |
| [PdfDevice](pdfdevice/#constructor_3)(*[PdfRenderingOptions](../pdfrenderingoptions/), string*) | 通过渲染选项和输出文件名初始化 `PdfDevice` 类的新实例。 |
...
| 名称 | 描述 |
| --- | --- |
| class [PdfGraphicContext](../../aspose.svg.rendering.pdf/pdfdevice.pdfgraphiccontext) | 保存 PdfDevice 的当前图形控制参数。这些参数定义了图形操作执行的全局框架。 |
