...
description: Aspose.Svg.Rendering.GraphicContext 班级. 保存当前图形控制参数 这些参数定义了图形运算符执行的全局框架
type: docs
weight: 2800
...
| 姓名 | 描述 |
| --- | --- |
| virtual [Clone](../../aspose.svg.rendering/graphiccontext/clone/)() | 使用与现有实例相同的属性值创建 GraphicContext 类的新实例。 |
