...
| virtual [TextInfo](../../aspose.svg.rendering/graphiccontext/textinfo) { get; } | 获取一个[`TextInfo`](../textinfo)对象，其中包含有关渲染文本的信息。 |
...
| 姓名 | 描述 |
| --- | --- |
| virtual [Clone](../../aspose.svg.rendering/graphiccontext/clone)() | 创建具有与现有实例相同的属性值的 GraphicContext 类的新实例。 |
| virtual [Transform](../../aspose.svg.rendering/graphiccontext/transform)(Matrix) | 通过乘以指定的矩阵来修改当前的变换矩阵。 |
