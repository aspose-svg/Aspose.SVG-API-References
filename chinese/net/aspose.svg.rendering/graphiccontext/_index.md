...
description: "Aspose.Svg.Rendering.GraphicContext 类。保存当前图形控制参数。这些参数定义了图形操作符执行时的全局框架"
type: docs
weight: 4880
...
| virtual [TextInfo](../../aspose.svg.rendering/graphiccontext/textinfo/) { get; } | 获取一个 [`TextInfo`](../textinfo/) 对象，其中包含已渲染文本的信息。 |
