...
description: Aspose.Svg.Dom.Events.CustomEvent 班级. 使用CustomEvent接口的事件可以用来携带自定义数据
type: docs
weight: 880
...
| [InitCustomEvent](../../aspose.svg.dom.events/customevent/initcustomevent/)(string, bool, bool, object) | /// 这个[`InitEvent`](../event/initevent/)方法用于初始化一个值[`Event`](../event/)通过创建[`IDocumentEvent`](../idocumentevent/)接口. |
