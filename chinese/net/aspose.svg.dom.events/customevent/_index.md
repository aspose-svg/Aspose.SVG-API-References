...
description: 使用 CustomEvent 接口的事件可用于携带自定义数据
type: docs
weight: 890
...
| [InitCustomEvent](../../aspose.svg.dom.events/customevent/initcustomevent)(string, bool, bool, object) | /// 使用了[`InitEvent`](../event/initevent)方法初始化通过[`IDocumentEvent`](../idocumentevent)接口创建的[`Event`](../event)的值。 |
