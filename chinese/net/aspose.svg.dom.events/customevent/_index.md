...
| 姓名 | 描述 |
| --- | --- |
| [CustomEvent](customevent#constructor)(string) | 初始化[`CustomEvent`](../customevent)类. |
| [CustomEvent](customevent#constructor_1)(string, IDictionary&lt;string, object&gt;) | 初始化[`CustomEvent`](../customevent)类. |
...
| [InitCustomEvent](../../aspose.svg.dom.events/customevent/initcustomevent)(string, bool, bool, object) | /// 的[`InitEvent`](../event/initevent)方法用于初始化一个值[`Event`](../event)通过创建[`IDocumentEvent`](../idocumentevent)接口. |
