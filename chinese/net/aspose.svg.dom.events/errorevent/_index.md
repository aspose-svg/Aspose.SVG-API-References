...
description: 的ErrorEvent./errorevent提供有关运行时发生的错误的上下文信息
type: docs
weight: 910
...
的[`ErrorEvent`](../errorevent)提供有关运行时发生的错误的上下文信息。
...
| 姓名 | 描述 |
| --- | --- |
| [ErrorEvent](errorevent#constructor_1)(Exception) | 初始化[`ErrorEvent`](../errorevent)类. |
| [ErrorEvent](errorevent#constructor)(IDictionary&lt;string, object&gt;) | 初始化[`ErrorEvent`](../errorevent)类. |
