...
| 姓名 | 描述 |
| --- | --- |
| [KeyboardEvent](keyboardevent#constructor)(string) | 初始化[`KeyboardEvent`](../keyboardevent)类. |
| [KeyboardEvent](keyboardevent#constructor_1)(string, IDictionary&lt;string, object&gt;) | 初始化[`KeyboardEvent`](../keyboardevent)类. |

## 特性

| 姓名 | 描述 |
| --- | --- |
| [AltKey](../../aspose.svg.dom.events/keyboardevent/altkey) { get; } | 如果 Alt（替代）（或“选项”）键修饰符处于活动状态，则为 true。此属性的未初始化值必须为 false. |
...
| [CtrlKey](../../aspose.svg.dom.events/keyboardevent/ctrlkey) { get; } | 如果 Control（控制）键修饰符处于活动状态，则为 true。 此属性的未初始化值必须为 false。 |
...
| [IsComposing](../../aspose.svg.dom.events/keyboardevent/iscomposing) { get; } | 如果关键事件作为组合会话的一部分发生，即在组合开始事件之后和相应组合结束事件之前发生，则为真。此属性的未初始化值必须为 false. |
...
| const [DOM_KEY_LOCATION_RIGHT](../../aspose.svg.dom.events/keyboardevent/dom_key_location_right) | 密钥激活源自正确的密钥位置（当此密钥存在多个可能位置时）。 |
| const [DOM_KEY_LOCATION_STANDARD](../../aspose.svg.dom.events/keyboardevent/dom_key_location_standard) | 键激活不得区分为左键或右键，并且（NumLock 键除外）不是源自数字小键盘（或不是源自与数字小键盘对应的虚拟键）。 |
