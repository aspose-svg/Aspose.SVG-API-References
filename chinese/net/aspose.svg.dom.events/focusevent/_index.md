...
| 姓名 | 描述 |
| --- | --- |
| [FocusEvent](focusevent#constructor)(string) | 初始化[`FocusEvent`](../focusevent)类. |
| [FocusEvent](focusevent#constructor_1)(string, IDictionary&lt;string, object&gt;) | 初始化[`FocusEvent`](../focusevent)类. |
...
| [RelatedTarget](../../aspose.svg.dom.events/focusevent/relatedtarget) { get; } | 用于标识与焦点事件相关的辅助 EventTarget，具体取决于事件的类型。 |
