...
description: "Aspose.Svg.Dom.Events.FocusEvent 类。FocusEvent 接口提供与焦点事件相关的特定上下文信息。"
type: docs
weight: 2930
...
| [FocusEvent](focusevent/#constructor_1)(*string, IDictionary&lt;string, object&gt;*) | 初始化 `FocusEvent` 类的新实例。 |
...
| [RelatedTarget](../../aspose.svg.dom.events/focusevent/relatedtarget/) { get; } | 用于识别与焦点事件相关的次要 EventTarget，取决于事件的类型。 |
