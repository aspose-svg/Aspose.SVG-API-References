...
| 姓名 | 描述 |
| --- | --- |
| [Url](url#constructor)(string) | 初始化[`Url`](../url)使用指定的 URL. |
| [Url](url#constructor_1)(string, string) | 初始化[`Url`](../url)使用指定的 URL 和基本 URL. |
...
| [SearchParams](../../aspose.svg/url/searchparams) { get; } | 获取关联的[`IUrlSearchParams`](../iurlsearchparams)对象. |
