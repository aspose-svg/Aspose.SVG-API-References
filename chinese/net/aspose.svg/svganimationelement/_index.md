...
description: "Aspose.Svg.SVGAnimationElement 类。SVGAnimationElement 接口是所有动画元素接口（SVGAnimateElement、SVGSetElement、SVGAnimateColorElement、SVGAnimateMotionElement 和 SVGAnimateTransformElement）的基础接口。"
type: docs
weight: 5190
...
该 SVGAnimationElement 接口是所有动画元素接口的基接口：SVGAnimateElement、SVGSetElement、SVGAnimateColorElement、SVGAnimateMotionElement 和 SVGAnimateTransformElement。
...
| [RequiredExtensions](../../aspose.svg/svganimationelement/requiredextensions/) { get; } | 对应于给定元素的 ‘requiredExtensions’ 属性。 |
| [RequiredFeatures](../../aspose.svg/svganimationelement/requiredfeatures/) { get; } | 对应于给定元素的 ‘requiredFeatures’ 属性。 |
...
| [SystemLanguage](../../aspose.svg/svganimationelement/systemlanguage/) { get; } | 对应于给定元素的 ‘systemLanguage’ 属性。 |
| [TagName](../../aspose.svg.dom/element/tagname/) { get; } | 元素的名称。 |
| [TargetElement](../../aspose.svg/svganimationelement/targetelement/) { get; } | 正在被动画化的元素。 |
