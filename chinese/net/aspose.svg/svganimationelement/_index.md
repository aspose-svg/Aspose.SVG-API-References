...
description: Aspose.Svg.SVGAnimationElement 班级. SVGAnimationElement 接口是所有动画元素接口的基础接口SVGAnimateElementSVGSetElementSVGAnimateColorElementSVGAnimateMotionElement 和 SVGAnimateTransformElement.
type: docs
weight: 3120
...
| [RequiredFeatures](../../aspose.svg/svganimationelement/requiredfeatures/) { get; } | 对应于给定元素上的属性“requiredFeatures”。 |
...
| [SystemLanguage](../../aspose.svg/svganimationelement/systemlanguage/) { get; } | 对应于给定元素上的属性“systemLanguage”。 |
| [TagName](../../aspose.svg.dom/element/tagname/) { get; } | 元素的名称。 |
| [TargetElement](../../aspose.svg/svganimationelement/targetelement/) { get; } | 正在设置动画的元素。 |
