...
description: "Aspose.Svg.SVGFilterElement 类。SVGFilterElement 接口对应于 filter 元素"
type: docs
weight: 5310
...
| [FilterUnits](../../aspose.svg/svgfilterelement/filterunits/) { get; } | 对应于给定 ‘filter’ 元素的属性 ‘filterUnits’。取自 SVGUnitTypes 中定义的常量之一。 |
...
| [Height](../../aspose.svg/svgfilterelement/height/) { get; } | 对应于给定 ‘filter’ 元素的属性 ‘height’。 |
| [Href](../../aspose.svg/svgfilterelement/href/) { get; } | 对应给定元素上的属性 ‘xlink:href’。 |
...
| [PrimitiveUnits](../../aspose.svg/svgfilterelement/primitiveunits/) { get; } | 对应于给定 ‘filter’ 元素的属性 ‘primitiveUnits’。取自 SVGUnitTypes 中定义的常量之一。 |
...
| [Width](../../aspose.svg/svgfilterelement/width/) { get; } | 对应于给定 ‘filter’ 元素的属性 ‘width’。 |
| [X](../../aspose.svg/svgfilterelement/x/) { get; } | 对应于给定 ‘filter’ 元素的属性 ‘x’。 |
| [Y](../../aspose.svg/svgfilterelement/y/) { get; } | 对应于给定 ‘filter’ 元素的属性 ‘y’。 |
