...
description: Aspose.Svg.SVGFilterElement 班级. SVGFilterElement 接口对应于过滤器元素
type: docs
weight: 3240
...
| [Height](../../aspose.svg/svgfilterelement/height/) { get; } | 对应于给定“过滤器”元素上的属性“高度”。 |
...
| [PrimitiveUnits](../../aspose.svg/svgfilterelement/primitiveunits/) { get; } | 对应于给定“过滤器”元素上的属性“primitiveUnits”。采用 SVGUnitTypes. 中定义的常量之一 |
...
| [Width](../../aspose.svg/svgfilterelement/width/) { get; } | 对应于给定“过滤器”元素上的属性“宽度”。 |
| [X](../../aspose.svg/svgfilterelement/x/) { get; } | 对应于给定“过滤器”元素上的属性“x”。 |
| [Y](../../aspose.svg/svgfilterelement/y/) { get; } | 对应于给定“过滤器”元素上的属性“y”。 |
