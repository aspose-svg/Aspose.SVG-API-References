...
type: docs
weight: 3180
url: /zh/net/aspose.svg/svgfilterelement/
---
...
| [FilterUnits](../../aspose.svg/svgfilterelement/filterunits) { get; } | 对应于给定 'filter' 元素上的属性 'filterUnits'。采用 SVGUnitTypes 中定义的常量之一。 |
...
| [Height](../../aspose.svg/svgfilterelement/height) { get; } | 对应于给定“过滤器”元素的属性“高度”。 |
| [Href](../../aspose.svg/svgfilterelement/href) { get; } | 对应于给定元素上的属性“xlink:href”。 |
...
| [PrimitiveUnits](../../aspose.svg/svgfilterelement/primitiveunits) { get; } | 对应于给定 'filter' 元素上的属性 'primitiveUnits'。采用 SVGUnitTypes 中定义的常量之一。 |
...
| [Width](../../aspose.svg/svgfilterelement/width) { get; } | 对应于给定“过滤器”元素的属性“宽度”。 |
| [X](../../aspose.svg/svgfilterelement/x) { get; } | 对应于给定“过滤器”元素的属性“x”。 |
| [Y](../../aspose.svg/svgfilterelement/y) { get; } | 对应于给定 'filter' 元素上的属性 'y'。 |
