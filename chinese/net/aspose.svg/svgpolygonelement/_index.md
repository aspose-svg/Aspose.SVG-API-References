...
description: "Aspose.Svg.SVGPolygonElement 类。SVGPolygonElement 接口对应于 polygon 元素。"
type: docs
weight: 5460
...
| 名称 | 描述 |
| --- | --- |
| [AnimatedPoints](../../aspose.svg/svgpolygonelement/animatedpoints/) { get; } | 提供对 ‘points’ 属性当前动画内容的访问。如果给定的属性或属性正在动画中，则包含该属性或属性的当前动画值。如果给定的属性或属性当前未动画，则包含与 points 相同的值。 |
...
| [Points](../../aspose.svg/svgpolygonelement/points/) { get; } | 提供对 ‘points’ 属性基础（即静态）内容的访问。 |
