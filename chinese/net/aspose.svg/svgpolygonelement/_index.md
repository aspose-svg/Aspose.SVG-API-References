...
description: SVGPolygonElement 接口对应于多边形元素
type: docs
weight: 3330
url: /zh/net/aspose.svg/svgpolygonelement/
---
...
| 姓名 | 描述 |
| --- | --- |
| [AnimatedPoints](../../aspose.svg/svgpolygonelement/animatedpoints) { get; } | 提供对“points”属性的当前动画内容的访问。如果给定的属性或属性正在被动画化，则包含属性或属性的当前动画值。如果给定的属性或属性当前没有被动画化，则包含与点相同的值。 |
...
| [Points](../../aspose.svg/svgpolygonelement/points) { get; } | 提供对“points”属性的基本（即静态）内容的访问。 |
