...
description: SVGUseElement 接口对应于use元素
type: docs
weight: 3520
url: /zh/net/aspose.svg/svguseelement/
---
## SVGUseElement class
...
| [Height](../../aspose.svg/svguseelement/height) { get; } | 对应于给定 'use' 元素的属性 'height'。 |
| [Href](../../aspose.svg/svguseelement/href) { get; } | 对应于给定元素上的属性“xlink:href”。 |
...
| [Width](../../aspose.svg/svguseelement/width) { get; } | 对应于给定 'use' 元素的属性 'width'。 |
| [X](../../aspose.svg/svguseelement/x) { get; } | 对应于给定 'use' 元素的属性 'x'。 |
| [Y](../../aspose.svg/svguseelement/y) { get; } | 对应于给定 'use' 元素的属性 'y'。 |
