...
description: "Aspose.Svg.SVGGeometryElement 类。SVGGeometryElement 接口表示渲染由几何形状（具有等效路径）定义且可以填充和描边的 SVG 元素。包括路径和基本形状"
type: docs
weight: 5340
...
SVGGeometryElement 接口表示其渲染由几何形状及等效路径定义且可以填充和描边的 SVG 元素。这包括路径和基本形状。
...
| [Combine](../../aspose.svg/svggeometryelement/combine/)(*SVGGeometryElement, [BooleanPathOp](../../aspose.svg.rendering/booleanpathop/)*) | 使用布尔运算将此几何体与另一个 SVG 几何体组合，并返回包含结果的新 `<path>` 元素。 |
...
| [GetEquivalentPath](../../aspose.svg/svggeometryelement/getequivalentpath/)() | 返回一个新的实例，代表 `SVGGeometryElement` 为路径段的 [`SVGPathSegList`](../../aspose.svg.paths/svgpathseglist/)。 |
