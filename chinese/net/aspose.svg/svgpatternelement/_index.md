...
description: Aspose.Svg.SVGPatternElement 班级. SVGPatternElement 接口对应于模式元素
type: docs
weight: 3380
...
| [Height](../../aspose.svg/svgpatternelement/height/) { get; } | 对应于给定“模式”元素上的属性“高度”。 |
...
| [PatternContentUnits](../../aspose.svg/svgpatternelement/patterncontentunits/) { get; } | 对应于给定“模式”元素上的属性“patternContentUnits”。采用 SVGUnitTypes. 中定义的常量之一 |
| [PatternTransform](../../aspose.svg/svgpatternelement/patterntransform/) { get; } | 对应于给定“模式”元素上的属性“patternTransform”。 |
| [PatternUnits](../../aspose.svg/svgpatternelement/patternunits/) { get; } | 对应于给定“pattern”元素上的属性“patternUnits”。采用 SVGUnitTypes. 中定义的常量之一 |
| override [Prefix](../../aspose.svg.dom/element/prefix/) { get; } | 此节点的名称空间前缀，如果未指定则为 null。定义为null时，设置无效 |
| [PreserveAspectRatio](../../aspose.svg/svgpatternelement/preserveaspectratio/) { get; } | 对应于给定元素上的属性“preserveAspectRatio”。 |
...
| [RequiredFeatures](../../aspose.svg/svgpatternelement/requiredfeatures/) { get; } | 对应于给定元素上的属性“requiredFeatures”。 |
...
| [SystemLanguage](../../aspose.svg/svgpatternelement/systemlanguage/) { get; } | 对应于给定元素上的属性“systemLanguage”。 |
...
| [ViewBox](../../aspose.svg/svgpatternelement/viewbox/) { get; } | 对应于给定元素上的属性“viewBox”。 |
| [ViewportElement](../../aspose.svg/svgelement/viewportelement/) { get; } | 建立当前视口的元素。通常，最近的祖先“svg”元素。如果给定元素是最外层的 svg 元素，则为空。 |
| [Width](../../aspose.svg/svgpatternelement/width/) { get; } | 对应于给定“模式”元素上的属性“宽度”。 |
| [X](../../aspose.svg/svgpatternelement/x/) { get; } | 对应于给定“模式”元素上的属性“x”。 |
| [Y](../../aspose.svg/svgpatternelement/y/) { get; } | 对应于给定“模式”元素上的属性“y”。 |
