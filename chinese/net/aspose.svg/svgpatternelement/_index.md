...
description: "Aspose.Svg.SVGPatternElement 类。SVGPatternElement 接口对应于 pattern 元素"
type: docs
weight: 5450
...
| [Href](../../aspose.svg/svgpatternelement/href/) { get; } | 对应给定元素上的属性 ‘xlink:href’。 |
...
| [PatternContentUnits](../../aspose.svg/svgpatternelement/patterncontentunits/) { get; } | 对应于给定 ‘pattern’ 元素的属性 ‘patternContentUnits’。取值为 SVGUnitTypes 中定义的常量之一。 |
| [PatternTransform](../../aspose.svg/svgpatternelement/patterntransform/) { get; } | 对应于给定 ‘pattern’ 元素的属性 ‘patternTransform’。 |
| [PatternUnits](../../aspose.svg/svgpatternelement/patternunits/) { get; } | 对应于给定 ‘pattern’ 元素的属性 ‘patternUnits’。取值为 SVGUnitTypes 中定义的常量之一。 |
| override [Prefix](../../aspose.svg.dom/element/prefix/) { get; } | 此节点的命名空间前缀，如果未指定则为 null。当其被定义为 null 时，设置它不会产生任何效果。 |
| [PreserveAspectRatio](../../aspose.svg/svgpatternelement/preserveaspectratio/) { get; } | 对应给定元素的属性 ‘preserveAspectRatio’。 |
...
| [RequiredExtensions](../../aspose.svg/svgpatternelement/requiredextensions/) { get; } | 对应于给定元素的 ‘requiredExtensions’ 属性。 |
| [RequiredFeatures](../../aspose.svg/svgpatternelement/requiredfeatures/) { get; } | 对应于给定元素的 ‘requiredFeatures’ 属性。 |
...
| [SystemLanguage](../../aspose.svg/svgpatternelement/systemlanguage/) { get; } | 对应于给定元素的 ‘systemLanguage’ 属性。 |
...
| [ViewBox](../../aspose.svg/svgpatternelement/viewbox/) { get; } | 对应给定元素的属性 ‘viewBox’。 |
