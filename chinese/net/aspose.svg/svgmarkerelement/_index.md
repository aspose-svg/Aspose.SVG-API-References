...
description: SVGMarkerElement 接口对应于标记元素
type: docs
weight: 3290
...
| [MarkerHeight](../../aspose.svg/svgmarkerelement/markerheight) { get; } | 对应于给定“marker”元素上的属性“markerHeight”。 |
| [MarkerUnits](../../aspose.svg/svgmarkerelement/markerunits) { get; } | 对应于给定 'marker' 元素上的属性 'markerUnits'。此接口上定义的标记单元类型之一。 |
| [MarkerWidth](../../aspose.svg/svgmarkerelement/markerwidth) { get; } | 对应于给定“marker”元素上的属性“markerWidth”。 |
...
| [OrientType](../../aspose.svg/svgmarkerelement/orienttype) { get; } | 对应于给定 'marker' 元素上的属性 'orient'。此接口上定义的标记方向类型之一。 |
...
| [PreserveAspectRatio](../../aspose.svg/svgmarkerelement/preserveaspectratio) { get; } | 对应于给定元素上的属性“preserveAspectRatio”。 |
...
| [ViewBox](../../aspose.svg/svgmarkerelement/viewbox) { get; } | 对应于给定元素上的属性“viewBox”。 |
