...
description: Aspose.Svg.SVGMarkerElement 班级. SVGMarkerElement 接口对应于 marker 元素
type: docs
weight: 3340
...
| [MarkerHeight](../../aspose.svg/svgmarkerelement/markerheight/) { get; } | 对应于给定“标记”元素上的属性“markerHeight”。 |
| [MarkerUnits](../../aspose.svg/svgmarkerelement/markerunits/) { get; } | 对应于给定“标记”元素上的属性“markerUnits”。此接口上定义的标记单元类型之一。 |
| [MarkerWidth](../../aspose.svg/svgmarkerelement/markerwidth/) { get; } | 对应于给定“标记”元素上的属性“markerWidth”。 |
...
| [OrientAngle](../../aspose.svg/svgmarkerelement/orientangle/) { get; } | 对应于给定“标记”元素上的属性“orient”。如果 markerUnits 是 SVG_MARKER_ORIENT_ANGLE，则属性 'orient' 的角度值；否则，它将被设置为零。 |
| [OrientType](../../aspose.svg/svgmarkerelement/orienttype/) { get; } | 对应于给定“标记”元素上的属性“orient”。此接口上定义的标记方向类型之一。 |
...
| [RefX](../../aspose.svg/svgmarkerelement/refx/) { get; } | 对应于给定“标记”元素上的属性“refX”。 |
| [RefY](../../aspose.svg/svgmarkerelement/refy/) { get; } | 对应于给定“标记”元素上的属性“refY”。 |
...
| [SetOrientToAngle](../../aspose.svg/svgmarkerelement/setorienttoangle/)(SVGAngle) | 将属性“orient”的值设置为给定角度。 |
...
| const [SVG_MARKERUNITS_UNKNOWN](../../aspose.svg/svgmarkerelement/svg_markerunits_unknown/) | 标记单元类型不是预定义类型之一。尝试定义此类型的新值或尝试将现有值切换为此类型是无效的。 |
...
| const [SVG_MARKER_ORIENT_UNKNOWN](../../aspose.svg/svgmarkerelement/svg_marker_orient_unknown/) | 标记方向不是预定义类型之一。尝试定义此类型的新值或尝试将现有值切换为此类型是无效的。 |
