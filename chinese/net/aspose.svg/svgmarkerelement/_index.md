...
type: docs
weight: 3280
url: /zh/net/aspose.svg/svgmarkerelement/
---
...
| [MarkerHeight](../../aspose.svg/svgmarkerelement/markerheight) { get; } | 对应于给定 'marker' 元素的属性 'markerHeight'。 |
| [MarkerUnits](../../aspose.svg/svgmarkerelement/markerunits) { get; } | 对应于给定 'marker' 元素上的属性 'markerUnits'。此接口上定义的标记单元类型之一。 |
| [MarkerWidth](../../aspose.svg/svgmarkerelement/markerwidth) { get; } | 对应于给定 'marker' 元素的属性 'markerWidth'。 |
...
| [OrientAngle](../../aspose.svg/svgmarkerelement/orientangle) { get; } | 对应于给定 'marker' 元素上的属性 'orient'。如果 markerUnits 是 SVG_MARKER_ORIENT_ANGLE，属性 'orient' 的角度值；否则，它将被设置为零。 |
| [OrientType](../../aspose.svg/svgmarkerelement/orienttype) { get; } | 对应于给定 'marker' 元素上的属性 'orient'。在此接口上定义的标记方向类型之一。 |
...
| [PreserveAspectRatio](../../aspose.svg/svgmarkerelement/preserveaspectratio) { get; } | 对应于给定元素的属性“preserveAspectRatio”。 |
...
| [RefX](../../aspose.svg/svgmarkerelement/refx) { get; } | 对应于给定 'marker' 元素上的属性 'refX'。 |
| [RefY](../../aspose.svg/svgmarkerelement/refy) { get; } | 对应于给定 'marker' 元素上的属性 'refY'。 |
...
| [ViewBox](../../aspose.svg/svgmarkerelement/viewbox) { get; } | 对应于给定元素的属性“viewBox”。 |
...
| [SetOrientToAngle](../../aspose.svg/svgmarkerelement/setorienttoangle)(SVGAngle) | 将属性“orient”的值设置为给定的角度。 |
| [SetOrientToAuto](../../aspose.svg/svgmarkerelement/setorienttoauto)() | 将属性“orient”的值设置为“auto”。 |
...
| 姓名 | 描述 |
| --- | --- |
| const [SVG_MARKERUNITS_STROKEWIDTH](../../aspose.svg/svgmarkerelement/svg_markerunits_strokewidth) | 属性“markerUnits”的值为“strokeWidth”。 |
| const [SVG_MARKERUNITS_UNKNOWN](../../aspose.svg/svgmarkerelement/svg_markerunits_unknown) | 标记单元类型不是预定义类型之一。尝试定义此类型的新值或尝试将现有值切换到此类型是无效的。 |
| const [SVG_MARKERUNITS_USERSPACEONUSE](../../aspose.svg/svgmarkerelement/svg_markerunits_userspaceonuse) | 属性“markerUnits”的值为“userSpaceOnUse”。 |
| const [SVG_MARKER_ORIENT_ANGLE](../../aspose.svg/svgmarkerelement/svg_marker_orient_angle) | 属性 'orient' 有一个角度值。 |
| const [SVG_MARKER_ORIENT_AUTO](../../aspose.svg/svgmarkerelement/svg_marker_orient_auto) | 属性“orient”的值为“auto”。 |
| const [SVG_MARKER_ORIENT_UNKNOWN](../../aspose.svg/svgmarkerelement/svg_marker_orient_unknown) | 标记方向不是预定义类型之一。尝试定义此类型的新值或尝试将现有值切换到此类型是无效的。 |
