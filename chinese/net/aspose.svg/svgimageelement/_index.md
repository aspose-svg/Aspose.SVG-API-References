...
description: "Aspose.Svg.SVGImageElement 类。SVGImageElement 接口对应于 image 元素。"
type: docs
weight: 5370
...
| [Height](../../aspose.svg/svgimageelement/height/) { get; } | 对应于给定 ‘image’ 元素的 ‘height’ 属性。 |
| [Href](../../aspose.svg/svgimageelement/href/) { get; } | 对应给定元素上的属性 ‘xlink:href’。 |
...
| [PreserveAspectRatio](../../aspose.svg/svgimageelement/preserveaspectratio/) { get; } | 对应给定 ‘image’ 元素上的属性 ‘preserveAspectRatio’。 |
...
| [Width](../../aspose.svg/svgimageelement/width/) { get; } | 对应给定 ‘image’ 元素上的属性 ‘width’。 |
| [X](../../aspose.svg/svgimageelement/x/) { get; } | 对应给定 ‘image’ 元素上的属性 ‘x’。 |
| [Y](../../aspose.svg/svgimageelement/y/) { get; } | 对应给定 ‘image’ 元素上的属性 ‘y’。 |
