...
description: "Aspose.Svg.SVGPathElement 类。SVGPathElement 接口对应于 path 元素。"
type: docs
weight: 5440
...
| 名称 | 描述 |
| --- | --- |
| [AnimatedPathSegList](../../aspose.svg/svgpathelement/animatedpathseglist/) { get; } | 提供对 ‘d’ 属性当前动画内容的访问，形式与 SVG 语法一一对应。如果给定的属性或属性正在被动画化，则包含该属性或属性的当前动画值，并且对象本身及其内容均为只读。如果给定的属性或属性当前未被动画化，则其值与 pathSegList 相同。 |
...
| [PathSegList](../../aspose.svg/svgpathelement/pathseglist/) { get; set; } | 提供对 ‘d’ 属性基础（即静态）内容的访问，形式与 SVG 语法一一对应。因此，如果 ‘d’ 属性包含一个"absolute moveto (M)"和一个"absolute arcto (A)"命令，则 pathSegList 将包含两个条目：SVG_PATHSEG_MOVETO_ABS 和 SVG_PATHSEG_ARC_ABS。 |
...
| [CreateSVGPathSegArcAbs](../../aspose.svg/svgpathelement/createsvgpathsegarcabs/)(*float, float, float, float, float, bool, bool*) | 返回一个独立的、无父级的 SVGPathSegArcAbs 对象。 |
| [CreateSVGPathSegArcRel](../../aspose.svg/svgpathelement/createsvgpathsegarcrel/)(*float, float, float, float, float, bool, bool*) | 返回一个独立的、无父级的 SVGPathSegArcRel 对象。 |
| [CreateSVGPathSegClosePath](../../aspose.svg/svgpathelement/createsvgpathsegclosepath/)() | 返回一个独立的、无父级的 SVGPathSegClosePath 对象。 |
| [CreateSVGPathSegCurvetoCubicAbs](../../aspose.svg/svgpathelement/createsvgpathsegcurvetocubicabs/)(*float, float, float, float, float, float*) | 返回一个独立的、无父级的 SVGPathSegCurvetoCubicAbs 对象。 |
| [CreateSVGPathSegCurvetoCubicRel](../../aspose.svg/svgpathelement/createsvgpathsegcurvetocubicrel/)(*float, float, float, float, float, float*) | 返回一个独立的、无父级的 SVGPathSegCurvetoCubicRel 对象。 |
| [CreateSVGPathSegCurvetoCubicSmoothAbs](../../aspose.svg/svgpathelement/createsvgpathsegcurvetocubicsmoothabs/)(*float, float, float, float*) | 返回一个独立的、无父级的 SVGPathSegCurvetoCubicSmoothAbs 对象。 |
| [CreateSVGPathSegCurvetoCubicSmoothRel](../../aspose.svg/svgpathelement/createsvgpathsegcurvetocubicsmoothrel/)(*float, float, float, float*) | 返回一个独立的、无父级的 SVGPathSegCurvetoCubicSmoothRel 对象。 |
| [CreateSVGPathSegCurvetoQuadraticAbs](../../aspose.svg/svgpathelement/createsvgpathsegcurvetoquadraticabs/)(*float, float, float, float*) | 返回一个独立的、无父级的 SVGPathSegCurvetoQuadraticAbs 对象。 |
| [CreateSVGPathSegCurvetoQuadraticRel](../../aspose.svg/svgpathelement/createsvgpathsegcurvetoquadraticrel/)(*float, float, float, float*) | 返回一个独立的、无父级的 SVGPathSegCurvetoQuadraticRel 对象。 |
| [CreateSVGPathSegCurvetoQuadraticSmoothAbs](../../aspose.svg/svgpathelement/createsvgpathsegcurvetoquadraticsmoothabs/)(*float, float*) | 返回一个独立的、无父级的 SVGPathSegCurvetoQuadraticSmoothAbs 对象。 |
| [CreateSVGPathSegCurvetoQuadraticSmoothRel](../../aspose.svg/svgpathelement/createsvgpathsegcurvetoquadraticsmoothrel/)(*float, float*) | 返回一个独立的、无父级的 SVGPathSegCurvetoQuadraticSmoothRel 对象。 |
| [CreateSVGPathSegLinetoAbs](../../aspose.svg/svgpathelement/createsvgpathseglinetoabs/)(*float, float*) | 返回一个独立的、无父级的 SVGPathSegLinetoAbs 对象。 |
| [CreateSVGPathSegLinetoHorizontalAbs](../../aspose.svg/svgpathelement/createsvgpathseglinetohorizontalabs/)(*float*) | 返回一个独立的、无父级的 SVGPathSegLinetoHorizontalAbs 对象。 |
| [CreateSVGPathSegLinetoHorizontalRel](../../aspose.svg/svgpathelement/createsvgpathseglinetohorizontalrel/)(*float*) | 返回一个独立的、无父级的 SVGPathSegLinetoHorizontalRel 对象。 |
| [CreateSVGPathSegLinetoRel](../../aspose.svg/svgpathelement/createsvgpathseglinetorel/)(*float, float*) | 返回一个独立的、无父级的 SVGPathSegLinetoRel 对象。 |
| [CreateSVGPathSegLinetoVerticalAbs](../../aspose.svg/svgpathelement/createsvgpathseglinetoverticalabs/)(*float*) | 返回一个独立的、无父级的 SVGPathSegLinetoVerticalAbs 对象。 |
| [CreateSVGPathSegLinetoVerticalRel](../../aspose.svg/svgpathelement/createsvgpathseglinetoverticalrel/)(*float*) | 返回一个独立的、无父级的 SVGPathSegLinetoVerticalRel 对象。 |
| [CreateSVGPathSegMovetoAbs](../../aspose.svg/svgpathelement/createsvgpathsegmovetoabs/)(*float, float*) | 返回一个独立的、无父级的 SVGPathSegMovetoAbs 对象。 |
| [CreateSVGPathSegMovetoRel](../../aspose.svg/svgpathelement/createsvgpathsegmovetorel/)(*float, float*) | 返回一个独立的、无父级的 SVGPathSegMovetoRel 对象。 |
