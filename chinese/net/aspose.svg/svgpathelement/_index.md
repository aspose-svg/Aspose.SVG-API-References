...
description: Aspose.Svg.SVGPathElement 班级. SVGPathElement 接口对应于路径元素
type: docs
weight: 3370
...
| 姓名 | 描述 |
| --- | --- |
| [AnimatedPathSegList](../../aspose.svg/svgpathelement/animatedpathseglist/) { get; } | 以与 SVG 语法一对一匹配的形式提供对“d”属性的当前动画内容的访问。如果给定的属性或属性正在动画，则包含属性或属性的当前动画值，并且对象本身及其内容都是只读的。如果给定的属性或属性当前未进行动画处理，则包含与 pathSegList. 相同的值 |
...
| [FarthestViewportElement](../../aspose.svg/svggraphicselement/farthestviewportelement/) { get; } | 最远的祖先“svg”元素。如果当前元素是最外层的 svg 元素，则为空。 |
...
| [NearestViewportElement](../../aspose.svg/svggraphicselement/nearestviewportelement/) { get; } | 建立当前视口的元素。通常，最近的祖先“svg”元素。如果当前元素是最外层的 svg 元素，则为空。 |
...
| [PathSegList](../../aspose.svg/svgpathelement/pathseglist/) { get; set; } | 以与 SVG 语法一对一匹配的形式提供对“d”属性的基本（即静态）内容的访问。 因此，如果“d”属性具有“绝对移动 (M)”和“绝对弧转 (A)”命令，则 pathSegList 将具有两个条目：SVG_PATHSEG_MOVETO_ABS 和 SVG_PATHSEG_ARC_ABS。 |
...
| [RequiredFeatures](../../aspose.svg/svggraphicselement/requiredfeatures/) { get; } | 对应于给定元素上的属性“requiredFeatures”。 |
...
| [SystemLanguage](../../aspose.svg/svggraphicselement/systemlanguage/) { get; } | 对应于给定元素上的属性“systemLanguage”。 |
...
| [Transform](../../aspose.svg/svggraphicselement/transform/) { get; } | 对应于给定元素上的属性“转换”。 |
...
| [CreateSVGPathSegArcAbs](../../aspose.svg/svgpathelement/createsvgpathsegarcabs/)(float, float, float, float, float, bool, bool) | 返回一个独立的、无父项的 SVGPathSegArcAbs 对象。 |
| [CreateSVGPathSegArcRel](../../aspose.svg/svgpathelement/createsvgpathsegarcrel/)(float, float, float, float, float, bool, bool) | 返回一个独立的、无父项的 SVGPathSegArcRel 对象。 |
| [CreateSVGPathSegClosePath](../../aspose.svg/svgpathelement/createsvgpathsegclosepath/)() | 返回一个独立的、无父项的 SVGPathSegClosePath 对象。 |
| [CreateSVGPathSegCurvetoCubicAbs](../../aspose.svg/svgpathelement/createsvgpathsegcurvetocubicabs/)(float, float, float, float, float, float) | 返回一个独立的、无父项的 SVGPathSegCurvetoCubicAbs 对象。 |
| [CreateSVGPathSegCurvetoCubicRel](../../aspose.svg/svgpathelement/createsvgpathsegcurvetocubicrel/)(float, float, float, float, float, float) | 返回一个独立的、无父项的 SVGPathSegCurvetoCubicRel 对象。 |
| [CreateSVGPathSegCurvetoCubicSmoothAbs](../../aspose.svg/svgpathelement/createsvgpathsegcurvetocubicsmoothabs/)(float, float, float, float) | 返回一个独立的、无父项的 SVGPathSegCurvetoCubicSmoothAbs 对象。 |
| [CreateSVGPathSegCurvetoCubicSmoothRel](../../aspose.svg/svgpathelement/createsvgpathsegcurvetocubicsmoothrel/)(float, float, float, float) | 返回一个独立的、无父项的 SVGPathSegCurvetoCubicSmoothRel 对象。 |
| [CreateSVGPathSegCurvetoQuadraticAbs](../../aspose.svg/svgpathelement/createsvgpathsegcurvetoquadraticabs/)(float, float, float, float) | 返回一个独立的、无父项的 SVGPathSegCurvetoQuadraticAbs 对象。 |
| [CreateSVGPathSegCurvetoQuadraticRel](../../aspose.svg/svgpathelement/createsvgpathsegcurvetoquadraticrel/)(float, float, float, float) | 返回一个独立的、无父项的 SVGPathSegCurvetoQuadraticRel 对象。 |
| [CreateSVGPathSegCurvetoQuadraticSmoothAbs](../../aspose.svg/svgpathelement/createsvgpathsegcurvetoquadraticsmoothabs/)(float, float) | 返回一个独立的、无父项的 SVGPathSegCurvetoQuadraticSmoothAbs 对象。 |
| [CreateSVGPathSegCurvetoQuadraticSmoothRel](../../aspose.svg/svgpathelement/createsvgpathsegcurvetoquadraticsmoothrel/)(float, float) | 返回一个独立的、无父项的 SVGPathSegCurvetoQuadraticSmoothRel 对象。 |
| [CreateSVGPathSegLinetoAbs](../../aspose.svg/svgpathelement/createsvgpathseglinetoabs/)(float, float) | 返回一个独立的、无父项的 SVGPathSegLinetoAbs 对象。 |
| [CreateSVGPathSegLinetoHorizontalAbs](../../aspose.svg/svgpathelement/createsvgpathseglinetohorizontalabs/)(float) | 返回一个独立的、无父项的 SVGPathSegLinetoHorizontalAbs 对象。 |
| [CreateSVGPathSegLinetoHorizontalRel](../../aspose.svg/svgpathelement/createsvgpathseglinetohorizontalrel/)(float) | 返回一个独立的、无父项的 SVGPathSegLinetoHorizontalRel 对象。 |
| [CreateSVGPathSegLinetoRel](../../aspose.svg/svgpathelement/createsvgpathseglinetorel/)(float, float) | 返回一个独立的、无父项的 SVGPathSegLinetoRel 对象。 |
| [CreateSVGPathSegLinetoVerticalAbs](../../aspose.svg/svgpathelement/createsvgpathseglinetoverticalabs/)(float) | 返回一个独立的、无父项的 SVGPathSegLinetoVerticalAbs 对象。 |
| [CreateSVGPathSegLinetoVerticalRel](../../aspose.svg/svgpathelement/createsvgpathseglinetoverticalrel/)(float) | 返回一个独立的、无父项的 SVGPathSegLinetoVerticalRel 对象。 |
| [CreateSVGPathSegMovetoAbs](../../aspose.svg/svgpathelement/createsvgpathsegmovetoabs/)(float, float) | 返回一个独立的、无父项的 SVGPathSegMovetoAbs 对象。 |
| [CreateSVGPathSegMovetoRel](../../aspose.svg/svgpathelement/createsvgpathsegmovetorel/)(float, float) | 返回一个独立的、无父项的 SVGPathSegMovetoRel 对象。 |
...
| [GetBBox](../../aspose.svg/svggraphicselement/getbbox/)() | 返回当前用户空间中的紧密边界框（即，在应用“变换”属性之后，如果有的话）所有包含的图形元素的几何图形，不包括描边、剪裁、遮罩和过滤效果）。请注意，getBBox 必须在调用该方法时返回实际的边界框，即使元素尚未呈现。 |
| [GetCTM](../../aspose.svg/svggraphicselement/getctm/)() | 返回从当前用户单位（即，在应用“转换”属性后，如果有的话）到最近的 ViewportElement 的视口坐标系的转换矩阵。 |
...
| [GetEquivalentPath](../../aspose.svg/svggeometryelement/getequivalentpath/)() | 返回一个新的实例实例[`SVGPathSegList`](../../aspose.svg.paths/svgpathseglist/)这代表[`SVGGeometryElement`](../svggeometryelement/)作为路径段. |
| virtual [GetPlatformType](../../aspose.svg.dom/domobject/getplatformtype/)() | 此方法用于检索 ECMAScript 对象Type . |
| [GetPointAtLength](../../aspose.svg/svggeometryelement/getpointatlength/)(float) | 返回用户空间中的 (x,y) 坐标，它是沿路径的距离单位，利用用户代理的沿路径距离算法。 |
| [GetScreenCTM](../../aspose.svg/svggraphicselement/getscreenctm/)() | 返回从当前用户单元（即，在应用“转换”属性后，如果有的话）到父用户代理对“像素”的通知的转换矩阵。对于显示设备，理想情况下这代表一个物理屏幕像素。对于物理像素大小未知的其他设备或环境，则可以改用类似于 CSS2 定义“像素”的算法。请注意，如果此元素未挂接到文档树中，则返回 null。此方法更恰当地命名为 getClientCTM，但由于历史原因保留了名称 getScreenCTM. |
| [GetTotalLength](../../aspose.svg/svggeometryelement/gettotallength/)() | 返回用户代理使用用户代理的沿路径距离算法为路径总长度计算的值，作为当前用户坐标系中的距离。 |
