...
| [Transform](../../aspose.svg/svggraphicselement/transform) { get; } | 对应于给定元素的“变换”属性。 |
...
| [CreateSVGPathSegArcAbs](../../aspose.svg/svgpathelement/createsvgpathsegarcabs)(float, float, float, float, float, bool, bool) | 返回一个独立的无父 SVGPathSegArcAbs 对象。 |
| [CreateSVGPathSegArcRel](../../aspose.svg/svgpathelement/createsvgpathsegarcrel)(float, float, float, float, float, bool, bool) | 返回一个独立的无父 SVGPathSegArcRel 对象。 |
| [CreateSVGPathSegClosePath](../../aspose.svg/svgpathelement/createsvgpathsegclosepath)() | 返回一个独立的无父 SVGPathSegClosePath 对象。 |
...
| [CreateSVGPathSegCurvetoCubicSmoothAbs](../../aspose.svg/svgpathelement/createsvgpathsegcurvetocubicsmoothabs)(float, float, float, float) | 返回一个独立的无父 SVGPathSegCurvetoCubicSmoothAbs 对象。 |
| [CreateSVGPathSegCurvetoCubicSmoothRel](../../aspose.svg/svgpathelement/createsvgpathsegcurvetocubicsmoothrel)(float, float, float, float) | 返回一个独立的无父 SVGPathSegCurvetoCubicSmoothRel 对象。 |
| [CreateSVGPathSegCurvetoQuadraticAbs](../../aspose.svg/svgpathelement/createsvgpathsegcurvetoquadraticabs)(float, float, float, float) | 返回一个独立的无父 SVGPathSegCurvetoQuadraticAbs 对象。 |
| [CreateSVGPathSegCurvetoQuadraticRel](../../aspose.svg/svgpathelement/createsvgpathsegcurvetoquadraticrel)(float, float, float, float) | 返回一个独立的无父 SVGPathSegCurvetoQuadraticRel 对象。 |
| [CreateSVGPathSegCurvetoQuadraticSmoothAbs](../../aspose.svg/svgpathelement/createsvgpathsegcurvetoquadraticsmoothabs)(float, float) | 返回一个独立的无父 SVGPathSegCurvetoQuadraticSmoothAbs 对象。 |
| [CreateSVGPathSegCurvetoQuadraticSmoothRel](../../aspose.svg/svgpathelement/createsvgpathsegcurvetoquadraticsmoothrel)(float, float) | 返回一个独立的无父 SVGPathSegCurvetoQuadraticSmoothRel 对象。 |
...
| [CreateSVGPathSegLinetoHorizontalAbs](../../aspose.svg/svgpathelement/createsvgpathseglinetohorizontalabs)(float) | 返回一个独立的无父 SVGPathSegLinetoHorizontalAbs 对象。 |
| [CreateSVGPathSegLinetoHorizontalRel](../../aspose.svg/svgpathelement/createsvgpathseglinetohorizontalrel)(float) | 返回一个独立的无父 SVGPathSegLinetoHorizontalRel 对象。 |
...
| [CreateSVGPathSegLinetoVerticalAbs](../../aspose.svg/svgpathelement/createsvgpathseglinetoverticalabs)(float) | 返回一个独立的无父 SVGPathSegLinetoVerticalAbs 对象。 |
...
| [CreateSVGPathSegMovetoRel](../../aspose.svg/svgpathelement/createsvgpathsegmovetorel)(float, float) | 返回一个独立的无父 SVGPathSegMovetoRel 对象。 |
...
| [GetBBox](../../aspose.svg/svggraphicselement/getbbox)() | 返回当前用户空间中的紧密边界框（即，在应用“变换”属性后，如果有的话）所有包含的图形元素的几何图形，不包括描边、剪裁、遮罩和过滤效果）。请注意，getBBox 必须在调用方法时返回实际的边界框，即使元素尚未渲染。 |
| [GetCTM](../../aspose.svg/svggraphicselement/getctm)() | 返回从当前用户单元（即，在应用 'transform' 属性后，如果有的话）到最近视口元素的视口坐标系的变换矩阵。 |
...
| [GetScreenCTM](../../aspose.svg/svggraphicselement/getscreenctm)() | 从当前用户单元（即，在应用 'transform' 属性后，如果有的话）返回转换矩阵到父用户代理的“像素”通知。对于显示设备，理想情况下这表示物理屏幕像素。对于不知道物理像素大小的其他设备或环境，可以使用类似于 CSS2 定义的“像素”的算法。请注意，如果此元素未挂接到文档树，则返回 null。这种方法更贴切地命名为 getClientCTM，但由于历史原因，名称 getScreenCTM 被保留。 |
| [GetTotalLength](../../aspose.svg/svggeometryelement/gettotallength)() | 返回用户代理使用用户代理的路径距离算法计算的路径总长度值，作为当前用户坐标系中的距离。 |
