...
description: "Aspose.Svg.SVGAnimateTransformElement 类。SVGAnimateTransformElement 接口对应于 animateTransform 元素。通过 SVG DOM 对 animateTransform 元素属性的面向对象访问不可用"
type: docs
weight: 5180
...
该 SVGAnimateTransformElement 接口对应于 ‘animateTransform’ 元素。通过 SVG DOM 对 ‘animateTransform’ 元素属性的面向对象访问不可用。
