...
description: SVGAnimateTransformElement 接口对应于animateTransform元素 无法通过 SVG DOM 对animateTransform元素的属性进行面向对象的访问
type: docs
weight: 3060
...
| [TargetElement](../../aspose.svg/svganimationelement/targetelement) { get; } | 正在动画的元素。 |
