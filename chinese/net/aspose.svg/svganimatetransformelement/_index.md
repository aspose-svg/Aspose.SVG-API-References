...
description: SVGAnimateTransformElement 接口对应于 animateTransform 元素 无法通过 SVG DOM 以面向对象的方式访问animateTransform元素的属性
type: docs
weight: 3050
url: /zh/net/aspose.svg/svganimatetransformelement/
---
## SVGAnimateTransformElement class

SVGAnimateTransformElement 接口对应于 'animateTransform' 元素。 无法通过 SVG DOM 以面向对象的方式访问“animateTransform”元素的属性。
...
| [RequiredExtensions](../../aspose.svg/svganimationelement/requiredextensions) { get; } | 对应于给定元素上的属性“requiredExtensions”。 |
| [RequiredFeatures](../../aspose.svg/svganimationelement/requiredfeatures) { get; } | 对应于给定元素的属性“requiredFeatures”。 |
...
| [SystemLanguage](../../aspose.svg/svganimationelement/systemlanguage) { get; } | 对应于给定元素的属性“systemLanguage”。 |
| [TagName](../../aspose.svg.dom/element/tagname) { get; } | 元素的名称。 |
| [TargetElement](../../aspose.svg/svganimationelement/targetelement) { get; } | 动画元素。 |
