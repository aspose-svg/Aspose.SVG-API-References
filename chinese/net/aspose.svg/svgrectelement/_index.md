...
description: "Aspose.Svg.SVGRectElement 类。SVGRectElement 接口对应于 rect 元素"
type: docs
weight: 5490
...
| [Height](../../aspose.svg/svgrectelement/height/) { get; } | 对应给定 ‘rect’ 元素的属性 ‘height’。 |
...
| [Rx](../../aspose.svg/svgrectelement/rx/) { get; } | 对应给定 ‘rect’ 元素的属性 ‘rx’。 |
| [Ry](../../aspose.svg/svgrectelement/ry/) { get; } | 对应给定 ‘rect’ 元素的属性 ‘ry’。 |
...
| [Width](../../aspose.svg/svgrectelement/width/) { get; } | 对应给定 ‘rect’ 元素的属性 ‘width’。 |
| [X](../../aspose.svg/svgrectelement/x/) { get; } | 对应给定 ‘rect’ 元素的属性 ‘x’。 |
| [Y](../../aspose.svg/svgrectelement/y/) { get; } | 对应给定 ‘rect’ 元素的属性 ‘y’。 |
