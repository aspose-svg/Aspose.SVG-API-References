...
description: "Aspose.Svg.SVGClipPathElement 类。SVGClipPathElement 接口对应于 clipPath 元素"
type: docs
weight: 5210
...
| [ClipPathUnits](../../aspose.svg/svgclippathelement/clippathunits/) { get; } | 对应于给定 ‘clipPath’ 元素上的属性 ‘clipPathUnits’。取自 SVGUnitTypes 中定义的常量之一。 |
...
| [Transform](../../aspose.svg/svgclippathelement/transform/) { get; } | 对应给定元素上的属性 ‘transform’。 |
