...
description: SVGTextPathElement 接口对应于textPath 元素
type: docs
weight: 3480
url: /zh/net/aspose.svg/svgtextpathelement/
---
...
| [Href](../../aspose.svg/svgtextpathelement/href) { get; } | 对应于给定元素上的属性“xlink:href”。 |
...
| [LengthAdjust](../../aspose.svg/svgtextcontentelement/lengthadjust) { get; } | 对应于给定元素的属性“lengthAdjust”。该值必须是此接口上定义的长度调整常量之一。 |
...
| [Method](../../aspose.svg/svgtextpathelement/method) { get; } | 对应于给定 'textPath' 元素的属性 'method'。 |
...
| [Spacing](../../aspose.svg/svgtextpathelement/spacing) { get; } | 对应于给定 'textPath' 元素上的属性 'spacing'。 |
| [StartOffset](../../aspose.svg/svgtextpathelement/startoffset) { get; } | 对应于给定 'textPath' 元素的属性 'startOffset'。 |
...
| [TextLength](../../aspose.svg/svgtextcontentelement/textlength) { get; } | 对应于给定元素的属性“textLength”。 |
...
| [GetComputedTextLength](../../aspose.svg/svgtextcontentelement/getcomputedtextlength)() | 渲染此元素内所有字符的所有提前值的总和，包括字形上的提前值（水平或垂直），属性“紧缩”的效果, 'letter-spacing' 和 'word-spacing' 以及由于 'tspan' 元素上的属性 'dx' 和 'dy' 的调整。对于非渲染环境，用户代理应对字形指标做出合理的假设。 |
...
| [GetNumberOfChars](../../aspose.svg/svgtextcontentelement/getnumberofchars)() | 返回当前元素中可渲染的字符总数，包括来自 'tref' 引用的引用字符，无论它们是否会被渲染。实际上，这相当于 DOM Level 3 Core（[DOM3]，第 1.4 节）中 Node::textContent 属性的长度，如果该属性还扩展了“tref”元素。 |
...
| 姓名 | 描述 |
| --- | --- |
| const [TEXTPATH_METHODTYPE_ALIGN](../../aspose.svg/svgtextpathelement/textpath_methodtype_align) | 对应于值“对齐”。 |
| const [TEXTPATH_METHODTYPE_STRETCH](../../aspose.svg/svgtextpathelement/textpath_methodtype_stretch) | 对应于值“拉伸”。 |
| const [TEXTPATH_METHODTYPE_UNKNOWN](../../aspose.svg/svgtextpathelement/textpath_methodtype_unknown) | 枚举设置为不是预定义类型之一的值。尝试定义此类型的新值或尝试将现有值切换到此类型是无效的。 |
| const [TEXTPATH_SPACINGTYPE_AUTO](../../aspose.svg/svgtextpathelement/textpath_spacingtype_auto) | 对应于值“自动”。 |
| const [TEXTPATH_SPACINGTYPE_EXACT](../../aspose.svg/svgtextpathelement/textpath_spacingtype_exact) | 对应于值“精确”。 |
| const [TEXTPATH_SPACINGTYPE_UNKNOWN](../../aspose.svg/svgtextpathelement/textpath_spacingtype_unknown) | 枚举设置为不是预定义类型之一的值。尝试定义此类型的新值或尝试将现有值切换到此类型是无效的。 |
