...
description: "Aspose.Svg.SVGTextPathElement 类。SVGTextPathElement 接口对应于 textPath 元素。"
type: docs
weight: 5610
...
| [Href](../../aspose.svg/svgtextpathelement/href/) { get; } | 对应给定元素上的属性 ‘xlink:href’。 |
...
| [LengthAdjust](../../aspose.svg/svgtextcontentelement/lengthadjust/) { get; } | 对应给定元素的属性 ‘lengthAdjust’。该值必须是此接口中定义的长度调整常量之一。 |
...
| [Spacing](../../aspose.svg/svgtextpathelement/spacing/) { get; } | 对应于给定 ‘textPath’ 元素的属性 ‘spacing’。 |
...
| [TextLength](../../aspose.svg/svgtextcontentelement/textlength/) { get; } | 对应给定元素的属性 ‘textLength’。 |
...
| [GetComputedTextLength](../../aspose.svg/svgtextcontentelement/getcomputedtextlength/)() | 该元素内部渲染所有字符的所有前进值的总和，包括字形（水平或垂直）的前进值、属性 ‘kerning’、‘letter-spacing’ 和 ‘word-spacing’ 的影响以及 ‘tspan’ 元素上属性 ‘dx’ 和 ‘dy’ 的调整。对于非渲染环境，用户代理应对字形度量做出合理假设。 |
...
| [GetNumberOfChars](../../aspose.svg/svgtextcontentelement/getnumberofchars/)() | 返回当前元素内可用于渲染的字符总数，包括来自 ‘tref’ 引用的字符，无论是否实际渲染。实际上，这等同于 DOM Level 3 Core（[DOM3]，第 1.4 节）中 Node::textContent 属性的长度，如果该属性同样展开了 ‘tref’ 元素的话。 |
...
| 名称 | 描述 |
| --- | --- |
| const [TEXTPATH_METHODTYPE_ALIGN](../../aspose.svg/svgtextpathelement/textpath_methodtype_align/) | 对应于值 'align'。 |
| const [TEXTPATH_METHODTYPE_STRETCH](../../aspose.svg/svgtextpathelement/textpath_methodtype_stretch/) | 对应于值 'stretch'。 |
| const [TEXTPATH_METHODTYPE_UNKNOWN](../../aspose.svg/svgtextpathelement/textpath_methodtype_unknown/) | 枚举被设置为非预定义类型之一的值。尝试为此类型定义新值或尝试将现有值切换到此类型都是无效的。 |
...
| const [TEXTPATH_SPACINGTYPE_UNKNOWN](../../aspose.svg/svgtextpathelement/textpath_spacingtype_unknown/) | 枚举被设置为非预定义类型之一的值。尝试为此类型定义新值或尝试将现有值切换到此类型都是无效的。 |
