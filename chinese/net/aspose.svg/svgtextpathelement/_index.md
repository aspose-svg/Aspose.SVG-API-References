...
description: SVGTextPathElement 接口对应于textPath元素
type: docs
weight: 3490
...
| [Method](../../aspose.svg/svgtextpathelement/method) { get; } | 对应于给定“textPath”元素的属性“方法”。 |
...
| [Spacing](../../aspose.svg/svgtextpathelement/spacing) { get; } | 对应于给定“textPath”元素的属性“间距”。 |
...
| [GetComputedTextLength](../../aspose.svg/svgtextcontentelement/getcomputedtextlength)() | 渲染此元素中所有字符的所有提前值的总和，包括字形上的提前值（水平或垂直）、属性“字距调整”、“字母间距”和“单词- 'tspan' 元素上的属性 'dx' 和 'dy' 导致的间距和调整。对于非渲染环境，用户代理应对字形指标做出合理的假设。 |
...
| [GetNumberOfChars](../../aspose.svg/svgtextcontentelement/getnumberofchars)() | 返回当前元素中可用于渲染的字符总数，其中包括来自“tref”引用的引用字符，无论它们是否会被渲染。实际上，这等效于 DOM Level 3 Core（[DOM3]，第 1.4 节）中 Node::textContent 属性的长度，如果该属性还扩展了“tref”元素。 |
