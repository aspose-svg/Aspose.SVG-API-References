...
description: Aspose.Svg.SVGTextPathElement 班级. SVGTextPathElement 接口对应于textPath元素
type: docs
weight: 3540
...
| [LengthAdjust](../../aspose.svg/svgtextcontentelement/lengthadjust/) { get; } | 对应于给定元素上的属性“lengthAdjust”。该值必须是在此接口上定义的长度调整常量之一。 |
...
| [Method](../../aspose.svg/svgtextpathelement/method/) { get; } | 对应于给定“textPath”元素上的属性“method”。 |
...
| [StartOffset](../../aspose.svg/svgtextpathelement/startoffset/) { get; } | 对应于给定“textPath”元素上的属性“startOffset”。 |
...
| [TextLength](../../aspose.svg/svgtextcontentelement/textlength/) { get; } | 对应于给定元素上的属性“textLength”。 |
...
| [GetComputedTextLength](../../aspose.svg/svgtextcontentelement/getcomputedtextlength/)() | 渲染该元素内所有字符的所有高级值的总和，包括字形（水平或垂直）上的高级值、属性“kerning”、“letter-spacing”和“word-”的效果间距”和由于“tspan”元素上的属性“dx”和“dy”而进行的调整。对于非渲染环境，用户代理应对字形指标做出合理的假设。 |
...
| [GetNumberOfChars](../../aspose.svg/svgtextcontentelement/getnumberofchars/)() | 返回当前元素中可用于渲染的字符总数，其中包括来自“tref”引用的引用字符，无论它们是否将被渲染。实际上，这相当于来自 DOM Level 3 Core（[DOM3]，第 1.4 节）的 Node::textContent 属性的长度，如果该属性也扩展了“tref”元素。 |
...
| 姓名 | 描述 |
| --- | --- |
| const [TEXTPATH_METHODTYPE_ALIGN](../../aspose.svg/svgtextpathelement/textpath_methodtype_align/) | 对应值 'align'. |
| const [TEXTPATH_METHODTYPE_STRETCH](../../aspose.svg/svgtextpathelement/textpath_methodtype_stretch/) | 对应于值 'stretch'. |
| const [TEXTPATH_METHODTYPE_UNKNOWN](../../aspose.svg/svgtextpathelement/textpath_methodtype_unknown/) | 枚举设置为不是预定义类型之一的值。尝试定义此类型的新值或尝试将现有值切换为此类型是无效的。 |
| const [TEXTPATH_SPACINGTYPE_AUTO](../../aspose.svg/svgtextpathelement/textpath_spacingtype_auto/) | 对应于值 'auto'. |
| const [TEXTPATH_SPACINGTYPE_EXACT](../../aspose.svg/svgtextpathelement/textpath_spacingtype_exact/) | 对应于值 'exact'. |
| const [TEXTPATH_SPACINGTYPE_UNKNOWN](../../aspose.svg/svgtextpathelement/textpath_spacingtype_unknown/) | 枚举设置为不是预定义类型之一的值。尝试定义此类型的新值或尝试将现有值切换为此类型是无效的。 |
