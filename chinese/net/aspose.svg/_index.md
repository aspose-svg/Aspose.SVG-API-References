...
description: 中的所有类 Aspose.Svg.Dom.Svg命名空间基于 w3c SVG2 建议使用此命名空间您可以根据需要加载 导航或渲染 SVG 文件
type: docs
weight: 10
url: /zh/net/aspose.svg/
---
中的所有类 **Aspose.Svg.Dom.Svg**命名空间基于 w3c SVG2 建议。使用此命名空间，您可以根据需要加载、 导航或渲染 SVG 文件。
