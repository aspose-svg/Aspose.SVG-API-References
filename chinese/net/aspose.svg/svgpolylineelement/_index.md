...
description: SVGPolylineElement 接口对应于折线元素
type: docs
weight: 3340
url: /zh/net/aspose.svg/svgpolylineelement/
---
## SVGPolylineElement class

SVGPolylineElement 接口对应于“折线”元素。
...
| 姓名 | 描述 |
| --- | --- |
| [AnimatedPoints](../../aspose.svg/svgpolylineelement/animatedpoints) { get; } | 提供对“points”属性的当前动画内容的访问。如果给定的属性或属性正在被动画化，则包含属性或属性的当前动画值。如果给定的属性或属性当前没有被动画化，则包含与点相同的值。 |
...
| [Points](../../aspose.svg/svgpolylineelement/points) { get; } | 提供对“points”属性的基本（即静态）内容的访问。 |
