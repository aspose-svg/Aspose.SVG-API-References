...
description: "Aspose.Svg.SVGPolylineElement 类。SVGPolylineElement 接口对应于 polyline 元素。"
type: docs
weight: 5470
...
| 名称 | 描述 |
| --- | --- |
| [AnimatedPoints](../../aspose.svg/svgpolylineelement/animatedpoints/) { get; } | 提供对 ‘points’ 属性当前动画内容的访问。如果给定的属性或属性正在动画中，则包含该属性或属性的当前动画值。如果给定的属性或属性当前未动画，则包含与 points 相同的值。 |
...
| [Points](../../aspose.svg/svgpolylineelement/points/) { get; } | 提供对 ‘points’ 属性基础（即静态）内容的访问。 |
