...
description: "Aspose.Svg.SVGAnimateElement 类。SVGAnimateElement 接口对应于 animate 元素。通过 SVG DOM 对 animate 元素属性的面向对象访问不可用"
type: docs
weight: 5160
...
该 SVGAnimateElement 接口对应于 ‘animate’ 元素。通过 SVG DOM 对 ‘animate’ 元素属性的面向对象访问不可用。
