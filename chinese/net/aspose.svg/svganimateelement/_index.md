...
description: SVGAnimateElement 接口对应于 animate 元素 无法通过 SVG DOM 以面向对象的方式访问动画元素的属性
type: docs
weight: 3030
url: /zh/net/aspose.svg/svganimateelement/
---
## SVGAnimateElement class

SVGAnimateElement 接口对应于 'animate' 元素。 无法通过 SVG DOM 以面向对象的方式访问“动画”元素的属性。
