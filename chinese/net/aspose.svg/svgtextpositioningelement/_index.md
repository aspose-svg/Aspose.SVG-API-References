...
description: "Aspose.Svg.SVGTextPositioningElement 类。SVGTextPositioningElement 接口被文本相关接口 SVGTextElement、SVGTSpanElement、SVGTRefElement 和 SVGAltGlyphElement 继承。"
type: docs
weight: 5620
...
| [Dx](../../aspose.svg/svgtextpositioningelement/dx/) { get; } | 对应给定元素的属性 ‘dx’。 |
| [Dy](../../aspose.svg/svgtextpositioningelement/dy/) { get; } | 对应给定元素的属性 ‘dy’。 |
...
| [Rotate](../../aspose.svg/svgtextpositioningelement/rotate/) { get; } | 对应给定元素的属性 ‘rotate’。 |
...
| [X](../../aspose.svg/svgtextpositioningelement/x/) { get; } | 对应给定元素的属性 ‘x’。 |
| [Y](../../aspose.svg/svgtextpositioningelement/y/) { get; } | 对应给定元素上的属性 ‘y’。 |
