...
description: "Aspose.Svg.SVGMaskElement 类。SVGMaskElement 接口对应于 mask 元素。"
type: docs
weight: 5420
...
| [Height](../../aspose.svg/svgmaskelement/height/) { get; } | 对应于给定 ‘mask’ 元素的属性 ‘height’。取自 SVGUnitTypes 中定义的常量之一。 |
...
| [MaskContentUnits](../../aspose.svg/svgmaskelement/maskcontentunits/) { get; } | 对应于给定 ‘mask’ 元素上的属性 ‘maskContentUnits’。取自 SVGUnitTypes 中定义的常量之一。 |
| [MaskUnits](../../aspose.svg/svgmaskelement/maskunits/) { get; } | 对应于给定 ‘mask’ 元素上的属性 ‘maskUnits’。取自 SVGUnitTypes 中定义的常量之一。 |
...
| [RequiredExtensions](../../aspose.svg/svgmaskelement/requiredextensions/) { get; } | 对应于给定元素的 ‘requiredExtensions’ 属性。 |
| [RequiredFeatures](../../aspose.svg/svgmaskelement/requiredfeatures/) { get; } | 对应于给定元素的 ‘requiredFeatures’ 属性。 |
...
| [SystemLanguage](../../aspose.svg/svgmaskelement/systemlanguage/) { get; } | 对应于给定元素的 ‘systemLanguage’ 属性。 |
...
| [Width](../../aspose.svg/svgmaskelement/width/) { get; } | 对应于给定 ‘mask’ 元素上的属性 ‘width’。取自 SVGUnitTypes 中定义的常量之一。 |
| [X](../../aspose.svg/svgmaskelement/x/) { get; } | 对应于给定 ‘mask’ 元素上的属性 ‘x’。取自 SVGUnitTypes 中定义的常量之一。 |
| [Y](../../aspose.svg/svgmaskelement/y/) { get; } | 对应于给定 ‘mask’ 元素上的属性 ‘y’。取自 SVGUnitTypes 中定义的常量之一。 |
