...
description: "Aspose.Svg.SVGRadialGradientElement 类。SVGRadialGradientElement 接口对应 radialGradient 元素"
type: docs
weight: 5480
...
| [Cx](../../aspose.svg/svgradialgradientelement/cx/) { get; } | 对应给定 ‘radialGradient’ 元素上的属性 ‘cx’。 |
| [Cy](../../aspose.svg/svgradialgradientelement/cy/) { get; } | 对应给定 ‘radialGradient’ 元素上的属性 ‘cy’。 |
...
| [Fr](../../aspose.svg/svgradialgradientelement/fr/) { get; } | 对应给定 ‘radialGradient’ 元素上的属性 ‘fr’。 |
| [Fx](../../aspose.svg/svgradialgradientelement/fx/) { get; } | 对应给定 ‘radialGradient’ 元素上的属性 ‘fx’。 |
| [Fy](../../aspose.svg/svgradialgradientelement/fy/) { get; } | 对应给定 ‘radialGradient’ 元素上的属性 ‘fy’。 |
...
| [R](../../aspose.svg/svgradialgradientelement/r/) { get; } | 对应给定 ‘radialGradient’ 元素上的属性 ‘r’。 |
