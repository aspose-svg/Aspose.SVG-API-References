...
description: "Aspose.Svg.SVGComponentTransferFunctionElement 类。此接口定义了组件传输函数接口使用的基础接口。"
type: docs
weight: 5220
...
| 名称 | 描述 |
| --- | --- |
| [Amplitude](../../aspose.svg/svgcomponenttransferfunctionelement/amplitude/) { get; } | 对应给定元素的属性 ‘amplitude’。 |
...
| [Exponent](../../aspose.svg/svgcomponenttransferfunctionelement/exponent/) { get; } | 对应给定元素的属性 ‘exponent’。 |
...
| [Intercept](../../aspose.svg/svgcomponenttransferfunctionelement/intercept/) { get; } | 对应给定元素的属性 ‘intercept’。 |
...
| [Offset](../../aspose.svg/svgcomponenttransferfunctionelement/offset/) { get; } | 对应给定元素的属性 ‘offset’。 |
...
| [Slope](../../aspose.svg/svgcomponenttransferfunctionelement/slope/) { get; } | 对应给定元素的属性 ‘slope’。 |
| [Style](../../aspose.svg/svgelement/style/) { get; } | 对应于给定元素的 ‘style’ 属性。如果用户代理不支持 CSS 样式，则此属性必须始终为 null。 |
| [TableValues](../../aspose.svg/svgcomponenttransferfunctionelement/tablevalues/) { get; } | 对应给定元素的属性 ‘tableValues’。 |
...
| [Type](../../aspose.svg/svgcomponenttransferfunctionelement/type/) { get; } | 对应给定元素的属性 ‘type’。取值为此接口中定义的 SVG_FECOMPONENTTRANSFER_TYPE_* 常量之一。 |
...
| 名称 | 描述 |
| --- | --- |
| const [SVG_FECOMPONENTTRANSFER_TYPE_DISCRETE](../../aspose.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_discrete/) | 对应值 'discrete'。 |
| const [SVG_FECOMPONENTTRANSFER_TYPE_GAMMA](../../aspose.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_gamma/) | 对应值 'gamma'。 |
| const [SVG_FECOMPONENTTRANSFER_TYPE_IDENTITY](../../aspose.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_identity/) | 对应值 'identity'。 |
| const [SVG_FECOMPONENTTRANSFER_TYPE_LINEAR](../../aspose.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_linear/) | 对应值 'linear'。 |
| const [SVG_FECOMPONENTTRANSFER_TYPE_TABLE](../../aspose.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_table/) | 对应值 'table'。 |
| const [SVG_FECOMPONENTTRANSFER_TYPE_UNKNOWN](../../aspose.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_unknown/) | 该类型不是预定义类型之一。尝试为此类型定义新值或尝试将现有值切换到此类型都是无效的。 |
