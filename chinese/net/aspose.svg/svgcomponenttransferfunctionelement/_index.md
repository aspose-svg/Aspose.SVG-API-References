...
type: docs
weight: 3090
url: /zh/net/aspose.svg/svgcomponenttransferfunctionelement/
---
...
| 姓名 | 描述 |
| --- | --- |
| [Amplitude](../../aspose.svg/svgcomponenttransferfunctionelement/amplitude) { get; } | 对应于给定元素上的属性“幅度”。 |
...
| [Exponent](../../aspose.svg/svgcomponenttransferfunctionelement/exponent) { get; } | 对应于给定元素的属性“指数”。 |
...
| [Intercept](../../aspose.svg/svgcomponenttransferfunctionelement/intercept) { get; } | 对应于给定元素上的属性“拦截”。 |
...
| [Offset](../../aspose.svg/svgcomponenttransferfunctionelement/offset) { get; } | 对应于给定元素的属性“偏移”。 |
...
| [Slope](../../aspose.svg/svgcomponenttransferfunctionelement/slope) { get; } | 对应于给定元素的属性“斜率”。 |
| [Style](../../aspose.svg/svgelement/style) { get; } | 对应于给定元素的属性“样式”。如果用户代理不支持 CSS 样式，则此属性必须始终具有 null 值。 |
| [TableValues](../../aspose.svg/svgcomponenttransferfunctionelement/tablevalues) { get; } | 对应于给定元素的属性“tableValues”。 |
...
| [Type](../../aspose.svg/svgcomponenttransferfunctionelement/type) { get; } | 对应于给定元素的属性“类型”。采用在此接口上定义的 SVG_FECOMPONENTTRANSFER_TYPE_* 常量之一。 |
...
| 姓名 | 描述 |
| --- | --- |
| const [SVG_FECOMPONENTTRANSFER_TYPE_DISCRETE](../../aspose.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_discrete) | 对应于值“离散”。 |
| const [SVG_FECOMPONENTTRANSFER_TYPE_GAMMA](../../aspose.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_gamma) | 对应于值 'gamma'。 |
| const [SVG_FECOMPONENTTRANSFER_TYPE_IDENTITY](../../aspose.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_identity) | 对应于值“身份”。 |
| const [SVG_FECOMPONENTTRANSFER_TYPE_LINEAR](../../aspose.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_linear) | 对应于值“线性”。 |
| const [SVG_FECOMPONENTTRANSFER_TYPE_TABLE](../../aspose.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_table) | 对应于值'table'。 |
| const [SVG_FECOMPONENTTRANSFER_TYPE_UNKNOWN](../../aspose.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_unknown) | 该类型不是预定义类型之一。尝试定义此类型的新值或尝试将现有值切换到此类型是无效的。 |
