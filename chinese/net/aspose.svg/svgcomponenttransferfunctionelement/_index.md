...
| [Offset](../../aspose.svg/svgcomponenttransferfunctionelement/offset) { get; } | 对应于给定元素上的属性“偏移”。 |
...
| [Slope](../../aspose.svg/svgcomponenttransferfunctionelement/slope) { get; } | 对应于给定元素上的属性“坡度”。 |
...
| [Type](../../aspose.svg/svgcomponenttransferfunctionelement/type) { get; } | 对应于给定元素的属性“类型”。采用此接口上定义的 SVG_FECOMPONENTTRANSFER_TYPE_* 常量之一。 |
...
| const [SVG_FECOMPONENTTRANSFER_TYPE_IDENTITY](../../aspose.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_identity) | 对应于值'identity'。 |
...
| const [SVG_FECOMPONENTTRANSFER_TYPE_TABLE](../../aspose.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_table) | 对应于值“表”。 |
