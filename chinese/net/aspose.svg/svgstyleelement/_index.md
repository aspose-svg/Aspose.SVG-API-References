...
description: "Aspose.Svg.SVGStyleElement 类。SVGStyleElement 接口对应于 style 元素。"
type: docs
weight: 5550
...
| [Media](../../aspose.svg/svgstyleelement/media/) { get; set; } | 对应给定元素的属性 ‘media’。 |
...
| [Title](../../aspose.svg/svgstyleelement/title/) { get; set; } | 对应给定元素的属性 ‘title’。 |
| [Type](../../aspose.svg/svgstyleelement/type/) { get; set; } | 对应给定元素的属性 ‘type’。 |
