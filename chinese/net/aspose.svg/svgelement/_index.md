...
description: "Aspose.Svg.SVGElement 类。所有直接对应于 SVG 语言中元素的 SVG DOM 接口（例如对应于 path 元素的 SVGPathElement 接口）均继承自 SVGElement 接口"
type: docs
weight: 5270
...
所有直接对应于 SVG 语言中元素的 SVG DOM 接口（例如对应于 ‘path’ 元素的 SVGPathElement 接口）均派生自 SVGElement 接口。
