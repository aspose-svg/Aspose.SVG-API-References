...
description: 与 SVG 语言中的元素直接对应的所有 SVG DOM 接口例如 path 元素的 SVGPathElement 接口都派生自 SVGElement 接口
type: docs
weight: 3140
url: /zh/net/aspose.svg/svgelement/
---
## SVGElement class

与 SVG 语言中的元素直接对应的所有 SVG DOM 接口（例如 'path' 元素的 SVGPathElement 接口）都派生自 SVGElement 接口。
