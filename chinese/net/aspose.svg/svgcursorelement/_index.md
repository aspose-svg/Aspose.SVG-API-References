...
description: "Aspose.Svg.SVGCursorElement 类。SVGCursorElement 接口对应于 cursor 元素。"
type: docs
weight: 5230
...
| [Href](../../aspose.svg/svgcursorelement/href/) { get; } | 对应给定元素上的属性 ‘xlink:href’。 |
...
| [RequiredExtensions](../../aspose.svg/svgcursorelement/requiredextensions/) { get; } | 对应于给定元素的 ‘requiredExtensions’ 属性。 |
| [RequiredFeatures](../../aspose.svg/svgcursorelement/requiredfeatures/) { get; } | 对应于给定元素的 ‘requiredFeatures’ 属性。 |
...
| [SystemLanguage](../../aspose.svg/svgcursorelement/systemlanguage/) { get; } | 对应于给定元素的 ‘systemLanguage’ 属性。 |
...
| [X](../../aspose.svg/svgcursorelement/x/) { get; } | 对应于给定 ‘cursor’ 元素的属性 ‘x’。 |
| [Y](../../aspose.svg/svgcursorelement/y/) { get; } | 对应于给定 ‘cursor’ 元素的属性 ‘y’。 |
