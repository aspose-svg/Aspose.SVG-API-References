...
description: SVGAnimateMotionElement 接口对应于 animateMotion 元素 无法通过 SVG DOM 以面向对象的方式访问animateMotion元素的属性
type: docs
weight: 3040
url: /zh/net/aspose.svg/svganimatemotionelement/
---
## SVGAnimateMotionElement class

SVGAnimateMotionElement 接口对应于 'animateMotion' 元素。 无法通过 SVG DOM 以面向对象的方式访问“animateMotion”元素的属性。
