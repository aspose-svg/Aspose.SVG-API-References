...
description: "Aspose.Svg.SVGAnimateMotionElement 类。SVGAnimateMotionElement 接口对应于 animateMotion 元素。通过 SVG DOM 对 animateMotion 元素属性的面向对象访问不可用"
type: docs
weight: 5170
...
该 SVGAnimateMotionElement 接口对应于 ‘animateMotion’ 元素。通过 SVG DOM 对 ‘animateMotion’ 元素属性的面向对象访问不可用。
