...
description: "Aspose.Svg.SVGViewElement 类。SVGViewElement 接口对应 view 元素"
type: docs
weight: 5660
...
| [PreserveAspectRatio](../../aspose.svg/svgviewelement/preserveaspectratio/) { get; } | 对应给定元素的属性 ‘preserveAspectRatio’。 |
...
| [ViewBox](../../aspose.svg/svgviewelement/viewbox/) { get; } | 对应给定元素的属性 ‘viewBox’。 |
| [ViewportElement](../../aspose.svg/svgelement/viewportelement/) { get; } | 确定当前视口的元素。通常为最近的祖先 ‘svg’ 元素。如果给定元素是最外层的 svg 元素，则为 Null。 |
| [ViewTarget](../../aspose.svg/svgviewelement/viewtarget/) { get; } | 对应给定 ‘view’ 元素的属性 ‘viewTarget’。一个 DOMString 值列表，包含在 ‘viewTarget’ 属性中列出的名称。每个 DOMString 值可通过调用 getElementById() 方法与相应的元素关联。 |
| [ZoomAndPan](../../aspose.svg/svgviewelement/zoomandpan/) { get; set; } | 对应给定元素的属性 ‘zoomAndPan’。该值必须是此接口定义的 SVG_ZOOMANDPAN_* 常量之一。 |
