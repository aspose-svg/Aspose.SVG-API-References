...
description: "SVGViewElement ZoomAndPan 属性。对应于给定元素上的 zoomAndPan 属性。该值必须是此接口中定义的 SVG_ZOOMANDPAN_ 常量之一"
type: docs
weight: 40
url: /zh/net/aspose.svg/svgviewelement/zoomandpan/
---
## SVGViewElement.ZoomAndPan property

对应给定元素的属性 ‘zoomAndPan’。该值必须是此接口定义的 SVG_ZOOMANDPAN_* 常量之一。
