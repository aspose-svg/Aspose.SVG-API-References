...
description: "Aspose.Svg.SVGGradientElement 类。SVGGradientElement 接口是 SVGLinearGradientElement 和 SVGRadialGradientElement 使用的基础接口"
type: docs
weight: 5350
...
SVGGradientElement 接口是 SVGLinearGradientElement 和 SVGRadialGradientElement 使用的基接口。
...
| [GradientTransform](../../aspose.svg/svggradientelement/gradienttransform/) { get; } | 对应给定元素上的属性 ‘gradientTransform’。 |
| [GradientUnits](../../aspose.svg/svggradientelement/gradientunits/) { get; } | 对应给定元素上的属性 ‘gradientUnits’。取值为 SVGUnitTypes 中定义的常量之一。 |
| [Href](../../aspose.svg/svggradientelement/href/) { get; } | 对应给定元素上的属性 ‘xlink:href’。 |
...
| [SpreadMethod](../../aspose.svg/svggradientelement/spreadmethod/) { get; } | 对应给定元素的属性 ‘spreadMethod’。此接口定义的传播方法类型之一。 |
...
| 名称 | 描述 |
| --- | --- |
| const [SVG_SPREADMETHOD_PAD](../../aspose.svg/svggradientelement/svg_spreadmethod_pad/) | 对应值 'pad'。 |
| const [SVG_SPREADMETHOD_REFLECT](../../aspose.svg/svggradientelement/svg_spreadmethod_reflect/) | 对应值 'reflect'。 |
| const [SVG_SPREADMETHOD_REPEAT](../../aspose.svg/svggradientelement/svg_spreadmethod_repeat/) | 对应值 'repeat'。 |
| const [SVG_SPREADMETHOD_UNKNOWN](../../aspose.svg/svggradientelement/svg_spreadmethod_unknown/) | 该类型不是预定义类型之一。尝试为此类型定义新值或尝试将现有值切换到此类型都是无效的。 |
