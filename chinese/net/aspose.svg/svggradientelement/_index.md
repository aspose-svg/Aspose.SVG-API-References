...
description: Aspose.Svg.SVGGradientElement 班级. SVGGradientElement 接口是 SVGLinearGradientElement 和 SVGRadialGradientElement 使用的基础接口
type: docs
weight: 3280
...
| const [SVG_SPREADMETHOD_UNKNOWN](../../aspose.svg/svggradientelement/svg_spreadmethod_unknown/) | 该类型不是预定义类型之一。尝试定义此类型的新值或尝试将现有值切换为此类型是无效的。 |
