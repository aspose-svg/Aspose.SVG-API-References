...
description: "Aspose.Svg.DataTypes.SVGAnimatedNumberList 类。用于接受数字列表并且可以动画化的属性"
type: docs
weight: 2150
...
| override [ToString](../../aspose.svg.datatypes/svganimatednumberlist/tostring/)() | 返回表示此实例的字符串。 |
