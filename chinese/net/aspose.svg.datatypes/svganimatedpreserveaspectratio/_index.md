...
description: "Aspose.Svg.DataTypes.SVGAnimatedPreserveAspectRatio 类。用于可以进行动画的 SVGPreserveAspectRatio 类型属性"
type: docs
weight: 2160
...
| override [ToString](../../aspose.svg.datatypes/svganimatedpreserveaspectratio/tostring/)() | 返回表示此实例的字符串。 |
