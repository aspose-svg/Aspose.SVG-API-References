...
description: "Aspose.Svg.DataTypes.SVGStringList 类。SVGStringList 具有与其他 SVGxxxList 接口相同的属性和方法。实现者可以考虑使用单一基类来实现各种 SVGxxxList 接口"
type: docs
weight: 2300
...
| override [ToString](../../aspose.svg.datatypes/svgstringlist/tostring/)() | 返回表示此实例的字符串。 |
