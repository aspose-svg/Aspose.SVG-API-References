...
description: Aspose.Svg.DataTypes.SVGAnimatedLengthList 班级. 用于可以设置动画的 SVGLengthList 类型的属性
type: docs
weight: 140
url: /zh/net/aspose.svg.datatypes/svganimatedlengthlist/
---
...
| override [ToString](../../aspose.svg.datatypes/svganimatedlengthlist/tostring/)() | 返回一个String代表这个实例. |
