...
description: 作为浮点值的值以用户为单位设置此属性将导致 valueInSpecifiedUnits 和 valueAsString 自动更新以反映此设置
type: docs
weight: 20
...
作为浮点值的值，以用户为单位。设置此属性将导致 valueInSpecifiedUnits 和 valueAsString 自动更新以反映此设置。
