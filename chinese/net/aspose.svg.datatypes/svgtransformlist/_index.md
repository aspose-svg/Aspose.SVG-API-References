...
description: Aspose.Svg.DataTypes.SVGTransformList 班级. 该接口定义了 SVGTransform 对象的列表
type: docs
weight: 330
...
| 姓名 | 描述 |
| --- | --- |
| [SVGTransformList](svgtransformlist/#constructor)() | 初始化一个新的实例`SVGTransformList`类. |
| [SVGTransformList](svgtransformlist/#constructor_1)(IEnumerable&lt;SVGTransform&gt;) | 初始化一个新的实例`SVGTransformList`类. |
