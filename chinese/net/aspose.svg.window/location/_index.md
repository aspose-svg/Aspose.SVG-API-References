...
description: Aspose.Svg.Window.Location 班级. Location 对象提供其文档浏览上下文的活动文档地址的表示并允许通过添加或替换历史对象中的条目来更改浏览上下文会话历史记录的当前条目
type: docs
weight: 3850
...
| [Href](../../aspose.svg/url/href/) { get; set; } | 获取或设置指定 URL 实例的序列化表示形式。 |
| [Origin](../../aspose.svg/url/origin/) { get; } | 获取指定 URL 来源的字符串表示形式。 |
...
| [SearchParams](../../aspose.svg/url/searchparams/) { get; } | 获取关联[`IUrlSearchParams`](../../aspose.svg/iurlsearchparams/)对象. |
...
| override [Equals](../../aspose.svg/url/equals/)(object) | 判断指定的是否Object 等于这个实例. |
