...
type: docs
weight: 1690
url: /zh/net/aspose.svg.filters/svgfediffuselightingelement/
---
...
| [DiffuseConstant](../../aspose.svg.filters/svgfediffuselightingelement/diffuseconstant) { get; } | 对应于给定 'feDiffuseLighting' 元素上的属性 'diffuseConstant'。 |
...
| [Height](../../aspose.svg.filters/svgfediffuselightingelement/height) { get; } | 对应于给定“过滤器”元素的属性“高度”。 |
| [Id](../../aspose.svg/svgelement/id) { get; set; } | 给定元素的 'id' 属性的值，如果 'id' 不存在，则为空字符串。 |
| [In1](../../aspose.svg.filters/svgfediffuselightingelement/in1) { get; } | 对应于给定 'feDiffuseLighting' 元素上的属性 'in'。 |
| [InnerHTML](../../aspose.svg.dom/element/innerhtml) { get; set; } | 返回代表元素内容的 HTML 或 XML 片段。 可以设置，用从给定字符串解析的节点替换元素的内容。 |
| [KernelUnitLengthX](../../aspose.svg.filters/svgfediffuselightingelement/kernelunitlengthx) { get; } | 对应于给定 'feDiffuseLighting' 元素的属性 'kernelUnitLength'。 |
| [KernelUnitLengthY](../../aspose.svg.filters/svgfediffuselightingelement/kernelunitlengthy) { get; } | 对应于给定 'feDiffuseLighting' 元素的属性 'kernelUnitLength'。 |
...
| [Result](../../aspose.svg.filters/svgfediffuselightingelement/result) { get; } | 对应于给定 'filter' 元素的属性 'result'。 |
...
| [SurfaceScale](../../aspose.svg.filters/svgfediffuselightingelement/surfacescale) { get; } | 对应于给定 'feDiffuseLighting' 元素上的属性 'surfaceScale'。 |
...
| [Width](../../aspose.svg.filters/svgfediffuselightingelement/width) { get; } | 对应于给定“过滤器”元素的属性“宽度”。 |
| [X](../../aspose.svg.filters/svgfediffuselightingelement/x) { get; } | 对应于给定“过滤器”元素的属性“x”。 |
| [Y](../../aspose.svg.filters/svgfediffuselightingelement/y) { get; } | 对应于给定 'filter' 元素上的属性 'y'。 |
