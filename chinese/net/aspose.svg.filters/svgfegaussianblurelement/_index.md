...
description: "Aspose.Svg.Filters.SVGFEGaussianBlurElement 类。SVGFEGaussianBlurElement 接口对应于 feGaussianBlur 元素。"
type: docs
weight: 3880
...
此 SVGFEGaussianBlurElement 接口对应于 ‘feGaussianBlur’ 元素。
...
| [Height](../../aspose.svg.filters/svgfegaussianblurelement/height/) { get; } | 对应于给定 �filter� 元素的属性 �height�。 |
...
| [Result](../../aspose.svg.filters/svgfegaussianblurelement/result/) { get; } | 对应于给定 �filter� 元素的属性 �result�。 |
...
| [Width](../../aspose.svg.filters/svgfegaussianblurelement/width/) { get; } | 对应于给定 �filter� 元素的属性 �width�。 |
| [X](../../aspose.svg.filters/svgfegaussianblurelement/x/) { get; } | 对应于给定 �filter� 元素的属性 �x�。 |
| [Y](../../aspose.svg.filters/svgfegaussianblurelement/y/) { get; } | 对应于给定 �filter� 元素的属性 �y�。 |
