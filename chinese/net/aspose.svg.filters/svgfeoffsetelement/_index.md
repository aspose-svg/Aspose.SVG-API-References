...
description: "Aspose.Svg.Filters.SVGFEOffsetElement 类。SVGFEOffsetElement 接口对应于 feOffset 元素"
type: docs
weight: 3930
...
此 SVGFEOffsetElement 接口对应于 ‘feOffset’ 元素。
...
| [Height](../../aspose.svg.filters/svgfeoffsetelement/height/) { get; } | 对应于给定 ‘filter’ 元素的属性 ‘height’。 |
...
| [Result](../../aspose.svg.filters/svgfeoffsetelement/result/) { get; } | 对应给定 ‘filter’ 元素的属性 ‘result’。 |
...
| [Width](../../aspose.svg.filters/svgfeoffsetelement/width/) { get; } | 对应于给定 ‘filter’ 元素的属性 ‘width’。 |
| [X](../../aspose.svg.filters/svgfeoffsetelement/x/) { get; } | 对应于给定 ‘filter’ 元素的属性 ‘x’。 |
| [Y](../../aspose.svg.filters/svgfeoffsetelement/y/) { get; } | 对应于给定 ‘filter’ 元素的属性 ‘y’。 |
