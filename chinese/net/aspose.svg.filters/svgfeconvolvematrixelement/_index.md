...
description: "Aspose.Svg.Filters.SVGFEConvolveMatrixElement 类。SVGFEConvolveMatrixElement 接口对应于 feConvolveMatrix 元素"
type: docs
weight: 3780
...
SVGFEConvolveMatrixElement 接口对应 ‘feConvolveMatrix’ 元素。
...
| [Height](../../aspose.svg.filters/svgfeconvolvematrixelement/height/) { get; } | 对应于给定 ‘filter’ 元素的属性 ‘height’。 |
| [Id](../../aspose.svg/svgelement/id/) { get; set; } | 给定元素的 ‘id’ 属性的值，如果不存在 ‘id’，则为空字符串。 |
| [In1](../../aspose.svg.filters/svgfeconvolvematrixelement/in1/) { get; } | 对应于给定 ‘feConvolveMatrix’ 元素的属性 ‘in’。 |
| [InnerHTML](../../aspose.svg.dom/element/innerhtml/) { get; set; } | 返回表示元素内容的 HTML 或 XML 片段。可以设置，以使用从给定字符串解析的节点替换元素的内容。 |
| [KernelMatrix](../../aspose.svg.filters/svgfeconvolvematrixelement/kernelmatrix/) { get; } | 对应于给定 ‘feConvolveMatrix’ 元素的属性 ‘kernelMatrix’。 |
| [KernelUnitLengthX](../../aspose.svg.filters/svgfeconvolvematrixelement/kernelunitlengthx/) { get; } | 对应于给定 ‘feConvolveMatrix’ 元素的属性 ‘kernelUnitLength’。 |
| [KernelUnitLengthY](../../aspose.svg.filters/svgfeconvolvematrixelement/kernelunitlengthy/) { get; } | 对应于给定 ‘feConvolveMatrix’ 元素的属性 ‘kernelUnitLength’。 |
...
| [Result](../../aspose.svg.filters/svgfeconvolvematrixelement/result/) { get; } | 对应给定 ‘filter’ 元素的属性 ‘result’。 |
...
| [TargetX](../../aspose.svg.filters/svgfeconvolvematrixelement/targetx/) { get; } | 对应于给定 ‘feConvolveMatrix’ 元素的属性 ‘targetX’。 |
| [TargetY](../../aspose.svg.filters/svgfeconvolvematrixelement/targety/) { get; } | 对应于给定 ‘feConvolveMatrix’ 元素的属性 ‘targetY’。 |
...
| [Width](../../aspose.svg.filters/svgfeconvolvematrixelement/width/) { get; } | 对应于给定 ‘filter’ 元素的属性 ‘width’。 |
| [X](../../aspose.svg.filters/svgfeconvolvematrixelement/x/) { get; } | 对应于给定 ‘filter’ 元素的属性 ‘x’。 |
| [Y](../../aspose.svg.filters/svgfeconvolvematrixelement/y/) { get; } | 对应于给定 ‘filter’ 元素的属性 ‘y’。 |
...
| 名称 | 描述 |
| --- | --- |
| const [SVG_EDGEMODE_DUPLICATE](../../aspose.svg.filters/svgfeconvolvematrixelement/svg_edgemode_duplicate/) | 对应于值 'duplicate'。 |
| const [SVG_EDGEMODE_NONE](../../aspose.svg.filters/svgfeconvolvematrixelement/svg_edgemode_none/) | 对应于值 'none'。 |
| const [SVG_EDGEMODE_UNKNOWN](../../aspose.svg.filters/svgfeconvolvematrixelement/svg_edgemode_unknown/) | 该类型不是预定义类型之一。尝试为此类型定义新值或尝试将现有值切换到此类型都是无效的。 |
