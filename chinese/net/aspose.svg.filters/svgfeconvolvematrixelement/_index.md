...
type: docs
weight: 1680
url: /zh/net/aspose.svg.filters/svgfeconvolvematrixelement/
---
...
| [Bias](../../aspose.svg.filters/svgfeconvolvematrixelement/bias) { get; } | 对应于给定 'feConvolveMatrix' 元素的属性 'bias'。 |
...
| [Divisor](../../aspose.svg.filters/svgfeconvolvematrixelement/divisor) { get; } | 对应于给定 'feConvolveMatrix' 元素的属性 'divisor'。 |
| [EdgeMode](../../aspose.svg.filters/svgfeconvolvematrixelement/edgemode) { get; } | 对应于给定 'feConvolveMatrix' 元素的属性 'edgeMode'。 |
...
| [Height](../../aspose.svg.filters/svgfeconvolvematrixelement/height) { get; } | 对应于给定“过滤器”元素的属性“高度”。 |
| [Id](../../aspose.svg/svgelement/id) { get; set; } | 给定元素的 'id' 属性的值，如果 'id' 不存在，则为空字符串。 |
| [In1](../../aspose.svg.filters/svgfeconvolvematrixelement/in1) { get; } | 对应于给定 'feConvolveMatrix' 元素上的属性 'in'。 |
| [InnerHTML](../../aspose.svg.dom/element/innerhtml) { get; set; } | 返回代表元素内容的 HTML 或 XML 片段。 可以设置，用从给定字符串解析的节点替换元素的内容。 |
| [KernelMatrix](../../aspose.svg.filters/svgfeconvolvematrixelement/kernelmatrix) { get; } | 对应于给定 'feConvolveMatrix' 元素上的属性 'kernelMatrix'。 |
| [KernelUnitLengthX](../../aspose.svg.filters/svgfeconvolvematrixelement/kernelunitlengthx) { get; } | 对应于给定 'feConvolveMatrix' 元素上的属性 'kernelUnitLength'。 |
| [KernelUnitLengthY](../../aspose.svg.filters/svgfeconvolvematrixelement/kernelunitlengthy) { get; } | 对应于给定 'feConvolveMatrix' 元素上的属性 'kernelUnitLength'。 |
...
| [OrderX](../../aspose.svg.filters/svgfeconvolvematrixelement/orderx) { get; } | 对应于给定 'feConvolveMatrix' 元素的属性 'order'。 |
| [OrderY](../../aspose.svg.filters/svgfeconvolvematrixelement/ordery) { get; } | 对应于给定 'feConvolveMatrix' 元素的属性 'order'。 |
...
| [PreserveAlpha](../../aspose.svg.filters/svgfeconvolvematrixelement/preservealpha) { get; } | 对应于给定 'feConvolveMatrix' 元素的属性 'preserveAlpha'。 |
...
| [Result](../../aspose.svg.filters/svgfeconvolvematrixelement/result) { get; } | 对应于给定 'filter' 元素的属性 'result'。 |
...
| [TargetX](../../aspose.svg.filters/svgfeconvolvematrixelement/targetx) { get; } | 对应于给定 'feConvolveMatrix' 元素上的属性 'targetX'。 |
| [TargetY](../../aspose.svg.filters/svgfeconvolvematrixelement/targety) { get; } | 对应于给定 'feConvolveMatrix' 元素上的属性 'targetY'。 |
...
| [Width](../../aspose.svg.filters/svgfeconvolvematrixelement/width) { get; } | 对应于给定“过滤器”元素的属性“宽度”。 |
| [X](../../aspose.svg.filters/svgfeconvolvematrixelement/x) { get; } | 对应于给定“过滤器”元素的属性“x”。 |
| [Y](../../aspose.svg.filters/svgfeconvolvematrixelement/y) { get; } | 对应于给定 'filter' 元素上的属性 'y'。 |
...
| 姓名 | 描述 |
| --- | --- |
| const [SVG_EDGEMODE_DUPLICATE](../../aspose.svg.filters/svgfeconvolvematrixelement/svg_edgemode_duplicate) | 对应于值“重复”。 |
| const [SVG_EDGEMODE_NONE](../../aspose.svg.filters/svgfeconvolvematrixelement/svg_edgemode_none) | 对应于值“无”。 |
| const [SVG_EDGEMODE_UNKNOWN](../../aspose.svg.filters/svgfeconvolvematrixelement/svg_edgemode_unknown) | 该类型不是预定义类型之一。尝试定义此类型的新值或尝试将现有值切换到此类型是无效的。 |
| const [SVG_EDGEMODE_WRAP](../../aspose.svg.filters/svgfeconvolvematrixelement/svg_edgemode_wrap) | 对应于值 'wrap'。 |
