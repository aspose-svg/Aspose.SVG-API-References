...
description: "Aspose.Svg.Filters.SVGFEFloodElement 类。SVGFEFloodElement 接口对应于 feFlood 元素。"
type: docs
weight: 3830
...
此 SVGFEFloodElement 接口对应于 ‘feFlood’ 元素。
...
| [Height](../../aspose.svg.filters/svgfefloodelement/height/) { get; } | 对应于给定 ‘filter’ 元素的属性 ‘height’。 |
...
| [Result](../../aspose.svg.filters/svgfefloodelement/result/) { get; } | 对应给定 ‘filter’ 元素的属性 ‘result’。 |
...
| [Width](../../aspose.svg.filters/svgfefloodelement/width/) { get; } | 对应于给定 ‘filter’ 元素的属性 ‘width’。 |
| [X](../../aspose.svg.filters/svgfefloodelement/x/) { get; } | 对应于给定 ‘filter’ 元素的属性 ‘x’。 |
| [Y](../../aspose.svg.filters/svgfefloodelement/y/) { get; } | 对应于给定 ‘filter’ 元素的属性 ‘y’。 |
