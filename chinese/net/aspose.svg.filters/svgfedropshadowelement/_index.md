...
description: "Aspose.Svg.Filters.SVGFEDropShadowElement 类。SVGFEDropShadowElement 接口对应于 feDropShadow 元素"
type: docs
weight: 3820
...
此 SVGFEDropShadowElement 接口对应于 ‘feDropShadow’ 元素。
...
| [Dx](../../aspose.svg.filters/svgfedropshadowelement/dx/) { get; } | 对应给定 ‘feDropShadow’ 元素的属性 ‘dx’。 |
| [Dy](../../aspose.svg.filters/svgfedropshadowelement/dy/) { get; } | 对应给定 ‘feDropShadow’ 元素的属性 ‘dy’。 |
...
| [Height](../../aspose.svg.filters/svgfedropshadowelement/height/) { get; } | 对应给定 ‘feDropShadow’ 元素的属性 ‘height’。 |
| [Id](../../aspose.svg/svgelement/id/) { get; set; } | 给定元素的 ‘id’ 属性的值，如果不存在 ‘id’，则为空字符串。 |
| [In1](../../aspose.svg.filters/svgfedropshadowelement/in1/) { get; } | 对应给定 ‘feDropShadow’ 元素的属性 ‘in’。 |
...
| [Result](../../aspose.svg.filters/svgfedropshadowelement/result/) { get; } | 对应给定 ‘feDropShadow’ 元素的属性 ‘result’。 |
| [ShadowRoot](../../aspose.svg.dom/element/shadowroot/) { get; } | 返回存储在此元素上的 shadowRoot，如果已关闭则返回 null。 |
| [StdDeviationX](../../aspose.svg.filters/svgfedropshadowelement/stddeviationx/) { get; } | 对应给定 ‘feDropShadow’ 元素的属性 ‘stdDeviation’。包含属性 ‘stdDeviation’ 的 X 分量。 |
| [StdDeviationY](../../aspose.svg.filters/svgfedropshadowelement/stddeviationy/) { get; } | 对应给定 ‘feDropShadow’ 元素的属性 ‘stdDeviation’。包含属性 ‘stdDeviation’ 的 Y 分量（可能自动计算）。 |
...
| [Width](../../aspose.svg.filters/svgfedropshadowelement/width/) { get; } | 对应给定 ‘feDropShadow’ 元素的属性 ‘width’。 |
| [X](../../aspose.svg.filters/svgfedropshadowelement/x/) { get; } | 对应给定 ‘feDropShadow’ 元素的属性 ‘x’。 |
| [Y](../../aspose.svg.filters/svgfedropshadowelement/y/) { get; } | 对应给定 ‘feDropShadow’ 元素的属性 ‘y’。 |
