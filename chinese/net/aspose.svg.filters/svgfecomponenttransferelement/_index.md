...
description: "Aspose.Svg.Filters.SVGFEComponentTransferElement 类。SVGFEComponentTransferElement 接口对应于 feComponentTransfer 元素"
type: docs
weight: 3760
...
SVGFEComponentTransferElement 接口对应 ‘feComponentTransfer’ 元素。
...
| [Height](../../aspose.svg.filters/svgfecomponenttransferelement/height/) { get; } | 对应于给定 ‘filter’ 元素的属性 ‘height’。 |
| [Id](../../aspose.svg/svgelement/id/) { get; set; } | 给定元素的 ‘id’ 属性的值，如果不存在 ‘id’，则为空字符串。 |
| [In1](../../aspose.svg.filters/svgfecomponenttransferelement/in1/) { get; } | 对应给定 ‘feComponentTransfer’ 元素的属性 ‘in’。 |
...
| [Result](../../aspose.svg.filters/svgfecomponenttransferelement/result/) { get; } | 对应给定 ‘filter’ 元素的属性 ‘result’。 |
...
| [Width](../../aspose.svg.filters/svgfecomponenttransferelement/width/) { get; } | 对应于给定 ‘filter’ 元素的属性 ‘width’。 |
| [X](../../aspose.svg.filters/svgfecomponenttransferelement/x/) { get; } | 对应于给定 ‘filter’ 元素的属性 ‘x’。 |
| [Y](../../aspose.svg.filters/svgfecomponenttransferelement/y/) { get; } | 对应于给定 ‘filter’ 元素的属性 ‘y’。 |
