...
description: "Aspose.Svg.Filters.SVGFEImageElement 类。SVGFEImageElement 接口对应于 feImage 元素"
type: docs
weight: 3890
...
此 SVGFEImageElement 接口对应于 ‘feImage’ 元素。
...
| [Height](../../aspose.svg.filters/svgfeimageelement/height/) { get; } | 对应于给定 ‘filter’ 元素的属性 ‘height’。 |
| [Href](../../aspose.svg.filters/svgfeimageelement/href/) { get; } | 对应给定元素上的属性 ‘xlink:href’。 |
...
| [PreserveAspectRatio](../../aspose.svg.filters/svgfeimageelement/preserveaspectratio/) { get; } | 对应给定 ‘feImage’ 元素的属性 ‘preserveAspectRatio’。 |
...
| [Result](../../aspose.svg.filters/svgfeimageelement/result/) { get; } | 对应给定 ‘filter’ 元素的属性 ‘result’。 |
...
| [Width](../../aspose.svg.filters/svgfeimageelement/width/) { get; } | 对应于给定 ‘filter’ 元素的属性 ‘width’。 |
| [X](../../aspose.svg.filters/svgfeimageelement/x/) { get; } | 对应于给定 ‘filter’ 元素的属性 ‘x’。 |
| [Y](../../aspose.svg.filters/svgfeimageelement/y/) { get; } | 对应于给定 ‘filter’ 元素的属性 ‘y’。 |
