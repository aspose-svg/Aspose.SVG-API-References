...
description: 的 Aspose.Svg.Dom.Svg.Filters命名空间包含SVG规范中与滤镜效果相关的类和 接口
type: docs
weight: 160
url: /zh/net/aspose.svg.filters/
---
的 **Aspose.Svg.Dom.Svg.Filters**命名空间包含SVG规范中与滤镜效果相关的类和 接口。
...
| [SVGFEImageElement](./svgfeimageelement) | SVGFEImageElement 接口对应“feImage”元素。 |
...
| 界面 | 描述 |
| --- | --- |
| [ISVGFilterPrimitiveStandardAttributes](./isvgfilterprimitivestandardattributes) | 这个接口定义了过滤器原语接口通用的 DOM 属性集。 |
