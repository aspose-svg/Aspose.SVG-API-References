...
description: "Aspose.Svg.Filters.SVGFESpecularLightingElement 类。SVGFESpecularLightingElement 接口对应于 feSpecularLighting 元素"
type: docs
weight: 3950
...
此 SVGFESpecularLightingElement 接口对应于 ‘feSpecularLighting’ 元素。
...
| [Height](../../aspose.svg.filters/svgfespecularlightingelement/height/) { get; } | 对应于给定 ‘filter’ 元素的属性 ‘height’。 |
| [Id](../../aspose.svg/svgelement/id/) { get; set; } | 给定元素的 ‘id’ 属性的值，如果不存在 ‘id’，则为空字符串。 |
| [In1](../../aspose.svg.filters/svgfespecularlightingelement/in1/) { get; } | 对应于给定 ‘feSpecularLighting’ 元素的属性 ‘in’。 |
| [InnerHTML](../../aspose.svg.dom/element/innerhtml/) { get; set; } | 返回表示元素内容的 HTML 或 XML 片段。可以设置，以使用从给定字符串解析的节点替换元素的内容。 |
| [KernelUnitLengthX](../../aspose.svg.filters/svgfespecularlightingelement/kernelunitlengthx/) { get; } | 对应于给定 ‘feSpecularLighting’ 元素的属性 ‘kernelUnitLength’。 |
| [KernelUnitLengthY](../../aspose.svg.filters/svgfespecularlightingelement/kernelunitlengthy/) { get; } | 对应于给定 ‘feSpecularLighting’ 元素的属性 ‘kernelUnitLength’。 |
...
| [Result](../../aspose.svg.filters/svgfespecularlightingelement/result/) { get; } | 对应给定 ‘filter’ 元素的属性 ‘result’。 |
| [ShadowRoot](../../aspose.svg.dom/element/shadowroot/) { get; } | 返回存储在此元素上的 shadowRoot，如果已关闭则返回 null。 |
| [SpecularConstant](../../aspose.svg.filters/svgfespecularlightingelement/specularconstant/) { get; } | 对应于给定 ‘feSpecularLighting’ 元素的属性 ‘specularConstant’。 |
| [SpecularExponent](../../aspose.svg.filters/svgfespecularlightingelement/specularexponent/) { get; } | 对应于给定 ‘feSpecularLighting’ 元素的属性 ‘specularExponent’。 |
| [Style](../../aspose.svg/svgelement/style/) { get; } | 对应于给定元素的 ‘style’ 属性。如果用户代理不支持 CSS 样式，则此属性必须始终为 null。 |
| [SurfaceScale](../../aspose.svg.filters/svgfespecularlightingelement/surfacescale/) { get; } | 对应于给定 ‘feSpecularLighting’ 元素的属性 ‘surfaceScale’。 |
...
| [Width](../../aspose.svg.filters/svgfespecularlightingelement/width/) { get; } | 对应于给定 ‘filter’ 元素的属性 ‘width’。 |
| [X](../../aspose.svg.filters/svgfespecularlightingelement/x/) { get; } | 对应于给定 ‘filter’ 元素的属性 ‘x’。 |
| [Y](../../aspose.svg.filters/svgfespecularlightingelement/y/) { get; } | 对应于给定 ‘filter’ 元素的属性 ‘y’。 |
