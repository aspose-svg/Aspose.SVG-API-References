...
type: docs
weight: 1850
url: /zh/net/aspose.svg.filters/svgfespecularlightingelement/
---
...
| [Height](../../aspose.svg.filters/svgfespecularlightingelement/height) { get; } | 对应于给定“过滤器”元素的属性“高度”。 |
| [Id](../../aspose.svg/svgelement/id) { get; set; } | 给定元素的 'id' 属性的值，如果 'id' 不存在，则为空字符串。 |
| [In1](../../aspose.svg.filters/svgfespecularlightingelement/in1) { get; } | 对应于给定 'feSpecularLighting' 元素上的属性 'in'。 |
| [InnerHTML](../../aspose.svg.dom/element/innerhtml) { get; set; } | 返回代表元素内容的 HTML 或 XML 片段。 可以设置，用从给定字符串解析的节点替换元素的内容。 |
| [KernelUnitLengthX](../../aspose.svg.filters/svgfespecularlightingelement/kernelunitlengthx) { get; } | 对应于给定 'feSpecularLighting' 元素上的属性 'kernelUnitLength'。 |
| [KernelUnitLengthY](../../aspose.svg.filters/svgfespecularlightingelement/kernelunitlengthy) { get; } | 对应于给定 'feSpecularLighting' 元素上的属性 'kernelUnitLength'。 |
...
| [Result](../../aspose.svg.filters/svgfespecularlightingelement/result) { get; } | 对应于给定 'filter' 元素的属性 'result'。 |
...
| [SpecularConstant](../../aspose.svg.filters/svgfespecularlightingelement/specularconstant) { get; } | 对应于给定 'feSpecularLighting' 元素上的属性 'specularConstant'。 |
| [SpecularExponent](../../aspose.svg.filters/svgfespecularlightingelement/specularexponent) { get; } | 对应于给定 'feSpecularLighting' 元素上的属性 'specularExponent'。 |
| [Style](../../aspose.svg/svgelement/style) { get; } | 对应于给定元素的属性“样式”。如果用户代理不支持 CSS 样式，则此属性必须始终具有 null 值。 |
| [SurfaceScale](../../aspose.svg.filters/svgfespecularlightingelement/surfacescale) { get; } | 对应于给定 'feSpecularLighting' 元素上的属性 'surfaceScale'。 |
...
| [Width](../../aspose.svg.filters/svgfespecularlightingelement/width) { get; } | 对应于给定“过滤器”元素的属性“宽度”。 |
| [X](../../aspose.svg.filters/svgfespecularlightingelement/x) { get; } | 对应于给定“过滤器”元素的属性“x”。 |
| [Y](../../aspose.svg.filters/svgfespecularlightingelement/y) { get; } | 对应于给定 'filter' 元素上的属性 'y'。 |
