...
type: docs
weight: 1670
url: /zh/net/aspose.svg.filters/svgfecompositeelement/
---
...
| [Height](../../aspose.svg.filters/svgfecompositeelement/height) { get; } | 对应于给定“过滤器”元素的属性“高度”。 |
| [Id](../../aspose.svg/svgelement/id) { get; set; } | 给定元素的 'id' 属性的值，如果 'id' 不存在，则为空字符串。 |
| [In1](../../aspose.svg.filters/svgfecompositeelement/in1) { get; } | 对应于给定 'feComposite' 元素的属性 'in'。 |
| [In2](../../aspose.svg.filters/svgfecompositeelement/in2) { get; } | 对应于给定 'feComposite' 元素的属性 'in2'。 |
| [InnerHTML](../../aspose.svg.dom/element/innerhtml) { get; set; } | 返回代表元素内容的 HTML 或 XML 片段。 可以设置，用从给定字符串解析的节点替换元素的内容。 |
| [K1](../../aspose.svg.filters/svgfecompositeelement/k1) { get; } | 对应于给定 'feComposite' 元素的属性 'k1'。 |
| [K2](../../aspose.svg.filters/svgfecompositeelement/k2) { get; } | 对应于给定 'feComposite' 元素的属性 'k2'。 |
| [K3](../../aspose.svg.filters/svgfecompositeelement/k3) { get; } | 对应于给定 'feComposite' 元素的属性 'k3'。 |
| [K4](../../aspose.svg.filters/svgfecompositeelement/k4) { get; } | 对应于给定 'feComposite' 元素的属性 'k4'。 |
...
| [Operator](../../aspose.svg.filters/svgfecompositeelement/operator) { get; } | 对应于给定 'feComposite' 元素的属性 'operator'。采用在此接口上定义的 SVG_FECOMPOSITE_OPERATOR_* 常量之一。 |
...
| [Result](../../aspose.svg.filters/svgfecompositeelement/result) { get; } | 对应于给定 'filter' 元素的属性 'result'。 |
...
| [Width](../../aspose.svg.filters/svgfecompositeelement/width) { get; } | 对应于给定“过滤器”元素的属性“宽度”。 |
| [X](../../aspose.svg.filters/svgfecompositeelement/x) { get; } | 对应于给定“过滤器”元素的属性“x”。 |
| [Y](../../aspose.svg.filters/svgfecompositeelement/y) { get; } | 对应于给定 'filter' 元素上的属性 'y'。 |
...
| 姓名 | 描述 |
| --- | --- |
| const [SVG_FECOMPOSITE_OPERATOR_ARITHMETIC](../../aspose.svg.filters/svgfecompositeelement/svg_fecomposite_operator_arithmetic) | 对应于值“算术”。 |
| const [SVG_FECOMPOSITE_OPERATOR_ATOP](../../aspose.svg.filters/svgfecompositeelement/svg_fecomposite_operator_atop) | 对应于值'atop'。 |
| const [SVG_FECOMPOSITE_OPERATOR_IN](../../aspose.svg.filters/svgfecompositeelement/svg_fecomposite_operator_in) | 对应于值'in'。 |
| const [SVG_FECOMPOSITE_OPERATOR_OUT](../../aspose.svg.filters/svgfecompositeelement/svg_fecomposite_operator_out) | 对应于值'out'。 |
| const [SVG_FECOMPOSITE_OPERATOR_OVER](../../aspose.svg.filters/svgfecompositeelement/svg_fecomposite_operator_over) | 对应于值“超过”。 |
| const [SVG_FECOMPOSITE_OPERATOR_UNKNOWN](../../aspose.svg.filters/svgfecompositeelement/svg_fecomposite_operator_unknown) | 该类型不是预定义类型之一。尝试定义此类型的新值或尝试将现有值切换到此类型是无效的。 |
| const [SVG_FECOMPOSITE_OPERATOR_XOR](../../aspose.svg.filters/svgfecompositeelement/svg_fecomposite_operator_xor) | 对应于值“异或”。 |
