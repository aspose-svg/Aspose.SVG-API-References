...
description: "Aspose.Svg.Filters.SVGFECompositeElement 类。SVGFECompositeElement 接口对应于 feComposite 元素"
type: docs
weight: 3770
...
SVGFECompositeElement 接口对应 ‘feComposite’ 元素。
...
| [Height](../../aspose.svg.filters/svgfecompositeelement/height/) { get; } | 对应于给定 ‘filter’ 元素的属性 ‘height’。 |
| [Id](../../aspose.svg/svgelement/id/) { get; set; } | 给定元素的 ‘id’ 属性的值，如果不存在 ‘id’，则为空字符串。 |
| [In1](../../aspose.svg.filters/svgfecompositeelement/in1/) { get; } | 对应给定 ‘feComposite’ 元素的属性 ‘in’。 |
| [In2](../../aspose.svg.filters/svgfecompositeelement/in2/) { get; } | 对应给定 ‘feComposite’ 元素的属性 ‘in2’。 |
| [InnerHTML](../../aspose.svg.dom/element/innerhtml/) { get; set; } | 返回表示元素内容的 HTML 或 XML 片段。可以设置，以使用从给定字符串解析的节点替换元素的内容。 |
| [K1](../../aspose.svg.filters/svgfecompositeelement/k1/) { get; } | 对应给定 ‘feComposite’ 元素的属性 ‘k1’。 |
...
| [Operator](../../aspose.svg.filters/svgfecompositeelement/operator/) { get; } | 对应于给定 ‘feComposite’ 元素的属性 ‘operator’。此属性取自此接口定义的 SVG_FECOMPOSITE_OPERATOR_* 常量之一。 |
...
| [Result](../../aspose.svg.filters/svgfecompositeelement/result/) { get; } | 对应给定 ‘filter’ 元素的属性 ‘result’。 |
...
| [Width](../../aspose.svg.filters/svgfecompositeelement/width/) { get; } | 对应于给定 ‘filter’ 元素的属性 ‘width’。 |
| [X](../../aspose.svg.filters/svgfecompositeelement/x/) { get; } | 对应于给定 ‘filter’ 元素的属性 ‘x’。 |
| [Y](../../aspose.svg.filters/svgfecompositeelement/y/) { get; } | 对应于给定 ‘filter’ 元素的属性 ‘y’。 |
...
| 名称 | 描述 |
| --- | --- |
| const [SVG_FECOMPOSITE_OPERATOR_ARITHMETIC](../../aspose.svg.filters/svgfecompositeelement/svg_fecomposite_operator_arithmetic/) | 对应于值 'arithmetic'。 |
...
| const [SVG_FECOMPOSITE_OPERATOR_OVER](../../aspose.svg.filters/svgfecompositeelement/svg_fecomposite_operator_over/) | 对应于值 'over'。 |
| const [SVG_FECOMPOSITE_OPERATOR_UNKNOWN](../../aspose.svg.filters/svgfecompositeelement/svg_fecomposite_operator_unknown/) | 该类型不是预定义类型之一。尝试为此类型定义新值或尝试将现有值切换到此类型都是无效的。 |
| const [SVG_FECOMPOSITE_OPERATOR_XOR](../../aspose.svg.filters/svgfecompositeelement/svg_fecomposite_operator_xor/) | 对应于值 'xor'。 |
