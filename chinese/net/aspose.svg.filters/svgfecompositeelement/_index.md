...
description: SVGFECompositeElement 接口对应于feComposite元素
type: docs
weight: 1680
...
| [Operator](../../aspose.svg.filters/svgfecompositeelement/operator) { get; } | 对应于给定 'feComposite' 元素的属性 'operator'。采用此接口上定义的 SVG_FECOMPOSITE_OPERATOR_* 常量之一。 |
