...
description: Aspose.Svg.Filters.SVGFEColorMatrixElement 班级. SVGFEColorMatrixElement 接口对应于feColorMatrix元素
type: docs
weight: 1660
...
| [Height](../../aspose.svg.filters/svgfecolormatrixelement/height/) { get; } | 对应于给定“过滤器”元素上的属性“高度”。 |
| [Id](../../aspose.svg/svgelement/id/) { get; set; } | 给定元素上“id”属性的值，如果“id”不存在则为空字符串。 |
| [In1](../../aspose.svg.filters/svgfecolormatrixelement/in1/) { get; } | 对应于给定“feColorMatrix”元素上的属性“in”。 |
...
| [Result](../../aspose.svg.filters/svgfecolormatrixelement/result/) { get; } | 对应于给定“过滤器”元素上的属性“结果”。 |
...
| [Type](../../aspose.svg.filters/svgfecolormatrixelement/type/) { get; } | 对应于给定“feColorMatrix”元素上的属性“type”。采用在此接口上定义的 SVG_FECOLORMATRIX_TYPE_* 常量之一。 |
| [Values](../../aspose.svg.filters/svgfecolormatrixelement/values/) { get; } | 对应于给定“feColorMatrix”元素上的属性“值”。 |
| [ViewportElement](../../aspose.svg/svgelement/viewportelement/) { get; } | 建立当前视口的元素。通常，最近的祖先“svg”元素。如果给定元素是最外层的 svg 元素，则为空。 |
| [Width](../../aspose.svg.filters/svgfecolormatrixelement/width/) { get; } | 对应于给定“过滤器”元素上的属性“宽度”。 |
| [X](../../aspose.svg.filters/svgfecolormatrixelement/x/) { get; } | 对应于给定“过滤器”元素上的属性“x”。 |
| [Y](../../aspose.svg.filters/svgfecolormatrixelement/y/) { get; } | 对应于给定“过滤器”元素上的属性“y”。 |
...
| const [SVG_FECOLORMATRIX_TYPE_UNKNOWN](../../aspose.svg.filters/svgfecolormatrixelement/svg_fecolormatrix_type_unknown/) | 该类型不是预定义类型之一。尝试定义此类型的新值或尝试将现有值切换为此类型是无效的。 |
