...
description: "Aspose.Svg.Filters.SVGFEColorMatrixElement 类。SVGFEColorMatrixElement 接口对应 feColorMatrix 元素"
type: docs
weight: 3750
...
SVGFEColorMatrixElement 接口对应 ‘feColorMatrix’ 元素。
...
| [Height](../../aspose.svg.filters/svgfecolormatrixelement/height/) { get; } | 对应于给定 ‘filter’ 元素的属性 ‘height’。 |
| [Id](../../aspose.svg/svgelement/id/) { get; set; } | 给定元素的 ‘id’ 属性的值，如果不存在 ‘id’，则为空字符串。 |
| [In1](../../aspose.svg.filters/svgfecolormatrixelement/in1/) { get; } | 对应给定 ‘feColorMatrix’ 元素的属性 ‘in’。 |
...
| [Result](../../aspose.svg.filters/svgfecolormatrixelement/result/) { get; } | 对应给定 ‘filter’ 元素的属性 ‘result’。 |
...
| [Type](../../aspose.svg.filters/svgfecolormatrixelement/type/) { get; } | 对应给定 ‘feColorMatrix’ 元素的属性 ‘type’。取值为此接口上定义的 SVG_FECOLORMATRIX_TYPE_* 常量之一。 |
| [Values](../../aspose.svg.filters/svgfecolormatrixelement/values/) { get; } | 对应给定 ‘feColorMatrix’ 元素的属性 ‘values’。 |
| [ViewportElement](../../aspose.svg/svgelement/viewportelement/) { get; } | 确定当前视口的元素。通常为最近的祖先 ‘svg’ 元素。如果给定元素是最外层的 svg 元素，则为 Null。 |
| [Width](../../aspose.svg.filters/svgfecolormatrixelement/width/) { get; } | 对应于给定 ‘filter’ 元素的属性 ‘width’。 |
| [X](../../aspose.svg.filters/svgfecolormatrixelement/x/) { get; } | 对应于给定 ‘filter’ 元素的属性 ‘x’。 |
| [Y](../../aspose.svg.filters/svgfecolormatrixelement/y/) { get; } | 对应于给定 ‘filter’ 元素的属性 ‘y’。 |
...
| 名称 | 描述 |
| --- | --- |
| const [SVG_FECOLORMATRIX_TYPE_HUEROTATE](../../aspose.svg.filters/svgfecolormatrixelement/svg_fecolormatrix_type_huerotate/) | 对应值 ‘hueRotate’。 |
| const [SVG_FECOLORMATRIX_TYPE_LUMINANCETOALPHA](../../aspose.svg.filters/svgfecolormatrixelement/svg_fecolormatrix_type_luminancetoalpha/) | 对应值 ‘luminanceToAlpha’。 |
| const [SVG_FECOLORMATRIX_TYPE_MATRIX](../../aspose.svg.filters/svgfecolormatrixelement/svg_fecolormatrix_type_matrix/) | 对应值 ‘matrix’。 |
| const [SVG_FECOLORMATRIX_TYPE_SATURATE](../../aspose.svg.filters/svgfecolormatrixelement/svg_fecolormatrix_type_saturate/) | 对应值 'saturate'。 |
| const [SVG_FECOLORMATRIX_TYPE_UNKNOWN](../../aspose.svg.filters/svgfecolormatrixelement/svg_fecolormatrix_type_unknown/) | 该类型不是预定义类型之一。尝试为此类型定义新值或尝试将现有值切换到此类型都是无效的。 |
