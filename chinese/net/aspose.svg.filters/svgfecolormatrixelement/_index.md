...
description: SVGFEColorMatrixElement 接口对应于feColorMatrix元素
type: docs
weight: 1660
...
| [Type](../../aspose.svg.filters/svgfecolormatrixelement/type) { get; } | 对应于给定 'feColorMatrix' 元素的属性 'type'。采用此接口上定义的 SVG_FECOLORMATRIX_TYPE_* 常量之一。 |
| [Values](../../aspose.svg.filters/svgfecolormatrixelement/values) { get; } | 对应于给定“feColorMatrix”元素的属性“值”。 |
