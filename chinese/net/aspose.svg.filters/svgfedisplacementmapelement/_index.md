...
description: Aspose.Svg.Filters.SVGFEDisplacementMapElement 班级. SVGFEDisplacementMapElement 接口对应于feDisplacementMap元素
type: docs
weight: 1710
...
| [Height](../../aspose.svg.filters/svgfedisplacementmapelement/height/) { get; } | 对应于给定“过滤器”元素上的属性“高度”。 |
...
| [Result](../../aspose.svg.filters/svgfedisplacementmapelement/result/) { get; } | 对应于给定“过滤器”元素上的属性“结果”。 |
...
| [Width](../../aspose.svg.filters/svgfedisplacementmapelement/width/) { get; } | 对应于给定“过滤器”元素上的属性“宽度”。 |
| [X](../../aspose.svg.filters/svgfedisplacementmapelement/x/) { get; } | 对应于给定“过滤器”元素上的属性“x”。 |
| [XChannelSelector](../../aspose.svg.filters/svgfedisplacementmapelement/xchannelselector/) { get; } | 对应于给定“feDisplacementMap”元素上的属性“xChannelSelector”。采用在此接口上定义的 SVG_CHANNEL_* 常量之一。 |
| [Y](../../aspose.svg.filters/svgfedisplacementmapelement/y/) { get; } | 对应于给定“过滤器”元素上的属性“y”。 |
| [YChannelSelector](../../aspose.svg.filters/svgfedisplacementmapelement/ychannelselector/) { get; } | 对应于给定“feDisplacementMap”元素上的属性“yChannelSelector”。采用在此接口上定义的 SVG_CHANNEL_* 常量之一。 |
...
| const [SVG_CHANNEL_UNKNOWN](../../aspose.svg.filters/svgfedisplacementmapelement/svg_channel_unknown/) | 该类型不是预定义类型之一。尝试定义此类型的新值或尝试将现有值切换为此类型是无效的。 |
