...
type: docs
weight: 1700
url: /zh/net/aspose.svg.filters/svgfedisplacementmapelement/
---
...
| [Height](../../aspose.svg.filters/svgfedisplacementmapelement/height) { get; } | 对应于给定“过滤器”元素的属性“高度”。 |
| [Id](../../aspose.svg/svgelement/id) { get; set; } | 给定元素的 'id' 属性的值，如果 'id' 不存在，则为空字符串。 |
| [In1](../../aspose.svg.filters/svgfedisplacementmapelement/in1) { get; } | 对应于给定 'feDisplacementMap' 元素上的属性 'in'。 |
| [In2](../../aspose.svg.filters/svgfedisplacementmapelement/in2) { get; } | 对应于给定 'feDisplacementMap' 元素上的属性 'in2'。 |
...
| [Result](../../aspose.svg.filters/svgfedisplacementmapelement/result) { get; } | 对应于给定 'filter' 元素的属性 'result'。 |
| [Scale](../../aspose.svg.filters/svgfedisplacementmapelement/scale) { get; } | 对应于给定 'feDisplacementMap' 元素上的属性 'scale'。 |
...
| [Width](../../aspose.svg.filters/svgfedisplacementmapelement/width) { get; } | 对应于给定“过滤器”元素的属性“宽度”。 |
| [X](../../aspose.svg.filters/svgfedisplacementmapelement/x) { get; } | 对应于给定“过滤器”元素的属性“x”。 |
| [XChannelSelector](../../aspose.svg.filters/svgfedisplacementmapelement/xchannelselector) { get; } | 对应于给定 'feDisplacementMap' 元素上的属性 'xChannelSelector'。采用此接口上定义的 SVG_CHANNEL_* 常量之一。 |
| [Y](../../aspose.svg.filters/svgfedisplacementmapelement/y) { get; } | 对应于给定 'filter' 元素上的属性 'y'。 |
| [YChannelSelector](../../aspose.svg.filters/svgfedisplacementmapelement/ychannelselector) { get; } | 对应于给定 'feDisplacementMap' 元素上的属性 'yChannelSelector'。采用此接口上定义的 SVG_CHANNEL_* 常量之一。 |
...
| 姓名 | 描述 |
| --- | --- |
| const [SVG_CHANNEL_A](../../aspose.svg.filters/svgfedisplacementmapelement/svg_channel_a) | 对应于值“A”。 |
| const [SVG_CHANNEL_B](../../aspose.svg.filters/svgfedisplacementmapelement/svg_channel_b) | 对应于值“B”。 |
| const [SVG_CHANNEL_G](../../aspose.svg.filters/svgfedisplacementmapelement/svg_channel_g) | 对应于值“G”。 |
| const [SVG_CHANNEL_R](../../aspose.svg.filters/svgfedisplacementmapelement/svg_channel_r) | 对应于值“R”。 |
| const [SVG_CHANNEL_UNKNOWN](../../aspose.svg.filters/svgfedisplacementmapelement/svg_channel_unknown) | 该类型不是预定义类型之一。尝试定义此类型的新值或尝试将现有值切换到此类型是无效的。 |
