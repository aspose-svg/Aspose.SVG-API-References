...
description: "Aspose.Svg.Filters.SVGFETurbulenceElement 类。SVGFETurbulenceElement 接口对应于 feTurbulence 元素"
type: docs
weight: 3980
...
此 SVGFETurbulenceElement 接口对应于 ‘feTurbulence’ 元素。
...
| [BaseFrequencyX](../../aspose.svg.filters/svgfeturbulenceelement/basefrequencyx/) { get; } | 对应给定 ‘feTurbulence’ 元素的属性 ‘baseFrequency’。包含 ‘baseFrequency’ 属性的 X 分量。 |
| [BaseFrequencyY](../../aspose.svg.filters/svgfeturbulenceelement/basefrequencyy/) { get; } | 对应给定 ‘feTurbulence’ 元素的属性 ‘baseFrequency’。包含（可能自动计算的）‘baseFrequency’ 属性的 Y 分量。 |
...
| [Height](../../aspose.svg.filters/svgfeturbulenceelement/height/) { get; } | 对应于给定 ‘filter’ 元素的属性 ‘height’。 |
...
| [NumOctaves](../../aspose.svg.filters/svgfeturbulenceelement/numoctaves/) { get; } | 对应给定 ‘feTurbulence’ 元素的属性 ‘numOctaves’。 |
...
| [Result](../../aspose.svg.filters/svgfeturbulenceelement/result/) { get; } | 对应给定 ‘filter’ 元素的属性 ‘result’。 |
| [Seed](../../aspose.svg.filters/svgfeturbulenceelement/seed/) { get; } | 对应给定 ‘feTurbulence’ 元素的属性 ‘seed’。 |
| [ShadowRoot](../../aspose.svg.dom/element/shadowroot/) { get; } | 返回存储在此元素上的 shadowRoot，如果已关闭则返回 null。 |
| [StitchTiles](../../aspose.svg.filters/svgfeturbulenceelement/stitchtiles/) { get; } | 对应给定 ‘feTurbulence’ 元素的属性 ‘stitchTiles’。取此接口上定义的 SVG_STITCHTYPE_* 常量之一。 |
...
| [Type](../../aspose.svg.filters/svgfeturbulenceelement/type/) { get; } | 对应给定 ‘feTurbulence’ 元素的属性 ‘type’。取此接口上定义的 SVG_TURBULENCE_TYPE_* 常量之一。 |
| [ViewportElement](../../aspose.svg/svgelement/viewportelement/) { get; } | 确定当前视口的元素。通常为最近的祖先 ‘svg’ 元素。如果给定元素是最外层的 svg 元素，则为 Null。 |
| [Width](../../aspose.svg.filters/svgfeturbulenceelement/width/) { get; } | 对应于给定 ‘filter’ 元素的属性 ‘width’。 |
| [X](../../aspose.svg.filters/svgfeturbulenceelement/x/) { get; } | 对应于给定 ‘filter’ 元素的属性 ‘x’。 |
| [Y](../../aspose.svg.filters/svgfeturbulenceelement/y/) { get; } | 对应于给定 ‘filter’ 元素的属性 ‘y’。 |
...
| 名称 | 描述 |
| --- | --- |
| const [SVG_STITCHTYPE_NOSTITCH](../../aspose.svg.filters/svgfeturbulenceelement/svg_stitchtype_nostitch/) | 对应值 'noStitch'。 |
| const [SVG_STITCHTYPE_STITCH](../../aspose.svg.filters/svgfeturbulenceelement/svg_stitchtype_stitch/) | 对应值 'stitch'。 |
| const [SVG_STITCHTYPE_UNKNOWN](../../aspose.svg.filters/svgfeturbulenceelement/svg_stitchtype_unknown/) | 该类型不是预定义类型之一。尝试为此类型定义新值或尝试将现有值切换到此类型都是无效的。 |
| const [SVG_TURBULENCE_TYPE_FRACTALNOISE](../../aspose.svg.filters/svgfeturbulenceelement/svg_turbulence_type_fractalnoise/) | 对应值 'fractalNoise'。 |
| const [SVG_TURBULENCE_TYPE_TURBULENCE](../../aspose.svg.filters/svgfeturbulenceelement/svg_turbulence_type_turbulence/) | 对应值 'turbulence'。 |
| const [SVG_TURBULENCE_TYPE_UNKNOWN](../../aspose.svg.filters/svgfeturbulenceelement/svg_turbulence_type_unknown/) | 该类型不是预定义类型之一。尝试为此类型定义新值或尝试将现有值切换到此类型都是无效的。 |
