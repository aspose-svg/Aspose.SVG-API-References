...
description: Aspose.Svg.Filters.SVGFETurbulenceElement 班级. SVGFETurbulenceElement 接口对应于feTurbulence元素
type: docs
weight: 1890
...
| [BaseFrequencyX](../../aspose.svg.filters/svgfeturbulenceelement/basefrequencyx/) { get; } | 对应于给定“feTurbulence”元素上的属性“baseFrequency”。包含“baseFrequency”属性的 X 分量。 |
| [BaseFrequencyY](../../aspose.svg.filters/svgfeturbulenceelement/basefrequencyy/) { get; } | 对应于给定“feTurbulence”元素上的属性“baseFrequency”。包含（可能自动计算的）“baseFrequency”属性的 Y 分量。 |
...
| [Height](../../aspose.svg.filters/svgfeturbulenceelement/height/) { get; } | 对应于给定“过滤器”元素上的属性“高度”。 |
...
| [Result](../../aspose.svg.filters/svgfeturbulenceelement/result/) { get; } | 对应于给定“过滤器”元素上的属性“结果”。 |
...
| [Type](../../aspose.svg.filters/svgfeturbulenceelement/type/) { get; } | 对应于给定“feTurbulence”元素上的属性“type”。采用在此接口上定义的 SVG_TURBULENCE_TYPE_* 常量之一。 |
| [ViewportElement](../../aspose.svg/svgelement/viewportelement/) { get; } | 建立当前视口的元素。通常，最近的祖先“svg”元素。如果给定元素是最外层的 svg 元素，则为空。 |
| [Width](../../aspose.svg.filters/svgfeturbulenceelement/width/) { get; } | 对应于给定“过滤器”元素上的属性“宽度”。 |
| [X](../../aspose.svg.filters/svgfeturbulenceelement/x/) { get; } | 对应于给定“过滤器”元素上的属性“x”。 |
| [Y](../../aspose.svg.filters/svgfeturbulenceelement/y/) { get; } | 对应于给定“过滤器”元素上的属性“y”。 |
...
| const [SVG_STITCHTYPE_UNKNOWN](../../aspose.svg.filters/svgfeturbulenceelement/svg_stitchtype_unknown/) | 该类型不是预定义类型之一。尝试定义此类型的新值或尝试将现有值切换为此类型是无效的。 |
...
| const [SVG_TURBULENCE_TYPE_TURBULENCE](../../aspose.svg.filters/svgfeturbulenceelement/svg_turbulence_type_turbulence/) | 对应于值“湍流”. |
| const [SVG_TURBULENCE_TYPE_UNKNOWN](../../aspose.svg.filters/svgfeturbulenceelement/svg_turbulence_type_unknown/) | 该类型不是预定义类型之一。尝试定义此类型的新值或尝试将现有值切换为此类型是无效的。 |
