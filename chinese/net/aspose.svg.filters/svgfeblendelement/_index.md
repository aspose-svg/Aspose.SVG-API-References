...
description: "Aspose.Svg.Filters.SVGFEBlendElement 类。SVGFEBlendElement 接口对应于 feBlend 元素。"
type: docs
weight: 3740
...
SVGFEBlendElement 接口对应 ‘feBlend’ 元素。
...
| [Height](../../aspose.svg.filters/svgfeblendelement/height/) { get; } | 对应于给定 ‘filter’ 元素的属性 ‘height’。 |
| [Id](../../aspose.svg/svgelement/id/) { get; set; } | 给定元素的 ‘id’ 属性的值，如果不存在 ‘id’，则为空字符串。 |
| [In1](../../aspose.svg.filters/svgfeblendelement/in1/) { get; } | 对应于给定 ‘feBlend’ 元素的 ‘in’ 属性。 |
| [In2](../../aspose.svg.filters/svgfeblendelement/in2/) { get; } | 对应于给定 ‘feBlend’ 元素的 ‘in2’ 属性。 |
...
| [Mode](../../aspose.svg.filters/svgfeblendelement/mode/) { get; } | 对应于给定 ‘feBlend’ 元素的 ‘mode’ 属性。取此接口中定义的 SVG_FEBLEND_MODE_* 常量之一。 |
...
| [Result](../../aspose.svg.filters/svgfeblendelement/result/) { get; } | 对应给定 ‘filter’ 元素的属性 ‘result’。 |
...
| [Width](../../aspose.svg.filters/svgfeblendelement/width/) { get; } | 对应于给定 ‘filter’ 元素的属性 ‘width’。 |
| [X](../../aspose.svg.filters/svgfeblendelement/x/) { get; } | 对应于给定 ‘filter’ 元素的属性 ‘x’。 |
| [Y](../../aspose.svg.filters/svgfeblendelement/y/) { get; } | 对应于给定 ‘filter’ 元素的属性 ‘y’。 |
...
| 名称 | 描述 |
| --- | --- |
| const [SVG_FEBLEND_MODE_COLOR](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_color/) | 对应于值 'color'。 |
...
| const [SVG_FEBLEND_MODE_DARKEN](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_darken/) | 对应于值 'darken'。 |
| const [SVG_FEBLEND_MODE_DIFFERENCE](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_difference/) | 对应于值 'difference'。 |
| const [SVG_FEBLEND_MODE_EXCLUSION](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_exclusion/) | 对应于值 'exclusion'。 |
...
| const [SVG_FEBLEND_MODE_LIGHTEN](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_lighten/) | 对应于值 'lighten'。 |
| const [SVG_FEBLEND_MODE_LUMINOSITY](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_luminosity/) | 对应于值 'luminosity'。 |
| const [SVG_FEBLEND_MODE_MULTIPLY](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_multiply/) | 对应于值 'multiply'。 |
| const [SVG_FEBLEND_MODE_NORMAL](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_normal/) | 对应于值 'normal'。 |
| const [SVG_FEBLEND_MODE_OVERLAY](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_overlay/) | 对应于值 'overlay'。 |
| const [SVG_FEBLEND_MODE_SATURATION](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_saturation/) | 对应于值 'saturation'。 |
| const [SVG_FEBLEND_MODE_SCREEN](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_screen/) | 对应于值 'screen'。 |
| const [SVG_FEBLEND_MODE_SOFT_LIGHT](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_soft_light/) | 对应于值 'soft_light'。 |
| const [SVG_FEBLEND_MODE_UNKNOWN](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_unknown/) | 该类型不是预定义类型之一。尝试为此类型定义新值或尝试将现有值切换到此类型都是无效的。 |
