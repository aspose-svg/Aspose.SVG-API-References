...
type: docs
weight: 1640
url: /zh/net/aspose.svg.filters/svgfeblendelement/
---
...
| [Height](../../aspose.svg.filters/svgfeblendelement/height) { get; } | 对应于给定“过滤器”元素的属性“高度”。 |
| [Id](../../aspose.svg/svgelement/id) { get; set; } | 给定元素的 'id' 属性的值，如果 'id' 不存在，则为空字符串。 |
| [In1](../../aspose.svg.filters/svgfeblendelement/in1) { get; } | 对应于给定 'feBlend' 元素的属性 'in'。 |
| [In2](../../aspose.svg.filters/svgfeblendelement/in2) { get; } | 对应于给定 'feBlend' 元素的属性 'in2'。 |
...
| [Mode](../../aspose.svg.filters/svgfeblendelement/mode) { get; } | 对应于给定 'feBlend' 元素的属性 'mode'。采用在此接口上定义的 SVG_FEBLEND_MODE_* 常量之一。 |
...
| [Result](../../aspose.svg.filters/svgfeblendelement/result) { get; } | 对应于给定 'filter' 元素的属性 'result'。 |
...
| [Width](../../aspose.svg.filters/svgfeblendelement/width) { get; } | 对应于给定“过滤器”元素的属性“宽度”。 |
| [X](../../aspose.svg.filters/svgfeblendelement/x) { get; } | 对应于给定“过滤器”元素的属性“x”。 |
| [Y](../../aspose.svg.filters/svgfeblendelement/y) { get; } | 对应于给定 'filter' 元素上的属性 'y'。 |
...
| 姓名 | 描述 |
| --- | --- |
| const [SVG_FEBLEND_MODE_COLOR](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_color) | 对应于值“颜色”。 |
| const [SVG_FEBLEND_MODE_COLOR_BURN](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_color_burn) | 对应于值 'color_burn'。 |
| const [SVG_FEBLEND_MODE_COLOR_DODGE](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_color_dodge) | 对应于值“color_dodge”。 |
| const [SVG_FEBLEND_MODE_DARKEN](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_darken) | 对应于值“变暗”。 |
| const [SVG_FEBLEND_MODE_DIFFERENCE](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_difference) | 对应于值“差异”。 |
| const [SVG_FEBLEND_MODE_EXCLUSION](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_exclusion) | 对应于值“排除”。 |
| const [SVG_FEBLEND_MODE_HARD_LIGHT](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_hard_light) | 对应于值 'hard_light'。 |
| const [SVG_FEBLEND_MODE_HUE](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_hue) | 对应于值 'hue'。 |
| const [SVG_FEBLEND_MODE_LIGHTEN](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_lighten) | 对应于值“减轻”。 |
| const [SVG_FEBLEND_MODE_LUMINOSITY](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_luminosity) | 对应于值“亮度”。 |
| const [SVG_FEBLEND_MODE_MULTIPLY](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_multiply) | 对应于值“乘”。 |
| const [SVG_FEBLEND_MODE_NORMAL](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_normal) | 对应于值“正常”。 |
| const [SVG_FEBLEND_MODE_OVERLAY](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_overlay) | 对应于值“覆盖”。 |
| const [SVG_FEBLEND_MODE_SATURATION](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_saturation) | 对应于值“饱和”。 |
| const [SVG_FEBLEND_MODE_SCREEN](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_screen) | 对应于值“屏幕”。 |
| const [SVG_FEBLEND_MODE_SOFT_LIGHT](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_soft_light) | 对应于值 'soft_light'。 |
| const [SVG_FEBLEND_MODE_UNKNOWN](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_unknown) | 该类型不是预定义类型之一。尝试定义此类型的新值或尝试将现有值切换到此类型是无效的。 |
