...
description: Aspose.Svg.Filters.SVGFEBlendElement 班级. SVGFEBlendElement 接口对应于feBlend元素
type: docs
weight: 1650
...
| [Height](../../aspose.svg.filters/svgfeblendelement/height/) { get; } | 对应于给定“过滤器”元素上的属性“高度”。 |
| [Id](../../aspose.svg/svgelement/id/) { get; set; } | 给定元素上“id”属性的值，如果“id”不存在则为空字符串。 |
| [In1](../../aspose.svg.filters/svgfeblendelement/in1/) { get; } | 对应于给定“feBlend”元素上的属性“in”。 |
| [In2](../../aspose.svg.filters/svgfeblendelement/in2/) { get; } | 对应于给定“feBlend”元素上的属性“in2”。 |
...
| [Mode](../../aspose.svg.filters/svgfeblendelement/mode/) { get; } | 对应于给定“feBlend”元素上的属性“mode”。采用在此接口上定义的 SVG_FEBLEND_MODE_* 常量之一。 |
...
| [Result](../../aspose.svg.filters/svgfeblendelement/result/) { get; } | 对应于给定“过滤器”元素上的属性“结果”。 |
...
| [Width](../../aspose.svg.filters/svgfeblendelement/width/) { get; } | 对应于给定“过滤器”元素上的属性“宽度”。 |
| [X](../../aspose.svg.filters/svgfeblendelement/x/) { get; } | 对应于给定“过滤器”元素上的属性“x”。 |
| [Y](../../aspose.svg.filters/svgfeblendelement/y/) { get; } | 对应于给定“过滤器”元素上的属性“y”。 |
...
| const [SVG_FEBLEND_MODE_NORMAL](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_normal/) | 对应值 'normal'. |
| const [SVG_FEBLEND_MODE_OVERLAY](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_overlay/) | 对应值 'overlay'. |
| const [SVG_FEBLEND_MODE_SATURATION](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_saturation/) | 对应于值“饱和度”。 |
...
| const [SVG_FEBLEND_MODE_UNKNOWN](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_unknown/) | 该类型不是预定义类型之一。尝试定义此类型的新值或尝试将现有值切换为此类型是无效的。 |
