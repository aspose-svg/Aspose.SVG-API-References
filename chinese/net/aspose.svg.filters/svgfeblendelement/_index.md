...
description: SVGFEBlendElement 接口对应于feBlend元素
type: docs
weight: 1650
...
| [Mode](../../aspose.svg.filters/svgfeblendelement/mode) { get; } | 对应于给定 'feBlend' 元素的属性 'mode'。采用此接口上定义的 SVG_FEBLEND_MODE_* 常量之一。 |
...
| const [SVG_FEBLEND_MODE_LIGHTEN](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_lighten) | 对应于值“变亮”。 |
