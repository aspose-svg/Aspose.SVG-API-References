...
description: "Aspose.Svg.Filters.SVGFESpotLightElement 类。SVGFESpotLightElement 接口对应于 feSpotLight 元素"
type: docs
weight: 3960
...
此 SVGFESpotLightElement 接口对应于 ‘feSpotLight’ 元素。
...
| [LimitingConeAngle](../../aspose.svg.filters/svgfespotlightelement/limitingconeangle/) { get; } | 对应给定 ‘feSpotLight’ 元素的属性 ‘limitingConeAngle’。 |
...
| [PointsAtX](../../aspose.svg.filters/svgfespotlightelement/pointsatx/) { get; } | 对应给定 ‘feSpotLight’ 元素的属性 ‘pointsAtX’。 |
| [PointsAtY](../../aspose.svg.filters/svgfespotlightelement/pointsaty/) { get; } | 对应给定 ‘feSpotLight’ 元素的属性 ‘pointsAtY’。 |
| [PointsAtZ](../../aspose.svg.filters/svgfespotlightelement/pointsatz/) { get; } | 对应给定 ‘feSpotLight’ 元素的属性 ‘pointsAtZ’。 |
...
| [SpecularExponent](../../aspose.svg.filters/svgfespotlightelement/specularexponent/) { get; } | 对应给定 ‘feSpotLight’ 元素的属性 ‘specularExponent’。 |
...
| [X](../../aspose.svg.filters/svgfespotlightelement/x/) { get; } | 对应给定 ‘feSpotLight’ 元素的属性 ‘x’。 |
| [Y](../../aspose.svg.filters/svgfespotlightelement/y/) { get; } | 对应给定 ‘feSpotLight’ 元素的属性 ‘y’。 |
| [Z](../../aspose.svg.filters/svgfespotlightelement/z/) { get; } | 对应给定 ‘feSpotLight’ 元素的属性 ‘z’。 |
