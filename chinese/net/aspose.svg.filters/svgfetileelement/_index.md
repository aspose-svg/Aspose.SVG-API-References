...
description: "Aspose.Svg.Filters.SVGFETileElement 类。SVGFETileElement 接口对应 feTile 元素"
type: docs
weight: 3970
...
此 SVGFETileElement 接口对应于 ‘feTile’ 元素。
...
| [Height](../../aspose.svg.filters/svgfetileelement/height/) { get; } | 对应于给定 ‘filter’ 元素的属性 ‘height’。 |
| [Id](../../aspose.svg/svgelement/id/) { get; set; } | 给定元素的 ‘id’ 属性的值，如果不存在 ‘id’，则为空字符串。 |
| [In1](../../aspose.svg.filters/svgfetileelement/in1/) { get; } | 对应给定 ‘feTile’ 元素的属性 ‘in’。 |
...
| [Result](../../aspose.svg.filters/svgfetileelement/result/) { get; } | 对应给定 ‘filter’ 元素的属性 ‘result’。 |
...
| [Width](../../aspose.svg.filters/svgfetileelement/width/) { get; } | 对应于给定 ‘filter’ 元素的属性 ‘width’。 |
| [X](../../aspose.svg.filters/svgfetileelement/x/) { get; } | 对应于给定 ‘filter’ 元素的属性 ‘x’。 |
| [Y](../../aspose.svg.filters/svgfetileelement/y/) { get; } | 对应于给定 ‘filter’ 元素的属性 ‘y’。 |
