...
description: "Aspose.Svg.Filters.SVGFEMorphologyElement 类。SVGFEMorphologyElement 接口对应于 feMorphology 元素"
type: docs
weight: 3920
...
此 SVGFEMorphologyElement 接口对应于 ‘feMorphology’ 元素。
...
| [Height](../../aspose.svg.filters/svgfemorphologyelement/height/) { get; } | 对应于给定 ‘filter’ 元素的属性 ‘height’。 |
| [Id](../../aspose.svg/svgelement/id/) { get; set; } | 给定元素的 ‘id’ 属性的值，如果不存在 ‘id’，则为空字符串。 |
| [In1](../../aspose.svg.filters/svgfemorphologyelement/in1/) { get; } | 对应给定 ‘feMorphology’ 元素的属性 ‘in’。 |
...
| [Operator](../../aspose.svg.filters/svgfemorphologyelement/operator/) { get; } | 对应给定 ‘feMorphology’ 元素的属性 ‘operator’。取此接口上定义的 SVG_MORPHOLOGY_OPERATOR_* 常量之一。 |
...
| [RadiusX](../../aspose.svg.filters/svgfemorphologyelement/radiusx/) { get; } | 对应给定 ‘feMorphology’ 元素的属性 ‘radius’。 |
| [RadiusY](../../aspose.svg.filters/svgfemorphologyelement/radiusy/) { get; } | 对应给定 ‘feMorphology’ 元素的属性 ‘radius’。 |
| [Result](../../aspose.svg.filters/svgfemorphologyelement/result/) { get; } | 对应给定 ‘filter’ 元素的属性 ‘result’。 |
...
| [Width](../../aspose.svg.filters/svgfemorphologyelement/width/) { get; } | 对应于给定 ‘filter’ 元素的属性 ‘width’。 |
| [X](../../aspose.svg.filters/svgfemorphologyelement/x/) { get; } | 对应于给定 ‘filter’ 元素的属性 ‘x’。 |
| [Y](../../aspose.svg.filters/svgfemorphologyelement/y/) { get; } | 对应于给定 ‘filter’ 元素的属性 ‘y’。 |
...
| 名称 | 描述 |
| --- | --- |
| const [SVG_MORPHOLOGY_OPERATOR_DILATE](../../aspose.svg.filters/svgfemorphologyelement/svg_morphology_operator_dilate/) | 对应值 ‘dilate’。 |
| const [SVG_MORPHOLOGY_OPERATOR_ERODE](../../aspose.svg.filters/svgfemorphologyelement/svg_morphology_operator_erode/) | 对应值 ‘erode’。 |
| const [SVG_MORPHOLOGY_OPERATOR_UNKNOWN](../../aspose.svg.filters/svgfemorphologyelement/svg_morphology_operator_unknown/) | 该类型不是预定义类型之一。尝试为此类型定义新值或尝试将现有值切换到此类型都是无效的。 |
