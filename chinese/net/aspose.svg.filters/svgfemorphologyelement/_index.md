...
| [Operator](../../aspose.svg.filters/svgfemorphologyelement/operator) { get; } | 对应于给定 'feMorphology' 元素的属性 'operator'。采用此接口上定义的 SVG_MORPHOLOGY_OPERATOR_* 常量之一。 |
...
| [RadiusX](../../aspose.svg.filters/svgfemorphologyelement/radiusx) { get; } | 对应于给定“feMorphology”元素的属性“半径”。 |
| [RadiusY](../../aspose.svg.filters/svgfemorphologyelement/radiusy) { get; } | 对应于给定“feMorphology”元素的属性“半径”。 |
