...
description: SVGFEMorphologyElement 接口对应于 feMorphology 元素
type: docs
weight: 1820
url: /zh/net/aspose.svg.filters/svgfemorphologyelement/
---
...
| [Height](../../aspose.svg.filters/svgfemorphologyelement/height) { get; } | 对应于给定“过滤器”元素的属性“高度”。 |
| [Id](../../aspose.svg/svgelement/id) { get; set; } | 给定元素的 'id' 属性的值，如果 'id' 不存在，则为空字符串。 |
| [In1](../../aspose.svg.filters/svgfemorphologyelement/in1) { get; } | 对应于给定 'feMorphology' 元素的属性 'in'。 |
...
| [Operator](../../aspose.svg.filters/svgfemorphologyelement/operator) { get; } | 对应于给定 'feMorphology' 元素上的属性 'operator'。采用在此接口上定义的 SVG_MORPHOLOGY_OPERATOR_* 常量之一。 |
...
| [RadiusX](../../aspose.svg.filters/svgfemorphologyelement/radiusx) { get; } | 对应于给定 'feMorphology' 元素上的属性 'radius'。 |
| [RadiusY](../../aspose.svg.filters/svgfemorphologyelement/radiusy) { get; } | 对应于给定 'feMorphology' 元素上的属性 'radius'。 |
| [Result](../../aspose.svg.filters/svgfemorphologyelement/result) { get; } | 对应于给定 'filter' 元素的属性 'result'。 |
...
| [Width](../../aspose.svg.filters/svgfemorphologyelement/width) { get; } | 对应于给定“过滤器”元素的属性“宽度”。 |
| [X](../../aspose.svg.filters/svgfemorphologyelement/x) { get; } | 对应于给定“过滤器”元素的属性“x”。 |
| [Y](../../aspose.svg.filters/svgfemorphologyelement/y) { get; } | 对应于给定 'filter' 元素上的属性 'y'。 |
...
| 姓名 | 描述 |
| --- | --- |
| const [SVG_MORPHOLOGY_OPERATOR_DILATE](../../aspose.svg.filters/svgfemorphologyelement/svg_morphology_operator_dilate) | 对应于值“扩张”。 |
| const [SVG_MORPHOLOGY_OPERATOR_ERODE](../../aspose.svg.filters/svgfemorphologyelement/svg_morphology_operator_erode) | 对应于值“侵蚀”。 |
| const [SVG_MORPHOLOGY_OPERATOR_UNKNOWN](../../aspose.svg.filters/svgfemorphologyelement/svg_morphology_operator_unknown) | 该类型不是预定义类型之一。尝试定义此类型的新值或尝试将现有值切换到此类型是无效的。 |
