...
| 姓名 | 描述 |
| --- | --- |
| [Identifier](../../aspose.svg.dom.css/counter/identifier) { get; } | 该属性用于计数器的标识符。 |
| [ListStyle](../../aspose.svg.dom.css/counter/liststyle) { get; } | 该属性用于列表的样式。 |
| [Separator](../../aspose.svg.dom.css/counter/separator) { get; } | 该属性用于嵌套计数器的分隔符。 |
