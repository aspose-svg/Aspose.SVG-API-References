...
description: StyleSheetList 接口提供样式表有序集合的抽象
type: docs
weight: 750
...
| 姓名 | 描述 |
| --- | --- |
| [Item](../../aspose.svg.dom.css/istylesheetlist/item) { get; } | 用于根据 http://www.w3.org/TR/2000/REC-DOM-Level-2-Style-20001113/stylesheets.html. 通过方法 item(int index) 检索样式表 |
