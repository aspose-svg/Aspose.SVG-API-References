...
description: "Aspose.Svg.Rendering.Image.ImageDeviceImageGraphicContext 类。保存 ImageDevice 的当前图形控制参数。这些参数定义了图形操作执行的全局框架。"
type: docs
weight: 4920
...
保存对 [`ImageDevice`](../imagedevice/) 的当前图形控制参数。这些参数定义了图形操作执行的全局框架。
...
| 名称 | 描述 |
| --- | --- |
| [ImageGraphicContext](../../aspose.svg.rendering.image/imagedevice.imagegraphiccontext/.ctor)() | 默认构造函数。 |
