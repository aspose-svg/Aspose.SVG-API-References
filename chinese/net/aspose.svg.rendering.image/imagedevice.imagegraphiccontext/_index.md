...
| 姓名 | 描述 |
| --- | --- |
| override [Clone](../../aspose.svg.rendering.image/imagegraphiccontext/clone)() | 使用与现有实例相同的属性值创建 GdiGraphicContext 类的新实例。 |
| override [Transform](../../aspose.svg.rendering.image/imagegraphiccontext/transform)(Matrix) | 通过乘以指定的矩阵来修改当前的变换矩阵。 |
