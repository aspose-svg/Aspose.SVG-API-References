...
description: Aspose.Svg.Rendering.Image.ImageDeviceImageGraphicContext 班级. 保存当前图形控制参数ImageDevice. 这些参数定义图形运算符执行的全局框架
type: docs
weight: 2840
...
| virtual [LineJoin](../../aspose.svg.rendering/graphiccontext/linejoin/) { get; set; } | 设置或获取指定描边路径的连接段之间关节形状的代码。 |
| virtual [LineWidth](../../aspose.svg.rendering/graphiccontext/linewidth/) { get; set; } | 设置或获取要描边的路径的厚度。 |
...
| override [TransformationMatrix](../../aspose.svg.rendering.image/imagegraphiccontext/transformationmatrix/) { get; set; } | 设置或获取转换矩阵。 |
...
| override [Transform](../../aspose.svg.rendering.image/imagegraphiccontext/transform/)(Matrix) | 乘以指定矩阵修改当前变换矩阵 |
