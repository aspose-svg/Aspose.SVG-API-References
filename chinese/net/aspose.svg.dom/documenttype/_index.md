...
description: "Aspose.Svg.Dom.DocumentType 类。DocumentType 提供了一个接口，用于访问文档中定义的实体列表。"
type: docs
weight: 2830
...
DocumentType 提供了一个接口，用于访问为文档定义的实体列表。
...
| 名称 | 描述 |
| --- | --- |
| [DocumentType](documenttype/)(*string, string, string, string, [Document](../document/)*) | 初始化 `DocumentType` 类的新实例。 |
...
| [InternalSubset](../../aspose.svg.dom/documenttype/internalsubset/) { get; } | 内部子集的字符串表示，如果不存在则为 null。 |
...
| [SystemId](../../aspose.svg.dom/documenttype/systemid/) { get; } | 外部子集的系统标识符。它可能是绝对 URI，也可能不是。 |
...
| override [ToString](../../aspose.svg.dom/documenttype/tostring/)() | 返回表示此实例的字符串。 |
