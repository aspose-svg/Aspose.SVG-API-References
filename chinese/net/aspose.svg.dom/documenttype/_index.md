...
description: Aspose.Svg.Dom.DocumentType 班级. DocumentType 为为文档 定义的实体列表提供接口
type: docs
weight: 830
...
| [InternalSubset](../../aspose.svg.dom/documenttype/internalsubset/) { get; } | 作为字符串的内部子集，如果没有则为 null。 |
...
| [Name](../../aspose.svg.dom/documenttype/name/) { get; } | DTD 的名称；即，紧跟在 DOCTYPE 关键字之后的名称。 |
