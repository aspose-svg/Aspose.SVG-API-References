...
description: "Aspose.Svg.Dom.Text 类。Text 接口继承自 CharacterData，并表示元素或属性的 XML 中称为字符数据的文本内容。"
type: docs
weight: 3200
url: /zh/net/aspose.svg.dom/text/
---
## Text class
...
| virtual [Data](../../aspose.svg.dom/characterdata/data/) { get; set; } | 实现此接口的节点的字符数据。 |
| [FirstChild](../../aspose.svg.dom/node/firstchild/) { get; } | 返回节点在树中的第一个子节点，如果节点没有子节点则返回 null。 |
| [IsElementContentWhitespace](../../aspose.svg.dom/text/iselementcontentwhitespace/) { get; } | 返回此文本节点是否包含元素内容空白，通常被误称为“可忽略空白”。 |
| [LastChild](../../aspose.svg.dom/node/lastchild/) { get; } | 返回节点的最后一个子节点。如果其父节点是元素，则该子节点通常是元素节点、文本节点或注释节点。如果没有子元素，则返回 null。 |
| [Length](../../aspose.svg.dom/characterdata/length/) { get; } | 通过 data 和下面的 substringData 方法可用的 16 位单元的数量。该值可能为零，即 CharacterData 节点可能为空。 |
...
| override [NodeName](../../aspose.svg.dom/text/nodename/) { get; } | 此节点的名称，取决于其类型。 |
| override [NodeType](../../aspose.svg.dom/text/nodetype/) { get; } | 表示底层对象类型的代码。 |
...
| override [TextContent](../../aspose.svg.dom/text/textcontent/) { get; set; } | 此属性返回该节点及其后代的文本内容。当其被定义为 null 时，设置它不会产生任何效果。设置时，节点可能拥有的所有子节点都会被移除，如果新字符串非空且非 null，则会被一个包含该字符串的单一 Text 节点所取代。 |
| [WholeText](../../aspose.svg.dom/text/wholetext/) { get; } | 返回此节点的逻辑相邻 Text 节点的所有文本，按文档顺序连接。 |
...
| virtual [DeleteData](../../aspose.svg.dom/characterdata/deletedata/)(*int, int*) | 从节点中移除一段 16 位单元。 |
...
| virtual [InsertData](../../aspose.svg.dom/characterdata/insertdata/)(*int, string*) | 在指定的 16 位单元偏移处插入字符串。 |
...
| virtual [ReplaceData](../../aspose.svg.dom/characterdata/replacedata/)(*int, int, string*) | 用指定的字符串替换从指定的 16 位单元偏移开始的字符。 |
| [ReplaceWholeText](../../aspose.svg.dom/text/replacewholetext/)(*string*) | 用指定文本替换当前节点及所有逻辑相邻的文本节点的文本。所有逻辑相邻的文本节点都会被移除，包括当前节点，除非它是接收替换文本的节点。 |
| [SplitText](../../aspose.svg.dom/text/splittext/)(*int*) | 在指定偏移处将此节点拆分为两个节点，保持它们在树中作为兄弟节点。 |
| virtual [SubstringData](../../aspose.svg.dom/characterdata/substringdata/)(*int, int*) | 从节点中提取一段数据。 |
| override [ToString](../../aspose.svg.dom/characterdata/tostring/)() | 返回表示此实例的字符串。 |
