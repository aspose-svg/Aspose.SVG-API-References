...
description: "Aspose.Svg.Dom.ProcessingInstruction 类。ProcessingInstruction 表示在 XML 中使用的处理指令，用于在文档文本中保留特定处理器的信息。"
type: docs
weight: 3160
url: /zh/net/aspose.svg.dom/processinginstruction/
---
...
| override [NodeName](../../aspose.svg.dom/processinginstruction/nodename/) { get; } | 此节点的名称，取决于其类型。 |
| override [NodeType](../../aspose.svg.dom/processinginstruction/nodetype/) { get; } | 表示底层对象类型的代码。 |
| override [NodeValue](../../aspose.svg.dom/processinginstruction/nodevalue/) { get; set; } | 此节点的值，取决于其类型。 |
...
| [Target](../../aspose.svg.dom/processinginstruction/target/) { get; } | 此处理指令的目标。 |
| override [TextContent](../../aspose.svg.dom/processinginstruction/textcontent/) { get; set; } | 此属性返回该节点及其后代的文本内容。当其被定义为 null 时，设置它不会产生任何效果。设置时，节点可能拥有的所有子节点都会被移除，如果新字符串非空且非 null，则会被一个包含该字符串的单一 Text 节点所取代。 |
