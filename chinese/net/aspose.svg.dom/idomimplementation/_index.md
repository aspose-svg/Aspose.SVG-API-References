...
| [CreateHTMLDocument](../../aspose.svg.dom/idomimplementation/createhtmldocument)(string) | 返回一个文档，其中包含一个包含标题元素的基本树，除非省略标题参数。 |
| [HasFeature](../../aspose.svg.dom/idomimplementation/hasfeature)() | 测试 DOM 实现是否实现了特定功能和版本，如 DOM 功能中指定的那样。 |
