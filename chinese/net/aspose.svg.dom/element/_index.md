...
description: "Aspose.Svg.Dom.Element 类。Element 接口表示 HTML 或 XML 文档中的元素。"
type: docs
weight: 2840
...
| 名称 | 描述 |
| --- | --- |
| [Element](element/)(*[QualifiedName](../qualifiedname/), [Document](../document/)*) | 初始化 `Element` 类的新实例。不要直接调用此构造函数，请使用 [`CreateElement`](../document/createelement/) 或 [`CreateElementNS`](../document/createelementns/)。 |
...
| [ParentElement](../../aspose.svg.dom/node/parentelement/) { get; } | 返回 DOM 节点的父 `Element`，如果节点没有父节点或其父节点不是 DOM Element，则返回 null。 |
...
| [AttachShadow](../../aspose.svg.dom/element/attachshadow/)(*[ShadowRootMode](../shadowrootmode/)*) | 创建 shadow root 并将其附加到当前元素。 |
...
| [GetElementsByClassName](../../aspose.svg.dom/element/getelementsbyclassname/)(*string*) | 返回包含 `element` 中所有具有参数中指定的全部类的元素的 [`HTMLCollection`](../../aspose.svg.collections/htmlcollection/) 对象。 |
| [GetElementsByTagName](../../aspose.svg.dom/element/getelementsbytagname/)(*string*) | 返回按文档顺序包含具有给定标签名的所有 `elements` 的 [`HTMLCollection`](../../aspose.svg.collections/htmlcollection/) 对象。 |
| [GetElementsByTagNameNS](../../aspose.svg.dom/element/getelementsbytagnamens/)(*string, string*) | 返回按文档顺序包含具有给定本地名称和命名空间 URI 字符串的所有 `elements` 的 [`HTMLCollection`](../../aspose.svg.collections/htmlcollection/) 对象。 |
...
| [RemoveAttributeNode](../../aspose.svg.dom/element/removeattributenode/)(*[Attr](../attr/)*) | 删除指定的属性节点。 |
...
| [SetAttributeNode](../../aspose.svg.dom/element/setattributenode/)(*[Attr](../attr/)*) | 添加新属性节点。如果元素中已存在具有该名称（nodeName）的属性，则它将被新属性替换。 |
| [SetAttributeNodeNS](../../aspose.svg.dom/element/setattributenodens/)(*[Attr](../attr/)*) | 添加新属性。如果元素中已存在具有该本地名称和命名空间 URI 的属性，则它将被新属性替换。 |
...
| [ToggleAttribute](../../aspose.svg.dom/element/toggleattribute/#toggleattribute)(*string*) | 如果未提供 force，则“切换” qualifiedName：如果它已存在则移除，若不存在则添加。如果 force 为 true，则添加 qualifiedName；如果 force 为 false，则移除 qualifiedName。 |
| [ToggleAttribute](../../aspose.svg.dom/element/toggleattribute/#toggleattribute_1)(*string, bool*) | 如果未提供 force，则“切换” qualifiedName：如果它已存在则移除，若不存在则添加。如果 force 为 true，则添加 qualifiedName；如果 force 为 false，则移除 qualifiedName。 |
