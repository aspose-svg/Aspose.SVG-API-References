...
description: Aspose.Svg.Dom.Element 班级. Element 接口表示 HTML 或 XML 文档中的元素
type: docs
weight: 840
...
| [Id](../../aspose.svg.dom/element/id/) { get; set; } | 元素的标识符。参见 HTML 4.01. 中的 id 属性定义 |
...
| [ParentElement](../../aspose.svg.dom/node/parentelement/) { get; } | 获取父级`Element`这个节点的. |
