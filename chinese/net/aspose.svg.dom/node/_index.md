...
description: Node 接口是整个 Document 对象模型的主要数据类型它代表文档树中的单个节点
type: docs
weight: 1150
...
| [CloneNode](../../aspose.svg.dom/node/clonenode#clonenode)() | 返回此节点的副本，即用作节点的通用复制构造函数。重复节点没有父节点（parentNode 为空）且没有用户数据。 |
| [CloneNode](../../aspose.svg.dom/node/clonenode#clonenode_1)(bool) | 返回此节点的副本，即用作节点的通用复制构造函数。重复节点没有父节点（parentNode 为空）且没有用户数据。 |
...
| const [CDATA_SECTION_NODE](../../aspose.svg.dom/node/cdata_section_node) | 一个 cdata 节 node |
| const [COMMENT_NODE](../../aspose.svg.dom/node/comment_node) | 一个评论节点 |
| const [DOCUMENT_FRAGMENT_NODE](../../aspose.svg.dom/node/document_fragment_node) | 文档片段节点 |
| const [DOCUMENT_NODE](../../aspose.svg.dom/node/document_node) | 一个文档节点 |
| const [DOCUMENT_TYPE_NODE](../../aspose.svg.dom/node/document_type_node) | 文档类型节点 |
| const [ELEMENT_NODE](../../aspose.svg.dom/node/element_node) | 一个元素节点 |
| const [ENTITY_NODE](../../aspose.svg.dom/node/entity_node) | 一个实体节点 |
| const [ENTITY_REFERENCE_NODE](../../aspose.svg.dom/node/entity_reference_node) | 实体引用节点 |
| const [NOTATION_NODE](../../aspose.svg.dom/node/notation_node) | 一个符号节点 |
