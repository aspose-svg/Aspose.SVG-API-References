...
description: Aspose.Svg.Dom.Node 班级. Node 接口是整个文档对象模型的主要数据类型它代表文档树中的单个节点
type: docs
weight: 1150
...
| abstract [NodeName](../../aspose.svg.dom/node/nodename/) { get; } | 此节点的名称，取决于其类型。 |
...
| [CloneNode](../../aspose.svg.dom/node/clonenode/#clonenode)() | 返回此节点的副本，即用作节点的通用复制构造函数。重复节点没有父节点（parentNode 为空），也没有用户数据。 |
| [CloneNode](../../aspose.svg.dom/node/clonenode/#clonenode_1)(bool) | 返回此节点的副本，即用作节点的通用复制构造函数。重复节点没有父节点（parentNode 为空），也没有用户数据。 |
...
| 姓名 | 描述 |
| --- | --- |
| const [ATTRIBUTE_NODE](../../aspose.svg.dom/node/attribute_node/) | 一个属性节点 |
| const [CDATA_SECTION_NODE](../../aspose.svg.dom/node/cdata_section_node/) | cdata 部分 node |
| const [COMMENT_NODE](../../aspose.svg.dom/node/comment_node/) | 注释节点 |
| const [DOCUMENT_FRAGMENT_NODE](../../aspose.svg.dom/node/document_fragment_node/) | 文档片段 node |
| const [DOCUMENT_NODE](../../aspose.svg.dom/node/document_node/) | 文档 node |
| const [DOCUMENT_TYPE_NODE](../../aspose.svg.dom/node/document_type_node/) | 文档类型 node |
| const [ELEMENT_NODE](../../aspose.svg.dom/node/element_node/) | 一个元素 node |
| const [ENTITY_NODE](../../aspose.svg.dom/node/entity_node/) | 实体节点 |
| const [ENTITY_REFERENCE_NODE](../../aspose.svg.dom/node/entity_reference_node/) | 实体引用 node |
| const [NOTATION_NODE](../../aspose.svg.dom/node/notation_node/) | 符号 node |
| const [PROCESSING_INSTRUCTION_NODE](../../aspose.svg.dom/node/processing_instruction_node/) | 一个处理指令node |
| const [TEXT_NODE](../../aspose.svg.dom/node/text_node/) | 文本节点 |
