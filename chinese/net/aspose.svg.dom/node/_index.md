...
| [CloneNode](../../aspose.svg.dom/node/clonenode#clonenode)() | 返回此节点的副本，即用作节点的通用复制构造函数。重复节点没有父节点（parentNode 为空）并且没有用户数据。 |
| [CloneNode](../../aspose.svg.dom/node/clonenode#clonenode_1)(bool) | 返回此节点的副本，即用作节点的通用复制构造函数。重复节点没有父节点（parentNode 为空）并且没有用户数据。 |
...
| const [CDATA_SECTION_NODE](../../aspose.svg.dom/node/cdata_section_node) | cdata 节节点 |
| const [COMMENT_NODE](../../aspose.svg.dom/node/comment_node) | 评论节点 |
...
| const [NOTATION_NODE](../../aspose.svg.dom/node/notation_node) | 符号节点 |
