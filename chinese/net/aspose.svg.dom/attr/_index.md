...
| override [LocalName](../../aspose.svg.dom/attr/localname) { get; } | 返回此节点的限定名称的本地部分。 对于除 ELEMENT_NODE 和 ATTRIBUTE_NODE 以外的任何类型的节点以及使用 DOM 级别 1 方法（例如 Document.createElement()）创建的节点，这始终为 null。 |
...
| override [Prefix](../../aspose.svg.dom/attr/prefix) { get; } | 此节点的命名空间前缀，如果未指定，则为 null。定义为null时，设置无效 |
...
| [Specified](../../aspose.svg.dom/attr/specified) { get; } | 如果该属性在实例文档中被明确地赋予了一个值，则为真，否则为假。 |
