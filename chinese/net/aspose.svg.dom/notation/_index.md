...
description: Aspose.Svg.Dom.Notation 班级. 表示在 DTD 中声明的符号
type: docs
weight: 1160
...
| [PublicId](../../aspose.svg.dom/notation/publicid/) { get; } | 此表示法的公共标识符。如果未指定公共标识符，则为 null. |
| [SystemId](../../aspose.svg.dom/notation/systemid/) { get; } | 此表示法的系统标识符。如果未指定系统标识符，则为空。这可能是绝对 URI，也可能不是。 |
