...
description: "Aspose.Svg.Dom.Notation 类。表示在 DTD 中声明的符号"
type: docs
weight: 3150
url: /zh/net/aspose.svg.dom/notation/
---
## Notation class
...
| override [NodeName](../../aspose.svg.dom/notation/nodename/) { get; } | 此节点的名称，取决于其类型。 |
| override [NodeType](../../aspose.svg.dom/notation/nodetype/) { get; } | 表示底层对象类型的代码。 |
...
| [PublicId](../../aspose.svg.dom/notation/publicid/) { get; } | 此符号的公共标识符。如果未指定公共标识符，则为 null。 |
| [SystemId](../../aspose.svg.dom/notation/systemid/) { get; } | 此符号的系统标识符。如果未指定系统标识符，则为 null。它可能是绝对 URI，也可能不是。 |
