...
| [PublicId](../../aspose.svg.dom/entity/publicid) { get; } | 如果指定，则与实体关联的公共标识符，否则为 null。 |
| [SystemId](../../aspose.svg.dom/entity/systemid) { get; } | 如果指定，则为与实体关联的系统标识符，否则为 null。这可能是绝对 URI，也可能不是。 |
...
| [XmlEncoding](../../aspose.svg.dom/entity/xmlencoding) { get; } | 一个属性，作为文本声明的一部分，当它是一个外部解析实体时，它指定该实体的编码。否则为空。 |
| [XmlVersion](../../aspose.svg.dom/entity/xmlversion) { get; } | 一个属性，作为文本声明的一部分，当它是一个外部解析实体时，它指定了这个实体的版本号。否则为空。 |
