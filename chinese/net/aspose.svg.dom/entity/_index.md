...
| [InputEncoding](../../aspose.svg.dom/entity/inputencoding) { get; } | 一个属性，指定在解析时用于该实体的编码，当它是一个外部解析实体时。如果它是来自内部子集的实体或者它是未知的，则为空。 |
...
| [PublicId](../../aspose.svg.dom/entity/publicid) { get; } | 与实体关联的公共标识符（如果指定），否则为 null。 |
| [SystemId](../../aspose.svg.dom/entity/systemid) { get; } | 与实体关联的系统标识符（如果指定），否则为 null。这可能是绝对 URI，也可能不是。 |
...
| [XmlEncoding](../../aspose.svg.dom/entity/xmlencoding) { get; } | 一个属性，当它是一个外部解析实体时，作为文本声明的一部分，指定该实体的编码。否则为 null。 |
| [XmlVersion](../../aspose.svg.dom/entity/xmlversion) { get; } | 一个属性，当它是一个外部解析实体时，作为文本声明的一部分，指定该实体的版本号。否则为 null。 |
