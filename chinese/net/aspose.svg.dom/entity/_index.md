...
description: "Aspose.Svg.Dom.Entity 类。表示 XML 文档中已知的实体，可为已解析或未解析的实体。"
type: docs
weight: 2850
...
| [InputEncoding](../../aspose.svg.dom/entity/inputencoding/) { get; } | 当它是外部已解析实体时，此属性指定解析时使用的编码。如果是内部子集中的实体或未知，则为 null。 |
...
| [NotationName](../../aspose.svg.dom/entity/notationname/) { get; } | 对于未解析的实体，提供实体的标记名称。对于已解析的实体，则为 null。 |
...
| [PublicId](../../aspose.svg.dom/entity/publicid/) { get; } | 如果已指定，则返回与实体关联的公共标识符，否则为 null。 |
| [SystemId](../../aspose.svg.dom/entity/systemid/) { get; } | 如果已指定，则返回与实体关联的系统标识符，否则为 null。它可以是绝对 URI，也可以不是。 |
| virtual [TextContent](../../aspose.svg.dom/node/textcontent/) { get; set; } | 表示节点及其后代的文本内容。 |
| [XmlEncoding](../../aspose.svg.dom/entity/xmlencoding/) { get; } | 当它是外部已解析实体时，此属性作为文本声明的一部分指定实体的编码。否则为 null。 |
| [XmlVersion](../../aspose.svg.dom/entity/xmlversion/) { get; } | 当它是外部已解析实体时，此属性作为文本声明的一部分指定实体的版本号。否则为 null。 |
