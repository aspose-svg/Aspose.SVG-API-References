...
description: Aspose.Svg.Dom.EntityReference 班级. EntityReference 节点可用于表示树中的实体引用
type: docs
weight: 860
url: /zh/net/aspose.svg.dom/entityreference/
---
...
| override [NodeName](../../aspose.svg.dom/entityreference/nodename/) { get; } | 此节点的名称，取决于其类型。 |
| override [NodeType](../../aspose.svg.dom/entityreference/nodetype/) { get; } | 表示底层对象类型的代码。 |
