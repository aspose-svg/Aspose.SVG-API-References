...
description: "SVGBuilderExtensions FontWeight 方法。使用预定义的字体粗细值为 SVG 元素设置 font-weight 属性"
type: docs
weight: 940
url: /zh/net/aspose.svg.builder/svgbuilderextensions/fontweight/
---
## SVGBuilderExtensions.FontWeight<TBuilder> method

使用预定义的字体粗细值为 SVG 元素设置 'font-weight' 属性。
