...
description: Aspose.Svg.Paths.SVGPathSegCurvetoCubicAbs 班级. SVGPathSegCurvetoCubicAbs 接口对应于绝对立方贝塞尔曲线C路径数据命令
type: docs
weight: 2530
...
| [X](../../aspose.svg.paths/svgpathsegcurvetocubicabs/x/) { get; set; } | 此路径段终点的绝对 X 坐标。 |
