...
description: "Aspose.Svg.Paths.SVGPathSegCurvetoQuadraticAbs 类。该 SVGPathSegCurvetoQuadraticAbs 接口对应于一个绝对二次 Bézier 曲线 curveto Q 路径数据命令。"
type: docs
weight: 4640
...
该 SVGPathSegCurvetoQuadraticAbs 接口对应一个 "absolute quadratic Bézier curveto" (Q) 路径数据命令。
...
| [X](../../aspose.svg.paths/svgpathsegcurvetoquadraticabs/x/) { get; set; } | 此路径段终点的绝对 X 坐标。 |
