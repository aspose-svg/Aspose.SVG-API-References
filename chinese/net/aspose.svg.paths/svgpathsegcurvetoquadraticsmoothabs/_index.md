...
description: SVGPathSegCurvetoQuadraticSmoothAbs 接口对应于绝对平滑三次曲线到T 路径数据命令
type: docs
weight: 2550
...
SVGPathSegCurvetoQuadraticSmoothAbs 接口对应于“绝对平滑三次曲线到”(T) 路径数据命令。
...
| [X](../../aspose.svg.paths/svgpathsegcurvetoquadraticsmoothabs/x) { get; set; } | 该路径段终点的绝对 X 坐标。 |
