...
description: Aspose.Svg.Paths.SVGPathSegLinetoVerticalRel 班级. SVGPathSegLinetoVerticalRel接口对应一个相对垂直linetov路径数据命令
type: docs
weight: 2660
...
SVGPathSegLinetoVerticalRel接口对应一个“相对垂直lineto”(v)路径数据命令。
