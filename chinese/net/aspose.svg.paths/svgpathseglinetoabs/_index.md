...
description: SVGPathSegLinetoAbs 接口对应于绝对线到L路径数据命令
type: docs
weight: 2580
...
SVGPathSegLinetoAbs 接口对应于“绝对线到”（L）路径数据命令。
...
| [Y](../../aspose.svg.paths/svgpathseglinetoabs/y) { get; set; } | 该路径段终点的绝对 Y 坐标。 |
