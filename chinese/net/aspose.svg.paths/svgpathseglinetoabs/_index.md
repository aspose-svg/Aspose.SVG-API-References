...
description: "Aspose.Svg.Paths.SVGPathSegLinetoAbs 类。SVGPathSegLinetoAbs 接口对应一个绝对 lineto (L) 路径数据命令。"
type: docs
weight: 4680
...
该 SVGPathSegLinetoAbs 接口对应一个 "absolute lineto" (L) 路径数据命令。
...
| [X](../../aspose.svg.paths/svgpathseglinetoabs/x/) { get; set; } | 此路径段终点的绝对 X 坐标。 |
