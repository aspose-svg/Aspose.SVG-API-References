...
type: docs
weight: 290
url: /zh/python-net/aspose.svg.rendering/icanvascontext/transformation_matrix/
is_root: false
---
...
Gets or sets the transformation matrix. See [`IMatrix`](/svg/python-net/aspose.svg.drawing/imatrix).
### Definition:
```python
@property
