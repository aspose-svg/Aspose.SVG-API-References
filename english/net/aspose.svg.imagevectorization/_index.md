...
| [ImageVectorizerConfiguration](./imagevectorizerconfiguration) | The ImageVectorizerConfiguration class defines a configuration of image vectorization methods and options. The configuration is used to initialize an ImageVectorizer and provides the configuration options for vectorizing images. |
| [PathBuilder](./pathbuilder) | The PathBuilder class is responsible for building path segments [`SVGPathSeg`](../aspose.svg.paths/svgpathseg) from list of the trace points. |
## Interfaces
