...
description: The ImageVectorizerConfiguration./imagevectorizerconfiguration/ class defines a configuration of image vectorization methods and options. The configuration is used to initialize an ImageVectorizer and provides the configuration options for vectorizing images.
type: docs
weight: 2150
...
The [`ImageVectorizerConfiguration`](./imagevectorizerconfiguration/) class defines a configuration of image vectorization methods and options. The configuration is used to initialize an ImageVectorizer and provides the configuration options for vectorizing images.
