...
description: BezierPathBuilder method. Builds an optimized Bezier path from a sequence of trace points. The method approximates the given trace with a Bezier curve using a combination of line and curve segments. It aims to minimize the number of segments while ensuring the path closely fits the original trace
type: docs
weight: 50
