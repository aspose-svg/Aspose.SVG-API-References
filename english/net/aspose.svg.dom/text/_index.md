...
description: Aspose.Svg.Dom.Text class. The Text interface inherits from CharacterData and represents the textual content termed character data in XML of an Element or Attr
type: docs
weight: 3290
...
| [IsElementContentWhitespace](../../aspose.svg.dom/text/iselementcontentwhitespace/) { get; } | Returns whether this text node contains element content whitespace, often abusively called "ignorable whitespace". |
...
| override [NodeName](../../aspose.svg.dom/text/nodename/) { get; } | The name of this node, depending on its type. |
| override [NodeType](../../aspose.svg.dom/text/nodetype/) { get; } | A code representing the type of the underlying object. |
| override [NodeValue](../../aspose.svg.dom/text/nodevalue/) { get; set; } | The value of this node, depending on its type. |
...
| [WholeText](../../aspose.svg.dom/text/wholetext/) { get; } | Returns all text of Text nodes logically-adjacent text nodes to this node, concatenated in document order. |
...
| [ReplaceWholeText](../../aspose.svg.dom/text/replacewholetext/)(string) | Replaces the text of the current node and all logically-adjacent text nodes with the specified text. All logically-adjacent text nodes are removed including the current node unless it was the recipient of the replacement text. |
| [SplitText](../../aspose.svg.dom/text/splittext/)(int) | Breaks this node into two nodes at the specified offset, keeping both in the tree as siblings. |
