...
description: Aspose.Svg.Dom.DocumentType class. The DocumentType provides an interface to the list of entities that are defined for the document
type: docs
weight: 3570
...
| [InternalSubset](../../aspose.svg.dom/documenttype/internalsubset/) { get; } | The internal subset as a string, or null if there is none. |
...
| [Name](../../aspose.svg.dom/documenttype/name/) { get; } | The name of DTD; i.e., the name immediately following the DOCTYPE keyword. |
...
| override [NodeName](../../aspose.svg.dom/documenttype/nodename/) { get; } | The name of this node, depending on its type. |
| override [NodeType](../../aspose.svg.dom/documenttype/nodetype/) { get; } | A code representing the type of the underlying object. |
...
| [PublicId](../../aspose.svg.dom/documenttype/publicid/) { get; } | The public identifier of the external subset. |
| [SystemId](../../aspose.svg.dom/documenttype/systemid/) { get; } | The system identifier of the external subset. This may be an absolute URI or not. |
...
| override [ToString](../../aspose.svg.dom/documenttype/tostring/)() | Returns a String that represents this instance. |
