...
| override [NodeName](../../aspose.svg.dom/notation/nodename/) { get; } | The name of this node, depending on its type. |
| override [NodeType](../../aspose.svg.dom/notation/nodetype/) { get; } | A code representing the type of the underlying object. |
...
| [PublicId](../../aspose.svg.dom/notation/publicid/) { get; } | The public identifier of this notation. If the public identifier was not specified, this is null. |
| [SystemId](../../aspose.svg.dom/notation/systemid/) { get; } | The system identifier of this notation. If the system identifier was not specified, this is null. This may be an absolute URI or not. |
