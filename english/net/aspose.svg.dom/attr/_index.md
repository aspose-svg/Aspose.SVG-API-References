...
| override [NamespaceURI](../../aspose.svg.dom/attr/namespaceuri/) { get; } | The namespace URI of this node, or null if it is unspecified. |
...
| override [NodeName](../../aspose.svg.dom/attr/nodename/) { get; } | The name of this node, depending on its type. |
| override [NodeType](../../aspose.svg.dom/attr/nodetype/) { get; } | A code representing the type of the underlying object. |
| override [NodeValue](../../aspose.svg.dom/attr/nodevalue/) { get; set; } | The value of this node, depending on its type. |
...
| [OwnerElement](../../aspose.svg.dom/attr/ownerelement/) { get; } | The Element node this attribute is attached to or null if this attribute is not in use. |
