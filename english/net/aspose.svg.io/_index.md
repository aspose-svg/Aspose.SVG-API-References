...
| [LocalFileSystemStorage](./localfilesystemstorage/) | A file system storage. |
| [OutputStream](./outputstream/) | A surrogate stream wraps the real output stream and controls access to it. [`OutputStream`](../aspose.svg.io/outputstream/) contains URI data that describes location of the output stream. |
