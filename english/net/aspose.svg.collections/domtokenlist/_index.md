...
| [Toggle](../../aspose.svg.collections/domtokenlist/toggle)(string) | Removes the token from the list if it exists, or adds the token to the list if it doesn't. |
| [Toggle](../../aspose.svg.collections/domtokenlist/toggle)(string, bool?) | Removes the token from the list if it exists, or adds the token to the list if it doesn't. |
