...
description: Aspose.Svg.Filters.SVGFEFuncAElement class. The SVGFEFuncAElement interface corresponds to the feFuncA element
type: docs
weight: 3840
...
| Name | Description |
| --- | --- |
| [Amplitude](../../aspose.svg/svgcomponenttransferfunctionelement/amplitude/) { get; } | Corresponds to attribute ‘amplitude’ on the given element. |
...
| [Exponent](../../aspose.svg/svgcomponenttransferfunctionelement/exponent/) { get; } | Corresponds to attribute ‘exponent’ on the given element. |
...
| [Intercept](../../aspose.svg/svgcomponenttransferfunctionelement/intercept/) { get; } | Corresponds to attribute ‘intercept’ on the given element. |
...
| [Offset](../../aspose.svg/svgcomponenttransferfunctionelement/offset/) { get; } | Corresponds to attribute ‘offset’ on the given element. |
...
| [Slope](../../aspose.svg/svgcomponenttransferfunctionelement/slope/) { get; } | Corresponds to attribute ‘slope’ on the given element. |
...
| [TableValues](../../aspose.svg/svgcomponenttransferfunctionelement/tablevalues/) { get; } | Corresponds to attribute ‘tableValues’ on the given element. |
...
| [Type](../../aspose.svg/svgcomponenttransferfunctionelement/type/) { get; } | Corresponds to attribute ‘type’ on the given element. Takes one of the SVG_FECOMPONENTTRANSFER_TYPE_* constants defined on this interface. |
