...
| [Height](../../aspose.svg.filters/svgfeblendelement/height/) { get; } | Corresponds to attribute ‘height’ on the given ‘filter’ element. |
...
| [In1](../../aspose.svg.filters/svgfeblendelement/in1/) { get; } | Corresponds to attribute ‘in’ on the given ‘feBlend’ element. |
| [In2](../../aspose.svg.filters/svgfeblendelement/in2/) { get; } | Corresponds to attribute ‘in2’ on the given ‘feBlend’ element. |
...
| [Mode](../../aspose.svg.filters/svgfeblendelement/mode/) { get; } | Corresponds to attribute ‘mode’ on the given ‘feBlend’ element. Takes one of the SVG_FEBLEND_MODE_* constants defined on this interface. |
...
| [Result](../../aspose.svg.filters/svgfeblendelement/result/) { get; } | Corresponds to attribute ‘result’ on the given ‘filter’ element. |
...
| [Width](../../aspose.svg.filters/svgfeblendelement/width/) { get; } | Corresponds to attribute ‘width’ on the given ‘filter’ element. |
| [X](../../aspose.svg.filters/svgfeblendelement/x/) { get; } | Corresponds to attribute ‘x’ on the given ‘filter’ element. |
| [Y](../../aspose.svg.filters/svgfeblendelement/y/) { get; } | Corresponds to attribute ‘y’ on the given ‘filter’ element. |
