...
description: Aspose.Svg.Filters.SVGFEGaussianBlurElement class. The SVGFEGaussianBlurElement interface corresponds to the feGaussianBlur element
type: docs
weight: 3880
...
| [Height](../../aspose.svg.filters/svgfegaussianblurelement/height/) { get; } | Corresponds to attribute �height� on the given �filter� element. |
...
| [In1](../../aspose.svg.filters/svgfegaussianblurelement/in1/) { get; } | Corresponds to attribute �in� on the given �feGaussianBlur� element. |
...
| [Result](../../aspose.svg.filters/svgfegaussianblurelement/result/) { get; } | Corresponds to attribute �result� on the given �filter� element. |
| [ShadowRoot](../../aspose.svg.dom/element/shadowroot/) { get; } | Returns shadowRoot stored on this element or null if it's closed. |
| [StdDeviationX](../../aspose.svg.filters/svgfegaussianblurelement/stddeviationx/) { get; } | Corresponds to attribute �stdDeviation� on the given �feGaussianBlur� element. Contains the X component of attribute �stdDeviation�. |
| [StdDeviationY](../../aspose.svg.filters/svgfegaussianblurelement/stddeviationy/) { get; } | Corresponds to attribute �stdDeviation� on the given �feGaussianBlur� element. Contains the Y component (possibly computed automatically) of attribute �stdDeviation�. |
...
| [Width](../../aspose.svg.filters/svgfegaussianblurelement/width/) { get; } | Corresponds to attribute �width� on the given �filter� element. |
| [X](../../aspose.svg.filters/svgfegaussianblurelement/x/) { get; } | Corresponds to attribute �x� on the given �filter� element. |
| [Y](../../aspose.svg.filters/svgfegaussianblurelement/y/) { get; } | Corresponds to attribute �y� on the given �filter� element. |
...
| [SetStdDeviation](../../aspose.svg.filters/svgfegaussianblurelement/setstddeviation/)(*float, float*) | Sets the values for attribute �stdDeviation�. |
