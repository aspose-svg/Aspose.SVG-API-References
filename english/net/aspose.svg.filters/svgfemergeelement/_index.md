...
description: Aspose.Svg.Filters.SVGFEMergeElement class. The SVGFEMergeElement interface corresponds to the feMerge element
type: docs
weight: 3900
...
| [Height](../../aspose.svg.filters/svgfemergeelement/height/) { get; } | Corresponds to attribute ‘height’ on the given ‘filter’ element. |
...
| [Result](../../aspose.svg.filters/svgfemergeelement/result/) { get; } | Corresponds to attribute ‘result’ on the given ‘filter’ element. |
...
| [Width](../../aspose.svg.filters/svgfemergeelement/width/) { get; } | Corresponds to attribute ‘width’ on the given ‘filter’ element. |
| [X](../../aspose.svg.filters/svgfemergeelement/x/) { get; } | Corresponds to attribute ‘x’ on the given ‘filter’ element. |
| [Y](../../aspose.svg.filters/svgfemergeelement/y/) { get; } | Corresponds to attribute ‘y’ on the given ‘filter’ element. |
