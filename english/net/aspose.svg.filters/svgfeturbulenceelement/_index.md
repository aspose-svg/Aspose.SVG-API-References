...
| [Height](../../aspose.svg.filters/svgfeturbulenceelement/height/) { get; } | Corresponds to attribute ‘height’ on the given ‘filter’ element. |
...
| [NumOctaves](../../aspose.svg.filters/svgfeturbulenceelement/numoctaves/) { get; } | Corresponds to attribute ‘numOctaves’ on the given ‘feTurbulence’ element. |
...
| [Type](../../aspose.svg.filters/svgfeturbulenceelement/type/) { get; } | Corresponds to attribute ‘type’ on the given ‘feTurbulence’ element. Takes one of the SVG_TURBULENCE_TYPE_* constants defined on this interface. |
...
| [Width](../../aspose.svg.filters/svgfeturbulenceelement/width/) { get; } | Corresponds to attribute ‘width’ on the given ‘filter’ element. |
| [X](../../aspose.svg.filters/svgfeturbulenceelement/x/) { get; } | Corresponds to attribute ‘x’ on the given ‘filter’ element. |
| [Y](../../aspose.svg.filters/svgfeturbulenceelement/y/) { get; } | Corresponds to attribute ‘y’ on the given ‘filter’ element. |
