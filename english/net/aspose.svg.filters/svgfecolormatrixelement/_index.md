...
| [Height](../../aspose.svg.filters/svgfecolormatrixelement/height/) { get; } | Corresponds to attribute ‘height’ on the given ‘filter’ element. |
...
| [In1](../../aspose.svg.filters/svgfecolormatrixelement/in1/) { get; } | Corresponds to attribute ‘in’ on the given ‘feColorMatrix’ element. |
...
| [Result](../../aspose.svg.filters/svgfecolormatrixelement/result/) { get; } | Corresponds to attribute ‘result’ on the given ‘filter’ element. |
...
| [Type](../../aspose.svg.filters/svgfecolormatrixelement/type/) { get; } | Corresponds to attribute ‘type’ on the given ‘feColorMatrix’ element. Takes one of the SVG_FECOLORMATRIX_TYPE_* constants defined on this interface. |
| [Values](../../aspose.svg.filters/svgfecolormatrixelement/values/) { get; } | Corresponds to attribute ‘values’ on the given ‘feColorMatrix’ element. |
...
| [Width](../../aspose.svg.filters/svgfecolormatrixelement/width/) { get; } | Corresponds to attribute ‘width’ on the given ‘filter’ element. |
| [X](../../aspose.svg.filters/svgfecolormatrixelement/x/) { get; } | Corresponds to attribute ‘x’ on the given ‘filter’ element. |
| [Y](../../aspose.svg.filters/svgfecolormatrixelement/y/) { get; } | Corresponds to attribute ‘y’ on the given ‘filter’ element. |
