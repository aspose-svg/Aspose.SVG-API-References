...
| [Dy](../../aspose.svg.filters/svgfedropshadowelement/dy/) { get; } | Corresponds to attribute ‘dy’ on the given ‘feDropShadow’ element. |
...
| [Height](../../aspose.svg.filters/svgfedropshadowelement/height/) { get; } | Corresponds to attribute ‘height’ on the given ‘feDropShadow’ element. |
...
| [In1](../../aspose.svg.filters/svgfedropshadowelement/in1/) { get; } | Corresponds to attribute ‘in’ on the given ‘feDropShadow’ element. |
...
| [Result](../../aspose.svg.filters/svgfedropshadowelement/result/) { get; } | Corresponds to attribute ‘result’ on the given ‘feDropShadow’ element. |
| [ShadowRoot](../../aspose.svg.dom/element/shadowroot/) { get; } | Returns shadowRoot stored on this element or null if it's closed. |
| [StdDeviationX](../../aspose.svg.filters/svgfedropshadowelement/stddeviationx/) { get; } | Corresponds to attribute ‘stdDeviation’ on the given ‘feDropShadow’ element. Contains the X component of attribute ‘stdDeviation’. |
| [StdDeviationY](../../aspose.svg.filters/svgfedropshadowelement/stddeviationy/) { get; } | Corresponds to attribute ‘stdDeviation’ on the given ‘feDropShadow’ element. Contains the Y component (possibly computed automatically) of attribute ‘stdDeviation’. |
...
| [Width](../../aspose.svg.filters/svgfedropshadowelement/width/) { get; } | Corresponds to attribute ‘width’ on the given ‘feDropShadow’ element. |
| [X](../../aspose.svg.filters/svgfedropshadowelement/x/) { get; } | Corresponds to attribute ‘x’ on the given ‘feDropShadow’ element. |
| [Y](../../aspose.svg.filters/svgfedropshadowelement/y/) { get; } | Corresponds to attribute ‘y’ on the given ‘feDropShadow’ element. |
...
| [SetStdDeviation](../../aspose.svg.filters/svgfedropshadowelement/setstddeviation/)(*float, float*) | Sets the values for attribute ‘stdDeviation’. |
