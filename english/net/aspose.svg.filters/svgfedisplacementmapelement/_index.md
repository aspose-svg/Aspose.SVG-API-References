...
description: Aspose.Svg.Filters.SVGFEDisplacementMapElement class. The SVGFEDisplacementMapElement interface corresponds to the feDisplacementMap element
type: docs
weight: 3800
...
| [Height](../../aspose.svg.filters/svgfedisplacementmapelement/height/) { get; } | Corresponds to attribute ‘height’ on the given ‘filter’ element. |
...
| [In1](../../aspose.svg.filters/svgfedisplacementmapelement/in1/) { get; } | Corresponds to attribute ‘in’ on the given ‘feDisplacementMap’ element. |
| [In2](../../aspose.svg.filters/svgfedisplacementmapelement/in2/) { get; } | Corresponds to attribute ‘in2’ on the given ‘feDisplacementMap’ element. |
...
| [Result](../../aspose.svg.filters/svgfedisplacementmapelement/result/) { get; } | Corresponds to attribute ‘result’ on the given ‘filter’ element. |
| [Scale](../../aspose.svg.filters/svgfedisplacementmapelement/scale/) { get; } | Corresponds to attribute ‘scale’ on the given ‘feDisplacementMap’ element. |
...
| [Width](../../aspose.svg.filters/svgfedisplacementmapelement/width/) { get; } | Corresponds to attribute ‘width’ on the given ‘filter’ element. |
| [X](../../aspose.svg.filters/svgfedisplacementmapelement/x/) { get; } | Corresponds to attribute ‘x’ on the given ‘filter’ element. |
| [XChannelSelector](../../aspose.svg.filters/svgfedisplacementmapelement/xchannelselector/) { get; } | Corresponds to attribute ‘xChannelSelector’ on the given ‘feDisplacementMap’ element. Takes one of the SVG_CHANNEL_* constants defined on this interface. |
| [Y](../../aspose.svg.filters/svgfedisplacementmapelement/y/) { get; } | Corresponds to attribute ‘y’ on the given ‘filter’ element. |
| [YChannelSelector](../../aspose.svg.filters/svgfedisplacementmapelement/ychannelselector/) { get; } | Corresponds to attribute ‘yChannelSelector’ on the given ‘feDisplacementMap’ element. Takes one of the SVG_CHANNEL_* constants defined on this interface. |
