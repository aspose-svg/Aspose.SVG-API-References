...
description: Aspose.Svg.Filters.SVGFEOffsetElement class. The SVGFEOffsetElement interface corresponds to the feOffset element
type: docs
weight: 3930
...
| [Dx](../../aspose.svg.filters/svgfeoffsetelement/dx/) { get; } | Corresponds to attribute ‘dx’ on the given ‘feOffset’ element. |
| [Dy](../../aspose.svg.filters/svgfeoffsetelement/dy/) { get; } | Corresponds to attribute ‘dy’ on the given ‘feOffset’ element. |
...
| [Height](../../aspose.svg.filters/svgfeoffsetelement/height/) { get; } | Corresponds to attribute ‘height’ on the given ‘filter’ element. |
...
| [In1](../../aspose.svg.filters/svgfeoffsetelement/in1/) { get; } | Corresponds to attribute ‘in’ on the given ‘feOffset’ element. |
...
| [Result](../../aspose.svg.filters/svgfeoffsetelement/result/) { get; } | Corresponds to attribute ‘result’ on the given ‘filter’ element. |
...
| [Width](../../aspose.svg.filters/svgfeoffsetelement/width/) { get; } | Corresponds to attribute ‘width’ on the given ‘filter’ element. |
| [X](../../aspose.svg.filters/svgfeoffsetelement/x/) { get; } | Corresponds to attribute ‘x’ on the given ‘filter’ element. |
| [Y](../../aspose.svg.filters/svgfeoffsetelement/y/) { get; } | Corresponds to attribute ‘y’ on the given ‘filter’ element. |
