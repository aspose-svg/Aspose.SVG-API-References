...
| [DiffuseConstant](../../aspose.svg.filters/svgfediffuselightingelement/diffuseconstant/) { get; } | Corresponds to attribute ‘diffuseConstant’ on the given ‘feDiffuseLighting’ element. |
...
| [Height](../../aspose.svg.filters/svgfediffuselightingelement/height/) { get; } | Corresponds to attribute ‘height’ on the given ‘filter’ element. |
...
| [In1](../../aspose.svg.filters/svgfediffuselightingelement/in1/) { get; } | Corresponds to attribute ‘in’ on the given ‘feDiffuseLighting’ element. |
...
| [KernelUnitLengthX](../../aspose.svg.filters/svgfediffuselightingelement/kernelunitlengthx/) { get; } | Corresponds to attribute ‘kernelUnitLength’ on the given ‘feDiffuseLighting’ element. |
| [KernelUnitLengthY](../../aspose.svg.filters/svgfediffuselightingelement/kernelunitlengthy/) { get; } | Corresponds to attribute ‘kernelUnitLength’ on the given ‘feDiffuseLighting’ element. |
...
| [Result](../../aspose.svg.filters/svgfediffuselightingelement/result/) { get; } | Corresponds to attribute ‘result’ on the given ‘filter’ element. |
...
| [SurfaceScale](../../aspose.svg.filters/svgfediffuselightingelement/surfacescale/) { get; } | Corresponds to attribute ‘surfaceScale’ on the given ‘feDiffuseLighting’ element. |
...
| [Width](../../aspose.svg.filters/svgfediffuselightingelement/width/) { get; } | Corresponds to attribute ‘width’ on the given ‘filter’ element. |
| [X](../../aspose.svg.filters/svgfediffuselightingelement/x/) { get; } | Corresponds to attribute ‘x’ on the given ‘filter’ element. |
| [Y](../../aspose.svg.filters/svgfediffuselightingelement/y/) { get; } | Corresponds to attribute ‘y’ on the given ‘filter’ element. |
