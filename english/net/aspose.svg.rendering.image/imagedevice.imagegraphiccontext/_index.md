...
| override [TransformationMatrix](../../aspose.svg.rendering.image/imagedevice.imagegraphiccontext/transformationmatrix) { get; set; } | Sets or gets transformation matrix. |

## Methods

| Name | Description |
| --- | --- |
| override [Clone](../../aspose.svg.rendering.image/imagedevice.imagegraphiccontext/clone)() | Creates a new instance of a GdiGraphicContext class with the same property values as an existing instance. |
| override [Transform](../../aspose.svg.rendering.image/imagedevice.imagegraphiccontext/transform)(Matrix) | Modify the current transformation matrix by multiplying the specified matrix. |
