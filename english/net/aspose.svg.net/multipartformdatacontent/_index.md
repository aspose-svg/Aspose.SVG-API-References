...
| Name | Description |
| --- | --- |
| override [Add](../../aspose.svg.net/multipartformdatacontent/add/#add)(*[Content](../content/)*) | Add the content to the `MultipartFormDataContent` class |
| [Add](../../aspose.svg.net/multipartformdatacontent/add/#add_1)(*[Content](../content/), string*) | Add the content to the `MultipartFormDataContent` class with field name parameter |
| [Add](../../aspose.svg.net/multipartformdatacontent/add/#add_2)(*[Content](../content/), string, string*) | Add the content to the `MultipartFormDataContent` class with field and file name parameter |
