...
description: Aspose.Svg.SVGTextPathElement class. The SVGTextPathElement interface corresponds to the textPath element
type: docs
weight: 5600
...
| [Href](../../aspose.svg/svgtextpathelement/href/) { get; } | Corresponds to attribute ‘xlink:href’ on the given element. |
...
| [LengthAdjust](../../aspose.svg/svgtextcontentelement/lengthadjust/) { get; } | Corresponds to attribute ‘lengthAdjust’ on the given element. The value must be one of the length adjust constants defined on this interface. |
...
| [Method](../../aspose.svg/svgtextpathelement/method/) { get; } | Corresponds to attribute ‘method’ on the given ‘textPath’ element. |
...
| [Spacing](../../aspose.svg/svgtextpathelement/spacing/) { get; } | Corresponds to attribute ‘spacing’ on the given ‘textPath’ element. |
| [StartOffset](../../aspose.svg/svgtextpathelement/startoffset/) { get; } | Corresponds to attribute ‘startOffset’ on the given ‘textPath’ element. |
...
| [TextLength](../../aspose.svg/svgtextcontentelement/textlength/) { get; } | Corresponds to attribute ‘textLength’ on the given element. |
...
| [GetComputedTextLength](../../aspose.svg/svgtextcontentelement/getcomputedtextlength/)() | The total sum of all of the advance values from rendering all of the characters within this element, including the advance value on the glyphs (horizontal or vertical), the effect of properties ‘kerning’, ‘letter-spacing’ and ‘word-spacing’ and adjustments due to attributes ‘dx’ and ‘dy’ on ‘tspan’ elements. For non-rendering environments, the user agent shall make reasonable assumptions about glyph metrics. |
...
| Name | Description |
| --- | --- |
| const [TEXTPATH_METHODTYPE_ALIGN](../../aspose.svg/svgtextpathelement/textpath_methodtype_align/) | Corresponds to value 'align'. |
| const [TEXTPATH_METHODTYPE_STRETCH](../../aspose.svg/svgtextpathelement/textpath_methodtype_stretch/) | Corresponds to value 'stretch'. |
| const [TEXTPATH_METHODTYPE_UNKNOWN](../../aspose.svg/svgtextpathelement/textpath_methodtype_unknown/) | The enumeration was set to a value that is not one of predefined types. It is invalid to attempt to define a new value of this type or to attempt to switch an existing value to this type. |
| const [TEXTPATH_SPACINGTYPE_AUTO](../../aspose.svg/svgtextpathelement/textpath_spacingtype_auto/) | Corresponds to value 'auto'. |
| const [TEXTPATH_SPACINGTYPE_EXACT](../../aspose.svg/svgtextpathelement/textpath_spacingtype_exact/) | Corresponds to value 'exact'. |
| const [TEXTPATH_SPACINGTYPE_UNKNOWN](../../aspose.svg/svgtextpathelement/textpath_spacingtype_unknown/) | The enumeration was set to a value that is not one of predefined types. It is invalid to attempt to define a new value of this type or to attempt to switch an existing value to this type. |
