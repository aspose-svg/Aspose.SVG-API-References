...
description: Aspose.Svg.SVGFilterElement class. The SVGFilterElement interface corresponds to the filter element
type: docs
weight: 5310
...
| [FilterUnits](../../aspose.svg/svgfilterelement/filterunits/) { get; } | Corresponds to attribute ‘filterUnits’ on the given ‘filter’ element. Takes one of the constants defined in SVGUnitTypes. |
...
| [Height](../../aspose.svg/svgfilterelement/height/) { get; } | Corresponds to attribute ‘height’ on the given ‘filter’ element. |
| [Href](../../aspose.svg/svgfilterelement/href/) { get; } | Corresponds to attribute ‘xlink:href’ on the given element. |
...
| [PrimitiveUnits](../../aspose.svg/svgfilterelement/primitiveunits/) { get; } | Corresponds to attribute ‘primitiveUnits’ on the given ‘filter’ element. Takes one of the constants defined in SVGUnitTypes. |
...
| [Width](../../aspose.svg/svgfilterelement/width/) { get; } | Corresponds to attribute ‘width’ on the given ‘filter’ element. |
| [X](../../aspose.svg/svgfilterelement/x/) { get; } | Corresponds to attribute ‘x’ on the given ‘filter’ element. |
| [Y](../../aspose.svg/svgfilterelement/y/) { get; } | Corresponds to attribute ‘y’ on the given ‘filter’ element. |
