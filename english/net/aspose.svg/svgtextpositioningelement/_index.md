...
description: Aspose.Svg.SVGTextPositioningElement class. The SVGTextPositioningElement interface is inherited by text-related interfaces SVGTextElement SVGTSpanElement SVGTRefElement and SVGAltGlyphElement
type: docs
weight: 5620
...
| [Dx](../../aspose.svg/svgtextpositioningelement/dx/) { get; } | Corresponds to attribute ‘dx’ on the given element. |
| [Dy](../../aspose.svg/svgtextpositioningelement/dy/) { get; } | Corresponds to attribute ‘dy’ on the given element. |
...
| [Rotate](../../aspose.svg/svgtextpositioningelement/rotate/) { get; } | Corresponds to attribute ‘rotate’ on the given element. |
...
| [X](../../aspose.svg/svgtextpositioningelement/x/) { get; } | Corresponds to attribute ‘x’ on the given element. |
| [Y](../../aspose.svg/svgtextpositioningelement/y/) { get; } | Corresponds to attribute ‘y’ on the given element. |
