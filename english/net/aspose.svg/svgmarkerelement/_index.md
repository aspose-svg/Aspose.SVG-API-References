...
| [MarkerHeight](../../aspose.svg/svgmarkerelement/markerheight/) { get; } | Corresponds to attribute ‘markerHeight’ on the given ‘marker’ element. |
| [MarkerUnits](../../aspose.svg/svgmarkerelement/markerunits/) { get; } | Corresponds to attribute ‘markerUnits’ on the given ‘marker’ element. One of the Marker Unit Types defined on this interface. |
| [MarkerWidth](../../aspose.svg/svgmarkerelement/markerwidth/) { get; } | Corresponds to attribute ‘markerWidth’ on the given ‘marker’ element. |
...
| [OrientAngle](../../aspose.svg/svgmarkerelement/orientangle/) { get; } | Corresponds to attribute ‘orient’ on the given ‘marker’ element. If markerUnits is SVG_MARKER_ORIENT_ANGLE, the angle value for attribute ‘orient’; otherwise, it will be set to zero. |
| [OrientType](../../aspose.svg/svgmarkerelement/orienttype/) { get; } | Corresponds to attribute ‘orient’ on the given ‘marker’ element. One of the Marker Orientation Types defined on this interface. |
...
| [PreserveAspectRatio](../../aspose.svg/svgmarkerelement/preserveaspectratio/) { get; } | Corresponds to attribute ‘preserveAspectRatio’ on the given element. |
...
| [RefX](../../aspose.svg/svgmarkerelement/refx/) { get; } | Corresponds to attribute ‘refX’ on the given ‘marker’ element. |
| [RefY](../../aspose.svg/svgmarkerelement/refy/) { get; } | Corresponds to attribute ‘refY’ on the given ‘marker’ element. |
...
| [ViewBox](../../aspose.svg/svgmarkerelement/viewbox/) { get; } | Corresponds to attribute ‘viewBox’ on the given element. |
...
| [SetOrientToAngle](../../aspose.svg/svgmarkerelement/setorienttoangle/)(*[SVGAngle](../../aspose.svg.datatypes/svgangle/)*) | Sets the value of attribute ‘orient’ to the given angle. |
| [SetOrientToAuto](../../aspose.svg/svgmarkerelement/setorienttoauto/)() | Sets the value of attribute ‘orient’ to 'auto'. |
...
| Name | Description |
| --- | --- |
| const [SVG_MARKERUNITS_STROKEWIDTH](../../aspose.svg/svgmarkerelement/svg_markerunits_strokewidth/) | The value of attribute ‘markerUnits’ is 'strokeWidth'. |
| const [SVG_MARKERUNITS_UNKNOWN](../../aspose.svg/svgmarkerelement/svg_markerunits_unknown/) | The marker unit type is not one of predefined types. It is invalid to attempt to define a new value of this type or to attempt to switch an existing value to this type. |
| const [SVG_MARKERUNITS_USERSPACEONUSE](../../aspose.svg/svgmarkerelement/svg_markerunits_userspaceonuse/) | The value of attribute ‘markerUnits’ is 'userSpaceOnUse'. |
| const [SVG_MARKER_ORIENT_ANGLE](../../aspose.svg/svgmarkerelement/svg_marker_orient_angle/) | Attribute ‘orient’ has an angle value. |
| const [SVG_MARKER_ORIENT_AUTO](../../aspose.svg/svgmarkerelement/svg_marker_orient_auto/) | Attribute ‘orient’ has value 'auto'. |
| const [SVG_MARKER_ORIENT_UNKNOWN](../../aspose.svg/svgmarkerelement/svg_marker_orient_unknown/) | The marker orientation is not one of predefined types. It is invalid to attempt to define a new value of this type or to attempt to switch an existing value to this type. |
