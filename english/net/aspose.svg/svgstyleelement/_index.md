...
description: Aspose.Svg.SVGStyleElement class. The SVGStyleElement interface corresponds to the style element
type: docs
weight: 5550
...
| [Media](../../aspose.svg/svgstyleelement/media/) { get; set; } | Corresponds to attribute ‘media’ on the given element. |
...
| [Sheet](../../aspose.svg/svgstyleelement/sheet/) { get; } | Gets the associated style sheet. |
...
| [Title](../../aspose.svg/svgstyleelement/title/) { get; set; } | Corresponds to attribute ‘title’ on the given element. |
| [Type](../../aspose.svg/svgstyleelement/type/) { get; set; } | Corresponds to attribute ‘type’ on the given element. |
