...
| [Height](../../aspose.svg/svgmaskelement/height/) { get; } | Corresponds to attribute ‘height’ on the given ‘mask’ element. Takes one of the constants defined in SVGUnitTypes. |
...
| [MaskContentUnits](../../aspose.svg/svgmaskelement/maskcontentunits/) { get; } | Corresponds to attribute ‘maskContentUnits’ on the given ‘mask’ element. Takes one of the constants defined in SVGUnitTypes. |
| [MaskUnits](../../aspose.svg/svgmaskelement/maskunits/) { get; } | Corresponds to attribute ‘maskUnits’ on the given ‘mask’ element. Takes one of the constants defined in SVGUnitTypes. |
...
| [RequiredExtensions](../../aspose.svg/svgmaskelement/requiredextensions/) { get; } | Corresponds to attribute ‘requiredExtensions’ on the given element. |
| [RequiredFeatures](../../aspose.svg/svgmaskelement/requiredfeatures/) { get; } | Corresponds to attribute ‘requiredFeatures’ on the given element. |
...
| [SystemLanguage](../../aspose.svg/svgmaskelement/systemlanguage/) { get; } | Corresponds to attribute ‘systemLanguage’ on the given element. |
...
| [Width](../../aspose.svg/svgmaskelement/width/) { get; } | Corresponds to attribute ‘width’ on the given ‘mask’ element. Takes one of the constants defined in SVGUnitTypes. |
| [X](../../aspose.svg/svgmaskelement/x/) { get; } | Corresponds to attribute ‘x’ on the given ‘mask’ element. Takes one of the constants defined in SVGUnitTypes. |
| [Y](../../aspose.svg/svgmaskelement/y/) { get; } | Corresponds to attribute ‘y’ on the given ‘mask’ element. Takes one of the constants defined in SVGUnitTypes. |
