...
description: Aspose.Svg.SVGPatternElement class. The SVGPatternElement interface corresponds to the pattern element
type: docs
weight: 5450
...
| [Height](../../aspose.svg/svgpatternelement/height/) { get; } | Corresponds to attribute ‘height’ on the given ‘pattern’ element. |
| [Href](../../aspose.svg/svgpatternelement/href/) { get; } | Corresponds to attribute ‘xlink:href’ on the given element. |
...
| [PatternContentUnits](../../aspose.svg/svgpatternelement/patterncontentunits/) { get; } | Corresponds to attribute ‘patternContentUnits’ on the given ‘pattern’ element. Takes one of the constants defined in SVGUnitTypes. |
| [PatternTransform](../../aspose.svg/svgpatternelement/patterntransform/) { get; } | Corresponds to attribute ‘patternTransform’ on the given ‘pattern’ element. |
| [PatternUnits](../../aspose.svg/svgpatternelement/patternunits/) { get; } | Corresponds to attribute ‘patternUnits’ on the given ‘pattern’ element. Takes one of the constants defined in SVGUnitTypes. |
...
| [PreserveAspectRatio](../../aspose.svg/svgpatternelement/preserveaspectratio/) { get; } | Corresponds to attribute ‘preserveAspectRatio’ on the given element. |
...
| [RequiredExtensions](../../aspose.svg/svgpatternelement/requiredextensions/) { get; } | Corresponds to attribute ‘requiredExtensions’ on the given element. |
| [RequiredFeatures](../../aspose.svg/svgpatternelement/requiredfeatures/) { get; } | Corresponds to attribute ‘requiredFeatures’ on the given element. |
...
| [SystemLanguage](../../aspose.svg/svgpatternelement/systemlanguage/) { get; } | Corresponds to attribute ‘systemLanguage’ on the given element. |
...
| [ViewBox](../../aspose.svg/svgpatternelement/viewbox/) { get; } | Corresponds to attribute ‘viewBox’ on the given element. |
...
| [Width](../../aspose.svg/svgpatternelement/width/) { get; } | Corresponds to attribute ‘width’ on the given ‘pattern’ element. |
| [X](../../aspose.svg/svgpatternelement/x/) { get; } | Corresponds to attribute ‘x’ on the given ‘pattern’ element. |
| [Y](../../aspose.svg/svgpatternelement/y/) { get; } | Corresponds to attribute ‘y’ on the given ‘pattern’ element. |
