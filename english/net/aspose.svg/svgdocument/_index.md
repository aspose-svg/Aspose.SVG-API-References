...
| [Save](../../aspose.svg/svgdocument/save)(IOutputStorage) | Saves the document content and resources to the output storage. |
| [Save](../../aspose.svg/svgdocument/save)(string) | Saves the document to local file specified by `path`. All resources used in this document will be saved in to adjacent folder, whose name will be constructed as: output_file_name + "_files". |
| [Save](../../aspose.svg/svgdocument/save)(Url) | Saves the document to local file specified by `url`. All resources used in this document will be saved in to adjacent folder, whose name will be constructed as: output_file_name + "_files". |
| [Save](../../aspose.svg/svgdocument/save)(IOutputStorage, SVGSaveFormat) | Saves the document content and resources to the output storage. |
| [Save](../../aspose.svg/svgdocument/save)(IOutputStorage, SVGSaveOptions) | Saves the document content and resources to the output storage. |
| [Save](../../aspose.svg/svgdocument/save)(string, SVGSaveFormat) | Saves the document to local file specified by `path`. All resources used in this document will be saved in to adjacent folder, whose name will be constructed as: output_file_name + "_files". |
| [Save](../../aspose.svg/svgdocument/save)(string, SVGSaveOptions) | Saves the document to local file specified by `path`. All resources used in this document will be saved in to adjacent folder, whose name will be constructed as: output_file_name + "_files". |
| [Save](../../aspose.svg/svgdocument/save)(Url, SVGSaveFormat) | Saves the document to local file specified by `url`. All resources used in this document will be saved in to adjacent folder, whose name will be constructed as: output_file_name + "_files". |
| [Save](../../aspose.svg/svgdocument/save)(Url, SVGSaveOptions) | Saves the document to local file specified by `url`. All resources used in this document will be saved in to adjacent folder, whose name will be constructed as: output_file_name + "_files". |
