...
description: Aspose.Svg.Paths.SVGPathSegLinetoRel class. The SVGPathSegLinetoRel interface corresponds to a relative lineto l path data command
type: docs
weight: 4730
...
| [X](../../aspose.svg.paths/svgpathseglinetorel/x/) { get; set; } | The relative X coordinate for the end point of this path segment. |
| [Y](../../aspose.svg.paths/svgpathseglinetorel/y/) { get; set; } | The relative Y coordinate for the end point of this path segment. |
