...
| [X](../../aspose.svg.paths/svgpathsegcurvetocubicabs/x/) { get; set; } | The absolute X coordinate for the end point of this path segment. |
| [X1](../../aspose.svg.paths/svgpathsegcurvetocubicabs/x1/) { get; set; } | The absolute X coordinate for the first control point. |
| [X2](../../aspose.svg.paths/svgpathsegcurvetocubicabs/x2/) { get; set; } | The absolute X coordinate for the second control point. |
| [Y](../../aspose.svg.paths/svgpathsegcurvetocubicabs/y/) { get; set; } | The absolute Y coordinate for the end point of this path segment. |
| [Y1](../../aspose.svg.paths/svgpathsegcurvetocubicabs/y1/) { get; set; } | The absolute Y coordinate for the first control point. |
| [Y2](../../aspose.svg.paths/svgpathsegcurvetocubicabs/y2/) { get; set; } | The absolute Y coordinate for the second control point. |
