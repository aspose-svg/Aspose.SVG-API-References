---
title: SVGFEMorphologyElementBuilder.SetOperator
...
type: docs
weight: 30
url: /net/aspose.svg.builder/svgfemorphologyelementbuilder/setoperator/
---
## SVGFEMorphologyElementBuilder.SetOperator method

Sets the 'operator' attribute of the feMorphology element, specifying the type of morphological operation.

```csharp
public SVGFEMorphologyElementBuilder SetOperator(MorphologyOperator op)
```
