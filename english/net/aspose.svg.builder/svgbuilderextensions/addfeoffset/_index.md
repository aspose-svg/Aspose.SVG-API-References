...
description: SVGBuilderExtensions method. Adds an feOffset element to the SVG builder creating an offset effect by shifting the input image by a specified vector
type: docs
weight: 260
url: /net/aspose.svg.builder/svgbuilderextensions/addfeoffset/
---
## AddFeOffset&lt;TBuilder&gt;(this TBuilder, double?, double?, OneOf&lt;string, FilterInput&gt;, string, OneOf&lt;double, (double, LengthType)&gt;, OneOf&lt;double, (double, LengthType)&gt;, OneOf&lt;double, (double, LengthType)&gt;, OneOf&lt;double, (double, LengthType)&gt;, OneOf&lt;Color, Paint&gt;, OneOf&lt;Color, Paint&gt;, string, Action&lt;SVGFEOffsetElementBuilder&gt;) {#addfeoffset_1}
