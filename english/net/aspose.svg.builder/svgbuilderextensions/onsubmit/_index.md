...
description: SVGBuilderExtensions OnSubmit method. Sets the onsubmit event attribute for handling form submission events
type: docs
weight: 1790
...
| value | The JavaScript function or script to execute when a form is submitted. |
