...
description: SVGBuilderExtensions method. Adds a linearGradient element to the SVG builder specifying its start and end positions along with other gradient properties
type: docs
weight: 360
