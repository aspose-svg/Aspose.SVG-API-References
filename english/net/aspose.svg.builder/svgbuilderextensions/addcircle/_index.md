...
---
## AddCircle&lt;TBuilder&gt;(this TBuilder, OneOf&lt;double, (double, LengthType)&gt;, OneOf&lt;double, (double, LengthType)&gt;, OneOf&lt;double, (double, LengthType)&gt;, OneOf&lt;Color, Paint&gt;, OneOf&lt;Color, Paint&gt;, string, Action&lt;SVGCircleElementBuilder&gt;) {#addcircle}
...
public static TBuilder AddCircle<TBuilder>(this TBuilder builder, 
    ...
    OneOf<double, (double, LengthType)> r = null, OneOf<Color, Paint> fill = null, 
...
| fill | The fill color or paint style for the circle. Can be a Color or a Paint enum value. Optional parameter. |
| stroke | The stroke color or paint style for the circle's outline. Can be a Color or a Paint enum value. Optional parameter. |
