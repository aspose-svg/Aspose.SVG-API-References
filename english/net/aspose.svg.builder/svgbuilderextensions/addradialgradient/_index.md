...
description: SVGBuilderExtensions method. Adds a radialGradient element to the SVG builder specifying its center radius and focal points along with other gradient properties
type: docs
weight: 440
