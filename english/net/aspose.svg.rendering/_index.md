...
| [DeviceAdapter](./deviceadapter/) | Represents a device adapter that adapts the interface of the wrapped device. |
...
| --- | --- |
| [ICanvas](./icanvas/) | Represents a canvas for drawing 2D graphics. |
| [ICanvasContext](./icanvascontext/) | Represents the context of an HTML canvas 2D drawing. |
| [ICanvasFactory](./icanvasfactory/) | Represents a factory for creating instances of the canvas. |
| [ICanvasPathFactory](./icanvaspathfactory/) | Represents a factory for creating canvas paths. |
...
| [IPath](./ipath/) | Represents a path for defining shapes or outlines. |
| [ISVGDeviceContext](./isvgdevicecontext/) | Represents a device context for SVG rendering. |
| [ISVGDeviceContextFactory](./isvgdevicecontextfactory/) | Represents a factory for creating SVG device contexts. |
| [ISVGElementRendererService](./isvgelementrendererservice/) | Represents a service for rendering SVG elements. |
| [ISVGRenderContext](./isvgrendercontext/) | Represents a rendering context for SVG rendering. |
| [ISVGRenderContextFactory](./isvgrendercontextfactory/) | Represents a factory for creating SVG render contexts. |
## Enumeration

| Enumeration | Description |
| --- | --- |
| [AtPagePriority](./atpagepriority/) | Specifies possible orders of applying page size declarations. |
| [ClipStrategy](./clipstrategy/) | Specifies the strategy for clipping an SVG element. This enum is used to determine how to apply clipping paths or masks to SVG elements during rendering. |
