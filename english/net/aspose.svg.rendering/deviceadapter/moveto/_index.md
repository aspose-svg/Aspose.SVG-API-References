---
title: DeviceAdapter.MoveTo
second_title: Aspose.SVG for .NET API Reference
description: DeviceAdapter method. Begins a new subpath by moving the current point to coordinates of the parameter pt omitting any connecting line segment. If the previous path construction method in the current path was also MoveTo the new MoveTo overrides it no vestige of the previous MoveTo operation remains in the path
type: docs
weight: 210
url: /net/aspose.svg.rendering/deviceadapter/moveto/
---
## DeviceAdapter.MoveTo method
