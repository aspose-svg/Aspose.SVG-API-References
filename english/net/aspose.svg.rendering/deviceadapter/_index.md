...
```csharp
public class DeviceAdapter : Device, IDevice
```
...
| Name | Description |
| --- | --- |
| [DeviceAdapter](deviceadapter/)(*[IDevice](../idevice/)*) | Initializes a new instance of the `DeviceAdapter` class. |

## Properties

| Name | Description |
| --- | --- |
| [AdaptedDevice](../../aspose.svg.rendering/deviceadapter/adapteddevice/) { get; set; } | Gets or sets the adapted device. See [`IDevice`](../idevice/). |
