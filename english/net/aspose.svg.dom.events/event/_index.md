...
| [InitEvent](../../aspose.svg.dom.events/event/initevent/)(string, bool, bool) | The [`InitEvent`](./initevent/) method is used to initialize the value of an `Event` created through the [`IDocumentEvent`](../idocumentevent/) interface. |
