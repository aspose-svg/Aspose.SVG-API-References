...
description: ITreeWalker PreviousSibling method. Moves the TreeWalker to the previous sibling of the current node and returns the new node. If the current node has no visible previous sibling returns null and retains the current node
type: docs
weight: 80
url: /net/aspose.svg.dom.traversal/itreewalker/previoussibling/
---
