...
type: docs
weight: 30
url: /python-net/aspose.svg.dom/processinginstruction/append_child/
is_root: false
---
...
| :- | :- | :- |
| node | [`Node`](/svg/python-net/aspose.svg.dom/node) | The node to append to the given parent node (commonly an element). |
### Exceptions
