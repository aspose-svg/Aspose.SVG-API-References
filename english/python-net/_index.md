...
| [`aspose.svg.dom.xpath`](/svg/python-net/aspose.svg.dom.xpath) | The **Aspose.Svg.Dom.XPath**  namespace contains methods to<br/>navigate through elements and attributes in an XML document. |
...
| [`aspose.svg.rendering.skia`](/svg/python-net/aspose.svg.rendering.skia) | The **Aspose.Svg.Rendering.Skia**  namespace provides<br/>specific device class as well as few rendering options classes<br/>responsible for rendering to a Skia canvas. |
