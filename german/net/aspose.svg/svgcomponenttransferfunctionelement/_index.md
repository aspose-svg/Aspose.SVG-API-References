...
description: "Aspose.Svg.SVGComponentTransferFunctionElement Klasse. Dieses Interface definiert ein Basis-Interface, das von den Component-Transfer-Funktions-Interfaces verwendet wird."
type: docs
weight: 5220
...
Dieses Interface definiert ein Basis‑Interface, das von den Komponenten‑Transfer‑Funktions‑Interfaces verwendet wird.
...
| [Exponent](../../aspose.svg/svgcomponenttransferfunctionelement/exponent/) { get; } | Entspricht dem Attribut ‘exponent’ des angegebenen Elements. |
...
| [Intercept](../../aspose.svg/svgcomponenttransferfunctionelement/intercept/) { get; } | Entspricht dem Attribut ‘intercept’ des angegebenen Elements. |
...
| [Offset](../../aspose.svg/svgcomponenttransferfunctionelement/offset/) { get; } | Entspricht dem Attribut ‘offset’ im angegebenen Element. |
...
| [Slope](../../aspose.svg/svgcomponenttransferfunctionelement/slope/) { get; } | Entspricht dem Attribut ‘slope’ im angegebenen Element. |
...
| [TableValues](../../aspose.svg/svgcomponenttransferfunctionelement/tablevalues/) { get; } | Entspricht dem Attribut ‘tableValues’ im angegebenen Element. |
...
| [Type](../../aspose.svg/svgcomponenttransferfunctionelement/type/) { get; } | Entspricht dem Attribut ‘type’ im angegebenen Element. Akzeptiert einen der auf diesem Interface definierten SVG_FECOMPONENTTRANSFER_TYPE_* Konstanten. |
...
| Name | Beschreibung |
| --- | --- |
| const [SVG_FECOMPONENTTRANSFER_TYPE_DISCRETE](../../aspose.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_discrete/) | Entspricht dem Wert 'discrete'. |
| const [SVG_FECOMPONENTTRANSFER_TYPE_GAMMA](../../aspose.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_gamma/) | Entspricht dem Wert 'gamma'. |
| const [SVG_FECOMPONENTTRANSFER_TYPE_IDENTITY](../../aspose.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_identity/) | Entspricht dem Wert 'identity'. |
| const [SVG_FECOMPONENTTRANSFER_TYPE_LINEAR](../../aspose.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_linear/) | Entspricht dem Wert 'linear'. |
| const [SVG_FECOMPONENTTRANSFER_TYPE_TABLE](../../aspose.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_table/) | Entspricht dem Wert 'table'. |
| const [SVG_FECOMPONENTTRANSFER_TYPE_UNKNOWN](../../aspose.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_unknown/) | Der Typ ist keiner der vordefinierten Typen. Es ist ungültig, zu versuchen, einen neuen Wert dieses Typs zu definieren oder einen bestehenden Wert zu diesem Typ zu wechseln. |
