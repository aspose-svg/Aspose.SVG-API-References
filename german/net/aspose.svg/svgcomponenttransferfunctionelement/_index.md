...
description: Aspose.Svg.SVGComponentTransferFunctionElement klas. Diese Schnittstelle definiert eine Basisschnittstelle die von den Schnittstellen der Komponentenübertragungsfunktion verwendet wird.
type: docs
weight: 3150
url: /de/net/aspose.svg/svgcomponenttransferfunctionelement/
---
...
| Name | Beschreibung |
| --- | --- |
| [Amplitude](../../aspose.svg/svgcomponenttransferfunctionelement/amplitude/) { get; } | Entspricht dem Attribut „Amplitude“ des angegebenen Elements. |
...
| [Exponent](../../aspose.svg/svgcomponenttransferfunctionelement/exponent/) { get; } | Entspricht dem Attribut 'exponent' auf dem gegebenen Element. |
...
| [Intercept](../../aspose.svg/svgcomponenttransferfunctionelement/intercept/) { get; } | Entspricht dem Attribut 'Intercept' auf dem angegebenen Element. |
...
| [Offset](../../aspose.svg/svgcomponenttransferfunctionelement/offset/) { get; } | Entspricht dem Attribut 'offset' des angegebenen Elements. |
...
| [Slope](../../aspose.svg/svgcomponenttransferfunctionelement/slope/) { get; } | Entspricht dem Attribut „Steigung“ des angegebenen Elements. |
...
| [TableValues](../../aspose.svg/svgcomponenttransferfunctionelement/tablevalues/) { get; } | Entspricht dem Attribut 'tableValues' des angegebenen Elements. |
...
| [Type](../../aspose.svg/svgcomponenttransferfunctionelement/type/) { get; } | Entspricht dem Attribut 'type' des angegebenen Elements. Akzeptiert eine der auf dieser Schnittstelle definierten SVG_FECOMPONENTTRANSFER_TYPE_*-Konstanten. |
...
| Name | Beschreibung |
| --- | --- |
| const [SVG_FECOMPONENTTRANSFER_TYPE_DISCRETE](../../aspose.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_discrete/) | Entspricht dem Wert 'diskret'. |
| const [SVG_FECOMPONENTTRANSFER_TYPE_GAMMA](../../aspose.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_gamma/) | Entspricht Wert 'Gamma'. |
| const [SVG_FECOMPONENTTRANSFER_TYPE_IDENTITY](../../aspose.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_identity/) | Entspricht Wert 'Identität'. |
| const [SVG_FECOMPONENTTRANSFER_TYPE_LINEAR](../../aspose.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_linear/) | Entspricht Wert 'linear'. |
| const [SVG_FECOMPONENTTRANSFER_TYPE_TABLE](../../aspose.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_table/) | Entspricht Wert 'Tabelle'. |
| const [SVG_FECOMPONENTTRANSFER_TYPE_UNKNOWN](../../aspose.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_unknown/) | Der Typ ist keiner der vordefinierten Typen. Es ist ungültig, einen neuen Wert dieses Typs zu definieren oder einen vorhandenen Wert auf diesen Typ umzustellen. |
