...
description: "Aspose.Svg.SVGTextPathElement Klasse. Das SVGTextPathElement-Interface entspricht dem textPath-Element"
type: docs
weight: 5610
...
| [LengthAdjust](../../aspose.svg/svgtextcontentelement/lengthadjust/) { get; } | Entspricht dem Attribut ‘lengthAdjust’ des angegebenen Elements. Der Wert muss einer der auf dieser Schnittstelle definierten length‑adjust‑Konstanten entsprechen. |
...
| [Method](../../aspose.svg/svgtextpathelement/method/) { get; } | Entspricht dem Attribut ‘method’ im angegebenen ‘textPath’-Element. |
...
| [Spacing](../../aspose.svg/svgtextpathelement/spacing/) { get; } | Entspricht dem Attribut ‘spacing’ im angegebenen ‘textPath’-Element. |
| [StartOffset](../../aspose.svg/svgtextpathelement/startoffset/) { get; } | Entspricht dem Attribut ‘startOffset’ im angegebenen ‘textPath’-Element. |
...
| Name | Beschreibung |
| --- | --- |
| const [TEXTPATH_METHODTYPE_ALIGN](../../aspose.svg/svgtextpathelement/textpath_methodtype_align/) | Entspricht dem Wert 'align'. |
| const [TEXTPATH_METHODTYPE_STRETCH](../../aspose.svg/svgtextpathelement/textpath_methodtype_stretch/) | Entspricht dem Wert 'stretch'. |
| const [TEXTPATH_METHODTYPE_UNKNOWN](../../aspose.svg/svgtextpathelement/textpath_methodtype_unknown/) | Die Aufzählung wurde auf einen Wert gesetzt, der nicht zu den vordefinierten Typen gehört. Es ist ungültig, zu versuchen, einen neuen Wert dieses Typs zu definieren oder einen bestehenden Wert zu diesem Typ zu wechseln. |
| const [TEXTPATH_SPACINGTYPE_AUTO](../../aspose.svg/svgtextpathelement/textpath_spacingtype_auto/) | Entspricht dem Wert 'auto'. |
| const [TEXTPATH_SPACINGTYPE_EXACT](../../aspose.svg/svgtextpathelement/textpath_spacingtype_exact/) | Entspricht dem Wert 'exact'. |
| const [TEXTPATH_SPACINGTYPE_UNKNOWN](../../aspose.svg/svgtextpathelement/textpath_spacingtype_unknown/) | Die Aufzählung wurde auf einen Wert gesetzt, der nicht zu den vordefinierten Typen gehört. Es ist ungültig, zu versuchen, einen neuen Wert dieses Typs zu definieren oder einen bestehenden Wert zu diesem Typ zu wechseln. |
