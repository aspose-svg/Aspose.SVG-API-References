...
description: Aspose.Svg.SVGMarkerElement klas. Die SVGMarkerElementSchnittstelle entspricht dem markerElement.
type: docs
weight: 3340
url: /de/net/aspose.svg/svgmarkerelement/
---
...
| [MarkerHeight](../../aspose.svg/svgmarkerelement/markerheight/) { get; } | Entspricht dem Attribut „markerHeight“ des angegebenen „marker“-Elements. |
| [MarkerUnits](../../aspose.svg/svgmarkerelement/markerunits/) { get; } | Entspricht dem Attribut 'markerUnits' des angegebenen 'marker'-Elements. Einer der Marker-Einheitentypen, die auf dieser Schnittstelle definiert sind. |
| [MarkerWidth](../../aspose.svg/svgmarkerelement/markerwidth/) { get; } | Entspricht dem Attribut 'markerWidth' des angegebenen 'marker'-Elements. |
...
| [OrientAngle](../../aspose.svg/svgmarkerelement/orientangle/) { get; } | Entspricht dem Attribut 'orient' auf dem gegebenen 'marker'-Element. Wenn markerUnits SVG_MARKER_ORIENT_ANGLE ist, der Winkelwert für das Attribut 'orient'; andernfalls wird es auf Null gesetzt. |
| [OrientType](../../aspose.svg/svgmarkerelement/orienttype/) { get; } | Entspricht dem Attribut 'orient' auf dem gegebenen 'marker'-Element. Einer der Marker-Ausrichtungstypen, die auf dieser Schnittstelle definiert sind. |
...
| [PreserveAspectRatio](../../aspose.svg/svgmarkerelement/preserveaspectratio/) { get; } | Entspricht dem Attribut „preserveAspectRatio“ für das angegebene Element. |
...
| [RefX](../../aspose.svg/svgmarkerelement/refx/) { get; } | Entspricht dem Attribut 'refX' auf dem gegebenen 'marker'-Element. |
| [RefY](../../aspose.svg/svgmarkerelement/refy/) { get; } | Entspricht dem Attribut 'refY' auf dem gegebenen 'marker'-Element. |
...
| [ViewBox](../../aspose.svg/svgmarkerelement/viewbox/) { get; } | Entspricht dem Attribut 'viewBox' des angegebenen Elements. |
...
| [SetOrientToAngle](../../aspose.svg/svgmarkerelement/setorienttoangle/)(SVGAngle) | Setzt den Wert des Attributs 'orient' auf den angegebenen Winkel. |
| [SetOrientToAuto](../../aspose.svg/svgmarkerelement/setorienttoauto/)() | Setzt den Wert des Attributs 'orient' auf 'auto'. |
...
| Name | Beschreibung |
| --- | --- |
| const [SVG_MARKERUNITS_STROKEWIDTH](../../aspose.svg/svgmarkerelement/svg_markerunits_strokewidth/) | Der Wert des Attributs „markerUnits“ ist „strokeWidth“. |
| const [SVG_MARKERUNITS_UNKNOWN](../../aspose.svg/svgmarkerelement/svg_markerunits_unknown/) | Der Markierungseinheitstyp ist keiner der vordefinierten Typen. Es ist ungültig, einen neuen Wert dieses Typs zu definieren oder einen vorhandenen Wert auf diesen Typ umzustellen. |
| const [SVG_MARKERUNITS_USERSPACEONUSE](../../aspose.svg/svgmarkerelement/svg_markerunits_userspaceonuse/) | Der Wert des Attributs „markerUnits“ ist „userSpaceOnUse“. |
| const [SVG_MARKER_ORIENT_ANGLE](../../aspose.svg/svgmarkerelement/svg_marker_orient_angle/) | Attribut 'orient' hat einen Winkelwert. |
| const [SVG_MARKER_ORIENT_AUTO](../../aspose.svg/svgmarkerelement/svg_marker_orient_auto/) | Das Attribut „orient“ hat den Wert „auto“. |
| const [SVG_MARKER_ORIENT_UNKNOWN](../../aspose.svg/svgmarkerelement/svg_marker_orient_unknown/) | Die Markierungsausrichtung gehört nicht zu den vordefinierten Typen. Es ist ungültig, einen neuen Wert dieses Typs zu definieren oder einen vorhandenen Wert auf diesen Typ umzustellen. |
