...
description: "Aspose.Svg.SVGMarkerElement Klasse. Das SVGMarkerElement-Interface entspricht dem marker-Element"
type: docs
weight: 5410
...
| [MarkerHeight](../../aspose.svg/svgmarkerelement/markerheight/) { get; } | Entspricht dem Attribut ‘markerHeight’ im angegebenen ‘marker’-Element. |
| [MarkerUnits](../../aspose.svg/svgmarkerelement/markerunits/) { get; } | Entspricht dem Attribut ‘markerUnits’ im angegebenen ‘marker’-Element. Einer der auf diesem Interface definierten Marker-Einheitstypen. |
| [MarkerWidth](../../aspose.svg/svgmarkerelement/markerwidth/) { get; } | Entspricht dem Attribut ‘markerWidth’ im angegebenen ‘marker’-Element. |
...
| [OrientAngle](../../aspose.svg/svgmarkerelement/orientangle/) { get; } | Entspricht dem Attribut ‘orient’ im angegebenen ‘marker’-Element. Wenn markerUnits SVG_MARKER_ORIENT_ANGLE ist, der Winkelwert für das Attribut ‘orient’; andernfalls wird er auf Null gesetzt. |
| [OrientType](../../aspose.svg/svgmarkerelement/orienttype/) { get; } | Entspricht dem Attribut ‘orient’ im angegebenen ‘marker’-Element. Einer der auf diesem Interface definierten Marker-Orientierungstypen. |
...
| [PreserveAspectRatio](../../aspose.svg/svgmarkerelement/preserveaspectratio/) { get; } | Entspricht dem Attribut ‘preserveAspectRatio’ des angegebenen Elements. |
...
| [RefX](../../aspose.svg/svgmarkerelement/refx/) { get; } | Entspricht dem Attribut ‘refX’ im angegebenen ‘marker’-Element. |
| [RefY](../../aspose.svg/svgmarkerelement/refy/) { get; } | Entspricht dem Attribut ‘refY’ im angegebenen ‘marker’-Element. |
...
| [SetOrientToAngle](../../aspose.svg/svgmarkerelement/setorienttoangle/)(*[SVGAngle](../../aspose.svg.datatypes/svgangle/)*) | Setzt den Wert des Attributs ‘orient’ auf den angegebenen Winkel. |
...
| const [SVG_MARKERUNITS_UNKNOWN](../../aspose.svg/svgmarkerelement/svg_markerunits_unknown/) | Der Marker-Einheitstyp ist keiner der vordefinierten Typen. Es ist ungültig, zu versuchen, einen neuen Wert dieses Typs zu definieren oder einen bestehenden Wert zu diesem Typ zu wechseln. |
...
| const [SVG_MARKER_ORIENT_AUTO](../../aspose.svg/svgmarkerelement/svg_marker_orient_auto/) | Attribut ‘orient’ hat den Wert 'auto'. |
| const [SVG_MARKER_ORIENT_UNKNOWN](../../aspose.svg/svgmarkerelement/svg_marker_orient_unknown/) | Die Marker-Orientierung ist keiner der vordefinierten Typen. Es ist ungültig, zu versuchen, einen neuen Wert dieses Typs zu definieren oder einen bestehenden Wert zu diesem Typ zu wechseln. |
