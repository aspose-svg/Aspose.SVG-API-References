...
description: Aspose.Svg.SVGMaskElement klas. Die SVGMaskElementSchnittstelle entspricht dem maskElement.
type: docs
weight: 3350
url: /de/net/aspose.svg/svgmaskelement/
---
...
| [Height](../../aspose.svg/svgmaskelement/height/) { get; } | Entspricht dem Attribut 'height' auf dem gegebenen 'mask'-Element. Akzeptiert eine der in SVGUnitTypes. definierten Konstanten |
...
| [MaskContentUnits](../../aspose.svg/svgmaskelement/maskcontentunits/) { get; } | Entspricht dem Attribut 'maskContentUnits' des angegebenen 'mask'-Elements. Akzeptiert eine der in SVGUnitTypes. definierten Konstanten |
| [MaskUnits](../../aspose.svg/svgmaskelement/maskunits/) { get; } | Entspricht dem Attribut 'maskUnits' des angegebenen 'mask'-Elements. Akzeptiert eine der in SVGUnitTypes. definierten Konstanten |
...
| [RequiredExtensions](../../aspose.svg/svgmaskelement/requiredextensions/) { get; } | Entspricht dem Attribut 'requiredExtensions' für das angegebene Element. |
| [RequiredFeatures](../../aspose.svg/svgmaskelement/requiredfeatures/) { get; } | Entspricht dem Attribut 'requiredFeatures' für das angegebene Element. |
...
| [SystemLanguage](../../aspose.svg/svgmaskelement/systemlanguage/) { get; } | Entspricht dem Attribut 'systemLanguage' des angegebenen Elements. |
...
| [Width](../../aspose.svg/svgmaskelement/width/) { get; } | Entspricht dem Attribut 'width' auf dem gegebenen 'mask'-Element. Akzeptiert eine der in SVGUnitTypes. definierten Konstanten |
| [X](../../aspose.svg/svgmaskelement/x/) { get; } | Entspricht dem Attribut 'x' auf dem gegebenen 'mask'-Element. Akzeptiert eine der in SVGUnitTypes. definierten Konstanten |
| [Y](../../aspose.svg/svgmaskelement/y/) { get; } | Entspricht dem Attribut 'y' des angegebenen 'mask'-Elements. Akzeptiert eine der in SVGUnitTypes. definierten Konstanten |
