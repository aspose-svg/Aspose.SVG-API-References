...
description: "Aspose.Svg.SVGMaskElement Klasse. Das SVGMaskElement-Interface entspricht dem Masken-Element."
type: docs
weight: 5420
...
| [Height](../../aspose.svg/svgmaskelement/height/) { get; } | Entspricht dem Attribut ‘height’ im angegebenen ‘mask’-Element. Akzeptiert eine der in SVGUnitTypes definierten Konstanten. |
...
| [MaskContentUnits](../../aspose.svg/svgmaskelement/maskcontentunits/) { get; } | Entspricht dem Attribut ‘maskContentUnits’ im angegebenen ‘mask’-Element. Akzeptiert eine der in SVGUnitTypes definierten Konstanten. |
| [MaskUnits](../../aspose.svg/svgmaskelement/maskunits/) { get; } | Entspricht dem Attribut ‘maskUnits’ im angegebenen ‘mask’-Element. Akzeptiert eine der in SVGUnitTypes definierten Konstanten. |
...
| [RequiredExtensions](../../aspose.svg/svgmaskelement/requiredextensions/) { get; } | Entspricht dem Attribut ‘requiredExtensions’ des angegebenen Elements. |
| [RequiredFeatures](../../aspose.svg/svgmaskelement/requiredfeatures/) { get; } | Entspricht dem Attribut ‘requiredFeatures’ des angegebenen Elements. |
...
| [Width](../../aspose.svg/svgmaskelement/width/) { get; } | Entspricht dem Attribut ‘width’ im angegebenen ‘mask’-Element. Akzeptiert eine der in SVGUnitTypes definierten Konstanten. |
| [X](../../aspose.svg/svgmaskelement/x/) { get; } | Entspricht dem Attribut ‘x’ im angegebenen ‘mask’-Element. Akzeptiert eine der in SVGUnitTypes definierten Konstanten. |
| [Y](../../aspose.svg/svgmaskelement/y/) { get; } | Entspricht dem Attribut ‘y’ im angegebenen ‘mask’-Element. Akzeptiert eine der in SVGUnitTypes definierten Konstanten. |
