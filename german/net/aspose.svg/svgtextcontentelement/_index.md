...
| Name | Beschreibung |
| --- | --- |
| const [LENGTHADJUST_SPACING](../../aspose.svg/svgtextcontentelement/lengthadjust_spacing/) | Entspricht Wert 'Abstand'. |
| const [LENGTHADJUST_SPACINGANDGLYPHS](../../aspose.svg/svgtextcontentelement/lengthadjust_spacingandglyphs/) | Entspricht dem Wert 'spacingAndGlyphs'. |
| const [LENGTHADJUST_UNKNOWN](../../aspose.svg/svgtextcontentelement/lengthadjust_unknown/) | Die Enumeration wurde auf einen Wert gesetzt, der nicht zu den vordefinierten Typen gehört. Es ist ungültig, einen neuen Wert dieses Typs zu definieren oder einen vorhandenen Wert auf diesen Typ umzustellen. |
