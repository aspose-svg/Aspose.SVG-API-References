...
| [Domain](../../aspose.svg/svgdocument/domain/) { get; } | Der Domänenname des Servers, der das Dokument bereitgestellt hat, oder eine Nullzeichenfolge, wenn der Server nicht durch einen Domänennamen identifiziert werden kann. |
...
| [Referrer](../../aspose.svg/svgdocument/referrer/) { get; } | Gibt den URI der Seite zurück, die auf diese Seite verlinkt ist. Der Wert ist ein leerer String, wenn der Benutzer direkt auf die Seite navigiert ist (nicht über einen Link, sondern beispielsweise über ein Lesezeichen). |
| [RootElement](../../aspose.svg/svgdocument/rootelement/) { get; } | Die Wurzel „svg“ in der Dokumenthierarchie. |
...
| [Title](../../aspose.svg/svgdocument/title/) { get; } | Der Titel eines Dokuments, wie er durch das Unterelement „title“ des Root-Elements „svg“ angegeben wird (d. h.Hier ist der Titel... ) |
| [URL](../../aspose.svg/svgdocument/url/) { get; } | Der vollständige URI des Dokuments. |
...
| [CreateNodeIterator](../../aspose.svg.dom/document/createnodeiterator/)(Node) | Erstellen Sie einen neuen NodeIterator über dem Teilbaum, der an dem angegebenen Knoten verwurzelt ist. |
| [CreateNodeIterator](../../aspose.svg.dom/document/createnodeiterator/)(Node, long) | Erstellen Sie einen neuen NodeIterator über dem Teilbaum, der an dem angegebenen Knoten verwurzelt ist. |
| [CreateNodeIterator](../../aspose.svg.dom/document/createnodeiterator/)(Node, long, INodeFilter) | Erstellen Sie einen neuen NodeIterator über dem Teilbaum, der an dem angegebenen Knoten verwurzelt ist. |
...
| [CreateTreeWalker](../../aspose.svg.dom/document/createtreewalker/)(Node) | Erstellen Sie einen neuen TreeWalker über dem Teilbaum, der an dem angegebenen Knoten verwurzelt ist. |
| [CreateTreeWalker](../../aspose.svg.dom/document/createtreewalker/)(Node, long) | Erstellen Sie einen neuen TreeWalker über dem Teilbaum, der an dem angegebenen Knoten verwurzelt ist. |
| [CreateTreeWalker](../../aspose.svg.dom/document/createtreewalker/)(Node, long, INodeFilter) | Erstellen Sie einen neuen TreeWalker über dem Teilbaum, der an dem angegebenen Knoten verwurzelt ist. |
...
| [GetOverrideStyle](../../aspose.svg/svgdocument/getoverridestyle/)(Element, string) | Diese Methode wird verwendet, um die Überschreibungsstildeklaration für ein bestimmtes Element und ein bestimmtes Pseudoelement abzurufen. |
...
| [Navigate](../../aspose.svg.dom/document/navigate/)(RequestMessage) | Lädt das Dokument basierend auf dem angegebenen Anforderungsobjekt und ersetzt den vorherigen Inhalt. |
| [Navigate](../../aspose.svg.dom/document/navigate/)(string) | Lädt das Dokument unter der angegebenen URL (Uniform Resource Locator) in die aktuelle Instanz und ersetzt den vorherigen Inhalt. |
| [Navigate](../../aspose.svg.dom/document/navigate/)(Url) | Lädt das Dokument unter der angegebenen URL (Uniform Resource Locator) in die aktuelle Instanz und ersetzt den vorherigen Inhalt. |
| [Navigate](../../aspose.svg.dom/document/navigate/)(Stream, string) | Lädt das Dokument aus dem angegebenen Inhalt und verwendet baseUri, um relative Ressourcen aufzulösen, wodurch der vorherige Inhalt ersetzt wird. Das Laden des Dokuments beginnt an der aktuellen Position im Stream. |
| [Navigate](../../aspose.svg.dom/document/navigate/)(Stream, Url) | Lädt das Dokument aus dem angegebenen Inhalt und verwendet baseUri, um relative Ressourcen aufzulösen, wodurch der vorherige Inhalt ersetzt wird. Das Laden des Dokuments beginnt an der aktuellen Position im Stream. |
...
| [Navigate](../../aspose.svg.dom/document/navigate/)(string, Url) | Lädt das Dokument aus dem angegebenen Inhalt und verwendet baseUri, um relative Ressourcen aufzulösen, wobei der vorherige Inhalt ersetzt wird. |
...
| override [RenderTo](../../aspose.svg/svgdocument/renderto/)(IDevice) | Diese Methode wird verwendet, um den Inhalt des aktuellen Dokuments auf dem angegebenen Gerät zu drucken. |
...
| [Save](../../aspose.svg/svgdocument/save/#save)(IOutputStorage) | Speichert den Dokumentinhalt und die Ressourcen im Ausgabespeicher. |
| [Save](../../aspose.svg/svgdocument/save/#save_6)(string) | Speichert das Dokument in der durch angegebenen lokalen Datei`Weg` . Alle in diesem Dokument verwendeten Ressourcen werden in im angrenzenden Ordner gespeichert, dessen Name wie folgt aufgebaut ist: output_file_name + "_files". |
| [Save](../../aspose.svg/svgdocument/save/#save_3)(Url) | Speichert das Dokument in der durch angegebenen lokalen Datei`URL` . Alle in diesem Dokument verwendeten Ressourcen werden in im angrenzenden Ordner gespeichert, dessen Name wie folgt aufgebaut ist: output_file_name + "_files". |
| [Save](../../aspose.svg/svgdocument/save/#save_1)(IOutputStorage, SVGSaveFormat) | Speichert den Dokumentinhalt und die Ressourcen im Ausgabespeicher. |
| [Save](../../aspose.svg/svgdocument/save/#save_2)(IOutputStorage, SVGSaveOptions) | Speichert den Dokumentinhalt und die Ressourcen im Ausgabespeicher. |
| [Save](../../aspose.svg/svgdocument/save/#save_7)(string, SVGSaveFormat) | Speichert das Dokument in der durch angegebenen lokalen Datei`Weg` . Alle in diesem Dokument verwendeten Ressourcen werden in im angrenzenden Ordner gespeichert, dessen Name wie folgt aufgebaut ist: output_file_name + "_files". |
| [Save](../../aspose.svg/svgdocument/save/#save_8)(string, SVGSaveOptions) | Speichert das Dokument in der durch angegebenen lokalen Datei`Weg` . Alle in diesem Dokument verwendeten Ressourcen werden in im angrenzenden Ordner gespeichert, dessen Name wie folgt aufgebaut ist: output_file_name + "_files". |
| [Save](../../aspose.svg/svgdocument/save/#save_4)(Url, SVGSaveFormat) | Speichert das Dokument in der durch angegebenen lokalen Datei`URL` . Alle in diesem Dokument verwendeten Ressourcen werden in im angrenzenden Ordner gespeichert, dessen Name wie folgt aufgebaut ist: output_file_name + "_files". |
| [Save](../../aspose.svg/svgdocument/save/#save_5)(Url, SVGSaveOptions) | Speichert das Dokument in der durch angegebenen lokalen Datei`URL` . Alle in diesem Dokument verwendeten Ressourcen werden in im angrenzenden Ordner gespeichert, dessen Name wie folgt aufgebaut ist: output_file_name + "_files". |
...
| Name | Beschreibung |
| --- | --- |
| event [OnAbort](../../aspose.svg.dom/document/onabort/) | Ruft den Event-Handler für das OnAbort-Ereignis ab oder legt ihn fest. |
| event [OnBlur](../../aspose.svg.dom/document/onblur/) | Ruft den Event-Handler für das OnBlur-Ereignis ab oder legt ihn fest. |
| event [OnCancel](../../aspose.svg.dom/document/oncancel/) | Ruft den Ereignishandler für das OnCancel-Ereignis ab oder legt ihn fest. |
| event [OnCanplay](../../aspose.svg.dom/document/oncanplay/) | Ruft den Ereignishandler für das OnCanplay-Ereignis ab oder legt ihn fest. |
| event [OnCanPlayThrough](../../aspose.svg.dom/document/oncanplaythrough/) | Ruft den Ereignishandler für das OnCanPlayThrough-Ereignis ab oder legt ihn fest. |
| event [OnChange](../../aspose.svg.dom/document/onchange/) | Ruft den Event-Handler für das OnChange-Ereignis ab oder legt ihn fest. |
| event [OnClick](../../aspose.svg.dom/document/onclick/) | Ruft den Event-Handler für das OnClick-Ereignis ab oder legt ihn fest. |
| event [OnCueChange](../../aspose.svg.dom/document/oncuechange/) | Ruft den Event-Handler für das OnCueChange-Ereignis ab oder legt ihn fest. |
| event [OnDblClick](../../aspose.svg.dom/document/ondblclick/) | Ruft den Ereignishandler für das OnDblClick-Ereignis ab oder legt ihn fest. |
| event [OnDurationChange](../../aspose.svg.dom/document/ondurationchange/) | Ruft den Ereignishandler für das OnDurationChange-Ereignis ab oder legt ihn fest. |
| event [OnEmptied](../../aspose.svg.dom/document/onemptied/) | Ruft den Ereignishandler für das OnEmptied-Ereignis ab oder legt ihn fest. |
| event [OnEnded](../../aspose.svg.dom/document/onended/) | Ruft Ereignishandler für OnEnded-Ereignis ab oder legt sie fest. |
| event [OnError](../../aspose.svg.dom/document/onerror/) | Ruft den Event-Handler für das OnError-Ereignis ab oder legt ihn fest. |
| event [OnFocus](../../aspose.svg.dom/document/onfocus/) | Ruft den Event-Handler für das OnFocus-Ereignis ab oder legt ihn fest. |
| event [OnInput](../../aspose.svg.dom/document/oninput/) | Ruft den Ereignishandler für das OnInput-Ereignis ab oder legt ihn fest. |
| event [OnInvalid](../../aspose.svg.dom/document/oninvalid/) | Ruft Ereignishandler für das OnInvalid-Ereignis ab oder legt es fest. |
| event [OnKeyDown](../../aspose.svg.dom/document/onkeydown/) | Ruft den Event-Handler für das OnKeyDown-Ereignis ab oder legt ihn fest. |
| event [OnKeyPress](../../aspose.svg.dom/document/onkeypress/) | Ruft den Event-Handler für das OnKeyPress-Ereignis ab oder legt ihn fest. |
| event [OnKeyUp](../../aspose.svg.dom/document/onkeyup/) | Ruft den Event-Handler für das OnKeyUp-Ereignis ab oder legt ihn fest. |
| event [OnLoad](../../aspose.svg.dom/document/onload/) | Ruft den Ereignishandler für das OnLoad-Ereignis ab oder legt ihn fest. |
| event [OnLoadedData](../../aspose.svg.dom/document/onloadeddata/) | Ruft den Ereignishandler für das OnLoadedData-Ereignis ab oder legt ihn fest. |
| event [OnLoadedMetadata](../../aspose.svg.dom/document/onloadedmetadata/) | Ruft den Event-Handler für das OnLoadedMetadata-Ereignis ab oder legt ihn fest. |
| event [OnLoadStart](../../aspose.svg.dom/document/onloadstart/) | Ruft den Ereignishandler für das OnLoadStart-Ereignis ab oder legt ihn fest. |
| event [OnMouseDown](../../aspose.svg.dom/document/onmousedown/) | Ruft den Ereignishandler für das OnMouseDown-Ereignis ab oder legt ihn fest. |
| event [OnMouseEnter](../../aspose.svg.dom/document/onmouseenter/) | Ruft Ereignishandler für das OnMouseEnter-Ereignis ab oder legt es fest. |
| event [OnMouseLeave](../../aspose.svg.dom/document/onmouseleave/) | Ruft den Ereignishandler für das OnMouseLeave-Ereignis ab oder legt ihn fest. |
| event [OnMouseMove](../../aspose.svg.dom/document/onmousemove/) | Ruft Ereignishandler für das OnMouseMove-Ereignis ab oder legt es fest. |
| event [OnMouseOut](../../aspose.svg.dom/document/onmouseout/) | Ruft den Event-Handler für das OnMouseOut-Ereignis ab oder legt ihn fest. |
| event [OnMouseOver](../../aspose.svg.dom/document/onmouseover/) | Ruft den Ereignishandler für das OnMouseOver-Ereignis ab oder legt ihn fest. |
| event [OnMouseUp](../../aspose.svg.dom/document/onmouseup/) | Ruft Ereignishandler für das OnMouseUp-Ereignis ab oder legt es fest. |
| event [OnMouseWheel](../../aspose.svg.dom/document/onmousewheel/) | Ruft Ereignishandler für das OnMouseWheel-Ereignis ab oder legt es fest. |
| event [OnPause](../../aspose.svg.dom/document/onpause/) | Ruft den Ereignishandler für das OnPause-Ereignis ab oder legt ihn fest. |
| event [OnPlay](../../aspose.svg.dom/document/onplay/) | Ruft den Ereignishandler für das OnPlay-Ereignis ab oder legt ihn fest. |
| event [OnPlaying](../../aspose.svg.dom/document/onplaying/) | Ruft den Event-Handler für das OnPlaying-Ereignis ab oder legt ihn fest. |
| event [OnProgress](../../aspose.svg.dom/document/onprogress/) | Ruft den Ereignishandler für das OnProgress-Ereignis ab oder legt ihn fest. |
| event [OnRateChange](../../aspose.svg.dom/document/onratechange/) | Ruft den Ereignishandler für das OnRateChange-Ereignis ab oder legt ihn fest. |
| event [OnReadyStateChange](../../aspose.svg.dom/document/onreadystatechange/) | Ruft den Ereignishandler für das OnReadyStateChange-Ereignis ab oder legt ihn fest. |
| event [OnReset](../../aspose.svg.dom/document/onreset/) | Ruft den Ereignishandler für das OnReset-Ereignis ab oder legt ihn fest. |
| event [OnResize](../../aspose.svg.dom/document/onresize/) | Ruft den Event-Handler für das OnResize-Ereignis ab oder legt ihn fest. |
| event [OnScroll](../../aspose.svg.dom/document/onscroll/) | Ruft den Event-Handler für das OnScroll-Ereignis ab oder legt ihn fest. |
| event [OnSeeked](../../aspose.svg.dom/document/onseeked/) | Ruft den Ereignishandler für das OnSeeked-Ereignis ab oder legt ihn fest. |
| event [OnSeeking](../../aspose.svg.dom/document/onseeking/) | Ruft den Event-Handler für das OnSeeking-Ereignis ab oder legt ihn fest. |
| event [OnSelect](../../aspose.svg.dom/document/onselect/) | Ruft den Ereignishandler für das OnSelect-Ereignis ab oder legt ihn fest. |
| event [OnShow](../../aspose.svg.dom/document/onshow/) | Ruft den Ereignishandler für das OnShow-Ereignis ab oder legt ihn fest. |
| event [OnStalled](../../aspose.svg.dom/document/onstalled/) | Ruft den Event-Handler für das OnStalled-Ereignis ab oder legt ihn fest. |
| event [OnSubmit](../../aspose.svg.dom/document/onsubmit/) | Ruft den Event-Handler für das OnSubmit-Ereignis ab oder legt ihn fest. |
| event [OnSuspend](../../aspose.svg.dom/document/onsuspend/) | Ruft den Ereignishandler für das OnSuspend-Ereignis ab oder legt ihn fest. |
| event [OnTimeUpdate](../../aspose.svg.dom/document/ontimeupdate/) | Ruft Ereignishandler für das OnTimeUpdate-Ereignis ab oder legt es fest. |
| event [OnToggle](../../aspose.svg.dom/document/ontoggle/) | Ruft den Event-Handler für das OnToggle-Ereignis ab oder legt ihn fest. |
| event [OnVolumeChange](../../aspose.svg.dom/document/onvolumechange/) | Ruft Ereignishandler für das OnVolumeChange-Ereignis ab oder legt es fest. |
| event [OnWaiting](../../aspose.svg.dom/document/onwaiting/) | Ruft den Ereignishandler für das OnWaiting-Ereignis ab oder legt ihn fest. |
