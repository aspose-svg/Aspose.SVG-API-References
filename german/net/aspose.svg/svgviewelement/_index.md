...
description: "Aspose.Svg.SVGViewElement Klasse. Das SVGViewElement‑Interface entspricht dem view-Element"
type: docs
weight: 5660
...
| [PreserveAspectRatio](../../aspose.svg/svgviewelement/preserveaspectratio/) { get; } | Entspricht dem Attribut ‘preserveAspectRatio’ des angegebenen Elements. |
...
| [ViewTarget](../../aspose.svg/svgviewelement/viewtarget/) { get; } | Entspricht dem Attribut ‘viewTarget’ im angegebenen ‘view’-Element. Eine Liste von DOMString‑Werten, die die im ‘viewTarget’-Attribut aufgeführten Namen enthalten. Jeder der DOMString‑Werte kann mittels des Aufrufs der Methode getElementById() dem entsprechenden Element zugeordnet werden. |
| [ZoomAndPan](../../aspose.svg/svgviewelement/zoomandpan/) { get; set; } | Entspricht dem Attribut ‘zoomAndPan’ des angegebenen Elements. Der Wert muss einer der auf diesem Interface definierten SVG_ZOOMANDPAN_*‑Konstanten entsprechen. |
