...
description: Aspose.Svg.SVGViewElement klas. Die SVGViewElementSchnittstelle entspricht dem viewElement.
type: docs
weight: 3590
url: /de/net/aspose.svg/svgviewelement/
---
...
| [PreserveAspectRatio](../../aspose.svg/svgviewelement/preserveaspectratio/) { get; } | Entspricht dem Attribut „preserveAspectRatio“ für das angegebene Element. |
...
| [ViewBox](../../aspose.svg/svgviewelement/viewbox/) { get; } | Entspricht dem Attribut 'viewBox' des angegebenen Elements. |
...
| [ViewTarget](../../aspose.svg/svgviewelement/viewtarget/) { get; } | Entspricht dem Attribut 'viewTarget' des angegebenen 'view'-Elements. Eine Liste von DOMString-Werten, die die im 'viewTarget'-Attribut aufgelisteten Namen enthalten. Jeder der DOMString-Werte kann mithilfe des Methodenaufrufs getElementById() mit dem entsprechenden Element verknüpft werden. |
| [ZoomAndPan](../../aspose.svg/svgviewelement/zoomandpan/) { get; set; } | Entspricht dem Attribut 'zoomAndPan' des angegebenen Elements. Der Wert muss eine der auf dieser Schnittstelle definierten SVG_ZOOMANDPAN_*-Konstanten sein. |
