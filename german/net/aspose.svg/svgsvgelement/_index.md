...
type: docs
weight: 3390
url: /de/net/aspose.svg/svgsvgelement/
---
## SVGSVGElement class
...
| [Height](../../aspose.svg/svgsvgelement/height) { get; } | Entspricht dem Attribut „Höhe“ des angegebenen „svg“-Elements. |
...
| [PreserveAspectRatio](../../aspose.svg/svgsvgelement/preserveaspectratio) { get; } | Entspricht dem Attribut „preserveAspectRatio“ für das angegebene Element. |
...
| [ViewBox](../../aspose.svg/svgsvgelement/viewbox) { get; } | Entspricht dem Attribut 'viewBox' des angegebenen Elements. |
...
| [Width](../../aspose.svg/svgsvgelement/width) { get; } | Entspricht dem Attribut „Breite“ des angegebenen „svg“-Elements. |
| [X](../../aspose.svg/svgsvgelement/x) { get; } | Entspricht dem Attribut 'x' des angegebenen 'svg'-Elements. |
| [Y](../../aspose.svg/svgsvgelement/y) { get; } | Entspricht dem Attribut „y“ des angegebenen „svg“-Elements. |
| [ZoomAndPan](../../aspose.svg/svgsvgelement/zoomandpan) { get; set; } | Entspricht dem Attribut 'zoomAndPan' des angegebenen Elements. Der Wert muss eine der auf dieser Schnittstelle definierten SVG_ZOOMANDPAN_*-Konstanten sein. |
...
| [AnimationsPaused](../../aspose.svg/svgsvgelement/animationspaused)() | Gibt „true“ zurück, wenn sich dieses SVG-Dokumentfragment im angehaltenen Zustand befindet. |
...
| [CreateEvent](../../aspose.svg/svgsvgelement/createevent)(string) | Erstellt eine[`Event`](../../aspose.svg.dom.events/event) eines Typs, der von der Implementierung unterstützt wird. |
| [CreateSVGAngle](../../aspose.svg/svgsvgelement/createsvgangle)() | Erstellt ein SVGAngle-Objekt außerhalb von Dokumentbäumen. Das Objekt wird auf den Wert 0 Grad (ohne Einheit) initialisiert. |
| [CreateSVGLength](../../aspose.svg/svgsvgelement/createsvglength)() | Erstellt ein SVGLength-Objekt außerhalb von Dokumentbäumen. Das Objekt wird auf den Wert 0 Benutzereinheiten initialisiert. |
| [CreateSVGMatrix](../../aspose.svg/svgsvgelement/createsvgmatrix)() | Erstellt ein SVGMatrix-Objekt außerhalb von Dokumentbäumen. Das Objekt wird mit der Identitätsmatrix initialisiert. |
| [CreateSVGNumber](../../aspose.svg/svgsvgelement/createsvgnumber)() | Erstellt ein SVGNumber-Objekt außerhalb von Dokumentbäumen. Das Objekt wird auf einen Wert von Null initialisiert. |
| [CreateSVGPoint](../../aspose.svg/svgsvgelement/createsvgpoint)() | Erstellt ein SVGPoint-Objekt außerhalb von Dokumentbäumen. Das Objekt wird auf den Punkt (0,0) im Benutzerkoordinatensystem initialisiert. |
| [CreateSVGRect](../../aspose.svg/svgsvgelement/createsvgrect)() | Erstellt ein SVGRect-Objekt außerhalb von Dokumentbäumen. Das Objekt wird so initialisiert, dass alle Werte auf 0 Benutzereinheiten gesetzt werden. |
| [CreateSVGTransform](../../aspose.svg/svgsvgelement/createsvgtransform)() | Erstellt ein SVGTransform-Objekt außerhalb von Dokumentbäumen. Das Objekt wird mit einer Identitätsmatrixtransformation (SVG_TRANSFORM_MATRIX) initialisiert. |
...
| [UnpauseAnimations](../../aspose.svg/svgsvgelement/unpauseanimations)() | Hebt die Unterbrechung auf (d. h. setzt die Pause fort) aktuell ausgeführter Animationen, die im SVG-Dokumentfragment definiert sind, wodurch die Animationsuhr ab dem Zeitpunkt fortgesetzt wird, zu dem sie unterbrochen wurde. |
