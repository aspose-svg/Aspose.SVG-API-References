...
description: Aspose.Svg.SVGGeometryElement klas. Schnittstelle SVGGeometryElement stellt SVGElemente dar deren Wiedergabe durch Geometrie mit einem äquivalenten Pfad definiert ist und die gefüllt und gezeichnet werden können. Dazu gehören Pfade und die Grundformen.
type: docs
weight: 3270
...
| [GetEquivalentPath](../../aspose.svg/svggeometryelement/getequivalentpath/)() | Gibt eine neue Instanzinstanz von zurück[`SVGPathSegList`](../../aspose.svg.paths/svgpathseglist/) was darstellt`SVGGeometryElement` als Pfadsegmente. |
