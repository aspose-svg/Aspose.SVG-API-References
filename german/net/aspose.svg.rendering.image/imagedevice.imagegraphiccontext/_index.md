...
description: "Aspose.Svg.Rendering.Image.ImageDeviceImageGraphicContext Klasse. Enthält aktuelle Grafiksteuerungsparameter für das ImageDevice. Diese Parameter definieren das globale Rahmenwerk, in dem die Grafikoperatoren ausgeführt werden."
type: docs
weight: 4920
...
Enthält aktuelle Grafiksteuerungsparameter für das [`ImageDevice`](../imagedevice/). Diese Parameter definieren das globale Rahmenwerk, in dem die Grafikoperatoren ausgeführt werden.
...
| Name | Beschreibung |
| --- | --- |
| [ImageGraphicContext](../../aspose.svg.rendering.image/imagedevice.imagegraphiccontext/.ctor)() | Der Standard‑Konstruktor. |
