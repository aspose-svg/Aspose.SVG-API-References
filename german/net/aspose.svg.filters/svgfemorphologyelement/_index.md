...
description: "Aspose.Svg.Filters.SVGFEMorphologyElement Klasse. Das SVGFEMorphologyElement-Interface entspricht dem feMorphology-Element"
type: docs
weight: 3920
...
| [Height](../../aspose.svg.filters/svgfemorphologyelement/height/) { get; } | Entspricht dem Attribut ‘height’ des angegebenen ‘filter’-Elements. |
...
| [Operator](../../aspose.svg.filters/svgfemorphologyelement/operator/) { get; } | Entspricht dem Attribut ‘operator’ des angegebenen ‘feMorphology’-Elements. Akzeptiert eine der auf diesem Interface definierten SVG_MORPHOLOGY_OPERATOR_*-Konstanten. |
...
| [RadiusX](../../aspose.svg.filters/svgfemorphologyelement/radiusx/) { get; } | Entspricht dem Attribut ‘radius’ des angegebenen ‘feMorphology’-Elements. |
| [RadiusY](../../aspose.svg.filters/svgfemorphologyelement/radiusy/) { get; } | Entspricht dem Attribut ‘radius’ des angegebenen ‘feMorphology’-Elements. |
| [Result](../../aspose.svg.filters/svgfemorphologyelement/result/) { get; } | Entspricht dem Attribut ‘result’ im angegebenen ‘filter’-Element. |
...
| [Width](../../aspose.svg.filters/svgfemorphologyelement/width/) { get; } | Entspricht dem Attribut ‘width’ des angegebenen ‘filter’-Elements. |
| [X](../../aspose.svg.filters/svgfemorphologyelement/x/) { get; } | Entspricht dem Attribut ‘x’ des angegebenen ‘filter’-Elements. |
...
| Name | Beschreibung |
| --- | --- |
| const [SVG_MORPHOLOGY_OPERATOR_DILATE](../../aspose.svg.filters/svgfemorphologyelement/svg_morphology_operator_dilate/) | Entspricht dem Wert 'dilate'. |
| const [SVG_MORPHOLOGY_OPERATOR_ERODE](../../aspose.svg.filters/svgfemorphologyelement/svg_morphology_operator_erode/) | Entspricht dem Wert 'erode'. |
| const [SVG_MORPHOLOGY_OPERATOR_UNKNOWN](../../aspose.svg.filters/svgfemorphologyelement/svg_morphology_operator_unknown/) | Der Typ ist keiner der vordefinierten Typen. Es ist ungültig, zu versuchen, einen neuen Wert dieses Typs zu definieren oder einen bestehenden Wert zu diesem Typ zu wechseln. |
