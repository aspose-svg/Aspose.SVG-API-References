...
description: Aspose.Svg.Filters.SVGFEMorphologyElement klas. Die SVGFEMorphologyElementSchnittstelle entspricht dem feMorphologyElement.
type: docs
weight: 1830
url: /de/net/aspose.svg.filters/svgfemorphologyelement/
---
...
| [Height](../../aspose.svg.filters/svgfemorphologyelement/height/) { get; } | Entspricht dem Attribut „Höhe“ des angegebenen „Filter“-Elements. |
...
| [In1](../../aspose.svg.filters/svgfemorphologyelement/in1/) { get; } | Entspricht dem Attribut „in“ des angegebenen „feMorphology“-Elements. |
...
| [Operator](../../aspose.svg.filters/svgfemorphologyelement/operator/) { get; } | Entspricht dem Attribut 'operator' des angegebenen 'feMorphology'-Elements. Akzeptiert eine der SVG_MORPHOLOGY_OPERATOR_*-Konstanten, die auf dieser Schnittstelle definiert sind. |
...
| [RadiusX](../../aspose.svg.filters/svgfemorphologyelement/radiusx/) { get; } | Entspricht dem Attribut 'radius' auf dem gegebenen 'feMorphology'-Element. |
| [RadiusY](../../aspose.svg.filters/svgfemorphologyelement/radiusy/) { get; } | Entspricht dem Attribut 'radius' auf dem gegebenen 'feMorphology'-Element. |
| [Result](../../aspose.svg.filters/svgfemorphologyelement/result/) { get; } | Entspricht dem Attribut „Ergebnis“ des angegebenen „Filter“-Elements. |
...
| [Width](../../aspose.svg.filters/svgfemorphologyelement/width/) { get; } | Entspricht dem Attribut „Breite“ des angegebenen „Filter“-Elements. |
| [X](../../aspose.svg.filters/svgfemorphologyelement/x/) { get; } | Entspricht dem Attribut 'x' im angegebenen 'filter'-Element. |
| [Y](../../aspose.svg.filters/svgfemorphologyelement/y/) { get; } | Entspricht dem Attribut 'y' des angegebenen 'filter'-Elements. |
...
| Name | Beschreibung |
| --- | --- |
| const [SVG_MORPHOLOGY_OPERATOR_DILATE](../../aspose.svg.filters/svgfemorphologyelement/svg_morphology_operator_dilate/) | Entspricht Wert 'dilatieren'. |
| const [SVG_MORPHOLOGY_OPERATOR_ERODE](../../aspose.svg.filters/svgfemorphologyelement/svg_morphology_operator_erode/) | Entspricht Wert 'erode'. |
| const [SVG_MORPHOLOGY_OPERATOR_UNKNOWN](../../aspose.svg.filters/svgfemorphologyelement/svg_morphology_operator_unknown/) | Der Typ ist keiner der vordefinierten Typen. Es ist ungültig, einen neuen Wert dieses Typs zu definieren oder einen vorhandenen Wert auf diesen Typ umzustellen. |
