...
description: "Aspose.Svg.Filters.SVGFETurbulenceElement Klasse. Das SVGFETurbulenceElement‑Interface entspricht dem feTurbulence‑Element"
type: docs
weight: 3980
...
| [BaseFrequencyX](../../aspose.svg.filters/svgfeturbulenceelement/basefrequencyx/) { get; } | Entspricht dem Attribut ‘baseFrequency’ im angegebenen ‘feTurbulence’-Element. Enthält die X‑Komponente des Attributs ‘baseFrequency’. |
| [BaseFrequencyY](../../aspose.svg.filters/svgfeturbulenceelement/basefrequencyy/) { get; } | Entspricht dem Attribut ‘baseFrequency’ im angegebenen ‘feTurbulence’-Element. Enthält die Y‑Komponente des (möglicherweise automatisch berechneten) Attributs ‘baseFrequency’. |
...
| [Height](../../aspose.svg.filters/svgfeturbulenceelement/height/) { get; } | Entspricht dem Attribut ‘height’ des angegebenen ‘filter’-Elements. |
...
| [NumOctaves](../../aspose.svg.filters/svgfeturbulenceelement/numoctaves/) { get; } | Entspricht dem Attribut ‘numOctaves’ im angegebenen ‘feTurbulence’-Element. |
...
| [Result](../../aspose.svg.filters/svgfeturbulenceelement/result/) { get; } | Entspricht dem Attribut ‘result’ im angegebenen ‘filter’-Element. |
| [Seed](../../aspose.svg.filters/svgfeturbulenceelement/seed/) { get; } | Entspricht dem Attribut ‘seed’ im angegebenen ‘feTurbulence’-Element. |
...
| [StitchTiles](../../aspose.svg.filters/svgfeturbulenceelement/stitchtiles/) { get; } | Entspricht dem Attribut ‘stitchTiles’ im angegebenen ‘feTurbulence’-Element. Akzeptiert eine der auf diesem Interface definierten SVG_STITCHTYPE_*‑Konstanten. |
...
| [Type](../../aspose.svg.filters/svgfeturbulenceelement/type/) { get; } | Entspricht dem Attribut ‘type’ im angegebenen ‘feTurbulence’-Element. Akzeptiert eine der auf diesem Interface definierten SVG_TURBULENCE_TYPE_*‑Konstanten. |
...
| [Width](../../aspose.svg.filters/svgfeturbulenceelement/width/) { get; } | Entspricht dem Attribut ‘width’ des angegebenen ‘filter’-Elements. |
| [X](../../aspose.svg.filters/svgfeturbulenceelement/x/) { get; } | Entspricht dem Attribut ‘x’ des angegebenen ‘filter’-Elements. |
...
| Name | Beschreibung |
| --- | --- |
| const [SVG_STITCHTYPE_NOSTITCH](../../aspose.svg.filters/svgfeturbulenceelement/svg_stitchtype_nostitch/) | Entspricht dem Wert 'noStitch'. |
| const [SVG_STITCHTYPE_STITCH](../../aspose.svg.filters/svgfeturbulenceelement/svg_stitchtype_stitch/) | Entspricht dem Wert 'stitch'. |
| const [SVG_STITCHTYPE_UNKNOWN](../../aspose.svg.filters/svgfeturbulenceelement/svg_stitchtype_unknown/) | Der Typ ist keiner der vordefinierten Typen. Es ist ungültig, zu versuchen, einen neuen Wert dieses Typs zu definieren oder einen bestehenden Wert zu diesem Typ zu wechseln. |
...
| const [SVG_TURBULENCE_TYPE_TURBULENCE](../../aspose.svg.filters/svgfeturbulenceelement/svg_turbulence_type_turbulence/) | Entspricht dem Wert 'turbulence'. |
| const [SVG_TURBULENCE_TYPE_UNKNOWN](../../aspose.svg.filters/svgfeturbulenceelement/svg_turbulence_type_unknown/) | Der Typ ist keiner der vordefinierten Typen. Es ist ungültig, zu versuchen, einen neuen Wert dieses Typs zu definieren oder einen bestehenden Wert zu diesem Typ zu wechseln. |
