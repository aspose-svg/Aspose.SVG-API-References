...
description: Aspose.Svg.Filters.SVGFETurbulenceElement klas. Die SVGFETurbulenceElementSchnittstelle entspricht dem feTurbulenceElement.
type: docs
weight: 1890
url: /de/net/aspose.svg.filters/svgfeturbulenceelement/
---
...
| [BaseFrequencyX](../../aspose.svg.filters/svgfeturbulenceelement/basefrequencyx/) { get; } | Entspricht dem Attribut „baseFrequency“ des angegebenen „feTurbulence“-Elements. Enthält die X-Komponente des Attributs „baseFrequency“. |
| [BaseFrequencyY](../../aspose.svg.filters/svgfeturbulenceelement/basefrequencyy/) { get; } | Entspricht dem Attribut „baseFrequency“ des angegebenen „feTurbulence“-Elements. Enthält die Y-Komponente des (evtl. automatisch berechneten) 'baseFrequency'-Attributs. |
...
| [Height](../../aspose.svg.filters/svgfeturbulenceelement/height/) { get; } | Entspricht dem Attribut „Höhe“ des angegebenen „Filter“-Elements. |
...
| [NumOctaves](../../aspose.svg.filters/svgfeturbulenceelement/numoctaves/) { get; } | Entspricht dem Attribut 'numOctaves' auf dem gegebenen 'feTurbulence'-Element. |
...
| [Result](../../aspose.svg.filters/svgfeturbulenceelement/result/) { get; } | Entspricht dem Attribut „Ergebnis“ des angegebenen „Filter“-Elements. |
| [SchemaTypeInfo](../../aspose.svg.dom/element/schematypeinfo/) { get; } | Die diesem Element zugeordneten Typinformationen. |
| [Seed](../../aspose.svg.filters/svgfeturbulenceelement/seed/) { get; } | Entspricht dem Attribut 'Seed' auf dem angegebenen Element 'feTurbulence'. |
...
| [StitchTiles](../../aspose.svg.filters/svgfeturbulenceelement/stitchtiles/) { get; } | Entspricht dem Attribut 'stitchTiles' auf dem gegebenen 'feTurbulence'-Element. Akzeptiert eine der SVG_STITCHTYPE_*-Konstanten, die auf dieser Schnittstelle definiert sind. |
...
| [Type](../../aspose.svg.filters/svgfeturbulenceelement/type/) { get; } | Entspricht dem Attribut 'type' des angegebenen 'feTurbulence'-Elements. Akzeptiert eine der SVG_TURBULENCE_TYPE_*-Konstanten, die auf dieser Schnittstelle definiert sind. |
...
| [Width](../../aspose.svg.filters/svgfeturbulenceelement/width/) { get; } | Entspricht dem Attribut „Breite“ des angegebenen „Filter“-Elements. |
| [X](../../aspose.svg.filters/svgfeturbulenceelement/x/) { get; } | Entspricht dem Attribut 'x' im angegebenen 'filter'-Element. |
| [Y](../../aspose.svg.filters/svgfeturbulenceelement/y/) { get; } | Entspricht dem Attribut 'y' des angegebenen 'filter'-Elements. |
...
| Name | Beschreibung |
| --- | --- |
| const [SVG_STITCHTYPE_NOSTITCH](../../aspose.svg.filters/svgfeturbulenceelement/svg_stitchtype_nostitch/) | Entspricht Wert 'noStitch'. |
| const [SVG_STITCHTYPE_STITCH](../../aspose.svg.filters/svgfeturbulenceelement/svg_stitchtype_stitch/) | Entspricht dem Wert 'Stich'. |
| const [SVG_STITCHTYPE_UNKNOWN](../../aspose.svg.filters/svgfeturbulenceelement/svg_stitchtype_unknown/) | Der Typ ist keiner der vordefinierten Typen. Es ist ungültig, einen neuen Wert dieses Typs zu definieren oder einen vorhandenen Wert auf diesen Typ umzustellen. |
| const [SVG_TURBULENCE_TYPE_FRACTALNOISE](../../aspose.svg.filters/svgfeturbulenceelement/svg_turbulence_type_fractalnoise/) | Entspricht dem Wert 'fractalNoise'. |
| const [SVG_TURBULENCE_TYPE_TURBULENCE](../../aspose.svg.filters/svgfeturbulenceelement/svg_turbulence_type_turbulence/) | Entspricht Wert 'Turbulenz'. |
| const [SVG_TURBULENCE_TYPE_UNKNOWN](../../aspose.svg.filters/svgfeturbulenceelement/svg_turbulence_type_unknown/) | Der Typ ist keiner der vordefinierten Typen. Es ist ungültig, einen neuen Wert dieses Typs zu definieren oder einen vorhandenen Wert auf diesen Typ umzustellen. |
