...
description: "Aspose.Svg.Filters.SVGFEGaussianBlurElement Klasse. Das SVGFEGaussianBlurElement-Interface entspricht dem feGaussianBlur-Element."
type: docs
weight: 3880
...
| [Height](../../aspose.svg.filters/svgfegaussianblurelement/height/) { get; } | Entspricht dem Attribut �height� im angegebenen �filter�-Element. |
...
| [In1](../../aspose.svg.filters/svgfegaussianblurelement/in1/) { get; } | Entspricht dem Attribut �in� im angegebenen �feGaussianBlur�-Element. |
...
| [Result](../../aspose.svg.filters/svgfegaussianblurelement/result/) { get; } | Entspricht dem Attribut �result� im angegebenen �filter�-Element. |
...
| [StdDeviationX](../../aspose.svg.filters/svgfegaussianblurelement/stddeviationx/) { get; } | Entspricht dem Attribut �stdDeviation� im angegebenen �feGaussianBlur�-Element. Enthält die X-Komponente des Attributs �stdDeviation�. |
| [StdDeviationY](../../aspose.svg.filters/svgfegaussianblurelement/stddeviationy/) { get; } | Entspricht dem Attribut �stdDeviation� im angegebenen �feGaussianBlur�-Element. Enthält die Y‑Komponente (möglicherweise automatisch berechnet) des Attributs �stdDeviation�. |
...
| [Width](../../aspose.svg.filters/svgfegaussianblurelement/width/) { get; } | Entspricht dem Attribut �width� im angegebenen �filter�-Element. |
| [X](../../aspose.svg.filters/svgfegaussianblurelement/x/) { get; } | Entspricht dem Attribut �x� im angegebenen �filter�-Element. |
| [Y](../../aspose.svg.filters/svgfegaussianblurelement/y/) { get; } | Entspricht dem Attribut �y� im angegebenen �filter�-Element. |
