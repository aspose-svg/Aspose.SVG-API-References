...
description: "Aspose.Svg.Filters.SVGFEConvolveMatrixElement Klasse. Das SVGFEConvolveMatrixElement Interface entspricht dem feConvolveMatrix-Element."
type: docs
weight: 3780
...
| [Bias](../../aspose.svg.filters/svgfeconvolvematrixelement/bias/) { get; } | Entspricht dem Attribut ‘bias’ im angegebenen ‘feConvolveMatrix’-Element. |
...
| [Divisor](../../aspose.svg.filters/svgfeconvolvematrixelement/divisor/) { get; } | Entspricht dem Attribut ‘divisor’ im angegebenen ‘feConvolveMatrix’-Element. |
| [EdgeMode](../../aspose.svg.filters/svgfeconvolvematrixelement/edgemode/) { get; } | Entspricht dem Attribut ‘edgeMode’ im angegebenen ‘feConvolveMatrix’-Element. |
...
| [Height](../../aspose.svg.filters/svgfeconvolvematrixelement/height/) { get; } | Entspricht dem Attribut ‘height’ des angegebenen ‘filter’-Elements. |
...
| [In1](../../aspose.svg.filters/svgfeconvolvematrixelement/in1/) { get; } | Entspricht dem Attribut ‘in’ im angegebenen ‘feConvolveMatrix’-Element. |
...
| [KernelMatrix](../../aspose.svg.filters/svgfeconvolvematrixelement/kernelmatrix/) { get; } | Entspricht dem Attribut ‘kernelMatrix’ im angegebenen ‘feConvolveMatrix’-Element. |
| [KernelUnitLengthX](../../aspose.svg.filters/svgfeconvolvematrixelement/kernelunitlengthx/) { get; } | Entspricht dem Attribut ‘kernelUnitLength’ im angegebenen ‘feConvolveMatrix’-Element. |
| [KernelUnitLengthY](../../aspose.svg.filters/svgfeconvolvematrixelement/kernelunitlengthy/) { get; } | Entspricht dem Attribut ‘kernelUnitLength’ im angegebenen ‘feConvolveMatrix’-Element. |
...
| [OrderX](../../aspose.svg.filters/svgfeconvolvematrixelement/orderx/) { get; } | Entspricht dem Attribut ‘order’ im angegebenen ‘feConvolveMatrix’-Element. |
| [OrderY](../../aspose.svg.filters/svgfeconvolvematrixelement/ordery/) { get; } | Entspricht dem Attribut ‘order’ im angegebenen ‘feConvolveMatrix’-Element. |
...
| [PreserveAlpha](../../aspose.svg.filters/svgfeconvolvematrixelement/preservealpha/) { get; } | Entspricht dem Attribut ‘preserveAlpha’ im angegebenen ‘feConvolveMatrix’-Element. |
...
| [Result](../../aspose.svg.filters/svgfeconvolvematrixelement/result/) { get; } | Entspricht dem Attribut ‘result’ im angegebenen ‘filter’-Element. |
...
| [TargetX](../../aspose.svg.filters/svgfeconvolvematrixelement/targetx/) { get; } | Entspricht dem Attribut ‘targetX’ im angegebenen ‘feConvolveMatrix’-Element. |
| [TargetY](../../aspose.svg.filters/svgfeconvolvematrixelement/targety/) { get; } | Entspricht dem Attribut ‘targetY’ im angegebenen ‘feConvolveMatrix’-Element. |
...
| [Width](../../aspose.svg.filters/svgfeconvolvematrixelement/width/) { get; } | Entspricht dem Attribut ‘width’ des angegebenen ‘filter’-Elements. |
| [X](../../aspose.svg.filters/svgfeconvolvematrixelement/x/) { get; } | Entspricht dem Attribut ‘x’ des angegebenen ‘filter’-Elements. |
...
| Name | Beschreibung |
| --- | --- |
| const [SVG_EDGEMODE_DUPLICATE](../../aspose.svg.filters/svgfeconvolvematrixelement/svg_edgemode_duplicate/) | Entspricht dem Wert 'duplicate'. |
| const [SVG_EDGEMODE_NONE](../../aspose.svg.filters/svgfeconvolvematrixelement/svg_edgemode_none/) | Entspricht dem Wert 'none'. |
| const [SVG_EDGEMODE_UNKNOWN](../../aspose.svg.filters/svgfeconvolvematrixelement/svg_edgemode_unknown/) | Der Typ ist keiner der vordefinierten Typen. Es ist ungültig, zu versuchen, einen neuen Wert dieses Typs zu definieren oder einen bestehenden Wert zu diesem Typ zu wechseln. |
