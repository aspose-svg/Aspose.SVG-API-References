...
description: Aspose.Svg.Filters.SVGFEConvolveMatrixElement klas. Die SVGFEConvolveMatrixElementSchnittstelle entspricht dem feConvolveMatrixElement.
type: docs
weight: 1690
url: /de/net/aspose.svg.filters/svgfeconvolvematrixelement/
---
...
| [Bias](../../aspose.svg.filters/svgfeconvolvematrixelement/bias/) { get; } | Entspricht dem Attribut 'bias' auf dem gegebenen 'feConvolveMatrix'-Element. |
...
| [Divisor](../../aspose.svg.filters/svgfeconvolvematrixelement/divisor/) { get; } | Entspricht dem Attribut 'divisor' auf dem gegebenen 'feConvolveMatrix'-Element. |
| [EdgeMode](../../aspose.svg.filters/svgfeconvolvematrixelement/edgemode/) { get; } | Entspricht dem Attribut 'edgeMode' auf dem gegebenen 'feConvolveMatrix'-Element. |
...
| [Height](../../aspose.svg.filters/svgfeconvolvematrixelement/height/) { get; } | Entspricht dem Attribut „Höhe“ des angegebenen „Filter“-Elements. |
...
| [In1](../../aspose.svg.filters/svgfeconvolvematrixelement/in1/) { get; } | Entspricht dem Attribut „in“ des angegebenen „feConvolveMatrix“-Elements. |
...
| [KernelMatrix](../../aspose.svg.filters/svgfeconvolvematrixelement/kernelmatrix/) { get; } | Entspricht dem Attribut 'kernelMatrix' auf dem gegebenen 'feConvolveMatrix'-Element. |
| [KernelUnitLengthX](../../aspose.svg.filters/svgfeconvolvematrixelement/kernelunitlengthx/) { get; } | Entspricht dem Attribut „kernelUnitLength“ des angegebenen „feConvolveMatrix“-Elements. |
| [KernelUnitLengthY](../../aspose.svg.filters/svgfeconvolvematrixelement/kernelunitlengthy/) { get; } | Entspricht dem Attribut „kernelUnitLength“ des angegebenen „feConvolveMatrix“-Elements. |
...
| [OrderX](../../aspose.svg.filters/svgfeconvolvematrixelement/orderx/) { get; } | Entspricht dem Attribut 'order' auf dem gegebenen 'feConvolveMatrix'-Element. |
| [OrderY](../../aspose.svg.filters/svgfeconvolvematrixelement/ordery/) { get; } | Entspricht dem Attribut 'order' auf dem gegebenen 'feConvolveMatrix'-Element. |
...
| [PreserveAlpha](../../aspose.svg.filters/svgfeconvolvematrixelement/preservealpha/) { get; } | Entspricht dem Attribut „preserveAlpha“ des angegebenen „feConvolveMatrix“-Elements. |
...
| [Result](../../aspose.svg.filters/svgfeconvolvematrixelement/result/) { get; } | Entspricht dem Attribut „Ergebnis“ des angegebenen „Filter“-Elements. |
...
| [TargetX](../../aspose.svg.filters/svgfeconvolvematrixelement/targetx/) { get; } | Entspricht dem Attribut 'targetX' auf dem gegebenen 'feConvolveMatrix'-Element. |
| [TargetY](../../aspose.svg.filters/svgfeconvolvematrixelement/targety/) { get; } | Entspricht dem Attribut „targetY“ des angegebenen „feConvolveMatrix“-Elements. |
...
| [Width](../../aspose.svg.filters/svgfeconvolvematrixelement/width/) { get; } | Entspricht dem Attribut „Breite“ des angegebenen „Filter“-Elements. |
| [X](../../aspose.svg.filters/svgfeconvolvematrixelement/x/) { get; } | Entspricht dem Attribut 'x' im angegebenen 'filter'-Element. |
| [Y](../../aspose.svg.filters/svgfeconvolvematrixelement/y/) { get; } | Entspricht dem Attribut 'y' des angegebenen 'filter'-Elements. |
...
| Name | Beschreibung |
| --- | --- |
| const [SVG_EDGEMODE_DUPLICATE](../../aspose.svg.filters/svgfeconvolvematrixelement/svg_edgemode_duplicate/) | Entspricht Wert 'duplizieren'. |
| const [SVG_EDGEMODE_NONE](../../aspose.svg.filters/svgfeconvolvematrixelement/svg_edgemode_none/) | Entspricht dem Wert 'none'. |
| const [SVG_EDGEMODE_UNKNOWN](../../aspose.svg.filters/svgfeconvolvematrixelement/svg_edgemode_unknown/) | Der Typ ist keiner der vordefinierten Typen. Es ist ungültig, einen neuen Wert dieses Typs zu definieren oder einen vorhandenen Wert auf diesen Typ umzustellen. |
| const [SVG_EDGEMODE_WRAP](../../aspose.svg.filters/svgfeconvolvematrixelement/svg_edgemode_wrap/) | Entspricht dem Wert 'wrap'. |
