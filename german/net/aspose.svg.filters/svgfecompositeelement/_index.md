...
description: "Aspose.Svg.Filters.SVGFECompositeElement Klasse. Das SVGFECompositeElement-Interface entspricht dem feComposite-Element"
type: docs
weight: 3770
...
| [Height](../../aspose.svg.filters/svgfecompositeelement/height/) { get; } | Entspricht dem Attribut ‘height’ des angegebenen ‘filter’-Elements. |
...
| [Operator](../../aspose.svg.filters/svgfecompositeelement/operator/) { get; } | Entspricht dem Attribut ‘operator’ des angegebenen ‘feComposite’-Elements. Akzeptiert eine der auf diesem Interface definierten SVG_FECOMPOSITE_OPERATOR_*-Konstanten. |
...
| [Result](../../aspose.svg.filters/svgfecompositeelement/result/) { get; } | Entspricht dem Attribut ‘result’ im angegebenen ‘filter’-Element. |
...
| [Width](../../aspose.svg.filters/svgfecompositeelement/width/) { get; } | Entspricht dem Attribut ‘width’ des angegebenen ‘filter’-Elements. |
| [X](../../aspose.svg.filters/svgfecompositeelement/x/) { get; } | Entspricht dem Attribut ‘x’ des angegebenen ‘filter’-Elements. |
...
| const [SVG_FECOMPOSITE_OPERATOR_ATOP](../../aspose.svg.filters/svgfecompositeelement/svg_fecomposite_operator_atop/) | Entspricht dem Wert 'atop'. |
| const [SVG_FECOMPOSITE_OPERATOR_IN](../../aspose.svg.filters/svgfecompositeelement/svg_fecomposite_operator_in/) | Entspricht dem Wert 'in'. |
...
| const [SVG_FECOMPOSITE_OPERATOR_OVER](../../aspose.svg.filters/svgfecompositeelement/svg_fecomposite_operator_over/) | Entspricht dem Wert 'over'. |
| const [SVG_FECOMPOSITE_OPERATOR_UNKNOWN](../../aspose.svg.filters/svgfecompositeelement/svg_fecomposite_operator_unknown/) | Der Typ ist keiner der vordefinierten Typen. Es ist ungültig, zu versuchen, einen neuen Wert dieses Typs zu definieren oder einen bestehenden Wert zu diesem Typ zu wechseln. |
| const [SVG_FECOMPOSITE_OPERATOR_XOR](../../aspose.svg.filters/svgfecompositeelement/svg_fecomposite_operator_xor/) | Entspricht dem Wert 'xor'. |
