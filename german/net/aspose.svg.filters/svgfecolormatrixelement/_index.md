...
description: "Aspose.Svg.Filters.SVGFEColorMatrixElement Klasse. Das SVGFEColorMatrixElement-Interface entspricht dem feColorMatrix-Element."
type: docs
weight: 3750
...
| [Height](../../aspose.svg.filters/svgfecolormatrixelement/height/) { get; } | Entspricht dem Attribut ‘height’ des angegebenen ‘filter’-Elements. |
...
| [In1](../../aspose.svg.filters/svgfecolormatrixelement/in1/) { get; } | Entspricht dem Attribut ‘in’ im angegebenen ‘feColorMatrix’-Element. |
...
| [Result](../../aspose.svg.filters/svgfecolormatrixelement/result/) { get; } | Entspricht dem Attribut ‘result’ im angegebenen ‘filter’-Element. |
...
| [Type](../../aspose.svg.filters/svgfecolormatrixelement/type/) { get; } | Entspricht dem Attribut ‘type’ im angegebenen ‘feColorMatrix’-Element. Akzeptiert einen der auf diesem Interface definierten SVG_FECOLORMATRIX_TYPE_*‑Konstanten. |
| [Values](../../aspose.svg.filters/svgfecolormatrixelement/values/) { get; } | Entspricht dem Attribut ‘values’ im angegebenen ‘feColorMatrix’-Element. |
...
| [Width](../../aspose.svg.filters/svgfecolormatrixelement/width/) { get; } | Entspricht dem Attribut ‘width’ des angegebenen ‘filter’-Elements. |
| [X](../../aspose.svg.filters/svgfecolormatrixelement/x/) { get; } | Entspricht dem Attribut ‘x’ des angegebenen ‘filter’-Elements. |
...
| Name | Beschreibung |
| --- | --- |
| const [SVG_FECOLORMATRIX_TYPE_HUEROTATE](../../aspose.svg.filters/svgfecolormatrixelement/svg_fecolormatrix_type_huerotate/) | Entspricht dem Wert 'hueRotate'. |
| const [SVG_FECOLORMATRIX_TYPE_LUMINANCETOALPHA](../../aspose.svg.filters/svgfecolormatrixelement/svg_fecolormatrix_type_luminancetoalpha/) | Entspricht dem Wert 'luminanceToAlpha'. |
| const [SVG_FECOLORMATRIX_TYPE_MATRIX](../../aspose.svg.filters/svgfecolormatrixelement/svg_fecolormatrix_type_matrix/) | Entspricht dem Wert 'matrix'. |
| const [SVG_FECOLORMATRIX_TYPE_SATURATE](../../aspose.svg.filters/svgfecolormatrixelement/svg_fecolormatrix_type_saturate/) | Entspricht dem Wert 'saturate'. |
| const [SVG_FECOLORMATRIX_TYPE_UNKNOWN](../../aspose.svg.filters/svgfecolormatrixelement/svg_fecolormatrix_type_unknown/) | Der Typ ist keiner der vordefinierten Typen. Es ist ungültig, zu versuchen, einen neuen Wert dieses Typs zu definieren oder einen bestehenden Wert zu diesem Typ zu wechseln. |
