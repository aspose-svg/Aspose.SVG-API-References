...
description: "Aspose.Svg.Filters.SVGFEDropShadowElement Klasse. Das SVGFEDropShadowElement-Interface entspricht dem feDropShadow-Element."
type: docs
weight: 3820
...
| [Dx](../../aspose.svg.filters/svgfedropshadowelement/dx/) { get; } | Entspricht dem Attribut ‘dx’ im angegebenen ‘feDropShadow’-Element. |
| [Dy](../../aspose.svg.filters/svgfedropshadowelement/dy/) { get; } | Entspricht dem Attribut ‘dy’ im angegebenen ‘feDropShadow’-Element. |
...
| [Height](../../aspose.svg.filters/svgfedropshadowelement/height/) { get; } | Entspricht dem Attribut ‘height’ im angegebenen ‘feDropShadow’-Element. |
...
| [In1](../../aspose.svg.filters/svgfedropshadowelement/in1/) { get; } | Entspricht dem Attribut ‘in’ im angegebenen ‘feDropShadow’-Element. |
...
| [Result](../../aspose.svg.filters/svgfedropshadowelement/result/) { get; } | Entspricht dem Attribut ‘result’ im angegebenen ‘feDropShadow’-Element. |
...
| [StdDeviationX](../../aspose.svg.filters/svgfedropshadowelement/stddeviationx/) { get; } | Entspricht dem Attribut ‘stdDeviation’ im angegebenen ‘feDropShadow’-Element. Enthält die X‑Komponente des Attributs ‘stdDeviation’. |
| [StdDeviationY](../../aspose.svg.filters/svgfedropshadowelement/stddeviationy/) { get; } | Entspricht dem Attribut ‘stdDeviation’ im angegebenen ‘feDropShadow’-Element. Enthält die Y‑Komponente (möglicherweise automatisch berechnet) des Attributs ‘stdDeviation’. |
...
| [Width](../../aspose.svg.filters/svgfedropshadowelement/width/) { get; } | Entspricht dem Attribut ‘width’ im angegebenen ‘feDropShadow’-Element. |
| [X](../../aspose.svg.filters/svgfedropshadowelement/x/) { get; } | Entspricht dem Attribut ‘x’ im angegebenen ‘feDropShadow’-Element. |
| [Y](../../aspose.svg.filters/svgfedropshadowelement/y/) { get; } | Entspricht dem Attribut ‘y’ im angegebenen ‘feDropShadow’-Element. |
