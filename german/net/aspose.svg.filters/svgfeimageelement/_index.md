...
description: "Aspose.Svg.Filters.SVGFEImageElement Klasse. Das SVGFEImageElement-Interface entspricht dem feImage-Element"
type: docs
weight: 3890
...
| [Height](../../aspose.svg.filters/svgfeimageelement/height/) { get; } | Entspricht dem Attribut ‘height’ des angegebenen ‘filter’-Elements. |
...
| [PreserveAspectRatio](../../aspose.svg.filters/svgfeimageelement/preserveaspectratio/) { get; } | Entspricht dem Attribut ‘preserveAspectRatio’ im angegebenen ‘feImage’-Element. |
...
| [Result](../../aspose.svg.filters/svgfeimageelement/result/) { get; } | Entspricht dem Attribut ‘result’ im angegebenen ‘filter’-Element. |
...
| [Width](../../aspose.svg.filters/svgfeimageelement/width/) { get; } | Entspricht dem Attribut ‘width’ des angegebenen ‘filter’-Elements. |
| [X](../../aspose.svg.filters/svgfeimageelement/x/) { get; } | Entspricht dem Attribut ‘x’ des angegebenen ‘filter’-Elements. |
