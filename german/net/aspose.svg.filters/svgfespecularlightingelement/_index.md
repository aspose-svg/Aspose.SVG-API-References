...
description: "Aspose.Svg.Filters.SVGFESpecularLightingElement Klasse. Das SVGFESpecularLightingElement-Interface entspricht dem feSpecularLighting-Element."
type: docs
weight: 3950
...
| [Height](../../aspose.svg.filters/svgfespecularlightingelement/height/) { get; } | Entspricht dem Attribut ‘height’ des angegebenen ‘filter’-Elements. |
...
| [In1](../../aspose.svg.filters/svgfespecularlightingelement/in1/) { get; } | Entspricht dem Attribut ‘in’ im angegebenen ‘feSpecularLighting’-Element. |
...
| [KernelUnitLengthX](../../aspose.svg.filters/svgfespecularlightingelement/kernelunitlengthx/) { get; } | Entspricht dem Attribut ‘kernelUnitLength’ im angegebenen ‘feSpecularLighting’-Element. |
| [KernelUnitLengthY](../../aspose.svg.filters/svgfespecularlightingelement/kernelunitlengthy/) { get; } | Entspricht dem Attribut ‘kernelUnitLength’ im angegebenen ‘feSpecularLighting’-Element. |
...
| [Result](../../aspose.svg.filters/svgfespecularlightingelement/result/) { get; } | Entspricht dem Attribut ‘result’ im angegebenen ‘filter’-Element. |
...
| [SpecularConstant](../../aspose.svg.filters/svgfespecularlightingelement/specularconstant/) { get; } | Entspricht dem Attribut ‘specularConstant’ im angegebenen ‘feSpecularLighting’-Element. |
| [SpecularExponent](../../aspose.svg.filters/svgfespecularlightingelement/specularexponent/) { get; } | Entspricht dem Attribut ‘specularExponent’ im angegebenen ‘feSpecularLighting’-Element. |
...
| [SurfaceScale](../../aspose.svg.filters/svgfespecularlightingelement/surfacescale/) { get; } | Entspricht dem Attribut ‘surfaceScale’ im angegebenen ‘feSpecularLighting’-Element. |
...
| [Width](../../aspose.svg.filters/svgfespecularlightingelement/width/) { get; } | Entspricht dem Attribut ‘width’ des angegebenen ‘filter’-Elements. |
| [X](../../aspose.svg.filters/svgfespecularlightingelement/x/) { get; } | Entspricht dem Attribut ‘x’ des angegebenen ‘filter’-Elements. |
