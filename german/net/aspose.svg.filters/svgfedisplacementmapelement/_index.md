...
description: "Aspose.Svg.Filters.SVGFEDisplacementMapElement Klasse. Das SVGFEDisplacementMapElement‑Interface entspricht dem feDisplacementMap‑Element"
type: docs
weight: 3800
...
| [Height](../../aspose.svg.filters/svgfedisplacementmapelement/height/) { get; } | Entspricht dem Attribut ‘height’ des angegebenen ‘filter’-Elements. |
...
| [In1](../../aspose.svg.filters/svgfedisplacementmapelement/in1/) { get; } | Entspricht dem Attribut ‘in’ im angegebenen ‘feDisplacementMap’-Element. |
| [In2](../../aspose.svg.filters/svgfedisplacementmapelement/in2/) { get; } | Entspricht dem Attribut ‘in2’ im angegebenen ‘feDisplacementMap’-Element. |
...
| [Result](../../aspose.svg.filters/svgfedisplacementmapelement/result/) { get; } | Entspricht dem Attribut ‘result’ im angegebenen ‘filter’-Element. |
| [Scale](../../aspose.svg.filters/svgfedisplacementmapelement/scale/) { get; } | Entspricht dem Attribut ‘scale’ im angegebenen ‘feDisplacementMap’-Element. |
...
| [Width](../../aspose.svg.filters/svgfedisplacementmapelement/width/) { get; } | Entspricht dem Attribut ‘width’ des angegebenen ‘filter’-Elements. |
| [X](../../aspose.svg.filters/svgfedisplacementmapelement/x/) { get; } | Entspricht dem Attribut ‘x’ des angegebenen ‘filter’-Elements. |
| [XChannelSelector](../../aspose.svg.filters/svgfedisplacementmapelement/xchannelselector/) { get; } | Entspricht dem Attribut ‘xChannelSelector’ im angegebenen ‘feDisplacementMap’-Element. Akzeptiert eine der auf diesem Interface definierten SVG_CHANNEL_*‑Konstanten. |
| [Y](../../aspose.svg.filters/svgfedisplacementmapelement/y/) { get; } | Entspricht dem Attribut ‘y’ des angegebenen ‘filter’-Elements. |
| [YChannelSelector](../../aspose.svg.filters/svgfedisplacementmapelement/ychannelselector/) { get; } | Entspricht dem Attribut ‘yChannelSelector’ im angegebenen ‘feDisplacementMap’-Element. Akzeptiert eine der auf diesem Interface definierten SVG_CHANNEL_*‑Konstanten. |
...
| const [SVG_CHANNEL_B](../../aspose.svg.filters/svgfedisplacementmapelement/svg_channel_b/) | Entspricht dem Wert 'B'. |
| const [SVG_CHANNEL_G](../../aspose.svg.filters/svgfedisplacementmapelement/svg_channel_g/) | Entspricht dem Wert 'G'. |
| const [SVG_CHANNEL_R](../../aspose.svg.filters/svgfedisplacementmapelement/svg_channel_r/) | Entspricht dem Wert 'R'. |
| const [SVG_CHANNEL_UNKNOWN](../../aspose.svg.filters/svgfedisplacementmapelement/svg_channel_unknown/) | Der Typ ist keiner der vordefinierten Typen. Es ist ungültig, zu versuchen, einen neuen Wert dieses Typs zu definieren oder einen bestehenden Wert zu diesem Typ zu wechseln. |
