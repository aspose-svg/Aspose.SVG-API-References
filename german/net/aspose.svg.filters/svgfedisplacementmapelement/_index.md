...
description: Aspose.Svg.Filters.SVGFEDisplacementMapElement klas. Die SVGFEDisplacementMapElementSchnittstelle entspricht dem feDisplacementMapElement.
type: docs
weight: 1710
url: /de/net/aspose.svg.filters/svgfedisplacementmapelement/
---
...
| [Height](../../aspose.svg.filters/svgfedisplacementmapelement/height/) { get; } | Entspricht dem Attribut „Höhe“ des angegebenen „Filter“-Elements. |
...
| [In1](../../aspose.svg.filters/svgfedisplacementmapelement/in1/) { get; } | Entspricht dem Attribut 'in' auf dem gegebenen 'feDisplacementMap'-Element. |
| [In2](../../aspose.svg.filters/svgfedisplacementmapelement/in2/) { get; } | Entspricht dem Attribut 'in2' auf dem gegebenen 'feDisplacementMap'-Element. |
...
| [Result](../../aspose.svg.filters/svgfedisplacementmapelement/result/) { get; } | Entspricht dem Attribut „Ergebnis“ des angegebenen „Filter“-Elements. |
| [Scale](../../aspose.svg.filters/svgfedisplacementmapelement/scale/) { get; } | Entspricht dem Attribut 'scale' auf dem gegebenen 'feDisplacementMap'-Element. |
...
| [Width](../../aspose.svg.filters/svgfedisplacementmapelement/width/) { get; } | Entspricht dem Attribut „Breite“ des angegebenen „Filter“-Elements. |
| [X](../../aspose.svg.filters/svgfedisplacementmapelement/x/) { get; } | Entspricht dem Attribut 'x' im angegebenen 'filter'-Element. |
| [XChannelSelector](../../aspose.svg.filters/svgfedisplacementmapelement/xchannelselector/) { get; } | Entspricht dem Attribut 'xChannelSelector' auf dem angegebenen Element 'feDisplacementMap'. Akzeptiert eine der auf dieser Schnittstelle definierten SVG_CHANNEL_*-Konstanten. |
| [Y](../../aspose.svg.filters/svgfedisplacementmapelement/y/) { get; } | Entspricht dem Attribut 'y' des angegebenen 'filter'-Elements. |
| [YChannelSelector](../../aspose.svg.filters/svgfedisplacementmapelement/ychannelselector/) { get; } | Entspricht dem Attribut 'yChannelSelector' auf dem gegebenen 'feDisplacementMap'-Element. Akzeptiert eine der auf dieser Schnittstelle definierten SVG_CHANNEL_*-Konstanten. |
...
| Name | Beschreibung |
| --- | --- |
| const [SVG_CHANNEL_A](../../aspose.svg.filters/svgfedisplacementmapelement/svg_channel_a/) | Entspricht dem Wert 'A'. |
| const [SVG_CHANNEL_B](../../aspose.svg.filters/svgfedisplacementmapelement/svg_channel_b/) | Entspricht Wert 'B'. |
| const [SVG_CHANNEL_G](../../aspose.svg.filters/svgfedisplacementmapelement/svg_channel_g/) | Entspricht Wert 'G'. |
| const [SVG_CHANNEL_R](../../aspose.svg.filters/svgfedisplacementmapelement/svg_channel_r/) | Entspricht Wert 'R'. |
| const [SVG_CHANNEL_UNKNOWN](../../aspose.svg.filters/svgfedisplacementmapelement/svg_channel_unknown/) | Der Typ ist keiner der vordefinierten Typen. Es ist ungültig, einen neuen Wert dieses Typs zu definieren oder einen vorhandenen Wert auf diesen Typ umzustellen. |
