...
description: "Aspose.Svg.Filters.SVGFEDiffuseLightingElement Klasse. Das SVGFEDiffuseLightingElement-Interface entspricht dem feDiffuseLighting-Element."
type: docs
weight: 3790
...
| [DiffuseConstant](../../aspose.svg.filters/svgfediffuselightingelement/diffuseconstant/) { get; } | Entspricht dem Attribut ‘diffuseConstant’ im angegebenen ‘feDiffuseLighting’-Element. |
...
| [Height](../../aspose.svg.filters/svgfediffuselightingelement/height/) { get; } | Entspricht dem Attribut ‘height’ des angegebenen ‘filter’-Elements. |
...
| [In1](../../aspose.svg.filters/svgfediffuselightingelement/in1/) { get; } | Entspricht dem Attribut ‘in’ im angegebenen ‘feDiffuseLighting’-Element. |
...
| [KernelUnitLengthX](../../aspose.svg.filters/svgfediffuselightingelement/kernelunitlengthx/) { get; } | Entspricht dem Attribut ‘kernelUnitLength’ im angegebenen ‘feDiffuseLighting’-Element. |
| [KernelUnitLengthY](../../aspose.svg.filters/svgfediffuselightingelement/kernelunitlengthy/) { get; } | Entspricht dem Attribut ‘kernelUnitLength’ im angegebenen ‘feDiffuseLighting’-Element. |
...
| [Result](../../aspose.svg.filters/svgfediffuselightingelement/result/) { get; } | Entspricht dem Attribut ‘result’ im angegebenen ‘filter’-Element. |
...
| [SurfaceScale](../../aspose.svg.filters/svgfediffuselightingelement/surfacescale/) { get; } | Entspricht dem Attribut ‘surfaceScale’ im angegebenen ‘feDiffuseLighting’-Element. |
...
| [Width](../../aspose.svg.filters/svgfediffuselightingelement/width/) { get; } | Entspricht dem Attribut ‘width’ des angegebenen ‘filter’-Elements. |
| [X](../../aspose.svg.filters/svgfediffuselightingelement/x/) { get; } | Entspricht dem Attribut ‘x’ des angegebenen ‘filter’-Elements. |
