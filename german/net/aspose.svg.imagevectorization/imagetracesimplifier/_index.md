...
description: Die ImageTraceSimplifierKlasse ist dafür verantwortlich die Anzahl der Punkte in einer Kurve zu reduzieren die durch eine Reihe von Verfolgungspunkten angenähert wird.
type: docs
weight: 2110
...
| Name | Beschreibung |
| --- | --- |
| [ImageTraceSimplifier](imagetracesimplifier#constructor)() | Initialisiert eine neue Instanz von[`ImageTraceSimplifier`](../imagetracesimplifier) Klasse. |
| [ImageTraceSimplifier](imagetracesimplifier#constructor_1)(float) | Initialisiert eine neue Instanz von[`ImageTraceSimplifier`](../imagetracesimplifier) Klasse. |
