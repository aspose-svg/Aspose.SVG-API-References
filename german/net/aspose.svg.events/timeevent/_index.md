...
description: Aspose.Svg.Events.TimeEvent klas. Die TimeEventSchnittstelle stellt spezifische Kontextinformationen bereit die Zeitereignissen zugeordnet sind. Die verschiedenen Arten von Ereignissen die auftreten können sind beginEvent endEvent und repeatEvent.
type: docs
weight: 1630
...
| [CurrentTarget](../../aspose.svg.dom.events/event/currenttarget/) { get; } | Wird verwendet, um die anzuzeigen[`IEventTarget`](../../aspose.svg.dom.events/ieventtarget/) wessen[`IEventListener`](../../aspose.svg.dom.events/ieventlistener/) s werden gerade verarbeitet. Dies ist besonders nützlich beim Erfassen und Bubbling. |
