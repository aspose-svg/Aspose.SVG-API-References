...
description: "SVGBuilderExtensions AddFeTile-Methode. Fügt dem Builder eine feTile-Elementkonfiguration hinzu. Dieses Element füllt ein Rechteck mit dem wiederholten Kachelmuster eines Eingabebildes."
type: docs
weight: 280
url: /de/net/aspose.svg.builder/svgbuilderextensions/addfetile/
---
## AddFeTile<TBuilder>(*this TBuilder, Action&lt;SVGFETileElementBuilder&gt;*) {#addfetile_1}

Fügt dem Builder eine 'feTile'-Elementkonfiguration hinzu. Dieses Element füllt ein Rechteck mit dem wiederholten, gekachelten Muster eines Eingabebildes.
...
| konfigurieren | Die Konfigurationsaktion für das 'feTile'-Element. |
...
Fügt dem SVG-Builder ein 'feTile'-Element hinzu, das ein Kachelmuster erzeugt, indem das Eingabebild repliziert wird.
...
| builder | Die SVG-Builder‑Instanz, zu der das 'feTile'-Element hinzugefügt wird. |
| in | Das Eingabebild, das in Kacheln repliziert werden soll. Kann ein String oder ein FilterInput sein. Optionaler Parameter. |
...
| extend | Eine optionale Aktion, um den SVGFETileElementBuilder weiter zu konfigurieren. |
