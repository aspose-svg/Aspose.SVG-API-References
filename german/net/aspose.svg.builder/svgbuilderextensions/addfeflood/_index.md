...
description: "SVGBuilderExtensions AddFeFlood-Methode. Fügt dem Builder eine feFlood-Elementkonfiguration hinzu. Dieses Element füllt den Filterunterbereich mit einer angegebenen Farbe."
type: docs
weight: 210
url: /de/net/aspose.svg.builder/svgbuilderextensions/addfeflood/
---
## AddFeFlood<TBuilder>(*this TBuilder, Action&lt;SVGFEFloodElementBuilder&gt;*) {#addfeflood}

Fügt dem Builder eine 'feFlood'-Elementkonfiguration hinzu. Dieses Element füllt den Filterunterbereich mit einer angegebenen Farbe.
...
| konfigurieren | Die Konfigurationsaktion für das 'feFlood'-Element. |
...
Fügt dem SVG-Builder ein 'feFlood'-Element hinzu, das einen einheitlichen Flutfarbeneffekt über den gesamten Filterunterbereich erzeugt.
...
| builder | Die SVG-Builder-Instanz, zu der das 'feFlood'-Element hinzugefügt wird. |
| floodColor | Die für den Flood-Effekt verwendete Farbe. Optionaler Parameter. |
| floodOpacity | Der Transparenzgrad der Flood-Farbe. Optionaler Parameter. |
...
| extend | Eine optionale Aktion, um den SVGFEFloodElementBuilder weiter zu konfigurieren. |
