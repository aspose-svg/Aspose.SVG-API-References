...
description: "SVGBuilderExtensions AddFeComposite-Methode. Fügt dem Builder eine feComposite-Elementkonfiguration hinzu. Dieses Element führt eine bitweise Kombination von zwei Eingabegrafiken aus."
type: docs
weight: 160
url: /de/net/aspose.svg.builder/svgbuilderextensions/addfecomposite/
---
## AddFeComposite<TBuilder>(*this TBuilder, Action&lt;SVGFECompositeElementBuilder&gt;*) {#addfecomposite}

Fügt dem Builder eine 'feComposite'-Elementkonfiguration hinzu. Dieses Element führt eine bitweise Kombination von zwei Eingabegrafiken durch.
...
| konfigurieren | Die Konfigurationsaktion für das 'feComposite'-Element. |
...
Fügt dem SVG-Builder ein 'feComposite'-Element hinzu und gibt die Composite-Operation sowie verschiedene weitere Eigenschaften zum Kombinieren von Eingabebildern an.
...
| builder | Die SVG-Builder-Instanz, zu der das 'feComposite'-Element hinzugefügt wird. |
| compositeOperator | Der zu verwendende Composite-Operator. Optionaler Parameter. |
| k1 | Der erste numerische Wert für die Composite-Operation. Optionaler Parameter. |
| k2 | Der zweite numerische Wert für die Composite-Operation. Optionaler Parameter. |
| k3 | Der dritte numerische Wert für die Composite-Operation. Optionaler Parameter. |
| k4 | Der vierte numerische Wert für die Composite-Operation. Optionaler Parameter. |
| in | Der erste Eingabeparameter für den Composite-Effekt. Kann ein String oder ein FilterInput sein. Optionaler Parameter. |
| in2 | Der zweite Eingabeparameter für den Composite-Effekt. Kann ein String oder ein FilterInput sein. Optionaler Parameter. |
...
| extend | Eine optionale Aktion, um den SVGFECompositeElementBuilder weiter zu konfigurieren. |
