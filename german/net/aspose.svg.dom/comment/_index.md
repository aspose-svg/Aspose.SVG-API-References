---
title: "Kommentar-Klasse"
second_title: "Aspose.SVG für .NET API-Referenz"
description: "Aspose.Svg.Dom.Comment-Klasse. Erbt von CharacterData und stellt den Inhalt eines Kommentars dar, d. h. alle Zeichen zwischen dem Anfang"
type: docs
weight: 2460
url: /de/net/aspose.svg.dom/comment/
---
## Comment class

Erbt von CharacterData und stellt den Inhalt eines Kommentars dar, d. h. alle Zeichen zwischen dem startenden ''.
...
| override [NodeName](../../aspose.svg.dom/comment/nodename/) { get; } | Der Name dieses Knotens, abhängig von seinem Typ. |
| override [NodeType](../../aspose.svg.dom/comment/nodetype/) { get; } | Ein Code, der den Typ des zugrunde liegenden Objekts darstellt. |
| override [NodeValue](../../aspose.svg.dom/comment/nodevalue/) { get; set; } | Der Wert dieses Knotens, abhängig von seinem Typ. |
...
| override [TextContent](../../aspose.svg.dom/comment/textcontent/) { get; set; } | Dieses Attribut gibt den Textinhalt dieses Knotens und seiner Nachkommen zurück. Wenn es als null definiert ist, hat das Setzen keine Auswirkung. Beim Setzen werden alle möglichen Kindknoten dieses Knotens entfernt und, wenn die neue Zeichenkette nicht leer oder null ist, durch einen einzelnen Textknoten ersetzt, der die Zeichenkette enthält, auf die dieses Attribut gesetzt wird. |
