...
description: "Aspose.Svg.Dom.Entity-Klasse. Stellt eine bekannte Entität dar, die in einem XML-Dokument geparst oder ungeparst ist."
type: docs
weight: 2850
url: /de/net/aspose.svg.dom/entity/
---
## Entity class

Stellt eine bekannte Entität, entweder geparst oder ungeparst, in einem XML-Dokument dar.
...
| [InputEncoding](../../aspose.svg.dom/entity/inputencoding/) { get; } | Ein Attribut, das die beim Parsen verwendete Kodierung für diese Entität angibt, wenn es sich um eine externe geparste Entität handelt. Dieser Wert ist null, wenn es sich um eine Entität aus dem internen Subset handelt oder wenn sie nicht bekannt ist. |
...
| override [NodeName](../../aspose.svg.dom/entity/nodename/) { get; } | Der Name dieses Knotens, abhängig von seinem Typ. |
| override [NodeType](../../aspose.svg.dom/entity/nodetype/) { get; } | Ein Code, der den Typ des zugrunde liegenden Objekts darstellt. |
| virtual [NodeValue](../../aspose.svg.dom/node/nodevalue/) { get; set; } | Gibt den Wert des aktuellen Knotens zurück oder setzt ihn. |
| [NotationName](../../aspose.svg.dom/entity/notationname/) { get; } | Für ungeparste Entitäten der Name der Notation für die Entität. Für geparste Entitäten ist dieser Wert null. |
...
| [PublicId](../../aspose.svg.dom/entity/publicid/) { get; } | Der öffentliche Bezeichner, der mit der Entität verknüpft ist, falls angegeben, andernfalls null. |
| [SystemId](../../aspose.svg.dom/entity/systemid/) { get; } | Der Systembezeichner, der mit der Entität verknüpft ist, falls angegeben, andernfalls null. Dies kann ein absoluter URI sein oder nicht. |
| virtual [TextContent](../../aspose.svg.dom/node/textcontent/) { get; set; } | Stellt den Textinhalt des Knotens und seiner Nachkommen dar. |
| [XmlEncoding](../../aspose.svg.dom/entity/xmlencoding/) { get; } | Ein Attribut, das als Teil der Textdeklaration die Kodierung dieser Entität angibt, wenn es sich um eine externe geparste Entität handelt. Andernfalls ist es null. |
| [XmlVersion](../../aspose.svg.dom/entity/xmlversion/) { get; } | Ein Attribut, das als Teil der Textdeklaration die Versionsnummer dieser Entität angibt, wenn es sich um eine externe geparste Entität handelt. Andernfalls ist es null. |
