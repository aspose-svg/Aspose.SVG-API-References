...
description: Aspose.Svg.Dom.Entity klas. Repräsentiert eine bekannte Entität entweder geparst oder nicht geparst in einem XMLDokument.
type: docs
weight: 850
...
| [InputEncoding](../../aspose.svg.dom/entity/inputencoding/) { get; } | Ein Attribut, das die Codierung angibt, die für diese Entität zum Zeitpunkt der Analyse verwendet wurde, wenn es sich um eine externe analysierte Entität handelt. Dies ist null, wenn es sich um eine Entität aus der internen Teilmenge handelt oder wenn sie nicht bekannt ist. |
...
| [NotationName](../../aspose.svg.dom/entity/notationname/) { get; } | Für nicht geparste Entitäten der Name der Notation für die Entität. Für geparste Entitäten ist dies null. |
...
| [PublicId](../../aspose.svg.dom/entity/publicid/) { get; } | Der öffentliche Bezeichner, der der Entität zugeordnet ist, falls angegeben, andernfalls null. |
| [SystemId](../../aspose.svg.dom/entity/systemid/) { get; } | Die der Entität zugeordnete Systemkennung, falls angegeben, andernfalls null. Dies kann ein absoluter URI sein oder nicht. |
...
| [XmlEncoding](../../aspose.svg.dom/entity/xmlencoding/) { get; } | Ein Attribut, das als Teil der Textdeklaration die Codierung dieser Entität angibt, wenn es sich um eine externe geparste Entität handelt. Andernfalls ist dies null. |
| [XmlVersion](../../aspose.svg.dom/entity/xmlversion/) { get; } | Ein Attribut, das als Teil der Textdeklaration die Versionsnummer dieser Entität angibt, wenn es sich um eine externe geparste Entität handelt. Andernfalls ist dies null. |
