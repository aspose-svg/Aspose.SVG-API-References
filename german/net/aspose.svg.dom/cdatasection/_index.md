...
description: "Aspose.Svg.Dom.CDATASection Klasse. CDATA-Abschnitte werden verwendet, um Textblöcke zu maskieren, die Zeichen enthalten, die sonst als Markup betrachtet würden."
type: docs
weight: 2440
url: /de/net/aspose.svg.dom/cdatasection/
---
## CDATASection class

CDATA-Abschnitte werden verwendet, um Textblöcke zu maskieren, die Zeichen enthalten, die sonst als Markup betrachtet würden.
...
| override [NodeName](../../aspose.svg.dom/cdatasection/nodename/) { get; } | Der Name dieses Knotens, abhängig von seinem Typ. |
| override [NodeType](../../aspose.svg.dom/cdatasection/nodetype/) { get; } | Ein Code, der den Typ des zugrunde liegenden Objekts darstellt. |
