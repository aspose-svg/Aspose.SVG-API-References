...
description: Aspose.Svg.Dom.Element klas. Die ElementSchnittstelle repräsentiert ein Element in einem HTML oder XMLDokument.
type: docs
weight: 840
url: /de/net/aspose.svg.dom/element/
---
## Element class
...
| [Id](../../aspose.svg.dom/element/id/) { get; set; } | Der Bezeichner des Elements. Siehe die ID-Attributdefinition in HTML 4.01. |
...
| [ParentElement](../../aspose.svg.dom/node/parentelement/) { get; } | Ruft das übergeordnete Element ab`Element` dieses Knotens. |
