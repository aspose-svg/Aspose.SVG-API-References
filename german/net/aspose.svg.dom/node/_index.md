...
description: "Aspose.Svg.Dom.Node Klasse. Das Node-Interface ist der primäre Datentyp für das gesamte Document Object Model. Es stellt einen einzelnen Knoten im Dokumentbaum dar."
type: docs
weight: 3140
...
Das Node-Interface ist der primäre Datentyp für das gesamte Document Object Model. Es repräsentiert einen einzelnen Knoten im Dokumentbaum.
...
| [NextSibling](../../aspose.svg.dom/node/nextsibling/) { get; } | Gibt den Knoten zurück, der dem angegebenen Knoten im [`ChildNodes`](./childnodes/)-Array des Elternteils unmittelbar folgt, oder null, wenn der angegebene Knoten das letzte Kind im Elternelement ist. |
| abstract [NodeName](../../aspose.svg.dom/node/nodename/) { get; } | Gibt den Namen des aktuellen Knotens als Zeichenkette zurück. |
...
| [PreviousSibling](../../aspose.svg.dom/node/previoussibling/) { get; } | Gibt den Knoten zurück, der dem angegebenen Knoten in der [`ChildNodes`](./childnodes/)-Liste des Elternteils unmittelbar vorausgeht, oder null, wenn der angegebene Knoten das erste Element in dieser Liste ist. |
...
| [AppendChild](../../aspose.svg.dom/node/appendchild/)(*Node*) | Fügt einem angegebenen Elternelement einen Knoten am Ende seiner Kindliste hinzu. Wenn das übergebene Kind eine Referenz auf einen bereits im Dokument vorhandenen Knoten ist, verschiebt [`AppendChild`](./appendchild/) ihn von seiner aktuellen Position in die neue Position (es ist nicht erforderlich, den Knoten vor dem Anhängen an ein anderes Element aus seinem Elternelement zu entfernen). |
| [CloneNode](../../aspose.svg.dom/node/clonenode/#clonenode)() | Gibt ein Duplikat des Knotens zurück, auf dem diese Methode aufgerufen wurde. |
| [CloneNode](../../aspose.svg.dom/node/clonenode/#clonenode_1)(*bool*) | Gibt ein Duplikat des Knotens zurück, auf dem diese Methode aufgerufen wurde. Sein Parameter steuert, ob der im Knoten enthaltene Teilbaum ebenfalls geklont wird oder nicht. |
...
| [HasChildNodes](../../aspose.svg.dom/node/haschildnodes/)() | Gibt einen booleschen Wert zurück, der angibt, ob der angegebene `Node` Kindknoten hat oder nicht. |
| [InsertBefore](../../aspose.svg.dom/node/insertbefore/)(*Node, Node*) | Fügt den Knoten vor dem vorhandenen Kindknoten child ein. Wenn child null ist, wird der Knoten am Ende der Kindliste eingefügt. Wenn child ein DocumentFragment-Objekt ist, werden all seine Kinder in derselben Reihenfolge vor child eingefügt. Wenn das Kind bereits im Baum ist, wird es zuerst entfernt. |
...
| [IsEqualNode](../../aspose.svg.dom/node/isequalnode/)(*Node*) | Testet, ob zwei Knoten gleich sind. Diese Methode prüft die Gleichheit von Knoten, nicht die Identität (d. h., ob die beiden Knoten Referenzen auf dasselbe Objekt sind), was mit Node.isSameNode() getestet werden kann. Alle Knoten, die identisch sind, sind auch gleich, obwohl das Gegenteil nicht unbedingt zutrifft. |
| [IsSameNode](../../aspose.svg.dom/node/issamenode/)(*Node*) | Die Methode ist ein veralteter Alias für den strikten Gleichheitsoperator ===. Das heißt, sie prüft, ob zwei Knoten identisch sind (mit anderen Worten, ob sie auf dasselbe Objekt verweisen). |
...
| [RemoveChild](../../aspose.svg.dom/node/removechild/)(*Node*) | Entfernt einen Kindknoten aus dem DOM und gibt den entfernten Knoten zurück. |
...
| const [CDATA_SECTION_NODE](../../aspose.svg.dom/node/cdata_section_node/) | Ein CDATA‑Abschnittsknoten |
| const [COMMENT_NODE](../../aspose.svg.dom/node/comment_node/) | Ein Kommentar‑Knoten |
| const [DOCUMENT_FRAGMENT_NODE](../../aspose.svg.dom/node/document_fragment_node/) | Ein Dokumentfragment‑Knoten |
| const [DOCUMENT_NODE](../../aspose.svg.dom/node/document_node/) | Ein Dokument‑Knoten |
| const [DOCUMENT_TYPE_NODE](../../aspose.svg.dom/node/document_type_node/) | Ein Dokumenttyp‑Knoten |
| const [ELEMENT_NODE](../../aspose.svg.dom/node/element_node/) | Ein Element‑Knoten |
| const [ENTITY_NODE](../../aspose.svg.dom/node/entity_node/) | Ein Entity‑Knoten |
| const [ENTITY_REFERENCE_NODE](../../aspose.svg.dom/node/entity_reference_node/) | Ein Entity‑Referenz‑Knoten |
| const [NOTATION_NODE](../../aspose.svg.dom/node/notation_node/) | Ein Notations‑Knoten |
| const [PROCESSING_INSTRUCTION_NODE](../../aspose.svg.dom/node/processing_instruction_node/) | Ein Verarbeitungs‑Instruktions‑Knoten |
| const [TEXT_NODE](../../aspose.svg.dom/node/text_node/) | Ein Text‑Knoten |
