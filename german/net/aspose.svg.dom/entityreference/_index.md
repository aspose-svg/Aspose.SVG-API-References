...
description: "Aspose.Svg.Dom.EntityReference‑Klasse. EntityReference‑Knoten können verwendet werden, um eine Entity‑Referenz im Baum darzustellen."
type: docs
weight: 2860
url: /de/net/aspose.svg.dom/entityreference/
---
...
| override [NodeName](../../aspose.svg.dom/entityreference/nodename/) { get; } | Der Name dieses Knotens, abhängig von seinem Typ. |
| override [NodeType](../../aspose.svg.dom/entityreference/nodetype/) { get; } | Ein Code, der den Typ des zugrunde liegenden Objekts darstellt. |
