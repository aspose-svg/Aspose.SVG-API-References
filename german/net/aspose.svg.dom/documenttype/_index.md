...
description: "Aspose.Svg.Dom.DocumentType-Klasse. Die DocumentType stellt eine Schnittstelle zur Liste der im Dokument definierten Entitäten bereit"
type: docs
weight: 2830
...
Der DocumentType stellt ein Interface zur Liste der für das Dokument definierten Entitäten bereit.
...
| Name | Beschreibung |
| --- | --- |
| [DocumentType](documenttype/)(*string, string, string, string, [Document](../document/)*) | Initialisiert eine neue Instanz der `DocumentType`-Klasse. |
...
| [InternalSubset](../../aspose.svg.dom/documenttype/internalsubset/) { get; } | Das interne Subset als Zeichenkette, oder null, falls keines vorhanden ist. |
...
| [Name](../../aspose.svg.dom/documenttype/name/) { get; } | Der Name des DTD; d. h. der Name, der unmittelbar nach dem Schlüsselwort DOCTYPE folgt. |
...
| [PublicId](../../aspose.svg.dom/documenttype/publicid/) { get; } | Der öffentliche Bezeichner des externen Subsets. |
| [SystemId](../../aspose.svg.dom/documenttype/systemid/) { get; } | Der Systembezeichner des externen Subsets. Dies kann ein absoluter URI sein oder nicht. |
...
| override [ToString](../../aspose.svg.dom/documenttype/tostring/)() | Gibt einen String zurück, der diese Instanz darstellt. |
