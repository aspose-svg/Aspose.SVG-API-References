...
description: "Aspose.Svg.Dom.Events.FocusEvent‑Klasse. Die FocusEvent‑Schnittstelle liefert spezifische Kontextinformationen, die mit Fokus‑Ereignissen verbunden sind."
type: docs
weight: 2930
url: /de/net/aspose.svg.dom.events/focusevent/
---
## FocusEvent class
...
| [FocusEvent](focusevent/#constructor_1)(*string, IDictionary&lt;string, object&gt;*) | Initialisiert eine neue Instanz der `FocusEvent`‑Klasse. |
...
| [RelatedTarget](../../aspose.svg.dom.events/focusevent/relatedtarget/) { get; } | Wird verwendet, um ein sekundäres EventTarget zu identifizieren, das mit einem Fokus‑Ereignis in Zusammenhang steht, abhängig vom Ereignistyp. |
