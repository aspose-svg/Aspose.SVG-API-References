...
description: "Méthode AddFeFlood de SVGBuilderExtensions. Ajoute une configuration d'élément feFlood au constructeur. Cet élément remplit la sous-région du filtre avec une couleur spécifiée."
type: docs
weight: 210
url: /fr/net/aspose.svg.builder/svgbuilderextensions/addfeflood/
---
## AddFeFlood<TBuilder>(*this TBuilder, Action&lt;SVGFEFloodElementBuilder&gt;*) {#addfeflood}

Ajoute une configuration d'élément 'feFlood' au constructeur. Cet élément remplit la sous-région du filtre avec une couleur spécifiée.
...
| configurer | L'action de configuration pour l'élément 'feFlood'. |
...
Ajoute un élément 'feFlood' au constructeur SVG, créant un effet de couleur de débordement uniforme sur l'ensemble de la sous-région du filtre.
...
| constructeur | L'instance du constructeur SVG à laquelle l'élément 'feFlood' sera ajouté. |
| floodColor | La couleur utilisée pour l'effet de remplissage. Paramètre optionnel. |
| floodOpacity | Le niveau d'opacité de la couleur de remplissage. Paramètre optionnel. |
...
| étendre | Une action optionnelle pour configurer davantage le SVGFEFloodElementBuilder. |
