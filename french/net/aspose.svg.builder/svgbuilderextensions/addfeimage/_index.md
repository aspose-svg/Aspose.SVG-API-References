...
description: "Méthode AddFeImage de SVGBuilderExtensions. Ajoute une configuration d'élément feImage au constructeur. Cet élément récupère une image externe et l'inclut dans le pipeline de filtre"
type: docs
weight: 230
url: /fr/net/aspose.svg.builder/svgbuilderextensions/addfeimage/
---
## AddFeImage<TBuilder>(*this TBuilder, Action&lt;SVGFEImageElementBuilder&gt;*) {#addfeimage}

Ajoute une configuration d'élément 'feImage' au constructeur. Cet élément récupère une image externe et l'inclut dans le pipeline du filtre.
...
| configurer | L'action de configuration pour l'élément 'feImage'. |
...
Ajoute un élément 'feImage' au constructeur SVG, incorporant une image externe dans l'effet du filtre.
...
| constructeur | L'instance du constructeur SVG à laquelle l'élément 'feImage' sera ajouté. |
...
| étendre | Une action optionnelle pour configurer davantage le SVGFEImageElementBuilder. |
