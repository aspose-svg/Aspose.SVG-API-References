...
| [CurrentTarget](../../aspose.svg.dom.events/event/currenttarget) { get; } | Utilisé pour indiquer le[`IEventTarget`](../../aspose.svg.dom.events/ieventtarget) à qui[`IEventListener`](../../aspose.svg.dom.events/ieventlistener) s sont en cours de traitement. Ceci est particulièrement utile lors de la capture et du bouillonnement. |
