...
description: Renvoie une nouvelle couleur avec les valeurs cyan magenta jaune clé noir et alpha demandées.
type: docs
weight: 30
url: /fr/net/aspose.svg.drawing/color/fromcmyka/
---
## Color.FromCmyka method

Renvoie une nouvelle couleur avec les valeurs cyan, magenta, jaune, clé (noir) et alpha demandées.
