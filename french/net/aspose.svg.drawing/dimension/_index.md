...
description: Aspose.Svg.Drawing.Dimension classe. Fournit la classe de base pour les dimensions. Le terme général dimension fait référence à un nombre avec une unité qui lui est attachée et sont désignés parUnitType .
type: docs
weight: 1410
