...
description: Aspose.Svg.Dom.Attr classe. Linterface Attr représente un attribut dans un objet Element. Généralement les valeurs autorisées pour lattribut sont définies dans un schéma associé au document.
type: docs
weight: 350
