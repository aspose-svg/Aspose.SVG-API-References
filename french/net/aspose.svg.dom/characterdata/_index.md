...
description: Aspose.Svg.Dom.CharacterData classe. Le CharacterData étend Node avec un ensemble dattributs et de méthodes pour accéder aux données de caractères dans le DOM.
type: docs
weight: 450
url: /fr/net/aspose.svg.dom/characterdata/
---
## CharacterData class
