...
description: Aspose.Svg.Dom.Notation classe. Représente une notation déclarée dans la DTD.
type: docs
weight: 1160
url: /fr/net/aspose.svg.dom/notation/
---
## Notation class
...
| override [NodeName](../../aspose.svg.dom/notation/nodename/) { get; } | Le nom de ce nœud, en fonction de son type. |
| override [NodeType](../../aspose.svg.dom/notation/nodetype/) { get; } | Un code représentant le type de l'objet sous-jacent. |
...
| [PublicId](../../aspose.svg.dom/notation/publicid/) { get; } | L'identifiant public de cette notation. Si l'identifiant public n'a pas été spécifié, c'est null. |
| [SystemId](../../aspose.svg.dom/notation/systemid/) { get; } | L'identifiant système de cette notation. Si l'identifiant système n'a pas été spécifié, c'est nul. Cela peut être un URI absolu ou non. |
