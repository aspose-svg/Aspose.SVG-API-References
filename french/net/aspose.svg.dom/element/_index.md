...
description: Aspose.Svg.Dom.Element classe. Linterface Element représente un élément dans un document HTML ou XML.
type: docs
weight: 840
url: /fr/net/aspose.svg.dom/element/
---
## Element class
...
| [Id](../../aspose.svg.dom/element/id/) { get; set; } | L'identifiant de l'élément. Voir la définition de l'attribut id dans HTML 4.01. |
...
| [ParentElement](../../aspose.svg.dom/node/parentelement/) { get; } | Obtient le parent`Element` de ce nœud. |
