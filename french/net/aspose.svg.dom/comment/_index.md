...
description: Aspose.Svg.Dom.Comment classe. Hérite de CharacterData et représente le contenu dun commentaire cestàdire tous les caractères entre le  de début .
type: docs
weight: 460
url: /fr/net/aspose.svg.dom/comment/
---
## Comment class
...
| override [NodeName](../../aspose.svg.dom/comment/nodename/) { get; } | Le nom de ce nœud, en fonction de son type. |
| override [NodeType](../../aspose.svg.dom/comment/nodetype/) { get; } | Un code représentant le type de l'objet sous-jacent. |
| override [NodeValue](../../aspose.svg.dom/comment/nodevalue/) { get; set; } | La valeur de ce nœud, en fonction de son type. |
