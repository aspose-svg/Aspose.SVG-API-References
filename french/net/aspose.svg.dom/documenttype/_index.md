...
description: Aspose.Svg.Dom.DocumentType classe. Le DocumentType fournit une interface à la liste des entités qui sont définies pour le document
type: docs
weight: 830
url: /fr/net/aspose.svg.dom/documenttype/
---
## DocumentType class
...
| [InternalSubset](../../aspose.svg.dom/documenttype/internalsubset/) { get; } | Le sous-ensemble interne sous forme de chaîne, ou null s'il n'y en a pas. |
...
| [Name](../../aspose.svg.dom/documenttype/name/) { get; } | Le nom de la DTD ; c'est-à-dire, le nom suivant immédiatement le mot-clé DOCTYPE. |
...
| override [NodeName](../../aspose.svg.dom/documenttype/nodename/) { get; } | Le nom de ce nœud, en fonction de son type. |
| override [NodeType](../../aspose.svg.dom/documenttype/nodetype/) { get; } | Un code représentant le type de l'objet sous-jacent. |
...
| [PublicId](../../aspose.svg.dom/documenttype/publicid/) { get; } | L'identifiant public du sous-ensemble externe. |
| [SystemId](../../aspose.svg.dom/documenttype/systemid/) { get; } | L'identifiant système du sous-ensemble externe. Cela peut être un URI absolu ou non. |
...
| override [ToString](../../aspose.svg.dom/documenttype/tostring/)() | Renvoie unString qui représente cette instance. |
