...
description: Aspose.Svg.Dom.Entity classe. Représente une entité connue analysée ou non dans un document XML.
type: docs
weight: 850
url: /fr/net/aspose.svg.dom/entity/
---
## Entity class
...
| [InputEncoding](../../aspose.svg.dom/entity/inputencoding/) { get; } | Un attribut spécifiant l'encodage utilisé pour cette entité au moment de l'analyse, lorsqu'il s'agit d'une entité externe analysée. Ceci est nul s'il s'agit d'une entité du sous-ensemble interne ou s'il n'est pas connu. |
...
| override [NodeName](../../aspose.svg.dom/entity/nodename/) { get; } | Le nom de ce nœud, en fonction de son type. |
| override [NodeType](../../aspose.svg.dom/entity/nodetype/) { get; } | Un code représentant le type de l'objet sous-jacent. |
| virtual [NodeValue](../../aspose.svg.dom/node/nodevalue/) { get; set; } | La valeur de ce nœud, en fonction de son type. |
| [NotationName](../../aspose.svg.dom/entity/notationname/) { get; } | Pour les entités non analysées, le nom de la notation de l'entité. Pour les entités analysées, c'est null. |
...
| [PublicId](../../aspose.svg.dom/entity/publicid/) { get; } | L'identifiant public associé à l'entité si spécifié, et null sinon. |
| [SystemId](../../aspose.svg.dom/entity/systemid/) { get; } | L'identifiant système associé à l'entité si spécifié, et null sinon. Cela peut être un URI absolu ou non. |
...
| [XmlEncoding](../../aspose.svg.dom/entity/xmlencoding/) { get; } | Un attribut spécifiant, dans le cadre de la déclaration de texte, l'encodage de cette entité, lorsqu'il s'agit d'une entité analysée externe. Ceci est nul sinon. |
| [XmlVersion](../../aspose.svg.dom/entity/xmlversion/) { get; } | Un attribut spécifiant, dans le cadre de la déclaration de texte, le numéro de version de cette entité, lorsqu'il s'agit d'une entité analysée externe. Ceci est nul sinon. |
