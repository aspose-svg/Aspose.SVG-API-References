...
description: Aspose.Svg.Dom.Node classe. Linterface Node est le type de données principal pour lensemble du modèle dobjet Document. Il représente un nœud unique dans larborescence du document.
type: docs
weight: 1150
url: /fr/net/aspose.svg.dom/node/
---
## Node class
...
| abstract [NodeName](../../aspose.svg.dom/node/nodename/) { get; } | Le nom de ce nœud, en fonction de son type. |
| abstract [NodeType](../../aspose.svg.dom/node/nodetype/) { get; } | Un code représentant le type de l'objet sous-jacent. |
...
| [CloneNode](../../aspose.svg.dom/node/clonenode/#clonenode)() | Renvoie un doublon de ce nœud, c'est-à-dire qu'il sert de constructeur de copie générique pour les nœuds. Le nœud dupliqué n'a pas de parent (parentNode est nul) et pas de données utilisateur. |
| [CloneNode](../../aspose.svg.dom/node/clonenode/#clonenode_1)(bool) | Renvoie un doublon de ce nœud, c'est-à-dire qu'il sert de constructeur de copie générique pour les nœuds. Le nœud dupliqué n'a pas de parent (parentNode est nul) et pas de données utilisateur. |
...
| Nom | La description |
| --- | --- |
| const [ATTRIBUTE_NODE](../../aspose.svg.dom/node/attribute_node/) | Un nœud d'attribut |
| const [CDATA_SECTION_NODE](../../aspose.svg.dom/node/cdata_section_node/) | Un nœud de section de données |
| const [COMMENT_NODE](../../aspose.svg.dom/node/comment_node/) | Un nœud de commentaire |
| const [DOCUMENT_FRAGMENT_NODE](../../aspose.svg.dom/node/document_fragment_node/) | Un nœud de fragment de document |
| const [DOCUMENT_NODE](../../aspose.svg.dom/node/document_node/) | Un nœud de document |
| const [DOCUMENT_TYPE_NODE](../../aspose.svg.dom/node/document_type_node/) | Un type de document node |
| const [ELEMENT_NODE](../../aspose.svg.dom/node/element_node/) | Un nœud d'élément |
| const [ENTITY_NODE](../../aspose.svg.dom/node/entity_node/) | Un nœud d'entité |
| const [ENTITY_REFERENCE_NODE](../../aspose.svg.dom/node/entity_reference_node/) | Un nœud de référence d'entité |
| const [NOTATION_NODE](../../aspose.svg.dom/node/notation_node/) | Un nœud de notation |
| const [PROCESSING_INSTRUCTION_NODE](../../aspose.svg.dom/node/processing_instruction_node/) | Un noeud d'instruction de traitement |
| const [TEXT_NODE](../../aspose.svg.dom/node/text_node/) | Un nœud de texte |
