...
Si un[`IEventListener`](../../../aspose.svg.dom.events/ieventlistener) est ajouté à un[`EventTarget`](../../eventtarget) pendant qu'il traite un événement, il ne sera pas déclenché par les actions en cours, mais peut être déclenché lors d'une étape ultérieure du flux d'événements, comme la phase de bouillonnement.
