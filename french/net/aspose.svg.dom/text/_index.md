...
description: Aspose.Svg.Dom.Text classe. Linterface Text hérite de CharacterData et représente le contenu textuel appelé données de caractères en XML dun Element ou Attr.
type: docs
weight: 1200
url: /fr/net/aspose.svg.dom/text/
---
## Text class
...
| override [NodeName](../../aspose.svg.dom/text/nodename/) { get; } | Le nom de ce nœud, en fonction de son type. |
| override [NodeType](../../aspose.svg.dom/text/nodetype/) { get; } | Un code représentant le type de l'objet sous-jacent. |
