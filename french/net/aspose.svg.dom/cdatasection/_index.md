...
description: Aspose.Svg.Dom.CDATASection classe. Les sections CDATA sont utilisées pour échapper des blocs de texte contenant des caractères qui seraient autrement considérés comme du balisage.
type: docs
weight: 440
url: /fr/net/aspose.svg.dom/cdatasection/
---
## CDATASection class
...
| [IsElementContentWhitespace](../../aspose.svg.dom/text/iselementcontentwhitespace/) { get; } | Renvoie si ce nœud de texte contient des espaces de contenu d'élément, souvent appelés abusivement "espaces ignorables". |
...
| override [NodeName](../../aspose.svg.dom/cdatasection/nodename/) { get; } | Le nom de ce nœud, en fonction de son type. |
| override [NodeType](../../aspose.svg.dom/cdatasection/nodetype/) { get; } | Un code représentant le type de l'objet sous-jacent. |
| override [NodeValue](../../aspose.svg.dom/text/nodevalue/) { get; set; } | La valeur de ce nœud, en fonction de son type. |
...
| [WholeText](../../aspose.svg.dom/text/wholetext/) { get; } | Renvoie tout le texte des nœuds de texte logiquement adjacents à ce nœud, concaténés dans l'ordre du document. |
