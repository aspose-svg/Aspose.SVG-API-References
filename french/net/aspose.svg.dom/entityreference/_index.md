...
description: Aspose.Svg.Dom.EntityReference classe. Les nœuds EntityReference peuvent être utilisés pour représenter une référence dentité dans larborescence.
type: docs
weight: 860
url: /fr/net/aspose.svg.dom/entityreference/
---
...
| override [NodeName](../../aspose.svg.dom/entityreference/nodename/) { get; } | Le nom de ce nœud, en fonction de son type. |
| override [NodeType](../../aspose.svg.dom/entityreference/nodetype/) { get; } | Un code représentant le type de l'objet sous-jacent. |
