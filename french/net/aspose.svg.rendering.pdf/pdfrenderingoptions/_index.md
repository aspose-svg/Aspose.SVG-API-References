...
description: Aspose.Svg.Rendering.Pdf.PdfRenderingOptions classe. Représente les options de rendu pourPdfDevice .
type: docs
weight: 2980
...
| Nom | La description |
| --- | --- |
| [PdfRenderingOptions](pdfrenderingoptions/)() | Initialise une nouvelle instance du`PdfRenderingOptions` classe. |
...
| [FormFieldBehaviour](../../aspose.svg.rendering.pdf/pdfrenderingoptions/formfieldbehaviour/) { get; set; } | Spécifie le comportement des champs de formulaire dans le document PDF de sortie. |
