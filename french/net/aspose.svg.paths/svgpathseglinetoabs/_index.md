...
description: Aspose.Svg.Paths.SVGPathSegLinetoAbs classe. Linterface SVGPathSegLinetoAbs correspond à une commande de données de chemin absolue lineto L.
type: docs
weight: 2610
url: /fr/net/aspose.svg.paths/svgpathseglinetoabs/
---
...
| [X](../../aspose.svg.paths/svgpathseglinetoabs/x/) { get; set; } | La coordonnée X absolue pour le point final de ce segment de chemin. |
| [Y](../../aspose.svg.paths/svgpathseglinetoabs/y/) { get; set; } | La coordonnée Y absolue pour le point final de ce segment de chemin. |
