...
description: Aspose.Svg.Paths.SVGPathSegCurvetoQuadraticSmoothAbs classe. Linterface SVGPathSegCurvetoQuadraticSmoothAbs correspond à une commande de données de chemin absolue smooth cubic curveto T.
type: docs
weight: 2590
url: /fr/net/aspose.svg.paths/svgpathsegcurvetoquadraticsmoothabs/
---
...
| [X](../../aspose.svg.paths/svgpathsegcurvetoquadraticsmoothabs/x/) { get; set; } | La coordonnée X absolue pour le point final de ce segment de chemin. |
| [Y](../../aspose.svg.paths/svgpathsegcurvetoquadraticsmoothabs/y/) { get; set; } | La coordonnée Y absolue pour le point final de ce segment de chemin. |
