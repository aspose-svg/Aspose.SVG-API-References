...
description: Aspose.Svg.SVGScriptElement classe. Linterface SVGScriptElement correspond à lélément script.
type: docs
weight: 3450
url: /fr/net/aspose.svg/svgscriptelement/
---
...
| [CrossOrigin](../../aspose.svg/svgscriptelement/crossorigin/) { get; set; } | Correspond à l'attribut 'crossorigin' sur l'élément 'script' donné. |
...
| [Href](../../aspose.svg/svgscriptelement/href/) { get; } | Correspond à l'attribut 'xlink:href' sur l'élément donné. |
...
| [Type](../../aspose.svg/svgscriptelement/type/) { get; set; } | Correspond à l'attribut 'type' sur l'élément 'script' donné. |
