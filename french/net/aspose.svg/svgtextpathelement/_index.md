...
description: Aspose.Svg.SVGTextPathElement classe. Linterface SVGTextPathElement correspond à lélément textPath.
type: docs
weight: 3540
url: /fr/net/aspose.svg/svgtextpathelement/
---
...
| [Href](../../aspose.svg/svgtextpathelement/href/) { get; } | Correspond à l'attribut 'xlink:href' sur l'élément donné. |
...
| [LengthAdjust](../../aspose.svg/svgtextcontentelement/lengthadjust/) { get; } | Correspond à l'attribut 'lengthAdjust' sur l'élément donné. La valeur doit être l'une des constantes d'ajustement de longueur définies sur cette interface. |
...
| [Method](../../aspose.svg/svgtextpathelement/method/) { get; } | Correspond à l'attribut 'method' sur l'élément 'textPath' donné. |
...
| [Spacing](../../aspose.svg/svgtextpathelement/spacing/) { get; } | Correspond à l'attribut 'spacing' sur l'élément 'textPath' donné. |
| [StartOffset](../../aspose.svg/svgtextpathelement/startoffset/) { get; } | Correspond à l'attribut 'startOffset' sur l'élément 'textPath' donné. |
...
| [TextLength](../../aspose.svg/svgtextcontentelement/textlength/) { get; } | Correspond à l'attribut 'textLength' sur l'élément donné. |
...
| [GetComputedTextLength](../../aspose.svg/svgtextcontentelement/getcomputedtextlength/)() | La somme totale de toutes les valeurs d'avance du rendu de tous les caractères de cet élément, y compris la valeur d'avance sur les glyphes (horizontal ou vertical), l'effet des propriétés 'kerning', 'letter-spacing' et 'word- spacing' et ajustements dus aux attributs 'dx' et 'dy' sur les éléments 'tspan'. Pour les environnements sans rendu, l'agent utilisateur doit faire des hypothèses raisonnables sur les métriques de glyphe. |
...
| Nom | La description |
| --- | --- |
| const [TEXTPATH_METHODTYPE_ALIGN](../../aspose.svg/svgtextpathelement/textpath_methodtype_align/) | Correspond à la valeur 'align'. |
| const [TEXTPATH_METHODTYPE_STRETCH](../../aspose.svg/svgtextpathelement/textpath_methodtype_stretch/) | Correspond à la valeur 'stretch'. |
| const [TEXTPATH_METHODTYPE_UNKNOWN](../../aspose.svg/svgtextpathelement/textpath_methodtype_unknown/) | L'énumération a été définie sur une valeur qui ne fait pas partie des types prédéfinis. Il n'est pas valide de tenter de définir une nouvelle valeur de ce type ou de tenter de basculer une valeur existante vers ce type. |
| const [TEXTPATH_SPACINGTYPE_AUTO](../../aspose.svg/svgtextpathelement/textpath_spacingtype_auto/) | Correspond à la valeur 'auto'. |
| const [TEXTPATH_SPACINGTYPE_EXACT](../../aspose.svg/svgtextpathelement/textpath_spacingtype_exact/) | Correspond à la valeur 'exact'. |
| const [TEXTPATH_SPACINGTYPE_UNKNOWN](../../aspose.svg/svgtextpathelement/textpath_spacingtype_unknown/) | L'énumération a été définie sur une valeur qui ne fait pas partie des types prédéfinis. Il n'est pas valide de tenter de définir une nouvelle valeur de ce type ou de tenter de basculer une valeur existante vers ce type. |
