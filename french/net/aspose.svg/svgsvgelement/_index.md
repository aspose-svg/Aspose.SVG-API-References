...
type: docs
weight: 3390
url: /fr/net/aspose.svg/svgsvgelement/
---
## SVGSVGElement class
...
| [FarthestViewportElement](../../aspose.svg/svggraphicselement/farthestviewportelement) { get; } | L'élément 'svg' ancêtre le plus éloigné. Null si l'élément actuel est l'élément svg le plus externe. |
...
| [Height](../../aspose.svg/svgsvgelement/height) { get; } | Correspond à l'attribut 'height' sur l'élément 'svg' donné. |
...
| [NearestViewportElement](../../aspose.svg/svggraphicselement/nearestviewportelement) { get; } | L'élément qui a établi la fenêtre courante. Souvent, l'élément 'svg' ancêtre le plus proche. Null si l'élément actuel est l'élément svg le plus externe. |
...
| [PreserveAspectRatio](../../aspose.svg/svgsvgelement/preserveaspectratio) { get; } | Correspond à l'attribut 'preserveAspectRatio' sur l'élément donné. |
...
| [ViewBox](../../aspose.svg/svgsvgelement/viewbox) { get; } | Correspond à l'attribut 'viewBox' sur l'élément donné. |
...
| [Width](../../aspose.svg/svgsvgelement/width) { get; } | Correspond à l'attribut 'width' sur l'élément 'svg' donné. |
| [X](../../aspose.svg/svgsvgelement/x) { get; } | Correspond à l'attribut 'x' sur l'élément 'svg' donné. |
| [Y](../../aspose.svg/svgsvgelement/y) { get; } | Correspond à l'attribut 'y' sur l'élément 'svg' donné. |
| [ZoomAndPan](../../aspose.svg/svgsvgelement/zoomandpan) { get; set; } | Correspond à l'attribut 'zoomAndPan' sur l'élément donné. La valeur doit être l'une des constantes SVG_ZOOMANDPAN_* définies sur cette interface. |
...
| [AnimationsPaused](../../aspose.svg/svgsvgelement/animationspaused)() | Renvoie true si ce fragment de document SVG est en pause. |
...
| [CreateEvent](../../aspose.svg/svgsvgelement/createevent)(string) | Crée un[`Event`](../../aspose.svg.dom.events/event) d'un type pris en charge par l'implémentation. |
| [CreateSVGAngle](../../aspose.svg/svgsvgelement/createsvgangle)() | Crée un objet SVGAngle en dehors de toute arborescence de documents. L'objet est initialisé à la valeur 0 degrés (sans unité). |
| [CreateSVGLength](../../aspose.svg/svgsvgelement/createsvglength)() | Crée un objet SVGLength en dehors de toute arborescence de documents. L'objet est initialisé à la valeur de 0 unités utilisateur. |
| [CreateSVGMatrix](../../aspose.svg/svgsvgelement/createsvgmatrix)() | Crée un objet SVGMatrix en dehors de toute arborescence de documents. L'objet est initialisé à la matrice d'identité. |
| [CreateSVGNumber](../../aspose.svg/svgsvgelement/createsvgnumber)() | Crée un objet SVGNumber en dehors de toute arborescence de documents. L'objet est initialisé à une valeur de zéro. |
| [CreateSVGPoint](../../aspose.svg/svgsvgelement/createsvgpoint)() | Crée un objet SVGPoint en dehors de toute arborescence de documents. L'objet est initialisé au point (0,0) dans le système de coordonnées utilisateur. |
| [CreateSVGRect](../../aspose.svg/svgsvgelement/createsvgrect)() | Crée un objet SVGRect en dehors de toute arborescence de documents. L'objet est initialisé de sorte que toutes les valeurs soient définies sur 0 unités utilisateur. |
| [CreateSVGTransform](../../aspose.svg/svgsvgelement/createsvgtransform)() | Crée un objet SVGTransform en dehors de toute arborescence de documents. L'objet est initialisé à une transformation de matrice d'identité (SVG_TRANSFORM_MATRIX). |
...
| [UnpauseAnimations](../../aspose.svg/svgsvgelement/unpauseanimations)() | Annule la suspension (c'est-à-dire, rétablit la pause) des animations en cours d'exécution qui sont définies dans le fragment de document SVG, entraînant la poursuite de l'horloge de l'animation à partir du moment où elle a été suspendue. |
