...
description: Aspose.Svg.SVGEllipseElement classe. Linterface SVGEllipseElement correspond à lélément ellipse.
type: docs
weight: 3220
url: /fr/net/aspose.svg/svgellipseelement/
---
...
| [Cx](../../aspose.svg/svgellipseelement/cx/) { get; } | Correspond à l'attribut 'cx' sur l'élément 'cercle' donné. |
| [Cy](../../aspose.svg/svgellipseelement/cy/) { get; } | Correspond à l'attribut 'cy' sur l'élément 'circle' donné. |
...
| [Rx](../../aspose.svg/svgellipseelement/rx/) { get; } | Correspond à l'attribut 'cx' sur l'élément 'cercle' donné. |
| [Ry](../../aspose.svg/svgellipseelement/ry/) { get; } | Correspond à l'attribut 'ry' sur l'élément 'circle' donné. |
