...
description: Aspose.Svg.SVGFilterElement classe. Linterface SVGFilterElement correspond à lélément filter.
type: docs
weight: 3240
url: /fr/net/aspose.svg/svgfilterelement/
---
...
| [FilterUnits](../../aspose.svg/svgfilterelement/filterunits/) { get; } | Correspond à l'attribut 'filterUnits' sur l'élément 'filter' donné. Prend l'une des constantes définies dans SVGUnitTypes. |
...
| [Height](../../aspose.svg/svgfilterelement/height/) { get; } | Correspond à l'attribut 'height' sur l'élément 'filter' donné. |
| [Href](../../aspose.svg/svgfilterelement/href/) { get; } | Correspond à l'attribut 'xlink:href' sur l'élément donné. |
...
| [PrimitiveUnits](../../aspose.svg/svgfilterelement/primitiveunits/) { get; } | Correspond à l'attribut 'primitiveUnits' sur l'élément 'filter' donné. Prend l'une des constantes définies dans SVGUnitTypes. |
...
| [Width](../../aspose.svg/svgfilterelement/width/) { get; } | Correspond à l'attribut 'width' sur l'élément 'filter' donné. |
| [X](../../aspose.svg/svgfilterelement/x/) { get; } | Correspond à l'attribut 'x' sur l'élément 'filter' donné. |
| [Y](../../aspose.svg/svgfilterelement/y/) { get; } | Correspond à l'attribut 'y' sur l'élément 'filter' donné. |
