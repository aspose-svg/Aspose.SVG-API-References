...
description: Aspose.Svg.SVGGradientElement classe. Linterface SVGGradientElement est une interface de base utilisée par SVGLinearGradientElement et SVGRadialGradientElement.
type: docs
weight: 3280
url: /fr/net/aspose.svg/svggradientelement/
---
...
| Nom | La description |
| --- | --- |
| const [SVG_SPREADMETHOD_PAD](../../aspose.svg/svggradientelement/svg_spreadmethod_pad/) | Correspond à la valeur 'pad'. |
| const [SVG_SPREADMETHOD_REFLECT](../../aspose.svg/svggradientelement/svg_spreadmethod_reflect/) | Correspond à la valeur 'reflect'. |
| const [SVG_SPREADMETHOD_REPEAT](../../aspose.svg/svggradientelement/svg_spreadmethod_repeat/) | Correspond à la valeur 'repeat'. |
| const [SVG_SPREADMETHOD_UNKNOWN](../../aspose.svg/svggradientelement/svg_spreadmethod_unknown/) | Le type ne fait pas partie des types prédéfinis. Il n'est pas valide de tenter de définir une nouvelle valeur de ce type ou de tenter de basculer une valeur existante vers ce type. |
