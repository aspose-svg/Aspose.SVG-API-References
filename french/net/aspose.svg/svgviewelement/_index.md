...
description: Aspose.Svg.SVGViewElement classe. Linterface SVGViewElement correspond à lélément view.
type: docs
weight: 3590
url: /fr/net/aspose.svg/svgviewelement/
---
...
| [PreserveAspectRatio](../../aspose.svg/svgviewelement/preserveaspectratio/) { get; } | Correspond à l'attribut 'preserveAspectRatio' sur l'élément donné. |
...
| [ViewBox](../../aspose.svg/svgviewelement/viewbox/) { get; } | Correspond à l'attribut 'viewBox' sur l'élément donné. |
...
| [ViewTarget](../../aspose.svg/svgviewelement/viewtarget/) { get; } | Correspond à l'attribut 'viewTarget' sur l'élément 'view' donné. Une liste de valeurs DOMString qui contiennent les noms listés dans l'attribut 'viewTarget'. Chacune des valeurs DOMString peut être associée à l'élément correspondant à l'aide de l'appel de méthode getElementById(). |
| [ZoomAndPan](../../aspose.svg/svgviewelement/zoomandpan/) { get; set; } | Correspond à l'attribut 'zoomAndPan' sur l'élément donné. La valeur doit être l'une des constantes SVG_ZOOMANDPAN_* définies sur cette interface. |
