...
description: Aspose.Svg.SVGPatternElement classe. Linterface SVGPatternElement correspond à lélément pattern.
type: docs
weight: 3380
url: /fr/net/aspose.svg/svgpatternelement/
---
...
| [Height](../../aspose.svg/svgpatternelement/height/) { get; } | Correspond à l'attribut 'height' sur l'élément 'pattern' donné. |
| [Href](../../aspose.svg/svgpatternelement/href/) { get; } | Correspond à l'attribut 'xlink:href' sur l'élément donné. |
...
| [PatternContentUnits](../../aspose.svg/svgpatternelement/patterncontentunits/) { get; } | Correspond à l'attribut 'patternContentUnits' sur l'élément 'pattern' donné. Prend l'une des constantes définies dans SVGUnitTypes. |
| [PatternTransform](../../aspose.svg/svgpatternelement/patterntransform/) { get; } | Correspond à l'attribut 'patternTransform' sur l'élément 'pattern' donné. |
| [PatternUnits](../../aspose.svg/svgpatternelement/patternunits/) { get; } | Correspond à l'attribut 'patternUnits' sur l'élément 'pattern' donné. Prend l'une des constantes définies dans SVGUnitTypes. |
...
| [PreserveAspectRatio](../../aspose.svg/svgpatternelement/preserveaspectratio/) { get; } | Correspond à l'attribut 'preserveAspectRatio' sur l'élément donné. |
...
| [RequiredExtensions](../../aspose.svg/svgpatternelement/requiredextensions/) { get; } | Correspond à l'attribut 'requiredExtensions' sur l'élément donné. |
| [RequiredFeatures](../../aspose.svg/svgpatternelement/requiredfeatures/) { get; } | Correspond à l'attribut 'requiredFeatures' sur l'élément donné. |
...
| [SystemLanguage](../../aspose.svg/svgpatternelement/systemlanguage/) { get; } | Correspond à l'attribut 'systemLanguage' sur l'élément donné. |
...
| [ViewBox](../../aspose.svg/svgpatternelement/viewbox/) { get; } | Correspond à l'attribut 'viewBox' sur l'élément donné. |
...
| [Width](../../aspose.svg/svgpatternelement/width/) { get; } | Correspond à l'attribut 'width' sur l'élément 'pattern' donné. |
| [X](../../aspose.svg/svgpatternelement/x/) { get; } | Correspond à l'attribut 'x' sur l'élément 'pattern' donné. |
| [Y](../../aspose.svg/svgpatternelement/y/) { get; } | Correspond à l'attribut 'y' sur l'élément 'pattern' donné. |
