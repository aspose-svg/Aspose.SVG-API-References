...
description: Aspose.Svg.SVGRadialGradientElement classe. Linterface SVGRadialGradientElement correspond à lélément radialGradient.
type: docs
weight: 3410
url: /fr/net/aspose.svg/svgradialgradientelement/
---
...
| [Cx](../../aspose.svg/svgradialgradientelement/cx/) { get; } | Correspond à l'attribut 'cx' sur l'élément 'radialGradient' donné. |
| [Cy](../../aspose.svg/svgradialgradientelement/cy/) { get; } | Correspond à l'attribut 'cy' sur l'élément 'radialGradient' donné. |
...
| [Fr](../../aspose.svg/svgradialgradientelement/fr/) { get; } | Correspond à l'attribut 'fr' sur l'élément 'radialGradient' donné. |
| [Fx](../../aspose.svg/svgradialgradientelement/fx/) { get; } | Correspond à l'attribut 'fx' sur l'élément 'radialGradient' donné. |
| [Fy](../../aspose.svg/svgradialgradientelement/fy/) { get; } | Correspond à l'attribut 'fy' sur l'élément 'radialGradient' donné. |
| [GradientTransform](../../aspose.svg/svggradientelement/gradienttransform/) { get; } | Correspond à l'attribut 'gradientTransform' sur l'élément donné. |
| [GradientUnits](../../aspose.svg/svggradientelement/gradientunits/) { get; } | Correspond à l'attribut 'gradientUnits' sur l'élément donné. Prend l'une des constantes définies dans SVGUnitTypes. |
| [Href](../../aspose.svg/svggradientelement/href/) { get; } | Correspond à l'attribut 'xlink:href' sur l'élément donné. |
...
| [R](../../aspose.svg/svgradialgradientelement/r/) { get; } | Correspond à l'attribut 'r' sur l'élément 'radialGradient' donné. |
...
| [SpreadMethod](../../aspose.svg/svggradientelement/spreadmethod/) { get; } | Correspond à l'attribut 'spreadMethod' sur l'élément donné. L'un des types de méthodes de répartition définis sur cette interface. |
