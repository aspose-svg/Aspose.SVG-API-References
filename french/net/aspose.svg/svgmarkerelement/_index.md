...
description: Aspose.Svg.SVGMarkerElement classe. Linterface SVGMarkerElement correspond à lélément marker.
type: docs
weight: 3340
url: /fr/net/aspose.svg/svgmarkerelement/
---
...
| [MarkerHeight](../../aspose.svg/svgmarkerelement/markerheight/) { get; } | Correspond à l'attribut 'markerHeight' sur l'élément 'marker' donné. |
| [MarkerUnits](../../aspose.svg/svgmarkerelement/markerunits/) { get; } | Correspond à l'attribut 'markerUnits' sur l'élément 'marker' donné. L'un des types d'unités de marqueur définis sur cette interface. |
| [MarkerWidth](../../aspose.svg/svgmarkerelement/markerwidth/) { get; } | Correspond à l'attribut 'markerWidth' sur l'élément 'marker' donné. |
...
| [OrientAngle](../../aspose.svg/svgmarkerelement/orientangle/) { get; } | Correspond à l'attribut 'orient' sur l'élément 'marker' donné. Si markerUnits est SVG_MARKER_ORIENT_ANGLE, la valeur d'angle pour l'attribut 'orient' ; sinon, il sera mis à zéro. |
| [OrientType](../../aspose.svg/svgmarkerelement/orienttype/) { get; } | Correspond à l'attribut 'orient' sur l'élément 'marker' donné. L'un des types d'orientation de marqueur définis sur cette interface. |
...
| [PreserveAspectRatio](../../aspose.svg/svgmarkerelement/preserveaspectratio/) { get; } | Correspond à l'attribut 'preserveAspectRatio' sur l'élément donné. |
...
| [RefX](../../aspose.svg/svgmarkerelement/refx/) { get; } | Correspond à l'attribut 'refX' sur l'élément 'marker' donné. |
| [RefY](../../aspose.svg/svgmarkerelement/refy/) { get; } | Correspond à l'attribut 'refY' sur l'élément 'marker' donné. |
...
| [ViewBox](../../aspose.svg/svgmarkerelement/viewbox/) { get; } | Correspond à l'attribut 'viewBox' sur l'élément donné. |
...
| [SetOrientToAngle](../../aspose.svg/svgmarkerelement/setorienttoangle/)(SVGAngle) | Définit la valeur de l'attribut 'orient' à l'angle donné. |
| [SetOrientToAuto](../../aspose.svg/svgmarkerelement/setorienttoauto/)() | Définit la valeur de l'attribut 'orient' sur 'auto'. |
...
| Nom | La description |
| --- | --- |
| const [SVG_MARKERUNITS_STROKEWIDTH](../../aspose.svg/svgmarkerelement/svg_markerunits_strokewidth/) | La valeur de l'attribut 'markerUnits' est 'strokeWidth'. |
| const [SVG_MARKERUNITS_UNKNOWN](../../aspose.svg/svgmarkerelement/svg_markerunits_unknown/) | Le type d'unité de repère ne fait pas partie des types prédéfinis. Il n'est pas valide de tenter de définir une nouvelle valeur de ce type ou de tenter de basculer une valeur existante vers ce type. |
| const [SVG_MARKERUNITS_USERSPACEONUSE](../../aspose.svg/svgmarkerelement/svg_markerunits_userspaceonuse/) | La valeur de l'attribut 'markerUnits' est 'userSpaceOnUse'. |
| const [SVG_MARKER_ORIENT_ANGLE](../../aspose.svg/svgmarkerelement/svg_marker_orient_angle/) | L'attribut 'orient' a une valeur d'angle. |
| const [SVG_MARKER_ORIENT_AUTO](../../aspose.svg/svgmarkerelement/svg_marker_orient_auto/) | L'attribut 'orient' a la valeur 'auto'. |
| const [SVG_MARKER_ORIENT_UNKNOWN](../../aspose.svg/svgmarkerelement/svg_marker_orient_unknown/) | L'orientation du marqueur ne fait pas partie des types prédéfinis. Il n'est pas valide de tenter de définir une nouvelle valeur de ce type ou de tenter de basculer une valeur existante vers ce type. |
