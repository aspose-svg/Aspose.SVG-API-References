...
description: Aspose.Svg.SVGCursorElement classe. Linterface SVGCursorElement correspond à lélément cursor.
type: docs
weight: 3160
url: /fr/net/aspose.svg/svgcursorelement/
---
...
| [Href](../../aspose.svg/svgcursorelement/href/) { get; } | Correspond à l'attribut 'xlink:href' sur l'élément donné. |
...
| [RequiredExtensions](../../aspose.svg/svgcursorelement/requiredextensions/) { get; } | Correspond à l'attribut 'requiredExtensions' sur l'élément donné. |
| [RequiredFeatures](../../aspose.svg/svgcursorelement/requiredfeatures/) { get; } | Correspond à l'attribut 'requiredFeatures' sur l'élément donné. |
...
| [SystemLanguage](../../aspose.svg/svgcursorelement/systemlanguage/) { get; } | Correspond à l'attribut 'systemLanguage' sur l'élément donné. |
...
| [X](../../aspose.svg/svgcursorelement/x/) { get; } | Correspond à l'attribut 'x' sur l'élément 'cursor' donné. |
| [Y](../../aspose.svg/svgcursorelement/y/) { get; } | Correspond à l'attribut 'y' sur l'élément 'cursor' donné. |
