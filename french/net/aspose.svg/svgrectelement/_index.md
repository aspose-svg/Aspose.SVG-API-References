...
description: Aspose.Svg.SVGRectElement classe. Linterface SVGRectElement correspond à lélément rect.
type: docs
weight: 3420
url: /fr/net/aspose.svg/svgrectelement/
---
...
| [Height](../../aspose.svg/svgrectelement/height/) { get; } | Correspond à l'attribut 'height' sur l'élément 'rect' donné. |
...
| [Rx](../../aspose.svg/svgrectelement/rx/) { get; } | Correspond à l'attribut 'rx' sur l'élément 'rect' donné. |
| [Ry](../../aspose.svg/svgrectelement/ry/) { get; } | Correspond à l'attribut 'ry' sur l'élément 'rect' donné. |
...
| [Width](../../aspose.svg/svgrectelement/width/) { get; } | Correspond à l'attribut 'width' sur l'élément 'rect' donné. |
| [X](../../aspose.svg/svgrectelement/x/) { get; } | Correspond à l'attribut 'x' sur l'élément 'rect' donné. |
| [Y](../../aspose.svg/svgrectelement/y/) { get; } | Correspond à l'attribut 'y' sur l'élément 'rect' donné. |
...
| [GetEquivalentPath](../../aspose.svg/svggeometryelement/getequivalentpath/)() | Renvoie une nouvelle instance instance du[`SVGPathSegList`](../../aspose.svg.paths/svgpathseglist/) qui représente[`SVGGeometryElement`](../svggeometryelement/) comme segments de chemin. |
