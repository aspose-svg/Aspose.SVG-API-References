...
description: Aspose.Svg.SVGMaskElement classe. Linterface SVGMaskElement correspond à lélément mask.
type: docs
weight: 3350
url: /fr/net/aspose.svg/svgmaskelement/
---
...
| [Height](../../aspose.svg/svgmaskelement/height/) { get; } | Correspond à l'attribut 'height' sur l'élément 'mask' donné. Prend l'une des constantes définies dans SVGUnitTypes. |
...
| [MaskContentUnits](../../aspose.svg/svgmaskelement/maskcontentunits/) { get; } | Correspond à l'attribut 'maskContentUnits' sur l'élément 'mask' donné. Prend l'une des constantes définies dans SVGUnitTypes. |
| [MaskUnits](../../aspose.svg/svgmaskelement/maskunits/) { get; } | Correspond à l'attribut 'maskUnits' sur l'élément 'mask' donné. Prend l'une des constantes définies dans SVGUnitTypes. |
...
| [RequiredExtensions](../../aspose.svg/svgmaskelement/requiredextensions/) { get; } | Correspond à l'attribut 'requiredExtensions' sur l'élément donné. |
| [RequiredFeatures](../../aspose.svg/svgmaskelement/requiredfeatures/) { get; } | Correspond à l'attribut 'requiredFeatures' sur l'élément donné. |
...
| [SystemLanguage](../../aspose.svg/svgmaskelement/systemlanguage/) { get; } | Correspond à l'attribut 'systemLanguage' sur l'élément donné. |
...
| [Width](../../aspose.svg/svgmaskelement/width/) { get; } | Correspond à l'attribut 'width' sur l'élément 'mask' donné. Prend l'une des constantes définies dans SVGUnitTypes. |
| [X](../../aspose.svg/svgmaskelement/x/) { get; } | Correspond à l'attribut 'x' sur l'élément 'mask' donné. Prend l'une des constantes définies dans SVGUnitTypes. |
| [Y](../../aspose.svg/svgmaskelement/y/) { get; } | Correspond à l'attribut 'y' sur l'élément 'mask' donné. Prend l'une des constantes définies dans SVGUnitTypes. |
