...
description: Aspose.Svg.SVGImageElement classe. Linterface SVGImageElement correspond à lélément image.
type: docs
weight: 3300
url: /fr/net/aspose.svg/svgimageelement/
---
...
| [Height](../../aspose.svg/svgimageelement/height/) { get; } | Correspond à l'attribut 'height' sur l'élément 'image' donné. |
| [Href](../../aspose.svg/svgimageelement/href/) { get; } | Correspond à l'attribut 'xlink:href' sur l'élément donné. |
...
| [PreserveAspectRatio](../../aspose.svg/svgimageelement/preserveaspectratio/) { get; } | Correspond à l'attribut 'preserveAspectRatio' sur l'élément 'image' donné. |
...
| [Width](../../aspose.svg/svgimageelement/width/) { get; } | Correspond à l'attribut 'width' sur l'élément 'image' donné. |
| [X](../../aspose.svg/svgimageelement/x/) { get; } | Correspond à l'attribut 'x' sur l'élément 'image' donné. |
| [Y](../../aspose.svg/svgimageelement/y/) { get; } | Correspond à l'attribut 'y' sur l'élément 'image' donné. |
