...
description: Aspose.Svg.SVGForeignObjectElement classe. Linterface SVGForeignObjectElement correspond à lélément foreignObject.
type: docs
weight: 3250
url: /fr/net/aspose.svg/svgforeignobjectelement/
---
...
| [Height](../../aspose.svg/svgforeignobjectelement/height/) { get; } | Correspond à l'attribut 'height' sur l'élément 'foreignObject' donné. |
...
| [Width](../../aspose.svg/svgforeignobjectelement/width/) { get; } | Correspond à l'attribut 'width' sur l'élément 'foreignObject' donné. |
| [X](../../aspose.svg/svgforeignobjectelement/x/) { get; } | Correspond à l'attribut 'x' sur l'élément 'foreignObject' donné. |
| [Y](../../aspose.svg/svgforeignobjectelement/y/) { get; } | Correspond à l'attribut 'y' sur l'élément 'foreignObject' donné. |
