...
description: Aspose.Svg.SVGComponentTransferFunctionElement classe. Cette interface définit une interface de base utilisée par les interfaces de la fonction de transfert des composants.
type: docs
weight: 3150
url: /fr/net/aspose.svg/svgcomponenttransferfunctionelement/
---
...
| Nom | La description |
| --- | --- |
| [Amplitude](../../aspose.svg/svgcomponenttransferfunctionelement/amplitude/) { get; } | Correspond à l'attribut 'amplitude' sur l'élément donné. |
...
| [Exponent](../../aspose.svg/svgcomponenttransferfunctionelement/exponent/) { get; } | Correspond à l'attribut 'exponent' sur l'élément donné. |
...
| [Intercept](../../aspose.svg/svgcomponenttransferfunctionelement/intercept/) { get; } | Correspond à l'attribut 'interception' sur l'élément donné. |
...
| [Offset](../../aspose.svg/svgcomponenttransferfunctionelement/offset/) { get; } | Correspond à l'attribut 'offset' sur l'élément donné. |
...
| [Slope](../../aspose.svg/svgcomponenttransferfunctionelement/slope/) { get; } | Correspond à l'attribut 'pente' sur l'élément donné. |
...
| [TableValues](../../aspose.svg/svgcomponenttransferfunctionelement/tablevalues/) { get; } | Correspond à l'attribut 'tableValues' sur l'élément donné. |
...
| [Type](../../aspose.svg/svgcomponenttransferfunctionelement/type/) { get; } | Correspond à l'attribut 'type' sur l'élément donné. Prend l'une des constantes SVG_FECOMPONENTTRANSFER_TYPE_* définies sur cette interface. |
...
| Nom | La description |
| --- | --- |
| const [SVG_FECOMPONENTTRANSFER_TYPE_DISCRETE](../../aspose.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_discrete/) | Correspond à la valeur 'discrète'. |
| const [SVG_FECOMPONENTTRANSFER_TYPE_GAMMA](../../aspose.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_gamma/) | Correspond à la valeur 'gamma'. |
| const [SVG_FECOMPONENTTRANSFER_TYPE_IDENTITY](../../aspose.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_identity/) | Correspond à la valeur 'identité'. |
| const [SVG_FECOMPONENTTRANSFER_TYPE_LINEAR](../../aspose.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_linear/) | Correspond à la valeur 'linéaire'. |
| const [SVG_FECOMPONENTTRANSFER_TYPE_TABLE](../../aspose.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_table/) | Correspond à la valeur 'table'. |
