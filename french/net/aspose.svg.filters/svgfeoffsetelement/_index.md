...
description: Aspose.Svg.Filters.SVGFEOffsetElement classe. Linterface SVGFEOffsetElement correspond à lélément feOffset.
type: docs
weight: 1840
url: /fr/net/aspose.svg.filters/svgfeoffsetelement/
---
...
| [Dx](../../aspose.svg.filters/svgfeoffsetelement/dx/) { get; } | Correspond à l'attribut 'dx' sur l'élément 'feOffset' donné. |
| [Dy](../../aspose.svg.filters/svgfeoffsetelement/dy/) { get; } | Correspond à l'attribut 'dy' sur l'élément 'feOffset' donné. |
...
| [Height](../../aspose.svg.filters/svgfeoffsetelement/height/) { get; } | Correspond à l'attribut 'height' sur l'élément 'filter' donné. |
...
| [In1](../../aspose.svg.filters/svgfeoffsetelement/in1/) { get; } | Correspond à l'attribut 'in' sur l'élément 'feOffset' donné. |
...
| [Result](../../aspose.svg.filters/svgfeoffsetelement/result/) { get; } | Correspond à l'attribut 'result' sur l'élément 'filter' donné. |
...
| [Width](../../aspose.svg.filters/svgfeoffsetelement/width/) { get; } | Correspond à l'attribut 'width' sur l'élément 'filter' donné. |
| [X](../../aspose.svg.filters/svgfeoffsetelement/x/) { get; } | Correspond à l'attribut 'x' sur l'élément 'filter' donné. |
| [Y](../../aspose.svg.filters/svgfeoffsetelement/y/) { get; } | Correspond à l'attribut 'y' sur l'élément 'filter' donné. |
