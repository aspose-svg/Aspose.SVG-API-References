...
description: Aspose.Svg.Filters.SVGFETurbulenceElement classe. Linterface SVGFETurbulenceElement correspond à lélément feTurbulence.
type: docs
weight: 1890
url: /fr/net/aspose.svg.filters/svgfeturbulenceelement/
---
...
| [BaseFrequencyX](../../aspose.svg.filters/svgfeturbulenceelement/basefrequencyx/) { get; } | Correspond à l'attribut 'baseFrequency' sur l'élément 'feTurbulence' donné. Contient le composant X de l'attribut 'baseFrequency'. |
| [BaseFrequencyY](../../aspose.svg.filters/svgfeturbulenceelement/basefrequencyy/) { get; } | Correspond à l'attribut 'baseFrequency' sur l'élément 'feTurbulence' donné. Contient la composante Y de l'attribut 'baseFrequency' (éventuellement calculé automatiquement). |
...
| [Height](../../aspose.svg.filters/svgfeturbulenceelement/height/) { get; } | Correspond à l'attribut 'height' sur l'élément 'filter' donné. |
...
| [NumOctaves](../../aspose.svg.filters/svgfeturbulenceelement/numoctaves/) { get; } | Correspond à l'attribut 'numOctaves' sur l'élément 'feTurbulence' donné. |
...
| [Result](../../aspose.svg.filters/svgfeturbulenceelement/result/) { get; } | Correspond à l'attribut 'result' sur l'élément 'filter' donné. |
| [SchemaTypeInfo](../../aspose.svg.dom/element/schematypeinfo/) { get; } | Les informations de type associées à cet élément. |
| [Seed](../../aspose.svg.filters/svgfeturbulenceelement/seed/) { get; } | Correspond à l'attribut 'seed' sur l'élément 'feTurbulence' donné. |
| [ShadowRoot](../../aspose.svg.dom/element/shadowroot/) { get; } | Renvoie shadowRoot stocké sur cet élément ou null s'il est fermé. |
| [StitchTiles](../../aspose.svg.filters/svgfeturbulenceelement/stitchtiles/) { get; } | Correspond à l'attribut 'stitchTiles' sur l'élément 'feTurbulence' donné. Prend l'une des constantes SVG_STITCHTYPE_* définies sur cette interface. |
...
| [Type](../../aspose.svg.filters/svgfeturbulenceelement/type/) { get; } | Correspond à l'attribut 'type' sur l'élément 'feTurbulence' donné. Prend une des constantes SVG_TURBULENCE_TYPE_* définies sur cette interface. |
...
| [Width](../../aspose.svg.filters/svgfeturbulenceelement/width/) { get; } | Correspond à l'attribut 'width' sur l'élément 'filter' donné. |
| [X](../../aspose.svg.filters/svgfeturbulenceelement/x/) { get; } | Correspond à l'attribut 'x' sur l'élément 'filter' donné. |
| [Y](../../aspose.svg.filters/svgfeturbulenceelement/y/) { get; } | Correspond à l'attribut 'y' sur l'élément 'filter' donné. |
...
| Nom | La description |
| --- | --- |
| const [SVG_STITCHTYPE_NOSTITCH](../../aspose.svg.filters/svgfeturbulenceelement/svg_stitchtype_nostitch/) | Correspond à la valeur 'noStitch'. |
| const [SVG_STITCHTYPE_STITCH](../../aspose.svg.filters/svgfeturbulenceelement/svg_stitchtype_stitch/) | Correspond à la valeur 'point'. |
| const [SVG_STITCHTYPE_UNKNOWN](../../aspose.svg.filters/svgfeturbulenceelement/svg_stitchtype_unknown/) | Le type ne fait pas partie des types prédéfinis. Il n'est pas valide de tenter de définir une nouvelle valeur de ce type ou de tenter de basculer une valeur existante vers ce type. |
| const [SVG_TURBULENCE_TYPE_FRACTALNOISE](../../aspose.svg.filters/svgfeturbulenceelement/svg_turbulence_type_fractalnoise/) | Correspond à la valeur 'fractalNoise'. |
| const [SVG_TURBULENCE_TYPE_TURBULENCE](../../aspose.svg.filters/svgfeturbulenceelement/svg_turbulence_type_turbulence/) | Correspond à la valeur 'turbulence'. |
| const [SVG_TURBULENCE_TYPE_UNKNOWN](../../aspose.svg.filters/svgfeturbulenceelement/svg_turbulence_type_unknown/) | Le type ne fait pas partie des types prédéfinis. Il n'est pas valide de tenter de définir une nouvelle valeur de ce type ou de tenter de basculer une valeur existante vers ce type. |
