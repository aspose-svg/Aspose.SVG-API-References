...
description: Aspose.Svg.Filters.SVGFEColorMatrixElement classe. Linterface SVGFEColorMatrixElement correspond à lélément feColorMatrix.
type: docs
weight: 1660
url: /fr/net/aspose.svg.filters/svgfecolormatrixelement/
---
...
| [Height](../../aspose.svg.filters/svgfecolormatrixelement/height/) { get; } | Correspond à l'attribut 'height' sur l'élément 'filter' donné. |
...
| [In1](../../aspose.svg.filters/svgfecolormatrixelement/in1/) { get; } | Correspond à l'attribut 'in' sur l'élément 'feColorMatrix' donné. |
...
| [Result](../../aspose.svg.filters/svgfecolormatrixelement/result/) { get; } | Correspond à l'attribut 'result' sur l'élément 'filter' donné. |
...
| [Type](../../aspose.svg.filters/svgfecolormatrixelement/type/) { get; } | Correspond à l'attribut 'type' sur l'élément 'feColorMatrix' donné. Prend une des constantes SVG_FECOLORMATRIX_TYPE_* définies sur cette interface. |
| [Values](../../aspose.svg.filters/svgfecolormatrixelement/values/) { get; } | Correspond à l'attribut 'values' sur l'élément 'feColorMatrix' donné. |
...
| [Width](../../aspose.svg.filters/svgfecolormatrixelement/width/) { get; } | Correspond à l'attribut 'width' sur l'élément 'filter' donné. |
| [X](../../aspose.svg.filters/svgfecolormatrixelement/x/) { get; } | Correspond à l'attribut 'x' sur l'élément 'filter' donné. |
| [Y](../../aspose.svg.filters/svgfecolormatrixelement/y/) { get; } | Correspond à l'attribut 'y' sur l'élément 'filter' donné. |
...
| Nom | La description |
| --- | --- |
| const [SVG_FECOLORMATRIX_TYPE_HUEROTATE](../../aspose.svg.filters/svgfecolormatrixelement/svg_fecolormatrix_type_huerotate/) | Correspond à la valeur 'hueRotate'. |
| const [SVG_FECOLORMATRIX_TYPE_LUMINANCETOALPHA](../../aspose.svg.filters/svgfecolormatrixelement/svg_fecolormatrix_type_luminancetoalpha/) | Correspond à la valeur 'luminanceToAlpha'. |
| const [SVG_FECOLORMATRIX_TYPE_MATRIX](../../aspose.svg.filters/svgfecolormatrixelement/svg_fecolormatrix_type_matrix/) | Correspond à la valeur 'matrice'. |
| const [SVG_FECOLORMATRIX_TYPE_SATURATE](../../aspose.svg.filters/svgfecolormatrixelement/svg_fecolormatrix_type_saturate/) | Correspond à la valeur 'saturer'. |
| const [SVG_FECOLORMATRIX_TYPE_UNKNOWN](../../aspose.svg.filters/svgfecolormatrixelement/svg_fecolormatrix_type_unknown/) | Le type ne fait pas partie des types prédéfinis. Il n'est pas valide de tenter de définir une nouvelle valeur de ce type ou de tenter de basculer une valeur existante vers ce type. |
