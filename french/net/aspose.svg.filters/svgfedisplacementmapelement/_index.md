...
description: Aspose.Svg.Filters.SVGFEDisplacementMapElement classe. Linterface SVGFEDisplacementMapElement correspond à lélément feDisplacementMap.
type: docs
weight: 1710
url: /fr/net/aspose.svg.filters/svgfedisplacementmapelement/
---
...
| [Height](../../aspose.svg.filters/svgfedisplacementmapelement/height/) { get; } | Correspond à l'attribut 'height' sur l'élément 'filter' donné. |
...
| [In1](../../aspose.svg.filters/svgfedisplacementmapelement/in1/) { get; } | Correspond à l'attribut 'in' sur l'élément 'feDisplacementMap' donné. |
| [In2](../../aspose.svg.filters/svgfedisplacementmapelement/in2/) { get; } | Correspond à l'attribut 'in2' sur l'élément 'feDisplacementMap' donné. |
...
| [Result](../../aspose.svg.filters/svgfedisplacementmapelement/result/) { get; } | Correspond à l'attribut 'result' sur l'élément 'filter' donné. |
| [Scale](../../aspose.svg.filters/svgfedisplacementmapelement/scale/) { get; } | Correspond à l'attribut 'scale' sur l'élément 'feDisplacementMap' donné. |
...
| [Width](../../aspose.svg.filters/svgfedisplacementmapelement/width/) { get; } | Correspond à l'attribut 'width' sur l'élément 'filter' donné. |
| [X](../../aspose.svg.filters/svgfedisplacementmapelement/x/) { get; } | Correspond à l'attribut 'x' sur l'élément 'filter' donné. |
| [XChannelSelector](../../aspose.svg.filters/svgfedisplacementmapelement/xchannelselector/) { get; } | Correspond à l'attribut 'xChannelSelector' sur l'élément 'feDisplacementMap' donné. Prend l'une des constantes SVG_CHANNEL_* définies sur cette interface. |
| [Y](../../aspose.svg.filters/svgfedisplacementmapelement/y/) { get; } | Correspond à l'attribut 'y' sur l'élément 'filter' donné. |
| [YChannelSelector](../../aspose.svg.filters/svgfedisplacementmapelement/ychannelselector/) { get; } | Correspond à l'attribut 'yChannelSelector' sur l'élément 'feDisplacementMap' donné. Prend l'une des constantes SVG_CHANNEL_* définies sur cette interface. |
...
| Nom | La description |
| --- | --- |
| const [SVG_CHANNEL_A](../../aspose.svg.filters/svgfedisplacementmapelement/svg_channel_a/) | Correspond à la valeur 'A'. |
| const [SVG_CHANNEL_B](../../aspose.svg.filters/svgfedisplacementmapelement/svg_channel_b/) | Correspond à la valeur 'B'. |
| const [SVG_CHANNEL_G](../../aspose.svg.filters/svgfedisplacementmapelement/svg_channel_g/) | Correspond à la valeur 'G'. |
| const [SVG_CHANNEL_R](../../aspose.svg.filters/svgfedisplacementmapelement/svg_channel_r/) | Correspond à la valeur 'R'. |
| const [SVG_CHANNEL_UNKNOWN](../../aspose.svg.filters/svgfedisplacementmapelement/svg_channel_unknown/) | Le type ne fait pas partie des types prédéfinis. Il n'est pas valide de tenter de définir une nouvelle valeur de ce type ou de tenter de basculer une valeur existante vers ce type. |
