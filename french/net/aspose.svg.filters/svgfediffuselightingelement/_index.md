...
description: Aspose.Svg.Filters.SVGFEDiffuseLightingElement classe. Linterface SVGFEDiffuseLightingElement correspond à lélément feDiffuseLighting.
type: docs
weight: 1700
url: /fr/net/aspose.svg.filters/svgfediffuselightingelement/
---
...
| [DiffuseConstant](../../aspose.svg.filters/svgfediffuselightingelement/diffuseconstant/) { get; } | Correspond à l'attribut 'diffuseConstant' sur l'élément 'feDiffuseLighting' donné. |
...
| [Height](../../aspose.svg.filters/svgfediffuselightingelement/height/) { get; } | Correspond à l'attribut 'height' sur l'élément 'filter' donné. |
...
| [In1](../../aspose.svg.filters/svgfediffuselightingelement/in1/) { get; } | Correspond à l'attribut 'in' sur l'élément 'feDiffuseLighting' donné. |
...
| [KernelUnitLengthX](../../aspose.svg.filters/svgfediffuselightingelement/kernelunitlengthx/) { get; } | Correspond à l'attribut 'kernelUnitLength' sur l'élément 'feDiffuseLighting' donné. |
| [KernelUnitLengthY](../../aspose.svg.filters/svgfediffuselightingelement/kernelunitlengthy/) { get; } | Correspond à l'attribut 'kernelUnitLength' sur l'élément 'feDiffuseLighting' donné. |
...
| [Result](../../aspose.svg.filters/svgfediffuselightingelement/result/) { get; } | Correspond à l'attribut 'result' sur l'élément 'filter' donné. |
...
| [SurfaceScale](../../aspose.svg.filters/svgfediffuselightingelement/surfacescale/) { get; } | Correspond à l'attribut 'surfaceScale' sur l'élément 'feDiffuseLighting' donné. |
...
| [Width](../../aspose.svg.filters/svgfediffuselightingelement/width/) { get; } | Correspond à l'attribut 'width' sur l'élément 'filter' donné. |
| [X](../../aspose.svg.filters/svgfediffuselightingelement/x/) { get; } | Correspond à l'attribut 'x' sur l'élément 'filter' donné. |
| [Y](../../aspose.svg.filters/svgfediffuselightingelement/y/) { get; } | Correspond à l'attribut 'y' sur l'élément 'filter' donné. |
