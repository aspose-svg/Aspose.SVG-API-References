...
description: Aspose.Svg.Filters.SVGFEBlendElement classe. Linterface SVGFEBlendElement correspond à lélément feBlend.
type: docs
weight: 1650
url: /fr/net/aspose.svg.filters/svgfeblendelement/
---
...
| [Height](../../aspose.svg.filters/svgfeblendelement/height/) { get; } | Correspond à l'attribut 'height' sur l'élément 'filter' donné. |
...
| [In1](../../aspose.svg.filters/svgfeblendelement/in1/) { get; } | Correspond à l'attribut 'in' sur l'élément 'feBlend' donné. |
| [In2](../../aspose.svg.filters/svgfeblendelement/in2/) { get; } | Correspond à l'attribut 'in2' sur l'élément 'feBlend' donné. |
...
| [Mode](../../aspose.svg.filters/svgfeblendelement/mode/) { get; } | Correspond à l'attribut 'mode' sur l'élément 'feBlend' donné. Prend une des constantes SVG_FEBLEND_MODE_* définies sur cette interface. |
...
| [Result](../../aspose.svg.filters/svgfeblendelement/result/) { get; } | Correspond à l'attribut 'result' sur l'élément 'filter' donné. |
...
| [Width](../../aspose.svg.filters/svgfeblendelement/width/) { get; } | Correspond à l'attribut 'width' sur l'élément 'filter' donné. |
| [X](../../aspose.svg.filters/svgfeblendelement/x/) { get; } | Correspond à l'attribut 'x' sur l'élément 'filter' donné. |
| [Y](../../aspose.svg.filters/svgfeblendelement/y/) { get; } | Correspond à l'attribut 'y' sur l'élément 'filter' donné. |
...
| Nom | La description |
| --- | --- |
| const [SVG_FEBLEND_MODE_COLOR](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_color/) | Correspond à la valeur 'couleur'. |
| const [SVG_FEBLEND_MODE_COLOR_BURN](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_color_burn/) | Correspond à la valeur 'color_burn'. |
| const [SVG_FEBLEND_MODE_COLOR_DODGE](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_color_dodge/) | Correspond à la valeur 'color_dodge'. |
| const [SVG_FEBLEND_MODE_DARKEN](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_darken/) | Correspond à la valeur 'obscurcir'. |
| const [SVG_FEBLEND_MODE_DIFFERENCE](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_difference/) | Correspond à la valeur 'différence'. |
| const [SVG_FEBLEND_MODE_EXCLUSION](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_exclusion/) | Correspond à la valeur 'exclusion'. |
| const [SVG_FEBLEND_MODE_HARD_LIGHT](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_hard_light/) | Correspond à la valeur 'hard_light'. |
| const [SVG_FEBLEND_MODE_HUE](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_hue/) | Correspond à la valeur 'hue'. |
| const [SVG_FEBLEND_MODE_LIGHTEN](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_lighten/) | Correspond à la valeur 'lighten'. |
| const [SVG_FEBLEND_MODE_LUMINOSITY](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_luminosity/) | Correspond à la valeur 'luminosité'. |
| const [SVG_FEBLEND_MODE_MULTIPLY](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_multiply/) | Correspond à la valeur 'multiplier'. |
| const [SVG_FEBLEND_MODE_NORMAL](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_normal/) | Correspond à la valeur 'normale'. |
| const [SVG_FEBLEND_MODE_OVERLAY](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_overlay/) | Correspond à la valeur 'overlay'. |
| const [SVG_FEBLEND_MODE_SATURATION](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_saturation/) | Correspond à la valeur 'saturation'. |
| const [SVG_FEBLEND_MODE_SCREEN](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_screen/) | Correspond à la valeur 'écran'. |
| const [SVG_FEBLEND_MODE_SOFT_LIGHT](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_soft_light/) | Correspond à la valeur 'soft_light'. |
| const [SVG_FEBLEND_MODE_UNKNOWN](../../aspose.svg.filters/svgfeblendelement/svg_feblend_mode_unknown/) | Le type ne fait pas partie des types prédéfinis. Il n'est pas valide de tenter de définir une nouvelle valeur de ce type ou de tenter de basculer une valeur existante vers ce type. |
