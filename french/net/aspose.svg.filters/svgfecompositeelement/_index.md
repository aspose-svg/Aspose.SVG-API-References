...
description: Aspose.Svg.Filters.SVGFECompositeElement classe. Linterface SVGFECompositeElement correspond à lélément feComposite.
type: docs
weight: 1680
url: /fr/net/aspose.svg.filters/svgfecompositeelement/
---
...
| [Height](../../aspose.svg.filters/svgfecompositeelement/height/) { get; } | Correspond à l'attribut 'height' sur l'élément 'filter' donné. |
...
| [In1](../../aspose.svg.filters/svgfecompositeelement/in1/) { get; } | Correspond à l'attribut 'in' sur l'élément 'feComposite' donné. |
| [In2](../../aspose.svg.filters/svgfecompositeelement/in2/) { get; } | Correspond à l'attribut 'in2' sur l'élément 'feComposite' donné. |
...
| [K1](../../aspose.svg.filters/svgfecompositeelement/k1/) { get; } | Correspond à l'attribut 'k1' sur l'élément 'feComposite' donné. |
| [K2](../../aspose.svg.filters/svgfecompositeelement/k2/) { get; } | Correspond à l'attribut 'k2' sur l'élément 'feComposite' donné. |
| [K3](../../aspose.svg.filters/svgfecompositeelement/k3/) { get; } | Correspond à l'attribut 'k3' sur l'élément 'feComposite' donné. |
| [K4](../../aspose.svg.filters/svgfecompositeelement/k4/) { get; } | Correspond à l'attribut 'k4' sur l'élément 'feComposite' donné. |
...
| [Operator](../../aspose.svg.filters/svgfecompositeelement/operator/) { get; } | Correspond à l'attribut 'operator' sur l'élément 'feComposite' donné. Prend l'une des constantes SVG_FECOMPOSITE_OPERATOR_* définies sur cette interface. |
...
| [Result](../../aspose.svg.filters/svgfecompositeelement/result/) { get; } | Correspond à l'attribut 'result' sur l'élément 'filter' donné. |
...
| [Width](../../aspose.svg.filters/svgfecompositeelement/width/) { get; } | Correspond à l'attribut 'width' sur l'élément 'filter' donné. |
| [X](../../aspose.svg.filters/svgfecompositeelement/x/) { get; } | Correspond à l'attribut 'x' sur l'élément 'filter' donné. |
| [Y](../../aspose.svg.filters/svgfecompositeelement/y/) { get; } | Correspond à l'attribut 'y' sur l'élément 'filter' donné. |
...
| Nom | La description |
| --- | --- |
| const [SVG_FECOMPOSITE_OPERATOR_ARITHMETIC](../../aspose.svg.filters/svgfecompositeelement/svg_fecomposite_operator_arithmetic/) | Correspond à la valeur 'arithmétique'. |
| const [SVG_FECOMPOSITE_OPERATOR_ATOP](../../aspose.svg.filters/svgfecompositeelement/svg_fecomposite_operator_atop/) | Correspond à la valeur 'au sommet'. |
| const [SVG_FECOMPOSITE_OPERATOR_IN](../../aspose.svg.filters/svgfecompositeelement/svg_fecomposite_operator_in/) | Correspond à la valeur 'in'. |
| const [SVG_FECOMPOSITE_OPERATOR_OUT](../../aspose.svg.filters/svgfecompositeelement/svg_fecomposite_operator_out/) | Correspond à la valeur 'out'. |
| const [SVG_FECOMPOSITE_OPERATOR_OVER](../../aspose.svg.filters/svgfecompositeelement/svg_fecomposite_operator_over/) | Correspond à la valeur 'over'. |
| const [SVG_FECOMPOSITE_OPERATOR_UNKNOWN](../../aspose.svg.filters/svgfecompositeelement/svg_fecomposite_operator_unknown/) | Le type ne fait pas partie des types prédéfinis. Il n'est pas valide de tenter de définir une nouvelle valeur de ce type ou de tenter de basculer une valeur existante vers ce type. |
| const [SVG_FECOMPOSITE_OPERATOR_XOR](../../aspose.svg.filters/svgfecompositeelement/svg_fecomposite_operator_xor/) | Correspond à la valeur 'xor'. |
