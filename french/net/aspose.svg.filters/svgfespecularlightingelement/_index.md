...
description: Aspose.Svg.Filters.SVGFESpecularLightingElement classe. Linterface SVGFESpecularLightingElement correspond à lélément feSpecularLighting.
type: docs
weight: 1860
url: /fr/net/aspose.svg.filters/svgfespecularlightingelement/
---
...
| [Height](../../aspose.svg.filters/svgfespecularlightingelement/height/) { get; } | Correspond à l'attribut 'height' sur l'élément 'filter' donné. |
...
| [In1](../../aspose.svg.filters/svgfespecularlightingelement/in1/) { get; } | Correspond à l'attribut 'in' sur l'élément 'feSpecularLighting' donné. |
...
| [KernelUnitLengthX](../../aspose.svg.filters/svgfespecularlightingelement/kernelunitlengthx/) { get; } | Correspond à l'attribut 'kernelUnitLength' sur l'élément 'feSpecularLighting' donné. |
| [KernelUnitLengthY](../../aspose.svg.filters/svgfespecularlightingelement/kernelunitlengthy/) { get; } | Correspond à l'attribut 'kernelUnitLength' sur l'élément 'feSpecularLighting' donné. |
...
| [Result](../../aspose.svg.filters/svgfespecularlightingelement/result/) { get; } | Correspond à l'attribut 'result' sur l'élément 'filter' donné. |
...
| [SpecularConstant](../../aspose.svg.filters/svgfespecularlightingelement/specularconstant/) { get; } | Correspond à l'attribut 'specularConstant' sur l'élément 'feSpecularLighting' donné. |
| [SpecularExponent](../../aspose.svg.filters/svgfespecularlightingelement/specularexponent/) { get; } | Correspond à l'attribut 'specularExponent' sur l'élément 'feSpecularLighting' donné. |
...
| [SurfaceScale](../../aspose.svg.filters/svgfespecularlightingelement/surfacescale/) { get; } | Correspond à l'attribut 'surfaceScale' sur l'élément 'feSpecularLighting' donné. |
...
| [Width](../../aspose.svg.filters/svgfespecularlightingelement/width/) { get; } | Correspond à l'attribut 'width' sur l'élément 'filter' donné. |
| [X](../../aspose.svg.filters/svgfespecularlightingelement/x/) { get; } | Correspond à l'attribut 'x' sur l'élément 'filter' donné. |
| [Y](../../aspose.svg.filters/svgfespecularlightingelement/y/) { get; } | Correspond à l'attribut 'y' sur l'élément 'filter' donné. |
