...
description: Aspose.Svg.Filters.SVGFEConvolveMatrixElement classe. Linterface SVGFEConvolveMatrixElement correspond à lélément feConvolveMatrix.
type: docs
weight: 1690
url: /fr/net/aspose.svg.filters/svgfeconvolvematrixelement/
---
...
| [Bias](../../aspose.svg.filters/svgfeconvolvematrixelement/bias/) { get; } | Correspond à l'attribut 'bias' sur l'élément 'feConvolveMatrix' donné. |
...
| [Divisor](../../aspose.svg.filters/svgfeconvolvematrixelement/divisor/) { get; } | Correspond à l'attribut 'divisor' sur l'élément 'feConvolveMatrix' donné. |
| [EdgeMode](../../aspose.svg.filters/svgfeconvolvematrixelement/edgemode/) { get; } | Correspond à l'attribut 'edgeMode' sur l'élément 'feConvolveMatrix' donné. |
...
| [Height](../../aspose.svg.filters/svgfeconvolvematrixelement/height/) { get; } | Correspond à l'attribut 'height' sur l'élément 'filter' donné. |
...
| [In1](../../aspose.svg.filters/svgfeconvolvematrixelement/in1/) { get; } | Correspond à l'attribut 'in' sur l'élément 'feConvolveMatrix' donné. |
...
| [KernelMatrix](../../aspose.svg.filters/svgfeconvolvematrixelement/kernelmatrix/) { get; } | Correspond à l'attribut 'kernelMatrix' sur l'élément 'feConvolveMatrix' donné. |
| [KernelUnitLengthX](../../aspose.svg.filters/svgfeconvolvematrixelement/kernelunitlengthx/) { get; } | Correspond à l'attribut 'kernelUnitLength' sur l'élément 'feConvolveMatrix' donné. |
| [KernelUnitLengthY](../../aspose.svg.filters/svgfeconvolvematrixelement/kernelunitlengthy/) { get; } | Correspond à l'attribut 'kernelUnitLength' sur l'élément 'feConvolveMatrix' donné. |
...
| [OrderX](../../aspose.svg.filters/svgfeconvolvematrixelement/orderx/) { get; } | Correspond à l'attribut 'order' sur l'élément 'feConvolveMatrix' donné. |
| [OrderY](../../aspose.svg.filters/svgfeconvolvematrixelement/ordery/) { get; } | Correspond à l'attribut 'order' sur l'élément 'feConvolveMatrix' donné. |
...
| [PreserveAlpha](../../aspose.svg.filters/svgfeconvolvematrixelement/preservealpha/) { get; } | Correspond à l'attribut 'preserveAlpha' sur l'élément 'feConvolveMatrix' donné. |
...
| [Result](../../aspose.svg.filters/svgfeconvolvematrixelement/result/) { get; } | Correspond à l'attribut 'result' sur l'élément 'filter' donné. |
...
| [TargetX](../../aspose.svg.filters/svgfeconvolvematrixelement/targetx/) { get; } | Correspond à l'attribut 'targetX' sur l'élément 'feConvolveMatrix' donné. |
| [TargetY](../../aspose.svg.filters/svgfeconvolvematrixelement/targety/) { get; } | Correspond à l'attribut 'targetY' sur l'élément 'feConvolveMatrix' donné. |
...
| [Width](../../aspose.svg.filters/svgfeconvolvematrixelement/width/) { get; } | Correspond à l'attribut 'width' sur l'élément 'filter' donné. |
| [X](../../aspose.svg.filters/svgfeconvolvematrixelement/x/) { get; } | Correspond à l'attribut 'x' sur l'élément 'filter' donné. |
| [Y](../../aspose.svg.filters/svgfeconvolvematrixelement/y/) { get; } | Correspond à l'attribut 'y' sur l'élément 'filter' donné. |
...
| Nom | La description |
| --- | --- |
| const [SVG_EDGEMODE_DUPLICATE](../../aspose.svg.filters/svgfeconvolvematrixelement/svg_edgemode_duplicate/) | Correspond à la valeur 'dupliquer'. |
| const [SVG_EDGEMODE_NONE](../../aspose.svg.filters/svgfeconvolvematrixelement/svg_edgemode_none/) | Correspond à la valeur 'aucun'. |
| const [SVG_EDGEMODE_UNKNOWN](../../aspose.svg.filters/svgfeconvolvematrixelement/svg_edgemode_unknown/) | Le type ne fait pas partie des types prédéfinis. Il n'est pas valide de tenter de définir une nouvelle valeur de ce type ou de tenter de basculer une valeur existante vers ce type. |
| const [SVG_EDGEMODE_WRAP](../../aspose.svg.filters/svgfeconvolvematrixelement/svg_edgemode_wrap/) | Correspond à la valeur 'wrap'. |
