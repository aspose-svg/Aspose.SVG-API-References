...
description: Aspose.Svg.Filters.SVGFEGaussianBlurElement classe. Linterface SVGFEGaussianBlurElement correspond à lélément feGaussianBlur.
type: docs
weight: 1790
url: /fr/net/aspose.svg.filters/svgfegaussianblurelement/
---
...
| [Height](../../aspose.svg.filters/svgfegaussianblurelement/height/) { get; } | Correspond à l'attribut "height" sur l'élément "filter" donné. |
...
| [In1](../../aspose.svg.filters/svgfegaussianblurelement/in1/) { get; } | Correspond à l'attribut "in" sur l'élément "feGaussianBlur" donné. |
...
| [Result](../../aspose.svg.filters/svgfegaussianblurelement/result/) { get; } | Correspond à l'attribut "résultat" sur l'élément "filtre" donné. |
...
| [StdDeviationX](../../aspose.svg.filters/svgfegaussianblurelement/stddeviationx/) { get; } | Correspond à l'attribut "stdDeviation" sur l'élément "feGaussianBlur" donné. Contient la composante X de l'attribut �stdDeviation�. |
| [StdDeviationY](../../aspose.svg.filters/svgfegaussianblurelement/stddeviationy/) { get; } | Correspond à l'attribut "stdDeviation" sur l'élément "feGaussianBlur" donné. Contient la composante Y (éventuellement calculée automatiquement) de l'attribut "stdDeviation". |
...
| [Width](../../aspose.svg.filters/svgfegaussianblurelement/width/) { get; } | Correspond à l'attribut "width" sur l'élément "filter" donné. |
| [X](../../aspose.svg.filters/svgfegaussianblurelement/x/) { get; } | Correspond à l'attribut "x" sur l'élément "filtre" donné. |
| [Y](../../aspose.svg.filters/svgfegaussianblurelement/y/) { get; } | Correspond à l'attribut "y" sur l'élément "filter" donné. |
...
| [SetStdDeviation](../../aspose.svg.filters/svgfegaussianblurelement/setstddeviation/)(float, float) | Définit les valeurs de l'attribut "stdDeviation". |
