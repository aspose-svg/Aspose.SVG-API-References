...
description: Aspose.Svg.Filters.SVGFEDropShadowElement classe. Linterface SVGFEDropShadowElement correspond à lélément feDropShadow.
type: docs
weight: 1730
url: /fr/net/aspose.svg.filters/svgfedropshadowelement/
---
...
| [Dx](../../aspose.svg.filters/svgfedropshadowelement/dx/) { get; } | Correspond à l'attribut 'dx' sur l'élément 'feDropShadow' donné. |
| [Dy](../../aspose.svg.filters/svgfedropshadowelement/dy/) { get; } | Correspond à l'attribut 'dy' sur l'élément 'feDropShadow' donné. |
...
| [Height](../../aspose.svg.filters/svgfedropshadowelement/height/) { get; } | Correspond à l'attribut 'height' sur l'élément 'feDropShadow' donné. |
...
| [In1](../../aspose.svg.filters/svgfedropshadowelement/in1/) { get; } | Correspond à l'attribut 'in' sur l'élément 'feDropShadow' donné. |
...
| [Result](../../aspose.svg.filters/svgfedropshadowelement/result/) { get; } | Correspond à l'attribut 'result' sur l'élément 'feDropShadow' donné. |
...
| [StdDeviationX](../../aspose.svg.filters/svgfedropshadowelement/stddeviationx/) { get; } | Correspond à l'attribut 'stdDeviation' sur l'élément 'feDropShadow' donné. Contient le composant X de l'attribut 'stdDeviation'. |
| [StdDeviationY](../../aspose.svg.filters/svgfedropshadowelement/stddeviationy/) { get; } | Correspond à l'attribut 'stdDeviation' sur l'élément 'feDropShadow' donné. Contient la composante Y (éventuellement calculée automatiquement) de l'attribut 'stdDeviation'. |
...
| [Width](../../aspose.svg.filters/svgfedropshadowelement/width/) { get; } | Correspond à l'attribut 'width' sur l'élément 'feDropShadow' donné. |
| [X](../../aspose.svg.filters/svgfedropshadowelement/x/) { get; } | Correspond à l'attribut 'x' sur l'élément 'feDropShadow' donné. |
| [Y](../../aspose.svg.filters/svgfedropshadowelement/y/) { get; } | Correspond à l'attribut 'y' sur l'élément 'feDropShadow' donné. |
...
| [SetStdDeviation](../../aspose.svg.filters/svgfedropshadowelement/setstddeviation/)(float, float) | Définit les valeurs de l'attribut 'stdDeviation'. |
