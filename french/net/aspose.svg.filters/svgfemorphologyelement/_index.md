...
description: Aspose.Svg.Filters.SVGFEMorphologyElement classe. Linterface SVGFEMorphologyElement correspond à lélément feMorphology.
type: docs
weight: 1830
url: /fr/net/aspose.svg.filters/svgfemorphologyelement/
---
...
| [Height](../../aspose.svg.filters/svgfemorphologyelement/height/) { get; } | Correspond à l'attribut 'height' sur l'élément 'filter' donné. |
...
| [In1](../../aspose.svg.filters/svgfemorphologyelement/in1/) { get; } | Correspond à l'attribut 'in' sur l'élément 'feMorphology' donné. |
...
| [Operator](../../aspose.svg.filters/svgfemorphologyelement/operator/) { get; } | Correspond à l'attribut 'operator' sur l'élément 'feMorphology' donné. Prend une des constantes SVG_MORPHOLOGY_OPERATOR_* définies sur cette interface. |
...
| [RadiusX](../../aspose.svg.filters/svgfemorphologyelement/radiusx/) { get; } | Correspond à l'attribut 'radius' sur l'élément 'feMorphology' donné. |
| [RadiusY](../../aspose.svg.filters/svgfemorphologyelement/radiusy/) { get; } | Correspond à l'attribut 'radius' sur l'élément 'feMorphology' donné. |
| [Result](../../aspose.svg.filters/svgfemorphologyelement/result/) { get; } | Correspond à l'attribut 'result' sur l'élément 'filter' donné. |
...
| [Width](../../aspose.svg.filters/svgfemorphologyelement/width/) { get; } | Correspond à l'attribut 'width' sur l'élément 'filter' donné. |
| [X](../../aspose.svg.filters/svgfemorphologyelement/x/) { get; } | Correspond à l'attribut 'x' sur l'élément 'filter' donné. |
| [Y](../../aspose.svg.filters/svgfemorphologyelement/y/) { get; } | Correspond à l'attribut 'y' sur l'élément 'filter' donné. |
...
| Nom | La description |
| --- | --- |
| const [SVG_MORPHOLOGY_OPERATOR_DILATE](../../aspose.svg.filters/svgfemorphologyelement/svg_morphology_operator_dilate/) | Correspond à la valeur 'dilate'. |
| const [SVG_MORPHOLOGY_OPERATOR_ERODE](../../aspose.svg.filters/svgfemorphologyelement/svg_morphology_operator_erode/) | Correspond à la valeur 'erode'. |
| const [SVG_MORPHOLOGY_OPERATOR_UNKNOWN](../../aspose.svg.filters/svgfemorphologyelement/svg_morphology_operator_unknown/) | Le type ne fait pas partie des types prédéfinis. Il n'est pas valide de tenter de définir une nouvelle valeur de ce type ou de tenter de basculer une valeur existante vers ce type. |
