...
description: Aspose.Svg.Filters.SVGFETileElement classe. Linterface SVGFETileElement correspond à lélément feTile.
type: docs
weight: 1880
url: /fr/net/aspose.svg.filters/svgfetileelement/
---
...
| [Height](../../aspose.svg.filters/svgfetileelement/height/) { get; } | Correspond à l'attribut 'height' sur l'élément 'filter' donné. |
...
| [In1](../../aspose.svg.filters/svgfetileelement/in1/) { get; } | Correspond à l'attribut 'in' sur l'élément 'feTile' donné. |
...
| [Result](../../aspose.svg.filters/svgfetileelement/result/) { get; } | Correspond à l'attribut 'result' sur l'élément 'filter' donné. |
...
| [Width](../../aspose.svg.filters/svgfetileelement/width/) { get; } | Correspond à l'attribut 'width' sur l'élément 'filter' donné. |
| [X](../../aspose.svg.filters/svgfetileelement/x/) { get; } | Correspond à l'attribut 'x' sur l'élément 'filter' donné. |
| [Y](../../aspose.svg.filters/svgfetileelement/y/) { get; } | Correspond à l'attribut 'y' sur l'élément 'filter' donné. |
