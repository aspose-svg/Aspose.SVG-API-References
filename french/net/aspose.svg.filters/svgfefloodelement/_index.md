...
description: Aspose.Svg.Filters.SVGFEFloodElement classe. Linterface SVGFEFloodElement correspond à lélément feFlood.
type: docs
weight: 1740
url: /fr/net/aspose.svg.filters/svgfefloodelement/
---
...
| [Height](../../aspose.svg.filters/svgfefloodelement/height/) { get; } | Correspond à l'attribut 'height' sur l'élément 'filter' donné. |
...
| [Result](../../aspose.svg.filters/svgfefloodelement/result/) { get; } | Correspond à l'attribut 'result' sur l'élément 'filter' donné. |
...
| [Width](../../aspose.svg.filters/svgfefloodelement/width/) { get; } | Correspond à l'attribut 'width' sur l'élément 'filter' donné. |
| [X](../../aspose.svg.filters/svgfefloodelement/x/) { get; } | Correspond à l'attribut 'x' sur l'élément 'filter' donné. |
| [Y](../../aspose.svg.filters/svgfefloodelement/y/) { get; } | Correspond à l'attribut 'y' sur l'élément 'filter' donné. |
