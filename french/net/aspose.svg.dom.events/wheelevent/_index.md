...
description: Aspose.Svg.Dom.Events.WheelEvent classe. Linterface WheelEvent fournit des informations contextuelles spécifiques associées aux événements de roue. Pour créer une instance de linterface WheelEvent utilisez le constructeur WheelEvent en transmettant un dictionnaire WheelEventInit facultatif.
type: docs
weight: 1010
