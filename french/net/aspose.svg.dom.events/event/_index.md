...
| [InitEvent](../../aspose.svg.dom.events/event/initevent)(string, bool, bool) | Le[`InitEvent`](./initevent) méthode est utilisée pour initialiser la valeur d'un[`Event`](../event) créé via the [`IDocumentEvent`](../idocumentevent) interface. |
