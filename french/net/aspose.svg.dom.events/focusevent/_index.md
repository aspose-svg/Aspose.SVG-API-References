...
description: Aspose.Svg.Dom.Events.FocusEvent classe. Linterface FocusEvent fournit des informations contextuelles spécifiques associées aux événements Focus.
type: docs
weight: 930
url: /fr/net/aspose.svg.dom.events/focusevent/
---
## FocusEvent class
...
| [RelatedTarget](../../aspose.svg.dom.events/focusevent/relatedtarget/) { get; } | Utilisé pour identifier un EventTarget secondaire lié à un événement Focus, selon le type d'événement. |
