...
type: docs
weight: 30
url: /fr/python-net/aspose.svg.dom.events/ieventtarget/dispatch_event/
is_root: false
---
...
| :- | :- | :- |
| event | [`Event`](/svg/python-net/aspose.svg.dom.events/event) | Specifies the event type, behavior, and contextual information to be used in processing the event. |
### Remarks
